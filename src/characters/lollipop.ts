 ...
 *   Eyes on the stick, mouth on the candy, concentric red/white swirl
 */
...
export class LollipopCharacter extends BaseCharacter {
  ...
  constructor(def: CharacterDef) {
    ...
    this.rig = new ChibiRig({
      palette: { limb: '#E63946', hand: '#F4E9DA', foot: '#D8D2C4' },
    });
    ...
    const mass = new THREE.Mesh(
      ...
      toonMat({ color: '#E63946', roughness: 0.7 })
    );
    mass.name = 'lollipop_mass_STUB';
