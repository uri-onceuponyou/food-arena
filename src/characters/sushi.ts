 ...
 *   Rice cylinder banded with nori, salmon centre, wide eyes and puckered lips
 */
...
export class SushiCharacter extends BaseCharacter {
  ...
  constructor(def: CharacterDef) {
    ...
    this.rig = new ChibiRig({
      palette: { limb: '#FFFFFF', hand: '#F4A261', foot: '#2B2B2B' },
    });
    ...
    const mass = new THREE.Mesh(
      ...
      toonMat({ color: '#FFFFFF', roughness: 0.7 })
    );
    mass.name = 'sushi_mass_STUB';
