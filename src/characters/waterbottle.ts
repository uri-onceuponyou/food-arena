 ...
 *   Translucent blue bottle, darker cap, eyes above the cap, big smile
 */
...
export class WaterBottleCharacter extends BaseCharacter {
  ...
  constructor(def: CharacterDef) {
    ...
    this.rig = new ChibiRig({
      palette: { limb: '#BFEFFF', hand: '#1E90D8', foot: '#1878B0' },
    });
    ...
    const mass = new THREE.Mesh(
      ...
      toonMat({ color: '#BFEFFF', roughness: 0.7 })
    );
    mass.name = 'waterbottle_mass_STUB';
