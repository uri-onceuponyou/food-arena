 ...
 *   White wrap, upright, toppings visible at the open end
 */
...
export class BurritoCharacter extends BaseCharacter {
  ...
  constructor(def: CharacterDef) {
    ...
    this.rig = new ChibiRig({
      palette: { limb: '#F4E9DA', hand: '#E8C9A0', foot: '#D9BE95' },
    });
    ...
    const mass = new THREE.Mesh(
      ...
      toonMat({ color: '#F4E9DA', roughness: 0.7 })
    );
    mass.name = 'burrito_mass_STUB';
