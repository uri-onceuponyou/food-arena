 ...
 */
/**
 * capture-audit: css-immune — `gl.readPixels()` on `preview.html`; the ratio is delivered px / footprint px off the
 * drawing buffer. `preview.html` has no `.fa-stack` and never animates a screen in.
 */
