/** Screenshot a menu screen, waiting for the roster portraits to finish rendering.
 *  tools/shoot.mjs waits on __previewReady, which fires two frames after mount —
 *  long before the progressive emoji->portrait upgrade completes. */
...
if (a.thumbs !== '0') {
  await p.waitForFunction('window.__thumbsReady === true',null,{timeout:120000}).catch(()=>console.warn('thumbs timeout'));
}
