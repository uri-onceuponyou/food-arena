#!/usr/bin/env node
/**
 * ey_shot — one WHOLE-FIGURE capture of one character, at EITHER shipped camera.
 *
...
const OUT = get('--out', 'shots/ey/out.png');
...
await writeFile(`${OUT}.capture.json`, JSON.stringify({
  tool: 'ey_shot.mjs', label: LABEL, takenAt: new Date().toISOString(), painted, id: ID, url,
