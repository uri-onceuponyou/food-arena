import{C as re,l as Zr,c as Ra,L as io,a as Ee,t as za,b as Jr,V as de,d as J,S as Dl,e as Me,M as W,f as Ve,R as at,B as Gh,g as E,h as Ma,i as En,j as et,k as Qr,m as ri,G as ie,P as to,n as V,o as Rt,p as zl,q as Tn,O as el,Z as Wh,A as Ds,r as Bf,s as r0,N as qf,u as tl,v as l0,w as h0,x as Hl,y as Kt,z as Gt,D as Nt,E as Aa,F as Le,H as me,I as Dn,J as Uf,K as jf,Q as Je,T as Gf,U as Wf,W as Yf,X as c0,Y as d0,_ as Yh,$ as al,a0 as Vf,a1 as Kf,a2 as Xf,a3 as It,a4 as Zf,a5 as p0,a6 as Jf,a7 as Qf,a8 as em,a9 as u0,aa as tm,ab as am,ac as Ts,ad as Vh,ae as Kh,af as Sn,ag as om,ah as tn,ai as Di,aj as nm,ak as sm,al as zi,am as Xh,an as ol,ao as im,ap as zs,aq as rm,ar as lm,as as nl,at as hm,au as sl,av as cm,aw as dm,ax as pm,ay as um,az as Hs,aA as il,aB as fm,aC as mm,aD as gm,aE as wm,aF as _l,aG as st,aH as Wo,aI as li,aJ as Qe,aK as Ka,aL as Pl,aM as $l,aN as hi,aO as ro,aP as Bl,aQ as ba,aR as Ct,aS as lo,aT as f0,aU as ql,aV as Ia,aW as bm,aX as ym,aY as Wa,aZ as xm,a_ as vm,a$ as km,b0 as Zh,b1 as an,b2 as _s,b3 as Mm,b4 as Hi,b5 as Em,b6 as Tm,b7 as Sm,b8 as Am,b9 as Rm,ba as Im,bb as Cm,bc as Jh,bd as Fm,be as Om,bf as Nm,bg as Lm,bh as _i,bi as Dm,bj as zm,bk as Hm,bl as _m,bm as Pm,bn as $m}from"./kitchen-B5SOJVV-.js";const Ht=6,nt=2;function Bm(t){return t===0?"player":"enemy"}function qm(t){return 1<<t}function Um(t){const{id:e,controller:a,characterId:o,spawn:n,maxHp:s,size:i,hitRadius:r,facing:l}=t,h=re[o].weapons.length,c=Ra(t.level??io);return{id:e,controller:a,role:Bm(e),characterId:o,level:c,damageMul:Zr(c),x:n.x,y:n.y,hp:s,maxHp:s,size:i,hitRadius:r,facing:{x:l.x,y:l.y},status:{slowedUntil:-1/0,stunnedUntil:-1/0,slowAppliedAt:-1/0,slowStacks:0,stunAppliedAt:-1/0,stunStacks:0},alive:!0,deaths:0,lastUsed:new Array(h).fill(-1/0),hazardTimers:[],fogTimer:0,regenTimer:0,trailDropTimer:0,detourSign:0,lastDamagedAt:-1/0,terrainSlowFactor:1,concealed:!1,revealedUntil:-1/0,cast:null,push:{x:0,y:0,remaining:0}}}function m0(t){return t.cast!==null}function Ul(t,e){return e<t.status.stunnedUntil||t.cast!==null}function g0(t){return t==="player"?"enemy":"player"}function ci(t,e){return t!==e&&t.alive&&t.hp>0}function w0(t,e){let a=null,o=1/0;for(const n of t.fighters){if(!ci(n,e))continue;const s=Math.hypot(n.x-e.x,n.y-e.y);s<o&&(o=s,a=n)}return a}function jm(t){let e=null;for(const a of t.fighters)if(!(!a.alive||a.hp<=0)){if(e!==null)return null;e=a}return e}function rl(t,e,a){return t*a+e}function Gm(t){const e=t.get("seats");if(e!==null)return di(Number(e))}function di(t){if(Number.isInteger(t)&&!(t<=nt||t>Ht))return t}const Qh=Array.from({length:Ht-nt+1},(t,e)=>nt+e);function b0(t,e,a){if(!Number.isInteger(a)||a<nt||a>Ht)throw new RangeError(`brawlRoster: ${a} seats; the sim seats ${nt}..${Ht} (see state.ts MIN_FIGHTERS / MAX_FIGHTERS)`);const o=[t];a>1&&o.push(e);const n=Ee.indexOf(t);for(let s=1;o.length<a&&s<=Ee.length;s++){const i=Ee[(n+s)%Ee.length];o.includes(i)||o.push(i)}if(o.length!==a||new Set(o).size!==a)throw new RangeError(`brawlRoster: built ${o.length} seats (${new Set(o).size} distinct) for ${a} from ${Ee.length} characters — [${o.join(", ")}]`);return o}const ec={coins:500,gems:25},Wm=!1,y0=Ee[0],ct={trophiesWin:za("MATCH_PAYOUT.trophiesWin",15,{group:"economy",unit:"trophies",min:0,max:200,int:!0,doc:"Trophies for first place. The whole placement curve is stated relative to this — see the placement block below."}),trophyLossBase:za("MATCH_PAYOUT.trophyLossBase",2,{group:"economy",unit:"trophies",min:0,max:100,int:!0,doc:"Flat part of a loss. Loss = min(cap, base + floor(trophies / per))."}),trophyLossPer:za("MATCH_PAYOUT.trophyLossPer",150,{group:"economy",unit:"trophies",min:1,max:1e4,int:!0,doc:"Trophies per extra point of loss — the escalation rate. A DIVISOR: smaller is harsher."}),trophyLossCap:za("MATCH_PAYOUT.trophyLossCap",10,{group:"economy",unit:"trophies",min:0,max:200,int:!0,doc:"Ceiling on a single loss, however many trophies are held."}),trophyLossGraceBelow:za("MATCH_PAYOUT.trophyLossGraceBelow",100,{group:"economy",unit:"trophies",min:0,max:1e4,int:!0,doc:"Below this standing a loss costs nothing — the first hour must not read as standing still."}),coinsWin:za("MATCH_PAYOUT.coinsWin",60,{group:"economy",unit:"coins",min:0,max:1e4,int:!0,doc:"Coins for a win. The 3:1 ratio against coinsLoss is the design statement, not either number alone."}),coinsLoss:za("MATCH_PAYOUT.coinsLoss",20,{group:"economy",unit:"coins",min:0,max:1e4,int:!0,doc:"Coins for a loss. Always non-zero: a losing streak must not feel like a waste of ten minutes."}),winsPerChest:3,placementSteepness:1},No={Normal:120,Rare:260,Epic:520,Legendary:900,Neon:1400,Cyber:2200},on={baseCoins:300,growth:1.32,rarityCostMultiplier:{Normal:1,Rare:1,Epic:1,Legendary:1,Neon:1,Cyber:1},roundTo:10},ra=["chest","hamburgerBox","pineappleBox","redBox","fireBox"],x0="Rarity sets how hard a fighter is to find — not how strong it is, and not what it costs to level up. Two fighters at the same level are a fair fight whatever their rarity.",Pe={chest:{name:"Chest",emoji:"📦",blurb:"Earned by winning matches and along the Trophy Road.",price:null,entries:[{weight:50,coins:120},{weight:22,coins:220},{weight:13,coins:90,gems:5},{weight:8,coins:400},{weight:4,coins:150,gems:20},{weight:2.1,characterRarity:"Normal"},{weight:.9,characterRarity:"Rare"}]},hamburgerBox:{name:"Hamburger Box",emoji:"🍔",blurb:"Mostly Normal fighters, with a chance of something rarer.",price:{coins:900,gems:60},entries:[{weight:89,characterRarity:"Normal"},{weight:10,characterRarity:"Rare"},{weight:1,characterRarity:"Epic"}]},pineappleBox:{name:"Purple Pineapple Box",emoji:"🍍",blurb:"Rare fighters guaranteed, Epic and Legendary possible.",price:{coins:3200,gems:120},entries:[{weight:94.5,characterRarity:"Rare"},{weight:5,characterRarity:"Epic"},{weight:.5,characterRarity:"Legendary"}]},redBox:{name:"Big Smile Box",emoji:"🎁",blurb:"Epic fighters, with the only Cyber chance outside the Fire Box.",price:{coins:5600,gems:240},entries:[{weight:89.49,characterRarity:"Epic"},{weight:10,characterRarity:"Legendary"},{weight:.5,characterRarity:"Neon"},{weight:.01,characterRarity:"Cyber"}]},fireBox:{name:"Purple Fire Box",emoji:"🔥",blurb:"Legendary fighters, with the best Neon and Cyber odds in the game.",price:{coins:12e3,gems:480},entries:[{weight:94.5,characterRarity:"Legendary"},{weight:5,characterRarity:"Neon"},{weight:.5,characterRarity:"Cyber"}]}},na=[{trophies:10,reward:{type:"container",kind:"chest",count:1}},{trophies:25,reward:{type:"coins",amount:150}},{trophies:42,reward:{type:"gems",amount:5}},{trophies:60,reward:{type:"character",id:"donut"}},{trophies:85,reward:{type:"container",kind:"hamburgerBox",count:1}},{trophies:107,reward:{type:"coins",amount:250}},{trophies:130,reward:{type:"character",id:"taco"}},{trophies:160,reward:{type:"gems",amount:10}},{trophies:190,reward:{type:"container",kind:"chest",count:1}},{trophies:220,reward:{type:"character",id:"burrito"}},{trophies:260,reward:{type:"coins",amount:400}},{trophies:300,reward:{type:"container",kind:"hamburgerBox",count:1}},{trophies:345,reward:{type:"character",id:"soup"}},{trophies:400,reward:{type:"gems",amount:20}},{trophies:455,reward:{type:"container",kind:"chest",count:1}},{trophies:510,reward:{type:"character",id:"sushi"}},{trophies:580,reward:{type:"coins",amount:700}},{trophies:650,reward:{type:"container",kind:"pineappleBox",count:1}},{trophies:725,reward:{type:"character",id:"waterbottle"}},{trophies:815,reward:{type:"gems",amount:35}},{trophies:905,reward:{type:"container",kind:"chest",count:1}},{trophies:1e3,reward:{type:"character",id:"pizza"}},{trophies:1105,reward:{type:"coins",amount:1200}},{trophies:1220,reward:{type:"container",kind:"redBox",count:1}},{trophies:1340,reward:{type:"character",id:"egg"}},{trophies:1485,reward:{type:"gems",amount:60}},{trophies:1630,reward:{type:"container",kind:"pineappleBox",count:1}},{trophies:1780,reward:{type:"character",id:"lollipop"}},{trophies:1980,reward:{type:"coins",amount:2e3}},{trophies:2190,reward:{type:"container",kind:"redBox",count:1}},{trophies:2400,reward:{type:"character",id:"hotdog"}},{trophies:2650,reward:{type:"gems",amount:100}},{trophies:2900,reward:{type:"container",kind:"fireBox",count:1}},{trophies:3200,reward:{type:"bundle",parts:[{type:"coins",amount:5e3},{type:"gems",amount:150},{type:"container",kind:"fireBox",count:1}]}}],v0=[{id:"gemsPouch",name:"Pouch of Gems",emoji:"💎",priceUsdCents:99,gems:80},{id:"gemsSack",name:"Sack of Gems",emoji:"💎",priceUsdCents:499,gems:500},{id:"gemsCrate",name:"Crate of Gems",emoji:"💎",priceUsdCents:999,gems:1200},{id:"gemsBarrel",name:"Barrel of Gems",emoji:"💎",priceUsdCents:1999,gems:2600},{id:"gemsVault",name:"Vault of Gems",emoji:"💎",priceUsdCents:4999,gems:7e3},{id:"starterBundle",name:"Chef Starter Pack",emoji:"🧑‍🍳",priceUsdCents:499,gems:500,coins:2e3,container:{kind:"pineappleBox",count:1},oneTime:!0}],pi=(()=>{const t={};for(const e of Ee){const a=re[e].rarity;(t[a]??=[]).push(e)}return t})();function Ym(t){let e=t>>>0;return e=Math.imul(e^e>>>16,569420461),e=Math.imul(e^e>>>15,1935289751),(e^e>>>15)>>>0}function Vm(t){let e=Ym(Math.trunc(t)||0);const a=()=>{e=e+1831565813>>>0;let o=e;return o=Math.imul(o^o>>>15,o|1),o^=o+Math.imul(o^o>>>7,o|61),((o^o>>>14)>>>0)/4294967296};return{next:a,int(o){return o>0?Math.floor(a()*o):0},pick(o){return o.length>0?o[Math.floor(a()*o.length)]:void 0}}}function Km(t,e,a){if(e.length===0)return-1;const o=t.next()*a;let n=0;for(let s=0;s<e.length;s++)if(n+=e[s],o<n)return s;return e.length-1}function Xm(){return Math.floor(Math.random()*4294967295)>>>0||1}function jl(){return{coins:0,gems:0,containers:{},characters:[]}}function Ss(t,e){return e===1?t:/[sxz]$/i.test(t)?`${t}es`:`${t}s`}function k0(t,e){t.coins+=e.coins,t.gems+=e.gems;for(const[a,o]of Object.entries(e.containers))t.containers[a]=(t.containers[a]??0)+o;for(const a of e.characters)t.characters.includes(a)||t.characters.push(a);return t}function Zm(t){const e=[];for(const a of t.characters)e.push({emoji:re[a].emoji,label:re[a].name});for(const[a,o]of Object.entries(t.containers)){if(!o)continue;const n=Pe[a];e.push({emoji:n.emoji,label:o>1?`${o} ${Ss(n.name,o)}`:n.name})}return t.coins>0&&e.push({emoji:"🪙",label:`${t.coins.toLocaleString()} ${Ss("Coin",t.coins)}`}),t.gems>0&&e.push({emoji:"💎",label:`${t.gems.toLocaleString()} ${Ss("Gem",t.gems)}`}),e}function ui(t){return t.reduce((e,a)=>e+a.weight,0)}function An(t){const e=Pe[t],a=ui(e.entries);if(a<=0)return[];const o=[];for(const s of e.entries){const i=s.weight/a*100;if(s.characterRarity){const r=pi[s.characterRarity]??[];o.push({label:`${s.characterRarity} fighter`,percent:i,rarity:s.characterRarity,pool:r})}else{const r=[];s.coins&&r.push(`${s.coins.toLocaleString()} coins`),s.gems&&r.push(`${s.gems.toLocaleString()} gems`),o.push({label:r.join(" + ")||"Nothing",percent:i})}}const n=new Map;for(const s of o){const i=n.get(s.label);i?i.percent+=s.percent:n.set(s.label,{...s})}return[...n.values()].sort((s,i)=>i.percent-s.percent)}function M0(t){return`${t.toFixed(4).replace(/0+$/,"").replace(/\.$/,"")}%`}function Jm(t,e,a){const o=Pe[t],n=ui(o.entries),s=o.entries[Km(e,o.entries.map(r=>r.weight),n)],i=jl();if(!s)return{kind:t,reward:i};if(s.coins&&(i.coins+=s.coins),s.gems&&(i.gems+=s.gems),s.characterRarity){const r=pi[s.characterRarity]??[],l=r.filter(h=>!a.has(h));if(l.length>0){const h=e.pick(l);i.characters.push(h)}else{const h=e.pick(r);if(i.coins+=No[s.characterRarity],h)return{kind:t,reward:i,duplicateOf:h}}}return{kind:t,reward:i}}function E0(t){return No[re[t].rarity]}function Qm(t){return t<ct.trophyLossGraceBelow?0:Math.min(ct.trophyLossCap,ct.trophyLossBase+Math.floor(t/ct.trophyLossPer))}function fi(t,e){if(!Number.isInteger(e)||e<nt||e>Ht)throw new RangeError(`placementRank01: ${e} seats; the sim seats ${nt}..${Ht} (see game/state.ts MIN_FIGHTERS / MAX_FIGHTERS)`);if(!Number.isInteger(t)||t<0||t>=e)throw new RangeError(`placementRank01: place ${t} is outside 0..${e-1}`);return t/(e-1)}function Gl(t,e=ct.placementSteepness){return t<=0?0:t>=1?1:Math.pow(t,e)}function eg(t,e,a,o){const n=Gl(fi(t,e),o),s=ct.trophiesWin+Qm(a);return Math.round(ct.trophiesWin-n*s)}function tg(t,e,a){const o=Gl(fi(t,e),a);return Math.round(ct.coinsWin-o*(ct.coinsWin-ct.coinsLoss))}function ag(t,e){return fi(t,e)<.5}function og(){return na}function ll(){return na.length>0?na[na.length-1].trophies:0}function T0(t,e){return na.filter(a=>t>=a.trophies&&!e.includes(a.trophies))}function ng(t){return na.find(e=>t<e.trophies)??null}function S0(t){const e=ng(t);if(!e)return{from:ll(),to:ll(),progress01:1,next:null};const a=na.indexOf(e),o=a>0?na[a-1].trophies:0,n=e.trophies-o,s=n>0?Math.min(1,Math.max(0,(t-o)/n)):0;return{from:o,to:e.trophies,progress01:s,next:e}}function A0(t,e){const a=jl();switch(t.type){case"coins":a.coins+=t.amount;break;case"gems":a.gems+=t.amount;break;case"container":a.containers[t.kind]=(a.containers[t.kind]??0)+t.count;break;case"character":a.coins+=E0(t.id);break;case"bundle":for(const o of t.parts)k0(a,A0(o));break}return a}function hl(t,e){switch(t.type){case"coins":return{emoji:"🪙",title:`${t.amount.toLocaleString()} Coins`,isCharacter:!1};case"gems":return{emoji:"💎",title:`${t.amount.toLocaleString()} Gems`,isCharacter:!1};case"container":{const a=Pe[t.kind];return{emoji:a.emoji,title:t.count>1?`${t.count} ${Ss(a.name,t.count)}`:a.name,isCharacter:!1}}case"character":{const a=re[t.id],o=Wm;return{emoji:a.emoji,title:a.name,isCharacter:!0,payoutNote:o?void 0:`owned · 🪙 ${E0(t.id).toLocaleString()}`}}case"bundle":return{emoji:"🎉",title:"Grand Prize",isCharacter:!1}}}function sg(t,e){const a=Ra(e);if(a>=Jr)return null;const o=a-io,n=on.baseCoins*Math.pow(on.growth,o)*on.rarityCostMultiplier[re[t].rarity];return{coins:Math.round(n/on.roundTo)*on.roundTo,gems:0}}function R0(t){return Ra(t)}function ig(){return v0}function rg(t){return new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}).format(t/100)}function tc(t){return t.priceUsdCents>0?t.gems/(t.priceUsdCents/100):0}function lg(t){const e=v0.filter(n=>!n.oneTime&&n.gems>0),a=e.reduce((n,s)=>s.priceUsdCents<n.priceUsdCents?s:n,e[0]);if(!a||t.id===a.id)return 0;const o=tc(t)/tc(a);return Math.max(0,Math.round((o-1)*100))}function I0(){const t={};for(const e of ra)t[e]=0;return t}function C0(t=Xm()){return{trophies:0,bestTrophies:0,coins:ec.coins,gems:ec.gems,containers:I0(),claimed:[],unlocked:[y0],winsTowardChest:0,lastMatch:null,levels:{},seed:t,rolls:0}}function Wl(t){return new Set(Ee)}function hg(t,e){return!0}function F0(t,e){t.coins+=e.coins,t.gems+=e.gems;for(const[a,o]of Object.entries(e.containers))t.containers[a]=(t.containers[a]??0)+(o??0);for(const a of e.characters)t.unlocked.includes(a)||t.unlocked.push(a)}function cl(t,e,a){return t.coins<e||t.gems<a?!1:(t.coins-=e,t.gems-=a,!0)}function cg(t,e,a){const o=eg(e,a,t.trophies);t.trophies=Math.max(0,t.trophies+o),t.bestTrophies=Math.max(t.bestTrophies,t.trophies);const n=tg(e,a);t.coins+=n;let s=0;if(ag(e,a)){for(t.winsTowardChest++;t.winsTowardChest>=ct.winsPerChest;)t.winsTowardChest-=ct.winsPerChest,s++;t.containers.chest+=s}const i={won:e===0,trophies:o,coins:n,chests:s,place:e,seats:a,seen:!1};return t.lastMatch=i,i}function dg(t){return Math.max(0,ct.winsPerChest-t.winsTowardChest)}function O0(t){return T0(t.trophies,t.claimed)}function N0(t,e){const a=T0(t.trophies,t.claimed).find(n=>n.trophies===e);if(!a)return null;const o=A0(a.reward,Wl());return t.claimed.push(e),t.claimed.sort((n,s)=>n-s),F0(t,o),o}function pg(t){const e=jl();for(const a of O0(t)){const o=N0(t,a.trophies);o&&k0(e,o)}return e}function ug(t,e){if((t.containers[e]??0)<=0)return null;t.containers[e]--;const a=Vm(t.seed+t.rolls);t.rolls++;const o=Jm(e,a,Wl());return F0(t,o.reward),o}function fg(t){return ra.reduce((e,a)=>e+(t.containers[a]??0),0)}function mg(t,e,a){const o=Pe[e].price;return!o||!(a==="coins"?cl(t,o.coins,0):cl(t,0,o.gems))?!1:(t.containers[e]++,!0)}function Yl(t,e){return Ra(t.levels[e]??io)}function Vl(t,e){return sg(e,Yl(t,e))}function gg(t,e){const a=Vl(t,e);return a!==null&&t.coins>=a.coins&&t.gems>=a.gems}function wg(t,e){const a=Vl(t,e);if(!a||!cl(t,a.coins,a.gems))return null;const o=Ra(Yl(t,e)+1);return t.levels[e]=o,{level:o,spent:a}}function bg(t){const e=C0();if(!t||typeof t!="object")return e;const a=t,o=(s,i)=>typeof s=="number"&&Number.isFinite(s)&&s>=0?Math.floor(s):i,n={trophies:o(a.trophies,0),bestTrophies:o(a.bestTrophies,0),coins:o(a.coins,e.coins),gems:o(a.gems,e.gems),containers:I0(),claimed:[],unlocked:[y0],winsTowardChest:o(a.winsTowardChest,0),lastMatch:null,levels:{},seed:o(a.seed,e.seed)||e.seed,rolls:o(a.rolls,0)};if(a.containers&&typeof a.containers=="object"){const s=a.containers;for(const i of ra)n.containers[i]=o(s[i],0)}if(Array.isArray(a.claimed)){const s=new Set(na.map(r=>r.trophies)),i=new Set(a.claimed.filter(r=>typeof r=="number"&&s.has(r)));n.claimed=[...i].sort((r,l)=>r-l)}if(Array.isArray(a.unlocked))for(const s of a.unlocked)typeof s=="string"&&Ee.includes(s)&&!n.unlocked.includes(s)&&n.unlocked.push(s);if(a.levels&&typeof a.levels=="object"){const s=a.levels;for(const i of Ee){const r=s[i];if(typeof r!="number"||!Number.isFinite(r))continue;const l=Ra(r);l>io&&(n.levels[i]=l)}}if(a.lastMatch&&typeof a.lastMatch=="object"){const s=a.lastMatch,i=s.won===!0,r=Number.isInteger(s.seats)&&s.seats>=nt&&s.seats<=Ht?s.seats:nt,l=Number.isInteger(s.place)&&s.place>=0&&s.place<r?s.place:i?0:r-1;n.lastMatch={won:l===0,trophies:typeof s.trophies=="number"&&Number.isFinite(s.trophies)?Math.trunc(s.trophies):0,coins:o(s.coins,0),chests:o(s.chests,0),place:l,seats:r,seen:s.seen===!0}}return n.bestTrophies=Math.max(n.bestTrophies,n.trophies),n}function yg(t){return{trophies:t.trophies,bestTrophies:t.bestTrophies,coins:t.coins,gems:t.gems,containers:{...t.containers},claimed:[...t.claimed],unlocked:[...t.unlocked],winsTowardChest:t.winsTowardChest,lastMatch:t.lastMatch?{...t.lastMatch}:null,levels:{...t.levels},seed:t.seed,rolls:t.rolls}}function xg(t,e){typeof e.coins=="number"&&Number.isFinite(e.coins)&&e.coins>=0&&(t.coins=Math.floor(e.coins)),typeof e.gems=="number"&&Number.isFinite(e.gems)&&e.gems>=0&&(t.gems=Math.floor(e.gems))}const L0="food-arena.profile.v1",xn=250,ac=100,vg=35;function D0(t,e){const a=Gl(fi(t,e));return Math.round(ac-a*(ac-vg))}const dl="Chef",pl=16;function z0(t){if(typeof t!="string")return dl;const e=t.replace(/\s+/g," ").replace(/[\p{Cc}\p{Cf}]/gu,"").trim().slice(0,pl).trim();return e.length>0?e:dl}function kg(t){return typeof t=="string"&&Ee.includes(t)}function Pi(t,e){return typeof t=="number"&&Number.isFinite(t)&&t>=0?t:e}function oc(){return{name:dl,wins:0,losses:0,xp:0,selected:Ee[0],economy:C0()}}function nc(){try{const t=localStorage.getItem(L0);if(!t)return oc();const e=JSON.parse(t),a=bg(e.economy);return e.economy===void 0&&xg(a,e),{name:z0(e.name),wins:Math.floor(Pi(e.wins,0)),losses:Math.floor(Pi(e.losses,0)),xp:Math.floor(Pi(e.xp,0)),selected:kg(e.selected)?e.selected:Ee[0],economy:a}}catch{return oc()}}class H0{data;listeners=new Set;constructor(e){this.data=e?{...nc(),...e}:nc()}get name(){return this.data.name}get wins(){return this.data.wins}get losses(){return this.data.losses}get xp(){return this.data.xp}get selected(){return this.data.selected}get level(){return Math.floor(this.data.xp/xn)+1}get levelProgress01(){return this.data.xp%xn/xn}get economy(){return this.data.economy}get coins(){return this.data.economy.coins}get gems(){return this.data.economy.gems}get trophies(){return this.data.economy.trophies}get bestTrophies(){return this.data.economy.bestTrophies}get containers(){return this.data.economy.containers}get containerCount(){return fg(this.data.economy)}get winsToNextChest(){return dg(this.data.economy)}get lastMatch(){return this.data.economy.lastMatch}get unlocked(){return Wl(this.data.economy)}isUnlocked(e){return hg(this.data.economy)}get claimable(){return O0(this.data.economy)}select(e){this.data.selected!==e&&(this.data.selected=e,this.commit())}setName(e){const a=z0(e);return a===this.data.name||(this.data.name=a,this.commit()),a}recordPlacement(e,a){const o=cg(this.data.economy,e,a);return o.won?this.data.wins++:this.data.losses++,this.data.xp+=D0(e,a),this.commit(),o}recordResult(e){return this.recordPlacement(e?0:1,nt)}markLastMatchSeen(){const e=this.data.economy.lastMatch;!e||e.seen||(e.seen=!0,this.commit())}claimMilestone(e){const a=N0(this.data.economy,e);return a&&this.commit(),a}claimAllMilestones(){const e=pg(this.data.economy);return this.commit(),e}openContainer(e){const a=ug(this.data.economy,e);return a&&this.commit(),a}buyContainer(e,a){const o=mg(this.data.economy,e,a);return o&&this.commit(),o}characterLevel(e){return Yl(this.data.economy,e)}nextLevelPrice(e){return Vl(this.data.economy,e)}canLevelUp(e){return gg(this.data.economy,e)}levelUp(e){const a=wg(this.data.economy,e);return a&&this.commit(),a}onChange(e){return this.listeners.add(e),()=>this.listeners.delete(e)}commit(){try{localStorage.setItem(L0,JSON.stringify({name:this.data.name,wins:this.data.wins,losses:this.data.losses,xp:this.data.xp,selected:this.data.selected,economy:yg(this.data.economy)}))}catch{}for(const e of this.listeners)e()}}const Mg="fa-screen-styles";function la(t,e){if(document.getElementById(t))return;const a=document.createElement("style");a.id=t,a.textContent=e,document.head.appendChild(a)}function Eg(){la(Mg,Tg)}function _0(t,e){const a=t.replace("#",""),o=a.length===3?a.split("").map(r=>r+r).join(""):a,n=parseInt(o.slice(0,2),16)||0,s=parseInt(o.slice(2,4),16)||0,i=parseInt(o.slice(4,6),16)||0;return`rgba(${n},${s},${i},${e})`}const Tg=`
:root {
...
`,Sg=3101286,P0="#2f5266",Ag="#2E4E60",Rg="#284053",sc="#3F5462",Ig="#6D8290",Cg="#9FB1BE",nn=5,sn=14,$i=-.6,Fg=[[-.6,.86],[0,.88],[1.2,.94],[2.6,1.02],[3.8,1.16],[8,1.4],[14,1.55]],ic=1.3,Og=.52,rc=new de(16.35,9.82,4.69).normalize(),Ng=[[0,.58],[1.5,.62],[2.6,.88],[3.8,1.16],[4.7,1.36],[6.4,1.42]],rn=.24,ln=.215,lc=.62,Lg=2.48,Dg=.86;function hc(t,e){if(e<=t[0][0])return t[0][1];const a=t[t.length-1];if(e>=a[0])return a[1];for(let o=1;o<t.length;o++){const[n,s]=t[o],[i,r]=t[o-1];if(e>n)continue;const l=(e-i)/Math.max(1e-6,n-i);return r+(s-r)*(l*l*(3-2*l))}return a[1]}function zg(t,e=128){const a=document.createElement("canvas");a.width=e,a.height=e;const o=a.getContext("2d");if(o){const s=o.createRadialGradient(e/2,e/2,0,e/2,e/2,e/2),[i,r,l]=t,h=c=>`rgb(${Math.round(i+(255-i)*c)},${Math.round(r+(255-r)*c)},${Math.round(l+(255-l)*c)})`;s.addColorStop(0,h(0)),s.addColorStop(.54,h(.1)),s.addColorStop(.8,h(.58)),s.addColorStop(1,"rgb(255,255,255)"),o.fillStyle=s,o.fillRect(0,0,e,e)}const n=new et(a);return n.colorSpace=qf,n.wrapS=tl,n.wrapT=tl,n}function cc(t,e,a){const o=new V({map:zg(e),blending:r0,blendEquation:Ds,blendSrc:Wh,blendDst:Bf,blendEquationAlpha:Ds,blendSrcAlpha:Wh,blendDstAlpha:el,transparent:!0,depthWrite:!1,toneMapped:!1}),n=new E(new to(t,t),o);return n.rotation.x=-Math.PI/2,n.renderOrder=a,n.userData.noOutline=!0,n}const Zt={counterBody:"#123A50",counterTop:"#A8641F",counterLip:"#D08A2E",shelf:"#7A431A",steel:"#24485C",jars:["#B02733","#4E8A12","#C99414","#1668A8","#6B3AA8","#B85A18","#2E8C6A","#C4553C"]};class Ps{stage;holder=document.createElement("div");model=null;currentId=null;subjectW=J*.8;subjectH=J;elapsed=0;introT=0;observer=null;footShadow=null;disposed=!1;dressing=null;constructor(){this.holder.style.cssText="position:absolute;inset:0;",this.stage=new Dl({container:this.holder,background:Sg,fog:null,camera:{pitchDeg:20,yawDeg:0,frameMode:"subject",subjectHeight:J,subjectFill:.6,targetHeight:J*.52,followLerp:1},budget:"menu",maxPixelRatio:2}),this.stage.canvas.style.cssText="display:block;width:100%;height:100%;",this.buildSet(),this.stage.rig.snapTo(0,0),this.stage.lighting.focus(0,0,6)}buildSet(){const e=new Me(nn,nn,sn,72,28,!0);this.paintVertexRamp(e,(m,g,w)=>{const b=W.clamp(-(m*rc.x+w*rc.z)/nn,0,1);return hc(Fg,g+sn/2+$i)*(ic+(Og-ic)*b)});const a=Ve({color:Ag,ramp:at(),roughness:.9,rim:!1});a.side=Gh,a.vertexColors=!0;const o=new E(e,a);o.position.y=sn/2+$i,o.receiveShadow=!0,o.userData.noOutline=!0,o.name="menu_wall",o.renderOrder=-1,this.stage.scene.add(o);const n=new Ma(0,6.4,96,32);this.paintVertexRamp(n,(m,g)=>hc(Ng,Math.hypot(m,g)));const s=Ve({color:Rg,ramp:at(),roughness:.86,rim:!1});s.vertexColors=!0;const i=new E(n,s);i.rotation.x=-Math.PI/2,i.receiveShadow=!0,i.userData.noOutline=!0,i.name="menu_ground",this.stage.scene.add(i);const r=cc(5.4,[18,32,160],1);r.position.y=.012,r.name="menu_ground_decal",this.stage.scene.add(r);const l=new E(new Me(1.15,1.24,.18,48),Ve({color:sc,ramp:at(),roughness:.72}));l.position.y=.09,l.castShadow=!0,l.receiveShadow=!0,l.userData.noOutline=!0,l.name="menu_plinth_body",this.stage.scene.add(l);const h=Ve({color:Ig,ramp:at(),roughness:.55}),c=new E(new Me(1.21,1.19,.06,48,1,!0),h);c.position.y=rn-.03,c.castShadow=!0,c.receiveShadow=!0,c.userData.noOutline=!0,c.name="menu_plinth_rim",this.stage.scene.add(c);const d=new E(new Ma(1.1,1.21,48),h);d.rotation.x=-Math.PI/2,d.position.y=rn,d.receiveShadow=!0,d.userData.noOutline=!0,d.name="menu_plinth_rim_top",this.stage.scene.add(d);const p=new E(new Me(1.1,1.1,rn-ln,48,1,!0),Ve({color:sc,ramp:at(),roughness:.8,doubleSide:!0}));p.position.y=(rn+ln)/2,p.receiveShadow=!0,p.userData.noOutline=!0,p.name="menu_plinth_recess",this.stage.scene.add(p);const u=new E(new Me(1.1,1.1,.05,48),Ve({color:Cg,ramp:at(),roughness:.45}));u.position.y=ln-.025,u.receiveShadow=!0,u.userData.noOutline=!0,u.name="menu_plinth_top",this.stage.scene.add(u);const f=cc(1.9,[58,64,72],2);f.position.y=ln+.004,f.scale.set(1,1,.72),f.name="menu_foot_decal",this.footShadow=f,this.stage.scene.add(f)}paintVertexRamp(e,a){const o=e.attributes.position,n=new Float32Array(o.count*3);for(let s=0;s<o.count;s++){const i=a(o.getX(s),o.getY(s),o.getZ(s));n[s*3]=i,n[s*3+1]=i,n[s*3+2]=i}e.setAttribute("color",new En(n,3))}applyFraming(){const e=this.stage.rig.camera,a=e.aspect>0&&Number.isFinite(e.aspect)?e.aspect:1,o=Math.max(.5,this.subjectH)+rn,n=Math.max(.5,this.subjectW,Lg),s=Dg*a*o/n;this.stage.rig.subjectHeight=o,this.stage.rig.subjectFill=W.clamp(Math.min(lc,s),.2,lc),this.stage.rig.targetHeight=o*.5,this.stage.rig.apply()}static floorGridTexture(e=256){const a=document.createElement("canvas");a.width=e,a.height=e;const o=a.getContext("2d");o&&(o.clearRect(0,0,e,e),o.strokeStyle="rgba(0,0,0,0.55)",o.lineWidth=e*.055,o.strokeRect(0,0,e,e));const n=new et(a);return n.wrapS=Qr,n.wrapT=Qr,n.repeat.set(22,22),n.colorSpace=ri,n}buildDressing(){const e=new ie;e.name="lobby_dressing";const a=(f,m=!1)=>(f.castShadow=m,f.receiveShadow=!0,f.userData.noOutline=!0,e.add(f),f),o=-3.35,n=7.2,s=.78,i=new E(new to(13,13),new V({map:Ps.floorGridTexture(),transparent:!0,depthWrite:!1,toneMapped:!1}));i.rotation.x=-Math.PI/2,i.position.y=.006,i.renderOrder=0,i.userData.noOutline=!0,i.name="lobby_floor_grid",e.add(i);const r=Ps.floorGridTexture();r.repeat.set(26,9);const l=new E(new Me(nn-.04,nn-.04,sn,72,1,!0),new V({map:r,side:Gh,transparent:!0,depthWrite:!1,toneMapped:!1}));l.position.y=sn/2+$i,l.renderOrder=0,l.userData.noOutline=!0,l.name="lobby_wall_grid",e.add(l),a(new E(new Rt(n,s,.72),Ve({color:Zt.counterBody,ramp:at(),roughness:.8})),!0).position.set(0,s/2,o),a(new E(new Rt(n+.12,.11,.84),Ve({color:Zt.counterTop,ramp:at(),roughness:.5}))).position.set(0,s+.055,o),a(new E(new Rt(n+.12,.045,.06),Ve({color:Zt.counterLip,ramp:at(),roughness:.4}))).position.set(0,s+.012,o+.44),a(new E(new Rt(n-.4,.13,.52),Ve({color:Zt.shelf,ramp:at(),roughness:.75}))).position.set(0,2.15,o-.05);for(const f of[-2.6,2.6])a(new E(new Rt(.1,.36,.1),Ve({color:Zt.steel,ramp:at(),roughness:.7}))).position.set(f,2.31,o-.2);const h=new Me(.19,.21,.44,20),c=new Me(.21,.21,.07,20),d=Ve({color:Zt.steel,ramp:at(),roughness:.45}),p=[-2.95,-2.25,-1.55,1.55,2.25,2.95,-2.6,2.6],u=[2.35,2.35,2.35,2.35,2.35,2.35,.9,.9];for(let f=0;f<p.length;f++){const m=.86+f*37%5*.09,g=u[f]+.22*m;a(new E(h,Ve({color:Zt.jars[f],ramp:at(),roughness:.55}))).position.set(p[f],g,o-.02),e.children[e.children.length-1].scale.setScalar(m),a(new E(c,d)).position.set(p[f],g+.25*m,o-.02),e.children[e.children.length-1].scale.setScalar(m)}for(const f of[-1.95,1.95])a(new E(new Me(.4,.36,.46,24),Ve({color:Zt.steel,ramp:at(),roughness:.35}))).position.set(f,s+.34,o-.02),a(new E(new Me(.44,.44,.06,24),Ve({color:Zt.counterLip,ramp:at(),roughness:.3}))).position.set(f,s+.6,o-.02);return e}setScene(e){this.disposed||(e==="lobby"&&!this.dressing&&(this.dressing=this.buildDressing(),this.stage.scene.add(this.dressing)),this.dressing&&(this.dressing.visible=e==="lobby"))}attachTo(e){this.disposed||(this.holder.parentElement!==e&&e.appendChild(this.holder),this.observer?.disconnect(),this.observer=new ResizeObserver(()=>this.resize()),this.observer.observe(e),this.resize())}detach(){this.observer?.disconnect(),this.observer=null,this.holder.remove()}show(e){if(this.disposed||e===this.currentId)return;this.model&&(this.stage.scene.remove(this.model.root),this.model.dispose()),this.model=zl(e),this.model.play("idle"),this.stage.scene.add(this.model.root);const a=new Tn().setFromObject(this.model.root);if(this.subjectH=Math.max(.5,a.max.y-a.min.y),this.subjectW=2*Math.max(.25,Math.abs(a.min.x),Math.abs(a.max.x),Math.abs(a.min.z),Math.abs(a.max.z)),this.model.root.position.y=ln+.005-a.min.y,this.footShadow){const o=W.clamp(Math.max(a.max.x-a.min.x,a.max.z-a.min.z)*1.15,1,2.3);this.footShadow.scale.set(o/1.9,1,o/1.9*.72)}this.currentId=e,this.introT=.34,this.applyFraming()}poke(){this.model?.play("attack")}update(e){if(!this.disposed){if(this.elapsed+=e,this.stage.rig.yawDeg=Math.sin(this.elapsed*.42)*22,this.model){if(this.introT>0){this.introT=Math.max(0,this.introT-e);const a=1-this.introT/.34,o=Math.sin(a*Math.PI)*(1-a*.4);this.model.root.scale.setScalar(1+o*.16),this.model.root.rotation.y=(1-a)*-.9}else this.model.root.scale.setScalar(1),this.model.root.rotation.y=0;this.model.update({dt:e,elapsed:this.elapsed,moveSpeed01:0,health01:1})}this.stage.render(e)}}resize(){this.disposed||(this.stage.resize(),this.applyFraming())}info(){const e=this.stage.rig.camera,a=this.model?new Tn().setFromObject(this.model.root):null,o=s=>{const i=s.clone().project(e);return{x:+(i.x*.5+.5).toFixed(3),y:+(1-(i.y*.5+.5)).toFixed(3)}},n=this.stage.rig;return{id:this.currentId,aspect:+e.aspect.toFixed(3),fill:+n.subjectFill.toFixed(3),subject:{w:+this.subjectW.toFixed(2),h:+this.subjectH.toFixed(2)},cameraOk:Number.isFinite(e.position.x)&&Number.isFinite(e.position.y),feet:a?o(new de(0,a.min.y,0)):null,crown:a?o(new de(0,a.max.y,0)):null,left:a?o(new de(a.min.x,(a.min.y+a.max.y)/2,0)):null,right:a?o(new de(a.max.x,(a.min.y+a.max.y)/2,0)):null}}dispose(){if(!this.disposed){if(this.disposed=!0,this.observer?.disconnect(),this.observer=null,this.dressing){const e=new Set,a=new Set;this.dressing.traverse(o=>{const n=o;if(n.geometry&&e.add(n.geometry),n.material)for(const s of Array.isArray(n.material)?n.material:[n.material])a.add(s)}),e.forEach(o=>o.dispose()),a.forEach(o=>o.dispose()),this.stage.scene.remove(this.dressing),this.dressing=null}this.model&&(this.stage.scene.remove(this.model.root),this.model.dispose(),this.model=null),this.stage.dispose(),this.holder.remove()}}}let So=null;function Kl(){return So||(So=new Ps,typeof window<"u"&&(window.__charStage=()=>So?.info()??null)),So}function dc(){So?.dispose(),So=null}const Bi=1e-4,Hg=2e4;function Xl(t){let e=t|0||2654435769;return()=>(e^=e<<13,e^=e>>>17,e^=e<<5,(e>>>0)/4294967296)}function be(t,e,a){return e+t()*(a-e)}function ne(t,e){return Math.pow(2,be(t,-e,e)/1200)}const pc=new WeakMap;function _g(t){const e=pc.get(t);if(e)return e;const a=Math.floor(t.sampleRate*2),o=t.createBuffer(1,a,t.sampleRate),n=o.getChannelData(0),s=Xl(6221086);for(let i=0;i<a;i++)n[i]=s()*2-1;return pc.set(t,o),o}const uc=new WeakMap;function Pg(t,e){let a=uc.get(t);a||(a=new Map,uc.set(t,a));const o=Math.max(.05,Math.round(e*20)/20),n=a.get(o);if(n)return n;const s=1024,i=new Float32Array(s),r=Math.tanh(o);for(let l=0;l<s;l++){const h=l/(s-1)*2-1;i[l]=Math.tanh(o*h)/r}return a.set(o,i),i}function $0(t,e){const a=t.createWaveShaper();return a.curve=Pg(t,e),a.oversample="2x",a}const $g=.26,Bg=.19,fc=new WeakMap;function qg(t){const e=fc.get(t);if(e)return e;const a=t.sampleRate,o=Math.floor(a*$g),n=t.createBuffer(2,o,a),s=Math.floor(a*.005),i=6.9078/(Bg*a);for(let h=0;h<2;h++){const c=n.getChannelData(h),d=Xl(h===0?1990433:7840721);let p=0;for(let f=s;f<o;f++){const m=f-s,g=.3+.42*(m/(o-s)),w=d()*2-1;p=p*g+w*(1-g),c[f]=p*Math.exp(-i*m)}const u=h===0?[.0071,.0132,.0198,.0281,.0367,.0458]:[.0083,.0119,.0214,.0263,.0389,.0441];for(let f=0;f<u.length;f++){const m=s+Math.floor(u[f]*a);if(m>=o)continue;const g=f%2===0?1:-1;c[m]+=g*.62*Math.exp(-i*(m-s)*.55)}}let r=0;for(let h=0;h<2;h++){const c=n.getChannelData(h);for(let d=0;d<o;d++)r=Math.max(r,Math.abs(c[d]))}const l=r>0?.6/r:1;for(let h=0;h<2;h++){const c=n.getChannelData(h);for(let d=0;d<o;d++)c[d]*=l}return fc.set(t,n),n}function Ug(t){const e=t.createConvolver();return e.normalize=!1,e.buffer=qg(t),e}function B0(t,e,a){if(!t.wet||!(a>0))return;const o=t.ctx.createGain();o.gain.value=a,e.connect(o),o.connect(t.wet)}function q0(t,e,a){const o=t.createGain(),n=Math.max(5e-4,a.attack??.002),s=(a.duration-n)*Math.max(0,Math.min(.9,a.hold??0)),i=Math.max(Bi*2,a.peak),r=e+a.duration;return o.gain.setValueAtTime(Bi,e),o.gain.linearRampToValueAtTime(i,e+n),s>0&&o.gain.setValueAtTime(i,e+n+s),(a.curve??"exp")==="exp"?o.gain.exponentialRampToValueAtTime(Bi,r):o.gain.linearRampToValueAtTime(0,r),o.gain.setValueAtTime(0,r+.001),o}function Ao(t,e,a,o,n="exp"){if(typeof e=="number"){t.setValueAtTime(e,a);return}const[s,i]=e;t.setValueAtTime(s,a),n==="exp"&&s>0&&i>0?t.exponentialRampToValueAtTime(i,a+o):t.linearRampToValueAtTime(i,a+o)}function q(t,e){const{ctx:a,dest:o,when:n}=t,s=a.createBufferSource(),i=_g(a);s.buffer=i,s.playbackRate.value=e.rate??1,e.loop&&(s.loop=!0,s.loopStart=0,s.loopEnd=i.duration);const r=Math.max(0,i.duration-(e.duration+.02)),l=e.loop?be(t.rng,0,i.duration):be(t.rng,0,Math.min(1.5,r)),h=q0(a,n,e),c=e.tremolo?jg(a,n,e.duration,e.tremolo.rate,e.tremolo.depth):h;c!==h&&c.connect(h);const d=e.drive?$0(a,e.drive):c;if(d!==c&&d.connect(c),e.filter){const p=u=>{const f=a.createBiquadFilter();return f.type=e.filter,f.Q.value=u,Ao(f.frequency,e.freq??1e3,n,e.duration,e.freqCurve??"exp"),f};if(e.poles===24){const u=Math.sqrt(Math.max(.1,e.q??1));s.connect(p(u)).connect(p(u)).connect(d)}else s.connect(p(e.q??1)).connect(d)}else s.connect(d);return h.connect(o),B0(t,h,e.wet??0),s.start(n,l,e.duration+.02),s.stop(n+e.duration+.02),e.duration}function X(t,e){const{ctx:a,dest:o,when:n}=t,s=q0(a,n,e);let i=s;if(e.ring!==void 0){const h=a.createGain();h.gain.value=0;const c=a.createOscillator();c.type="sine",Ao(c.frequency,e.ring,n,e.duration,"exp"),c.connect(h.gain),c.start(n),c.stop(n+e.duration+.02),h.connect(s),i=h}if(e.drive){const h=$0(a,e.drive);h.connect(i),i=h}if(e.lowpass!==void 0){const h=a.createBiquadFilter();h.type="lowpass",h.Q.value=.7,Ao(h.frequency,e.lowpass,n,e.duration),h.connect(i),i=h}const r=Math.max(1,Math.min(3,Math.round(e.voices??1))),l=e.detuneCents??0;for(let h=0;h<r;h++){const c=a.createOscillator();c.type=e.type??"sine";const d=r===1?0:(h/(r-1)-.5)*l,p=Math.pow(2,d/1200);if(typeof e.freq=="number"?Ao(c.frequency,e.freq*p,n,e.duration,e.freqCurve??"exp"):Ao(c.frequency,[e.freq[0]*p,e.freq[1]*p],n,e.duration,e.freqCurve??"exp"),r>1){const u=a.createGain();u.gain.value=1/r,c.connect(u).connect(i)}else c.connect(i);c.start(n),c.stop(n+e.duration+.02)}return s.connect(o),B0(t,s,e.wet??0),e.duration}function mi(t,e){let a=0;for(const o of e.modes){const n=e.duration*o.decay,s=typeof e.freq=="number"?e.freq*o.ratio:[e.freq[0]*o.ratio,e.freq[1]*o.ratio];(typeof s=="number"?s:Math.max(s[0],s[1]))>Hg||(a=Math.max(a,n),X(t,{type:"sine",freq:s,peak:e.peak*o.gain,attack:e.attack??.0015,duration:n,drive:e.drive,wet:e.wet}))}return a}function jg(t,e,a,o,n){const s=Math.max(0,Math.min(1,n)),i=t.createGain();i.gain.value=1-s*.5;const r=t.createOscillator();r.type="sine",Ao(r.frequency,o,e,a,"lin");const l=t.createGain();return l.gain.value=s*.5,r.connect(l),l.connect(i.gain),r.start(e),r.stop(e+a+.02),i}function ve(t,e){const a=e.freq??5e3,o=q(t,{filter:"highpass",freq:a,q:.9,peak:e.peak,attack:4e-4,duration:.007,wet:e.wet??.06});if(!e.snap)return o;const n=(e.snapMs??14)/1e3,s=X(t,{type:"triangle",freq:[e.snap,e.snap*.38],peak:e.peak*.72,attack:6e-4,duration:n,drive:2.2,wet:e.wet??.06});return G(o,s)}function ze(t,e){const[a,o]=e.grainMs??[4,11],n=e.decay??.35,s=e.freqShift;for(let i=0;i<e.count;i++){const r=Math.pow(t.rng(),1.5)*e.spread,l=be(t.rng,a,o)/1e3,h=e.peak*(1-r/e.spread*(1-n))*be(t.rng,.55,1),c=s?s[0]+(s[1]-s[0])*(r/e.spread):1;q({...t,when:t.when+r},{filter:"bandpass",freq:be(t.rng,e.freq[0],e.freq[1])*c,q:e.q??6,peak:h,attack:8e-4,duration:l,drive:e.drive,wet:e.wet})}return e.spread+o/1e3}function gn(t,e){const a=e.rise??2.6;let o=0;for(let n=0;n<e.count;n++){const s=be(t.rng,0,e.spread),i=be(t.rng,e.freq[0],e.freq[1]),r=be(t.rng,.045,.095);o=Math.max(o,s+r),X({...t,when:t.when+s},{type:"sine",freq:[i,i*a],peak:e.peak*be(t.rng,.5,1),attack:.002,duration:r,wet:e.wet})}return o}function $s(t,e){const[a,o]=e.pingMs??[7,18],n=e.bend??.92,s=Math.log2(e.freq[0]),i=Math.log2(e.freq[1]);let r=0;for(let l=0;l<e.count;l++){const h=Math.pow(t.rng(),1.6)*e.spread,c=Math.pow(2,s+(t.rng()+l*.6180339887)%1*(i-s)),d=be(t.rng,a,o)/1e3;r=Math.max(r,h+d),X({...t,when:t.when+h},{type:"sine",freq:[c,c*n],peak:e.peak*be(t.rng,.55,1),attack:6e-4,duration:d,wet:e.wet})}return r}function Zl(t,e){const[a,o]=e.freq??[9e3,3200],n=e.duration??.11,s=e.wet??.3,i=q(t,{filter:"bandpass",freq:[a*ne(t.rng,90),o*ne(t.rng,90)],q:.7,peak:e.peak,attack:.0012,duration:n,wet:s}),r=q(t,{filter:"highpass",poles:24,freq:[a*.8,a*.45],q:.7,peak:e.peak*.55,attack:6e-4,duration:n*.55,wet:s}),l=e.drops??6,h=l>0?ze(t,{count:l,spread:n*.85,grainMs:[3,9],freq:[o,a],q:5,peak:e.peak*.85,decay:.25,wet:s}):0;return G(i,r,h)}function G(...t){let e=0;for(const a of t)a>e&&(e=a);return e}const mc="fa.audio.volume",gc="fa.audio.muted",Gg=.62,Wg=20,Yg=.008,Ke={Ambient:0,Normal:1,Critical:2},Vg=.11,wc=[1,.62,.42,.3,.22],Kg=.5,hn=.7,bc=1.2,U0=3,yc=new WeakMap;function Xg(t){const e=yc.get(t);if(e)return e;const a=2048,o=new Float32Array(a);for(let n=0;n<a;n++){const s=(n/(a-1)*2-1)*U0,i=Math.abs(s),r=i<=hn?i:hn+(bc-hn)*Math.tanh((i-hn)/(bc-hn));o[n]=Math.sign(s)*r}return yc.set(t,o),o}function Zg(t,e,a=!0){const o=t.createGain();o.gain.value=1;let n=null;if(a)try{n=t.createGain(),n.gain.value=1;const l=t.createGain();l.gain.value=Kg,n.connect(Ug(t)).connect(l).connect(o)}catch{n=null}const s=t.createGain();s.gain.value=1/U0;const i=t.createWaveShaper();i.curve=Xg(t),i.oversample="2x";const r=t.createGain();return r.gain.value=0,o.connect(s).connect(i).connect(r).connect(e??t.destination),{input:o,wetIn:n,limiter:i,master:r}}function Jg(t){const e=Math.max(0,Math.min(1,t));return Math.pow(e,1.8)*Gg}function Qg(){const t=typeof navigator<"u"?navigator.userActivation:void 0;return t===void 0||t.isActive===!0}class ew{ctx=null;chain=null;state="idle";failure=null;volume=.8;muted=!1;maxVoices;persist;reverb;injected;injectedDestination;offline;voices=[];retrigger=new Map;listeners=new Set;virtualTime=0;counters={started:0,droppedBudget:0,droppedThrottle:0,droppedNotRunning:0};analyser=null;gestureBound=!1;constructor(e={}){this.maxVoices=e.maxVoices??Wg,this.persist=e.persist??!0,this.reverb=e.reverb??!0,this.injected=e.context??null,this.injectedDestination=e.destination??null,this.offline=!!this.injected&&typeof OfflineAudioContext<"u"&&this.injected instanceof OfflineAudioContext,this.loadSettings(),this.injected?(this.attachContext(this.injected),this.offline&&(this.state="running")):(this.bindGestureUnlock(),this.bindVisibility())}setVolume(e){this.volume=Math.max(0,Math.min(1,Number.isFinite(e)?e:0)),this.applyMasterGain(.02),this.saveSettings(),this.emit()}getVolume(){return this.volume}setMuted(e){this.muted=!!e,this.applyMasterGain(.015),this.saveSettings(),this.emit()}isMuted(){return this.muted}toggleMuted(){return this.setMuted(!this.muted),this.muted}onChange(e){return this.listeners.add(e),()=>this.listeners.delete(e)}getState(){return this.state}getFailure(){return this.failure}activeVoices(){return this.prune(this.now()),this.voices.length}unlock(){if(this.state==="failed"||this.offline||!this.ctx&&!Qg())return;const e=this.ensureContext();e&&(typeof e.resume=="function"&&e.state!=="running"&&e.resume().then(()=>this.syncState(),()=>this.syncState()),this.syncState())}bindGestureUnlock(){if(this.gestureBound||typeof window>"u")return;this.gestureBound=!0;const e=["pointerdown","touchend","keydown","click"],a=()=>{if(this.unlock(),this.state==="running"||this.state==="failed")for(const o of e)window.removeEventListener(o,a,!0)};for(const o of e)window.addEventListener(o,a,!0)}bindVisibility(){typeof document>"u"||document.addEventListener("visibilitychange",()=>{const e=this.ctx;if(!(!e||typeof e.suspend!="function")){try{document.hidden?e.suspend().catch(()=>{}):this.state!=="idle"&&e.resume().catch(()=>{})}catch{}this.syncState()}})}ensureContext(){if(this.ctx)return this.ctx;if(this.state==="failed")return null;try{const e=typeof AudioContext<"u"?AudioContext:globalThis.webkitAudioContext;if(!e)return this.fail("Web Audio API unavailable"),null;const a=new e({latencyHint:"interactive"});return this.attachContext(a),a}catch(e){return this.fail(String(e)),null}}attachContext(e){this.ctx=e;try{this.chain=Zg(e,this.injectedDestination??void 0,this.reverb),this.applyMasterGain(0),this.syncState()}catch(a){this.fail(String(a))}}syncState(){if(this.state==="failed")return;const e=this.state;this.ctx?this.offline?this.state="running":this.state=this.ctx.state==="running"?"running":"suspended":this.state="idle",e!==this.state&&this.emit()}fail(e){this.state="failed",this.failure=e,console.warn("[audio] disabled:",e),this.emit()}play(e,a={}){try{return this.playInner(e,a)}catch(o){return this.failure||(this.failure=String(o),console.warn("[audio] sound failed:",o)),!1}}playInner(e,a){if(this.state==="failed")return!1;if(this.state!=="running"||!this.ctx||!this.chain)return this.counters.droppedNotRunning++,!1;const o=this.now();this.prune(o);const n=a.priority??Ke.Normal;let s=1,i=1;if(a.key){const y=this.retrigger.get(a.key),k=y&&o-y.at<Vg?y.count+1:0;if(this.retrigger.set(a.key,{at:o,count:k}),k>=wc.length)return this.counters.droppedThrottle++,!1;s=wc[k],i=1+k*.045}if(this.voices.length>=this.maxVoices){if(n<Ke.Critical&&!this.steal(n))return this.counters.droppedBudget++,!1;n>=Ke.Critical&&this.voices.length>=this.maxVoices&&this.steal(Ke.Critical)}const r=this.ctx,l=Math.max(o,r.currentTime)+Yg+(a.delay??0),h=Math.max(0,(a.gain??1)*s),c=r.createGain();c.gain.value=h;const d=a.pan!==void 0&&typeof r.createStereoPanner=="function",p=Math.max(-1,Math.min(1,a.pan??0));let u=c;if(d){const y=r.createStereoPanner();y.pan.value=p,c.connect(y),u=y}u.connect(this.chain.input);let f=null;if(this.chain.wetIn)if(f=r.createGain(),f.gain.value=h,d){const y=r.createStereoPanner();y.pan.value=p,f.connect(y).connect(this.chain.wetIn)}else f.connect(this.chain.wetIn);const m=Xl(a.seed??Math.random()*4294967295|0),g={ctx:r,dest:c,wet:f??void 0,when:l,rng:m};let w=0;try{w=e(g)||0}catch(y){throw c.disconnect(),f?.disconnect(),y}const b=l+w/i+.05;if(this.voices.push({node:c,wet:f,end:b,priority:n}),this.counters.started++,!this.offline){const y=Math.max(30,(b-r.currentTime)*1e3+40);setTimeout(()=>this.prune(this.now()),y)}return!0}steal(e){let a=-1;for(let n=0;n<this.voices.length;n++)if(this.voices[n].priority<e){a=n;break}if(a<0)return!1;const[o]=this.voices.splice(a,1);return this.release(o),!0}prune(e){for(let a=this.voices.length-1;a>=0;a--)if(this.voices[a].end<=e){const[o]=this.voices.splice(a,1);this.release(o)}if(this.retrigger.size>64)for(const[a,o]of this.retrigger)e-o.at>1&&this.retrigger.delete(a)}release(e){try{e.node.gain.cancelScheduledValues(0),e.node.gain.value=0,e.node.disconnect()}catch{}if(e.wet)try{e.wet.gain.cancelScheduledValues(0),e.wet.gain.value=0,e.wet.disconnect()}catch{}}now(){return this.ctx?Math.max(this.ctx.currentTime,this.virtualTime):this.virtualTime}setVirtualTime(e){this.virtualTime=e,this.prune(e)}tap(){if(!this.ctx||!this.chain)return null;if(this.analyser)return this.analyser;try{const e=this.ctx.createAnalyser();return e.fftSize=2048,e.smoothingTimeConstant=0,this.chain.master.connect(e),this.analyser=e,e}catch{return null}}connectTap(e){if(!this.ctx||!this.chain)return!1;try{return this.chain.master.connect(e),!0}catch{return!1}}get context(){return this.ctx}get busInput(){return this.chain?.input??null}applyMasterGain(e){if(!this.chain||!this.ctx)return;const a=this.muted?0:Jg(this.volume),o=this.chain.master.gain;try{if(e>0&&!this.offline){const n=this.ctx.currentTime;o.cancelScheduledValues(n),o.setValueAtTime(o.value,n),o.linearRampToValueAtTime(a,n+e)}else o.cancelScheduledValues(0),o.value=a}catch{o.value=a}}loadSettings(){if(!(!this.persist||typeof localStorage>"u"))try{const e=localStorage.getItem(mc);if(e!==null){const a=Number(e);Number.isFinite(a)&&(this.volume=Math.max(0,Math.min(1,a)))}this.muted=localStorage.getItem(gc)==="1"}catch{}}saveSettings(){if(!(!this.persist||typeof localStorage>"u"))try{localStorage.setItem(mc,String(this.volume)),localStorage.setItem(gc,this.muted?"1":"0")}catch{}}emit(){for(const e of this.listeners)try{e()}catch{}}}const Ce=0;function _e(t){const e=t.fighters;return Array.isArray(e)&&e.length>0?e:[t.player,t.enemy].filter(Boolean)}function Xe(t){return _e(t)[Ce]??t.player}function gt(t,e,a){if(typeof e=="number"){const o=_e(t)[e];if(o)return o}return t[a]}function wn(t,e,a){return gt(t,e.attackerId,g0(a))}function xc(t,e){return gt(t,e.ownerId,e.ownerRole)}function aa(t,e){return typeof t=="number"?t:e==="player"?0:1}function tw(t){return t===0?"player":t===1?"enemy":`slot${t}`}function aw(t){const{seats:e,center:a,eliminated:o,winnerId:n}=t,s=g=>e.find(w=>w.id===g),i=g=>g.maxHp>0?g.hp/g.maxHp:0,r=g=>Math.hypot(g.x-a.x,g.y-a.y),l=(g,w)=>{const b=i(g),y=i(w);if(b!==y)return y-b;const k=r(g),x=r(w);return k!==x?k-x:g.deaths!==w.deaths?g.deaths-w.deaths:g.id-w.id},h=e.filter(g=>g.alive&&g.hp>0).slice().sort(l).map(g=>g.id),c=new Set(h),d=new Map;o.forEach((g,w)=>{s(g)!==void 0&&d.set(g,w)});const p=[...d.keys()].filter(g=>!c.has(g)).sort((g,w)=>{const b=d.get(g)??-1,y=d.get(w)??-1;if(b!==y)return y-b;const k=s(g),x=s(w);return k&&x&&k.deaths!==x.deaths?k.deaths-x.deaths:g-w}),u=new Set([...h,...p]),f=e.filter(g=>!u.has(g.id)).slice().sort((g,w)=>g.deaths!==w.deaths?g.deaths-w.deaths:g.id-w.id).map(g=>g.id),m=[...h,...p,...f];return n!==null&&m[0]!==n&&s(n)!==void 0?[n,...m.filter(g=>g!==n)]:m}function ow(t,e,a){if(!(t>e))return 1;if(t>=a)return 0;const o=a-e,n=(t-e)/o;return 1-n*n*(3-2*n)}const nw=200,sw=900;function Jl(t){return Math.max(0,Math.min(1,(t-2)/16))}function iw(t){const e=Jl(t);return a=>{const o=ne(a.rng,70),n=q(a,{filter:"bandpass",freq:[2600*o,620*o],q:1.1,peak:.26+e*.12,attack:.006,duration:.13,drive:1.5,wet:.14}),s=X(a,{type:"sine",freq:[440*o,170*o],peak:.16+e*.12,attack:.004,duration:.11,drive:1.9,voices:2,detuneCents:14,wet:.1});return G(n,s)}}function rw(t,e){const a=Jl(t),o=Math.min(1,e/180);return n=>{const s=ne(n.rng,55),i=.2+o*.1,r=q(n,{filter:"bandpass",freq:[420*s,(1900-o*600)*s],q:2.2,peak:.44+a*.2,attack:.05+o*.03,hold:.12,duration:i,drive:1.6,wet:.2}),l=X(n,{type:"sawtooth",freq:[200*s,88*s],lowpass:[900,300],peak:.2+a*.12,attack:.02,duration:i*.8,drive:1.8,voices:2,detuneCents:18,wet:.12});return G(r,l)}}function lw(){const t=[523.25,659.25,783.99];return e=>{const a=ne(e.rng,25);t.forEach((n,s)=>{X({...e,when:e.when+s*.06},{type:"triangle",freq:n*a,peak:.2,attack:.012,hold:.2,duration:.3,voices:2,detuneCents:9,wet:.42})});const o=q(e,{filter:"highpass",freq:[3e3,7e3],q:.8,peak:.07,attack:.08,duration:.42,wet:.5});return G(.3+t.length*.06,o)}}function hw(){return t=>{const e=ne(t.rng,30),a=X(t,{type:"sine",freq:[130*e,30*e],peak:.9,attack:.004,hold:.08,duration:.78,drive:3.4,voices:3,detuneCents:22,wet:.3}),o=q(t,{filter:"lowpass",freq:[2200,140],q:1.4,peak:.55,attack:.01,duration:.62,drive:2.2,wet:.34}),n=ve(t,{peak:.62,freq:3e3,snap:1900,snapMs:26}),s=ze(t,{count:10,spread:.42,freq:[900,4200],peak:.16,q:5,wet:.4});return G(a,o,n,s)}}function cw(t){const e=Jl(t);return a=>{const o=ne(a.rng,60),n=ve(a,{peak:.66-e*.14,freq:3900-e*1100,snap:2700-e*800,snapMs:11+e*7}),s=X(a,{type:"sine",freq:[(230-e*80)*o,(62-e*22)*o],peak:.48+e*.34,attack:.0018,duration:.11+e*.22,drive:2+e*1.5,voices:2,detuneCents:16,wet:.16}),i=e>.12?X(a,{type:"sine",freq:[(118-e*38)*o,(44-e*12)*o],peak:.14+e*.38,attack:.004,duration:.1+e*.2,drive:1.5,wet:.1}):0,r=q(a,{filter:"bandpass",freq:[1700*o,470*o],q:1.5,peak:.24+e*.2,attack:.0012,duration:.07+e*.1,drive:1.9,wet:.22}),l=q(a,{filter:"bandpass",freq:[1900,640],q:.9,peak:.05+e*.05,attack:.018,duration:.16+e*.22,wet:.6}),h=Zl(a,{peak:.1+(1-e)*.06,freq:[8600-e*2200,3400-e*900],duration:.06+e*.05,drops:5,wet:.28});return G(n,s,i,r,l,h)}}function dw(t){const e=t<.3;return a=>{const o=ne(a.rng,45),n=be(a.rng,.9,1.15),s=be(a.rng,285,360),i=X(a,{type:"sawtooth",freq:[s*o,s*o*.4],lowpass:[be(a.rng,1180,1620),260],peak:.3,attack:.004,duration:(e?.34:.22)*n,drive:be(a.rng,2.1,2.8),voices:2,detuneCents:20,wet:.18}),r=be(a.rng,830,1150),l=q(a,{filter:"lowpass",poles:24,freq:[r,190],q:.9,peak:.2,attack:.002,duration:.16*n,drive:1.6,wet:.24}),h=ve(a,{peak:.2,freq:3600,wet:.16}),c=ze(a,{count:4,spread:.03,grainMs:[3,8],freq:[be(a.rng,2700,3400),be(a.rng,6e3,9e3)],q:4,peak:.24,decay:.3,wet:.2}),d=Zl(a,{peak:.13,freq:[be(a.rng,7600,9400),be(a.rng,2800,3600)],duration:be(a.rng,.05,.08),drops:5,wet:.26}),p=e?X(a,{type:"sine",freq:[be(a.rng,88,104),32],peak:.55,attack:.006,duration:.3*n,drive:2.6,wet:.16}):0;return G(i,l,h,c,d,p)}}function pw(){return t=>{const e=ne(t.rng,30),a=ve(t,{peak:.2,freq:5400,snap:3800,snapMs:6}),o=X(t,{type:"triangle",freq:[620*e,1560*e],ring:[132,96],peak:.34,attack:.022,duration:.26,wet:.34}),n=X(t,{type:"sine",freq:[1880*e,2520*e],peak:.1,attack:.03,duration:.34,wet:.55});return G(a,o,n)}}function uw(){return t=>{const e=ne(t.rng,40),a=X(t,{type:"sawtooth",freq:[440*e,58*e],lowpass:[2600,240],peak:.42,attack:.006,duration:.6,drive:2.2,voices:2,detuneCents:24,wet:.26}),o=q(t,{filter:"lowpass",freq:[3200,200],q:1.1,peak:.34,attack:.004,duration:.44,drive:1.5,wet:.4}),n=X(t,{type:"sine",freq:[150*e,30*e],peak:.7,attack:.003,duration:.42,drive:3,voices:2,detuneCents:14,wet:.2});return G(a,o,n)}}function fw(){const t=[392,523.25,659.25];return e=>{const a=ne(e.rng,20);return t.forEach((o,n)=>{X({...e,when:e.when+n*.05},{type:"triangle",freq:o*a,peak:.26,attack:.01,duration:.24,voices:2,detuneCents:8,wet:.34})}),.24+t.length*.05}}function mw(){return t=>{const e=q(t,{filter:"lowpass",poles:24,freq:[420,110],q:1.2,peak:.34,attack:.05,duration:.4,drive:2,wet:.35}),a=q(t,{filter:"bandpass",freq:[1400,2600],q:.7,peak:.1,attack:.08,duration:.42,wet:.55});return G(e,a)}}const gw=2.1,j0=1.5,qi=.55;function ww(){return t=>{const e=gw,a={attack:qi,hold:(j0-qi)/(e-qi),duration:e},o=X(t,{type:"sine",freq:118*ne(t.rng,25),peak:.026,voices:3,detuneCents:26,drive:1.6,...a,wet:.25}),n=q(t,{filter:"bandpass",freq:[be(t.rng,900,1500),be(t.rng,1700,2500)],q:.45,peak:.055,loop:!0,tremolo:{rate:[.55,.85],depth:.3},...a,wet:.4}),s=q(t,{filter:"highpass",poles:24,freq:[6400,8200],q:.7,peak:.009,loop:!0,...a,wet:.5}),i=be(t.rng,.3,e-.6),r={...t,when:t.when+i},l=Math.floor(t.rng()*4);let h=0;if(l===0)h=mi(r,{freq:be(t.rng,620,980),duration:.42,peak:.085,attack:.0015,wet:.62,modes:[{ratio:1,gain:1,decay:1},{ratio:2.71,gain:.6,decay:.5},{ratio:4.63,gain:.34,decay:.3}]});else if(l===1){const c=ve(r,{peak:.1,freq:3400,snap:900,snapMs:14,wet:.5}),d=be(t.rng,.11,.19),p=ve({...r,when:r.when+d},{peak:.075,freq:3100,snap:820,snapMs:12,wet:.5});h=G(c,d+p)}else l===2?h=q(r,{filter:"bandpass",freq:[be(t.rng,2800,3600),be(t.rng,5600,7400)],q:.8,peak:.04,attack:.09,duration:.55,wet:.7}):h=$s(r,{count:3,spread:.16,freq:[4200,11e3],peak:.022,pingMs:[8,20],bend:.94,wet:.6});return G(o,n,s,i+h)}}function bw(){return t=>{const e=q(t,{filter:"highpass",freq:[2600,5200],q:.8,peak:.18,attack:.01,duration:.26,wet:.3}),a=ze(t,{count:4,spread:.2,freq:[2500,6e3],peak:.1,q:7,wet:.35});return G(e,a)}}function yw(){return t=>{const e=q(t,{filter:"lowpass",freq:[1400,260],q:3.2,peak:.2,attack:.008,duration:.15,drive:1.8,wet:.2}),a=X(t,{type:"sine",freq:[180,84],peak:.14,duration:.11,drive:2.2,wet:.14});return G(e,a)}}function xw(){return t=>{const e=ne(t.rng,90),a=ve(t,{peak:.26,freq:2400,snap:1200,snapMs:8}),o=X(t,{type:"sine",freq:[150*e,66*e],peak:.22,duration:.09,drive:2,wet:.24});return G(o,a)}}function vw(t){const e=[523.25,587.33,659.25,698.46,783.99],a=e[Math.max(0,Math.min(e.length-1,5-t))];return o=>{const n=X(o,{type:"triangle",freq:a,peak:.34,attack:.004,hold:.25,duration:.16,voices:2,detuneCents:7,wet:.3}),s=q(o,{filter:"highpass",freq:3800,peak:.12,duration:.015,wet:.12});return G(n,s)}}function kw(){const t=[523.25,659.25,1046.5];return e=>{t.forEach((o,n)=>{X({...e,when:e.when+n*.07},{type:"square",freq:o,lowpass:[3200,1800],peak:.22,attack:.006,hold:.3,duration:.34,voices:2,detuneCents:10,wet:.3})});const a=q(e,{filter:"bandpass",freq:[500,4e3],q:.9,peak:.16,attack:.14,duration:.2,wet:.35});return G(.34+t.length*.07,a)}}function Mw(){return t=>{const e=ne(t.rng,18);[587.33,392].forEach((n,s)=>{X({...t,when:t.when+s*.16},{type:"triangle",freq:n*e,peak:.26,attack:.008,hold:.25,duration:.38,voices:2,detuneCents:11,wet:.34})});const a=X(t,{type:"sine",freq:[196*e,98*e],peak:.34,attack:.02,hold:.3,duration:.72,drive:2.2,voices:2,detuneCents:15,wet:.28}),o=q(t,{filter:"bandpass",freq:[2200,620],q:.8,peak:.12,attack:.06,duration:.66,wet:.55});return G(.38+.16,a,o)}}function Ew(t){const e=t?[523.25,659.25,783.99,1046.5]:[659.25,587.33,493.88,392];return a=>(e.forEach((o,n)=>{X({...a,when:a.when+n*.1},{type:t?"square":"sawtooth",freq:o,lowpass:t?[3600,2200]:[1600,500],peak:.24,attack:.008,hold:.3,duration:.4,voices:2,detuneCents:t?9:16,wet:.34})}),.4+e.length*.1)}function Tw(t){const e=t?[523.25,659.25,1046.5]:[587.33,493.88,392],a=.62;return o=>{const n=(r,l)=>(q({...o,when:o.when+r},{filter:"bandpass",freq:2900,q:10,peak:.7,attack:.012,hold:.45,duration:l,tremolo:{rate:24,depth:.7},wet:.06}),r+l);n(0,.26);const s=n(.36,.22),i=X(o,{type:"sawtooth",freq:[150,132],lowpass:[1100,420],peak:.14,attack:.01,hold:.5,duration:.58,drive:1.8,voices:2,detuneCents:22,wet:.2});return e.forEach((r,l)=>{X({...o,when:o.when+a+l*.1},{type:t?"square":"sawtooth",freq:r,lowpass:t?[3600,2200]:[1600,500],peak:.24,attack:.008,hold:.3,duration:.36,voices:2,detuneCents:t?9:16,wet:.34})}),G(s,i,a+(e.length-1)*.1+.36)}}function Sw(){return t=>{const e=X(t,{type:"triangle",freq:[900,620],peak:.22,duration:.055,drive:1.6,wet:.16}),a=q(t,{filter:"highpass",freq:5e3,peak:.1,duration:.012});return G(e,a)}}function Xn(t,e,a,o,n){return ze(t,{count:12,spread:e,grainMs:[5,14],freq:[2300,4600],freqShift:[a,o],q:3.2,peak:n,decay:.4,drive:1.5,wet:.3})}function cn(t,e,a){return ze(t,{count:7,spread:e,grainMs:[2,5],freq:[5600,11e3],q:9,peak:a,decay:.25,wet:.34})}const Aw={Disc:{cast(t){const e=ne(t.rng,55),a=Xn(t,.3,1.35,.62,.3),o=cn(t,.22,.13),n=q(t,{filter:"bandpass",freq:[700*e,1800*e],q:1.6,peak:.34,attack:.05,hold:.1,duration:.3,drive:1.4,wet:.3});return G(a,o,n)},impact(t){const e=ve(t,{peak:.46,freq:3400,snap:1600,snapMs:10,wet:.1}),a=q(t,{filter:"bandpass",freq:[2400,950],q:2,peak:.3,attack:.003,duration:.07,drive:1.9,wet:.24}),o=Xn(t,.2,1.3,.68,.3),n=cn(t,.14,.46),s=X(t,{type:"sine",freq:[190,72],peak:.46,attack:.0022,duration:.1,drive:2.6,voices:2,detuneCents:15,wet:.14});return G(e,a,o,n,s)}},Roll:{cast(t){const e=ne(t.rng,60);return q(t,{filter:"bandpass",freq:[900*e,2100*e],q:2.4,peak:.36,attack:.04,duration:.2,drive:1.5,wet:.3})},impact(t){const e=Xn(t,.26,.7,1.5,.32),a=cn(t,.2,.44),o=q(t,{filter:"bandpass",freq:[1100,3400],q:7,peak:.3,attack:.02,duration:.26,drive:1.6,wet:.32}),n=X(t,{type:"sine",freq:[230,124],peak:.18,attack:.004,duration:.08,drive:2.2,wet:.12});return G(e,a,o,n)}},Swarm:{cast(t){const e=ne(t.rng,70),a=q(t,{filter:"bandpass",freq:[1400*e,3e3*e],q:4,peak:.36,attack:.025,duration:.17,drive:1.7,wet:.3}),o=cn(t,.16,.16);return G(a,o)},impact(t){const e=ve(t,{peak:.36,freq:4200,snap:2200,snapMs:7,wet:.1}),a=Xn(t,.13,1.2,.8,.24),o=cn(t,.1,.3),n=X(t,{type:"sine",freq:[250,118],peak:.18,attack:.002,duration:.07,drive:2.4,wet:.12});return G(e,a,o,n)}}};function Zn(t,e,a,o){return mi(t,{freq:e,duration:a,peak:o,attack:.0012,drive:1.4,wet:.34,modes:[{ratio:1,gain:1,decay:1},{ratio:2.06,gain:.82,decay:.82},{ratio:3.18,gain:.6,decay:.6},{ratio:4.34,gain:.4,decay:.42},{ratio:5.52,gain:.3,decay:.3}]})}function vc(t,e,a){return ze(t,{count:7,spread:e,grainMs:[2,5],freq:[4200,12e3],q:10,peak:a,decay:.3,wet:.12})}function Rw(t,e,a){return $s(t,{count:4,spread:e,freq:[5e3,12500],peak:a,pingMs:[5,13],bend:1.08,wet:.2})}const Iw={Candy:{cast(t){const e=ne(t.rng,70),a=q(t,{filter:"bandpass",freq:[1400*e,3200*e],q:2,peak:.34,attack:.022,duration:.13,wet:.28}),o=Zn(t,1900*e,.11,.2),n=vc(t,.07,.1);return G(a,o,n)},impact(t){const e=ne(t.rng,60),a=ve(t,{peak:.5,freq:5400,snap:3200,snapMs:8,wet:.12}),o=Zn(t,2450*e,.4,.56),n=vc(t,.22,.9),s=Rw(t,.16,.74),i=Zn({...t,when:t.when+.09},2450*e*1.02,.26,.22),r=Zn({...t,when:t.when+.175},2450*e*1.045,.17,.11),l=X(t,{type:"sine",freq:[280*e,130*e],peak:.42,attack:.0018,duration:.1,drive:3.2,wet:.12});return G(a,o,n,s,.09+i,.175+r,l)}}};function Ui(t,e,a){const o=ne(t.rng,60),n=ve(t,{peak:e,freq:(4200+a*1800)*o,snap:(2600+a*900)*o,snapMs:7,wet:.05}),s=q(t,{filter:"bandpass",freq:[(2600+a*800)*o,(5200+a*1600)*o],q:3.4,peak:e*.8,attack:5e-4,duration:.022,drive:2.2,wet:.1}),i=q(t,{filter:"highpass",poles:24,freq:[(7e3+a*1800)*o,(4600+a*1200)*o],q:.7,peak:e*1.5,attack:4e-4,duration:.024,wet:.12});return G(n,s,i)}function kc(t,e){const a=ne(t.rng,70),o=q(t,{filter:"lowpass",poles:24,freq:[(1800+e*600)*a,(420-e*110)*a],q:3.6,peak:.26+e*.18,attack:.012+e*.01,duration:.15+e*.12,drive:2,wet:.24}),n=X(t,{type:"sine",freq:[(180-e*45)*a,(58-e*16)*a],peak:.36+e*.3,attack:.006,duration:.13+e*.1,drive:3.2,voices:2,detuneCents:16,wet:.14}),s=q(t,{filter:"bandpass",freq:[700*a,1500*a],q:6,peak:.12+e*.08,attack:.03,duration:.2+e*.14,wet:.36}),i=ze(t,{count:Math.round(5+e*5),spread:.12+e*.06,grainMs:[3,8],freq:[3800,10600],q:7,peak:.5+e*.3,decay:.3,wet:.28});return G(o,n,s,i)}const ji=.045,Cw={Tackle:{cast(t){const e=ne(t.rng,40),a=q(t,{filter:"bandpass",freq:[420*e,1900*e],q:2,peak:.44,attack:.07,hold:.1,duration:.26,drive:1.6,wet:.3}),o=X(t,{type:"sine",freq:[120*e,240*e],peak:.28,attack:.08,duration:.24,drive:2.4,voices:2,detuneCents:14,wet:.16});return G(a,o)},impact(t){const e=Ui(t,.88,.35),a=kc({...t,when:t.when+ji},1);return G(e,ji+a)}},Hatch:{cast(t){const e=Ui(t,.5,0),a=X({...t,when:t.when+.05},{type:"triangle",freq:[1500,2400],peak:.3,attack:.006,duration:.09,drive:2.2,wet:.32}),o=X({...t,when:t.when+.15},{type:"triangle",freq:[1800,2700],peak:.24,attack:.005,duration:.07,drive:2.2,wet:.32});return G(e,.05+a,.15+o)},impact(t){const e=ve(t,{peak:.4,freq:5400,snap:3200,snapMs:6,wet:.1}),a=q(t,{filter:"highpass",poles:24,freq:[8200,5600],q:.7,peak:.2,attack:4e-4,duration:.005,wet:.12}),o=X(t,{type:"triangle",freq:[2100,1250],peak:.22,attack:.0015,duration:.05,drive:2.4,wet:.2}),n=X({...t,when:t.when+.035},{type:"triangle",freq:[1700,2600],peak:.18,attack:.005,duration:.06,drive:2,wet:.3}),s=X(t,{type:"sine",freq:[240,120],peak:.22,attack:.002,duration:.06,drive:2.2,wet:.1});return G(e,a,o,.035+n,s)}},Shards:{cast(t){const e=ne(t.rng,80),a=q(t,{filter:"highpass",freq:[1900*e,3800*e],q:1.1,peak:.32,attack:.016,duration:.11,wet:.26}),o=ze(t,{count:4,spread:.08,grainMs:[3,6],freq:[3400,7e3],q:8,peak:.13,wet:.28});return G(a,o)},impact(t){const e=ji*.62,a=Ui(t,.66,1),o=kc({...t,when:t.when+e},.18);return G(a,e+o)}}};function Mc(t,e,a,o){const n=ne(t.rng,70),s=X(t,{type:"sine",freq:[(170-e*55)*n,(52-e*16)*n],peak:o,attack:.003,duration:a,drive:3+e*1.2,voices:2,detuneCents:18,wet:.12}),i=q(t,{filter:"lowpass",poles:24,freq:[(760-e*220)*n,(150-e*45)*n],q:1.2,peak:o*.45,attack:.002,duration:a*.7,drive:2.2,wet:.2}),r=q(t,{filter:"bandpass",freq:[(2400-e*400)*n,(1450-e*300)*n],q:.8,peak:o*.056,attack:.003,duration:a*.55,drive:1.4,wet:.3});return G(s,i,r)}const Fw={Smash:{cast(t){const e=ne(t.rng,55),a=q(t,{filter:"lowpass",poles:24,freq:[1300*e,420*e],q:1.6,peak:.42,attack:.055,hold:.1,duration:.22,drive:1.7,wet:.22}),o=X(t,{type:"sawtooth",freq:[180*e,92*e],lowpass:[620,220],peak:.24,attack:.03,duration:.2,drive:2.2,voices:2,detuneCents:20,wet:.12});return G(a,o)},impact(t){const e=ve(t,{peak:.44,freq:1500,snap:620,snapMs:22,wet:.1}),a=Mc(t,1,.24,.86);return G(e,a)}},Tomato:{cast(t){const e=ne(t.rng,80),a=q(t,{filter:"lowpass",poles:24,freq:[1500*e,520*e],q:2.1,peak:.36,attack:.014,duration:.14,drive:1.6,wet:.18}),o=X(t,{type:"sine",freq:[300*e,140*e],peak:.16,attack:.006,duration:.11,drive:2,wet:.1});return G(a,o)},impact(t){const e=ve(t,{peak:.34,freq:1900,snap:780,snapMs:15,wet:.1}),a=Mc(t,.55,.19,.62),o=q(t,{filter:"lowpass",poles:24,freq:[1e3,260],q:2.8,peak:.24,attack:.008,duration:.13,drive:1.8,wet:.26});return G(e,a,o)}},Lettuce:{cast(t){return q(t,{filter:"bandpass",freq:[900,2200],q:1.2,peak:.26,attack:.03,duration:.15,wet:.3})},impact(t){const e=q(t,{filter:"lowpass",poles:24,freq:[1600,380],q:1.4,peak:.3,attack:.006,duration:.16,drive:1.5,wet:.3}),a=X(t,{type:"triangle",freq:[240,96],peak:.3,attack:.012,hold:.2,duration:.3,drive:2.4,voices:2,detuneCents:22,wet:.18}),o=q(t,{filter:"bandpass",freq:[3400,1900],q:.9,peak:.042,attack:.004,duration:.1,wet:.34});return G(e,a,o)}},Onion:{cast(t){const e=ne(t.rng,20),a=[174.61,220,261.63];a.forEach((n,s)=>{X({...t,when:t.when+s*.07},{type:"triangle",freq:n*e,peak:.28,attack:.016,hold:.22,duration:.34,drive:2.2,voices:2,detuneCents:11,wet:.4})});const o=q(t,{filter:"lowpass",poles:24,freq:[900,300],q:1,peak:.1,attack:.1,duration:.45,wet:.5});return G(.34+a.length*.07,o)}}};function Ec(t,e,a,o,n){const s=ne(t.rng,60),i=.075+o*.045,r=.1+o*.06,l=q(t,{filter:"bandpass",freq:[e*s,a*s],q:5.5,peak:n,attack:.012,duration:i,drive:1.8,wet:.2}),h=q({...t,when:t.when+i*.82},{filter:"bandpass",freq:[a*s,e*.72*s],q:5.5,peak:n*.9,attack:.008,duration:r,drive:1.8,wet:.24}),c=X(t,{type:"triangle",freq:[e*.34*s,a*.3*s],peak:n*.5,attack:.014,duration:i+r*.6,drive:2.4,voices:2,detuneCents:16,wet:.14});return G(l,i*.82+h,c)}function Tc(t,e,a){const o=ne(t.rng,70),n=ve(t,{peak:.3+e*.1,freq:1700+a*700,snap:700+a*320,snapMs:16,wet:.1}),s=q(t,{filter:"lowpass",poles:24,freq:[(1400+a*600)*o,(280+a*120)*o],q:3.2,peak:.42+e*.2,attack:.005,duration:.15+e*.07,drive:2,wet:.26}),i=X(t,{type:"sine",freq:[(210-e*50)*o,(66-e*18)*o],peak:.6+e*.34,attack:.0025,duration:.16+e*.14,drive:2.6,voices:2,detuneCents:15,wet:.14}),r=q(t,{filter:"bandpass",freq:[(4200+a*2200)*o,(2100+a*900)*o],q:.75,peak:.23+a*.06,attack:.0015,duration:.05+a*.03,wet:.34});return G(n,s,i,r)}const Ow={Mustard:{cast(t){return Ec(t,520,1250,.15,.44)},impact(t){return Tc(t,.42,1)}},Ketchup:{cast(t){return Ec(t,340,780,1,.42)},impact(t){const e=Tc(t,.3,0),a=q(t,{filter:"lowpass",poles:24,freq:[640,200],q:4,peak:.2,attack:.04,duration:.34,drive:1.6,wet:.4});return G(e,a)}},Slash:{cast(t){const e=ne(t.rng,50);return q(t,{filter:"bandpass",freq:[700*e,2300*e],q:2,peak:.38,attack:.05,hold:.1,duration:.19,drive:1.5,wet:.26})},impact(t){const e=ne(t.rng,45),a=.026,o=(h,c,d)=>ve({...t,when:t.when+h},{peak:c,freq:d,snap:d*.3,snapMs:20,wet:.12}),n=o(0,.5,1400),s=o(a,.4,1200),i=q(t,{filter:"bandpass",freq:[900*e,340*e],q:2.4,peak:.34,attack:.0015,duration:.12,drive:2.1,wet:.24}),r=X(t,{type:"sine",freq:[200*e,58*e],peak:.95,attack:.002,duration:.24,drive:3,voices:2,detuneCents:17,wet:.14}),l=ze(t,{count:5,spread:.075,grainMs:[3,9],freq:[3e3,6400],q:4,peak:.38,decay:.3,wet:.3});return G(n,a+s,i,r,l)}}};function Gi(t,e,a,o){const n=mi(t,{freq:e,duration:a,peak:o,attack:8e-4,wet:.36,modes:[{ratio:1,gain:1,decay:1},{ratio:2.76,gain:.8,decay:.7},{ratio:5.4,gain:.5,decay:.44}]}),s=X(t,{type:"sine",freq:[e*1.02,e*.92],ring:e*1.37,peak:o*.7,attack:8e-4,duration:a*.8,wet:.4});return G(n,s)}function Sc(t,e,a,o){return ze(t,{count:e,spread:a,grainMs:[2,5],freq:[5600,14e3],q:11,peak:o,decay:.3,wet:.3})}const Nw={Smash:{cast(t){const e=ne(t.rng,50),a=q(t,{filter:"bandpass",freq:[600*e,2400*e],q:2.4,peak:.44,attack:.055,hold:.1,duration:.22,drive:1.5,wet:.3}),o=Gi(t,2400*e,.12,.16);return G(a,o)},impact(t){const e=ne(t.rng,45),a=ve(t,{peak:.66,freq:6400,snap:4200,snapMs:6,wet:.14}),o=Gi(t,5400*e,.34,.56),n=Sc(t,9,.2,.8),s=X(t,{type:"sine",freq:[250*e,100*e],peak:.62,attack:.0015,duration:.12,drive:3,wet:.12}),i=q(t,{filter:"bandpass",freq:[7e3,12e3],q:1.2,peak:.26,attack:.025,duration:.16,wet:.5});return G(a,o,n,i,s)}},Giant:{impact(t){const e=ne(t.rng,35),a=ve(t,{peak:.72,freq:5800,snap:3600,snapMs:9,wet:.16}),o=Gi(t,4550*e,.5,.64),n=Sc(t,12,.36,.84),s=q(t,{filter:"bandpass",freq:[6e3,9500],q:1.4,peak:.14,attack:.06,duration:.58,wet:.6}),i=X(t,{type:"sine",freq:[230*e,78*e],peak:.52,attack:.0025,duration:.14,drive:3,voices:2,detuneCents:16,wet:.14});return G(a,o,n,s,i)}}};function Wi(t,e,a){const o=ne(t.rng,60),n=.38+a*.12,s=q(t,{filter:"bandpass",freq:[(560-a*200)*o,(2200-a*900)*o],q:1.5,peak:1.2,attack:.035,hold:.1,duration:n,drive:1.5,wet:.1*Math.min(1,16/e),tremolo:{rate:[e*.88,e],depth:.85}}),i=q(t,{filter:"highpass",freq:3600,peak:.16,attack:8e-4,duration:.018,wet:.1});return G(s,i)}const Lw={Dough:{cast(t){return Wi(t,16,.85)},impact(t){const e=ne(t.rng,70),a=q(t,{filter:"lowpass",poles:24,freq:[1100*e,190*e],q:1.1,peak:.34,attack:.004,duration:.13,drive:1.8,wet:.24}),o=ve(t,{peak:.34,freq:1600,snap:660,snapMs:18,wet:.1}),n=X(t,{type:"sine",freq:[150*e,58*e],peak:.5,attack:.003,duration:.18,drive:2.8,voices:2,detuneCents:18,wet:.14}),s=q(t,{filter:"bandpass",freq:[2500,1700],q:.8,peak:.028,attack:.012,duration:.11,wet:.4});return G(a,o,n,s)}},Tomato:{cast(t){return Wi(t,26,.25)},impact(t){const e=ne(t.rng,65),a=q(t,{filter:"bandpass",freq:[1350*e,400*e],q:1.4,peak:.34,attack:.001,duration:.07,drive:2,wet:.2}),o=q(t,{filter:"lowpass",poles:24,freq:[900,240],q:2.6,peak:.3,attack:.008,duration:.15,drive:1.7,wet:.26}),n=ve(t,{peak:.34,freq:2e3,snap:900,snapMs:13,wet:.1}),s=X(t,{type:"sine",freq:[200*e,72*e],peak:.62,duration:.18,drive:3.2,voices:2,detuneCents:16,wet:.14}),i=Zl(t,{peak:.15,freq:[8200,3e3],duration:.085,drops:6,wet:.34});return G(a,o,n,s,i)}},Cheese:{cast(t){return Wi(t,12,.6)},impact(t){const e=ne(t.rng,55),a=q(t,{filter:"bandpass",freq:[1400*e,480*e],q:2.2,peak:.3,attack:.01,duration:.2,drive:1.6,wet:.26}),o=X(t,{type:"triangle",freq:[300*e,110*e],peak:.32,attack:.012,hold:.25,duration:.34,drive:2.4,voices:2,detuneCents:20,wet:.18}),n=ve(t,{peak:.26,freq:1800,snap:760,snapMs:16,wet:.1}),s=ze(t,{count:4,spread:.13,grainMs:[6,16],freq:[3200,5200],q:3.5,peak:.16,decay:.35,freqShift:[1,.62],wet:.34});return G(a,o,n,s)}}};function Yi(t,e,a){return q(t,{filter:"bandpass",freq:[2800,5600],q:.85,peak:e,attack:a*.35,duration:a,wet:.55})}function Vi(t,e,a,o){return gn(t,{count:e,spread:a,freq:[1500,3100],rise:1.9,peak:o,wet:.42})}function Ki(t,e,a,o){const n=ne(t.rng,80),s=(2600-e*900)*n,i=(420-e*200)*n,r=q(t,{filter:"lowpass",freq:[s,i],poles:24,q:2.4+e*2,peak:o*.72,attack:.006+e*.012,duration:a,drive:1.8,wet:.3}),l=X(t,{type:"sine",freq:[(190-e*60)*n,(68-e*22)*n],peak:o*(.85+e*.55),attack:.005,duration:a*.75,drive:2.5,voices:2,detuneCents:16,wet:.14}),h=ve(t,{peak:.22+e*.12,freq:1150,snap:460,snapMs:18,wet:.12});return G(r,l,h)}const Dw={Splash:{cast(t){const e=ne(t.rng,90),a=q(t,{filter:"bandpass",freq:[900*e,260*e],q:3.4,peak:.46,attack:.012,duration:.12,drive:1.8,wet:.24}),o=gn(t,{count:2,spread:.07,freq:[620,980],peak:.2,wet:.3});return G(a,o)},impact(t){const e=Ki(t,.24,.2,.44),a=gn(t,{count:4,spread:.16,freq:[480,900],peak:.14,wet:.3}),o=Vi(t,7,.11,.2),n=Yi(t,.11,.34);return G(e,a,o,n)}},Noodle:{cast(t){const e=ne(t.rng,70),a=q(t,{filter:"bandpass",freq:[1500*e,520*e],q:2.2,peak:.42,attack:.01,duration:.16,drive:1.7,wet:.26}),o=X(t,{type:"sine",freq:[520*e,190*e],peak:.16,attack:.02,duration:.18,drive:2,wet:.16});return G(a,o)},impact(t){const e=q(t,{filter:"bandpass",freq:[1400,560],q:1.6,peak:.26,attack:.0015,duration:.05,drive:1.8,wet:.18}),a=Ki(t,.35,.26,.44),o=gn(t,{count:3,spread:.2,freq:[440,820],peak:.12,wet:.3}),n=Vi(t,8,.14,.2),s=Yi(t,.12,.42);return G(e,a,o,n,s)}},Dump:{cast(t){const e=ne(t.rng,40);let a=0;const o=9;for(let s=0;s<o;s++){const i=s/o*.34+be(t.rng,-.012,.012),r=be(t.rng,320,1100)*e,l=be(t.rng,.05,.11);a=Math.max(a,i+l),q({...t,when:t.when+Math.max(0,i)},{filter:"lowpass",poles:24,freq:[r*2.2,r*.6],q:4.5,peak:.32,attack:.008,duration:l,drive:1.6,wet:.28})}const n=X(t,{type:"sine",freq:[150*e,70*e],peak:.3,attack:.12,duration:.4,drive:2,voices:2,detuneCents:14,wet:.2});return G(a,n)},impact(t){const e=Ki(t,1,.42,.62),a=gn(t,{count:7,spread:.34,freq:[380,820],peak:.16,wet:.34}),o=ze(t,{count:5,spread:.26,freq:[600,1500],peak:.1,q:4,wet:.3}),n=Vi(t,7,.22,.14),s=Yi(t,.15,.75);return G(e,a,o,n,s)}}};function Xi(t,e,a,o,n){const s=ne(t.rng,45),i=q(t,{filter:"bandpass",freq:[e*s,a*s],q:12,peak:n,attack:.004,duration:o,curve:"lin",freqCurve:"exp",wet:.18}),r=q({...t,when:t.when+o*.16},{filter:"bandpass",freq:[e*2*s,a*1.7*s],q:14,peak:n*.5,attack:.002,duration:o*.7,curve:"lin",wet:.22}),l=q({...t,when:t.when+o*.06},{filter:"bandpass",freq:[e*3.4*s,a*2.6*s],q:16,peak:n*.8,attack:.0015,duration:o*.45,curve:"lin",wet:.24});return G(i,o*.16+r,o*.06+l)}function Jn(t,e,a,o){return ze(t,{count:e,spread:a,grainMs:[2,5],freq:[4200,12e3],q:6,peak:o,decay:.35,wet:.1})}const zw={Rice:{cast(t){const e=q(t,{filter:"highpass",freq:[2200,4200],q:1,peak:.3,attack:.012,duration:.09,wet:.2}),a=Jn(t,7,.09,.2);return G(e,a)},impact(t){const e=Jn(t,6,.075,.34),a=ve(t,{peak:.3,freq:5600,snap:3600,snapMs:5,wet:.08}),o=X(t,{type:"sine",freq:[300,170],peak:.16,attack:.0015,duration:.05,drive:2,wet:.1});return G(e,a,o)}},Seaweed:{cast(t){const e=ne(t.rng,60);return q(t,{filter:"bandpass",freq:[1600*e,3400*e],q:1.8,peak:.34,attack:.03,duration:.18,wet:.3})},impact(t){const e=ne(t.rng,55),a=ze(t,{count:10,spread:.16,grainMs:[3,9],freq:[2800,6400],q:4.5,peak:.28,decay:.35,wet:.28}),o=q(t,{filter:"bandpass",freq:[3600*e,1600*e],q:7,peak:.26,attack:.012,duration:.24,wet:.32}),n=ve(t,{peak:.32,freq:4200,snap:2400,snapMs:7,wet:.1}),s=X(t,{type:"sine",freq:[280,150],peak:.13,attack:.003,duration:.06,drive:2,wet:.12});return G(a,o,n,s)}},Fish:{cast(t){return Xi(t,900,2600,.14,.3)},impact(t){const e=Xi(t,2600,8200,.17,.72),a=q(t,{filter:"lowpass",poles:24,freq:[1100,340],q:2.4,peak:.16,attack:.006,duration:.09,drive:1.8,wet:.24}),o=Jn(t,5,.1,.2),n=X(t,{type:"sine",freq:[230,96],peak:.42,attack:.0018,duration:.07,drive:2.4,wet:.12});return G(e,a,o,n)}},Catch:{cast(t){const e=ne(t.rng,40),a=X(t,{type:"sine",freq:[140*e,300*e],peak:.3,attack:.1,duration:.3,drive:2.2,voices:2,detuneCents:14,wet:.24}),o=q(t,{filter:"bandpass",freq:[800*e,2400*e],q:2.2,peak:.34,attack:.08,duration:.28,wet:.32});return G(a,o)},impact(t){const e=Xi(t,3e3,9e3,.15,.8),a=q({...t,when:t.when+.05},{filter:"lowpass",poles:24,freq:[1300,420],q:2.2,peak:.2,attack:.005,duration:.11,drive:1.9,wet:.26}),o=Jn({...t,when:t.when+.04},8,.16,.28),n=ve(t,{peak:.52,freq:5e3,snap:2800,snapMs:7,wet:.1}),s=X(t,{type:"sine",freq:[220,80],peak:.5,attack:.0018,duration:.09,drive:2.6,voices:2,detuneCents:14,wet:.14});return G(e,.05+a,.04+o,n,s)}}};function Qn(t,e,a){const o=ne(t.rng,70),n=q(t,{filter:"bandpass",freq:[3400*o,1500*o],q:1.2,peak:.55+e*.3,attack:6e-4,duration:.03,drive:2.2,wet:.12}),s=ve(t,{peak:.44+e*.2,freq:5200*o,snap:(2900-e*500)*o,snapMs:8,wet:.1}),i=ze(t,{count:Math.round(7+e*6),spread:.14+e*.1,grainMs:[3,9-a*3],freq:[2700+a*900,9200+a*2600],q:7,peak:.34+e*.16,decay:.28,drive:1.6,wet:.26}),r=e*(1-a)>.02?X(t,{type:"sine",freq:[(190-e*60)*o,(72-e*22)*o],peak:.24+e*.26,attack:.002,duration:.08+e*.1,drive:2.6,voices:2,detuneCents:16,wet:.14}):0,l=q(t,{filter:"highpass",poles:24,freq:[8e3+a*2e3,5200+a*1200],q:.7,peak:.165+e*.065,attack:6e-4,duration:.014+e*.012,wet:.22});return G(n,s,i,r,l)}const Hw={Filling:{cast(t){const e=ne(t.rng,60),a=q(t,{filter:"bandpass",freq:[700*e,1800*e],q:2,peak:.44,attack:.03,duration:.16,drive:1.6,wet:.26}),o=ze(t,{count:4,spread:.1,freq:[3e3,7e3],peak:.11,q:8,wet:.28}),n=X(t,{type:"sine",freq:[260*e,130*e],peak:.14,duration:.1,drive:2,wet:.12});return G(a,o,n)},impact(t){return Qn(t,.75,.3)}},Onion:{cast(t){const e=ne(t.rng,80);return q(t,{filter:"highpass",freq:[1800*e,3400*e],q:1.1,peak:.36,attack:.02,duration:.12,wet:.28})},impact(t){const e=Qn(t,.3,1),a=q(t,{filter:"bandpass",freq:[1100,420],q:1.6,peak:.26,attack:.006,duration:.1,drive:1.7,wet:.24});return G(e,a)}},Double:{cast(t){const e=ne(t.rng,50),a=q(t,{filter:"bandpass",freq:[640*e,1700*e],q:2,peak:.44,attack:.025,duration:.15,drive:1.6,wet:.26}),o=q({...t,when:t.when+.055},{filter:"bandpass",freq:[820*e,2100*e],q:2,peak:.38,attack:.02,duration:.13,drive:1.6,wet:.26}),n=X(t,{type:"sine",freq:[240*e,118*e],peak:.16,duration:.12,drive:2,wet:.12});return G(a,.055+o,n)},impact(t){const e=Qn(t,.85,.1),a=Qn({...t,when:t.when+.055},.4,.85);return G(e,.055+a)}}};function es(t,e,a,o){return mi(t,{freq:e,duration:a,peak:o,attack:.001,drive:1.8,wet:.22,modes:[{ratio:1,gain:1,decay:1},{ratio:2.43,gain:.78,decay:.55},{ratio:3.71,gain:.5,decay:.34},{ratio:5.86,gain:.3,decay:.2}]})}function Ac(t,e,a){const o=q(t,{filter:"bandpass",freq:[1300,2800],q:1.5,peak:e,attack:.004,duration:a,wet:.34}),n=ze(t,{count:7,spread:a*.7,grainMs:[3,7],freq:[2600,8600],q:8,peak:e*.42,decay:.3,wet:.3}),s=q(t,{filter:"highpass",poles:24,freq:[6200,3800],q:.7,peak:e*.25,attack:.002,duration:a*.5,wet:.36});return G(o,n,s)}const _w={Spray:{cast(t){const e=q(t,{filter:"bandpass",freq:[900,2800],q:1.1,peak:.34,attack:.02,duration:.14,wet:.28}),a=es(t,190,.06,.2);return G(e,a)},impact(t){const e=ve(t,{peak:.28,freq:4200,snap:2500,snapMs:8,wet:.12}),a=Ac(t,.34,.16),o=X(t,{type:"sine",freq:[260,120],peak:.3,attack:.002,duration:.09,drive:2,wet:.12});return G(e,a,o)}},Glass:{cast(t){const e=ne(t.rng,70),a=q(t,{filter:"highpass",freq:[1600*e,3600*e],q:1.2,peak:.36,attack:.018,duration:.13,wet:.26}),o=ze(t,{count:3,spread:.07,grainMs:[3,7],freq:[4200,8e3],q:9,peak:.14,wet:.3});return G(a,o)},impact(t){const e=ve(t,{peak:.62,freq:4600,snap:3400,snapMs:9,wet:.14}),a=es(t,460,.13,.42),o=ze(t,{count:9,spread:.15,grainMs:[3,8],freq:[3200,9200],q:8,peak:.3,decay:.25,wet:.32}),n=$s(t,{count:3,spread:.1,freq:[5200,11e3],peak:.19,pingMs:[6,14],bend:.9,wet:.34});return G(e,a,o,n)}},Cap:{cast(t){const e=X(t,{type:"sine",freq:[520,900],peak:.4,attack:.001,duration:.05,drive:2.6,wet:.2}),a=ve(t,{peak:.3,freq:4e3,snap:2400,snapMs:6,wet:.12});return G(e,a)},impact(t){const e=ve(t,{peak:.52,freq:3800,snap:2300,snapMs:9,wet:.12}),a=es(t,560,.2,.7),o=X(t,{type:"sine",freq:[150,68],peak:.17,attack:.003,duration:.11,drive:2.4,wet:.12}),n=$s(t,{count:2,spread:.05,freq:[4600,9e3],peak:.3,pingMs:[5,11],bend:.86,wet:.28});return G(e,a,o,n)}},Mega:{cast(t){const e=ne(t.rng,35),a=q(t,{filter:"bandpass",freq:[500*e,2600*e],q:1.8,peak:.44,attack:.1,hold:.08,duration:.34,drive:1.5,wet:.34}),o=X(t,{type:"sine",freq:[90*e,200*e],peak:.34,attack:.12,duration:.36,drive:2.4,voices:2,detuneCents:14,wet:.2});return G(a,o)},impact(t){const e=ve(t,{peak:.58,freq:3e3,snap:1500,snapMs:16,wet:.12}),a=Ac(t,.56,.42),o=es(t,380,.24,.56),n=X(t,{type:"sine",freq:[140,46],peak:.62,attack:.003,duration:.3,drive:3.2,voices:2,detuneCents:18,wet:.16});return G(e,a,o,n)}}};function Et(t,e){const a={};for(const[o,n]of Object.entries(e))n&&(a[`${t}.${o}`]=n);return a}const Pw={...Et("burrito",Aw),...Et("donut",Iw),...Et("egg",Cw),...Et("hamburger",Fw),...Et("hotdog",Ow),...Et("lollipop",Nw),...Et("pizza",Lw),...Et("soup",Dw),...Et("sushi",zw),...Et("taco",Hw),...Et("waterbottle",_w)};function Rc(t,e){return Pw[`${t}.${e}`]}const $w=210,Bw=.78,qw=420,Uw=900,jw=520,Gw=.45,Ww=1.5,Yw=1600,Vw=qw,Kw=.6180339887,Xw=.42;class Bs{constructor(e,a={}){this.engine=e,this.localSlot=a.listenerId??(a.listener==="enemy"?1:Ce),this.listenerSlot=this.localSlot}listenerSlot;localSlot;lastFogSoundAt=-1/0;lastHealSoundAt=-1/0;ringFloored=!1;sawRingAboveFloor=!1;statusBefore=[];statusWriterUnclaimed=[];statusTrackable=!1;nextAmbienceAt=-1/0;ambienceChunk=0;lastCombatAt=-1/0;setListener(e){this.listenerSlot=e}handleEvents(e,a){try{this.watchZone(a),this.watchAmbience(a),this.openStatusWindow(a);for(const o of e)this.handleEvent(o,a)}catch(o){console.warn("[audio] event dispatch failed:",o)}finally{this.closeStatusWindow(a)}}reset(){this.listenerSlot=this.localSlot,this.lastFogSoundAt=-1/0,this.lastHealSoundAt=-1/0,this.ringFloored=!1,this.sawRingAboveFloor=!1,this.statusBefore=[],this.statusWriterUnclaimed=[],this.statusTrackable=!1,this.nextAmbienceAt=-1/0,this.ambienceChunk=0,this.lastCombatAt=-1/0}static statusTimestamps(e){const a=e.status;return!a||typeof a.stunnedUntil!="number"||typeof a.slowedUntil!="number"?null:{stun:a.stunnedUntil,slow:a.slowedUntil}}openStatusWindow(e){const o=_e(e).map(n=>Bs.statusTimestamps(n));if(this.statusTrackable=o.length>0&&o.every(n=>n!==null),!!this.statusTrackable)for(let n=0;n<o.length;n++){const s=this.statusBefore[n]??{stun:NaN,slow:NaN},i=o[n];this.statusWriterUnclaimed[n]={stun:i.stun!==s.stun,slow:i.slow!==s.slow}}}closeStatusWindow(e){_e(e).forEach((a,o)=>{const n=Bs.statusTimestamps(a);n&&(this.statusBefore[o]=n)})}wasStatusRefused(e,a){if(!this.statusTrackable)return!1;const o=this.statusWriterUnclaimed[e];return o?.[a]?(o[a]=!1,!1):!0}watchZone(e){if(!this.ringFloored&&e.phase==="playing"){if(e.safeRadius>l0(e.fighters.length,e.timeRemaining)+.5){this.sawRingAboveFloor=!0;return}this.sawRingAboveFloor&&(this.ringFloored=!0,this.engine.play(Mw(),{priority:Ke.Critical}))}}watchAmbience(e){if(e.phase!=="playing"||e.elapsed<this.nextAmbienceAt)return;this.nextAmbienceAt=e.elapsed+j0*1e3;const a=this.ambienceChunk*Kw%1;this.ambienceChunk++;const o=_e(e);let n=1/0;for(let i=0;i<o.length;i++)for(let r=i+1;r<o.length;r++){const l=Math.hypot(o[i].x-o[r].x,o[i].y-o[r].y);l<n&&(n=l)}const s=e.elapsed-this.lastCombatAt<Yw||n<Vw;this.engine.play(ww(),{gain:s?Gw:Ww,pan:(a*2-1)*Xw,priority:Ke.Ambient,key:"ambience"})}handleEvent(e,a){switch(e.type){case"countdown-tick":this.engine.play(vw(e.value),{priority:Ke.Critical});break;case"match-started":this.engine.play(kw(),{priority:Ke.Critical});break;case"match-ended":{const o=_e(a),n=o.length>0&&o.every(i=>i.alive===!0),s=aa(e.winnerId,e.winner)===this.localSlot;this.engine.play(n?Tw(s):Ew(s),{priority:Ke.Critical});break}case"weapon-fired":this.lastCombatAt=a.elapsed,this.playCast(gt(a,e.fighterId,e.fighterRole),e.weaponKey,a);break;case"hit-landed":this.lastCombatAt=a.elapsed,this.playHit(e,a);break;case"heal":{if(e.amount<=h0&&a.elapsed-this.lastHealSoundAt<jw)break;this.lastHealSoundAt=a.elapsed;const o=gt(a,e.fighterId,e.fighterRole);this.engine.play(fw(),{...this.place(o.x,o.y,a),key:"heal"});break}case"death":{const o=gt(a,e.fighterId,e.fighterRole),n=this.place(o.x,o.y,a);this.engine.play(uw(),{...n,priority:Ke.Critical,gain:aa(e.fighterId,e.fighterRole)===this.localSlot?1:n.gain});break}case"projectile-destroyed":e.reason==="hit-cover"&&this.engine.play(xw(),{...this.place(e.x,e.y,a),priority:Ke.Ambient,key:"cover"});break}}playCast(e,a,o){const n=re[e.characterId].weapons.find(r=>r.key===a);if(!n)return;if(n.giantSlam){this.engine.play(hw(),{priority:Ke.Critical});return}const s=Rc(e.characterId,a)?.cast,i=s?this.wrapWeaponHook(s,n,e.characterId,n.damage):Zw(n);this.engine.play(i,{...this.place(e.x,e.y,o),key:`cast:${e.characterId}.${a}`})}playHit(e,a){const o=this.place(e.x,e.y,a),n=aa(e.targetId,e.targetRole),s=e.effect==="stun"&&this.wasStatusRefused(n,"stun");if(e.source.kind==="fog"){if(a.elapsed-this.lastFogSoundAt<Uw)return;this.lastFogSoundAt=a.elapsed,this.engine.play(mw(),{priority:Ke.Ambient,key:"fog"});return}if(e.source.kind==="hazard"){this.engine.play(bw(),{...o,priority:Ke.Ambient,key:"hazard"});return}if(e.source.kind==="trail"){this.engine.play(yw(),{...o,priority:Ke.Ambient,key:"trail"});return}const i=e.source.weaponKey,r=wn(a,e.source,e.targetRole),l=re[r.characterId].weapons.find(d=>d.key===i),h=l?Rc(r.characterId,l.key)?.impact:void 0,c=h&&l?this.wrapWeaponHook(h,l,r.characterId,e.amount):cw(e.amount);if(this.engine.play(c,{...o,key:`impact:${r.characterId}.${i}`}),n===this.localSlot){const d=gt(a,e.targetId,e.targetRole);this.engine.play(dw(d.hp/d.maxHp),{gain:.9,key:"hurt",priority:Ke.Normal})}s&&this.engine.play(pw(),{...o,key:"shrug",priority:Ke.Normal})}wrapWeaponHook(e,a,o,n){return s=>e({...s,color:a.color,damage:n,weapon:a,characterId:o})}place(e,a,o){const n=_e(o)[this.listenerSlot]??o.player,s=e-n.x,i=a-n.y,r=Math.max(-1,Math.min(1,s/$w))*Bw,l=Math.hypot(s,i),h=ow(l,nw,sw);return{pan:r,gain:h}}}function Zw(t){return t.type==="melee"?rw(t.damage,t.cone??90):t.type==="self"?lw():iw(t.damage)}const Zi="/food-arena/",Ic=`${Zi.endsWith("/")?Zi:`${Zi}/`}audio/bounce-and-bash.mp3`,Cc=.45,G0="fa.audio.music";function Jw(){try{const t=localStorage.getItem(G0);if(t){const e=JSON.parse(t);return{volume:typeof e.volume=="number"?Math.min(1,Math.max(0,e.volume)):Cc,enabled:e.enabled!==!1}}}catch{}return{volume:Cc,enabled:!0}}function Fc(t){try{localStorage.setItem(G0,JSON.stringify(t))}catch{}}class Qw{el=null;source=null;gain=null;state=Jw();wanted=!1;listeners=new Set;fadeToken=0;loadError=null;suppressed=!1;ensureGraph(){if(typeof document>"u")return!1;const e=lt(),a=e.context,o=e.busInput;if(!a||!o||typeof a.createMediaElementSource!="function")return!1;if(this.source)return!0;if(!this.el){const n=document.createElement("audio");n.src=Ic,n.loop=!0,n.preload="auto",n.volume=1,n.crossOrigin="anonymous",n.addEventListener("error",()=>{const s=n.error?n.error.code:0;this.loadError=`music track failed to load (MediaError ${s}) from ${n.currentSrc||n.src}`,console.warn(`[audio] ${this.loadError}`),this.emit()},{once:!0}),this.el=n}try{return this.source=a.createMediaElementSource(this.el),this.gain=a.createGain(),this.gain.gain.value=this.state.enabled?this.state.volume:0,this.source.connect(this.gain).connect(o),!0}catch{return this.source=null,this.gain=null,!1}}play(){if(this.wanted=!0,this.suppressed||!this.state.enabled||!this.ensureGraph()||!this.el)return;const e=this.el.play();e&&typeof e.catch=="function"&&e.catch(()=>{})}pause(){this.wanted=!1,this.el?.pause()}onUnlock(){this.wanted&&this.play()}isPlaying(){return!!this.el&&!this.el.paused}getLoadError(){return this.loadError}getTrackUrl(){return this.el?this.el.src:Ic}getVolume(){return this.state.volume}setVolume(e){this.state.volume=Math.min(1,Math.max(0,e)),Fc(this.state),this.applyGain(),this.emit()}isEnabled(){return this.state.enabled}setEnabled(e){this.state.enabled=e,Fc(this.state),this.applyGain(),e?this.play():this.el?.pause(),this.emit()}fadeOut(e=.6){if(this.suppressed=!0,!this.el||this.el.paused)return;this.applyGain(0,e);const a=this.el;window.setTimeout(()=>{this.fadeToken===o&&a.pause()},e*1e3+40);const o=++this.fadeToken}fadeIn(e=.8){if(this.fadeToken++,this.suppressed=!1,!this.state.enabled||!this.ensureGraph()||!this.el)return;const a=this.el.paused;if(a){this.gain&&(this.gain.gain.value=0);const o=this.el.play();o&&typeof o.catch=="function"&&o.catch(()=>{})}this.applyGain(void 0,a?e:.25)}duck(e=.35){this.applyGain(this.state.volume*Math.min(1,Math.max(0,e)))}unduck(){this.applyGain()}onChange(e){return this.listeners.add(e),()=>this.listeners.delete(e)}applyGain(e,a=.08){if(!this.gain)return;const n=lt().context,s=this.state.enabled?e??this.state.volume:0;try{if(n){const i=n.currentTime;this.gain.gain.cancelScheduledValues(i),this.gain.gain.setValueAtTime(this.gain.gain.value,i),this.gain.gain.linearRampToValueAtTime(s,i+a)}else this.gain.gain.value=s}catch{this.gain.gain.value=s}}emit(){for(const e of this.listeners)try{e()}catch{}}}let ts=null;function ot(){if(!ts){ts=new Qw;const t=ts;lt().onChange(()=>{lt().getState()==="running"&&t.onUnlock()})}return ts}let as=null;function lt(){return as||(as=new ew,t1(as)),as}function e1(t){return new Bs(lt(),t)}const ke={setVolume(t){lt().setVolume(t)},getVolume(){return lt().getVolume()},setMuted(t){lt().setMuted(t)},isMuted(){return lt().isMuted()},toggleMuted(){return lt().toggleMuted()},onChange(t){return lt().onChange(t)},getState(){return lt().getState()},unlock(){lt().unlock()},previewClick(){lt().play(Sw(),{key:"ui"})},music:{play(){ot().play()},pause(){ot().pause()},isPlaying(){return ot().isPlaying()},getVolume(){return ot().getVolume()},setVolume(t){ot().setVolume(t)},isEnabled(){return ot().isEnabled()},setEnabled(t){ot().setEnabled(t)},fadeOut(t){ot().fadeOut(t)},fadeIn(t){ot().fadeIn(t)},duck(t){ot().duck(t)},unduck(){ot().unduck()},onChange(t){return ot().onChange(t)},getLoadError(){return ot().getLoadError()},getTrackUrl(){return ot().getTrackUrl()}}};function t1(t){typeof window>"u"||(window.__audio={engine:t,tap:()=>t.tap(),connectTap:e=>t.connectTap(e),stats:()=>({state:t.getState(),activeVoices:t.activeVoices(),started:t.counters.started,droppedBudget:t.counters.droppedBudget,droppedThrottle:t.counters.droppedThrottle,droppedNotRunning:t.counters.droppedNotRunning,volume:t.getVolume(),muted:t.isMuted()}),get music(){const e=ot();return{url:e.getTrackUrl(),error:e.getLoadError(),playing:e.isPlaying(),enabled:e.isEnabled()}}})}const I={ink:"#1a1224",cream:"#FFF3DE",white:"#FFFFFF",gold:"#F4A300",goldDark:"#B87400",mustard:"#FFC93C",mustardHi:"#FFDD6B",ketchup:"#D62839",tomato:"#E63946",tomatoHi:"#FF9E9E",lettuce:"#7CB518",leafDark:"#4E8B2B",water:"#1E90D8",waterHi:"#5BC8F5",ice:"#8FE1FF",iceHi:"#BFF0FF",grape:"#7A4BC4",grapeHi:"#9B6BE0",grapeDark:"#5B2E8C",violet:"#B497D6",wood:"#8B4A22",woodHi:"#B4622A",meat:"#8B3A2E",meatHi:"#D98A72",patty:"#A05A2C",pattyDark:"#5A2E17",steel:"#DCD6E8",candy:"#FF6FA5",candyHi:"#FFB3D1",flame:"#FF7A2F"};function Ro(t,e,a,o=12,n=12){const s=[];for(let i=0;i<t*2;i++){const r=i%2===0?e:a,l=Math.PI*i/t-Math.PI/2;s.push(`${(o+r*Math.cos(l)).toFixed(2)} ${(n+r*Math.sin(l)).toFixed(2)}`)}return`M${s.join("L")}Z`}const a1={patty:`
...
<path d="M8.4 15a4 4 0 0 0 4.6 4.4" stroke="${I.gold}" stroke-width="1.9"/>`,burst:`<path d="${Ro(9,10.2,4.6)}" fill="${I.gold}"/>
<path d="${Ro(9,5.6,2.4)}" fill="${I.mustardHi}" stroke-width="1.3"/>`,hammer:`
...
<path d="M18.3 9.2c1.7 2.4 2.5 4.2 2.5 5.5 0 1.5-.9 2.5-2.2 2.5s-2.2-1-2.2-2.5c0-1.3.6-3 1.9-5.5z" fill="${I.mustardHi}"/>`};function os(t,e,a,o=""){return`
...
${o}`}const o1=`<path d="M12 0.6c2.6 2.2 3.7 3.9 3.2 5.5-.9-.8-1.6-1.1-2.3-.9.7 1.9.3 3.1-.9 4-1.2-.9-1.6-2.1-.9-4-.7-.2-1.4.1-2.3.9-.5-1.6.6-3.3 3.2-5.5z" fill="${I.flame}" stroke-width="1.3"/>`,n1=`<path d="M12 0.4c2.4.8 3.6 2.4 3.6 4.6-2.4-.7-3.6-2.3-3.6-4.6zM12 0.4c-2.4.8-3.6 2.4-3.6 4.6C10.8 4.3 12 2.7 12 .4z" fill="${I.lettuce}" stroke-width="1.3"/>`,s1=`<path d="M12 5.6C9.2 1.6 4.8 2.8 6.2 5.6M12 5.6C14.8 1.6 19.2 2.8 17.8 5.6" fill="${I.mustard}" stroke-width="1.4"/>`,i1=`<path d="M4.9 13.4a2.6 2.6 0 0 1 5.2 0z" fill="#B4622A" stroke-width="1.2"/>
<path d="M4.7 13.4h5.6v1.5H4.7z" fill="${I.lettuce}" stroke-width="1.2"/>
<path d="M4.9 15h5.2a2.2 2.2 0 0 1-5.2 0z" fill="#B4622A" stroke-width="1.2"/>`,r1=Array.from({length:8},(t,e)=>`<rect x="10.3" y="0.9" width="3.4" height="5.4" rx="1.2" fill="${I.gold}" transform="rotate(${e*45} 12 12)"/>`).join(""),l1={coin:`
<circle cx="12" cy="12" r="9.5" fill="${I.goldDark}"/>
<circle cx="12" cy="12" r="7.6" fill="${I.gold}" stroke="none"/>
<path d="${Ro(5,5.8,2.5,12,12)}" fill="${I.cream}" stroke="none"/>`,gem:`
...
<path d="M9.6 5.1a3.4 3.4 0 0 0 .5 4.5" stroke="${I.cream}" stroke-width="1.4"/>`,star:`<path d="${Ro(5,9.4,4.1)}" fill="${I.mustard}"/>
...
<circle cx="12" cy="12.9" r="0.85" fill="${I.wood}" stroke="none"/>`,boxBurger:os(I.gold,I.mustard,I.ketchup,i1),boxPineapple:os(I.grape,I.grapeHi,I.mustard,n1),boxRed:os(I.ketchup,"#E9536A",I.mustard,s1),boxFire:os(I.grapeDark,I.grape,I.flame,o1),gift:`
...
<path d="M12 6.2c-2.6-3.4-6.2-2.4-5 .2M12 6.2c2.6-3.4 6.2-2.4 5 .2" fill="${I.mustard}" stroke-width="1.4"/>`,gear:`${r1}
...
<path d="M12 9.6v5.6M9.2 12.4h5.6" stroke="${I.cream}" stroke-width="2.1"/>`,stun:`<path d="${Ro(5,8.6,3.7,10.2,10.6)}" fill="${I.mustard}"/>
<path d="${Ro(5,4.2,1.8,19.2,18)}" fill="${I.mustardHi}" stroke-width="1.4"/>`,slow:`
...
<path d="M16.2 8.8 18.6 6.4" stroke-width="1.4"/>`},ut=416,yt=496,Oc=ut/yt,h1=.42,c1=.07,Ji=.08,d1=.66,p1=.08,Ha={x0:.035,x1:.965,y0:.045,y1:.725},u1=.7,Qi=.18,er=.92,f1=1.15,Za=new Map,tr=new Map,ul=[];let ar=!1;function m1(t){const a=document.createElement("canvas");a.width=8,a.height=8;const o=a.getContext("2d",{willReadFrequently:!0});if(!o)return[0,0,0];o.drawImage(t,0,0,8,8);const n=o.getImageData(0,0,8,8).data;let s=0,i=0,r=0;for(let h=0;h<n.length;h+=4)s+=n[h],i+=n[h+1],r+=n[h+2];const l=n.length/4;return[Math.round(s/l),Math.round(i/l),Math.round(r/l)]}function Ql(t){return Za.get(t)}function fl(){const t=[...Ee];if(typeof document>"u"||typeof window<"u"&&window.__screen==="characters")return t;const e=new Set;for(const a of document.querySelectorAll("[data-portrait]")){const o=a.dataset.portrait;Ee.includes(o)&&e.add(o)}return!e.size&&(typeof window>"u"||!window.__screen)?t:[...e]}function W0(t){for(const a of Ee){const o=Za.get(a);o&&t(a,o)}if(Ee.every(a=>Za.has(a))){window.__thumbsReady=!0;return}if(ul.push(t),ar)return;ar=!0,window.__thumbsReady=!1;const e=()=>void g1().finally(()=>{ar=!1,ul.length=0,window.__thumbsReady=fl().every(a=>Za.has(a))});typeof requestIdleCallback=="function"?requestIdleCallback(e,{timeout:600}):setTimeout(e,120)}async function g1(){if(!fl().some(a=>!Za.has(a)))return;const t=document.createElement("div");t.style.cssText=`position:fixed;left:-9999px;top:0;width:${ut}px;height:${yt}px;pointer-events:none;`,document.body.appendChild(t);let e=null;try{e=new Dl({container:t,background:0,fog:null,camera:{pitchDeg:12,yawDeg:24,frameMode:"subject",subjectHeight:2.1,subjectFill:1,targetHeight:1.05,followLerp:1},shadows:!1,postFx:"grade",offscreen:!0,maxPixelRatio:1}),e.canvas.style.cssText=`display:block;width:${ut}px;height:${yt}px;`,e.resize();const a=new Set;for(;;){const o=fl().filter(n=>!Za.has(n)&&!a.has(n));if(!o.length)break;for(const n of o)a.add(n),await b1(e,n)}}catch{}finally{e?.dispose(),t.remove()}}function dn(t,e,a,o){const n=new de,s=t.getCenter(n.clone()).applyMatrix4(e.matrixWorldInverse).z;let i=1/0,r=1/0,l=-1/0,h=-1/0;for(let c=0;c<8;c++){n.set(c&1?t.max.x:t.min.x,c&2?t.max.y:t.min.y,c&4?t.max.z:t.min.z).applyMatrix4(e.matrixWorldInverse),n.z=s,n.applyMatrix4(e.projectionMatrix);const d=(n.x*.5+.5)*a,p=(1-(n.y*.5+.5))*o;i=Math.min(i,d),l=Math.max(l,d),r=Math.min(r,p),h=Math.max(h,p)}return{x:+i.toFixed(1),y:+r.toFixed(1),w:+(l-i).toFixed(1),h:+(h-r).toFixed(1)}}function Nc(t,e){const a=t.getObjectByName(e);if(!a)return null;const o=new Tn().setFromObject(a);return o.isEmpty()?null:o}function w1(t,e,a){const o=new de;let n=0;return t.traverse(s=>{const i=s;if(!i.isMesh||!i.visible)return;const r=i.geometry?.getAttribute("position");if(r)for(let l=0;l<r.count;l++){if(o.fromBufferAttribute(r,l).applyMatrix4(i.matrixWorld),o.y<e)continue;const h=Math.abs(o.dot(a));h>n&&(n=h)}}),n}async function b1(t,e){const a=zl(e);t.scene.add(a.root),a.play("idle"),a.update({dt:.4,elapsed:.4,moveSpeed01:0,health01:1});const o=new Tn().setFromObject(a.root),n=Nc(a.root,"head"),s=Nc(a.root,"face"),i=Math.max(.5,o.max.y-o.min.y),r=o.max.y,l=(s??n)?.min.y??o.min.y+.45*i,h=Math.max(o.min.y,Math.min(o.min.y+h1*i,l-c1*i)),c=Math.max(.4,r-h),d=t.rig.camera,p=new de,u=(T,S,R)=>{t.rig.subjectFill=1,t.rig.subjectHeight=T,t.rig.targetHeight=S-T/2,t.rig.snapTo(R*p.x,R*p.z),d.updateMatrixWorld(!0),d.matrixWorldInverse.copy(d.matrixWorld).invert()};u(c/er,r+Ji*(c/er),0),p.setFromMatrixColumn(d.matrixWorld,0).normalize();const f=w1(a.root,h,p),m=Math.max(c/er,2*f/(Oc*f1),s?(r-s.min.y)/(d1+p1):0);let g=r+Ji*m,w=0,b=m;if(s){const T=()=>r-Qi*b;for(let S=0;S<4;S++){g=r+Ji*b;for(let z=0;z<3;z++){u(b,g,w);const Y=dn(s,d,ut,yt),O=(Y.y+Y.h)/yt-u1;if(O<=0)break;const _=Math.max(0,(Y.y/yt-Ha.y0)*b),H=Math.max(T(),g-Math.min(O*b,_));if(Math.abs(H-g)<1e-4)break;g=H}u(b,g,w);const R=dn(s,d,ut,yt),F=R.x+R.w-Ha.x1*ut,A=Ha.x0*ut-R.x,C=b*Oc/ut;F>0&&A<0?w+=Math.min(F,-A)*C:A>0&&F<0&&(w-=Math.min(A,-F)*C);const N=R.w/((Ha.x1-Ha.x0)*ut),L=(R.y+R.h)/yt,P=L>Ha.y1?(L+Qi)/(Ha.y1+Qi):1,j=Math.max(N,P);if(j<=1.001)break;b*=j}}u(b,g,w);const y=Hl[re[e].rarity];t.scene.background=new Kt(y),t.lighting.focus(0,0,4),tr.has(y)||(a.root.visible=!1,t.render(0),tr.set(y,m1(t.canvas)),a.root.visible=!0),t.render(0),t.render(0);const k=t.canvas.toDataURL("image/png"),x=a.root.getObjectByName("hips"),M=a.root.getObjectByName("shoulderL"),v=new de;(window.__thumbMeta??={})[e]={size:{w:ut,h:yt},subject:dn(o,d,ut,yt),head:n?dn(n,d,ut,yt):null,face:s?dn(s,d,ut,yt):null,bg:tr.get(y)??null,world:{minY:+o.min.y.toFixed(4),maxY:+o.max.y.toFixed(4),halfWidth:+Math.max(Math.abs(o.min.x),Math.abs(o.max.x)).toFixed(4),hipsY:x?+x.getWorldPosition(v).y.toFixed(4):null,shoulderY:M?+M.getWorldPosition(v).y.toFixed(4):null,headY:n?[+n.min.y.toFixed(4),+n.max.y.toFixed(4)]:null,faceY:s?[+s.min.y.toFixed(4),+s.max.y.toFixed(4)]:null,yCut:+h.toFixed(4),upperHalfWidth:+f.toFixed(4)},frame:{subjectHeight:+t.rig.subjectHeight.toFixed(4),subjectFill:+t.rig.subjectFill.toFixed(4),targetHeight:+t.rig.targetHeight.toFixed(4),headroom:+((g-r)/b).toFixed(4),pan:+w.toFixed(4)}},t.scene.remove(a.root),a.dispose(),Za.set(e,k);for(const T of ul)T(e,k);await new Promise(T=>setTimeout(T,0))}const y1='<circle cx="12" cy="9" r="5.6" fill="#FFF3DE"/><path d="M5.2 21.6c0-3.5 3-5.6 6.8-5.6s6.8 2.1 6.8 5.6z" fill="#FFF3DE"/>';function Ea(t,e={}){const a=Hl[re[t].rarity],o=Ql(t),n=["fa-ic-portrait",e.crop==="head"?"fa-ic-portrait--head":"",o?"has-render":"",e.class??""].filter(Boolean).join(" "),s=o?` src="${o}"`:"";return`<span class="${n}" data-portrait="${t}" style="--pc:${a}"><img alt=""${s}/><svg class="fa-ic" viewBox="0 0 24 24" fill="none" style="stroke:var(--fa-ic-ink,#1a1224)" stroke-width="1.7" stroke-linejoin="round" stroke-linecap="round" aria-hidden="true" focusable="false">${y1}</svg></span>`}function _o(t,e={}){const a=(o,n)=>{for(const s of t.querySelectorAll(`[data-portrait="${o}"]`)){const i=s.querySelector("img");i&&(i.getAttribute("src")!==n&&i.setAttribute("src",n),s.classList.add("has-render"))}};if(e.generate===!1){for(const o of t.querySelectorAll("[data-portrait]")){const n=o.dataset.portrait,s=Ql(n);s&&a(n,s)}return}W0(a)}const x1={...l1,...a1},v1='viewBox="0 0 24 24" fill="none" style="stroke:var(--fa-ic-ink,#1a1224)" stroke-width="1.7" stroke-linejoin="round" stroke-linecap="round"';function D(t,e={}){const a=x1[t];if(!a)return"";const o=["fa-ic",`fa-ic--${t}`,e.class??""].filter(Boolean).join(" "),n=e.size??"1em",s=e.label?`role="img" aria-label="${e.label}"`:'aria-hidden="true" focusable="false"';return`<svg class="${o}" ${v1} width="${n}" height="${n}" ${s}>${a}</svg>`}const k1={"🪙":"coin","💎":"gem","🏆":"trophy","⭐":"star","✨":"sparkle","🏁":"flag","📍":"pin","🎉":"party","🎁":"gift","🧑‍🍳":"chefhat","⚙️":"gear","⚙":"gear","🔒":"lock","▶":"play","⏸":"pause","◀":"back","🙂":"avatar","🚧":"cone","🔇":"mute","🔊":"sound","🏠":"home","🍟":"swap","❤️":"health","❤":"health","💨":"speed","↔":"range","⏱":"timer","💚":"heal","💫":"stun","🐌":"slow","🍖":"patty","🍅":"tomato","🥬":"lettuce","🧅":"onion","🍬":"candy","🥩":"meat","🌯":"wrap","🌀":"swirl","🥚":"egg","🐣":"chick","💥":"burst","🔨":"hammer","🍭":"lollipop","⚪":"dough","🧀":"cheese","🍚":"rice","🌿":"seaweed","🐟":"fish","🐡":"puffer","💦":"droplets","🍜":"noodle","🌊":"wave","🧊":"shards","🔵":"cap","💛":"mustardblast","🔴":"ketchupslip","⚔️":"slash","⚔":"damage","🍯":"honey","💧":"droplets"},M1={chest:"chest",hamburgerBox:"boxBurger",pineappleBox:"boxPineapple",redBox:"boxRed",fireBox:"boxFire"};function ya(t,e={}){const a=k1[t];return a?D(a,e):t}function At(t,e={}){return D(M1[t]??"chest",e)}function Y0(t,e={}){return ya(t,e)}const Lc="fa-icon-styles";function ha(){if(document.getElementById(Lc))return;const t=document.createElement("style");t.id=Lc,t.textContent=E1,document.head.appendChild(t)}const E1=`
...
`,Dc=[Gt.tomato,Gt.mustard,Gt.lettuce,Gt.cheese,Gt.glaze,Gt.waterCap];function qs(t,e=50,a=26){for(let o=0;o<a;o++){const n=document.createElement("span");n.className="fa-confetti",n.style.left=`${e+(Math.random()*12-6)}%`,n.style.background=Dc[Math.floor(Math.random()*Dc.length)],n.style.animationDelay=`${(Math.random()*.22).toFixed(2)}s`,n.style.setProperty("--x",`${Math.round(Math.random()*240-120)}px`),t.appendChild(n),setTimeout(()=>n.remove(),1800)}}function Fe(t,e,a){const o=document.createElement(t);return e&&(o.className=e),o}const T1="Kitchen Rumble";function S1(t){const e=Math.round(t/1e3);return`${Math.floor(e/60)}:${String(e%60).padStart(2,"0")}`}function A1(t){la("fa-home-styles",R1),ha();const e=Fe("div","fa-screen fa-home"),a=Kl();a.setScene("lobby"),e.innerHTML=`
    ...
    <footer class="home-bottom">
      ...
      <button class="home-mode" type="button" data-el="mode"
        ...
        <span class="home-mode-lines">
          <span class="home-mode-name">${T1}</span>
          <span class="home-mode-sub" data-el="modesub">${S1(Aa)} · last one standing</span>
        </span>
  ...
  `;const o=x=>{const M=e.querySelector(`[data-el="${x}"]`);if(!M)throw new Error(`home: missing element "${x}"`);return M},n=o("stage3d"),s=o("confetti"),i=o("heroname"),r=o("herorarity"),l=o("hint");let h=0;function c(){const x=t.profile.claimable.length,M=o("road"),v=o("roadfill");if(x>0){M.classList.add("is-ready"),o("roadicon").innerHTML=D("sparkle"),o("roadtitle").textContent=x>1?`${x} rewards ready`:"Reward ready",o("roadsub").textContent="Tap to claim",o("roadpill").textContent="Claim",v.style.width="100%";return}M.classList.remove("is-ready");const{progress01:T,next:S}=S0(t.profile.trophies);if(v.style.width=`${(T*100).toFixed(1)}%`,!S){o("roadicon").innerHTML=D("flag"),o("roadtitle").textContent="Road complete",o("roadsub").textContent="Every reward claimed",o("roadpill").innerHTML=`${D("trophy")} ${t.profile.trophies.toLocaleString()}`;return}const R=hl(S.reward,t.profile.unlocked);o("roadicon").innerHTML=S.reward.type==="character"?Ea(S.reward.id,{crop:"head"}):S.reward.type==="container"?At(S.reward.kind):ya(R.emoji),_o(e),o("roadtitle").textContent=R.title,o("roadsub").textContent=`${(S.trophies-t.profile.trophies).toLocaleString()} trophies to go`,o("roadpill").innerHTML=`${D("trophy")} ${S.trophies.toLocaleString()}`}function d(){const x=t.profile.winsToNextChest,M=ct.winsPerChest,v=Math.max(0,Math.min(M,M-x));o("chestsub").textContent=x===0?"Ready on your next win":`${x} more ${x===1?"win":"wins"}`,o("pips").innerHTML=Array.from({length:M},(T,S)=>`<span class="home-pip${S<v?" is-on":""}"></span>`).join("")}function p(){const x=t.profile.containerCount,M=o("held");M.hidden=x===0,x>0&&(o("heldtitle").textContent=x===1?"1 chest held":`${x} chests held`)}const u=[["damage","Damage","damage","#FF8A96"],["health","Health","health","#8FE04A"],["speed","Speed","speed","#6FC8F5"]];function f(){const x=re[t.profile.selected];o("stats").innerHTML=u.map(([M,v,T,S])=>`
      <div class="fa-stat ds-row ds-row--slate home-stat" style="--ds-row-accent:${S}">
        <span class="ds-tile ds-tile--stat" style="--ds-tile-fill:${S}">${D(M)}</span>
        <span class="ds-row-body">
          <span class="ds-row-label">${v}</span>
      ...
      </button>`).join("");const M=o("kitcap"),v=x.abilities[h];M.innerHTML=v?`<span class="home-kit-capname">${v.name}</span><span>${v.desc}</span>`:"",g()}function g(){const x=o("kit"),M=x.children[h];if(!M)return;const v=x.getBoundingClientRect(),T=M.getBoundingClientRect();if(v.width<=0||T.width<=0)return;const S=T.left+T.width/2,R=getComputedStyle(x).direction==="rtl"?(v.right-S)/v.width:(S-v.left)/v.width;o("kitcap").style.setProperty("--home-cap-x",`${(R*100).toFixed(1)}%`)}function w(){const x=re[t.profile.selected];o("name").textContent=t.profile.name,o("trophies").textContent=t.profile.trophies.toLocaleString(),o("coins").textContent=t.profile.coins.toLocaleString(),c(),d(),p(),f(),o("wins").textContent=t.profile.wins.toLocaleString(),o("losses").textContent=t.profile.losses.toLocaleString(),o("best").textContent=t.profile.bestTrophies.toLocaleString(),o("lv").textContent=`Lv ${t.profile.level}`,o("lvnext").textContent=`Lv ${t.profile.level+1}`,o("lvfill").style.width=`${(t.profile.levelProgress01*100).toFixed(1)}%`,o("lvxp").textContent=`${t.profile.xp%xn} / ${xn} XP`,i.textContent=x.name,r.textContent=x.rarity,r.style.background=Nt[x.rarity],a.show(x.id)}const b=x=>{const M=x.target,v=M.closest("[data-kit]");if(v){const R=Number(v.dataset.kit);Number.isInteger(R)&&(h=R,m());return}const T=M.closest("[data-go]");if(!T)return;const S=T.dataset.go;S==="characters"?t.navigate({name:"characters"}):S==="trophies"?t.navigate({name:"trophies"}):S==="shop"&&t.navigate({name:"shop"})};e.addEventListener("click",b),o("start").addEventListener("click",()=>{t.navigate({name:"characters"})}),o("mode").addEventListener("click",()=>{t.navigate({name:"lobby"})}),o("settings").addEventListener("click",()=>{t.navigate({name:"settings"})}),o("stage").addEventListener("click",()=>{a.poke(),qs(s,50,18)}),setTimeout(()=>l.classList.add("is-faded"),4200);const y=t.profile.onChange(w);w(),a.attachTo(n);const k=requestAnimationFrame(()=>g());return{root:e,update(x){a.update(x)},resize(){a.resize(),g()},dispose(){y(),cancelAnimationFrame(k),e.removeEventListener("click",b),a.setScene("portrait"),a.detach(),e.remove()}}}const R1=`
/* ═══════════════════════════════════════════════════════════════════════════
...
`,I1=4500,C1=["No","One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen","Twenty"];function F1(t){return C1[t]??String(t)}function O1(){const t=new URLSearchParams(location.search).get("hold"),e=t===null?NaN:Number(t);return Number.isFinite(e)&&e>=0?e:I1}function N1(t){la("fa-opening-styles",L1),ha();const e=Fe("div","fa-screen fa-opening"),a=Kl();e.innerHTML=`
    <header class="open-head">
      <h1 class="open-title">Food Fight Arena</h1>
      <p class="open-tagline">${F1(Ee.length)} fighters. One kitchen. No table manners.</p>
    </header>
...
`,D1=.15,z1=44,H1=78,_1=5,P1=10,zc=.5,Hc="touch-styles";function $1(){return typeof window>"u"?!1:typeof navigator<"u"&&(navigator.maxTouchPoints??0)>0?!0:"ontouchstart"in window}function B1(){return typeof window.matchMedia!="function"?!1:window.matchMedia("(pointer: coarse)").matches}function q1(){const t=Math.min(window.innerWidth,window.innerHeight);return Math.max(z1,Math.min(H1,t*D1))}function U1(t,e,a){const o=Math.max(Math.abs(t),Math.abs(e)),n=o>1e-6?Math.min(1,Math.hypot(t,e))/o:0;return a.x=Math.max(-1,Math.min(1,t*n)),a.y=Math.max(-1,Math.min(1,e*n)),a}function _c(){return{id:null,baseX:0,baseY:0,curX:0,curY:0}}function j1(t){const e=$1(),a=_c(),o=_c(),n={x:0,y:0},s={x:0,y:-1};let i=!1,r=!1,l=!1,h=0,c="",d="";if(!e)return{available:!1,get engaged(){return!1},move:n,get moving(){return!1},aimDir:()=>null,get firing(){return!1},clearAim(){},reset(){},dispose(){}};G1();const p=document.createElement("div");p.className="tch-root",p.innerHTML='<div class="tch-stick tch-stick--move" data-el="move-stick"><div class="tch-knob"></div></div><div class="tch-stick tch-stick--aim" data-el="aim-stick"><div class="tch-knob"></div></div><div class="tch-hint tch-hint--move" data-el="move-hint"><div class="tch-hint-ring"></div><div class="tch-hint-label">MOVE</div></div><div class="tch-hint tch-hint--aim" data-el="aim-hint"><div class="tch-hint-ring"></div><div class="tch-hint-label">AIM &amp; FIRE</div></div>',document.body.appendChild(p);const u=H=>p.querySelector('[data-el="'+H+'"]'),f=u("move-stick"),m=u("aim-stick"),g=u("move-hint"),w=u("aim-hint");B1()&&(p.classList.add("is-hinted"),document.documentElement.classList.add("fa-touch-capable"));const y=t.canvas.parentElement,k=t.canvas.style.touchAction,x=y?y.style.touchAction:"";t.canvas.style.touchAction="none",y&&(y.style.touchAction="none");function M(H){if(!(H instanceof Node))return!1;const K=t.canvas;return H===K||K.contains(H)||H.contains(K)}function v(){return q1()}function T(H,K){const ce=v();let se=H.curX-H.baseX,$=H.curY-H.baseY;const ee=Math.hypot(se,$);if(ee>ce){const Se=ce/ee;H.baseX=H.curX-se*Se,H.baseY=H.curY-$*Se,se*=Se,$*=Se}const ye=Math.hypot(se,$);return K.x=se,K.y=$,ye}const S={x:0,y:0},R=[];function F(H){const K=R.indexOf(H);K>=0&&R.splice(K,1)}function A(H,K){for(let ce=0;ce<H.length;ce++)if(H[ce].identifier===K)return H[ce];return null}function C(H,K,ce){for(let se=R.length-1;se>=0;se--){const $=A(ce,R[se]);if(!$){R.splice(se,1);continue}if($.clientX<window.innerWidth*zc===K){R.splice(se,1),H.id=$.identifier,H.baseX=$.clientX,H.baseY=$.clientY,H.curX=$.clientX,H.curY=$.clientY;return}}}function N(){if(a.id===null){n.x=0,n.y=0;return}if(T(a,S)<_1){n.x=0,n.y=0;return}const K=v();U1(S.x/K,S.y/K,n)}function L(){if(o.id===null)return;const H=T(o,S);H<P1||(s.x=S.x/H,s.y=S.y/H,i=!0)}function P(H,K,ce){if(K.id===null)return ce!==""&&(H.style.display="none"),"";const se=K.curX-K.baseX,$=K.curY-K.baseY,ee=v(),ye=Math.hypot(se,$),Se=ye>ee?ee/ye:1,Ye=Math.round(K.baseX),mo=Math.round(K.baseY),Wn=Math.round(K.baseX+se*Se),Yn=Math.round(K.baseY+$*Se),Zo=Ye+","+mo+","+Wn+","+Yn+","+Math.round(ee);if(Zo===ce)return Zo;ce===""&&(H.style.display="block"),H.style.setProperty("--r",ee.toFixed(0)+"px"),H.style.transform="translate("+Ye+"px,"+mo+"px) translate(-50%,-50%)";const Vn=H.firstElementChild;return Vn&&(Vn.style.transform="translate("+(Wn-Ye)+"px,"+(Yn-mo)+"px) translate(-50%,-50%)"),Zo}function j(){if(c=P(f,a,c),d=P(m,o,d),a.id===null&&o.id===null){h=0;return}h=requestAnimationFrame(j)}function z(){!h&&!l&&(h=requestAnimationFrame(j))}const Y=H=>{if(l)return;let K=!1;for(let ce=0;ce<H.changedTouches.length;ce++){const se=H.changedTouches[ce];if(!M(se.target))continue;const $=se.clientX<window.innerWidth*zc,ee=$?a:o;if(ee.id!==null){R.includes(se.identifier)||R.push(se.identifier),K=!0;continue}ee.id=se.identifier,ee.baseX=se.clientX,ee.baseY=se.clientY,ee.curX=se.clientX,ee.curY=se.clientY,K=!0,$?g.classList.add("is-used"):w.classList.add("is-used")}K&&(r||(r=!0,document.documentElement.classList.add("fa-touch")),N(),L(),z(),H.preventDefault())},O=H=>{if(l)return;let K=!1;for(let ce=0;ce<H.changedTouches.length;ce++){const se=H.changedTouches[ce];se.identifier===a.id?(a.curX=se.clientX,a.curY=se.clientY,K=!0):se.identifier===o.id?(o.curX=se.clientX,o.curY=se.clientY,K=!0):R.includes(se.identifier)&&(K=!0)}K&&(N(),L(),z(),H.preventDefault())},_=H=>{if(l)return;let K=!1;for(let ce=0;ce<H.changedTouches.length;ce++){const se=H.changedTouches[ce];se.identifier===a.id?(a.id=null,C(a,!0,H.touches),K=!0):se.identifier===o.id?(o.id=null,C(o,!1,H.touches),K=!0):R.includes(se.identifier)&&(F(se.identifier),K=!0)}K&&(N(),L(),z())};return window.addEventListener("touchstart",Y,{passive:!1}),window.addEventListener("touchmove",O,{passive:!1}),window.addEventListener("touchend",_),window.addEventListener("touchcancel",_),{available:!0,get engaged(){return r},move:n,get moving(){return a.id!==null},aimDir:()=>i?s:null,get firing(){return o.id!==null},clearAim(){o.id===null&&(i=!1)},reset(){a.id=null,o.id=null,R.length=0,n.x=0,n.y=0,i=!1,z()},dispose(){l||(l=!0,cancelAnimationFrame(h),window.removeEventListener("touchstart",Y),window.removeEventListener("touchmove",O),window.removeEventListener("touchend",_),window.removeEventListener("touchcancel",_),R.length=0,t.canvas.style.touchAction=k,y&&(y.style.touchAction=x),document.documentElement.classList.remove("fa-touch","fa-touch-capable"),p.remove())}}}function G1(){if(document.getElementById(Hc))return;const t=document.createElement("style");t.id=Hc,t.textContent=W1,document.head.appendChild(t)}const W1=`
.tch-root {
  position: fixed;
  inset: 0;
  z-index: 25;
...
`,Yt={left:["KeyA","ArrowLeft"],right:["KeyD","ArrowRight"],up:["KeyW","ArrowUp"],down:["KeyS","ArrowDown"]},eh="KeyM",th=9,Y1=.155,V1=84,K1=190;function X1(t){const e=new URLSearchParams(location.search).get(t);if(e===null)return null;const a=Number(e);return Number.isFinite(a)?a:null}class Z1{constructor(e){this.canvas=e;const a=X1("aimSens");this.sensitivity=a!==null&&a>0?Math.min(6,a):1,this.freeAim=new URLSearchParams(location.search).get("aimMode")==="free",this.touch=j1({canvas:e}),window.addEventListener("keydown",this.onKeyDown),window.addEventListener("keyup",this.onKeyUp),window.addEventListener("blur",this.onBlur),document.addEventListener("visibilitychange",this.onVisibilityChange),e.addEventListener("mousemove",this.onMouseMove),e.addEventListener("mousedown",this.onMouseDown),window.addEventListener("mouseup",this.onMouseUp),e.addEventListener("contextmenu",this.onContextMenu)}keys=new Set;mouseDown=!1;ndcX=0;ndcY=0;hasMouse=!1;weaponIndex=0;weaponCount=1;locked=!1;offX=0;offY=0;clientX=0;clientY=0;sensitivity;freeAim;touch;touchOffset={x:0,y:0};setWeaponCount(e){this.weaponCount=Math.max(1,e),this.weaponIndex>=this.weaponCount&&(this.weaponIndex=0)}get selectedWeapon(){return this.weaponIndex}selectWeapon(e){!Number.isInteger(e)||e<0||e>=this.weaponCount||(this.weaponIndex=e)}get touchEngaged(){return this.touch.engaged}get attackHeld(){return this.mouseDown||this.touch.firing}get mouseNdc(){return this.hasMouse&&!this.locked?{x:this.ndcX,y:this.ndcY}:null}get pointerLocked(){return this.locked}get aimOffsetPx(){const e=this.touch.aimDir();if(e){const a=this.aimRadiusPx();return this.touchOffset.x=e.x*a,this.touchOffset.y=e.y*a,this.touchOffset}return this.locked?{x:this.offX,y:this.offY}:null}setPointerLocked(e){e!==this.locked&&(this.locked=e,e&&(this.hasMouse?(this.offX=this.clientX-window.innerWidth/2,this.offY=this.clientY-window.innerHeight/2):(this.offX=0,this.offY=-this.aimRadiusPx()),this.clampOffset(),this.hasMouse=!0))}moveAxes(){let e=0,a=0;return this.keyDown(Yt.left)&&(e-=1),this.keyDown(Yt.right)&&(e+=1),this.keyDown(Yt.up)&&(a-=1),this.keyDown(Yt.down)&&(a+=1),this.touch.moving&&(e=Math.max(-1,Math.min(1,e+this.touch.move.x)),a=Math.max(-1,Math.min(1,a+this.touch.move.y))),{x:e,y:a}}reset(){this.keys.clear(),this.mouseDown=!1,this.touch.reset(),this.locked&&(this.offX=0,this.offY=-this.aimRadiusPx())}dispose(){this.touch.dispose(),window.removeEventListener("keydown",this.onKeyDown),window.removeEventListener("keyup",this.onKeyUp),window.removeEventListener("blur",this.onBlur),document.removeEventListener("visibilitychange",this.onVisibilityChange),this.canvas.removeEventListener("mousemove",this.onMouseMove),this.canvas.removeEventListener("mousedown",this.onMouseDown),window.removeEventListener("mouseup",this.onMouseUp),this.canvas.removeEventListener("contextmenu",this.onContextMenu)}aimRadiusPx(){const e=Math.min(window.innerWidth,window.innerHeight);return Math.max(V1,Math.min(K1,e*Y1))}clampOffset(){if(this.freeAim){const n=window.innerWidth/2,s=window.innerHeight/2;this.offX=Math.max(-n,Math.min(n,this.offX)),this.offY=Math.max(-s,Math.min(s,this.offY));return}const e=this.aimRadiusPx(),a=Math.hypot(this.offX,this.offY);if(a<=e){a<.001&&(this.offY=-e);return}const o=e/a;this.offX*=o,this.offY*=o}keyDown(e){return e.some(a=>this.keys.has(a))}onKeyDown=e=>{this.keys.add(e.code);const a=Number(e.key);if(Number.isInteger(a)&&a>=1&&a<=th){const o=a-1;o<this.weaponCount&&(this.weaponIndex=o)}e.code===eh&&!e.repeat&&!e.ctrlKey&&!e.metaKey&&!e.altKey&&ke.toggleMuted()};onKeyUp=e=>{this.keys.delete(e.code)};onMouseMove=e=>{if(this.touch.clearAim(),this.locked){this.offX+=(e.movementX??0)*this.sensitivity,this.offY+=(e.movementY??0)*this.sensitivity,this.clampOffset(),this.hasMouse=!0;return}const a=this.canvas.getBoundingClientRect();this.clientX=e.clientX,this.clientY=e.clientY,this.ndcX=(e.clientX-a.left)/a.width*2-1,this.ndcY=-((e.clientY-a.top)/a.height*2-1),this.hasMouse=!0};onMouseDown=e=>{e.button===0&&(this.mouseDown=!0)};onMouseUp=e=>{e.button===0&&(this.mouseDown=!1)};onBlur=()=>{this.keys.clear(),this.mouseDown=!1,this.touch.reset()};onVisibilityChange=()=>{document.visibilityState==="hidden"&&this.onBlur()};onContextMenu=e=>{e.preventDefault()}}const Pc=16241663,J1=14711797,Q1=12872686,Io=2755399,eb=.34,ns=3.2,tb=6.5;function ab(t){return W.clamp(t*.3,J,tb)}const ob=.5,je=128,ah=Gf+Wf,nb=[{offset:-14,color:Pc,alpha:0},{offset:-1,color:Pc,alpha:.9},{offset:7,color:J1,alpha:.85},{offset:34,color:5906060,alpha:.3},{offset:150,color:Io,alpha:.18},{offset:0,absolute:ah,color:Io,alpha:.18}],sb=[{offset:12,color:Io,alpha:0},{offset:44,color:Io,alpha:.6},{offset:140,color:Io,alpha:.72},{offset:0,absolute:ah,color:Io,alpha:.72}];function ib(){const a=document.createElement("canvas");a.width=64,a.height=256;const o=a.getContext("2d"),n=o.createImageData(64,256);let s=2654435769;const i=()=>(s=s*1664525+1013904223>>>0,s/4294967295),r=new Float32Array(64);for(let h=0;h<64;h++)r[h]=.18+.82*i();for(let h=0;h<256;h++){const c=1-h/255,d=Math.pow(1-c,2.6);for(let p=0;p<64;p++){const u=.85+.15*Math.sin(p*.9+c*5),f=Math.max(0,Math.min(1,d*r[p]*u)),m=(h*64+p)*4,g=Math.pow(1-c,3);n.data[m]=255,n.data[m+1]=Math.round(190+65*g),n.data[m+2]=255,n.data[m+3]=Math.round(f*255)}}o.putImageData(n,0,0);const l=new et(a);return l.wrapS=Qr,l.wrapT=tl,l.needsUpdate=!0,l}function $c(t,e,a,o){const n=t.length*je,s=new Float32Array(n*3),i=new Float32Array(n*4),r=[],l=new Float32Array(je),h=new Float32Array(je);for(let m=0;m<je;m++){const g=m/je*Math.PI*2;l[m]=Math.cos(g),h[m]=Math.sin(g)}const c=new Kt;for(let m=0;m<t.length;m++){c.setHex(t[m].color);for(let g=0;g<je;g++){const w=m*je+g;s[w*3+1]=0,i[w*4]=c.r,i[w*4+1]=c.g,i[w*4+2]=c.b,i[w*4+3]=t[m].alpha}}for(let m=0;m<t.length-1;m++)for(let g=0;g<je;g++){const w=(g+1)%je;r.push(m*je+g,(m+1)*je+g,m*je+w),r.push(m*je+w,(m+1)*je+g,(m+1)*je+w)}const d=new Dn,p=new En(s,3);p.setUsage(Uf),d.setAttribute("position",p),d.setAttribute("color",new En(i,4)),d.setIndex(r),d.boundingSphere=new jf(new de,Je(ah)*1.2);const u=new V({vertexColors:!0,transparent:!0,depthWrite:!1,side:me,toneMapped:!1}),f=new E(d,u);return f.name=`${o}__no_outline`,f.userData.noOutline=!0,f.renderOrder=a,f.frustumCulled=!1,f.castShadow=!1,f.receiveShadow=!1,f.position.y=e,{mesh:f,setRadius(m){for(let g=0;g<t.length;g++){const w=t[g],b=w.absolute!==void 0?Math.max(w.absolute,m+200):Math.max(0,m+w.offset),y=Je(b),k=g*je;for(let x=0;x<je;x++){const M=(k+x)*3;s[M]=l[x]*y,s[M+2]=h[x]*y}}p.needsUpdate=!0},setOpacity(m){u.opacity=m},dispose(){d.dispose(),u.dispose()}}}function rb(t){const e=new ie;e.name="fog_boundary";const a=Le(t.x,t.y);e.position.set(a.x,0,a.z),e.frustumCulled=!1;const o=$c(nb,eb,6,"fog_edge"),n=$c(sb,ns,8,"fog_canopy");e.add(o.mesh);const s=ib(),i=new Me(1,1,1,je,1,!0),r=new V({map:s,color:Q1,transparent:!0,opacity:.82,depthWrite:!1,side:me,toneMapped:!1}),l=new E(i,r);l.name="fog_curtain__no_outline",l.userData.noOutline=!0,l.renderOrder=7,l.frustumCulled=!1,l.castShadow=!1,l.receiveShadow=!1,e.add(l),e.add(n.mesh);let h=0,c=0;return{root:e,update(d,p,u,f){const m=Math.min(.25,Math.max(0,p-c));if(c=p,h=u&&d>=0?1:Math.max(0,h-m/ob),e.visible=h>.002,!e.visible)return;const w=Math.max(0,d);o.setRadius(w),n.setRadius(w),o.setOpacity(h),n.setOpacity(h);const b=f.camera.position.y,y=W.clamp(b>ns?(b-ns)/b:0,.05,1);n.mesh.scale.set(y,1,y),n.mesh.position.set((1-y)*(f.camera.position.x-e.position.x),ns,(1-y)*(f.camera.position.z-e.position.z));const k=Je(w),x=ab(k);l.scale.set(k,x,k),l.position.y=x/2;const M=2*Math.PI*k;s.repeat.x=Math.max(6,Math.round(M/5)),s.offset.x=p*.035%1,r.opacity=(.82+.1*Math.sin(p*2.1))*h},dispose(){o.dispose(),n.dispose(),i.dispose(),r.dispose(),s.dispose(),e.clear()}}}function gi(t,e,a,o,n,s,i,r){return Math.abs(t-n)<(a+i)/2&&Math.abs(e-s)<(o+r)/2}function Us(t,e,a,o){for(let n=0;n<o.length;n++){const s=o[n];if(Math.abs(t-s.x)<(a+s.w)/2&&Math.abs(e-s.y)<(a+s.h)/2)return!0}return!1}const V0=[];function K0(t){return t.concealment??V0}function lb(t,e){if(!e)return!1;const a=e.brokenConcealment;for(let o=0;o<a.length;o++)if(a[o]===t)return!0;return!1}function hb(t,e,a,o){const n=K0(a);for(let s=0;s<n.length;s++){const i=n[s];if(gi(t,e,0,0,i.x,i.y,i.w,i.h)&&!lb(i,o))return!0}return!1}function X0(t,e,a,o,n){return o&&n&&o.elapsed<n.revealedUntil?!1:hb(t,e,a,o)}function oh(t,e,a,o,n,s,i){return X0(a,o,n,s,i)?Math.hypot(a-t,o-e)<=Yf:!0}function cb(t,e,a,o){const n=K0(a);let s=null;for(let i=0;i<n.length;i++){const r=n[i];gi(t,e,0,0,r.x,r.y,r.w,r.h)&&(o.includes(r)||(o.push(r),(s??=[]).push(r)))}return s??V0}function Z0(t,e,a,o){let n=1;for(const s of a.hazards)s.kind==="slow"&&Math.hypot(t-s.x,e-s.y)<s.radius&&(n=Math.min(n,s.slowFactor??Yh));for(const s of o)Math.hypot(t-s.x,e-s.y)<al&&(n=Math.min(n,Yh));return n}const db=d0,pb=1e-6;function ml(t,e,a,o){if(!(o>0))return;const n=Math.hypot(e,a);if(n<pb)return;const s=t.push;s.x=e/n,s.y=a/n,s.remaining=Math.min(db,s.remaining+o)}function ub(t,e,a,o){const n=t.push;if(n.remaining<=0)return!1;const s=c0*e,i=n.remaining<s?n.remaining:s;n.remaining-=i;const r=Ul(t,o)?!1:js(t,n.x*i,n.y*i,a);return n.remaining<=0&&(n.remaining=0,n.x=0,n.y=0),r}const fb=4,Bc=.01;function mb(t,e){const a=t.size,o=a/2,n=e.cover;for(let s=0;s<fb;s++){let i=null,r=0;for(let c=0;c<n.length;c++){const d=n[c],p=(a+d.w)/2-Math.abs(t.x-d.x);if(p<=0)continue;const u=(a+d.h)/2-Math.abs(t.y-d.y);if(u<=0)continue;const f=p<u?p:u;f>r&&(r=f,i=d)}if(i===null)return;const l=(a+i.w)/2-Math.abs(t.x-i.x),h=(a+i.h)/2-Math.abs(t.y-i.y);if(l<=h){const c=t.x>=i.x?1:-1;t.x=Math.min(e.width-o,Math.max(o,t.x+c*(l+Bc)))}else{const c=t.y>=i.y?1:-1;t.y=Math.min(e.height-o,Math.max(o,t.y+c*(h+Bc)))}}}function js(t,e,a,o){const n=t.size/2,s=t.x,i=t.y;if((e!==0||a!==0)&&mb(t,o),e!==0){const r=Math.min(o.width-n,Math.max(n,t.x+e));Us(r,t.y,t.size,o.cover)||(t.x=r)}if(a!==0){const r=Math.min(o.height-n,Math.max(n,t.y+a));Us(t.x,r,t.size,o.cover)||(t.y=r)}return t.x!==s||t.y!==i}const gb=10,wb=4e4,J0=16,bb=8,yb=4,qc=new WeakMap;function xb(t,e){const a=qc.get(t);if(a&&a.size===e&&a.cover===t.cover)return a;let o=gb;for(;Math.ceil(t.width/o)*Math.ceil(t.height/o)>wb;)o*=2;const n=Math.max(1,Math.ceil(t.width/o)),s=Math.max(1,Math.ceil(t.height/o)),i=n*s,r=new Uint8Array(i),l=e/2;for(let c=0;c<s;c++)for(let d=0;d<n;d++){const p=(d+.5)*o,u=(c+.5)*o;p>=l&&p<=t.width-l&&u>=l&&u<=t.height-l&&!Us(p,u,e,t.cover)&&(r[c*n+d]=1)}const h={cell:o,cols:n,rows:s,size:e,cover:t.cover,passable:r,dist:new Int32Array(i),queue:new Int32Array(i),chain:new Int32Array(J0+1),goalCell:-1,requestedGoal:-1};return qc.set(t,h),h}function or(t,e){const{cols:a,rows:o,passable:n,dist:s,queue:i}=t;s.fill(-1),t.goalCell=e,s[e]=0,i[0]=e;let r=0,l=1;for(;r<l;){const h=i[r++],c=h%a,d=(h-c)/a,p=s[h]+1;for(let u=-1;u<=1;u++){const f=d+u;if(f<0||f>=o)continue;const m=f*a;for(let g=-1;g<=1;g++){if(g===0&&u===0)continue;const w=c+g;if(w<0||w>=a)continue;const b=m+w;n[b]===0||s[b]>=0||g!==0&&u!==0&&(n[d*a+w]===0||n[m+c]===0)||(s[b]=p,i[l++]=b)}}}}function Uc(t,e,a,o,n){const{cols:s,rows:i,passable:r,dist:l}=t;if(e>=0&&e<s&&a>=0&&a<i){const h=a*s+e;if(r[h]===1)return h}for(let h=1;h<=o;h++)for(let c=-h;c<=h;c++){const d=a+c;if(d<0||d>=i)continue;const p=Math.abs(c)===h;for(let u=-h;u<=h;u+=p?1:2*h){const f=e+u;if(f<0||f>=s)continue;const m=d*s+f;if(r[m]===1)return m}}return-1}function jc(t,e,a,o,n,s){const i=a-t,r=o-e,l=Math.max(1,Math.ceil(Math.hypot(i,r)/(n*.4)));for(let h=1;h<=l;h++){const c=h/l;if(Us(t+i*c,e+r*c,n,s))return!1}return!0}const xa={dirX:0,dirY:0,wpX:0,wpY:0};function vb(t,e,a,o){const n=xb(t,e.size),{cell:s,cols:i,rows:r,dist:l,chain:h}=n,c=e.size/2,d=Math.min(t.width-c,Math.max(c,a)),p=Math.min(t.height-c,Math.max(c,o)),u=Uc(n,Math.min(i-1,Math.max(0,Math.floor(d/s))),Math.min(r-1,Math.max(0,Math.floor(p/s))),bb);if(u<0)return!1;const f=Uc(n,Math.min(i-1,Math.max(0,Math.floor(e.x/s))),Math.min(r-1,Math.max(0,Math.floor(e.y/s))),yb);if(f<0)return!1;if(n.requestedGoal!==u||l[f]<0){if(or(n,u),l[f]<0){or(n,f);let M=f,v=1/0;for(let T=0;T<l.length;T++){if(l[T]<0)continue;const S=T%i,R=(S+.5)*s-d,F=((T-S)/i+.5)*s-p,A=R*R+F*F;A<v&&(v=A,M=T)}or(n,M)}n.requestedGoal=u}if(l[f]<0)return!1;let m=f,g=0;for(;g<J0&&l[m]>0;){const M=m%i,v=(m-M)/i,T=l[m];let S=-1,R=T,F=1/0;for(let A=-1;A<=1;A++){const C=v+A;if(C<0||C>=r)continue;const N=C*i;for(let L=-1;L<=1;L++){if(L===0&&A===0)continue;const P=M+L;if(P<0||P>=i)continue;const j=N+P,z=l[j];if(z<0||z>=T||L!==0&&A!==0&&(n.passable[v*i+P]===0||n.passable[N+M]===0))continue;const Y=(P+.5)*s-d,O=(C+.5)*s-p,_=Y*Y+O*O;(z<R||z===R&&_<F)&&(R=z,F=_,S=j)}}if(S<0)break;h[g++]=S,m=S}let w,b;if(g===0)w=d,b=p;else{let M=0;for(let R=1;R<g;R++){const F=h[R],A=F%i,C=(F-A)/i;if(!jc(e.x,e.y,(A+.5)*s,(C+.5)*s,e.size,t.cover))break;M=R}const v=h[M],T=v%i,S=(v-T)/i;w=(T+.5)*s,b=(S+.5)*s,M===g-1&&l[v]===0&&jc(e.x,e.y,d,p,e.size,t.cover)&&(w=d,b=p)}const y=w-e.x,k=b-e.y,x=Math.hypot(y,k);return x<1e-6?!1:(xa.dirX=y/x,xa.dirY=k/x,xa.wpX=w,xa.wpY=b,!0)}function Gc(t,e,a,o,n,s,i){const r=t.x,l=t.y;let h=e,c=a,d=s,p=i;vb(n,t,s,i)&&(h=xa.dirX,c=xa.dirY,d=xa.wpX,p=xa.wpY);const u=(M,v)=>Math.hypot(M-d,v-p),f=u(r,l);js(t,h*o,c*o,n);const m=t.x,g=t.y;if(f-u(m,g)>=o*.35)return t.detourSign=0,!0;const w=M=>{t.x=r,t.y=l;const v=-c*M+h*.3,T=h*M+c*.3,S=Math.hypot(v,T)||1;return js(t,v/S*o,T/S*o,n),Math.hypot(t.x-r,t.y-l)};if(t.detourSign!==0&&w(t.detourSign)>=o*.35)return!0;const b=w(1),y=t.x,k=t.y,x=w(-1);if(b>=x){if(b>=o*.35)return t.detourSign=1,t.x=y,t.y=k,!0}else if(x>=o*.35)return t.detourSign=-1,!0;return t.detourSign=0,t.x=m,t.y=g,m!==r||g!==l}const kb=180/Math.PI,Mb=Math.PI/180,Eb=1e-6;function nh(t,e){return re[e.characterId].hasTrail?t.trailMarks.some(a=>a.ownerId===e.id&&Math.hypot(e.x-a.x,e.y-a.y)<It.radius):!1}function Gs(t,e){return e==="stun"?t.status.stunnedUntil+Vf:t.status.slowedUntil+Kf}function gl(t,e,a){const o=t.status,n=e==="stun"?o.stunAppliedAt:o.slowAppliedAt,s=e==="stun"?o.stunStacks:o.slowStacks,i=a-n>=em;return Math.min(i?0:s+1,p0.length-1)}function Wc(t,e,a,o){return o*p0[gl(t,e,a)]}function Yc(t,e,a){const o=t.cast;o!==null&&(t.cast=null,a.push({type:"cast-cancelled",fighterRole:t.role,fighterId:t.id,weaponKey:re[t.characterId].weapons[o.weaponIndex].key,reason:e}))}function Tb(t,e,a,o){const n=o.knockback??0;n>0&&ml(a,a.x-e.x,a.y-e.y,n);const s=o.lure??0;if(s>0){const i=a.x,r=a.y;for(const l of t.fighters){if(!ci(l,e))continue;const h=i-l.x,c=r-l.y,d=Math.hypot(h,c);ml(l,h,c,s<d?s:d)}}}function Ja(t,e,a,o,n,s){if(!e.alive)return;const i=n.kind==="weapon"?t.fighters[n.attackerId]:n.kind==="trail"?t.fighters[n.ownerId]:null,r=i?a*i.damageMul:a;if(e.hp=Math.max(0,e.hp-r),e.lastDamagedAt=t.elapsed,o==="slow"){if(t.elapsed>=Gs(e,"slow")){const l=Wc(e,"slow",t.elapsed,Jf);l>0&&(e.status.slowStacks=gl(e,"slow",t.elapsed),e.status.slowAppliedAt=t.elapsed,e.status.slowedUntil=t.elapsed+l)}}else if(o==="stun"){const l=t.elapsed>=Gs(e,"stun")?Wc(e,"stun",t.elapsed,Qf):0;l>0&&(e.status.stunStacks=gl(e,"stun",t.elapsed),e.status.stunAppliedAt=t.elapsed,e.status.stunnedUntil=t.elapsed+l,e.cast!==null&&Yc(e,"stun",s))}if(i!=null&&n.kind==="weapon"){const l=re[i.characterId].weapons.find(h=>h.key===n.weaponKey);l!==void 0&&Tb(t,i,e,l)}if(s.push({type:"hit-landed",targetRole:e.role,targetId:e.id,amount:r,effect:o,source:n,x:e.x,y:e.y}),e.hp===0&&(e.alive=!1,s.push({type:"death",fighterRole:e.role,fighterId:e.id}),e.deaths++,e.cast!==null&&Yc(e,"death",s),t.phase==="playing")){const l=jm(t);l!==null&&(t.phase="ended",t.winner=l.role,t.winnerId=l.id,s.push({type:"match-ended",winner:l.role,winnerId:l.id}))}}function nr(t,e,a,o,n,s,i,r,l,h,c){const d=Math.atan2(h.y,h.x)+n*Mb,p=Math.cos(d),u=Math.sin(d),f=o.speed??0,m=i??o.color,g=r??o.emoji,w=t.nextId++;t.projectiles.push({id:w,ownerId:e.id,targetId:a.id,ownerRole:e.role,targetRole:a.role,weapon:o,x:l.x,y:l.y,vx:p*f,vy:u*f,traveled:0,tx:a.x,ty:a.y,age:0,damage:s,color:m,emoji:g}),c.push({type:"projectile-spawned",id:w,ownerRole:e.role,ownerId:e.id,weaponKey:o.key,x:l.x,y:l.y,color:m,emoji:g})}function Q0(t,e,a,o){if(a.type!=="self"){e.revealedUntil=t.elapsed+Xf;for(const n of cb(e.x,e.y,t.arena,t.brokenConcealment))o.push({type:"concealment-broken",ownerRole:e.role,ownerId:e.id,x:n.x,y:n.y,w:n.w,h:n.h,kind:n.kind})}}function eu(t,e,a,o){const s=re[e.characterId].weapons[a];if(!s)return!1;o.push({type:"weapon-fired",fighterRole:e.role,fighterId:e.id,weaponKey:s.key}),Q0(t,e,s,o);const i=Ab(t,e,s,o),r=s.selfLaunch??0;return r>0&&ml(e,e.facing.x,e.facing.y,r),i}function Sb(t,e,a){if(t.phase!=="playing")return!1;const o=e.cast;return o===null||t.elapsed<o.resolvesAt?!1:(e.cast=null,eu(t,e,o.weaponIndex,a))}function wl(t,e,a,o){if(t.phase!=="playing")return!1;const n=re[e.characterId].weapons[a];if(!n)return!1;const s=t.elapsed,i=n.castMs??0;return e.cast!==null&&i>0||s-e.lastUsed[a]<n.cooldown?!1:(e.lastUsed[a]=s,i>0?(e.cast={weaponIndex:a,startedAt:s,resolvesAt:s+i},o.push({type:"cast-started",fighterRole:e.role,fighterId:e.id,weaponKey:n.key,castMs:i}),Q0(t,e,n,o),!0):eu(t,e,a,o))}function Ab(t,e,a,o){const n=w0(t,e);if(a.type==="self"){const h=(a.healAmount??0)*Zf(e.level),c=Math.min(h,e.maxHp-e.hp);return e.hp=Math.min(e.maxHp,e.hp+h),c>0&&o.push({type:"heal",fighterRole:e.role,fighterId:e.id,amount:c}),!0}if(n===null)return!0;if(a.type==="melee"){const h=a.cone??360,c=a.range??0;for(const d of t.fighters){if(!ci(d,e))continue;const p=d.x-e.x,u=d.y-e.y,f=Math.hypot(p,u);if(!(f>c)){if(h<360){if(f<Eb)continue;const m=(e.facing.x*p+e.facing.y*u)/f;if(Math.acos(Math.max(-1,Math.min(1,m)))*kb>h/2)continue}Ja(t,d,a.damage,a.effect,{kind:"weapon",weaponKey:a.key,weaponName:a.name,attackerId:e.id},o)}}return!0}const s={x:e.x,y:e.y},i=e.facing;if(a.comboParts){for(const h of a.comboParts)nr(t,e,n,a,h.angle,h.damage,h.color,h.emoji,s,i,o);return!0}const l=!!a.trailBoosted&&nh(t,e)?Math.round(a.damage*It.damageBoost):a.damage;if(a.pellets&&a.pellets>1){const h=a.spreadDeg??0;for(let c=0;c<a.pellets;c++){const d=(c-(a.pellets-1)/2)*h,p=a.pelletColors?a.pelletColors[c%a.pelletColors.length]:void 0,u=a.pelletEmojis?a.pelletEmojis[c%a.pelletEmojis.length]:void 0;nr(t,e,n,a,d,l,p,u,s,i,o)}}else nr(t,e,n,a,0,l,void 0,void 0,s,i,o);return!0}const ss=400,va=1e-6,Vc=.8,Kc=.6,qt={x:0,y:0},Ue={dirX:0,dirY:0,navX:0,navY:0},tu=Math.PI/180,Rb=[0];function au(t){if(t.comboParts)return t.comboParts.map(n=>n.angle);const e=t.pellets??1;if(e<=1)return Rb;const a=t.spreadDeg??0,o=[];for(let n=0;n<e;n++)o.push((n-(e-1)/2)*a);return o}const Ib=(()=>{const t=new Map;for(const e of Ee)for(const a of re[e].weapons)t.set(a,au(a));return t})();function Cb(t,e,a,o,n){const s=e.range??0;if(s<=0)return null;const i=a-t.x,r=o-t.y,l=Math.hypot(i,r),h=l>va?i/l:1,c=l>va?r/l:0;switch(e.type){case"self":return null;case"melee":return{margin:l-s,outX:h,outY:c};case"ranged":{const p=s+n,u=l-p;if(e.homing)return{margin:u,outX:h,outY:c};const f=Math.hypot(t.facing.x,t.facing.y);if(f<va)return{margin:u,outX:h,outY:c};const m=t.facing.x/f,g=t.facing.y/f,w=i*m+r*g,b=-i*g+r*m;let y=-1/0,k=-1/0,x=!1,M=!0;for(const S of Ib.get(e)??au(e)){const R=S*tu,F=Math.cos(R),A=Math.sin(R);if(w*F+b*A<0)continue;if(F<=va){M=!1;break}x=!0;const N=b*F-w*A,L=(n-N)/F,P=(n+N)/F;L>y&&(y=L),P>k&&(k=P)}if(!M)return{margin:u,outX:h,outY:c};if(!x)return{margin:l-n,outX:h,outY:c};const v=y<=k,T=v?-y:-k;return u>=T?{margin:u,outX:h,outY:c}:{margin:T,outX:v?-g:g,outY:v?m:-m}}}return e.type}function Fb(t,e,a,o,n){const s=e.x,i=e.y;qt.x=0,qt.y=0;let r=0;for(const u of t.arena.hazards){if(u.kind!=="damage")continue;const f=s-u.x,m=i-u.y,g=Math.hypot(f,m),w=u.radius+tn;if(g>=w)continue;const b=g>va?f/g:1,y=g>va?m/g:0,k=-y*a+b*o>=0?1:-1,x=-y*k,M=b*k,v=Math.min(2,(w-g)/tn),T=v*Di;qt.x+=(b*Vc+x*Kc)*T,qt.y+=(y*Vc+M*Kc)*T,v>r&&(r=v)}const l=t.arena.center.x,h=t.arena.center.y,c=l-s,d=h-i,p=Math.hypot(c,d);if(p>va){const u=t.safeRadius-p;if(u<zi){const f=Math.min(2,(zi-u)/zi);qt.x+=c/p*f*Xh,qt.y+=d/p*f*Xh,f>r&&(r=f)}}for(const u of t.fighters){if(u===e||!u.alive)continue;const f=u.cast;if(f===null)continue;const m=re[u.characterId].weapons[f.weaponIndex];if(m===void 0)continue;const g=Cb(u,m,s,i,e.hitRadius);if(g===null)continue;const w=g.margin;if(w>=tn)continue;const b=Math.max(0,f.resolvesAt-t.elapsed);if(w<0&&-w>n*b)continue;const y=Math.min(2,(tn-w)/tn);qt.x+=g.outX*y*Di,qt.y+=g.outY*y*Di,y>r&&(r=y)}return r}const Xc={melee:!0,ranged:!0,self:!1},Ob={melee:!1,ranged:!1,self:!0},Nb=(()=>{const t=new Map,e=a=>{const o=Math.abs(Math.sin(a*tu));return o<1e-9?1/0:u0/o};for(const a of Ee)for(const o of re[a].weapons){let n=0;const s=[];if(o.type!=="self")if(o.comboParts)for(const i of o.comboParts){const r=e(i.angle);r===1/0?n+=i.damage:s.push({maxDist:r,damage:i.damage})}else{const i=o.damage*(o.peckHits??1),r=o.pellets??1;if(o.type==="melee"||r<=1||o.homing)n=i*r;else{const l=o.spreadDeg??0;for(let h=0;h<r;h++){const c=e((h-(r-1)/2)*l);c===1/0?n+=i:s.push({maxDist:c,damage:i})}}}t.set(o,{always:n,offAxis:s})}return t})();function Lb(t,e){const a=Nb.get(t);if(!a)return t.damage;let o=a.always;for(const n of a.offAxis)e<n.maxDist&&(o+=n.damage);return o}const Zc=(t,e,a,o,n)=>Lb(a,n),Db=(t,e,a)=>{const o=a.healAmount??0;return o<=0||e.hp>e.maxHp*sm||e.maxHp-e.hp<o?-1/0:o};function sr(t,e,a,o,n,s){const i=re[e.characterId].weapons,r=t.elapsed;let l=null,h=-1/0;for(let c=0;c<i.length;c++){const d=i[c];if(!o[d.type]||r-e.lastUsed[c]<d.cooldown||a>(d.range??1/0)||(d.castMs??0)>0&&(d.castMs??0)>=s)continue;const p=n(t,e,d,c,a);p>h&&(h=p,l=c)}return l}function zb(t,e,a,o){if(t.phase!=="playing")return!1;const n=w0(t,e);if(e.hp<=0||n===null)return!1;const s=t.elapsed,i=oh(e.x,e.y,n.x,n.y,t.arena,t,n),r=t.sightings[rl(e.id,n.id,t.fighters.length)];i&&(r.x=n.x,r.y=n.y,r.at=s);const l=r.x,h=r.y,c=l-e.x,d=h-e.y,p=Math.hypot(c,d),u=p||1,f=p>1e-6,m=e.hp<e.maxHp*tm,g=(s<e.status.slowedUntil?am:1)*Z0(e.x,e.y,t.arena,t.splats)*(nh(t,e)?It.speedBoost:1),w=Ul(e,s);f&&!m0(e)&&(e.facing={x:c/u,y:d/u});let b=!1;const y=m?-1:1,k=Ts(e.characterId,m?Vh:Kh)*g,x=Fb(t,e,y*c/u,y*d/u,k),M=x>=nm,v=(F,A,C,N)=>{if(Ue.dirX=F,Ue.dirY=A,Ue.navX=C,Ue.navY=N,x<=0)return;const L=F+qt.x,P=A+qt.y,j=Math.hypot(L,P);j<va||(Ue.dirX=L/j,Ue.dirY=P/j,Ue.navX=e.x+Ue.dirX*ss,Ue.navY=e.y+Ue.dirY*ss)},T=M&&!w,S=M?0:Sn(t.timeRemaining)?e.hp*1e3/om:1/0,R=T?null:sr(t,e,u,Ob,Db,S);if(m){if(!w){const A=Ts(e.characterId,Vh)*a*g;v(-c/u,-d/u,e.x-c/u*ss,e.y-d/u*ss),Gc(e,Ue.dirX,Ue.dirY,A,t.arena,Ue.navX,Ue.navY),b=!0}const F=R??(i?sr(t,e,u,Xc,Zc,S):null);F!==null&&wl(t,e,F,o)}else{const F=T?null:R??(i?sr(t,e,u,Xc,Zc,S):null);if(F!==null)wl(t,e,F,o);else if(!w){const A=Ts(e.characterId,Kh)*a*g;v(c/u,d/u,l,h),Gc(e,Ue.dirX,Ue.dirY,A,t.arena,Ue.navX,Ue.navY),b=!0}}return b}const Jc=12;function ir(t,e,a,o){if(Array.isArray(e)){if(a!==void 0||o!==void 0)throw new TypeError("createMatch: the fighter-list form takes no third or fourth argument; put `level` on each FighterConfig instead");return Qc(t,e)}const n=o??{};return Qc(t,[{characterId:e,level:n.player},{characterId:a,level:n.enemy}])}function Qc(t,e){if(e.length<nt||e.length>Ht)throw new RangeError(`createMatch: ${e.length} fighters; the sim seats ${nt}..${Ht} (see state.ts MIN_FIGHTERS / MAX_FIGHTERS)`);const a=e.length===nt,o=e.map((i,r)=>{const l=Ra(i.level??io),h=r===0,c=a&&!h,d=i.spawn??Hb(t,r);return Um({id:r,controller:i.controller??(h?"human":"ai"),characterId:i.characterId,spawn:d,maxHp:i.maxHp??nl(i.characterId,c?hm:sl,l),size:i.size??(c?lm:d0),hitRadius:i.hitRadius??(c?rm:u0),facing:i.facing??_b(t,r,d),level:l})}),n=o.length,s=new Array(n*n);for(let i=0;i<n;i++)for(let r=0;r<n;r++)s[rl(i,r,n)]={x:o[r].x,y:o[r].y,at:0};return{phase:"countdown",elapsed:0,countdownValue:cm,countdownTick:0,startFlashTimer:0,timeRemaining:Aa,safeRadius:t.maxSafeRadius,fighters:o,player:o[0],enemy:o[1],projectiles:[],splats:[],trailMarks:[],winner:null,winnerId:null,arena:t,sightings:s,aiSighting:s[rl(1,0,n)],brokenConcealment:[],nextId:1}}function Hb(t,e){if(e===0)return t.playerSpawn;if(e===1)return t.enemySpawn;const a=t.spawns?.[e];if(a)return{x:a.x,y:a.y};throw new RangeError(`createMatch: slot ${e} has no spawn. ArenaDefinition declares playerSpawn and enemySpawn only, so slots 2 and up must pass \`spawn\` explicitly — arena geometry is src/arena/**'s to own (DECISIONS §48: spawn placement is part of the 180° point-symmetry fairness constraint).`)}function _b(t,e,a){if(e===0)return{x:1,y:0};if(e===1)return{x:-1,y:0};const o=t.center.x-a.x,n=t.center.y-a.y,s=Math.hypot(o,n);return s>1e-6?{x:o/s,y:n/s}:{x:1,y:0}}const Pb=Object.freeze({move:Object.freeze({x:0,y:0}),selectedWeapon:0,attack:!1});function $b(t,e,a){const o=[];if(t.elapsed+=e,qb(t,e,o),t.phase==="playing"){t.timeRemaining=Math.max(0,t.timeRemaining-e);const n=Aa-t.timeRemaining;t.safeRadius=Sn(t.timeRemaining)?ol:im(n,t.arena.maxSafeRadius,zs(t.fighters.length))}if(Ub(t),t.phase==="playing"){const n=Array.isArray(a)?a:null;for(const s of t.fighters){let i;if(Sb(t,s,o),!!s.alive){if(s.controller==="human"){const r=n===null?a:n[s.id]??Pb;jb(s,r),r.attack&&wl(t,s,r.selectedWeapon,o),i=Gb(t,s,e,r)}else i=zb(t,s,e,o);ub(s,e,t.arena,t.elapsed),Wb(t,s,e,i,o)}}Sn(t.timeRemaining)&&Yb(t,e,o)}return Kb(t,e,o),t.phase==="playing"&&t.timeRemaining<=0&&Bb(t,o),o}function Bb(t,e){const{arena:a}=t,o=r=>r.maxHp>0?r.hp/r.maxHp:0,n=r=>Math.hypot(r.x-a.center.x,r.y-a.center.y),i=t.fighters.slice().sort((r,l)=>{const h=o(r),c=o(l);if(h!==c)return c-h;const d=n(r),p=n(l);return d!==p?d-p:r.deaths!==l.deaths?r.deaths-l.deaths:r.id-l.id})[0];t.phase="ended",t.winner=i.role,t.winnerId=i.id,e.push({type:"match-ended",winner:i.role,winnerId:i.id})}function qb(t,e,a){t.phase==="countdown"&&(t.countdownTick+=e,t.countdownTick>=1e3&&(t.countdownTick-=1e3,t.countdownValue-=1,t.countdownValue>0?a.push({type:"countdown-tick",value:t.countdownValue}):(t.startFlashTimer=dm,a.push({type:"countdown-tick",value:0}))),t.countdownValue<=0&&(t.startFlashTimer-=e,t.startFlashTimer<=0&&(t.phase="playing",t.timeRemaining=Aa,t.safeRadius=t.arena.maxSafeRadius,a.push({type:"match-started"}))))}function Ub(t){for(let e=t.splats.length-1;e>=0;e--)t.elapsed>=t.splats[e].expiresAt&&t.splats.splice(e,1);for(let e=t.trailMarks.length-1;e>=0;e--)t.elapsed>=t.trailMarks[e].expiresAt&&t.trailMarks.splice(e,1)}function ou(t,e){return Z0(e.x,e.y,t.arena,t.splats)}function jb(t,e){if(m0(t)||!e.aim)return;const a=Math.hypot(e.aim.x,e.aim.y);a>1e-6&&(t.facing={x:e.aim.x/a,y:e.aim.y/a})}function Gb(t,e,a,o){const n=t.elapsed;let s=ou(t,e);nh(t,e)&&(s*=It.speedBoost),n<e.status.slowedUntil&&(s*=wm);const r=Ul(e,n)?0:Ts(e.characterId,c0)*a*s,l=o.move.x*r,h=o.move.y*r;return js(e,l,h,t.arena),l!==0||h!==0}function Wb(t,e,a,o,n){if(!e.alive)return;if(e.terrainSlowFactor=ou(t,e),e.concealed=X0(e.x,e.y,t.arena,t,e),re[e.characterId].hasTrail&&o){if(e.trailDropTimer+=a,e.trailDropTimer>=It.dropIntervalMs){e.trailDropTimer=0;const r={id:t.nextId++,ownerId:e.id,ownerRole:e.role,x:e.x,y:e.y,expiresAt:t.elapsed+It.durationMs,damagedMask:0,damaged:!1};t.trailMarks.push(r),n.push({type:"trail-mark-created",ownerRole:e.role,ownerId:e.id,x:e.x,y:e.y})}}else e.trailDropTimer=0;for(const r of t.fighters){if(r===e||!r.alive)continue;const l=qm(r.id);let h=0;for(const c of t.trailMarks)if(!(c.ownerId!==e.id||(c.damagedMask&l)!==0)&&!(Math.hypot(r.x-c.x,r.y-c.y)>=It.radius)&&(c.damagedMask|=l,c.damaged=!0,!(h>=It.maxHitsPerTick)&&(h++,Ja(t,r,It.damage,null,{kind:"trail",ownerId:e.id,ownerRole:e.role},n),!r.alive)))break}if(t.arena.hazards.forEach((r,l)=>{if(r.kind!=="damage")return;if(Math.hypot(e.x-r.x,e.y-r.y)<r.radius){const c=(e.hazardTimers[l]??0)+a;c>=(r.tickMs??1/0)?(e.hazardTimers[l]=0,Ja(t,e,r.damage??0,null,{kind:"hazard"},n)):e.hazardTimers[l]=c}else e.hazardTimers[l]=0}),t.elapsed-e.lastDamagedAt>pm&&e.hp<e.maxHp&&e.hp>0){if(e.regenTimer+=a,e.regenTimer>=um){e.regenTimer=0;const r=e.hp;e.hp=Math.min(e.maxHp,e.hp+h0),e.hp>r&&n.push({type:"heal",fighterRole:e.role,fighterId:e.id,amount:e.hp-r})}}else e.regenTimer=0;if(Sn(t.timeRemaining))return;Math.hypot(e.x-t.arena.center.x,e.y-t.arena.center.y)>t.safeRadius&&e.hp>0?(e.fogTimer+=a,e.fogTimer>=Hs&&(e.fogTimer=0,Ja(t,e,_l,null,{kind:"fog"},n))):e.fogTimer=0}function Yb(t,e,a){const o=il-t.timeRemaining;if(Math.floor(o/Hs)===Math.floor((o-e)/Hs))return;const n=t.fighters.slice().sort((s,i)=>s.hp!==i.hp?s.hp-i.hp:i.id-s.id);for(const s of n){if(t.phase!=="playing")break;!s.alive||s.hp<=0||Math.hypot(s.x-t.arena.center.x,s.y-t.arena.center.y)<=t.safeRadius||Ja(t,s,_l,null,{kind:"fog"},a)}}function is(t,e,a,o){const n=t.projectiles[e];o.push({type:"projectile-destroyed",id:n.id,reason:a,x:n.x,y:n.y}),t.projectiles.splice(e,1)}function ed(t,e,a,o){const n={id:t.nextId++,x:e,y:a,expiresAt:t.elapsed+mm};t.splats.push(n),o.push({type:"splat-created",x:e,y:a})}function Vb(t,e,a){let o=null,n=1/0;for(const s of t.fighters){if(!ci(s,a))continue;const i=Math.hypot(e.x-s.x,e.y-s.y);i>=s.hitRadius||i<n&&(n=i,o=s)}return o}function Kb(t,e,a){for(let o=t.projectiles.length-1;o>=0;o--){const n=t.projectiles[o],s=n.weapon,i=t.fighters[n.targetId],r=t.fighters[n.ownerId];if(s.peckHits&&n.arrived){if(i.hp<=0){is(t,o,"expired",a);continue}n.peckTimer=(n.peckTimer??0)+e,n.peckTimer>=(s.peckInterval??500)&&(n.peckTimer=0,Ja(t,i,n.damage,s.effect,{kind:"weapon",weaponKey:s.key,weaponName:s.name,attackerId:n.ownerId},a),n.hitsSoFar=(n.hitsSoFar??1)+1,n.hitsSoFar>=s.peckHits&&is(t,o,"expired",a));continue}if(s.homing&&i.hp>0&&oh(n.x,n.y,i.x,i.y,t.arena,t,i)){const g=i.x-n.x,w=i.y-n.y,b=Math.hypot(g,w)||1,y=g/b,k=w/b,x=Math.hypot(n.vx,n.vy)||1,M=n.vx/x,v=n.vy/x,T=Math.min(1,gm*e),S=M+(y-M)*T,R=v+(k-v)*T,F=Math.hypot(S,R)||1,A=s.speed??0;n.vx=S/F*A,n.vy=R/F*A}const l=n.vx*e/1e3,h=n.vy*e/1e3,c=n.x+l,d=n.y+h,p=t.arena.cover.some(g=>gi(c,d,Jc,Jc,g.x,g.y,g.w,g.h)),u=Math.hypot(l,h);let f=u;if(u>0&&n.tx!==void 0&&n.ty!==void 0){const g=((i.x-n.tx)*l+(i.y-n.ty)*h)/u;g>0&&(f=u-g)}if(n.tx=i.x,n.ty=i.y,n.age=(n.age??0)+e,n.traveled+=f>0?f:0,n.x=c,n.y=d,p||n.traveled>=(s.range??1/0)||n.age>=fm(s)){s.splatter&&ed(t,n.x,n.y,a),is(t,o,p?"hit-cover":"expired",a);continue}const m=Vb(t,n,r);if(m!==null){if(m!==i&&(n.targetId=m.id,n.targetRole=m.role),Ja(t,m,n.damage,s.effect,{kind:"weapon",weaponKey:s.key,weaponName:s.name,attackerId:n.ownerId},a),s.splatter&&ed(t,n.x,n.y,a),s.peckHits){n.arrived=!0,n.peckTimer=0,n.hitsSoFar=1;continue}is(t,o,"hit-target",a);continue}}}const td="pointerlock-styles",Xb=2600;function nu(){const t=new URLSearchParams(location.search);return t.get("pointerLock")??t.get("pointerlock")}function Zb(){const t=nu();if(t==="0")return!1;if(t==="1"||t==="sim")return!0;const e=new URLSearchParams(location.search);return!(e.has("shot")||e.has("simSpeed"))}function Jb(){return typeof window.matchMedia!="function"?!0:window.matchMedia("(pointer: fine)").matches}function Qb(t){const{target:e}=t,a=nu()==="sim";let o=!1;const s=typeof document<"u"&&"pointerLockElement"in document&&typeof e.requestPointerLock=="function"&&Jb()&&Zb();let i=!1,r=!1,l=!0,h="hidden",c=0,d=!1,p=!1,u="";const f=document.createElement("div");f.className="plk-root",f.innerHTML=`
  ...
  `;const m=z=>f.querySelector(`[data-el="${z}"]`),g=m("fs"),w=m("fs2");function b(){return a?o:document.pointerLockElement===e}function y(){window.__plockDebug={state:h,wantsLock:i,locked:b(),pending:p,lastError:u,available:s}}function k(){f.classList.toggle("is-prompt",h==="prompt"),f.classList.toggle("is-toast",h==="toast"),f.classList.toggle("is-lost",h==="lost"),y()}function x(z){h!==z&&(h=z,window.clearTimeout(c),z==="toast"&&(c=window.setTimeout(()=>{!d&&h==="toast"&&x("hidden")},Xb)),k())}function M(){const Y=!!document.fullscreenElement?"⛶ Exit fullscreen":"⛶ Fullscreen";g.textContent=Y,w.textContent=Y}function v(){try{document.fullscreenElement?document.exitFullscreen?.()?.catch(()=>{}):document.documentElement.requestFullscreen?.()?.catch(()=>{})}catch{}}function T(z){u=z===void 0?"refused":String(z?.message??z),y(),!(d||!i||b())&&(t.pause(),x("lost"))}function S(){if(!(d||!s||!i||b()||p)){if(a){o=!0,C();return}p=!0;try{const z=e.requestPointerLock();z&&typeof z.then=="function"?z.then(()=>{p=!1},Y=>{p=!1,T(Y)}):window.setTimeout(()=>{p=!1},0)}catch(z){p=!1,T(z)}}}function R(){if(b()){if(r=!0,a){o=!1,C();return}try{document.exitPointerLock()}catch{r=!1}}}function F(){i=!0,t.resume()}function A(){i=!1,R(),x("prompt"),t.resume()}const C=()=>{if(d)return;const z=b();if(t.onLockChange(z),p=!1,z){i=!0,r=!1,x("toast");return}if(r){r=!1,x(l&&s?"prompt":"hidden");return}i?(t.pause(),x("lost")):x(l&&s?"prompt":"hidden")},N=()=>{p=!1,!d&&T("pointerlockerror")},L=()=>{d||!i||!s||b()||h!=="lost"&&(t.pause(),x("lost"))},P=()=>M(),j=z=>{d||!o||z.key!=="Escape"||(z.preventDefault(),z.stopImmediatePropagation(),o=!1,C())};return s&&(ey(),document.body.appendChild(f),document.addEventListener("pointerlockchange",C),document.addEventListener("pointerlockerror",N),document.addEventListener("fullscreenchange",P),window.addEventListener("blur",L),a&&window.addEventListener("keydown",j,!0),m("capture").addEventListener("click",z=>{z.stopPropagation(),F()}),m("resume").addEventListener("click",z=>{z.stopPropagation(),F()}),m("scrim").addEventListener("click",()=>F()),m("free").addEventListener("click",z=>{z.stopPropagation(),A()}),g.addEventListener("click",z=>{z.stopPropagation(),v()}),w.addEventListener("click",z=>{z.stopPropagation(),v()}),M(),x("prompt"),k()),{available:s,get locked(){return s&&b()},engage:S,release:R,setMatchActive(z){!s||l===z||(l=z,z?b()||x("prompt"):(R(),x("hidden")))},dispose(){d||(d=!0,window.clearTimeout(c),s&&(R(),document.removeEventListener("pointerlockchange",C),document.removeEventListener("pointerlockerror",N),document.removeEventListener("fullscreenchange",P),window.removeEventListener("blur",L),window.removeEventListener("keydown",j,!0),f.remove()))}}}function ey(){if(document.getElementById(td))return;const t=document.createElement("style");t.id=td,t.textContent=ty,document.head.appendChild(t)}const ty=`
.plk-root {
  position: fixed;
  inset: 0;
  z-index: 30;
...
`,Vt=.11,ad=J*.1,su=new st(Vt,12,10);su.scale(1,.86,1);const ay=new Wo(Vt*.32,Vt*.5,6),Lo=new li(Vt*.6,0);Lo.scale(1,.4,1);const oy=new V({color:"#E63946"}),ny=new V({color:"#3E5C2B"}),sy=new V({color:"#FF9E9E",transparent:!0,opacity:.55,depthWrite:!1});function sh(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const iy=sh(18,()=>new V({color:"#E63946",transparent:!0,opacity:.85,depthWrite:!1})),ry=sh(20,()=>new V({color:"#C21F32",transparent:!0,opacity:.9,depthWrite:!1})),od=sh(6,()=>new V({color:"#FFD9C7",transparent:!0,opacity:.95,blending:Qe,depthWrite:!1}));function ly(t){const e=new ie,a=new E(su,oy);e.add(a);const o=new E(ay,ny);o.position.set(0,Vt*.75,0),e.add(o);const n=new E(Lo,sy);return n.scale.setScalar(.55),n.position.set(Vt*.32,Vt*.28,Vt*.5),e.add(n),e}function rr(t,e,a,o,n,s=1){const i=new E(Lo,ry()),r=(.3+Math.random()*.25)*s;i.scale.setScalar(r),i.position.copy(e);const l=e.x,h=e.y,c=e.z,d=1.1+Math.random()*1.3,p=-5.5,u=.32+Math.random()*.16;t.spawnTransient(i,u,(f,m)=>{i.position.set(l+a*n*m,h+d*m+.5*p*m*m,c+o*n*m),i.scale.setScalar(r*(1-f*.35)),i.material.opacity=.9*(1-f)})}const hy={Tomato:{projectile(t){const e=ly(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=(e.userData.__spin??0)+a*8;e.userData.__spin=o,e.rotation.x=o,e.rotation.z=Math.sin(o*.6)*.25;const n=1+Math.sin(o*2.2)*.09;e.scale.set(1/n,n,1/n);const s=(e.userData.__dripTimer??.05)-a;s<=0?(e.userData.__dripTimer=.09+Math.random()*.05,rr(t,t.position,-t.direction.x*.5,-t.direction.z*.5,.3+Math.random()*.25)):e.userData.__dripTimer=s},impact(t){const e=t.position,a=W.clamp(1+t.damage*.05,1,2.2),o=ad/(Vt*.6),n=new E(Lo,od());n.position.copy(e),n.scale.setScalar(.7*o),t.spawnTransient(n,.18,r=>{n.scale.setScalar(W.lerp(.7,2.4,r)*o*a),n.material.opacity=.9*(1-r)});const s=7,i=Ka*.45;for(let r=0;r<s;r++){const l=r/s*Math.PI*2+Math.random()*.5,h=i+(.5+Math.random()*.75)*a,c=new E(Lo,iy()),d=(.55+Math.random()*.4)*o*a,p=e.x+Math.cos(l)*i,u=e.y,f=e.z+Math.sin(l)*i;c.position.set(p,u,f),c.rotation.y=Math.random()*Math.PI*2;const m=e.x+Math.cos(l)*h,g=e.z+Math.sin(l)*h,w=u-.9;t.spawnTransient(c,.55+Math.random()*.2,b=>{const y=1-Math.pow(1-b,3);c.position.set(W.lerp(p,m,y),W.lerp(u,w,Math.min(1,y*1.3)),W.lerp(f,g,y)),c.scale.setScalar(d*(1-b*.3)),c.material.opacity=.85*(1-Math.pow(b,1.5))})}for(let r=0;r<5;r++){const l=Math.random()*Math.PI*2;rr(t,e,Math.cos(l),Math.sin(l),1.3+Math.random()*1.1,o)}},cast(t){const e=ad/(Vt*.6),a=new E(Lo,od()),o=a.material;o.color.set(t.color),a.position.copy(t.position),a.scale.setScalar(.16*e),t.spawnTransient(a,.15,n=>{a.scale.setScalar(W.lerp(.16,.62,n)*e),o.opacity=.9*(1-n)});for(let n=0;n<3;n++){const s=(Math.random()-.5)*.6;rr(t,t.position,t.direction.x+s,t.direction.z+s,.9+Math.random()*.5,e*.35)}}}},ih="#C93F73",cy="#F0C070",wi="#FFF0F6",dy="#FFD9EC",bl=["#E63946","#7CB518","#FFC93C","#7C4DFF","#2E86D8","#FFFFFF"],vt=J,ao=Math.PI*2,Ws=.28,zt=vt*.09,sa=vt*.043,py=vt*.014,uy=vt*.042,rs=vt*.375,ls=vt*.4;function Do(t,e,a,o,n){const s=new $l(t,e,a,o,n);return s.rotateX(-Math.PI/2),s}const fy=Do(zt,sa,8,22),my=Do(zt,sa*.82,8,22),gy=Do(zt,sa*1.3,8,22),nd=[Do(zt*.92,sa*.86,6,8,1.5),Do(zt*1.05,sa*.72,6,8,1),Do(zt*.8,sa*.95,6,7,2.1)];let wy=0;const by=()=>nd[wy++%nd.length],iu=new Pl(py,uy,3,6);function ru(t,e=40){const a=new Ma(t,1,e,1);return a.rotateX(-Math.PI/2),a}const yy=ru(.84),xy=ru(.7);function Yo(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Vo=(t,e,a={})=>new V({color:t,transparent:!0,opacity:e,depthWrite:!1,side:me,...a}),sd=new V({color:"#FF6FA5"}),vy=new V({color:cy}),ky=new V({color:ih}),id=bl.map(t=>new V({color:t})),My=Yo(18,()=>Vo(ih,1)),Ey=Yo(18,()=>Vo("#FF6FA5",1)),Ty=Yo(30,()=>Vo("#FFFFFF",1)),Sy=Yo(24,()=>Vo(wi,.7)),Ay=Yo(20,()=>Vo(wi,.7,{blending:Qe})),Ry=Yo(24,()=>Vo(wi,1)),lu=new de(0,1,0),rd=new de,lr=new hi,ld=new hi;function Iy(t,e,a,o,n){lr.setFromAxisAngle(lu,o);const s=Math.hypot(e,a);Math.abs(n)>1e-4&&s>1e-4?(rd.set(a/s,0,-e/s),ld.setFromAxisAngle(rd,n),t.quaternion.copy(ld).multiply(lr)):t.quaternion.copy(lr)}function Cy(t){return t.range&&t.speed?t.range/t.speed:ro.normal/1e3}function Fy(t,e,a){let o=t.userData.__ring;return o||(o={spin:Math.random()*ao,rate:a*ao/Cy(e),shed:0,echo:0},t.userData.__ring=o),o}function _a(t,e,a,o,n,s,i,r,l,h={}){const c=h.hard?Ry():h.glow?Ay():Sy();c.color.set(i),c.opacity=r;const d=new E(h.band?xy:yy,c);d.renderOrder=h.renderOrder??9,d.position.set(e,a,o),d.rotation.y=Math.random()*ao,d.scale.set(n,1,n);const p=h.fadePow??1,u=h.hold??0;t.spawnTransient(d,l,f=>{const m=W.lerp(n,s,1-Math.pow(1-f,2.4));d.scale.set(m,1,m),c.opacity=f<u?r:r*(1-Math.pow((f-u)/(1-u),p))})}function hr(t,e,a,o,n,s,i,r,l=1){const h=Ty();h.color.set(bl[Math.random()*bl.length|0]),h.opacity=1;const c=new E(iu,h);c.renderOrder=9,c.position.set(e,a,o),c.scale.setScalar(l);const d=(Math.random()-.5)*26,p=(Math.random()-.5)*26,u=-9;t.spawnTransient(c,r,(f,m)=>{c.position.set(e+n*m,Math.max(Ws,a+s*m+.5*u*m*m),o+i*m),c.rotation.set(d*m,0,p*m),h.opacity=1-Math.pow(f,2.4)})}function Oy(t,e,a,o,n,s,i){const r=new ie,l=My();l.color.set(ih),l.opacity=1;const h=by(),c=new E(h,l);c.scale.setScalar(1.28),r.add(c);const d=Ey();d.color.set(a),d.opacity=1,r.add(new E(h,d)),r.renderOrder=9,r.position.copy(e),r.scale.setScalar(s);const p=e.x,u=e.y,f=e.z,m=Math.cos(o)*n,g=Math.sin(o)*n,w=1.5+Math.random()*1.2,b=-8.5,y=(Math.random()-.5)*20,k=(Math.random()-.5)*20;t.spawnTransient(r,i,(x,M)=>{r.position.set(p+m*M,Math.max(Ws,u+w*M+.5*b*M*M),f+g*M),r.rotation.set(y*M,0,k*M);const v=1-Math.pow(x,2.2);d.opacity=v,l.opacity=v})}function Ny(t){return W.clamp(.85+t*.035,.85,1.25)}function Ly(t){const e=new ie,a=new E(gy,ky);a.position.y=-vt*.007,e.add(a),e.add(new E(fy,vy)),sd.color.set(t);const o=new E(my,sd);o.position.y=sa*.36,e.add(o);const n=Math.random()*ao;for(let s=0;s<5;s++){const i=n+s/5*ao+(Math.random()-.5)*.6,r=new E(iu,id[Math.random()*id.length|0]);r.position.set(Math.cos(i)*zt,sa*1.05,Math.sin(i)*zt),r.quaternion.setFromAxisAngle(lu,-i),r.rotateX(Math.PI/2),r.scale.setScalar(1.05),e.add(r)}return e.userData.__isCandyRing=!0,e}const Dy={Candy:{projectile(t){const e=Ly(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Fy(e,t.weapon,2.4);if(o.spin+=o.rate*a,Iy(e,t.direction.x,t.direction.z,o.spin,.13+Math.sin(o.spin*.41)*.08),e.position.y+=Math.sin(o.spin*.62)*vt*.011,o.echo-=a,o.echo<=0){o.echo=.075;const n=zt+sa;_a(t,t.position.x,t.position.y,t.position.z,n,n*1.45,dy,.55,.2,{glow:!0,fadePow:1.4})}o.shed-=a,o.shed<=0&&(o.shed=.085+Math.random()*.05,hr(t,t.position.x-t.direction.x*zt,t.position.y,t.position.z-t.direction.z*zt,-t.direction.x*.6+(Math.random()-.5)*.6,.15+Math.random()*.35,-t.direction.z*.6+(Math.random()-.5)*.6,.34,.85))},impact(t){const e=Ny(t.damage),{x:a,y:o,z:n}=t.position;_a(t,a,o,n,rs*.8*e,rs*e,"#FFF6FA",1,.16,{hard:!0,renderOrder:12,fadePow:1.1,hold:.45}),_a(t,a,o,n,rs*.62*e,rs*.86*e,t.color,1,.19,{hard:!0,renderOrder:11,fadePow:1.4,hold:.3}),_a(t,a,Ws,n,ls*.2*e,ls*e,t.color,.95,.3,{hard:!0,renderOrder:7,fadePow:1.6,hold:.35}),_a(t,a,Ws-.01,n,ls*.16*e,ls*.86*e,wi,.9,.34,{hard:!0,band:!0,renderOrder:6,fadePow:1.4,hold:.3});for(let s=0;s<3;s++){const i=s/3*ao+Math.random()*.9;Oy(t,t.position,t.color,i,(2.3+Math.random()*1.5)*e,(1.05+Math.random()*.5)*e,.36+Math.random()*.12)}for(let s=0;s<8;s++){const i=Math.random()*ao,r=(2.2+Math.random()*1.8)*e;hr(t,a,o,n,Math.cos(i)*r+t.direction.x*.9,2.5+Math.random()*1.6,Math.sin(i)*r+t.direction.z*.9,.4+Math.random()*.14,1.1+Math.random()*.6)}},cast(t){_a(t,t.position.x,t.position.y,t.position.z,vt*.06,vt*.2,"#FFF6FA",1,.16,{hard:!0,renderOrder:12,hold:.3}),_a(t,t.position.x,t.position.y,t.position.z,vt*.03,vt*.13,t.color,.95,.13,{hard:!0,band:!0,renderOrder:11,hold:.25});for(let e=0;e<4;e++)hr(t,t.position.x,t.position.y,t.position.z,t.direction.x*(1.2+Math.random()*.8)+(Math.random()-.5)*.7,.7+Math.random()*.6,t.direction.z*(1.2+Math.random()*.8)+(Math.random()-.5)*.7,.3,.85)}}},zn="#F2A73E",rh="#B96F16",hu="#E9C078",lh="#4E2C1B",cu="#E63946",du="#8FCB1E",bi="#EFE2FA",pu="#C9A9E4",uu="#CDB0EE",pe=J,$e=Math.PI*2,Ys=.29,Po=pe*.085,yi=pe*.105,cr=pe*.032,we=pe*.105,ta=pe*.07,qa=pe*.036,Re=pe*.125,zy=pe*.33;function zo(t,e=7){return new Me(1,1,1,e,1,!0,-t/2,t)}const $o=[zo(1.1),zo(1.7),zo(2.3)];let Hy=0;const _y=()=>$o[Hy++%$o.length],yl=zo(2.7,9),fu=zo(2.9,12),xl=new li(1,0),mu=new Bl(1,0),vl=new Rt(1,1,1),hd=new st(1,14,10),Py=new st(1,16,10,0,Math.PI*1.5),$y=new $l(1,.062,5,20),cd=new Wo(1,1,6),By=zo(2.2,7),qy=(()=>{const e=document.createElement("canvas");e.width=e.height=64;const a=e.getContext("2d"),o=a.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);o.addColorStop(0,"rgba(255,255,255,0.85)"),o.addColorStop(.42,"rgba(255,255,255,0.44)"),o.addColorStop(.76,"rgba(255,255,255,0.12)"),o.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=o,a.fillRect(0,0,64,64);const n=new et(e);return n.colorSpace=ri,n})();function ho(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Ko=(t,e={})=>new V({color:t,transparent:!0,opacity:1,depthWrite:!1,side:me,...e}),hh=ho(26,()=>Ko(zn)),gu=ho(34,()=>Ko(hu)),hs=ho(30,()=>Ko(lh)),Uy=ho(12,()=>Ko(pu)),wu=ho(20,()=>Ko("#FFF3D6")),jy=ho(14,()=>new Ct({map:qy,color:uu,transparent:!0,opacity:.3,depthWrite:!1})),ca=(t,e={})=>new V({color:t,side:me,...e}),dd=ca("#6B3E26"),Gy=ca(lh),Wy=ca(zn),Yy=ca(rh),pd=ca(du),Vy=ca(cu),ud=ca("#B497D6"),Ky=ca(pu),dr=ca(bi);function Xy(t){return t.range&&t.speed?t.range/t.speed:ro.normal/1e3}function pr(t){const e=t.weapon.comboParts;if(!e)return-1;const a=e.findIndex(o=>o.color===t.color&&o.damage===t.damage);return a>=0?a:e.findIndex(o=>o.color===t.color)}function bu(t){return W.clamp(.85+t*.035,.85,1.45)}function yu(t,e,a){let o=t.userData.__tumble;return o||(o={t:Math.random()*$e,rate:a*$e/Xy(e),shed:0},t.userData.__tumble=o),o}function Co(t,e,a,o,n,s,i,r,l,h,c,d,p,u,f=-9){a.color.set(o),a.opacity=1;const m=new E(e,a);m.renderOrder=9,m.position.set(n,s,i),m.scale.set(c,d,p),m.rotation.set(Math.random()*$e,Math.random()*$e,Math.random()*$e);const g=(Math.random()-.5)*20,w=(Math.random()-.5)*20,b=(Math.random()-.5)*20,y=m.rotation.x,k=m.rotation.y,x=m.rotation.z;t.spawnTransient(m,u,(M,v)=>{const T=s+l*v+.5*f*v*v,S=T<=Ys;m.position.set(n+r*v,S?Ys:T,i+h*v),S||m.rotation.set(y+g*v,k+w*v,x+b*v),a.opacity=1-Math.pow(M,2.4)})}function xu(t,e,a,o,n,s,i,r,l){Co(t,_y(),hh(),Math.random()<.35?rh:zn,e,a,o,n,s,i,Po*r,yi*r,Po*r,l)}function xi(t,e,a,o,n,s,i,r,l){Co(t,mu,gu(),hu,e,a,o,n,s,i,cr*r,cr*r,cr*r,l)}function vi(t,e,a,o,n,s,i,r,l,h){if(e==="lettuce")Co(t,yl,hs(),du,a,o,n,s,i,r,ta*l,ta*.42*l,ta*l,h,-6.5);else if(e==="tomato")Co(t,vl,hs(),cu,a,o,n,s,i,r,qa*l,qa*l,qa*l,h);else if(e==="onion")Co(t,vl,hs(),bi,a,o,n,s,i,r,qa*1.3*l,qa*.4*l,qa*1.3*l,h);else{const c=we*(.45+Math.random()*.3)*l;Co(t,xl,hs(),Math.random()<.4?lh:"#6B3E26",a,o,n,s,i,r,c,c*.8,c*1.15,h)}}function ch(t,e,a,o,n){const s=wu();s.color.set("#FFF3D6"),s.opacity=1;const i=new E(mu,s);i.renderOrder=12,i.position.set(e,a,o),i.rotation.set(Math.random()*$e,Math.random()*$e,0),i.scale.setScalar(n*.6),t.spawnTransient(i,.12,r=>{i.scale.setScalar(n*W.lerp(.6,1.3,r)),s.opacity=r<.4?1:1-(r-.4)/.6})}function vu(t,e){const{x:a,y:o,z:n}=t.position,s=t.direction,i=Math.random()*$e;for(let r=0;r<5;r++){const l=i+r/5*$e,h=wu();h.color.set(r%2===0?"#FFF3D6":"#FFD27A"),h.opacity=1;const c=new E($o[r%$o.length],h);c.renderOrder=12;const d=Math.cos(l),p=Math.sin(l),u=pe*.11*e,f=pe*.44*e,m=Math.atan2(d,p);t.spawnTransient(c,.13,g=>{const w=1-Math.pow(1-g,2.2),b=W.lerp(u,f,w);c.position.set(a+d*b+s.x*b*.3,o,n+p*b+s.z*b*.3);const y=(1-g*.45)*e;c.rotation.set(0,m,0),c.scale.set(Po*1.15*y,yi*1*y,Po*1.15*y),h.opacity=g<.45?1:1-(g-.45)/.55})}}function fd(t,e,a,o,n,s,i,r=.3){const l=new ba(jy()),h=l.material;h.color.set(uu),h.opacity=0,l.renderOrder=10;const c=(Math.random()-.5)*n*1.4,d=(Math.random()-.5)*n*1.4;l.position.set(e,a,o),l.scale.set(n,n,1),t.spawnTransient(l,i,p=>{const u=1-Math.pow(1-p,2);l.position.set(e+c*u,a+s*u,o+d*u);const f=n*(1+u*.9);l.scale.set(f,f,1),h.opacity=r*Math.sin(Math.min(1,p*1.25)*Math.PI)})}function Zy(t,e,a,o){const{x:n,y:s,z:i}=t.position,r=t.direction;let l=-r.z,h=r.x;Math.hypot(l,h)<1e-4&&(l=1,h=0);for(const c of[-1,1]){const d=hh();d.color.set(c<0?zn:rh),d.opacity=1;const p=new E(fu,d);p.renderOrder=9;const u=n+l*c*pe*.24*e,f=i+h*c*pe*.24*e;p.position.set(u,s,f);const m=Po*2.1*e;p.scale.set(m,yi*1.9*e,m);const g=l*c*a+r.x*a*.35,w=h*c*a+r.z*a*.35,b=1.5+Math.random()*.9,y=c*(7+Math.random()*5),k=(Math.random()-.5)*6;t.spawnTransient(p,o,(x,M)=>{const v=s+b*M-4.6*M*M;p.position.set(u+g*M,Math.max(Ys,v),f+w*M),p.rotation.set(k*M,y*M,c*.5),d.opacity=1-Math.pow(x,2.2)})}}function ur(t){const e=new ie;dd.color.set(t);const a=new E(xl,dd);a.scale.set(we,we*.85,we*1.18),a.rotation.set(.6,.4,.2),e.add(a);const o=new E(xl,Gy);o.scale.setScalar(we*.62),o.position.set(we*.55,-we*.4,-we*.3),o.rotation.set(1.1,.3,.8),e.add(o);const n=new E(yl,pd);n.scale.set(ta*1.15,ta*.4,ta*1.15),n.position.set(-we*.45,we*.55,we*.2),n.rotation.set(.9,.7,-.5),e.add(n);for(const[l,h,c]of[[.8,.3,.5],[-.55,-.25,-.8]]){const d=new E(vl,Vy);d.scale.setScalar(qa*1.45),d.position.set(we*l,we*h,we*c),d.rotation.set(Math.random(),Math.random(),Math.random()),e.add(d)}const s=new E(yl,pd);s.scale.set(ta*.8,ta*.3,ta*.8),s.position.set(we*.3,-we*.15,-we*.7),s.rotation.set(-.6,1.9,.8),e.add(s);const i=new E($o[2],Wy);i.scale.set(we*1.02,we*1.25,we*1.02),i.position.set(-we*.25,-we*.72,-we*.1),i.rotation.set(1.5,.4,.15),e.add(i);const r=new E($o[0],Yy);return r.scale.set(we*.7,we*.85,we*.7),r.position.set(we*.75,-we*.35,we*.45),r.rotation.set(.9,2.2,-.6),e.add(r),e}function fr(t){const e=new ie;ud.color.set(t);const a=new E(hd,ud);a.scale.set(Re,Re*.92,Re),e.add(a);const o=new ie;for(let i=0;i<3;i++){const r=new E($y,dr);r.scale.set(Re*1.01,Re*.93,Re*1.01),r.rotation.y=i/3*Math.PI,o.add(r)}e.add(o);const n=new E(cd,dr);n.scale.set(Re*.42,Re*.62,Re*.42),n.position.y=Re*1.06,n.rotation.z=.18,e.add(n);for(let i=0;i<3;i++){const r=i/3*$e+.4,l=new E(cd,Ky);l.scale.set(Re*.09,Re*.34,Re*.09),l.position.set(Math.cos(r)*Re*.2,-Re*1,Math.sin(r)*Re*.2),l.rotation.set(Math.PI+(Math.random()-.5)*.6,0,(Math.random()-.5)*.6),e.add(l)}const s=new E(hd,dr);return s.scale.set(Re*.42,Re*.2,Re*.42),s.position.set(Re*.42,Re*.62,-Re*.3),e.add(s),e.userData.__bands=o,e}function md(t,e){const a=t.object;if(!a)return;const o=t.dt??0,n=yu(a,t.weapon,e);if(n.t+=n.rate*o,a.rotation.x=n.t,a.rotation.z=Math.sin(n.t*.63)*.9,n.shed-=o,n.shed<=0){n.shed=.06+Math.random()*.04;const s=Math.random(),i=s<.45?"meat":s<.72?"tomato":"lettuce",r=t.position.x-t.direction.x*we,l=t.position.z-t.direction.z*we;vi(t,i,r,t.position.y-we*.4,l,-t.direction.x*.5+(Math.random()-.5)*.7,-.2-Math.random()*.4,-t.direction.z*.5+(Math.random()-.5)*.7,.85,.34),Math.random()<.55&&xi(t,r,t.position.y,l,-t.direction.x*.7+(Math.random()-.5)*.6,.1+Math.random()*.3,-t.direction.z*.7+(Math.random()-.5)*.6,.9,.3)}}function gd(t,e){const a=bu(t.damage)*e,{x:o,y:n,z:s}=t.position,i=t.direction;ch(t,o,n,s,pe*.24*a),vu(t,a),Zy(t,a*.95,2.4*a,.4);const r=pe*.26*a,l=.8;for(let h=0;h<6;h++){const c=h/6*$e+Math.random()*.7,d=(2.2+Math.random()*1.5)*a,p=Math.random();vi(t,p<.5?"meat":p<.78?"tomato":"lettuce",o+Math.cos(c)*r,n,s+Math.sin(c)*r,Math.cos(c)*d+i.x*l,1.9+Math.random()*1.3,Math.sin(c)*d+i.z*l,a,.42+Math.random()*.14)}for(let h=0;h<4;h++){const c=h/4*$e+Math.random()*.9,d=(2.4+Math.random()*1.6)*a;xu(t,o+Math.cos(c)*r,n,s+Math.sin(c)*r,Math.cos(c)*d+i.x*l,1.7+Math.random()*1.5,Math.sin(c)*d+i.z*l,(.85+Math.random()*.5)*a,.42+Math.random()*.12)}for(let h=0;h<9;h++){const c=Math.random()*$e,d=(2.6+Math.random()*2.1)*a;xi(t,o+Math.cos(c)*r*.8,n,s+Math.sin(c)*r*.8,Math.cos(c)*d+i.x*l,1.5+Math.random()*1.8,Math.sin(c)*d+i.z*l,(.85+Math.random()*.7)*a,.36+Math.random()*.14)}}function wd(t,e){const a=t.object;if(!a)return;const o=t.dt??0,n=yu(a,t.weapon,e);n.t+=n.rate*o,a.rotation.x=n.t*.8,a.rotation.z=n.t*.45;const s=a.userData.__bands;if(s&&(s.rotation.y+=o*1.9),n.shed-=o,n.shed<=0){n.shed=.1+Math.random()*.07;const i=gu();i.color.set(bi),i.opacity=1;const r=new E(By,i);r.renderOrder=9;const l=t.position.x-t.direction.x*Re,h=t.position.z-t.direction.z*Re;r.position.set(l,t.position.y,h);const c=Re*(.3+Math.random()*.2);r.scale.set(c,c*.5,c);const d=-t.direction.x*.5+(Math.random()-.5)*.5,p=-t.direction.z*.5+(Math.random()-.5)*.5,u=5+Math.random()*5;t.spawnTransient(r,.42,(f,m)=>{r.position.set(l+d*m,t.position.y-.7*m*m-.25*m,h+p*m),r.rotation.set(Math.sin(m*u)*1.4,m*3,Math.cos(m*u*.7)*1.1),i.opacity=1-Math.pow(f,2)})}}function bd(t,e){const a=bu(t.damage)*e,{x:o,y:n,z:s}=t.position,i=t.direction;ch(t,o,n,s,pe*.21*a),vu(t,a*.88);for(let h=0;h<3;h++){const c=Uy();c.color.set(h===0||h===1?t.color:bi),c.opacity=.66;const d=new E(Py,c);d.renderOrder=10,d.position.set(o,n,s),d.rotation.set((Math.random()-.5)*.5,Math.random()*$e,(Math.random()-.5)*.5);const p=Re*(.8+h*.12),u=zy*a*(.78+h*.22),f=(Math.random()-.5)*5;t.spawnTransient(d,.3+h*.05,m=>{const g=1-Math.pow(1-m,2.6),w=W.lerp(p,u,g);d.scale.set(w,w*(.9-g*.45),w),d.position.y=n+g*pe*.06,d.rotation.y+=f*.02,c.opacity=.66*(1-Math.pow(m,1.4))})}fd(t,o,n*.6,s,pe*.34*a,pe*.3,.65,.4);for(let h=0;h<3;h++){const c=h/3*$e+Math.random();fd(t,o+Math.cos(c)*pe*.24*a,Ys+pe*.12,s+Math.sin(c)*pe*.24*a,pe*.28*a,pe*.26,.6,.34)}const r=pe*.24*a,l=.7;for(let h=0;h<5;h++){const c=h/5*$e+Math.random()*.8,d=(2.3+Math.random()*1.4)*a;vi(t,"onion",o+Math.cos(c)*r,n,s+Math.sin(c)*r,Math.cos(c)*d+i.x*l,1.9+Math.random()*1.2,Math.sin(c)*d+i.z*l,a,.4+Math.random()*.12)}for(let h=0;h<3;h++){const c=Math.random()*$e,d=(2.3+Math.random()*1.5)*a;xu(t,o+Math.cos(c)*r,n,s+Math.sin(c)*r,Math.cos(c)*d+i.x*l,1.6+Math.random()*1.4,Math.sin(c)*d+i.z*l,(.75+Math.random()*.45)*a,.4)}for(let h=0;h<7;h++){const c=Math.random()*$e,d=(2.5+Math.random()*1.9)*a;xi(t,o+Math.cos(c)*r*.8,n,s+Math.sin(c)*r*.8,Math.cos(c)*d+i.x*l,1.4+Math.random()*1.6,Math.sin(c)*d+i.z*l,(.8+Math.random()*.6)*a,.34+Math.random()*.12)}}function mr(t,e,a){const o=t.direction,{x:n,y:s,z:i}=t.position,r=hh();r.color.set(zn),r.opacity=.9;const l=new E(fu,r);l.renderOrder=11;const h=Math.atan2(o.x,o.z),c=Po*.9*a;t.spawnTransient(l,.18,d=>{const p=c*(1+d*1.5);l.position.set(n+o.x*d*pe*.14,s-d*pe*.04,i+o.z*d*pe*.14),l.scale.set(p,yi*1.1*a*(1-d*.35),p),l.rotation.set(0,h+d*1.1,0),r.opacity=.9*(1-d*d)}),ch(t,n+o.x*pe*.06,s,i+o.z*pe*.06,pe*.1*a);for(let d=0;d<7;d++)xi(t,n,s,i,o.x*(1.4+Math.random()*1.1)+(Math.random()-.5)*.9,.6+Math.random()*.7,o.z*(1.4+Math.random()*1.1)+(Math.random()-.5)*.9,.9,.3);for(const d of e)vi(t,d,n,s,i,o.x*(1.3+Math.random()*.7)+(Math.random()-.5)*.6,.8+Math.random()*.5,o.z*(1.3+Math.random()*.7)+(Math.random()-.5)*.6,.9*a,.3)}const Jy=pe*.83/(we*2.8),Qy=new st(pe*.06,7,6),e2=ho(8,()=>Ko("#FFF3D6",{blending:Qe,opacity:0}));function yd(t,e){let a=0;t.traverse(o=>{o.isMesh&&!o.name&&(o.name=`${e}Part${a++}`)})}const t2={Filling:{projectile(t){const e=ur(t.color);return e.position.copy(t.position),e},trail(t){md(t,1.7)},impact(t){gd(t,1)},cast(t){mr(t,["meat","tomato"],1)}},Onion:{projectile(t){const e=fr(t.color);return e.position.copy(t.position),e},trail(t){wd(t,1.2)},impact(t){bd(t,1)},cast(t){mr(t,["onion","onion"],1)}},Double:{projectile(t){const e=pr(t)===1?fr(t.color):ur(t.color);return e.scale.setScalar(1.12),e.position.copy(t.position),e},trail(t){pr(t)===1?wd(t,1.3):md(t,1.9)},impact(t){pr(t)===1?bd(t,1.12):gd(t,1.12)},cast(t){mr(t,["meat","onion","tomato"],1.25)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=new e.Group;o.name="teleTacoRoot";const n=t.position.clone();n.y-=pe*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=t.weapon.comboParts??[],i=ur(s[0]?.color??t.color);i.name="teleTacoFilling";const r=fr(s[1]?.color??"#B497D6");r.name="teleTacoOnion",yd(i,"teleTacoFilling"),yd(r,"teleTacoOnion"),o.add(i,r);const l=6,h=[];for(let m=0;m<l;m++){const g=new e.Mesh(Qy,e2());g.name=`teleTacoSpark${m}`,h.push(g),o.add(g)}const c=(m,g,w)=>{const b=e.MathUtils.clamp((m-g)/(w-g),0,1);return b*b*(3-2*b)},d=pe*.48,p=pe*.72,u=[e.MathUtils.degToRad(s[0]?.angle??-10),e.MathUtils.degToRad(s[1]?.angle??10)],f=(m,g)=>{const w=e.MathUtils.clamp(g/a,0,1),b=c(w,0,.42),y=c(w,.3,.82),k=c(w,.82,1);for(let x=0;x<2;x++){const M=x===0?i:r,v=x===0?-1:1,T=.76+.24*b,S=-pe*.62*y,R=d*(.55+.65*b+.35*y),F=u[x],A=pe*.85*k,C=v*R+Math.sin(F)*A,N=S+Math.cos(F)*A;M.position.set(C,p+pe*(.2*y+.1*k),N),M.scale.setScalar(Jy*T*(1+.18*k)),M.rotation.set(w*5.5*(x===0?1:-1),w*3.1,w*2.2*v)}for(let x=0;x<l;x++){const M=h[x],v=x/l*$e+w*6.5,T=d*(.25+.85*b);M.position.set(Math.cos(v)*T,p+Math.sin(v*1.7)*pe*.16+pe*.18*y,Math.sin(v)*T*.55-pe*.3*y);const S=.85+1.15*w;M.scale.setScalar(S),M.material.opacity=.45+.45*w}};f(0,0),t.spawnTransient(o,a+.06,f)}}},Xo="#F5EAD6",a2="#E4CFA0",ku="#B9843C",Mu="#6B3E12",Eu="#452D18",ki="#E0562B",Tu="#D5EAF4",dh="#FFFFFF",Hn="#FFF6E4",Su="#5B3324",ph="#FFC93C",uh="#E63946",fh="#7DA33F",o2="#FFFDF7",ae=J,Ie=Math.PI*2,Rn=.29,Ne=ae*.115,it=ae*.3,n2=ae*.085,Au=ae*.075,mh=ae*.09,Bo=ae*.032,gr=ae*.058,s2=ae*.1,qo=ae*.022,i2=ae*.4,r2=ae*.97,l2=ae*.7,Ru=ae*.11,kl=new Rt(1,1,1),h2=new Me(.5,.5,1,8,1,!0,-1.5,3),Iu=new li(.5,0),Cu=new Bl(.62,0),_n=new Pl(1,1.4,3,6);_n.scale(.5,1/3.4,.5);const Fu=new st(.5,8,6),In=new Rt(1,1,1),Ou=new Wo(.5,1,4),Cn=new Rt(1,1,1),xd=new $l(1,.085,5,18),vd=new Me(1,1,1,16,1),c2=new Me(.55,1,1,14,1),d2=new Me(1,1,1,12,1,!0,-1.55,3.1),p2=new lo(1,18);function da(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const pa=(t,e={})=>new V({color:t,transparent:!0,opacity:1,depthWrite:!1,side:me,...e}),u2=da(30,()=>pa(Xo)),Mo=da(34,()=>pa(Hn)),f2=da(6,()=>pa(ki)),m2=da(10,()=>pa(Xo)),g2=da(10,()=>pa(Mu)),Nu=da(24,()=>pa(dh)),We=(t,e={})=>new V({color:t,side:me,...e}),kd=We(Xo),Md=We(a2),cs=We(ku),w2=We(Tu),b2=We(ki),Ed=We(Hn),y2=We(Su);We(ph);We(uh);We(fh);const x2=[We(fh),We(uh),We(ph),We(Hn)],v2=[We("#5C7F2A"),We("#B02733"),We("#E0A317"),We(o2)],ds=new de,ps=new de,wr=new de,Td=new f0;function k2(t,e,a,o,n,s,i){ds.set(e,a,o).normalize(),ps.set(n,s,i).normalize(),wr.crossVectors(ds,ps).normalize(),ps.crossVectors(wr,ds).normalize(),Td.makeBasis(ds,ps,wr),t.quaternion.setFromRotationMatrix(Td)}function M2(t){return t.range&&t.speed?t.range/t.speed:ro.normal/1e3}function Sd(t){const e=t.weapon.pelletColors;if(!e||e.length===0)return 0;const a=e.indexOf(t.color);return a>=0?a%4:0}function Ml(t){return W.clamp(.85+t*.035,.85,1.35)}function Lu(t,e,a){let o=t.userData.__spin;return o||(o={t:Math.random()*Ie,rate:a*Ie/M2(e),shed:0,age:0},t.userData.__spin=o),o}function Ft(t,e,a,o,n,s,i,r,l,h,c,d,p,u,f=-9){a.color.set(o),a.opacity=1;const m=new E(e,a);m.renderOrder=9,m.position.set(n,s,i),m.scale.set(c,d,p),m.rotation.set(Math.random()*Ie,Math.random()*Ie,Math.random()*Ie);const g=(Math.random()-.5)*18,w=(Math.random()-.5)*18,b=(Math.random()-.5)*18,y=m.rotation.x,k=m.rotation.y,x=m.rotation.z;t.spawnTransient(m,u,(M,v)=>{const T=s+l*v+.5*f*v*v,S=T<=Rn;m.position.set(n+r*v,S?Rn:T,i+h*v),S||m.rotation.set(y+g*v,k+w*v,x+b*v),a.opacity=1-Math.pow(M,2.4)})}function Ho(t,e,a,o,n,s,i,r,l){const h=n2*r*(.85+Math.random()*.55),c=Math.random();Ft(t,h2,u2(),c<.24?Eu:c<.48?ku:Xo,e,a,o,n,s,i,h,h*.85,h,l,-7.5)}function Fn(t,e,a,o,n,s,i,r,l){const h=Au*r*(.7+Math.random()*.6);Ft(t,Math.random()<.5?Iu:Cu,Nu(),Math.random()<.45?dh:Tu,e,a,o,n,s,i,h*1.3,h*.34,h,l,-8.5)}function On(t,e,a,o,n,s,i,r,l,h){if(e==="rice")Ft(t,_n,Mo(),Hn,a,o,n,s,i,r,Bo*l,mh*l,Bo*l,h);else if(e==="bean"){const c=gr*l;Ft(t,Fu,Mo(),Su,a,o,n,s,i,r,c*1.35,c*.85,c*.85,h)}else if(e==="cheese")Ft(t,In,Mo(),ph,a,o,n,s,i,r,s2*l,qo*l,qo*l,h,-6.5);else if(e==="salsa"){const c=gr*.85*l;Ft(t,Cn,Mo(),uh,a,o,n,s,i,r,c,c,c,h)}else{const c=gr*l;Ft(t,Cn,Mo(),fh,a,o,n,s,i,r,c*1.2,c*.55,c*1.2,h)}}const E2=ae*.075,us=da(28,()=>pa(Hn)),Ad=7;function T2(t,e,a,o,n,s,i,r,l,h){const c=t.color,d=E2*l;if(e===0)Ft(t,Ou,us(),c,a,o,n,s,i,r,d*.5,d*2.6,d*.22,h,-7.2);else if(e===1){const p=d*(1+Math.random()*.35);Ft(t,Cn,us(),c,a,o,n,s,i,r,p,p,p,h)}else e===2?Ft(t,In,us(),c,a,o,n,s,i,r,d*2.5,qo*2.2,qo*2.2,h,-6.5):Ft(t,_n,us(),c,a,o,n,s,i,r,Bo*1.15*l,mh*1.15*l,Bo*1.15*l,h,-7.5)}function El(t,e){const{x:a,y:o,z:n}=t.position,s=t.direction,i=Math.random()*Ie;for(let r=0;r<8;r++){const l=i+r/8*Ie,h=Nu();h.color.set(r%2===0?dh:Eu),h.opacity=1;const c=new E(r%2===0?Iu:Cu,h);c.renderOrder=12;const d=Math.cos(l),p=Math.sin(l),u=ae*.26*e,f=ae*.44*e,m=(Math.random()-.5)*14;t.spawnTransient(c,.14,g=>{const w=1-Math.pow(1-g,2.2),b=W.lerp(u,f,w);c.position.set(a+d*b+s.x*b*.28,o+w*ae*.05,n+p*b+s.z*b*.28);const y=Au*e*(1.7-g*.5);c.scale.set(y*1.6,y*.34,y),c.rotation.set(m*g,Math.atan2(d,p),m*g*.6),h.opacity=g<.45?1:1-(g-.45)/.55})}}const ka=16,Du=2.35,S2=.42;function gh(t){const e=new ie,a=m2(),o=g2();a.color.set(Xo),a.opacity=1,o.color.set(Mu),o.opacity=1;const n=[];for(let s=0;s<t;s++){const i=new E(kl,o);i.renderOrder=10;const r=new E(kl,a);r.renderOrder=11,i.scale.setScalar(0),r.scale.setScalar(0),e.add(i,r),n.push({face:r,back:i})}return{group:e,slats:n,faceMat:a,backMat:o}}function A2(t,e,a,o,n,s,i,r){const{group:l,slats:h,faceMat:c,backMat:d}=gh(ka),p=ae*.06*i,u=ae*.15*i,f=l2*i,m=Ru*i,g=(k,x,M)=>{const v=k*Du*Ie*s,T=k*S2*Ie*s,S=v+(T-v)*x,R=p+k*(u-p),F=p+k*(f-p),A=R+(F-R)*x;M.x=e+Math.cos(n+S)*A,M.z=o+Math.sin(n+S)*A},w={x:0,z:0},b={x:0,z:0},y=k=>{const x=1-Math.pow(1-Math.min(1,k/.62),2.4),M=W.lerp(a,Rn,1-Math.pow(1-Math.min(1,k/.72),1.8));for(let T=0;T<ka;T++){const S=T/ka,R=(T+1)/ka;g(S,x,w),g(R,x,b);const F=b.x-w.x,A=b.z-w.z,C=Math.hypot(F,A)*1.14,N=Math.atan2(F,A),L=(w.x+b.x)*.5,P=(w.z+b.z)*.5,j=m*(1-S*.35),{face:z,back:Y}=h[T];z.rotation.set(0,N,0),Y.rotation.set(0,N,0),z.position.set(L,M+.022,P),Y.position.set(L,M,P),z.scale.set(j,ae*.008,C),Y.scale.set(j*1.8,ae*.006,C*1.12)}const v=k<.68?1:1-(k-.68)/.32;c.opacity=v,d.opacity=v*.95};y(0),t.spawnTransient(l,r,y)}function R2(t,e,a){const{x:o,z:n}=t.position,s=22,i=2.2,r=i2*e,{group:l,slats:h,faceMat:c,backMat:d}=gh(s),p=Math.random()*Ie,u=Rn+ae*.02,f=(r2*e-u)/(s-1),m=i*Ie/(s-1),g=w=>{const b=Math.min(1,w/.52),y=w<.62?1:1-(w-.62)/.38*.16;for(let x=0;x<s;x++){const M=x/s*.9,v=b>M,{face:T,back:S}=h[x];if(T.visible=v,S.visible=v,!v)continue;const R=p+x*m,F=r*y,A=o+Math.cos(R)*F,C=u+x*f,N=n+Math.sin(R)*F;k2(T,-Math.sin(R)*F*m,f,Math.cos(R)*F*m,Math.cos(R),0,Math.sin(R)),S.quaternion.copy(T.quaternion);const L=F*m*1.02,P=ae*.1*e;T.position.set(A,C,N),S.position.set(A-Math.cos(R)*.02,C,N-Math.sin(R)*.02),T.scale.set(L,ae*.009,P),S.scale.set(L*1.02,ae*.007,P*1.75)}const k=w<.62?1:1-(w-.62)/.38;c.opacity=.88*k,d.opacity=.92*k};g(0),t.spawnTransient(l,a,g)}function zu(t,e,a,o,n,s,i,r,l){const{group:h,slats:c,faceMat:d,backMat:p}=gh(ka),u=ae*.03*r,f=ae*.13*r,m=Math.random()<.5?1:-1,g=m*(9+Math.random()*5),w={x:0,z:0},b={x:0,z:0},y=(x,M,v)=>{const T=M+x*Du*Ie*m,S=u+x*(f-u);v.x=Math.cos(T)*S,v.z=Math.sin(T)*S},k=(x,M)=>{const v=g*M,T=e+n*M,S=Math.max(Rn,a+s*M-4*M*M),R=o+i*M;for(let A=0;A<ka;A++){y(A/ka,v,w),y((A+1)/ka,v,b);const C=b.x-w.x,N=b.z-w.z,L=Math.hypot(C,N)*1.16,P=Math.atan2(C,N),{face:j,back:z}=c[A];j.rotation.set(0,P,0),z.rotation.set(0,P,0),j.position.set(T+(w.x+b.x)*.5,S+.018,R+(w.z+b.z)*.5),z.position.set(T+(w.x+b.x)*.5,S,R+(w.z+b.z)*.5);const Y=Ru*r*.72;j.scale.set(Y,ae*.007,L),z.scale.set(Y*1.8,ae*.005,L*1.14)}const F=1-Math.pow(x,2);d.opacity=F,p.opacity=F*.95};k(0,0),t.spawnTransient(h,l,k)}function I2(t){const e=new ie,a=new ie;e.add(a),kd.color.set(t);const o=new E(vd,kd);o.rotation.x=Math.PI/2,o.scale.set(Ne,it*.8,Ne),a.add(o);const n=new E(c2,Md);n.rotation.x=-Math.PI/2,n.scale.set(Ne,it*.12,Ne),n.position.z=-it*.46,a.add(n);const s=new E(d2,cs);s.rotation.x=Math.PI/2,s.scale.set(Ne*1.02,it*.8,Ne*1.02),a.add(s);const i=new E(In,cs);i.position.set(Ne*.92,0,0),i.rotation.set(.42,0,0),i.scale.set(Ne*.14,Ne*.16,it*.82),a.add(i);const r=new E(vd,w2);r.rotation.x=Math.PI/2,r.scale.set(Ne*1.07,it*.26,Ne*1.07),r.position.z=-it*.2,a.add(r);for(const c of[-it*.1,it*.04]){const d=new E(xd,b2);d.scale.set(Ne*1.08,Ne*1.08,Ne*.85),d.position.z=c,a.add(d)}const l=new E(p2,Md);l.scale.setScalar(Ne*.99),l.position.z=it*.404,a.add(l);const h=[cs,Ed,cs];for(let c=0;c<3;c++){const d=new E(xd,h[c]),p=Ne*(.78-c*.25);d.scale.set(p,p,Ne*.2),d.position.z=it*.412,a.add(d)}for(let c=0;c<4;c++){const d=c/4*Ie+.5,p=new E(c%2===0?_n:Fu,c%2===0?Ed:y2),u=Ne*.28;p.scale.set(u,c%2===0?u*2:u,u),p.position.set(Math.cos(d)*Ne*.6,Math.sin(d)*Ne*.6,it*.42),p.rotation.set(Math.random(),Math.random(),Math.random()),a.add(p)}return e.userData.__spinner=a,e}function Rd(t){const e=new ie,a=x2[t],o=v2[t],n=ae*.075;if(t===0){for(let i=0;i<3;i++){const r=new E(Ou,i===1?o:a);r.scale.set(n*.5,n*2.6,n*.22),r.position.set((i-1)*n*.5,n*.4,0),r.rotation.set(.2,0,(i-1)*.55),e.add(r)}const s=new E(In,o);s.scale.set(n*.16,n*1.2,n*.16),s.position.y=-n*.7,e.add(s)}else if(t===1)for(let s=0;s<3;s++){const i=s/3*Ie,r=new E(Cn,s===2?o:a),l=n*(1+Math.random()*.35);r.scale.setScalar(l),r.position.set(Math.cos(i)*n*.75,Math.sin(i)*n*.5,Math.sin(i*1.7)*n*.55),r.rotation.set(Math.random(),Math.random(),Math.random()),e.add(r)}else if(t===2)for(let s=0;s<4;s++){const i=new E(In,s===3?o:a);i.scale.set(n*2.5,qo*1.2,qo*1.2),i.position.set(0,(s-1.5)*n*.28,(s-1.5)*n*.2),i.rotation.set(0,(s-1.5)*.28,(s-1.5)*.14),e.add(i)}else for(let s=0;s<5;s++){const i=s/5*Ie+.3,r=new E(_n,s===4?o:a);r.scale.set(Bo*1.15,mh*1.15,Bo*1.15),r.position.set(Math.cos(i)*n*.55,Math.sin(i*1.3)*n*.4,Math.sin(i)*n*.55),r.rotation.set(Math.random()*2,Math.random()*2,Math.random()*2),e.add(r)}return e}function C2(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Lu(e,t.weapon,9);o.t+=o.rate*a;const n=e.userData.__spinner;if(n&&(n.rotation.z=o.t),e.rotation.x=Math.sin(o.t*.35)*.1,o.shed-=a,o.shed<=0){o.shed=.055+Math.random()*.04;const s=t.position.x-t.direction.x*it*.5,i=t.position.z-t.direction.z*it*.5,r=Math.random();r<.42?On(t,"rice",s,t.position.y-Ne*.3,i,-t.direction.x*.6+(Math.random()-.5)*.7,-.15-Math.random()*.4,-t.direction.z*.6+(Math.random()-.5)*.7,.9,.32):r<.72?Ho(t,s,t.position.y,i,-t.direction.x*.8+(Math.random()-.5)*.6,.15+Math.random()*.3,-t.direction.z*.8+(Math.random()-.5)*.6,.75,.3):Fn(t,s,t.position.y,i,-t.direction.x*.9+(Math.random()-.5)*.5,.2+Math.random()*.35,-t.direction.z*.9+(Math.random()-.5)*.5,.65,.26)}}function F2(t){const e=Ml(t.damage),{x:a,y:o,z:n}=t.position,s=t.direction;El(t,e);const i=ae*.16*e;let r=-s.z,l=s.x;Math.hypot(r,l)<1e-4&&(r=1,l=0);const h=Math.atan2(s.z,s.x);for(const p of[-1,1])A2(t,a+s.x*i+r*p*i*.7,o,n+s.z*i+l*p*i*.7,h+p*1.05,p,e*.92,.78);const c=ae*.26*e,d=.8;for(let p=0;p<9;p++){const u=p/9*Ie+Math.random()*.6,f=(2.3+Math.random()*1.5)*e,m=Math.random();On(t,m<.32?"rice":m<.66?"bean":m<.85?"cheese":"salsa",a+Math.cos(u)*c,o,n+Math.sin(u)*c,Math.cos(u)*f+s.x*d,1.9+Math.random()*1.3,Math.sin(u)*f+s.z*d,e,.42+Math.random()*.14)}for(let p=0;p<6;p++){const u=p/6*Ie+Math.random()*.9,f=(2.4+Math.random()*1.6)*e;Ho(t,a+Math.cos(u)*c,o,n+Math.sin(u)*c,Math.cos(u)*f+s.x*d,1.8+Math.random()*1.4,Math.sin(u)*f+s.z*d,(.9+Math.random()*.5)*e,.44+Math.random()*.12)}for(let p=0;p<4;p++){const u=Math.random()*Ie,f=(2.7+Math.random()*1.8)*e;Fn(t,a+Math.cos(u)*c*.9,o,n+Math.sin(u)*c*.9,Math.cos(u)*f+s.x*d,1.6+Math.random()*1.6,Math.sin(u)*f+s.z*d,(.8+Math.random()*.6)*e,.36+Math.random()*.12)}}function O2(t,e){const a=t.direction,{x:o,y:n,z:s}=t.position;zu(t,o,n,s,a.x*2.2+(Math.random()-.5)*.4,.7,a.z*2.2+(Math.random()-.5)*.4,e,.26);for(let i=0;i<5;i++)On(t,i%2===0?"rice":"bean",o,n,s,a.x*(1.5+Math.random()*1)+(Math.random()-.5)*.9,.7+Math.random()*.6,a.z*(1.5+Math.random()*1)+(Math.random()-.5)*.9,.9*e,.3);for(let i=0;i<4;i++)Fn(t,o,n,s,a.x*(1.7+Math.random()*1.2)+(Math.random()-.5)*.8,.8+Math.random()*.6,a.z*(1.7+Math.random()*1.2)+(Math.random()-.5)*.8,.8*e,.24);for(let i=0;i<3;i++)Ho(t,o,n,s,a.x*(1.3+Math.random()*.9)+(Math.random()-.5)*.7,.6+Math.random()*.5,a.z*(1.3+Math.random()*.9)+(Math.random()-.5)*.7,.8*e,.26)}const N2=3.6,Id=new st(1,14,10),L2=da(4,()=>pa(ki,{opacity:.85})),D2=da(4,()=>pa(Xo,{opacity:.7}));function z2(t,e){let a=0;t.traverse(o=>{o.isMesh&&!o.name&&(o.name=`${e}Part${a++}`)})}const H2={Disc:{projectile(t){const e=I2(t.color);return e.position.copy(t.position),e},trail(t){C2(t)},impact(t){F2(t)},cast(t){O2(t,1)}},Roll:{impact(t){const e=Ml(t.damage);R2(t,1,.62),El(t,e*.85);const{x:a,y:o,z:n}=t.position,s=t.direction,i=ae*.24*e;for(let r=0;r<5;r++){const l=r/5*Ie+Math.random()*.8,h=(2+Math.random()*1.3)*e;On(t,r%2===0?"rice":"guac",a+Math.cos(l)*i,o,n+Math.sin(l)*i,Math.cos(l)*h+s.x*.6,1.7+Math.random()*1.1,Math.sin(l)*h+s.z*.6,e,.38+Math.random()*.12)}for(let r=0;r<3;r++){const l=Math.random()*Ie,h=(2.2+Math.random()*1.4)*e;Ho(t,a+Math.cos(l)*i,o,n+Math.sin(l)*i,Math.cos(l)*h+s.x*.6,1.6+Math.random()*1.2,Math.sin(l)*h+s.z*.6,.85*e,.4)}},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position;for(const s of[-.5,.5])zu(t,a-e.z*s*ae*.12,o,n+e.x*s*ae*.12,e.x*2.6-e.z*s*1.2,.5,e.z*2.6+e.x*s*1.2,.9,.3);for(let s=0;s<5;s++)Ho(t,a,o,n,e.x*(1.6+Math.random()*1.1)+(Math.random()-.5)*1,.6+Math.random()*.6,e.z*(1.6+Math.random()*1.1)+(Math.random()-.5)*1,.85,.28);for(let s=0;s<3;s++)Fn(t,a,o,n,e.x*(1.8+Math.random()*1)+(Math.random()-.5)*.9,.7+Math.random()*.5,e.z*(1.8+Math.random()*1)+(Math.random()-.5)*.9,.75,.24)}},Swarm:{projectile(t){const e=Rd(Sd(t));return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Lu(e,t.weapon,2.4);o.t+=o.rate*a,o.age+=a;const n=Math.sin(o.age*7.5+o.t)*ae*.085;if(e.position.x+=-t.direction.z*n,e.position.z+=t.direction.x*n,e.position.y+=Math.sin(o.age*5.2)*ae*.03,e.rotation.x=o.t*.8,e.rotation.z=Math.sin(o.t*.7)*.7,o.shed-=a,o.shed<=0){o.shed=.14+Math.random()*.08;const s=Mo();s.color.set(t.color),s.opacity=1;const i=new E(Cn,s);i.renderOrder=9;const r=e.position.x,l=e.position.y,h=e.position.z,c=ae*.03;i.position.set(r,l,h),i.scale.setScalar(c),t.spawnTransient(i,.26,(d,p)=>{i.position.set(r,l-.5*p*p,h),i.scale.setScalar(c*(1-d*.6)),s.opacity=1-d})}},impact(t){const e=Ml(t.damage)*.8,{x:a,y:o,z:n}=t.position,s=t.direction;El(t,1);const i=ae*.28,r=Sd(t);for(let l=0;l<Ad;l++){const h=l/Ad*Ie+Math.random()*.8,c=(2.6+Math.random()*1.5)*e;T2(t,r,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*.7,1.8+Math.random()*1.2,Math.sin(h)*c+s.z*.7,1.15,.44+Math.random()*.1)}for(let l=0;l<4;l++){const h=l/4*Ie+Math.random()*.9,c=(2.5+Math.random()*1.5)*e;Ho(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*.5,1.6+Math.random()*1.2,Math.sin(h)*c+s.z*.5,1+Math.random()*.4,.38)}},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position,s=(t.weapon.spreadDeg??40)*Math.PI/360,i=["guac","salsa","cheese","rice"];for(let c=0;c<12;c++){const d=(Math.random()*2-1)*s,p=Math.cos(d),u=Math.sin(d),f=e.x*p-e.z*u,m=e.x*u+e.z*p,g=1.8+Math.random()*1.4;On(t,i[c%4],a,o,n,f*g,.8+Math.random()*.7,m*g,.95,.34)}const r=f2();r.color.set(ki),r.opacity=1;const l=new E(kl,r);l.renderOrder=11;const h=Math.atan2(e.x,e.z);t.spawnTransient(l,.2,c=>{const d=1-Math.pow(1-c,2);l.position.set(a+e.x*d*ae*.3,o+d*ae*.05,n+e.z*d*ae*.3),l.rotation.set(0,h+d*.8,0),l.scale.set(ae*.2*(1+d*.5),ae*.01,ae*.05),r.opacity=1-c*c});for(let c=0;c<4;c++)Fn(t,a,o,n,e.x*(1.6+Math.random()*1.1)+(Math.random()-.5)*1.1,.8+Math.random()*.6,e.z*(1.6+Math.random()*1.1)+(Math.random()-.5)*1.1,.8,.26)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=new e.Group;o.name="teleBurritoRoot";const n=t.position.clone();n.y-=ae*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=L2(),i=new e.Mesh(Id,s);i.name="teleBurritoBulge",o.add(i);const r=D2(),l=new e.Mesh(Id,r);l.name="teleBurritoShell",o.add(l);const h=4,c=[];for(let g=0;g<h;g++){const w=Rd(g);w.name=`teleBurritoTopping${g}`,z2(w,`teleBurritoTopping${g}`),c.push(w),o.add(w)}const d=(g,w,b)=>{const y=e.MathUtils.clamp((g-w)/(b-w),0,1);return y*y*(3-2*y)},p=ae*.78,u=ae*.22,f=(t.weapon.spreadDeg??55)*Math.PI/360,m=(g,w)=>{const b=e.MathUtils.clamp(w/a,0,1),y=d(b,0,.4),k=d(b,.85,1),x=ae*(.13+.15*y)*(1-.35*k);i.position.set(0,p,u),i.scale.set(x,x*(.82+.25*Math.sin(b*11)),x),s.opacity=(.55+.4*y)*(1-k*.8);const M=ae*(.17-.05*y);l.position.set(0,p-ae*.04,u-ae*.16),l.scale.set(M,M*(1.25-.3*y),M),r.opacity=.62*(1-k*.9);for(let v=0;v<h;v++){const T=c[v],S=v*.09,R=d(b,.18+S,.85),F=(v/(h-1)-.5)*2*f,A=v/h*Ie+b*(3.2+2.4*R),C=e.MathUtils.lerp(A,F,k),N=ae*(.42+.34*R+.26*k);T.position.set(Math.sin(C)*N,p+Math.sin(A*1.6)*ae*.1*(1-k)+ae*.1*R,u+Math.cos(C)*N*(.55+.45*k));const L=2.2+(N2-2.2)*R;T.scale.setScalar(L),T.rotation.set(b*4.2+v,b*3-v,b*2.4)}};m(0,0),t.spawnTransient(o,a+.06,m)}}},co="#FFF8EA",wh="#E4D6AE",Mi="#FFFFFF",bh="#4A3118",Hu="#FF9E12",_2="#FFCE55",_u="#F4FBFF",As="#FFD84D",P2="#EFB528",$2="#F5872B",B2="#2A2320",Pu="#FFF0B8",Te=J,De=Math.PI*2,oo=.29,q2=Te*.31,U2=Te*.2,$u=Te*.03,j2=Te*.062,G2=Te*.115,W2=Te*.052,Y2=Te*.16,V2=Te*.026,K2=Te*.045,Ua=Te*.125,rt=Te*.085,fs=Te*.115,no=new Wo(.5,1,4);no.rotateZ(-Math.PI/2);const Tl=new st(.5,16,11,0,Math.PI*1.5),X2=new Me(.5,.5,1,8,1,!0,-1.35,2.7),Z2=new Me(.5,.5,1,8,1,!0,-1.2,2.4),Fo=new st(.5,12,10),yh=new Pl(1,2.2,3,7);yh.scale(.5,1/4.2,.5);yh.rotateZ(-Math.PI/2);const Bu=new Bl(.62,0),J2=new Wo(.5,1,3),Q2=new Rt(1,1,1),qu=new Wo(.5,1,4);qu.rotateX(Math.PI/2);function Pn(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const $n=(t,e={})=>new V({color:t,transparent:!0,opacity:1,depthWrite:!1,side:me,...e}),Uu=Pn(34,()=>$n(co)),ex=Pn(18,()=>$n(Hu)),tx=Pn(18,()=>$n(_u)),ax=Pn(16,()=>$n(Pu)),Uo=Pn(40,()=>$n(Mi)),ia=(t,e={})=>new V({color:t,side:me,...e}),br=ia(co),Sl=ia(wh),ox=ia(co),Cd=ia($2),nx=ia(B2),Fd=ia(P2),Od=[ia(As),ia(As),ia(As)];let sx=0;const pn=new de,un=new de,yr=new de,Nd=new f0;function Ei(t,e,a,o){pn.set(e,a,o).normalize(),Math.abs(pn.y)>.94?un.set(1,0,0):un.set(0,1,0),yr.crossVectors(pn,un).normalize(),un.crossVectors(yr,pn).normalize(),Nd.makeBasis(pn,un,yr),t.quaternion.setFromRotationMatrix(Nd)}function ix(t){return t.range&&t.speed?t.range/t.speed:ro.normal/1e3}function Al(t){return W.clamp(.85+t*.035,.85,1.45)}function rx(t,e,a,o,n,s,i,r,l,h,c,d,p,u,f=-9){a.color.set(o),a.opacity=1;const m=new E(e,a);m.renderOrder=9,m.position.set(n,s,i),m.scale.set(c,d,p),m.rotation.set(Math.random()*De,Math.random()*De,Math.random()*De);const g=(Math.random()-.5)*20,w=(Math.random()-.5)*20,b=(Math.random()-.5)*20,y=m.rotation.x,k=m.rotation.y,x=m.rotation.z;t.spawnTransient(m,u,(M,v)=>{const T=s+l*v+.5*f*v*v,S=T<=oo;m.position.set(n+r*v,S?oo:T,i+h*v),S||m.rotation.set(y+g*v,k+w*v,x+b*v),a.opacity=1-Math.pow(M,2.4)})}function Ya(t,e,a,o,n,s,i,r,l){const h=j2*r*(.75+Math.random()*.6);rx(t,Bu,Uu(),Math.random()<.3?wh:co,e,a,o,n,s,i,h,h*.8,h,l)}function xr(t,e,a,o,n,s,i,r,l){const h=ex();h.color.set(Math.random()<.3?_2:Hu),h.opacity=1;const c=new E(Fo,h);c.renderOrder=9;const d=W2*r*(.8+Math.random()*.6);c.position.set(e,a,o),c.scale.setScalar(d);const p=14+Math.random()*10,u=Math.random()*De;t.spawnTransient(c,l,(f,m)=>{const g=a+s*m-4.4*m*m;c.position.set(e+n*m,Math.max(oo,g),o+i*m);const w=Math.sin(u+m*p)*.24;c.scale.set(d*(1+w),d*(1-w),d*(1+w*.4)),h.opacity=1-Math.pow(f,3)})}function Rs(t,e,a,o,n,s,i,r,l){const h=tx();h.color.set(_u),h.opacity=.78;const c=new E(yh,h);c.renderOrder=10,c.position.set(e,a,o);const d=Y2*r*(.55+Math.random()*.4),p=V2*r*(.75+Math.random()*.5);Ei(c,n,s,i),c.scale.set(d,p,p),t.spawnTransient(c,l,(u,f)=>{const m=a+s*f-2.2*f*f;c.position.set(e+n*f,Math.max(oo,m),o+i*f),c.scale.set(d*(1+u*1.5),p*(1-u*.4),p*(1-u*.4)),h.opacity=.78*(1-Math.pow(u,1.8))})}function xh(t,e,a,o,n,s,i,r){const l=ax();l.color.set(Math.random()<.35?As:Pu),l.opacity=1;const h=new E(J2,l);h.renderOrder=9;const c=K2*i*(.7+Math.random()*.6);h.position.set(e,a,o),h.scale.set(c,c*1.5,c*.35);const d=4+Math.random()*4,p=Math.random()*De;t.spawnTransient(h,r,(u,f)=>{h.position.set(e+n*f+Math.sin(p+f*d)*.1,a+.35*f-.55*f*f,o+s*f+Math.cos(p+f*d*.8)*.1),h.rotation.set(Math.sin(p+f*d)*1.5,f*2.2,Math.cos(p+f*d*.7)*1.2),l.opacity=1-Math.pow(u,2)})}function Is(t,e,a,o=.13){const{x:n,y:s,z:i}=t.position,r=t.direction,l=Math.random()*De;for(let h=0;h<e;h++){const c=l+h/e*De+(Math.random()-.5)*.5,d=(h%3-1)*.42+(Math.random()-.5)*.2,p=Math.cos(d),u=Math.cos(c)*p,f=Math.sin(d),m=Math.sin(c)*p,g=Uo();g.color.set(h%2===0?Mi:co),g.opacity=1;const w=Uo();w.color.set(bh),w.opacity=1;const b=new E(no,g),y=new E(no,w);b.renderOrder=13,y.renderOrder=12;const k=q2,x=k+U2*a*(.7+Math.random()*.55),M=$u*(.8+Math.random()*.45),v=n+r.x*k*.22,T=i+r.z*k*.22,S=new ie;S.add(y,b),Ei(b,u,f,m),y.quaternion.copy(b.quaternion),t.spawnTransient(S,o,R=>{const F=1-Math.pow(1-R,2.4),A=W.lerp(k,k+(x-k)*.45,F),C=W.lerp(k+(x-k)*.35,x,F),N=Math.max(.02,C-A),L=(A+C)*.5;b.position.set(v+u*L,s+f*L,T+m*L),y.position.copy(b.position),b.scale.set(N,M,M),y.scale.set(N*1.06,M*2.6,M*2.6);const P=R<.45?1:1-(R-.45)/.55;g.opacity=P,w.opacity=P})}}function Ld(t,e,a,o){const{x:n,z:s}=t.position,i=Math.random()*De,r=new ie,l=Uo();l.color.set(Mi),l.opacity=1;const h=Uo();h.color.set(bh),h.opacity=1;const c=[];for(let u=0;u<e;u++){const f=i+u/e*De+(Math.random()-.5)*.55,m=new E(no,h),g=new E(no,l);m.renderOrder=10,g.renderOrder=11,m.scale.setScalar(0),g.scale.setScalar(0),Ei(g,Math.cos(f),0,Math.sin(f)),m.quaternion.copy(g.quaternion),r.add(m,g),c.push({face:g,seam:m,a:f,len:Te*(.16+Math.random()*.3)*a,w:Te*(.02+Math.random()*.014)*a})}const d=Te*.2*a,p=u=>{const f=1-Math.pow(1-Math.min(1,u/.22),2.6);for(const g of c){const w=Math.max(.001,g.len*f),b=d+w*.5,y=n+Math.cos(g.a)*b,k=s+Math.sin(g.a)*b;g.face.position.set(y,oo+.012,k),g.seam.position.set(y,oo,k),g.face.scale.set(w,Te*.006,g.w),g.seam.scale.set(w*1.05,Te*.004,g.w*2.1)}const m=u<.42?1:1-(u-.42)/.58;l.opacity=.92*m,h.opacity=.92*m};p(0),t.spawnTransient(r,o,p)}function Dd(t,e,a,o){const{x:n,y:s,z:i}=t.position,r=t.direction;let l=-r.z,h=r.x;Math.hypot(l,h)<1e-4&&(l=1,h=0);for(const c of[-1,1]){const d=Uu();d.color.set(c<0?co:wh),d.opacity=1;const p=new E(Tl,d);p.renderOrder=10;const u=n+l*c*Te*.26*e,f=i+h*c*Te*.26*e,m=G2*2*e;p.position.set(u,s,f),p.scale.set(m,m*1.15,m),p.rotation.set(0,c*1.4,0);const g=l*c*a+r.x*a*.35,w=h*c*a+r.z*a*.35,b=1.6+Math.random()*.9,y=c*(6+Math.random()*4),k=(Math.random()-.5)*5;t.spawnTransient(p,o,(x,M)=>{const v=s+b*M-4.6*M*M;p.position.set(u+g*M,Math.max(oo,v),f+w*M),p.rotation.set(k*M,c*1.4+y*M,c*.4),d.opacity=1-Math.pow(x,2.2)})}}function lx(t){const e=new ie,a=new ie;e.add(a);const o=Od[sx++%Od.length];o.color.set(t);const n=Ua,s=new E(Fo,o);s.scale.set(n*2,n*1.85,n*1.9),s.position.y=n*.15,a.add(s);const i=new E(Fo,Fd);i.scale.set(n*1.5,n*.8,n*1.45),i.position.set(0,-n*.42,n*.18),a.add(i);const r=new E(qu,Cd);r.scale.set(n*.55,n*.46,n*.7),r.position.set(0,n*.26,n*.92),a.add(r);for(const c of[-1,1]){const d=new E(Fo,nx);d.scale.setScalar(n*.34),d.position.set(c*n*.4,n*.62,n*.62),a.add(d);const p=new E(Fo,Fd);p.scale.set(n*.34,n*.85,n*1.05),p.position.set(c*n*.92,n*.08,-n*.1),p.rotation.z=c*.4,a.add(p),p.userData.__side=c;const u=new E(Q2,Cd);u.scale.set(n*.18,n*.1,n*.44),u.position.set(c*n*.34,-n*.92,n*.12),a.add(u)}const l=new E(Tl,ox);l.scale.set(n*1.22,n*1,n*1.22),l.position.set(-n*.16,n*.88,-n*.22),l.rotation.set(Math.PI-.42,.7,.3),a.add(l);const h=new E(Tl,Sl);return h.scale.set(n*1.08,n*.8,n*1.08),h.position.set(-n*.16,n*.86,-n*.22),h.rotation.set(Math.PI-.42,.7,.3),a.add(h),e.userData.__bob=a,e}function hx(t){const e=new ie;br.color.set(t);const a=new E(X2,br);a.scale.set(rt*2,fs,rt*2),e.add(a);const o=new E(Z2,Sl);o.scale.set(rt*1.78,fs*.92,rt*1.78),e.add(o);for(let s=0;s<2;s++){const i=new E(Bu,br),r=rt*(.42+s*.18);i.scale.set(r,r*.7,r),i.position.set(rt*(s===0?.8:-.5),fs*(s===0?.45:-.5),rt*.4),i.rotation.set(Math.random()*2,Math.random()*2,Math.random()*2),e.add(i)}const n=new E(Fo,Sl);return n.scale.set(rt*.75,rt*.4,rt*.75),n.position.set(-rt*.2,-fs*.34,0),e.add(n),e}function ju(t,e,a){let o=t.userData.__anim;return o||(o={t:Math.random()*De,rate:a*De/ix(e.weapon),shed:0,age:0,lx:e.position.x,lz:e.position.z,speed:Je(e.weapon.speed??160)},t.userData.__anim=o),o}function cx(t){const e=t.object;if(!e)return;const a=t.dt??0,o=ju(e,t,1);o.age+=a;const n=Math.hypot(t.position.x-o.lx,t.position.z-o.lz);a>0&&(o.speed=o.speed*.55+n/a*.45),o.lx=t.position.x,o.lz=t.position.z;const s=Je(t.weapon.speed??160),i=o.speed<s*.28,r=e.userData.__bob;if(r)if(i){const l=o.age*2.2%1,h=Math.sin(Math.min(1,l*2.2)*Math.PI);r.position.set(0,-Ua*.3*h,Ua*.75*h),r.rotation.set(h*.95,0,0)}else{const l=o.age*7;r.position.set(0,Math.abs(Math.sin(l))*Ua*.22,0),r.rotation.set(0,0,Math.sin(l*.5)*.3);for(const h of r.children){const c=h.userData.__side;c!==void 0&&(h.rotation.z=c*(.4+Math.sin(l)*.5))}}o.shed-=a,o.shed<=0&&(o.shed=i?.1+Math.random()*.08:.2+Math.random()*.14,xh(t,t.position.x+(Math.random()-.5)*Ua,t.position.y+Ua*.3,t.position.z+(Math.random()-.5)*Ua,-t.direction.x*.25+(Math.random()-.5)*.35,-t.direction.z*.25+(Math.random()-.5)*.35,1,.7))}const dx=Te*.27;function px(t){const e=Al(t.damage)*1.25,{x:a,y:o,z:n}=t.position,s=t.direction;Is(t,4,e*1.15);const i=dx;for(let r=0;r<9;r++){const l=r/9*De+Math.random()*.6,h=(1.9+Math.random()*1.2)*e;Ya(t,a+Math.cos(l)*i,o,n+Math.sin(l)*i,Math.cos(l)*h+s.x*.5,1.5+Math.random()*1,Math.sin(l)*h+s.z*.5,1.2*e,.34)}for(let r=0;r<10;r++){const l=Math.random()*De;xh(t,a+Math.cos(l)*i,o+Te*.05,n+Math.sin(l)*i,Math.cos(l)*(.9+Math.random()*.8),Math.sin(l)*(.9+Math.random()*.8),e*1.25,.62)}}function ux(t){const e=t.object;if(!e)return;const a=t.dt??0,o=ju(e,t,1.9);if(o.t+=o.rate*a,e.rotation.x=o.t,e.rotation.z=Math.sin(o.t*.7)*1,o.shed-=a,o.shed<=0){o.shed=.075+Math.random()*.05;const n=t.position.x-t.direction.x*rt,s=t.position.z-t.direction.z*rt;Math.random()<.45?Rs(t,n,t.position.y-rt*.3,s,-t.direction.x*.35+(Math.random()-.5)*.4,-.5-Math.random()*.4,-t.direction.z*.35+(Math.random()-.5)*.4,.6,.3):Ya(t,n,t.position.y,s,-t.direction.x*.7+(Math.random()-.5)*.6,.1+Math.random()*.3,-t.direction.z*.7+(Math.random()-.5)*.6,.7,.28)}}const fx={Tackle:{impact(t){const e=Al(t.damage),{x:a,y:o,z:n}=t.position,s=t.direction;Is(t,8,e),Dd(t,e*.95,2.4*e,.42),Ld(t,7,e,.66);const i=Te*.26*e,r=.8;for(let l=0;l<5;l++){const h=l/5*De+Math.random()*.7,c=(2+Math.random()*1.2)*e;xr(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*r,1.9+Math.random()*1.1,Math.sin(h)*c+s.z*r,e*1.15,.5+Math.random()*.12)}for(let l=0;l<6;l++){const h=l/6*De+Math.random()*.8,c=(2.4+Math.random()*1.5)*e;Rs(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*r,1.4+Math.random()*1,Math.sin(h)*c+s.z*r,e,.4+Math.random()*.12)}for(let l=0;l<11;l++){const h=Math.random()*De,c=(2.6+Math.random()*2)*e;Ya(t,a+Math.cos(h)*i*.9,o,n+Math.sin(h)*i*.9,Math.cos(h)*c+s.x*r,1.7+Math.random()*1.7,Math.sin(h)*c+s.z*r,(.9+Math.random()*.6)*e,.4+Math.random()*.14)}},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position,s=Math.atan2(e.x,e.z);for(let i=0;i<4;i++){const r=(i-1.5)*.34,l=Math.sin(s+r),h=Math.cos(s+r),c=(i%2-.5)*.35,d=Uo();d.color.set(i%2===0?Mi:co),d.opacity=1;const p=Uo();p.color.set(bh),p.opacity=1;const u=new E(no,d),f=new E(no,p);u.renderOrder=13,f.renderOrder=12;const m=new ie;m.add(f,u),Ei(u,l,c,h),f.quaternion.copy(u.quaternion);const g=$u*.85;t.spawnTransient(m,.17,w=>{const b=1-Math.pow(1-w,2.2),y=Te*.1+b*Te*.1,k=Te*(.12+b*.22),x=y+k*.5;u.position.set(a+l*x,o+c*x*.5,n+h*x),f.position.copy(u.position),u.scale.set(k,g,g),f.scale.set(k*1.06,g*2.6,g*2.6);const M=w<.5?1:1-(w-.5)/.5;d.opacity=M,p.opacity=M})}for(let i=0;i<8;i++)Ya(t,a,o,n,e.x*(1.5+Math.random()*1.1)+(Math.random()-.5)*.9,.7+Math.random()*.7,e.z*(1.5+Math.random()*1.1)+(Math.random()-.5)*.9,.9,.3);for(let i=0;i<3;i++)xr(t,a,o,n,e.x*(1.2+Math.random()*.8)+(Math.random()-.5)*.6,.8+Math.random()*.5,e.z*(1.2+Math.random()*.8)+(Math.random()-.5)*.6,.9,.32)}},Hatch:{projectile(t){const e=lx(t.color);return e.position.copy(t.position),e},trail(t){cx(t)},impact(t){px(t)},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position;Is(t,6,.62,.14),Dd(t,.8,2,.4);for(let s=0;s<9;s++){const i=Math.random()*De;xh(t,a+Math.cos(i)*Te*.1,o+Te*.06,n+Math.sin(i)*Te*.1,Math.cos(i)*(.8+Math.random()*.9)+e.x*.5,Math.sin(i)*(.8+Math.random()*.9)+e.z*.5,1.1,.8)}for(let s=0;s<5;s++)Ya(t,a,o,n,e.x*(1.2+Math.random()*.9)+(Math.random()-.5)*1,.8+Math.random()*.6,e.z*(1.2+Math.random()*.9)+(Math.random()-.5)*1,.85,.3)}},Shards:{projectile(t){const e=hx(t.color);return e.position.copy(t.position),e},trail(t){ux(t)},impact(t){const e=Al(t.damage)*.9,{x:a,y:o,z:n}=t.position,s=t.direction;Is(t,5,e*.82,.12),Ld(t,5,e*.7,.6);const i=Te*.24*e,r=.7;for(let l=0;l<6;l++){const h=l/6*De+Math.random()*.8,c=(2.2+Math.random()*1.4)*e;Rs(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*r,1.4+Math.random()*1,Math.sin(h)*c+s.z*r,e*1.1,.42+Math.random()*.12)}for(let l=0;l<7;l++){const h=l/7*De+Math.random()*.9,c=(2.4+Math.random()*1.7)*e;Ya(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*r,1.6+Math.random()*1.4,Math.sin(h)*c+s.z*r,(.85+Math.random()*.5)*e,.38+Math.random()*.12)}for(let l=0;l<2;l++){const h=Math.random()*De;xr(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*2*e+s.x*r,1.7+Math.random()*.9,Math.sin(h)*2*e+s.z*r,e*.85,.44)}},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position,s=(t.weapon.spreadDeg??30)*Math.PI/360;for(let i=0;i<9;i++){const r=(Math.random()*2-1)*s,l=Math.cos(r),h=Math.sin(r),c=e.x*l-e.z*h,d=e.x*h+e.z*l,p=1.6+Math.random()*1.2;Ya(t,a,o,n,c*p,.7+Math.random()*.6,d*p,.95,.32)}for(let i=0;i<3;i++){const r=(Math.random()*2-1)*s,l=Math.cos(r),h=Math.sin(r),c=e.x*l-e.z*h,d=e.x*h+e.z*l;Rs(t,a,o,n,c*1.6,.5+Math.random()*.4,d*1.6,.85,.3)}}}},Ca="#E63946",Fa="#FFFDF9",Gu="#00E5B0",mx="#FFEAF1",gx=.32,wx=.34,zd=.36,bx=.33,vr=.46;function Bn(t){const e=document.createElement("canvas");return e.width=t,e.height=t,e.getContext("2d")}function qn(t){const e=new et(t.canvas);return e.anisotropy=8,e.needsUpdate=!0,e}function yx(){const e=Bn(512),a=512/2,o=a,n=5,s=1.15,i=Math.PI/n*.52,r=56;e.fillStyle="#ffffff";for(let h=0;h<n;h++){const c=h/n*Math.PI*2;e.beginPath();for(let d=0;d<=r;d++){const p=d/r*o,u=c+s*Math.PI*2*(p/o)-i,f=a+Math.cos(u)*p,m=a+Math.sin(u)*p;d===0?e.moveTo(f,m):e.lineTo(f,m)}for(let d=r;d>=0;d--){const p=d/r*o,u=c+s*Math.PI*2*(p/o)+i;e.lineTo(a+Math.cos(u)*p,a+Math.sin(u)*p)}e.closePath(),e.fill()}e.globalCompositeOperation="destination-out";const l=e.createRadialGradient(a,a,o*.9,a,a,o);return l.addColorStop(0,"rgba(0,0,0,0)"),l.addColorStop(1,"rgba(0,0,0,1)"),e.fillStyle=l,e.fillRect(0,0,512,512),e.globalCompositeOperation="source-over",qn(e)}function xx(){const e=Bn(256),a=256/2,o=e.createRadialGradient(a,a,0,a,a,a);return o.addColorStop(0,"rgba(255,255,255,0.62)"),o.addColorStop(.55,"rgba(255,255,255,0.58)"),o.addColorStop(.88,"rgba(255,255,255,0.8)"),o.addColorStop(.975,"rgba(255,255,255,1)"),o.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=o,e.fillRect(0,0,256,256),qn(e)}function vx(){const e=Bn(512),a=512/2,o=a,n=o*.74;e.fillStyle="#ffffff",e.beginPath(),e.moveTo(a+o,a),e.arc(a,a,o,0,Math.PI*2,!1),e.moveTo(a+n,a),e.arc(a,a,n,0,Math.PI*2,!0),e.fill(),e.globalCompositeOperation="destination-out";const s=40;e.fillStyle="rgba(0,0,0,0.5)";for(let l=0;l<s;l++){const h=l/s*Math.PI*2,c=h+Math.PI/s;e.beginPath(),e.moveTo(a,a),e.arc(a,a,o,h,c),e.closePath(),e.fill()}const i=e.createRadialGradient(a,a,o*.96,a,a,o);i.addColorStop(0,"rgba(0,0,0,0)"),i.addColorStop(1,"rgba(0,0,0,1)"),e.fillStyle=i,e.fillRect(0,0,512,512);const r=e.createRadialGradient(a,a,n,a,a,n*1.22);return r.addColorStop(0,"rgba(0,0,0,1)"),r.addColorStop(1,"rgba(0,0,0,0)"),e.fillStyle=r,e.fillRect(0,0,512,512),e.globalCompositeOperation="source-over",qn(e)}function kx(){const e=Bn(512),a=512/2,o=e.createRadialGradient(a,a,0,a,a,a);return o.addColorStop(0,"rgba(255,255,255,0)"),o.addColorStop(.966,"rgba(255,255,255,0)"),o.addColorStop(.976,"rgba(255,255,255,1)"),o.addColorStop(.991,"rgba(255,255,255,1)"),o.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=o,e.fillRect(0,0,512,512),qn(e)}function Mx(){const e=Bn(64),a=64/2,o=e.createRadialGradient(a,a,0,a,a,a);return o.addColorStop(0,"rgba(255,255,255,1)"),o.addColorStop(.35,"rgba(255,255,255,0.8)"),o.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=o,e.fillRect(0,0,64,64),qn(e)}const Un=yx(),vh=xx(),Ex=vx(),kh=kx(),Ti=Mx(),ft=new lo(1,96);ft.rotateX(-Math.PI/2);const Tx=new Me(1,1,.34,12),Wu=new Me(1,1,.22,44),Yu=new Me(.055,.055,1,10);function Oe(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Sx=Oe(3,()=>new V({map:vh,color:Ca,transparent:!0,opacity:.6,depthWrite:!1})),Ax=Oe(2,()=>new V({map:Un,color:Fa,transparent:!0,opacity:.5,depthWrite:!1})),Rx=Oe(2,()=>new V({map:Un,color:Ca,transparent:!0,opacity:.9,depthWrite:!1})),Ix=Oe(6,()=>new V({map:Un,color:Fa,transparent:!0,opacity:.9,depthWrite:!1})),Cx=Oe(3,()=>new V({map:Ex,color:Fa,transparent:!0,opacity:1,depthWrite:!1,blending:Qe})),Vu=Oe(4,()=>new V({map:kh,color:Ca,transparent:!0,opacity:1,depthWrite:!1})),Fx=Oe(2,()=>new V({map:kh,color:Fa,transparent:!0,opacity:1,depthWrite:!1})),Ox=Oe(10,()=>new V({map:Un,color:Ca,transparent:!0,opacity:.9,depthWrite:!1})),Nx=Oe(14,()=>new V({color:Ca,transparent:!0,opacity:1})),Lx=Oe(14,()=>new V({color:Fa,transparent:!0,opacity:1})),Dx=Oe(24,()=>new Ct({map:Ti,color:mx,transparent:!0,opacity:1,depthWrite:!1,blending:Qe})),zx=Oe(12,()=>new Ct({map:Ti,color:Gu,transparent:!0,opacity:1,depthWrite:!1,blending:Qe})),Hx=Oe(12,()=>new Ct({map:Ti,color:Ca,transparent:!0,opacity:1,depthWrite:!1})),_x=Oe(5,()=>new Ct({map:Ti,color:Gu,transparent:!0,opacity:1,depthWrite:!1})),Px=Oe(2,()=>new V({color:Fa,transparent:!0,opacity:1})),$x=Oe(2,()=>new V({color:"#FBF7EE",transparent:!0,opacity:1}));function Hd(t,e,a,o,n,s){const i=Ox(),r=new E(ft,i);r.position.set(e,bx,a),r.rotation.y=Math.random()*Math.PI*2,r.renderOrder=12;const l=(Math.random()<.5?-1:1)*(2.4+Math.random()*1.2),h=r.rotation.y;r.scale.setScalar(o*.35),t.spawnTransient(r,n,c=>{const d=1-Math.pow(1-Math.min(1,c*3.2),3);r.scale.setScalar(o*(.35+.65*d)),r.rotation.y=h+l*c*.35,i.opacity=s*(1-Math.pow(c,1.6))})}function _d(t,e,a,o,n,s,i){const r=Math.random()<.45?Nx():Lx(),l=new E(Tx,r);l.scale.setScalar(s),l.position.set(e.x,e.y,e.z),l.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI);const h=e.x,c=e.y,d=e.z,p=1.5+Math.random()*1.9,u=-9.4,f=(Math.random()-.5)*16,m=(Math.random()-.5)*16;t.spawnTransient(l,i,(g,w)=>{l.position.set(h+a*n*w,Math.max(.08,c+p*w+.5*u*w*w),d+o*n*w),l.rotation.x+=f*.016,l.rotation.z+=m*.016,r.opacity=1-Math.pow(g,2.2)})}function Pa(t,e,a,o,n,s,i,r,l=Dx,h=0){const c=l(),d=new ba(c);d.position.set(e,a,o),d.scale.set(n,n,1),d.renderOrder=14,d.visible=h<=0;const p=(Math.random()-.5)*.5;t.spawnTransient(d,i+h,(u,f)=>{if(f<h){d.visible=!1;return}d.visible=!0;const m=Math.min(1,(f-h)/i),g=W.lerp(n,s,m);d.scale.set(g,g,1),d.position.y=a+r*m,d.position.x=e+p*m,c.opacity=1-Math.pow(m,1.5)})}function Bx(t,e,a,o,n){const s=J*.85,i=J*1.7,r=new ie,l=Math.hypot(o,n)||1,h=s+J*.5;r.position.set(e+o/l*h,0,a+n/l*h);const c=Vu(),d=new E(ft,c);d.scale.setScalar(s*1.16),d.position.y=.115,d.renderOrder=12,r.add(d);const p=Px(),u=new E(Wu,p);u.scale.set(s,1,s),r.add(u);const f=Rx(),m=new E(ft,f);m.scale.setScalar(s*.99),m.position.y=.13,m.renderOrder=13,r.add(m);const g=$x(),w=new E(Yu,g);w.scale.set(1,i,1);const b=new de(-o,0,-n);b.lengthSq()<1e-6&&b.set(0,0,-1),b.normalize(),w.quaternion.setFromUnitVectors(new de(0,1,0),b),w.position.set(b.x*(s+i*.5)*.92,.05,b.z*(s+i*.5)*.92),r.add(w);const y=5.2,k=.09;t.spawnTransient(r,.75,(M,v)=>{if(v<k){const S=v/k;r.position.y=y*(1-S*S),r.scale.set(1,1,1)}else{const S=Math.min(1,(v-k)/.16);r.position.y=0;const R=1-.55*(1-S)*Math.cos(S*Math.PI*1.2);r.scale.set(1+(1-R)*.22,Math.max(.25,R),1+(1-R)*.22)}const T=M<.45?1:1-(M-.45)/.55;p.opacity=T,g.opacity=T,f.opacity=.9*T,c.opacity=T})}const ja=J*.85,ms=ja+J*.5,Pd=J*1.7,qx="#3C0F12",Ux="#EC656F",jx="#F5B0B5",Gx=Oe(2,()=>new V({map:vh,color:qx,transparent:!0,opacity:0,depthWrite:!1})),Wx=Oe(2,()=>new V({map:vh,color:Ux,transparent:!0,opacity:0,depthWrite:!1})),Yx=Oe(2,()=>new V({map:kh,color:jx,transparent:!0,opacity:0,depthWrite:!1})),Vx=Oe(2,()=>new V({color:Fa,transparent:!0,opacity:1,depthWrite:!1})),Kx=Oe(2,()=>new V({map:Un,color:Ca,transparent:!0,opacity:.95,depthWrite:!1})),Xx=Oe(2,()=>new V({color:"#FBF7EE",transparent:!0,opacity:1,depthWrite:!1})),Zx={Smash:{cast(t){const e=t.direction.x,a=t.direction.z,o=t.position.x-e*.75,n=t.position.z-a*.75,s=Math.atan2(a,e),i=J*1.15,r=W.degToRad((t.weapon.cone??80)/2),l=J*.34;for(let h=0;h<2;h++){const c=h*.05,d=Ix();d.color.set(h===0?Fa:Ca);const p=new E(ft,d);p.scale.setScalar(l*(1-h*.16)),p.renderOrder=13;const u=h===0?.95:.42;t.spawnTransient(p,.2,f=>{const m=W.clamp((f*.2-c)/.2,0,1),g=1-Math.pow(1-m,2),w=s-r+g*r*2;p.position.set(o+Math.cos(w)*i,W.lerp(J*.8,.4,g),n+Math.sin(w)*i),p.rotation.y=w*1.6,d.opacity=u*(m<=0?0:1-Math.pow(f,2.4))})}for(let h=0;h<2;h++){const c=s+(Math.random()-.5)*r*1.4;Pa(t,o+Math.cos(c)*i*1.05,J*.5,n+Math.sin(c)*i*1.05,J*.13,J*.03,.2,.25)}},impact(t){const{x:e,z:a}=t.position,o=W.clamp(.85+t.damage*.03,.85,1.6);Pa(t,e,t.position.y,a,J*.3*o,J*.6*o,.15,.1),Hd(t,e,a,J*.32*o,.5,.85);const n=6;for(let s=0;s<n;s++){const i=s/n*Math.PI*2+Math.random()*.7;_d(t,{x:e,y:t.position.y*.8,z:a},Math.cos(i),Math.sin(i),(1.7+Math.random()*1.9)*o,J*(.065+Math.random()*.03),.42+Math.random()*.18)}for(let s=0;s<3;s++){const i=Math.random()*Math.PI*2;Pa(t,e+Math.cos(i)*.3,t.position.y+.1,a+Math.sin(i)*.3,J*.14,J*.04,.34,.5)}}},Giant:{cast(t){const{x:e,z:a}=t.position,o=Je(t.weapon.range??0),n=Sx(),s=new E(ft,n);s.position.set(e,gx,a),s.renderOrder=10,s.scale.setScalar(o*.12),t.spawnTransient(s,1,u=>{const f=1-Math.pow(1-Math.min(1,u/.26),3);s.scale.setScalar(o*(.12+.88*f)),n.opacity=.3*(u<.2?1:Math.pow(1-(u-.2)/.8,1.5))});for(const[u,f,m,g]of[[Vu(),1,.95,16],[Fx(),.974,.9,17]]){const w=new E(ft,u);w.position.set(e,zd+.01,a),w.renderOrder=g,w.scale.setScalar(o*.12*f),t.spawnTransient(w,1,b=>{const y=1-Math.pow(1-Math.min(1,b/.26),3);w.scale.setScalar(o*(.12+.88*y)*f),u.opacity=m*(b<.42?1:Math.pow(1-(b-.42)/.58,1.4))})}const i=Ax(),r=new E(ft,i);r.position.set(e,wx,a),r.renderOrder=11,r.scale.setScalar(o*.12),t.spawnTransient(r,1,u=>{const f=1-Math.pow(1-Math.min(1,u/.26),3);r.scale.setScalar(o*(.12+.88*f)),r.rotation.y=(1-Math.pow(1-u,2))*1.5,i.opacity=.4*(u<.22?1:Math.pow(1-(u-.22)/.78,1.5))});const l=Cx(),h=new E(ft,l);h.position.set(e,zd,a),h.renderOrder=15,h.scale.setScalar(o*.05),t.spawnTransient(h,vr+.22,(u,f)=>{const m=Math.min(1,f/vr),g=1-Math.pow(1-m,2.2);h.scale.setScalar(o*(.05+.98*g)),h.rotation.y=g*.5,l.opacity=.95*(1-Math.pow(u,2.4))});const c=10,d=.55,p=Math.PI*(3-Math.sqrt(5));for(let u=0;u<c;u++){const f=o*d*Math.sqrt((u+.6)/c),m=u*p,g=e+Math.cos(m)*f,w=a+Math.sin(m)*f,b=f/o*vr;Pa(t,g,.55,w,J*.2,J*.68,.3,.55,Hx,b),u%3===0&&Pa(t,g,.5,w,J*.12,J*.34,.34,.7,_x,b+.03)}Bx(t,e,a,t.direction.x,t.direction.z)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1500)/1e3),o=new e.Group;o.name="teleLolliRoot";const n=t.position.clone();n.y-=J*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=Gx(),i=new e.Mesh(ft,s);i.name="teleLolliBase",i.scale.setScalar(ja),i.position.set(0,.02,ms),i.renderOrder=5,o.add(i);const r=Wx(),l=new e.Mesh(ft,r);l.name="teleLolliFill",l.position.set(0,.032,ms),l.renderOrder=5.01,o.add(l);const h=Yx(),c=new e.Mesh(ft,h);c.name="teleLolliRim",c.scale.setScalar(ja*1.06),c.position.set(0,.044,ms),c.renderOrder=5.02,o.add(c);const d=new e.Group;d.name="teleLolliCandy",o.add(d);const p=Vx(),u=new e.Mesh(Wu,p);u.name="teleLolliHead",u.scale.set(ja,1,ja),d.add(u);const f=Kx(),m=new e.Mesh(ft,f);m.name="teleLolliSwirl",m.scale.setScalar(ja*.99),m.position.y=.13,m.renderOrder=13,d.add(m);const g=Xx(),w=new e.Mesh(Yu,g);w.name="teleLolliStick",w.scale.set(1,Pd,1),w.rotation.x=-Math.PI/2,w.position.z=-3.57*.92,d.add(w);const b=(k,x,M)=>{const v=e.MathUtils.clamp((k-x)/(M-x),0,1);return v*v*(3-2*v)},y=(k,x)=>{const M=e.MathUtils.clamp(x/a,0,1),v=b(M,0,.78),T=b(M,.78,1),S=.5+.5*Math.sin(Math.PI*2*(2*M+3*M*M));s.opacity=.6+.14*S;const R=ja*(.12+.88*M);l.scale.setScalar(R),r.opacity=.7+.22*M,h.opacity=.62+.36*M*M;const F=.28+.72*v;d.scale.setScalar(F),d.position.set(0,J*(.55+1.05*v+.55*T),ms*(.35+.65*v)-Pd*.1*T),d.rotation.y=M*(2.2+5.5*M),d.rotation.x=-.55*T;const A=.85+.15*S;p.opacity=A,g.opacity=A,f.opacity=.95*A};y(0,0),t.spawnTransient(o,a+.06,y)},impact(t){const{x:e,z:a}=t.position,o=W.clamp(.9+t.damage*.035,.9,1.7);Pa(t,e,t.position.y,a,J*.34*o,J*.62*o,.18,.12),Hd(t,e,a,J*.42*o,.62,.9);const n=8;for(let s=0;s<n;s++){const i=s/n*Math.PI*2+Math.random()*.6;_d(t,{x:e,y:t.position.y*.85,z:a},Math.cos(i),Math.sin(i),(2.1+Math.random()*2.2)*o,J*(.07+Math.random()*.035),.48+Math.random()*.2)}for(let s=0;s<4;s++){const i=s/4*Math.PI*2+Math.random();Pa(t,e+Math.cos(i)*.34,t.position.y+.15,a+Math.sin(i)*.34,J*.11,J*.04,.42,.85,zx)}}}},Jx="#EFB868",Qx="#CE8A2E",Ku="#4A2A12",ev="#B93A28",vn="#F7ECD3",xe=J,ht=Math.PI*2,Si=.26;function po(t,e=10){const a=new ql(t,e);return a.rotateX(-Math.PI/2),a}function Mh(t,e){const a=Math.tan(e)*t,o=-t*.58,n=t*.42,s=new Ia;return s.moveTo(0,o),s.lineTo(-a,n),s.quadraticCurveTo(0,n+a*.5,a,n),s.closePath(),s}function tv(t){const e=new Ia;return e.moveTo(0,t),e.quadraticCurveTo(t*.82,t*.78,t*.96,-t*.06),e.quadraticCurveTo(t*.7,-t*.72,0,-t),e.quadraticCurveTo(-t*.84,-t*.66,-t,t*.04),e.quadraticCurveTo(-t*.7,t*.8,0,t),e}function Xu(t,e,a=22){const o=new Ia;for(let n=0;n<=a;n++){const s=n/a*ht,i=1+Math.sin(s*3+t)*.17+Math.sin(s*5+e)*.11,r=Math.cos(s)*i,l=Math.sin(s)*i;n===0?o.moveTo(r,l):o.lineTo(r,l)}return o}function av(t){const e=new Ia;return e.moveTo(-t,0),e.lineTo(t,0),e.lineTo(0,1),e.closePath(),e}const Oo=xe*.3,kn=xe*.16,Cs=xe*.18,$d=po(Mh(Oo,.44),8),Fs=po(tv(Cs),8),Eh=(()=>{const t=new lo(1,12);return t.rotateX(-Math.PI/2),t})(),Bd=(()=>{const t=new lo(kn,20);t.rotateX(-Math.PI/2);const e=t.attributes.position;for(let a=1;a<e.count;a++){const o=e.getX(a),n=e.getZ(a),s=Math.atan2(n,o),i=1+Math.sin(s*3)*.13+Math.sin(s*7+1.3)*.075;e.setX(a,o*i),e.setZ(a,n*i)}return e.needsUpdate=!0,t})(),qd=po(Mh(xe*.105,.52),4),Zu=po(Mh(1,.62),3),Ju=po(Xu(0,2.1),1),ov=po(Xu(1.7,4.3),1),nv=po(av(.16),1),Qu=(()=>{const t=new Ma(.62,1,18,1,0,Math.PI*.8);return t.rotateX(-Math.PI/2),t})(),sv=(()=>{const t=new lo(xe*.032,6);return t.rotateX(-Math.PI/2),t})(),iv=(()=>{const t=new Rt(xe*.022,1,xe*.022);return t.translate(0,-.5,0),t})();function uo(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Oa=t=>new V({color:t,side:me}),Ud=Oa("#F6E3B4"),jd=Oa("#E63946"),Gd=Oa("#FFD873"),rv=Oa(Jx),ef=Oa(Qx),lv=Oa(ev),hv=Oa(vn),cv=Oa(Ku),dv=uo(20,()=>new V({color:"#E63946",transparent:!0,opacity:1,side:me,depthWrite:!1})),tf=uo(24,()=>new V({color:Ku,transparent:!0,opacity:1,side:me,depthWrite:!1})),af=uo(10,()=>new V({color:"#B62430",transparent:!0,opacity:.9,side:me,depthWrite:!1})),pv=uo(28,()=>new V({color:vn,transparent:!0,opacity:.9,side:me,depthWrite:!1})),of=uo(8,()=>new V({color:"#FFE9A8",transparent:!0,opacity:.9,side:me,blending:Qe,depthWrite:!1})),nf=uo(16,()=>new V({color:"#FFD9A0",transparent:!0,opacity:.5,side:me,blending:Qe,depthWrite:!1})),kr=uo(12,()=>new V({color:"#FFD873",transparent:!0,opacity:.95,side:me,depthWrite:!1})),uv=new de(0,1,0),Wd=new de,Yd=new de,Mr=new hi,Vd=new hi;function Eo(t,e,a,o){Mr.setFromAxisAngle(uv,a);const n=Math.hypot(e.x,e.z);Math.abs(o)>1e-4&&n>1e-4?(Wd.set(e.z/n,0,-e.x/n),Vd.setFromAxisAngle(Wd,o),t.quaternion.copy(Vd).multiply(Mr)):t.quaternion.copy(Mr)}function Th(t,e,a){const o=new ie,n=new E(t,cv);return n.scale.set(a,1,a),n.position.y=-xe*.011,o.add(n),o.add(new E(t,e)),o}function fv(t){return t.range&&t.speed?t.range/t.speed:ro.normal/1e3}function Er(t,e,a){let o=t.userData.__spin;return o||(o={spin:Math.random()*ht,rate:a*ht/fv(e),shed:0},t.userData.__spin=o),o}function Kd(t,e,a,o){const n=nf();n.color.set(o),n.opacity=.45;const s=new E(Qu,n);s.renderOrder=9,s.position.copy(t.position),s.rotation.y=a,s.scale.set(e,1,e),t.spawnTransient(s,.13,i=>{const r=e*(1+i*.28);s.scale.set(r,1,r),n.opacity=.45*(1-i)})}function fa(t,e,a,o,n,s,i,r,l){const h=pv();h.color.set(a),h.opacity=.9;const c=new E(sv,h);c.renderOrder=9,c.position.copy(e),c.scale.setScalar(r);const d=e.x,p=e.y,u=e.z;t.spawnTransient(c,l,(f,m)=>{c.position.set(d+o*m,Math.max(Si,p+n*m+.5*i*m*m),u+s*m),h.opacity=.9*(1-f*f)})}function Tr(t,e,a,o,n,s,i){const r=new ie,l=tf();l.opacity=1;const h=new E(qd,l);h.scale.set(1.22,1,1.22),h.position.y=-xe*.008,r.add(h);const c=dv();c.color.set(a),c.opacity=1,r.add(new E(qd,c)),r.renderOrder=9,r.position.copy(e),r.scale.setScalar(s);const d=e.x,p=e.y,u=e.z,f=Math.cos(o),m=Math.sin(o),g=f*n,w=m*n,b=.8+Math.random()*.9,y=-7.5,k=Math.random()*ht,x=(Math.random()-.5)*24;t.spawnTransient(r,i,(M,v)=>{r.position.set(d+g*v,Math.max(Si,p+b*v+.5*y*v*v),u+w*v),Yd.set(f,0,m),Eo(r,Yd,k+x*v,.22);const T=1-Math.pow(M,2.2);c.opacity=T,l.opacity=T})}function mv(t,e,a,o,n,s){const i=new ie;i.position.set(t.position.x,Si,t.position.z),i.renderOrder=4;const r=af();r.color.set(e),r.opacity=s;const l=new E(Math.random()<.5?Ju:ov,r);l.rotation.y=Math.random()*ht,i.add(l);for(let h=0;h<o;h++){const c=new E(nv,r);c.rotation.y=h/o*ht+Math.random()*.7,c.scale.set(.7+Math.random()*.4,1,1+Math.random()*.4),i.add(c)}t.spawnTransient(i,n,h=>{const c=1-Math.pow(1-Math.min(1,h*5),3);i.scale.set(a*c,1,a*c),r.opacity=s*(h<.55?1:1-(h-.55)/.45)})}function Sr(t,e,a,o){const n=of();n.color.set(e),n.opacity=.9;const s=new E(Zu,n);s.renderOrder=11,s.position.copy(t.position),s.rotation.y=Math.random()*ht,s.scale.set(a*.35,1,a*.35),t.spawnTransient(s,o,i=>{const r=W.lerp(a*.35,a,1-Math.pow(1-i,2));s.scale.set(r,1,r),n.opacity=.9*(1-i)})}function Ar(t){return W.clamp(.85+t*.035,.85,1.4)}function gv(t){const e=Th($d,rv,1.15);jd.color.set(t);const a=new E($d,jd);a.scale.set(.86,1,.86),a.position.set(0,xe*.006,Oo*.04),e.add(a);for(const[o,n,s]of[[-.2,-.1,.075],[.15,.11,.06]]){const i=new E(Eh,lv);i.position.set(Oo*o,xe*.012,Oo*n),i.scale.setScalar(Oo*s*2),e.add(i)}return e}function wv(t){const e=Th(Bd,ef,1.13);Ud.color.set(t);const a=new E(Bd,Ud);a.scale.set(.84,1,.84),a.position.y=xe*.006,e.add(a);const o=new E(Eh,hv);return o.scale.setScalar(kn*.44),o.position.set(kn*.4,xe*.011,-kn*.26),e.add(o),e}function bv(t){Gd.color.set(t);const e=Th(Fs,Gd,1.12),a=new E(Eh,ef);return a.scale.setScalar(Cs*.22),a.position.set(Cs*.34,xe*.006,Cs*.2),e.add(a),e}const yv={Dough:{projectile(t){const e=wv(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Er(e,t.weapon,2.6);o.spin+=o.rate*a,Eo(e,t.direction,o.spin,.15+Math.sin(o.spin*.37)*.07),e.position.y+=Math.sin(o.spin*.5)*xe*.012,o.shed-=a,o.shed<=0&&(o.shed=.055+Math.random()*.04,fa(t,t.position,vn,-t.direction.x*.5+(Math.random()-.5)*.5,.25+Math.random()*.4,-t.direction.z*.5+(Math.random()-.5)*.5,-1.1,.5+Math.random()*.35,.3+Math.random()*.15),Math.random()<.45&&Kd(t,kn*1.2,o.spin,"#FFF0CC"))},impact(t){const e=Ar(t.damage),a=af();a.color.set("#F0DDAE"),a.opacity=.95;const o=new E(Ju,a);o.renderOrder=4,o.position.set(t.position.x,Si,t.position.z),o.rotation.y=Math.random()*ht;const n=xe*.25*e;t.spawnTransient(o,.62,s=>{const i=W.lerp(n*.3,n,1-Math.pow(1-Math.min(1,s*4),3));o.scale.set(i,1,i),a.opacity=.95*(s<.5?1:1-(s-.5)/.5)}),Sr(t,"#FFF3D2",xe*.3*e,.18);for(let s=0;s<10;s++){const i=s/10*ht+Math.random()*.5,r=(.9+Math.random()*1.2)*e;fa(t,t.position,vn,Math.cos(i)*r,.7+Math.random()*.9,Math.sin(i)*r,-2.4,.6+Math.random()*.6,.45+Math.random()*.25)}for(let s=0;s<4;s++)Tr(t,t.position,"#EFD9A6",Math.random()*ht,(1.9+Math.random()*1.3)*e,(.55+Math.random()*.35)*e,.4+Math.random()*.14)},cast(t){const e=nf();e.color.set("#FFF0CC"),e.opacity=.6;const a=new E(Qu,e);a.renderOrder=11,a.position.copy(t.position),t.spawnTransient(a,.16,o=>{const n=W.lerp(xe*.05,xe*.16,o);a.scale.set(n,1,n),a.rotation.y=o*9,e.opacity=.6*(1-o)});for(let o=0;o<5;o++)fa(t,t.position,vn,t.direction.x*(.5+Math.random()*.6)+(Math.random()-.5)*.6,.5+Math.random()*.5,t.direction.z*(.5+Math.random()*.6)+(Math.random()-.5)*.6,-1.6,.55+Math.random()*.4,.3+Math.random()*.15)}},Tomato:{projectile(t){const e=gv(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Er(e,t.weapon,1.8);o.spin+=o.rate*a,Eo(e,t.direction,o.spin,.17+Math.sin(o.spin*.5)*.06),o.shed-=a,o.shed<=0&&(o.shed=.058,Kd(t,Oo*.62,o.spin,"#FFC08A"),Math.random()<.5&&fa(t,t.position,"#C4262F",-t.direction.x*.7+(Math.random()-.5)*.4,.15+Math.random()*.3,-t.direction.z*.7+(Math.random()-.5)*.4,-2.2,.5+Math.random()*.3,.26))},impact(t){const e=Ar(t.damage);Sr(t,"#FFE7CC",xe*.4*e,.18),mv(t,t.color,xe*.22*e,4,.55,.9);for(let a=0;a<5;a++){const o=a/5*ht+Math.random()*.6;Tr(t,t.position,t.color,o,(2.2+Math.random()*1.4)*e,(.75+Math.random()*.45)*e,.4+Math.random()*.14)}for(let a=0;a<6;a++){const o=Math.random()*ht,n=(1.3+Math.random()*1.5)*e;fa(t,t.position,"#C4262F",Math.cos(o)*n,1+Math.random()*1.1,Math.sin(o)*n,-6.5,.7+Math.random()*.5,.34+Math.random()*.14)}},cast(t){const e=of();e.color.set("#FF8E6A"),e.opacity=.85;const a=new E(Zu,e);a.renderOrder=11,a.position.copy(t.position),a.rotation.y=Math.atan2(t.direction.x,t.direction.z),t.spawnTransient(a,.15,o=>{const n=W.lerp(xe*.08,xe*.24,1-Math.pow(1-o,2));a.scale.set(n*.7,1,n),e.opacity=.85*(1-o)});for(let o=0;o<3;o++)fa(t,t.position,"#C4262F",t.direction.x*(1+Math.random())+(Math.random()-.5)*.5,.4+Math.random()*.4,t.direction.z*(1+Math.random())+(Math.random()-.5)*.5,-2.6,.6,.28)}},Cheese:{projectile(t){const e=bv(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Er(e,t.weapon,.9);o.spin+=o.rate*a,Eo(e,t.direction,o.spin,.2*Math.sin(o.spin*1.9));const n=1+Math.sin(o.spin*2.4)*.22;e.scale.set(1/n,1,n),e.position.y+=Math.sin(o.spin*1.2)*xe*.016,o.shed-=a,o.shed<=0&&(o.shed=.13+Math.random()*.07,fa(t,t.position,"#FFE49A",-t.direction.x*.4,-.1,-t.direction.z*.4,-1.6,.5,.24))},impact(t){const e=Ar(t.damage),a=xe*.96,o=kr();o.color.set(t.color),o.opacity=.95;const n=new E(Fs,o);n.renderOrder=11;const s=tf();s.opacity=.6;const i=new E(Fs,s);i.scale.set(1.12,1,1.12),i.position.y=-xe*.008,n.add(i),n.position.set(t.position.x,a,t.position.z);const r=1.8*e;t.spawnTransient(n,.5,l=>{const h=W.lerp(r*.4,r,1-Math.pow(1-Math.min(1,l*3.5),3));n.scale.set(h,1,h*(1-l*.25)),n.position.y=a-l*l*xe*.34,Eo(n,t.direction,l*1.2,.35+l*.5);const c=l<.6?1:1-(l-.6)/.4;o.opacity=.95*c,s.opacity=.6*c}),Sr(t,"#FFF6D8",xe*.26*e,.17);for(let l=0;l<4;l++){const h=kr();h.color.set("#FFE08A"),h.opacity=.9;const c=new E(iv,h);c.renderOrder=10;const d=Math.random()*ht,p=xe*(.06+Math.random()*.08)*e;c.position.set(t.position.x+Math.cos(d)*p,a-xe*.04,t.position.z+Math.sin(d)*p);const u=xe*(.14+Math.random()*.12)*e;t.spawnTransient(c,.42,f=>{c.scale.set(1-f*.55,u*(.3+f*.7),1-f*.55),h.opacity=.9*(1-f*f)})}for(let l=0;l<3;l++)Tr(t,t.position,"#FFD873",Math.random()*ht,(1+Math.random())*e,(.55+Math.random()*.3)*e,.38)},cast(t){const e=kr();e.color.set(t.color),e.opacity=.85;const a=new E(Fs,e);a.renderOrder=11,a.position.copy(t.position),t.spawnTransient(a,.16,o=>{const n=W.lerp(.3,.85,1-Math.pow(1-o,2));a.scale.set(n*(.5+o*.6),1,n),Eo(a,t.direction,o*2.4,.3-o*.25),e.opacity=.85*(1-o)});for(let o=0;o<3;o++)fa(t,t.position,"#FFE49A",t.direction.x*(.6+Math.random()*.5),.35+Math.random()*.3,t.direction.z*(.6+Math.random()*.5),-2,.55,.26)}}},jo="#FFFDF6",sf="#E4D7BE",Ta="#22301F",xv="#3E5B33",Sh=Gt.salmon,Ah="#B85B26",rf="#FFEEDD",lf="#F2FBFF",hf="#8FD3E8",Z=J,bt=Math.PI*2,Ot=.29;function cf(t,e=8){const a=new ql(t,e);return a.rotateX(-Math.PI/2),a}const Lt=(()=>{const t=new to(1,1);return t.rotateX(-Math.PI/2),t})(),Xd=(()=>{const t=new Ia;t.moveTo(0,0),t.quadraticCurveTo(1,.5,0,1),t.quadraticCurveTo(-1,.5,0,0);const e=cf(t,10);return e.translate(0,0,1),e})(),Zd=(()=>{const e=new Ia;return e.moveTo(-.5+.22,-.5),e.lineTo(.5-.22,-.5),e.quadraticCurveTo(.5,-.5,.5,-.5+.22),e.lineTo(.5,.5-.22),e.quadraticCurveTo(.5,.5,.5-.22,.5),e.lineTo(-.5+.22,.5),e.quadraticCurveTo(-.5,.5,-.5,.5-.22),e.lineTo(-.5,-.5+.22),e.quadraticCurveTo(-.5,-.5,-.5+.22,-.5),cf(e,6)})(),Rh=(()=>{const t=new st(.5,7,5);return t.scale(.44,.44,1),t})(),vv=new Me(.5,.5,1,20,1,!0),Rr=(()=>{const t=new lo(.5,20);return t.rotateX(-Math.PI/2),t})(),kv=new Me(.5,.5,1,12,1,!0,0,Math.PI),Jd=(()=>{const t=new lo(.5,12,-Math.PI/2,Math.PI);return t.rotateX(-Math.PI/2),t})(),Mv=(()=>{const t=new to(1,1);return t.rotateY(-Math.PI/2),t})(),mt=Z*.155,df=Z*.46,Os=Z*.3,$t=Z*.185,gs=Z*.2;function _t(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const jn=t=>new V({color:t,side:me}),pf=jn(jo),Ev=jn(sf),uf=jn(Ta),Tv=jn(Ah),Qd=new Map;function Ih(t){let e=Qd.get(t);return e||(e=jn(t),Qd.set(t,e)),e}const Na=(t,e)=>new V({color:t,transparent:!0,opacity:e,side:me,depthWrite:!1}),ff=(t,e)=>new V({color:t,transparent:!0,opacity:e,side:me,depthWrite:!1,depthTest:!1}),mf=_t(56,()=>new V({color:jo,transparent:!0,opacity:1,depthWrite:!1})),Sv=_t(12,()=>ff(lf,1)),Av=_t(12,()=>ff(hf,.5)),Vs=_t(28,()=>Na(Ta,1)),Ks=_t(28,()=>Na(xv,1)),Rv=_t(24,()=>Na(Sh,1)),Iv=_t(24,()=>Na(Ah,1)),Cv=_t(24,()=>Na(rf,1)),Fv=_t(12,()=>Na(Ta,1)),Ov=_t(12,()=>Na(jo,1)),Nv=_t(12,()=>Na(Sh,1));function Bt(t,e){return Math.atan2(t,e)}function Lv(t,e=.62){const a=Math.sin(t),o=Math.cos(t);if(Math.abs(a)>=e)return t;const n=a>=0?1:-1,s=o>=0?1:-1;return Math.atan2(n*e,s*Math.sqrt(1-e*e))}function Ir(t){return t.range&&t.speed?t.range/t.speed:ro.normal/1e3}function ws(t){return W.clamp(.85+t*.035,.85,1.4)}function Cr(t){let e=t.userData.__sushi;return e||(e={phase:Math.random()*bt,shed:0,grow:0},t.userData.__sushi=e),e}function bs(t,e,a,o,n,s,i,r){const l=new ie,h=Lv(n);l.rotation.y=h,l.position.set(e-Math.sin(h)*s*.5,a,o-Math.cos(h)*s*.5),l.renderOrder=13;const c=Av();c.color.set(hf),c.opacity=.55;const d=new E(Xd,c);d.scale.set(2.9,1,1.02),d.position.y=-Z*.006,d.renderOrder=0,l.add(d);const p=Sv();p.color.set(lf),p.opacity=1;const u=new E(Xd,p);u.renderOrder=1,l.add(u),t.spawnTransient(l,r,f=>{const m=Math.min(1,f*8);l.scale.set(i*(1-f*.55),1,Math.max(.02,s*m));const g=f<.3?1:1-(f-.3)/.7;p.opacity=g,c.opacity=.55*g*g})}function $a(t,e,a,o,n,s,i,r,l,h=!1){const c=mf();c.color.set(h?sf:jo),c.opacity=1;const d=new E(Rh,c);d.renderOrder=9,d.scale.setScalar(r),d.position.set(e,a,o);const p=-9.6,u=(Math.random()-.5)*14,f=(Math.random()-.5)*14;t.spawnTransient(d,l,(m,g)=>{let w=a+s*g+.5*p*g*g,b=1;if(w<Ot){const y=Ot-w;w=Ot+y*.28,b=.35,w<Ot&&(w=Ot)}d.position.set(e+n*g,w,o+i*g*1),d.rotation.set(u*g*b,f*g*b,0),c.opacity=1-m*m*m})}function Dv(t,e,a){const o=new ie,n=new E(Zd,a.deep);n.scale.set(t*1.16,1,e*1.1),n.position.y=-Z*.008,o.add(n);const s=new E(Zd,a.face);s.scale.set(t,1,e),o.add(s);for(let i=0;i<2;i++){const r=new E(Lt,a.fat);r.scale.set(t*.86,1,e*.09),r.position.set(0,Z*.005,e*(i===0?-.18:.16)),o.add(r)}return o}function ep(t,e,a){const o=new ie,n=new E(kv,a.wall);n.scale.set(t*2,e,t*2),o.add(n);const s=new E(Jd,a.face);s.scale.set(t*1.6,1,t*1.6),s.position.y=e*.5,o.add(s);const i=new E(Jd,a.core);i.scale.set(t*.94,1,t*.94),i.position.y=e*.5+Z*.004,o.add(i);const r=new E(Mv,a.face);return r.scale.set(1,e*.98,t*1.96),o.add(r),o}function zv(t){const e=new ie,a=t==="#FFFFFF"?pf:Ih(t),o=[[0,0,mt*.34,1],[-mt*.4,Z*.012,-mt*.3,.85],[mt*.38,-Z*.014,-mt*.42,.78]];for(let n=0;n<o.length;n++){const[s,i,r,l]=o[n],h=new E(Rh,n===1?Ev:a);h.scale.setScalar(mt*l),h.position.set(s,i,r),h.rotation.set(0,(n-1)*.5,0),e.add(h)}return e}function tp(t){const e=new ie,a=[],o=4,n=df/o,s=Ih(t);for(let r=0;r<o;r++){const l=new ie,h=new E(Lt,uf);h.scale.set(Os,1,n*1.02),l.add(h);for(const c of[-1,1]){const d=new E(Lt,s);d.scale.set(Os*.1,1,n*1.02),d.position.set(c*Os*.45,Z*.004,0),l.add(d)}l.position.z=(r-(o-1)/2)*n,e.add(l),a.push(l)}const i={segs:a};return e.userData.__parts=i,e}function ap(t){const e=new ie,a=new E(vv,uf);a.scale.set($t*2,gs,$t*2),e.add(a);const o=new E(Rr,pf);o.scale.set($t*1.6,1,$t*1.6),o.position.y=gs*.5,e.add(o);const n=new E(Rr,Ih(t));n.scale.set($t*.94,1,$t*.94),n.position.y=gs*.5+Z*.004,e.add(n);const s=new E(Rr,Tv);return s.scale.set($t*.34,1,$t*.34),s.position.set($t*.46,gs*.5+Z*.005,-$t*.3),e.add(s),e}const Hv=1.9;function op(t,e){let a=0;t.traverse(o=>{o.isMesh&&!o.name&&(o.name=`${e}Part${a++}`)})}const _v={Rice:{projectile(t){const e=zv(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Cr(e);o.phase+=a/Ir(t.weapon)*bt*1.6,e.rotation.y=Bt(t.direction.x,t.direction.z)+Math.sin(o.phase)*.3;const n=1+Math.sin(o.phase*1.9)*.14;e.scale.set(n,1,1/n);for(let s=0;s<e.children.length;s++)e.children[s].rotation.x=o.phase*(.6+s*.35);o.shed-=a,o.shed<=0&&(o.shed=.1+Math.random()*.06,$a(t,t.position.x,t.position.y,t.position.z,-t.direction.x*.5+(Math.random()-.5)*.7,-.15,-t.direction.z*.5+(Math.random()-.5)*.7,mt*.75,.3+Math.random()*.12,Math.random()<.4))},impact(t){const e=ws(t.damage),{x:a,y:o,z:n}=t.position,s=t.direction,i=Z*.26*e;for(let c=0;c<7;c++){const d=c/7*bt+Math.random()*.7,p=(1.9+Math.random()*1.5)*e;$a(t,a+Math.cos(d)*i,o,n+Math.sin(d)*i,Math.cos(d)*p+s.x*.7,1.5+Math.random()*1.2,Math.sin(d)*p+s.z*.7,mt*(.9+Math.random()*.5)*e,.44+Math.random()*.16,Math.random()<.35)}const r=Math.hypot(s.x,s.z)>1e-4?Z*.34:0,l=mf();l.color.set(jo),l.opacity=1;const h=new E(Rh,l);h.renderOrder=12,h.position.set(a-s.x*r,o,n-s.z*r),h.rotation.y=Bt(s.x,s.z)+Math.PI*.5,t.spawnTransient(h,.14,c=>{h.scale.setScalar(W.lerp(Z*.12,Z*.3,c)*e),l.opacity=1-c})},cast(t){const e=t.direction;for(let a=0;a<6;a++)$a(t,t.position.x,t.position.y,t.position.z,e.x*(1.5+Math.random()*1.2)+(Math.random()-.5)*1.1,.5+Math.random()*.5,e.z*(1.5+Math.random()*1.2)+(Math.random()-.5)*1.1,mt*(.7+Math.random()*.4),.3+Math.random()*.12,Math.random()<.4)}},Seaweed:{projectile(t){const e=tp(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Cr(e);o.phase+=a/Ir(t.weapon)*bt*2.8,e.rotation.y=Bt(t.direction.x,t.direction.z);const n=e.userData.__parts;if(n)for(let s=0;s<n.segs.length;s++){const i=o.phase-s*1.1;n.segs[s].rotation.x=Math.sin(i)*.42,n.segs[s].position.y=Math.sin(i)*Z*.03}o.shed-=a,o.shed<=0&&(o.shed=.14+Math.random()*.08,Fr(t,t.position.x,t.position.y,t.position.z,-t.direction.x*.5+(Math.random()-.5)*.6,-.05,-t.direction.z*.5+(Math.random()-.5)*.6,Z*.075,.28,t.color))},impact(t){const e=ws(t.damage),a=t.direction,o=Bt(a.x,a.z),{x:n,y:s,z:i}=t.position,r=new ie;r.rotation.y=o,r.position.set(n+a.x*Z*.42,Ot,i+a.z*Z*.42),r.renderOrder=5;const l=Ks();l.color.set(t.color),l.opacity=.95;const h=new E(Lt,l);h.scale.set(1.1,1,1.07),h.position.y=-.004,r.add(h);const c=Vs();c.color.set(Ta),c.opacity=.95,r.add(new E(Lt,c));const d=Z*.42*e,p=Z*.72*e;t.spawnTransient(r,.85,f=>{const m=1-Math.pow(1-Math.min(1,f*8),3);r.scale.set(d,1,Math.max(.02,p*m));const g=f<.55?1:1-(f-.55)/.45;c.opacity=.95*g,l.opacity=.95*g});const u=Z*.28*e;for(let f=0;f<4;f++){const m=f/4*bt+Math.random()*.8,g=(1.7+Math.random()*1.2)*e;Pv(t,n+Math.cos(m)*u,s,i+Math.sin(m)*u,Math.cos(m)*g,1.3+Math.random()*1.1,Math.sin(m)*g,Z*(.34+Math.random()*.16)*e,.42+Math.random()*.14,t.color)}for(let f=0;f<5;f++){const m=Math.random()*bt;Fr(t,n+Math.cos(m)*u*.8,s,i+Math.sin(m)*u*.8,Math.cos(m)*(1.6+Math.random()*1.4),1.2+Math.random(),Math.sin(m)*(1.6+Math.random()*1.4),Z*.085*e,.36,t.color)}},cast(t){const e=t.direction,a=Bt(e.x,e.z),o=new ie;o.rotation.y=a,o.position.copy(t.position),o.renderOrder=11;const n=Ks();n.color.set(t.color),n.opacity=1;const s=new E(Lt,n);s.scale.set(1.12,1,1.08),s.position.y=-Z*.006,o.add(s);const i=Vs();i.color.set(Ta),i.opacity=1,o.add(new E(Lt,i)),t.spawnTransient(o,.18,r=>{const l=1-Math.pow(1-r,2);o.scale.set(Os*(.5+l*.6),1,df*(.25+l*.8)),o.position.set(t.position.x+e.x*l*Z*.16,t.position.y,t.position.z+e.z*l*Z*.16),i.opacity=1-r,n.opacity=1-r});for(let r=0;r<3;r++)Fr(t,t.position.x,t.position.y,t.position.z,e.x*(1+Math.random())+(Math.random()-.5)*.7,.4+Math.random()*.4,e.z*(1+Math.random())+(Math.random()-.5)*.7,Z*.08,.28,t.color)}},Fish:{impact(t){const e=ws(t.damage),a=t.direction,{x:o,y:n,z:s}=t.position,i=Bt(a.x,a.z);bs(t,o,n,s,i+Math.PI*.5,Z*.95*e,Z*.078,.28);const r=Z*.3*e;for(let l=0;l<5;l++){const h=l/5*bt+Math.random()*.5;Or(t,o+Math.cos(h)*r,n,s+Math.sin(h)*r,h,(1.5+Math.random()*1)*e,Z*.16*e,Z*.3*e,.5+Math.random()*.16)}for(let l=0;l<8;l++){const h=Math.random()*bt,c=(1.7+Math.random()*1.4)*e;$a(t,o+Math.cos(h)*r*.85,n,s+Math.sin(h)*r*.85,Math.cos(h)*c,1.4+Math.random()*1.2,Math.sin(h)*c,mt*(.85+Math.random()*.4)*e,.42+Math.random()*.14,Math.random()<.35)}},cast(t){const e=t.direction,a=Bt(e.x,e.z);bs(t,t.position.x,t.position.y,t.position.z,a+Math.PI*.42,Z*.5,Z*.062,.17);const o=(t.weapon.cone??150)*Math.PI/180;for(let n=0;n<3;n++){const s=(n-1)*o*.3,i=a+s;Or(t,t.position.x,t.position.y,t.position.z,Math.atan2(Math.sin(i),Math.cos(i))-Math.PI*.5,1.5+Math.random()*.7,Z*.12,Z*.22,.34)}}},Catch:{projectile(t){const e=ap(t.color);return e.position.copy(t.position),e.scale.setScalar(.6),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Cr(e),n=Ir(t.weapon);o.phase+=a/n*bt*1.1,o.grow=Math.min(1,o.grow+a/n),e.rotation.y=o.phase;const s=W.lerp(.6,1.28,1-Math.pow(1-o.grow,2));e.scale.setScalar(s),e.position.y+=Math.sin(o.phase*1.6)*Z*.02,o.shed-=a,o.shed<=0&&(o.shed=.1+Math.random()*.06,$a(t,t.position.x,t.position.y,t.position.z,-t.direction.x*.6+(Math.random()-.5)*.8,.1,-t.direction.z*.6+(Math.random()-.5)*.8,mt*.8,.32,Math.random()<.4))},impact(t){const e=ws(t.damage),a=t.direction,{x:o,y:n,z:s}=t.position,r=Bt(a.x,a.z)+Math.PI*.5;bs(t,o,n,s,r,Z*1.12*e,Z*.085,.32);const l=Z*.25*e,h=Z*.26*e,c=new ie;c.rotation.y=r,c.position.set(o,n-Z*.05,s),c.renderOrder=10;const d=Fv();d.color.set(Ta),d.opacity=1;const p=Ov();p.color.set(jo),p.opacity=1;const u=Nv();u.color.set(t.color),u.opacity=1;const f={wall:d,face:p,core:u},m=ep(l,h,f),g=ep(l,h,f);g.rotation.y=Math.PI,c.add(m,g);const w=Z*.185*e,b=Z*.4*e,y=n-Z*.05-(Ot+l*.6);t.spawnTransient(c,.55,x=>{const M=1-Math.pow(1-x,2),v=W.lerp(w,b,M);m.position.x=v,g.position.x=-v,m.rotation.z=-M*.9,g.rotation.z=M*.9,c.position.y=n-Z*.05-y*M*M;const T=x<.6?1:1-(x-.6)/.4;d.opacity=T,p.opacity=T,u.opacity=T});const k=Z*.3*e;for(let x=0;x<9;x++){const M=x/9*bt+Math.random()*.6,v=(1.9+Math.random()*1.5)*e;$a(t,o+Math.cos(M)*k,n,s+Math.sin(M)*k,Math.cos(M)*v,1.6+Math.random()*1.3,Math.sin(M)*v,mt*(.9+Math.random()*.5)*e,.46+Math.random()*.16,Math.random()<.35)}for(let x=0;x<2;x++){const M=r+(x===0?.6:-.6)+Math.PI*(x===0?0:1);Or(t,o+Math.cos(M)*k,n,s+Math.sin(M)*k,M,(1.6+Math.random()*.9)*e,Z*.14*e,Z*.26*e,.48)}},cast(t){const e=t.direction,a=Bt(e.x,e.z);bs(t,t.position.x,t.position.y,t.position.z,a+Math.PI*.38,Z*.58,Z*.068,.18);for(let o=0;o<5;o++)$a(t,t.position.x,t.position.y,t.position.z,e.x*(1.3+Math.random())+(Math.random()-.5)*.9,.5+Math.random()*.4,e.z*(1.3+Math.random())+(Math.random()-.5)*.9,mt*.8,.3,Math.random()<.4)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=new e.Group;o.name="teleSushiRoot";const n=t.position.clone();n.y-=Z*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=tp(t.color);s.name="teleSushiNori",op(s,"teleSushiNori"),o.add(s);const i=Math.max(1,t.weapon.pellets??3),r=[];for(let p=0;p<i;p++){const u=ap(t.color);u.name=`teleSushiRoll${p}`,op(u,`teleSushiRoll${p}`),r.push(u),o.add(u)}const l=(p,u,f)=>{const m=e.MathUtils.clamp((p-u)/(f-u),0,1);return m*m*(3-2*m)},h=(t.weapon.spreadDeg??40)*Math.PI/360,c=Z*.7,d=(p,u)=>{const f=e.MathUtils.clamp(u/a,0,1),m=l(f,0,.38),g=l(f,.88,1);s.position.set(Math.sin(f*3.1)*Z*.3,c+Z*(.7+.34*m),Z*(.1+.34*m)),s.rotation.set(-.95-.3*Math.sin(f*4.2),f*2.6,.35*Math.sin(f*3.4));const w=.85+.45*m;s.scale.set(w,1,w*(1+.25*Math.sin(f*5)));for(let b=0;b<i;b++){const y=r[b],k=b*.1,x=l(f,.15+k,.88),M=i===1?0:(b/(i-1)-.5)*2*h,v=b/i*bt+f*(2.4+2*x),T=e.MathUtils.lerp(v,M,g),S=Z*(.62+.3*x+.34*g);y.position.set(Math.sin(T)*S,c+Math.sin(v*1.4)*Z*.14*(1-g)+Z*.16*x,Math.cos(T)*S*(.6+.4*g)),y.scale.setScalar(1.1+(Hv-1.1)*x),y.rotation.y=v*1.5}};d(0,0),t.spawnTransient(o,a+.06,d)}}};function Fr(t,e,a,o,n,s,i,r,l,h){const c=new ie,d=Ks();d.color.set(h),d.opacity=1;const p=new E(Lt,d);p.scale.set(r*1.3,1,r*.75),p.position.y=-Z*.005,c.add(p);const u=Vs();u.color.set(Ta),u.opacity=1;const f=new E(Lt,u);f.scale.set(r,1,r*.55),c.add(f),c.renderOrder=9,c.position.set(e,a,o),c.rotation.y=Math.random()*bt;const m=(Math.random()-.5)*9,g=-5.2;t.spawnTransient(c,l,(w,b)=>{c.position.set(e+n*b,Math.max(Ot,a+s*b+.5*g*b*b),o+i*b),c.rotation.y+=m*.016,u.opacity=1-w*w,d.opacity=1-w*w})}function Pv(t,e,a,o,n,s,i,r,l,h){const c=new ie,d=Ks();d.color.set(h),d.opacity=1;const p=new E(Lt,d);p.scale.set(Z*.075,1,r*1.03),p.position.y=-Z*.006,c.add(p);const u=Vs();u.color.set(Ta),u.opacity=1;const f=new E(Lt,u);f.scale.set(Z*.05,1,r),c.add(f),c.renderOrder=9,c.position.set(e,a,o);const m=-5.6,g=(Math.random()-.5)*4.5;t.spawnTransient(c,l,(w,b)=>{c.position.set(e+n*b,Math.max(Ot,a+s*b+.5*m*b*b),o+i*b),c.rotation.y=Bt(n,i)+g*b,c.scale.set(1+w*.5,1,1-w*.35),u.opacity=1-w*w,d.opacity=1-w*w})}function Or(t,e,a,o,n,s,i,r,l){const h=Rv();h.color.set(Sh),h.opacity=1;const c=Iv();c.color.set(Ah),c.opacity=1;const d=Cv();d.color.set(rf),d.opacity=1;const p=Dv(i,r,{face:h,deep:c,fat:d});p.renderOrder=9,p.position.set(e,a,o),p.rotation.y=n+Math.PI*.5;const u=Math.cos(n)*s,f=Math.sin(n)*s,m=.9+Math.random()*.7,g=-7.8,w=(Math.random()-.5)*2.2;t.spawnTransient(p,l,(b,y)=>{const k=a+m*y+.5*g*y*y,x=k<=Ot;p.position.set(e+u*y,x?Ot:k,o+f*y),p.rotation.y=n+Math.PI*.5+w*y;const M=1-Math.pow(b,2.4);h.opacity=M,c.opacity=M,d.opacity=M})}function $v(t){const e=t.replace("#","");return[0,2,4].map(a=>parseInt(e.slice(a,a+2),16)/255)}function Bv(t){return`#${t.map(e=>Math.round(Math.max(0,Math.min(1,e))*255).toString(16).padStart(2,"0").toUpperCase()).join("")}`}function np(t){return .2126*t[0]+.7152*t[1]+.0722*t[2]}function qv([t,e,a]){const o=Math.max(t,e,a),n=Math.min(t,e,a),s=(o+n)/2,i=o-n;if(i===0)return[0,0,s];const r=s>.5?i/(2-o-n):i/(o+n);return[(o===t?(e-a)/i+(e<a?6:0):o===e?(a-t)/i+2:(t-e)/i+4)*60,r,s]}function sp([t,e,a]){const o=(t%360+360)%360/360,n=a<.5?a*(1+e):a+e-a*e,s=2*a-n,i=r=>{const l=(r+1)%1;return l<1/6?s+(n-s)*6*l:l<.5?n:l<2/3?s+(n-s)*(2/3-l)*6:s};return[i(o+1/3),i(o),i(o-1/3)]}function gf(t,e,a,o){const n=$v(t),[s,i]=qv(n),r=np(n)+o,l=s+e,h=Math.max(0,Math.min(1,i+a));let c=0,d=1;for(let p=0;p<32;p++){const u=(c+d)/2;np(sp([l,h,u]))<r?c=u:d=u}return Bv(sp([l,h,(c+d)/2]))}function wf(t){const e=re.soup.weapons.find(a=>a.key===t);if(!e)throw new Error(`soup vfx: no weapon '${t}' in CHARACTERS.soup.weapons`);return e.color}const Ai=wf("Splash"),Ri=gf(Ai,7.1,.195,.196),Ii=gf(Ai,-6.4,.07,-.212),Uv="#FFF2E2",Ch=wf("Noodle"),oe=J,Ge=.27,fn=oe*.3,jv=oe*.34,Nr=oe*.55,Qa=oe*.042,Ze=oe*.085,Dt=oe*.4,Gv=oe*.024;function bf(t){let e=t%2147483647;return e<=0&&(e+=2147483646),()=>(e=e*48271%2147483647,e/2147483647)}function Lr(t,e){const o=bf(t),n=o()*Math.PI*2,s=o()*Math.PI*2,i=o()*Math.PI*2,r=[];for(let u=0;u<e;u++)r.push([o()*Math.PI*2,.14+o()*.2,.16+o()*.14]);const l=[];let h=0;for(let u=0;u<=84;u++){const f=u/84*Math.PI*2;let m=1+.15*Math.sin(3*f+n)+.09*Math.sin(5*f+s)+.05*Math.sin(8*f+i);for(const[g,w,b]of r){let y=f-g;for(;y>Math.PI;)y-=Math.PI*2;for(;y<-Math.PI;)y+=Math.PI*2;m+=w*Math.exp(-(y*y)/(2*b*b))}l.push(m),m>h&&(h=m)}const c=new Float32Array(258);for(let u=0;u<=84;u++){const f=u/84*Math.PI*2,m=l[u]/h,g=(u+1)*3;c[g]=Math.cos(f)*m,c[g+1]=0,c[g+2]=Math.sin(f)*m}const d=[];for(let u=1;u<=84;u++)d.push(0,u+1,u);const p=new Dn;return p.setAttribute("position",new En(c,3)),p.setIndex(d),p.computeVertexNormals(),p}const ip=[Lr(9173,4),Lr(48271,5),Lr(11071,3)];let Wv=0;const yf=()=>ip[Wv++%ip.length],Nn=new st(1,9,7);Nn.scale(.78,.78,1.4);const Xa=new st(1,10,8),Yv=new Me(1,.34,1,24,1,!0),Vv=(()=>{const e=document.createElement("canvas");e.width=e.height=64;const a=e.getContext("2d"),o=a.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);o.addColorStop(0,"rgba(255,255,255,0.95)"),o.addColorStop(.45,"rgba(255,255,255,0.52)"),o.addColorStop(.78,"rgba(255,255,255,0.14)"),o.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=o,a.fillRect(0,0,64,64);const n=new et(e);return n.colorSpace=ri,n})();function Dr(t){const e=bf(t),a=1.1+e()*1.4,o=.9+e()*1.3,n=.13+e()*.11,s=.08+e()*.09,i=[],r=8;for(let l=0;l<r;l++){const h=l/(r-1);i.push(new de(Math.sin(h*Math.PI*a+t)*n,Math.cos(h*Math.PI*o+t)*s,h-.5))}return new bm(new ym(i),20,Gv/Dt,5,!1)}const rp=[Dr(7919),Dr(30011),Dr(65449)];let Kv=0;const Fh=()=>rp[Kv++%rp.length];function dt(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Mt=(t,e)=>new V({color:t,transparent:!0,opacity:e,depthWrite:!1,side:me}),xf=dt(10,()=>Mt(Ii,.9)),Xv=dt(10,()=>Mt(Ri,.9)),vf=dt(28,()=>Mt(Ai,.95)),Xs=dt(14,()=>Mt(Ri,.95)),Zv=dt(16,()=>Mt(Ch,1)),Jv=dt(6,()=>Mt(Ii,.85)),Rl=dt(6,()=>Mt(Ai,1)),Qv=dt(6,()=>Mt(Ri,1)),e5=dt(12,()=>Mt(Ch,1)),t5=dt(3,()=>Mt(Ii,.92)),a5=dt(3,()=>Mt(Ri,.9)),o5=dt(6,()=>Mt(Ch,1)),n5=dt(16,()=>new Ct({map:Vv,color:Uv,transparent:!0,opacity:.5,depthWrite:!1})),s5=dt(8,()=>new V({color:"#FFF4DF",transparent:!0,opacity:.9,depthWrite:!1,blending:Qe})),ys=new de,i5=new de(0,0,1);function Zs(t,e,a,o){ys.set(e,a,o),!(ys.lengthSq()<1e-9)&&(ys.normalize(),t.quaternion.setFromUnitVectors(i5,ys))}function Sa(t,e,a,o,n,s,i,r,l,h=!1){const c=new E(Nn,h?Xs():vf()),d=c.material,p=.95;d.opacity=p,c.position.set(e,a,o);const u=-9.4;t.spawnTransient(c,l,(f,m)=>{const g=a+s*m+.5*u*m*m,w=g<=Ge;c.position.set(e+n*m,w?Ge:g,o+i*m);const b=s+u*m;if(w)Zs(c,n,0,i),c.scale.set(r*1.5,r*.3,r*1.7);else{Zs(c,n,b,i);const y=Math.hypot(n,b,i),k=1+Math.min(.9,y*.075);c.scale.set(r/Math.sqrt(k),r/Math.sqrt(k),r*k)}d.opacity=p*(1-f*f)})}function eo(t,e,a,o,n,s,i){const r=new ba(n5()),l=r.material;l.opacity=0;const h=(Math.random()-.5)*n*1.6,c=(Math.random()-.5)*n*1.6;r.renderOrder=9,r.position.set(e,a,o),r.scale.set(n*1.1,n*1.1,1),t.spawnTransient(r,i,d=>{const p=1-Math.pow(1-d,2);r.position.set(e+h*p,a+s*p,o+c*p);const u=n*(1.1+p*1.5);r.scale.set(u,u,1),l.opacity=.5*Math.sin(Math.min(1,d*1.3)*Math.PI)})}function Oh(t,e,a,o,n){const s=yf(),i=Math.random()*Math.PI*2,r=new E(s,xf()),l=r.material;r.rotation.y=i,r.position.set(e,Ge,a),r.renderOrder=6,r.scale.setScalar(o*.35);const h=new E(s,Xv()),c=h.material;h.rotation.y=i+.7,h.position.set(e,Ge+.01,a),h.renderOrder=7,h.scale.setScalar(o*.18);const d=p=>p<.34?1-Math.pow(1-p/.34,2.2):1;t.spawnTransient(r,n,p=>{r.scale.setScalar(o*W.lerp(.35,1,d(p))),l.opacity=.82*(1-Math.pow(p,1.5))}),t.spawnTransient(h,n*.86,p=>{h.scale.setScalar(o*W.lerp(.18,.62,d(p))),c.opacity=.9*(1-Math.pow(p,1.8))})}function r5(t,e,a,o,n){const s=new E(Yv,Jv()),i=s.material;i.color.set(Ii),i.opacity=.85,s.rotation.y=Math.random()*Math.PI*2,s.renderOrder=8;const r=o*.78,l=h=>{const c=h<.5?1-Math.pow(1-h/.5,2.4):1,d=o*W.lerp(.24,1,c),p=r*W.lerp(1,.18,c);s.position.set(e,Ge+p*.5,a),s.scale.set(d,p,d),i.opacity=.85*(1-Math.pow(h,1.6))};l(0),t.spawnTransient(s,n,l)}function Nh(t,e,a,o,n){const s=new E(Xa,s5()),i=s.material;s.position.set(e,a,o),s.scale.set(n,n*.55,n),t.spawnTransient(s,.19,r=>{const l=n*W.lerp(.9,1.7,r);s.scale.set(l,l*.5,l),i.opacity=.9*(1-r)*(1-r)})}function Js(t,e,a,o,n,s,i,r,l){const h=new E(Fh(),Zv()),c=h.material;c.opacity=1,h.position.set(e,a,o),h.scale.setScalar(r);const d=-9.4,p=6+Math.random()*6,u=Math.atan2(n,i)+(Math.random()-.5)*.8;t.spawnTransient(h,l,(f,m)=>{const g=a+s*m+.5*d*m*m;g<=Ge+.02?(h.position.set(e+n*m,Ge+.02,o+i*m),h.quaternion.identity(),h.rotation.set(0,u,0),h.scale.set(r,r*.55,r)):(h.position.set(e+n*m,g,o+i*m),Zs(h,n,s+d*m,i),h.rotateZ(m*p)),c.opacity=1-Math.pow(f,3)})}function l5(t){const e=new ie,a=new E(Nn,Rl());a.material.color.set(t),a.scale.setScalar(Ze),a.position.z=Ze*.4,e.add(a);const o=new E(Xa,Qv());o.scale.setScalar(Ze*.5),o.position.set(Ze*.25,Ze*.4,Ze*.85),e.add(o);for(let n=0;n<2;n++){const s=new E(Nn,Rl());s.material.color.set(t);const i=Ze*(.44-n*.13);s.scale.setScalar(i),s.position.set((Math.random()-.5)*Ze*.5,(Math.random()-.5)*Ze*.4,-Ze*(1.05+n*.95)),e.add(s)}return e.userData.__head=a,e}const h5={projectile(t){const e=l5(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=(e.userData.__phase??Math.random()*6)+a*17;e.userData.__phase=o;const n=1+Math.sin(o)*.22;e.scale.set(1/Math.sqrt(n),1/Math.sqrt(n),n);const s=e.userData.__head;s&&(s.position.x=Math.sin(o*.55)*Ze*.3);const i=(e.userData.__drip??.04)-a;i<=0?(e.userData.__drip=.055+Math.random()*.045,Sa(t,t.position.x-t.direction.x*Ze*1.6,t.position.y-Ze*.4,t.position.z-t.direction.z*Ze*1.6,-t.direction.x*.5+(Math.random()-.5)*.5,-.3-Math.random()*.4,-t.direction.z*.5+(Math.random()-.5)*.5,Qa*(.5+Math.random()*.4),.3)):e.userData.__drip=i;const r=(e.userData.__steam??.09)-a;r<=0?(e.userData.__steam=.13+Math.random()*.09,eo(t,t.position.x,t.position.y+Ze,t.position.z,oe*.075,oe*.14,.34)):e.userData.__steam=r},impact(t){const{x:e,z:a}=t.position,o=t.direction;let n=o.x,s=o.z;const i=Math.hypot(n,s);i<1e-4?(n=1,s=0):(n/=i,s/=i),Nh(t,e,t.position.y*.55,a,oe*.19);const r=fn*.85;Oh(t,e+n*r,a+s*r,fn,.42),r5(t,e+n*r*.45,a+s*r*.45,fn*1.15,.24);for(let l=0;l<7;l++){const h=l/7*Math.PI*2+Math.random()*.6,c=1.7+Math.random()*1.5;Sa(t,e+Math.cos(h)*fn*.55,t.position.y*.5,a+Math.sin(h)*fn*.55,Math.cos(h)*c+n*.9,2.1+Math.random()*1.2,Math.sin(h)*c+s*.9,Qa*(1+Math.random()*.7),.36+Math.random()*.12,l%3===0)}eo(t,e+n*r*.6,Ge+oe*.05,a+s*r*.6,oe*.14,oe*.3,.5)},cast(t){const e=t.direction,a=new E(Nn,Xs()),o=a.material;a.position.copy(t.position),Zs(a,e.x,-.25,e.z),t.spawnTransient(a,.16,n=>{a.position.set(t.position.x+e.x*n*oe*.2,t.position.y-n*oe*.07,t.position.z+e.z*n*oe*.2);const s=oe*(.05+n*.05);a.scale.set(s*1.5,s*.8,s*(1.6+n)),o.opacity=.95*(1-n*n)});for(let n=0;n<4;n++){const s=(Math.random()-.5)*.8,i=(Math.random()-.5)*.8;Sa(t,t.position.x,t.position.y,t.position.z,e.x*(1.6+Math.random())+s,.7+Math.random()*.9,e.z*(1.6+Math.random())+i,Qa*(.5+Math.random()*.4),.3)}eo(t,t.position.x,t.position.y,t.position.z,oe*.09,oe*.2,.34)}};function c5(t){const e=new ie,a=[];for(let n=0;n<3;n++){const s=new E(Fh(),e5());s.material.color.set(t),s.scale.setScalar(Dt*.62),s.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),s.position.set((Math.random()-.5)*Dt*.22,(Math.random()-.5)*Dt*.22,(Math.random()-.5)*Dt*.22),e.add(s),a.push(s)}const o=new E(Xa,Rl());return o.scale.setScalar(Ze*.62),e.add(o),e.userData.__strands=a,e}const d5={projectile(t){const e=c5(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=e.userData.__strands;if(o)for(let s=0;s<o.length;s++){const i=o[s];i.rotation.x+=a*(3.4+s*1.7),i.rotation.z+=a*(2.1+s*1.1)}const n=(e.userData.__drip??.06)-a;n<=0?(e.userData.__drip=.085+Math.random()*.06,Sa(t,t.position.x,t.position.y-Dt*.2,t.position.z,(Math.random()-.5)*.7,-.2-Math.random()*.5,(Math.random()-.5)*.7,Qa*(.45+Math.random()*.35),.32)):e.userData.__drip=n},impact(t){const{x:e,z:a}=t.position;Nh(t,e,t.position.y*.55,a,oe*.18),Oh(t,e,a,jv,.48);for(let o=0;o<5;o++){const n=o/5*Math.PI*2+Math.random()*.7,s=1.3+Math.random()*1.2;Js(t,e,t.position.y*.7,a,Math.cos(n)*s,1.5+Math.random()*1.1,Math.sin(n)*s,Dt*(.7+Math.random()*.45),.7+Math.random()*.15)}for(let o=0;o<4;o++){const n=Math.random()*Math.PI*2,s=1.2+Math.random()*1.3;Sa(t,e,t.position.y*.6,a,Math.cos(n)*s,1.8+Math.random()*1.1,Math.sin(n)*s,Qa*(.6+Math.random()*.5),.36,o===0)}eo(t,e,Ge+oe*.05,a,oe*.15,oe*.32,.55)},cast(t){const e=t.direction;Js(t,t.position.x,t.position.y,t.position.z,e.x*1.4,1.5,e.z*1.4,Dt*.7,.26);for(let a=0;a<3;a++)Sa(t,t.position.x,t.position.y,t.position.z,e.x*1.2+(Math.random()-.5)*.8,.9+Math.random()*.7,e.z*1.2+(Math.random()-.5)*.8,Qa*.55,.28)}},p5={cast(t){const e=t.direction,a=Je(t.weapon.range??Wa.meleeHeavy),o=t.position.x,n=t.position.y,s=t.position.z,i=-e.z,r=e.x;for(let d=0;d<13;d++){const p=(d/12-.5)*2,u=p*a*.16+(Math.random()-.5)*a*.06,f=1.1+Math.random()*1.5-Math.abs(p)*.35,m=oe*(.055+Math.random()*.055)*(1-Math.abs(p)*.25);Sa(t,o+i*u,n+oe*(.05+Math.random()*.12),s+r*u,e.x*f+i*p*.35,.5+Math.random()*.7,e.z*f+r*p*.35,m,.42+Math.random()*.16,d%4===0)}for(let d=0;d<3;d++){const p=new E(Xa,d===1?Xs():vf()),u=p.material,f=.35+d*.5,m=o+e.x*a*.1,g=s+e.z*a*.1,w=n+oe*.1;p.position.set(m,w,g),t.spawnTransient(p,.4,y=>{const k=y*y;p.position.set(m+e.x*f*a*.28*y,Math.max(Ge,w-k*oe*.8),g+e.z*f*a*.28*y),p.scale.set(oe*(.13+y*.1),oe*(.13-y*.09),oe*(.13+y*.1)),u.opacity=.85*(1-Math.pow(y,1.7))})}for(let d=0;d<3;d++){const p=(d-1)*.5;Js(t,o+i*p*a*.1,n,s+r*p*a*.1,e.x*(1.6+Math.random())+i*p,.9+Math.random()*.6,e.z*(1.6+Math.random())+r*p,Dt*(.8+Math.random()*.4),.6)}const l=yf(),h=new E(l,xf()),c=h.material;h.position.set(o+e.x*a*.26,Ge,s+e.z*a*.26),h.rotation.y=Math.atan2(e.x,e.z),h.renderOrder=6,t.spawnTransient(h,.6,d=>{const p=d<.45?1-Math.pow(1-d/.45,2):1;h.scale.set(a*.13*p+.05,1,a*.3*p+.05),c.opacity=.8*(1-Math.pow(d,2.2))});for(let d=0;d<3;d++)eo(t,o+e.x*a*(.12+d*.13),Ge+oe*.06,s+e.z*a*(.12+d*.13),oe*.16,oe*.42,.6)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=new e.Group;o.name="teleSoupRoot";const n=t.position.clone();n.y-=oe*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=new e.Group;s.name="teleSoupTilt",o.add(s);const i=t5(),r=new e.Mesh(Xa,i);r.name="teleSoupBroth",s.add(r);const l=a5(),h=new e.Mesh(Xa,l);h.name="teleSoupLip",s.add(h);const c=3,d=[];for(let m=0;m<c;m++){const g=new e.Mesh(Fh(),o5());g.name=`teleSoupNoodle${m}`,d.push(g),s.add(g)}const p=(m,g,w)=>{const b=e.MathUtils.clamp((m-g)/(w-g),0,1);return b*b*(3-2*b)},u=oe*.98,f=(m,g)=>{const w=e.MathUtils.clamp(g/a,0,1),b=p(w,0,.45),y=p(w,.25,.85),k=p(w,.85,1),x=oe*(.45+.22*b),M=Math.sin(w*(7+9*y));r.position.set(Math.sin(w*(5+7*y))*oe*.06*y,u+oe*.1*b,oe*.3*y),r.scale.set(x*(1+.1*M),x*(.72-.1*M),x),i.opacity=.8+.15*b;const v=x*(.48+.3*k);h.position.set(r.position.x,r.position.y+x*(.3-.34*k),r.position.z+x*(.42+.55*k)),h.scale.set(v,v*.55,v),l.opacity=.35+.6*k+.15*y;for(let T=0;T<c;T++){const S=d[T],R=T/c*Math.PI*2+w*3.4,F=p(w,.25+T*.08,.9),A=x*(.35+.75*F);S.position.set(r.position.x+Math.cos(R)*A,r.position.y+x*(.35+.45*F),r.position.z+Math.sin(R)*A*.7),S.scale.setScalar(Dt*(.5+.85*F)),S.rotation.set(R*1.3,w*4.1+T,R*.8),S.material.opacity=.55+.45*F}s.rotation.x=k*.75+y*.12};f(0,0),t.spawnTransient(o,a+.06,f)},impact(t){const{x:e,z:a}=t.position,o=new E(Xa,Xs()),n=o.material;o.position.set(e,Ge,a),t.spawnTransient(o,.16,s=>{const i=1-Math.pow(1-s,2.6),r=oe*W.lerp(.42,.05,i),l=oe*W.lerp(.13,.4,i);o.position.set(e,Ge+r*.5,a),o.scale.set(l,r,l),n.opacity=.95*(1-Math.pow(s,2.5))}),Nh(t,e,t.position.y*.5,a,oe*.3),Oh(t,e,a,Nr,.62);for(let s=0;s<11;s++){const i=s/11*Math.PI*2+Math.random()*.5,r=2.2+Math.random()*2.2;Sa(t,e+Math.cos(i)*oe*.12,Ge+oe*.1,a+Math.sin(i)*oe*.12,Math.cos(i)*r,2.6+Math.random()*1.8,Math.sin(i)*r,Qa*(.9+Math.random()*.8),.45+Math.random()*.15,s%3===0)}for(let s=0;s<4;s++){const i=s/4*Math.PI*2+Math.random(),r=1.5+Math.random()*1.3;Js(t,e,Ge+oe*.15,a,Math.cos(i)*r,2+Math.random()*1.2,Math.sin(i)*r,Dt*(.85+Math.random()*.45),.85)}eo(t,e,Ge+oe*.05,a,oe*.22,oe*.6,.8);for(let s=0;s<3;s++){const i=s/3*Math.PI*2+Math.random();eo(t,e+Math.cos(i)*Nr*.55,Ge+oe*.03,a+Math.sin(i)*Nr*.55,oe*.14,oe*.4,.7)}}},u5={Splash:h5,Noodle:d5,Dump:p5},Wt=.09,f5=J*.075,m5=J*.1,lp=Ka*.5,Lh=new xm(Wt,0);Lh.scale(.55,1.7,.55);const Il=new st(Wt*.24,6,6);function La(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const kf=La(24,()=>new V({color:"#BFEFFF",transparent:!0,opacity:.8,depthWrite:!1})),g5=La(8,()=>new V({color:"#FFFFFF",transparent:!0,opacity:1,blending:Qe,depthWrite:!1})),hp=La(6,()=>new V({color:"#EAFBFF",transparent:!0,opacity:.95,blending:Qe,depthWrite:!1}));function cp(t){const e=new ie,a=4;for(let n=0;n<a;n++){const s=kf();s.color.set(t);const i=new E(Lh,s),r=n/a*Math.PI*2;i.position.set(Math.cos(r)*Wt*.5,(Math.random()-.5)*Wt*.6,Math.sin(r)*Wt*.5),i.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),i.scale.setScalar(.6+Math.random()*.5),e.add(i)}const o=new E(Il,g5());return e.add(o),e.userData.__glint=o,e}const xs=J*1,w5=new Me(.3,.36,.66,14,1,!1),b5=new st(.3,14,8),y5=new Me(.15,.24,.16,12,1,!1),x5=new Me(.185,.185,.14,12,1,!1),v5=new Me(.26,.31,.6,12,1,!1),k5=new st(J*.09,7,6),M5=new Me(1,1,1,16,1,!0),dp=new Ma(.72,1,28),E5=La(8,()=>new V({color:"#7FD4F5",transparent:!0,opacity:.42,depthWrite:!1,side:me})),T5=La(4,()=>new V({color:"#BFEFFF",transparent:!0,opacity:.9,depthWrite:!1})),S5=La(20,()=>new V({color:"#BFEFFF",transparent:!0,opacity:.9,depthWrite:!1})),A5=La(6,()=>new V({color:"#1E90D8",transparent:!0,opacity:.95,depthWrite:!1})),zr=La(8,()=>new V({color:"#8FD9F7",transparent:!0,opacity:.9,blending:Qe,depthWrite:!1,side:me}));function pp(t){const e=new ie;e.name=t;const a=E5(),o=new E(w5,a);o.name=`${t}Body`,o.position.y=.33;const n=new E(b5,a);n.name=`${t}Shoulder`,n.position.y=.66,n.scale.set(1,.62,1);const s=new E(y5,a);s.name=`${t}Neck`,s.position.y=.8;const i=new E(v5,T5());i.name=`${t}Fill`,i.position.y=.3;const r=new E(x5,A5());return r.name=`${t}Cap`,r.position.y=.93,e.add(o,n,s,i,r),e.userData.__cap=r,e.userData.__fill=i,e}const R5={Mega:{telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=t.position.clone();o.y-=J*.55;const n=new e.Group;n.name="megaTelegraph",n.position.copy(o);const s=pp("megaSelfBottle"),i=pp("megaCapBottle");n.add(s,i);const r=[],l=16;for(let g=0;g<l;g++){const w=new e.Mesh(k5,S5());w.name=`megaLaunchStreak${g}`,w.scale.set(.8,2.6,.8),r.push(w),n.add(w)}const h=new e.Mesh(dp,zr());h.name="megaMergeGlow",h.rotation.x=-Math.PI/2,h.visible=!1,n.add(h);const c=g=>g.userData.__cap,d=g=>g.userData.__fill,p=(g,w,b)=>{const y=e.MathUtils.clamp((g-w)/(b-w),0,1);return y*y*(3-2*y)},u=J*.85,f=2.05,m=(g,w)=>{const b=e.MathUtils.clamp(w/a,0,1),y=p(b,0,.38),k=p(b,.22,.62),x=p(b,.55,.88),M=p(b,.88,1),v=u*y;s.position.set(0,v,0),s.rotation.z=.24+.09*Math.sin(b*7);const T=xs*(.55+.45*y);s.scale.setScalar(T);for(let N=0;N<l;N++){const L=N/l*Math.PI*2,P=N%4*.06,j=e.MathUtils.clamp((b-P)/.5,0,1),z=r[N],Y=Ka*(.6+1.5*j);z.position.set(Math.cos(L)*Y,J*(.05+1.25*j),Math.sin(L)*Y),z.scale.set(.8*(1-j*.4),2.6*(1-j*.5),.8*(1-j*.4)),z.material.opacity=.9*(1-j)*(1-x)}const S=c(s);S.position.y=.93+k*.55,S.visible=k<.98;const R=k>.02;if(i.visible=R,R){const N=xs*(.06+.62*k);i.scale.setScalar(N);const L=Ka*1.5*k*(1-x);i.position.set(L,v+T*.95+k*J*.42,0),i.rotation.z=-.3-.1*Math.sin(b*6),c(i).visible=k>.5}if(x>0){const N=xs*e.MathUtils.lerp(1,f,x);s.scale.setScalar(N),s.position.set(0,u+J*.25*x,0),i.position.x*=1-x,i.position.y=s.position.y+N*.55,s.rotation.z=(.24+.09*Math.sin(b*7))*(1-x*.5);const L=xs*e.MathUtils.lerp(.62,.02,x);i.scale.setScalar(Math.max(.001,L)),h.visible=x<.99,h.position.set(0,s.position.y+N*.45,0);const P=N*(.22+.3*x);h.scale.set(P,P,P),h.material.opacity=.75*Math.sin(Math.PI*x)}else h.visible=!1;const F=M*.85;n.rotation.z=-F*t.direction.x,n.rotation.x=F*t.direction.z;const A=d(s),C=.35+.65*b;A.scale.set(1,C,1),A.position.y=.3*C,A.material.opacity=.75+.25*M};m(0,0),t.spawnTransient(n,a+.06,m)},cast(t){const e=t.THREE,a=t.position.clone();a.y-=J*.55;const o=new e.Mesh(M5,zr());o.name="megaPourColumn";const n=Ka*1.35,s=J*2.6;o.position.set(a.x,a.y+s*.5,a.z),o.scale.set(n,s,n),t.spawnTransient(o,.34,i=>{const r=Math.min(1,i*2.4),l=Math.max(0,(i-.42)/.58);o.position.y=a.y+s*.5*(1-.55*r),o.scale.set(n*(1+1.5*l),s*(1-.5*r),n*(1+1.5*l)),o.material.opacity=.85*(1-i*i)});for(let i=0;i<2;i++){const r=new e.Mesh(dp,zr());r.name=`megaPourRing${i}`,r.rotation.x=-Math.PI/2,r.position.set(a.x,a.y+.05+i*.03,a.z);const l=i*.09;t.spawnTransient(r,.42+l,h=>{const c=Math.max(0,(h*(.42+l)-l)/.42),d=Ka*(.8+3.6*c);r.scale.set(d,d,d),r.material.opacity=.9*(1-c)})}}},Glass:{projectile(t){const e=cp(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=e.userData.__glint;let n=0;for(const s of e.children){if(s===o)continue;const i=2+n*.9;s.rotation.x+=a*i,s.rotation.y+=a*i*.75,n++}if(o){const s=o.material;s.opacity=Math.max(0,s.opacity-a*3.2);const i=(e.userData.__glintTimer??0)-a;i<=0?(e.userData.__glintTimer=.14+Math.random()*.3,s.opacity=1,o.position.set((Math.random()-.5)*Wt,(Math.random()-.5)*Wt,(Math.random()-.5)*Wt)):e.userData.__glintTimer=i}},impact(t){const e=t.position,a=m5/Wt,o=new E(Il,hp());o.position.copy(e),o.scale.setScalar(1.25*a),t.spawnTransient(o,.14,i=>{o.scale.setScalar(W.lerp(1.25,3,i)*a),o.material.opacity=.95*(1-i)});const n=W.clamp(1+t.damage*.06,1,2.4),s=11;for(let i=0;i<s;i++){const r=i/s*Math.PI*2+Math.random()*.5,l=(1.6+Math.random()*2.4)*n,h=kf();h.color.set(t.color);const c=new E(Lh,h),d=(.42+Math.random()*.43)*a*n;c.scale.setScalar(d);const p=e.x+Math.cos(r)*lp,u=e.y,f=e.z+Math.sin(r)*lp;c.position.set(p,u,f);const m=1.1+Math.random()*1.6,g=-9,w=(Math.random()-.5)*22,b=(Math.random()-.5)*22;t.spawnTransient(c,.38+Math.random()*.2,(y,k)=>{c.position.set(p+Math.cos(r)*l*k,u+m*k+.5*g*k*k,f+Math.sin(r)*l*k),c.rotation.x=k*w,c.rotation.y=k*b,c.scale.setScalar(d*(1-y*.25)),c.material.opacity=.85*(1-y)})}},cast(t){const e=f5/Wt,a=cp(t.color);a.position.copy(t.position),a.scale.setScalar(.35*e),t.spawnTransient(a,.16,n=>{const s=Math.min(1,n*2.2),i=n>.55?1-(n-.55)*2.2:1;a.scale.setScalar(W.clamp(.35+s*.75,.1,1.15)*e*Math.max(0,i)),a.rotation.y=n*5});const o=new E(Il,hp());o.position.copy(t.position),o.scale.setScalar(.8*e),t.spawnTransient(o,.12,n=>{o.scale.setScalar(W.lerp(.8,1.9,n)*e),o.material.opacity=.9*(1-n)})}}},Go=Gt.mustard,Ut="#9A6410",Dh="#FFF2C0",zh=Gt.ketchup,Qt="#6E121D",Cl="#FFC0AE",Ns=Gt.bun,Mn="#7A4A1E",Fl="#F9E9C2",Q=J,To=Math.PI*2,Qs=.28;function Ci(t,e=8){const a=new ql(t,e);return a.rotateX(-Math.PI/2),a}function Hh(t,e,a,o){const n=Math.max(2,a*2),s=new Ia,i=l=>l%2===0?-o:o,r=l=>-t/2+l/n*t;s.moveTo(i(0)-e,r(0));for(let l=1;l<=n;l++)s.lineTo(i(l)-e,r(l));for(let l=n;l>=0;l--)s.lineTo(i(l)+e,r(l));return s.closePath(),s}function I5(t,e){const a=new Ia;return a.moveTo(0,t),a.quadraticCurveTo(e,t*.45,e,0),a.quadraticCurveTo(e,-t*.45,0,-t),a.quadraticCurveTo(-e,-t*.45,-e,0),a.quadraticCurveTo(-e,t*.45,0,t),a}const Ln=Q*.44,Ol=Q*.065,C5=Q*.072,ea=Q*.26,yo=Q*.185,ei=Ci(Hh(Ln,Ol,3,C5),1),ti=Q*.78,Mf=Q*.075,Ef=(Mf+Q*.098)*2,Hr=(()=>{const t=Ci(Hh(ti,Mf,3,Q*.098),1);return t.translate(0,0,ti/2),t})(),kt=Ci(I5(.5,.5),6),F5=new li(Q*.024,0),up=(()=>{const t=new Me(1,1,1,16,1,!0,0,Math.PI);return t.rotateZ(-Math.PI/2),t.rotateY(Math.PI/2),t})(),O5=(()=>{const t=new to(2,1);return t.rotateX(-Math.PI/2),t})(),N5=Ci(Hh(1,.14,4,.36),1);function Da(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const fo=t=>new V({color:t,side:me}),L5=fo(Go),fp=fo(Ut),D5=fo(Dh),z5=fo(zh),mp=fo(Qt),H5=fo(Cl),Gn=(t,e)=>new V({color:t,transparent:!0,opacity:e,side:me,depthWrite:!1}),ai=Da(48,()=>Gn(Go,1)),oi=Da(48,()=>Gn(Ut,1)),Tf=Da(20,()=>Gn(Dh,1)),gp=Da(8,()=>new V({color:Ns,transparent:!0,opacity:1,side:me,depthWrite:!1})),wp=Da(8,()=>new V({color:Mn,transparent:!0,opacity:1,side:me,depthWrite:!1})),bp=Da(8,()=>Gn(Fl,1)),yp=Da(8,()=>Gn(Go,1)),_5=Da(14,()=>new V({color:Mn,transparent:!0,opacity:1,depthWrite:!1}));function xt(t,e){return Math.atan2(t,e)}function xp(t){return t.range&&t.speed?t.range/t.speed:ro.normal/1e3}function _r(t){return W.clamp(.85+t*.035,.85,1.4)}function vp(t){let e=t.userData.__hotdog;return e||(e={phase:Math.random()*To,shed:0},t.userData.__hotdog=e),e}function ma(t,e,a,o,n,s,i,r,l,h,c){const d=new ie,p=oi();p.color.set(a),p.opacity=1;const u=new E(kt,p);u.scale.set(1.34,1,1.14),u.position.y=-Q*.008,d.add(u);const f=ai();f.color.set(e),f.opacity=1,d.add(new E(kt,f)),d.renderOrder=9,d.position.set(o,n,s);const m=h*.45,g=-8.2;t.spawnTransient(d,c,(w,b)=>{const y=n+r*b+.5*g*b*b,k=y<=Qs;if(d.position.set(o+i*b,k?Qs:y,s+l*b),k)d.rotation.y=xt(i,l),d.scale.set(m*1.5,1,h*.75);else{const M=r+g*b,v=Math.hypot(i,M,l),T=1+Math.min(.85,v*.07);d.rotation.y=xt(i,l),d.scale.set(m/T,1,h*T)}const x=1-w*w;f.opacity=x,p.opacity=x})}function kp(t,e,a,o,n,s){const i=t.direction,r=Math.hypot(i.x,i.z)>1e-4,l=r?Q*.36:0;Ls(t,e,a,t.position.x-i.x*l,t.position.y,t.position.z-i.z*l,r?xt(i.x,i.z)+Math.PI*.5:0,o,n,s,.45)}function Ls(t,e,a,o,n,s,i,r,l,h,c,d=1,p="#FFF6DC"){const u=r/ti,f=l/Ef,m=new ie;m.rotation.y=i,m.position.set(o-Math.sin(i)*r*.5,n,s-Math.cos(i)*r*.5);const g=oi();g.color.set(a),g.opacity=d;const w=new E(Hr,g);w.scale.set(1.42,1,1.02),w.position.y=-Q*.009,m.add(w);const b=ai();b.color.set(e),b.opacity=d,m.add(new E(Hr,b));const y=Tf();y.color.set(p),y.opacity=d;const k=new E(Hr,y);k.scale.set(.42,1,.985),k.position.y=Q*.006,m.add(k),t.spawnTransient(m,h,x=>{const M=1-Math.pow(1-Math.min(1,x*5.5),3);m.scale.set(f,1,Math.max(.02,u*M));const v=x<c?1:1-(x-c)/(1-c);b.opacity=d*v,g.opacity=d*v,y.opacity=d*v})}function P5(t){const e=new ie,a=new E(ei,fp);a.scale.set(1.5,1,1.07),a.position.y=-Q*.012,e.add(a),e.add(new E(ei,t===Go?L5:Sf(t)));const o=new E(kt,fp);o.scale.set(Ol*3.2,1,Q*.15),o.position.set(0,-Q*.012,Ln*.46),e.add(o);const n=new E(kt,D5);return n.scale.set(Ol*2.1,1,Q*.105),n.position.set(0,0,Ln*.47),e.add(n),e}function $5(t){const e=new ie,a=t===zh?z5:Sf(t),o=new E(kt,mp);o.scale.set(yo*1.32,1,ea*1.12),o.position.y=-Q*.012,e.add(o);const n=new E(kt,a);n.scale.set(yo,1,ea),e.add(n);const s=new E(kt,H5);s.scale.set(yo*.32,1,ea*.42),s.position.set(-yo*.2,Q*.004,ea*.16),e.add(s);const i=[];for(let l=0;l<3;l++){const h=new ie,c=1-l*.24,d=new E(kt,mp);d.scale.set(yo*.72*c*1.34,1,ea*.42*c*1.14),d.position.y=-Q*.012,h.add(d);const p=new E(kt,a);p.scale.set(yo*.72*c,1,ea*.42*c),h.add(p),h.position.z=-ea*(.7+l*.46),e.add(h),i.push(h)}const r={tail:i};return e.userData.__parts=r,e}const Mp=new Map;function Sf(t){let e=Mp.get(t);return e||(e=fo(t),Mp.set(t,e)),e}function vs(t,e,a){const o=new ie,n=new E(up,a.crust);n.scale.set(t*1.13,t*1.13,e*1.04),n.position.y=-t*.04,o.add(n);const s=new E(up,a.bun);s.scale.set(t,t,e),o.add(s);const i=new E(O5,a.crumb);i.scale.set(t*.86,1,e*.92),i.position.y=-t*.34,o.add(i);const r=new E(N5,a.seam);return r.scale.set(t*1.3,1,e*.84),r.position.y=-t*.3,o.add(r),o}const B5={Mustard:{projectile(t){const e=P5(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=vp(e);o.phase+=a/xp(t.weapon)*To*3.2,e.rotation.y=xt(t.direction.x,t.direction.z)+Math.sin(o.phase)*.16;const n=1+Math.sin(o.phase*1.7)*.13;e.scale.set(1/n,1,n),o.shed-=a,o.shed<=0&&(o.shed=.05+Math.random()*.03,ma(t,t.color,Ut,t.position.x-t.direction.x*Ln*.5,t.position.y,t.position.z-t.direction.z*Ln*.5,-t.direction.x*(.6+Math.random()*.7)+(Math.random()-.5)*.9,.25+Math.random()*.45,-t.direction.z*(.6+Math.random()*.7)+(Math.random()-.5)*.9,Q*(.12+Math.random()*.06),.26+Math.random()*.12))},impact(t){const e=_r(t.damage),a=t.direction,o=xt(a.x,a.z)+Math.PI*.5;Ls(t,t.color,Ut,t.position.x,t.position.y,t.position.z,o,Q*1.045*e,Q*.3*e,.34,.5),kp(t,Dh,Ut,Q*.46*e,Q*.2*e,.19);const{x:n,y:s,z:i}=t.position,r=Q*.3*e;for(let l=0;l<8;l++){const h=l/8*To+Math.random()*.6,c=(2.1+Math.random()*1.5)*e;ma(t,t.color,Ut,n+Math.cos(h)*r,s,i+Math.sin(h)*r,Math.cos(h)*c+t.direction.x*.7,1.7+Math.random()*1.2,Math.sin(h)*c+t.direction.z*.7,Q*(.14+Math.random()*.07)*e,.42+Math.random()*.14)}},cast(t){const e=t.direction,a=xt(e.x,e.z),o=new ie,n=oi();n.color.set(Ut),n.opacity=1;const s=new E(ei,n);s.scale.set(1.5,1,1.08),s.position.y=-Q*.012,o.add(s);const i=ai();i.color.set(t.color),i.opacity=1,o.add(new E(ei,i)),o.renderOrder=11,o.rotation.y=a;const r=t.position.x,l=t.position.z;t.spawnTransient(o,.16,h=>{const c=1-Math.pow(1-h,2);o.scale.set(.6+h*.3,1,.35+c*.85),o.position.set(r+e.x*c*Q*.16,t.position.y,l+e.z*c*Q*.16);const d=1-h;i.opacity=d,n.opacity=d});for(let h=0;h<4;h++)ma(t,t.color,Ut,t.position.x,t.position.y,t.position.z,e.x*(1.4+Math.random()*1.1)+(Math.random()-.5)*.7,.4+Math.random()*.5,e.z*(1.4+Math.random()*1.1)+(Math.random()-.5)*.7,Q*(.12+Math.random()*.05),.3)}},Ketchup:{projectile(t){const e=$5(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=vp(e);o.phase+=a/xp(t.weapon)*To*2.4,e.rotation.y=xt(t.direction.x,t.direction.z);const n=e.userData.__parts;if(n)for(let i=0;i<n.tail.length;i++){const r=n.tail[i],l=Math.sin(o.phase-(i+1)*.9);r.position.x=l*Q*.055*(i+1)*.55,r.rotation.y=l*.4}const s=1+Math.sin(o.phase*1.3)*.09;e.scale.set(s,1,1/s),o.shed-=a,o.shed<=0&&(o.shed=.09+Math.random()*.05,ma(t,t.color,Qt,t.position.x-t.direction.x*ea*1.5,t.position.y,t.position.z-t.direction.z*ea*1.5,(Math.random()-.5)*.9,.1+Math.random()*.3,(Math.random()-.5)*.9,Q*(.11+Math.random()*.05),.24+Math.random()*.1))},impact(t){const e=_r(t.damage),a=t.direction;Ls(t,t.color,Qt,t.position.x,t.position.y,t.position.z,xt(a.x,a.z)+Math.PI*.5,Q*.78*e,Q*.36*e,.3,.45),kp(t,Cl,Qt,Q*.4*e,Q*.2*e,.18),Ls(t,t.color,Qt,t.position.x+a.x*Q*.5,Qs,t.position.z+a.z*Q*.5,xt(a.x,a.z),ti*e,Ef*e,.8,.55,.95,Cl);const{x:o,y:n,z:s}=t.position,i=Q*.29*e;for(let r=0;r<6;r++){const l=r/6*To+Math.random()*.7,h=(1.8+Math.random()*1.3)*e;ma(t,t.color,Qt,o+Math.cos(l)*i,n,s+Math.sin(l)*i,Math.cos(l)*h+a.x*.6,1.5+Math.random()*1.1,Math.sin(l)*h+a.z*.6,Q*(.14+Math.random()*.07)*e,.44+Math.random()*.14)}},cast(t){const e=t.direction;for(let i=0;i<5;i++)ma(t,t.color,Qt,t.position.x,t.position.y,t.position.z,e.x*(1+Math.random()*.9)+(Math.random()-.5)*.8,.3+Math.random()*.4,e.z*(1+Math.random()*.9)+(Math.random()-.5)*.8,Q*(.13+Math.random()*.05),.3);const a=new ie,o=oi();o.color.set(Qt),o.opacity=1;const n=new E(kt,o);n.scale.set(1.3,1,1.16),n.position.y=-Q*.01,a.add(n);const s=ai();s.color.set(t.color),s.opacity=1,a.add(new E(kt,s)),a.renderOrder=11,a.rotation.y=xt(e.x,e.z),a.position.copy(t.position),t.spawnTransient(a,.15,i=>{const r=W.lerp(Q*.06,Q*.24,1-Math.pow(1-i,2));a.scale.set(r*.55,1,r),a.position.set(t.position.x+e.x*i*Q*.14,t.position.y,t.position.z+e.z*i*Q*.14),s.opacity=1-i,o.opacity=1-i})}},Slash:{impact(t){const e=_r(t.damage),a=t.direction,o=xt(a.x,a.z),{x:n,y:s,z:i}=t.position,r=Q*.175*e,l=Q*.62*e,h=Q*.375*e,c=Q*.125*e,d=new ie;d.rotation.y=o,d.position.set(n,s-Q*.06,i),d.renderOrder=10;const p=gp();p.color.set(Ns),p.opacity=1;const u=bp();u.color.set(Fl),u.opacity=1;const f=yp();f.color.set(t.color),f.opacity=1;const m=wp();m.color.set(Mn),m.opacity=1;const g={bun:p,crust:m,crumb:u,seam:f},w=vs(r,l,g),b=vs(r,l,g);d.add(w,b);const y=Tf();y.color.set("#FFF6DA"),y.opacity=0;const k=new E(kt,y);k.scale.set(Q*.075,1,l*.92),k.position.y=r*.15,k.renderOrder=12,d.add(k);let x=!1;t.spawnTransient(d,.46,v=>{const T=Math.min(1,v/.35),S=1-Math.pow(1-T,3),R=v<=.35?S:S-(v-.35)/.65*.55,F=W.lerp(h,c,W.clamp(R,0,1));w.position.x=F,b.position.x=-F;const A=W.lerp(.55,.12,W.clamp(R,0,1));w.rotation.z=A,b.rotation.z=-A,y.opacity=v<.35?0:Math.max(0,1-(v-.35)/.2);const C=v<.6?1:1-(v-.6)/.4;if(p.opacity=C,m.opacity=C,u.opacity=C,f.opacity=C,!x&&v>=.35){x=!0;const N=-Math.sin(o),L=-Math.cos(o);for(let P=0;P<6;P++){const j=P%2===0?1:-1,z=P<4,Y=(Math.random()-.5)*.8;ma(t,z?Go:zh,z?Ut:Qt,n+N*j*c*1.2,s,i+L*j*c*1.2,N*j*(2.4+Math.random()*1.6)+a.x*Y,1.6+Math.random()*1.3,L*j*(2.4+Math.random()*1.6)+a.z*Y,Q*(.15+Math.random()*.07)*e,.4+Math.random()*.14)}}});const M=Q*.24*e;for(let v=0;v<6;v++){const T=Math.random()*To,S=(1.9+Math.random()*1.6)*e,R=_5();R.color.set(v%3===0?Ns:Mn),R.opacity=1;const F=new E(F5,R);F.renderOrder=9;const A=n+Math.cos(T)*M,C=i+Math.sin(T)*M,N=Math.cos(T)*S,L=Math.sin(T)*S,P=1.7+Math.random()*1.3,j=(.8+Math.random()*.7)*e;F.scale.setScalar(j);const z=Math.random()*9-4.5,Y=Math.random()*9-4.5;t.spawnTransient(F,.42+Math.random()*.14,(O,_)=>{F.position.set(A+N*_,Math.max(Qs,s+P*_-4.6*_*_),C+L*_),F.rotation.set(z*_,Y*_,0),R.opacity=1-O*O})}},cast(t){const e=t.direction,a=xt(e.x,e.z),o=.62,n=Q*.175*o,s=Q*.62*o,i=new ie;i.rotation.y=a,i.position.copy(t.position),i.renderOrder=11;const r=gp();r.color.set(Ns),r.opacity=1;const l=bp();l.color.set(Fl),l.opacity=1;const h=yp();h.color.set(t.color),h.opacity=1;const c=wp();c.color.set(Mn),c.opacity=1;const d={bun:r,crust:c,crumb:l,seam:h},p=vs(n,s,d),u=vs(n,s,d);i.add(p,u),t.spawnTransient(i,.2,f=>{const m=1-Math.pow(1-f,2),g=W.lerp(Q*.06,Q*.2,m);p.position.x=g,u.position.x=-g,p.rotation.z=m*.6,u.rotation.z=-m*.6;const w=1-f;r.opacity=w,c.opacity=w,l.opacity=w,h.opacity=w});for(let f=0;f<3;f++)ma(t,Go,Ut,t.position.x,t.position.y,t.position.z,e.x*(1.2+Math.random())+(Math.random()-.5)*.9,.5+Math.random()*.4,e.z*(1.2+Math.random())+(Math.random()-.5)*.9,Q*(.12+Math.random()*.05),.28)}}};function Tt(t,e){const a={};for(const[o,n]of Object.entries(e))n&&(a[`${t}.${o}`]=n);return a}const q5={...Tt("hamburger",hy),...Tt("donut",Dy),...Tt("taco",t2),...Tt("burrito",H2),...Tt("egg",fx),...Tt("lollipop",Zx),...Tt("pizza",yv),...Tt("sushi",_v),...Tt("soup",u5),...Tt("waterbottle",R5),...Tt("hotdog",B5)};function mn(t,e){return q5[`${t}.${e}`]}function Jt(t){window.__vfxQaCounts??={cast:0,meleeArc:0,impact:0,death:0,heal:0,giantSlam:0,puddleSplash:0,coverScuff:0,castTelegraph:0},window.__vfxQaCounts[t]++}const xo=.5,U5=.3,Fi=.3,j5=Fi,G5=Fi+.01,ga=1.15,Pr=1.25,W5=.25,Y5=0,Ba=Fi+.02,ks=Fi+.04,V5=J,Ep=.85,Tp=.68,K5=4,X5=.7,Z5=.92,J5=7,Q5=.55,Sp=.6,Ap=.32,$r=new Kt("#F2F6FF"),ek=new Kt("#63A8E0"),tk=J*.62,ak=J*.66,ok=J*.62,nk=.58,sk="#EAF4FF",ik="#1D2740",Rp=18,bn=.8,Br=3,Ip=["#F5475E","#F5C147","#47C4F5","#6BE05A","#B36BF5","#F58A47"],Cp="#EF5B2E",rk=.62,lk=.28,Fp=.85,hk=.9,ck=1.15,dk=1.45,pk=2,Op=.3,pt=new Kt("#ffffff"),uk=new Kt("#241a33"),Np=new Kt("#FFE79A"),qr=vm.clone().normalize(),fk=.38,mk=.45,gk=.995;function Af(t){if(t.userData.__fxShaded)return!1;const e=t.getAttribute("position");if(!e)return t.userData.__fxShaded=!0,!1;const a=t.getAttribute("normal"),o=e.count,n=new Float32Array(o*3);let s=!0;if(a&&a.count===o){let u=0,f=0,m=0;for(let g=0;g<o;g++)u+=a.getX(g),f+=a.getY(g),m+=a.getZ(g);s=Math.hypot(u/o,f/o,m/o)>=gk}t.computeBoundingSphere();const i=t.boundingSphere,r=i?i.center.x:0,l=i?i.center.y:0,h=i?i.center.z:0,c=Math.max(i?i.radius:1,1e-6);let d=0;for(let u=0;u<o;u++){const f=Math.min(1,Math.hypot(e.getX(u)-r,e.getY(u)-l,e.getZ(u)-h)/c),m=1-mk*f*f,g=s?1:1+fk*(a.getX(u)*qr.x+a.getY(u)*qr.y+a.getZ(u)*qr.z),w=Math.max(0,g*m);n[u*3]=w,d+=w}const p=d>1e-9?o/d:1;for(let u=0;u<o;u++){const f=n[u*3]*p;n[u*3]=f,n[u*3+1]=f,n[u*3+2]=f}return t.setAttribute("color",new En(n,3)),t.userData.__fxShaded=!0,!0}function wk(t){const e=t;return e.vertexColors||e.map?!1:(e.vertexColors=!0,e.needsUpdate=!0,!0)}const bk=.62,yk=.3,Lp=new WeakMap;function Dp(t){const e=t;if(!t.isMeshBasicMaterial||e.transparent||e.blending!==Mm||e.map)return null;const a=Lp.get(t);if(a)return a;const o=Ve({color:e.color.clone(),roughness:yk,metalness:0,doubleSide:e.side===me,emissive:e.color.clone().multiplyScalar(bk)});return o.depthWrite=e.depthWrite,o.depthTest=e.depthTest,o.vertexColors=e.vertexColors,Lp.set(t,o),o}function zp(t){t.traverse(e=>{const a=e;if(!a.isMesh||a.isSprite)return;if(Array.isArray(a.material)){const n=a.material.map(s=>Dp(s)??s);a.material=n;return}const o=Dp(a.material);o&&(a.material=o)})}function Rf(t){t.traverse(e=>{const a=e;if(!a.isMesh)return;const o=Array.isArray(a.material)?a.material:[a.material];o.some(n=>n&&!n.map)&&Af(a.geometry);for(const n of o)n&&wk(n)})}const Hp=.55,xk=.34,vk=.72,kk=1,Mk=.34,Ek=1.1,Tk=J*.85,Sk=.8,Ak=12,Rk=2,Ur=.05,wa={scopes:0,inert:0,members:0,mats:0,opaqueSkipped:0,cores:0,coresStarved:0,aliasTouches:0};function Ik(t){const e=[],a=new Set;return t.traverse(o=>{const s=o.material;if(!s)return;const i=Array.isArray(s)?s:[s];for(const r of i)if(r){if(!r.transparent){wa.opaqueSkipped++;continue}a.has(r.uuid)||(a.add(r.uuid),e.push(r))}}),wa.mats+=e.length,{mats:e}}function Ck(t,e){let a=0;e.set(0,0,0);const o=(n,s,i,r)=>{const l=s+n.position.x,h=i+n.position.y,c=r+n.position.z;if(!n.visible)return;const d=n;(d.isMesh||d.isSprite)&&(e.x+=l,e.y+=h,e.z+=c,a++);for(const p of n.children)o(p,l,h,c)};return o(t,0,0,0),a===0?!1:(e.multiplyScalar(1/a),!0)}function Ms(t,e,a,o,n){const s=new Set;for(const i of a){s.add(i.id);let r=t.get(i.id);r||(r=o(i),Rf(r),e.add(r),t.set(i.id,r)),n(r,i)}for(const[i,r]of t)s.has(i)||(e.remove(r),t.delete(i))}function Fk(t){return t.depthWrite=!1,t}const _p=t=>1-Math.pow(1-t,3);function Pp(t){const e=Math.sin(t*12.9898)*43758.5453;return(e-Math.floor(e))*Math.PI*2}function jr(t,e){const a=Math.hypot(t,e);return a>1e-6?{x:t/a,y:e/a}:{x:0,y:0}}function Ok(){const e=document.createElement("canvas");e.width=64,e.height=64;const a=e.getContext("2d"),o=a.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);o.addColorStop(0,"rgba(255,255,255,1)"),o.addColorStop(.4,"rgba(255,255,255,0.85)"),o.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=o,a.fillRect(0,0,64,64);const n=new et(e);return n.needsUpdate=!0,n}function Nk(){const e=document.createElement("canvas");e.width=64,e.height=64;const a=e.getContext("2d"),o=a.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);o.addColorStop(0,"rgba(255,255,255,1)"),o.addColorStop(.14,"rgba(255,255,255,0.85)"),o.addColorStop(.32,"rgba(255,255,255,0.45)"),o.addColorStop(.55,"rgba(255,255,255,0.18)"),o.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=o,a.fillRect(0,0,64,64);const n=new et(e);return n.needsUpdate=!0,n}function Lk(){const e=document.createElement("canvas");e.width=64,e.height=64;const a=e.getContext("2d"),o=a.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);o.addColorStop(0,"rgba(255,255,255,1)"),o.addColorStop(.62,"rgba(255,255,255,1)"),o.addColorStop(.82,"rgba(255,255,255,0.6)"),o.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=o,a.fillRect(0,0,64,64);const n=new et(e);return n.needsUpdate=!0,n}function Dk(){const a=document.createElement("canvas");a.width=128,a.height=128;const o=a.getContext("2d"),n=o.createRadialGradient(64,64,0,64,64,128*.16);n.addColorStop(0,"rgba(255,255,255,1)"),n.addColorStop(.6,"rgba(255,255,255,0.85)"),n.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=n,o.fillRect(0,0,128,128);const s=8;for(let r=0;r<s;r++){const l=r%2===0,h=128*(l?.48:.26),c=128*(l?.045:.028),d=r/s*Math.PI*2;o.save(),o.translate(64,64),o.rotate(d);const p=o.createLinearGradient(0,0,h,0);p.addColorStop(0,"rgba(255,255,255,1)"),p.addColorStop(.7,"rgba(255,255,255,0.8)"),p.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=p,o.beginPath(),o.moveTo(0,-c),o.lineTo(h,0),o.lineTo(0,c),o.closePath(),o.fill(),o.restore()}const i=new et(a);return i.needsUpdate=!0,i}function zk(){const a=document.createElement("canvas");a.width=128,a.height=32;const o=a.getContext("2d"),n=o.createLinearGradient(0,0,128,0);n.addColorStop(0,"rgba(255,255,255,0)"),n.addColorStop(.5,"rgba(255,255,255,1)"),n.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=n,o.fillRect(0,0,128,32),o.globalCompositeOperation="destination-in";const s=o.createLinearGradient(0,0,0,32);s.addColorStop(0,"rgba(255,255,255,0)"),s.addColorStop(.5,"rgba(255,255,255,1)"),s.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=s,o.fillRect(0,0,128,32),o.globalCompositeOperation="source-over";const i=new et(a);return i.needsUpdate=!0,i}function Hk(){const a=document.createElement("canvas");a.width=8,a.height=64;const o=a.getContext("2d"),n=o.createLinearGradient(0,0,0,64);n.addColorStop(0,"rgba(255,255,255,0.1)"),n.addColorStop(.55,"rgba(255,255,255,0.55)"),n.addColorStop(.86,"rgba(255,255,255,0.85)"),n.addColorStop(.94,"rgba(255,255,255,1)"),n.addColorStop(1,"rgba(255,255,255,0.65)"),o.fillStyle=n,o.fillRect(0,0,8,64);const s=new et(a);return s.flipY=!1,s.needsUpdate=!0,s}function _k(){const a=document.createElement("canvas");a.width=8,a.height=128;const o=a.getContext("2d"),n=o.createLinearGradient(0,0,0,128);n.addColorStop(0,"rgba(255,255,255,0)"),n.addColorStop(.78,"rgba(255,255,255,0)"),n.addColorStop(.88,"rgba(255,255,255,0.85)"),n.addColorStop(.94,"rgba(255,255,255,1)"),n.addColorStop(1,"rgba(255,255,255,0.75)"),o.fillStyle=n,o.fillRect(0,0,8,128);const s=new et(a);return s.flipY=!1,s.needsUpdate=!0,s}function ni(t){const e=t.replace("#","");return[parseInt(e.slice(0,2),16),parseInt(e.slice(2,4),16),parseInt(e.slice(4,6),16)]}const si=t=>t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4),Pk=t=>t<=.0031308?t*12.92:1.055*Math.pow(t,1/2.4)-.055,$k=42,Bk=.7,$p=.66;function _h(t){const[e,a,o]=ni(t).map(y=>y/255),n=Math.max(e,a,o),s=Math.min(e,a,o),i=(n+s)/2,r=n-s,l=r===0?0:r/(1-Math.abs(2*i-1));let h=0;r!==0&&(n===e?h=60*((a-o)/r%6):n===a?h=60*((o-e)/r+2):h=60*((e-a)/r+4)),h<0&&(h+=360);let c=$k-h;c>180&&(c-=360),c<-180&&(c+=360);const d=(h+c*Bk+360)%360,p=(1-Math.abs(2*$p-1))*l,u=p*(1-Math.abs(d/60%2-1)),f=$p-p/2,m=Math.floor(d/60)%6,w=[[p,u,0],[u,p,0],[0,p,u],[0,u,p],[u,0,p],[p,0,u]][m].map((y,k)=>Math.max(y+f,[e,a,o][k])),b=y=>Math.round(Math.min(1,y)*255).toString(16).padStart(2,"0");return`#${b(w[0])}${b(w[1])}${b(w[2])}`}function Bp(t,e){const a=/rgb\((\d+),(\d+),(\d+)\)/.exec(Ga(t,e)),o=ni(_h(t)).map(s=>si(s/255)),n=[1,2,3].map(s=>si(Number(a[s])/255));return .2126*o[0]*n[0]+.7152*o[1]*n[1]+.0722*o[2]*n[2]}const qp="#F5475E";function vo(t,e){if(t===qp)return e;const a=Bp(qp,e);let o=0,n=2;for(let s=0;s<28;s++){const i=(o+n)/2;Bp(t,i)<a?o=i:n=i}return(o+n)/2}function Ga(t,e){const a=ni(t).map(r=>si(r/255)),o=ni(_h(t)).map(r=>si(r/255)),n=a.map((r,l)=>r/Math.max(1e-6,o[l])),s=Math.max(0,Math.min(1,e-1)),i=n.map(r=>Math.round(255*Pk(e<=1?r*Math.max(0,e):r+(1-r)*s)));return`rgb(${i[0]},${i[1]},${i[2]})`}function qk(t,e){const n=document.createElement("canvas");n.width=128,n.height=128;const s=n.getContext("2d"),i=document.createElement("canvas");i.width=128,i.height=128;const r=i.getContext("2d"),l=v=>{const T=Math.round(255*v);return`rgb(${T},${T},${T})`},h=1.9*t,c=3.3*t+.7,d=v=>64*(bn+.13*Math.sin(v*3+h)+.06*Math.sin(v*5+c)),p=v=>{v.beginPath();const T=96;for(let S=0;S<=T;S++){const R=S/T*Math.PI*2,F=d(R),A=64+Math.cos(R)*F,C=64+Math.sin(R)*F;S===0?v.moveTo(A,C):v.lineTo(A,C)}v.closePath()},u=()=>p(s);u();const f=s.createLinearGradient(128*.18,128*.12,128*.86,128*.92);f.addColorStop(0,Ga(e,vo(e,dk))),f.addColorStop(.5,Ga(e,vo(e,ck))),f.addColorStop(1,Ga(e,vo(e,hk))),s.fillStyle=f,s.fill(),p(r),r.fillStyle=l(rk),r.fill(),s.save(),u(),s.clip(),r.save(),p(r),r.clip();const m=.45,g=1/Math.sqrt(.5+.5*m*m),w=(v,T,S,R,F)=>{const A=64+v*128,C=64+T*128,N=S*128*g,L=(z,Y)=>{const O=z.createRadialGradient(A,C,0,A,C,N),_=H=>`rgba(${Y[0]},${Y[1]},${Y[2]},${H})`;O.addColorStop(0,_(1)),O.addColorStop(m,_(1)),O.addColorStop(1,_(0)),z.fillStyle=O,z.beginPath(),z.arc(A,C,N,0,Math.PI*2),z.fill()},P=/rgb\((\d+),(\d+),(\d+)\)/.exec(R);L(s,[Number(P[1]),Number(P[2]),Number(P[3])]);const j=Math.round(255*F);L(r,[j,j,j])},b=t*1.7;for(let v=0;v<7;v++){const T=b+v*2.399963,S=.075+.215*Math.sqrt((v+.55)/7),R=.08-.005*v,F=pk-.055*v;w(Math.cos(T)*S,Math.sin(T)*S,R,Ga(e,vo(e,F)),lk)}w(-.06+.05*t,.2,.075,Ga(e,vo(e,Op)),Fp),w(.2-.04*t,-.17,.055,Ga(e,vo(e,Op*.85)),Fp),s.restore(),r.restore();const y=s.getImageData(0,0,128,128),k=y.data,x=r.getImageData(0,0,128,128).data;for(let v=0;v<k.length;v+=4){const T=k[v+3];if(T===0){k[v]=0,k[v+1]=0,k[v+2]=0;continue}const S=T/255;k[v]=Math.round(k[v]*S),k[v+1]=Math.round(k[v+1]*S),k[v+2]=Math.round(k[v+2]*S),k[v+3]=Math.round(x[v]*S)}s.putImageData(y,0,0);const M=new et(n);return M.colorSpace=ri,M.needsUpdate=!0,M}const Uk=.26,jk=2.4,Gk=1.65,Up=.36,Wk=.64,Yk=.66,Vk=.4,Kk=.78,Xk=1.25,Zk=6;function Jk(){const e=document.createElement("canvas");e.width=128,e.height=128;const a=e.getContext("2d"),o=a.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);o.addColorStop(0,"rgba(255,255,255,0.22)"),o.addColorStop(.44,"rgba(255,255,255,0.34)"),o.addColorStop(.62,"rgba(255,255,255,0.78)"),o.addColorStop(.82,"rgba(255,255,255,0.90)"),o.addColorStop(.88,"rgba(70,70,70,0.86)"),o.addColorStop(.96,"rgba(48,48,48,0.55)"),o.addColorStop(1,"rgba(40,40,40,0)"),a.fillStyle=o,a.fillRect(0,0,128,128);const n=new et(e);return n.needsUpdate=!0,n}function Qk(t){const e=/^#?([0-9a-f]{6})$/i.exec(t.trim());if(!e)return t;const a=parseInt(e[1],16),o=(a>>16&255)/255,n=(a>>8&255)/255,s=(a&255)/255,i=Math.max(o,n,s),r=Math.min(o,n,s),l=i-r;let h=0;l>1e-6&&(i===o?h=(n-s)/l%6:i===n?h=(s-o)/l+2:h=(o-n)/l+4,h*=60,h<0&&(h+=360));const c=(i+r)/2,d=l<1e-6?0:l/(1-Math.abs(2*c-1)),p=c>=Kk?Vk:Math.max(c,Yk),u=Math.min(1,d*Xk),f=(1-Math.abs(2*p-1))*u,m=f*(1-Math.abs(h/60%2-1)),g=p-f/2;let w=0,b=0,y=0;h<60?(w=f,b=m):h<120?(w=m,b=f):h<180?(b=f,y=m):h<240?(b=m,y=f):h<300?(w=m,y=f):(w=f,y=m);const k=x=>Math.round((x+g)*255).toString(16).padStart(2,"0");return`#${k(w)}${k(b)}${k(y)}`}function e4(){const e=document.createElement("canvas");e.width=64,e.height=64;const a=e.getContext("2d"),o=[[.5,.02],[.78,.32],[.68,.98],[.32,.98],[.22,.32],[.5,.02]];a.beginPath(),o.forEach(([i,r],l)=>{const h=i*64,c=r*64;l===0?a.moveTo(h,c):a.lineTo(h,c)}),a.closePath();const n=a.createLinearGradient(64*.3,0,64*.6,64);n.addColorStop(0,"rgba(255,255,255,1)"),n.addColorStop(.45,"rgba(255,255,255,0.85)"),n.addColorStop(1,"rgba(255,255,255,0.55)"),a.fillStyle=n,a.fill(),a.beginPath(),a.moveTo(64*.5,64*.05),a.lineTo(64*.62,64*.34),a.lineTo(64*.5,64*.5),a.lineTo(64*.4,64*.3),a.closePath(),a.fillStyle="rgba(255,255,255,0.9)",a.fill();const s=new et(e);return s.needsUpdate=!0,s}function t4(t,e,a,o){const n=[],s=[],i=Math.PI*2/a,r=i*o,l=6;let h=0;for(let d=0;d<a;d++){const p=d*i;for(let u=0;u<=l;u++){const f=p+u/l*r;n.push(Math.sin(f)*t,0,Math.cos(f)*t),n.push(Math.sin(f)*e,0,Math.cos(f)*e)}for(let u=0;u<l;u++){const f=h+u*2;s.push(f,f+1,f+2,f+1,f+3,f+2)}h+=(l+1)*2}const c=new Dn;return c.setAttribute("position",new _s(n,3)),c.setIndex(s),c.computeVertexNormals(),c}function Gr(t,e){const a=W.degToRad(W.clamp(e,1,360))/2,o=Math.max(8,Math.round(e/8)),n=[0,0,0],s=[.5,0];for(let l=0;l<=o;l++){const h=-a+l/o*a*2;n.push(Math.sin(h)*t,0,Math.cos(h)*t),s.push(l/o,1)}const i=[];for(let l=1;l<o+1;l++)i.push(0,l,l+1);const r=new Dn;return r.setAttribute("position",new _s(n,3)),r.setAttribute("uv",new _s(s,2)),r.setIndex(i),r.computeVertexNormals(),r}function a4(t,e=8,a=.45){const o=e*2,n=[0,0,0];for(let r=0;r<=o;r++){const l=r/o*Math.PI*2,h=r%2===0?t:t*a;n.push(Math.sin(l)*h,0,Math.cos(l)*h)}const s=[];for(let r=1;r<o+1;r++)s.push(0,r,r+1);const i=new Dn;return i.setAttribute("position",new _s(n,3)),i.setIndex(s),i.computeVertexNormals(),i}const o4=96,n4=10,s4=16,jp=.09,Gp=.2;function Wp(t,e,a){const o=t.clone().convertLinearToSRGB(),n=e.clone().convertLinearToSRGB();return o.lerp(n,a).convertSRGBToLinear()}function i4(t,e){return t.clone().convertLinearToSRGB().multiplyScalar(e).convertSRGBToLinear()}function Wr(t){t.traverse(e=>{const a=e.material;if(a)for(const o of Array.isArray(a)?a:[a])o.userData?.__ownMat&&o.dispose()})}class r4{group=new ie;projectilePool=new Map;shellPool=new Map;splatPool=new Map;trailPool=new Map;materialCache=new Map;transientEffects=[];unionScopes=[];pendingUnion=null;unionCores=[];unionMemberState=new WeakMap;unionMatState=new WeakMap;unionFrame=0;unionPointScratch=new de;unionCentreScratch=new de;unionDistScratch=[];unionSortScratch=[];castTelegraphs=new Map;lastSyncElapsedMs=0;projectileGeo=new st(Je(10),10,8);splatGeo=new to(2*Je(al)/bn,2*Je(al)/bn);trailGeo=new to(2*Je(It.radius)/bn,2*Je(It.radius)/bn);glazeTexByColor=new Map;glazeTexFor(e){let a=this.glazeTexByColor.get(e);return a||(a=Array.from({length:Br},(o,n)=>qk(n,e)),this.glazeTexByColor.set(e,a)),a}haloTex=Jk();haloMats=new Map;shellBox=new Tn;shellSize=new de;splatMats=this.glazeTexFor(Cp).map(e=>this.groundMarkMat(Cp,e));trailMats=[];trailMatsFor(e){let a=this.trailMats[e];if(!a){const o=Ip[e]??Ip[0];a=this.glazeTexFor(o).map(n=>this.groundMarkMat(o,n)),this.trailMats[e]=a}return a}groundMarkMat(e,a){const o=Fk(km(_h(e),{transparent:!0,opacity:1}));return o.userData.markColor=e,o.map=a,o.blending=r0,o.blendEquation=Ds,o.blendSrc=el,o.blendDst=Zh,o.blendEquationAlpha=Ds,o.blendSrcAlpha=el,o.blendDstAlpha=Zh,o.needsUpdate=!0,o}glowTex=Ok();coreTex=Nk();softDiscTex=Lk();starTex=Dk();streakTex=zk();shardTex=e4();wedgeGradientTex=Hk();telegraphRimTex=_k();particles=[];wedges=[];rings=[];wedgeGeoCache=new Map;ringUnitGeo=new Ma(.62,1,40);wardGeo=t4(X5,Z5,J5,Q5);statusBySlot=[];buildStatusVisual;ensureSlots(e){for(;this.statusBySlot.length<e;)this.statusBySlot.push(this.buildStatusVisual()),this.slowSplashState.push({lastX:NaN,lastY:NaN,distAccum:0}),this.statusSnapshot.push({x:NaN,y:NaN,stunReady:!0,slowReady:!0})}slowSplashState=[];statusSnapshot=[];constructor(e){this.group.name="vfx_layer",e.add(this.group);for(let o=0;o<o4;o++){const n=new Ct({map:this.glowTex,color:16777215,transparent:!0,opacity:0,depthWrite:!1,blending:Qe}),s=new ba(n);s.visible=!1,s.renderOrder=10,this.group.add(s),this.particles.push({sprite:s,mat:n,active:!1,life:0,maxLife:1,vx:0,vy:0,vz:0,gravity:0,startScale:1,endScale:1,startOpacity:1,endOpacity:0,fadeEase:1,aspect:1})}for(let o=0;o<Ak;o++){const n=new Ct({map:this.coreTex,color:16777215,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1,blending:Qe}),s=new ba(n);s.name="vfx_union_core",s.visible=!1,s.renderOrder=9,this.group.add(s),this.unionCores.push({sprite:s,mat:n,busy:!1})}for(let o=0;o<n4;o++){const n=new V({color:16777215,map:this.wedgeGradientTex,transparent:!0,opacity:0,side:me,depthWrite:!1}),s=new E(Gr(.01,10),n);s.visible=!1,s.renderOrder=5,this.group.add(s),this.wedges.push({mesh:s,mat:n,active:!1,life:0,maxLife:1,startOpacity:.6})}for(let o=0;o<s4;o++){const n=new V({color:16777215,transparent:!0,opacity:0,side:me,depthWrite:!1,blending:Qe}),s=new E(this.ringUnitGeo,n);s.rotation.x=-Math.PI/2,s.visible=!1,s.renderOrder=6,this.group.add(s),this.rings.push({mesh:s,mat:n,active:!1,life:0,maxLife:1,startScale:.1,targetScale:1,startOpacity:.9})}const a=()=>{const o=new V({color:ik,transparent:!0,opacity:0,side:me,depthWrite:!1}),n=new E(new Ma(.55,.95,28),o);n.rotation.x=-Math.PI/2,n.visible=!1,n.renderOrder=3,this.group.add(n);const s=new V({color:sk,transparent:!0,opacity:0,side:me,depthWrite:!1}),i=new E(new Ma(.64,.86,28),s);i.rotation.x=-Math.PI/2,i.visible=!1,i.renderOrder=4,this.group.add(i);const r=new Ct({map:this.softDiscTex,color:ek,transparent:!0,opacity:0,depthTest:!1,depthWrite:!1}),l=new ba(r);l.scale.set(tk,ak,1),l.visible=!1,l.renderOrder=8,this.group.add(l);const h=[];for(let p=0;p<K5;p++){const u=new Ct({map:this.starTex,color:"#FFE75E",transparent:!0,opacity:0,depthWrite:!1,blending:Qe}),f=new ba(u);f.scale.set(Tp,Tp,1),f.visible=!1,f.renderOrder=11,this.group.add(f),h.push(f)}const c=new V({color:$r,transparent:!0,opacity:0,side:me,depthWrite:!1}),d=new E(this.wardGeo,c);return d.visible=!1,d.renderOrder=2,this.group.add(d),{slowRing:i,slowRingDark:n,slowTint:l,stunStars:h,wardRing:d,wardMat:c,wardPop:0,wardPopColor:new Kt($r)}};this.buildStatusVisual=a,this.ensureSlots(2),window.__vfxSpawnTest=(o,n,s,i=14,r="#FFC93C",l,h,c)=>{const d=l??"hamburger",p=h?re[d]?.weapons?.find(u=>u.key===h):void 0;if(o==="impact")this.spawnImpactBurst(n,s,r,i,p?{weapon:p,characterId:d,fromXWU:n-60,fromYWU:s}:void 0);else if(o==="death")this.spawnDeathBurst(n,s,r);else if(o==="heal")this.spawnHealPulse(n,s);else if(o==="puddleSplash"){const u=Le(n,s);this.spawnPuddleSplash(u.x,u.z)}else if(o==="meleeArc")this.spawnMeleeArc(n,s,{x:1,y:0},p?.range??70,p?.cone??80,p?.color??r);else if(o==="giantSlam")this.spawnGiantSlamShockwave(n,s,p?.color??r,p?.range??Wa.ultimateSlam);else if(o==="coverScuff")this.spawnCoverScuff(n,s,p?.color??r,1,0);else if(o==="castTelegraph"){const u=p??{key:"qa",name:"qa",type:"melee",range:84,cone:100,damage:i,cooldown:1,color:r,effect:null},f=c??u.castMs??1100;this.spawnCastTelegraph(0,n,s,{x:1,y:0},u,d,f)}else if(o==="weaponFired"){const u=p??{key:"qa",name:"qa",type:"ranged",range:100,damage:i,cooldown:1,color:r,effect:null};this.spawnWeaponCast(n,s,{x:1,y:0},u,d)}else{const u=p??{key:"qa",name:"qa",type:"ranged",range:100,damage:i,cooldown:1,color:r,effect:null};this.spawnCastFlash(n,s,{x:1,y:0},u,d)}},window.__vfxLayer=this}sync(e){const a=_e(e);this.ensureSlots(a.length);const o=s=>({x:s.x,y:s.y,hp:s.hp,alive:s.alive,terrainSlowFactor:s.terrainSlowFactor});window.__vfxDebugFighters={player:o(a[0]),enemy:o(a[1]??a[0]),slots:a.map(o)};const n=Math.max(0,(e.elapsed-this.lastSyncElapsedMs)/1e3);this.lastSyncElapsedMs=e.elapsed,Ms(this.projectilePool,this.group,e.projectiles,s=>{const i=gt(e,s.ownerId,s.ownerRole),r=mn(i.characterId,s.weapon.key);if(r?.projectile){const h=Le(s.x,s.y),c=jr(s.vx,s.vy),d={THREE:an,position:new de(h.x,xo,h.z),direction:new de(c.x,0,c.y),color:s.color,damage:s.damage,weapon:s.weapon,characterId:i.characterId,spawnTransient:(u,f,m)=>this.spawnTransientObject(u,f,m)},p=r.projectile(d);return zp(p),p.userData.weaponVfx=r,p.name=`projectile:${i.characterId}.${s.weapon.key}`,this.measureShell(p),p}const l=new E(this.projectileGeo,this.materialFor(s.color));return l.name=`projectile:${i.characterId}.${s.weapon.key}`,this.measureShell(l),l},(s,i)=>{const r=gt(e,i.ownerId,i.ownerRole),l=s.userData.weaponVfx,h=Le(i.x,i.y),c=s.userData.shellSpec?.scale??1;if(!l){const u=s;if(u.material=this.materialFor(i.color),i.arrived){const f=(i.peckTimer??0)/500,m=1+Math.sin(f*Math.PI)*.5;u.scale.setScalar(m*c)}else u.scale.setScalar(c);u.position.set(h.x,xo,h.z);return}s.position.set(h.x,xo,h.z);const d=jr(i.vx,i.vy);(d.x!==0||d.y!==0)&&(s.rotation.y=Math.atan2(d.x,d.y));const p=s.userData.__authoredScale??=s.scale.clone();if(s.scale.copy(p),l.trail){const u={THREE:an,position:s.position.clone(),direction:new de(d.x,0,d.y),color:i.color,damage:i.damage,weapon:i.weapon,characterId:r.characterId,spawnTransient:(f,m,g)=>this.spawnTransientObject(f,m,g),object:s,dt:n};l.trail(u)}p.copy(s.scale),s.scale.multiplyScalar(c)}),Ms(this.shellPool,this.group,e.projectiles,s=>{const r=`${gt(e,s.ownerId,s.ownerRole).characterId}.${s.weapon.key}`,h=this.projectilePool.get(s.id)?.userData.shellSpec?.haloR??Up,c=new ie;c.name=`projectile_shell:${r}`;let d=this.haloMats.get(s.color);d||(d=new Ct({map:this.haloTex,color:new Kt(Qk(s.color)),transparent:!0,opacity:1,depthWrite:!1}),this.haloMats.set(s.color,d));const p=new ba(d);return p.name=`projectile_halo:${r}`,p.scale.set(h*2,h*2,1),p.renderOrder=Zk,c.add(p),c},(s,i)=>{const r=Le(i.x,i.y);s.position.set(r.x,xo,r.z)}),Ms(this.splatPool,this.group,e.splats,s=>{const i=new E(this.splatGeo,this.splatMats[s.id%Br]);return i.name="vfx_ground_mark",i.rotation.set(-Math.PI/2,0,Pp(s.id)),i},(s,i)=>{const r=Le(i.x,i.y);s.position.set(r.x,j5,r.z)}),Ms(this.trailPool,this.group,e.trailMarks,s=>{const i=new E(this.trailGeo,this.trailMatsFor(aa(s.ownerId,s.ownerRole))[s.id%Br]);return i.name="vfx_ground_mark",i.rotation.set(-Math.PI/2,0,Pp(s.id)),i},(s,i)=>{const r=Le(i.x,i.y),l=(e.elapsed+i.id*137)*.004,h=1+Math.sin(l)*.08;s.position.set(r.x,G5,r.z),s.scale.setScalar(h)}),a.forEach((s,i)=>{const r=this.statusBySlot[i];if(!r)return;const l=Le(s.x,s.y),h=s.alive&&s.terrainSlowFactor<1,c=s.alive&&e.elapsed<s.status.slowedUntil,d=h||c;if(r.slowRing.visible=d,r.slowRingDark.visible=d,r.slowTint.visible=d,d){const k=.9+Math.sin(e.elapsed*.0035)*.12,x=e.elapsed*.0012;r.slowRingDark.position.set(l.x,ks-.01,l.z),r.slowRingDark.scale.setScalar(k),r.slowRingDark.rotation.z=x,r.slowRingDark.material.opacity=.5,r.slowRing.position.set(l.x,ks,l.z),r.slowRing.scale.setScalar(k),r.slowRing.rotation.z=x,r.slowRing.material.opacity=.9,r.slowTint.position.set(l.x,ok,l.z);const M=nk+Math.sin(e.elapsed*.006)*.08;r.slowTint.material.opacity=M}const p=this.slowSplashState[i];if(h){if(Number.isFinite(p.lastX))for(p.distAccum+=Math.hypot(s.x-p.lastX,s.y-p.lastY);p.distAccum>=Rp;)p.distAccum-=Rp,this.spawnPuddleSplash(l.x,l.z)}else p.distAccum=0;p.lastX=s.x,p.lastY=s.y;const u=e.elapsed>=Gs(s,"stun"),f=e.elapsed>=Gs(s,"slow");this.statusSnapshot[i]={x:s.x,y:s.y,stunReady:u,slowReady:f};const m=s.alive&&!u&&e.elapsed>=s.status.stunnedUntil,g=s.alive&&!f&&e.elapsed>=s.status.slowedUntil,w=m||g,b=r.wardPop>0?r.wardPop/Ap:0;r.wardRing.visible=w||b>0,r.wardRing.visible&&(r.wardRing.position.set(l.x,ks-.02,l.z),r.wardRing.rotation.y=-e.elapsed*.0019,r.wardRing.scale.setScalar(1+.5*b),r.wardMat.opacity=w?Sp+(1-Sp)*b:b,r.wardMat.color.copy($r).lerp(r.wardPopColor,b));const y=s.alive&&e.elapsed<s.status.stunnedUntil;r.stunStars.forEach((k,x)=>{if(k.visible=y,!y)return;const M=e.elapsed*.006+x*Math.PI*2/r.stunStars.length;k.position.set(l.x+Math.cos(M)*Ep,V5+Math.sin(e.elapsed*.01+x)*.05,l.z+Math.sin(M)*Ep),k.material.opacity=.95})})}updateEffects(e){for(const a of this.particles){if(!a.active)continue;if(a.life+=e,a.life>=a.maxLife){a.active=!1,a.sprite.visible=!1;continue}const o=a.life/a.maxLife;a.vy+=a.gravity*e,a.sprite.position.x+=a.vx*e,a.sprite.position.y+=a.vy*e,a.sprite.position.z+=a.vz*e;const n=W.lerp(a.startScale,a.endScale,_p(o));a.sprite.scale.set(n,n*a.aspect,1),a.mat.opacity=Math.max(0,W.lerp(a.startOpacity,a.endOpacity,Math.pow(o,a.fadeEase)))}for(const a of this.wedges){if(!a.active)continue;if(a.life+=e,a.life>=a.maxLife){a.active=!1,a.mesh.visible=!1;continue}const o=a.life/a.maxLife;a.mat.opacity=a.startOpacity*(1-Math.pow(o,1.8))}for(const a of this.rings){if(!a.active)continue;if(a.life+=e,a.life>=a.maxLife){a.active=!1,a.mesh.visible=!1;continue}const o=a.life/a.maxLife,n=W.lerp(a.startScale,a.targetScale,_p(o));a.mesh.scale.set(n,n,n),a.mat.opacity=a.startOpacity*(1-o)}for(const a of this.statusBySlot)a.wardPop>0&&(a.wardPop=Math.max(0,a.wardPop-e));for(let a=this.transientEffects.length-1;a>=0;a--){const o=this.transientEffects[a];if(o.life+=e,o.life>=o.maxLife){this.group.remove(o.object),Wr(o.object),o.telegraphOwner!==void 0&&this.castTelegraphs.get(o.telegraphOwner)===o.object&&this.castTelegraphs.delete(o.telegraphOwner),this.detachUnionMember(o),this.transientEffects.splice(a,1);continue}o.onUpdate?.(o.life/o.maxLife,o.life)}this.updateUnionScopes(e)}spawnTransientObject(e,a,o,n){Rf(e),zp(e),this.group.add(e);const s=this.pendingUnion;s&&(s.members.push(e),this.unionMemberState.set(e,Ik(e)),s.maxLife=Math.max(s.maxLife,Math.max(.001,a)),wa.members++),this.transientEffects.push({object:e,life:0,maxLife:Math.max(.001,a),onUpdate:o,telegraphOwner:n,union:s??void 0})}openUnionScope(e,a){this.pendingUnion={cx:e.x,cy:ga,cz:e.z,members:[],life:0,maxLife:0,core:null,color:a}}closeUnionScope(){const e=this.pendingUnion;if(this.pendingUnion=null,!e)return;if(wa.scopes++,e.members.length<Rk){wa.inert++;return}const a=this.unionCores.find(o=>!o.busy)??null;a?(a.busy=!0,a.sprite.visible=!0,a.sprite.position.set(e.cx,e.cy,e.cz),a.sprite.scale.set(Ur,Ur,1),a.mat.color.set(e.color).lerp(pt,vk),a.mat.opacity=0,e.core=a,wa.cores++):wa.coresStarved++,this.unionScopes.push(e)}detachUnionMember(e){if(!e.union)return;const a=e.union.members.indexOf(e.object);a>=0&&e.union.members.splice(a,1)}releaseUnionCore(e){e.core&&(e.core.busy=!1,e.core.sprite.visible=!1,e.core.mat.opacity=0,e.core=null)}updateUnionScopes(e){this.unionFrame++;for(let a=this.unionScopes.length-1;a>=0;a--){const o=this.unionScopes[a];if(o.life+=e,o.members.length===0||o.life>=o.maxLife){this.releaseUnionCore(o),this.unionScopes.splice(a,1);continue}const n=this.unionDistScratch;n.length=0;for(const p of o.members){if(!Ck(p,this.unionPointScratch)){n.push(-1);continue}n.push(this.unionPointScratch.distanceTo(this.unionCentreScratch.set(o.cx,o.cy,o.cz)))}const s=this.unionSortScratch;s.length=0;for(const p of n)p>=0&&s.push(p);if(s.length===0)continue;s.sort((p,u)=>p-u);const i=s[Math.min(s.length-1,Math.floor(s.length*Sk))],r=W.clamp(i,Ur,Tk);let l=0,h=0;for(let p=0;p<o.members.length;p++){const u=n[p];if(u<0)continue;const f=this.unionMemberState.get(o.members[p]);if(!f||f.mats.length===0)continue;const m=Math.min(1,u/r);l+=1-Hp*m*m,h++}if(h===0)continue;const c=l>1e-9?h/l:1;for(let p=0;p<o.members.length;p++){const u=n[p];if(u<0)continue;const f=this.unionMemberState.get(o.members[p]);if(!f||f.mats.length===0)continue;const m=Math.min(1,u/r),g=(1-Hp*m*m)*c;for(const w of f.mats){const b=w.opacity;let y=this.unionMatState.get(w);y||(y={frame:-1,base:b,written:NaN},this.unionMatState.set(w,y)),y.frame!==this.unionFrame?(y.base=y.written===b?y.base:b,y.frame=this.unionFrame):wa.aliasTouches++;const k=Math.min(1,y.base*g);y.written=k,w.opacity=k}}const d=o.core;if(d){const p=Math.min(1,o.life/Mk),u=2*r*xk;d.sprite.position.set(o.cx,o.cy,o.cz),d.sprite.scale.set(u,u,1),d.mat.opacity=kk*Math.pow(1-p,Ek),p>=1&&this.releaseUnionCore(o)}}}spawnCastTelegraph(e,a,o,n,s,i,r){if(!(r>0))return;const l=s.range??0;if(!(l>0))return;Jt("castTelegraph"),this.cancelCastTelegraph(e,"resolved");const h=Le(a,o),c=s.type==="melee"?s.cone??360:Math.max(12,s.spreadDeg??18),d=Je(l),p=mn(i,s.key)?.telegraph,u=s.giantSlam!==!0;if(!u&&!p)return;const f=`${Math.round(c)}_${d.toFixed(3)}`;let m=this.wedgeGeoCache.get(f);m||(m=Gr(d,c),this.wedgeGeoCache.set(f,m));const g=new Kt(s.color),w=Math.atan2(n.x,n.y),b=(C,N,L,P,j)=>{const z=new V({color:N,map:j?this.telegraphRimTex:null,transparent:!0,opacity:0,depthWrite:!1,side:me});z.userData.__ownMat=!0;const Y=new E(m,z);return Y.name=C,Y.rotation.y=w,Y.position.set(0,L,0),Y.renderOrder=P,Y},y=new ie;y.name="castTelegraph",y.position.set(h.x,Ba,h.z);const k=u?b("castTelegraphBase",i4(g,.26),0,5,!1):null,x=u?b("castTelegraphFill",Wp(g,pt,.22),.012,5.01,!1):null,M=u?b("castTelegraphRim",Wp(g,pt,.6),.024,5.02,!0):null;k&&x&&M&&y.add(k,x,M);const v=r/1e3,T=k?.material,S=x?.material,R=M?.material;this.castTelegraphs.set(e,y);const F=(C,N)=>{if(!k||!x||!M||!T||!S||!R)return;const L=W.clamp(N/v,0,1),P=N<=v?1:Math.max(0,1-(N-v)/jp),j=.5+.5*Math.sin(Math.PI*2*(2*L+3*L*L));T.opacity=(.6+.14*j)*P;const z=.1+.9*L;x.scale.set(z,1,z),S.opacity=(.7+.22*L)*P,R.opacity=(.62+.36*L*L)*P};if(F(0,0),this.spawnTransientObject(y,v+jp,F,e),!p)return;const A={THREE:an,position:new de(h.x,Pr,h.z),direction:new de(n.x,0,n.y).normalize(),color:s.color,damage:s.damage,weapon:s,characterId:i,castMs:r,spawnTransient:(C,N,L)=>this.spawnTransientObject(C,N,L,e)};p(A)}cancelCastTelegraph(e,a){const o=this.castTelegraphs.get(e);if(o){this.castTelegraphs.delete(e);for(let n=this.transientEffects.length-1;n>=0;n--){const s=this.transientEffects[n];if(s.telegraphOwner===e){if(s.object===o&&a!=="resolved"){const i=s.life,r=o.children.map(l=>l.material.opacity);s.maxLife=i+Gp,s.onUpdate=(l,h)=>{const c=W.clamp((h-i)/Gp,0,1),d=Math.max(.001,1-c);o.scale.set(d,1,d);for(let p=0;p<o.children.length;p++){const u=o.children[p].material;u.opacity=r[p]*(1-c)}};continue}this.group.remove(s.object),Wr(s.object),this.detachUnionMember(s),this.transientEffects.splice(n,1)}}}}spawnWeaponCast(e,a,o,n,s){const i=!!mn(s,n.key)?.cast;this.spawnCastFlash(e,a,o,n,s),n.type==="melee"&&(n.giantSlam&&i||this.spawnMeleeArc(e,a,o,n.range??0,n.cone??360,n.color)),n.giantSlam&&this.spawnGiantSlamShockwave(e,a,n.color,n.range??0,{bespokeOwnsGround:i})}spawnCastFlash(e,a,o,n,s){Jt("cast");const i=Le(e,a),r=Math.hypot(o.x,o.y)||1,l=o.x/r,h=o.y/r,c=.7,d=n.color,p=mn(s,n.key)?.cast;if(this.castMuzzle(i.x+l*c,i.z+h*c,d,p?"subordinate":"primary"),!p)return;const u={THREE:an,position:new de(i.x+l*c,Pr,i.z+h*c),direction:new de(l,0,h),color:d,damage:n.damage,weapon:n,characterId:s,spawnTransient:(f,m,g)=>this.spawnTransientObject(f,m,g)};p(u)}castMuzzle(e,a,o,n){const s=n==="primary"?1:.75,i=this.allocParticle();i.active=!0,i.life=0,i.maxLife=n==="primary"?.16:.13,i.sprite.visible=!0,i.sprite.position.set(e,Pr,a),i.vx=0,i.vy=0,i.vz=0,i.gravity=0,i.startScale=.75*s,i.endScale=1.3*s,i.startOpacity=1,i.endOpacity=0,i.fadeEase=1.6,i.mat.color.set(o).lerp(pt,.4)}spawnMeleeArc(e,a,o,n,s,i){Jt("meleeArc");const r=Le(e,a),l=Je(n),h=`${Math.round(s)}_${l.toFixed(3)}`;let c=this.wedgeGeoCache.get(h);c||(c=Gr(l,s),this.wedgeGeoCache.set(h,c));const d=this.allocWedge();d.active=!0,d.life=0,d.maxLife=.3,d.startOpacity=.88,d.mesh.visible=!0,d.mesh.geometry=c,d.mesh.rotation.y=Math.atan2(o.x,o.y),d.mesh.position.set(r.x,Ba,r.z),d.mat.color.set(i).lerp(uk,.14),d.mat.opacity=d.startOpacity}spawnImpactStarDecal(e,a,o,n){const s=`star_${o.toFixed(3)}`;let i=this.wedgeGeoCache.get(s);i||(i=a4(o,8,.42),this.wedgeGeoCache.set(s,i));const r=this.allocWedge();r.active=!0,r.life=0,r.maxLife=n,r.startOpacity=.9,r.mesh.visible=!0,r.mesh.geometry=i,r.mesh.rotation.y=Math.random()*Math.PI*2,r.mesh.position.set(e.x,Ba+.03,e.z),r.mat.map=null,Af(i),r.mat.vertexColors,r.mat.vertexColors=!0,r.mat.needsUpdate=!0,r.mat.color.set(a).lerp(pt,.05),r.mat.opacity=r.startOpacity}spawnImpactBurst(e,a,o,n,s){Jt("impact");const i=Le(e,a);(s?.weapon.effect==="stun"||s?.weapon.effect==="slow")&&this.flagStatusRefused(e,a,s.weapon.effect,s.weapon.color);const r=s&&mn(s.characterId,s.weapon.key)?.impact;if(this.impactAnchor(i,o,n,r?"subordinate":"primary"),r&&s){let l=0,h=0;if(s.fromXWU!==void 0&&s.fromYWU!==void 0){const d=jr(e-s.fromXWU,a-s.fromYWU);l=d.x,h=d.y}const c={THREE:an,position:new de(i.x,ga,i.z),direction:new de(l,0,h),color:o,damage:n,weapon:s.weapon,characterId:s.characterId,spawnTransient:(d,p,u)=>this.spawnTransientObject(d,p,u)};this.openUnionScope(i,o);try{r(c)}finally{this.closeUnionScope()}}}impactAnchor(e,a,o,n){const s=n==="primary"?1:W5,i=W.clamp(.42+o*.075,.42,2)*s,r=Math.max(2,Math.round(W.clamp(1+o*.4,2,8)*s));if(n==="primary"){this.burst(e,a,i,r);return}this.burst(e,a,i,0,{skipFlash:!0,skipStreaks:!0,decalMinRadius:Y5})}flagStatusRefused(e,a,o,n){for(let s=0;s<this.statusSnapshot.length;s++){const i=this.statusSnapshot[s];if(!Number.isFinite(i.x)||Math.hypot(i.x-e,i.y-a)>1)continue;if(o==="stun"?i.stunReady:i.slowReady)return;const l=this.statusBySlot[s];if(l){l.wardPop=Ap,l.wardPopColor.set(n).lerp(pt,.35);return}}}spawnDeathBurst(e,a,o){Jt("death");const n=Le(e,a);this.burst(n,o,2.6,9,{life:1.35})}spawnHealPulse(e,a){Jt("heal");const o=Le(e,a),n=7;for(let s=0;s<n;s++){const i=this.allocParticle(),r=s/n*Math.PI*2+Math.random()*.5,l=.66+Math.random()*.3;i.active=!0,i.life=0,i.maxLife=.72+Math.random()*.22,i.sprite.visible=!0,i.sprite.position.set(o.x+Math.cos(r)*l,J*.22,o.z+Math.sin(r)*l),i.vx=Math.cos(r)*.22,i.vz=Math.sin(r)*.22,i.vy=2+Math.random()*.45,i.gravity=-.45,i.startScale=.46+Math.random()*.14,i.endScale=.14,i.startOpacity=.95,i.endOpacity=0,i.fadeEase=1,i.mat.color.set("#6FE0A8")}}spawnPuddleSplash(e,a){Jt("puddleSplash");const o=5;for(let n=0;n<o;n++){const s=this.allocParticle(),i=n/o*Math.PI*2+Math.random()*1,r=Ka*(.58+Math.random()*.16);s.active=!0,s.life=0,s.maxLife=.3+Math.random()*.12,s.sprite.visible=!0,s.sprite.position.set(e+Math.cos(i)*r,ks,a+Math.sin(i)*r);const l=2.2+Math.random()*.6;s.vx=Math.cos(i)*l,s.vz=Math.sin(i)*l,s.vy=1.1+Math.random()*.5,s.gravity=-5.5,s.startScale=.58+Math.random()*.2,s.endScale=.12,s.startOpacity=1,s.endOpacity=0,s.fadeEase=1,s.mat.color.set("#E8F8FF")}}spawnCoverScuff(e,a,o,n,s){Jt("coverScuff");const i=Le(e,a),r=Math.hypot(n,s),l=r>1e-4?-n/r:0,h=r>1e-4?-s/r:-1,c=this.allocParticle();c.active=!0,c.life=0,c.maxLife=.12,c.sprite.visible=!0,c.sprite.position.set(i.x,xo,i.z),c.vx=0,c.vy=0,c.vz=0,c.gravity=0,c.startScale=.42,c.endScale=.85,c.startOpacity=1,c.endOpacity=0,c.fadeEase=1.4,c.mat.color.set(o).lerp(pt,.6);for(let d=0;d<5;d++){const p=(Math.random()-.5)*(Math.PI*2/3),u=Math.cos(p),f=Math.sin(p),m=l*u-h*f,g=l*f+h*u,w=this.allocParticle();w.mat.map=this.streakTex,w.mat.rotation=Math.atan2(g,m),w.aspect=.22,w.active=!0,w.life=0,w.maxLife=.22+Math.random()*.1,w.sprite.visible=!0,w.sprite.position.set(i.x+l*.22,xo,i.z+h*.22),w.vx=m*(2.4+Math.random()*1.6),w.vz=g*(2.4+Math.random()*1.6),w.vy=.9+Math.random()*.7,w.gravity=-7.5,w.startScale=.62+Math.random()*.28,w.endScale=.12,w.startOpacity=1,w.endOpacity=0,w.fadeEase=1.2,w.mat.color.set(Np)}}spawnGiantSlamShockwave(e,a,o,n,s){Jt("giantSlam");const i=Le(e,a),r=Je(n);if(!(s?.bespokeOwnsGround??!1)){const h=this.allocRing();h.active=!0,h.life=0,h.maxLife=.65,h.startScale=.3,h.targetScale=r*1.05,h.startOpacity=1,h.mesh.visible=!0,h.mesh.position.set(i.x,Ba+.02,i.z),h.mesh.scale.setScalar(h.startScale),h.mat.color.set(o).lerp(pt,.3),h.mat.opacity=h.startOpacity;const c=this.allocRing();c.active=!0,c.life=0,c.maxLife=.8,c.startScale=.15,c.targetScale=r*.85,c.startOpacity=.6,c.mesh.visible=!0,c.mesh.position.set(i.x,Ba+.01,i.z),c.mesh.scale.setScalar(c.startScale),c.mat.color.set(o),c.mat.opacity=c.startOpacity,this.spawnStarPop(i,ga*1.5,o,5.2,.38);const d=this.allocParticle();d.active=!0,d.life=0,d.maxLife=.3,d.sprite.visible=!0,d.sprite.position.set(i.x,ga*1.5,i.z),d.vx=0,d.vy=0,d.vz=0,d.gravity=0,d.startScale=1.8,d.endScale=3.5,d.startOpacity=.9,d.endOpacity=0,d.fadeEase=1.2,d.mat.color.set(o).lerp(pt,.4),this.spawnStreaks(i,ga*.6,"#FFE79A",10,4.5,.55)}this.burst(i,o,3.2,14,{life:.9,speedMult:1.7,skipFlash:!0,skipRing:!0,skipStreaks:!0,skipDecal:!0})}burst(e,a,o,n,s){const i=s?.life??1,r=s?.speedMult??1;if(s?.skipDecal||this.spawnImpactStarDecal(e,a,W.clamp(.65*o,s?.decalMinRadius??.55,1.5),(.55+o*.08)*i),!s?.skipFlash){const h=this.allocParticle();h.active=!0,h.life=0,h.maxLife=(.16+o*.04)*i,h.sprite.visible=!0,h.sprite.position.set(e.x,ga,e.z),h.vx=0,h.vy=0,h.vz=0,h.gravity=0,h.startScale=.5*o,h.endScale=1.15*o,h.startOpacity=1,h.endOpacity=0,h.fadeEase=1.4,h.mat.color.set(a).lerp(pt,.3)}if(!s?.skipRing){const h=this.allocRing();h.active=!0,h.life=0,h.maxLife=(.24+o*.06)*i,h.startScale=.15,h.targetScale=.6*o+.35,h.startOpacity=.95,h.mesh.visible=!0,h.mesh.position.set(e.x,Ba,e.z),h.mesh.scale.setScalar(h.startScale),h.mat.color.set(a).lerp(pt,.25),h.mat.opacity=h.startOpacity;const c=this.allocRing();c.active=!0,c.life=0,c.maxLife=(.32+o*.08)*i,c.startScale=.1,c.targetScale=(.6*o+.35)*1.35,c.startOpacity=.55,c.mesh.visible=!0,c.mesh.position.set(e.x,Ba-.01,e.z),c.mesh.scale.setScalar(c.startScale),c.mat.color.set(a),c.mat.opacity=c.startOpacity}if(!s?.skipStreaks){const h=Math.max(4,Math.round(n*.7));this.spawnStreaks(e,ga,"#FFE79A",h,(.5+o*.5)*r,.26*i)}const l=.4*o;for(let h=0;h<n;h++){const c=this.allocParticle();c.mat.map=this.shardTex;const d=Math.random()*Math.PI*2;c.mat.rotation=d,c.aspect=.4+Math.random()*.15;const p=(2.6+Math.random()*2.8)*(.6+o*.4)*r,u=.18+Math.random()*.24;c.active=!0,c.life=0,c.maxLife=(.36+Math.random()*.22+o*.06)*i,c.sprite.visible=!0,c.sprite.position.set(e.x+Math.cos(d)*u,ga,e.z+Math.sin(d)*u),c.vx=Math.cos(d)*p,c.vz=Math.sin(d)*p,c.vy=1.3+Math.random()*1.8,c.gravity=-6.2,c.startScale=l*(.8+Math.random()*.5),c.endScale=l*.2,c.startOpacity=1,c.endOpacity=0,c.fadeEase=.85,c.mat.color.set(Np)}}allocParticle(){let e=null;for(const o of this.particles)if(!o.active){e=o;break}if(!e){let o=-1/0;for(const n of this.particles){const s=n.life/n.maxLife;s>o&&(o=s,e=n)}}const a=e;return a.mat.map=this.glowTex,a.mat.rotation=0,a.aspect=1,a}spawnStarPop(e,a,o,n,s){const i=this.allocParticle();i.mat.map=this.starTex,i.active=!0,i.life=0,i.maxLife=s,i.sprite.visible=!0,i.sprite.position.set(e.x,a,e.z),i.vx=0,i.vy=0,i.vz=0,i.gravity=0,i.startScale=n*.5,i.endScale=n,i.startOpacity=1,i.endOpacity=0,i.fadeEase=1.7,i.mat.color.set(o).lerp(pt,.45)}spawnStreaks(e,a,o,n,s,i){for(let r=0;r<n;r++){const l=this.allocParticle();l.mat.map=this.streakTex,l.mat.rotation=Math.random()*Math.PI*2,l.aspect=.22,l.active=!0,l.life=0,l.maxLife=i*(.8+Math.random()*.4),l.sprite.visible=!0,l.sprite.position.set(e.x,a,e.z),l.vx=0,l.vy=0,l.vz=0,l.gravity=0,l.startScale=s*(.7+Math.random()*.3),l.endScale=s*1.35,l.startOpacity=.95,l.endOpacity=0,l.fadeEase=1.3,l.mat.color.set(o).lerp(pt,.3)}}allocWedge(){let e;for(const a of this.wedges)if(!a.active){e=a;break}return e||(e=this.wedges.reduce((a,o)=>a.life/a.maxLife>=o.life/o.maxLife?a:o)),e.mat.map!==this.wedgeGradientTex&&(e.mat.map=this.wedgeGradientTex,e.mat.needsUpdate=!0),e.mat.vertexColors&&(e.mat.vertexColors=!1,e.mat.needsUpdate=!0),e}allocRing(){for(const e of this.rings)if(!e.active)return e;return this.rings.reduce((e,a)=>e.life/e.maxLife>=a.life/a.maxLife?e:a)}clear(){for(const e of[this.projectilePool,this.shellPool,this.splatPool,this.trailPool]){for(const a of e.values())this.group.remove(a);e.clear()}for(const e of this.particles)e.active=!1,e.sprite.visible=!1;for(const e of this.wedges)e.active=!1,e.mesh.visible=!1;for(const e of this.rings)e.active=!1,e.mesh.visible=!1;for(const e of this.transientEffects)this.group.remove(e.object),Wr(e.object);this.transientEffects.length=0;for(const e of this.unionScopes)this.releaseUnionCore(e);this.unionScopes.length=0,this.pendingUnion=null,this.castTelegraphs.clear(),this.lastSyncElapsedMs=0;for(let e=0;e<this.statusBySlot.length;e++){const a=this.statusBySlot[e];a.slowRing.visible=!1,a.slowRingDark.visible=!1,a.slowTint.visible=!1,a.stunStars.forEach(n=>{n.visible=!1}),a.wardRing.visible=!1,a.wardPop=0,this.statusSnapshot[e]={x:NaN,y:NaN,stunReady:!0,slowReady:!0};const o=this.slowSplashState[e];o.lastX=NaN,o.lastY=NaN,o.distAccum=0}}dispose(){this.clear(),delete window.__vfxSpawnTest,window.__vfxLayer===this&&delete window.__vfxLayer,this.projectileGeo.dispose(),this.splatGeo.dispose(),this.trailGeo.dispose(),this.splatMats.forEach(e=>e.dispose()),Object.values(this.trailMats).forEach(e=>e.forEach(a=>a.dispose())),this.glazeTexByColor.forEach(e=>e.forEach(a=>a.dispose())),this.glazeTexByColor.clear(),this.materialCache.forEach(e=>e.dispose()),this.materialCache.clear(),this.haloTex.dispose(),this.haloMats.forEach(e=>e.dispose()),this.haloMats.clear(),this.glowTex.dispose(),this.coreTex.dispose(),this.softDiscTex.dispose(),this.starTex.dispose(),this.streakTex.dispose(),this.shardTex.dispose(),this.wedgeGradientTex.dispose(),this.telegraphRimTex.dispose();for(const e of this.particles)e.mat.dispose();for(const e of this.unionCores)e.mat.dispose();for(const e of this.wedges)e.mat.dispose();for(const e of this.rings)e.mat.dispose();this.wedgeGeoCache.forEach(e=>e.dispose()),this.wedgeGeoCache.clear(),this.ringUnitGeo.dispose(),this.wardGeo.dispose();for(const e of this.statusBySlot)e.slowRing.material.dispose(),e.slowRing.geometry.dispose(),e.slowRingDark.material.dispose(),e.slowRingDark.geometry.dispose(),e.slowTint.material.dispose(),e.stunStars.forEach(a=>a.material.dispose()),e.wardMat.dispose()}measureShell(e){let a=Je(10);if(this.shellBox.setFromObject(e),!this.shellBox.isEmpty()){this.shellBox.getSize(this.shellSize);const s=.5*Math.max(this.shellSize.x,this.shellSize.y,this.shellSize.z);s>1e-4&&(a=s)}const o=Math.min(jk,Math.max(1,Uk/a)),n=Math.min(Wk,Math.max(Up,a*o*Gk));e.userData.shellSpec={scale:o,haloR:n}}materialFor(e){let a=this.materialCache.get(e);return a||(a=Ve({color:e,roughness:U5,metalness:0}),this.materialCache.set(e,a)),a}}function Nl(t,e,a){return oh(e.x,e.y,a.x,a.y,t.arena,t,a)}function Yp(t,e){return _e(t)[e.observerSlot??Ce]??Xe(t)}function Yr(t){return t.phase==="playing"&&!Xe(t).alive}const Vp="hud-styles";function l4(){if(document.getElementById(Vp))return;const t=document.createElement("style");t.id=Vp,t.textContent=p4,document.head.appendChild(t)}function Kp(t){const e=Math.max(0,Math.ceil(t/1e3)),a=Math.floor(e/60),o=e%60;return`${a}:${String(o).padStart(2,"0")}`}function h4(t){const e=Math.max(0,Math.round(t/1e3)),a=Math.floor(e/60),o=e%60;return`${a}:${String(o).padStart(2,"0")}`}const Xp=.25,Zp=.14;function c4(t,e,a,o){const n=o>0?Math.max(0,Math.min(1,a/o)):0;t.style.width=`${(n*100).toFixed(1)}%`,e.textContent=`${Math.max(0,Math.ceil(a))} / ${o}`}function d4(t,e){l4(),ha(),t.innerHTML=`
    <div class="hud-root">
  ...
  `;const a=U=>{const te=t.querySelector(`[data-el="${U}"]`);if(!te)throw new Error(`hud: missing element "${U}"`);return te},o=a("timer"),n=a("weapons"),s=a("spectate"),i=a("countdown"),r=a("gameover"),l=a("gameover-title"),h=a("gameover-place"),c=a("gameover-subtitle"),d=a("gameover-stats"),p=a("gameover-payout"),u=a("gameover-btn"),f=a("topbar"),m=t.querySelector(".hud-clock"),g=t.querySelector(".hud-root"),w=a("dmg-layer"),b=a("screenflash"),y=a("zone"),k=a("zone-label"),x=a("zone-value"),M=a("zone-bar"),v=a("radar"),T=a("radar-safe"),S=a("radar-arena"),R=a("radar-map"),F=a("radar-cap"),A=a("fogedge"),C=a("fogtick"),N=a("safearrow"),L=a("safearrow-label"),P=a("aim-stick"),j=a("aim-reticle"),z=a("mute");let Y=[],O=null;function _(U){if(Y.length===U)return;for(const he of Y)he.bar.parentElement?.remove(),he.float.remove(),he.blip.remove();Y=[],O?.remove(),O=null;const te=U>2;f.classList.toggle("hud-topbar--chips",te),te&&(O=document.createElement("div"),O.className="hud-chips",O.dataset.el="chips",f.appendChild(O));for(let he=0;he<U;he++){const B=tw(he),ue=he===0?"player":"enemy",le=te&&he>0,fe=document.createElement("div");fe.className=`hud-fighter hud-fighter--${ue}${le?" hud-fighter--chip":""}`;const Ae=`<div class="hud-fighter-level" data-el="${B}-level"><span class="hud-fighter-level-tag">LV</span><span class="hud-fighter-level-n" data-el="${B}-level-n"></span></div>`,Be=he===0?`<div class="hud-fighter-emoji" data-el="${B}-emoji"></div><div class="hud-fighter-name" data-el="${B}-name"></div>`+Ae:Ae+`<div class="hud-fighter-name" data-el="${B}-name"></div><div class="hud-fighter-emoji" data-el="${B}-emoji"></div>`;fe.innerHTML=`<div class="hud-fighter-pill">${Be}</div><div class="hud-healthbar hud-healthbar--${ue}" data-el="${B}-bar"><div class="hud-healthbar-fill" data-el="${B}-fill"></div><div class="hud-healthbar-text" data-el="${B}-hp"></div></div>`,he===0?f.insertBefore(fe,m):O?O.appendChild(fe):f.appendChild(fe);const He=document.createElement("div");He.className=`hud-float hud-float--${ue}`,He.dataset.el=`float-${B}`,He.innerHTML=`<div class="hud-float-pill"><div class="hud-float-emoji" data-el="float-${B}-emoji"></div><div class="hud-float-bar"><div class="hud-float-fill" data-el="float-${B}-fill"></div></div></div>`,v.parentElement.insertBefore(He,v);const qe=document.createElement("div");qe.className=`hud-radar-dot hud-radar-dot--${ue}`,qe.dataset.el=`radar-${B}`,he===0?R.appendChild(qe):R.insertBefore(qe,R.querySelector(".hud-radar-dot--player")),Y.push({name:fe.querySelector(`[data-el="${B}-name"]`),emoji:fe.querySelector(`[data-el="${B}-emoji"]`),level:fe.querySelector(`[data-el="${B}-level-n"]`),levelValue:-1,bar:fe.querySelector(`[data-el="${B}-bar"]`),fill:fe.querySelector(`[data-el="${B}-fill"]`),hpText:fe.querySelector(`[data-el="${B}-hp"]`),float:He,floatEmoji:He.querySelector(`[data-el="float-${B}-emoji"]`),floatFill:He.querySelector(`[data-el="float-${B}-fill"]`),blip:qe})}}_(2);let H=0,K=null;function ce(){const U=ke.isMuted();if(U===K)return;const te=K===null;if(K=U,window.clearTimeout(H),U){z.innerHTML=D("mute")+"<span>MUTED · M</span>",z.classList.add("is-on"),z.classList.remove("is-ok");return}if(te){z.classList.remove("is-on","is-ok");return}z.innerHTML=D("sound")+"<span>SOUND ON · M</span>",z.classList.add("is-on","is-ok"),H=window.setTimeout(()=>z.classList.remove("is-on","is-ok"),1500)}const se=ke.onChange(ce);ce();const $=24,ee=[];let ye=0;for(let U=0;U<$;U++){const te=document.createElement("div");te.className="hud-dmg",w.appendChild(te),ee.push(te)}function Se(U,te){const he=U.replace("#",""),B=he.length===3?he.split("").map(Ae=>Ae+Ae).join(""):he,ue=parseInt(B.slice(0,2),16)||0,le=parseInt(B.slice(2,4),16)||0,fe=parseInt(B.slice(4,6),16)||0;return`rgba(${ue},${le},${fe},${te})`}u.addEventListener("click",()=>e.onRestart());let Ye=null,mo=[];function Wn(U){n.innerHTML="",mo=U.map((te,he)=>{const B=document.createElement("div");return B.className="hud-weapon-slot",B.innerHTML=`
        <div class="hud-weapon-cooldown"></div>
        <div class="hud-weapon-emoji">${Y0(te.emoji)}</div>
        <div class="hud-weapon-timer" data-role="timer"></div>
        <div class="hud-weapon-key">${he+1}</div>
      `,B.addEventListener("pointerdown",ue=>{ue.preventDefault(),ue.stopPropagation(),e.onSelectWeapon?.(he)}),n.appendChild(B),{root:B,cooldown:B.querySelector(".hud-weapon-cooldown"),timer:B.querySelector('[data-role="timer"]'),wasReady:!0}})}const Yn=Math.round(_l/Hs*1e3);function Zo(U,te){const he=Hi(U-Em.radiusUnits,U,te)-Hi(U,U,te);return he>0?Math.min(12e3,he):0}function Vn(U){const te=U.arena.maxSafeRadius,he=Xe(U),B=Math.hypot(he.x-U.arena.center.x,he.y-U.arena.center.y),ue=B>U.safeRadius,le=Aa-U.timeRemaining,fe=zs(U.fighters.length),Ae=B<=l0(U.fighters.length,U.timeRemaining);return{outside:ue,holds:Ae,ringAtFloor:U.safeRadius<=fe,sudden:Sn(U.timeRemaining),radius01:te>0?Math.max(0,Math.min(1,U.safeRadius/te)):0,msUntilEdge:ue||Ae?null:Hi(B,te,fe)-le}}const $h=56;let Bh=0,Oi=-1,qh=-1,Uh=-1;function Ni(){if(window.innerWidth!==Oi||window.innerHeight!==qh||Y.length!==Uh){Oi=window.innerWidth,qh=window.innerHeight,Uh=Y.length;const U=f.getBoundingClientRect().bottom;Bh=U+36,w.style.setProperty("--fa-dmg-top",`${Math.max(0,Math.round(U+2))}px`),g.style.setProperty("--fa-topbar-b",`${Math.max(0,Math.round(U))}px`)}return Bh}let Kn=0;function zf(U,te){const he=Yr(U);if(s.classList.toggle("is-on",he),!he){s.textContent!==""&&(s.textContent="");return}const B=Yp(U,te),le=B!==Xe(U)?`Spectating ${re[B.characterId].name}`:"Eliminated";s.textContent!==le&&(s.textContent=le)}function Hf(U,te){const he=U.phase==="playing",B=Vn(U),ue=Yr(U),le=he&&B.outside&&Xe(U).alive,fe=he&&B.sudden,Ae=U.arena.maxSafeRadius;y.classList.toggle("is-danger",le),y.classList.toggle("is-imminent",!le&&!ue&&B.msUntilEdge!==null&&B.msUntilEdge<Zo(Ae,zs(U.fighters.length))),M.style.width=`${(B.radius01*100).toFixed(1)}%`,fe?(k.textContent="SUDDEN DEATH",x.textContent="MOST HP WINS"):le?(k.textContent="▲ OUTSIDE THE ZONE",x.textContent=`−${Yn} HP/s`):(k.textContent="ZONE CLOSES",x.textContent=ue?B.ringAtFloor?"FINAL RING":"CLOSING":B.msUntilEdge!==null?`REACHES YOU ${Kp(B.msUntilEdge)}`:B.holds?"FINAL RING":"CLOSING");const Be=U.arena.width,He=U.arena.height,qe=U.arena.center.x,Xt=U.arena.center.y,Jo=Be/He,go=Math.max(Ae,qe,Be-qe)*(1+Zp),Li=Math.max(Xt,He-Xt)*(1+Zp),Pt=Math.max(2*go,2*Li*Jo),ge=Pt/Jo,wt=tt=>`${(50+(tt-qe)/Pt*100).toFixed(2)}%`,wo=tt=>`${(50+(tt-Xt)/ge*100).toFixed(2)}%`,Qo=tt=>`${(tt/Pt*100).toFixed(2)}%`,jh=tt=>`${(tt/ge*100).toFixed(2)}%`;T.style.left=wt(qe),T.style.top=wo(Xt),T.style.width=Qo(U.safeRadius*2),T.style.height=jh(U.safeRadius*2),S.style.left=wt(Be/2),S.style.top=wo(He/2),S.style.width=Qo(Be),S.style.height=jh(He);const Pf=Yp(U,te);_e(U).forEach((tt,en)=>{const bo=Y[en]?.blip;bo&&(bo.style.left=wt(tt.x),bo.style.top=wo(tt.y),bo.style.display=en===Ce?tt.alive?"block":"none":tt.alive&&Nl(U,Pf,tt)?"block":"none")}),v.classList.toggle("is-danger",le),F.textContent=fe?"SUDDEN DEATH":le?"GET INSIDE":"SAFE ZONE",A.classList.toggle("is-on",le);const ua=le&&!fe?te.safeArrow??null:null;if(ua){N.style.display="block",L.style.display="block";const tt=ua.angleRad*180/Math.PI;N.style.transform=`translate(${ua.at.x.toFixed(1)}px, ${ua.at.y.toFixed(1)}px) rotate(${tt.toFixed(1)}deg)`,(Kn===0||window.innerWidth!==Oi)&&(Kn=L.offsetWidth/2);const en=8,bo=Math.min(Math.max(ua.at.x+Math.cos(ua.angleRad)*178,Kn+en),window.innerWidth-Kn-en),$f=Math.min(Math.max(ua.at.y+Math.sin(ua.angleRad)*178,Ni()+4),window.innerHeight-22);L.style.transform=`translate(${bo.toFixed(1)}px, ${$f.toFixed(1)}px) translate(-50%, -50%)`}else N.style.display="none",L.style.display="none"}function _f(U){const te=U.aim??null;if(!te){P.style.display="none",j.style.display="none";return}const he=te.at.x-te.from.x,B=te.at.y-te.from.y,ue=Math.hypot(he,B),le=Math.atan2(B,he)*180/Math.PI;P.style.display="block",P.style.width=`${ue.toFixed(1)}px`,P.style.transform=`translate(${te.from.x.toFixed(1)}px, ${te.from.y.toFixed(1)}px) rotate(${le.toFixed(1)}deg)`,j.style.display="flex",j.style.transform=`translate(${te.at.x.toFixed(1)}px, ${te.at.y.toFixed(1)}px) translate(-50%, -50%)`}return{setCharacters(U){_(U.length),Ye=U[Ce]??null,U.forEach((te,he)=>{const B=Y[he];B&&(B.name.textContent=re[te].name,B.emoji.innerHTML=Ea(te,{crop:"head"}),B.floatEmoji.innerHTML=Ea(te,{crop:"head"}))}),Ye&&Wn(re[Ye].weapons),_o(t,{generate:!1})},update(U,te){o.textContent=Kp(U.timeRemaining),_e(U).forEach((B,ue)=>{const le=Y[ue];if(!le)return;c4(le.fill,le.hpText,B.hp,B.maxHp),le.levelValue!==B.level&&(le.levelValue=B.level,le.level.textContent=String(B.level));const fe=B.maxHp>0?B.hp/B.maxHp:0;le.bar.classList.toggle("is-low",B.alive&&fe<=Xp)});const he=Yr(U);if(n.classList.toggle("is-inert",he),Ye){const B=re[Ye].weapons,ue=Xe(U).lastUsed;mo.forEach((le,fe)=>{const Ae=B[fe];if(!Ae)return;const Be=Math.max(0,Ae.cooldown-(U.elapsed-ue[fe])),He=Ae.cooldown>0?Math.min(1,Be/Ae.cooldown):0;le.cooldown.style.setProperty("--p",He.toFixed(3));const qe=He<=0,Xt=qe&&!he;le.root.classList.toggle("is-ready",Xt),le.root.classList.toggle("is-selected",!he&&fe===te.selectedWeapon),le.timer.textContent=qe?"":(Be/1e3).toFixed(1),qe&&!le.wasReady&&!he&&(le.root.classList.remove("is-flash"),le.root.offsetWidth,le.root.classList.add("is-flash")),le.wasReady=qe})}if(zf(U,te),Hf(U,te),_f(te),U.phase==="countdown"){i.style.display="flex";const B=U.countdownValue<=0;i.textContent=B?"START!":String(U.countdownValue),i.classList.toggle("is-start",B)}else i.style.display="none";if(U.phase==="ended"){r.style.display="flex";const B=_e(U),ue=aa(U.winnerId??void 0,U.winner??"player"),le=ue===Ce;l.textContent=le?"VICTORY!":"DEFEAT!",l.classList.toggle("is-win",le),l.classList.toggle("is-lose",!le);const fe=B[ue]??B[0];re[fe.characterId];const Ae=B.every(ge=>ge.alive),Be=te.order??null,He=Be!==null&&Be.length===B.length&&Be.every(ge=>Number.isInteger(ge)&&ge>=0&&ge<B.length)&&new Set(Be).size===B.length,qe=Be&&He?Be.filter(ge=>ge!==ue).map(ge=>B[ge]):B.filter((ge,wt)=>wt!==ue),Xt=ge=>`<span class="hud-go-fighter"><span class="hud-go-emoji">${Ea(ge.characterId,{crop:"head"})}</span>${re[ge.characterId].name}</span>`,Jo=(ge,wt)=>wt.length?`<span class="hud-go-vs">${ge}</span>${wt.map(Xt).join("")}`:"";c.innerHTML=Xt(fe)+Jo("defeated",qe.filter(ge=>!ge.alive))+Jo("outlasted",qe.filter(ge=>ge.alive)),_o(c,{generate:!1});const go=te.place??null;if(go&&go.of>1){const ge=go.place,wt=ge%100>=11&&ge%100<=13?"th":{1:"st",2:"nd",3:"rd"}[ge%10]??"th";h.textContent=`${ge}${wt} of ${go.of}`,h.classList.toggle("is-podium",ge<=3),h.style.display="block"}else h.textContent="",h.style.display="none";const Li=Math.max(0,Aa-U.timeRemaining);d.innerHTML=Ae?`${D("timer")} Time up — no knockout`:`${D("timer")} Match time ${h4(Li)}`;const Pt=te.payout??null;if(Pt){const ge=(wt,wo,Qo="")=>`<span class="hud-go-pay">${D(wt)}<b>${wo>0?"+":""}${wo}</b>${Qo?`<i>${Qo}</i>`:""}</span>`;p.innerHTML=ge("trophy",Pt.trophies)+ge("coin",Pt.coins)+ge("star",Pt.xp,"xp")+(Pt.chests?ge("chest",Pt.chests):""),p.style.display="flex"}else p.innerHTML="",p.style.display="none"}else r.style.display="none"},updateFloatingBars(U,te){const he=Ni(),B=(ue,le)=>{const fe=Math.max(le.y,he),Ae=Math.min(Math.max(le.x,$h),window.innerWidth-$h);ue.style.transform=`translate(${Ae.toFixed(1)}px, ${fe.toFixed(1)}px) translate(-50%, -100%)`};Y.forEach((ue,le)=>{const fe=U[le]??null;if(!fe){ue.float.style.display="none";return}ue.float.style.display="flex",B(ue.float,fe);const Ae=Math.max(0,Math.min(1,te[le]??0));ue.floatFill.style.width=`${(Ae*100).toFixed(1)}%`,ue.floatFill.classList.toggle("is-low",Ae>0&&Ae<=Xp)})},spawnDamageNumber(U,te,he){const B=ee[ye];ye=(ye+1)%ee.length;const ue=!!he?.heal,le=te>=15,fe=!le&&te>=6,Ae=Math.max(U.y,Ni()),Be=Math.min(Math.max(U.x,24),window.innerWidth-24);B.style.setProperty("--x",`${Be.toFixed(1)}px`),B.style.setProperty("--y",`${Ae.toFixed(1)}px`),B.textContent=ue?`+${Math.round(te)}`:`-${Math.round(te)}`;const He=ue?" hud-dmg--heal":he?.fog?" hud-dmg--fog":"";B.className=`hud-dmg ${le?"hud-dmg--big":fe?"hud-dmg--medium":"hud-dmg--small"}${He}`,B.offsetWidth,B.classList.add("is-playing")},flashScreen(U){b.style.setProperty("--flash-color",Se(U,.42)),b.classList.remove("is-playing"),b.offsetWidth,b.classList.add("is-playing")},flashFogTick(){C.classList.remove("is-playing"),C.offsetWidth,C.classList.add("is-playing")},dispose(){u.removeEventListener("click",()=>e.onRestart()),window.clearTimeout(H),se(),t.innerHTML=""}}}const p4=`
.hud-root {
  position: fixed;
  inset: 0;
  pointer-events: none;
...
`,u4=["countdown-tick","match-started","match-ended","weapon-fired","weapon-fired:giantSlam","projectile-spawned","projectile-destroyed:hit-target","projectile-destroyed:hit-cover","projectile-destroyed:expired","hit-landed:weapon","hit-landed:trail","hit-landed:hazard","hit-landed:fog","heal","death","splat-created","trail-mark-created"],f4="hamburger",m4="donut";function Jp(t){const e=new URLSearchParams(location.search).get(t);return e&&Ee.includes(e)?e:null}function g4(){const t=new URLSearchParams(location.search).get("fighters");if(!t)return null;const e=[];for(const a of t.split(";")){const[o,n]=a.split("@"),s=o?.trim();if(!s||!Ee.includes(s))return null;const i={characterId:s};if(n){const[r,l]=n.split(",").map(Number);if(!Number.isFinite(r)||!Number.isFinite(l))return null;i.spawn={x:r,y:l}}e.push(i)}return e.length>=3?e:null}function Es(t){const e=new URLSearchParams(location.search).get(t);if(e===null)return null;const a=Number(e);return Number.isFinite(a)?a:null}function w4(t){if(t.type!=="hit-landed")return t;const e=t.targetRole??"enemy",a=t.source.kind==="trail"&&t.source.ownerRole===void 0?{...t.source,ownerRole:g0(e)}:t.source;return{...t,targetRole:e,source:a}}const b4=J+.35;class Va{constructor(e){this.opts=e,this.playerId=e.playerCharacterId??Jp("player")??f4,this.enemyId=e.enemyCharacterId??Jp("enemy")??m4;const a=Ra(e.playerLevel??Es("level")??io);this.levels={player:a,enemy:R0(a)},this.roster=e.roster&&e.roster.length>nt&&e.roster.length<=Ht?e.roster.slice():null,this.characterIds=this.qaFighters?this.qaFighters.map(n=>n.characterId):this.roster?this.roster.slice():[this.playerId,this.enemyId];const o=Number(new URLSearchParams(location.search).get("simSpeed"));this.simSpeed=Number.isFinite(o)&&o>0?Math.min(50,o):1,this.stage=new Dl({container:e.container,background:16764810,fog:{color:16764810,near:40,far:130},camera:{pitchDeg:58,yawDeg:0,frameMode:"fair"}}),this.stage.scene.add(this.arena.build()),this.fogRing=rb(this.arena.center),this.stage.scene.add(this.fogRing.root),this.vfx=new r4(this.stage.scene),this.hud=d4(e.hudRoot,{onRestart:()=>this.restart(),onSelectWeapon:n=>this.input.selectWeapon(n)}),this.hud.setCharacters(this.characterIds),this.input=new Z1(this.stage.canvas),this.input.setWeaponCount(re[this.characterIds[Ce]].weapons.length),this.pointerLock=Qb({target:this.stage.canvas,pause:()=>this.pause(),resume:()=>this.resume(),onLockChange:n=>this.input.setPointerLocked(n)}),this.state=this.newMatch(),this.spawnMatch(),window.__matchDebug=this.debug,window.__feelDebug=this.feel,window.__feelEvent=n=>this.handleEvents([w4(n)]),window.__matchArena=this.arena,window.addEventListener("resize",this.handleResize),this.raf=requestAnimationFrame(this.loop)}stage;arena=Tm();vfx;audio=e1();hud;input;pointerLock;fogRing;playerId;enemyId;levels;characterIds;qaFighters=g4();roster;models=[];state;eliminated=[];killedBy=[];viewSubject=Ce;spectateDwellMs=0;static SPECTATE_DWELL_MS=1350;endedOutcome=null;endedPayout=null;clock=new Sm;raf=0;disposed=!1;readyFired=!1;isPaused=!1;lastPhase=null;raycaster=new Am;groundPlane=new Rm(new de(0,1,0),0);rayHit=new de;projectVec=new de;projectileOrigins=new Map;simSpeed;qaFogRadius=Es("fogRadius");qaPlayerX=Es("px");qaPlayerY=Es("py");debug={phase:"countdown",winner:null,paused:!1,moveX:0,moveY:0,attack:!1,facingX:0,facingY:0,selectedWeapon:0,pointerLocked:!1,qaSpawnInsideCover:null,frames:0,viewSubject:Ce,viewReason:"local"};feel={events:Object.fromEntries(u4.map(e=>[e,0])),responses:{vfx:0,shake:0,hitStop:0,knockback:0,damageNumber:0,screenFlash:0},hitStopBudgetMs:0,hitStopBankedMs:0,lastHitStopMs:0,rawDtMs:0,stepDtMs:0,frames:0,frozenFrames:0,repayingFrames:0,peakHitAmount:0,peakShakeM:0,shakeSumM:0,shakeRawSumM:0,peakShakeRawM:0};hitStopBudgetMs=0;hitStopBankedMs=0;static HITSTOP_TRICKLE=.05;static HITSTOP_CATCHUP_RATE=3;static SHAKE_MAX_M=.4;shakeFadeUnits=-1;knockback=[];restart(){this.spawnMatch(),this.resume()}get paused(){return this.isPaused}pause(){this.isPaused=!0,this.pointerLock.release(),this.hud.update(this.state,{selectedWeapon:this.input.selectedWeapon,safeArrow:this.hudSafeArrow(),observerSlot:this.viewSubject,aim:null,...this.hudResult()})}resume(){this.isPaused=!1,this.pointerLock.engage()}resize(){this.stage.resize()}dispose(){this.disposed=!0,cancelAnimationFrame(this.raf),window.__matchDebug===this.debug&&delete window.__matchDebug,window.__feelDebug===this.feel&&delete window.__feelDebug,window.__matchArena===this.arena&&delete window.__matchArena,delete window.__feelEvent,window.removeEventListener("resize",this.handleResize),this.pointerLock.dispose(),this.input.dispose(),this.hud.dispose(),this.vfx.dispose(),this.fogRing.dispose();for(const e of this.models)e.dispose();this.stage.dispose()}newMatch(){return this.qaFighters?ir(this.arena,this.qaFighters):this.roster?ir(this.arena,this.roster.map((e,a)=>({characterId:e,level:a===Ce?this.levels.player:this.levels.enemy}))):ir(this.arena,this.playerId,this.enemyId,this.levels)}spawnMatch(){this.state=this.newMatch(),this.applyQaSetup();for(const n of this.models)this.stage.scene.remove(n.root),n.dispose();const e=_e(this.state);this.models=e.map((n,s)=>zl(this.characterIds[s]??n.characterId));for(const n of this.models)this.stage.scene.add(n.root);this.models.forEach((n,s)=>{this.syncModelTransform(n,e[s]),n.play("idle")}),this.vfx.clear(),this.audio.reset(),this.input.reset(),this.projectileOrigins.clear(),this.eliminated.length=0,this.killedBy.length=0,this.viewSubject=Ce,this.spectateDwellMs=0,this.hitStopBudgetMs=0,this.hitStopBankedMs=0;for(const n of Object.keys(this.feel.events))this.feel.events[n]=0;this.feel.responses.vfx=0,this.feel.responses.shake=0,this.feel.responses.hitStop=0,this.feel.responses.knockback=0,this.feel.responses.damageNumber=0,this.feel.responses.screenFlash=0,this.feel.frames=0,this.feel.frozenFrames=0,this.feel.repayingFrames=0,this.feel.peakHitAmount=0,this.feel.peakShakeM=0,this.feel.lastHitStopMs=0,this.feel.shakeSumM=0,this.feel.shakeRawSumM=0,this.feel.peakShakeRawM=0,this.knockback=e.map(()=>({x:0,z:0}));const a=Xe(this.state),o=Le(a.x,a.y);this.stage.rig.snapTo(o.x,o.z),this.stage.lighting.focus(o.x,o.z),this.fogRing.update(this.state.safeRadius,this.state.elapsed/1e3,this.state.phase==="playing",this.stage.rig),this.lastPhase=null,this.notifyPhase()}applyQaSetup(){const e=Xe(this.state);if(this.qaPlayerX!==null&&(e.x=this.qaPlayerX),this.qaPlayerY!==null&&(e.y=this.qaPlayerY),(this.qaPlayerX!==null||this.qaPlayerY!==null)&&this.checkQaSpawn(),this.qaFogRadius===null)return;const a=this.arena.maxSafeRadius;this.state.phase="playing",this.state.countdownValue=0,this.state.countdownTick=0,this.state.startFlashTimer=0;const o=Math.max(zs(this.state.fighters.length),a*(il/Aa));if(this.qaFogRadius<=o){this.qaFogRadius>ol&&console.warn(`[QA] ?fogRadius=${this.qaFogRadius} is below the lowest radius the schedule ever reaches (${o.toFixed(2)} wu — DECISIONS §2 collapses the ring at ${Im/1e3} s). Snapped to SUDDEN DEATH (radius 0). Ask for a larger radius if you wanted a ring.`),this.state.timeRemaining=il,this.state.safeRadius=ol;return}const n=W.clamp(this.qaFogRadius,o,a),s=W.clamp(n/a,0,1);this.state.timeRemaining=Aa*s,this.state.safeRadius=n}checkQaSpawn(){const e=Xe(this.state),a=this.arena.cover.find(o=>gi(e.x,e.y,e.size,e.size,o.x,o.y,o.w,o.h));this.debug.qaSpawnInsideCover=a?`${a.kind??"cover"} @(${a.x},${a.y}) ${a.w}x${a.h}`:null,a&&console.warn(`[QA] ?px=${e.x}&py=${e.y} places the player INSIDE cover "${a.kind??"cover"}" @(${a.x},${a.y}) ${a.w}x${a.h}. There is no depenetration in movement.ts, so the fighter cannot move at all — input is fine, the sim is refusing every step. Pick a point at least ${((e.size+Math.max(a.w,a.h))/2).toFixed(0)} wu from that centre.`)}aimCursor(){const e=this.input.aimOffsetPx;if(!e)return null;const a=Xe(this.state),o=this.projectPointToScreen(a.x,a.y,0);return o?{from:o,at:{x:o.x+e.x,y:o.y+e.y}}:null}buildInput(){const e=this.state.phase==="playing",a=e?this.input.moveAxes():{x:0,y:0};let o;if(e){const s=this.aimCursor();let i=this.input.mouseNdc;if(s){const r=this.stage.canvas.getBoundingClientRect();i={x:(s.at.x-r.left)/r.width*2-1,y:-((s.at.y-r.top)/r.height*2-1)}}if(i){this.raycaster.setFromCamera(new Cm(i.x,i.y),this.stage.rig.camera);const r=this.raycaster.ray.intersectPlane(this.groundPlane,this.rayHit);if(r){const l=Xe(this.state);o={x:Jh(r.x)-l.x,y:Jh(r.z)-l.y}}}}const n=e&&this.input.attackHeld;return{move:a,aim:o,selectedWeapon:this.input.selectedWeapon,attack:n}}syncModelTransform(e,a){const o=Le(a.x,a.y);e.root.position.set(o.x,0,o.z),e.root.rotation.y=Math.atan2(a.facing.x,a.facing.y)}attackerSlotOf(e,a){let o=null;if(e.kind==="weapon"?o=wn(this.state,e,a):e.kind==="trail"&&(o=xc(this.state,e)),!o)return;const n=_e(this.state).indexOf(o);return n>=0?n:void 0}colorForDamageSource(e,a){switch(a.kind){case"weapon":{const o=wn(this.state,a,e);return re[o.characterId].weapons.find(s=>s.key===a.weaponKey)?.color??"#FFFFFF"}case"trail":return aa(a.ownerId,a.ownerRole)===Ce?"#FF9EC4":"#FFD27A";case"hazard":return"#FF7A3D";case"fog":return"#B98CE6";default:return"#FFFFFF"}}triggerHitStop(e){this.hitStopBudgetMs=Math.max(this.hitStopBudgetMs,e),this.feel.responses.hitStop++,this.feel.lastHitStopMs=e}kick(e,a,o){const n=Math.min(e,Va.SHAKE_MAX_M),s=n*a;this.stage.rig.shake(s,o),this.feel.responses.shake++,this.feel.shakeSumM+=s,this.feel.shakeRawSumM+=n,s>this.feel.peakShakeM&&(this.feel.peakShakeM=s),n>this.feel.peakShakeRawM&&(this.feel.peakShakeRawM=n)}shakeProximity(e,a){this.shakeFadeUnits<0&&(this.shakeFadeUnits=this.stage.rig.shakeFadeRadiusUnits());const o=this.viewObserver();return Fm(Math.hypot(e-o.x,a-o.y),this.shakeFadeUnits)}viewObserver(){return _e(this.state)[this.viewSubject]??Xe(this.state)}updateViewSubject(e){const a=_e(this.state);if(a[Ce]?.alive){this.viewSubject=Ce,this.spectateDwellMs=0,this.audio.setListener(Ce),this.debug.viewSubject=Ce,this.debug.viewReason="local";return}if(this.spectateDwellMs>0){this.spectateDwellMs=Math.max(0,this.spectateDwellMs-e),this.debug.viewReason="dwell";return}this.shakeFadeUnits<0&&(this.shakeFadeUnits=this.stage.rig.shakeFadeRadiusUnits());const o=this.stage.rig.targetUnits(),n=Om({seats:a,localSlot:Ce,current:this.viewSubject,killedBy:this.killedBy,cameraX:o.x,cameraY:o.y,cutBeyondUnits:this.shakeFadeUnits});if(n.slot!==this.viewSubject&&(this.viewSubject=n.slot,n.cut)){const s=a[n.slot];if(s){const i=Le(s.x,s.y);this.stage.rig.snapTo(i.x,i.z),this.stage.lighting.focus(i.x,i.z)}}this.audio.setListener(this.viewSubject),this.debug.viewSubject=this.viewSubject,this.debug.viewReason=n.reason}applyKnockback(e,a,o,n){const s=_e(this.state)[e],i=this.knockback[e];if(!s||!i)return;const r=s.x-a,l=s.y-o,h=Math.hypot(r,l);if(h<1e-4)return;const c=W.clamp(n,0,.22);i.x+=r/h*c,i.z+=l/h*c,this.feel.responses.knockback++}handleEvents(e){const a=[],o=[];for(const n of e){const s=n.type==="hit-landed"?`hit-landed:${n.source.kind}`:n.type==="projectile-destroyed"?`projectile-destroyed:${n.reason}`:n.type;switch(s in this.feel.events&&this.feel.events[s]++,n.type){case"weapon-fired":{const i=this.models[aa(n.fighterId,n.fighterRole)],r=gt(this.state,n.fighterId,n.fighterRole);if(!i)break;const l=re[r.characterId].weapons,h=l.findIndex(d=>d.key===n.weaponKey),c=l[h<0?0:h];i.play("attack",{weaponIndex:h<0?0:h}),c&&(this.vfx.spawnWeaponCast(r.x,r.y,r.facing,c,r.characterId),this.feel.responses.vfx++,c.giantSlam&&(this.feel.events["weapon-fired:giantSlam"]++,this.hud.flashScreen(c.color),this.feel.responses.screenFlash++,this.kick(.55,this.shakeProximity(r.x,r.y),2.6),this.triggerHitStop(120),window.__vfxDebugGiantSlamCount=(window.__vfxDebugGiantSlamCount??0)+1));break}case"hit-landed":{const i=aa(n.targetId,n.targetRole);this.models[i]?.play("hit",{intensity:W.clamp(n.amount/12,.25,1)});const l=this.colorForDamageSource(n.targetRole,n.source);if(a[i]=l,o[i]=this.attackerSlotOf(n.source,n.targetRole),n.source.kind==="fog"){const m=this.projectPointToScreen(n.x,n.y,1.3);m&&(this.hud.spawnDamageNumber(m,n.amount,{fog:!0}),this.feel.responses.damageNumber++),i===Ce&&(this.hud.flashFogTick(),this.feel.responses.screenFlash++);break}let h;if(n.source.kind==="weapon"){const m=wn(this.state,n.source,n.targetRole),g=n.source.weaponKey,w=re[m.characterId].weapons.find(b=>b.key===g);w&&(h={weapon:w,characterId:m.characterId,fromXWU:m.x,fromYWU:m.y})}this.vfx.spawnImpactBurst(n.x,n.y,l,n.amount,h),this.feel.responses.vfx++,n.amount>this.feel.peakHitAmount&&(this.feel.peakHitAmount=n.amount);const c=this.projectPointToScreen(n.x,n.y,1.3);c&&(this.hud.spawnDamageNumber(c,n.amount),this.feel.responses.damageNumber++);const d=n.source.kind==="weapon",p=W.clamp(.012+n.amount*.0175,.012,Va.SHAKE_MAX_M),u=i===Ce?1.25:1,f=gt(this.state,n.targetId,n.targetRole);if(this.kick(p*u*(d?1:.45),this.shakeProximity(f.x,f.y)),d&&this.triggerHitStop(W.clamp(10+n.amount*4.6,16,105)),n.source.kind==="weapon"){const m=n.source,g=wn(this.state,m,n.targetRole);(re[g.characterId].weapons.find(y=>y.key===m.weaponKey)?.knockback??0)>0||this.applyKnockback(i,g.x,g.y,.05+n.amount*.006)}else if(n.source.kind==="trail"){const m=xc(this.state,n.source);this.applyKnockback(i,m.x,m.y,.03)}break}case"projectile-spawned":{this.projectileOrigins.set(n.id,{color:n.color,x:n.x,y:n.y});break}case"projectile-destroyed":{const i=this.projectileOrigins.get(n.id);if(this.projectileOrigins.delete(n.id),n.reason!=="hit-cover")break;this.vfx.spawnCoverScuff(n.x,n.y,i?.color??"#FFFFFF",i?n.x-i.x:0,i?n.y-i.y:0);break}case"heal":{const i=gt(this.state,n.fighterId,n.fighterRole);this.vfx.spawnHealPulse(i.x,i.y),this.feel.responses.vfx++;const r=this.projectPointToScreen(i.x,i.y,1.6);r&&(this.hud.spawnDamageNumber(r,n.amount,{heal:!0}),this.feel.responses.damageNumber++);break}case"death":{const i=aa(n.fighterId,n.fighterRole);this.eliminated.push(i),this.killedBy[i]=o[i]??null,i===this.viewSubject&&(this.spectateDwellMs=Va.SPECTATE_DWELL_MS),this.models[i]?.play("death");const r=gt(this.state,n.fighterId,n.fighterRole),l=a[i]??"#FFFFFF";this.vfx.spawnDeathBurst(r.x,r.y,l),this.feel.responses.vfx++,this.kick(.42,this.shakeProximity(r.x,r.y),3),this.triggerHitStop(90);break}}}}groundOnScreen(e,a){return this.projectVec.set(e,0,a),this.projectVec.project(this.stage.rig.camera),this.projectVec.z<=1&&Math.abs(this.projectVec.x)<=1&&Math.abs(this.projectVec.y)<=1}projectToScreen(e,a){if(!a||!this.groundOnScreen(e.root.position.x,e.root.position.z)||(this.projectVec.set(e.root.position.x,b4,e.root.position.z),this.projectVec.project(this.stage.rig.camera),this.projectVec.z>1))return null;const o=this.stage.canvas.getBoundingClientRect();return{x:(this.projectVec.x*.5+.5)*o.width+o.left,y:(1-(this.projectVec.y*.5+.5))*o.height+o.top}}projectPointToScreen(e,a,o){const n=Le(e,a);if(!this.groundOnScreen(n.x,n.z)||(this.projectVec.set(n.x,o,n.z),this.projectVec.project(this.stage.rig.camera),this.projectVec.z>1))return null;const s=this.stage.canvas.getBoundingClientRect();return{x:(this.projectVec.x*.5+.5)*s.width+s.left,y:(1-(this.projectVec.y*.5+.5))*s.height+s.top}}safeArrow(){const e=Xe(this.state),a=this.arena.center.x-e.x,o=this.arena.center.y-e.y,n=Math.hypot(a,o);if(n<.001)return null;const s=this.projectPointToScreen(e.x,e.y,.35),i=this.projectPointToScreen(e.x+a/n*80,e.y+o/n*80,.35);if(!s||!i)return null;const r=i.x-s.x,l=i.y-s.y;return Math.hypot(r,l)<1?null:{at:s,angleRad:Math.atan2(l,r)}}notifyPhase(){this.state.phase!==this.lastPhase&&(this.lastPhase=this.state.phase,this.pointerLock.setMatchActive(this.state.phase!=="ended"),this.endedOutcome=this.state.phase==="ended"?this.outcome():null,this.state.phase!=="ended"&&(this.endedPayout=null),this.opts.onPhase?.(this.state.phase,this.state.winner,this.endedOutcome))}showPayout(e){this.endedPayout=e}hudSafeArrow(){return Xe(this.state).alive?this.safeArrow():null}hudResult(){return{place:this.hudPlace(),order:this.endedOutcome?.places??null,payout:this.endedOutcome?this.endedPayout:null}}hudPlace(){const e=this.endedOutcome;return!e||e.seats<=1||e.localPlace<0?null:{place:e.localPlace+1,of:e.seats}}outcome(){const a={seats:_e(this.state).map((n,s)=>({id:s,alive:n.alive,hp:n.hp,maxHp:n.maxHp,x:n.x,y:n.y,deaths:n.deaths})),center:{x:this.arena.center.x,y:this.arena.center.y},eliminated:this.eliminated,winnerId:this.state.winnerId??null},o=aw(a);return{seats:a.seats.length,places:o,localPlace:o.indexOf(Ce),winnerId:a.winnerId}}handleResize=()=>this.resize();publishDebug(e,a,o){const n=this.debug;n.phase=this.state.phase,n.winner=this.state.winner,n.paused=this.isPaused,n.moveX=e,n.moveY=a,n.attack=o;const s=Xe(this.state);n.facingX=s.facing.x,n.facingY=s.facing.y,n.selectedWeapon=this.input.selectedWeapon,n.pointerLocked=this.input.pointerLocked,n.frames++}decayKnockback(e){const a=Math.exp(-e*14);for(const o of this.knockback)o.x*=a,o.z*=a,Math.abs(o.x)<1e-4&&(o.x=0),Math.abs(o.z)<1e-4&&(o.z=0)}loop=()=>{if(this.disposed)return;const e=Math.min(this.clock.getDelta(),1/20)*this.simSpeed,a=e*1e3;if(this.isPaused){this.publishDebug(0,0,!1),this.stage.render(0),this.raf=requestAnimationFrame(this.loop);return}let o;if(this.hitStopBudgetMs>0)this.hitStopBudgetMs=Math.max(0,this.hitStopBudgetMs-a),o=a*Va.HITSTOP_TRICKLE,this.hitStopBankedMs+=a-o;else if(this.hitStopBankedMs>0){const u=Math.min(this.hitStopBankedMs,a*Va.HITSTOP_CATCHUP_RATE);this.hitStopBankedMs-=u,o=a+u}else o=a;const n=o/1e3;this.feel.rawDtMs=a,this.feel.stepDtMs=o,this.feel.hitStopBudgetMs=this.hitStopBudgetMs,this.feel.hitStopBankedMs=this.hitStopBankedMs,this.feel.frames++,o<a*.5?this.feel.frozenFrames++:o>a*1.05&&this.feel.repayingFrames++;const s=_e(this.state),i=s.map(u=>({x:u.x,y:u.y})),r=this.buildInput(),l=$b(this.state,o,r);this.handleEvents(l),this.audio.handleEvents(l,this.state),this.notifyPhase(),this.publishDebug(r.move.x,r.move.y,r.attack===!0);const h=s.map((u,f)=>u.x!==i[f].x||u.y!==i[f].y);this.models.forEach((u,f)=>{const m=s[f];if(!m)return;this.syncModelTransform(u,m);const g=this.knockback[f];g&&(u.root.position.x+=g.x,u.root.position.z+=g.z)}),this.decayKnockback(e),this.updateViewSubject(a);const c=this.viewObserver();this.models.forEach((u,f)=>{if(f===Ce)return;const m=s[f];m&&(u.root.visible=Nl(this.state,c,m))}),this.models.forEach((u,f)=>{s[f]?.alive&&u.play(h[f]?"run":"idle")});const d=this.state.elapsed/1e3;this.models.forEach((u,f)=>{const m=s[f];m&&u.update({dt:n,elapsed:d,moveSpeed01:m.alive&&h[f]?1:0,health01:m.hp/m.maxHp})}),this.arena.update?.(n,d),this.vfx.sync(this.state),this.vfx.updateEffects(e),this.fogRing.update(this.state.safeRadius,this.clock.elapsedTime,this.state.phase==="playing",this.stage.rig);const p=Le(c.x,c.y);this.stage.rig.follow(p.x,p.z),this.stage.lighting.focus(p.x,p.z),window.__vfxDebugScreen={player:this.projectPointToScreen(s[0].x,s[0].y,0),enemy:s[1]?this.projectPointToScreen(s[1].x,s[1].y,0):null,slots:s.map(u=>this.projectPointToScreen(u.x,u.y,0))},this.hud.update(this.state,{selectedWeapon:this.input.selectedWeapon,safeArrow:this.hudSafeArrow(),aim:Xe(this.state).alive?this.aimCursor():null,observerSlot:this.viewSubject,...this.hudResult()}),this.hud.updateFloatingBars(this.models.map((u,f)=>{const m=s[f];if(!m)return null;const g=f===Ce?m.alive:m.alive&&Nl(this.state,c,m);return this.projectToScreen(u,g)}),s.map(u=>u.hp/u.maxHp)),this.stage.render(e),this.readyFired||(this.readyFired=!0,window.__gameReady=!0,window.__previewReady=!0),this.raf=requestAnimationFrame(this.loop)}}function y4(t){return new Va(t)}const Ph="Escape";function x4(t,e){if(e.name!=="match")throw new Error("createMatchScreen: wrong route");la("fa-match-styles",v4),ha();const a=Fe("div","fa-screen-bare fa-match");a.innerHTML=`
  ...
  `;const o=p=>{const u=a.querySelector(`[data-el="${p}"]`);if(!u)throw new Error(`matchScreen: missing element "${p}"`);return u},n=o("sheet"),s=o("pause"),i=o("exit");let r=!1;const l=e.seats===void 0?void 0:b0(e.player,e.enemy,e.seats),h=y4({container:t.gameHost,hudRoot:t.hudRoot,playerCharacterId:e.player,enemyCharacterId:e.enemy,roster:l,playerLevel:t.profile.characterLevel(e.player),onPhase(p,u,f){if(p==="ended"){if(!r){r=!0;const g=f!==null&&f.localPlace>=0&&f.seats>=nt&&f.seats<=Ht&&f?t.profile.recordPlacement(f.localPlace,f.seats):t.profile.recordResult(u==="player");h.showPayout({trophies:g.trophies,coins:g.coins,xp:D0(g.place,g.seats),chests:g.chests})}a.classList.add("is-ended")}else r=!1,a.classList.remove("is-ended")}});function c(p){p?h.pause():h.resume(),n.classList.toggle("is-open",p),s.innerHTML=D(p?"play":"pause")}s.addEventListener("click",()=>c(!h.paused)),o("resume").addEventListener("click",()=>c(!1)),o("change").addEventListener("click",()=>t.navigate({name:"characters"})),o("quit").addEventListener("click",()=>t.navigate({name:"home"})),i.addEventListener("click",()=>t.navigate({name:"home"}));const d=p=>{p.key===Ph&&(p.preventDefault(),c(!h.paused))};return window.addEventListener("keydown",d),i.title=l?l.map(p=>re[p].name).join(" · "):`${re[e.player].name} vs ${re[e.enemy].name}`,{root:a,resize(){h.resize()},dispose(){window.removeEventListener("keydown",d),h.dispose(),a.remove()}}}const v4=`
...
`,If="food-arena.settings.v1",k4="fa-reduce-motion";function Cf(){try{const t=localStorage.getItem(If),e=t?JSON.parse(t):{};return{reduceMotion:e.reduceMotion===!0,moveKeys:E4(e.moveKeys)}}catch{return{reduceMotion:!1,moveKeys:{}}}}function Vr(t){try{localStorage.setItem(If,JSON.stringify(t))}catch{}}function Ff(){const t=Cf();document.documentElement.classList.toggle(k4,t.reduceMotion),Ll(t.moveKeys)}const oa=["up","left","down","right"],yn={up:"Move up",left:"Move left",down:"Move down",right:"Move right"},so={...Yt},M4=[{code:eh,does:"mutes the game"},{code:Ph,does:"pauses a match"},{code:"Tab",does:"moves between controls"},{code:"Enter",does:"presses the control you are on"},{code:"NumpadEnter",does:"presses the control you are on"},...Array.from({length:th},(t,e)=>[{code:`Digit${e+1}`,does:"picks a weapon"},{code:`Numpad${e+1}`,does:"picks a weapon"}]).flat()];function Of(t){return M4.find(e=>e.code===t)?.does??null}function jt(t){if(t.startsWith("Key"))return t.slice(3);if(t.startsWith("Digit"))return t.slice(5);switch(t){case"ArrowUp":return"↑";case"ArrowDown":return"↓";case"ArrowLeft":return"←";case"ArrowRight":return"→";case"Escape":return"Esc";case"Space":return"Space";default:return t}}function Ll(t){const e=Yt;for(const a of oa){const o=so[a],n=t[a];e[a]=n?[n,...o.slice(1).filter(s=>s!==n)]:o}}function E4(t){const e={};if(t===null||typeof t!="object")return e;const a=t,o=new Set;for(const n of oa){const s=a[n];typeof s!="string"||s.length===0||s.length>32||Of(s)||o.has(s)||oa.some(i=>i!==n&&so[i].includes(s))||(o.add(s),e[n]=s)}return e}function T4(t,e,a){const o=Of(e);if(o)return`${jt(e)} already ${o}.`;for(const n of oa){if(n===t)continue;if((a[n]??so[n][0])===e||so[n].includes(e))return`${jt(e)} is already ${yn[n].toLowerCase()}.`}return null}function S4(){return oa.some(t=>Yt[t][0]!==so[t][0])}function Qp(){return'<svg class="fa-ic fa-ic--note" viewBox="0 0 24 24" fill="none" style="stroke:var(--fa-ic-ink,#1a1224)" stroke-width="1.7" stroke-linejoin="round" stroke-linecap="round" aria-hidden="true" focusable="false"><path d="M10.4 17.2V5.4l8.2-1.9v11.7" fill="none" stroke-width="2"/><ellipse cx="7.6" cy="17.4" rx="3" ry="2.5" fill="#FFC93C"/><ellipse cx="15.8" cy="15.2" rx="3" ry="2.5" fill="#FFC93C"/></svg>'}function A4(t){la("fa-settings-styles",R4),ha();const e=Fe("div","fa-screen fa-settings");let a=Cf(),o=null;const n=()=>{const O=[],_=oa.flatMap(K=>Yt[K].slice(1)).map(jt);_.length>0&&O.push({action:"Move (fixed)",keys:_}),O.push({action:"Aim",keys:["Mouse"]}),O.push({action:"Fire",keys:["Click"]});const H=Math.min(re[t.profile.selected].weapons.length,th);return H>1&&O.push({action:"Switch weapon",keys:Array.from({length:H},(K,ce)=>String(ce+1))}),O.push({action:"Mute / unmute",keys:[jt(eh)]}),O.push({action:"Pause",keys:[jt(Ph)]}),O},s=()=>`Aim, fire, mute and pause are fixed.${re[t.profile.selected].weapons.length>1?"":` ${re[t.profile.selected].name} carries one weapon, so there is no weapon-switch key while it is equipped.`} On a phone, twin sticks appear under your thumbs — the left half of the screen moves, the right half aims and fires — in landscape and in portrait alike.`,i=(O,_,H,K)=>`
    <div class="set-row">
     ...
     </span>`,h=O=>{const _=_i(O),H=O==="auto"?_i(Dm()):"";return`<button class="set-seg-btn" type="button" role="radio" aria-checked="false"
        aria-label="${H?`${_} (${H})`:_}"
    ...
    <div class="fa-scroll set-body">
        ...
        <div class="set-row">
          ...
          <span class="set-row-control set-name-wrap">
            <input class="set-name" type="text" data-el="name" aria-label="Player name"
                   maxlength="${pl}" autocomplete="off" autocapitalize="words"
      ...
      <section class="fa-panel set-section">
        ...
        ${i(Qp(),"Music","The menu and lobby theme",r("music","Music"))}
        ${i(Qp(),"Music volume","Sits under the effects",l("music","Music volume"))}
      </section>
  ...
  `;const c=O=>{const _=e.querySelector(`[data-el="${O}"]`);if(!_)throw new Error(`settings: missing element "${O}"`);return _},d=O=>e.querySelector(`[data-toggle="${O}"]`),p=O=>e.querySelector(`[data-range="${O}"]`),u=c("qualityrow"),f=O=>`${Math.round(O*100)}%`;function m(O,_){const H=d(O);H.setAttribute("aria-checked",_?"true":"false"),H.classList.toggle("is-on",_)}function g(){const O=Hm(),_=_m();for(const ce of u.querySelectorAll("[data-quality]")){const se=ce.dataset.quality===_;ce.setAttribute("aria-checked",se?"true":"false"),ce.classList.toggle("is-on",se),ce.disabled=O!==null}const H=c("qualitypin");O?(H.textContent=`This session is pinned to ${_i(O)} by a ?tier= link in the address bar, so this control is switched off. Reload without it to choose.`,H.hidden=!1):H.hidden=!0;const K=Pm();c("qualityblurb").textContent=_==="auto"&&!O?`Auto picked ${K.label} on this device. ${K.blurb}`:K.blurb}function w(){for(const O of oa){const _=c(`bind-${O}`),H=jt(Yt[O][0]),K=o===O;_.textContent=K?"…":H,_.classList.toggle("is-listening",K),_.setAttribute("aria-label",K?`${yn[O]}: press the key you want, or Escape to keep ${H}`:`${yn[O]}, currently ${H}. Press to change it.`)}c("bindreset").hidden=!S4(),c("keys").innerHTML=n().map(O=>`
      ...
      </div>`).join(""),c("ctrlnote").textContent=s()}function b(O){c("bindnote").textContent=O??(o!==null?"Press any key. Escape keeps the one you have.":`Tap a key to change it. ${oa.map(_=>jt(so[_].slice(1)[0]??"")).filter(Boolean).join(" ")} always work as well, so movement can never be lost.`)}function y(O){c("namecount").textContent=`${O.length}/${pl}`}function k(){const O=ke.isMuted(),_=ke.getState(),H=c("name");document.activeElement!==H&&(H.value=t.profile.name),y(H.value);const K=p("sfx");document.activeElement!==K&&(K.value=String(ke.getVolume())),K.style.setProperty("--p",f(ke.getVolume())),c("sfxval").textContent=f(ke.getVolume());const ce=p("music");document.activeElement!==ce&&(ce.value=String(ke.music.getVolume())),ce.style.setProperty("--p",f(ke.music.getVolume())),c("musicval").textContent=f(ke.music.getVolume()),m("mute",O),m("music",ke.music.isEnabled()),m("motion",a.reduceMotion),e.classList.toggle("is-muted",O);const se=c("audiostate");_==="failed"?(se.textContent="This browser blocked audio, so nothing here will make a sound.",se.hidden=!1):_!=="running"?(se.textContent="Sound switches on when you touch the screen — drag a slider to try it.",se.hidden=!1):se.hidden=!0}function x(O,_){const H=T4(O,_,a.moveKeys);if(H){b(`${H} Pick another, or press Escape.`);return}const K={...a.moveKeys};K[O]=_,a={...a,moveKeys:K},Vr(a),Ll(a.moveKeys),S(),b(`${yn[O]} is now ${jt(_)}.`),w()}function M(){a={...a,moveKeys:{}},Vr(a),Ll(a.moveKeys),S(),b(`Movement is back to ${oa.map(O=>jt(so[O][0])).join(" ")}.`),w()}const v=O=>{if(o!==null){if(O.preventDefault(),O.stopPropagation(),O.key==="Escape"){const _=o;S(),b(`Left ${yn[_].toLowerCase()} on ${jt(Yt[_][0])}.`),w();return}["Shift","Control","Alt","Meta","CapsLock"].includes(O.key)||O.code&&x(o,O.code)}};function T(O){if(o===O){S(),w(),b();return}o===null&&window.addEventListener("keydown",v,!0),o=O,w(),b()}function S(){o!==null&&(o=null,window.removeEventListener("keydown",v,!0))}const R=O=>{const _=O.target.closest("[data-quality]");if(_){zm(_.dataset.quality),g();return}const H=O.target.closest("[data-bind]");if(H){T(H.dataset.bind);return}if(O.target.closest('[data-el="bindreset"]')){M();return}o!==null&&(S(),w(),b());const K=O.target.closest("[data-toggle]");if(K){switch(K.dataset.toggle){case"mute":ke.setMuted(!ke.isMuted()),ke.isMuted()||ke.previewClick();break;case"music":ke.music.setEnabled(!ke.music.isEnabled());break;case"motion":a={...a,reduceMotion:!a.reduceMotion},Vr(a),Ff();break}k()}};e.addEventListener("click",R);const F=O=>{const _=O.target;if(_.dataset.el==="name"){t.profile.setName(_.value),y(_.value);return}const H=Number(_.value);Number.isFinite(H)&&(_.dataset.range==="sfx"?(ke.setVolume(H),ke.previewClick()):_.dataset.range==="music"&&ke.music.setVolume(H),k())};e.addEventListener("input",F);const A=O=>{const _=O.target;_.dataset.el==="name"&&(_.value=t.profile.setName(_.value),y(_.value))};e.addEventListener("change",A);const C=O=>{const _=O.target;!_||_.dataset.el!=="name"||O.key!=="Enter"||(O.preventDefault(),_.blur())};e.addEventListener("keydown",C),c("back").addEventListener("click",()=>t.navigate({name:"home"})),c("done").addEventListener("click",()=>t.navigate({name:"home"}));const N=c("confirm");c("reset").addEventListener("click",()=>{const O=Ee.filter(_=>t.profile.characterLevel(_)>io).length;c("confirmsub").textContent=`${t.profile.trophies.toLocaleString()} trophies, ${t.profile.coins.toLocaleString()} coins and ${t.profile.wins} wins will be deleted`+(O>0?`, along with ${O} upgraded fighter${O===1?"":"s"}.`:"."),N.hidden=!1}),c("cancel").addEventListener("click",()=>{N.hidden=!0}),c("confirmyes").addEventListener("click",()=>{try{const O=[];for(let _=0;_<localStorage.length;_++){const H=localStorage.key(_);H&&H.startsWith("food-arena.profile")&&O.push(H)}for(const _ of O)localStorage.removeItem(_)}catch{}location.reload()});const L=e.querySelector(".set-body"),P=()=>{const O=L.scrollHeight-L.scrollTop-L.clientHeight>2;L.classList.toggle("is-more",O)};L.addEventListener("scroll",P,{passive:!0}),requestAnimationFrame(P);const j=ke.onChange(k),z=ke.music.onChange(k),Y=Lm(g);return k(),g(),w(),b(),{root:e,resize(){P()},dispose(){j(),z(),Y(),S(),L.removeEventListener("scroll",P),e.removeEventListener("click",R),e.removeEventListener("input",F),e.removeEventListener("change",A),e.removeEventListener("keydown",C),e.remove()}}}const R4=`
...
`,e0=[{key:"damage",icon:"damage",label:"Damage",color:"#FF8A96"},{key:"health",icon:"health",label:"Health",color:"#8FE04A"},{key:"speed",icon:"speed",label:"Speed",color:"#6FC8F5"}],I4=new Set(["Neon","Cyber"]);function C4(t){return t===void 0?null:t>=Wa.ultimateSlam?"Widest":t>Wa.rangedLong?"Max range":t>Wa.rangedMid?"Long":t>Wa.rangedClose?"Mid":t>Wa.meleeHeavy?"Short":"Melee"}function F4(t){const e=[];t.type==="self"&&t.healAmount?e.push(`${D("heal")} +${t.healAmount} HP`):t.comboParts?.length?e.push(`${D("damage")} ${t.comboParts.map(o=>o.damage).join(" + ")}`):t.pellets&&t.pellets>1?e.push(`${D("damage")} ${t.damage} × ${t.pellets}`):t.damage>0&&e.push(`${D("damage")} ${t.damage}`);const a=C4(t.range);return a&&e.push(`${D("range")} ${a}`),e.push(`${D("timer")} ${(t.cooldown/1e3).toFixed(1)}s`),t.effect&&e.push(t.effect==="stun"?`${D("stun")} Stun`:`${D("slow")} Slow`),e}function O4(t){const e=Ee.filter(a=>a!==t);return e[Math.floor(Math.random()*e.length)]}function N4(t){la("fa-chars-styles",L4),ha();const e=Fe("div","fa-screen fa-chars"),a=Kl();let o=t.profile.selected;e.innerHTML=`
    <header class="fa-topbar">
    ...
    <div class="fa-confetti-layer" data-el="confetti"></div>
  `;const n=T=>{const S=e.querySelector(`[data-el="${T}"]`);if(!S)throw new Error(`characterSelect: missing element "${T}"`);return S},s=n("roster"),i=n("stats"),r=n("abilities"),l=n("hero3d"),h=n("heroname"),c=n("herorarity"),d=n("select"),p=n("level"),u=n("confetti"),f=new Map;for(const T of Ee){const S=re[T],R=Fe("button","chars-card");R.type="button",R.dataset.char=T,R.style.setProperty("--card-bg",Hl[S.rarity]),R.style.setProperty("--rarity",Nt[S.rarity]),R.style.setProperty("--rarity-glow",_0(Nt[S.rarity],.75)),I4.has(S.rarity)&&R.classList.add("is-animated"),R.innerHTML=`
    ...
    `,R.addEventListener("click",()=>k(T,!0)),s.appendChild(R),f.set(T,R)}const m=(T,S)=>{const R=f.get(T),F=R?.querySelector('[data-el="render"]');F&&(F.src=S,R.classList.add("has-render"))};for(const T of Ee){const S=Ql(T);S&&m(T,S)}W0(m);const g=Fe("div","chars-card chars-card--locked");g.innerHTML=`
    <span class="chars-card-art">${D("lock")}</span>
    <span class="chars-card-name">More soon</span>
  `,s.appendChild(g);const w=new Map;for(const T of e0){const S=Fe("div","fa-stat ds-row ds-row--slate chars-stat");S.style.setProperty("--ds-row-accent",T.color),S.innerHTML=`
    ...
    `,w.set(T.key,S.querySelector(".ds-row-val")),i.appendChild(S)}function b(){const T=o,S=t.profile.characterLevel(T),R=t.profile.nextLevelPrice(T),F=t.profile.canLevelUp(T),A=R===null,C=nl(T,sl,S),N=Zr(S),L=A?C:nl(T,sl,S+1),P=A?N:Zr(S+1),j=A?"":`
      ...
      <div class="chars-lv-head">
        <span class="chars-lv-badge${A?" is-max":""}">Lv ${S}${A?"":` / ${Jr}`}</span>
      ...
      ${j}
      <button class="ds-btn ds-btn--block chars-lv-btn" type="button" data-el="upgrade"${A||!F?" disabled":""}>${A?`${D("star")} Max level`:`${D("sparkle")} Upgrade <span class="chars-lv-price">${D("coin")} ${R.coins.toLocaleString()}</span>`}</button>
      ${A||F?"":`<span class="chars-lv-short">${(R.coins-t.profile.coins).toLocaleString()} more coins needed</span>`}
    `}function y(){const T=t.profile.selected;for(const[R,F]of f)F.classList.toggle("is-playing",R===T);const S=o===T;d.innerHTML=S?`${D("star")} Equipped`:`${D("star")} Equip`,d.classList.toggle("is-equipped",S),d.disabled=S}function k(T,S=!1){o=T;const R=re[T];for(const[F,A]of f)A.classList.toggle("is-viewed",F===T);S&&f.get(T)?.scrollIntoView({block:"nearest"}),h.textContent=R.name,c.textContent=R.rarity,c.style.background=Nt[R.rarity];for(const F of e0)w.get(F.key).textContent=String(R.stats[F.key]);r.innerHTML="";for(const F of $m(R)){const A=F.weapon,C=Fe("div","chars-ability");C.innerHTML=`
        <span class="chars-ability-em">${Y0(F.emoji)}</span>
        <span class="chars-ability-body">
          <span class="chars-ability-name">${F.name}</span>
          <span class="chars-ability-desc">${F.desc}</span>
          ${A?`<span class="chars-ability-facts">${F4(A).map(N=>`<span class="chars-fact">${N}</span>`).join("")}</span>`:""}
        </span>
      `,r.appendChild(C)}if(R.hasTrail){const F=Fe("div","chars-ability chars-ability--passive");F.innerHTML=`
      ...
      `,r.appendChild(F)}r.scrollTop=0,a.show(T),y(),b()}n("back").addEventListener("click",()=>t.navigate({name:"home"})),d.addEventListener("click",()=>{t.profile.select(o),y(),qs(u,50,24),a.poke()}),n("fight").addEventListener("click",()=>{t.profile.select(o),t.navigate({name:"match",player:o,enemy:O4(o)})});function x(){for(const[T,S]of f){const R=t.profile.characterLevel(T),F=S.querySelector('[data-el="lv"]');F&&(F.textContent=R>1?`Lv ${R}`:"",S.classList.toggle("has-lv",R>1),S.classList.toggle("is-maxed",R>=Jr))}}function M(){n("wins").textContent=String(t.profile.wins),n("coins").textContent=t.profile.coins.toLocaleString()}p.addEventListener("click",T=>{!T.target.closest('[data-el="upgrade"]')||!t.profile.levelUp(o)||(qs(u,34,18),a.poke())});const v=t.profile.onChange(()=>{M(),x(),b()});return M(),x(),k(o),a.attachTo(l),{root:e,update(T){a.update(T)},resize(){a.resize()},dispose(){v(),a.detach(),e.remove()}}}const L4=`
...
`,t0=["Normal","Rare","Epic","Legendary","Neon","Cyber"],D4=(()=>{const t=ra.map(a=>{const o=An(a).filter(r=>r.rarity);let n=null,s=-1,i=0;for(const r of o)i+=r.percent,r.percent>s&&(s=r.percent,n=r.rarity??null);return{kind:a,floor:n,charShare:i}});t.sort((a,o)=>{const n=a.floor?t0.indexOf(a.floor):-1,s=o.floor?t0.indexOf(o.floor):-1;return n-s||a.charShare-o.charShare});const e={};return t.forEach((a,o)=>{e[a.kind]={rank:o+1,of:t.length,floor:a.floor}}),e})();function Kr(t,e={}){const a=D4[t];if(!a)return"";const o=a.floor?Nt[a.floor]:"var(--ink)",n=Array.from({length:a.of},(i,r)=>`<i class="tr-pip${r<a.rank?" is-on":""}"></i>`).join(""),s=`Tier ${a.rank} of ${a.of}${a.floor?`, ${a.floor} or rarer`:""}`;return`<span class="tr-tier" style="--pip:${o}" role="img" aria-label="${s}">${n}${e.label&&a.floor?`<span class="tr-tier-txt">${a.floor}+</span>`:""}</span>`}function z4(t){la("fa-trophy-styles",H4),ha();const e=Fe("div","fa-screen fa-tr"),a=t.profile;e.innerHTML=`
    <header class="fa-topbar">
      <button class="fa-iconbtn" type="button" data-el="back" aria-label="Back to home">${D("back")} Back</button>
    ...
    <div class="fa-confetti-layer" data-el="confetti"></div>
  `;const o=A=>{const C=e.querySelector(`[data-el="${A}"]`);if(!C)throw new Error(`trophyRoad: missing element "${A}"`);return C},n=o("road"),s=o("inventory"),i=o("sheet"),r=o("sheetcard"),l=o("confetti"),h=o("claimall"),c=o("delta");function d(A=!1){const C=a.trophies;a.unlocked;const N=new Set(a.economy.claimed);n.innerHTML="";const L=Fe("div","tr-roadtrack"),P=Fe("div","tr-spine"),j=Fe("div","tr-spine-fill");P.appendChild(j),L.appendChild(P);let z=!1;const Y=()=>{const _=Fe("div","tr-pin");_.dataset.el="pin",_.innerHTML=`
        <span class="tr-pin-dot">${D("pin")}</span>
        <span class="tr-pin-label">${C.toLocaleString()}</span>
      `,L.appendChild(_),z=!0};let O=0;for(const _ of og()){!z&&C<_.trophies&&Y();const H=f(_,C,N.has(_.trophies));H.classList.add(O%2===0?"is-high":"is-low"),L.appendChild(H),O++}z||Y(),n.appendChild(L),_o(L),p(),A&&u()}function p(){const A=n.querySelector(".tr-roadtrack"),C=n.querySelector(".tr-spine"),N=n.querySelector(".tr-spine-fill"),L=n.querySelector('[data-el="pin"]');if(!A||!C||!N||!L)return;N.style.width=`${Math.max(0,L.offsetLeft+L.offsetWidth/2)}px`;const P=C.getBoundingClientRect();if(P.height===0)return;const j=P.top+P.height/2;for(const z of A.querySelectorAll(".tr-node")){const Y=z.getBoundingClientRect(),O=z.classList.contains("is-high")?j-Y.bottom:Y.top-j;z.style.setProperty("--stem",`${Math.max(0,Math.round(O))}px`)}}function u(){const A=n.querySelector('[data-el="pin"]');!A||n.clientWidth===0||(n.scrollLeft=Math.max(0,A.offsetLeft-n.clientWidth/2+A.offsetWidth/2))}function f(A,C,N,L){const P=hl(A.reward),z=C>=A.trophies&&!N,Y=z?Fe("button","tr-node is-claimable"):Fe("div","tr-node");if(z&&(Y.type="button"),N&&Y.classList.add("is-claimed"),P.isCharacter&&Y.classList.add("is-character"),Y.dataset.trophies=String(A.trophies),A.reward.type==="character"){const _=Nt[re[A.reward.id].rarity];Y.style.setProperty("--node-accent",_),Y.style.setProperty("--node-glow",_0(_,.55))}const O=N?`<span class="tr-status is-done">${D("check")} Claimed</span>`:z?'<span class="tr-status is-ready">Claim</span>':`<span class="tr-status">${(A.trophies-C).toLocaleString()} to go</span>`;return Y.innerHTML=`
      <span class="tr-node-req">${D("trophy")} ${A.trophies.toLocaleString()}</span>
      <span class="tr-node-medal"><span class="tr-node-em">${A.reward.type==="character"?Ea(A.reward.id,{crop:"head"}):A.reward.type==="container"?At(A.reward.kind):ya(P.emoji)}</span>${N?`<span class="tr-node-tick">${D("check")}</span>`:""}</span>
      <span class="tr-node-title">${P.title}</span>
      ${A.reward.type==="container"?Kr(A.reward.kind):""}
      ${P.payoutNote?`<span class="tr-node-note">${P.payoutNote.replace("🪙",D("coin"))}</span>`:""}
      ${O}
    `,Y}function m(){o("coins").textContent=a.coins.toLocaleString(),o("gems").textContent=a.gems.toLocaleString(),o("trophies").textContent=a.trophies.toLocaleString();const A=S0(a.trophies),C=o("fill");C.style.width=`${(A.progress01*100).toFixed(1)}%`;const N=a.claimable.length;if(N>0)o("nextlabel").textContent="Ready now",o("nextval").innerHTML=N>1?`${D("sparkle")} ${N} road rewards to claim`:`${D("sparkle")} 1 road reward — tap it on the track`;else if(A.next){const L=A.next.reward,P=hl(L,a.unlocked),j=A.next.trophies-a.trophies;o("nextlabel").textContent="Next reward",o("nextval").innerHTML=`${L.type==="character"?Ea(L.id,{crop:"head"}):L.type==="container"?At(L.kind):ya(P.emoji)} ${P.title} <span class="tr-togo">${D("trophy")} ${j.toLocaleString()} to go</span>`}else o("nextlabel").textContent="Road complete",o("nextval").innerHTML=`${D("flag")} Master of the Kitchen`;o("fillxp").textContent=A.next?`${(a.trophies-A.from).toLocaleString()} / ${(A.to-A.from).toLocaleString()}`:`Road complete — ${ll().toLocaleString()}`,h.style.display=N>1?"":"none",h.innerHTML=`${D("sparkle")} Claim ${N}`,g()}function g(){s.innerHTML="";const A=ra.filter(C=>(a.containers[C]??0)>0);if(A.length===0){const C=a.winsToNextChest,N=Fe("p","tr-inv-empty");N.innerHTML=`${D("chest")} <strong>${C}</strong> more ${C===1?"win":"wins"} for a free Chest`,s.appendChild(N);return}for(const C of A){const N=Pe[C],L=a.containers[C]??0,P=Fe("button","tr-open");P.type="button",P.dataset.open=C,P.innerHTML=`
        <span class="tr-open-em">${At(C)}</span>
        <span class="tr-open-body">
          <span class="tr-open-name">${N.name}</span>
          <span class="tr-open-cta">Open ${Kr(C)}</span>
        </span>
        <span class="tr-open-count">${L}</span>
      `,s.appendChild(P)}}function w(A,C="wide"){r.innerHTML=A,r.classList.toggle("is-reveal",C==="reveal"),i.classList.add("is-open")}function b(){i.classList.remove("is-open"),r.innerHTML=""}function y(A){const C=[];for(const N of A.characters)C.push(Ea(N,{crop:"head"}));for(const[N,L]of Object.entries(A.containers))L&&C.push(At(N));return A.coins>0&&C.push(D("coin")),A.gems>0&&C.push(D("gem")),C}function k(A,C){const N=Zm(A);if(N.length===0)return;const L=y(A),[P,...j]=N;w(`
      <div class="tr-reveal">
        <div class="tr-reveal-em">${L[0]??ya(P.emoji)}</div>
        <p class="tr-reveal-kicker">${C}</p>
        <p class="tr-reveal-name">${P.label}</p>
        ${j.length>0?`<div class="tr-reveal-more">${j.map((z,Y)=>`<span class="tr-reveal-chip">${L[Y+1]??ya(z.emoji)} ${z.label}</span>`).join("")}</div>`:""}
        <button class="fa-btn fa-btn--primary tr-sheet-close" type="button" data-el="close">Nice!</button>
      </div>
    `,"reveal"),_o(r),qs(l,50,28)}function x(){const A=ra.map(C=>{const N=Pe[C],L=An(C).map(j=>`
        <li class="tr-odds-row">
          <span class="tr-odds-what">${j.rarity?`<i class="tr-odds-dot" style="background:${Nt[j.rarity]}"></i>`:""}${j.label}</span>
          <span class="tr-odds-pct">${M0(j.percent)}</span>
        </li>
      `).join(""),P=An(C).filter(j=>j.pool&&j.pool.length>0).map(j=>`${j.rarity}: ${j.pool.map(z=>re[z].name).join(", ")}`).join(" · ");return`
        <section class="tr-odds-block">
          <h3 class="tr-odds-title">${At(C)} ${N.name} ${Kr(C,{label:!0})}</h3>
      ...
      <div class="fa-scroll tr-sheet-scroll">
        ...
        <p class="tr-sheet-note tr-sheet-note--rarity">${x0}</p>
        ${A}
      </div>
    `)}function M(){const A=ig().map(C=>{const N=lg(C),L=[];return C.coins&&L.push(`${D("coin")} ${C.coins.toLocaleString()}`),C.container&&L.push(`${At(C.container.kind)} ${Pe[C.container.kind].name}`),`
        <div class="tr-sku${C.oneTime?" is-featured":""}">
          ...
          <button class="tr-sku-buy" type="button" disabled>${`${rg(C.priceUsdCents)} · Soon`}</button>
        </div>
      `}).join("");w(`
      <div class="tr-sheet-head">
      ...
      <div class="fa-scroll tr-sheet-scroll">
        ...
        <div class="tr-skus">${A}</div>
      </div>
    `)}o("back").addEventListener("click",()=>t.navigate({name:"home"})),o("oddsbtn").addEventListener("click",x),o("storebtn").addEventListener("click",M),o("scrim").addEventListener("click",b),h.addEventListener("click",()=>{const A=a.claimAllMilestones();k(A,"You earned")});const v=A=>{const C=A.target;if(C.closest('[data-el="close"]')){b();return}const N=C.closest(".tr-node.is-claimable");if(N){const P=Number(N.dataset.trophies),j=a.claimMilestone(P);j&&k(j,"You earned");return}const L=C.closest("[data-open]");if(L){const P=L.dataset.open,j=a.openContainer(P);j&&k(j.reward,j.duplicateOf?`${re[j.duplicateOf].name} again — traded in`:`From a ${Pe[P].name}`)}};e.addEventListener("click",v);const T=A=>{A.key==="Escape"&&i.classList.contains("is-open")&&b()};window.addEventListener("keydown",T);const S=a.onChange(()=>{m(),d()});m(),d();let R=!1;requestAnimationFrame(()=>{R||(p(),u())});const F=a.lastMatch;if(F&&!F.seen){const A=F.trophies>0?"+":"";c.innerHTML=`${A}${F.trophies} ${D("trophy")}`,c.className=`tr-delta is-on ${F.trophies>0?"is-up":F.trophies<0?"is-down":"is-flat"}`,a.markLastMatchSeen()}return{root:e,resize(){d(),u()},dispose(){R=!0,S(),e.removeEventListener("click",v),window.removeEventListener("keydown",T),e.remove()}}}const H4=`
...
`,a0=Object.keys(No).sort((t,e)=>No[t]-No[e]);function _4(t,e){const a=Pe[t].entries,o=ui(a);return a.map(n=>{let s=n.coins??0;const i=n.gems??0;let r=null;return n.characterRarity&&((pi[n.characterRarity]??[]).some(h=>!e.has(h))?r=n.characterRarity:s+=No[n.characterRarity]),{chance01:o>0?n.weight/o:0,coins:s,gems:i,fighter:r}})}function Nf(t,e){const a=_4(t,e),o={canGrantFighter:!1,bestCoins:0,bestGems:0,expectedCoins:0,expectedGems:0,characterPercent:0,floorRarity:null};for(const s of a)s.fighter&&(o.canGrantFighter=!0),o.bestCoins=Math.max(o.bestCoins,s.coins),o.bestGems=Math.max(o.bestGems,s.gems),o.expectedCoins+=s.chance01*s.coins,o.expectedGems+=s.chance01*s.gems;const n=ui(Pe[t].entries);for(const s of Pe[t].entries){if(!s.characterRarity)continue;o.characterPercent+=n>0?s.weight/n*100:0;const i=a0.indexOf(s.characterRarity),r=o.floorRarity===null?1/0:a0.indexOf(o.floorRarity);i<r&&(o.floorRarity=s.characterRarity)}return o}function ko(t,e,a){const o=Pe[t].price;if(!o)return!1;const n=Nf(t,a);return n.canGrantFighter?!0:e==="coins"?n.bestCoins>o.coins:n.bestGems>o.gems}const P4=ra.filter(t=>Pe[t].price!==null);function $4(t){la("fa-shop-styles",B4),ha();const e=Fe("div","fa-screen fa-shop"),a=t.profile;e.innerHTML=`
    <header class="fa-topbar">
      <button class="fa-iconbtn" type="button" data-el="back" aria-label="Back to home">${D("back")} Back</button>
  ...
  `;const o=u=>{const f=e.querySelector(`[data-el="${u}"]`);if(!f)throw new Error(`shop: missing element "${u}"`);return f},n=o("scroll");function s(u){return`<ul class="shop-odds">${An(u).map(m=>`
      <li class="shop-odds-row">
        ...
        <span class="shop-odds-pct">${M0(m.percent)}</span>
      </li>`).join("")}</ul>`}function i(u){const f=An(u).filter(m=>m.rarity&&m.pool&&m.pool.length>0).map(m=>`<span class="shop-pool-line"><i class="shop-odds-dot" style="background:${Nt[m.rarity]}"></i>${m.pool.map(g=>re[g].name).join(", ")}</span>`).join("");return f?`<div class="shop-pool">${f}</div>`:""}function r(u,f){const m=Pe[u],g=m.price,w=Nf(u,f),b=w.canGrantFighter&&w.characterPercent>=99.999&&w.floorRarity?`<span class="shop-guarantee"><i class="shop-odds-dot" style="background:${Nt[w.floorRarity]}"></i>Always a fighter, ${w.floorRarity} or rarer</span>`:"",y=x=>{const M=x==="coins"?g.coins:g.gems,v=x==="coins"?a.coins:a.gems,T=D(x==="coins"?"coin":"gem"),S=ko(u,x,f),R=v>=M,F=S&&R,A=S?`You need ${(M-v).toLocaleString()} more ${x}`:"Not for sale right now";return`
        <button class="shop-buy shop-buy--${x}${F?"":" is-off"}" type="button"
          data-buy="${u}" data-currency="${x}"${F?"":` disabled title="${A}" aria-label="${M.toLocaleString()} ${x}. ${A}."`}>
          ${T} ${M.toLocaleString()}
        </button>`};let k="";if(!ko(u,"coins",f)&&!ko(u,"gems",f)){const x=w.bestGems===0,M=w.bestCoins<g.coins?`It pays back at most ${w.bestCoins.toLocaleString()} coins for a ${g.coins.toLocaleString()} coin price, and ${Math.round(w.expectedCoins).toLocaleString()} on average.`:`Its average return is ${Math.round(w.expectedCoins).toLocaleString()} coins against a ${g.coins.toLocaleString()} coin price.`;k=`
        <p class="shop-why">
        ...
        </p>`;else{const x=[...new Set(Pe[u].entries.flatMap(v=>v.characterRarity?pi[v.characterRarity]??[]:[]))],M=x.filter(v=>!f.has(v)).length;k=w.expectedCoins===0?`<p class="shop-why"><span class="shop-why-head">What you get</span>
            Every roll here is a new fighter. ${M} of the ${x.length} are still
      ...
      </section>`}function c(){const u=a.unlocked;o("coins").textContent=a.coins.toLocaleString(),o("gems").textContent=a.gems.toLocaleString();const f=P4.some(g=>ko(g,"coins",u)||ko(g,"gems",u)),m=f?"":`
      ...
      <section class="shop-section">
        ...
        <p class="shop-rarity">${x0}</p>
        <div class="shop-grid">${ra.map(g=>Pe[g].price?r(g,u):l(g)).join("")}</div>
      </section>
    `,o("footnote").textContent=f?"Coins and gems are earned by playing. Both work on every box.":"Boxes are earned, not bought:"}o("back").addEventListener("click",()=>t.navigate({name:"home"}));const d=u=>{const f=u.target,m=f.closest("[data-go]")?.dataset.go;if(m==="trophies"){t.navigate({name:"trophies"});return}if(m==="characters"){t.navigate({name:"characters"});return}const g=f.closest("[data-buy]");if(!g||g.disabled)return;const w=g.dataset.buy,b=g.dataset.currency;ko(w,b,a.unlocked)&&a.buyContainer(w,b)};e.addEventListener("click",d);const p=a.onChange(c);return c(),{root:e,dispose(){p(),e.removeEventListener("click",d),e.remove()}}}const B4=`
...
`,q4=null,o0="Open to a player",n0="Online play is not connected yet. This seat is played by a bot.";function U4(t){return`Online play is not connected yet, so ${t===1?"the other seat is":`all ${t} other seats are`} played by a bot. Opening a seat to another player is switched off rather than offered as a button that does nothing.`}function j4(t){la("fa-lobby-styles",W4),ha();const e=window.__faOpenSeat!==void 0?window.__faOpenSeat:q4,a=e!==null,o=t.profile.selected,n=G4(o);let s=Qh[0];const i=Fe("div","fa-screen fa-lobby");i.innerHTML=`
    <header class="fa-topbar">
      <button class="fa-iconbtn" type="button" data-el="back" aria-label="Back to home">${D("back")} Back</button>
  ...
  `;const r=g=>{const w=i.querySelector(`[data-el="${g}"]`);if(!w)throw new Error(`lobby: missing element "${g}"`);return w},l=r("seats"),h=r("opts"),c=r("note");for(const g of Qh){const w=Fe("button","ds-btn lobby-opt");w.type="button",w.dataset.seats=String(g),w.textContent=String(g),w.setAttribute("aria-label",`${g} players`),h.appendChild(w)}function d(){r("count").textContent=String(s);for(const g of h.querySelectorAll(".lobby-opt")){const w=Number(g.dataset.seats)===s;g.classList.toggle("is-on",w),g.setAttribute("aria-pressed",w?"true":"false")}}function p(){const g=b0(o,n,s),w=t.profile.characterLevel(o),b=R0(w);l.innerHTML=g.map((y,k)=>{const x=k===0,M=re[y].name,v=x?w:b,T=x?"You":"Bot",S=x?`<button class="ds-btn ds-btn--icon lobby-seat-act" type="button" data-el="swap"
             ...
             data-el="open" data-slot="${k}"${a?"":" disabled"}
             title="${o0}. ${n0}"
             aria-label="${o0} — seat ${k+1}. ${a?"":n0}">${D("avatar")}</button>`;return`
        <div class="lobby-seat${x?" is-you":""}" data-seat="${k}" data-char="${y}">
          ...
          <span class="lobby-seat-body">
            ...
            <span class="lobby-seat-tag"><b>${T}</b> · Lv ${v}</span>
          </span>
          ${S}
        </div>`}).join(""),_o(l)}function u(){c.textContent=a?"":U4(s-1),c.hidden=a}function f(){d(),p(),u()}const m=g=>{const w=g.target,b=w?.closest(".lobby-opt");if(b){const k=Number(b.dataset.seats);Number.isInteger(k)&&k!==s&&(s=k,f());return}const y=w?.closest('[data-el="open"]');if(y){e?.(Number(y.dataset.slot));return}if(w?.closest('[data-el="swap"]')){t.navigate({name:"characters"});return}w?.closest('[data-el="back"]')&&t.navigate({name:"home"})};return i.addEventListener("click",m),r("start").addEventListener("click",()=>{const g={name:"match",player:o,enemy:n,seats:di(s)};t.navigate(g)}),f(),{root:i,dispose(){i.removeEventListener("click",m),i.remove()}}}function G4(t){const e=Ee.filter(a=>a!==t);return e[Math.floor(Math.random()*e.length)]}const W4=`
...
`,Y4="admin panel is not enabled in this build — rebuild with VITE_FA_ADMIN=1, or run the dev server",Lf=["opening","home","characters","trophies","shop","settings","lobby","match"];function ii(t){return typeof t=="string"&&Ee.includes(t)}function V4(t){return typeof t=="number"?di(t):void 0}function K4(t){if(!t||typeof t!="object")return null;const e=t.name;if(typeof e!="string"||!Lf.includes(e))return null;if(e==="match"){const{player:a,enemy:o,seats:n}=t;return ii(a)&&ii(o)?{name:e,player:a,enemy:o,seats:V4(n)}:null}return{name:e}}function X4(t){const e=new URLSearchParams(t),a=e.get("screen");if(a===null||!Lf.includes(a))return null;if(a==="match"){const o=e.get("player"),n=e.get("enemy");return ii(o)&&ii(n)?{name:a,player:o,enemy:n,seats:Z4(e)}:null}return{name:a}}function Z4(t){const e=t.get("seats");return e===null?void 0:di(Number(e))}function Xr(t,e){return t.name!==e.name?!1:t.name==="match"&&e.name==="match"?t.player===e.player&&t.enemy===e.enemy&&t.seats===e.seats:!0}function s0(t){const e=new URLSearchParams(window.location.search);e.set("screen",t.name),t.name==="match"?(e.set("player",t.player),e.set("enemy",t.enemy),t.seats===void 0?e.delete("seats"):e.set("seats",String(t.seats))):(e.delete("player"),e.delete("enemy"),e.delete("seats"));const a=e.toString();return`${window.location.pathname}${a?`?${a}`:""}${window.location.hash}`}function J4(t,e){if(e!=="none")try{const a={fa:1,route:t};e==="push"?window.history.pushState(a,"",s0(t)):window.history.replaceState(a,"",s0(t))}catch{}}const Q4=3e3,eM=10,tM=140;function aM(t){Eg(),Ff();const e=document.createElement("div");e.className="fa-root",e.innerHTML=`
    <div class="fa-bg"></div>
    <div class="fa-rays"></div>
    <div class="fa-dots"></div>
    <div class="fa-stack" data-el="stack"></div>
    <div class="fa-curtain" data-el="curtain"></div>
  `,t.screenRoot.appendChild(e);const a=e.querySelector('[data-el="stack"]'),o=e.querySelector('[data-el="curtain"]'),n=t.profile??new H0;let s=null,i={name:"home"},r=0,l=0,h=!1,c=null,d=!1,p=null,u=0;function f($,ee){console.error(`[shell] ${$}:`,ee)}function m($){const ee=window.__shellFault;if(!ee)return!1;const ye=ee[$];return typeof ye!="number"||ye<=0?!1:(ee[$]=ye-1,!0)}const g={navigate:O,profile:n,gameHost:t.gameHost,hudRoot:t.hudRoot};function w($){if(m("build"))throw new Error(`__shellFault: build ${$.name}`);switch($.name){case"opening":return N1(g);case"home":return A1(g);case"characters":return N4(g);case"trophies":return z4(g);case"shop":return $4(g);case"settings":return A4(g);case"lobby":return j4(g);case"admin":throw new Error(Y4);case"match":return x4(g,$)}throw new Error(`unknown route "${String($.name)}"`)}function b(){r&&cancelAnimationFrame(r),r=0}function y(){b(),l=performance.now();const $=ee=>{if(d)return;const ye=Math.min(Math.max(0,(ee-l)/1e3),1/20);l=ee;try{if(m("update"))throw new Error("__shellFault: update");s?.update?.(ye),u=0}catch(Se){if(u++,u===1&&f(`screen "${i.name}" update() threw`,Se),u>=eM){f(`screen "${i.name}" update() threw ${u} frames running — stopping the menu loop`,Se),b();return}}r=requestAnimationFrame($)};r=requestAnimationFrame($)}function k($,ee){if($.name==="match")try{dc()}catch(Se){f("disposeCharacterStage() threw",Se)}try{$.name==="match"?ke.music.fadeOut():ke.music.fadeIn()}catch(Se){f("music transition threw",Se)}e.classList.toggle("is-ingame",$.name==="match");let ye;try{ye=w($)}catch(Se){P($,Se);return}i=$,s=ye,a.appendChild(ye.root),J4($,ee),A(),window.__screen=$.name,u=0,s.update?y():b(),$.name!=="match"&&(window.__previewReady=!1,requestAnimationFrame(()=>requestAnimationFrame(()=>{d||(window.__previewReady=!0)})))}function x($){$.style.cssText=["pointer-events:auto","background:#FFF3DE","color:#1a1224","border-radius:16px","padding:18px 22px","max-width:min(92vw,420px)","text-align:center","box-shadow:0 10px 30px rgba(0,0,0,0.45)","font-family:'Rubik',sans-serif"].join(";")}function M($){$.style.cssText=["position:absolute","inset:0","z-index:120","display:grid","place-items:center","padding:16px","background:rgba(20,13,30,0.72)","pointer-events:none"].join(";")}function v($){const ee=document.createElement("button");return ee.type="button",ee.textContent=$,ee.style.cssText=["min-height:44px","min-width:140px","margin-top:14px","padding:0 20px","border:0","border-radius:999px","background:#F4A300","color:#1a1224","font-family:'Rubik',sans-serif","font-weight:800","font-size:16px","cursor:pointer"].join(";"),ee.addEventListener("click",()=>window.location.reload()),ee}function T($){const ee=document.createElement("div");M(ee),ee.style.background="#16101f",ee.dataset.el="fa-fatal";const ye=document.createElement("div");x(ye);const Se=document.createElement("div");Se.textContent="The kitchen would not open",Se.style.cssText="font-weight:800;font-size:18px";const Ye=document.createElement("div");return Ye.textContent=String($?.message??$??"unknown error"),Ye.style.cssText="margin-top:8px;font-size:13px;opacity:0.75;font-family:'Heebo',sans-serif;word-break:break-word",ye.append(Se,Ye,v("Reload")),ee.appendChild(ye),ee}let S=null,R=null;function F(){if(d||S)return;const $=document.createElement("div");M($),$.dataset.el="fa-gl-notice";const ee=document.createElement("div");x(ee);const ye=document.createElement("div");ye.textContent="Graphics interrupted",ye.style.cssText="font-weight:800;font-size:18px";const Se=document.createElement("div");Se.textContent="The device took the graphics back. Restoring…",Se.style.cssText="margin-top:6px;font-size:14px;opacity:0.8;font-family:'Heebo',sans-serif";const Ye=v("Reload");Ye.style.display="none",ee.append(ye,Se,Ye),$.appendChild(ee),e.appendChild($),S=$,R=setTimeout(()=>{R=null,S&&(Se.textContent="The graphics have not come back. Reloading returns you to this same screen.",Ye.style.display="inline-block")},Q4)}function A(){R!==null&&(clearTimeout(R),R=null),S?.remove(),S=null}function C($){return $.detail?.offscreen===!0}function N($){C($)||F()}function L($){C($)||A()}function P($,ee){if(f(`screen "${$.name}" failed to mount`,ee),a.innerHTML="",$.name!=="home"){k({name:"home"},"replace");return}s=null,i={name:"home"},window.__screen="home",b(),a.appendChild(T(ee))}function j(){b();try{if(m("dispose"))throw new Error("__shellFault: dispose");s?.dispose()}catch($){f(`screen "${i.name}" dispose() threw`,$)}s=null,a.innerHTML=""}function z($){return i.name==="opening"||Xr($,i)?"replace":"push"}function Y($,ee){h=!0,window.__screenReady=!1,o.classList.add("is-on"),c=setTimeout(()=>{c=null;try{j(),k($,ee)}catch(ye){f("navigation threw",ye)}finally{o.classList.remove("is-on"),h=!1,window.__screenReady=!0,H()}},tM)}function O($){d||h||Y($,z($))}const _=$=>{if(d)return;const ee=$.state,ye=K4(ee?.route)??X4(window.location.search)??{name:"home"};if(!Xr(ye,i)){if(h){p=ye;return}Y(ye,"none")}};function H(){const $=p;p=null,!(!$||d||Xr($,i))&&Y($,"none")}const K=()=>{try{s?.resize?.()}catch($){f(`screen "${i.name}" resize() threw`,$)}},ce='button, [role="button"], a[href], [data-clicksound="on"]',se=$=>{try{if(ke.isMuted())return;const ee=$.target?.closest?.(ce);if(!ee||ee.closest('[data-clicksound="off"]')||ee.hasAttribute("disabled")||ee.getAttribute("aria-disabled")==="true")return;ke.previewClick()}catch(ee){f("ui click sound threw",ee)}};return e.addEventListener("click",se,!0),window.addEventListener("resize",K),window.addEventListener("popstate",_),window.addEventListener("fa:webglcontextlost",N),window.addEventListener("fa:webglcontextrestored",L),window.__shell={navigate:O,route:()=>i},{navigate($){if(!s){k($,$.name==="opening"?"none":"replace"),window.__screenReady=!0;return}O($)},get route(){return i},dispose(){d=!0,c!==null&&clearTimeout(c),e.removeEventListener("click",se,!0),window.removeEventListener("resize",K),window.removeEventListener("popstate",_),window.removeEventListener("fa:webglcontextlost",N),window.removeEventListener("fa:webglcontextrestored",L),A(),j(),dc(),e.remove(),delete window.__shell}}}const St=new URLSearchParams(location.search),oM=["player","enemy","simSpeed","fogRadius","px","py","fighters","seats"];function i0(t,e){const a=St.get(t);return a&&Ee.includes(a)?a:e}function nM(t){if(St.get("screen")==="match"||!St.has("screen")&&oM.some(a=>St.has(a))){const a=i0("player",t.selected),o=a==="donut"?"hamburger":"donut",n=Gm(St);return{name:"match",player:a,enemy:i0("enemy",o),seats:n}}return St.get("screen")==="lobby"?{name:"lobby"}:St.get("screen")==="characters"?{name:"characters"}:St.get("screen")==="trophies"?{name:"trophies"}:St.get("screen")==="shop"?{name:"shop"}:St.get("screen")==="settings"?{name:"settings"}:St.get("screen")==="home"?{name:"home"}:{name:"opening"}}const Df=new H0,sM=aM({gameHost:document.getElementById("game"),hudRoot:document.getElementById("hud"),screenRoot:document.getElementById("screens"),profile:Df});sM.navigate(nM(Df));ke.music.play();const iM=document.getElementById("boot");requestAnimationFrame(()=>iM.classList.add("hidden"));
