import{C as re,l as Br,c as Ta,L as no,a as Ee,t as Na,b as jr,V as pe,d as Q,S as Tl,e as Me,M as U,f as Qe,R as et,B as Dh,g as E,h as xa,i as Cs,j as nt,k as Gr,m as Sl,G as ie,P as Qa,n as Y,o as Rt,p as Al,q as vn,O as yf,Z as zh,A as Hh,r as xf,s as vf,N as kf,u as Wr,v as Bp,w as jp,x as Rl,y as Kt,z as Gt,D as Ot,E as Ea,F as Le,H as be,I as Cn,J as Mf,K as Ef,Q as Ze,T as Tf,U as Sf,W as Af,X as Gp,Y as Wp,_ as _h,$ as Ur,a0 as Rf,a1 as If,a2 as Ff,a3 as It,a4 as Cf,a5 as Up,a6 as Of,a7 as Nf,a8 as Lf,a9 as Yp,aa as Df,ab as zf,ac as vs,ad as Ph,ae as $h,af as kn,ag as Hf,ah as Jo,ai as Ri,aj as _f,ak as Pf,al as Ii,am as qh,an as Yr,ao as $f,ap as Os,aq as qf,ar as Bf,as as Vr,at as jf,au as Kr,av as Gf,aw as Wf,ax as Uf,ay as Yf,az as Ns,aA as Xr,aB as Vf,aC as Kf,aD as Xf,aE as Zf,aF as Il,aG as st,aH as jo,aI as ti,aJ as at,aK as Ua,aL as Fl,aM as Cl,aN as ai,aO as so,aP as Ol,aQ as Ya,aR as Ut,aS as io,aT as Vp,aU as Nl,aV as Sa,aW as Jf,aX as Qf,aY as ja,aZ as em,a_ as Bh,a$ as Qo,b0 as Ls,b1 as Fi,b2 as tm,b3 as am,b4 as om,b5 as nm,b6 as sm,b7 as im,b8 as rm,b9 as jh,ba as lm,bb as hm,bc as cm,bd as dm,be as Ci,bf as pm,bg as um,bh as fm,bi as mm,bj as gm,bk as wm}from"./kitchen-4LIrPAvw.js";const zt=6,ot=2;function bm(t){return t===0?"player":"enemy"}function ym(t){return 1<<t}function xm(t){const{id:e,controller:a,characterId:o,spawn:n,maxHp:s,size:i,hitRadius:r,facing:l}=t,h=re[o].weapons.length,c=Ta(t.level??no);return{id:e,controller:a,role:bm(e),characterId:o,level:c,damageMul:Br(c),x:n.x,y:n.y,hp:s,maxHp:s,size:i,hitRadius:r,facing:{x:l.x,y:l.y},status:{slowedUntil:-1/0,stunnedUntil:-1/0,slowAppliedAt:-1/0,slowStacks:0,stunAppliedAt:-1/0,stunStacks:0},alive:!0,deaths:0,lastUsed:new Array(h).fill(-1/0),hazardTimers:[],fogTimer:0,regenTimer:0,trailDropTimer:0,detourSign:0,lastDamagedAt:-1/0,terrainSlowFactor:1,concealed:!1,revealedUntil:-1/0,cast:null,push:{x:0,y:0,remaining:0}}}function Kp(t){return t.cast!==null}function Ll(t,e){return e<t.status.stunnedUntil||t.cast!==null}function Xp(t){return t==="player"?"enemy":"player"}function oi(t,e){return t!==e&&t.alive&&t.hp>0}function Zp(t,e){let a=null,o=1/0;for(const n of t.fighters){if(!oi(n,e))continue;const s=Math.hypot(n.x-e.x,n.y-e.y);s<o&&(o=s,a=n)}return a}function vm(t){let e=null;for(const a of t.fighters)if(!(!a.alive||a.hp<=0)){if(e!==null)return null;e=a}return e}function Zr(t,e,a){return t*a+e}function km(t){const e=t.get("seats");if(e!==null)return ni(Number(e))}function ni(t){if(Number.isInteger(t)&&!(t<=ot||t>zt))return t}const Gh=Array.from({length:zt-ot+1},(t,e)=>ot+e);function Jp(t,e,a){if(!Number.isInteger(a)||a<ot||a>zt)throw new RangeError(`brawlRoster: ${a} seats; the sim seats ${ot}..${zt} (see state.ts MIN_FIGHTERS / MAX_FIGHTERS)`);const o=[t];a>1&&o.push(e);const n=Ee.indexOf(t);for(let s=1;o.length<a&&s<=Ee.length;s++){const i=Ee[(n+s)%Ee.length];o.includes(i)||o.push(i)}if(o.length!==a||new Set(o).size!==a)throw new RangeError(`brawlRoster: built ${o.length} seats (${new Set(o).size} distinct) for ${a} from ${Ee.length} characters — [${o.join(", ")}]`);return o}const Wh={coins:500,gems:25},Mm=!1,Qp=Ee[0],ct={trophiesWin:Na("MATCH_PAYOUT.trophiesWin",15,{group:"economy",unit:"trophies",min:0,max:200,int:!0,doc:"Trophies for first place. The whole placement curve is stated relative to this — see the placement block below."}),trophyLossBase:Na("MATCH_PAYOUT.trophyLossBase",2,{group:"economy",unit:"trophies",min:0,max:100,int:!0,doc:"Flat part of a loss. Loss = min(cap, base + floor(trophies / per))."}),trophyLossPer:Na("MATCH_PAYOUT.trophyLossPer",150,{group:"economy",unit:"trophies",min:1,max:1e4,int:!0,doc:"Trophies per extra point of loss — the escalation rate. A DIVISOR: smaller is harsher."}),trophyLossCap:Na("MATCH_PAYOUT.trophyLossCap",10,{group:"economy",unit:"trophies",min:0,max:200,int:!0,doc:"Ceiling on a single loss, however many trophies are held."}),trophyLossGraceBelow:Na("MATCH_PAYOUT.trophyLossGraceBelow",100,{group:"economy",unit:"trophies",min:0,max:1e4,int:!0,doc:"Below this standing a loss costs nothing — the first hour must not read as standing still."}),coinsWin:Na("MATCH_PAYOUT.coinsWin",60,{group:"economy",unit:"coins",min:0,max:1e4,int:!0,doc:"Coins for a win. The 3:1 ratio against coinsLoss is the design statement, not either number alone."}),coinsLoss:Na("MATCH_PAYOUT.coinsLoss",20,{group:"economy",unit:"coins",min:0,max:1e4,int:!0,doc:"Coins for a loss. Always non-zero: a losing streak must not feel like a waste of ten minutes."}),winsPerChest:3,placementSteepness:1},Fo={Normal:120,Rare:260,Epic:520,Legendary:900,Neon:1400,Cyber:2200},en={baseCoins:300,growth:1.32,rarityCostMultiplier:{Normal:1,Rare:1,Epic:1,Legendary:1,Neon:1,Cyber:1},roundTo:10},ra=["chest","hamburgerBox","pineappleBox","redBox","fireBox"],e0="Rarity sets how hard a fighter is to find — not how strong it is, and not what it costs to level up. Two fighters at the same level are a fair fight whatever their rarity.",Pe={chest:{name:"Chest",emoji:"📦",blurb:"Earned by winning matches and along the Trophy Road.",price:null,entries:[{weight:50,coins:120},{weight:22,coins:220},{weight:13,coins:90,gems:5},{weight:8,coins:400},{weight:4,coins:150,gems:20},{weight:2.1,characterRarity:"Normal"},{weight:.9,characterRarity:"Rare"}]},hamburgerBox:{name:"Hamburger Box",emoji:"🍔",blurb:"Mostly Normal fighters, with a chance of something rarer.",price:{coins:900,gems:60},entries:[{weight:89,characterRarity:"Normal"},{weight:10,characterRarity:"Rare"},{weight:1,characterRarity:"Epic"}]},pineappleBox:{name:"Purple Pineapple Box",emoji:"🍍",blurb:"Rare fighters guaranteed, Epic and Legendary possible.",price:{coins:3200,gems:120},entries:[{weight:94.5,characterRarity:"Rare"},{weight:5,characterRarity:"Epic"},{weight:.5,characterRarity:"Legendary"}]},redBox:{name:"Big Smile Box",emoji:"🎁",blurb:"Epic fighters, with the only Cyber chance outside the Fire Box.",price:{coins:5600,gems:240},entries:[{weight:89.49,characterRarity:"Epic"},{weight:10,characterRarity:"Legendary"},{weight:.5,characterRarity:"Neon"},{weight:.01,characterRarity:"Cyber"}]},fireBox:{name:"Purple Fire Box",emoji:"🔥",blurb:"Legendary fighters, with the best Neon and Cyber odds in the game.",price:{coins:12e3,gems:480},entries:[{weight:94.5,characterRarity:"Legendary"},{weight:5,characterRarity:"Neon"},{weight:.5,characterRarity:"Cyber"}]}},na=[{trophies:10,reward:{type:"container",kind:"chest",count:1}},{trophies:25,reward:{type:"coins",amount:150}},{trophies:42,reward:{type:"gems",amount:5}},{trophies:60,reward:{type:"character",id:"donut"}},{trophies:85,reward:{type:"container",kind:"hamburgerBox",count:1}},{trophies:107,reward:{type:"coins",amount:250}},{trophies:130,reward:{type:"character",id:"taco"}},{trophies:160,reward:{type:"gems",amount:10}},{trophies:190,reward:{type:"container",kind:"chest",count:1}},{trophies:220,reward:{type:"character",id:"burrito"}},{trophies:260,reward:{type:"coins",amount:400}},{trophies:300,reward:{type:"container",kind:"hamburgerBox",count:1}},{trophies:345,reward:{type:"character",id:"soup"}},{trophies:400,reward:{type:"gems",amount:20}},{trophies:455,reward:{type:"container",kind:"chest",count:1}},{trophies:510,reward:{type:"character",id:"sushi"}},{trophies:580,reward:{type:"coins",amount:700}},{trophies:650,reward:{type:"container",kind:"pineappleBox",count:1}},{trophies:725,reward:{type:"character",id:"waterbottle"}},{trophies:815,reward:{type:"gems",amount:35}},{trophies:905,reward:{type:"container",kind:"chest",count:1}},{trophies:1e3,reward:{type:"character",id:"pizza"}},{trophies:1105,reward:{type:"coins",amount:1200}},{trophies:1220,reward:{type:"container",kind:"redBox",count:1}},{trophies:1340,reward:{type:"character",id:"egg"}},{trophies:1485,reward:{type:"gems",amount:60}},{trophies:1630,reward:{type:"container",kind:"pineappleBox",count:1}},{trophies:1780,reward:{type:"character",id:"lollipop"}},{trophies:1980,reward:{type:"coins",amount:2e3}},{trophies:2190,reward:{type:"container",kind:"redBox",count:1}},{trophies:2400,reward:{type:"character",id:"hotdog"}},{trophies:2650,reward:{type:"gems",amount:100}},{trophies:2900,reward:{type:"container",kind:"fireBox",count:1}},{trophies:3200,reward:{type:"bundle",parts:[{type:"coins",amount:5e3},{type:"gems",amount:150},{type:"container",kind:"fireBox",count:1}]}}],t0=[{id:"gemsPouch",name:"Pouch of Gems",emoji:"💎",priceUsdCents:99,gems:80},{id:"gemsSack",name:"Sack of Gems",emoji:"💎",priceUsdCents:499,gems:500},{id:"gemsCrate",name:"Crate of Gems",emoji:"💎",priceUsdCents:999,gems:1200},{id:"gemsBarrel",name:"Barrel of Gems",emoji:"💎",priceUsdCents:1999,gems:2600},{id:"gemsVault",name:"Vault of Gems",emoji:"💎",priceUsdCents:4999,gems:7e3},{id:"starterBundle",name:"Chef Starter Pack",emoji:"🧑‍🍳",priceUsdCents:499,gems:500,coins:2e3,container:{kind:"pineappleBox",count:1},oneTime:!0}],si=(()=>{const t={};for(const e of Ee){const a=re[e].rarity;(t[a]??=[]).push(e)}return t})();function Em(t){let e=t>>>0;return e=Math.imul(e^e>>>16,569420461),e=Math.imul(e^e>>>15,1935289751),(e^e>>>15)>>>0}function Tm(t){let e=Em(Math.trunc(t)||0);const a=()=>{e=e+1831565813>>>0;let o=e;return o=Math.imul(o^o>>>15,o|1),o^=o+Math.imul(o^o>>>7,o|61),((o^o>>>14)>>>0)/4294967296};return{next:a,int(o){return o>0?Math.floor(a()*o):0},pick(o){return o.length>0?o[Math.floor(a()*o.length)]:void 0}}}function Sm(t,e,a){if(e.length===0)return-1;const o=t.next()*a;let n=0;for(let s=0;s<e.length;s++)if(n+=e[s],o<n)return s;return e.length-1}function Am(){return Math.floor(Math.random()*4294967295)>>>0||1}function Dl(){return{coins:0,gems:0,containers:{},characters:[]}}function ks(t,e){return e===1?t:/[sxz]$/i.test(t)?`${t}es`:`${t}s`}function a0(t,e){t.coins+=e.coins,t.gems+=e.gems;for(const[a,o]of Object.entries(e.containers))t.containers[a]=(t.containers[a]??0)+o;for(const a of e.characters)t.characters.includes(a)||t.characters.push(a);return t}function Rm(t){const e=[];for(const a of t.characters)e.push({emoji:re[a].emoji,label:re[a].name});for(const[a,o]of Object.entries(t.containers)){if(!o)continue;const n=Pe[a];e.push({emoji:n.emoji,label:o>1?`${o} ${ks(n.name,o)}`:n.name})}return t.coins>0&&e.push({emoji:"🪙",label:`${t.coins.toLocaleString()} ${ks("Coin",t.coins)}`}),t.gems>0&&e.push({emoji:"💎",label:`${t.gems.toLocaleString()} ${ks("Gem",t.gems)}`}),e}function ii(t){return t.reduce((e,a)=>e+a.weight,0)}function Mn(t){const e=Pe[t],a=ii(e.entries);if(a<=0)return[];const o=[];for(const s of e.entries){const i=s.weight/a*100;if(s.characterRarity){const r=si[s.characterRarity]??[];o.push({label:`${s.characterRarity} fighter`,percent:i,rarity:s.characterRarity,pool:r})}else{const r=[];s.coins&&r.push(`${s.coins.toLocaleString()} coins`),s.gems&&r.push(`${s.gems.toLocaleString()} gems`),o.push({label:r.join(" + ")||"Nothing",percent:i})}}const n=new Map;for(const s of o){const i=n.get(s.label);i?i.percent+=s.percent:n.set(s.label,{...s})}return[...n.values()].sort((s,i)=>i.percent-s.percent)}function o0(t){return`${t.toFixed(4).replace(/0+$/,"").replace(/\.$/,"")}%`}function Im(t,e,a){const o=Pe[t],n=ii(o.entries),s=o.entries[Sm(e,o.entries.map(r=>r.weight),n)],i=Dl();if(!s)return{kind:t,reward:i};if(s.coins&&(i.coins+=s.coins),s.gems&&(i.gems+=s.gems),s.characterRarity){const r=si[s.characterRarity]??[],l=r.filter(h=>!a.has(h));if(l.length>0){const h=e.pick(l);i.characters.push(h)}else{const h=e.pick(r);if(i.coins+=Fo[s.characterRarity],h)return{kind:t,reward:i,duplicateOf:h}}}return{kind:t,reward:i}}function n0(t){return Fo[re[t].rarity]}function Fm(t){return t<ct.trophyLossGraceBelow?0:Math.min(ct.trophyLossCap,ct.trophyLossBase+Math.floor(t/ct.trophyLossPer))}function ri(t,e){if(!Number.isInteger(e)||e<ot||e>zt)throw new RangeError(`placementRank01: ${e} seats; the sim seats ${ot}..${zt} (see game/state.ts MIN_FIGHTERS / MAX_FIGHTERS)`);if(!Number.isInteger(t)||t<0||t>=e)throw new RangeError(`placementRank01: place ${t} is outside 0..${e-1}`);return t/(e-1)}function zl(t,e=ct.placementSteepness){return t<=0?0:t>=1?1:Math.pow(t,e)}function Cm(t,e,a,o){const n=zl(ri(t,e),o),s=ct.trophiesWin+Fm(a);return Math.round(ct.trophiesWin-n*s)}function Om(t,e,a){const o=zl(ri(t,e),a);return Math.round(ct.coinsWin-o*(ct.coinsWin-ct.coinsLoss))}function Nm(t,e){return ri(t,e)<.5}function Lm(){return na}function Jr(){return na.length>0?na[na.length-1].trophies:0}function s0(t,e){return na.filter(a=>t>=a.trophies&&!e.includes(a.trophies))}function Dm(t){return na.find(e=>t<e.trophies)??null}function i0(t){const e=Dm(t);if(!e)return{from:Jr(),to:Jr(),progress01:1,next:null};const a=na.indexOf(e),o=a>0?na[a-1].trophies:0,n=e.trophies-o,s=n>0?Math.min(1,Math.max(0,(t-o)/n)):0;return{from:o,to:e.trophies,progress01:s,next:e}}function r0(t,e){const a=Dl();switch(t.type){case"coins":a.coins+=t.amount;break;case"gems":a.gems+=t.amount;break;case"container":a.containers[t.kind]=(a.containers[t.kind]??0)+t.count;break;case"character":a.coins+=n0(t.id);break;case"bundle":for(const o of t.parts)a0(a,r0(o));break}return a}function Qr(t,e){switch(t.type){case"coins":return{emoji:"🪙",title:`${t.amount.toLocaleString()} Coins`,isCharacter:!1};case"gems":return{emoji:"💎",title:`${t.amount.toLocaleString()} Gems`,isCharacter:!1};case"container":{const a=Pe[t.kind];return{emoji:a.emoji,title:t.count>1?`${t.count} ${ks(a.name,t.count)}`:a.name,isCharacter:!1}}case"character":{const a=re[t.id],o=Mm;return{emoji:a.emoji,title:a.name,isCharacter:!0,payoutNote:o?void 0:`owned · 🪙 ${n0(t.id).toLocaleString()}`}}case"bundle":return{emoji:"🎉",title:"Grand Prize",isCharacter:!1}}}function zm(t,e){const a=Ta(e);if(a>=jr)return null;const o=a-no,n=en.baseCoins*Math.pow(en.growth,o)*en.rarityCostMultiplier[re[t].rarity];return{coins:Math.round(n/en.roundTo)*en.roundTo,gems:0}}function l0(t){return Ta(t)}function Hm(){return t0}function _m(t){return new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}).format(t/100)}function Uh(t){return t.priceUsdCents>0?t.gems/(t.priceUsdCents/100):0}function Pm(t){const e=t0.filter(n=>!n.oneTime&&n.gems>0),a=e.reduce((n,s)=>s.priceUsdCents<n.priceUsdCents?s:n,e[0]);if(!a||t.id===a.id)return 0;const o=Uh(t)/Uh(a);return Math.max(0,Math.round((o-1)*100))}function h0(){const t={};for(const e of ra)t[e]=0;return t}function c0(t=Am()){return{trophies:0,bestTrophies:0,coins:Wh.coins,gems:Wh.gems,containers:h0(),claimed:[],unlocked:[Qp],winsTowardChest:0,lastMatch:null,levels:{},seed:t,rolls:0}}function Hl(t){return new Set(Ee)}function $m(t,e){return!0}function d0(t,e){t.coins+=e.coins,t.gems+=e.gems;for(const[a,o]of Object.entries(e.containers))t.containers[a]=(t.containers[a]??0)+(o??0);for(const a of e.characters)t.unlocked.includes(a)||t.unlocked.push(a)}function el(t,e,a){return t.coins<e||t.gems<a?!1:(t.coins-=e,t.gems-=a,!0)}function qm(t,e,a){const o=Cm(e,a,t.trophies);t.trophies=Math.max(0,t.trophies+o),t.bestTrophies=Math.max(t.bestTrophies,t.trophies);const n=Om(e,a);t.coins+=n;let s=0;if(Nm(e,a)){for(t.winsTowardChest++;t.winsTowardChest>=ct.winsPerChest;)t.winsTowardChest-=ct.winsPerChest,s++;t.containers.chest+=s}const i={won:e===0,trophies:o,coins:n,chests:s,place:e,seats:a,seen:!1};return t.lastMatch=i,i}function Bm(t){return Math.max(0,ct.winsPerChest-t.winsTowardChest)}function p0(t){return s0(t.trophies,t.claimed)}function u0(t,e){const a=s0(t.trophies,t.claimed).find(n=>n.trophies===e);if(!a)return null;const o=r0(a.reward,Hl());return t.claimed.push(e),t.claimed.sort((n,s)=>n-s),d0(t,o),o}function jm(t){const e=Dl();for(const a of p0(t)){const o=u0(t,a.trophies);o&&a0(e,o)}return e}function Gm(t,e){if((t.containers[e]??0)<=0)return null;t.containers[e]--;const a=Tm(t.seed+t.rolls);t.rolls++;const o=Im(e,a,Hl());return d0(t,o.reward),o}function Wm(t){return ra.reduce((e,a)=>e+(t.containers[a]??0),0)}function Um(t,e,a){const o=Pe[e].price;return!o||!(a==="coins"?el(t,o.coins,0):el(t,0,o.gems))?!1:(t.containers[e]++,!0)}function _l(t,e){return Ta(t.levels[e]??no)}function Pl(t,e){return zm(e,_l(t,e))}function Ym(t,e){const a=Pl(t,e);return a!==null&&t.coins>=a.coins&&t.gems>=a.gems}function Vm(t,e){const a=Pl(t,e);if(!a||!el(t,a.coins,a.gems))return null;const o=Ta(_l(t,e)+1);return t.levels[e]=o,{level:o,spent:a}}function Km(t){const e=c0();if(!t||typeof t!="object")return e;const a=t,o=(s,i)=>typeof s=="number"&&Number.isFinite(s)&&s>=0?Math.floor(s):i,n={trophies:o(a.trophies,0),bestTrophies:o(a.bestTrophies,0),coins:o(a.coins,e.coins),gems:o(a.gems,e.gems),containers:h0(),claimed:[],unlocked:[Qp],winsTowardChest:o(a.winsTowardChest,0),lastMatch:null,levels:{},seed:o(a.seed,e.seed)||e.seed,rolls:o(a.rolls,0)};if(a.containers&&typeof a.containers=="object"){const s=a.containers;for(const i of ra)n.containers[i]=o(s[i],0)}if(Array.isArray(a.claimed)){const s=new Set(na.map(r=>r.trophies)),i=new Set(a.claimed.filter(r=>typeof r=="number"&&s.has(r)));n.claimed=[...i].sort((r,l)=>r-l)}if(Array.isArray(a.unlocked))for(const s of a.unlocked)typeof s=="string"&&Ee.includes(s)&&!n.unlocked.includes(s)&&n.unlocked.push(s);if(a.levels&&typeof a.levels=="object"){const s=a.levels;for(const i of Ee){const r=s[i];if(typeof r!="number"||!Number.isFinite(r))continue;const l=Ta(r);l>no&&(n.levels[i]=l)}}if(a.lastMatch&&typeof a.lastMatch=="object"){const s=a.lastMatch,i=s.won===!0,r=Number.isInteger(s.seats)&&s.seats>=ot&&s.seats<=zt?s.seats:ot,l=Number.isInteger(s.place)&&s.place>=0&&s.place<r?s.place:i?0:r-1;n.lastMatch={won:l===0,trophies:typeof s.trophies=="number"&&Number.isFinite(s.trophies)?Math.trunc(s.trophies):0,coins:o(s.coins,0),chests:o(s.chests,0),place:l,seats:r,seen:s.seen===!0}}return n.bestTrophies=Math.max(n.bestTrophies,n.trophies),n}function Xm(t){return{trophies:t.trophies,bestTrophies:t.bestTrophies,coins:t.coins,gems:t.gems,containers:{...t.containers},claimed:[...t.claimed],unlocked:[...t.unlocked],winsTowardChest:t.winsTowardChest,lastMatch:t.lastMatch?{...t.lastMatch}:null,levels:{...t.levels},seed:t.seed,rolls:t.rolls}}function Zm(t,e){typeof e.coins=="number"&&Number.isFinite(e.coins)&&e.coins>=0&&(t.coins=Math.floor(e.coins)),typeof e.gems=="number"&&Number.isFinite(e.gems)&&e.gems>=0&&(t.gems=Math.floor(e.gems))}const f0="food-arena.profile.v1",wn=250,Yh=100,Jm=35;function m0(t,e){const a=zl(ri(t,e));return Math.round(Yh-a*(Yh-Jm))}const tl="Chef",al=16;function g0(t){if(typeof t!="string")return tl;const e=t.replace(/\s+/g," ").replace(/[\p{Cc}\p{Cf}]/gu,"").trim().slice(0,al).trim();return e.length>0?e:tl}function Qm(t){return typeof t=="string"&&Ee.includes(t)}function Oi(t,e){return typeof t=="number"&&Number.isFinite(t)&&t>=0?t:e}function Vh(){return{name:tl,wins:0,losses:0,xp:0,selected:Ee[0],economy:c0()}}function Kh(){try{const t=localStorage.getItem(f0);if(!t)return Vh();const e=JSON.parse(t),a=Km(e.economy);return e.economy===void 0&&Zm(a,e),{name:g0(e.name),wins:Math.floor(Oi(e.wins,0)),losses:Math.floor(Oi(e.losses,0)),xp:Math.floor(Oi(e.xp,0)),selected:Qm(e.selected)?e.selected:Ee[0],economy:a}}catch{return Vh()}}class w0{data;listeners=new Set;constructor(e){this.data=e?{...Kh(),...e}:Kh()}get name(){return this.data.name}get wins(){return this.data.wins}get losses(){return this.data.losses}get xp(){return this.data.xp}get selected(){return this.data.selected}get level(){return Math.floor(this.data.xp/wn)+1}get levelProgress01(){return this.data.xp%wn/wn}get economy(){return this.data.economy}get coins(){return this.data.economy.coins}get gems(){return this.data.economy.gems}get trophies(){return this.data.economy.trophies}get bestTrophies(){return this.data.economy.bestTrophies}get containers(){return this.data.economy.containers}get containerCount(){return Wm(this.data.economy)}get winsToNextChest(){return Bm(this.data.economy)}get lastMatch(){return this.data.economy.lastMatch}get unlocked(){return Hl(this.data.economy)}isUnlocked(e){return $m(this.data.economy)}get claimable(){return p0(this.data.economy)}select(e){this.data.selected!==e&&(this.data.selected=e,this.commit())}setName(e){const a=g0(e);return a===this.data.name||(this.data.name=a,this.commit()),a}recordPlacement(e,a){const o=qm(this.data.economy,e,a);return o.won?this.data.wins++:this.data.losses++,this.data.xp+=m0(e,a),this.commit(),o}recordResult(e){return this.recordPlacement(e?0:1,ot)}markLastMatchSeen(){const e=this.data.economy.lastMatch;!e||e.seen||(e.seen=!0,this.commit())}claimMilestone(e){const a=u0(this.data.economy,e);return a&&this.commit(),a}claimAllMilestones(){const e=jm(this.data.economy);return this.commit(),e}openContainer(e){const a=Gm(this.data.economy,e);return a&&this.commit(),a}buyContainer(e,a){const o=Um(this.data.economy,e,a);return o&&this.commit(),o}characterLevel(e){return _l(this.data.economy,e)}nextLevelPrice(e){return Pl(this.data.economy,e)}canLevelUp(e){return Ym(this.data.economy,e)}levelUp(e){const a=Vm(this.data.economy,e);return a&&this.commit(),a}onChange(e){return this.listeners.add(e),()=>this.listeners.delete(e)}commit(){try{localStorage.setItem(f0,JSON.stringify({name:this.data.name,wins:this.data.wins,losses:this.data.losses,xp:this.data.xp,selected:this.data.selected,economy:Xm(this.data.economy)}))}catch{}for(const e of this.listeners)e()}}const eg="fa-screen-styles";function la(t,e){if(document.getElementById(t))return;const a=document.createElement("style");a.id=t,a.textContent=e,document.head.appendChild(a)}function tg(){la(eg,ag)}function b0(t,e){const a=t.replace("#",""),o=a.length===3?a.split("").map(r=>r+r).join(""):a,n=parseInt(o.slice(0,2),16)||0,s=parseInt(o.slice(2,4),16)||0,i=parseInt(o.slice(4,6),16)||0;return`rgba(${n},${s},${i},${e})`}const ag=`
:root {
...
`,og=1923712,y0="#1d5a80",ng="#1D5576",sg="#093F73",Xh="#8A4E15",ig="#C07A23",rg="#F4C55E",tn=5,an=14,Ni=-.6,lg=[[-.6,.86],[0,.88],[1.2,.94],[2.6,1.02],[3.8,1.16],[8,1.4],[14,1.55]],Zh=1.3,hg=.52,Jh=new pe(16.35,9.82,4.69).normalize(),cg=[[0,.58],[1.5,.62],[2.6,.88],[3.8,1.16],[4.7,1.36],[6.4,1.42]],on=.24,nn=.215,Qh=.62,dg=2.48,pg=.86;function ec(t,e){if(e<=t[0][0])return t[0][1];const a=t[t.length-1];if(e>=a[0])return a[1];for(let o=1;o<t.length;o++){const[n,s]=t[o],[i,r]=t[o-1];if(e>n)continue;const l=(e-i)/Math.max(1e-6,n-i);return r+(s-r)*(l*l*(3-2*l))}return a[1]}function ug(t,e=128){const a=document.createElement("canvas");a.width=e,a.height=e;const o=a.getContext("2d");if(o){const s=o.createRadialGradient(e/2,e/2,0,e/2,e/2,e/2),[i,r,l]=t,h=c=>`rgb(${Math.round(i+(255-i)*c)},${Math.round(r+(255-r)*c)},${Math.round(l+(255-l)*c)})`;s.addColorStop(0,h(0)),s.addColorStop(.54,h(.1)),s.addColorStop(.8,h(.58)),s.addColorStop(1,"rgb(255,255,255)"),o.fillStyle=s,o.fillRect(0,0,e,e)}const n=new nt(a);return n.colorSpace=kf,n.wrapS=Wr,n.wrapT=Wr,n}function tc(t,e,a){const o=new Y({map:ug(e),blending:vf,blendEquation:Hh,blendSrc:zh,blendDst:xf,blendEquationAlpha:Hh,blendSrcAlpha:zh,blendDstAlpha:yf,transparent:!0,depthWrite:!1,toneMapped:!1}),n=new E(new Qa(t,t),o);return n.rotation.x=-Math.PI/2,n.renderOrder=a,n.userData.noOutline=!0,n}const Zt={counterBody:"#123A50",counterTop:"#A8641F",counterLip:"#D08A2E",shelf:"#7A431A",steel:"#24485C",jars:["#B02733","#4E8A12","#C99414","#1668A8","#6B3AA8","#B85A18","#2E8C6A","#C4553C"]};class Ds{stage;holder=document.createElement("div");model=null;currentId=null;subjectW=Q*.8;subjectH=Q;elapsed=0;introT=0;observer=null;footShadow=null;disposed=!1;dressing=null;constructor(){this.holder.style.cssText="position:absolute;inset:0;",this.stage=new Tl({container:this.holder,background:og,fog:null,camera:{pitchDeg:20,yawDeg:0,frameMode:"subject",subjectHeight:Q,subjectFill:.6,targetHeight:Q*.52,followLerp:1},budget:"menu",maxPixelRatio:2}),this.stage.canvas.style.cssText="display:block;width:100%;height:100%;",this.buildSet(),this.stage.rig.snapTo(0,0),this.stage.lighting.focus(0,0,6)}buildSet(){const e=new Me(tn,tn,an,72,28,!0);this.paintVertexRamp(e,(f,g,w)=>{const b=U.clamp(-(f*Jh.x+w*Jh.z)/tn,0,1);return ec(lg,g+an/2+Ni)*(Zh+(hg-Zh)*b)});const a=Qe({color:ng,ramp:et(),roughness:.9,rim:!1});a.side=Dh,a.vertexColors=!0;const o=new E(e,a);o.position.y=an/2+Ni,o.receiveShadow=!0,o.userData.noOutline=!0,o.name="menu_wall",o.renderOrder=-1,this.stage.scene.add(o);const n=new xa(0,6.4,96,32);this.paintVertexRamp(n,(f,g)=>ec(cg,Math.hypot(f,g)));const s=Qe({color:sg,ramp:et(),roughness:.86,rim:!1});s.vertexColors=!0;const i=new E(n,s);i.rotation.x=-Math.PI/2,i.receiveShadow=!0,i.userData.noOutline=!0,i.name="menu_ground",this.stage.scene.add(i);const r=tc(5.4,[18,32,160],1);r.position.y=.012,r.name="menu_ground_decal",this.stage.scene.add(r);const l=new E(new Me(1.15,1.24,.18,48),Qe({color:Xh,ramp:et(),roughness:.72}));l.position.y=.09,l.castShadow=!0,l.receiveShadow=!0,l.userData.noOutline=!0,l.name="menu_plinth_body",this.stage.scene.add(l);const h=Qe({color:ig,ramp:et(),roughness:.55}),c=new E(new Me(1.21,1.19,.06,48,1,!0),h);c.position.y=on-.03,c.castShadow=!0,c.receiveShadow=!0,c.userData.noOutline=!0,c.name="menu_plinth_rim",this.stage.scene.add(c);const d=new E(new xa(1.1,1.21,48),h);d.rotation.x=-Math.PI/2,d.position.y=on,d.receiveShadow=!0,d.userData.noOutline=!0,this.stage.scene.add(d);const p=new E(new Me(1.1,1.1,on-nn,48,1,!0),Qe({color:Xh,ramp:et(),roughness:.8,doubleSide:!0}));p.position.y=(on+nn)/2,p.receiveShadow=!0,p.userData.noOutline=!0,this.stage.scene.add(p);const u=new E(new Me(1.1,1.1,.05,48),Qe({color:rg,ramp:et(),roughness:.45}));u.position.y=nn-.025,u.receiveShadow=!0,u.userData.noOutline=!0,u.name="menu_plinth_top",this.stage.scene.add(u);const m=tc(1.9,[92,62,30],2);m.position.y=nn+.004,m.scale.set(1,1,.72),m.name="menu_foot_decal",this.footShadow=m,this.stage.scene.add(m)}paintVertexRamp(e,a){const o=e.attributes.position,n=new Float32Array(o.count*3);for(let s=0;s<o.count;s++){const i=a(o.getX(s),o.getY(s),o.getZ(s));n[s*3]=i,n[s*3+1]=i,n[s*3+2]=i}e.setAttribute("color",new Cs(n,3))}applyFraming(){const e=this.stage.rig.camera,a=e.aspect>0&&Number.isFinite(e.aspect)?e.aspect:1,o=Math.max(.5,this.subjectH)+on,n=Math.max(.5,this.subjectW,dg),s=pg*a*o/n;this.stage.rig.subjectHeight=o,this.stage.rig.subjectFill=U.clamp(Math.min(Qh,s),.2,Qh),this.stage.rig.targetHeight=o*.5,this.stage.rig.apply()}static floorGridTexture(e=256){const a=document.createElement("canvas");a.width=e,a.height=e;const o=a.getContext("2d");o&&(o.clearRect(0,0,e,e),o.strokeStyle="rgba(0,0,0,0.55)",o.lineWidth=e*.055,o.strokeRect(0,0,e,e));const n=new nt(a);return n.wrapS=Gr,n.wrapT=Gr,n.repeat.set(22,22),n.colorSpace=Sl,n}buildDressing(){const e=new ie;e.name="lobby_dressing";const a=(m,f=!1)=>(m.castShadow=f,m.receiveShadow=!0,m.userData.noOutline=!0,e.add(m),m),o=-3.35,n=7.2,s=.78,i=new E(new Qa(13,13),new Y({map:Ds.floorGridTexture(),transparent:!0,depthWrite:!1,toneMapped:!1}));i.rotation.x=-Math.PI/2,i.position.y=.006,i.renderOrder=0,i.userData.noOutline=!0,i.name="lobby_floor_grid",e.add(i);const r=Ds.floorGridTexture();r.repeat.set(26,9);const l=new E(new Me(tn-.04,tn-.04,an,72,1,!0),new Y({map:r,side:Dh,transparent:!0,depthWrite:!1,toneMapped:!1}));l.position.y=an/2+Ni,l.renderOrder=0,l.userData.noOutline=!0,l.name="lobby_wall_grid",e.add(l),a(new E(new Rt(n,s,.72),Qe({color:Zt.counterBody,ramp:et(),roughness:.8})),!0).position.set(0,s/2,o),a(new E(new Rt(n+.12,.11,.84),Qe({color:Zt.counterTop,ramp:et(),roughness:.5}))).position.set(0,s+.055,o),a(new E(new Rt(n+.12,.045,.06),Qe({color:Zt.counterLip,ramp:et(),roughness:.4}))).position.set(0,s+.012,o+.44),a(new E(new Rt(n-.4,.13,.52),Qe({color:Zt.shelf,ramp:et(),roughness:.75}))).position.set(0,2.15,o-.05);for(const m of[-2.6,2.6])a(new E(new Rt(.1,.36,.1),Qe({color:Zt.steel,ramp:et(),roughness:.7}))).position.set(m,2.31,o-.2);const h=new Me(.19,.21,.44,20),c=new Me(.21,.21,.07,20),d=Qe({color:Zt.steel,ramp:et(),roughness:.45}),p=[-2.95,-2.25,-1.55,1.55,2.25,2.95,-2.6,2.6],u=[2.35,2.35,2.35,2.35,2.35,2.35,.9,.9];for(let m=0;m<p.length;m++){const f=.86+m*37%5*.09,g=u[m]+.22*f;a(new E(h,Qe({color:Zt.jars[m],ramp:et(),roughness:.55}))).position.set(p[m],g,o-.02),e.children[e.children.length-1].scale.setScalar(f),a(new E(c,d)).position.set(p[m],g+.25*f,o-.02),e.children[e.children.length-1].scale.setScalar(f)}for(const m of[-1.95,1.95])a(new E(new Me(.4,.36,.46,24),Qe({color:Zt.steel,ramp:et(),roughness:.35}))).position.set(m,s+.34,o-.02),a(new E(new Me(.44,.44,.06,24),Qe({color:Zt.counterLip,ramp:et(),roughness:.3}))).position.set(m,s+.6,o-.02);return e}setScene(e){this.disposed||(e==="lobby"&&!this.dressing&&(this.dressing=this.buildDressing(),this.stage.scene.add(this.dressing)),this.dressing&&(this.dressing.visible=e==="lobby"))}attachTo(e){this.disposed||(this.holder.parentElement!==e&&e.appendChild(this.holder),this.observer?.disconnect(),this.observer=new ResizeObserver(()=>this.resize()),this.observer.observe(e),this.resize())}detach(){this.observer?.disconnect(),this.observer=null,this.holder.remove()}show(e){if(this.disposed||e===this.currentId)return;this.model&&(this.stage.scene.remove(this.model.root),this.model.dispose()),this.model=Al(e),this.model.play("idle"),this.stage.scene.add(this.model.root);const a=new vn().setFromObject(this.model.root);if(this.subjectH=Math.max(.5,a.max.y-a.min.y),this.subjectW=2*Math.max(.25,Math.abs(a.min.x),Math.abs(a.max.x),Math.abs(a.min.z),Math.abs(a.max.z)),this.model.root.position.y=nn+.005-a.min.y,this.footShadow){const o=U.clamp(Math.max(a.max.x-a.min.x,a.max.z-a.min.z)*1.15,1,2.3);this.footShadow.scale.set(o/1.9,1,o/1.9*.72)}this.currentId=e,this.introT=.34,this.applyFraming()}poke(){this.model?.play("attack")}update(e){if(!this.disposed){if(this.elapsed+=e,this.stage.rig.yawDeg=Math.sin(this.elapsed*.42)*22,this.model){if(this.introT>0){this.introT=Math.max(0,this.introT-e);const a=1-this.introT/.34,o=Math.sin(a*Math.PI)*(1-a*.4);this.model.root.scale.setScalar(1+o*.16),this.model.root.rotation.y=(1-a)*-.9}else this.model.root.scale.setScalar(1),this.model.root.rotation.y=0;this.model.update({dt:e,elapsed:this.elapsed,moveSpeed01:0,health01:1})}this.stage.render(e)}}resize(){this.disposed||(this.stage.resize(),this.applyFraming())}info(){const e=this.stage.rig.camera,a=this.model?new vn().setFromObject(this.model.root):null,o=s=>{const i=s.clone().project(e);return{x:+(i.x*.5+.5).toFixed(3),y:+(1-(i.y*.5+.5)).toFixed(3)}},n=this.stage.rig;return{id:this.currentId,aspect:+e.aspect.toFixed(3),fill:+n.subjectFill.toFixed(3),subject:{w:+this.subjectW.toFixed(2),h:+this.subjectH.toFixed(2)},cameraOk:Number.isFinite(e.position.x)&&Number.isFinite(e.position.y),feet:a?o(new pe(0,a.min.y,0)):null,crown:a?o(new pe(0,a.max.y,0)):null,left:a?o(new pe(a.min.x,(a.min.y+a.max.y)/2,0)):null,right:a?o(new pe(a.max.x,(a.min.y+a.max.y)/2,0)):null}}dispose(){if(!this.disposed){if(this.disposed=!0,this.observer?.disconnect(),this.observer=null,this.dressing){const e=new Set,a=new Set;this.dressing.traverse(o=>{const n=o;if(n.geometry&&e.add(n.geometry),n.material)for(const s of Array.isArray(n.material)?n.material:[n.material])a.add(s)}),e.forEach(o=>o.dispose()),a.forEach(o=>o.dispose()),this.stage.scene.remove(this.dressing),this.dressing=null}this.model&&(this.stage.scene.remove(this.model.root),this.model.dispose(),this.model=null),this.stage.dispose(),this.holder.remove()}}}let Mo=null;function $l(){return Mo||(Mo=new Ds,typeof window<"u"&&(window.__charStage=()=>Mo?.info()??null)),Mo}function ac(){Mo?.dispose(),Mo=null}const Li=1e-4,fg=2e4;function ql(t){let e=t|0||2654435769;return()=>(e^=e<<13,e^=e>>>17,e^=e<<5,(e>>>0)/4294967296)}function we(t,e,a){return e+t()*(a-e)}function ne(t,e){return Math.pow(2,we(t,-e,e)/1200)}const oc=new WeakMap;function mg(t){const e=oc.get(t);if(e)return e;const a=Math.floor(t.sampleRate*2),o=t.createBuffer(1,a,t.sampleRate),n=o.getChannelData(0),s=ql(6221086);for(let i=0;i<a;i++)n[i]=s()*2-1;return oc.set(t,o),o}const nc=new WeakMap;function gg(t,e){let a=nc.get(t);a||(a=new Map,nc.set(t,a));const o=Math.max(.05,Math.round(e*20)/20),n=a.get(o);if(n)return n;const s=1024,i=new Float32Array(s),r=Math.tanh(o);for(let l=0;l<s;l++){const h=l/(s-1)*2-1;i[l]=Math.tanh(o*h)/r}return a.set(o,i),i}function x0(t,e){const a=t.createWaveShaper();return a.curve=gg(t,e),a.oversample="2x",a}const wg=.26,bg=.19,sc=new WeakMap;function yg(t){const e=sc.get(t);if(e)return e;const a=t.sampleRate,o=Math.floor(a*wg),n=t.createBuffer(2,o,a),s=Math.floor(a*.005),i=6.9078/(bg*a);for(let h=0;h<2;h++){const c=n.getChannelData(h),d=ql(h===0?1990433:7840721);let p=0;for(let m=s;m<o;m++){const f=m-s,g=.3+.42*(f/(o-s)),w=d()*2-1;p=p*g+w*(1-g),c[m]=p*Math.exp(-i*f)}const u=h===0?[.0071,.0132,.0198,.0281,.0367,.0458]:[.0083,.0119,.0214,.0263,.0389,.0441];for(let m=0;m<u.length;m++){const f=s+Math.floor(u[m]*a);if(f>=o)continue;const g=m%2===0?1:-1;c[f]+=g*.62*Math.exp(-i*(f-s)*.55)}}let r=0;for(let h=0;h<2;h++){const c=n.getChannelData(h);for(let d=0;d<o;d++)r=Math.max(r,Math.abs(c[d]))}const l=r>0?.6/r:1;for(let h=0;h<2;h++){const c=n.getChannelData(h);for(let d=0;d<o;d++)c[d]*=l}return sc.set(t,n),n}function xg(t){const e=t.createConvolver();return e.normalize=!1,e.buffer=yg(t),e}function v0(t,e,a){if(!t.wet||!(a>0))return;const o=t.ctx.createGain();o.gain.value=a,e.connect(o),o.connect(t.wet)}function k0(t,e,a){const o=t.createGain(),n=Math.max(5e-4,a.attack??.002),s=(a.duration-n)*Math.max(0,Math.min(.9,a.hold??0)),i=Math.max(Li*2,a.peak),r=e+a.duration;return o.gain.setValueAtTime(Li,e),o.gain.linearRampToValueAtTime(i,e+n),s>0&&o.gain.setValueAtTime(i,e+n+s),(a.curve??"exp")==="exp"?o.gain.exponentialRampToValueAtTime(Li,r):o.gain.linearRampToValueAtTime(0,r),o.gain.setValueAtTime(0,r+.001),o}function Eo(t,e,a,o,n="exp"){if(typeof e=="number"){t.setValueAtTime(e,a);return}const[s,i]=e;t.setValueAtTime(s,a),n==="exp"&&s>0&&i>0?t.exponentialRampToValueAtTime(i,a+o):t.linearRampToValueAtTime(i,a+o)}function B(t,e){const{ctx:a,dest:o,when:n}=t,s=a.createBufferSource(),i=mg(a);s.buffer=i,s.playbackRate.value=e.rate??1,e.loop&&(s.loop=!0,s.loopStart=0,s.loopEnd=i.duration);const r=Math.max(0,i.duration-(e.duration+.02)),l=e.loop?we(t.rng,0,i.duration):we(t.rng,0,Math.min(1.5,r)),h=k0(a,n,e),c=e.tremolo?vg(a,n,e.duration,e.tremolo.rate,e.tremolo.depth):h;c!==h&&c.connect(h);const d=e.drive?x0(a,e.drive):c;if(d!==c&&d.connect(c),e.filter){const p=u=>{const m=a.createBiquadFilter();return m.type=e.filter,m.Q.value=u,Eo(m.frequency,e.freq??1e3,n,e.duration,e.freqCurve??"exp"),m};if(e.poles===24){const u=Math.sqrt(Math.max(.1,e.q??1));s.connect(p(u)).connect(p(u)).connect(d)}else s.connect(p(e.q??1)).connect(d)}else s.connect(d);return h.connect(o),v0(t,h,e.wet??0),s.start(n,l,e.duration+.02),s.stop(n+e.duration+.02),e.duration}function X(t,e){const{ctx:a,dest:o,when:n}=t,s=k0(a,n,e);let i=s;if(e.ring!==void 0){const h=a.createGain();h.gain.value=0;const c=a.createOscillator();c.type="sine",Eo(c.frequency,e.ring,n,e.duration,"exp"),c.connect(h.gain),c.start(n),c.stop(n+e.duration+.02),h.connect(s),i=h}if(e.drive){const h=x0(a,e.drive);h.connect(i),i=h}if(e.lowpass!==void 0){const h=a.createBiquadFilter();h.type="lowpass",h.Q.value=.7,Eo(h.frequency,e.lowpass,n,e.duration),h.connect(i),i=h}const r=Math.max(1,Math.min(3,Math.round(e.voices??1))),l=e.detuneCents??0;for(let h=0;h<r;h++){const c=a.createOscillator();c.type=e.type??"sine";const d=r===1?0:(h/(r-1)-.5)*l,p=Math.pow(2,d/1200);if(typeof e.freq=="number"?Eo(c.frequency,e.freq*p,n,e.duration,e.freqCurve??"exp"):Eo(c.frequency,[e.freq[0]*p,e.freq[1]*p],n,e.duration,e.freqCurve??"exp"),r>1){const u=a.createGain();u.gain.value=1/r,c.connect(u).connect(i)}else c.connect(i);c.start(n),c.stop(n+e.duration+.02)}return s.connect(o),v0(t,s,e.wet??0),e.duration}function li(t,e){let a=0;for(const o of e.modes){const n=e.duration*o.decay,s=typeof e.freq=="number"?e.freq*o.ratio:[e.freq[0]*o.ratio,e.freq[1]*o.ratio];(typeof s=="number"?s:Math.max(s[0],s[1]))>fg||(a=Math.max(a,n),X(t,{type:"sine",freq:s,peak:e.peak*o.gain,attack:e.attack??.0015,duration:n,drive:e.drive,wet:e.wet}))}return a}function vg(t,e,a,o,n){const s=Math.max(0,Math.min(1,n)),i=t.createGain();i.gain.value=1-s*.5;const r=t.createOscillator();r.type="sine",Eo(r.frequency,o,e,a,"lin");const l=t.createGain();return l.gain.value=s*.5,r.connect(l),l.connect(i.gain),r.start(e),r.stop(e+a+.02),i}function ve(t,e){const a=e.freq??5e3,o=B(t,{filter:"highpass",freq:a,q:.9,peak:e.peak,attack:4e-4,duration:.007,wet:e.wet??.06});if(!e.snap)return o;const n=(e.snapMs??14)/1e3,s=X(t,{type:"triangle",freq:[e.snap,e.snap*.38],peak:e.peak*.72,attack:6e-4,duration:n,drive:2.2,wet:e.wet??.06});return G(o,s)}function ze(t,e){const[a,o]=e.grainMs??[4,11],n=e.decay??.35,s=e.freqShift;for(let i=0;i<e.count;i++){const r=Math.pow(t.rng(),1.5)*e.spread,l=we(t.rng,a,o)/1e3,h=e.peak*(1-r/e.spread*(1-n))*we(t.rng,.55,1),c=s?s[0]+(s[1]-s[0])*(r/e.spread):1;B({...t,when:t.when+r},{filter:"bandpass",freq:we(t.rng,e.freq[0],e.freq[1])*c,q:e.q??6,peak:h,attack:8e-4,duration:l,drive:e.drive,wet:e.wet})}return e.spread+o/1e3}function un(t,e){const a=e.rise??2.6;let o=0;for(let n=0;n<e.count;n++){const s=we(t.rng,0,e.spread),i=we(t.rng,e.freq[0],e.freq[1]),r=we(t.rng,.045,.095);o=Math.max(o,s+r),X({...t,when:t.when+s},{type:"sine",freq:[i,i*a],peak:e.peak*we(t.rng,.5,1),attack:.002,duration:r,wet:e.wet})}return o}function zs(t,e){const[a,o]=e.pingMs??[7,18],n=e.bend??.92,s=Math.log2(e.freq[0]),i=Math.log2(e.freq[1]);let r=0;for(let l=0;l<e.count;l++){const h=Math.pow(t.rng(),1.6)*e.spread,c=Math.pow(2,s+(t.rng()+l*.6180339887)%1*(i-s)),d=we(t.rng,a,o)/1e3;r=Math.max(r,h+d),X({...t,when:t.when+h},{type:"sine",freq:[c,c*n],peak:e.peak*we(t.rng,.55,1),attack:6e-4,duration:d,wet:e.wet})}return r}function Bl(t,e){const[a,o]=e.freq??[9e3,3200],n=e.duration??.11,s=e.wet??.3,i=B(t,{filter:"bandpass",freq:[a*ne(t.rng,90),o*ne(t.rng,90)],q:.7,peak:e.peak,attack:.0012,duration:n,wet:s}),r=B(t,{filter:"highpass",poles:24,freq:[a*.8,a*.45],q:.7,peak:e.peak*.55,attack:6e-4,duration:n*.55,wet:s}),l=e.drops??6,h=l>0?ze(t,{count:l,spread:n*.85,grainMs:[3,9],freq:[o,a],q:5,peak:e.peak*.85,decay:.25,wet:s}):0;return G(i,r,h)}function G(...t){let e=0;for(const a of t)a>e&&(e=a);return e}const ic="fa.audio.volume",rc="fa.audio.muted",kg=.62,Mg=20,Eg=.008,Ve={Ambient:0,Normal:1,Critical:2},Tg=.11,lc=[1,.62,.42,.3,.22],Sg=.5,sn=.7,hc=1.2,M0=3,cc=new WeakMap;function Ag(t){const e=cc.get(t);if(e)return e;const a=2048,o=new Float32Array(a);for(let n=0;n<a;n++){const s=(n/(a-1)*2-1)*M0,i=Math.abs(s),r=i<=sn?i:sn+(hc-sn)*Math.tanh((i-sn)/(hc-sn));o[n]=Math.sign(s)*r}return cc.set(t,o),o}function Rg(t,e,a=!0){const o=t.createGain();o.gain.value=1;let n=null;if(a)try{n=t.createGain(),n.gain.value=1;const l=t.createGain();l.gain.value=Sg,n.connect(xg(t)).connect(l).connect(o)}catch{n=null}const s=t.createGain();s.gain.value=1/M0;const i=t.createWaveShaper();i.curve=Ag(t),i.oversample="2x";const r=t.createGain();return r.gain.value=0,o.connect(s).connect(i).connect(r).connect(e??t.destination),{input:o,wetIn:n,limiter:i,master:r}}function Ig(t){const e=Math.max(0,Math.min(1,t));return Math.pow(e,1.8)*kg}function Fg(){const t=typeof navigator<"u"?navigator.userActivation:void 0;return t===void 0||t.isActive===!0}class Cg{ctx=null;chain=null;state="idle";failure=null;volume=.8;muted=!1;maxVoices;persist;reverb;injected;injectedDestination;offline;voices=[];retrigger=new Map;listeners=new Set;virtualTime=0;counters={started:0,droppedBudget:0,droppedThrottle:0,droppedNotRunning:0};analyser=null;gestureBound=!1;constructor(e={}){this.maxVoices=e.maxVoices??Mg,this.persist=e.persist??!0,this.reverb=e.reverb??!0,this.injected=e.context??null,this.injectedDestination=e.destination??null,this.offline=!!this.injected&&typeof OfflineAudioContext<"u"&&this.injected instanceof OfflineAudioContext,this.loadSettings(),this.injected?(this.attachContext(this.injected),this.offline&&(this.state="running")):(this.bindGestureUnlock(),this.bindVisibility())}setVolume(e){this.volume=Math.max(0,Math.min(1,Number.isFinite(e)?e:0)),this.applyMasterGain(.02),this.saveSettings(),this.emit()}getVolume(){return this.volume}setMuted(e){this.muted=!!e,this.applyMasterGain(.015),this.saveSettings(),this.emit()}isMuted(){return this.muted}toggleMuted(){return this.setMuted(!this.muted),this.muted}onChange(e){return this.listeners.add(e),()=>this.listeners.delete(e)}getState(){return this.state}getFailure(){return this.failure}activeVoices(){return this.prune(this.now()),this.voices.length}unlock(){if(this.state==="failed"||this.offline||!this.ctx&&!Fg())return;const e=this.ensureContext();e&&(typeof e.resume=="function"&&e.state!=="running"&&e.resume().then(()=>this.syncState(),()=>this.syncState()),this.syncState())}bindGestureUnlock(){if(this.gestureBound||typeof window>"u")return;this.gestureBound=!0;const e=["pointerdown","touchend","keydown","click"],a=()=>{if(this.unlock(),this.state==="running"||this.state==="failed")for(const o of e)window.removeEventListener(o,a,!0)};for(const o of e)window.addEventListener(o,a,!0)}bindVisibility(){typeof document>"u"||document.addEventListener("visibilitychange",()=>{const e=this.ctx;if(!(!e||typeof e.suspend!="function")){try{document.hidden?e.suspend().catch(()=>{}):this.state!=="idle"&&e.resume().catch(()=>{})}catch{}this.syncState()}})}ensureContext(){if(this.ctx)return this.ctx;if(this.state==="failed")return null;try{const e=typeof AudioContext<"u"?AudioContext:globalThis.webkitAudioContext;if(!e)return this.fail("Web Audio API unavailable"),null;const a=new e({latencyHint:"interactive"});return this.attachContext(a),a}catch(e){return this.fail(String(e)),null}}attachContext(e){this.ctx=e;try{this.chain=Rg(e,this.injectedDestination??void 0,this.reverb),this.applyMasterGain(0),this.syncState()}catch(a){this.fail(String(a))}}syncState(){if(this.state==="failed")return;const e=this.state;this.ctx?this.offline?this.state="running":this.state=this.ctx.state==="running"?"running":"suspended":this.state="idle",e!==this.state&&this.emit()}fail(e){this.state="failed",this.failure=e,console.warn("[audio] disabled:",e),this.emit()}play(e,a={}){try{return this.playInner(e,a)}catch(o){return this.failure||(this.failure=String(o),console.warn("[audio] sound failed:",o)),!1}}playInner(e,a){if(this.state==="failed")return!1;if(this.state!=="running"||!this.ctx||!this.chain)return this.counters.droppedNotRunning++,!1;const o=this.now();this.prune(o);const n=a.priority??Ve.Normal;let s=1,i=1;if(a.key){const x=this.retrigger.get(a.key),M=x&&o-x.at<Tg?x.count+1:0;if(this.retrigger.set(a.key,{at:o,count:M}),M>=lc.length)return this.counters.droppedThrottle++,!1;s=lc[M],i=1+M*.045}if(this.voices.length>=this.maxVoices){if(n<Ve.Critical&&!this.steal(n))return this.counters.droppedBudget++,!1;n>=Ve.Critical&&this.voices.length>=this.maxVoices&&this.steal(Ve.Critical)}const r=this.ctx,l=Math.max(o,r.currentTime)+Eg+(a.delay??0),h=Math.max(0,(a.gain??1)*s),c=r.createGain();c.gain.value=h;const d=a.pan!==void 0&&typeof r.createStereoPanner=="function",p=Math.max(-1,Math.min(1,a.pan??0));let u=c;if(d){const x=r.createStereoPanner();x.pan.value=p,c.connect(x),u=x}u.connect(this.chain.input);let m=null;if(this.chain.wetIn)if(m=r.createGain(),m.gain.value=h,d){const x=r.createStereoPanner();x.pan.value=p,m.connect(x).connect(this.chain.wetIn)}else m.connect(this.chain.wetIn);const f=ql(a.seed??Math.random()*4294967295|0),g={ctx:r,dest:c,wet:m??void 0,when:l,rng:f};let w=0;try{w=e(g)||0}catch(x){throw c.disconnect(),m?.disconnect(),x}const b=l+w/i+.05;if(this.voices.push({node:c,wet:m,end:b,priority:n}),this.counters.started++,!this.offline){const x=Math.max(30,(b-r.currentTime)*1e3+40);setTimeout(()=>this.prune(this.now()),x)}return!0}steal(e){let a=-1;for(let n=0;n<this.voices.length;n++)if(this.voices[n].priority<e){a=n;break}if(a<0)return!1;const[o]=this.voices.splice(a,1);return this.release(o),!0}prune(e){for(let a=this.voices.length-1;a>=0;a--)if(this.voices[a].end<=e){const[o]=this.voices.splice(a,1);this.release(o)}if(this.retrigger.size>64)for(const[a,o]of this.retrigger)e-o.at>1&&this.retrigger.delete(a)}release(e){try{e.node.gain.cancelScheduledValues(0),e.node.gain.value=0,e.node.disconnect()}catch{}if(e.wet)try{e.wet.gain.cancelScheduledValues(0),e.wet.gain.value=0,e.wet.disconnect()}catch{}}now(){return this.ctx?Math.max(this.ctx.currentTime,this.virtualTime):this.virtualTime}setVirtualTime(e){this.virtualTime=e,this.prune(e)}tap(){if(!this.ctx||!this.chain)return null;if(this.analyser)return this.analyser;try{const e=this.ctx.createAnalyser();return e.fftSize=2048,e.smoothingTimeConstant=0,this.chain.master.connect(e),this.analyser=e,e}catch{return null}}connectTap(e){if(!this.ctx||!this.chain)return!1;try{return this.chain.master.connect(e),!0}catch{return!1}}get context(){return this.ctx}get busInput(){return this.chain?.input??null}applyMasterGain(e){if(!this.chain||!this.ctx)return;const a=this.muted?0:Ig(this.volume),o=this.chain.master.gain;try{if(e>0&&!this.offline){const n=this.ctx.currentTime;o.cancelScheduledValues(n),o.setValueAtTime(o.value,n),o.linearRampToValueAtTime(a,n+e)}else o.cancelScheduledValues(0),o.value=a}catch{o.value=a}}loadSettings(){if(!(!this.persist||typeof localStorage>"u"))try{const e=localStorage.getItem(ic);if(e!==null){const a=Number(e);Number.isFinite(a)&&(this.volume=Math.max(0,Math.min(1,a)))}this.muted=localStorage.getItem(rc)==="1"}catch{}}saveSettings(){if(!(!this.persist||typeof localStorage>"u"))try{localStorage.setItem(ic,String(this.volume)),localStorage.setItem(rc,this.muted?"1":"0")}catch{}}emit(){for(const e of this.listeners)try{e()}catch{}}}const Fe=0;function _e(t){const e=t.fighters;return Array.isArray(e)&&e.length>0?e:[t.player,t.enemy].filter(Boolean)}function Ke(t){return _e(t)[Fe]??t.player}function mt(t,e,a){if(typeof e=="number"){const o=_e(t)[e];if(o)return o}return t[a]}function fn(t,e,a){return mt(t,e.attackerId,Xp(a))}function dc(t,e){return mt(t,e.ownerId,e.ownerRole)}function aa(t,e){return typeof t=="number"?t:e==="player"?0:1}function Og(t){return t===0?"player":t===1?"enemy":`slot${t}`}function Ng(t){const{seats:e,center:a,eliminated:o,winnerId:n}=t,s=g=>e.find(w=>w.id===g),i=g=>g.maxHp>0?g.hp/g.maxHp:0,r=g=>Math.hypot(g.x-a.x,g.y-a.y),l=(g,w)=>{const b=i(g),x=i(w);if(b!==x)return x-b;const M=r(g),y=r(w);return M!==y?M-y:g.deaths!==w.deaths?g.deaths-w.deaths:g.id-w.id},h=e.filter(g=>g.alive&&g.hp>0).slice().sort(l).map(g=>g.id),c=new Set(h),d=new Map;o.forEach((g,w)=>{s(g)!==void 0&&d.set(g,w)});const p=[...d.keys()].filter(g=>!c.has(g)).sort((g,w)=>{const b=d.get(g)??-1,x=d.get(w)??-1;if(b!==x)return x-b;const M=s(g),y=s(w);return M&&y&&M.deaths!==y.deaths?M.deaths-y.deaths:g-w}),u=new Set([...h,...p]),m=e.filter(g=>!u.has(g.id)).slice().sort((g,w)=>g.deaths!==w.deaths?g.deaths-w.deaths:g.id-w.id).map(g=>g.id),f=[...h,...p,...m];return n!==null&&f[0]!==n&&s(n)!==void 0?[n,...f.filter(g=>g!==n)]:f}function Lg(t,e,a){if(!(t>e))return 1;if(t>=a)return 0;const o=a-e,n=(t-e)/o;return 1-n*n*(3-2*n)}const Dg=200,zg=900;function jl(t){return Math.max(0,Math.min(1,(t-2)/16))}function Hg(t){const e=jl(t);return a=>{const o=ne(a.rng,70),n=B(a,{filter:"bandpass",freq:[2600*o,620*o],q:1.1,peak:.26+e*.12,attack:.006,duration:.13,drive:1.5,wet:.14}),s=X(a,{type:"sine",freq:[440*o,170*o],peak:.16+e*.12,attack:.004,duration:.11,drive:1.9,voices:2,detuneCents:14,wet:.1});return G(n,s)}}function _g(t,e){const a=jl(t),o=Math.min(1,e/180);return n=>{const s=ne(n.rng,55),i=.2+o*.1,r=B(n,{filter:"bandpass",freq:[420*s,(1900-o*600)*s],q:2.2,peak:.44+a*.2,attack:.05+o*.03,hold:.12,duration:i,drive:1.6,wet:.2}),l=X(n,{type:"sawtooth",freq:[200*s,88*s],lowpass:[900,300],peak:.2+a*.12,attack:.02,duration:i*.8,drive:1.8,voices:2,detuneCents:18,wet:.12});return G(r,l)}}function Pg(){const t=[523.25,659.25,783.99];return e=>{const a=ne(e.rng,25);t.forEach((n,s)=>{X({...e,when:e.when+s*.06},{type:"triangle",freq:n*a,peak:.2,attack:.012,hold:.2,duration:.3,voices:2,detuneCents:9,wet:.42})});const o=B(e,{filter:"highpass",freq:[3e3,7e3],q:.8,peak:.07,attack:.08,duration:.42,wet:.5});return G(.3+t.length*.06,o)}}function $g(){return t=>{const e=ne(t.rng,30),a=X(t,{type:"sine",freq:[130*e,30*e],peak:.9,attack:.004,hold:.08,duration:.78,drive:3.4,voices:3,detuneCents:22,wet:.3}),o=B(t,{filter:"lowpass",freq:[2200,140],q:1.4,peak:.55,attack:.01,duration:.62,drive:2.2,wet:.34}),n=ve(t,{peak:.62,freq:3e3,snap:1900,snapMs:26}),s=ze(t,{count:10,spread:.42,freq:[900,4200],peak:.16,q:5,wet:.4});return G(a,o,n,s)}}function qg(t){const e=jl(t);return a=>{const o=ne(a.rng,60),n=ve(a,{peak:.66-e*.14,freq:3900-e*1100,snap:2700-e*800,snapMs:11+e*7}),s=X(a,{type:"sine",freq:[(230-e*80)*o,(62-e*22)*o],peak:.48+e*.34,attack:.0018,duration:.11+e*.22,drive:2+e*1.5,voices:2,detuneCents:16,wet:.16}),i=e>.12?X(a,{type:"sine",freq:[(118-e*38)*o,(44-e*12)*o],peak:.14+e*.38,attack:.004,duration:.1+e*.2,drive:1.5,wet:.1}):0,r=B(a,{filter:"bandpass",freq:[1700*o,470*o],q:1.5,peak:.24+e*.2,attack:.0012,duration:.07+e*.1,drive:1.9,wet:.22}),l=B(a,{filter:"bandpass",freq:[1900,640],q:.9,peak:.05+e*.05,attack:.018,duration:.16+e*.22,wet:.6}),h=Bl(a,{peak:.1+(1-e)*.06,freq:[8600-e*2200,3400-e*900],duration:.06+e*.05,drops:5,wet:.28});return G(n,s,i,r,l,h)}}function Bg(t){const e=t<.3;return a=>{const o=ne(a.rng,45),n=we(a.rng,.9,1.15),s=we(a.rng,285,360),i=X(a,{type:"sawtooth",freq:[s*o,s*o*.4],lowpass:[we(a.rng,1180,1620),260],peak:.3,attack:.004,duration:(e?.34:.22)*n,drive:we(a.rng,2.1,2.8),voices:2,detuneCents:20,wet:.18}),r=we(a.rng,830,1150),l=B(a,{filter:"lowpass",poles:24,freq:[r,190],q:.9,peak:.2,attack:.002,duration:.16*n,drive:1.6,wet:.24}),h=ve(a,{peak:.2,freq:3600,wet:.16}),c=ze(a,{count:4,spread:.03,grainMs:[3,8],freq:[we(a.rng,2700,3400),we(a.rng,6e3,9e3)],q:4,peak:.24,decay:.3,wet:.2}),d=Bl(a,{peak:.13,freq:[we(a.rng,7600,9400),we(a.rng,2800,3600)],duration:we(a.rng,.05,.08),drops:5,wet:.26}),p=e?X(a,{type:"sine",freq:[we(a.rng,88,104),32],peak:.55,attack:.006,duration:.3*n,drive:2.6,wet:.16}):0;return G(i,l,h,c,d,p)}}function jg(){return t=>{const e=ne(t.rng,30),a=ve(t,{peak:.2,freq:5400,snap:3800,snapMs:6}),o=X(t,{type:"triangle",freq:[620*e,1560*e],ring:[132,96],peak:.34,attack:.022,duration:.26,wet:.34}),n=X(t,{type:"sine",freq:[1880*e,2520*e],peak:.1,attack:.03,duration:.34,wet:.55});return G(a,o,n)}}function Gg(){return t=>{const e=ne(t.rng,40),a=X(t,{type:"sawtooth",freq:[440*e,58*e],lowpass:[2600,240],peak:.42,attack:.006,duration:.6,drive:2.2,voices:2,detuneCents:24,wet:.26}),o=B(t,{filter:"lowpass",freq:[3200,200],q:1.1,peak:.34,attack:.004,duration:.44,drive:1.5,wet:.4}),n=X(t,{type:"sine",freq:[150*e,30*e],peak:.7,attack:.003,duration:.42,drive:3,voices:2,detuneCents:14,wet:.2});return G(a,o,n)}}function Wg(){const t=[392,523.25,659.25];return e=>{const a=ne(e.rng,20);return t.forEach((o,n)=>{X({...e,when:e.when+n*.05},{type:"triangle",freq:o*a,peak:.26,attack:.01,duration:.24,voices:2,detuneCents:8,wet:.34})}),.24+t.length*.05}}function Ug(){return t=>{const e=B(t,{filter:"lowpass",poles:24,freq:[420,110],q:1.2,peak:.34,attack:.05,duration:.4,drive:2,wet:.35}),a=B(t,{filter:"bandpass",freq:[1400,2600],q:.7,peak:.1,attack:.08,duration:.42,wet:.55});return G(e,a)}}const Yg=2.1,E0=1.5,Di=.55;function Vg(){return t=>{const e=Yg,a={attack:Di,hold:(E0-Di)/(e-Di),duration:e},o=X(t,{type:"sine",freq:118*ne(t.rng,25),peak:.026,voices:3,detuneCents:26,drive:1.6,...a,wet:.25}),n=B(t,{filter:"bandpass",freq:[we(t.rng,900,1500),we(t.rng,1700,2500)],q:.45,peak:.055,loop:!0,tremolo:{rate:[.55,.85],depth:.3},...a,wet:.4}),s=B(t,{filter:"highpass",poles:24,freq:[6400,8200],q:.7,peak:.009,loop:!0,...a,wet:.5}),i=we(t.rng,.3,e-.6),r={...t,when:t.when+i},l=Math.floor(t.rng()*4);let h=0;if(l===0)h=li(r,{freq:we(t.rng,620,980),duration:.42,peak:.085,attack:.0015,wet:.62,modes:[{ratio:1,gain:1,decay:1},{ratio:2.71,gain:.6,decay:.5},{ratio:4.63,gain:.34,decay:.3}]});else if(l===1){const c=ve(r,{peak:.1,freq:3400,snap:900,snapMs:14,wet:.5}),d=we(t.rng,.11,.19),p=ve({...r,when:r.when+d},{peak:.075,freq:3100,snap:820,snapMs:12,wet:.5});h=G(c,d+p)}else l===2?h=B(r,{filter:"bandpass",freq:[we(t.rng,2800,3600),we(t.rng,5600,7400)],q:.8,peak:.04,attack:.09,duration:.55,wet:.7}):h=zs(r,{count:3,spread:.16,freq:[4200,11e3],peak:.022,pingMs:[8,20],bend:.94,wet:.6});return G(o,n,s,i+h)}}function Kg(){return t=>{const e=B(t,{filter:"highpass",freq:[2600,5200],q:.8,peak:.18,attack:.01,duration:.26,wet:.3}),a=ze(t,{count:4,spread:.2,freq:[2500,6e3],peak:.1,q:7,wet:.35});return G(e,a)}}function Xg(){return t=>{const e=B(t,{filter:"lowpass",freq:[1400,260],q:3.2,peak:.2,attack:.008,duration:.15,drive:1.8,wet:.2}),a=X(t,{type:"sine",freq:[180,84],peak:.14,duration:.11,drive:2.2,wet:.14});return G(e,a)}}function Zg(){return t=>{const e=ne(t.rng,90),a=ve(t,{peak:.26,freq:2400,snap:1200,snapMs:8}),o=X(t,{type:"sine",freq:[150*e,66*e],peak:.22,duration:.09,drive:2,wet:.24});return G(o,a)}}function Jg(t){const e=[523.25,587.33,659.25,698.46,783.99],a=e[Math.max(0,Math.min(e.length-1,5-t))];return o=>{const n=X(o,{type:"triangle",freq:a,peak:.34,attack:.004,hold:.25,duration:.16,voices:2,detuneCents:7,wet:.3}),s=B(o,{filter:"highpass",freq:3800,peak:.12,duration:.015,wet:.12});return G(n,s)}}function Qg(){const t=[523.25,659.25,1046.5];return e=>{t.forEach((o,n)=>{X({...e,when:e.when+n*.07},{type:"square",freq:o,lowpass:[3200,1800],peak:.22,attack:.006,hold:.3,duration:.34,voices:2,detuneCents:10,wet:.3})});const a=B(e,{filter:"bandpass",freq:[500,4e3],q:.9,peak:.16,attack:.14,duration:.2,wet:.35});return G(.34+t.length*.07,a)}}function ew(){return t=>{const e=ne(t.rng,18);[587.33,392].forEach((n,s)=>{X({...t,when:t.when+s*.16},{type:"triangle",freq:n*e,peak:.26,attack:.008,hold:.25,duration:.38,voices:2,detuneCents:11,wet:.34})});const a=X(t,{type:"sine",freq:[196*e,98*e],peak:.34,attack:.02,hold:.3,duration:.72,drive:2.2,voices:2,detuneCents:15,wet:.28}),o=B(t,{filter:"bandpass",freq:[2200,620],q:.8,peak:.12,attack:.06,duration:.66,wet:.55});return G(.38+.16,a,o)}}function tw(t){const e=t?[523.25,659.25,783.99,1046.5]:[659.25,587.33,493.88,392];return a=>(e.forEach((o,n)=>{X({...a,when:a.when+n*.1},{type:t?"square":"sawtooth",freq:o,lowpass:t?[3600,2200]:[1600,500],peak:.24,attack:.008,hold:.3,duration:.4,voices:2,detuneCents:t?9:16,wet:.34})}),.4+e.length*.1)}function aw(t){const e=t?[523.25,659.25,1046.5]:[587.33,493.88,392],a=.62;return o=>{const n=(r,l)=>(B({...o,when:o.when+r},{filter:"bandpass",freq:2900,q:10,peak:.7,attack:.012,hold:.45,duration:l,tremolo:{rate:24,depth:.7},wet:.06}),r+l);n(0,.26);const s=n(.36,.22),i=X(o,{type:"sawtooth",freq:[150,132],lowpass:[1100,420],peak:.14,attack:.01,hold:.5,duration:.58,drive:1.8,voices:2,detuneCents:22,wet:.2});return e.forEach((r,l)=>{X({...o,when:o.when+a+l*.1},{type:t?"square":"sawtooth",freq:r,lowpass:t?[3600,2200]:[1600,500],peak:.24,attack:.008,hold:.3,duration:.36,voices:2,detuneCents:t?9:16,wet:.34})}),G(s,i,a+(e.length-1)*.1+.36)}}function ow(){return t=>{const e=X(t,{type:"triangle",freq:[900,620],peak:.22,duration:.055,drive:1.6,wet:.16}),a=B(t,{filter:"highpass",freq:5e3,peak:.1,duration:.012});return G(e,a)}}function Un(t,e,a,o,n){return ze(t,{count:12,spread:e,grainMs:[5,14],freq:[2300,4600],freqShift:[a,o],q:3.2,peak:n,decay:.4,drive:1.5,wet:.3})}function rn(t,e,a){return ze(t,{count:7,spread:e,grainMs:[2,5],freq:[5600,11e3],q:9,peak:a,decay:.25,wet:.34})}const nw={Disc:{cast(t){const e=ne(t.rng,55),a=Un(t,.3,1.35,.62,.3),o=rn(t,.22,.13),n=B(t,{filter:"bandpass",freq:[700*e,1800*e],q:1.6,peak:.34,attack:.05,hold:.1,duration:.3,drive:1.4,wet:.3});return G(a,o,n)},impact(t){const e=ve(t,{peak:.46,freq:3400,snap:1600,snapMs:10,wet:.1}),a=B(t,{filter:"bandpass",freq:[2400,950],q:2,peak:.3,attack:.003,duration:.07,drive:1.9,wet:.24}),o=Un(t,.2,1.3,.68,.3),n=rn(t,.14,.46),s=X(t,{type:"sine",freq:[190,72],peak:.46,attack:.0022,duration:.1,drive:2.6,voices:2,detuneCents:15,wet:.14});return G(e,a,o,n,s)}},Roll:{cast(t){const e=ne(t.rng,60);return B(t,{filter:"bandpass",freq:[900*e,2100*e],q:2.4,peak:.36,attack:.04,duration:.2,drive:1.5,wet:.3})},impact(t){const e=Un(t,.26,.7,1.5,.32),a=rn(t,.2,.44),o=B(t,{filter:"bandpass",freq:[1100,3400],q:7,peak:.3,attack:.02,duration:.26,drive:1.6,wet:.32}),n=X(t,{type:"sine",freq:[230,124],peak:.18,attack:.004,duration:.08,drive:2.2,wet:.12});return G(e,a,o,n)}},Swarm:{cast(t){const e=ne(t.rng,70),a=B(t,{filter:"bandpass",freq:[1400*e,3e3*e],q:4,peak:.36,attack:.025,duration:.17,drive:1.7,wet:.3}),o=rn(t,.16,.16);return G(a,o)},impact(t){const e=ve(t,{peak:.36,freq:4200,snap:2200,snapMs:7,wet:.1}),a=Un(t,.13,1.2,.8,.24),o=rn(t,.1,.3),n=X(t,{type:"sine",freq:[250,118],peak:.18,attack:.002,duration:.07,drive:2.4,wet:.12});return G(e,a,o,n)}}};function Yn(t,e,a,o){return li(t,{freq:e,duration:a,peak:o,attack:.0012,drive:1.4,wet:.34,modes:[{ratio:1,gain:1,decay:1},{ratio:2.06,gain:.82,decay:.82},{ratio:3.18,gain:.6,decay:.6},{ratio:4.34,gain:.4,decay:.42},{ratio:5.52,gain:.3,decay:.3}]})}function pc(t,e,a){return ze(t,{count:7,spread:e,grainMs:[2,5],freq:[4200,12e3],q:10,peak:a,decay:.3,wet:.12})}function sw(t,e,a){return zs(t,{count:4,spread:e,freq:[5e3,12500],peak:a,pingMs:[5,13],bend:1.08,wet:.2})}const iw={Candy:{cast(t){const e=ne(t.rng,70),a=B(t,{filter:"bandpass",freq:[1400*e,3200*e],q:2,peak:.34,attack:.022,duration:.13,wet:.28}),o=Yn(t,1900*e,.11,.2),n=pc(t,.07,.1);return G(a,o,n)},impact(t){const e=ne(t.rng,60),a=ve(t,{peak:.5,freq:5400,snap:3200,snapMs:8,wet:.12}),o=Yn(t,2450*e,.4,.56),n=pc(t,.22,.9),s=sw(t,.16,.74),i=Yn({...t,when:t.when+.09},2450*e*1.02,.26,.22),r=Yn({...t,when:t.when+.175},2450*e*1.045,.17,.11),l=X(t,{type:"sine",freq:[280*e,130*e],peak:.42,attack:.0018,duration:.1,drive:3.2,wet:.12});return G(a,o,n,s,.09+i,.175+r,l)}}};function zi(t,e,a){const o=ne(t.rng,60),n=ve(t,{peak:e,freq:(4200+a*1800)*o,snap:(2600+a*900)*o,snapMs:7,wet:.05}),s=B(t,{filter:"bandpass",freq:[(2600+a*800)*o,(5200+a*1600)*o],q:3.4,peak:e*.8,attack:5e-4,duration:.022,drive:2.2,wet:.1}),i=B(t,{filter:"highpass",poles:24,freq:[(7e3+a*1800)*o,(4600+a*1200)*o],q:.7,peak:e*1.5,attack:4e-4,duration:.024,wet:.12});return G(n,s,i)}function uc(t,e){const a=ne(t.rng,70),o=B(t,{filter:"lowpass",poles:24,freq:[(1800+e*600)*a,(420-e*110)*a],q:3.6,peak:.26+e*.18,attack:.012+e*.01,duration:.15+e*.12,drive:2,wet:.24}),n=X(t,{type:"sine",freq:[(180-e*45)*a,(58-e*16)*a],peak:.36+e*.3,attack:.006,duration:.13+e*.1,drive:3.2,voices:2,detuneCents:16,wet:.14}),s=B(t,{filter:"bandpass",freq:[700*a,1500*a],q:6,peak:.12+e*.08,attack:.03,duration:.2+e*.14,wet:.36}),i=ze(t,{count:Math.round(5+e*5),spread:.12+e*.06,grainMs:[3,8],freq:[3800,10600],q:7,peak:.5+e*.3,decay:.3,wet:.28});return G(o,n,s,i)}const Hi=.045,rw={Tackle:{cast(t){const e=ne(t.rng,40),a=B(t,{filter:"bandpass",freq:[420*e,1900*e],q:2,peak:.44,attack:.07,hold:.1,duration:.26,drive:1.6,wet:.3}),o=X(t,{type:"sine",freq:[120*e,240*e],peak:.28,attack:.08,duration:.24,drive:2.4,voices:2,detuneCents:14,wet:.16});return G(a,o)},impact(t){const e=zi(t,.88,.35),a=uc({...t,when:t.when+Hi},1);return G(e,Hi+a)}},Hatch:{cast(t){const e=zi(t,.5,0),a=X({...t,when:t.when+.05},{type:"triangle",freq:[1500,2400],peak:.3,attack:.006,duration:.09,drive:2.2,wet:.32}),o=X({...t,when:t.when+.15},{type:"triangle",freq:[1800,2700],peak:.24,attack:.005,duration:.07,drive:2.2,wet:.32});return G(e,.05+a,.15+o)},impact(t){const e=ve(t,{peak:.4,freq:5400,snap:3200,snapMs:6,wet:.1}),a=B(t,{filter:"highpass",poles:24,freq:[8200,5600],q:.7,peak:.2,attack:4e-4,duration:.005,wet:.12}),o=X(t,{type:"triangle",freq:[2100,1250],peak:.22,attack:.0015,duration:.05,drive:2.4,wet:.2}),n=X({...t,when:t.when+.035},{type:"triangle",freq:[1700,2600],peak:.18,attack:.005,duration:.06,drive:2,wet:.3}),s=X(t,{type:"sine",freq:[240,120],peak:.22,attack:.002,duration:.06,drive:2.2,wet:.1});return G(e,a,o,.035+n,s)}},Shards:{cast(t){const e=ne(t.rng,80),a=B(t,{filter:"highpass",freq:[1900*e,3800*e],q:1.1,peak:.32,attack:.016,duration:.11,wet:.26}),o=ze(t,{count:4,spread:.08,grainMs:[3,6],freq:[3400,7e3],q:8,peak:.13,wet:.28});return G(a,o)},impact(t){const e=Hi*.62,a=zi(t,.66,1),o=uc({...t,when:t.when+e},.18);return G(a,e+o)}}};function fc(t,e,a,o){const n=ne(t.rng,70),s=X(t,{type:"sine",freq:[(170-e*55)*n,(52-e*16)*n],peak:o,attack:.003,duration:a,drive:3+e*1.2,voices:2,detuneCents:18,wet:.12}),i=B(t,{filter:"lowpass",poles:24,freq:[(760-e*220)*n,(150-e*45)*n],q:1.2,peak:o*.45,attack:.002,duration:a*.7,drive:2.2,wet:.2}),r=B(t,{filter:"bandpass",freq:[(2400-e*400)*n,(1450-e*300)*n],q:.8,peak:o*.056,attack:.003,duration:a*.55,drive:1.4,wet:.3});return G(s,i,r)}const lw={Smash:{cast(t){const e=ne(t.rng,55),a=B(t,{filter:"lowpass",poles:24,freq:[1300*e,420*e],q:1.6,peak:.42,attack:.055,hold:.1,duration:.22,drive:1.7,wet:.22}),o=X(t,{type:"sawtooth",freq:[180*e,92*e],lowpass:[620,220],peak:.24,attack:.03,duration:.2,drive:2.2,voices:2,detuneCents:20,wet:.12});return G(a,o)},impact(t){const e=ve(t,{peak:.44,freq:1500,snap:620,snapMs:22,wet:.1}),a=fc(t,1,.24,.86);return G(e,a)}},Tomato:{cast(t){const e=ne(t.rng,80),a=B(t,{filter:"lowpass",poles:24,freq:[1500*e,520*e],q:2.1,peak:.36,attack:.014,duration:.14,drive:1.6,wet:.18}),o=X(t,{type:"sine",freq:[300*e,140*e],peak:.16,attack:.006,duration:.11,drive:2,wet:.1});return G(a,o)},impact(t){const e=ve(t,{peak:.34,freq:1900,snap:780,snapMs:15,wet:.1}),a=fc(t,.55,.19,.62),o=B(t,{filter:"lowpass",poles:24,freq:[1e3,260],q:2.8,peak:.24,attack:.008,duration:.13,drive:1.8,wet:.26});return G(e,a,o)}},Lettuce:{cast(t){return B(t,{filter:"bandpass",freq:[900,2200],q:1.2,peak:.26,attack:.03,duration:.15,wet:.3})},impact(t){const e=B(t,{filter:"lowpass",poles:24,freq:[1600,380],q:1.4,peak:.3,attack:.006,duration:.16,drive:1.5,wet:.3}),a=X(t,{type:"triangle",freq:[240,96],peak:.3,attack:.012,hold:.2,duration:.3,drive:2.4,voices:2,detuneCents:22,wet:.18}),o=B(t,{filter:"bandpass",freq:[3400,1900],q:.9,peak:.042,attack:.004,duration:.1,wet:.34});return G(e,a,o)}},Onion:{cast(t){const e=ne(t.rng,20),a=[174.61,220,261.63];a.forEach((n,s)=>{X({...t,when:t.when+s*.07},{type:"triangle",freq:n*e,peak:.28,attack:.016,hold:.22,duration:.34,drive:2.2,voices:2,detuneCents:11,wet:.4})});const o=B(t,{filter:"lowpass",poles:24,freq:[900,300],q:1,peak:.1,attack:.1,duration:.45,wet:.5});return G(.34+a.length*.07,o)}}};function mc(t,e,a,o,n){const s=ne(t.rng,60),i=.075+o*.045,r=.1+o*.06,l=B(t,{filter:"bandpass",freq:[e*s,a*s],q:5.5,peak:n,attack:.012,duration:i,drive:1.8,wet:.2}),h=B({...t,when:t.when+i*.82},{filter:"bandpass",freq:[a*s,e*.72*s],q:5.5,peak:n*.9,attack:.008,duration:r,drive:1.8,wet:.24}),c=X(t,{type:"triangle",freq:[e*.34*s,a*.3*s],peak:n*.5,attack:.014,duration:i+r*.6,drive:2.4,voices:2,detuneCents:16,wet:.14});return G(l,i*.82+h,c)}function gc(t,e,a){const o=ne(t.rng,70),n=ve(t,{peak:.3+e*.1,freq:1700+a*700,snap:700+a*320,snapMs:16,wet:.1}),s=B(t,{filter:"lowpass",poles:24,freq:[(1400+a*600)*o,(280+a*120)*o],q:3.2,peak:.42+e*.2,attack:.005,duration:.15+e*.07,drive:2,wet:.26}),i=X(t,{type:"sine",freq:[(210-e*50)*o,(66-e*18)*o],peak:.6+e*.34,attack:.0025,duration:.16+e*.14,drive:2.6,voices:2,detuneCents:15,wet:.14}),r=B(t,{filter:"bandpass",freq:[(4200+a*2200)*o,(2100+a*900)*o],q:.75,peak:.23+a*.06,attack:.0015,duration:.05+a*.03,wet:.34});return G(n,s,i,r)}const hw={Mustard:{cast(t){return mc(t,520,1250,.15,.44)},impact(t){return gc(t,.42,1)}},Ketchup:{cast(t){return mc(t,340,780,1,.42)},impact(t){const e=gc(t,.3,0),a=B(t,{filter:"lowpass",poles:24,freq:[640,200],q:4,peak:.2,attack:.04,duration:.34,drive:1.6,wet:.4});return G(e,a)}},Slash:{cast(t){const e=ne(t.rng,50);return B(t,{filter:"bandpass",freq:[700*e,2300*e],q:2,peak:.38,attack:.05,hold:.1,duration:.19,drive:1.5,wet:.26})},impact(t){const e=ne(t.rng,45),a=.026,o=(h,c,d)=>ve({...t,when:t.when+h},{peak:c,freq:d,snap:d*.3,snapMs:20,wet:.12}),n=o(0,.5,1400),s=o(a,.4,1200),i=B(t,{filter:"bandpass",freq:[900*e,340*e],q:2.4,peak:.34,attack:.0015,duration:.12,drive:2.1,wet:.24}),r=X(t,{type:"sine",freq:[200*e,58*e],peak:.95,attack:.002,duration:.24,drive:3,voices:2,detuneCents:17,wet:.14}),l=ze(t,{count:5,spread:.075,grainMs:[3,9],freq:[3e3,6400],q:4,peak:.38,decay:.3,wet:.3});return G(n,a+s,i,r,l)}}};function _i(t,e,a,o){const n=li(t,{freq:e,duration:a,peak:o,attack:8e-4,wet:.36,modes:[{ratio:1,gain:1,decay:1},{ratio:2.76,gain:.8,decay:.7},{ratio:5.4,gain:.5,decay:.44}]}),s=X(t,{type:"sine",freq:[e*1.02,e*.92],ring:e*1.37,peak:o*.7,attack:8e-4,duration:a*.8,wet:.4});return G(n,s)}function wc(t,e,a,o){return ze(t,{count:e,spread:a,grainMs:[2,5],freq:[5600,14e3],q:11,peak:o,decay:.3,wet:.3})}const cw={Smash:{cast(t){const e=ne(t.rng,50),a=B(t,{filter:"bandpass",freq:[600*e,2400*e],q:2.4,peak:.44,attack:.055,hold:.1,duration:.22,drive:1.5,wet:.3}),o=_i(t,2400*e,.12,.16);return G(a,o)},impact(t){const e=ne(t.rng,45),a=ve(t,{peak:.66,freq:6400,snap:4200,snapMs:6,wet:.14}),o=_i(t,5400*e,.34,.56),n=wc(t,9,.2,.8),s=X(t,{type:"sine",freq:[250*e,100*e],peak:.62,attack:.0015,duration:.12,drive:3,wet:.12}),i=B(t,{filter:"bandpass",freq:[7e3,12e3],q:1.2,peak:.26,attack:.025,duration:.16,wet:.5});return G(a,o,n,i,s)}},Giant:{impact(t){const e=ne(t.rng,35),a=ve(t,{peak:.72,freq:5800,snap:3600,snapMs:9,wet:.16}),o=_i(t,4550*e,.5,.64),n=wc(t,12,.36,.84),s=B(t,{filter:"bandpass",freq:[6e3,9500],q:1.4,peak:.14,attack:.06,duration:.58,wet:.6}),i=X(t,{type:"sine",freq:[230*e,78*e],peak:.52,attack:.0025,duration:.14,drive:3,voices:2,detuneCents:16,wet:.14});return G(a,o,n,s,i)}}};function Pi(t,e,a){const o=ne(t.rng,60),n=.38+a*.12,s=B(t,{filter:"bandpass",freq:[(560-a*200)*o,(2200-a*900)*o],q:1.5,peak:1.2,attack:.035,hold:.1,duration:n,drive:1.5,wet:.1*Math.min(1,16/e),tremolo:{rate:[e*.88,e],depth:.85}}),i=B(t,{filter:"highpass",freq:3600,peak:.16,attack:8e-4,duration:.018,wet:.1});return G(s,i)}const dw={Dough:{cast(t){return Pi(t,16,.85)},impact(t){const e=ne(t.rng,70),a=B(t,{filter:"lowpass",poles:24,freq:[1100*e,190*e],q:1.1,peak:.34,attack:.004,duration:.13,drive:1.8,wet:.24}),o=ve(t,{peak:.34,freq:1600,snap:660,snapMs:18,wet:.1}),n=X(t,{type:"sine",freq:[150*e,58*e],peak:.5,attack:.003,duration:.18,drive:2.8,voices:2,detuneCents:18,wet:.14}),s=B(t,{filter:"bandpass",freq:[2500,1700],q:.8,peak:.028,attack:.012,duration:.11,wet:.4});return G(a,o,n,s)}},Tomato:{cast(t){return Pi(t,26,.25)},impact(t){const e=ne(t.rng,65),a=B(t,{filter:"bandpass",freq:[1350*e,400*e],q:1.4,peak:.34,attack:.001,duration:.07,drive:2,wet:.2}),o=B(t,{filter:"lowpass",poles:24,freq:[900,240],q:2.6,peak:.3,attack:.008,duration:.15,drive:1.7,wet:.26}),n=ve(t,{peak:.34,freq:2e3,snap:900,snapMs:13,wet:.1}),s=X(t,{type:"sine",freq:[200*e,72*e],peak:.62,duration:.18,drive:3.2,voices:2,detuneCents:16,wet:.14}),i=Bl(t,{peak:.15,freq:[8200,3e3],duration:.085,drops:6,wet:.34});return G(a,o,n,s,i)}},Cheese:{cast(t){return Pi(t,12,.6)},impact(t){const e=ne(t.rng,55),a=B(t,{filter:"bandpass",freq:[1400*e,480*e],q:2.2,peak:.3,attack:.01,duration:.2,drive:1.6,wet:.26}),o=X(t,{type:"triangle",freq:[300*e,110*e],peak:.32,attack:.012,hold:.25,duration:.34,drive:2.4,voices:2,detuneCents:20,wet:.18}),n=ve(t,{peak:.26,freq:1800,snap:760,snapMs:16,wet:.1}),s=ze(t,{count:4,spread:.13,grainMs:[6,16],freq:[3200,5200],q:3.5,peak:.16,decay:.35,freqShift:[1,.62],wet:.34});return G(a,o,n,s)}}};function $i(t,e,a){return B(t,{filter:"bandpass",freq:[2800,5600],q:.85,peak:e,attack:a*.35,duration:a,wet:.55})}function qi(t,e,a,o){return un(t,{count:e,spread:a,freq:[1500,3100],rise:1.9,peak:o,wet:.42})}function Bi(t,e,a,o){const n=ne(t.rng,80),s=(2600-e*900)*n,i=(420-e*200)*n,r=B(t,{filter:"lowpass",freq:[s,i],poles:24,q:2.4+e*2,peak:o*.72,attack:.006+e*.012,duration:a,drive:1.8,wet:.3}),l=X(t,{type:"sine",freq:[(190-e*60)*n,(68-e*22)*n],peak:o*(.85+e*.55),attack:.005,duration:a*.75,drive:2.5,voices:2,detuneCents:16,wet:.14}),h=ve(t,{peak:.22+e*.12,freq:1150,snap:460,snapMs:18,wet:.12});return G(r,l,h)}const pw={Splash:{cast(t){const e=ne(t.rng,90),a=B(t,{filter:"bandpass",freq:[900*e,260*e],q:3.4,peak:.46,attack:.012,duration:.12,drive:1.8,wet:.24}),o=un(t,{count:2,spread:.07,freq:[620,980],peak:.2,wet:.3});return G(a,o)},impact(t){const e=Bi(t,.24,.2,.44),a=un(t,{count:4,spread:.16,freq:[480,900],peak:.14,wet:.3}),o=qi(t,7,.11,.2),n=$i(t,.11,.34);return G(e,a,o,n)}},Noodle:{cast(t){const e=ne(t.rng,70),a=B(t,{filter:"bandpass",freq:[1500*e,520*e],q:2.2,peak:.42,attack:.01,duration:.16,drive:1.7,wet:.26}),o=X(t,{type:"sine",freq:[520*e,190*e],peak:.16,attack:.02,duration:.18,drive:2,wet:.16});return G(a,o)},impact(t){const e=B(t,{filter:"bandpass",freq:[1400,560],q:1.6,peak:.26,attack:.0015,duration:.05,drive:1.8,wet:.18}),a=Bi(t,.35,.26,.44),o=un(t,{count:3,spread:.2,freq:[440,820],peak:.12,wet:.3}),n=qi(t,8,.14,.2),s=$i(t,.12,.42);return G(e,a,o,n,s)}},Dump:{cast(t){const e=ne(t.rng,40);let a=0;const o=9;for(let s=0;s<o;s++){const i=s/o*.34+we(t.rng,-.012,.012),r=we(t.rng,320,1100)*e,l=we(t.rng,.05,.11);a=Math.max(a,i+l),B({...t,when:t.when+Math.max(0,i)},{filter:"lowpass",poles:24,freq:[r*2.2,r*.6],q:4.5,peak:.32,attack:.008,duration:l,drive:1.6,wet:.28})}const n=X(t,{type:"sine",freq:[150*e,70*e],peak:.3,attack:.12,duration:.4,drive:2,voices:2,detuneCents:14,wet:.2});return G(a,n)},impact(t){const e=Bi(t,1,.42,.62),a=un(t,{count:7,spread:.34,freq:[380,820],peak:.16,wet:.34}),o=ze(t,{count:5,spread:.26,freq:[600,1500],peak:.1,q:4,wet:.3}),n=qi(t,7,.22,.14),s=$i(t,.15,.75);return G(e,a,o,n,s)}}};function ji(t,e,a,o,n){const s=ne(t.rng,45),i=B(t,{filter:"bandpass",freq:[e*s,a*s],q:12,peak:n,attack:.004,duration:o,curve:"lin",freqCurve:"exp",wet:.18}),r=B({...t,when:t.when+o*.16},{filter:"bandpass",freq:[e*2*s,a*1.7*s],q:14,peak:n*.5,attack:.002,duration:o*.7,curve:"lin",wet:.22}),l=B({...t,when:t.when+o*.06},{filter:"bandpass",freq:[e*3.4*s,a*2.6*s],q:16,peak:n*.8,attack:.0015,duration:o*.45,curve:"lin",wet:.24});return G(i,o*.16+r,o*.06+l)}function Vn(t,e,a,o){return ze(t,{count:e,spread:a,grainMs:[2,5],freq:[4200,12e3],q:6,peak:o,decay:.35,wet:.1})}const uw={Rice:{cast(t){const e=B(t,{filter:"highpass",freq:[2200,4200],q:1,peak:.3,attack:.012,duration:.09,wet:.2}),a=Vn(t,7,.09,.2);return G(e,a)},impact(t){const e=Vn(t,6,.075,.34),a=ve(t,{peak:.3,freq:5600,snap:3600,snapMs:5,wet:.08}),o=X(t,{type:"sine",freq:[300,170],peak:.16,attack:.0015,duration:.05,drive:2,wet:.1});return G(e,a,o)}},Seaweed:{cast(t){const e=ne(t.rng,60);return B(t,{filter:"bandpass",freq:[1600*e,3400*e],q:1.8,peak:.34,attack:.03,duration:.18,wet:.3})},impact(t){const e=ne(t.rng,55),a=ze(t,{count:10,spread:.16,grainMs:[3,9],freq:[2800,6400],q:4.5,peak:.28,decay:.35,wet:.28}),o=B(t,{filter:"bandpass",freq:[3600*e,1600*e],q:7,peak:.26,attack:.012,duration:.24,wet:.32}),n=ve(t,{peak:.32,freq:4200,snap:2400,snapMs:7,wet:.1}),s=X(t,{type:"sine",freq:[280,150],peak:.13,attack:.003,duration:.06,drive:2,wet:.12});return G(a,o,n,s)}},Fish:{cast(t){return ji(t,900,2600,.14,.3)},impact(t){const e=ji(t,2600,8200,.17,.72),a=B(t,{filter:"lowpass",poles:24,freq:[1100,340],q:2.4,peak:.16,attack:.006,duration:.09,drive:1.8,wet:.24}),o=Vn(t,5,.1,.2),n=X(t,{type:"sine",freq:[230,96],peak:.42,attack:.0018,duration:.07,drive:2.4,wet:.12});return G(e,a,o,n)}},Catch:{cast(t){const e=ne(t.rng,40),a=X(t,{type:"sine",freq:[140*e,300*e],peak:.3,attack:.1,duration:.3,drive:2.2,voices:2,detuneCents:14,wet:.24}),o=B(t,{filter:"bandpass",freq:[800*e,2400*e],q:2.2,peak:.34,attack:.08,duration:.28,wet:.32});return G(a,o)},impact(t){const e=ji(t,3e3,9e3,.15,.8),a=B({...t,when:t.when+.05},{filter:"lowpass",poles:24,freq:[1300,420],q:2.2,peak:.2,attack:.005,duration:.11,drive:1.9,wet:.26}),o=Vn({...t,when:t.when+.04},8,.16,.28),n=ve(t,{peak:.52,freq:5e3,snap:2800,snapMs:7,wet:.1}),s=X(t,{type:"sine",freq:[220,80],peak:.5,attack:.0018,duration:.09,drive:2.6,voices:2,detuneCents:14,wet:.14});return G(e,.05+a,.04+o,n,s)}}};function Kn(t,e,a){const o=ne(t.rng,70),n=B(t,{filter:"bandpass",freq:[3400*o,1500*o],q:1.2,peak:.55+e*.3,attack:6e-4,duration:.03,drive:2.2,wet:.12}),s=ve(t,{peak:.44+e*.2,freq:5200*o,snap:(2900-e*500)*o,snapMs:8,wet:.1}),i=ze(t,{count:Math.round(7+e*6),spread:.14+e*.1,grainMs:[3,9-a*3],freq:[2700+a*900,9200+a*2600],q:7,peak:.34+e*.16,decay:.28,drive:1.6,wet:.26}),r=e*(1-a)>.02?X(t,{type:"sine",freq:[(190-e*60)*o,(72-e*22)*o],peak:.24+e*.26,attack:.002,duration:.08+e*.1,drive:2.6,voices:2,detuneCents:16,wet:.14}):0,l=B(t,{filter:"highpass",poles:24,freq:[8e3+a*2e3,5200+a*1200],q:.7,peak:.165+e*.065,attack:6e-4,duration:.014+e*.012,wet:.22});return G(n,s,i,r,l)}const fw={Filling:{cast(t){const e=ne(t.rng,60),a=B(t,{filter:"bandpass",freq:[700*e,1800*e],q:2,peak:.44,attack:.03,duration:.16,drive:1.6,wet:.26}),o=ze(t,{count:4,spread:.1,freq:[3e3,7e3],peak:.11,q:8,wet:.28}),n=X(t,{type:"sine",freq:[260*e,130*e],peak:.14,duration:.1,drive:2,wet:.12});return G(a,o,n)},impact(t){return Kn(t,.75,.3)}},Onion:{cast(t){const e=ne(t.rng,80);return B(t,{filter:"highpass",freq:[1800*e,3400*e],q:1.1,peak:.36,attack:.02,duration:.12,wet:.28})},impact(t){const e=Kn(t,.3,1),a=B(t,{filter:"bandpass",freq:[1100,420],q:1.6,peak:.26,attack:.006,duration:.1,drive:1.7,wet:.24});return G(e,a)}},Double:{cast(t){const e=ne(t.rng,50),a=B(t,{filter:"bandpass",freq:[640*e,1700*e],q:2,peak:.44,attack:.025,duration:.15,drive:1.6,wet:.26}),o=B({...t,when:t.when+.055},{filter:"bandpass",freq:[820*e,2100*e],q:2,peak:.38,attack:.02,duration:.13,drive:1.6,wet:.26}),n=X(t,{type:"sine",freq:[240*e,118*e],peak:.16,duration:.12,drive:2,wet:.12});return G(a,.055+o,n)},impact(t){const e=Kn(t,.85,.1),a=Kn({...t,when:t.when+.055},.4,.85);return G(e,.055+a)}}};function Xn(t,e,a,o){return li(t,{freq:e,duration:a,peak:o,attack:.001,drive:1.8,wet:.22,modes:[{ratio:1,gain:1,decay:1},{ratio:2.43,gain:.78,decay:.55},{ratio:3.71,gain:.5,decay:.34},{ratio:5.86,gain:.3,decay:.2}]})}function bc(t,e,a){const o=B(t,{filter:"bandpass",freq:[1300,2800],q:1.5,peak:e,attack:.004,duration:a,wet:.34}),n=ze(t,{count:7,spread:a*.7,grainMs:[3,7],freq:[2600,8600],q:8,peak:e*.42,decay:.3,wet:.3}),s=B(t,{filter:"highpass",poles:24,freq:[6200,3800],q:.7,peak:e*.25,attack:.002,duration:a*.5,wet:.36});return G(o,n,s)}const mw={Spray:{cast(t){const e=B(t,{filter:"bandpass",freq:[900,2800],q:1.1,peak:.34,attack:.02,duration:.14,wet:.28}),a=Xn(t,190,.06,.2);return G(e,a)},impact(t){const e=ve(t,{peak:.28,freq:4200,snap:2500,snapMs:8,wet:.12}),a=bc(t,.34,.16),o=X(t,{type:"sine",freq:[260,120],peak:.3,attack:.002,duration:.09,drive:2,wet:.12});return G(e,a,o)}},Glass:{cast(t){const e=ne(t.rng,70),a=B(t,{filter:"highpass",freq:[1600*e,3600*e],q:1.2,peak:.36,attack:.018,duration:.13,wet:.26}),o=ze(t,{count:3,spread:.07,grainMs:[3,7],freq:[4200,8e3],q:9,peak:.14,wet:.3});return G(a,o)},impact(t){const e=ve(t,{peak:.62,freq:4600,snap:3400,snapMs:9,wet:.14}),a=Xn(t,460,.13,.42),o=ze(t,{count:9,spread:.15,grainMs:[3,8],freq:[3200,9200],q:8,peak:.3,decay:.25,wet:.32}),n=zs(t,{count:3,spread:.1,freq:[5200,11e3],peak:.19,pingMs:[6,14],bend:.9,wet:.34});return G(e,a,o,n)}},Cap:{cast(t){const e=X(t,{type:"sine",freq:[520,900],peak:.4,attack:.001,duration:.05,drive:2.6,wet:.2}),a=ve(t,{peak:.3,freq:4e3,snap:2400,snapMs:6,wet:.12});return G(e,a)},impact(t){const e=ve(t,{peak:.52,freq:3800,snap:2300,snapMs:9,wet:.12}),a=Xn(t,560,.2,.7),o=X(t,{type:"sine",freq:[150,68],peak:.17,attack:.003,duration:.11,drive:2.4,wet:.12}),n=zs(t,{count:2,spread:.05,freq:[4600,9e3],peak:.3,pingMs:[5,11],bend:.86,wet:.28});return G(e,a,o,n)}},Mega:{cast(t){const e=ne(t.rng,35),a=B(t,{filter:"bandpass",freq:[500*e,2600*e],q:1.8,peak:.44,attack:.1,hold:.08,duration:.34,drive:1.5,wet:.34}),o=X(t,{type:"sine",freq:[90*e,200*e],peak:.34,attack:.12,duration:.36,drive:2.4,voices:2,detuneCents:14,wet:.2});return G(a,o)},impact(t){const e=ve(t,{peak:.58,freq:3e3,snap:1500,snapMs:16,wet:.12}),a=bc(t,.56,.42),o=Xn(t,380,.24,.56),n=X(t,{type:"sine",freq:[140,46],peak:.62,attack:.003,duration:.3,drive:3.2,voices:2,detuneCents:18,wet:.16});return G(e,a,o,n)}}};function Et(t,e){const a={};for(const[o,n]of Object.entries(e))n&&(a[`${t}.${o}`]=n);return a}const gw={...Et("burrito",nw),...Et("donut",iw),...Et("egg",rw),...Et("hamburger",lw),...Et("hotdog",hw),...Et("lollipop",cw),...Et("pizza",dw),...Et("soup",pw),...Et("sushi",uw),...Et("taco",fw),...Et("waterbottle",mw)};function yc(t,e){return gw[`${t}.${e}`]}const ww=210,bw=.78,yw=420,xw=900,vw=520,kw=.45,Mw=1.5,Ew=1600,Tw=yw,Sw=.6180339887,Aw=.42;class Hs{constructor(e,a={}){this.engine=e,this.localSlot=a.listenerId??(a.listener==="enemy"?1:Fe),this.listenerSlot=this.localSlot}listenerSlot;localSlot;lastFogSoundAt=-1/0;lastHealSoundAt=-1/0;ringFloored=!1;sawRingAboveFloor=!1;statusBefore=[];statusWriterUnclaimed=[];statusTrackable=!1;nextAmbienceAt=-1/0;ambienceChunk=0;lastCombatAt=-1/0;setListener(e){this.listenerSlot=e}handleEvents(e,a){try{this.watchZone(a),this.watchAmbience(a),this.openStatusWindow(a);for(const o of e)this.handleEvent(o,a)}catch(o){console.warn("[audio] event dispatch failed:",o)}finally{this.closeStatusWindow(a)}}reset(){this.listenerSlot=this.localSlot,this.lastFogSoundAt=-1/0,this.lastHealSoundAt=-1/0,this.ringFloored=!1,this.sawRingAboveFloor=!1,this.statusBefore=[],this.statusWriterUnclaimed=[],this.statusTrackable=!1,this.nextAmbienceAt=-1/0,this.ambienceChunk=0,this.lastCombatAt=-1/0}static statusTimestamps(e){const a=e.status;return!a||typeof a.stunnedUntil!="number"||typeof a.slowedUntil!="number"?null:{stun:a.stunnedUntil,slow:a.slowedUntil}}openStatusWindow(e){const o=_e(e).map(n=>Hs.statusTimestamps(n));if(this.statusTrackable=o.length>0&&o.every(n=>n!==null),!!this.statusTrackable)for(let n=0;n<o.length;n++){const s=this.statusBefore[n]??{stun:NaN,slow:NaN},i=o[n];this.statusWriterUnclaimed[n]={stun:i.stun!==s.stun,slow:i.slow!==s.slow}}}closeStatusWindow(e){_e(e).forEach((a,o)=>{const n=Hs.statusTimestamps(a);n&&(this.statusBefore[o]=n)})}wasStatusRefused(e,a){if(!this.statusTrackable)return!1;const o=this.statusWriterUnclaimed[e];return o?.[a]?(o[a]=!1,!1):!0}watchZone(e){if(!this.ringFloored&&e.phase==="playing"){if(e.safeRadius>Bp(e.fighters.length,e.timeRemaining)+.5){this.sawRingAboveFloor=!0;return}this.sawRingAboveFloor&&(this.ringFloored=!0,this.engine.play(ew(),{priority:Ve.Critical}))}}watchAmbience(e){if(e.phase!=="playing"||e.elapsed<this.nextAmbienceAt)return;this.nextAmbienceAt=e.elapsed+E0*1e3;const a=this.ambienceChunk*Sw%1;this.ambienceChunk++;const o=_e(e);let n=1/0;for(let i=0;i<o.length;i++)for(let r=i+1;r<o.length;r++){const l=Math.hypot(o[i].x-o[r].x,o[i].y-o[r].y);l<n&&(n=l)}const s=e.elapsed-this.lastCombatAt<Ew||n<Tw;this.engine.play(Vg(),{gain:s?kw:Mw,pan:(a*2-1)*Aw,priority:Ve.Ambient,key:"ambience"})}handleEvent(e,a){switch(e.type){case"countdown-tick":this.engine.play(Jg(e.value),{priority:Ve.Critical});break;case"match-started":this.engine.play(Qg(),{priority:Ve.Critical});break;case"match-ended":{const o=_e(a),n=o.length>0&&o.every(i=>i.alive===!0),s=aa(e.winnerId,e.winner)===this.localSlot;this.engine.play(n?aw(s):tw(s),{priority:Ve.Critical});break}case"weapon-fired":this.lastCombatAt=a.elapsed,this.playCast(mt(a,e.fighterId,e.fighterRole),e.weaponKey,a);break;case"hit-landed":this.lastCombatAt=a.elapsed,this.playHit(e,a);break;case"heal":{if(e.amount<=jp&&a.elapsed-this.lastHealSoundAt<vw)break;this.lastHealSoundAt=a.elapsed;const o=mt(a,e.fighterId,e.fighterRole);this.engine.play(Wg(),{...this.place(o.x,o.y,a),key:"heal"});break}case"death":{const o=mt(a,e.fighterId,e.fighterRole),n=this.place(o.x,o.y,a);this.engine.play(Gg(),{...n,priority:Ve.Critical,gain:aa(e.fighterId,e.fighterRole)===this.localSlot?1:n.gain});break}case"projectile-destroyed":e.reason==="hit-cover"&&this.engine.play(Zg(),{...this.place(e.x,e.y,a),priority:Ve.Ambient,key:"cover"});break}}playCast(e,a,o){const n=re[e.characterId].weapons.find(r=>r.key===a);if(!n)return;if(n.giantSlam){this.engine.play($g(),{priority:Ve.Critical});return}const s=yc(e.characterId,a)?.cast,i=s?this.wrapWeaponHook(s,n,e.characterId,n.damage):Rw(n);this.engine.play(i,{...this.place(e.x,e.y,o),key:`cast:${e.characterId}.${a}`})}playHit(e,a){const o=this.place(e.x,e.y,a),n=aa(e.targetId,e.targetRole),s=e.effect==="stun"&&this.wasStatusRefused(n,"stun");if(e.source.kind==="fog"){if(a.elapsed-this.lastFogSoundAt<xw)return;this.lastFogSoundAt=a.elapsed,this.engine.play(Ug(),{priority:Ve.Ambient,key:"fog"});return}if(e.source.kind==="hazard"){this.engine.play(Kg(),{...o,priority:Ve.Ambient,key:"hazard"});return}if(e.source.kind==="trail"){this.engine.play(Xg(),{...o,priority:Ve.Ambient,key:"trail"});return}const i=e.source.weaponKey,r=fn(a,e.source,e.targetRole),l=re[r.characterId].weapons.find(d=>d.key===i),h=l?yc(r.characterId,l.key)?.impact:void 0,c=h&&l?this.wrapWeaponHook(h,l,r.characterId,e.amount):qg(e.amount);if(this.engine.play(c,{...o,key:`impact:${r.characterId}.${i}`}),n===this.localSlot){const d=mt(a,e.targetId,e.targetRole);this.engine.play(Bg(d.hp/d.maxHp),{gain:.9,key:"hurt",priority:Ve.Normal})}s&&this.engine.play(jg(),{...o,key:"shrug",priority:Ve.Normal})}wrapWeaponHook(e,a,o,n){return s=>e({...s,color:a.color,damage:n,weapon:a,characterId:o})}place(e,a,o){const n=_e(o)[this.listenerSlot]??o.player,s=e-n.x,i=a-n.y,r=Math.max(-1,Math.min(1,s/ww))*bw,l=Math.hypot(s,i),h=Lg(l,Dg,zg);return{pan:r,gain:h}}}function Rw(t){return t.type==="melee"?_g(t.damage,t.cone??90):t.type==="self"?Pg():Hg(t.damage)}const Gi="/food-arena/",xc=`${Gi.endsWith("/")?Gi:`${Gi}/`}audio/bounce-and-bash.mp3`,vc=.45,T0="fa.audio.music";function Iw(){try{const t=localStorage.getItem(T0);if(t){const e=JSON.parse(t);return{volume:typeof e.volume=="number"?Math.min(1,Math.max(0,e.volume)):vc,enabled:e.enabled!==!1}}}catch{}return{volume:vc,enabled:!0}}function kc(t){try{localStorage.setItem(T0,JSON.stringify(t))}catch{}}class Fw{el=null;source=null;gain=null;state=Iw();wanted=!1;listeners=new Set;fadeToken=0;loadError=null;suppressed=!1;ensureGraph(){if(typeof document>"u")return!1;const e=lt(),a=e.context,o=e.busInput;if(!a||!o||typeof a.createMediaElementSource!="function")return!1;if(this.source)return!0;if(!this.el){const n=document.createElement("audio");n.src=xc,n.loop=!0,n.preload="auto",n.volume=1,n.crossOrigin="anonymous",n.addEventListener("error",()=>{const s=n.error?n.error.code:0;this.loadError=`music track failed to load (MediaError ${s}) from ${n.currentSrc||n.src}`,console.warn(`[audio] ${this.loadError}`),this.emit()},{once:!0}),this.el=n}try{return this.source=a.createMediaElementSource(this.el),this.gain=a.createGain(),this.gain.gain.value=this.state.enabled?this.state.volume:0,this.source.connect(this.gain).connect(o),!0}catch{return this.source=null,this.gain=null,!1}}play(){if(this.wanted=!0,this.suppressed||!this.state.enabled||!this.ensureGraph()||!this.el)return;const e=this.el.play();e&&typeof e.catch=="function"&&e.catch(()=>{})}pause(){this.wanted=!1,this.el?.pause()}onUnlock(){this.wanted&&this.play()}isPlaying(){return!!this.el&&!this.el.paused}getLoadError(){return this.loadError}getTrackUrl(){return this.el?this.el.src:xc}getVolume(){return this.state.volume}setVolume(e){this.state.volume=Math.min(1,Math.max(0,e)),kc(this.state),this.applyGain(),this.emit()}isEnabled(){return this.state.enabled}setEnabled(e){this.state.enabled=e,kc(this.state),this.applyGain(),e?this.play():this.el?.pause(),this.emit()}fadeOut(e=.6){if(this.suppressed=!0,!this.el||this.el.paused)return;this.applyGain(0,e);const a=this.el;window.setTimeout(()=>{this.fadeToken===o&&a.pause()},e*1e3+40);const o=++this.fadeToken}fadeIn(e=.8){if(this.fadeToken++,this.suppressed=!1,!this.state.enabled||!this.ensureGraph()||!this.el)return;const a=this.el.paused;if(a){this.gain&&(this.gain.gain.value=0);const o=this.el.play();o&&typeof o.catch=="function"&&o.catch(()=>{})}this.applyGain(void 0,a?e:.25)}duck(e=.35){this.applyGain(this.state.volume*Math.min(1,Math.max(0,e)))}unduck(){this.applyGain()}onChange(e){return this.listeners.add(e),()=>this.listeners.delete(e)}applyGain(e,a=.08){if(!this.gain)return;const n=lt().context,s=this.state.enabled?e??this.state.volume:0;try{if(n){const i=n.currentTime;this.gain.gain.cancelScheduledValues(i),this.gain.gain.setValueAtTime(this.gain.gain.value,i),this.gain.gain.linearRampToValueAtTime(s,i+a)}else this.gain.gain.value=s}catch{this.gain.gain.value=s}}emit(){for(const e of this.listeners)try{e()}catch{}}}let Zn=null;function tt(){if(!Zn){Zn=new Fw;const t=Zn;lt().onChange(()=>{lt().getState()==="running"&&t.onUnlock()})}return Zn}let Jn=null;function lt(){return Jn||(Jn=new Cg,Ow(Jn)),Jn}function Cw(t){return new Hs(lt(),t)}const ke={setVolume(t){lt().setVolume(t)},getVolume(){return lt().getVolume()},setMuted(t){lt().setMuted(t)},isMuted(){return lt().isMuted()},toggleMuted(){return lt().toggleMuted()},onChange(t){return lt().onChange(t)},getState(){return lt().getState()},unlock(){lt().unlock()},previewClick(){lt().play(ow(),{key:"ui"})},music:{play(){tt().play()},pause(){tt().pause()},isPlaying(){return tt().isPlaying()},getVolume(){return tt().getVolume()},setVolume(t){tt().setVolume(t)},isEnabled(){return tt().isEnabled()},setEnabled(t){tt().setEnabled(t)},fadeOut(t){tt().fadeOut(t)},fadeIn(t){tt().fadeIn(t)},duck(t){tt().duck(t)},unduck(){tt().unduck()},onChange(t){return tt().onChange(t)},getLoadError(){return tt().getLoadError()},getTrackUrl(){return tt().getTrackUrl()}}};function Ow(t){typeof window>"u"||(window.__audio={engine:t,tap:()=>t.tap(),connectTap:e=>t.connectTap(e),stats:()=>({state:t.getState(),activeVoices:t.activeVoices(),started:t.counters.started,droppedBudget:t.counters.droppedBudget,droppedThrottle:t.counters.droppedThrottle,droppedNotRunning:t.counters.droppedNotRunning,volume:t.getVolume(),muted:t.isMuted()}),get music(){const e=tt();return{url:e.getTrackUrl(),error:e.getLoadError(),playing:e.isPlaying(),enabled:e.isEnabled()}}})}const I={ink:"#1a1224",cream:"#FFF3DE",white:"#FFFFFF",gold:"#F4A300",goldDark:"#B87400",mustard:"#FFC93C",mustardHi:"#FFDD6B",ketchup:"#D62839",tomato:"#E63946",tomatoHi:"#FF9E9E",lettuce:"#7CB518",leafDark:"#4E8B2B",water:"#1E90D8",waterHi:"#5BC8F5",ice:"#8FE1FF",iceHi:"#BFF0FF",grape:"#7A4BC4",grapeHi:"#9B6BE0",grapeDark:"#5B2E8C",violet:"#B497D6",wood:"#8B4A22",woodHi:"#B4622A",meat:"#8B3A2E",meatHi:"#D98A72",patty:"#A05A2C",pattyDark:"#5A2E17",steel:"#DCD6E8",candy:"#FF6FA5",candyHi:"#FFB3D1",flame:"#FF7A2F"};function To(t,e,a,o=12,n=12){const s=[];for(let i=0;i<t*2;i++){const r=i%2===0?e:a,l=Math.PI*i/t-Math.PI/2;s.push(`${(o+r*Math.cos(l)).toFixed(2)} ${(n+r*Math.sin(l)).toFixed(2)}`)}return`M${s.join("L")}Z`}const Nw={patty:`
...
<path d="M8.4 15a4 4 0 0 0 4.6 4.4" stroke="${I.gold}" stroke-width="1.9"/>`,burst:`<path d="${To(9,10.2,4.6)}" fill="${I.gold}"/>
<path d="${To(9,5.6,2.4)}" fill="${I.mustardHi}" stroke-width="1.3"/>`,hammer:`
...
<path d="M18.3 9.2c1.7 2.4 2.5 4.2 2.5 5.5 0 1.5-.9 2.5-2.2 2.5s-2.2-1-2.2-2.5c0-1.3.6-3 1.9-5.5z" fill="${I.mustardHi}"/>`};function Qn(t,e,a,o=""){return`
...
${o}`}const Lw=`<path d="M12 0.6c2.6 2.2 3.7 3.9 3.2 5.5-.9-.8-1.6-1.1-2.3-.9.7 1.9.3 3.1-.9 4-1.2-.9-1.6-2.1-.9-4-.7-.2-1.4.1-2.3.9-.5-1.6.6-3.3 3.2-5.5z" fill="${I.flame}" stroke-width="1.3"/>`,Dw=`<path d="M12 0.4c2.4.8 3.6 2.4 3.6 4.6-2.4-.7-3.6-2.3-3.6-4.6zM12 0.4c-2.4.8-3.6 2.4-3.6 4.6C10.8 4.3 12 2.7 12 .4z" fill="${I.lettuce}" stroke-width="1.3"/>`,zw=`<path d="M12 5.6C9.2 1.6 4.8 2.8 6.2 5.6M12 5.6C14.8 1.6 19.2 2.8 17.8 5.6" fill="${I.mustard}" stroke-width="1.4"/>`,Hw=`<path d="M4.9 13.4a2.6 2.6 0 0 1 5.2 0z" fill="#B4622A" stroke-width="1.2"/>
<path d="M4.7 13.4h5.6v1.5H4.7z" fill="${I.lettuce}" stroke-width="1.2"/>
<path d="M4.9 15h5.2a2.2 2.2 0 0 1-5.2 0z" fill="#B4622A" stroke-width="1.2"/>`,_w=Array.from({length:8},(t,e)=>`<rect x="10.3" y="0.9" width="3.4" height="5.4" rx="1.2" fill="${I.gold}" transform="rotate(${e*45} 12 12)"/>`).join(""),Pw={coin:`
<circle cx="12" cy="12" r="9.5" fill="${I.goldDark}"/>
<circle cx="12" cy="12" r="7.6" fill="${I.gold}" stroke="none"/>
<path d="${To(5,5.8,2.5,12,12)}" fill="${I.cream}" stroke="none"/>`,gem:`
...
<path d="M9.6 5.1a3.4 3.4 0 0 0 .5 4.5" stroke="${I.cream}" stroke-width="1.4"/>`,star:`<path d="${To(5,9.4,4.1)}" fill="${I.mustard}"/>
...
<circle cx="12" cy="12.9" r="0.85" fill="${I.wood}" stroke="none"/>`,boxBurger:Qn(I.gold,I.mustard,I.ketchup,Hw),boxPineapple:Qn(I.grape,I.grapeHi,I.mustard,Dw),boxRed:Qn(I.ketchup,"#E9536A",I.mustard,zw),boxFire:Qn(I.grapeDark,I.grape,I.flame,Lw),gift:`
...
<path d="M12 6.2c-2.6-3.4-6.2-2.4-5 .2M12 6.2c2.6-3.4 6.2-2.4 5 .2" fill="${I.mustard}" stroke-width="1.4"/>`,gear:`${_w}
...
<path d="M12 9.6v5.6M9.2 12.4h5.6" stroke="${I.cream}" stroke-width="2.1"/>`,stun:`<path d="${To(5,8.6,3.7,10.2,10.6)}" fill="${I.mustard}"/>
<path d="${To(5,4.2,1.8,19.2,18)}" fill="${I.mustardHi}" stroke-width="1.4"/>`,slow:`
...
<path d="M16.2 8.8 18.6 6.4" stroke-width="1.4"/>`},pt=416,yt=496,Mc=pt/yt,$w=.42,qw=.07,Wi=.08,Bw=.66,jw=.08,La={x0:.035,x1:.965,y0:.045,y1:.725},Gw=.7,Ui=.18,Yi=.92,Ww=1.15,Ka=new Map,Vi=new Map,ol=[];let Ki=!1;function Uw(t){const a=document.createElement("canvas");a.width=8,a.height=8;const o=a.getContext("2d",{willReadFrequently:!0});if(!o)return[0,0,0];o.drawImage(t,0,0,8,8);const n=o.getImageData(0,0,8,8).data;let s=0,i=0,r=0;for(let h=0;h<n.length;h+=4)s+=n[h],i+=n[h+1],r+=n[h+2];const l=n.length/4;return[Math.round(s/l),Math.round(i/l),Math.round(r/l)]}function Gl(t){return Ka.get(t)}function nl(){const t=[...Ee];if(typeof document>"u"||typeof window<"u"&&window.__screen==="characters")return t;const e=new Set;for(const a of document.querySelectorAll("[data-portrait]")){const o=a.dataset.portrait;Ee.includes(o)&&e.add(o)}return!e.size&&(typeof window>"u"||!window.__screen)?t:[...e]}function S0(t){for(const a of Ee){const o=Ka.get(a);o&&t(a,o)}if(Ee.every(a=>Ka.has(a))){window.__thumbsReady=!0;return}if(ol.push(t),Ki)return;Ki=!0,window.__thumbsReady=!1;const e=()=>void Yw().finally(()=>{Ki=!1,ol.length=0,window.__thumbsReady=nl().every(a=>Ka.has(a))});typeof requestIdleCallback=="function"?requestIdleCallback(e,{timeout:600}):setTimeout(e,120)}async function Yw(){if(!nl().some(a=>!Ka.has(a)))return;const t=document.createElement("div");t.style.cssText=`position:fixed;left:-9999px;top:0;width:${pt}px;height:${yt}px;pointer-events:none;`,document.body.appendChild(t);let e=null;try{e=new Tl({container:t,background:0,fog:null,camera:{pitchDeg:12,yawDeg:24,frameMode:"subject",subjectHeight:2.1,subjectFill:1,targetHeight:1.05,followLerp:1},shadows:!1,postFx:"grade",offscreen:!0,maxPixelRatio:1}),e.canvas.style.cssText=`display:block;width:${pt}px;height:${yt}px;`,e.resize();const a=new Set;for(;;){const o=nl().filter(n=>!Ka.has(n)&&!a.has(n));if(!o.length)break;for(const n of o)a.add(n),await Kw(e,n)}}catch{}finally{e?.dispose(),t.remove()}}function ln(t,e,a,o){const n=new pe,s=t.getCenter(n.clone()).applyMatrix4(e.matrixWorldInverse).z;let i=1/0,r=1/0,l=-1/0,h=-1/0;for(let c=0;c<8;c++){n.set(c&1?t.max.x:t.min.x,c&2?t.max.y:t.min.y,c&4?t.max.z:t.min.z).applyMatrix4(e.matrixWorldInverse),n.z=s,n.applyMatrix4(e.projectionMatrix);const d=(n.x*.5+.5)*a,p=(1-(n.y*.5+.5))*o;i=Math.min(i,d),l=Math.max(l,d),r=Math.min(r,p),h=Math.max(h,p)}return{x:+i.toFixed(1),y:+r.toFixed(1),w:+(l-i).toFixed(1),h:+(h-r).toFixed(1)}}function Ec(t,e){const a=t.getObjectByName(e);if(!a)return null;const o=new vn().setFromObject(a);return o.isEmpty()?null:o}function Vw(t,e,a){const o=new pe;let n=0;return t.traverse(s=>{const i=s;if(!i.isMesh||!i.visible)return;const r=i.geometry?.getAttribute("position");if(r)for(let l=0;l<r.count;l++){if(o.fromBufferAttribute(r,l).applyMatrix4(i.matrixWorld),o.y<e)continue;const h=Math.abs(o.dot(a));h>n&&(n=h)}}),n}async function Kw(t,e){const a=Al(e);t.scene.add(a.root),a.play("idle"),a.update({dt:.4,elapsed:.4,moveSpeed01:0,health01:1});const o=new vn().setFromObject(a.root),n=Ec(a.root,"head"),s=Ec(a.root,"face"),i=Math.max(.5,o.max.y-o.min.y),r=o.max.y,l=(s??n)?.min.y??o.min.y+.45*i,h=Math.max(o.min.y,Math.min(o.min.y+$w*i,l-qw*i)),c=Math.max(.4,r-h),d=t.rig.camera,p=new pe,u=(T,S,A)=>{t.rig.subjectFill=1,t.rig.subjectHeight=T,t.rig.targetHeight=S-T/2,t.rig.snapTo(A*p.x,A*p.z),d.updateMatrixWorld(!0),d.matrixWorldInverse.copy(d.matrixWorld).invert()};u(c/Yi,r+Wi*(c/Yi),0),p.setFromMatrixColumn(d.matrixWorld,0).normalize();const m=Vw(a.root,h,p),f=Math.max(c/Yi,2*m/(Mc*Ww),s?(r-s.min.y)/(Bw+jw):0);let g=r+Wi*f,w=0,b=f;if(s){const T=()=>r-Ui*b;for(let S=0;S<4;S++){g=r+Wi*b;for(let H=0;H<3;H++){u(b,g,w);const K=ln(s,d,pt,yt),O=(K.y+K.h)/yt-Gw;if(O<=0)break;const _=Math.max(0,(K.y/yt-La.y0)*b),z=Math.max(T(),g-Math.min(O*b,_));if(Math.abs(z-g)<1e-4)break;g=z}u(b,g,w);const A=ln(s,d,pt,yt),C=A.x+A.w-La.x1*pt,R=La.x0*pt-A.x,F=b*Mc/pt;C>0&&R<0?w+=Math.min(C,-R)*F:R>0&&C<0&&(w-=Math.min(R,-C)*F);const N=A.w/((La.x1-La.x0)*pt),L=(A.y+A.h)/yt,P=L>La.y1?(L+Ui)/(La.y1+Ui):1,W=Math.max(N,P);if(W<=1.001)break;b*=W}}u(b,g,w);const x=Rl[re[e].rarity];t.scene.background=new Kt(x),t.lighting.focus(0,0,4),Vi.has(x)||(a.root.visible=!1,t.render(0),Vi.set(x,Uw(t.canvas)),a.root.visible=!0),t.render(0),t.render(0);const M=t.canvas.toDataURL("image/png"),y=a.root.getObjectByName("hips"),v=a.root.getObjectByName("shoulderL"),k=new pe;(window.__thumbMeta??={})[e]={size:{w:pt,h:yt},subject:ln(o,d,pt,yt),head:n?ln(n,d,pt,yt):null,face:s?ln(s,d,pt,yt):null,bg:Vi.get(x)??null,world:{minY:+o.min.y.toFixed(4),maxY:+o.max.y.toFixed(4),halfWidth:+Math.max(Math.abs(o.min.x),Math.abs(o.max.x)).toFixed(4),hipsY:y?+y.getWorldPosition(k).y.toFixed(4):null,shoulderY:v?+v.getWorldPosition(k).y.toFixed(4):null,headY:n?[+n.min.y.toFixed(4),+n.max.y.toFixed(4)]:null,faceY:s?[+s.min.y.toFixed(4),+s.max.y.toFixed(4)]:null,yCut:+h.toFixed(4),upperHalfWidth:+m.toFixed(4)},frame:{subjectHeight:+t.rig.subjectHeight.toFixed(4),subjectFill:+t.rig.subjectFill.toFixed(4),targetHeight:+t.rig.targetHeight.toFixed(4),headroom:+((g-r)/b).toFixed(4),pan:+w.toFixed(4)}},t.scene.remove(a.root),a.dispose(),Ka.set(e,M);for(const T of ol)T(e,M);await new Promise(T=>setTimeout(T,0))}const Xw='<circle cx="12" cy="9" r="5.6" fill="#FFF3DE"/><path d="M5.2 21.6c0-3.5 3-5.6 6.8-5.6s6.8 2.1 6.8 5.6z" fill="#FFF3DE"/>';function va(t,e={}){const a=Rl[re[t].rarity],o=Gl(t),n=["fa-ic-portrait",e.crop==="head"?"fa-ic-portrait--head":"",o?"has-render":"",e.class??""].filter(Boolean).join(" "),s=o?` src="${o}"`:"";return`<span class="${n}" data-portrait="${t}" style="--pc:${a}"><img alt=""${s}/><svg class="fa-ic" viewBox="0 0 24 24" fill="none" style="stroke:var(--fa-ic-ink,#1a1224)" stroke-width="1.7" stroke-linejoin="round" stroke-linecap="round" aria-hidden="true" focusable="false">${Xw}</svg></span>`}function Do(t,e={}){const a=(o,n)=>{for(const s of t.querySelectorAll(`[data-portrait="${o}"]`)){const i=s.querySelector("img");i&&(i.getAttribute("src")!==n&&i.setAttribute("src",n),s.classList.add("has-render"))}};if(e.generate===!1){for(const o of t.querySelectorAll("[data-portrait]")){const n=o.dataset.portrait,s=Gl(n);s&&a(n,s)}return}S0(a)}const Zw={...Pw,...Nw},Jw='viewBox="0 0 24 24" fill="none" style="stroke:var(--fa-ic-ink,#1a1224)" stroke-width="1.7" stroke-linejoin="round" stroke-linecap="round"';function D(t,e={}){const a=Zw[t];if(!a)return"";const o=["fa-ic",`fa-ic--${t}`,e.class??""].filter(Boolean).join(" "),n=e.size??"1em",s=e.label?`role="img" aria-label="${e.label}"`:'aria-hidden="true" focusable="false"';return`<svg class="${o}" ${Jw} width="${n}" height="${n}" ${s}>${a}</svg>`}const Qw={"🪙":"coin","💎":"gem","🏆":"trophy","⭐":"star","✨":"sparkle","🏁":"flag","📍":"pin","🎉":"party","🎁":"gift","🧑‍🍳":"chefhat","⚙️":"gear","⚙":"gear","🔒":"lock","▶":"play","⏸":"pause","◀":"back","🙂":"avatar","🚧":"cone","🔇":"mute","🔊":"sound","🏠":"home","🍟":"swap","❤️":"health","❤":"health","💨":"speed","↔":"range","⏱":"timer","💚":"heal","💫":"stun","🐌":"slow","🍖":"patty","🍅":"tomato","🥬":"lettuce","🧅":"onion","🍬":"candy","🥩":"meat","🌯":"wrap","🌀":"swirl","🥚":"egg","🐣":"chick","💥":"burst","🔨":"hammer","🍭":"lollipop","⚪":"dough","🧀":"cheese","🍚":"rice","🌿":"seaweed","🐟":"fish","🐡":"puffer","💦":"droplets","🍜":"noodle","🌊":"wave","🧊":"shards","🔵":"cap","💛":"mustardblast","🔴":"ketchupslip","⚔️":"slash","⚔":"damage","🍯":"honey","💧":"droplets"},e1={chest:"chest",hamburgerBox:"boxBurger",pineappleBox:"boxPineapple",redBox:"boxRed",fireBox:"boxFire"};function ga(t,e={}){const a=Qw[t];return a?D(a,e):t}function At(t,e={}){return D(e1[t]??"chest",e)}function A0(t,e={}){return ga(t,e)}const Tc="fa-icon-styles";function ha(){if(document.getElementById(Tc))return;const t=document.createElement("style");t.id=Tc,t.textContent=t1,document.head.appendChild(t)}const t1=`
...
`,Sc=[Gt.tomato,Gt.mustard,Gt.lettuce,Gt.cheese,Gt.glaze,Gt.waterCap];function _s(t,e=50,a=26){for(let o=0;o<a;o++){const n=document.createElement("span");n.className="fa-confetti",n.style.left=`${e+(Math.random()*12-6)}%`,n.style.background=Sc[Math.floor(Math.random()*Sc.length)],n.style.animationDelay=`${(Math.random()*.22).toFixed(2)}s`,n.style.setProperty("--x",`${Math.round(Math.random()*240-120)}px`),t.appendChild(n),setTimeout(()=>n.remove(),1800)}}function Ce(t,e,a){const o=document.createElement(t);return e&&(o.className=e),o}const a1="Kitchen Rumble";function o1(t){const e=Math.round(t/1e3);return`${Math.floor(e/60)}:${String(e%60).padStart(2,"0")}`}function n1(t){la("fa-home-styles",s1),ha();const e=Ce("div","fa-screen fa-home"),a=$l();a.setScene("lobby"),e.innerHTML=`
    ...
    <footer class="home-bottom">
      ...
      <button class="home-mode" type="button" data-el="mode"
        ...
        <span class="home-mode-lines">
          <span class="home-mode-name">${a1}</span>
          <span class="home-mode-sub" data-el="modesub">${o1(Ea)} · last one standing</span>
        </span>
  ...
  `;const o=y=>{const v=e.querySelector(`[data-el="${y}"]`);if(!v)throw new Error(`home: missing element "${y}"`);return v},n=o("stage3d"),s=o("confetti"),i=o("heroname"),r=o("herorarity"),l=o("hint");let h=0;function c(){const y=t.profile.claimable.length,v=o("road"),k=o("roadfill");if(y>0){v.classList.add("is-ready"),o("roadicon").innerHTML=D("sparkle"),o("roadtitle").textContent=y>1?`${y} rewards ready`:"Reward ready",o("roadsub").textContent="Tap to claim",o("roadpill").textContent="Claim",k.style.width="100%";return}v.classList.remove("is-ready");const{progress01:T,next:S}=i0(t.profile.trophies);if(k.style.width=`${(T*100).toFixed(1)}%`,!S){o("roadicon").innerHTML=D("flag"),o("roadtitle").textContent="Road complete",o("roadsub").textContent="Every reward claimed",o("roadpill").innerHTML=`${D("trophy")} ${t.profile.trophies.toLocaleString()}`;return}const A=Qr(S.reward,t.profile.unlocked);o("roadicon").innerHTML=S.reward.type==="character"?va(S.reward.id,{crop:"head"}):S.reward.type==="container"?At(S.reward.kind):ga(A.emoji),Do(e),o("roadtitle").textContent=A.title,o("roadsub").textContent=`${(S.trophies-t.profile.trophies).toLocaleString()} trophies to go`,o("roadpill").innerHTML=`${D("trophy")} ${S.trophies.toLocaleString()}`}function d(){const y=t.profile.winsToNextChest,v=ct.winsPerChest,k=Math.max(0,Math.min(v,v-y));o("chestsub").textContent=y===0?"Ready on your next win":`${y} more ${y===1?"win":"wins"}`,o("pips").innerHTML=Array.from({length:v},(T,S)=>`<span class="home-pip${S<k?" is-on":""}"></span>`).join("")}function p(){const y=t.profile.containerCount,v=o("held");v.hidden=y===0,y>0&&(o("heldtitle").textContent=y===1?"1 chest held":`${y} chests held`)}const u=[["damage","Damage","damage","#FF8A96"],["health","Health","health","#8FE04A"],["speed","Speed","speed","#6FC8F5"]];function m(){const y=re[t.profile.selected];o("stats").innerHTML=u.map(([v,k,T,S])=>`
      <div class="fa-stat ds-row ds-row--slate home-stat" style="--ds-row-accent:${S}">
        ...
        <span class="ds-row-body">
          ...
          <span class="ds-row-val ds-num">${y.stats[T]}</span>
        </span>
      </div>`).join(""),f()}function f(){const y=re[t.profile.selected];h>=y.abilities.length&&(h=0),o("kit").innerHTML=y.abilities.map((T,S)=>`
      <button class="home-kit-tile${S===h?" is-on":""}" type="button" data-kit="${S}">
        <span class="home-kit-em">${ga(T.emoji)}</span>
        <span class="home-kit-name">${T.name}</span>
      </button>`).join("");const v=o("kitcap"),k=y.abilities[h];v.innerHTML=k?`<span class="home-kit-capname">${k.name}</span><span>${k.desc}</span>`:"",g()}function g(){const y=o("kit"),v=y.children[h];if(!v)return;const k=y.getBoundingClientRect(),T=v.getBoundingClientRect();if(k.width<=0||T.width<=0)return;const S=T.left+T.width/2,A=getComputedStyle(y).direction==="rtl"?(k.right-S)/k.width:(S-k.left)/k.width;o("kitcap").style.setProperty("--home-cap-x",`${(A*100).toFixed(1)}%`)}function w(){const y=re[t.profile.selected];o("name").textContent=t.profile.name,o("trophies").textContent=t.profile.trophies.toLocaleString(),o("coins").textContent=t.profile.coins.toLocaleString(),c(),d(),p(),m(),o("wins").textContent=t.profile.wins.toLocaleString(),o("losses").textContent=t.profile.losses.toLocaleString(),o("best").textContent=t.profile.bestTrophies.toLocaleString(),o("lv").textContent=`Lv ${t.profile.level}`,o("lvnext").textContent=`Lv ${t.profile.level+1}`,o("lvfill").style.width=`${(t.profile.levelProgress01*100).toFixed(1)}%`,o("lvxp").textContent=`${t.profile.xp%wn} / ${wn} XP`,i.textContent=y.name,r.textContent=y.rarity,r.style.background=Ot[y.rarity],a.show(y.id)}const b=y=>{const v=y.target,k=v.closest("[data-kit]");if(k){const A=Number(k.dataset.kit);Number.isInteger(A)&&(h=A,f());return}const T=v.closest("[data-go]");if(!T)return;const S=T.dataset.go;S==="characters"?t.navigate({name:"characters"}):S==="trophies"?t.navigate({name:"trophies"}):S==="shop"&&t.navigate({name:"shop"})};e.addEventListener("click",b),o("start").addEventListener("click",()=>{t.navigate({name:"characters"})}),o("mode").addEventListener("click",()=>{t.navigate({name:"lobby"})}),o("settings").addEventListener("click",()=>{t.navigate({name:"settings"})}),o("stage").addEventListener("click",()=>{a.poke(),_s(s,50,18)}),setTimeout(()=>l.classList.add("is-faded"),4200);const x=t.profile.onChange(w);w(),a.attachTo(n);const M=requestAnimationFrame(()=>g());return{root:e,update(y){a.update(y)},resize(){a.resize(),g()},dispose(){x(),cancelAnimationFrame(M),e.removeEventListener("click",b),a.setScene("portrait"),a.detach(),e.remove()}}}const s1=`
/* ═══════════════════════════════════════════════════════════════════════════
...
`,i1=4500,r1=["No","One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen","Twenty"];function l1(t){return r1[t]??String(t)}function h1(){const t=new URLSearchParams(location.search).get("hold"),e=t===null?NaN:Number(t);return Number.isFinite(e)&&e>=0?e:i1}function c1(t){la("fa-opening-styles",d1),ha();const e=Ce("div","fa-screen fa-opening"),a=$l();e.innerHTML=`
    <header class="open-head">
      <h1 class="open-title">Food Fight Arena</h1>
      <p class="open-tagline">${l1(Ee.length)} fighters. One kitchen. No table manners.</p>
    </header>
...
`,p1=.15,u1=44,f1=78,m1=5,g1=10,Ac=.5,Rc="touch-styles";function w1(){return typeof window>"u"?!1:typeof navigator<"u"&&(navigator.maxTouchPoints??0)>0?!0:"ontouchstart"in window}function b1(){return typeof window.matchMedia!="function"?!1:window.matchMedia("(pointer: coarse)").matches}function y1(){const t=Math.min(window.innerWidth,window.innerHeight);return Math.max(u1,Math.min(f1,t*p1))}function x1(t,e,a){const o=Math.max(Math.abs(t),Math.abs(e)),n=o>1e-6?Math.min(1,Math.hypot(t,e))/o:0;return a.x=Math.max(-1,Math.min(1,t*n)),a.y=Math.max(-1,Math.min(1,e*n)),a}function Ic(){return{id:null,baseX:0,baseY:0,curX:0,curY:0}}function v1(t){const e=w1(),a=Ic(),o=Ic(),n={x:0,y:0},s={x:0,y:-1};let i=!1,r=!1,l=!1,h=0,c="",d="";if(!e)return{available:!1,get engaged(){return!1},move:n,get moving(){return!1},aimDir:()=>null,get firing(){return!1},clearAim(){},reset(){},dispose(){}};k1();const p=document.createElement("div");p.className="tch-root",p.innerHTML='<div class="tch-stick tch-stick--move" data-el="move-stick"><div class="tch-knob"></div></div><div class="tch-stick tch-stick--aim" data-el="aim-stick"><div class="tch-knob"></div></div><div class="tch-hint tch-hint--move" data-el="move-hint"><div class="tch-hint-ring"></div><div class="tch-hint-label">MOVE</div></div><div class="tch-hint tch-hint--aim" data-el="aim-hint"><div class="tch-hint-ring"></div><div class="tch-hint-label">AIM &amp; FIRE</div></div>',document.body.appendChild(p);const u=z=>p.querySelector('[data-el="'+z+'"]'),m=u("move-stick"),f=u("aim-stick"),g=u("move-hint"),w=u("aim-hint");b1()&&(p.classList.add("is-hinted"),document.documentElement.classList.add("fa-touch-capable"));const x=t.canvas.parentElement,M=t.canvas.style.touchAction,y=x?x.style.touchAction:"";t.canvas.style.touchAction="none",x&&(x.style.touchAction="none");function v(z){if(!(z instanceof Node))return!1;const V=t.canvas;return z===V||V.contains(z)||z.contains(V)}function k(){return y1()}function T(z,V){const ce=k();let se=z.curX-z.baseX,$=z.curY-z.baseY;const ee=Math.hypot(se,$);if(ee>ce){const Se=ce/ee;z.baseX=z.curX-se*Se,z.baseY=z.curY-$*Se,se*=Se,$*=Se}const ye=Math.hypot(se,$);return V.x=se,V.y=$,ye}const S={x:0,y:0},A=[];function C(z){const V=A.indexOf(z);V>=0&&A.splice(V,1)}function R(z,V){for(let ce=0;ce<z.length;ce++)if(z[ce].identifier===V)return z[ce];return null}function F(z,V,ce){for(let se=A.length-1;se>=0;se--){const $=R(ce,A[se]);if(!$){A.splice(se,1);continue}if($.clientX<window.innerWidth*Ac===V){A.splice(se,1),z.id=$.identifier,z.baseX=$.clientX,z.baseY=$.clientY,z.curX=$.clientX,z.curY=$.clientY;return}}}function N(){if(a.id===null){n.x=0,n.y=0;return}if(T(a,S)<m1){n.x=0,n.y=0;return}const V=k();x1(S.x/V,S.y/V,n)}function L(){if(o.id===null)return;const z=T(o,S);z<g1||(s.x=S.x/z,s.y=S.y/z,i=!0)}function P(z,V,ce){if(V.id===null)return ce!==""&&(z.style.display="none"),"";const se=V.curX-V.baseX,$=V.curY-V.baseY,ee=k(),ye=Math.hypot(se,$),Se=ye>ee?ee/ye:1,Ye=Math.round(V.baseX),uo=Math.round(V.baseY),Bn=Math.round(V.baseX+se*Se),jn=Math.round(V.baseY+$*Se),Vo=Ye+","+uo+","+Bn+","+jn+","+Math.round(ee);if(Vo===ce)return Vo;ce===""&&(z.style.display="block"),z.style.setProperty("--r",ee.toFixed(0)+"px"),z.style.transform="translate("+Ye+"px,"+uo+"px) translate(-50%,-50%)";const Gn=z.firstElementChild;return Gn&&(Gn.style.transform="translate("+(Bn-Ye)+"px,"+(jn-uo)+"px) translate(-50%,-50%)"),Vo}function W(){if(c=P(m,a,c),d=P(f,o,d),a.id===null&&o.id===null){h=0;return}h=requestAnimationFrame(W)}function H(){!h&&!l&&(h=requestAnimationFrame(W))}const K=z=>{if(l)return;let V=!1;for(let ce=0;ce<z.changedTouches.length;ce++){const se=z.changedTouches[ce];if(!v(se.target))continue;const $=se.clientX<window.innerWidth*Ac,ee=$?a:o;if(ee.id!==null){A.includes(se.identifier)||A.push(se.identifier),V=!0;continue}ee.id=se.identifier,ee.baseX=se.clientX,ee.baseY=se.clientY,ee.curX=se.clientX,ee.curY=se.clientY,V=!0,$?g.classList.add("is-used"):w.classList.add("is-used")}V&&(r||(r=!0,document.documentElement.classList.add("fa-touch")),N(),L(),H(),z.preventDefault())},O=z=>{if(l)return;let V=!1;for(let ce=0;ce<z.changedTouches.length;ce++){const se=z.changedTouches[ce];se.identifier===a.id?(a.curX=se.clientX,a.curY=se.clientY,V=!0):se.identifier===o.id?(o.curX=se.clientX,o.curY=se.clientY,V=!0):A.includes(se.identifier)&&(V=!0)}V&&(N(),L(),H(),z.preventDefault())},_=z=>{if(l)return;let V=!1;for(let ce=0;ce<z.changedTouches.length;ce++){const se=z.changedTouches[ce];se.identifier===a.id?(a.id=null,F(a,!0,z.touches),V=!0):se.identifier===o.id?(o.id=null,F(o,!1,z.touches),V=!0):A.includes(se.identifier)&&(C(se.identifier),V=!0)}V&&(N(),L(),H())};return window.addEventListener("touchstart",K,{passive:!1}),window.addEventListener("touchmove",O,{passive:!1}),window.addEventListener("touchend",_),window.addEventListener("touchcancel",_),{available:!0,get engaged(){return r},move:n,get moving(){return a.id!==null},aimDir:()=>i?s:null,get firing(){return o.id!==null},clearAim(){o.id===null&&(i=!1)},reset(){a.id=null,o.id=null,A.length=0,n.x=0,n.y=0,i=!1,H()},dispose(){l||(l=!0,cancelAnimationFrame(h),window.removeEventListener("touchstart",K),window.removeEventListener("touchmove",O),window.removeEventListener("touchend",_),window.removeEventListener("touchcancel",_),A.length=0,t.canvas.style.touchAction=M,x&&(x.style.touchAction=y),document.documentElement.classList.remove("fa-touch","fa-touch-capable"),p.remove())}}}function k1(){if(document.getElementById(Rc))return;const t=document.createElement("style");t.id=Rc,t.textContent=M1,document.head.appendChild(t)}const M1=`
.tch-root {
  position: fixed;
  inset: 0;
  z-index: 25;
...
`,Yt={left:["KeyA","ArrowLeft"],right:["KeyD","ArrowRight"],up:["KeyW","ArrowUp"],down:["KeyS","ArrowDown"]},Wl="KeyM",Ul=9,E1=.155,T1=84,S1=190;function A1(t){const e=new URLSearchParams(location.search).get(t);if(e===null)return null;const a=Number(e);return Number.isFinite(a)?a:null}class R1{constructor(e){this.canvas=e;const a=A1("aimSens");this.sensitivity=a!==null&&a>0?Math.min(6,a):1,this.freeAim=new URLSearchParams(location.search).get("aimMode")==="free",this.touch=v1({canvas:e}),window.addEventListener("keydown",this.onKeyDown),window.addEventListener("keyup",this.onKeyUp),window.addEventListener("blur",this.onBlur),document.addEventListener("visibilitychange",this.onVisibilityChange),e.addEventListener("mousemove",this.onMouseMove),e.addEventListener("mousedown",this.onMouseDown),window.addEventListener("mouseup",this.onMouseUp),e.addEventListener("contextmenu",this.onContextMenu)}keys=new Set;mouseDown=!1;ndcX=0;ndcY=0;hasMouse=!1;weaponIndex=0;weaponCount=1;locked=!1;offX=0;offY=0;clientX=0;clientY=0;sensitivity;freeAim;touch;touchOffset={x:0,y:0};setWeaponCount(e){this.weaponCount=Math.max(1,e),this.weaponIndex>=this.weaponCount&&(this.weaponIndex=0)}get selectedWeapon(){return this.weaponIndex}selectWeapon(e){!Number.isInteger(e)||e<0||e>=this.weaponCount||(this.weaponIndex=e)}get touchEngaged(){return this.touch.engaged}get attackHeld(){return this.mouseDown||this.touch.firing}get mouseNdc(){return this.hasMouse&&!this.locked?{x:this.ndcX,y:this.ndcY}:null}get pointerLocked(){return this.locked}get aimOffsetPx(){const e=this.touch.aimDir();if(e){const a=this.aimRadiusPx();return this.touchOffset.x=e.x*a,this.touchOffset.y=e.y*a,this.touchOffset}return this.locked?{x:this.offX,y:this.offY}:null}setPointerLocked(e){e!==this.locked&&(this.locked=e,e&&(this.hasMouse?(this.offX=this.clientX-window.innerWidth/2,this.offY=this.clientY-window.innerHeight/2):(this.offX=0,this.offY=-this.aimRadiusPx()),this.clampOffset(),this.hasMouse=!0))}moveAxes(){let e=0,a=0;return this.keyDown(Yt.left)&&(e-=1),this.keyDown(Yt.right)&&(e+=1),this.keyDown(Yt.up)&&(a-=1),this.keyDown(Yt.down)&&(a+=1),this.touch.moving&&(e=Math.max(-1,Math.min(1,e+this.touch.move.x)),a=Math.max(-1,Math.min(1,a+this.touch.move.y))),{x:e,y:a}}reset(){this.keys.clear(),this.mouseDown=!1,this.touch.reset(),this.locked&&(this.offX=0,this.offY=-this.aimRadiusPx())}dispose(){this.touch.dispose(),window.removeEventListener("keydown",this.onKeyDown),window.removeEventListener("keyup",this.onKeyUp),window.removeEventListener("blur",this.onBlur),document.removeEventListener("visibilitychange",this.onVisibilityChange),this.canvas.removeEventListener("mousemove",this.onMouseMove),this.canvas.removeEventListener("mousedown",this.onMouseDown),window.removeEventListener("mouseup",this.onMouseUp),this.canvas.removeEventListener("contextmenu",this.onContextMenu)}aimRadiusPx(){const e=Math.min(window.innerWidth,window.innerHeight);return Math.max(T1,Math.min(S1,e*E1))}clampOffset(){if(this.freeAim){const n=window.innerWidth/2,s=window.innerHeight/2;this.offX=Math.max(-n,Math.min(n,this.offX)),this.offY=Math.max(-s,Math.min(s,this.offY));return}const e=this.aimRadiusPx(),a=Math.hypot(this.offX,this.offY);if(a<=e){a<.001&&(this.offY=-e);return}const o=e/a;this.offX*=o,this.offY*=o}keyDown(e){return e.some(a=>this.keys.has(a))}onKeyDown=e=>{this.keys.add(e.code);const a=Number(e.key);if(Number.isInteger(a)&&a>=1&&a<=Ul){const o=a-1;o<this.weaponCount&&(this.weaponIndex=o)}e.code===Wl&&!e.repeat&&!e.ctrlKey&&!e.metaKey&&!e.altKey&&ke.toggleMuted()};onKeyUp=e=>{this.keys.delete(e.code)};onMouseMove=e=>{if(this.touch.clearAim(),this.locked){this.offX+=(e.movementX??0)*this.sensitivity,this.offY+=(e.movementY??0)*this.sensitivity,this.clampOffset(),this.hasMouse=!0;return}const a=this.canvas.getBoundingClientRect();this.clientX=e.clientX,this.clientY=e.clientY,this.ndcX=(e.clientX-a.left)/a.width*2-1,this.ndcY=-((e.clientY-a.top)/a.height*2-1),this.hasMouse=!0};onMouseDown=e=>{e.button===0&&(this.mouseDown=!0)};onMouseUp=e=>{e.button===0&&(this.mouseDown=!1)};onBlur=()=>{this.keys.clear(),this.mouseDown=!1,this.touch.reset()};onVisibilityChange=()=>{document.visibilityState==="hidden"&&this.onBlur()};onContextMenu=e=>{e.preventDefault()}}const Fc=16241663,I1=14711797,F1=12872686,So=2755399,C1=.34,es=3.2,O1=6.5;function N1(t){return U.clamp(t*.3,Q,O1)}const L1=.5,Ge=128,Yl=Tf+Sf,D1=[{offset:-14,color:Fc,alpha:0},{offset:-1,color:Fc,alpha:.9},{offset:7,color:I1,alpha:.85},{offset:34,color:5906060,alpha:.3},{offset:150,color:So,alpha:.18},{offset:0,absolute:Yl,color:So,alpha:.18}],z1=[{offset:12,color:So,alpha:0},{offset:44,color:So,alpha:.6},{offset:140,color:So,alpha:.72},{offset:0,absolute:Yl,color:So,alpha:.72}];function H1(){const a=document.createElement("canvas");a.width=64,a.height=256;const o=a.getContext("2d"),n=o.createImageData(64,256);let s=2654435769;const i=()=>(s=s*1664525+1013904223>>>0,s/4294967295),r=new Float32Array(64);for(let h=0;h<64;h++)r[h]=.18+.82*i();for(let h=0;h<256;h++){const c=1-h/255,d=Math.pow(1-c,2.6);for(let p=0;p<64;p++){const u=.85+.15*Math.sin(p*.9+c*5),m=Math.max(0,Math.min(1,d*r[p]*u)),f=(h*64+p)*4,g=Math.pow(1-c,3);n.data[f]=255,n.data[f+1]=Math.round(190+65*g),n.data[f+2]=255,n.data[f+3]=Math.round(m*255)}}o.putImageData(n,0,0);const l=new nt(a);return l.wrapS=Gr,l.wrapT=Wr,l.needsUpdate=!0,l}function Cc(t,e,a,o){const n=t.length*Ge,s=new Float32Array(n*3),i=new Float32Array(n*4),r=[],l=new Float32Array(Ge),h=new Float32Array(Ge);for(let f=0;f<Ge;f++){const g=f/Ge*Math.PI*2;l[f]=Math.cos(g),h[f]=Math.sin(g)}const c=new Kt;for(let f=0;f<t.length;f++){c.setHex(t[f].color);for(let g=0;g<Ge;g++){const w=f*Ge+g;s[w*3+1]=0,i[w*4]=c.r,i[w*4+1]=c.g,i[w*4+2]=c.b,i[w*4+3]=t[f].alpha}}for(let f=0;f<t.length-1;f++)for(let g=0;g<Ge;g++){const w=(g+1)%Ge;r.push(f*Ge+g,(f+1)*Ge+g,f*Ge+w),r.push(f*Ge+w,(f+1)*Ge+g,(f+1)*Ge+w)}const d=new Cn,p=new Cs(s,3);p.setUsage(Mf),d.setAttribute("position",p),d.setAttribute("color",new Cs(i,4)),d.setIndex(r),d.boundingSphere=new Ef(new pe,Ze(Yl)*1.2);const u=new Y({vertexColors:!0,transparent:!0,depthWrite:!1,side:be,toneMapped:!1}),m=new E(d,u);return m.name=`${o}__no_outline`,m.userData.noOutline=!0,m.renderOrder=a,m.frustumCulled=!1,m.castShadow=!1,m.receiveShadow=!1,m.position.y=e,{mesh:m,setRadius(f){for(let g=0;g<t.length;g++){const w=t[g],b=w.absolute!==void 0?Math.max(w.absolute,f+200):Math.max(0,f+w.offset),x=Ze(b),M=g*Ge;for(let y=0;y<Ge;y++){const v=(M+y)*3;s[v]=l[y]*x,s[v+2]=h[y]*x}}p.needsUpdate=!0},setOpacity(f){u.opacity=f},dispose(){d.dispose(),u.dispose()}}}function _1(t){const e=new ie;e.name="fog_boundary";const a=Le(t.x,t.y);e.position.set(a.x,0,a.z),e.frustumCulled=!1;const o=Cc(D1,C1,6,"fog_edge"),n=Cc(z1,es,8,"fog_canopy");e.add(o.mesh);const s=H1(),i=new Me(1,1,1,Ge,1,!0),r=new Y({map:s,color:F1,transparent:!0,opacity:.82,depthWrite:!1,side:be,toneMapped:!1}),l=new E(i,r);l.name="fog_curtain__no_outline",l.userData.noOutline=!0,l.renderOrder=7,l.frustumCulled=!1,l.castShadow=!1,l.receiveShadow=!1,e.add(l),e.add(n.mesh);let h=0,c=0;return{root:e,update(d,p,u,m){const f=Math.min(.25,Math.max(0,p-c));if(c=p,h=u&&d>=0?1:Math.max(0,h-f/L1),e.visible=h>.002,!e.visible)return;const w=Math.max(0,d);o.setRadius(w),n.setRadius(w),o.setOpacity(h),n.setOpacity(h);const b=m.camera.position.y,x=U.clamp(b>es?(b-es)/b:0,.05,1);n.mesh.scale.set(x,1,x),n.mesh.position.set((1-x)*(m.camera.position.x-e.position.x),es,(1-x)*(m.camera.position.z-e.position.z));const M=Ze(w),y=N1(M);l.scale.set(M,y,M),l.position.y=y/2;const v=2*Math.PI*M;s.repeat.x=Math.max(6,Math.round(v/5)),s.offset.x=p*.035%1,r.opacity=(.82+.1*Math.sin(p*2.1))*h},dispose(){o.dispose(),n.dispose(),i.dispose(),r.dispose(),s.dispose(),e.clear()}}}function hi(t,e,a,o,n,s,i,r){return Math.abs(t-n)<(a+i)/2&&Math.abs(e-s)<(o+r)/2}function Ps(t,e,a,o){for(let n=0;n<o.length;n++){const s=o[n];if(Math.abs(t-s.x)<(a+s.w)/2&&Math.abs(e-s.y)<(a+s.h)/2)return!0}return!1}const R0=[];function I0(t){return t.concealment??R0}function P1(t,e){if(!e)return!1;const a=e.brokenConcealment;for(let o=0;o<a.length;o++)if(a[o]===t)return!0;return!1}function $1(t,e,a,o){const n=I0(a);for(let s=0;s<n.length;s++){const i=n[s];if(hi(t,e,0,0,i.x,i.y,i.w,i.h)&&!P1(i,o))return!0}return!1}function F0(t,e,a,o,n){return o&&n&&o.elapsed<n.revealedUntil?!1:$1(t,e,a,o)}function Vl(t,e,a,o,n,s,i){return F0(a,o,n,s,i)?Math.hypot(a-t,o-e)<=Af:!0}function q1(t,e,a,o){const n=I0(a);let s=null;for(let i=0;i<n.length;i++){const r=n[i];hi(t,e,0,0,r.x,r.y,r.w,r.h)&&(o.includes(r)||(o.push(r),(s??=[]).push(r)))}return s??R0}function C0(t,e,a,o){let n=1;for(const s of a.hazards)s.kind==="slow"&&Math.hypot(t-s.x,e-s.y)<s.radius&&(n=Math.min(n,s.slowFactor??_h));for(const s of o)Math.hypot(t-s.x,e-s.y)<Ur&&(n=Math.min(n,_h));return n}const B1=Wp,j1=1e-6;function sl(t,e,a,o){if(!(o>0))return;const n=Math.hypot(e,a);if(n<j1)return;const s=t.push;s.x=e/n,s.y=a/n,s.remaining=Math.min(B1,s.remaining+o)}function G1(t,e,a,o){const n=t.push;if(n.remaining<=0)return!1;const s=Gp*e,i=n.remaining<s?n.remaining:s;n.remaining-=i;const r=Ll(t,o)?!1:$s(t,n.x*i,n.y*i,a);return n.remaining<=0&&(n.remaining=0,n.x=0,n.y=0),r}const W1=4,Oc=.01;function U1(t,e){const a=t.size,o=a/2,n=e.cover;for(let s=0;s<W1;s++){let i=null,r=0;for(let c=0;c<n.length;c++){const d=n[c],p=(a+d.w)/2-Math.abs(t.x-d.x);if(p<=0)continue;const u=(a+d.h)/2-Math.abs(t.y-d.y);if(u<=0)continue;const m=p<u?p:u;m>r&&(r=m,i=d)}if(i===null)return;const l=(a+i.w)/2-Math.abs(t.x-i.x),h=(a+i.h)/2-Math.abs(t.y-i.y);if(l<=h){const c=t.x>=i.x?1:-1;t.x=Math.min(e.width-o,Math.max(o,t.x+c*(l+Oc)))}else{const c=t.y>=i.y?1:-1;t.y=Math.min(e.height-o,Math.max(o,t.y+c*(h+Oc)))}}}function $s(t,e,a,o){const n=t.size/2,s=t.x,i=t.y;if((e!==0||a!==0)&&U1(t,o),e!==0){const r=Math.min(o.width-n,Math.max(n,t.x+e));Ps(r,t.y,t.size,o.cover)||(t.x=r)}if(a!==0){const r=Math.min(o.height-n,Math.max(n,t.y+a));Ps(t.x,r,t.size,o.cover)||(t.y=r)}return t.x!==s||t.y!==i}const Y1=10,V1=4e4,O0=16,K1=8,X1=4,Nc=new WeakMap;function Z1(t,e){const a=Nc.get(t);if(a&&a.size===e&&a.cover===t.cover)return a;let o=Y1;for(;Math.ceil(t.width/o)*Math.ceil(t.height/o)>V1;)o*=2;const n=Math.max(1,Math.ceil(t.width/o)),s=Math.max(1,Math.ceil(t.height/o)),i=n*s,r=new Uint8Array(i),l=e/2;for(let c=0;c<s;c++)for(let d=0;d<n;d++){const p=(d+.5)*o,u=(c+.5)*o;p>=l&&p<=t.width-l&&u>=l&&u<=t.height-l&&!Ps(p,u,e,t.cover)&&(r[c*n+d]=1)}const h={cell:o,cols:n,rows:s,size:e,cover:t.cover,passable:r,dist:new Int32Array(i),queue:new Int32Array(i),chain:new Int32Array(O0+1),goalCell:-1,requestedGoal:-1};return Nc.set(t,h),h}function Xi(t,e){const{cols:a,rows:o,passable:n,dist:s,queue:i}=t;s.fill(-1),t.goalCell=e,s[e]=0,i[0]=e;let r=0,l=1;for(;r<l;){const h=i[r++],c=h%a,d=(h-c)/a,p=s[h]+1;for(let u=-1;u<=1;u++){const m=d+u;if(m<0||m>=o)continue;const f=m*a;for(let g=-1;g<=1;g++){if(g===0&&u===0)continue;const w=c+g;if(w<0||w>=a)continue;const b=f+w;n[b]===0||s[b]>=0||g!==0&&u!==0&&(n[d*a+w]===0||n[f+c]===0)||(s[b]=p,i[l++]=b)}}}}function Lc(t,e,a,o,n){const{cols:s,rows:i,passable:r,dist:l}=t;if(e>=0&&e<s&&a>=0&&a<i){const h=a*s+e;if(r[h]===1)return h}for(let h=1;h<=o;h++)for(let c=-h;c<=h;c++){const d=a+c;if(d<0||d>=i)continue;const p=Math.abs(c)===h;for(let u=-h;u<=h;u+=p?1:2*h){const m=e+u;if(m<0||m>=s)continue;const f=d*s+m;if(r[f]===1)return f}}return-1}function Dc(t,e,a,o,n,s){const i=a-t,r=o-e,l=Math.max(1,Math.ceil(Math.hypot(i,r)/(n*.4)));for(let h=1;h<=l;h++){const c=h/l;if(Ps(t+i*c,e+r*c,n,s))return!1}return!0}const wa={dirX:0,dirY:0,wpX:0,wpY:0};function J1(t,e,a,o){const n=Z1(t,e.size),{cell:s,cols:i,rows:r,dist:l,chain:h}=n,c=e.size/2,d=Math.min(t.width-c,Math.max(c,a)),p=Math.min(t.height-c,Math.max(c,o)),u=Lc(n,Math.min(i-1,Math.max(0,Math.floor(d/s))),Math.min(r-1,Math.max(0,Math.floor(p/s))),K1);if(u<0)return!1;const m=Lc(n,Math.min(i-1,Math.max(0,Math.floor(e.x/s))),Math.min(r-1,Math.max(0,Math.floor(e.y/s))),X1);if(m<0)return!1;if(n.requestedGoal!==u||l[m]<0){if(Xi(n,u),l[m]<0){Xi(n,m);let v=m,k=1/0;for(let T=0;T<l.length;T++){if(l[T]<0)continue;const S=T%i,A=(S+.5)*s-d,C=((T-S)/i+.5)*s-p,R=A*A+C*C;R<k&&(k=R,v=T)}Xi(n,v)}n.requestedGoal=u}if(l[m]<0)return!1;let f=m,g=0;for(;g<O0&&l[f]>0;){const v=f%i,k=(f-v)/i,T=l[f];let S=-1,A=T,C=1/0;for(let R=-1;R<=1;R++){const F=k+R;if(F<0||F>=r)continue;const N=F*i;for(let L=-1;L<=1;L++){if(L===0&&R===0)continue;const P=v+L;if(P<0||P>=i)continue;const W=N+P,H=l[W];if(H<0||H>=T||L!==0&&R!==0&&(n.passable[k*i+P]===0||n.passable[N+v]===0))continue;const K=(P+.5)*s-d,O=(F+.5)*s-p,_=K*K+O*O;(H<A||H===A&&_<C)&&(A=H,C=_,S=W)}}if(S<0)break;h[g++]=S,f=S}let w,b;if(g===0)w=d,b=p;else{let v=0;for(let A=1;A<g;A++){const C=h[A],R=C%i,F=(C-R)/i;if(!Dc(e.x,e.y,(R+.5)*s,(F+.5)*s,e.size,t.cover))break;v=A}const k=h[v],T=k%i,S=(k-T)/i;w=(T+.5)*s,b=(S+.5)*s,v===g-1&&l[k]===0&&Dc(e.x,e.y,d,p,e.size,t.cover)&&(w=d,b=p)}const x=w-e.x,M=b-e.y,y=Math.hypot(x,M);return y<1e-6?!1:(wa.dirX=x/y,wa.dirY=M/y,wa.wpX=w,wa.wpY=b,!0)}function zc(t,e,a,o,n,s,i){const r=t.x,l=t.y;let h=e,c=a,d=s,p=i;J1(n,t,s,i)&&(h=wa.dirX,c=wa.dirY,d=wa.wpX,p=wa.wpY);const u=(v,k)=>Math.hypot(v-d,k-p),m=u(r,l);$s(t,h*o,c*o,n);const f=t.x,g=t.y;if(m-u(f,g)>=o*.35)return t.detourSign=0,!0;const w=v=>{t.x=r,t.y=l;const k=-c*v+h*.3,T=h*v+c*.3,S=Math.hypot(k,T)||1;return $s(t,k/S*o,T/S*o,n),Math.hypot(t.x-r,t.y-l)};if(t.detourSign!==0&&w(t.detourSign)>=o*.35)return!0;const b=w(1),x=t.x,M=t.y,y=w(-1);if(b>=y){if(b>=o*.35)return t.detourSign=1,t.x=x,t.y=M,!0}else if(y>=o*.35)return t.detourSign=-1,!0;return t.detourSign=0,t.x=f,t.y=g,f!==r||g!==l}const Q1=180/Math.PI,eb=Math.PI/180,tb=1e-6;function Kl(t,e){return re[e.characterId].hasTrail?t.trailMarks.some(a=>a.ownerId===e.id&&Math.hypot(e.x-a.x,e.y-a.y)<It.radius):!1}function qs(t,e){return e==="stun"?t.status.stunnedUntil+Rf:t.status.slowedUntil+If}function il(t,e,a){const o=t.status,n=e==="stun"?o.stunAppliedAt:o.slowAppliedAt,s=e==="stun"?o.stunStacks:o.slowStacks,i=a-n>=Lf;return Math.min(i?0:s+1,Up.length-1)}function Hc(t,e,a,o){return o*Up[il(t,e,a)]}function _c(t,e,a){const o=t.cast;o!==null&&(t.cast=null,a.push({type:"cast-cancelled",fighterRole:t.role,fighterId:t.id,weaponKey:re[t.characterId].weapons[o.weaponIndex].key,reason:e}))}function ab(t,e,a,o){const n=o.knockback??0;n>0&&sl(a,a.x-e.x,a.y-e.y,n);const s=o.lure??0;if(s>0){const i=a.x,r=a.y;for(const l of t.fighters){if(!oi(l,e))continue;const h=i-l.x,c=r-l.y,d=Math.hypot(h,c);sl(l,h,c,s<d?s:d)}}}function Xa(t,e,a,o,n,s){if(!e.alive)return;const i=n.kind==="weapon"?t.fighters[n.attackerId]:n.kind==="trail"?t.fighters[n.ownerId]:null,r=i?a*i.damageMul:a;if(e.hp=Math.max(0,e.hp-r),e.lastDamagedAt=t.elapsed,o==="slow"){if(t.elapsed>=qs(e,"slow")){const l=Hc(e,"slow",t.elapsed,Of);l>0&&(e.status.slowStacks=il(e,"slow",t.elapsed),e.status.slowAppliedAt=t.elapsed,e.status.slowedUntil=t.elapsed+l)}}else if(o==="stun"){const l=t.elapsed>=qs(e,"stun")?Hc(e,"stun",t.elapsed,Nf):0;l>0&&(e.status.stunStacks=il(e,"stun",t.elapsed),e.status.stunAppliedAt=t.elapsed,e.status.stunnedUntil=t.elapsed+l,e.cast!==null&&_c(e,"stun",s))}if(i!=null&&n.kind==="weapon"){const l=re[i.characterId].weapons.find(h=>h.key===n.weaponKey);l!==void 0&&ab(t,i,e,l)}if(s.push({type:"hit-landed",targetRole:e.role,targetId:e.id,amount:r,effect:o,source:n,x:e.x,y:e.y}),e.hp===0&&(e.alive=!1,s.push({type:"death",fighterRole:e.role,fighterId:e.id}),e.deaths++,e.cast!==null&&_c(e,"death",s),t.phase==="playing")){const l=vm(t);l!==null&&(t.phase="ended",t.winner=l.role,t.winnerId=l.id,s.push({type:"match-ended",winner:l.role,winnerId:l.id}))}}function Zi(t,e,a,o,n,s,i,r,l,h,c){const d=Math.atan2(h.y,h.x)+n*eb,p=Math.cos(d),u=Math.sin(d),m=o.speed??0,f=i??o.color,g=r??o.emoji,w=t.nextId++;t.projectiles.push({id:w,ownerId:e.id,targetId:a.id,ownerRole:e.role,targetRole:a.role,weapon:o,x:l.x,y:l.y,vx:p*m,vy:u*m,traveled:0,tx:a.x,ty:a.y,age:0,damage:s,color:f,emoji:g}),c.push({type:"projectile-spawned",id:w,ownerRole:e.role,ownerId:e.id,weaponKey:o.key,x:l.x,y:l.y,color:f,emoji:g})}function N0(t,e,a,o){if(a.type!=="self"){e.revealedUntil=t.elapsed+Ff;for(const n of q1(e.x,e.y,t.arena,t.brokenConcealment))o.push({type:"concealment-broken",ownerRole:e.role,ownerId:e.id,x:n.x,y:n.y,w:n.w,h:n.h,kind:n.kind})}}function L0(t,e,a,o){const s=re[e.characterId].weapons[a];if(!s)return!1;o.push({type:"weapon-fired",fighterRole:e.role,fighterId:e.id,weaponKey:s.key}),N0(t,e,s,o);const i=nb(t,e,s,o),r=s.selfLaunch??0;return r>0&&sl(e,e.facing.x,e.facing.y,r),i}function ob(t,e,a){if(t.phase!=="playing")return!1;const o=e.cast;return o===null||t.elapsed<o.resolvesAt?!1:(e.cast=null,L0(t,e,o.weaponIndex,a))}function rl(t,e,a,o){if(t.phase!=="playing")return!1;const n=re[e.characterId].weapons[a];if(!n)return!1;const s=t.elapsed,i=n.castMs??0;return e.cast!==null&&i>0||s-e.lastUsed[a]<n.cooldown?!1:(e.lastUsed[a]=s,i>0?(e.cast={weaponIndex:a,startedAt:s,resolvesAt:s+i},o.push({type:"cast-started",fighterRole:e.role,fighterId:e.id,weaponKey:n.key,castMs:i}),N0(t,e,n,o),!0):L0(t,e,a,o))}function nb(t,e,a,o){const n=Zp(t,e);if(a.type==="self"){const h=(a.healAmount??0)*Cf(e.level),c=Math.min(h,e.maxHp-e.hp);return e.hp=Math.min(e.maxHp,e.hp+h),c>0&&o.push({type:"heal",fighterRole:e.role,fighterId:e.id,amount:c}),!0}if(n===null)return!0;if(a.type==="melee"){const h=a.cone??360,c=a.range??0;for(const d of t.fighters){if(!oi(d,e))continue;const p=d.x-e.x,u=d.y-e.y,m=Math.hypot(p,u);if(!(m>c)){if(h<360){if(m<tb)continue;const f=(e.facing.x*p+e.facing.y*u)/m;if(Math.acos(Math.max(-1,Math.min(1,f)))*Q1>h/2)continue}Xa(t,d,a.damage,a.effect,{kind:"weapon",weaponKey:a.key,weaponName:a.name,attackerId:e.id},o)}}return!0}const s={x:e.x,y:e.y},i=e.facing;if(a.comboParts){for(const h of a.comboParts)Zi(t,e,n,a,h.angle,h.damage,h.color,h.emoji,s,i,o);return!0}const l=!!a.trailBoosted&&Kl(t,e)?Math.round(a.damage*It.damageBoost):a.damage;if(a.pellets&&a.pellets>1){const h=a.spreadDeg??0;for(let c=0;c<a.pellets;c++){const d=(c-(a.pellets-1)/2)*h,p=a.pelletColors?a.pelletColors[c%a.pelletColors.length]:void 0,u=a.pelletEmojis?a.pelletEmojis[c%a.pelletEmojis.length]:void 0;Zi(t,e,n,a,d,l,p,u,s,i,o)}}else Zi(t,e,n,a,0,l,void 0,void 0,s,i,o);return!0}const ts=400,ba=1e-6,Pc=.8,$c=.6,qt={x:0,y:0},je={dirX:0,dirY:0,navX:0,navY:0},D0=Math.PI/180,sb=[0];function z0(t){if(t.comboParts)return t.comboParts.map(n=>n.angle);const e=t.pellets??1;if(e<=1)return sb;const a=t.spreadDeg??0,o=[];for(let n=0;n<e;n++)o.push((n-(e-1)/2)*a);return o}const ib=(()=>{const t=new Map;for(const e of Ee)for(const a of re[e].weapons)t.set(a,z0(a));return t})();function rb(t,e,a,o,n){const s=e.range??0;if(s<=0)return null;const i=a-t.x,r=o-t.y,l=Math.hypot(i,r),h=l>ba?i/l:1,c=l>ba?r/l:0;switch(e.type){case"self":return null;case"melee":return{margin:l-s,outX:h,outY:c};case"ranged":{const p=s+n,u=l-p;if(e.homing)return{margin:u,outX:h,outY:c};const m=Math.hypot(t.facing.x,t.facing.y);if(m<ba)return{margin:u,outX:h,outY:c};const f=t.facing.x/m,g=t.facing.y/m,w=i*f+r*g,b=-i*g+r*f;let x=-1/0,M=-1/0,y=!1,v=!0;for(const S of ib.get(e)??z0(e)){const A=S*D0,C=Math.cos(A),R=Math.sin(A);if(w*C+b*R<0)continue;if(C<=ba){v=!1;break}y=!0;const N=b*C-w*R,L=(n-N)/C,P=(n+N)/C;L>x&&(x=L),P>M&&(M=P)}if(!v)return{margin:u,outX:h,outY:c};if(!y)return{margin:l-n,outX:h,outY:c};const k=x<=M,T=k?-x:-M;return u>=T?{margin:u,outX:h,outY:c}:{margin:T,outX:k?-g:g,outY:k?f:-f}}}return e.type}function lb(t,e,a,o,n){const s=e.x,i=e.y;qt.x=0,qt.y=0;let r=0;for(const u of t.arena.hazards){if(u.kind!=="damage")continue;const m=s-u.x,f=i-u.y,g=Math.hypot(m,f),w=u.radius+Jo;if(g>=w)continue;const b=g>ba?m/g:1,x=g>ba?f/g:0,M=-x*a+b*o>=0?1:-1,y=-x*M,v=b*M,k=Math.min(2,(w-g)/Jo),T=k*Ri;qt.x+=(b*Pc+y*$c)*T,qt.y+=(x*Pc+v*$c)*T,k>r&&(r=k)}const l=t.arena.center.x,h=t.arena.center.y,c=l-s,d=h-i,p=Math.hypot(c,d);if(p>ba){const u=t.safeRadius-p;if(u<Ii){const m=Math.min(2,(Ii-u)/Ii);qt.x+=c/p*m*qh,qt.y+=d/p*m*qh,m>r&&(r=m)}}for(const u of t.fighters){if(u===e||!u.alive)continue;const m=u.cast;if(m===null)continue;const f=re[u.characterId].weapons[m.weaponIndex];if(f===void 0)continue;const g=rb(u,f,s,i,e.hitRadius);if(g===null)continue;const w=g.margin;if(w>=Jo)continue;const b=Math.max(0,m.resolvesAt-t.elapsed);if(w<0&&-w>n*b)continue;const x=Math.min(2,(Jo-w)/Jo);qt.x+=g.outX*x*Ri,qt.y+=g.outY*x*Ri,x>r&&(r=x)}return r}const qc={melee:!0,ranged:!0,self:!1},hb={melee:!1,ranged:!1,self:!0},cb=(()=>{const t=new Map,e=a=>{const o=Math.abs(Math.sin(a*D0));return o<1e-9?1/0:Yp/o};for(const a of Ee)for(const o of re[a].weapons){let n=0;const s=[];if(o.type!=="self")if(o.comboParts)for(const i of o.comboParts){const r=e(i.angle);r===1/0?n+=i.damage:s.push({maxDist:r,damage:i.damage})}else{const i=o.damage*(o.peckHits??1),r=o.pellets??1;if(o.type==="melee"||r<=1||o.homing)n=i*r;else{const l=o.spreadDeg??0;for(let h=0;h<r;h++){const c=e((h-(r-1)/2)*l);c===1/0?n+=i:s.push({maxDist:c,damage:i})}}}t.set(o,{always:n,offAxis:s})}return t})();function db(t,e){const a=cb.get(t);if(!a)return t.damage;let o=a.always;for(const n of a.offAxis)e<n.maxDist&&(o+=n.damage);return o}const Bc=(t,e,a,o,n)=>db(a,n),pb=(t,e,a)=>{const o=a.healAmount??0;return o<=0||e.hp>e.maxHp*Pf||e.maxHp-e.hp<o?-1/0:o};function Ji(t,e,a,o,n,s){const i=re[e.characterId].weapons,r=t.elapsed;let l=null,h=-1/0;for(let c=0;c<i.length;c++){const d=i[c];if(!o[d.type]||r-e.lastUsed[c]<d.cooldown||a>(d.range??1/0)||(d.castMs??0)>0&&(d.castMs??0)>=s)continue;const p=n(t,e,d,c,a);p>h&&(h=p,l=c)}return l}function ub(t,e,a,o){if(t.phase!=="playing")return!1;const n=Zp(t,e);if(e.hp<=0||n===null)return!1;const s=t.elapsed,i=Vl(e.x,e.y,n.x,n.y,t.arena,t,n),r=t.sightings[Zr(e.id,n.id,t.fighters.length)];i&&(r.x=n.x,r.y=n.y,r.at=s);const l=r.x,h=r.y,c=l-e.x,d=h-e.y,p=Math.hypot(c,d),u=p||1,m=p>1e-6,f=e.hp<e.maxHp*Df,g=(s<e.status.slowedUntil?zf:1)*C0(e.x,e.y,t.arena,t.splats)*(Kl(t,e)?It.speedBoost:1),w=Ll(e,s);m&&!Kp(e)&&(e.facing={x:c/u,y:d/u});let b=!1;const x=f?-1:1,M=vs(e.characterId,f?Ph:$h)*g,y=lb(t,e,x*c/u,x*d/u,M),v=y>=_f,k=(C,R,F,N)=>{if(je.dirX=C,je.dirY=R,je.navX=F,je.navY=N,y<=0)return;const L=C+qt.x,P=R+qt.y,W=Math.hypot(L,P);W<ba||(je.dirX=L/W,je.dirY=P/W,je.navX=e.x+je.dirX*ts,je.navY=e.y+je.dirY*ts)},T=v&&!w,S=v?0:kn(t.timeRemaining)?e.hp*1e3/Hf:1/0,A=T?null:Ji(t,e,u,hb,pb,S);if(f){if(!w){const R=vs(e.characterId,Ph)*a*g;k(-c/u,-d/u,e.x-c/u*ts,e.y-d/u*ts),zc(e,je.dirX,je.dirY,R,t.arena,je.navX,je.navY),b=!0}const C=A??(i?Ji(t,e,u,qc,Bc,S):null);C!==null&&rl(t,e,C,o)}else{const C=T?null:A??(i?Ji(t,e,u,qc,Bc,S):null);if(C!==null)rl(t,e,C,o);else if(!w){const R=vs(e.characterId,$h)*a*g;k(c/u,d/u,l,h),zc(e,je.dirX,je.dirY,R,t.arena,je.navX,je.navY),b=!0}}return b}const jc=12;function Qi(t,e,a,o){if(Array.isArray(e)){if(a!==void 0||o!==void 0)throw new TypeError("createMatch: the fighter-list form takes no third or fourth argument; put `level` on each FighterConfig instead");return Gc(t,e)}const n=o??{};return Gc(t,[{characterId:e,level:n.player},{characterId:a,level:n.enemy}])}function Gc(t,e){if(e.length<ot||e.length>zt)throw new RangeError(`createMatch: ${e.length} fighters; the sim seats ${ot}..${zt} (see state.ts MIN_FIGHTERS / MAX_FIGHTERS)`);const a=e.length===ot,o=e.map((i,r)=>{const l=Ta(i.level??no),h=r===0,c=a&&!h,d=i.spawn??fb(t,r);return xm({id:r,controller:i.controller??(h?"human":"ai"),characterId:i.characterId,spawn:d,maxHp:i.maxHp??Vr(i.characterId,c?jf:Kr,l),size:i.size??(c?Bf:Wp),hitRadius:i.hitRadius??(c?qf:Yp),facing:i.facing??mb(t,r,d),level:l})}),n=o.length,s=new Array(n*n);for(let i=0;i<n;i++)for(let r=0;r<n;r++)s[Zr(i,r,n)]={x:o[r].x,y:o[r].y,at:0};return{phase:"countdown",elapsed:0,countdownValue:Gf,countdownTick:0,startFlashTimer:0,timeRemaining:Ea,safeRadius:t.maxSafeRadius,fighters:o,player:o[0],enemy:o[1],projectiles:[],splats:[],trailMarks:[],winner:null,winnerId:null,arena:t,sightings:s,aiSighting:s[Zr(1,0,n)],brokenConcealment:[],nextId:1}}function fb(t,e){if(e===0)return t.playerSpawn;if(e===1)return t.enemySpawn;const a=t.spawns?.[e];if(a)return{x:a.x,y:a.y};throw new RangeError(`createMatch: slot ${e} has no spawn. ArenaDefinition declares playerSpawn and enemySpawn only, so slots 2 and up must pass \`spawn\` explicitly — arena geometry is src/arena/**'s to own (DECISIONS §48: spawn placement is part of the 180° point-symmetry fairness constraint).`)}function mb(t,e,a){if(e===0)return{x:1,y:0};if(e===1)return{x:-1,y:0};const o=t.center.x-a.x,n=t.center.y-a.y,s=Math.hypot(o,n);return s>1e-6?{x:o/s,y:n/s}:{x:1,y:0}}const gb=Object.freeze({move:Object.freeze({x:0,y:0}),selectedWeapon:0,attack:!1});function wb(t,e,a){const o=[];if(t.elapsed+=e,yb(t,e,o),t.phase==="playing"){t.timeRemaining=Math.max(0,t.timeRemaining-e);const n=Ea-t.timeRemaining;t.safeRadius=kn(t.timeRemaining)?Yr:$f(n,t.arena.maxSafeRadius,Os(t.fighters.length))}if(xb(t),t.phase==="playing"){const n=Array.isArray(a)?a:null;for(const s of t.fighters){let i;if(ob(t,s,o),!!s.alive){if(s.controller==="human"){const r=n===null?a:n[s.id]??gb;vb(s,r),r.attack&&rl(t,s,r.selectedWeapon,o),i=kb(t,s,e,r)}else i=ub(t,s,e,o);G1(s,e,t.arena,t.elapsed),Mb(t,s,e,i,o)}}kn(t.timeRemaining)&&Eb(t,e,o)}return Sb(t,e,o),t.phase==="playing"&&t.timeRemaining<=0&&bb(t,o),o}function bb(t,e){const{arena:a}=t,o=r=>r.maxHp>0?r.hp/r.maxHp:0,n=r=>Math.hypot(r.x-a.center.x,r.y-a.center.y),i=t.fighters.slice().sort((r,l)=>{const h=o(r),c=o(l);if(h!==c)return c-h;const d=n(r),p=n(l);return d!==p?d-p:r.deaths!==l.deaths?r.deaths-l.deaths:r.id-l.id})[0];t.phase="ended",t.winner=i.role,t.winnerId=i.id,e.push({type:"match-ended",winner:i.role,winnerId:i.id})}function yb(t,e,a){t.phase==="countdown"&&(t.countdownTick+=e,t.countdownTick>=1e3&&(t.countdownTick-=1e3,t.countdownValue-=1,t.countdownValue>0?a.push({type:"countdown-tick",value:t.countdownValue}):(t.startFlashTimer=Wf,a.push({type:"countdown-tick",value:0}))),t.countdownValue<=0&&(t.startFlashTimer-=e,t.startFlashTimer<=0&&(t.phase="playing",t.timeRemaining=Ea,t.safeRadius=t.arena.maxSafeRadius,a.push({type:"match-started"}))))}function xb(t){for(let e=t.splats.length-1;e>=0;e--)t.elapsed>=t.splats[e].expiresAt&&t.splats.splice(e,1);for(let e=t.trailMarks.length-1;e>=0;e--)t.elapsed>=t.trailMarks[e].expiresAt&&t.trailMarks.splice(e,1)}function H0(t,e){return C0(e.x,e.y,t.arena,t.splats)}function vb(t,e){if(Kp(t)||!e.aim)return;const a=Math.hypot(e.aim.x,e.aim.y);a>1e-6&&(t.facing={x:e.aim.x/a,y:e.aim.y/a})}function kb(t,e,a,o){const n=t.elapsed;let s=H0(t,e);Kl(t,e)&&(s*=It.speedBoost),n<e.status.slowedUntil&&(s*=Zf);const r=Ll(e,n)?0:vs(e.characterId,Gp)*a*s,l=o.move.x*r,h=o.move.y*r;return $s(e,l,h,t.arena),l!==0||h!==0}function Mb(t,e,a,o,n){if(!e.alive)return;if(e.terrainSlowFactor=H0(t,e),e.concealed=F0(e.x,e.y,t.arena,t,e),re[e.characterId].hasTrail&&o){if(e.trailDropTimer+=a,e.trailDropTimer>=It.dropIntervalMs){e.trailDropTimer=0;const r={id:t.nextId++,ownerId:e.id,ownerRole:e.role,x:e.x,y:e.y,expiresAt:t.elapsed+It.durationMs,damagedMask:0,damaged:!1};t.trailMarks.push(r),n.push({type:"trail-mark-created",ownerRole:e.role,ownerId:e.id,x:e.x,y:e.y})}}else e.trailDropTimer=0;for(const r of t.fighters){if(r===e||!r.alive)continue;const l=ym(r.id);let h=0;for(const c of t.trailMarks)if(!(c.ownerId!==e.id||(c.damagedMask&l)!==0)&&!(Math.hypot(r.x-c.x,r.y-c.y)>=It.radius)&&(c.damagedMask|=l,c.damaged=!0,!(h>=It.maxHitsPerTick)&&(h++,Xa(t,r,It.damage,null,{kind:"trail",ownerId:e.id,ownerRole:e.role},n),!r.alive)))break}if(t.arena.hazards.forEach((r,l)=>{if(r.kind!=="damage")return;if(Math.hypot(e.x-r.x,e.y-r.y)<r.radius){const c=(e.hazardTimers[l]??0)+a;c>=(r.tickMs??1/0)?(e.hazardTimers[l]=0,Xa(t,e,r.damage??0,null,{kind:"hazard"},n)):e.hazardTimers[l]=c}else e.hazardTimers[l]=0}),t.elapsed-e.lastDamagedAt>Uf&&e.hp<e.maxHp&&e.hp>0){if(e.regenTimer+=a,e.regenTimer>=Yf){e.regenTimer=0;const r=e.hp;e.hp=Math.min(e.maxHp,e.hp+jp),e.hp>r&&n.push({type:"heal",fighterRole:e.role,fighterId:e.id,amount:e.hp-r})}}else e.regenTimer=0;if(kn(t.timeRemaining))return;Math.hypot(e.x-t.arena.center.x,e.y-t.arena.center.y)>t.safeRadius&&e.hp>0?(e.fogTimer+=a,e.fogTimer>=Ns&&(e.fogTimer=0,Xa(t,e,Il,null,{kind:"fog"},n))):e.fogTimer=0}function Eb(t,e,a){const o=Xr-t.timeRemaining;if(Math.floor(o/Ns)===Math.floor((o-e)/Ns))return;const n=t.fighters.slice().sort((s,i)=>s.hp!==i.hp?s.hp-i.hp:i.id-s.id);for(const s of n){if(t.phase!=="playing")break;!s.alive||s.hp<=0||Math.hypot(s.x-t.arena.center.x,s.y-t.arena.center.y)<=t.safeRadius||Xa(t,s,Il,null,{kind:"fog"},a)}}function as(t,e,a,o){const n=t.projectiles[e];o.push({type:"projectile-destroyed",id:n.id,reason:a,x:n.x,y:n.y}),t.projectiles.splice(e,1)}function Wc(t,e,a,o){const n={id:t.nextId++,x:e,y:a,expiresAt:t.elapsed+Kf};t.splats.push(n),o.push({type:"splat-created",x:e,y:a})}function Tb(t,e,a){let o=null,n=1/0;for(const s of t.fighters){if(!oi(s,a))continue;const i=Math.hypot(e.x-s.x,e.y-s.y);i>=s.hitRadius||i<n&&(n=i,o=s)}return o}function Sb(t,e,a){for(let o=t.projectiles.length-1;o>=0;o--){const n=t.projectiles[o],s=n.weapon,i=t.fighters[n.targetId],r=t.fighters[n.ownerId];if(s.peckHits&&n.arrived){if(i.hp<=0){as(t,o,"expired",a);continue}n.peckTimer=(n.peckTimer??0)+e,n.peckTimer>=(s.peckInterval??500)&&(n.peckTimer=0,Xa(t,i,n.damage,s.effect,{kind:"weapon",weaponKey:s.key,weaponName:s.name,attackerId:n.ownerId},a),n.hitsSoFar=(n.hitsSoFar??1)+1,n.hitsSoFar>=s.peckHits&&as(t,o,"expired",a));continue}if(s.homing&&i.hp>0&&Vl(n.x,n.y,i.x,i.y,t.arena,t,i)){const g=i.x-n.x,w=i.y-n.y,b=Math.hypot(g,w)||1,x=g/b,M=w/b,y=Math.hypot(n.vx,n.vy)||1,v=n.vx/y,k=n.vy/y,T=Math.min(1,Xf*e),S=v+(x-v)*T,A=k+(M-k)*T,C=Math.hypot(S,A)||1,R=s.speed??0;n.vx=S/C*R,n.vy=A/C*R}const l=n.vx*e/1e3,h=n.vy*e/1e3,c=n.x+l,d=n.y+h,p=t.arena.cover.some(g=>hi(c,d,jc,jc,g.x,g.y,g.w,g.h)),u=Math.hypot(l,h);let m=u;if(u>0&&n.tx!==void 0&&n.ty!==void 0){const g=((i.x-n.tx)*l+(i.y-n.ty)*h)/u;g>0&&(m=u-g)}if(n.tx=i.x,n.ty=i.y,n.age=(n.age??0)+e,n.traveled+=m>0?m:0,n.x=c,n.y=d,p||n.traveled>=(s.range??1/0)||n.age>=Vf(s)){s.splatter&&Wc(t,n.x,n.y,a),as(t,o,p?"hit-cover":"expired",a);continue}const f=Tb(t,n,r);if(f!==null){if(f!==i&&(n.targetId=f.id,n.targetRole=f.role),Xa(t,f,n.damage,s.effect,{kind:"weapon",weaponKey:s.key,weaponName:s.name,attackerId:n.ownerId},a),s.splatter&&Wc(t,n.x,n.y,a),s.peckHits){n.arrived=!0,n.peckTimer=0,n.hitsSoFar=1;continue}as(t,o,"hit-target",a);continue}}}const Uc="pointerlock-styles",Ab=2600;function _0(){const t=new URLSearchParams(location.search);return t.get("pointerLock")??t.get("pointerlock")}function Rb(){const t=_0();if(t==="0")return!1;if(t==="1"||t==="sim")return!0;const e=new URLSearchParams(location.search);return!(e.has("shot")||e.has("simSpeed"))}function Ib(){return typeof window.matchMedia!="function"?!0:window.matchMedia("(pointer: fine)").matches}function Fb(t){const{target:e}=t,a=_0()==="sim";let o=!1;const s=typeof document<"u"&&"pointerLockElement"in document&&typeof e.requestPointerLock=="function"&&Ib()&&Rb();let i=!1,r=!1,l=!0,h="hidden",c=0,d=!1,p=!1,u="";const m=document.createElement("div");m.className="plk-root",m.innerHTML=`
  ...
  `;const f=H=>m.querySelector(`[data-el="${H}"]`),g=f("fs"),w=f("fs2");function b(){return a?o:document.pointerLockElement===e}function x(){window.__plockDebug={state:h,wantsLock:i,locked:b(),pending:p,lastError:u,available:s}}function M(){m.classList.toggle("is-prompt",h==="prompt"),m.classList.toggle("is-toast",h==="toast"),m.classList.toggle("is-lost",h==="lost"),x()}function y(H){h!==H&&(h=H,window.clearTimeout(c),H==="toast"&&(c=window.setTimeout(()=>{!d&&h==="toast"&&y("hidden")},Ab)),M())}function v(){const K=!!document.fullscreenElement?"⛶ Exit fullscreen":"⛶ Fullscreen";g.textContent=K,w.textContent=K}function k(){try{document.fullscreenElement?document.exitFullscreen?.()?.catch(()=>{}):document.documentElement.requestFullscreen?.()?.catch(()=>{})}catch{}}function T(H){u=H===void 0?"refused":String(H?.message??H),x(),!(d||!i||b())&&(t.pause(),y("lost"))}function S(){if(!(d||!s||!i||b()||p)){if(a){o=!0,F();return}p=!0;try{const H=e.requestPointerLock();H&&typeof H.then=="function"?H.then(()=>{p=!1},K=>{p=!1,T(K)}):window.setTimeout(()=>{p=!1},0)}catch(H){p=!1,T(H)}}}function A(){if(b()){if(r=!0,a){o=!1,F();return}try{document.exitPointerLock()}catch{r=!1}}}function C(){i=!0,t.resume()}function R(){i=!1,A(),y("prompt"),t.resume()}const F=()=>{if(d)return;const H=b();if(t.onLockChange(H),p=!1,H){i=!0,r=!1,y("toast");return}if(r){r=!1,y(l&&s?"prompt":"hidden");return}i?(t.pause(),y("lost")):y(l&&s?"prompt":"hidden")},N=()=>{p=!1,!d&&T("pointerlockerror")},L=()=>{d||!i||!s||b()||h!=="lost"&&(t.pause(),y("lost"))},P=()=>v(),W=H=>{d||!o||H.key!=="Escape"||(H.preventDefault(),H.stopImmediatePropagation(),o=!1,F())};return s&&(Cb(),document.body.appendChild(m),document.addEventListener("pointerlockchange",F),document.addEventListener("pointerlockerror",N),document.addEventListener("fullscreenchange",P),window.addEventListener("blur",L),a&&window.addEventListener("keydown",W,!0),f("capture").addEventListener("click",H=>{H.stopPropagation(),C()}),f("resume").addEventListener("click",H=>{H.stopPropagation(),C()}),f("scrim").addEventListener("click",()=>C()),f("free").addEventListener("click",H=>{H.stopPropagation(),R()}),g.addEventListener("click",H=>{H.stopPropagation(),k()}),w.addEventListener("click",H=>{H.stopPropagation(),k()}),v(),y("prompt"),M()),{available:s,get locked(){return s&&b()},engage:S,release:A,setMatchActive(H){!s||l===H||(l=H,H?b()||y("prompt"):(A(),y("hidden")))},dispose(){d||(d=!0,window.clearTimeout(c),s&&(A(),document.removeEventListener("pointerlockchange",F),document.removeEventListener("pointerlockerror",N),document.removeEventListener("fullscreenchange",P),window.removeEventListener("blur",L),window.removeEventListener("keydown",W,!0),m.remove()))}}}function Cb(){if(document.getElementById(Uc))return;const t=document.createElement("style");t.id=Uc,t.textContent=Ob,document.head.appendChild(t)}const Ob=`
.plk-root {
  position: fixed;
  inset: 0;
  z-index: 30;
...
`,Vt=.11,Yc=Q*.1,P0=new st(Vt,12,10);P0.scale(1,.86,1);const Nb=new jo(Vt*.32,Vt*.5,6),Co=new ti(Vt*.6,0);Co.scale(1,.4,1);const Lb=new Y({color:"#E63946"}),Db=new Y({color:"#3E5C2B"}),zb=new Y({color:"#FF9E9E",transparent:!0,opacity:.55,depthWrite:!1});function Xl(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Hb=Xl(18,()=>new Y({color:"#E63946",transparent:!0,opacity:.85,depthWrite:!1})),_b=Xl(20,()=>new Y({color:"#C21F32",transparent:!0,opacity:.9,depthWrite:!1})),Vc=Xl(6,()=>new Y({color:"#FFD9C7",transparent:!0,opacity:.95,blending:at,depthWrite:!1}));function Pb(t){const e=new ie,a=new E(P0,Lb);e.add(a);const o=new E(Nb,Db);o.position.set(0,Vt*.75,0),e.add(o);const n=new E(Co,zb);return n.scale.setScalar(.55),n.position.set(Vt*.32,Vt*.28,Vt*.5),e.add(n),e}function er(t,e,a,o,n,s=1){const i=new E(Co,_b()),r=(.3+Math.random()*.25)*s;i.scale.setScalar(r),i.position.copy(e);const l=e.x,h=e.y,c=e.z,d=1.1+Math.random()*1.3,p=-5.5,u=.32+Math.random()*.16;t.spawnTransient(i,u,(m,f)=>{i.position.set(l+a*n*f,h+d*f+.5*p*f*f,c+o*n*f),i.scale.setScalar(r*(1-m*.35)),i.material.opacity=.9*(1-m)})}const $b={Tomato:{projectile(t){const e=Pb(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=(e.userData.__spin??0)+a*8;e.userData.__spin=o,e.rotation.x=o,e.rotation.z=Math.sin(o*.6)*.25;const n=1+Math.sin(o*2.2)*.09;e.scale.set(1/n,n,1/n);const s=(e.userData.__dripTimer??.05)-a;s<=0?(e.userData.__dripTimer=.09+Math.random()*.05,er(t,t.position,-t.direction.x*.5,-t.direction.z*.5,.3+Math.random()*.25)):e.userData.__dripTimer=s},impact(t){const e=t.position,a=U.clamp(1+t.damage*.05,1,2.2),o=Yc/(Vt*.6),n=new E(Co,Vc());n.position.copy(e),n.scale.setScalar(.7*o),t.spawnTransient(n,.18,r=>{n.scale.setScalar(U.lerp(.7,2.4,r)*o*a),n.material.opacity=.9*(1-r)});const s=7,i=Ua*.45;for(let r=0;r<s;r++){const l=r/s*Math.PI*2+Math.random()*.5,h=i+(.5+Math.random()*.75)*a,c=new E(Co,Hb()),d=(.55+Math.random()*.4)*o*a,p=e.x+Math.cos(l)*i,u=e.y,m=e.z+Math.sin(l)*i;c.position.set(p,u,m),c.rotation.y=Math.random()*Math.PI*2;const f=e.x+Math.cos(l)*h,g=e.z+Math.sin(l)*h,w=u-.9;t.spawnTransient(c,.55+Math.random()*.2,b=>{const x=1-Math.pow(1-b,3);c.position.set(U.lerp(p,f,x),U.lerp(u,w,Math.min(1,x*1.3)),U.lerp(m,g,x)),c.scale.setScalar(d*(1-b*.3)),c.material.opacity=.85*(1-Math.pow(b,1.5))})}for(let r=0;r<5;r++){const l=Math.random()*Math.PI*2;er(t,e,Math.cos(l),Math.sin(l),1.3+Math.random()*1.1,o)}},cast(t){const e=Yc/(Vt*.6),a=new E(Co,Vc()),o=a.material;o.color.set(t.color),a.position.copy(t.position),a.scale.setScalar(.16*e),t.spawnTransient(a,.15,n=>{a.scale.setScalar(U.lerp(.16,.62,n)*e),o.opacity=.9*(1-n)});for(let n=0;n<3;n++){const s=(Math.random()-.5)*.6;er(t,t.position,t.direction.x+s,t.direction.z+s,.9+Math.random()*.5,e*.35)}}}},Zl="#C93F73",qb="#F0C070",ci="#FFF0F6",Bb="#FFD9EC",ll=["#E63946","#7CB518","#FFC93C","#7C4DFF","#2E86D8","#FFFFFF"],vt=Q,eo=Math.PI*2,Bs=.28,Dt=vt*.09,sa=vt*.043,jb=vt*.014,Gb=vt*.042,os=vt*.375,ns=vt*.4;function Oo(t,e,a,o,n){const s=new Cl(t,e,a,o,n);return s.rotateX(-Math.PI/2),s}const Wb=Oo(Dt,sa,8,22),Ub=Oo(Dt,sa*.82,8,22),Yb=Oo(Dt,sa*1.3,8,22),Kc=[Oo(Dt*.92,sa*.86,6,8,1.5),Oo(Dt*1.05,sa*.72,6,8,1),Oo(Dt*.8,sa*.95,6,7,2.1)];let Vb=0;const Kb=()=>Kc[Vb++%Kc.length],$0=new Fl(jb,Gb,3,6);function q0(t,e=40){const a=new xa(t,1,e,1);return a.rotateX(-Math.PI/2),a}const Xb=q0(.84),Zb=q0(.7);function Go(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Wo=(t,e,a={})=>new Y({color:t,transparent:!0,opacity:e,depthWrite:!1,side:be,...a}),Xc=new Y({color:"#FF6FA5"}),Jb=new Y({color:qb}),Qb=new Y({color:Zl}),Zc=ll.map(t=>new Y({color:t})),ey=Go(18,()=>Wo(Zl,1)),ty=Go(18,()=>Wo("#FF6FA5",1)),ay=Go(30,()=>Wo("#FFFFFF",1)),oy=Go(24,()=>Wo(ci,.7)),ny=Go(20,()=>Wo(ci,.7,{blending:at})),sy=Go(24,()=>Wo(ci,1)),B0=new pe(0,1,0),Jc=new pe,tr=new ai,Qc=new ai;function iy(t,e,a,o,n){tr.setFromAxisAngle(B0,o);const s=Math.hypot(e,a);Math.abs(n)>1e-4&&s>1e-4?(Jc.set(a/s,0,-e/s),Qc.setFromAxisAngle(Jc,n),t.quaternion.copy(Qc).multiply(tr)):t.quaternion.copy(tr)}function ry(t){return t.range&&t.speed?t.range/t.speed:so.normal/1e3}function ly(t,e,a){let o=t.userData.__ring;return o||(o={spin:Math.random()*eo,rate:a*eo/ry(e),shed:0,echo:0},t.userData.__ring=o),o}function Da(t,e,a,o,n,s,i,r,l,h={}){const c=h.hard?sy():h.glow?ny():oy();c.color.set(i),c.opacity=r;const d=new E(h.band?Zb:Xb,c);d.renderOrder=h.renderOrder??9,d.position.set(e,a,o),d.rotation.y=Math.random()*eo,d.scale.set(n,1,n);const p=h.fadePow??1,u=h.hold??0;t.spawnTransient(d,l,m=>{const f=U.lerp(n,s,1-Math.pow(1-m,2.4));d.scale.set(f,1,f),c.opacity=m<u?r:r*(1-Math.pow((m-u)/(1-u),p))})}function ar(t,e,a,o,n,s,i,r,l=1){const h=ay();h.color.set(ll[Math.random()*ll.length|0]),h.opacity=1;const c=new E($0,h);c.renderOrder=9,c.position.set(e,a,o),c.scale.setScalar(l);const d=(Math.random()-.5)*26,p=(Math.random()-.5)*26,u=-9;t.spawnTransient(c,r,(m,f)=>{c.position.set(e+n*f,Math.max(Bs,a+s*f+.5*u*f*f),o+i*f),c.rotation.set(d*f,0,p*f),h.opacity=1-Math.pow(m,2.4)})}function hy(t,e,a,o,n,s,i){const r=new ie,l=ey();l.color.set(Zl),l.opacity=1;const h=Kb(),c=new E(h,l);c.scale.setScalar(1.28),r.add(c);const d=ty();d.color.set(a),d.opacity=1,r.add(new E(h,d)),r.renderOrder=9,r.position.copy(e),r.scale.setScalar(s);const p=e.x,u=e.y,m=e.z,f=Math.cos(o)*n,g=Math.sin(o)*n,w=1.5+Math.random()*1.2,b=-8.5,x=(Math.random()-.5)*20,M=(Math.random()-.5)*20;t.spawnTransient(r,i,(y,v)=>{r.position.set(p+f*v,Math.max(Bs,u+w*v+.5*b*v*v),m+g*v),r.rotation.set(x*v,0,M*v);const k=1-Math.pow(y,2.2);d.opacity=k,l.opacity=k})}function cy(t){return U.clamp(.85+t*.035,.85,1.25)}function dy(t){const e=new ie,a=new E(Yb,Qb);a.position.y=-vt*.007,e.add(a),e.add(new E(Wb,Jb)),Xc.color.set(t);const o=new E(Ub,Xc);o.position.y=sa*.36,e.add(o);const n=Math.random()*eo;for(let s=0;s<5;s++){const i=n+s/5*eo+(Math.random()-.5)*.6,r=new E($0,Zc[Math.random()*Zc.length|0]);r.position.set(Math.cos(i)*Dt,sa*1.05,Math.sin(i)*Dt),r.quaternion.setFromAxisAngle(B0,-i),r.rotateX(Math.PI/2),r.scale.setScalar(1.05),e.add(r)}return e.userData.__isCandyRing=!0,e}const py={Candy:{projectile(t){const e=dy(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=ly(e,t.weapon,2.4);if(o.spin+=o.rate*a,iy(e,t.direction.x,t.direction.z,o.spin,.13+Math.sin(o.spin*.41)*.08),e.position.y+=Math.sin(o.spin*.62)*vt*.011,o.echo-=a,o.echo<=0){o.echo=.075;const n=Dt+sa;Da(t,t.position.x,t.position.y,t.position.z,n,n*1.45,Bb,.55,.2,{glow:!0,fadePow:1.4})}o.shed-=a,o.shed<=0&&(o.shed=.085+Math.random()*.05,ar(t,t.position.x-t.direction.x*Dt,t.position.y,t.position.z-t.direction.z*Dt,-t.direction.x*.6+(Math.random()-.5)*.6,.15+Math.random()*.35,-t.direction.z*.6+(Math.random()-.5)*.6,.34,.85))},impact(t){const e=cy(t.damage),{x:a,y:o,z:n}=t.position;Da(t,a,o,n,os*.8*e,os*e,"#FFF6FA",1,.16,{hard:!0,renderOrder:12,fadePow:1.1,hold:.45}),Da(t,a,o,n,os*.62*e,os*.86*e,t.color,1,.19,{hard:!0,renderOrder:11,fadePow:1.4,hold:.3}),Da(t,a,Bs,n,ns*.2*e,ns*e,t.color,.95,.3,{hard:!0,renderOrder:7,fadePow:1.6,hold:.35}),Da(t,a,Bs-.01,n,ns*.16*e,ns*.86*e,ci,.9,.34,{hard:!0,band:!0,renderOrder:6,fadePow:1.4,hold:.3});for(let s=0;s<3;s++){const i=s/3*eo+Math.random()*.9;hy(t,t.position,t.color,i,(2.3+Math.random()*1.5)*e,(1.05+Math.random()*.5)*e,.36+Math.random()*.12)}for(let s=0;s<8;s++){const i=Math.random()*eo,r=(2.2+Math.random()*1.8)*e;ar(t,a,o,n,Math.cos(i)*r+t.direction.x*.9,2.5+Math.random()*1.6,Math.sin(i)*r+t.direction.z*.9,.4+Math.random()*.14,1.1+Math.random()*.6)}},cast(t){Da(t,t.position.x,t.position.y,t.position.z,vt*.06,vt*.2,"#FFF6FA",1,.16,{hard:!0,renderOrder:12,hold:.3}),Da(t,t.position.x,t.position.y,t.position.z,vt*.03,vt*.13,t.color,.95,.13,{hard:!0,band:!0,renderOrder:11,hold:.25});for(let e=0;e<4;e++)ar(t,t.position.x,t.position.y,t.position.z,t.direction.x*(1.2+Math.random()*.8)+(Math.random()-.5)*.7,.7+Math.random()*.6,t.direction.z*(1.2+Math.random()*.8)+(Math.random()-.5)*.7,.3,.85)}}},On="#F2A73E",Jl="#B96F16",j0="#E9C078",Ql="#4E2C1B",G0="#E63946",W0="#8FCB1E",di="#EFE2FA",U0="#C9A9E4",Y0="#CDB0EE",de=Q,$e=Math.PI*2,js=.29,zo=de*.085,pi=de*.105,or=de*.032,ge=de*.105,ta=de*.07,$a=de*.036,Re=de*.125,uy=de*.33;function No(t,e=7){return new Me(1,1,1,e,1,!0,-t/2,t)}const Ho=[No(1.1),No(1.7),No(2.3)];let fy=0;const my=()=>Ho[fy++%Ho.length],hl=No(2.7,9),V0=No(2.9,12),cl=new ti(1,0),K0=new Ol(1,0),dl=new Rt(1,1,1),ed=new st(1,14,10),gy=new st(1,16,10,0,Math.PI*1.5),wy=new Cl(1,.062,5,20),td=new jo(1,1,6),by=No(2.2,7),yy=(()=>{const e=document.createElement("canvas");e.width=e.height=64;const a=e.getContext("2d"),o=a.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);o.addColorStop(0,"rgba(255,255,255,0.85)"),o.addColorStop(.42,"rgba(255,255,255,0.44)"),o.addColorStop(.76,"rgba(255,255,255,0.12)"),o.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=o,a.fillRect(0,0,64,64);const n=new nt(e);return n.colorSpace=Sl,n})();function ro(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Uo=(t,e={})=>new Y({color:t,transparent:!0,opacity:1,depthWrite:!1,side:be,...e}),eh=ro(26,()=>Uo(On)),X0=ro(34,()=>Uo(j0)),ss=ro(30,()=>Uo(Ql)),xy=ro(12,()=>Uo(U0)),Z0=ro(20,()=>Uo("#FFF3D6")),vy=ro(14,()=>new Ut({map:yy,color:Y0,transparent:!0,opacity:.3,depthWrite:!1})),ca=(t,e={})=>new Y({color:t,side:be,...e}),ad=ca("#6B3E26"),ky=ca(Ql),My=ca(On),Ey=ca(Jl),od=ca(W0),Ty=ca(G0),nd=ca("#B497D6"),Sy=ca(U0),nr=ca(di);function Ay(t){return t.range&&t.speed?t.range/t.speed:so.normal/1e3}function sr(t){const e=t.weapon.comboParts;if(!e)return-1;const a=e.findIndex(o=>o.color===t.color&&o.damage===t.damage);return a>=0?a:e.findIndex(o=>o.color===t.color)}function J0(t){return U.clamp(.85+t*.035,.85,1.45)}function Q0(t,e,a){let o=t.userData.__tumble;return o||(o={t:Math.random()*$e,rate:a*$e/Ay(e),shed:0},t.userData.__tumble=o),o}function Ao(t,e,a,o,n,s,i,r,l,h,c,d,p,u,m=-9){a.color.set(o),a.opacity=1;const f=new E(e,a);f.renderOrder=9,f.position.set(n,s,i),f.scale.set(c,d,p),f.rotation.set(Math.random()*$e,Math.random()*$e,Math.random()*$e);const g=(Math.random()-.5)*20,w=(Math.random()-.5)*20,b=(Math.random()-.5)*20,x=f.rotation.x,M=f.rotation.y,y=f.rotation.z;t.spawnTransient(f,u,(v,k)=>{const T=s+l*k+.5*m*k*k,S=T<=js;f.position.set(n+r*k,S?js:T,i+h*k),S||f.rotation.set(x+g*k,M+w*k,y+b*k),a.opacity=1-Math.pow(v,2.4)})}function eu(t,e,a,o,n,s,i,r,l){Ao(t,my(),eh(),Math.random()<.35?Jl:On,e,a,o,n,s,i,zo*r,pi*r,zo*r,l)}function ui(t,e,a,o,n,s,i,r,l){Ao(t,K0,X0(),j0,e,a,o,n,s,i,or*r,or*r,or*r,l)}function fi(t,e,a,o,n,s,i,r,l,h){if(e==="lettuce")Ao(t,hl,ss(),W0,a,o,n,s,i,r,ta*l,ta*.42*l,ta*l,h,-6.5);else if(e==="tomato")Ao(t,dl,ss(),G0,a,o,n,s,i,r,$a*l,$a*l,$a*l,h);else if(e==="onion")Ao(t,dl,ss(),di,a,o,n,s,i,r,$a*1.3*l,$a*.4*l,$a*1.3*l,h);else{const c=ge*(.45+Math.random()*.3)*l;Ao(t,cl,ss(),Math.random()<.4?Ql:"#6B3E26",a,o,n,s,i,r,c,c*.8,c*1.15,h)}}function th(t,e,a,o,n){const s=Z0();s.color.set("#FFF3D6"),s.opacity=1;const i=new E(K0,s);i.renderOrder=12,i.position.set(e,a,o),i.rotation.set(Math.random()*$e,Math.random()*$e,0),i.scale.setScalar(n*.6),t.spawnTransient(i,.12,r=>{i.scale.setScalar(n*U.lerp(.6,1.3,r)),s.opacity=r<.4?1:1-(r-.4)/.6})}function tu(t,e){const{x:a,y:o,z:n}=t.position,s=t.direction,i=Math.random()*$e;for(let r=0;r<5;r++){const l=i+r/5*$e,h=Z0();h.color.set(r%2===0?"#FFF3D6":"#FFD27A"),h.opacity=1;const c=new E(Ho[r%Ho.length],h);c.renderOrder=12;const d=Math.cos(l),p=Math.sin(l),u=de*.11*e,m=de*.44*e,f=Math.atan2(d,p);t.spawnTransient(c,.13,g=>{const w=1-Math.pow(1-g,2.2),b=U.lerp(u,m,w);c.position.set(a+d*b+s.x*b*.3,o,n+p*b+s.z*b*.3);const x=(1-g*.45)*e;c.rotation.set(0,f,0),c.scale.set(zo*1.15*x,pi*1*x,zo*1.15*x),h.opacity=g<.45?1:1-(g-.45)/.55})}}function sd(t,e,a,o,n,s,i,r=.3){const l=new Ya(vy()),h=l.material;h.color.set(Y0),h.opacity=0,l.renderOrder=10;const c=(Math.random()-.5)*n*1.4,d=(Math.random()-.5)*n*1.4;l.position.set(e,a,o),l.scale.set(n,n,1),t.spawnTransient(l,i,p=>{const u=1-Math.pow(1-p,2);l.position.set(e+c*u,a+s*u,o+d*u);const m=n*(1+u*.9);l.scale.set(m,m,1),h.opacity=r*Math.sin(Math.min(1,p*1.25)*Math.PI)})}function Ry(t,e,a,o){const{x:n,y:s,z:i}=t.position,r=t.direction;let l=-r.z,h=r.x;Math.hypot(l,h)<1e-4&&(l=1,h=0);for(const c of[-1,1]){const d=eh();d.color.set(c<0?On:Jl),d.opacity=1;const p=new E(V0,d);p.renderOrder=9;const u=n+l*c*de*.24*e,m=i+h*c*de*.24*e;p.position.set(u,s,m);const f=zo*2.1*e;p.scale.set(f,pi*1.9*e,f);const g=l*c*a+r.x*a*.35,w=h*c*a+r.z*a*.35,b=1.5+Math.random()*.9,x=c*(7+Math.random()*5),M=(Math.random()-.5)*6;t.spawnTransient(p,o,(y,v)=>{const k=s+b*v-4.6*v*v;p.position.set(u+g*v,Math.max(js,k),m+w*v),p.rotation.set(M*v,x*v,c*.5),d.opacity=1-Math.pow(y,2.2)})}}function ir(t){const e=new ie;ad.color.set(t);const a=new E(cl,ad);a.scale.set(ge,ge*.85,ge*1.18),a.rotation.set(.6,.4,.2),e.add(a);const o=new E(cl,ky);o.scale.setScalar(ge*.62),o.position.set(ge*.55,-ge*.4,-ge*.3),o.rotation.set(1.1,.3,.8),e.add(o);const n=new E(hl,od);n.scale.set(ta*1.15,ta*.4,ta*1.15),n.position.set(-ge*.45,ge*.55,ge*.2),n.rotation.set(.9,.7,-.5),e.add(n);for(const[l,h,c]of[[.8,.3,.5],[-.55,-.25,-.8]]){const d=new E(dl,Ty);d.scale.setScalar($a*1.45),d.position.set(ge*l,ge*h,ge*c),d.rotation.set(Math.random(),Math.random(),Math.random()),e.add(d)}const s=new E(hl,od);s.scale.set(ta*.8,ta*.3,ta*.8),s.position.set(ge*.3,-ge*.15,-ge*.7),s.rotation.set(-.6,1.9,.8),e.add(s);const i=new E(Ho[2],My);i.scale.set(ge*1.02,ge*1.25,ge*1.02),i.position.set(-ge*.25,-ge*.72,-ge*.1),i.rotation.set(1.5,.4,.15),e.add(i);const r=new E(Ho[0],Ey);return r.scale.set(ge*.7,ge*.85,ge*.7),r.position.set(ge*.75,-ge*.35,ge*.45),r.rotation.set(.9,2.2,-.6),e.add(r),e}function rr(t){const e=new ie;nd.color.set(t);const a=new E(ed,nd);a.scale.set(Re,Re*.92,Re),e.add(a);const o=new ie;for(let i=0;i<3;i++){const r=new E(wy,nr);r.scale.set(Re*1.01,Re*.93,Re*1.01),r.rotation.y=i/3*Math.PI,o.add(r)}e.add(o);const n=new E(td,nr);n.scale.set(Re*.42,Re*.62,Re*.42),n.position.y=Re*1.06,n.rotation.z=.18,e.add(n);for(let i=0;i<3;i++){const r=i/3*$e+.4,l=new E(td,Sy);l.scale.set(Re*.09,Re*.34,Re*.09),l.position.set(Math.cos(r)*Re*.2,-Re*1,Math.sin(r)*Re*.2),l.rotation.set(Math.PI+(Math.random()-.5)*.6,0,(Math.random()-.5)*.6),e.add(l)}const s=new E(ed,nr);return s.scale.set(Re*.42,Re*.2,Re*.42),s.position.set(Re*.42,Re*.62,-Re*.3),e.add(s),e.userData.__bands=o,e}function id(t,e){const a=t.object;if(!a)return;const o=t.dt??0,n=Q0(a,t.weapon,e);if(n.t+=n.rate*o,a.rotation.x=n.t,a.rotation.z=Math.sin(n.t*.63)*.9,n.shed-=o,n.shed<=0){n.shed=.06+Math.random()*.04;const s=Math.random(),i=s<.45?"meat":s<.72?"tomato":"lettuce",r=t.position.x-t.direction.x*ge,l=t.position.z-t.direction.z*ge;fi(t,i,r,t.position.y-ge*.4,l,-t.direction.x*.5+(Math.random()-.5)*.7,-.2-Math.random()*.4,-t.direction.z*.5+(Math.random()-.5)*.7,.85,.34),Math.random()<.55&&ui(t,r,t.position.y,l,-t.direction.x*.7+(Math.random()-.5)*.6,.1+Math.random()*.3,-t.direction.z*.7+(Math.random()-.5)*.6,.9,.3)}}function rd(t,e){const a=J0(t.damage)*e,{x:o,y:n,z:s}=t.position,i=t.direction;th(t,o,n,s,de*.24*a),tu(t,a),Ry(t,a*.95,2.4*a,.4);const r=de*.26*a,l=.8;for(let h=0;h<6;h++){const c=h/6*$e+Math.random()*.7,d=(2.2+Math.random()*1.5)*a,p=Math.random();fi(t,p<.5?"meat":p<.78?"tomato":"lettuce",o+Math.cos(c)*r,n,s+Math.sin(c)*r,Math.cos(c)*d+i.x*l,1.9+Math.random()*1.3,Math.sin(c)*d+i.z*l,a,.42+Math.random()*.14)}for(let h=0;h<4;h++){const c=h/4*$e+Math.random()*.9,d=(2.4+Math.random()*1.6)*a;eu(t,o+Math.cos(c)*r,n,s+Math.sin(c)*r,Math.cos(c)*d+i.x*l,1.7+Math.random()*1.5,Math.sin(c)*d+i.z*l,(.85+Math.random()*.5)*a,.42+Math.random()*.12)}for(let h=0;h<9;h++){const c=Math.random()*$e,d=(2.6+Math.random()*2.1)*a;ui(t,o+Math.cos(c)*r*.8,n,s+Math.sin(c)*r*.8,Math.cos(c)*d+i.x*l,1.5+Math.random()*1.8,Math.sin(c)*d+i.z*l,(.85+Math.random()*.7)*a,.36+Math.random()*.14)}}function ld(t,e){const a=t.object;if(!a)return;const o=t.dt??0,n=Q0(a,t.weapon,e);n.t+=n.rate*o,a.rotation.x=n.t*.8,a.rotation.z=n.t*.45;const s=a.userData.__bands;if(s&&(s.rotation.y+=o*1.9),n.shed-=o,n.shed<=0){n.shed=.1+Math.random()*.07;const i=X0();i.color.set(di),i.opacity=1;const r=new E(by,i);r.renderOrder=9;const l=t.position.x-t.direction.x*Re,h=t.position.z-t.direction.z*Re;r.position.set(l,t.position.y,h);const c=Re*(.3+Math.random()*.2);r.scale.set(c,c*.5,c);const d=-t.direction.x*.5+(Math.random()-.5)*.5,p=-t.direction.z*.5+(Math.random()-.5)*.5,u=5+Math.random()*5;t.spawnTransient(r,.42,(m,f)=>{r.position.set(l+d*f,t.position.y-.7*f*f-.25*f,h+p*f),r.rotation.set(Math.sin(f*u)*1.4,f*3,Math.cos(f*u*.7)*1.1),i.opacity=1-Math.pow(m,2)})}}function hd(t,e){const a=J0(t.damage)*e,{x:o,y:n,z:s}=t.position,i=t.direction;th(t,o,n,s,de*.21*a),tu(t,a*.88);for(let h=0;h<3;h++){const c=xy();c.color.set(h===0||h===1?t.color:di),c.opacity=.66;const d=new E(gy,c);d.renderOrder=10,d.position.set(o,n,s),d.rotation.set((Math.random()-.5)*.5,Math.random()*$e,(Math.random()-.5)*.5);const p=Re*(.8+h*.12),u=uy*a*(.78+h*.22),m=(Math.random()-.5)*5;t.spawnTransient(d,.3+h*.05,f=>{const g=1-Math.pow(1-f,2.6),w=U.lerp(p,u,g);d.scale.set(w,w*(.9-g*.45),w),d.position.y=n+g*de*.06,d.rotation.y+=m*.02,c.opacity=.66*(1-Math.pow(f,1.4))})}sd(t,o,n*.6,s,de*.34*a,de*.3,.65,.4);for(let h=0;h<3;h++){const c=h/3*$e+Math.random();sd(t,o+Math.cos(c)*de*.24*a,js+de*.12,s+Math.sin(c)*de*.24*a,de*.28*a,de*.26,.6,.34)}const r=de*.24*a,l=.7;for(let h=0;h<5;h++){const c=h/5*$e+Math.random()*.8,d=(2.3+Math.random()*1.4)*a;fi(t,"onion",o+Math.cos(c)*r,n,s+Math.sin(c)*r,Math.cos(c)*d+i.x*l,1.9+Math.random()*1.2,Math.sin(c)*d+i.z*l,a,.4+Math.random()*.12)}for(let h=0;h<3;h++){const c=Math.random()*$e,d=(2.3+Math.random()*1.5)*a;eu(t,o+Math.cos(c)*r,n,s+Math.sin(c)*r,Math.cos(c)*d+i.x*l,1.6+Math.random()*1.4,Math.sin(c)*d+i.z*l,(.75+Math.random()*.45)*a,.4)}for(let h=0;h<7;h++){const c=Math.random()*$e,d=(2.5+Math.random()*1.9)*a;ui(t,o+Math.cos(c)*r*.8,n,s+Math.sin(c)*r*.8,Math.cos(c)*d+i.x*l,1.4+Math.random()*1.6,Math.sin(c)*d+i.z*l,(.8+Math.random()*.6)*a,.34+Math.random()*.12)}}function lr(t,e,a){const o=t.direction,{x:n,y:s,z:i}=t.position,r=eh();r.color.set(On),r.opacity=.9;const l=new E(V0,r);l.renderOrder=11;const h=Math.atan2(o.x,o.z),c=zo*.9*a;t.spawnTransient(l,.18,d=>{const p=c*(1+d*1.5);l.position.set(n+o.x*d*de*.14,s-d*de*.04,i+o.z*d*de*.14),l.scale.set(p,pi*1.1*a*(1-d*.35),p),l.rotation.set(0,h+d*1.1,0),r.opacity=.9*(1-d*d)}),th(t,n+o.x*de*.06,s,i+o.z*de*.06,de*.1*a);for(let d=0;d<7;d++)ui(t,n,s,i,o.x*(1.4+Math.random()*1.1)+(Math.random()-.5)*.9,.6+Math.random()*.7,o.z*(1.4+Math.random()*1.1)+(Math.random()-.5)*.9,.9,.3);for(const d of e)fi(t,d,n,s,i,o.x*(1.3+Math.random()*.7)+(Math.random()-.5)*.6,.8+Math.random()*.5,o.z*(1.3+Math.random()*.7)+(Math.random()-.5)*.6,.9*a,.3)}const Iy=de*.83/(ge*2.8),Fy=new st(de*.06,7,6),Cy=ro(8,()=>Uo("#FFF3D6",{blending:at,opacity:0}));function cd(t,e){let a=0;t.traverse(o=>{o.isMesh&&!o.name&&(o.name=`${e}Part${a++}`)})}const Oy={Filling:{projectile(t){const e=ir(t.color);return e.position.copy(t.position),e},trail(t){id(t,1.7)},impact(t){rd(t,1)},cast(t){lr(t,["meat","tomato"],1)}},Onion:{projectile(t){const e=rr(t.color);return e.position.copy(t.position),e},trail(t){ld(t,1.2)},impact(t){hd(t,1)},cast(t){lr(t,["onion","onion"],1)}},Double:{projectile(t){const e=sr(t)===1?rr(t.color):ir(t.color);return e.scale.setScalar(1.12),e.position.copy(t.position),e},trail(t){sr(t)===1?ld(t,1.3):id(t,1.9)},impact(t){sr(t)===1?hd(t,1.12):rd(t,1.12)},cast(t){lr(t,["meat","onion","tomato"],1.25)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=new e.Group;o.name="teleTacoRoot";const n=t.position.clone();n.y-=de*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=t.weapon.comboParts??[],i=ir(s[0]?.color??t.color);i.name="teleTacoFilling";const r=rr(s[1]?.color??"#B497D6");r.name="teleTacoOnion",cd(i,"teleTacoFilling"),cd(r,"teleTacoOnion"),o.add(i,r);const l=6,h=[];for(let f=0;f<l;f++){const g=new e.Mesh(Fy,Cy());g.name=`teleTacoSpark${f}`,h.push(g),o.add(g)}const c=(f,g,w)=>{const b=e.MathUtils.clamp((f-g)/(w-g),0,1);return b*b*(3-2*b)},d=de*.48,p=de*.72,u=[e.MathUtils.degToRad(s[0]?.angle??-10),e.MathUtils.degToRad(s[1]?.angle??10)],m=(f,g)=>{const w=e.MathUtils.clamp(g/a,0,1),b=c(w,0,.42),x=c(w,.3,.82),M=c(w,.82,1);for(let y=0;y<2;y++){const v=y===0?i:r,k=y===0?-1:1,T=.76+.24*b,S=-de*.62*x,A=d*(.55+.65*b+.35*x),C=u[y],R=de*.85*M,F=k*A+Math.sin(C)*R,N=S+Math.cos(C)*R;v.position.set(F,p+de*(.2*x+.1*M),N),v.scale.setScalar(Iy*T*(1+.18*M)),v.rotation.set(w*5.5*(y===0?1:-1),w*3.1,w*2.2*k)}for(let y=0;y<l;y++){const v=h[y],k=y/l*$e+w*6.5,T=d*(.25+.85*b);v.position.set(Math.cos(k)*T,p+Math.sin(k*1.7)*de*.16+de*.18*x,Math.sin(k)*T*.55-de*.3*x);const S=.85+1.15*w;v.scale.setScalar(S),v.material.opacity=.45+.45*w}};m(0,0),t.spawnTransient(o,a+.06,m)}}},Yo="#F5EAD6",Ny="#E4CFA0",au="#B9843C",ou="#6B3E12",nu="#452D18",mi="#E0562B",su="#D5EAF4",ah="#FFFFFF",Nn="#FFF6E4",iu="#5B3324",oh="#FFC93C",nh="#E63946",sh="#7DA33F",Ly="#FFFDF7",ae=Q,Ie=Math.PI*2,En=.29,Ne=ae*.115,it=ae*.3,Dy=ae*.085,ru=ae*.075,ih=ae*.09,_o=ae*.032,hr=ae*.058,zy=ae*.1,Po=ae*.022,Hy=ae*.4,_y=ae*.97,Py=ae*.7,lu=ae*.11,pl=new Rt(1,1,1),$y=new Me(.5,.5,1,8,1,!0,-1.5,3),hu=new ti(.5,0),cu=new Ol(.62,0),Ln=new Fl(1,1.4,3,6);Ln.scale(.5,1/3.4,.5);const du=new st(.5,8,6),Tn=new Rt(1,1,1),pu=new jo(.5,1,4),Sn=new Rt(1,1,1),dd=new Cl(1,.085,5,18),pd=new Me(1,1,1,16,1),qy=new Me(.55,1,1,14,1),By=new Me(1,1,1,12,1,!0,-1.55,3.1),jy=new io(1,18);function da(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const pa=(t,e={})=>new Y({color:t,transparent:!0,opacity:1,depthWrite:!1,side:be,...e}),Gy=da(30,()=>pa(Yo)),xo=da(34,()=>pa(Nn)),Wy=da(6,()=>pa(mi)),Uy=da(10,()=>pa(Yo)),Yy=da(10,()=>pa(ou)),uu=da(24,()=>pa(ah)),Ue=(t,e={})=>new Y({color:t,side:be,...e}),ud=Ue(Yo),fd=Ue(Ny),is=Ue(au),Vy=Ue(su),Ky=Ue(mi),md=Ue(Nn),Xy=Ue(iu);Ue(oh);Ue(nh);Ue(sh);const Zy=[Ue(sh),Ue(nh),Ue(oh),Ue(Nn)],Jy=[Ue("#5C7F2A"),Ue("#B02733"),Ue("#E0A317"),Ue(Ly)],rs=new pe,ls=new pe,cr=new pe,gd=new Vp;function Qy(t,e,a,o,n,s,i){rs.set(e,a,o).normalize(),ls.set(n,s,i).normalize(),cr.crossVectors(rs,ls).normalize(),ls.crossVectors(cr,rs).normalize(),gd.makeBasis(rs,ls,cr),t.quaternion.setFromRotationMatrix(gd)}function e2(t){return t.range&&t.speed?t.range/t.speed:so.normal/1e3}function wd(t){const e=t.weapon.pelletColors;if(!e||e.length===0)return 0;const a=e.indexOf(t.color);return a>=0?a%4:0}function ul(t){return U.clamp(.85+t*.035,.85,1.35)}function fu(t,e,a){let o=t.userData.__spin;return o||(o={t:Math.random()*Ie,rate:a*Ie/e2(e),shed:0,age:0},t.userData.__spin=o),o}function Ft(t,e,a,o,n,s,i,r,l,h,c,d,p,u,m=-9){a.color.set(o),a.opacity=1;const f=new E(e,a);f.renderOrder=9,f.position.set(n,s,i),f.scale.set(c,d,p),f.rotation.set(Math.random()*Ie,Math.random()*Ie,Math.random()*Ie);const g=(Math.random()-.5)*18,w=(Math.random()-.5)*18,b=(Math.random()-.5)*18,x=f.rotation.x,M=f.rotation.y,y=f.rotation.z;t.spawnTransient(f,u,(v,k)=>{const T=s+l*k+.5*m*k*k,S=T<=En;f.position.set(n+r*k,S?En:T,i+h*k),S||f.rotation.set(x+g*k,M+w*k,y+b*k),a.opacity=1-Math.pow(v,2.4)})}function Lo(t,e,a,o,n,s,i,r,l){const h=Dy*r*(.85+Math.random()*.55),c=Math.random();Ft(t,$y,Gy(),c<.24?nu:c<.48?au:Yo,e,a,o,n,s,i,h,h*.85,h,l,-7.5)}function An(t,e,a,o,n,s,i,r,l){const h=ru*r*(.7+Math.random()*.6);Ft(t,Math.random()<.5?hu:cu,uu(),Math.random()<.45?ah:su,e,a,o,n,s,i,h*1.3,h*.34,h,l,-8.5)}function Rn(t,e,a,o,n,s,i,r,l,h){if(e==="rice")Ft(t,Ln,xo(),Nn,a,o,n,s,i,r,_o*l,ih*l,_o*l,h);else if(e==="bean"){const c=hr*l;Ft(t,du,xo(),iu,a,o,n,s,i,r,c*1.35,c*.85,c*.85,h)}else if(e==="cheese")Ft(t,Tn,xo(),oh,a,o,n,s,i,r,zy*l,Po*l,Po*l,h,-6.5);else if(e==="salsa"){const c=hr*.85*l;Ft(t,Sn,xo(),nh,a,o,n,s,i,r,c,c,c,h)}else{const c=hr*l;Ft(t,Sn,xo(),sh,a,o,n,s,i,r,c*1.2,c*.55,c*1.2,h)}}const t2=ae*.075,hs=da(28,()=>pa(Nn)),bd=7;function a2(t,e,a,o,n,s,i,r,l,h){const c=t.color,d=t2*l;if(e===0)Ft(t,pu,hs(),c,a,o,n,s,i,r,d*.5,d*2.6,d*.22,h,-7.2);else if(e===1){const p=d*(1+Math.random()*.35);Ft(t,Sn,hs(),c,a,o,n,s,i,r,p,p,p,h)}else e===2?Ft(t,Tn,hs(),c,a,o,n,s,i,r,d*2.5,Po*2.2,Po*2.2,h,-6.5):Ft(t,Ln,hs(),c,a,o,n,s,i,r,_o*1.15*l,ih*1.15*l,_o*1.15*l,h,-7.5)}function fl(t,e){const{x:a,y:o,z:n}=t.position,s=t.direction,i=Math.random()*Ie;for(let r=0;r<8;r++){const l=i+r/8*Ie,h=uu();h.color.set(r%2===0?ah:nu),h.opacity=1;const c=new E(r%2===0?hu:cu,h);c.renderOrder=12;const d=Math.cos(l),p=Math.sin(l),u=ae*.26*e,m=ae*.44*e,f=(Math.random()-.5)*14;t.spawnTransient(c,.14,g=>{const w=1-Math.pow(1-g,2.2),b=U.lerp(u,m,w);c.position.set(a+d*b+s.x*b*.28,o+w*ae*.05,n+p*b+s.z*b*.28);const x=ru*e*(1.7-g*.5);c.scale.set(x*1.6,x*.34,x),c.rotation.set(f*g,Math.atan2(d,p),f*g*.6),h.opacity=g<.45?1:1-(g-.45)/.55})}}const ya=16,mu=2.35,o2=.42;function rh(t){const e=new ie,a=Uy(),o=Yy();a.color.set(Yo),a.opacity=1,o.color.set(ou),o.opacity=1;const n=[];for(let s=0;s<t;s++){const i=new E(pl,o);i.renderOrder=10;const r=new E(pl,a);r.renderOrder=11,i.scale.setScalar(0),r.scale.setScalar(0),e.add(i,r),n.push({face:r,back:i})}return{group:e,slats:n,faceMat:a,backMat:o}}function n2(t,e,a,o,n,s,i,r){const{group:l,slats:h,faceMat:c,backMat:d}=rh(ya),p=ae*.06*i,u=ae*.15*i,m=Py*i,f=lu*i,g=(M,y,v)=>{const k=M*mu*Ie*s,T=M*o2*Ie*s,S=k+(T-k)*y,A=p+M*(u-p),C=p+M*(m-p),R=A+(C-A)*y;v.x=e+Math.cos(n+S)*R,v.z=o+Math.sin(n+S)*R},w={x:0,z:0},b={x:0,z:0},x=M=>{const y=1-Math.pow(1-Math.min(1,M/.62),2.4),v=U.lerp(a,En,1-Math.pow(1-Math.min(1,M/.72),1.8));for(let T=0;T<ya;T++){const S=T/ya,A=(T+1)/ya;g(S,y,w),g(A,y,b);const C=b.x-w.x,R=b.z-w.z,F=Math.hypot(C,R)*1.14,N=Math.atan2(C,R),L=(w.x+b.x)*.5,P=(w.z+b.z)*.5,W=f*(1-S*.35),{face:H,back:K}=h[T];H.rotation.set(0,N,0),K.rotation.set(0,N,0),H.position.set(L,v+.022,P),K.position.set(L,v,P),H.scale.set(W,ae*.008,F),K.scale.set(W*1.8,ae*.006,F*1.12)}const k=M<.68?1:1-(M-.68)/.32;c.opacity=k,d.opacity=k*.95};x(0),t.spawnTransient(l,r,x)}function s2(t,e,a){const{x:o,z:n}=t.position,s=22,i=2.2,r=Hy*e,{group:l,slats:h,faceMat:c,backMat:d}=rh(s),p=Math.random()*Ie,u=En+ae*.02,m=(_y*e-u)/(s-1),f=i*Ie/(s-1),g=w=>{const b=Math.min(1,w/.52),x=w<.62?1:1-(w-.62)/.38*.16;for(let y=0;y<s;y++){const v=y/s*.9,k=b>v,{face:T,back:S}=h[y];if(T.visible=k,S.visible=k,!k)continue;const A=p+y*f,C=r*x,R=o+Math.cos(A)*C,F=u+y*m,N=n+Math.sin(A)*C;Qy(T,-Math.sin(A)*C*f,m,Math.cos(A)*C*f,Math.cos(A),0,Math.sin(A)),S.quaternion.copy(T.quaternion);const L=C*f*1.02,P=ae*.1*e;T.position.set(R,F,N),S.position.set(R-Math.cos(A)*.02,F,N-Math.sin(A)*.02),T.scale.set(L,ae*.009,P),S.scale.set(L*1.02,ae*.007,P*1.75)}const M=w<.62?1:1-(w-.62)/.38;c.opacity=.88*M,d.opacity=.92*M};g(0),t.spawnTransient(l,a,g)}function gu(t,e,a,o,n,s,i,r,l){const{group:h,slats:c,faceMat:d,backMat:p}=rh(ya),u=ae*.03*r,m=ae*.13*r,f=Math.random()<.5?1:-1,g=f*(9+Math.random()*5),w={x:0,z:0},b={x:0,z:0},x=(y,v,k)=>{const T=v+y*mu*Ie*f,S=u+y*(m-u);k.x=Math.cos(T)*S,k.z=Math.sin(T)*S},M=(y,v)=>{const k=g*v,T=e+n*v,S=Math.max(En,a+s*v-4*v*v),A=o+i*v;for(let R=0;R<ya;R++){x(R/ya,k,w),x((R+1)/ya,k,b);const F=b.x-w.x,N=b.z-w.z,L=Math.hypot(F,N)*1.16,P=Math.atan2(F,N),{face:W,back:H}=c[R];W.rotation.set(0,P,0),H.rotation.set(0,P,0),W.position.set(T+(w.x+b.x)*.5,S+.018,A+(w.z+b.z)*.5),H.position.set(T+(w.x+b.x)*.5,S,A+(w.z+b.z)*.5);const K=lu*r*.72;W.scale.set(K,ae*.007,L),H.scale.set(K*1.8,ae*.005,L*1.14)}const C=1-Math.pow(y,2);d.opacity=C,p.opacity=C*.95};M(0,0),t.spawnTransient(h,l,M)}function i2(t){const e=new ie,a=new ie;e.add(a),ud.color.set(t);const o=new E(pd,ud);o.rotation.x=Math.PI/2,o.scale.set(Ne,it*.8,Ne),a.add(o);const n=new E(qy,fd);n.rotation.x=-Math.PI/2,n.scale.set(Ne,it*.12,Ne),n.position.z=-it*.46,a.add(n);const s=new E(By,is);s.rotation.x=Math.PI/2,s.scale.set(Ne*1.02,it*.8,Ne*1.02),a.add(s);const i=new E(Tn,is);i.position.set(Ne*.92,0,0),i.rotation.set(.42,0,0),i.scale.set(Ne*.14,Ne*.16,it*.82),a.add(i);const r=new E(pd,Vy);r.rotation.x=Math.PI/2,r.scale.set(Ne*1.07,it*.26,Ne*1.07),r.position.z=-it*.2,a.add(r);for(const c of[-it*.1,it*.04]){const d=new E(dd,Ky);d.scale.set(Ne*1.08,Ne*1.08,Ne*.85),d.position.z=c,a.add(d)}const l=new E(jy,fd);l.scale.setScalar(Ne*.99),l.position.z=it*.404,a.add(l);const h=[is,md,is];for(let c=0;c<3;c++){const d=new E(dd,h[c]),p=Ne*(.78-c*.25);d.scale.set(p,p,Ne*.2),d.position.z=it*.412,a.add(d)}for(let c=0;c<4;c++){const d=c/4*Ie+.5,p=new E(c%2===0?Ln:du,c%2===0?md:Xy),u=Ne*.28;p.scale.set(u,c%2===0?u*2:u,u),p.position.set(Math.cos(d)*Ne*.6,Math.sin(d)*Ne*.6,it*.42),p.rotation.set(Math.random(),Math.random(),Math.random()),a.add(p)}return e.userData.__spinner=a,e}function yd(t){const e=new ie,a=Zy[t],o=Jy[t],n=ae*.075;if(t===0){for(let i=0;i<3;i++){const r=new E(pu,i===1?o:a);r.scale.set(n*.5,n*2.6,n*.22),r.position.set((i-1)*n*.5,n*.4,0),r.rotation.set(.2,0,(i-1)*.55),e.add(r)}const s=new E(Tn,o);s.scale.set(n*.16,n*1.2,n*.16),s.position.y=-n*.7,e.add(s)}else if(t===1)for(let s=0;s<3;s++){const i=s/3*Ie,r=new E(Sn,s===2?o:a),l=n*(1+Math.random()*.35);r.scale.setScalar(l),r.position.set(Math.cos(i)*n*.75,Math.sin(i)*n*.5,Math.sin(i*1.7)*n*.55),r.rotation.set(Math.random(),Math.random(),Math.random()),e.add(r)}else if(t===2)for(let s=0;s<4;s++){const i=new E(Tn,s===3?o:a);i.scale.set(n*2.5,Po*1.2,Po*1.2),i.position.set(0,(s-1.5)*n*.28,(s-1.5)*n*.2),i.rotation.set(0,(s-1.5)*.28,(s-1.5)*.14),e.add(i)}else for(let s=0;s<5;s++){const i=s/5*Ie+.3,r=new E(Ln,s===4?o:a);r.scale.set(_o*1.15,ih*1.15,_o*1.15),r.position.set(Math.cos(i)*n*.55,Math.sin(i*1.3)*n*.4,Math.sin(i)*n*.55),r.rotation.set(Math.random()*2,Math.random()*2,Math.random()*2),e.add(r)}return e}function r2(t){const e=t.object;if(!e)return;const a=t.dt??0,o=fu(e,t.weapon,9);o.t+=o.rate*a;const n=e.userData.__spinner;if(n&&(n.rotation.z=o.t),e.rotation.x=Math.sin(o.t*.35)*.1,o.shed-=a,o.shed<=0){o.shed=.055+Math.random()*.04;const s=t.position.x-t.direction.x*it*.5,i=t.position.z-t.direction.z*it*.5,r=Math.random();r<.42?Rn(t,"rice",s,t.position.y-Ne*.3,i,-t.direction.x*.6+(Math.random()-.5)*.7,-.15-Math.random()*.4,-t.direction.z*.6+(Math.random()-.5)*.7,.9,.32):r<.72?Lo(t,s,t.position.y,i,-t.direction.x*.8+(Math.random()-.5)*.6,.15+Math.random()*.3,-t.direction.z*.8+(Math.random()-.5)*.6,.75,.3):An(t,s,t.position.y,i,-t.direction.x*.9+(Math.random()-.5)*.5,.2+Math.random()*.35,-t.direction.z*.9+(Math.random()-.5)*.5,.65,.26)}}function l2(t){const e=ul(t.damage),{x:a,y:o,z:n}=t.position,s=t.direction;fl(t,e);const i=ae*.16*e;let r=-s.z,l=s.x;Math.hypot(r,l)<1e-4&&(r=1,l=0);const h=Math.atan2(s.z,s.x);for(const p of[-1,1])n2(t,a+s.x*i+r*p*i*.7,o,n+s.z*i+l*p*i*.7,h+p*1.05,p,e*.92,.78);const c=ae*.26*e,d=.8;for(let p=0;p<9;p++){const u=p/9*Ie+Math.random()*.6,m=(2.3+Math.random()*1.5)*e,f=Math.random();Rn(t,f<.32?"rice":f<.66?"bean":f<.85?"cheese":"salsa",a+Math.cos(u)*c,o,n+Math.sin(u)*c,Math.cos(u)*m+s.x*d,1.9+Math.random()*1.3,Math.sin(u)*m+s.z*d,e,.42+Math.random()*.14)}for(let p=0;p<6;p++){const u=p/6*Ie+Math.random()*.9,m=(2.4+Math.random()*1.6)*e;Lo(t,a+Math.cos(u)*c,o,n+Math.sin(u)*c,Math.cos(u)*m+s.x*d,1.8+Math.random()*1.4,Math.sin(u)*m+s.z*d,(.9+Math.random()*.5)*e,.44+Math.random()*.12)}for(let p=0;p<4;p++){const u=Math.random()*Ie,m=(2.7+Math.random()*1.8)*e;An(t,a+Math.cos(u)*c*.9,o,n+Math.sin(u)*c*.9,Math.cos(u)*m+s.x*d,1.6+Math.random()*1.6,Math.sin(u)*m+s.z*d,(.8+Math.random()*.6)*e,.36+Math.random()*.12)}}function h2(t,e){const a=t.direction,{x:o,y:n,z:s}=t.position;gu(t,o,n,s,a.x*2.2+(Math.random()-.5)*.4,.7,a.z*2.2+(Math.random()-.5)*.4,e,.26);for(let i=0;i<5;i++)Rn(t,i%2===0?"rice":"bean",o,n,s,a.x*(1.5+Math.random()*1)+(Math.random()-.5)*.9,.7+Math.random()*.6,a.z*(1.5+Math.random()*1)+(Math.random()-.5)*.9,.9*e,.3);for(let i=0;i<4;i++)An(t,o,n,s,a.x*(1.7+Math.random()*1.2)+(Math.random()-.5)*.8,.8+Math.random()*.6,a.z*(1.7+Math.random()*1.2)+(Math.random()-.5)*.8,.8*e,.24);for(let i=0;i<3;i++)Lo(t,o,n,s,a.x*(1.3+Math.random()*.9)+(Math.random()-.5)*.7,.6+Math.random()*.5,a.z*(1.3+Math.random()*.9)+(Math.random()-.5)*.7,.8*e,.26)}const c2=3.6,xd=new st(1,14,10),d2=da(4,()=>pa(mi,{opacity:.85})),p2=da(4,()=>pa(Yo,{opacity:.7}));function u2(t,e){let a=0;t.traverse(o=>{o.isMesh&&!o.name&&(o.name=`${e}Part${a++}`)})}const f2={Disc:{projectile(t){const e=i2(t.color);return e.position.copy(t.position),e},trail(t){r2(t)},impact(t){l2(t)},cast(t){h2(t,1)}},Roll:{impact(t){const e=ul(t.damage);s2(t,1,.62),fl(t,e*.85);const{x:a,y:o,z:n}=t.position,s=t.direction,i=ae*.24*e;for(let r=0;r<5;r++){const l=r/5*Ie+Math.random()*.8,h=(2+Math.random()*1.3)*e;Rn(t,r%2===0?"rice":"guac",a+Math.cos(l)*i,o,n+Math.sin(l)*i,Math.cos(l)*h+s.x*.6,1.7+Math.random()*1.1,Math.sin(l)*h+s.z*.6,e,.38+Math.random()*.12)}for(let r=0;r<3;r++){const l=Math.random()*Ie,h=(2.2+Math.random()*1.4)*e;Lo(t,a+Math.cos(l)*i,o,n+Math.sin(l)*i,Math.cos(l)*h+s.x*.6,1.6+Math.random()*1.2,Math.sin(l)*h+s.z*.6,.85*e,.4)}},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position;for(const s of[-.5,.5])gu(t,a-e.z*s*ae*.12,o,n+e.x*s*ae*.12,e.x*2.6-e.z*s*1.2,.5,e.z*2.6+e.x*s*1.2,.9,.3);for(let s=0;s<5;s++)Lo(t,a,o,n,e.x*(1.6+Math.random()*1.1)+(Math.random()-.5)*1,.6+Math.random()*.6,e.z*(1.6+Math.random()*1.1)+(Math.random()-.5)*1,.85,.28);for(let s=0;s<3;s++)An(t,a,o,n,e.x*(1.8+Math.random()*1)+(Math.random()-.5)*.9,.7+Math.random()*.5,e.z*(1.8+Math.random()*1)+(Math.random()-.5)*.9,.75,.24)}},Swarm:{projectile(t){const e=yd(wd(t));return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=fu(e,t.weapon,2.4);o.t+=o.rate*a,o.age+=a;const n=Math.sin(o.age*7.5+o.t)*ae*.085;if(e.position.x+=-t.direction.z*n,e.position.z+=t.direction.x*n,e.position.y+=Math.sin(o.age*5.2)*ae*.03,e.rotation.x=o.t*.8,e.rotation.z=Math.sin(o.t*.7)*.7,o.shed-=a,o.shed<=0){o.shed=.14+Math.random()*.08;const s=xo();s.color.set(t.color),s.opacity=1;const i=new E(Sn,s);i.renderOrder=9;const r=e.position.x,l=e.position.y,h=e.position.z,c=ae*.03;i.position.set(r,l,h),i.scale.setScalar(c),t.spawnTransient(i,.26,(d,p)=>{i.position.set(r,l-.5*p*p,h),i.scale.setScalar(c*(1-d*.6)),s.opacity=1-d})}},impact(t){const e=ul(t.damage)*.8,{x:a,y:o,z:n}=t.position,s=t.direction;fl(t,1);const i=ae*.28,r=wd(t);for(let l=0;l<bd;l++){const h=l/bd*Ie+Math.random()*.8,c=(2.6+Math.random()*1.5)*e;a2(t,r,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*.7,1.8+Math.random()*1.2,Math.sin(h)*c+s.z*.7,1.15,.44+Math.random()*.1)}for(let l=0;l<4;l++){const h=l/4*Ie+Math.random()*.9,c=(2.5+Math.random()*1.5)*e;Lo(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*.5,1.6+Math.random()*1.2,Math.sin(h)*c+s.z*.5,1+Math.random()*.4,.38)}},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position,s=(t.weapon.spreadDeg??40)*Math.PI/360,i=["guac","salsa","cheese","rice"];for(let c=0;c<12;c++){const d=(Math.random()*2-1)*s,p=Math.cos(d),u=Math.sin(d),m=e.x*p-e.z*u,f=e.x*u+e.z*p,g=1.8+Math.random()*1.4;Rn(t,i[c%4],a,o,n,m*g,.8+Math.random()*.7,f*g,.95,.34)}const r=Wy();r.color.set(mi),r.opacity=1;const l=new E(pl,r);l.renderOrder=11;const h=Math.atan2(e.x,e.z);t.spawnTransient(l,.2,c=>{const d=1-Math.pow(1-c,2);l.position.set(a+e.x*d*ae*.3,o+d*ae*.05,n+e.z*d*ae*.3),l.rotation.set(0,h+d*.8,0),l.scale.set(ae*.2*(1+d*.5),ae*.01,ae*.05),r.opacity=1-c*c});for(let c=0;c<4;c++)An(t,a,o,n,e.x*(1.6+Math.random()*1.1)+(Math.random()-.5)*1.1,.8+Math.random()*.6,e.z*(1.6+Math.random()*1.1)+(Math.random()-.5)*1.1,.8,.26)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=new e.Group;o.name="teleBurritoRoot";const n=t.position.clone();n.y-=ae*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=d2(),i=new e.Mesh(xd,s);i.name="teleBurritoBulge",o.add(i);const r=p2(),l=new e.Mesh(xd,r);l.name="teleBurritoShell",o.add(l);const h=4,c=[];for(let g=0;g<h;g++){const w=yd(g);w.name=`teleBurritoTopping${g}`,u2(w,`teleBurritoTopping${g}`),c.push(w),o.add(w)}const d=(g,w,b)=>{const x=e.MathUtils.clamp((g-w)/(b-w),0,1);return x*x*(3-2*x)},p=ae*.78,u=ae*.22,m=(t.weapon.spreadDeg??55)*Math.PI/360,f=(g,w)=>{const b=e.MathUtils.clamp(w/a,0,1),x=d(b,0,.4),M=d(b,.85,1),y=ae*(.13+.15*x)*(1-.35*M);i.position.set(0,p,u),i.scale.set(y,y*(.82+.25*Math.sin(b*11)),y),s.opacity=(.55+.4*x)*(1-M*.8);const v=ae*(.17-.05*x);l.position.set(0,p-ae*.04,u-ae*.16),l.scale.set(v,v*(1.25-.3*x),v),r.opacity=.62*(1-M*.9);for(let k=0;k<h;k++){const T=c[k],S=k*.09,A=d(b,.18+S,.85),C=(k/(h-1)-.5)*2*m,R=k/h*Ie+b*(3.2+2.4*A),F=e.MathUtils.lerp(R,C,M),N=ae*(.42+.34*A+.26*M);T.position.set(Math.sin(F)*N,p+Math.sin(R*1.6)*ae*.1*(1-M)+ae*.1*A,u+Math.cos(F)*N*(.55+.45*M));const L=2.2+(c2-2.2)*A;T.scale.setScalar(L),T.rotation.set(b*4.2+k,b*3-k,b*2.4)}};f(0,0),t.spawnTransient(o,a+.06,f)}}},lo="#FFF8EA",lh="#E4D6AE",gi="#FFFFFF",hh="#4A3118",wu="#FF9E12",m2="#FFCE55",bu="#F4FBFF",Ms="#FFD84D",g2="#EFB528",w2="#F5872B",b2="#2A2320",yu="#FFF0B8",Te=Q,De=Math.PI*2,to=.29,y2=Te*.31,x2=Te*.2,xu=Te*.03,v2=Te*.062,k2=Te*.115,M2=Te*.052,E2=Te*.16,T2=Te*.026,S2=Te*.045,qa=Te*.125,rt=Te*.085,cs=Te*.115,ao=new jo(.5,1,4);ao.rotateZ(-Math.PI/2);const ml=new st(.5,16,11,0,Math.PI*1.5),A2=new Me(.5,.5,1,8,1,!0,-1.35,2.7),R2=new Me(.5,.5,1,8,1,!0,-1.2,2.4),Ro=new st(.5,12,10),ch=new Fl(1,2.2,3,7);ch.scale(.5,1/4.2,.5);ch.rotateZ(-Math.PI/2);const vu=new Ol(.62,0),I2=new jo(.5,1,3),F2=new Rt(1,1,1),ku=new jo(.5,1,4);ku.rotateX(Math.PI/2);function Dn(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const zn=(t,e={})=>new Y({color:t,transparent:!0,opacity:1,depthWrite:!1,side:be,...e}),Mu=Dn(34,()=>zn(lo)),C2=Dn(18,()=>zn(wu)),O2=Dn(18,()=>zn(bu)),N2=Dn(16,()=>zn(yu)),$o=Dn(40,()=>zn(gi)),ia=(t,e={})=>new Y({color:t,side:be,...e}),dr=ia(lo),gl=ia(lh),L2=ia(lo),vd=ia(w2),D2=ia(b2),kd=ia(g2),Md=[ia(Ms),ia(Ms),ia(Ms)];let z2=0;const hn=new pe,cn=new pe,pr=new pe,Ed=new Vp;function wi(t,e,a,o){hn.set(e,a,o).normalize(),Math.abs(hn.y)>.94?cn.set(1,0,0):cn.set(0,1,0),pr.crossVectors(hn,cn).normalize(),cn.crossVectors(pr,hn).normalize(),Ed.makeBasis(hn,cn,pr),t.quaternion.setFromRotationMatrix(Ed)}function H2(t){return t.range&&t.speed?t.range/t.speed:so.normal/1e3}function wl(t){return U.clamp(.85+t*.035,.85,1.45)}function _2(t,e,a,o,n,s,i,r,l,h,c,d,p,u,m=-9){a.color.set(o),a.opacity=1;const f=new E(e,a);f.renderOrder=9,f.position.set(n,s,i),f.scale.set(c,d,p),f.rotation.set(Math.random()*De,Math.random()*De,Math.random()*De);const g=(Math.random()-.5)*20,w=(Math.random()-.5)*20,b=(Math.random()-.5)*20,x=f.rotation.x,M=f.rotation.y,y=f.rotation.z;t.spawnTransient(f,u,(v,k)=>{const T=s+l*k+.5*m*k*k,S=T<=to;f.position.set(n+r*k,S?to:T,i+h*k),S||f.rotation.set(x+g*k,M+w*k,y+b*k),a.opacity=1-Math.pow(v,2.4)})}function Ga(t,e,a,o,n,s,i,r,l){const h=v2*r*(.75+Math.random()*.6);_2(t,vu,Mu(),Math.random()<.3?lh:lo,e,a,o,n,s,i,h,h*.8,h,l)}function ur(t,e,a,o,n,s,i,r,l){const h=C2();h.color.set(Math.random()<.3?m2:wu),h.opacity=1;const c=new E(Ro,h);c.renderOrder=9;const d=M2*r*(.8+Math.random()*.6);c.position.set(e,a,o),c.scale.setScalar(d);const p=14+Math.random()*10,u=Math.random()*De;t.spawnTransient(c,l,(m,f)=>{const g=a+s*f-4.4*f*f;c.position.set(e+n*f,Math.max(to,g),o+i*f);const w=Math.sin(u+f*p)*.24;c.scale.set(d*(1+w),d*(1-w),d*(1+w*.4)),h.opacity=1-Math.pow(m,3)})}function Es(t,e,a,o,n,s,i,r,l){const h=O2();h.color.set(bu),h.opacity=.78;const c=new E(ch,h);c.renderOrder=10,c.position.set(e,a,o);const d=E2*r*(.55+Math.random()*.4),p=T2*r*(.75+Math.random()*.5);wi(c,n,s,i),c.scale.set(d,p,p),t.spawnTransient(c,l,(u,m)=>{const f=a+s*m-2.2*m*m;c.position.set(e+n*m,Math.max(to,f),o+i*m),c.scale.set(d*(1+u*1.5),p*(1-u*.4),p*(1-u*.4)),h.opacity=.78*(1-Math.pow(u,1.8))})}function dh(t,e,a,o,n,s,i,r){const l=N2();l.color.set(Math.random()<.35?Ms:yu),l.opacity=1;const h=new E(I2,l);h.renderOrder=9;const c=S2*i*(.7+Math.random()*.6);h.position.set(e,a,o),h.scale.set(c,c*1.5,c*.35);const d=4+Math.random()*4,p=Math.random()*De;t.spawnTransient(h,r,(u,m)=>{h.position.set(e+n*m+Math.sin(p+m*d)*.1,a+.35*m-.55*m*m,o+s*m+Math.cos(p+m*d*.8)*.1),h.rotation.set(Math.sin(p+m*d)*1.5,m*2.2,Math.cos(p+m*d*.7)*1.2),l.opacity=1-Math.pow(u,2)})}function Ts(t,e,a,o=.13){const{x:n,y:s,z:i}=t.position,r=t.direction,l=Math.random()*De;for(let h=0;h<e;h++){const c=l+h/e*De+(Math.random()-.5)*.5,d=(h%3-1)*.42+(Math.random()-.5)*.2,p=Math.cos(d),u=Math.cos(c)*p,m=Math.sin(d),f=Math.sin(c)*p,g=$o();g.color.set(h%2===0?gi:lo),g.opacity=1;const w=$o();w.color.set(hh),w.opacity=1;const b=new E(ao,g),x=new E(ao,w);b.renderOrder=13,x.renderOrder=12;const M=y2,y=M+x2*a*(.7+Math.random()*.55),v=xu*(.8+Math.random()*.45),k=n+r.x*M*.22,T=i+r.z*M*.22,S=new ie;S.add(x,b),wi(b,u,m,f),x.quaternion.copy(b.quaternion),t.spawnTransient(S,o,A=>{const C=1-Math.pow(1-A,2.4),R=U.lerp(M,M+(y-M)*.45,C),F=U.lerp(M+(y-M)*.35,y,C),N=Math.max(.02,F-R),L=(R+F)*.5;b.position.set(k+u*L,s+m*L,T+f*L),x.position.copy(b.position),b.scale.set(N,v,v),x.scale.set(N*1.06,v*2.6,v*2.6);const P=A<.45?1:1-(A-.45)/.55;g.opacity=P,w.opacity=P})}}function Td(t,e,a,o){const{x:n,z:s}=t.position,i=Math.random()*De,r=new ie,l=$o();l.color.set(gi),l.opacity=1;const h=$o();h.color.set(hh),h.opacity=1;const c=[];for(let u=0;u<e;u++){const m=i+u/e*De+(Math.random()-.5)*.55,f=new E(ao,h),g=new E(ao,l);f.renderOrder=10,g.renderOrder=11,f.scale.setScalar(0),g.scale.setScalar(0),wi(g,Math.cos(m),0,Math.sin(m)),f.quaternion.copy(g.quaternion),r.add(f,g),c.push({face:g,seam:f,a:m,len:Te*(.16+Math.random()*.3)*a,w:Te*(.02+Math.random()*.014)*a})}const d=Te*.2*a,p=u=>{const m=1-Math.pow(1-Math.min(1,u/.22),2.6);for(const g of c){const w=Math.max(.001,g.len*m),b=d+w*.5,x=n+Math.cos(g.a)*b,M=s+Math.sin(g.a)*b;g.face.position.set(x,to+.012,M),g.seam.position.set(x,to,M),g.face.scale.set(w,Te*.006,g.w),g.seam.scale.set(w*1.05,Te*.004,g.w*2.1)}const f=u<.42?1:1-(u-.42)/.58;l.opacity=.92*f,h.opacity=.92*f};p(0),t.spawnTransient(r,o,p)}function Sd(t,e,a,o){const{x:n,y:s,z:i}=t.position,r=t.direction;let l=-r.z,h=r.x;Math.hypot(l,h)<1e-4&&(l=1,h=0);for(const c of[-1,1]){const d=Mu();d.color.set(c<0?lo:lh),d.opacity=1;const p=new E(ml,d);p.renderOrder=10;const u=n+l*c*Te*.26*e,m=i+h*c*Te*.26*e,f=k2*2*e;p.position.set(u,s,m),p.scale.set(f,f*1.15,f),p.rotation.set(0,c*1.4,0);const g=l*c*a+r.x*a*.35,w=h*c*a+r.z*a*.35,b=1.6+Math.random()*.9,x=c*(6+Math.random()*4),M=(Math.random()-.5)*5;t.spawnTransient(p,o,(y,v)=>{const k=s+b*v-4.6*v*v;p.position.set(u+g*v,Math.max(to,k),m+w*v),p.rotation.set(M*v,c*1.4+x*v,c*.4),d.opacity=1-Math.pow(y,2.2)})}}function P2(t){const e=new ie,a=new ie;e.add(a);const o=Md[z2++%Md.length];o.color.set(t);const n=qa,s=new E(Ro,o);s.scale.set(n*2,n*1.85,n*1.9),s.position.y=n*.15,a.add(s);const i=new E(Ro,kd);i.scale.set(n*1.5,n*.8,n*1.45),i.position.set(0,-n*.42,n*.18),a.add(i);const r=new E(ku,vd);r.scale.set(n*.55,n*.46,n*.7),r.position.set(0,n*.26,n*.92),a.add(r);for(const c of[-1,1]){const d=new E(Ro,D2);d.scale.setScalar(n*.34),d.position.set(c*n*.4,n*.62,n*.62),a.add(d);const p=new E(Ro,kd);p.scale.set(n*.34,n*.85,n*1.05),p.position.set(c*n*.92,n*.08,-n*.1),p.rotation.z=c*.4,a.add(p),p.userData.__side=c;const u=new E(F2,vd);u.scale.set(n*.18,n*.1,n*.44),u.position.set(c*n*.34,-n*.92,n*.12),a.add(u)}const l=new E(ml,L2);l.scale.set(n*1.22,n*1,n*1.22),l.position.set(-n*.16,n*.88,-n*.22),l.rotation.set(Math.PI-.42,.7,.3),a.add(l);const h=new E(ml,gl);return h.scale.set(n*1.08,n*.8,n*1.08),h.position.set(-n*.16,n*.86,-n*.22),h.rotation.set(Math.PI-.42,.7,.3),a.add(h),e.userData.__bob=a,e}function $2(t){const e=new ie;dr.color.set(t);const a=new E(A2,dr);a.scale.set(rt*2,cs,rt*2),e.add(a);const o=new E(R2,gl);o.scale.set(rt*1.78,cs*.92,rt*1.78),e.add(o);for(let s=0;s<2;s++){const i=new E(vu,dr),r=rt*(.42+s*.18);i.scale.set(r,r*.7,r),i.position.set(rt*(s===0?.8:-.5),cs*(s===0?.45:-.5),rt*.4),i.rotation.set(Math.random()*2,Math.random()*2,Math.random()*2),e.add(i)}const n=new E(Ro,gl);return n.scale.set(rt*.75,rt*.4,rt*.75),n.position.set(-rt*.2,-cs*.34,0),e.add(n),e}function Eu(t,e,a){let o=t.userData.__anim;return o||(o={t:Math.random()*De,rate:a*De/H2(e.weapon),shed:0,age:0,lx:e.position.x,lz:e.position.z,speed:Ze(e.weapon.speed??160)},t.userData.__anim=o),o}function q2(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Eu(e,t,1);o.age+=a;const n=Math.hypot(t.position.x-o.lx,t.position.z-o.lz);a>0&&(o.speed=o.speed*.55+n/a*.45),o.lx=t.position.x,o.lz=t.position.z;const s=Ze(t.weapon.speed??160),i=o.speed<s*.28,r=e.userData.__bob;if(r)if(i){const l=o.age*2.2%1,h=Math.sin(Math.min(1,l*2.2)*Math.PI);r.position.set(0,-qa*.3*h,qa*.75*h),r.rotation.set(h*.95,0,0)}else{const l=o.age*7;r.position.set(0,Math.abs(Math.sin(l))*qa*.22,0),r.rotation.set(0,0,Math.sin(l*.5)*.3);for(const h of r.children){const c=h.userData.__side;c!==void 0&&(h.rotation.z=c*(.4+Math.sin(l)*.5))}}o.shed-=a,o.shed<=0&&(o.shed=i?.1+Math.random()*.08:.2+Math.random()*.14,dh(t,t.position.x+(Math.random()-.5)*qa,t.position.y+qa*.3,t.position.z+(Math.random()-.5)*qa,-t.direction.x*.25+(Math.random()-.5)*.35,-t.direction.z*.25+(Math.random()-.5)*.35,1,.7))}const B2=Te*.27;function j2(t){const e=wl(t.damage)*1.25,{x:a,y:o,z:n}=t.position,s=t.direction;Ts(t,4,e*1.15);const i=B2;for(let r=0;r<9;r++){const l=r/9*De+Math.random()*.6,h=(1.9+Math.random()*1.2)*e;Ga(t,a+Math.cos(l)*i,o,n+Math.sin(l)*i,Math.cos(l)*h+s.x*.5,1.5+Math.random()*1,Math.sin(l)*h+s.z*.5,1.2*e,.34)}for(let r=0;r<10;r++){const l=Math.random()*De;dh(t,a+Math.cos(l)*i,o+Te*.05,n+Math.sin(l)*i,Math.cos(l)*(.9+Math.random()*.8),Math.sin(l)*(.9+Math.random()*.8),e*1.25,.62)}}function G2(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Eu(e,t,1.9);if(o.t+=o.rate*a,e.rotation.x=o.t,e.rotation.z=Math.sin(o.t*.7)*1,o.shed-=a,o.shed<=0){o.shed=.075+Math.random()*.05;const n=t.position.x-t.direction.x*rt,s=t.position.z-t.direction.z*rt;Math.random()<.45?Es(t,n,t.position.y-rt*.3,s,-t.direction.x*.35+(Math.random()-.5)*.4,-.5-Math.random()*.4,-t.direction.z*.35+(Math.random()-.5)*.4,.6,.3):Ga(t,n,t.position.y,s,-t.direction.x*.7+(Math.random()-.5)*.6,.1+Math.random()*.3,-t.direction.z*.7+(Math.random()-.5)*.6,.7,.28)}}const W2={Tackle:{impact(t){const e=wl(t.damage),{x:a,y:o,z:n}=t.position,s=t.direction;Ts(t,8,e),Sd(t,e*.95,2.4*e,.42),Td(t,7,e,.66);const i=Te*.26*e,r=.8;for(let l=0;l<5;l++){const h=l/5*De+Math.random()*.7,c=(2+Math.random()*1.2)*e;ur(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*r,1.9+Math.random()*1.1,Math.sin(h)*c+s.z*r,e*1.15,.5+Math.random()*.12)}for(let l=0;l<6;l++){const h=l/6*De+Math.random()*.8,c=(2.4+Math.random()*1.5)*e;Es(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*r,1.4+Math.random()*1,Math.sin(h)*c+s.z*r,e,.4+Math.random()*.12)}for(let l=0;l<11;l++){const h=Math.random()*De,c=(2.6+Math.random()*2)*e;Ga(t,a+Math.cos(h)*i*.9,o,n+Math.sin(h)*i*.9,Math.cos(h)*c+s.x*r,1.7+Math.random()*1.7,Math.sin(h)*c+s.z*r,(.9+Math.random()*.6)*e,.4+Math.random()*.14)}},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position,s=Math.atan2(e.x,e.z);for(let i=0;i<4;i++){const r=(i-1.5)*.34,l=Math.sin(s+r),h=Math.cos(s+r),c=(i%2-.5)*.35,d=$o();d.color.set(i%2===0?gi:lo),d.opacity=1;const p=$o();p.color.set(hh),p.opacity=1;const u=new E(ao,d),m=new E(ao,p);u.renderOrder=13,m.renderOrder=12;const f=new ie;f.add(m,u),wi(u,l,c,h),m.quaternion.copy(u.quaternion);const g=xu*.85;t.spawnTransient(f,.17,w=>{const b=1-Math.pow(1-w,2.2),x=Te*.1+b*Te*.1,M=Te*(.12+b*.22),y=x+M*.5;u.position.set(a+l*y,o+c*y*.5,n+h*y),m.position.copy(u.position),u.scale.set(M,g,g),m.scale.set(M*1.06,g*2.6,g*2.6);const v=w<.5?1:1-(w-.5)/.5;d.opacity=v,p.opacity=v})}for(let i=0;i<8;i++)Ga(t,a,o,n,e.x*(1.5+Math.random()*1.1)+(Math.random()-.5)*.9,.7+Math.random()*.7,e.z*(1.5+Math.random()*1.1)+(Math.random()-.5)*.9,.9,.3);for(let i=0;i<3;i++)ur(t,a,o,n,e.x*(1.2+Math.random()*.8)+(Math.random()-.5)*.6,.8+Math.random()*.5,e.z*(1.2+Math.random()*.8)+(Math.random()-.5)*.6,.9,.32)}},Hatch:{projectile(t){const e=P2(t.color);return e.position.copy(t.position),e},trail(t){q2(t)},impact(t){j2(t)},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position;Ts(t,6,.62,.14),Sd(t,.8,2,.4);for(let s=0;s<9;s++){const i=Math.random()*De;dh(t,a+Math.cos(i)*Te*.1,o+Te*.06,n+Math.sin(i)*Te*.1,Math.cos(i)*(.8+Math.random()*.9)+e.x*.5,Math.sin(i)*(.8+Math.random()*.9)+e.z*.5,1.1,.8)}for(let s=0;s<5;s++)Ga(t,a,o,n,e.x*(1.2+Math.random()*.9)+(Math.random()-.5)*1,.8+Math.random()*.6,e.z*(1.2+Math.random()*.9)+(Math.random()-.5)*1,.85,.3)}},Shards:{projectile(t){const e=$2(t.color);return e.position.copy(t.position),e},trail(t){G2(t)},impact(t){const e=wl(t.damage)*.9,{x:a,y:o,z:n}=t.position,s=t.direction;Ts(t,5,e*.82,.12),Td(t,5,e*.7,.6);const i=Te*.24*e,r=.7;for(let l=0;l<6;l++){const h=l/6*De+Math.random()*.8,c=(2.2+Math.random()*1.4)*e;Es(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*r,1.4+Math.random()*1,Math.sin(h)*c+s.z*r,e*1.1,.42+Math.random()*.12)}for(let l=0;l<7;l++){const h=l/7*De+Math.random()*.9,c=(2.4+Math.random()*1.7)*e;Ga(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*r,1.6+Math.random()*1.4,Math.sin(h)*c+s.z*r,(.85+Math.random()*.5)*e,.38+Math.random()*.12)}for(let l=0;l<2;l++){const h=Math.random()*De;ur(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*2*e+s.x*r,1.7+Math.random()*.9,Math.sin(h)*2*e+s.z*r,e*.85,.44)}},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position,s=(t.weapon.spreadDeg??30)*Math.PI/360;for(let i=0;i<9;i++){const r=(Math.random()*2-1)*s,l=Math.cos(r),h=Math.sin(r),c=e.x*l-e.z*h,d=e.x*h+e.z*l,p=1.6+Math.random()*1.2;Ga(t,a,o,n,c*p,.7+Math.random()*.6,d*p,.95,.32)}for(let i=0;i<3;i++){const r=(Math.random()*2-1)*s,l=Math.cos(r),h=Math.sin(r),c=e.x*l-e.z*h,d=e.x*h+e.z*l;Es(t,a,o,n,c*1.6,.5+Math.random()*.4,d*1.6,.85,.3)}}}},Aa="#E63946",Ra="#FFFDF9",Tu="#00E5B0",U2="#FFEAF1",Y2=.32,V2=.34,Ad=.36,K2=.33,fr=.46;function Hn(t){const e=document.createElement("canvas");return e.width=t,e.height=t,e.getContext("2d")}function _n(t){const e=new nt(t.canvas);return e.anisotropy=8,e.needsUpdate=!0,e}function X2(){const e=Hn(512),a=512/2,o=a,n=5,s=1.15,i=Math.PI/n*.52,r=56;e.fillStyle="#ffffff";for(let h=0;h<n;h++){const c=h/n*Math.PI*2;e.beginPath();for(let d=0;d<=r;d++){const p=d/r*o,u=c+s*Math.PI*2*(p/o)-i,m=a+Math.cos(u)*p,f=a+Math.sin(u)*p;d===0?e.moveTo(m,f):e.lineTo(m,f)}for(let d=r;d>=0;d--){const p=d/r*o,u=c+s*Math.PI*2*(p/o)+i;e.lineTo(a+Math.cos(u)*p,a+Math.sin(u)*p)}e.closePath(),e.fill()}e.globalCompositeOperation="destination-out";const l=e.createRadialGradient(a,a,o*.9,a,a,o);return l.addColorStop(0,"rgba(0,0,0,0)"),l.addColorStop(1,"rgba(0,0,0,1)"),e.fillStyle=l,e.fillRect(0,0,512,512),e.globalCompositeOperation="source-over",_n(e)}function Z2(){const e=Hn(256),a=256/2,o=e.createRadialGradient(a,a,0,a,a,a);return o.addColorStop(0,"rgba(255,255,255,0.62)"),o.addColorStop(.55,"rgba(255,255,255,0.58)"),o.addColorStop(.88,"rgba(255,255,255,0.8)"),o.addColorStop(.975,"rgba(255,255,255,1)"),o.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=o,e.fillRect(0,0,256,256),_n(e)}function J2(){const e=Hn(512),a=512/2,o=a,n=o*.74;e.fillStyle="#ffffff",e.beginPath(),e.moveTo(a+o,a),e.arc(a,a,o,0,Math.PI*2,!1),e.moveTo(a+n,a),e.arc(a,a,n,0,Math.PI*2,!0),e.fill(),e.globalCompositeOperation="destination-out";const s=40;e.fillStyle="rgba(0,0,0,0.5)";for(let l=0;l<s;l++){const h=l/s*Math.PI*2,c=h+Math.PI/s;e.beginPath(),e.moveTo(a,a),e.arc(a,a,o,h,c),e.closePath(),e.fill()}const i=e.createRadialGradient(a,a,o*.96,a,a,o);i.addColorStop(0,"rgba(0,0,0,0)"),i.addColorStop(1,"rgba(0,0,0,1)"),e.fillStyle=i,e.fillRect(0,0,512,512);const r=e.createRadialGradient(a,a,n,a,a,n*1.22);return r.addColorStop(0,"rgba(0,0,0,1)"),r.addColorStop(1,"rgba(0,0,0,0)"),e.fillStyle=r,e.fillRect(0,0,512,512),e.globalCompositeOperation="source-over",_n(e)}function Q2(){const e=Hn(512),a=512/2,o=e.createRadialGradient(a,a,0,a,a,a);return o.addColorStop(0,"rgba(255,255,255,0)"),o.addColorStop(.966,"rgba(255,255,255,0)"),o.addColorStop(.976,"rgba(255,255,255,1)"),o.addColorStop(.991,"rgba(255,255,255,1)"),o.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=o,e.fillRect(0,0,512,512),_n(e)}function ex(){const e=Hn(64),a=64/2,o=e.createRadialGradient(a,a,0,a,a,a);return o.addColorStop(0,"rgba(255,255,255,1)"),o.addColorStop(.35,"rgba(255,255,255,0.8)"),o.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=o,e.fillRect(0,0,64,64),_n(e)}const Pn=X2(),ph=Z2(),tx=J2(),uh=Q2(),bi=ex(),ut=new io(1,96);ut.rotateX(-Math.PI/2);const ax=new Me(1,1,.34,12),Su=new Me(1,1,.22,44),Au=new Me(.055,.055,1,10);function Oe(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const ox=Oe(3,()=>new Y({map:ph,color:Aa,transparent:!0,opacity:.6,depthWrite:!1})),nx=Oe(2,()=>new Y({map:Pn,color:Ra,transparent:!0,opacity:.5,depthWrite:!1})),sx=Oe(2,()=>new Y({map:Pn,color:Aa,transparent:!0,opacity:.9,depthWrite:!1})),ix=Oe(6,()=>new Y({map:Pn,color:Ra,transparent:!0,opacity:.9,depthWrite:!1})),rx=Oe(3,()=>new Y({map:tx,color:Ra,transparent:!0,opacity:1,depthWrite:!1,blending:at})),Ru=Oe(4,()=>new Y({map:uh,color:Aa,transparent:!0,opacity:1,depthWrite:!1})),lx=Oe(2,()=>new Y({map:uh,color:Ra,transparent:!0,opacity:1,depthWrite:!1})),hx=Oe(10,()=>new Y({map:Pn,color:Aa,transparent:!0,opacity:.9,depthWrite:!1})),cx=Oe(14,()=>new Y({color:Aa,transparent:!0,opacity:1})),dx=Oe(14,()=>new Y({color:Ra,transparent:!0,opacity:1})),px=Oe(24,()=>new Ut({map:bi,color:U2,transparent:!0,opacity:1,depthWrite:!1,blending:at})),ux=Oe(12,()=>new Ut({map:bi,color:Tu,transparent:!0,opacity:1,depthWrite:!1,blending:at})),fx=Oe(12,()=>new Ut({map:bi,color:Aa,transparent:!0,opacity:1,depthWrite:!1})),mx=Oe(5,()=>new Ut({map:bi,color:Tu,transparent:!0,opacity:1,depthWrite:!1})),gx=Oe(2,()=>new Y({color:Ra,transparent:!0,opacity:1})),wx=Oe(2,()=>new Y({color:"#FBF7EE",transparent:!0,opacity:1}));function Rd(t,e,a,o,n,s){const i=hx(),r=new E(ut,i);r.position.set(e,K2,a),r.rotation.y=Math.random()*Math.PI*2,r.renderOrder=12;const l=(Math.random()<.5?-1:1)*(2.4+Math.random()*1.2),h=r.rotation.y;r.scale.setScalar(o*.35),t.spawnTransient(r,n,c=>{const d=1-Math.pow(1-Math.min(1,c*3.2),3);r.scale.setScalar(o*(.35+.65*d)),r.rotation.y=h+l*c*.35,i.opacity=s*(1-Math.pow(c,1.6))})}function Id(t,e,a,o,n,s,i){const r=Math.random()<.45?cx():dx(),l=new E(ax,r);l.scale.setScalar(s),l.position.set(e.x,e.y,e.z),l.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI);const h=e.x,c=e.y,d=e.z,p=1.5+Math.random()*1.9,u=-9.4,m=(Math.random()-.5)*16,f=(Math.random()-.5)*16;t.spawnTransient(l,i,(g,w)=>{l.position.set(h+a*n*w,Math.max(.08,c+p*w+.5*u*w*w),d+o*n*w),l.rotation.x+=m*.016,l.rotation.z+=f*.016,r.opacity=1-Math.pow(g,2.2)})}function za(t,e,a,o,n,s,i,r,l=px,h=0){const c=l(),d=new Ya(c);d.position.set(e,a,o),d.scale.set(n,n,1),d.renderOrder=14,d.visible=h<=0;const p=(Math.random()-.5)*.5;t.spawnTransient(d,i+h,(u,m)=>{if(m<h){d.visible=!1;return}d.visible=!0;const f=Math.min(1,(m-h)/i),g=U.lerp(n,s,f);d.scale.set(g,g,1),d.position.y=a+r*f,d.position.x=e+p*f,c.opacity=1-Math.pow(f,1.5)})}function bx(t,e,a,o,n){const s=Q*.85,i=Q*1.7,r=new ie,l=Math.hypot(o,n)||1,h=s+Q*.5;r.position.set(e+o/l*h,0,a+n/l*h);const c=Ru(),d=new E(ut,c);d.scale.setScalar(s*1.16),d.position.y=.115,d.renderOrder=12,r.add(d);const p=gx(),u=new E(Su,p);u.scale.set(s,1,s),r.add(u);const m=sx(),f=new E(ut,m);f.scale.setScalar(s*.99),f.position.y=.13,f.renderOrder=13,r.add(f);const g=wx(),w=new E(Au,g);w.scale.set(1,i,1);const b=new pe(-o,0,-n);b.lengthSq()<1e-6&&b.set(0,0,-1),b.normalize(),w.quaternion.setFromUnitVectors(new pe(0,1,0),b),w.position.set(b.x*(s+i*.5)*.92,.05,b.z*(s+i*.5)*.92),r.add(w);const x=5.2,M=.09;t.spawnTransient(r,.75,(v,k)=>{if(k<M){const S=k/M;r.position.y=x*(1-S*S),r.scale.set(1,1,1)}else{const S=Math.min(1,(k-M)/.16);r.position.y=0;const A=1-.55*(1-S)*Math.cos(S*Math.PI*1.2);r.scale.set(1+(1-A)*.22,Math.max(.25,A),1+(1-A)*.22)}const T=v<.45?1:1-(v-.45)/.55;p.opacity=T,g.opacity=T,m.opacity=.9*T,c.opacity=T})}const Ba=Q*.85,ds=Ba+Q*.5,Fd=Q*1.7,yx="#3C0F12",xx="#EC656F",vx="#F5B0B5",kx=Oe(2,()=>new Y({map:ph,color:yx,transparent:!0,opacity:0,depthWrite:!1})),Mx=Oe(2,()=>new Y({map:ph,color:xx,transparent:!0,opacity:0,depthWrite:!1})),Ex=Oe(2,()=>new Y({map:uh,color:vx,transparent:!0,opacity:0,depthWrite:!1})),Tx=Oe(2,()=>new Y({color:Ra,transparent:!0,opacity:1,depthWrite:!1})),Sx=Oe(2,()=>new Y({map:Pn,color:Aa,transparent:!0,opacity:.95,depthWrite:!1})),Ax=Oe(2,()=>new Y({color:"#FBF7EE",transparent:!0,opacity:1,depthWrite:!1})),Rx={Smash:{cast(t){const e=t.direction.x,a=t.direction.z,o=t.position.x-e*.75,n=t.position.z-a*.75,s=Math.atan2(a,e),i=Q*1.15,r=U.degToRad((t.weapon.cone??80)/2),l=Q*.34;for(let h=0;h<2;h++){const c=h*.05,d=ix();d.color.set(h===0?Ra:Aa);const p=new E(ut,d);p.scale.setScalar(l*(1-h*.16)),p.renderOrder=13;const u=h===0?.95:.42;t.spawnTransient(p,.2,m=>{const f=U.clamp((m*.2-c)/.2,0,1),g=1-Math.pow(1-f,2),w=s-r+g*r*2;p.position.set(o+Math.cos(w)*i,U.lerp(Q*.8,.4,g),n+Math.sin(w)*i),p.rotation.y=w*1.6,d.opacity=u*(f<=0?0:1-Math.pow(m,2.4))})}for(let h=0;h<2;h++){const c=s+(Math.random()-.5)*r*1.4;za(t,o+Math.cos(c)*i*1.05,Q*.5,n+Math.sin(c)*i*1.05,Q*.13,Q*.03,.2,.25)}},impact(t){const{x:e,z:a}=t.position,o=U.clamp(.85+t.damage*.03,.85,1.6);za(t,e,t.position.y,a,Q*.3*o,Q*.6*o,.15,.1),Rd(t,e,a,Q*.32*o,.5,.85);const n=6;for(let s=0;s<n;s++){const i=s/n*Math.PI*2+Math.random()*.7;Id(t,{x:e,y:t.position.y*.8,z:a},Math.cos(i),Math.sin(i),(1.7+Math.random()*1.9)*o,Q*(.065+Math.random()*.03),.42+Math.random()*.18)}for(let s=0;s<3;s++){const i=Math.random()*Math.PI*2;za(t,e+Math.cos(i)*.3,t.position.y+.1,a+Math.sin(i)*.3,Q*.14,Q*.04,.34,.5)}}},Giant:{cast(t){const{x:e,z:a}=t.position,o=Ze(t.weapon.range??0),n=ox(),s=new E(ut,n);s.position.set(e,Y2,a),s.renderOrder=10,s.scale.setScalar(o*.12),t.spawnTransient(s,1,u=>{const m=1-Math.pow(1-Math.min(1,u/.26),3);s.scale.setScalar(o*(.12+.88*m)),n.opacity=.3*(u<.2?1:Math.pow(1-(u-.2)/.8,1.5))});for(const[u,m,f,g]of[[Ru(),1,.95,16],[lx(),.974,.9,17]]){const w=new E(ut,u);w.position.set(e,Ad+.01,a),w.renderOrder=g,w.scale.setScalar(o*.12*m),t.spawnTransient(w,1,b=>{const x=1-Math.pow(1-Math.min(1,b/.26),3);w.scale.setScalar(o*(.12+.88*x)*m),u.opacity=f*(b<.42?1:Math.pow(1-(b-.42)/.58,1.4))})}const i=nx(),r=new E(ut,i);r.position.set(e,V2,a),r.renderOrder=11,r.scale.setScalar(o*.12),t.spawnTransient(r,1,u=>{const m=1-Math.pow(1-Math.min(1,u/.26),3);r.scale.setScalar(o*(.12+.88*m)),r.rotation.y=(1-Math.pow(1-u,2))*1.5,i.opacity=.4*(u<.22?1:Math.pow(1-(u-.22)/.78,1.5))});const l=rx(),h=new E(ut,l);h.position.set(e,Ad,a),h.renderOrder=15,h.scale.setScalar(o*.05),t.spawnTransient(h,fr+.22,(u,m)=>{const f=Math.min(1,m/fr),g=1-Math.pow(1-f,2.2);h.scale.setScalar(o*(.05+.98*g)),h.rotation.y=g*.5,l.opacity=.95*(1-Math.pow(u,2.4))});const c=10,d=.55,p=Math.PI*(3-Math.sqrt(5));for(let u=0;u<c;u++){const m=o*d*Math.sqrt((u+.6)/c),f=u*p,g=e+Math.cos(f)*m,w=a+Math.sin(f)*m,b=m/o*fr;za(t,g,.55,w,Q*.2,Q*.68,.3,.55,fx,b),u%3===0&&za(t,g,.5,w,Q*.12,Q*.34,.34,.7,mx,b+.03)}bx(t,e,a,t.direction.x,t.direction.z)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1500)/1e3),o=new e.Group;o.name="teleLolliRoot";const n=t.position.clone();n.y-=Q*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=kx(),i=new e.Mesh(ut,s);i.name="teleLolliBase",i.scale.setScalar(Ba),i.position.set(0,.02,ds),i.renderOrder=5,o.add(i);const r=Mx(),l=new e.Mesh(ut,r);l.name="teleLolliFill",l.position.set(0,.032,ds),l.renderOrder=5.01,o.add(l);const h=Ex(),c=new e.Mesh(ut,h);c.name="teleLolliRim",c.scale.setScalar(Ba*1.06),c.position.set(0,.044,ds),c.renderOrder=5.02,o.add(c);const d=new e.Group;d.name="teleLolliCandy",o.add(d);const p=Tx(),u=new e.Mesh(Su,p);u.name="teleLolliHead",u.scale.set(Ba,1,Ba),d.add(u);const m=Sx(),f=new e.Mesh(ut,m);f.name="teleLolliSwirl",f.scale.setScalar(Ba*.99),f.position.y=.13,f.renderOrder=13,d.add(f);const g=Ax(),w=new e.Mesh(Au,g);w.name="teleLolliStick",w.scale.set(1,Fd,1),w.rotation.x=-Math.PI/2,w.position.z=-3.57*.92,d.add(w);const b=(M,y,v)=>{const k=e.MathUtils.clamp((M-y)/(v-y),0,1);return k*k*(3-2*k)},x=(M,y)=>{const v=e.MathUtils.clamp(y/a,0,1),k=b(v,0,.78),T=b(v,.78,1),S=.5+.5*Math.sin(Math.PI*2*(2*v+3*v*v));s.opacity=.6+.14*S;const A=Ba*(.12+.88*v);l.scale.setScalar(A),r.opacity=.7+.22*v,h.opacity=.62+.36*v*v;const C=.28+.72*k;d.scale.setScalar(C),d.position.set(0,Q*(.55+1.05*k+.55*T),ds*(.35+.65*k)-Fd*.1*T),d.rotation.y=v*(2.2+5.5*v),d.rotation.x=-.55*T;const R=.85+.15*S;p.opacity=R,g.opacity=R,m.opacity=.95*R};x(0,0),t.spawnTransient(o,a+.06,x)},impact(t){const{x:e,z:a}=t.position,o=U.clamp(.9+t.damage*.035,.9,1.7);za(t,e,t.position.y,a,Q*.34*o,Q*.62*o,.18,.12),Rd(t,e,a,Q*.42*o,.62,.9);const n=8;for(let s=0;s<n;s++){const i=s/n*Math.PI*2+Math.random()*.6;Id(t,{x:e,y:t.position.y*.85,z:a},Math.cos(i),Math.sin(i),(2.1+Math.random()*2.2)*o,Q*(.07+Math.random()*.035),.48+Math.random()*.2)}for(let s=0;s<4;s++){const i=s/4*Math.PI*2+Math.random();za(t,e+Math.cos(i)*.34,t.position.y+.15,a+Math.sin(i)*.34,Q*.11,Q*.04,.42,.85,ux)}}}},Ix="#EFB868",Fx="#CE8A2E",Iu="#4A2A12",Cx="#B93A28",bn="#F7ECD3",xe=Q,ht=Math.PI*2,yi=.26;function ho(t,e=10){const a=new Nl(t,e);return a.rotateX(-Math.PI/2),a}function fh(t,e){const a=Math.tan(e)*t,o=-t*.58,n=t*.42,s=new Sa;return s.moveTo(0,o),s.lineTo(-a,n),s.quadraticCurveTo(0,n+a*.5,a,n),s.closePath(),s}function Ox(t){const e=new Sa;return e.moveTo(0,t),e.quadraticCurveTo(t*.82,t*.78,t*.96,-t*.06),e.quadraticCurveTo(t*.7,-t*.72,0,-t),e.quadraticCurveTo(-t*.84,-t*.66,-t,t*.04),e.quadraticCurveTo(-t*.7,t*.8,0,t),e}function Fu(t,e,a=22){const o=new Sa;for(let n=0;n<=a;n++){const s=n/a*ht,i=1+Math.sin(s*3+t)*.17+Math.sin(s*5+e)*.11,r=Math.cos(s)*i,l=Math.sin(s)*i;n===0?o.moveTo(r,l):o.lineTo(r,l)}return o}function Nx(t){const e=new Sa;return e.moveTo(-t,0),e.lineTo(t,0),e.lineTo(0,1),e.closePath(),e}const Io=xe*.3,yn=xe*.16,Ss=xe*.18,Cd=ho(fh(Io,.44),8),As=ho(Ox(Ss),8),mh=(()=>{const t=new io(1,12);return t.rotateX(-Math.PI/2),t})(),Od=(()=>{const t=new io(yn,20);t.rotateX(-Math.PI/2);const e=t.attributes.position;for(let a=1;a<e.count;a++){const o=e.getX(a),n=e.getZ(a),s=Math.atan2(n,o),i=1+Math.sin(s*3)*.13+Math.sin(s*7+1.3)*.075;e.setX(a,o*i),e.setZ(a,n*i)}return e.needsUpdate=!0,t})(),Nd=ho(fh(xe*.105,.52),4),Cu=ho(fh(1,.62),3),Ou=ho(Fu(0,2.1),1),Lx=ho(Fu(1.7,4.3),1),Dx=ho(Nx(.16),1),Nu=(()=>{const t=new xa(.62,1,18,1,0,Math.PI*.8);return t.rotateX(-Math.PI/2),t})(),zx=(()=>{const t=new io(xe*.032,6);return t.rotateX(-Math.PI/2),t})(),Hx=(()=>{const t=new Rt(xe*.022,1,xe*.022);return t.translate(0,-.5,0),t})();function co(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Ia=t=>new Y({color:t,side:be}),Ld=Ia("#F6E3B4"),Dd=Ia("#E63946"),zd=Ia("#FFD873"),_x=Ia(Ix),Lu=Ia(Fx),Px=Ia(Cx),$x=Ia(bn),qx=Ia(Iu),Bx=co(20,()=>new Y({color:"#E63946",transparent:!0,opacity:1,side:be,depthWrite:!1})),Du=co(24,()=>new Y({color:Iu,transparent:!0,opacity:1,side:be,depthWrite:!1})),zu=co(10,()=>new Y({color:"#B62430",transparent:!0,opacity:.9,side:be,depthWrite:!1})),jx=co(28,()=>new Y({color:bn,transparent:!0,opacity:.9,side:be,depthWrite:!1})),Hu=co(8,()=>new Y({color:"#FFE9A8",transparent:!0,opacity:.9,side:be,blending:at,depthWrite:!1})),_u=co(16,()=>new Y({color:"#FFD9A0",transparent:!0,opacity:.5,side:be,blending:at,depthWrite:!1})),mr=co(12,()=>new Y({color:"#FFD873",transparent:!0,opacity:.95,side:be,depthWrite:!1})),Gx=new pe(0,1,0),Hd=new pe,_d=new pe,gr=new ai,Pd=new ai;function vo(t,e,a,o){gr.setFromAxisAngle(Gx,a);const n=Math.hypot(e.x,e.z);Math.abs(o)>1e-4&&n>1e-4?(Hd.set(e.z/n,0,-e.x/n),Pd.setFromAxisAngle(Hd,o),t.quaternion.copy(Pd).multiply(gr)):t.quaternion.copy(gr)}function gh(t,e,a){const o=new ie,n=new E(t,qx);return n.scale.set(a,1,a),n.position.y=-xe*.011,o.add(n),o.add(new E(t,e)),o}function Wx(t){return t.range&&t.speed?t.range/t.speed:so.normal/1e3}function wr(t,e,a){let o=t.userData.__spin;return o||(o={spin:Math.random()*ht,rate:a*ht/Wx(e),shed:0},t.userData.__spin=o),o}function $d(t,e,a,o){const n=_u();n.color.set(o),n.opacity=.45;const s=new E(Nu,n);s.renderOrder=9,s.position.copy(t.position),s.rotation.y=a,s.scale.set(e,1,e),t.spawnTransient(s,.13,i=>{const r=e*(1+i*.28);s.scale.set(r,1,r),n.opacity=.45*(1-i)})}function fa(t,e,a,o,n,s,i,r,l){const h=jx();h.color.set(a),h.opacity=.9;const c=new E(zx,h);c.renderOrder=9,c.position.copy(e),c.scale.setScalar(r);const d=e.x,p=e.y,u=e.z;t.spawnTransient(c,l,(m,f)=>{c.position.set(d+o*f,Math.max(yi,p+n*f+.5*i*f*f),u+s*f),h.opacity=.9*(1-m*m)})}function br(t,e,a,o,n,s,i){const r=new ie,l=Du();l.opacity=1;const h=new E(Nd,l);h.scale.set(1.22,1,1.22),h.position.y=-xe*.008,r.add(h);const c=Bx();c.color.set(a),c.opacity=1,r.add(new E(Nd,c)),r.renderOrder=9,r.position.copy(e),r.scale.setScalar(s);const d=e.x,p=e.y,u=e.z,m=Math.cos(o),f=Math.sin(o),g=m*n,w=f*n,b=.8+Math.random()*.9,x=-7.5,M=Math.random()*ht,y=(Math.random()-.5)*24;t.spawnTransient(r,i,(v,k)=>{r.position.set(d+g*k,Math.max(yi,p+b*k+.5*x*k*k),u+w*k),_d.set(m,0,f),vo(r,_d,M+y*k,.22);const T=1-Math.pow(v,2.2);c.opacity=T,l.opacity=T})}function Ux(t,e,a,o,n,s){const i=new ie;i.position.set(t.position.x,yi,t.position.z),i.renderOrder=4;const r=zu();r.color.set(e),r.opacity=s;const l=new E(Math.random()<.5?Ou:Lx,r);l.rotation.y=Math.random()*ht,i.add(l);for(let h=0;h<o;h++){const c=new E(Dx,r);c.rotation.y=h/o*ht+Math.random()*.7,c.scale.set(.7+Math.random()*.4,1,1+Math.random()*.4),i.add(c)}t.spawnTransient(i,n,h=>{const c=1-Math.pow(1-Math.min(1,h*5),3);i.scale.set(a*c,1,a*c),r.opacity=s*(h<.55?1:1-(h-.55)/.45)})}function yr(t,e,a,o){const n=Hu();n.color.set(e),n.opacity=.9;const s=new E(Cu,n);s.renderOrder=11,s.position.copy(t.position),s.rotation.y=Math.random()*ht,s.scale.set(a*.35,1,a*.35),t.spawnTransient(s,o,i=>{const r=U.lerp(a*.35,a,1-Math.pow(1-i,2));s.scale.set(r,1,r),n.opacity=.9*(1-i)})}function xr(t){return U.clamp(.85+t*.035,.85,1.4)}function Yx(t){const e=gh(Cd,_x,1.15);Dd.color.set(t);const a=new E(Cd,Dd);a.scale.set(.86,1,.86),a.position.set(0,xe*.006,Io*.04),e.add(a);for(const[o,n,s]of[[-.2,-.1,.075],[.15,.11,.06]]){const i=new E(mh,Px);i.position.set(Io*o,xe*.012,Io*n),i.scale.setScalar(Io*s*2),e.add(i)}return e}function Vx(t){const e=gh(Od,Lu,1.13);Ld.color.set(t);const a=new E(Od,Ld);a.scale.set(.84,1,.84),a.position.y=xe*.006,e.add(a);const o=new E(mh,$x);return o.scale.setScalar(yn*.44),o.position.set(yn*.4,xe*.011,-yn*.26),e.add(o),e}function Kx(t){zd.color.set(t);const e=gh(As,zd,1.12),a=new E(mh,Lu);return a.scale.setScalar(Ss*.22),a.position.set(Ss*.34,xe*.006,Ss*.2),e.add(a),e}const Xx={Dough:{projectile(t){const e=Vx(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=wr(e,t.weapon,2.6);o.spin+=o.rate*a,vo(e,t.direction,o.spin,.15+Math.sin(o.spin*.37)*.07),e.position.y+=Math.sin(o.spin*.5)*xe*.012,o.shed-=a,o.shed<=0&&(o.shed=.055+Math.random()*.04,fa(t,t.position,bn,-t.direction.x*.5+(Math.random()-.5)*.5,.25+Math.random()*.4,-t.direction.z*.5+(Math.random()-.5)*.5,-1.1,.5+Math.random()*.35,.3+Math.random()*.15),Math.random()<.45&&$d(t,yn*1.2,o.spin,"#FFF0CC"))},impact(t){const e=xr(t.damage),a=zu();a.color.set("#F0DDAE"),a.opacity=.95;const o=new E(Ou,a);o.renderOrder=4,o.position.set(t.position.x,yi,t.position.z),o.rotation.y=Math.random()*ht;const n=xe*.25*e;t.spawnTransient(o,.62,s=>{const i=U.lerp(n*.3,n,1-Math.pow(1-Math.min(1,s*4),3));o.scale.set(i,1,i),a.opacity=.95*(s<.5?1:1-(s-.5)/.5)}),yr(t,"#FFF3D2",xe*.3*e,.18);for(let s=0;s<10;s++){const i=s/10*ht+Math.random()*.5,r=(.9+Math.random()*1.2)*e;fa(t,t.position,bn,Math.cos(i)*r,.7+Math.random()*.9,Math.sin(i)*r,-2.4,.6+Math.random()*.6,.45+Math.random()*.25)}for(let s=0;s<4;s++)br(t,t.position,"#EFD9A6",Math.random()*ht,(1.9+Math.random()*1.3)*e,(.55+Math.random()*.35)*e,.4+Math.random()*.14)},cast(t){const e=_u();e.color.set("#FFF0CC"),e.opacity=.6;const a=new E(Nu,e);a.renderOrder=11,a.position.copy(t.position),t.spawnTransient(a,.16,o=>{const n=U.lerp(xe*.05,xe*.16,o);a.scale.set(n,1,n),a.rotation.y=o*9,e.opacity=.6*(1-o)});for(let o=0;o<5;o++)fa(t,t.position,bn,t.direction.x*(.5+Math.random()*.6)+(Math.random()-.5)*.6,.5+Math.random()*.5,t.direction.z*(.5+Math.random()*.6)+(Math.random()-.5)*.6,-1.6,.55+Math.random()*.4,.3+Math.random()*.15)}},Tomato:{projectile(t){const e=Yx(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=wr(e,t.weapon,1.8);o.spin+=o.rate*a,vo(e,t.direction,o.spin,.17+Math.sin(o.spin*.5)*.06),o.shed-=a,o.shed<=0&&(o.shed=.058,$d(t,Io*.62,o.spin,"#FFC08A"),Math.random()<.5&&fa(t,t.position,"#C4262F",-t.direction.x*.7+(Math.random()-.5)*.4,.15+Math.random()*.3,-t.direction.z*.7+(Math.random()-.5)*.4,-2.2,.5+Math.random()*.3,.26))},impact(t){const e=xr(t.damage);yr(t,"#FFE7CC",xe*.4*e,.18),Ux(t,t.color,xe*.22*e,4,.55,.9);for(let a=0;a<5;a++){const o=a/5*ht+Math.random()*.6;br(t,t.position,t.color,o,(2.2+Math.random()*1.4)*e,(.75+Math.random()*.45)*e,.4+Math.random()*.14)}for(let a=0;a<6;a++){const o=Math.random()*ht,n=(1.3+Math.random()*1.5)*e;fa(t,t.position,"#C4262F",Math.cos(o)*n,1+Math.random()*1.1,Math.sin(o)*n,-6.5,.7+Math.random()*.5,.34+Math.random()*.14)}},cast(t){const e=Hu();e.color.set("#FF8E6A"),e.opacity=.85;const a=new E(Cu,e);a.renderOrder=11,a.position.copy(t.position),a.rotation.y=Math.atan2(t.direction.x,t.direction.z),t.spawnTransient(a,.15,o=>{const n=U.lerp(xe*.08,xe*.24,1-Math.pow(1-o,2));a.scale.set(n*.7,1,n),e.opacity=.85*(1-o)});for(let o=0;o<3;o++)fa(t,t.position,"#C4262F",t.direction.x*(1+Math.random())+(Math.random()-.5)*.5,.4+Math.random()*.4,t.direction.z*(1+Math.random())+(Math.random()-.5)*.5,-2.6,.6,.28)}},Cheese:{projectile(t){const e=Kx(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=wr(e,t.weapon,.9);o.spin+=o.rate*a,vo(e,t.direction,o.spin,.2*Math.sin(o.spin*1.9));const n=1+Math.sin(o.spin*2.4)*.22;e.scale.set(1/n,1,n),e.position.y+=Math.sin(o.spin*1.2)*xe*.016,o.shed-=a,o.shed<=0&&(o.shed=.13+Math.random()*.07,fa(t,t.position,"#FFE49A",-t.direction.x*.4,-.1,-t.direction.z*.4,-1.6,.5,.24))},impact(t){const e=xr(t.damage),a=xe*.96,o=mr();o.color.set(t.color),o.opacity=.95;const n=new E(As,o);n.renderOrder=11;const s=Du();s.opacity=.6;const i=new E(As,s);i.scale.set(1.12,1,1.12),i.position.y=-xe*.008,n.add(i),n.position.set(t.position.x,a,t.position.z);const r=1.8*e;t.spawnTransient(n,.5,l=>{const h=U.lerp(r*.4,r,1-Math.pow(1-Math.min(1,l*3.5),3));n.scale.set(h,1,h*(1-l*.25)),n.position.y=a-l*l*xe*.34,vo(n,t.direction,l*1.2,.35+l*.5);const c=l<.6?1:1-(l-.6)/.4;o.opacity=.95*c,s.opacity=.6*c}),yr(t,"#FFF6D8",xe*.26*e,.17);for(let l=0;l<4;l++){const h=mr();h.color.set("#FFE08A"),h.opacity=.9;const c=new E(Hx,h);c.renderOrder=10;const d=Math.random()*ht,p=xe*(.06+Math.random()*.08)*e;c.position.set(t.position.x+Math.cos(d)*p,a-xe*.04,t.position.z+Math.sin(d)*p);const u=xe*(.14+Math.random()*.12)*e;t.spawnTransient(c,.42,m=>{c.scale.set(1-m*.55,u*(.3+m*.7),1-m*.55),h.opacity=.9*(1-m*m)})}for(let l=0;l<3;l++)br(t,t.position,"#FFD873",Math.random()*ht,(1+Math.random())*e,(.55+Math.random()*.3)*e,.38)},cast(t){const e=mr();e.color.set(t.color),e.opacity=.85;const a=new E(As,e);a.renderOrder=11,a.position.copy(t.position),t.spawnTransient(a,.16,o=>{const n=U.lerp(.3,.85,1-Math.pow(1-o,2));a.scale.set(n*(.5+o*.6),1,n),vo(a,t.direction,o*2.4,.3-o*.25),e.opacity=.85*(1-o)});for(let o=0;o<3;o++)fa(t,t.position,"#FFE49A",t.direction.x*(.6+Math.random()*.5),.35+Math.random()*.3,t.direction.z*(.6+Math.random()*.5),-2,.55,.26)}}},qo="#FFFDF6",Pu="#E4D7BE",ka="#22301F",Zx="#3E5B33",wh=Gt.salmon,bh="#B85B26",$u="#FFEEDD",qu="#F2FBFF",Bu="#8FD3E8",Z=Q,bt=Math.PI*2,Ct=.29;function ju(t,e=8){const a=new Nl(t,e);return a.rotateX(-Math.PI/2),a}const Nt=(()=>{const t=new Qa(1,1);return t.rotateX(-Math.PI/2),t})(),qd=(()=>{const t=new Sa;t.moveTo(0,0),t.quadraticCurveTo(1,.5,0,1),t.quadraticCurveTo(-1,.5,0,0);const e=ju(t,10);return e.translate(0,0,1),e})(),Bd=(()=>{const e=new Sa;return e.moveTo(-.5+.22,-.5),e.lineTo(.5-.22,-.5),e.quadraticCurveTo(.5,-.5,.5,-.5+.22),e.lineTo(.5,.5-.22),e.quadraticCurveTo(.5,.5,.5-.22,.5),e.lineTo(-.5+.22,.5),e.quadraticCurveTo(-.5,.5,-.5,.5-.22),e.lineTo(-.5,-.5+.22),e.quadraticCurveTo(-.5,-.5,-.5+.22,-.5),ju(e,6)})(),yh=(()=>{const t=new st(.5,7,5);return t.scale(.44,.44,1),t})(),Jx=new Me(.5,.5,1,20,1,!0),vr=(()=>{const t=new io(.5,20);return t.rotateX(-Math.PI/2),t})(),Qx=new Me(.5,.5,1,12,1,!0,0,Math.PI),jd=(()=>{const t=new io(.5,12,-Math.PI/2,Math.PI);return t.rotateX(-Math.PI/2),t})(),ev=(()=>{const t=new Qa(1,1);return t.rotateY(-Math.PI/2),t})(),ft=Z*.155,Gu=Z*.46,Rs=Z*.3,Pt=Z*.185,ps=Z*.2;function Ht(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const $n=t=>new Y({color:t,side:be}),Wu=$n(qo),tv=$n(Pu),Uu=$n(ka),av=$n(bh),Gd=new Map;function xh(t){let e=Gd.get(t);return e||(e=$n(t),Gd.set(t,e)),e}const Fa=(t,e)=>new Y({color:t,transparent:!0,opacity:e,side:be,depthWrite:!1}),Yu=(t,e)=>new Y({color:t,transparent:!0,opacity:e,side:be,depthWrite:!1,depthTest:!1}),Vu=Ht(56,()=>new Y({color:qo,transparent:!0,opacity:1,depthWrite:!1})),ov=Ht(12,()=>Yu(qu,1)),nv=Ht(12,()=>Yu(Bu,.5)),Gs=Ht(28,()=>Fa(ka,1)),Ws=Ht(28,()=>Fa(Zx,1)),sv=Ht(24,()=>Fa(wh,1)),iv=Ht(24,()=>Fa(bh,1)),rv=Ht(24,()=>Fa($u,1)),lv=Ht(12,()=>Fa(ka,1)),hv=Ht(12,()=>Fa(qo,1)),cv=Ht(12,()=>Fa(wh,1));function $t(t,e){return Math.atan2(t,e)}function dv(t,e=.62){const a=Math.sin(t),o=Math.cos(t);if(Math.abs(a)>=e)return t;const n=a>=0?1:-1,s=o>=0?1:-1;return Math.atan2(n*e,s*Math.sqrt(1-e*e))}function kr(t){return t.range&&t.speed?t.range/t.speed:so.normal/1e3}function us(t){return U.clamp(.85+t*.035,.85,1.4)}function Mr(t){let e=t.userData.__sushi;return e||(e={phase:Math.random()*bt,shed:0,grow:0},t.userData.__sushi=e),e}function fs(t,e,a,o,n,s,i,r){const l=new ie,h=dv(n);l.rotation.y=h,l.position.set(e-Math.sin(h)*s*.5,a,o-Math.cos(h)*s*.5),l.renderOrder=13;const c=nv();c.color.set(Bu),c.opacity=.55;const d=new E(qd,c);d.scale.set(2.9,1,1.02),d.position.y=-Z*.006,d.renderOrder=0,l.add(d);const p=ov();p.color.set(qu),p.opacity=1;const u=new E(qd,p);u.renderOrder=1,l.add(u),t.spawnTransient(l,r,m=>{const f=Math.min(1,m*8);l.scale.set(i*(1-m*.55),1,Math.max(.02,s*f));const g=m<.3?1:1-(m-.3)/.7;p.opacity=g,c.opacity=.55*g*g})}function Ha(t,e,a,o,n,s,i,r,l,h=!1){const c=Vu();c.color.set(h?Pu:qo),c.opacity=1;const d=new E(yh,c);d.renderOrder=9,d.scale.setScalar(r),d.position.set(e,a,o);const p=-9.6,u=(Math.random()-.5)*14,m=(Math.random()-.5)*14;t.spawnTransient(d,l,(f,g)=>{let w=a+s*g+.5*p*g*g,b=1;if(w<Ct){const x=Ct-w;w=Ct+x*.28,b=.35,w<Ct&&(w=Ct)}d.position.set(e+n*g,w,o+i*g*1),d.rotation.set(u*g*b,m*g*b,0),c.opacity=1-f*f*f})}function pv(t,e,a){const o=new ie,n=new E(Bd,a.deep);n.scale.set(t*1.16,1,e*1.1),n.position.y=-Z*.008,o.add(n);const s=new E(Bd,a.face);s.scale.set(t,1,e),o.add(s);for(let i=0;i<2;i++){const r=new E(Nt,a.fat);r.scale.set(t*.86,1,e*.09),r.position.set(0,Z*.005,e*(i===0?-.18:.16)),o.add(r)}return o}function Wd(t,e,a){const o=new ie,n=new E(Qx,a.wall);n.scale.set(t*2,e,t*2),o.add(n);const s=new E(jd,a.face);s.scale.set(t*1.6,1,t*1.6),s.position.y=e*.5,o.add(s);const i=new E(jd,a.core);i.scale.set(t*.94,1,t*.94),i.position.y=e*.5+Z*.004,o.add(i);const r=new E(ev,a.face);return r.scale.set(1,e*.98,t*1.96),o.add(r),o}function uv(t){const e=new ie,a=t==="#FFFFFF"?Wu:xh(t),o=[[0,0,ft*.34,1],[-ft*.4,Z*.012,-ft*.3,.85],[ft*.38,-Z*.014,-ft*.42,.78]];for(let n=0;n<o.length;n++){const[s,i,r,l]=o[n],h=new E(yh,n===1?tv:a);h.scale.setScalar(ft*l),h.position.set(s,i,r),h.rotation.set(0,(n-1)*.5,0),e.add(h)}return e}function Ud(t){const e=new ie,a=[],o=4,n=Gu/o,s=xh(t);for(let r=0;r<o;r++){const l=new ie,h=new E(Nt,Uu);h.scale.set(Rs,1,n*1.02),l.add(h);for(const c of[-1,1]){const d=new E(Nt,s);d.scale.set(Rs*.1,1,n*1.02),d.position.set(c*Rs*.45,Z*.004,0),l.add(d)}l.position.z=(r-(o-1)/2)*n,e.add(l),a.push(l)}const i={segs:a};return e.userData.__parts=i,e}function Yd(t){const e=new ie,a=new E(Jx,Uu);a.scale.set(Pt*2,ps,Pt*2),e.add(a);const o=new E(vr,Wu);o.scale.set(Pt*1.6,1,Pt*1.6),o.position.y=ps*.5,e.add(o);const n=new E(vr,xh(t));n.scale.set(Pt*.94,1,Pt*.94),n.position.y=ps*.5+Z*.004,e.add(n);const s=new E(vr,av);return s.scale.set(Pt*.34,1,Pt*.34),s.position.set(Pt*.46,ps*.5+Z*.005,-Pt*.3),e.add(s),e}const fv=1.9;function Vd(t,e){let a=0;t.traverse(o=>{o.isMesh&&!o.name&&(o.name=`${e}Part${a++}`)})}const mv={Rice:{projectile(t){const e=uv(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Mr(e);o.phase+=a/kr(t.weapon)*bt*1.6,e.rotation.y=$t(t.direction.x,t.direction.z)+Math.sin(o.phase)*.3;const n=1+Math.sin(o.phase*1.9)*.14;e.scale.set(n,1,1/n);for(let s=0;s<e.children.length;s++)e.children[s].rotation.x=o.phase*(.6+s*.35);o.shed-=a,o.shed<=0&&(o.shed=.1+Math.random()*.06,Ha(t,t.position.x,t.position.y,t.position.z,-t.direction.x*.5+(Math.random()-.5)*.7,-.15,-t.direction.z*.5+(Math.random()-.5)*.7,ft*.75,.3+Math.random()*.12,Math.random()<.4))},impact(t){const e=us(t.damage),{x:a,y:o,z:n}=t.position,s=t.direction,i=Z*.26*e;for(let c=0;c<7;c++){const d=c/7*bt+Math.random()*.7,p=(1.9+Math.random()*1.5)*e;Ha(t,a+Math.cos(d)*i,o,n+Math.sin(d)*i,Math.cos(d)*p+s.x*.7,1.5+Math.random()*1.2,Math.sin(d)*p+s.z*.7,ft*(.9+Math.random()*.5)*e,.44+Math.random()*.16,Math.random()<.35)}const r=Math.hypot(s.x,s.z)>1e-4?Z*.34:0,l=Vu();l.color.set(qo),l.opacity=1;const h=new E(yh,l);h.renderOrder=12,h.position.set(a-s.x*r,o,n-s.z*r),h.rotation.y=$t(s.x,s.z)+Math.PI*.5,t.spawnTransient(h,.14,c=>{h.scale.setScalar(U.lerp(Z*.12,Z*.3,c)*e),l.opacity=1-c})},cast(t){const e=t.direction;for(let a=0;a<6;a++)Ha(t,t.position.x,t.position.y,t.position.z,e.x*(1.5+Math.random()*1.2)+(Math.random()-.5)*1.1,.5+Math.random()*.5,e.z*(1.5+Math.random()*1.2)+(Math.random()-.5)*1.1,ft*(.7+Math.random()*.4),.3+Math.random()*.12,Math.random()<.4)}},Seaweed:{projectile(t){const e=Ud(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Mr(e);o.phase+=a/kr(t.weapon)*bt*2.8,e.rotation.y=$t(t.direction.x,t.direction.z);const n=e.userData.__parts;if(n)for(let s=0;s<n.segs.length;s++){const i=o.phase-s*1.1;n.segs[s].rotation.x=Math.sin(i)*.42,n.segs[s].position.y=Math.sin(i)*Z*.03}o.shed-=a,o.shed<=0&&(o.shed=.14+Math.random()*.08,Er(t,t.position.x,t.position.y,t.position.z,-t.direction.x*.5+(Math.random()-.5)*.6,-.05,-t.direction.z*.5+(Math.random()-.5)*.6,Z*.075,.28,t.color))},impact(t){const e=us(t.damage),a=t.direction,o=$t(a.x,a.z),{x:n,y:s,z:i}=t.position,r=new ie;r.rotation.y=o,r.position.set(n+a.x*Z*.42,Ct,i+a.z*Z*.42),r.renderOrder=5;const l=Ws();l.color.set(t.color),l.opacity=.95;const h=new E(Nt,l);h.scale.set(1.1,1,1.07),h.position.y=-.004,r.add(h);const c=Gs();c.color.set(ka),c.opacity=.95,r.add(new E(Nt,c));const d=Z*.42*e,p=Z*.72*e;t.spawnTransient(r,.85,m=>{const f=1-Math.pow(1-Math.min(1,m*8),3);r.scale.set(d,1,Math.max(.02,p*f));const g=m<.55?1:1-(m-.55)/.45;c.opacity=.95*g,l.opacity=.95*g});const u=Z*.28*e;for(let m=0;m<4;m++){const f=m/4*bt+Math.random()*.8,g=(1.7+Math.random()*1.2)*e;gv(t,n+Math.cos(f)*u,s,i+Math.sin(f)*u,Math.cos(f)*g,1.3+Math.random()*1.1,Math.sin(f)*g,Z*(.34+Math.random()*.16)*e,.42+Math.random()*.14,t.color)}for(let m=0;m<5;m++){const f=Math.random()*bt;Er(t,n+Math.cos(f)*u*.8,s,i+Math.sin(f)*u*.8,Math.cos(f)*(1.6+Math.random()*1.4),1.2+Math.random(),Math.sin(f)*(1.6+Math.random()*1.4),Z*.085*e,.36,t.color)}},cast(t){const e=t.direction,a=$t(e.x,e.z),o=new ie;o.rotation.y=a,o.position.copy(t.position),o.renderOrder=11;const n=Ws();n.color.set(t.color),n.opacity=1;const s=new E(Nt,n);s.scale.set(1.12,1,1.08),s.position.y=-Z*.006,o.add(s);const i=Gs();i.color.set(ka),i.opacity=1,o.add(new E(Nt,i)),t.spawnTransient(o,.18,r=>{const l=1-Math.pow(1-r,2);o.scale.set(Rs*(.5+l*.6),1,Gu*(.25+l*.8)),o.position.set(t.position.x+e.x*l*Z*.16,t.position.y,t.position.z+e.z*l*Z*.16),i.opacity=1-r,n.opacity=1-r});for(let r=0;r<3;r++)Er(t,t.position.x,t.position.y,t.position.z,e.x*(1+Math.random())+(Math.random()-.5)*.7,.4+Math.random()*.4,e.z*(1+Math.random())+(Math.random()-.5)*.7,Z*.08,.28,t.color)}},Fish:{impact(t){const e=us(t.damage),a=t.direction,{x:o,y:n,z:s}=t.position,i=$t(a.x,a.z);fs(t,o,n,s,i+Math.PI*.5,Z*.95*e,Z*.078,.28);const r=Z*.3*e;for(let l=0;l<5;l++){const h=l/5*bt+Math.random()*.5;Tr(t,o+Math.cos(h)*r,n,s+Math.sin(h)*r,h,(1.5+Math.random()*1)*e,Z*.16*e,Z*.3*e,.5+Math.random()*.16)}for(let l=0;l<8;l++){const h=Math.random()*bt,c=(1.7+Math.random()*1.4)*e;Ha(t,o+Math.cos(h)*r*.85,n,s+Math.sin(h)*r*.85,Math.cos(h)*c,1.4+Math.random()*1.2,Math.sin(h)*c,ft*(.85+Math.random()*.4)*e,.42+Math.random()*.14,Math.random()<.35)}},cast(t){const e=t.direction,a=$t(e.x,e.z);fs(t,t.position.x,t.position.y,t.position.z,a+Math.PI*.42,Z*.5,Z*.062,.17);const o=(t.weapon.cone??150)*Math.PI/180;for(let n=0;n<3;n++){const s=(n-1)*o*.3,i=a+s;Tr(t,t.position.x,t.position.y,t.position.z,Math.atan2(Math.sin(i),Math.cos(i))-Math.PI*.5,1.5+Math.random()*.7,Z*.12,Z*.22,.34)}}},Catch:{projectile(t){const e=Yd(t.color);return e.position.copy(t.position),e.scale.setScalar(.6),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Mr(e),n=kr(t.weapon);o.phase+=a/n*bt*1.1,o.grow=Math.min(1,o.grow+a/n),e.rotation.y=o.phase;const s=U.lerp(.6,1.28,1-Math.pow(1-o.grow,2));e.scale.setScalar(s),e.position.y+=Math.sin(o.phase*1.6)*Z*.02,o.shed-=a,o.shed<=0&&(o.shed=.1+Math.random()*.06,Ha(t,t.position.x,t.position.y,t.position.z,-t.direction.x*.6+(Math.random()-.5)*.8,.1,-t.direction.z*.6+(Math.random()-.5)*.8,ft*.8,.32,Math.random()<.4))},impact(t){const e=us(t.damage),a=t.direction,{x:o,y:n,z:s}=t.position,r=$t(a.x,a.z)+Math.PI*.5;fs(t,o,n,s,r,Z*1.12*e,Z*.085,.32);const l=Z*.25*e,h=Z*.26*e,c=new ie;c.rotation.y=r,c.position.set(o,n-Z*.05,s),c.renderOrder=10;const d=lv();d.color.set(ka),d.opacity=1;const p=hv();p.color.set(qo),p.opacity=1;const u=cv();u.color.set(t.color),u.opacity=1;const m={wall:d,face:p,core:u},f=Wd(l,h,m),g=Wd(l,h,m);g.rotation.y=Math.PI,c.add(f,g);const w=Z*.185*e,b=Z*.4*e,x=n-Z*.05-(Ct+l*.6);t.spawnTransient(c,.55,y=>{const v=1-Math.pow(1-y,2),k=U.lerp(w,b,v);f.position.x=k,g.position.x=-k,f.rotation.z=-v*.9,g.rotation.z=v*.9,c.position.y=n-Z*.05-x*v*v;const T=y<.6?1:1-(y-.6)/.4;d.opacity=T,p.opacity=T,u.opacity=T});const M=Z*.3*e;for(let y=0;y<9;y++){const v=y/9*bt+Math.random()*.6,k=(1.9+Math.random()*1.5)*e;Ha(t,o+Math.cos(v)*M,n,s+Math.sin(v)*M,Math.cos(v)*k,1.6+Math.random()*1.3,Math.sin(v)*k,ft*(.9+Math.random()*.5)*e,.46+Math.random()*.16,Math.random()<.35)}for(let y=0;y<2;y++){const v=r+(y===0?.6:-.6)+Math.PI*(y===0?0:1);Tr(t,o+Math.cos(v)*M,n,s+Math.sin(v)*M,v,(1.6+Math.random()*.9)*e,Z*.14*e,Z*.26*e,.48)}},cast(t){const e=t.direction,a=$t(e.x,e.z);fs(t,t.position.x,t.position.y,t.position.z,a+Math.PI*.38,Z*.58,Z*.068,.18);for(let o=0;o<5;o++)Ha(t,t.position.x,t.position.y,t.position.z,e.x*(1.3+Math.random())+(Math.random()-.5)*.9,.5+Math.random()*.4,e.z*(1.3+Math.random())+(Math.random()-.5)*.9,ft*.8,.3,Math.random()<.4)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=new e.Group;o.name="teleSushiRoot";const n=t.position.clone();n.y-=Z*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=Ud(t.color);s.name="teleSushiNori",Vd(s,"teleSushiNori"),o.add(s);const i=Math.max(1,t.weapon.pellets??3),r=[];for(let p=0;p<i;p++){const u=Yd(t.color);u.name=`teleSushiRoll${p}`,Vd(u,`teleSushiRoll${p}`),r.push(u),o.add(u)}const l=(p,u,m)=>{const f=e.MathUtils.clamp((p-u)/(m-u),0,1);return f*f*(3-2*f)},h=(t.weapon.spreadDeg??40)*Math.PI/360,c=Z*.7,d=(p,u)=>{const m=e.MathUtils.clamp(u/a,0,1),f=l(m,0,.38),g=l(m,.88,1);s.position.set(Math.sin(m*3.1)*Z*.3,c+Z*(.7+.34*f),Z*(.1+.34*f)),s.rotation.set(-.95-.3*Math.sin(m*4.2),m*2.6,.35*Math.sin(m*3.4));const w=.85+.45*f;s.scale.set(w,1,w*(1+.25*Math.sin(m*5)));for(let b=0;b<i;b++){const x=r[b],M=b*.1,y=l(m,.15+M,.88),v=i===1?0:(b/(i-1)-.5)*2*h,k=b/i*bt+m*(2.4+2*y),T=e.MathUtils.lerp(k,v,g),S=Z*(.62+.3*y+.34*g);x.position.set(Math.sin(T)*S,c+Math.sin(k*1.4)*Z*.14*(1-g)+Z*.16*y,Math.cos(T)*S*(.6+.4*g)),x.scale.setScalar(1.1+(fv-1.1)*y),x.rotation.y=k*1.5}};d(0,0),t.spawnTransient(o,a+.06,d)}}};function Er(t,e,a,o,n,s,i,r,l,h){const c=new ie,d=Ws();d.color.set(h),d.opacity=1;const p=new E(Nt,d);p.scale.set(r*1.3,1,r*.75),p.position.y=-Z*.005,c.add(p);const u=Gs();u.color.set(ka),u.opacity=1;const m=new E(Nt,u);m.scale.set(r,1,r*.55),c.add(m),c.renderOrder=9,c.position.set(e,a,o),c.rotation.y=Math.random()*bt;const f=(Math.random()-.5)*9,g=-5.2;t.spawnTransient(c,l,(w,b)=>{c.position.set(e+n*b,Math.max(Ct,a+s*b+.5*g*b*b),o+i*b),c.rotation.y+=f*.016,u.opacity=1-w*w,d.opacity=1-w*w})}function gv(t,e,a,o,n,s,i,r,l,h){const c=new ie,d=Ws();d.color.set(h),d.opacity=1;const p=new E(Nt,d);p.scale.set(Z*.075,1,r*1.03),p.position.y=-Z*.006,c.add(p);const u=Gs();u.color.set(ka),u.opacity=1;const m=new E(Nt,u);m.scale.set(Z*.05,1,r),c.add(m),c.renderOrder=9,c.position.set(e,a,o);const f=-5.6,g=(Math.random()-.5)*4.5;t.spawnTransient(c,l,(w,b)=>{c.position.set(e+n*b,Math.max(Ct,a+s*b+.5*f*b*b),o+i*b),c.rotation.y=$t(n,i)+g*b,c.scale.set(1+w*.5,1,1-w*.35),u.opacity=1-w*w,d.opacity=1-w*w})}function Tr(t,e,a,o,n,s,i,r,l){const h=sv();h.color.set(wh),h.opacity=1;const c=iv();c.color.set(bh),c.opacity=1;const d=rv();d.color.set($u),d.opacity=1;const p=pv(i,r,{face:h,deep:c,fat:d});p.renderOrder=9,p.position.set(e,a,o),p.rotation.y=n+Math.PI*.5;const u=Math.cos(n)*s,m=Math.sin(n)*s,f=.9+Math.random()*.7,g=-7.8,w=(Math.random()-.5)*2.2;t.spawnTransient(p,l,(b,x)=>{const M=a+f*x+.5*g*x*x,y=M<=Ct;p.position.set(e+u*x,y?Ct:M,o+m*x),p.rotation.y=n+Math.PI*.5+w*x;const v=1-Math.pow(b,2.4);h.opacity=v,c.opacity=v,d.opacity=v})}function wv(t){const e=t.replace("#","");return[0,2,4].map(a=>parseInt(e.slice(a,a+2),16)/255)}function bv(t){return`#${t.map(e=>Math.round(Math.max(0,Math.min(1,e))*255).toString(16).padStart(2,"0").toUpperCase()).join("")}`}function Kd(t){return .2126*t[0]+.7152*t[1]+.0722*t[2]}function yv([t,e,a]){const o=Math.max(t,e,a),n=Math.min(t,e,a),s=(o+n)/2,i=o-n;if(i===0)return[0,0,s];const r=s>.5?i/(2-o-n):i/(o+n);return[(o===t?(e-a)/i+(e<a?6:0):o===e?(a-t)/i+2:(t-e)/i+4)*60,r,s]}function Xd([t,e,a]){const o=(t%360+360)%360/360,n=a<.5?a*(1+e):a+e-a*e,s=2*a-n,i=r=>{const l=(r+1)%1;return l<1/6?s+(n-s)*6*l:l<.5?n:l<2/3?s+(n-s)*(2/3-l)*6:s};return[i(o+1/3),i(o),i(o-1/3)]}function Ku(t,e,a,o){const n=wv(t),[s,i]=yv(n),r=Kd(n)+o,l=s+e,h=Math.max(0,Math.min(1,i+a));let c=0,d=1;for(let p=0;p<32;p++){const u=(c+d)/2;Kd(Xd([l,h,u]))<r?c=u:d=u}return bv(Xd([l,h,(c+d)/2]))}function Xu(t){const e=re.soup.weapons.find(a=>a.key===t);if(!e)throw new Error(`soup vfx: no weapon '${t}' in CHARACTERS.soup.weapons`);return e.color}const xi=Xu("Splash"),vi=Ku(xi,7.1,.195,.196),ki=Ku(xi,-6.4,.07,-.212),xv="#FFF2E2",vh=Xu("Noodle"),oe=Q,We=.27,dn=oe*.3,vv=oe*.34,Sr=oe*.55,Za=oe*.042,Xe=oe*.085,Lt=oe*.4,kv=oe*.024;function Zu(t){let e=t%2147483647;return e<=0&&(e+=2147483646),()=>(e=e*48271%2147483647,e/2147483647)}function Ar(t,e){const o=Zu(t),n=o()*Math.PI*2,s=o()*Math.PI*2,i=o()*Math.PI*2,r=[];for(let u=0;u<e;u++)r.push([o()*Math.PI*2,.14+o()*.2,.16+o()*.14]);const l=[];let h=0;for(let u=0;u<=84;u++){const m=u/84*Math.PI*2;let f=1+.15*Math.sin(3*m+n)+.09*Math.sin(5*m+s)+.05*Math.sin(8*m+i);for(const[g,w,b]of r){let x=m-g;for(;x>Math.PI;)x-=Math.PI*2;for(;x<-Math.PI;)x+=Math.PI*2;f+=w*Math.exp(-(x*x)/(2*b*b))}l.push(f),f>h&&(h=f)}const c=new Float32Array(258);for(let u=0;u<=84;u++){const m=u/84*Math.PI*2,f=l[u]/h,g=(u+1)*3;c[g]=Math.cos(m)*f,c[g+1]=0,c[g+2]=Math.sin(m)*f}const d=[];for(let u=1;u<=84;u++)d.push(0,u+1,u);const p=new Cn;return p.setAttribute("position",new Cs(c,3)),p.setIndex(d),p.computeVertexNormals(),p}const Zd=[Ar(9173,4),Ar(48271,5),Ar(11071,3)];let Mv=0;const Ju=()=>Zd[Mv++%Zd.length],In=new st(1,9,7);In.scale(.78,.78,1.4);const Va=new st(1,10,8),Ev=new Me(1,.34,1,24,1,!0),Tv=(()=>{const e=document.createElement("canvas");e.width=e.height=64;const a=e.getContext("2d"),o=a.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);o.addColorStop(0,"rgba(255,255,255,0.95)"),o.addColorStop(.45,"rgba(255,255,255,0.52)"),o.addColorStop(.78,"rgba(255,255,255,0.14)"),o.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=o,a.fillRect(0,0,64,64);const n=new nt(e);return n.colorSpace=Sl,n})();function Rr(t){const e=Zu(t),a=1.1+e()*1.4,o=.9+e()*1.3,n=.13+e()*.11,s=.08+e()*.09,i=[],r=8;for(let l=0;l<r;l++){const h=l/(r-1);i.push(new pe(Math.sin(h*Math.PI*a+t)*n,Math.cos(h*Math.PI*o+t)*s,h-.5))}return new Jf(new Qf(i),20,kv/Lt,5,!1)}const Jd=[Rr(7919),Rr(30011),Rr(65449)];let Sv=0;const kh=()=>Jd[Sv++%Jd.length];function dt(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Mt=(t,e)=>new Y({color:t,transparent:!0,opacity:e,depthWrite:!1,side:be}),Qu=dt(10,()=>Mt(ki,.9)),Av=dt(10,()=>Mt(vi,.9)),ef=dt(28,()=>Mt(xi,.95)),Us=dt(14,()=>Mt(vi,.95)),Rv=dt(16,()=>Mt(vh,1)),Iv=dt(6,()=>Mt(ki,.85)),bl=dt(6,()=>Mt(xi,1)),Fv=dt(6,()=>Mt(vi,1)),Cv=dt(12,()=>Mt(vh,1)),Ov=dt(3,()=>Mt(ki,.92)),Nv=dt(3,()=>Mt(vi,.9)),Lv=dt(6,()=>Mt(vh,1)),Dv=dt(16,()=>new Ut({map:Tv,color:xv,transparent:!0,opacity:.5,depthWrite:!1})),zv=dt(8,()=>new Y({color:"#FFF4DF",transparent:!0,opacity:.9,depthWrite:!1,blending:at})),ms=new pe,Hv=new pe(0,0,1);function Ys(t,e,a,o){ms.set(e,a,o),!(ms.lengthSq()<1e-9)&&(ms.normalize(),t.quaternion.setFromUnitVectors(Hv,ms))}function Ma(t,e,a,o,n,s,i,r,l,h=!1){const c=new E(In,h?Us():ef()),d=c.material,p=.95;d.opacity=p,c.position.set(e,a,o);const u=-9.4;t.spawnTransient(c,l,(m,f)=>{const g=a+s*f+.5*u*f*f,w=g<=We;c.position.set(e+n*f,w?We:g,o+i*f);const b=s+u*f;if(w)Ys(c,n,0,i),c.scale.set(r*1.5,r*.3,r*1.7);else{Ys(c,n,b,i);const x=Math.hypot(n,b,i),M=1+Math.min(.9,x*.075);c.scale.set(r/Math.sqrt(M),r/Math.sqrt(M),r*M)}d.opacity=p*(1-m*m)})}function Ja(t,e,a,o,n,s,i){const r=new Ya(Dv()),l=r.material;l.opacity=0;const h=(Math.random()-.5)*n*1.6,c=(Math.random()-.5)*n*1.6;r.renderOrder=9,r.position.set(e,a,o),r.scale.set(n*1.1,n*1.1,1),t.spawnTransient(r,i,d=>{const p=1-Math.pow(1-d,2);r.position.set(e+h*p,a+s*p,o+c*p);const u=n*(1.1+p*1.5);r.scale.set(u,u,1),l.opacity=.5*Math.sin(Math.min(1,d*1.3)*Math.PI)})}function Mh(t,e,a,o,n){const s=Ju(),i=Math.random()*Math.PI*2,r=new E(s,Qu()),l=r.material;r.rotation.y=i,r.position.set(e,We,a),r.renderOrder=6,r.scale.setScalar(o*.35);const h=new E(s,Av()),c=h.material;h.rotation.y=i+.7,h.position.set(e,We+.01,a),h.renderOrder=7,h.scale.setScalar(o*.18);const d=p=>p<.34?1-Math.pow(1-p/.34,2.2):1;t.spawnTransient(r,n,p=>{r.scale.setScalar(o*U.lerp(.35,1,d(p))),l.opacity=.82*(1-Math.pow(p,1.5))}),t.spawnTransient(h,n*.86,p=>{h.scale.setScalar(o*U.lerp(.18,.62,d(p))),c.opacity=.9*(1-Math.pow(p,1.8))})}function _v(t,e,a,o,n){const s=new E(Ev,Iv()),i=s.material;i.color.set(ki),i.opacity=.85,s.rotation.y=Math.random()*Math.PI*2,s.renderOrder=8;const r=o*.78,l=h=>{const c=h<.5?1-Math.pow(1-h/.5,2.4):1,d=o*U.lerp(.24,1,c),p=r*U.lerp(1,.18,c);s.position.set(e,We+p*.5,a),s.scale.set(d,p,d),i.opacity=.85*(1-Math.pow(h,1.6))};l(0),t.spawnTransient(s,n,l)}function Eh(t,e,a,o,n){const s=new E(Va,zv()),i=s.material;s.position.set(e,a,o),s.scale.set(n,n*.55,n),t.spawnTransient(s,.19,r=>{const l=n*U.lerp(.9,1.7,r);s.scale.set(l,l*.5,l),i.opacity=.9*(1-r)*(1-r)})}function Vs(t,e,a,o,n,s,i,r,l){const h=new E(kh(),Rv()),c=h.material;c.opacity=1,h.position.set(e,a,o),h.scale.setScalar(r);const d=-9.4,p=6+Math.random()*6,u=Math.atan2(n,i)+(Math.random()-.5)*.8;t.spawnTransient(h,l,(m,f)=>{const g=a+s*f+.5*d*f*f;g<=We+.02?(h.position.set(e+n*f,We+.02,o+i*f),h.quaternion.identity(),h.rotation.set(0,u,0),h.scale.set(r,r*.55,r)):(h.position.set(e+n*f,g,o+i*f),Ys(h,n,s+d*f,i),h.rotateZ(f*p)),c.opacity=1-Math.pow(m,3)})}function Pv(t){const e=new ie,a=new E(In,bl());a.material.color.set(t),a.scale.setScalar(Xe),a.position.z=Xe*.4,e.add(a);const o=new E(Va,Fv());o.scale.setScalar(Xe*.5),o.position.set(Xe*.25,Xe*.4,Xe*.85),e.add(o);for(let n=0;n<2;n++){const s=new E(In,bl());s.material.color.set(t);const i=Xe*(.44-n*.13);s.scale.setScalar(i),s.position.set((Math.random()-.5)*Xe*.5,(Math.random()-.5)*Xe*.4,-Xe*(1.05+n*.95)),e.add(s)}return e.userData.__head=a,e}const $v={projectile(t){const e=Pv(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=(e.userData.__phase??Math.random()*6)+a*17;e.userData.__phase=o;const n=1+Math.sin(o)*.22;e.scale.set(1/Math.sqrt(n),1/Math.sqrt(n),n);const s=e.userData.__head;s&&(s.position.x=Math.sin(o*.55)*Xe*.3);const i=(e.userData.__drip??.04)-a;i<=0?(e.userData.__drip=.055+Math.random()*.045,Ma(t,t.position.x-t.direction.x*Xe*1.6,t.position.y-Xe*.4,t.position.z-t.direction.z*Xe*1.6,-t.direction.x*.5+(Math.random()-.5)*.5,-.3-Math.random()*.4,-t.direction.z*.5+(Math.random()-.5)*.5,Za*(.5+Math.random()*.4),.3)):e.userData.__drip=i;const r=(e.userData.__steam??.09)-a;r<=0?(e.userData.__steam=.13+Math.random()*.09,Ja(t,t.position.x,t.position.y+Xe,t.position.z,oe*.075,oe*.14,.34)):e.userData.__steam=r},impact(t){const{x:e,z:a}=t.position,o=t.direction;let n=o.x,s=o.z;const i=Math.hypot(n,s);i<1e-4?(n=1,s=0):(n/=i,s/=i),Eh(t,e,t.position.y*.55,a,oe*.19);const r=dn*.85;Mh(t,e+n*r,a+s*r,dn,.42),_v(t,e+n*r*.45,a+s*r*.45,dn*1.15,.24);for(let l=0;l<7;l++){const h=l/7*Math.PI*2+Math.random()*.6,c=1.7+Math.random()*1.5;Ma(t,e+Math.cos(h)*dn*.55,t.position.y*.5,a+Math.sin(h)*dn*.55,Math.cos(h)*c+n*.9,2.1+Math.random()*1.2,Math.sin(h)*c+s*.9,Za*(1+Math.random()*.7),.36+Math.random()*.12,l%3===0)}Ja(t,e+n*r*.6,We+oe*.05,a+s*r*.6,oe*.14,oe*.3,.5)},cast(t){const e=t.direction,a=new E(In,Us()),o=a.material;a.position.copy(t.position),Ys(a,e.x,-.25,e.z),t.spawnTransient(a,.16,n=>{a.position.set(t.position.x+e.x*n*oe*.2,t.position.y-n*oe*.07,t.position.z+e.z*n*oe*.2);const s=oe*(.05+n*.05);a.scale.set(s*1.5,s*.8,s*(1.6+n)),o.opacity=.95*(1-n*n)});for(let n=0;n<4;n++){const s=(Math.random()-.5)*.8,i=(Math.random()-.5)*.8;Ma(t,t.position.x,t.position.y,t.position.z,e.x*(1.6+Math.random())+s,.7+Math.random()*.9,e.z*(1.6+Math.random())+i,Za*(.5+Math.random()*.4),.3)}Ja(t,t.position.x,t.position.y,t.position.z,oe*.09,oe*.2,.34)}};function qv(t){const e=new ie,a=[];for(let n=0;n<3;n++){const s=new E(kh(),Cv());s.material.color.set(t),s.scale.setScalar(Lt*.62),s.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),s.position.set((Math.random()-.5)*Lt*.22,(Math.random()-.5)*Lt*.22,(Math.random()-.5)*Lt*.22),e.add(s),a.push(s)}const o=new E(Va,bl());return o.scale.setScalar(Xe*.62),e.add(o),e.userData.__strands=a,e}const Bv={projectile(t){const e=qv(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=e.userData.__strands;if(o)for(let s=0;s<o.length;s++){const i=o[s];i.rotation.x+=a*(3.4+s*1.7),i.rotation.z+=a*(2.1+s*1.1)}const n=(e.userData.__drip??.06)-a;n<=0?(e.userData.__drip=.085+Math.random()*.06,Ma(t,t.position.x,t.position.y-Lt*.2,t.position.z,(Math.random()-.5)*.7,-.2-Math.random()*.5,(Math.random()-.5)*.7,Za*(.45+Math.random()*.35),.32)):e.userData.__drip=n},impact(t){const{x:e,z:a}=t.position;Eh(t,e,t.position.y*.55,a,oe*.18),Mh(t,e,a,vv,.48);for(let o=0;o<5;o++){const n=o/5*Math.PI*2+Math.random()*.7,s=1.3+Math.random()*1.2;Vs(t,e,t.position.y*.7,a,Math.cos(n)*s,1.5+Math.random()*1.1,Math.sin(n)*s,Lt*(.7+Math.random()*.45),.7+Math.random()*.15)}for(let o=0;o<4;o++){const n=Math.random()*Math.PI*2,s=1.2+Math.random()*1.3;Ma(t,e,t.position.y*.6,a,Math.cos(n)*s,1.8+Math.random()*1.1,Math.sin(n)*s,Za*(.6+Math.random()*.5),.36,o===0)}Ja(t,e,We+oe*.05,a,oe*.15,oe*.32,.55)},cast(t){const e=t.direction;Vs(t,t.position.x,t.position.y,t.position.z,e.x*1.4,1.5,e.z*1.4,Lt*.7,.26);for(let a=0;a<3;a++)Ma(t,t.position.x,t.position.y,t.position.z,e.x*1.2+(Math.random()-.5)*.8,.9+Math.random()*.7,e.z*1.2+(Math.random()-.5)*.8,Za*.55,.28)}},jv={cast(t){const e=t.direction,a=Ze(t.weapon.range??ja.meleeHeavy),o=t.position.x,n=t.position.y,s=t.position.z,i=-e.z,r=e.x;for(let d=0;d<13;d++){const p=(d/12-.5)*2,u=p*a*.16+(Math.random()-.5)*a*.06,m=1.1+Math.random()*1.5-Math.abs(p)*.35,f=oe*(.055+Math.random()*.055)*(1-Math.abs(p)*.25);Ma(t,o+i*u,n+oe*(.05+Math.random()*.12),s+r*u,e.x*m+i*p*.35,.5+Math.random()*.7,e.z*m+r*p*.35,f,.42+Math.random()*.16,d%4===0)}for(let d=0;d<3;d++){const p=new E(Va,d===1?Us():ef()),u=p.material,m=.35+d*.5,f=o+e.x*a*.1,g=s+e.z*a*.1,w=n+oe*.1;p.position.set(f,w,g),t.spawnTransient(p,.4,x=>{const M=x*x;p.position.set(f+e.x*m*a*.28*x,Math.max(We,w-M*oe*.8),g+e.z*m*a*.28*x),p.scale.set(oe*(.13+x*.1),oe*(.13-x*.09),oe*(.13+x*.1)),u.opacity=.85*(1-Math.pow(x,1.7))})}for(let d=0;d<3;d++){const p=(d-1)*.5;Vs(t,o+i*p*a*.1,n,s+r*p*a*.1,e.x*(1.6+Math.random())+i*p,.9+Math.random()*.6,e.z*(1.6+Math.random())+r*p,Lt*(.8+Math.random()*.4),.6)}const l=Ju(),h=new E(l,Qu()),c=h.material;h.position.set(o+e.x*a*.26,We,s+e.z*a*.26),h.rotation.y=Math.atan2(e.x,e.z),h.renderOrder=6,t.spawnTransient(h,.6,d=>{const p=d<.45?1-Math.pow(1-d/.45,2):1;h.scale.set(a*.13*p+.05,1,a*.3*p+.05),c.opacity=.8*(1-Math.pow(d,2.2))});for(let d=0;d<3;d++)Ja(t,o+e.x*a*(.12+d*.13),We+oe*.06,s+e.z*a*(.12+d*.13),oe*.16,oe*.42,.6)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=new e.Group;o.name="teleSoupRoot";const n=t.position.clone();n.y-=oe*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=new e.Group;s.name="teleSoupTilt",o.add(s);const i=Ov(),r=new e.Mesh(Va,i);r.name="teleSoupBroth",s.add(r);const l=Nv(),h=new e.Mesh(Va,l);h.name="teleSoupLip",s.add(h);const c=3,d=[];for(let f=0;f<c;f++){const g=new e.Mesh(kh(),Lv());g.name=`teleSoupNoodle${f}`,d.push(g),s.add(g)}const p=(f,g,w)=>{const b=e.MathUtils.clamp((f-g)/(w-g),0,1);return b*b*(3-2*b)},u=oe*.98,m=(f,g)=>{const w=e.MathUtils.clamp(g/a,0,1),b=p(w,0,.45),x=p(w,.25,.85),M=p(w,.85,1),y=oe*(.45+.22*b),v=Math.sin(w*(7+9*x));r.position.set(Math.sin(w*(5+7*x))*oe*.06*x,u+oe*.1*b,oe*.3*x),r.scale.set(y*(1+.1*v),y*(.72-.1*v),y),i.opacity=.8+.15*b;const k=y*(.48+.3*M);h.position.set(r.position.x,r.position.y+y*(.3-.34*M),r.position.z+y*(.42+.55*M)),h.scale.set(k,k*.55,k),l.opacity=.35+.6*M+.15*x;for(let T=0;T<c;T++){const S=d[T],A=T/c*Math.PI*2+w*3.4,C=p(w,.25+T*.08,.9),R=y*(.35+.75*C);S.position.set(r.position.x+Math.cos(A)*R,r.position.y+y*(.35+.45*C),r.position.z+Math.sin(A)*R*.7),S.scale.setScalar(Lt*(.5+.85*C)),S.rotation.set(A*1.3,w*4.1+T,A*.8),S.material.opacity=.55+.45*C}s.rotation.x=M*.75+x*.12};m(0,0),t.spawnTransient(o,a+.06,m)},impact(t){const{x:e,z:a}=t.position,o=new E(Va,Us()),n=o.material;o.position.set(e,We,a),t.spawnTransient(o,.16,s=>{const i=1-Math.pow(1-s,2.6),r=oe*U.lerp(.42,.05,i),l=oe*U.lerp(.13,.4,i);o.position.set(e,We+r*.5,a),o.scale.set(l,r,l),n.opacity=.95*(1-Math.pow(s,2.5))}),Eh(t,e,t.position.y*.5,a,oe*.3),Mh(t,e,a,Sr,.62);for(let s=0;s<11;s++){const i=s/11*Math.PI*2+Math.random()*.5,r=2.2+Math.random()*2.2;Ma(t,e+Math.cos(i)*oe*.12,We+oe*.1,a+Math.sin(i)*oe*.12,Math.cos(i)*r,2.6+Math.random()*1.8,Math.sin(i)*r,Za*(.9+Math.random()*.8),.45+Math.random()*.15,s%3===0)}for(let s=0;s<4;s++){const i=s/4*Math.PI*2+Math.random(),r=1.5+Math.random()*1.3;Vs(t,e,We+oe*.15,a,Math.cos(i)*r,2+Math.random()*1.2,Math.sin(i)*r,Lt*(.85+Math.random()*.45),.85)}Ja(t,e,We+oe*.05,a,oe*.22,oe*.6,.8);for(let s=0;s<3;s++){const i=s/3*Math.PI*2+Math.random();Ja(t,e+Math.cos(i)*Sr*.55,We+oe*.03,a+Math.sin(i)*Sr*.55,oe*.14,oe*.4,.7)}}},Gv={Splash:$v,Noodle:Bv,Dump:jv},Wt=.09,Wv=Q*.075,Uv=Q*.1,Qd=Ua*.5,Th=new em(Wt,0);Th.scale(.55,1.7,.55);const yl=new st(Wt*.24,6,6);function Ca(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const tf=Ca(24,()=>new Y({color:"#BFEFFF",transparent:!0,opacity:.8,depthWrite:!1})),Yv=Ca(8,()=>new Y({color:"#FFFFFF",transparent:!0,opacity:1,blending:at,depthWrite:!1})),ep=Ca(6,()=>new Y({color:"#EAFBFF",transparent:!0,opacity:.95,blending:at,depthWrite:!1}));function tp(t){const e=new ie,a=4;for(let n=0;n<a;n++){const s=tf();s.color.set(t);const i=new E(Th,s),r=n/a*Math.PI*2;i.position.set(Math.cos(r)*Wt*.5,(Math.random()-.5)*Wt*.6,Math.sin(r)*Wt*.5),i.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),i.scale.setScalar(.6+Math.random()*.5),e.add(i)}const o=new E(yl,Yv());return e.add(o),e.userData.__glint=o,e}const gs=Q*1,Vv=new Me(.3,.36,.66,14,1,!1),Kv=new st(.3,14,8),Xv=new Me(.15,.24,.16,12,1,!1),Zv=new Me(.185,.185,.14,12,1,!1),Jv=new Me(.26,.31,.6,12,1,!1),Qv=new st(Q*.09,7,6),e5=new Me(1,1,1,16,1,!0),ap=new xa(.72,1,28),t5=Ca(8,()=>new Y({color:"#7FD4F5",transparent:!0,opacity:.42,depthWrite:!1,side:be})),a5=Ca(4,()=>new Y({color:"#BFEFFF",transparent:!0,opacity:.9,depthWrite:!1})),o5=Ca(20,()=>new Y({color:"#BFEFFF",transparent:!0,opacity:.9,depthWrite:!1})),n5=Ca(6,()=>new Y({color:"#1E90D8",transparent:!0,opacity:.95,depthWrite:!1})),Ir=Ca(8,()=>new Y({color:"#8FD9F7",transparent:!0,opacity:.9,blending:at,depthWrite:!1,side:be}));function op(t){const e=new ie;e.name=t;const a=t5(),o=new E(Vv,a);o.name=`${t}Body`,o.position.y=.33;const n=new E(Kv,a);n.name=`${t}Shoulder`,n.position.y=.66,n.scale.set(1,.62,1);const s=new E(Xv,a);s.name=`${t}Neck`,s.position.y=.8;const i=new E(Jv,a5());i.name=`${t}Fill`,i.position.y=.3;const r=new E(Zv,n5());return r.name=`${t}Cap`,r.position.y=.93,e.add(o,n,s,i,r),e.userData.__cap=r,e.userData.__fill=i,e}const s5={Mega:{telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=t.position.clone();o.y-=Q*.55;const n=new e.Group;n.name="megaTelegraph",n.position.copy(o);const s=op("megaSelfBottle"),i=op("megaCapBottle");n.add(s,i);const r=[],l=16;for(let g=0;g<l;g++){const w=new e.Mesh(Qv,o5());w.name=`megaLaunchStreak${g}`,w.scale.set(.8,2.6,.8),r.push(w),n.add(w)}const h=new e.Mesh(ap,Ir());h.name="megaMergeGlow",h.rotation.x=-Math.PI/2,h.visible=!1,n.add(h);const c=g=>g.userData.__cap,d=g=>g.userData.__fill,p=(g,w,b)=>{const x=e.MathUtils.clamp((g-w)/(b-w),0,1);return x*x*(3-2*x)},u=Q*.85,m=2.05,f=(g,w)=>{const b=e.MathUtils.clamp(w/a,0,1),x=p(b,0,.38),M=p(b,.22,.62),y=p(b,.55,.88),v=p(b,.88,1),k=u*x;s.position.set(0,k,0),s.rotation.z=.24+.09*Math.sin(b*7);const T=gs*(.55+.45*x);s.scale.setScalar(T);for(let N=0;N<l;N++){const L=N/l*Math.PI*2,P=N%4*.06,W=e.MathUtils.clamp((b-P)/.5,0,1),H=r[N],K=Ua*(.6+1.5*W);H.position.set(Math.cos(L)*K,Q*(.05+1.25*W),Math.sin(L)*K),H.scale.set(.8*(1-W*.4),2.6*(1-W*.5),.8*(1-W*.4)),H.material.opacity=.9*(1-W)*(1-y)}const S=c(s);S.position.y=.93+M*.55,S.visible=M<.98;const A=M>.02;if(i.visible=A,A){const N=gs*(.06+.62*M);i.scale.setScalar(N);const L=Ua*1.5*M*(1-y);i.position.set(L,k+T*.95+M*Q*.42,0),i.rotation.z=-.3-.1*Math.sin(b*6),c(i).visible=M>.5}if(y>0){const N=gs*e.MathUtils.lerp(1,m,y);s.scale.setScalar(N),s.position.set(0,u+Q*.25*y,0),i.position.x*=1-y,i.position.y=s.position.y+N*.55,s.rotation.z=(.24+.09*Math.sin(b*7))*(1-y*.5);const L=gs*e.MathUtils.lerp(.62,.02,y);i.scale.setScalar(Math.max(.001,L)),h.visible=y<.99,h.position.set(0,s.position.y+N*.45,0);const P=N*(.22+.3*y);h.scale.set(P,P,P),h.material.opacity=.75*Math.sin(Math.PI*y)}else h.visible=!1;const C=v*.85;n.rotation.z=-C*t.direction.x,n.rotation.x=C*t.direction.z;const R=d(s),F=.35+.65*b;R.scale.set(1,F,1),R.position.y=.3*F,R.material.opacity=.75+.25*v};f(0,0),t.spawnTransient(n,a+.06,f)},cast(t){const e=t.THREE,a=t.position.clone();a.y-=Q*.55;const o=new e.Mesh(e5,Ir());o.name="megaPourColumn";const n=Ua*1.35,s=Q*2.6;o.position.set(a.x,a.y+s*.5,a.z),o.scale.set(n,s,n),t.spawnTransient(o,.34,i=>{const r=Math.min(1,i*2.4),l=Math.max(0,(i-.42)/.58);o.position.y=a.y+s*.5*(1-.55*r),o.scale.set(n*(1+1.5*l),s*(1-.5*r),n*(1+1.5*l)),o.material.opacity=.85*(1-i*i)});for(let i=0;i<2;i++){const r=new e.Mesh(ap,Ir());r.name=`megaPourRing${i}`,r.rotation.x=-Math.PI/2,r.position.set(a.x,a.y+.05+i*.03,a.z);const l=i*.09;t.spawnTransient(r,.42+l,h=>{const c=Math.max(0,(h*(.42+l)-l)/.42),d=Ua*(.8+3.6*c);r.scale.set(d,d,d),r.material.opacity=.9*(1-c)})}}},Glass:{projectile(t){const e=tp(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=e.userData.__glint;let n=0;for(const s of e.children){if(s===o)continue;const i=2+n*.9;s.rotation.x+=a*i,s.rotation.y+=a*i*.75,n++}if(o){const s=o.material;s.opacity=Math.max(0,s.opacity-a*3.2);const i=(e.userData.__glintTimer??0)-a;i<=0?(e.userData.__glintTimer=.14+Math.random()*.3,s.opacity=1,o.position.set((Math.random()-.5)*Wt,(Math.random()-.5)*Wt,(Math.random()-.5)*Wt)):e.userData.__glintTimer=i}},impact(t){const e=t.position,a=Uv/Wt,o=new E(yl,ep());o.position.copy(e),o.scale.setScalar(1.25*a),t.spawnTransient(o,.14,i=>{o.scale.setScalar(U.lerp(1.25,3,i)*a),o.material.opacity=.95*(1-i)});const n=U.clamp(1+t.damage*.06,1,2.4),s=11;for(let i=0;i<s;i++){const r=i/s*Math.PI*2+Math.random()*.5,l=(1.6+Math.random()*2.4)*n,h=tf();h.color.set(t.color);const c=new E(Th,h),d=(.42+Math.random()*.43)*a*n;c.scale.setScalar(d);const p=e.x+Math.cos(r)*Qd,u=e.y,m=e.z+Math.sin(r)*Qd;c.position.set(p,u,m);const f=1.1+Math.random()*1.6,g=-9,w=(Math.random()-.5)*22,b=(Math.random()-.5)*22;t.spawnTransient(c,.38+Math.random()*.2,(x,M)=>{c.position.set(p+Math.cos(r)*l*M,u+f*M+.5*g*M*M,m+Math.sin(r)*l*M),c.rotation.x=M*w,c.rotation.y=M*b,c.scale.setScalar(d*(1-x*.25)),c.material.opacity=.85*(1-x)})}},cast(t){const e=Wv/Wt,a=tp(t.color);a.position.copy(t.position),a.scale.setScalar(.35*e),t.spawnTransient(a,.16,n=>{const s=Math.min(1,n*2.2),i=n>.55?1-(n-.55)*2.2:1;a.scale.setScalar(U.clamp(.35+s*.75,.1,1.15)*e*Math.max(0,i)),a.rotation.y=n*5});const o=new E(yl,ep());o.position.copy(t.position),o.scale.setScalar(.8*e),t.spawnTransient(o,.12,n=>{o.scale.setScalar(U.lerp(.8,1.9,n)*e),o.material.opacity=.9*(1-n)})}}},Bo=Gt.mustard,Bt="#9A6410",Sh="#FFF2C0",Ah=Gt.ketchup,Qt="#6E121D",xl="#FFC0AE",Is=Gt.bun,xn="#7A4A1E",vl="#F9E9C2",J=Q,ko=Math.PI*2,Ks=.28;function Mi(t,e=8){const a=new Nl(t,e);return a.rotateX(-Math.PI/2),a}function Rh(t,e,a,o){const n=Math.max(2,a*2),s=new Sa,i=l=>l%2===0?-o:o,r=l=>-t/2+l/n*t;s.moveTo(i(0)-e,r(0));for(let l=1;l<=n;l++)s.lineTo(i(l)-e,r(l));for(let l=n;l>=0;l--)s.lineTo(i(l)+e,r(l));return s.closePath(),s}function i5(t,e){const a=new Sa;return a.moveTo(0,t),a.quadraticCurveTo(e,t*.45,e,0),a.quadraticCurveTo(e,-t*.45,0,-t),a.quadraticCurveTo(-e,-t*.45,-e,0),a.quadraticCurveTo(-e,t*.45,0,t),a}const Fn=J*.44,kl=J*.065,r5=J*.072,ea=J*.26,wo=J*.185,Xs=Mi(Rh(Fn,kl,3,r5),1),Zs=J*.78,af=J*.075,of=(af+J*.098)*2,Fr=(()=>{const t=Mi(Rh(Zs,af,3,J*.098),1);return t.translate(0,0,Zs/2),t})(),kt=Mi(i5(.5,.5),6),l5=new ti(J*.024,0),np=(()=>{const t=new Me(1,1,1,16,1,!0,0,Math.PI);return t.rotateZ(-Math.PI/2),t.rotateY(Math.PI/2),t})(),h5=(()=>{const t=new Qa(2,1);return t.rotateX(-Math.PI/2),t})(),c5=Mi(Rh(1,.14,4,.36),1);function Oa(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const po=t=>new Y({color:t,side:be}),d5=po(Bo),sp=po(Bt),p5=po(Sh),u5=po(Ah),ip=po(Qt),f5=po(xl),qn=(t,e)=>new Y({color:t,transparent:!0,opacity:e,side:be,depthWrite:!1}),Js=Oa(48,()=>qn(Bo,1)),Qs=Oa(48,()=>qn(Bt,1)),nf=Oa(20,()=>qn(Sh,1)),rp=Oa(8,()=>new Y({color:Is,transparent:!0,opacity:1,side:be,depthWrite:!1})),lp=Oa(8,()=>new Y({color:xn,transparent:!0,opacity:1,side:be,depthWrite:!1})),hp=Oa(8,()=>qn(vl,1)),cp=Oa(8,()=>qn(Bo,1)),m5=Oa(14,()=>new Y({color:xn,transparent:!0,opacity:1,depthWrite:!1}));function xt(t,e){return Math.atan2(t,e)}function dp(t){return t.range&&t.speed?t.range/t.speed:so.normal/1e3}function Cr(t){return U.clamp(.85+t*.035,.85,1.4)}function pp(t){let e=t.userData.__hotdog;return e||(e={phase:Math.random()*ko,shed:0},t.userData.__hotdog=e),e}function ma(t,e,a,o,n,s,i,r,l,h,c){const d=new ie,p=Qs();p.color.set(a),p.opacity=1;const u=new E(kt,p);u.scale.set(1.34,1,1.14),u.position.y=-J*.008,d.add(u);const m=Js();m.color.set(e),m.opacity=1,d.add(new E(kt,m)),d.renderOrder=9,d.position.set(o,n,s);const f=h*.45,g=-8.2;t.spawnTransient(d,c,(w,b)=>{const x=n+r*b+.5*g*b*b,M=x<=Ks;if(d.position.set(o+i*b,M?Ks:x,s+l*b),M)d.rotation.y=xt(i,l),d.scale.set(f*1.5,1,h*.75);else{const v=r+g*b,k=Math.hypot(i,v,l),T=1+Math.min(.85,k*.07);d.rotation.y=xt(i,l),d.scale.set(f/T,1,h*T)}const y=1-w*w;m.opacity=y,p.opacity=y})}function up(t,e,a,o,n,s){const i=t.direction,r=Math.hypot(i.x,i.z)>1e-4,l=r?J*.36:0;Fs(t,e,a,t.position.x-i.x*l,t.position.y,t.position.z-i.z*l,r?xt(i.x,i.z)+Math.PI*.5:0,o,n,s,.45)}function Fs(t,e,a,o,n,s,i,r,l,h,c,d=1,p="#FFF6DC"){const u=r/Zs,m=l/of,f=new ie;f.rotation.y=i,f.position.set(o-Math.sin(i)*r*.5,n,s-Math.cos(i)*r*.5);const g=Qs();g.color.set(a),g.opacity=d;const w=new E(Fr,g);w.scale.set(1.42,1,1.02),w.position.y=-J*.009,f.add(w);const b=Js();b.color.set(e),b.opacity=d,f.add(new E(Fr,b));const x=nf();x.color.set(p),x.opacity=d;const M=new E(Fr,x);M.scale.set(.42,1,.985),M.position.y=J*.006,f.add(M),t.spawnTransient(f,h,y=>{const v=1-Math.pow(1-Math.min(1,y*5.5),3);f.scale.set(m,1,Math.max(.02,u*v));const k=y<c?1:1-(y-c)/(1-c);b.opacity=d*k,g.opacity=d*k,x.opacity=d*k})}function g5(t){const e=new ie,a=new E(Xs,sp);a.scale.set(1.5,1,1.07),a.position.y=-J*.012,e.add(a),e.add(new E(Xs,t===Bo?d5:sf(t)));const o=new E(kt,sp);o.scale.set(kl*3.2,1,J*.15),o.position.set(0,-J*.012,Fn*.46),e.add(o);const n=new E(kt,p5);return n.scale.set(kl*2.1,1,J*.105),n.position.set(0,0,Fn*.47),e.add(n),e}function w5(t){const e=new ie,a=t===Ah?u5:sf(t),o=new E(kt,ip);o.scale.set(wo*1.32,1,ea*1.12),o.position.y=-J*.012,e.add(o);const n=new E(kt,a);n.scale.set(wo,1,ea),e.add(n);const s=new E(kt,f5);s.scale.set(wo*.32,1,ea*.42),s.position.set(-wo*.2,J*.004,ea*.16),e.add(s);const i=[];for(let l=0;l<3;l++){const h=new ie,c=1-l*.24,d=new E(kt,ip);d.scale.set(wo*.72*c*1.34,1,ea*.42*c*1.14),d.position.y=-J*.012,h.add(d);const p=new E(kt,a);p.scale.set(wo*.72*c,1,ea*.42*c),h.add(p),h.position.z=-ea*(.7+l*.46),e.add(h),i.push(h)}const r={tail:i};return e.userData.__parts=r,e}const fp=new Map;function sf(t){let e=fp.get(t);return e||(e=po(t),fp.set(t,e)),e}function ws(t,e,a){const o=new ie,n=new E(np,a.crust);n.scale.set(t*1.13,t*1.13,e*1.04),n.position.y=-t*.04,o.add(n);const s=new E(np,a.bun);s.scale.set(t,t,e),o.add(s);const i=new E(h5,a.crumb);i.scale.set(t*.86,1,e*.92),i.position.y=-t*.34,o.add(i);const r=new E(c5,a.seam);return r.scale.set(t*1.3,1,e*.84),r.position.y=-t*.3,o.add(r),o}const b5={Mustard:{projectile(t){const e=g5(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=pp(e);o.phase+=a/dp(t.weapon)*ko*3.2,e.rotation.y=xt(t.direction.x,t.direction.z)+Math.sin(o.phase)*.16;const n=1+Math.sin(o.phase*1.7)*.13;e.scale.set(1/n,1,n),o.shed-=a,o.shed<=0&&(o.shed=.05+Math.random()*.03,ma(t,t.color,Bt,t.position.x-t.direction.x*Fn*.5,t.position.y,t.position.z-t.direction.z*Fn*.5,-t.direction.x*(.6+Math.random()*.7)+(Math.random()-.5)*.9,.25+Math.random()*.45,-t.direction.z*(.6+Math.random()*.7)+(Math.random()-.5)*.9,J*(.12+Math.random()*.06),.26+Math.random()*.12))},impact(t){const e=Cr(t.damage),a=t.direction,o=xt(a.x,a.z)+Math.PI*.5;Fs(t,t.color,Bt,t.position.x,t.position.y,t.position.z,o,J*1.045*e,J*.3*e,.34,.5),up(t,Sh,Bt,J*.46*e,J*.2*e,.19);const{x:n,y:s,z:i}=t.position,r=J*.3*e;for(let l=0;l<8;l++){const h=l/8*ko+Math.random()*.6,c=(2.1+Math.random()*1.5)*e;ma(t,t.color,Bt,n+Math.cos(h)*r,s,i+Math.sin(h)*r,Math.cos(h)*c+t.direction.x*.7,1.7+Math.random()*1.2,Math.sin(h)*c+t.direction.z*.7,J*(.14+Math.random()*.07)*e,.42+Math.random()*.14)}},cast(t){const e=t.direction,a=xt(e.x,e.z),o=new ie,n=Qs();n.color.set(Bt),n.opacity=1;const s=new E(Xs,n);s.scale.set(1.5,1,1.08),s.position.y=-J*.012,o.add(s);const i=Js();i.color.set(t.color),i.opacity=1,o.add(new E(Xs,i)),o.renderOrder=11,o.rotation.y=a;const r=t.position.x,l=t.position.z;t.spawnTransient(o,.16,h=>{const c=1-Math.pow(1-h,2);o.scale.set(.6+h*.3,1,.35+c*.85),o.position.set(r+e.x*c*J*.16,t.position.y,l+e.z*c*J*.16);const d=1-h;i.opacity=d,n.opacity=d});for(let h=0;h<4;h++)ma(t,t.color,Bt,t.position.x,t.position.y,t.position.z,e.x*(1.4+Math.random()*1.1)+(Math.random()-.5)*.7,.4+Math.random()*.5,e.z*(1.4+Math.random()*1.1)+(Math.random()-.5)*.7,J*(.12+Math.random()*.05),.3)}},Ketchup:{projectile(t){const e=w5(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=pp(e);o.phase+=a/dp(t.weapon)*ko*2.4,e.rotation.y=xt(t.direction.x,t.direction.z);const n=e.userData.__parts;if(n)for(let i=0;i<n.tail.length;i++){const r=n.tail[i],l=Math.sin(o.phase-(i+1)*.9);r.position.x=l*J*.055*(i+1)*.55,r.rotation.y=l*.4}const s=1+Math.sin(o.phase*1.3)*.09;e.scale.set(s,1,1/s),o.shed-=a,o.shed<=0&&(o.shed=.09+Math.random()*.05,ma(t,t.color,Qt,t.position.x-t.direction.x*ea*1.5,t.position.y,t.position.z-t.direction.z*ea*1.5,(Math.random()-.5)*.9,.1+Math.random()*.3,(Math.random()-.5)*.9,J*(.11+Math.random()*.05),.24+Math.random()*.1))},impact(t){const e=Cr(t.damage),a=t.direction;Fs(t,t.color,Qt,t.position.x,t.position.y,t.position.z,xt(a.x,a.z)+Math.PI*.5,J*.78*e,J*.36*e,.3,.45),up(t,xl,Qt,J*.4*e,J*.2*e,.18),Fs(t,t.color,Qt,t.position.x+a.x*J*.5,Ks,t.position.z+a.z*J*.5,xt(a.x,a.z),Zs*e,of*e,.8,.55,.95,xl);const{x:o,y:n,z:s}=t.position,i=J*.29*e;for(let r=0;r<6;r++){const l=r/6*ko+Math.random()*.7,h=(1.8+Math.random()*1.3)*e;ma(t,t.color,Qt,o+Math.cos(l)*i,n,s+Math.sin(l)*i,Math.cos(l)*h+a.x*.6,1.5+Math.random()*1.1,Math.sin(l)*h+a.z*.6,J*(.14+Math.random()*.07)*e,.44+Math.random()*.14)}},cast(t){const e=t.direction;for(let i=0;i<5;i++)ma(t,t.color,Qt,t.position.x,t.position.y,t.position.z,e.x*(1+Math.random()*.9)+(Math.random()-.5)*.8,.3+Math.random()*.4,e.z*(1+Math.random()*.9)+(Math.random()-.5)*.8,J*(.13+Math.random()*.05),.3);const a=new ie,o=Qs();o.color.set(Qt),o.opacity=1;const n=new E(kt,o);n.scale.set(1.3,1,1.16),n.position.y=-J*.01,a.add(n);const s=Js();s.color.set(t.color),s.opacity=1,a.add(new E(kt,s)),a.renderOrder=11,a.rotation.y=xt(e.x,e.z),a.position.copy(t.position),t.spawnTransient(a,.15,i=>{const r=U.lerp(J*.06,J*.24,1-Math.pow(1-i,2));a.scale.set(r*.55,1,r),a.position.set(t.position.x+e.x*i*J*.14,t.position.y,t.position.z+e.z*i*J*.14),s.opacity=1-i,o.opacity=1-i})}},Slash:{impact(t){const e=Cr(t.damage),a=t.direction,o=xt(a.x,a.z),{x:n,y:s,z:i}=t.position,r=J*.175*e,l=J*.62*e,h=J*.375*e,c=J*.125*e,d=new ie;d.rotation.y=o,d.position.set(n,s-J*.06,i),d.renderOrder=10;const p=rp();p.color.set(Is),p.opacity=1;const u=hp();u.color.set(vl),u.opacity=1;const m=cp();m.color.set(t.color),m.opacity=1;const f=lp();f.color.set(xn),f.opacity=1;const g={bun:p,crust:f,crumb:u,seam:m},w=ws(r,l,g),b=ws(r,l,g);d.add(w,b);const x=nf();x.color.set("#FFF6DA"),x.opacity=0;const M=new E(kt,x);M.scale.set(J*.075,1,l*.92),M.position.y=r*.15,M.renderOrder=12,d.add(M);let y=!1;t.spawnTransient(d,.46,k=>{const T=Math.min(1,k/.35),S=1-Math.pow(1-T,3),A=k<=.35?S:S-(k-.35)/.65*.55,C=U.lerp(h,c,U.clamp(A,0,1));w.position.x=C,b.position.x=-C;const R=U.lerp(.55,.12,U.clamp(A,0,1));w.rotation.z=R,b.rotation.z=-R,x.opacity=k<.35?0:Math.max(0,1-(k-.35)/.2);const F=k<.6?1:1-(k-.6)/.4;if(p.opacity=F,f.opacity=F,u.opacity=F,m.opacity=F,!y&&k>=.35){y=!0;const N=-Math.sin(o),L=-Math.cos(o);for(let P=0;P<6;P++){const W=P%2===0?1:-1,H=P<4,K=(Math.random()-.5)*.8;ma(t,H?Bo:Ah,H?Bt:Qt,n+N*W*c*1.2,s,i+L*W*c*1.2,N*W*(2.4+Math.random()*1.6)+a.x*K,1.6+Math.random()*1.3,L*W*(2.4+Math.random()*1.6)+a.z*K,J*(.15+Math.random()*.07)*e,.4+Math.random()*.14)}}});const v=J*.24*e;for(let k=0;k<6;k++){const T=Math.random()*ko,S=(1.9+Math.random()*1.6)*e,A=m5();A.color.set(k%3===0?Is:xn),A.opacity=1;const C=new E(l5,A);C.renderOrder=9;const R=n+Math.cos(T)*v,F=i+Math.sin(T)*v,N=Math.cos(T)*S,L=Math.sin(T)*S,P=1.7+Math.random()*1.3,W=(.8+Math.random()*.7)*e;C.scale.setScalar(W);const H=Math.random()*9-4.5,K=Math.random()*9-4.5;t.spawnTransient(C,.42+Math.random()*.14,(O,_)=>{C.position.set(R+N*_,Math.max(Ks,s+P*_-4.6*_*_),F+L*_),C.rotation.set(H*_,K*_,0),A.opacity=1-O*O})}},cast(t){const e=t.direction,a=xt(e.x,e.z),o=.62,n=J*.175*o,s=J*.62*o,i=new ie;i.rotation.y=a,i.position.copy(t.position),i.renderOrder=11;const r=rp();r.color.set(Is),r.opacity=1;const l=hp();l.color.set(vl),l.opacity=1;const h=cp();h.color.set(t.color),h.opacity=1;const c=lp();c.color.set(xn),c.opacity=1;const d={bun:r,crust:c,crumb:l,seam:h},p=ws(n,s,d),u=ws(n,s,d);i.add(p,u),t.spawnTransient(i,.2,m=>{const f=1-Math.pow(1-m,2),g=U.lerp(J*.06,J*.2,f);p.position.x=g,u.position.x=-g,p.rotation.z=f*.6,u.rotation.z=-f*.6;const w=1-m;r.opacity=w,c.opacity=w,l.opacity=w,h.opacity=w});for(let m=0;m<3;m++)ma(t,Bo,Bt,t.position.x,t.position.y,t.position.z,e.x*(1.2+Math.random())+(Math.random()-.5)*.9,.5+Math.random()*.4,e.z*(1.2+Math.random())+(Math.random()-.5)*.9,J*(.12+Math.random()*.05),.28)}}};function Tt(t,e){const a={};for(const[o,n]of Object.entries(e))n&&(a[`${t}.${o}`]=n);return a}const y5={...Tt("hamburger",$b),...Tt("donut",py),...Tt("taco",Oy),...Tt("burrito",f2),...Tt("egg",W2),...Tt("lollipop",Rx),...Tt("pizza",Xx),...Tt("sushi",mv),...Tt("soup",Gv),...Tt("waterbottle",s5),...Tt("hotdog",b5)};function pn(t,e){return y5[`${t}.${e}`]}function Jt(t){window.__vfxQaCounts??={cast:0,meleeArc:0,impact:0,death:0,heal:0,giantSlam:0,puddleSplash:0,coverScuff:0,castTelegraph:0},window.__vfxQaCounts[t]++}const bo=.5,Ei=.3,x5=Ei,v5=Ei+.01,_a=1.15,Or=1.25,k5=.25,M5=0,Pa=Ei+.02,bs=Ei+.04,E5=Q,mp=.85,gp=.68,T5=4,S5=.7,A5=.92,R5=7,I5=.55,wp=.6,bp=.32,Nr=new Kt("#F2F6FF"),F5=new Kt("#63A8E0"),C5=Q*.62,O5=Q*.66,N5=Q*.62,L5=.58,D5="#EAF4FF",z5="#1D2740",yp=18,mn=.8,Lr=3,xp=["#F5475E","#F5C147","#47C4F5","#6BE05A","#B36BF5","#F58A47"],H5="#EF5B2E",_5=.78,wt=new Kt("#ffffff"),P5=new Kt("#241a33"),vp=new Kt("#FFE79A");function ys(t,e,a,o,n){const s=new Set;for(const i of a){s.add(i.id);let r=t.get(i.id);r||(r=o(i),e.add(r),t.set(i.id,r)),n(r,i)}for(const[i,r]of t)s.has(i)||(e.remove(r),t.delete(i))}function $5(t){return t.depthWrite=!1,t}const kp=t=>1-Math.pow(1-t,3);function Mp(t){const e=Math.sin(t*12.9898)*43758.5453;return(e-Math.floor(e))*Math.PI*2}function Dr(t,e){const a=Math.hypot(t,e);return a>1e-6?{x:t/a,y:e/a}:{x:0,y:0}}function q5(){const e=document.createElement("canvas");e.width=64,e.height=64;const a=e.getContext("2d"),o=a.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);o.addColorStop(0,"rgba(255,255,255,1)"),o.addColorStop(.4,"rgba(255,255,255,0.85)"),o.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=o,a.fillRect(0,0,64,64);const n=new nt(e);return n.needsUpdate=!0,n}function B5(){const e=document.createElement("canvas");e.width=64,e.height=64;const a=e.getContext("2d"),o=a.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);o.addColorStop(0,"rgba(255,255,255,1)"),o.addColorStop(.62,"rgba(255,255,255,1)"),o.addColorStop(.82,"rgba(255,255,255,0.6)"),o.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=o,a.fillRect(0,0,64,64);const n=new nt(e);return n.needsUpdate=!0,n}function j5(){const a=document.createElement("canvas");a.width=128,a.height=128;const o=a.getContext("2d"),n=o.createRadialGradient(64,64,0,64,64,128*.16);n.addColorStop(0,"rgba(255,255,255,1)"),n.addColorStop(.6,"rgba(255,255,255,0.85)"),n.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=n,o.fillRect(0,0,128,128);const s=8;for(let r=0;r<s;r++){const l=r%2===0,h=128*(l?.48:.26),c=128*(l?.045:.028),d=r/s*Math.PI*2;o.save(),o.translate(64,64),o.rotate(d);const p=o.createLinearGradient(0,0,h,0);p.addColorStop(0,"rgba(255,255,255,1)"),p.addColorStop(.7,"rgba(255,255,255,0.8)"),p.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=p,o.beginPath(),o.moveTo(0,-c),o.lineTo(h,0),o.lineTo(0,c),o.closePath(),o.fill(),o.restore()}const i=new nt(a);return i.needsUpdate=!0,i}function G5(){const a=document.createElement("canvas");a.width=128,a.height=32;const o=a.getContext("2d"),n=o.createLinearGradient(0,0,128,0);n.addColorStop(0,"rgba(255,255,255,0)"),n.addColorStop(.5,"rgba(255,255,255,1)"),n.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=n,o.fillRect(0,0,128,32),o.globalCompositeOperation="destination-in";const s=o.createLinearGradient(0,0,0,32);s.addColorStop(0,"rgba(255,255,255,0)"),s.addColorStop(.5,"rgba(255,255,255,1)"),s.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=s,o.fillRect(0,0,128,32),o.globalCompositeOperation="source-over";const i=new nt(a);return i.needsUpdate=!0,i}function W5(){const a=document.createElement("canvas");a.width=8,a.height=64;const o=a.getContext("2d"),n=o.createLinearGradient(0,0,0,64);n.addColorStop(0,"rgba(255,255,255,0.1)"),n.addColorStop(.55,"rgba(255,255,255,0.55)"),n.addColorStop(.86,"rgba(255,255,255,0.85)"),n.addColorStop(.94,"rgba(255,255,255,1)"),n.addColorStop(1,"rgba(255,255,255,0.65)"),o.fillStyle=n,o.fillRect(0,0,8,64);const s=new nt(a);return s.flipY=!1,s.needsUpdate=!0,s}function U5(){const a=document.createElement("canvas");a.width=8,a.height=128;const o=a.getContext("2d"),n=o.createLinearGradient(0,0,0,128);n.addColorStop(0,"rgba(255,255,255,0)"),n.addColorStop(.78,"rgba(255,255,255,0)"),n.addColorStop(.88,"rgba(255,255,255,0.85)"),n.addColorStop(.94,"rgba(255,255,255,1)"),n.addColorStop(1,"rgba(255,255,255,0.75)"),o.fillStyle=n,o.fillRect(0,0,8,128);const s=new nt(a);return s.flipY=!1,s.needsUpdate=!0,s}function Y5(t){const o=document.createElement("canvas");o.width=128,o.height=128;const n=o.getContext("2d"),s=1.9*t,i=3.3*t+.7,r=v=>64*(mn+.13*Math.sin(v*3+s)+.06*Math.sin(v*5+i)),l=v=>{v.beginPath();const k=96;for(let T=0;T<=k;T++){const S=T/k*Math.PI*2,A=r(S),C=64+Math.cos(S)*A,R=64+Math.sin(S)*A;T===0?v.moveTo(C,R):v.lineTo(C,R)}v.closePath()},h=()=>l(n);h();const c=n.createLinearGradient(128*.18,128*.12,128*.86,128*.92);c.addColorStop(0,"rgb(98,98,98)"),c.addColorStop(.5,"rgb(67,67,67)"),c.addColorStop(1,"rgb(35,35,35)"),n.fillStyle=c,n.fill(),n.save(),h(),n.clip();const d=.45,p=1/Math.sqrt(.5+.5*d*d),u=(v,k,T,S)=>{const A=64+v*128,C=64+k*128,R=T*128*p,F=n.createRadialGradient(A,C,0,A,C,R);F.addColorStop(0,`rgba(${S},${S},${S},1)`),F.addColorStop(d,`rgba(${S},${S},${S},1)`),F.addColorStop(1,`rgba(${S},${S},${S},0)`),n.fillStyle=F,n.beginPath(),n.arc(A,C,R,0,Math.PI*2),n.fill()},m=t*1.7;for(let v=0;v<7;v++){const k=m+v*2.399963,T=.075+.215*Math.sqrt((v+.55)/7),S=.08-.005*v,A=255-8*v;u(Math.cos(k)*T,Math.sin(k)*T,S,A)}u(-.06+.05*t,.2,.075,24),u(.2-.04*t,-.17,.055,20),n.restore();const f=document.createElement("canvas");f.width=128,f.height=128;const g=f.getContext("2d");g.save(),l(g),g.clip(),g.lineWidth=128*.055,g.strokeStyle="#ffffff",l(g),g.stroke(),g.restore();const w=g.getImageData(0,0,128,128).data,b=n.getImageData(0,0,128,128),x=b.data,M=_5;for(let v=0;v<x.length;v+=4){const k=x[v+3];if(k===0)continue;const T=w[v+3]/255;x[v+3]=Math.round(k*(M+(1-M)*T))}n.putImageData(b,0,0);const y=new nt(o);return y.needsUpdate=!0,y}const V5=.26,K5=2.4,X5=1.65,Ep=.36,Z5=.64,J5=.66,Q5=.4,ek=.78,tk=1.25,ak=6;function ok(){const e=document.createElement("canvas");e.width=128,e.height=128;const a=e.getContext("2d"),o=a.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);o.addColorStop(0,"rgba(255,255,255,0.22)"),o.addColorStop(.44,"rgba(255,255,255,0.34)"),o.addColorStop(.62,"rgba(255,255,255,0.78)"),o.addColorStop(.82,"rgba(255,255,255,0.90)"),o.addColorStop(.88,"rgba(70,70,70,0.86)"),o.addColorStop(.96,"rgba(48,48,48,0.55)"),o.addColorStop(1,"rgba(40,40,40,0)"),a.fillStyle=o,a.fillRect(0,0,128,128);const n=new nt(e);return n.needsUpdate=!0,n}function nk(t){const e=/^#?([0-9a-f]{6})$/i.exec(t.trim());if(!e)return t;const a=parseInt(e[1],16),o=(a>>16&255)/255,n=(a>>8&255)/255,s=(a&255)/255,i=Math.max(o,n,s),r=Math.min(o,n,s),l=i-r;let h=0;l>1e-6&&(i===o?h=(n-s)/l%6:i===n?h=(s-o)/l+2:h=(o-n)/l+4,h*=60,h<0&&(h+=360));const c=(i+r)/2,d=l<1e-6?0:l/(1-Math.abs(2*c-1)),p=c>=ek?Q5:Math.max(c,J5),u=Math.min(1,d*tk),m=(1-Math.abs(2*p-1))*u,f=m*(1-Math.abs(h/60%2-1)),g=p-m/2;let w=0,b=0,x=0;h<60?(w=m,b=f):h<120?(w=f,b=m):h<180?(b=m,x=f):h<240?(b=f,x=m):h<300?(w=f,x=m):(w=m,x=f);const M=y=>Math.round((y+g)*255).toString(16).padStart(2,"0");return`#${M(w)}${M(b)}${M(x)}`}function sk(){const e=document.createElement("canvas");e.width=64,e.height=64;const a=e.getContext("2d"),o=[[.5,.02],[.78,.32],[.68,.98],[.32,.98],[.22,.32],[.5,.02]];a.beginPath(),o.forEach(([i,r],l)=>{const h=i*64,c=r*64;l===0?a.moveTo(h,c):a.lineTo(h,c)}),a.closePath();const n=a.createLinearGradient(64*.3,0,64*.6,64);n.addColorStop(0,"rgba(255,255,255,1)"),n.addColorStop(.45,"rgba(255,255,255,0.85)"),n.addColorStop(1,"rgba(255,255,255,0.55)"),a.fillStyle=n,a.fill(),a.beginPath(),a.moveTo(64*.5,64*.05),a.lineTo(64*.62,64*.34),a.lineTo(64*.5,64*.5),a.lineTo(64*.4,64*.3),a.closePath(),a.fillStyle="rgba(255,255,255,0.9)",a.fill();const s=new nt(e);return s.needsUpdate=!0,s}function ik(t,e,a,o){const n=[],s=[],i=Math.PI*2/a,r=i*o,l=6;let h=0;for(let d=0;d<a;d++){const p=d*i;for(let u=0;u<=l;u++){const m=p+u/l*r;n.push(Math.sin(m)*t,0,Math.cos(m)*t),n.push(Math.sin(m)*e,0,Math.cos(m)*e)}for(let u=0;u<l;u++){const m=h+u*2;s.push(m,m+1,m+2,m+1,m+3,m+2)}h+=(l+1)*2}const c=new Cn;return c.setAttribute("position",new Ls(n,3)),c.setIndex(s),c.computeVertexNormals(),c}function zr(t,e){const a=U.degToRad(U.clamp(e,1,360))/2,o=Math.max(8,Math.round(e/8)),n=[0,0,0],s=[.5,0];for(let l=0;l<=o;l++){const h=-a+l/o*a*2;n.push(Math.sin(h)*t,0,Math.cos(h)*t),s.push(l/o,1)}const i=[];for(let l=1;l<o+1;l++)i.push(0,l,l+1);const r=new Cn;return r.setAttribute("position",new Ls(n,3)),r.setAttribute("uv",new Ls(s,2)),r.setIndex(i),r.computeVertexNormals(),r}function rk(t,e=8,a=.45){const o=e*2,n=[0,0,0];for(let r=0;r<=o;r++){const l=r/o*Math.PI*2,h=r%2===0?t:t*a;n.push(Math.sin(l)*h,0,Math.cos(l)*h)}const s=[];for(let r=1;r<o+1;r++)s.push(0,r,r+1);const i=new Cn;return i.setAttribute("position",new Ls(n,3)),i.setIndex(s),i.computeVertexNormals(),i}const lk=96,hk=10,ck=16,Tp=.09,Sp=.2;function Ap(t,e,a){const o=t.clone().convertLinearToSRGB(),n=e.clone().convertLinearToSRGB();return o.lerp(n,a).convertSRGBToLinear()}function dk(t,e){return t.clone().convertLinearToSRGB().multiplyScalar(e).convertSRGBToLinear()}function Hr(t){t.traverse(e=>{const a=e.material;if(a)for(const o of Array.isArray(a)?a:[a])o.userData?.__ownMat&&o.dispose()})}class pk{group=new ie;projectilePool=new Map;shellPool=new Map;splatPool=new Map;trailPool=new Map;materialCache=new Map;transientEffects=[];castTelegraphs=new Map;lastSyncElapsedMs=0;projectileGeo=new st(Ze(10),10,8);splatGeo=new Qa(2*Ze(Ur)/mn,2*Ze(Ur)/mn);trailGeo=new Qa(2*Ze(It.radius)/mn,2*Ze(It.radius)/mn);glazeTex=Array.from({length:Lr},(e,a)=>Y5(a));haloTex=ok();haloMats=new Map;shellBox=new vn;shellSize=new pe;splatMats=this.glazeTex.map(e=>this.groundMarkMat(H5,e));trailMats=[];trailMatsFor(e){let a=this.trailMats[e];if(!a){const o=xp[e]??xp[0];a=this.glazeTex.map(n=>this.groundMarkMat(o,n)),this.trailMats[e]=a}return a}groundMarkMat(e,a){const o=$5(Bh(e,{transparent:!0,opacity:1}));return o.map=a,o.needsUpdate=!0,o}glowTex=q5();softDiscTex=B5();starTex=j5();streakTex=G5();shardTex=sk();wedgeGradientTex=W5();telegraphRimTex=U5();particles=[];wedges=[];rings=[];wedgeGeoCache=new Map;ringUnitGeo=new xa(.62,1,40);wardGeo=ik(S5,A5,R5,I5);statusBySlot=[];buildStatusVisual;ensureSlots(e){for(;this.statusBySlot.length<e;)this.statusBySlot.push(this.buildStatusVisual()),this.slowSplashState.push({lastX:NaN,lastY:NaN,distAccum:0}),this.statusSnapshot.push({x:NaN,y:NaN,stunReady:!0,slowReady:!0})}slowSplashState=[];statusSnapshot=[];constructor(e){this.group.name="vfx_layer",e.add(this.group);for(let o=0;o<lk;o++){const n=new Ut({map:this.glowTex,color:16777215,transparent:!0,opacity:0,depthWrite:!1,blending:at}),s=new Ya(n);s.visible=!1,s.renderOrder=10,this.group.add(s),this.particles.push({sprite:s,mat:n,active:!1,life:0,maxLife:1,vx:0,vy:0,vz:0,gravity:0,startScale:1,endScale:1,startOpacity:1,endOpacity:0,fadeEase:1,aspect:1})}for(let o=0;o<hk;o++){const n=new Y({color:16777215,map:this.wedgeGradientTex,transparent:!0,opacity:0,side:be,depthWrite:!1}),s=new E(zr(.01,10),n);s.visible=!1,s.renderOrder=5,this.group.add(s),this.wedges.push({mesh:s,mat:n,active:!1,life:0,maxLife:1,startOpacity:.6})}for(let o=0;o<ck;o++){const n=new Y({color:16777215,transparent:!0,opacity:0,side:be,depthWrite:!1,blending:at}),s=new E(this.ringUnitGeo,n);s.rotation.x=-Math.PI/2,s.visible=!1,s.renderOrder=6,this.group.add(s),this.rings.push({mesh:s,mat:n,active:!1,life:0,maxLife:1,startScale:.1,targetScale:1,startOpacity:.9})}const a=()=>{const o=new Y({color:z5,transparent:!0,opacity:0,side:be,depthWrite:!1}),n=new E(new xa(.55,.95,28),o);n.rotation.x=-Math.PI/2,n.visible=!1,n.renderOrder=3,this.group.add(n);const s=new Y({color:D5,transparent:!0,opacity:0,side:be,depthWrite:!1}),i=new E(new xa(.64,.86,28),s);i.rotation.x=-Math.PI/2,i.visible=!1,i.renderOrder=4,this.group.add(i);const r=new Ut({map:this.softDiscTex,color:F5,transparent:!0,opacity:0,depthTest:!1,depthWrite:!1}),l=new Ya(r);l.scale.set(C5,O5,1),l.visible=!1,l.renderOrder=8,this.group.add(l);const h=[];for(let p=0;p<T5;p++){const u=new Ut({map:this.starTex,color:"#FFE75E",transparent:!0,opacity:0,depthWrite:!1,blending:at}),m=new Ya(u);m.scale.set(gp,gp,1),m.visible=!1,m.renderOrder=11,this.group.add(m),h.push(m)}const c=new Y({color:Nr,transparent:!0,opacity:0,side:be,depthWrite:!1}),d=new E(this.wardGeo,c);return d.visible=!1,d.renderOrder=2,this.group.add(d),{slowRing:i,slowRingDark:n,slowTint:l,stunStars:h,wardRing:d,wardMat:c,wardPop:0,wardPopColor:new Kt(Nr)}};this.buildStatusVisual=a,this.ensureSlots(2),window.__vfxSpawnTest=(o,n,s,i=14,r="#FFC93C",l,h,c)=>{const d=l??"hamburger",p=h?re[d]?.weapons?.find(u=>u.key===h):void 0;if(o==="impact")this.spawnImpactBurst(n,s,r,i,p?{weapon:p,characterId:d,fromXWU:n-60,fromYWU:s}:void 0);else if(o==="death")this.spawnDeathBurst(n,s,r);else if(o==="heal")this.spawnHealPulse(n,s);else if(o==="puddleSplash"){const u=Le(n,s);this.spawnPuddleSplash(u.x,u.z)}else if(o==="meleeArc")this.spawnMeleeArc(n,s,{x:1,y:0},p?.range??70,p?.cone??80,p?.color??r);else if(o==="giantSlam")this.spawnGiantSlamShockwave(n,s,p?.color??r,p?.range??ja.ultimateSlam);else if(o==="coverScuff")this.spawnCoverScuff(n,s,p?.color??r,1,0);else if(o==="castTelegraph"){const u=p??{key:"qa",name:"qa",type:"melee",range:84,cone:100,damage:i,cooldown:1,color:r,effect:null},m=c??u.castMs??1100;this.spawnCastTelegraph(0,n,s,{x:1,y:0},u,d,m)}else if(o==="weaponFired"){const u=p??{key:"qa",name:"qa",type:"ranged",range:100,damage:i,cooldown:1,color:r,effect:null};this.spawnWeaponCast(n,s,{x:1,y:0},u,d)}else{const u=p??{key:"qa",name:"qa",type:"ranged",range:100,damage:i,cooldown:1,color:r,effect:null};this.spawnCastFlash(n,s,{x:1,y:0},u,d)}},window.__vfxLayer=this}sync(e){const a=_e(e);this.ensureSlots(a.length);const o=s=>({x:s.x,y:s.y,hp:s.hp,alive:s.alive,terrainSlowFactor:s.terrainSlowFactor});window.__vfxDebugFighters={player:o(a[0]),enemy:o(a[1]??a[0]),slots:a.map(o)};const n=Math.max(0,(e.elapsed-this.lastSyncElapsedMs)/1e3);this.lastSyncElapsedMs=e.elapsed,ys(this.projectilePool,this.group,e.projectiles,s=>{const i=mt(e,s.ownerId,s.ownerRole),r=pn(i.characterId,s.weapon.key);if(r?.projectile){const h=Le(s.x,s.y),c=Dr(s.vx,s.vy),d={THREE:Qo,position:new pe(h.x,bo,h.z),direction:new pe(c.x,0,c.y),color:s.color,damage:s.damage,weapon:s.weapon,characterId:i.characterId,spawnTransient:(u,m,f)=>this.spawnTransientObject(u,m,f)},p=r.projectile(d);return p.userData.weaponVfx=r,p.name=`projectile:${i.characterId}.${s.weapon.key}`,this.measureShell(p),p}const l=new E(this.projectileGeo,this.materialFor(s.color));return l.name=`projectile:${i.characterId}.${s.weapon.key}`,this.measureShell(l),l},(s,i)=>{const r=mt(e,i.ownerId,i.ownerRole),l=s.userData.weaponVfx,h=Le(i.x,i.y),c=s.userData.shellSpec?.scale??1;if(!l){const u=s;if(u.material=this.materialFor(i.color),i.arrived){const m=(i.peckTimer??0)/500,f=1+Math.sin(m*Math.PI)*.5;u.scale.setScalar(f*c)}else u.scale.setScalar(c);u.position.set(h.x,bo,h.z);return}s.position.set(h.x,bo,h.z);const d=Dr(i.vx,i.vy);(d.x!==0||d.y!==0)&&(s.rotation.y=Math.atan2(d.x,d.y));const p=s.userData.__authoredScale??=s.scale.clone();if(s.scale.copy(p),l.trail){const u={THREE:Qo,position:s.position.clone(),direction:new pe(d.x,0,d.y),color:i.color,damage:i.damage,weapon:i.weapon,characterId:r.characterId,spawnTransient:(m,f,g)=>this.spawnTransientObject(m,f,g),object:s,dt:n};l.trail(u)}p.copy(s.scale),s.scale.multiplyScalar(c)}),ys(this.shellPool,this.group,e.projectiles,s=>{const r=`${mt(e,s.ownerId,s.ownerRole).characterId}.${s.weapon.key}`,h=this.projectilePool.get(s.id)?.userData.shellSpec?.haloR??Ep,c=new ie;c.name=`projectile_shell:${r}`;let d=this.haloMats.get(s.color);d||(d=new Ut({map:this.haloTex,color:new Kt(nk(s.color)),transparent:!0,opacity:1,depthWrite:!1}),this.haloMats.set(s.color,d));const p=new Ya(d);return p.name=`projectile_halo:${r}`,p.scale.set(h*2,h*2,1),p.renderOrder=ak,c.add(p),c},(s,i)=>{const r=Le(i.x,i.y);s.position.set(r.x,bo,r.z)}),ys(this.splatPool,this.group,e.splats,s=>{const i=new E(this.splatGeo,this.splatMats[s.id%Lr]);return i.rotation.set(-Math.PI/2,0,Mp(s.id)),i},(s,i)=>{const r=Le(i.x,i.y);s.position.set(r.x,x5,r.z)}),ys(this.trailPool,this.group,e.trailMarks,s=>{const i=new E(this.trailGeo,this.trailMatsFor(aa(s.ownerId,s.ownerRole))[s.id%Lr]);return i.rotation.set(-Math.PI/2,0,Mp(s.id)),i},(s,i)=>{const r=Le(i.x,i.y),l=(e.elapsed+i.id*137)*.004,h=1+Math.sin(l)*.08;s.position.set(r.x,v5,r.z),s.scale.setScalar(h)}),a.forEach((s,i)=>{const r=this.statusBySlot[i];if(!r)return;const l=Le(s.x,s.y),h=s.alive&&s.terrainSlowFactor<1,c=s.alive&&e.elapsed<s.status.slowedUntil,d=h||c;if(r.slowRing.visible=d,r.slowRingDark.visible=d,r.slowTint.visible=d,d){const M=.9+Math.sin(e.elapsed*.0035)*.12,y=e.elapsed*.0012;r.slowRingDark.position.set(l.x,bs-.01,l.z),r.slowRingDark.scale.setScalar(M),r.slowRingDark.rotation.z=y,r.slowRingDark.material.opacity=.5,r.slowRing.position.set(l.x,bs,l.z),r.slowRing.scale.setScalar(M),r.slowRing.rotation.z=y,r.slowRing.material.opacity=.9,r.slowTint.position.set(l.x,N5,l.z);const v=L5+Math.sin(e.elapsed*.006)*.08;r.slowTint.material.opacity=v}const p=this.slowSplashState[i];if(h){if(Number.isFinite(p.lastX))for(p.distAccum+=Math.hypot(s.x-p.lastX,s.y-p.lastY);p.distAccum>=yp;)p.distAccum-=yp,this.spawnPuddleSplash(l.x,l.z)}else p.distAccum=0;p.lastX=s.x,p.lastY=s.y;const u=e.elapsed>=qs(s,"stun"),m=e.elapsed>=qs(s,"slow");this.statusSnapshot[i]={x:s.x,y:s.y,stunReady:u,slowReady:m};const f=s.alive&&!u&&e.elapsed>=s.status.stunnedUntil,g=s.alive&&!m&&e.elapsed>=s.status.slowedUntil,w=f||g,b=r.wardPop>0?r.wardPop/bp:0;r.wardRing.visible=w||b>0,r.wardRing.visible&&(r.wardRing.position.set(l.x,bs-.02,l.z),r.wardRing.rotation.y=-e.elapsed*.0019,r.wardRing.scale.setScalar(1+.5*b),r.wardMat.opacity=w?wp+(1-wp)*b:b,r.wardMat.color.copy(Nr).lerp(r.wardPopColor,b));const x=s.alive&&e.elapsed<s.status.stunnedUntil;r.stunStars.forEach((M,y)=>{if(M.visible=x,!x)return;const v=e.elapsed*.006+y*Math.PI*2/r.stunStars.length;M.position.set(l.x+Math.cos(v)*mp,E5+Math.sin(e.elapsed*.01+y)*.05,l.z+Math.sin(v)*mp),M.material.opacity=.95})})}updateEffects(e){for(const a of this.particles){if(!a.active)continue;if(a.life+=e,a.life>=a.maxLife){a.active=!1,a.sprite.visible=!1;continue}const o=a.life/a.maxLife;a.vy+=a.gravity*e,a.sprite.position.x+=a.vx*e,a.sprite.position.y+=a.vy*e,a.sprite.position.z+=a.vz*e;const n=U.lerp(a.startScale,a.endScale,kp(o));a.sprite.scale.set(n,n*a.aspect,1),a.mat.opacity=Math.max(0,U.lerp(a.startOpacity,a.endOpacity,Math.pow(o,a.fadeEase)))}for(const a of this.wedges){if(!a.active)continue;if(a.life+=e,a.life>=a.maxLife){a.active=!1,a.mesh.visible=!1;continue}const o=a.life/a.maxLife;a.mat.opacity=a.startOpacity*(1-Math.pow(o,1.8))}for(const a of this.rings){if(!a.active)continue;if(a.life+=e,a.life>=a.maxLife){a.active=!1,a.mesh.visible=!1;continue}const o=a.life/a.maxLife,n=U.lerp(a.startScale,a.targetScale,kp(o));a.mesh.scale.set(n,n,n),a.mat.opacity=a.startOpacity*(1-o)}for(const a of this.statusBySlot)a.wardPop>0&&(a.wardPop=Math.max(0,a.wardPop-e));for(let a=this.transientEffects.length-1;a>=0;a--){const o=this.transientEffects[a];if(o.life+=e,o.life>=o.maxLife){this.group.remove(o.object),Hr(o.object),o.telegraphOwner!==void 0&&this.castTelegraphs.get(o.telegraphOwner)===o.object&&this.castTelegraphs.delete(o.telegraphOwner),this.transientEffects.splice(a,1);continue}o.onUpdate?.(o.life/o.maxLife,o.life)}}spawnTransientObject(e,a,o,n){this.group.add(e),this.transientEffects.push({object:e,life:0,maxLife:Math.max(.001,a),onUpdate:o,telegraphOwner:n})}spawnCastTelegraph(e,a,o,n,s,i,r){if(!(r>0))return;const l=s.range??0;if(!(l>0))return;Jt("castTelegraph"),this.cancelCastTelegraph(e,"resolved");const h=Le(a,o),c=s.type==="melee"?s.cone??360:Math.max(12,s.spreadDeg??18),d=Ze(l),p=pn(i,s.key)?.telegraph,u=s.giantSlam!==!0;if(!u&&!p)return;const m=`${Math.round(c)}_${d.toFixed(3)}`;let f=this.wedgeGeoCache.get(m);f||(f=zr(d,c),this.wedgeGeoCache.set(m,f));const g=new Kt(s.color),w=Math.atan2(n.x,n.y),b=(F,N,L,P,W)=>{const H=new Y({color:N,map:W?this.telegraphRimTex:null,transparent:!0,opacity:0,depthWrite:!1,side:be});H.userData.__ownMat=!0;const K=new E(f,H);return K.name=F,K.rotation.y=w,K.position.set(0,L,0),K.renderOrder=P,K},x=new ie;x.name="castTelegraph",x.position.set(h.x,Pa,h.z);const M=u?b("castTelegraphBase",dk(g,.26),0,5,!1):null,y=u?b("castTelegraphFill",Ap(g,wt,.22),.012,5.01,!1):null,v=u?b("castTelegraphRim",Ap(g,wt,.6),.024,5.02,!0):null;M&&y&&v&&x.add(M,y,v);const k=r/1e3,T=M?.material,S=y?.material,A=v?.material;this.castTelegraphs.set(e,x);const C=(F,N)=>{if(!M||!y||!v||!T||!S||!A)return;const L=U.clamp(N/k,0,1),P=N<=k?1:Math.max(0,1-(N-k)/Tp),W=.5+.5*Math.sin(Math.PI*2*(2*L+3*L*L));T.opacity=(.6+.14*W)*P;const H=.1+.9*L;y.scale.set(H,1,H),S.opacity=(.7+.22*L)*P,A.opacity=(.62+.36*L*L)*P};if(C(0,0),this.spawnTransientObject(x,k+Tp,C,e),!p)return;const R={THREE:Qo,position:new pe(h.x,Or,h.z),direction:new pe(n.x,0,n.y).normalize(),color:s.color,damage:s.damage,weapon:s,characterId:i,castMs:r,spawnTransient:(F,N,L)=>this.spawnTransientObject(F,N,L,e)};p(R)}cancelCastTelegraph(e,a){const o=this.castTelegraphs.get(e);if(o){this.castTelegraphs.delete(e);for(let n=this.transientEffects.length-1;n>=0;n--){const s=this.transientEffects[n];if(s.telegraphOwner===e){if(s.object===o&&a!=="resolved"){const i=s.life,r=o.children.map(l=>l.material.opacity);s.maxLife=i+Sp,s.onUpdate=(l,h)=>{const c=U.clamp((h-i)/Sp,0,1),d=Math.max(.001,1-c);o.scale.set(d,1,d);for(let p=0;p<o.children.length;p++){const u=o.children[p].material;u.opacity=r[p]*(1-c)}};continue}this.group.remove(s.object),Hr(s.object),this.transientEffects.splice(n,1)}}}}spawnWeaponCast(e,a,o,n,s){const i=!!pn(s,n.key)?.cast;this.spawnCastFlash(e,a,o,n,s),n.type==="melee"&&(n.giantSlam&&i||this.spawnMeleeArc(e,a,o,n.range??0,n.cone??360,n.color)),n.giantSlam&&this.spawnGiantSlamShockwave(e,a,n.color,n.range??0,{bespokeOwnsGround:i})}spawnCastFlash(e,a,o,n,s){Jt("cast");const i=Le(e,a),r=Math.hypot(o.x,o.y)||1,l=o.x/r,h=o.y/r,c=.7,d=n.color,p=pn(s,n.key)?.cast;if(this.castMuzzle(i.x+l*c,i.z+h*c,d,p?"subordinate":"primary"),!p)return;const u={THREE:Qo,position:new pe(i.x+l*c,Or,i.z+h*c),direction:new pe(l,0,h),color:d,damage:n.damage,weapon:n,characterId:s,spawnTransient:(m,f,g)=>this.spawnTransientObject(m,f,g)};p(u)}castMuzzle(e,a,o,n){const s=n==="primary"?1:.75,i=this.allocParticle();i.active=!0,i.life=0,i.maxLife=n==="primary"?.16:.13,i.sprite.visible=!0,i.sprite.position.set(e,Or,a),i.vx=0,i.vy=0,i.vz=0,i.gravity=0,i.startScale=.75*s,i.endScale=1.3*s,i.startOpacity=1,i.endOpacity=0,i.fadeEase=1.6,i.mat.color.set(o).lerp(wt,.4)}spawnMeleeArc(e,a,o,n,s,i){Jt("meleeArc");const r=Le(e,a),l=Ze(n),h=`${Math.round(s)}_${l.toFixed(3)}`;let c=this.wedgeGeoCache.get(h);c||(c=zr(l,s),this.wedgeGeoCache.set(h,c));const d=this.allocWedge();d.active=!0,d.life=0,d.maxLife=.3,d.startOpacity=.88,d.mesh.visible=!0,d.mesh.geometry=c,d.mesh.rotation.y=Math.atan2(o.x,o.y),d.mesh.position.set(r.x,Pa,r.z),d.mat.color.set(i).lerp(P5,.14),d.mat.opacity=d.startOpacity}spawnImpactStarDecal(e,a,o,n){const s=`star_${o.toFixed(3)}`;let i=this.wedgeGeoCache.get(s);i||(i=rk(o,8,.42),this.wedgeGeoCache.set(s,i));const r=this.allocWedge();r.active=!0,r.life=0,r.maxLife=n,r.startOpacity=.9,r.mesh.visible=!0,r.mesh.geometry=i,r.mesh.rotation.y=Math.random()*Math.PI*2,r.mesh.position.set(e.x,Pa+.03,e.z),r.mat.map=null,r.mat.needsUpdate=!0,r.mat.color.set(a).lerp(wt,.05),r.mat.opacity=r.startOpacity}spawnImpactBurst(e,a,o,n,s){Jt("impact");const i=Le(e,a);(s?.weapon.effect==="stun"||s?.weapon.effect==="slow")&&this.flagStatusRefused(e,a,s.weapon.effect,s.weapon.color);const r=s&&pn(s.characterId,s.weapon.key)?.impact;if(this.impactAnchor(i,o,n,r?"subordinate":"primary"),r&&s){let l=0,h=0;if(s.fromXWU!==void 0&&s.fromYWU!==void 0){const d=Dr(e-s.fromXWU,a-s.fromYWU);l=d.x,h=d.y}const c={THREE:Qo,position:new pe(i.x,_a,i.z),direction:new pe(l,0,h),color:o,damage:n,weapon:s.weapon,characterId:s.characterId,spawnTransient:(d,p,u)=>this.spawnTransientObject(d,p,u)};r(c)}}impactAnchor(e,a,o,n){const s=n==="primary"?1:k5,i=U.clamp(.42+o*.075,.42,2)*s,r=Math.max(2,Math.round(U.clamp(1+o*.4,2,8)*s));if(n==="primary"){this.burst(e,a,i,r);return}this.burst(e,a,i,0,{skipFlash:!0,skipStreaks:!0,decalMinRadius:M5})}flagStatusRefused(e,a,o,n){for(let s=0;s<this.statusSnapshot.length;s++){const i=this.statusSnapshot[s];if(!Number.isFinite(i.x)||Math.hypot(i.x-e,i.y-a)>1)continue;if(o==="stun"?i.stunReady:i.slowReady)return;const l=this.statusBySlot[s];if(l){l.wardPop=bp,l.wardPopColor.set(n).lerp(wt,.35);return}}}spawnDeathBurst(e,a,o){Jt("death");const n=Le(e,a);this.burst(n,o,2.6,9,{life:1.35})}spawnHealPulse(e,a){Jt("heal");const o=Le(e,a),n=7;for(let s=0;s<n;s++){const i=this.allocParticle(),r=s/n*Math.PI*2+Math.random()*.5,l=.66+Math.random()*.3;i.active=!0,i.life=0,i.maxLife=.72+Math.random()*.22,i.sprite.visible=!0,i.sprite.position.set(o.x+Math.cos(r)*l,Q*.22,o.z+Math.sin(r)*l),i.vx=Math.cos(r)*.22,i.vz=Math.sin(r)*.22,i.vy=2+Math.random()*.45,i.gravity=-.45,i.startScale=.46+Math.random()*.14,i.endScale=.14,i.startOpacity=.95,i.endOpacity=0,i.fadeEase=1,i.mat.color.set("#6FE0A8")}}spawnPuddleSplash(e,a){Jt("puddleSplash");const o=5;for(let n=0;n<o;n++){const s=this.allocParticle(),i=n/o*Math.PI*2+Math.random()*1,r=Ua*(.58+Math.random()*.16);s.active=!0,s.life=0,s.maxLife=.3+Math.random()*.12,s.sprite.visible=!0,s.sprite.position.set(e+Math.cos(i)*r,bs,a+Math.sin(i)*r);const l=2.2+Math.random()*.6;s.vx=Math.cos(i)*l,s.vz=Math.sin(i)*l,s.vy=1.1+Math.random()*.5,s.gravity=-5.5,s.startScale=.58+Math.random()*.2,s.endScale=.12,s.startOpacity=1,s.endOpacity=0,s.fadeEase=1,s.mat.color.set("#E8F8FF")}}spawnCoverScuff(e,a,o,n,s){Jt("coverScuff");const i=Le(e,a),r=Math.hypot(n,s),l=r>1e-4?-n/r:0,h=r>1e-4?-s/r:-1,c=this.allocParticle();c.active=!0,c.life=0,c.maxLife=.12,c.sprite.visible=!0,c.sprite.position.set(i.x,bo,i.z),c.vx=0,c.vy=0,c.vz=0,c.gravity=0,c.startScale=.42,c.endScale=.85,c.startOpacity=1,c.endOpacity=0,c.fadeEase=1.4,c.mat.color.set(o).lerp(wt,.6);for(let d=0;d<5;d++){const p=(Math.random()-.5)*(Math.PI*2/3),u=Math.cos(p),m=Math.sin(p),f=l*u-h*m,g=l*m+h*u,w=this.allocParticle();w.mat.map=this.streakTex,w.mat.rotation=Math.atan2(g,f),w.aspect=.22,w.active=!0,w.life=0,w.maxLife=.22+Math.random()*.1,w.sprite.visible=!0,w.sprite.position.set(i.x+l*.22,bo,i.z+h*.22),w.vx=f*(2.4+Math.random()*1.6),w.vz=g*(2.4+Math.random()*1.6),w.vy=.9+Math.random()*.7,w.gravity=-7.5,w.startScale=.62+Math.random()*.28,w.endScale=.12,w.startOpacity=1,w.endOpacity=0,w.fadeEase=1.2,w.mat.color.set(vp)}}spawnGiantSlamShockwave(e,a,o,n,s){Jt("giantSlam");const i=Le(e,a),r=Ze(n);if(!(s?.bespokeOwnsGround??!1)){const h=this.allocRing();h.active=!0,h.life=0,h.maxLife=.65,h.startScale=.3,h.targetScale=r*1.05,h.startOpacity=1,h.mesh.visible=!0,h.mesh.position.set(i.x,Pa+.02,i.z),h.mesh.scale.setScalar(h.startScale),h.mat.color.set(o).lerp(wt,.3),h.mat.opacity=h.startOpacity;const c=this.allocRing();c.active=!0,c.life=0,c.maxLife=.8,c.startScale=.15,c.targetScale=r*.85,c.startOpacity=.6,c.mesh.visible=!0,c.mesh.position.set(i.x,Pa+.01,i.z),c.mesh.scale.setScalar(c.startScale),c.mat.color.set(o),c.mat.opacity=c.startOpacity,this.spawnStarPop(i,_a*1.5,o,5.2,.38);const d=this.allocParticle();d.active=!0,d.life=0,d.maxLife=.3,d.sprite.visible=!0,d.sprite.position.set(i.x,_a*1.5,i.z),d.vx=0,d.vy=0,d.vz=0,d.gravity=0,d.startScale=1.8,d.endScale=3.5,d.startOpacity=.9,d.endOpacity=0,d.fadeEase=1.2,d.mat.color.set(o).lerp(wt,.4),this.spawnStreaks(i,_a*.6,"#FFE79A",10,4.5,.55)}this.burst(i,o,3.2,14,{life:.9,speedMult:1.7,skipFlash:!0,skipRing:!0,skipStreaks:!0,skipDecal:!0})}burst(e,a,o,n,s){const i=s?.life??1,r=s?.speedMult??1;if(s?.skipDecal||this.spawnImpactStarDecal(e,a,U.clamp(.65*o,s?.decalMinRadius??.55,1.5),(.55+o*.08)*i),!s?.skipFlash){const h=this.allocParticle();h.active=!0,h.life=0,h.maxLife=(.16+o*.04)*i,h.sprite.visible=!0,h.sprite.position.set(e.x,_a,e.z),h.vx=0,h.vy=0,h.vz=0,h.gravity=0,h.startScale=.5*o,h.endScale=1.15*o,h.startOpacity=1,h.endOpacity=0,h.fadeEase=1.4,h.mat.color.set(a).lerp(wt,.3)}if(!s?.skipRing){const h=this.allocRing();h.active=!0,h.life=0,h.maxLife=(.24+o*.06)*i,h.startScale=.15,h.targetScale=.6*o+.35,h.startOpacity=.95,h.mesh.visible=!0,h.mesh.position.set(e.x,Pa,e.z),h.mesh.scale.setScalar(h.startScale),h.mat.color.set(a).lerp(wt,.25),h.mat.opacity=h.startOpacity;const c=this.allocRing();c.active=!0,c.life=0,c.maxLife=(.32+o*.08)*i,c.startScale=.1,c.targetScale=(.6*o+.35)*1.35,c.startOpacity=.55,c.mesh.visible=!0,c.mesh.position.set(e.x,Pa-.01,e.z),c.mesh.scale.setScalar(c.startScale),c.mat.color.set(a),c.mat.opacity=c.startOpacity}if(!s?.skipStreaks){const h=Math.max(4,Math.round(n*.7));this.spawnStreaks(e,_a,"#FFE79A",h,(.5+o*.5)*r,.26*i)}const l=.4*o;for(let h=0;h<n;h++){const c=this.allocParticle();c.mat.map=this.shardTex;const d=Math.random()*Math.PI*2;c.mat.rotation=d,c.aspect=.4+Math.random()*.15;const p=(2.6+Math.random()*2.8)*(.6+o*.4)*r,u=.18+Math.random()*.24;c.active=!0,c.life=0,c.maxLife=(.36+Math.random()*.22+o*.06)*i,c.sprite.visible=!0,c.sprite.position.set(e.x+Math.cos(d)*u,_a,e.z+Math.sin(d)*u),c.vx=Math.cos(d)*p,c.vz=Math.sin(d)*p,c.vy=1.3+Math.random()*1.8,c.gravity=-6.2,c.startScale=l*(.8+Math.random()*.5),c.endScale=l*.2,c.startOpacity=1,c.endOpacity=0,c.fadeEase=.85,c.mat.color.set(vp)}}allocParticle(){let e=null;for(const o of this.particles)if(!o.active){e=o;break}if(!e){let o=-1/0;for(const n of this.particles){const s=n.life/n.maxLife;s>o&&(o=s,e=n)}}const a=e;return a.mat.map=this.glowTex,a.mat.rotation=0,a.aspect=1,a}spawnStarPop(e,a,o,n,s){const i=this.allocParticle();i.mat.map=this.starTex,i.active=!0,i.life=0,i.maxLife=s,i.sprite.visible=!0,i.sprite.position.set(e.x,a,e.z),i.vx=0,i.vy=0,i.vz=0,i.gravity=0,i.startScale=n*.5,i.endScale=n,i.startOpacity=1,i.endOpacity=0,i.fadeEase=1.7,i.mat.color.set(o).lerp(wt,.45)}spawnStreaks(e,a,o,n,s,i){for(let r=0;r<n;r++){const l=this.allocParticle();l.mat.map=this.streakTex,l.mat.rotation=Math.random()*Math.PI*2,l.aspect=.22,l.active=!0,l.life=0,l.maxLife=i*(.8+Math.random()*.4),l.sprite.visible=!0,l.sprite.position.set(e.x,a,e.z),l.vx=0,l.vy=0,l.vz=0,l.gravity=0,l.startScale=s*(.7+Math.random()*.3),l.endScale=s*1.35,l.startOpacity=.95,l.endOpacity=0,l.fadeEase=1.3,l.mat.color.set(o).lerp(wt,.3)}}allocWedge(){let e;for(const a of this.wedges)if(!a.active){e=a;break}return e||(e=this.wedges.reduce((a,o)=>a.life/a.maxLife>=o.life/o.maxLife?a:o)),e.mat.map!==this.wedgeGradientTex&&(e.mat.map=this.wedgeGradientTex,e.mat.needsUpdate=!0),e}allocRing(){for(const e of this.rings)if(!e.active)return e;return this.rings.reduce((e,a)=>e.life/e.maxLife>=a.life/a.maxLife?e:a)}clear(){for(const e of[this.projectilePool,this.shellPool,this.splatPool,this.trailPool]){for(const a of e.values())this.group.remove(a);e.clear()}for(const e of this.particles)e.active=!1,e.sprite.visible=!1;for(const e of this.wedges)e.active=!1,e.mesh.visible=!1;for(const e of this.rings)e.active=!1,e.mesh.visible=!1;for(const e of this.transientEffects)this.group.remove(e.object),Hr(e.object);this.transientEffects.length=0,this.castTelegraphs.clear(),this.lastSyncElapsedMs=0;for(let e=0;e<this.statusBySlot.length;e++){const a=this.statusBySlot[e];a.slowRing.visible=!1,a.slowRingDark.visible=!1,a.slowTint.visible=!1,a.stunStars.forEach(n=>{n.visible=!1}),a.wardRing.visible=!1,a.wardPop=0,this.statusSnapshot[e]={x:NaN,y:NaN,stunReady:!0,slowReady:!0};const o=this.slowSplashState[e];o.lastX=NaN,o.lastY=NaN,o.distAccum=0}}dispose(){this.clear(),delete window.__vfxSpawnTest,window.__vfxLayer===this&&delete window.__vfxLayer,this.projectileGeo.dispose(),this.splatGeo.dispose(),this.trailGeo.dispose(),this.splatMats.forEach(e=>e.dispose()),Object.values(this.trailMats).forEach(e=>e.forEach(a=>a.dispose())),this.glazeTex.forEach(e=>e.dispose()),this.materialCache.forEach(e=>e.dispose()),this.materialCache.clear(),this.haloTex.dispose(),this.haloMats.forEach(e=>e.dispose()),this.haloMats.clear(),this.glowTex.dispose(),this.softDiscTex.dispose(),this.starTex.dispose(),this.streakTex.dispose(),this.shardTex.dispose(),this.wedgeGradientTex.dispose(),this.telegraphRimTex.dispose();for(const e of this.particles)e.mat.dispose();for(const e of this.wedges)e.mat.dispose();for(const e of this.rings)e.mat.dispose();this.wedgeGeoCache.forEach(e=>e.dispose()),this.wedgeGeoCache.clear(),this.ringUnitGeo.dispose(),this.wardGeo.dispose();for(const e of this.statusBySlot)e.slowRing.material.dispose(),e.slowRing.geometry.dispose(),e.slowRingDark.material.dispose(),e.slowRingDark.geometry.dispose(),e.slowTint.material.dispose(),e.stunStars.forEach(a=>a.material.dispose()),e.wardMat.dispose()}measureShell(e){let a=Ze(10);if(this.shellBox.setFromObject(e),!this.shellBox.isEmpty()){this.shellBox.getSize(this.shellSize);const s=.5*Math.max(this.shellSize.x,this.shellSize.y,this.shellSize.z);s>1e-4&&(a=s)}const o=Math.min(K5,Math.max(1,V5/a)),n=Math.min(Z5,Math.max(Ep,a*o*X5));e.userData.shellSpec={scale:o,haloR:n}}materialFor(e){let a=this.materialCache.get(e);return a||(a=Bh(e),this.materialCache.set(e,a)),a}}function Ml(t,e,a){return Vl(e.x,e.y,a.x,a.y,t.arena,t,a)}function Rp(t,e){return _e(t)[e.observerSlot??Fe]??Ke(t)}function _r(t){return t.phase==="playing"&&!Ke(t).alive}const Ip="hud-styles";function uk(){if(document.getElementById(Ip))return;const t=document.createElement("style");t.id=Ip,t.textContent=wk,document.head.appendChild(t)}function Fp(t){const e=Math.max(0,Math.ceil(t/1e3)),a=Math.floor(e/60),o=e%60;return`${a}:${String(o).padStart(2,"0")}`}function fk(t){const e=Math.max(0,Math.round(t/1e3)),a=Math.floor(e/60),o=e%60;return`${a}:${String(o).padStart(2,"0")}`}const Cp=.25,Op=.14;function mk(t,e,a,o){const n=o>0?Math.max(0,Math.min(1,a/o)):0;t.style.width=`${(n*100).toFixed(1)}%`,e.textContent=`${Math.max(0,Math.ceil(a))} / ${o}`}function gk(t,e){uk(),ha(),t.innerHTML=`
    <div class="hud-root">
  ...
  `;const a=j=>{const te=t.querySelector(`[data-el="${j}"]`);if(!te)throw new Error(`hud: missing element "${j}"`);return te},o=a("timer"),n=a("weapons"),s=a("spectate"),i=a("countdown"),r=a("gameover"),l=a("gameover-title"),h=a("gameover-place"),c=a("gameover-subtitle"),d=a("gameover-stats"),p=a("gameover-payout"),u=a("gameover-btn"),m=a("topbar"),f=t.querySelector(".hud-clock"),g=t.querySelector(".hud-root"),w=a("dmg-layer"),b=a("screenflash"),x=a("zone"),M=a("zone-label"),y=a("zone-value"),v=a("zone-bar"),k=a("radar"),T=a("radar-safe"),S=a("radar-arena"),A=a("radar-map"),C=a("radar-cap"),R=a("fogedge"),F=a("fogtick"),N=a("safearrow"),L=a("safearrow-label"),P=a("aim-stick"),W=a("aim-reticle"),H=a("mute");let K=[],O=null;function _(j){if(K.length===j)return;for(const he of K)he.bar.parentElement?.remove(),he.float.remove(),he.blip.remove();K=[],O?.remove(),O=null;const te=j>2;m.classList.toggle("hud-topbar--chips",te),te&&(O=document.createElement("div"),O.className="hud-chips",O.dataset.el="chips",m.appendChild(O));for(let he=0;he<j;he++){const q=Og(he),ue=he===0?"player":"enemy",le=te&&he>0,fe=document.createElement("div");fe.className=`hud-fighter hud-fighter--${ue}${le?" hud-fighter--chip":""}`;const Ae=`<div class="hud-fighter-level" data-el="${q}-level"><span class="hud-fighter-level-tag">LV</span><span class="hud-fighter-level-n" data-el="${q}-level-n"></span></div>`,qe=he===0?`<div class="hud-fighter-emoji" data-el="${q}-emoji"></div><div class="hud-fighter-name" data-el="${q}-name"></div>`+Ae:Ae+`<div class="hud-fighter-name" data-el="${q}-name"></div><div class="hud-fighter-emoji" data-el="${q}-emoji"></div>`;fe.innerHTML=`<div class="hud-fighter-pill">${qe}</div><div class="hud-healthbar hud-healthbar--${ue}" data-el="${q}-bar"><div class="hud-healthbar-fill" data-el="${q}-fill"></div><div class="hud-healthbar-text" data-el="${q}-hp"></div></div>`,he===0?m.insertBefore(fe,f):O?O.appendChild(fe):m.appendChild(fe);const He=document.createElement("div");He.className=`hud-float hud-float--${ue}`,He.dataset.el=`float-${q}`,He.innerHTML=`<div class="hud-float-pill"><div class="hud-float-emoji" data-el="float-${q}-emoji"></div><div class="hud-float-bar"><div class="hud-float-fill" data-el="float-${q}-fill"></div></div></div>`,k.parentElement.insertBefore(He,k);const Be=document.createElement("div");Be.className=`hud-radar-dot hud-radar-dot--${ue}`,Be.dataset.el=`radar-${q}`,he===0?A.appendChild(Be):A.insertBefore(Be,A.querySelector(".hud-radar-dot--player")),K.push({name:fe.querySelector(`[data-el="${q}-name"]`),emoji:fe.querySelector(`[data-el="${q}-emoji"]`),level:fe.querySelector(`[data-el="${q}-level-n"]`),levelValue:-1,bar:fe.querySelector(`[data-el="${q}-bar"]`),fill:fe.querySelector(`[data-el="${q}-fill"]`),hpText:fe.querySelector(`[data-el="${q}-hp"]`),float:He,floatEmoji:He.querySelector(`[data-el="float-${q}-emoji"]`),floatFill:He.querySelector(`[data-el="float-${q}-fill"]`),blip:Be})}}_(2);let z=0,V=null;function ce(){const j=ke.isMuted();if(j===V)return;const te=V===null;if(V=j,window.clearTimeout(z),j){H.innerHTML=D("mute")+"<span>MUTED · M</span>",H.classList.add("is-on"),H.classList.remove("is-ok");return}if(te){H.classList.remove("is-on","is-ok");return}H.innerHTML=D("sound")+"<span>SOUND ON · M</span>",H.classList.add("is-on","is-ok"),z=window.setTimeout(()=>H.classList.remove("is-on","is-ok"),1500)}const se=ke.onChange(ce);ce();const $=24,ee=[];let ye=0;for(let j=0;j<$;j++){const te=document.createElement("div");te.className="hud-dmg",w.appendChild(te),ee.push(te)}function Se(j,te){const he=j.replace("#",""),q=he.length===3?he.split("").map(Ae=>Ae+Ae).join(""):he,ue=parseInt(q.slice(0,2),16)||0,le=parseInt(q.slice(2,4),16)||0,fe=parseInt(q.slice(4,6),16)||0;return`rgba(${ue},${le},${fe},${te})`}u.addEventListener("click",()=>e.onRestart());let Ye=null,uo=[];function Bn(j){n.innerHTML="",uo=j.map((te,he)=>{const q=document.createElement("div");return q.className="hud-weapon-slot",q.innerHTML=`
        <div class="hud-weapon-cooldown"></div>
        <div class="hud-weapon-emoji">${A0(te.emoji)}</div>
        <div class="hud-weapon-timer" data-role="timer"></div>
        <div class="hud-weapon-key">${he+1}</div>
      `,q.addEventListener("pointerdown",ue=>{ue.preventDefault(),ue.stopPropagation(),e.onSelectWeapon?.(he)}),n.appendChild(q),{root:q,cooldown:q.querySelector(".hud-weapon-cooldown"),timer:q.querySelector('[data-role="timer"]'),wasReady:!0}})}const jn=Math.round(Il/Ns*1e3);function Vo(j,te){const he=Fi(j-tm.radiusUnits,j,te)-Fi(j,j,te);return he>0?Math.min(12e3,he):0}function Gn(j){const te=j.arena.maxSafeRadius,he=Ke(j),q=Math.hypot(he.x-j.arena.center.x,he.y-j.arena.center.y),ue=q>j.safeRadius,le=Ea-j.timeRemaining,fe=Os(j.fighters.length),Ae=q<=Bp(j.fighters.length,j.timeRemaining);return{outside:ue,holds:Ae,ringAtFloor:j.safeRadius<=fe,sudden:kn(j.timeRemaining),radius01:te>0?Math.max(0,Math.min(1,j.safeRadius/te)):0,msUntilEdge:ue||Ae?null:Fi(q,te,fe)-le}}const Fh=56;let Ch=0,Ti=-1,Oh=-1,Nh=-1;function Si(){if(window.innerWidth!==Ti||window.innerHeight!==Oh||K.length!==Nh){Ti=window.innerWidth,Oh=window.innerHeight,Nh=K.length;const j=m.getBoundingClientRect().bottom;Ch=j+36,w.style.setProperty("--fa-dmg-top",`${Math.max(0,Math.round(j+2))}px`),g.style.setProperty("--fa-topbar-b",`${Math.max(0,Math.round(j))}px`)}return Ch}let Wn=0;function ff(j,te){const he=_r(j);if(s.classList.toggle("is-on",he),!he){s.textContent!==""&&(s.textContent="");return}const q=Rp(j,te),le=q!==Ke(j)?`Spectating ${re[q.characterId].name}`:"Eliminated";s.textContent!==le&&(s.textContent=le)}function mf(j,te){const he=j.phase==="playing",q=Gn(j),ue=_r(j),le=he&&q.outside&&Ke(j).alive,fe=he&&q.sudden,Ae=j.arena.maxSafeRadius;x.classList.toggle("is-danger",le),x.classList.toggle("is-imminent",!le&&!ue&&q.msUntilEdge!==null&&q.msUntilEdge<Vo(Ae,Os(j.fighters.length))),v.style.width=`${(q.radius01*100).toFixed(1)}%`,fe?(M.textContent="SUDDEN DEATH",y.textContent="MOST HP WINS"):le?(M.textContent="▲ OUTSIDE THE ZONE",y.textContent=`−${jn} HP/s`):(M.textContent="ZONE CLOSES",y.textContent=ue?q.ringAtFloor?"FINAL RING":"CLOSING":q.msUntilEdge!==null?`REACHES YOU ${Fp(q.msUntilEdge)}`:q.holds?"FINAL RING":"CLOSING");const qe=j.arena.width,He=j.arena.height,Be=j.arena.center.x,Xt=j.arena.center.y,Ko=qe/He,fo=Math.max(Ae,Be,qe-Be)*(1+Op),Ai=Math.max(Xt,He-Xt)*(1+Op),_t=Math.max(2*fo,2*Ai*Ko),me=_t/Ko,gt=Je=>`${(50+(Je-Be)/_t*100).toFixed(2)}%`,mo=Je=>`${(50+(Je-Xt)/me*100).toFixed(2)}%`,Xo=Je=>`${(Je/_t*100).toFixed(2)}%`,Lh=Je=>`${(Je/me*100).toFixed(2)}%`;T.style.left=gt(Be),T.style.top=mo(Xt),T.style.width=Xo(j.safeRadius*2),T.style.height=Lh(j.safeRadius*2),S.style.left=gt(qe/2),S.style.top=mo(He/2),S.style.width=Xo(qe),S.style.height=Lh(He);const wf=Rp(j,te);_e(j).forEach((Je,Zo)=>{const go=K[Zo]?.blip;go&&(go.style.left=gt(Je.x),go.style.top=mo(Je.y),go.style.display=Zo===Fe?Je.alive?"block":"none":Je.alive&&Ml(j,wf,Je)?"block":"none")}),k.classList.toggle("is-danger",le),C.textContent=fe?"SUDDEN DEATH":le?"GET INSIDE":"SAFE ZONE",R.classList.toggle("is-on",le);const ua=le&&!fe?te.safeArrow??null:null;if(ua){N.style.display="block",L.style.display="block";const Je=ua.angleRad*180/Math.PI;N.style.transform=`translate(${ua.at.x.toFixed(1)}px, ${ua.at.y.toFixed(1)}px) rotate(${Je.toFixed(1)}deg)`,(Wn===0||window.innerWidth!==Ti)&&(Wn=L.offsetWidth/2);const Zo=8,go=Math.min(Math.max(ua.at.x+Math.cos(ua.angleRad)*178,Wn+Zo),window.innerWidth-Wn-Zo),bf=Math.min(Math.max(ua.at.y+Math.sin(ua.angleRad)*178,Si()+4),window.innerHeight-22);L.style.transform=`translate(${go.toFixed(1)}px, ${bf.toFixed(1)}px) translate(-50%, -50%)`}else N.style.display="none",L.style.display="none"}function gf(j){const te=j.aim??null;if(!te){P.style.display="none",W.style.display="none";return}const he=te.at.x-te.from.x,q=te.at.y-te.from.y,ue=Math.hypot(he,q),le=Math.atan2(q,he)*180/Math.PI;P.style.display="block",P.style.width=`${ue.toFixed(1)}px`,P.style.transform=`translate(${te.from.x.toFixed(1)}px, ${te.from.y.toFixed(1)}px) rotate(${le.toFixed(1)}deg)`,W.style.display="flex",W.style.transform=`translate(${te.at.x.toFixed(1)}px, ${te.at.y.toFixed(1)}px) translate(-50%, -50%)`}return{setCharacters(j){_(j.length),Ye=j[Fe]??null,j.forEach((te,he)=>{const q=K[he];q&&(q.name.textContent=re[te].name,q.emoji.innerHTML=va(te,{crop:"head"}),q.floatEmoji.innerHTML=va(te,{crop:"head"}))}),Ye&&Bn(re[Ye].weapons),Do(t,{generate:!1})},update(j,te){o.textContent=Fp(j.timeRemaining),_e(j).forEach((q,ue)=>{const le=K[ue];if(!le)return;mk(le.fill,le.hpText,q.hp,q.maxHp),le.levelValue!==q.level&&(le.levelValue=q.level,le.level.textContent=String(q.level));const fe=q.maxHp>0?q.hp/q.maxHp:0;le.bar.classList.toggle("is-low",q.alive&&fe<=Cp)});const he=_r(j);if(n.classList.toggle("is-inert",he),Ye){const q=re[Ye].weapons,ue=Ke(j).lastUsed;uo.forEach((le,fe)=>{const Ae=q[fe];if(!Ae)return;const qe=Math.max(0,Ae.cooldown-(j.elapsed-ue[fe])),He=Ae.cooldown>0?Math.min(1,qe/Ae.cooldown):0;le.cooldown.style.setProperty("--p",He.toFixed(3));const Be=He<=0,Xt=Be&&!he;le.root.classList.toggle("is-ready",Xt),le.root.classList.toggle("is-selected",!he&&fe===te.selectedWeapon),le.timer.textContent=Be?"":(qe/1e3).toFixed(1),Be&&!le.wasReady&&!he&&(le.root.classList.remove("is-flash"),le.root.offsetWidth,le.root.classList.add("is-flash")),le.wasReady=Be})}if(ff(j,te),mf(j,te),gf(te),j.phase==="countdown"){i.style.display="flex";const q=j.countdownValue<=0;i.textContent=q?"START!":String(j.countdownValue),i.classList.toggle("is-start",q)}else i.style.display="none";if(j.phase==="ended"){r.style.display="flex";const q=_e(j),ue=aa(j.winnerId??void 0,j.winner??"player"),le=ue===Fe;l.textContent=le?"VICTORY!":"DEFEAT!",l.classList.toggle("is-win",le),l.classList.toggle("is-lose",!le);const fe=q[ue]??q[0];re[fe.characterId];const Ae=q.every(me=>me.alive),qe=te.order??null,He=qe!==null&&qe.length===q.length&&qe.every(me=>Number.isInteger(me)&&me>=0&&me<q.length)&&new Set(qe).size===q.length,Be=qe&&He?qe.filter(me=>me!==ue).map(me=>q[me]):q.filter((me,gt)=>gt!==ue),Xt=me=>`<span class="hud-go-fighter"><span class="hud-go-emoji">${va(me.characterId,{crop:"head"})}</span>${re[me.characterId].name}</span>`,Ko=(me,gt)=>gt.length?`<span class="hud-go-vs">${me}</span>${gt.map(Xt).join("")}`:"";c.innerHTML=Xt(fe)+Ko("defeated",Be.filter(me=>!me.alive))+Ko("outlasted",Be.filter(me=>me.alive)),Do(c,{generate:!1});const fo=te.place??null;if(fo&&fo.of>1){const me=fo.place,gt=me%100>=11&&me%100<=13?"th":{1:"st",2:"nd",3:"rd"}[me%10]??"th";h.textContent=`${me}${gt} of ${fo.of}`,h.classList.toggle("is-podium",me<=3),h.style.display="block"}else h.textContent="",h.style.display="none";const Ai=Math.max(0,Ea-j.timeRemaining);d.innerHTML=Ae?`${D("timer")} Time up — no knockout`:`${D("timer")} Match time ${fk(Ai)}`;const _t=te.payout??null;if(_t){const me=(gt,mo,Xo="")=>`<span class="hud-go-pay">${D(gt)}<b>${mo>0?"+":""}${mo}</b>${Xo?`<i>${Xo}</i>`:""}</span>`;p.innerHTML=me("trophy",_t.trophies)+me("coin",_t.coins)+me("star",_t.xp,"xp")+(_t.chests?me("chest",_t.chests):""),p.style.display="flex"}else p.innerHTML="",p.style.display="none"}else r.style.display="none"},updateFloatingBars(j,te){const he=Si(),q=(ue,le)=>{const fe=Math.max(le.y,he),Ae=Math.min(Math.max(le.x,Fh),window.innerWidth-Fh);ue.style.transform=`translate(${Ae.toFixed(1)}px, ${fe.toFixed(1)}px) translate(-50%, -100%)`};K.forEach((ue,le)=>{const fe=j[le]??null;if(!fe){ue.float.style.display="none";return}ue.float.style.display="flex",q(ue.float,fe);const Ae=Math.max(0,Math.min(1,te[le]??0));ue.floatFill.style.width=`${(Ae*100).toFixed(1)}%`,ue.floatFill.classList.toggle("is-low",Ae>0&&Ae<=Cp)})},spawnDamageNumber(j,te,he){const q=ee[ye];ye=(ye+1)%ee.length;const ue=!!he?.heal,le=te>=15,fe=!le&&te>=6,Ae=Math.max(j.y,Si()),qe=Math.min(Math.max(j.x,24),window.innerWidth-24);q.style.setProperty("--x",`${qe.toFixed(1)}px`),q.style.setProperty("--y",`${Ae.toFixed(1)}px`),q.textContent=ue?`+${Math.round(te)}`:`-${Math.round(te)}`;const He=ue?" hud-dmg--heal":he?.fog?" hud-dmg--fog":"";q.className=`hud-dmg ${le?"hud-dmg--big":fe?"hud-dmg--medium":"hud-dmg--small"}${He}`,q.offsetWidth,q.classList.add("is-playing")},flashScreen(j){b.style.setProperty("--flash-color",Se(j,.42)),b.classList.remove("is-playing"),b.offsetWidth,b.classList.add("is-playing")},flashFogTick(){F.classList.remove("is-playing"),F.offsetWidth,F.classList.add("is-playing")},dispose(){u.removeEventListener("click",()=>e.onRestart()),window.clearTimeout(z),se(),t.innerHTML=""}}}const wk=`
.hud-root {
  position: fixed;
  inset: 0;
  pointer-events: none;
...
`,bk=["countdown-tick","match-started","match-ended","weapon-fired","weapon-fired:giantSlam","projectile-spawned","projectile-destroyed:hit-target","projectile-destroyed:hit-cover","projectile-destroyed:expired","hit-landed:weapon","hit-landed:trail","hit-landed:hazard","hit-landed:fog","heal","death","splat-created","trail-mark-created"],yk="hamburger",xk="donut";function Np(t){const e=new URLSearchParams(location.search).get(t);return e&&Ee.includes(e)?e:null}function vk(){const t=new URLSearchParams(location.search).get("fighters");if(!t)return null;const e=[];for(const a of t.split(";")){const[o,n]=a.split("@"),s=o?.trim();if(!s||!Ee.includes(s))return null;const i={characterId:s};if(n){const[r,l]=n.split(",").map(Number);if(!Number.isFinite(r)||!Number.isFinite(l))return null;i.spawn={x:r,y:l}}e.push(i)}return e.length>=3?e:null}function xs(t){const e=new URLSearchParams(location.search).get(t);if(e===null)return null;const a=Number(e);return Number.isFinite(a)?a:null}function kk(t){if(t.type!=="hit-landed")return t;const e=t.targetRole??"enemy",a=t.source.kind==="trail"&&t.source.ownerRole===void 0?{...t.source,ownerRole:Xp(e)}:t.source;return{...t,targetRole:e,source:a}}const Mk=Q+.35;class Wa{constructor(e){this.opts=e,this.playerId=e.playerCharacterId??Np("player")??yk,this.enemyId=e.enemyCharacterId??Np("enemy")??xk;const a=Ta(e.playerLevel??xs("level")??no);this.levels={player:a,enemy:l0(a)},this.roster=e.roster&&e.roster.length>ot&&e.roster.length<=zt?e.roster.slice():null,this.characterIds=this.qaFighters?this.qaFighters.map(n=>n.characterId):this.roster?this.roster.slice():[this.playerId,this.enemyId];const o=Number(new URLSearchParams(location.search).get("simSpeed"));this.simSpeed=Number.isFinite(o)&&o>0?Math.min(50,o):1,this.stage=new Tl({container:e.container,background:16764810,fog:{color:16764810,near:40,far:130},camera:{pitchDeg:58,yawDeg:0,frameMode:"fair"}}),this.stage.scene.add(this.arena.build()),this.fogRing=_1(this.arena.center),this.stage.scene.add(this.fogRing.root),this.vfx=new pk(this.stage.scene),this.hud=gk(e.hudRoot,{onRestart:()=>this.restart(),onSelectWeapon:n=>this.input.selectWeapon(n)}),this.hud.setCharacters(this.characterIds),this.input=new R1(this.stage.canvas),this.input.setWeaponCount(re[this.characterIds[Fe]].weapons.length),this.pointerLock=Fb({target:this.stage.canvas,pause:()=>this.pause(),resume:()=>this.resume(),onLockChange:n=>this.input.setPointerLocked(n)}),this.state=this.newMatch(),this.spawnMatch(),window.__matchDebug=this.debug,window.__feelDebug=this.feel,window.__feelEvent=n=>this.handleEvents([kk(n)]),window.__matchArena=this.arena,window.addEventListener("resize",this.handleResize),this.raf=requestAnimationFrame(this.loop)}stage;arena=am();vfx;audio=Cw();hud;input;pointerLock;fogRing;playerId;enemyId;levels;characterIds;qaFighters=vk();roster;models=[];state;eliminated=[];killedBy=[];viewSubject=Fe;spectateDwellMs=0;static SPECTATE_DWELL_MS=1350;endedOutcome=null;endedPayout=null;clock=new om;raf=0;disposed=!1;readyFired=!1;isPaused=!1;lastPhase=null;raycaster=new nm;groundPlane=new sm(new pe(0,1,0),0);rayHit=new pe;projectVec=new pe;projectileOrigins=new Map;simSpeed;qaFogRadius=xs("fogRadius");qaPlayerX=xs("px");qaPlayerY=xs("py");debug={phase:"countdown",winner:null,paused:!1,moveX:0,moveY:0,attack:!1,facingX:0,facingY:0,selectedWeapon:0,pointerLocked:!1,qaSpawnInsideCover:null,frames:0,viewSubject:Fe,viewReason:"local"};feel={events:Object.fromEntries(bk.map(e=>[e,0])),responses:{vfx:0,shake:0,hitStop:0,knockback:0,damageNumber:0,screenFlash:0},hitStopBudgetMs:0,hitStopBankedMs:0,lastHitStopMs:0,rawDtMs:0,stepDtMs:0,frames:0,frozenFrames:0,repayingFrames:0,peakHitAmount:0,peakShakeM:0,shakeSumM:0,shakeRawSumM:0,peakShakeRawM:0};hitStopBudgetMs=0;hitStopBankedMs=0;static HITSTOP_TRICKLE=.05;static HITSTOP_CATCHUP_RATE=3;static SHAKE_MAX_M=.4;shakeFadeUnits=-1;knockback=[];restart(){this.spawnMatch(),this.resume()}get paused(){return this.isPaused}pause(){this.isPaused=!0,this.pointerLock.release(),this.hud.update(this.state,{selectedWeapon:this.input.selectedWeapon,safeArrow:this.hudSafeArrow(),observerSlot:this.viewSubject,aim:null,...this.hudResult()})}resume(){this.isPaused=!1,this.pointerLock.engage()}resize(){this.stage.resize()}dispose(){this.disposed=!0,cancelAnimationFrame(this.raf),window.__matchDebug===this.debug&&delete window.__matchDebug,window.__feelDebug===this.feel&&delete window.__feelDebug,window.__matchArena===this.arena&&delete window.__matchArena,delete window.__feelEvent,window.removeEventListener("resize",this.handleResize),this.pointerLock.dispose(),this.input.dispose(),this.hud.dispose(),this.vfx.dispose(),this.fogRing.dispose();for(const e of this.models)e.dispose();this.stage.dispose()}newMatch(){return this.qaFighters?Qi(this.arena,this.qaFighters):this.roster?Qi(this.arena,this.roster.map((e,a)=>({characterId:e,level:a===Fe?this.levels.player:this.levels.enemy}))):Qi(this.arena,this.playerId,this.enemyId,this.levels)}spawnMatch(){this.state=this.newMatch(),this.applyQaSetup();for(const n of this.models)this.stage.scene.remove(n.root),n.dispose();const e=_e(this.state);this.models=e.map((n,s)=>Al(this.characterIds[s]??n.characterId));for(const n of this.models)this.stage.scene.add(n.root);this.models.forEach((n,s)=>{this.syncModelTransform(n,e[s]),n.play("idle")}),this.vfx.clear(),this.audio.reset(),this.input.reset(),this.projectileOrigins.clear(),this.eliminated.length=0,this.killedBy.length=0,this.viewSubject=Fe,this.spectateDwellMs=0,this.hitStopBudgetMs=0,this.hitStopBankedMs=0;for(const n of Object.keys(this.feel.events))this.feel.events[n]=0;this.feel.responses.vfx=0,this.feel.responses.shake=0,this.feel.responses.hitStop=0,this.feel.responses.knockback=0,this.feel.responses.damageNumber=0,this.feel.responses.screenFlash=0,this.feel.frames=0,this.feel.frozenFrames=0,this.feel.repayingFrames=0,this.feel.peakHitAmount=0,this.feel.peakShakeM=0,this.feel.lastHitStopMs=0,this.feel.shakeSumM=0,this.feel.shakeRawSumM=0,this.feel.peakShakeRawM=0,this.knockback=e.map(()=>({x:0,z:0}));const a=Ke(this.state),o=Le(a.x,a.y);this.stage.rig.snapTo(o.x,o.z),this.stage.lighting.focus(o.x,o.z),this.fogRing.update(this.state.safeRadius,this.state.elapsed/1e3,this.state.phase==="playing",this.stage.rig),this.lastPhase=null,this.notifyPhase()}applyQaSetup(){const e=Ke(this.state);if(this.qaPlayerX!==null&&(e.x=this.qaPlayerX),this.qaPlayerY!==null&&(e.y=this.qaPlayerY),(this.qaPlayerX!==null||this.qaPlayerY!==null)&&this.checkQaSpawn(),this.qaFogRadius===null)return;const a=this.arena.maxSafeRadius;this.state.phase="playing",this.state.countdownValue=0,this.state.countdownTick=0,this.state.startFlashTimer=0;const o=Math.max(Os(this.state.fighters.length),a*(Xr/Ea));if(this.qaFogRadius<=o){this.qaFogRadius>Yr&&console.warn(`[QA] ?fogRadius=${this.qaFogRadius} is below the lowest radius the schedule ever reaches (${o.toFixed(2)} wu — DECISIONS §2 collapses the ring at ${im/1e3} s). Snapped to SUDDEN DEATH (radius 0). Ask for a larger radius if you wanted a ring.`),this.state.timeRemaining=Xr,this.state.safeRadius=Yr;return}const n=U.clamp(this.qaFogRadius,o,a),s=U.clamp(n/a,0,1);this.state.timeRemaining=Ea*s,this.state.safeRadius=n}checkQaSpawn(){const e=Ke(this.state),a=this.arena.cover.find(o=>hi(e.x,e.y,e.size,e.size,o.x,o.y,o.w,o.h));this.debug.qaSpawnInsideCover=a?`${a.kind??"cover"} @(${a.x},${a.y}) ${a.w}x${a.h}`:null,a&&console.warn(`[QA] ?px=${e.x}&py=${e.y} places the player INSIDE cover "${a.kind??"cover"}" @(${a.x},${a.y}) ${a.w}x${a.h}. There is no depenetration in movement.ts, so the fighter cannot move at all — input is fine, the sim is refusing every step. Pick a point at least ${((e.size+Math.max(a.w,a.h))/2).toFixed(0)} wu from that centre.`)}aimCursor(){const e=this.input.aimOffsetPx;if(!e)return null;const a=Ke(this.state),o=this.projectPointToScreen(a.x,a.y,0);return o?{from:o,at:{x:o.x+e.x,y:o.y+e.y}}:null}buildInput(){const e=this.state.phase==="playing",a=e?this.input.moveAxes():{x:0,y:0};let o;if(e){const s=this.aimCursor();let i=this.input.mouseNdc;if(s){const r=this.stage.canvas.getBoundingClientRect();i={x:(s.at.x-r.left)/r.width*2-1,y:-((s.at.y-r.top)/r.height*2-1)}}if(i){this.raycaster.setFromCamera(new rm(i.x,i.y),this.stage.rig.camera);const r=this.raycaster.ray.intersectPlane(this.groundPlane,this.rayHit);if(r){const l=Ke(this.state);o={x:jh(r.x)-l.x,y:jh(r.z)-l.y}}}}const n=e&&this.input.attackHeld;return{move:a,aim:o,selectedWeapon:this.input.selectedWeapon,attack:n}}syncModelTransform(e,a){const o=Le(a.x,a.y);e.root.position.set(o.x,0,o.z),e.root.rotation.y=Math.atan2(a.facing.x,a.facing.y)}attackerSlotOf(e,a){let o=null;if(e.kind==="weapon"?o=fn(this.state,e,a):e.kind==="trail"&&(o=dc(this.state,e)),!o)return;const n=_e(this.state).indexOf(o);return n>=0?n:void 0}colorForDamageSource(e,a){switch(a.kind){case"weapon":{const o=fn(this.state,a,e);return re[o.characterId].weapons.find(s=>s.key===a.weaponKey)?.color??"#FFFFFF"}case"trail":return aa(a.ownerId,a.ownerRole)===Fe?"#FF9EC4":"#FFD27A";case"hazard":return"#FF7A3D";case"fog":return"#B98CE6";default:return"#FFFFFF"}}triggerHitStop(e){this.hitStopBudgetMs=Math.max(this.hitStopBudgetMs,e),this.feel.responses.hitStop++,this.feel.lastHitStopMs=e}kick(e,a,o){const n=Math.min(e,Wa.SHAKE_MAX_M),s=n*a;this.stage.rig.shake(s,o),this.feel.responses.shake++,this.feel.shakeSumM+=s,this.feel.shakeRawSumM+=n,s>this.feel.peakShakeM&&(this.feel.peakShakeM=s),n>this.feel.peakShakeRawM&&(this.feel.peakShakeRawM=n)}shakeProximity(e,a){this.shakeFadeUnits<0&&(this.shakeFadeUnits=this.stage.rig.shakeFadeRadiusUnits());const o=this.viewObserver();return lm(Math.hypot(e-o.x,a-o.y),this.shakeFadeUnits)}viewObserver(){return _e(this.state)[this.viewSubject]??Ke(this.state)}updateViewSubject(e){const a=_e(this.state);if(a[Fe]?.alive){this.viewSubject=Fe,this.spectateDwellMs=0,this.audio.setListener(Fe),this.debug.viewSubject=Fe,this.debug.viewReason="local";return}if(this.spectateDwellMs>0){this.spectateDwellMs=Math.max(0,this.spectateDwellMs-e),this.debug.viewReason="dwell";return}this.shakeFadeUnits<0&&(this.shakeFadeUnits=this.stage.rig.shakeFadeRadiusUnits());const o=this.stage.rig.targetUnits(),n=hm({seats:a,localSlot:Fe,current:this.viewSubject,killedBy:this.killedBy,cameraX:o.x,cameraY:o.y,cutBeyondUnits:this.shakeFadeUnits});if(n.slot!==this.viewSubject&&(this.viewSubject=n.slot,n.cut)){const s=a[n.slot];if(s){const i=Le(s.x,s.y);this.stage.rig.snapTo(i.x,i.z),this.stage.lighting.focus(i.x,i.z)}}this.audio.setListener(this.viewSubject),this.debug.viewSubject=this.viewSubject,this.debug.viewReason=n.reason}applyKnockback(e,a,o,n){const s=_e(this.state)[e],i=this.knockback[e];if(!s||!i)return;const r=s.x-a,l=s.y-o,h=Math.hypot(r,l);if(h<1e-4)return;const c=U.clamp(n,0,.22);i.x+=r/h*c,i.z+=l/h*c,this.feel.responses.knockback++}handleEvents(e){const a=[],o=[];for(const n of e){const s=n.type==="hit-landed"?`hit-landed:${n.source.kind}`:n.type==="projectile-destroyed"?`projectile-destroyed:${n.reason}`:n.type;switch(s in this.feel.events&&this.feel.events[s]++,n.type){case"weapon-fired":{const i=this.models[aa(n.fighterId,n.fighterRole)],r=mt(this.state,n.fighterId,n.fighterRole);if(!i)break;const l=re[r.characterId].weapons,h=l.findIndex(d=>d.key===n.weaponKey),c=l[h<0?0:h];i.play("attack",{weaponIndex:h<0?0:h}),c&&(this.vfx.spawnWeaponCast(r.x,r.y,r.facing,c,r.characterId),this.feel.responses.vfx++,c.giantSlam&&(this.feel.events["weapon-fired:giantSlam"]++,this.hud.flashScreen(c.color),this.feel.responses.screenFlash++,this.kick(.55,this.shakeProximity(r.x,r.y),2.6),this.triggerHitStop(120),window.__vfxDebugGiantSlamCount=(window.__vfxDebugGiantSlamCount??0)+1));break}case"hit-landed":{const i=aa(n.targetId,n.targetRole);this.models[i]?.play("hit",{intensity:U.clamp(n.amount/12,.25,1)});const l=this.colorForDamageSource(n.targetRole,n.source);if(a[i]=l,o[i]=this.attackerSlotOf(n.source,n.targetRole),n.source.kind==="fog"){const f=this.projectPointToScreen(n.x,n.y,1.3);f&&(this.hud.spawnDamageNumber(f,n.amount,{fog:!0}),this.feel.responses.damageNumber++),i===Fe&&(this.hud.flashFogTick(),this.feel.responses.screenFlash++);break}let h;if(n.source.kind==="weapon"){const f=fn(this.state,n.source,n.targetRole),g=n.source.weaponKey,w=re[f.characterId].weapons.find(b=>b.key===g);w&&(h={weapon:w,characterId:f.characterId,fromXWU:f.x,fromYWU:f.y})}this.vfx.spawnImpactBurst(n.x,n.y,l,n.amount,h),this.feel.responses.vfx++,n.amount>this.feel.peakHitAmount&&(this.feel.peakHitAmount=n.amount);const c=this.projectPointToScreen(n.x,n.y,1.3);c&&(this.hud.spawnDamageNumber(c,n.amount),this.feel.responses.damageNumber++);const d=n.source.kind==="weapon",p=U.clamp(.012+n.amount*.0175,.012,Wa.SHAKE_MAX_M),u=i===Fe?1.25:1,m=mt(this.state,n.targetId,n.targetRole);if(this.kick(p*u*(d?1:.45),this.shakeProximity(m.x,m.y)),d&&this.triggerHitStop(U.clamp(10+n.amount*4.6,16,105)),n.source.kind==="weapon"){const f=n.source,g=fn(this.state,f,n.targetRole);(re[g.characterId].weapons.find(x=>x.key===f.weaponKey)?.knockback??0)>0||this.applyKnockback(i,g.x,g.y,.05+n.amount*.006)}else if(n.source.kind==="trail"){const f=dc(this.state,n.source);this.applyKnockback(i,f.x,f.y,.03)}break}case"projectile-spawned":{this.projectileOrigins.set(n.id,{color:n.color,x:n.x,y:n.y});break}case"projectile-destroyed":{const i=this.projectileOrigins.get(n.id);if(this.projectileOrigins.delete(n.id),n.reason!=="hit-cover")break;this.vfx.spawnCoverScuff(n.x,n.y,i?.color??"#FFFFFF",i?n.x-i.x:0,i?n.y-i.y:0);break}case"heal":{const i=mt(this.state,n.fighterId,n.fighterRole);this.vfx.spawnHealPulse(i.x,i.y),this.feel.responses.vfx++;const r=this.projectPointToScreen(i.x,i.y,1.6);r&&(this.hud.spawnDamageNumber(r,n.amount,{heal:!0}),this.feel.responses.damageNumber++);break}case"death":{const i=aa(n.fighterId,n.fighterRole);this.eliminated.push(i),this.killedBy[i]=o[i]??null,i===this.viewSubject&&(this.spectateDwellMs=Wa.SPECTATE_DWELL_MS),this.models[i]?.play("death");const r=mt(this.state,n.fighterId,n.fighterRole),l=a[i]??"#FFFFFF";this.vfx.spawnDeathBurst(r.x,r.y,l),this.feel.responses.vfx++,this.kick(.42,this.shakeProximity(r.x,r.y),3),this.triggerHitStop(90);break}}}}groundOnScreen(e,a){return this.projectVec.set(e,0,a),this.projectVec.project(this.stage.rig.camera),this.projectVec.z<=1&&Math.abs(this.projectVec.x)<=1&&Math.abs(this.projectVec.y)<=1}projectToScreen(e,a){if(!a||!this.groundOnScreen(e.root.position.x,e.root.position.z)||(this.projectVec.set(e.root.position.x,Mk,e.root.position.z),this.projectVec.project(this.stage.rig.camera),this.projectVec.z>1))return null;const o=this.stage.canvas.getBoundingClientRect();return{x:(this.projectVec.x*.5+.5)*o.width+o.left,y:(1-(this.projectVec.y*.5+.5))*o.height+o.top}}projectPointToScreen(e,a,o){const n=Le(e,a);if(!this.groundOnScreen(n.x,n.z)||(this.projectVec.set(n.x,o,n.z),this.projectVec.project(this.stage.rig.camera),this.projectVec.z>1))return null;const s=this.stage.canvas.getBoundingClientRect();return{x:(this.projectVec.x*.5+.5)*s.width+s.left,y:(1-(this.projectVec.y*.5+.5))*s.height+s.top}}safeArrow(){const e=Ke(this.state),a=this.arena.center.x-e.x,o=this.arena.center.y-e.y,n=Math.hypot(a,o);if(n<.001)return null;const s=this.projectPointToScreen(e.x,e.y,.35),i=this.projectPointToScreen(e.x+a/n*80,e.y+o/n*80,.35);if(!s||!i)return null;const r=i.x-s.x,l=i.y-s.y;return Math.hypot(r,l)<1?null:{at:s,angleRad:Math.atan2(l,r)}}notifyPhase(){this.state.phase!==this.lastPhase&&(this.lastPhase=this.state.phase,this.pointerLock.setMatchActive(this.state.phase!=="ended"),this.endedOutcome=this.state.phase==="ended"?this.outcome():null,this.state.phase!=="ended"&&(this.endedPayout=null),this.opts.onPhase?.(this.state.phase,this.state.winner,this.endedOutcome))}showPayout(e){this.endedPayout=e}hudSafeArrow(){return Ke(this.state).alive?this.safeArrow():null}hudResult(){return{place:this.hudPlace(),order:this.endedOutcome?.places??null,payout:this.endedOutcome?this.endedPayout:null}}hudPlace(){const e=this.endedOutcome;return!e||e.seats<=1||e.localPlace<0?null:{place:e.localPlace+1,of:e.seats}}outcome(){const a={seats:_e(this.state).map((n,s)=>({id:s,alive:n.alive,hp:n.hp,maxHp:n.maxHp,x:n.x,y:n.y,deaths:n.deaths})),center:{x:this.arena.center.x,y:this.arena.center.y},eliminated:this.eliminated,winnerId:this.state.winnerId??null},o=Ng(a);return{seats:a.seats.length,places:o,localPlace:o.indexOf(Fe),winnerId:a.winnerId}}handleResize=()=>this.resize();publishDebug(e,a,o){const n=this.debug;n.phase=this.state.phase,n.winner=this.state.winner,n.paused=this.isPaused,n.moveX=e,n.moveY=a,n.attack=o;const s=Ke(this.state);n.facingX=s.facing.x,n.facingY=s.facing.y,n.selectedWeapon=this.input.selectedWeapon,n.pointerLocked=this.input.pointerLocked,n.frames++}decayKnockback(e){const a=Math.exp(-e*14);for(const o of this.knockback)o.x*=a,o.z*=a,Math.abs(o.x)<1e-4&&(o.x=0),Math.abs(o.z)<1e-4&&(o.z=0)}loop=()=>{if(this.disposed)return;const e=Math.min(this.clock.getDelta(),1/20)*this.simSpeed,a=e*1e3;if(this.isPaused){this.publishDebug(0,0,!1),this.stage.render(0),this.raf=requestAnimationFrame(this.loop);return}let o;if(this.hitStopBudgetMs>0)this.hitStopBudgetMs=Math.max(0,this.hitStopBudgetMs-a),o=a*Wa.HITSTOP_TRICKLE,this.hitStopBankedMs+=a-o;else if(this.hitStopBankedMs>0){const u=Math.min(this.hitStopBankedMs,a*Wa.HITSTOP_CATCHUP_RATE);this.hitStopBankedMs-=u,o=a+u}else o=a;const n=o/1e3;this.feel.rawDtMs=a,this.feel.stepDtMs=o,this.feel.hitStopBudgetMs=this.hitStopBudgetMs,this.feel.hitStopBankedMs=this.hitStopBankedMs,this.feel.frames++,o<a*.5?this.feel.frozenFrames++:o>a*1.05&&this.feel.repayingFrames++;const s=_e(this.state),i=s.map(u=>({x:u.x,y:u.y})),r=this.buildInput(),l=wb(this.state,o,r);this.handleEvents(l),this.audio.handleEvents(l,this.state),this.notifyPhase(),this.publishDebug(r.move.x,r.move.y,r.attack===!0);const h=s.map((u,m)=>u.x!==i[m].x||u.y!==i[m].y);this.models.forEach((u,m)=>{const f=s[m];if(!f)return;this.syncModelTransform(u,f);const g=this.knockback[m];g&&(u.root.position.x+=g.x,u.root.position.z+=g.z)}),this.decayKnockback(e),this.updateViewSubject(a);const c=this.viewObserver();this.models.forEach((u,m)=>{if(m===Fe)return;const f=s[m];f&&(u.root.visible=Ml(this.state,c,f))}),this.models.forEach((u,m)=>{s[m]?.alive&&u.play(h[m]?"run":"idle")});const d=this.state.elapsed/1e3;this.models.forEach((u,m)=>{const f=s[m];f&&u.update({dt:n,elapsed:d,moveSpeed01:f.alive&&h[m]?1:0,health01:f.hp/f.maxHp})}),this.arena.update?.(n,d),this.vfx.sync(this.state),this.vfx.updateEffects(e),this.fogRing.update(this.state.safeRadius,this.clock.elapsedTime,this.state.phase==="playing",this.stage.rig);const p=Le(c.x,c.y);this.stage.rig.follow(p.x,p.z),this.stage.lighting.focus(p.x,p.z),window.__vfxDebugScreen={player:this.projectPointToScreen(s[0].x,s[0].y,0),enemy:s[1]?this.projectPointToScreen(s[1].x,s[1].y,0):null,slots:s.map(u=>this.projectPointToScreen(u.x,u.y,0))},this.hud.update(this.state,{selectedWeapon:this.input.selectedWeapon,safeArrow:this.hudSafeArrow(),aim:Ke(this.state).alive?this.aimCursor():null,observerSlot:this.viewSubject,...this.hudResult()}),this.hud.updateFloatingBars(this.models.map((u,m)=>{const f=s[m];if(!f)return null;const g=m===Fe?f.alive:f.alive&&Ml(this.state,c,f);return this.projectToScreen(u,g)}),s.map(u=>u.hp/u.maxHp)),this.stage.render(e),this.readyFired||(this.readyFired=!0,window.__gameReady=!0,window.__previewReady=!0),this.raf=requestAnimationFrame(this.loop)}}function Ek(t){return new Wa(t)}const Ih="Escape";function Tk(t,e){if(e.name!=="match")throw new Error("createMatchScreen: wrong route");la("fa-match-styles",Sk),ha();const a=Ce("div","fa-screen-bare fa-match");a.innerHTML=`
  ...
  `;const o=p=>{const u=a.querySelector(`[data-el="${p}"]`);if(!u)throw new Error(`matchScreen: missing element "${p}"`);return u},n=o("sheet"),s=o("pause"),i=o("exit");let r=!1;const l=e.seats===void 0?void 0:Jp(e.player,e.enemy,e.seats),h=Ek({container:t.gameHost,hudRoot:t.hudRoot,playerCharacterId:e.player,enemyCharacterId:e.enemy,roster:l,playerLevel:t.profile.characterLevel(e.player),onPhase(p,u,m){if(p==="ended"){if(!r){r=!0;const g=m!==null&&m.localPlace>=0&&m.seats>=ot&&m.seats<=zt&&m?t.profile.recordPlacement(m.localPlace,m.seats):t.profile.recordResult(u==="player");h.showPayout({trophies:g.trophies,coins:g.coins,xp:m0(g.place,g.seats),chests:g.chests})}a.classList.add("is-ended")}else r=!1,a.classList.remove("is-ended")}});function c(p){p?h.pause():h.resume(),n.classList.toggle("is-open",p),s.innerHTML=D(p?"play":"pause")}s.addEventListener("click",()=>c(!h.paused)),o("resume").addEventListener("click",()=>c(!1)),o("change").addEventListener("click",()=>t.navigate({name:"characters"})),o("quit").addEventListener("click",()=>t.navigate({name:"home"})),i.addEventListener("click",()=>t.navigate({name:"home"}));const d=p=>{p.key===Ih&&(p.preventDefault(),c(!h.paused))};return window.addEventListener("keydown",d),i.title=l?l.map(p=>re[p].name).join(" · "):`${re[e.player].name} vs ${re[e.enemy].name}`,{root:a,resize(){h.resize()},dispose(){window.removeEventListener("keydown",d),h.dispose(),a.remove()}}}const Sk=`
...
`,rf="food-arena.settings.v1",Ak="fa-reduce-motion";function lf(){try{const t=localStorage.getItem(rf),e=t?JSON.parse(t):{};return{reduceMotion:e.reduceMotion===!0,moveKeys:Ik(e.moveKeys)}}catch{return{reduceMotion:!1,moveKeys:{}}}}function Pr(t){try{localStorage.setItem(rf,JSON.stringify(t))}catch{}}function hf(){const t=lf();document.documentElement.classList.toggle(Ak,t.reduceMotion),El(t.moveKeys)}const oa=["up","left","down","right"],gn={up:"Move up",left:"Move left",down:"Move down",right:"Move right"},oo={...Yt},Rk=[{code:Wl,does:"mutes the game"},{code:Ih,does:"pauses a match"},{code:"Tab",does:"moves between controls"},{code:"Enter",does:"presses the control you are on"},{code:"NumpadEnter",does:"presses the control you are on"},...Array.from({length:Ul},(t,e)=>[{code:`Digit${e+1}`,does:"picks a weapon"},{code:`Numpad${e+1}`,does:"picks a weapon"}]).flat()];function cf(t){return Rk.find(e=>e.code===t)?.does??null}function jt(t){if(t.startsWith("Key"))return t.slice(3);if(t.startsWith("Digit"))return t.slice(5);switch(t){case"ArrowUp":return"↑";case"ArrowDown":return"↓";case"ArrowLeft":return"←";case"ArrowRight":return"→";case"Escape":return"Esc";case"Space":return"Space";default:return t}}function El(t){const e=Yt;for(const a of oa){const o=oo[a],n=t[a];e[a]=n?[n,...o.slice(1).filter(s=>s!==n)]:o}}function Ik(t){const e={};if(t===null||typeof t!="object")return e;const a=t,o=new Set;for(const n of oa){const s=a[n];typeof s!="string"||s.length===0||s.length>32||cf(s)||o.has(s)||oa.some(i=>i!==n&&oo[i].includes(s))||(o.add(s),e[n]=s)}return e}function Fk(t,e,a){const o=cf(e);if(o)return`${jt(e)} already ${o}.`;for(const n of oa){if(n===t)continue;if((a[n]??oo[n][0])===e||oo[n].includes(e))return`${jt(e)} is already ${gn[n].toLowerCase()}.`}return null}function Ck(){return oa.some(t=>Yt[t][0]!==oo[t][0])}function Lp(){return'<svg class="fa-ic fa-ic--note" viewBox="0 0 24 24" fill="none" style="stroke:var(--fa-ic-ink,#1a1224)" stroke-width="1.7" stroke-linejoin="round" stroke-linecap="round" aria-hidden="true" focusable="false"><path d="M10.4 17.2V5.4l8.2-1.9v11.7" fill="none" stroke-width="2"/><ellipse cx="7.6" cy="17.4" rx="3" ry="2.5" fill="#FFC93C"/><ellipse cx="15.8" cy="15.2" rx="3" ry="2.5" fill="#FFC93C"/></svg>'}function Ok(t){la("fa-settings-styles",Nk),ha();const e=Ce("div","fa-screen fa-settings");let a=lf(),o=null;const n=()=>{const O=[],_=oa.flatMap(V=>Yt[V].slice(1)).map(jt);_.length>0&&O.push({action:"Move (fixed)",keys:_}),O.push({action:"Aim",keys:["Mouse"]}),O.push({action:"Fire",keys:["Click"]});const z=Math.min(re[t.profile.selected].weapons.length,Ul);return z>1&&O.push({action:"Switch weapon",keys:Array.from({length:z},(V,ce)=>String(ce+1))}),O.push({action:"Mute / unmute",keys:[jt(Wl)]}),O.push({action:"Pause",keys:[jt(Ih)]}),O},s=()=>`Aim, fire, mute and pause are fixed.${re[t.profile.selected].weapons.length>1?"":` ${re[t.profile.selected].name} carries one weapon, so there is no weapon-switch key while it is equipped.`} On a phone, twin sticks appear under your thumbs — the left half of the screen moves, the right half aims and fires — in landscape and in portrait alike.`,i=(O,_,z,V)=>`
    <div class="set-row">
    ...
    </div>`,r=(O,_,z=!1)=>`<button class="set-toggle" type="button" role="switch" aria-checked="false"
       aria-label="${_}" data-toggle="${O}"${z?' data-clicksound="off"':""}><span class="set-knob"></span></button>`,l=(O,_)=>`<span class="set-slider">
     ...
     </span>`,h=O=>{const _=Ci(O),z=O==="auto"?Ci(pm()):"";return`<button class="set-seg-btn" type="button" role="radio" aria-checked="false"
        aria-label="${z?`${_} (${z})`:_}"
    ...
    <div class="fa-scroll set-body">
        ...
        <div class="set-row">
          ...
          <span class="set-row-control set-name-wrap">
            <input class="set-name" type="text" data-el="name" aria-label="Player name"
                   maxlength="${al}" autocomplete="off" autocapitalize="words"
      ...
      <section class="fa-panel set-section">
        ...
        ${i(Lp(),"Music","The menu and lobby theme",r("music","Music"))}
        ${i(Lp(),"Music volume","Sits under the effects",l("music","Music volume"))}
      </section>
  ...
  `;const c=O=>{const _=e.querySelector(`[data-el="${O}"]`);if(!_)throw new Error(`settings: missing element "${O}"`);return _},d=O=>e.querySelector(`[data-toggle="${O}"]`),p=O=>e.querySelector(`[data-range="${O}"]`),u=c("qualityrow"),m=O=>`${Math.round(O*100)}%`;function f(O,_){const z=d(O);z.setAttribute("aria-checked",_?"true":"false"),z.classList.toggle("is-on",_)}function g(){const O=fm(),_=mm();for(const ce of u.querySelectorAll("[data-quality]")){const se=ce.dataset.quality===_;ce.setAttribute("aria-checked",se?"true":"false"),ce.classList.toggle("is-on",se),ce.disabled=O!==null}const z=c("qualitypin");O?(z.textContent=`This session is pinned to ${Ci(O)} by a ?tier= link in the address bar, so this control is switched off. Reload without it to choose.`,z.hidden=!1):z.hidden=!0;const V=gm();c("qualityblurb").textContent=_==="auto"&&!O?`Auto picked ${V.label} on this device. ${V.blurb}`:V.blurb}function w(){for(const O of oa){const _=c(`bind-${O}`),z=jt(Yt[O][0]),V=o===O;_.textContent=V?"…":z,_.classList.toggle("is-listening",V),_.setAttribute("aria-label",V?`${gn[O]}: press the key you want, or Escape to keep ${z}`:`${gn[O]}, currently ${z}. Press to change it.`)}c("bindreset").hidden=!Ck(),c("keys").innerHTML=n().map(O=>`
      ...
      </div>`).join(""),c("ctrlnote").textContent=s()}function b(O){c("bindnote").textContent=O??(o!==null?"Press any key. Escape keeps the one you have.":`Tap a key to change it. ${oa.map(_=>jt(oo[_].slice(1)[0]??"")).filter(Boolean).join(" ")} always work as well, so movement can never be lost.`)}function x(O){c("namecount").textContent=`${O.length}/${al}`}function M(){const O=ke.isMuted(),_=ke.getState(),z=c("name");document.activeElement!==z&&(z.value=t.profile.name),x(z.value);const V=p("sfx");document.activeElement!==V&&(V.value=String(ke.getVolume())),V.style.setProperty("--p",m(ke.getVolume())),c("sfxval").textContent=m(ke.getVolume());const ce=p("music");document.activeElement!==ce&&(ce.value=String(ke.music.getVolume())),ce.style.setProperty("--p",m(ke.music.getVolume())),c("musicval").textContent=m(ke.music.getVolume()),f("mute",O),f("music",ke.music.isEnabled()),f("motion",a.reduceMotion),e.classList.toggle("is-muted",O);const se=c("audiostate");_==="failed"?(se.textContent="This browser blocked audio, so nothing here will make a sound.",se.hidden=!1):_!=="running"?(se.textContent="Sound switches on when you touch the screen — drag a slider to try it.",se.hidden=!1):se.hidden=!0}function y(O,_){const z=Fk(O,_,a.moveKeys);if(z){b(`${z} Pick another, or press Escape.`);return}const V={...a.moveKeys};V[O]=_,a={...a,moveKeys:V},Pr(a),El(a.moveKeys),S(),b(`${gn[O]} is now ${jt(_)}.`),w()}function v(){a={...a,moveKeys:{}},Pr(a),El(a.moveKeys),S(),b(`Movement is back to ${oa.map(O=>jt(oo[O][0])).join(" ")}.`),w()}const k=O=>{if(o!==null){if(O.preventDefault(),O.stopPropagation(),O.key==="Escape"){const _=o;S(),b(`Left ${gn[_].toLowerCase()} on ${jt(Yt[_][0])}.`),w();return}["Shift","Control","Alt","Meta","CapsLock"].includes(O.key)||O.code&&y(o,O.code)}};function T(O){if(o===O){S(),w(),b();return}o===null&&window.addEventListener("keydown",k,!0),o=O,w(),b()}function S(){o!==null&&(o=null,window.removeEventListener("keydown",k,!0))}const A=O=>{const _=O.target.closest("[data-quality]");if(_){um(_.dataset.quality),g();return}const z=O.target.closest("[data-bind]");if(z){T(z.dataset.bind);return}if(O.target.closest('[data-el="bindreset"]')){v();return}o!==null&&(S(),w(),b());const V=O.target.closest("[data-toggle]");if(V){switch(V.dataset.toggle){case"mute":ke.setMuted(!ke.isMuted()),ke.isMuted()||ke.previewClick();break;case"music":ke.music.setEnabled(!ke.music.isEnabled());break;case"motion":a={...a,reduceMotion:!a.reduceMotion},Pr(a),hf();break}M()}};e.addEventListener("click",A);const C=O=>{const _=O.target;if(_.dataset.el==="name"){t.profile.setName(_.value),x(_.value);return}const z=Number(_.value);Number.isFinite(z)&&(_.dataset.range==="sfx"?(ke.setVolume(z),ke.previewClick()):_.dataset.range==="music"&&ke.music.setVolume(z),M())};e.addEventListener("input",C);const R=O=>{const _=O.target;_.dataset.el==="name"&&(_.value=t.profile.setName(_.value),x(_.value))};e.addEventListener("change",R);const F=O=>{const _=O.target;!_||_.dataset.el!=="name"||O.key!=="Enter"||(O.preventDefault(),_.blur())};e.addEventListener("keydown",F),c("back").addEventListener("click",()=>t.navigate({name:"home"})),c("done").addEventListener("click",()=>t.navigate({name:"home"}));const N=c("confirm");c("reset").addEventListener("click",()=>{const O=Ee.filter(_=>t.profile.characterLevel(_)>no).length;c("confirmsub").textContent=`${t.profile.trophies.toLocaleString()} trophies, ${t.profile.coins.toLocaleString()} coins and ${t.profile.wins} wins will be deleted`+(O>0?`, along with ${O} upgraded fighter${O===1?"":"s"}.`:"."),N.hidden=!1}),c("cancel").addEventListener("click",()=>{N.hidden=!0}),c("confirmyes").addEventListener("click",()=>{try{const O=[];for(let _=0;_<localStorage.length;_++){const z=localStorage.key(_);z&&z.startsWith("food-arena.profile")&&O.push(z)}for(const _ of O)localStorage.removeItem(_)}catch{}location.reload()});const L=e.querySelector(".set-body"),P=()=>{const O=L.scrollHeight-L.scrollTop-L.clientHeight>2;L.classList.toggle("is-more",O)};L.addEventListener("scroll",P,{passive:!0}),requestAnimationFrame(P);const W=ke.onChange(M),H=ke.music.onChange(M),K=dm(g);return M(),g(),w(),b(),{root:e,resize(){P()},dispose(){W(),H(),K(),S(),L.removeEventListener("scroll",P),e.removeEventListener("click",A),e.removeEventListener("input",C),e.removeEventListener("change",R),e.removeEventListener("keydown",F),e.remove()}}}const Nk=`
...
`,Dp=[{key:"damage",icon:"damage",label:"Damage",color:"#FF8A96"},{key:"health",icon:"health",label:"Health",color:"#8FE04A"},{key:"speed",icon:"speed",label:"Speed",color:"#6FC8F5"}],Lk=new Set(["Neon","Cyber"]);function Dk(t){return t===void 0?null:t>=ja.ultimateSlam?"Widest":t>ja.rangedLong?"Max range":t>ja.rangedMid?"Long":t>ja.rangedClose?"Mid":t>ja.meleeHeavy?"Short":"Melee"}function zk(t){const e=[];t.type==="self"&&t.healAmount?e.push(`${D("heal")} +${t.healAmount} HP`):t.comboParts?.length?e.push(`${D("damage")} ${t.comboParts.map(o=>o.damage).join(" + ")}`):t.pellets&&t.pellets>1?e.push(`${D("damage")} ${t.damage} × ${t.pellets}`):t.damage>0&&e.push(`${D("damage")} ${t.damage}`);const a=Dk(t.range);return a&&e.push(`${D("range")} ${a}`),e.push(`${D("timer")} ${(t.cooldown/1e3).toFixed(1)}s`),t.effect&&e.push(t.effect==="stun"?`${D("stun")} Stun`:`${D("slow")} Slow`),e}function Hk(t){const e=Ee.filter(a=>a!==t);return e[Math.floor(Math.random()*e.length)]}function _k(t){la("fa-chars-styles",Pk),ha();const e=Ce("div","fa-screen fa-chars"),a=$l();let o=t.profile.selected;e.innerHTML=`
    <header class="fa-topbar">
    ...
    <div class="fa-confetti-layer" data-el="confetti"></div>
  `;const n=T=>{const S=e.querySelector(`[data-el="${T}"]`);if(!S)throw new Error(`characterSelect: missing element "${T}"`);return S},s=n("roster"),i=n("stats"),r=n("abilities"),l=n("hero3d"),h=n("heroname"),c=n("herorarity"),d=n("select"),p=n("level"),u=n("confetti"),m=new Map;for(const T of Ee){const S=re[T],A=Ce("button","chars-card");A.type="button",A.dataset.char=T,A.style.setProperty("--card-bg",Rl[S.rarity]),A.style.setProperty("--rarity",Ot[S.rarity]),A.style.setProperty("--rarity-glow",b0(Ot[S.rarity],.75)),Lk.has(S.rarity)&&A.classList.add("is-animated"),A.innerHTML=`
      ...
      <span class="fa-rarity chars-card-rarity"
            style="background:${Ot[S.rarity]}">${S.rarity}</span>
      <span class="chars-card-playing">${D("star")}</span>
      <span class="chars-card-lv" data-el="lv"></span>
    `,A.addEventListener("click",()=>M(T,!0)),s.appendChild(A),m.set(T,A)}const f=(T,S)=>{const A=m.get(T),C=A?.querySelector('[data-el="render"]');C&&(C.src=S,A.classList.add("has-render"))};for(const T of Ee){const S=Gl(T);S&&f(T,S)}S0(f);const g=Ce("div","chars-card chars-card--locked");g.innerHTML=`
    <span class="chars-card-art">${D("lock")}</span>
    <span class="chars-card-name">More soon</span>
  `,s.appendChild(g);const w=new Map;for(const T of Dp){const S=Ce("div","fa-stat ds-row ds-row--slate chars-stat");S.style.setProperty("--ds-row-accent",T.color),S.innerHTML=`
    ...
    `,w.set(T.key,S.querySelector(".ds-row-val")),i.appendChild(S)}function b(){const T=o,S=t.profile.characterLevel(T),A=t.profile.nextLevelPrice(T),C=t.profile.canLevelUp(T),R=A===null,F=Vr(T,Kr,S),N=Br(S),L=R?F:Vr(T,Kr,S+1),P=R?N:Br(S+1),W=R?"":`
      <span class="chars-lv-gain"><span class="chars-lv-item">${D("health")} +${L-F}</span
        ><span class="chars-lv-item">${D("damage")} +${Math.round((P/N-1)*100)}%</span></span>`;p.innerHTML=`
      <div class="chars-lv-head">
        <span class="chars-lv-badge${R?" is-max":""}">Lv ${S}${R?"":` / ${jr}`}</span>
        <span class="chars-lv-now"><span class="chars-lv-item">${D("health")} ${F} HP</span
          ><span class="chars-lv-item">${D("damage")} x${N.toFixed(2)}</span></span>
      </div>
      ${W}
      <button class="ds-btn ds-btn--block chars-lv-btn" type="button" data-el="upgrade"${R||!C?" disabled":""}>${R?`${D("star")} Max level`:`${D("sparkle")} Upgrade <span class="chars-lv-price">${D("coin")} ${A.coins.toLocaleString()}</span>`}</button>
      ${R||C?"":`<span class="chars-lv-short">${(A.coins-t.profile.coins).toLocaleString()} more coins needed</span>`}
    `}function x(){const T=t.profile.selected;for(const[A,C]of m)C.classList.toggle("is-playing",A===T);const S=o===T;d.innerHTML=S?`${D("star")} Equipped`:`${D("star")} Equip`,d.classList.toggle("is-equipped",S),d.disabled=S}function M(T,S=!1){o=T;const A=re[T];for(const[C,R]of m)R.classList.toggle("is-viewed",C===T);S&&m.get(T)?.scrollIntoView({block:"nearest"}),h.textContent=A.name,c.textContent=A.rarity,c.style.background=Ot[A.rarity];for(const C of Dp)w.get(C.key).textContent=String(A.stats[C.key]);r.innerHTML="";for(const C of wm(A)){const R=C.weapon,F=Ce("div","chars-ability");F.innerHTML=`
        <span class="chars-ability-em">${A0(C.emoji)}</span>
        <span class="chars-ability-body">
          <span class="chars-ability-name">${C.name}</span>
          <span class="chars-ability-desc">${C.desc}</span>
          ${R?`<span class="chars-ability-facts">${zk(R).map(N=>`<span class="chars-fact">${N}</span>`).join("")}</span>`:""}
        </span>
      `,r.appendChild(F)}if(A.hasTrail){const C=Ce("div","chars-ability chars-ability--passive");C.innerHTML=`
      ...
      `,r.appendChild(C)}r.scrollTop=0,a.show(T),x(),b()}n("back").addEventListener("click",()=>t.navigate({name:"home"})),d.addEventListener("click",()=>{t.profile.select(o),x(),_s(u,50,24),a.poke()}),n("fight").addEventListener("click",()=>{t.profile.select(o),t.navigate({name:"match",player:o,enemy:Hk(o)})});function y(){for(const[T,S]of m){const A=t.profile.characterLevel(T),C=S.querySelector('[data-el="lv"]');C&&(C.textContent=A>1?`Lv ${A}`:"",S.classList.toggle("has-lv",A>1),S.classList.toggle("is-maxed",A>=jr))}}function v(){n("wins").textContent=String(t.profile.wins),n("coins").textContent=t.profile.coins.toLocaleString()}p.addEventListener("click",T=>{!T.target.closest('[data-el="upgrade"]')||!t.profile.levelUp(o)||(_s(u,34,18),a.poke())});const k=t.profile.onChange(()=>{v(),y(),b()});return v(),y(),M(o),a.attachTo(l),{root:e,update(T){a.update(T)},resize(){a.resize()},dispose(){k(),a.detach(),e.remove()}}}const Pk=`
...
`,zp=["Normal","Rare","Epic","Legendary","Neon","Cyber"],$k=(()=>{const t=ra.map(a=>{const o=Mn(a).filter(r=>r.rarity);let n=null,s=-1,i=0;for(const r of o)i+=r.percent,r.percent>s&&(s=r.percent,n=r.rarity??null);return{kind:a,floor:n,charShare:i}});t.sort((a,o)=>{const n=a.floor?zp.indexOf(a.floor):-1,s=o.floor?zp.indexOf(o.floor):-1;return n-s||a.charShare-o.charShare});const e={};return t.forEach((a,o)=>{e[a.kind]={rank:o+1,of:t.length,floor:a.floor}}),e})();function $r(t,e={}){const a=$k[t];if(!a)return"";const o=a.floor?Ot[a.floor]:"var(--ink)",n=Array.from({length:a.of},(i,r)=>`<i class="tr-pip${r<a.rank?" is-on":""}"></i>`).join(""),s=`Tier ${a.rank} of ${a.of}${a.floor?`, ${a.floor} or rarer`:""}`;return`<span class="tr-tier" style="--pip:${o}" role="img" aria-label="${s}">${n}${e.label&&a.floor?`<span class="tr-tier-txt">${a.floor}+</span>`:""}</span>`}function qk(t){la("fa-trophy-styles",Bk),ha();const e=Ce("div","fa-screen fa-tr"),a=t.profile;e.innerHTML=`
    <header class="fa-topbar">
      <button class="fa-iconbtn" type="button" data-el="back" aria-label="Back to home">${D("back")} Back</button>
    ...
    <div class="fa-confetti-layer" data-el="confetti"></div>
  `;const o=R=>{const F=e.querySelector(`[data-el="${R}"]`);if(!F)throw new Error(`trophyRoad: missing element "${R}"`);return F},n=o("road"),s=o("inventory"),i=o("sheet"),r=o("sheetcard"),l=o("confetti"),h=o("claimall"),c=o("delta");function d(R=!1){const F=a.trophies;a.unlocked;const N=new Set(a.economy.claimed);n.innerHTML="";const L=Ce("div","tr-roadtrack"),P=Ce("div","tr-spine"),W=Ce("div","tr-spine-fill");P.appendChild(W),L.appendChild(P);let H=!1;const K=()=>{const _=Ce("div","tr-pin");_.dataset.el="pin",_.innerHTML=`
        <span class="tr-pin-dot">${D("pin")}</span>
        <span class="tr-pin-label">${F.toLocaleString()}</span>
      `,L.appendChild(_),H=!0};let O=0;for(const _ of Lm()){!H&&F<_.trophies&&K();const z=m(_,F,N.has(_.trophies));z.classList.add(O%2===0?"is-high":"is-low"),L.appendChild(z),O++}H||K(),n.appendChild(L),Do(L),p(),R&&u()}function p(){const R=n.querySelector(".tr-roadtrack"),F=n.querySelector(".tr-spine"),N=n.querySelector(".tr-spine-fill"),L=n.querySelector('[data-el="pin"]');if(!R||!F||!N||!L)return;N.style.width=`${Math.max(0,L.offsetLeft+L.offsetWidth/2)}px`;const P=F.getBoundingClientRect();if(P.height===0)return;const W=P.top+P.height/2;for(const H of R.querySelectorAll(".tr-node")){const K=H.getBoundingClientRect(),O=H.classList.contains("is-high")?W-K.bottom:K.top-W;H.style.setProperty("--stem",`${Math.max(0,Math.round(O))}px`)}}function u(){const R=n.querySelector('[data-el="pin"]');!R||n.clientWidth===0||(n.scrollLeft=Math.max(0,R.offsetLeft-n.clientWidth/2+R.offsetWidth/2))}function m(R,F,N,L){const P=Qr(R.reward),H=F>=R.trophies&&!N,K=H?Ce("button","tr-node is-claimable"):Ce("div","tr-node");if(H&&(K.type="button"),N&&K.classList.add("is-claimed"),P.isCharacter&&K.classList.add("is-character"),K.dataset.trophies=String(R.trophies),R.reward.type==="character"){const _=Ot[re[R.reward.id].rarity];K.style.setProperty("--node-accent",_),K.style.setProperty("--node-glow",b0(_,.55))}const O=N?`<span class="tr-status is-done">${D("check")} Claimed</span>`:H?'<span class="tr-status is-ready">Claim</span>':`<span class="tr-status">${(R.trophies-F).toLocaleString()} to go</span>`;return K.innerHTML=`
      <span class="tr-node-req">${D("trophy")} ${R.trophies.toLocaleString()}</span>
      <span class="tr-node-medal"><span class="tr-node-em">${R.reward.type==="character"?va(R.reward.id,{crop:"head"}):R.reward.type==="container"?At(R.reward.kind):ga(P.emoji)}</span>${N?`<span class="tr-node-tick">${D("check")}</span>`:""}</span>
      <span class="tr-node-title">${P.title}</span>
      ${R.reward.type==="container"?$r(R.reward.kind):""}
      ${P.payoutNote?`<span class="tr-node-note">${P.payoutNote.replace("🪙",D("coin"))}</span>`:""}
      ${O}
    `,K}function f(){o("coins").textContent=a.coins.toLocaleString(),o("gems").textContent=a.gems.toLocaleString(),o("trophies").textContent=a.trophies.toLocaleString();const R=i0(a.trophies),F=o("fill");F.style.width=`${(R.progress01*100).toFixed(1)}%`;const N=a.claimable.length;if(N>0)o("nextlabel").textContent="Ready now",o("nextval").innerHTML=N>1?`${D("sparkle")} ${N} road rewards to claim`:`${D("sparkle")} 1 road reward — tap it on the track`;else if(R.next){const L=R.next.reward,P=Qr(L,a.unlocked),W=R.next.trophies-a.trophies;o("nextlabel").textContent="Next reward",o("nextval").innerHTML=`${L.type==="character"?va(L.id,{crop:"head"}):L.type==="container"?At(L.kind):ga(P.emoji)} ${P.title} <span class="tr-togo">${D("trophy")} ${W.toLocaleString()} to go</span>`}else o("nextlabel").textContent="Road complete",o("nextval").innerHTML=`${D("flag")} Master of the Kitchen`;o("fillxp").textContent=R.next?`${(a.trophies-R.from).toLocaleString()} / ${(R.to-R.from).toLocaleString()}`:`Road complete — ${Jr().toLocaleString()}`,h.style.display=N>1?"":"none",h.innerHTML=`${D("sparkle")} Claim ${N}`,g()}function g(){s.innerHTML="";const R=ra.filter(F=>(a.containers[F]??0)>0);if(R.length===0){const F=a.winsToNextChest,N=Ce("p","tr-inv-empty");N.innerHTML=`${D("chest")} <strong>${F}</strong> more ${F===1?"win":"wins"} for a free Chest`,s.appendChild(N);return}for(const F of R){const N=Pe[F],L=a.containers[F]??0,P=Ce("button","tr-open");P.type="button",P.dataset.open=F,P.innerHTML=`
        <span class="tr-open-em">${At(F)}</span>
        <span class="tr-open-body">
          <span class="tr-open-name">${N.name}</span>
          <span class="tr-open-cta">Open ${$r(F)}</span>
        </span>
        <span class="tr-open-count">${L}</span>
      `,s.appendChild(P)}}function w(R,F="wide"){r.innerHTML=R,r.classList.toggle("is-reveal",F==="reveal"),i.classList.add("is-open")}function b(){i.classList.remove("is-open"),r.innerHTML=""}function x(R){const F=[];for(const N of R.characters)F.push(va(N,{crop:"head"}));for(const[N,L]of Object.entries(R.containers))L&&F.push(At(N));return R.coins>0&&F.push(D("coin")),R.gems>0&&F.push(D("gem")),F}function M(R,F){const N=Rm(R);if(N.length===0)return;const L=x(R),[P,...W]=N;w(`
      <div class="tr-reveal">
        <div class="tr-reveal-em">${L[0]??ga(P.emoji)}</div>
        <p class="tr-reveal-kicker">${F}</p>
        <p class="tr-reveal-name">${P.label}</p>
        ${W.length>0?`<div class="tr-reveal-more">${W.map((H,K)=>`<span class="tr-reveal-chip">${L[K+1]??ga(H.emoji)} ${H.label}</span>`).join("")}</div>`:""}
        <button class="fa-btn fa-btn--primary tr-sheet-close" type="button" data-el="close">Nice!</button>
      </div>
    `,"reveal"),Do(r),_s(l,50,28)}function y(){const R=ra.map(F=>{const N=Pe[F],L=Mn(F).map(W=>`
        <li class="tr-odds-row">
          <span class="tr-odds-what">${W.rarity?`<i class="tr-odds-dot" style="background:${Ot[W.rarity]}"></i>`:""}${W.label}</span>
          <span class="tr-odds-pct">${o0(W.percent)}</span>
        </li>
      `).join(""),P=Mn(F).filter(W=>W.pool&&W.pool.length>0).map(W=>`${W.rarity}: ${W.pool.map(H=>re[H].name).join(", ")}`).join(" · ");return`
        <section class="tr-odds-block">
          <h3 class="tr-odds-title">${At(F)} ${N.name} ${$r(F,{label:!0})}</h3>
      ...
      <div class="fa-scroll tr-sheet-scroll">
        ...
        <p class="tr-sheet-note tr-sheet-note--rarity">${e0}</p>
        ${R}
      </div>
    `)}function v(){const R=Hm().map(F=>{const N=Pm(F),L=[];return F.coins&&L.push(`${D("coin")} ${F.coins.toLocaleString()}`),F.container&&L.push(`${At(F.container.kind)} ${Pe[F.container.kind].name}`),`
        <div class="tr-sku${F.oneTime?" is-featured":""}">
          ${N>0||F.oneTime?`<span class="tr-sku-flags">
            ${N>0?`<span class="tr-sku-bonus">+${N}%</span>`:""}
            ${F.oneTime?'<span class="tr-sku-bonus tr-sku-once">ONE TIME</span>':""}
          </span>`:""}
          <span class="tr-sku-em">${F.container?At(F.container.kind):ga(F.emoji)}</span>
          <span class="tr-sku-name">${F.name}</span>
          <span class="tr-sku-gems">${D("gem")} ${F.gems.toLocaleString()}</span>
          ${L.length>0?`<span class="tr-sku-extra">+ ${L.join(" + ")}</span>`:""}
          <button class="tr-sku-buy" type="button" disabled>${`${_m(F.priceUsdCents)} · Soon`}</button>
        </div>
      `}).join("");w(`
      <div class="tr-sheet-head">
    ...
    `)}o("back").addEventListener("click",()=>t.navigate({name:"home"})),o("oddsbtn").addEventListener("click",y),o("storebtn").addEventListener("click",v),o("scrim").addEventListener("click",b),h.addEventListener("click",()=>{const R=a.claimAllMilestones();M(R,"You earned")});const k=R=>{const F=R.target;if(F.closest('[data-el="close"]')){b();return}const N=F.closest(".tr-node.is-claimable");if(N){const P=Number(N.dataset.trophies),W=a.claimMilestone(P);W&&M(W,"You earned");return}const L=F.closest("[data-open]");if(L){const P=L.dataset.open,W=a.openContainer(P);W&&M(W.reward,W.duplicateOf?`${re[W.duplicateOf].name} again — traded in`:`From a ${Pe[P].name}`)}};e.addEventListener("click",k);const T=R=>{R.key==="Escape"&&i.classList.contains("is-open")&&b()};window.addEventListener("keydown",T);const S=a.onChange(()=>{f(),d()});f(),d();let A=!1;requestAnimationFrame(()=>{A||(p(),u())});const C=a.lastMatch;if(C&&!C.seen){const R=C.trophies>0?"+":"";c.innerHTML=`${R}${C.trophies} ${D("trophy")}`,c.className=`tr-delta is-on ${C.trophies>0?"is-up":C.trophies<0?"is-down":"is-flat"}`,a.markLastMatchSeen()}return{root:e,resize(){d(),u()},dispose(){A=!0,S(),e.removeEventListener("click",k),window.removeEventListener("keydown",T),e.remove()}}}const Bk=`
...
`,Hp=Object.keys(Fo).sort((t,e)=>Fo[t]-Fo[e]);function jk(t,e){const a=Pe[t].entries,o=ii(a);return a.map(n=>{let s=n.coins??0;const i=n.gems??0;let r=null;return n.characterRarity&&((si[n.characterRarity]??[]).some(h=>!e.has(h))?r=n.characterRarity:s+=Fo[n.characterRarity]),{chance01:o>0?n.weight/o:0,coins:s,gems:i,fighter:r}})}function df(t,e){const a=jk(t,e),o={canGrantFighter:!1,bestCoins:0,bestGems:0,expectedCoins:0,expectedGems:0,characterPercent:0,floorRarity:null};for(const s of a)s.fighter&&(o.canGrantFighter=!0),o.bestCoins=Math.max(o.bestCoins,s.coins),o.bestGems=Math.max(o.bestGems,s.gems),o.expectedCoins+=s.chance01*s.coins,o.expectedGems+=s.chance01*s.gems;const n=ii(Pe[t].entries);for(const s of Pe[t].entries){if(!s.characterRarity)continue;o.characterPercent+=n>0?s.weight/n*100:0;const i=Hp.indexOf(s.characterRarity),r=o.floorRarity===null?1/0:Hp.indexOf(o.floorRarity);i<r&&(o.floorRarity=s.characterRarity)}return o}function yo(t,e,a){const o=Pe[t].price;if(!o)return!1;const n=df(t,a);return n.canGrantFighter?!0:e==="coins"?n.bestCoins>o.coins:n.bestGems>o.gems}const Gk=ra.filter(t=>Pe[t].price!==null);function Wk(t){la("fa-shop-styles",Uk),ha();const e=Ce("div","fa-screen fa-shop"),a=t.profile;e.innerHTML=`
    <header class="fa-topbar">
      <button class="fa-iconbtn" type="button" data-el="back" aria-label="Back to home">${D("back")} Back</button>
  ...
  `;const o=u=>{const m=e.querySelector(`[data-el="${u}"]`);if(!m)throw new Error(`shop: missing element "${u}"`);return m},n=o("scroll");function s(u){return`<ul class="shop-odds">${Mn(u).map(f=>`
      <li class="shop-odds-row">
        <span class="shop-odds-what">${f.rarity?`<i class="shop-odds-dot" style="background:${Ot[f.rarity]}"></i>`:""}${f.label}</span>
        <span class="shop-odds-pct">${o0(f.percent)}</span>
      </li>`).join("")}</ul>`}function i(u){const m=Mn(u).filter(f=>f.rarity&&f.pool&&f.pool.length>0).map(f=>`<span class="shop-pool-line"><i class="shop-odds-dot" style="background:${Ot[f.rarity]}"></i>${f.pool.map(g=>re[g].name).join(", ")}</span>`).join("");return m?`<div class="shop-pool">${m}</div>`:""}function r(u,m){const f=Pe[u],g=f.price,w=df(u,m),b=w.canGrantFighter&&w.characterPercent>=99.999&&w.floorRarity?`<span class="shop-guarantee"><i class="shop-odds-dot" style="background:${Ot[w.floorRarity]}"></i>Always a fighter, ${w.floorRarity} or rarer</span>`:"",x=y=>{const v=y==="coins"?g.coins:g.gems,k=y==="coins"?a.coins:a.gems,T=D(y==="coins"?"coin":"gem"),S=yo(u,y,m),A=k>=v,C=S&&A,R=S?`You need ${(v-k).toLocaleString()} more ${y}`:"Not for sale right now";return`
        <button class="shop-buy shop-buy--${y}${C?"":" is-off"}" type="button"
          data-buy="${u}" data-currency="${y}"${C?"":` disabled title="${R}" aria-label="${v.toLocaleString()} ${y}. ${R}."`}>
          ${T} ${v.toLocaleString()}
        </button>`};let M="";if(!yo(u,"coins",m)&&!yo(u,"gems",m)){const y=w.bestGems===0,v=w.bestCoins<g.coins?`It pays back at most ${w.bestCoins.toLocaleString()} coins for a ${g.coins.toLocaleString()} coin price, and ${Math.round(w.expectedCoins).toLocaleString()} on average.`:`Its average return is ${Math.round(w.expectedCoins).toLocaleString()} coins against a ${g.coins.toLocaleString()} coin price.`;M=`
        <p class="shop-why">
          <span class="shop-why-head">Not for sale</span>
          Every fighter this box can give is already unlocked, so it can only pay
          ${y?"coins":"currency"} back. ${v}
        ...
        </p>`;else{const y=[...new Set(Pe[u].entries.flatMap(k=>k.characterRarity?si[k.characterRarity]??[]:[]))],v=y.filter(k=>!m.has(k)).length;M=w.expectedCoins===0?`<p class="shop-why"><span class="shop-why-head">What you get</span>
            Every roll here is a new fighter. ${v} of the ${y.length} are still
            missing from your roster.</p>`:`<p class="shop-why"><span class="shop-why-head">Duplicates</span>
            ${v} of the ${y.length} fighters here are still missing. A repeat
      ...
      <article class="shop-card">
        ...
        ${M}
      </article>`}function l(u){const m=Pe[u],f=a.winsToNextChest;return`
      ...
      </article>`}function h(){const u=ra.filter(f=>(a.containers[f]??0)>0);return u.length===0?"":`
      ...
      <span class="shop-held">
        <span class="shop-held-em">${At(f)}</span>
        <span class="shop-held-name">${Pe[f].name}</span>
      ...
      </section>`}function c(){const u=a.unlocked;o("coins").textContent=a.coins.toLocaleString(),o("gems").textContent=a.gems.toLocaleString();const m=Gk.some(g=>yo(g,"coins",u)||yo(g,"gems",u)),f=m?"":`
      ...
      <section class="shop-section">
        ...
        <p class="shop-rarity">${e0}</p>
        <div class="shop-grid">${ra.map(g=>Pe[g].price?r(g,u):l(g)).join("")}</div>
      </section>
    `,o("footnote").textContent=m?"Coins and gems are earned by playing. Both work on every box.":"Boxes are earned, not bought:"}o("back").addEventListener("click",()=>t.navigate({name:"home"}));const d=u=>{const m=u.target,f=m.closest("[data-go]")?.dataset.go;if(f==="trophies"){t.navigate({name:"trophies"});return}if(f==="characters"){t.navigate({name:"characters"});return}const g=m.closest("[data-buy]");if(!g||g.disabled)return;const w=g.dataset.buy,b=g.dataset.currency;yo(w,b,a.unlocked)&&a.buyContainer(w,b)};e.addEventListener("click",d);const p=a.onChange(c);return c(),{root:e,dispose(){p(),e.removeEventListener("click",d),e.remove()}}}const Uk=`
...
`,Yk=null,_p="Open to a player",Pp="Online play is not connected yet. This seat is played by a bot.";function Vk(t){return`Online play is not connected yet, so ${t===1?"the other seat is":`all ${t} other seats are`} played by a bot. Opening a seat to another player is switched off rather than offered as a button that does nothing.`}function Kk(t){la("fa-lobby-styles",Zk),ha();const e=window.__faOpenSeat!==void 0?window.__faOpenSeat:Yk,a=e!==null,o=t.profile.selected,n=Xk(o);let s=Gh[0];const i=Ce("div","fa-screen fa-lobby");i.innerHTML=`
    <header class="fa-topbar">
      <button class="fa-iconbtn" type="button" data-el="back" aria-label="Back to home">${D("back")} Back</button>
  ...
  `;const r=g=>{const w=i.querySelector(`[data-el="${g}"]`);if(!w)throw new Error(`lobby: missing element "${g}"`);return w},l=r("seats"),h=r("opts"),c=r("note");for(const g of Gh){const w=Ce("button","ds-btn lobby-opt");w.type="button",w.dataset.seats=String(g),w.textContent=String(g),w.setAttribute("aria-label",`${g} players`),h.appendChild(w)}function d(){r("count").textContent=String(s);for(const g of h.querySelectorAll(".lobby-opt")){const w=Number(g.dataset.seats)===s;g.classList.toggle("is-on",w),g.setAttribute("aria-pressed",w?"true":"false")}}function p(){const g=Jp(o,n,s),w=t.profile.characterLevel(o),b=l0(w);l.innerHTML=g.map((x,M)=>{const y=M===0,v=re[x].name,k=y?w:b,T=y?"You":"Bot",S=y?`<button class="ds-btn ds-btn--icon lobby-seat-act" type="button" data-el="swap"
             ...
             title="${_p}. ${Pp}"
             aria-label="${_p} — seat ${M+1}. ${a?"":Pp}">${D("avatar")}</button>`;return`
        <div class="lobby-seat${y?" is-you":""}" data-seat="${M}" data-char="${x}">
          <span class="lobby-seat-pic">${va(x,{crop:"head"})}</span>
          <span class="lobby-seat-body">
            <span class="lobby-seat-name" data-el="seat-name">${v}</span>
            <span class="lobby-seat-tag"><b>${T}</b> · Lv ${k}</span>
          </span>
          ${S}
        </div>`}).join(""),Do(l)}function u(){c.textContent=a?"":Vk(s-1),c.hidden=a}function m(){d(),p(),u()}const f=g=>{const w=g.target,b=w?.closest(".lobby-opt");if(b){const M=Number(b.dataset.seats);Number.isInteger(M)&&M!==s&&(s=M,m());return}const x=w?.closest('[data-el="open"]');if(x){e?.(Number(x.dataset.slot));return}if(w?.closest('[data-el="swap"]')){t.navigate({name:"characters"});return}w?.closest('[data-el="back"]')&&t.navigate({name:"home"})};return i.addEventListener("click",f),r("start").addEventListener("click",()=>{const g={name:"match",player:o,enemy:n,seats:ni(s)};t.navigate(g)}),m(),{root:i,dispose(){i.removeEventListener("click",f),i.remove()}}}function Xk(t){const e=Ee.filter(a=>a!==t);return e[Math.floor(Math.random()*e.length)]}const Zk=`
...
`,Jk="admin panel is not enabled in this build — rebuild with VITE_FA_ADMIN=1, or run the dev server",pf=["opening","home","characters","trophies","shop","settings","lobby","match"];function ei(t){return typeof t=="string"&&Ee.includes(t)}function Qk(t){return typeof t=="number"?ni(t):void 0}function e4(t){if(!t||typeof t!="object")return null;const e=t.name;if(typeof e!="string"||!pf.includes(e))return null;if(e==="match"){const{player:a,enemy:o,seats:n}=t;return ei(a)&&ei(o)?{name:e,player:a,enemy:o,seats:Qk(n)}:null}return{name:e}}function t4(t){const e=new URLSearchParams(t),a=e.get("screen");if(a===null||!pf.includes(a))return null;if(a==="match"){const o=e.get("player"),n=e.get("enemy");return ei(o)&&ei(n)?{name:a,player:o,enemy:n,seats:a4(e)}:null}return{name:a}}function a4(t){const e=t.get("seats");return e===null?void 0:ni(Number(e))}function qr(t,e){return t.name!==e.name?!1:t.name==="match"&&e.name==="match"?t.player===e.player&&t.enemy===e.enemy&&t.seats===e.seats:!0}function $p(t){const e=new URLSearchParams(window.location.search);e.set("screen",t.name),t.name==="match"?(e.set("player",t.player),e.set("enemy",t.enemy),t.seats===void 0?e.delete("seats"):e.set("seats",String(t.seats))):(e.delete("player"),e.delete("enemy"),e.delete("seats"));const a=e.toString();return`${window.location.pathname}${a?`?${a}`:""}${window.location.hash}`}function o4(t,e){if(e!=="none")try{const a={fa:1,route:t};e==="push"?window.history.pushState(a,"",$p(t)):window.history.replaceState(a,"",$p(t))}catch{}}const n4=3e3,s4=10,i4=140;function r4(t){tg(),hf();const e=document.createElement("div");e.className="fa-root",e.innerHTML=`
    <div class="fa-bg"></div>
    <div class="fa-rays"></div>
    <div class="fa-dots"></div>
    <div class="fa-stack" data-el="stack"></div>
    <div class="fa-curtain" data-el="curtain"></div>
  `,t.screenRoot.appendChild(e);const a=e.querySelector('[data-el="stack"]'),o=e.querySelector('[data-el="curtain"]'),n=t.profile??new w0;let s=null,i={name:"home"},r=0,l=0,h=!1,c=null,d=!1,p=null,u=0;function m($,ee){console.error(`[shell] ${$}:`,ee)}function f($){const ee=window.__shellFault;if(!ee)return!1;const ye=ee[$];return typeof ye!="number"||ye<=0?!1:(ee[$]=ye-1,!0)}const g={navigate:O,profile:n,gameHost:t.gameHost,hudRoot:t.hudRoot};function w($){if(f("build"))throw new Error(`__shellFault: build ${$.name}`);switch($.name){case"opening":return c1(g);case"home":return n1(g);case"characters":return _k(g);case"trophies":return qk(g);case"shop":return Wk(g);case"settings":return Ok(g);case"lobby":return Kk(g);case"admin":throw new Error(Jk);case"match":return Tk(g,$)}throw new Error(`unknown route "${String($.name)}"`)}function b(){r&&cancelAnimationFrame(r),r=0}function x(){b(),l=performance.now();const $=ee=>{if(d)return;const ye=Math.min(Math.max(0,(ee-l)/1e3),1/20);l=ee;try{if(f("update"))throw new Error("__shellFault: update");s?.update?.(ye),u=0}catch(Se){if(u++,u===1&&m(`screen "${i.name}" update() threw`,Se),u>=s4){m(`screen "${i.name}" update() threw ${u} frames running — stopping the menu loop`,Se),b();return}}r=requestAnimationFrame($)};r=requestAnimationFrame($)}function M($,ee){if($.name==="match")try{ac()}catch(Se){m("disposeCharacterStage() threw",Se)}try{$.name==="match"?ke.music.fadeOut():ke.music.fadeIn()}catch(Se){m("music transition threw",Se)}e.classList.toggle("is-ingame",$.name==="match");let ye;try{ye=w($)}catch(Se){P($,Se);return}i=$,s=ye,a.appendChild(ye.root),o4($,ee),R(),window.__screen=$.name,u=0,s.update?x():b(),$.name!=="match"&&(window.__previewReady=!1,requestAnimationFrame(()=>requestAnimationFrame(()=>{d||(window.__previewReady=!0)})))}function y($){$.style.cssText=["pointer-events:auto","background:#FFF3DE","color:#1a1224","border-radius:16px","padding:18px 22px","max-width:min(92vw,420px)","text-align:center","box-shadow:0 10px 30px rgba(0,0,0,0.45)","font-family:'Rubik',sans-serif"].join(";")}function v($){$.style.cssText=["position:absolute","inset:0","z-index:120","display:grid","place-items:center","padding:16px","background:rgba(20,13,30,0.72)","pointer-events:none"].join(";")}function k($){const ee=document.createElement("button");return ee.type="button",ee.textContent=$,ee.style.cssText=["min-height:44px","min-width:140px","margin-top:14px","padding:0 20px","border:0","border-radius:999px","background:#F4A300","color:#1a1224","font-family:'Rubik',sans-serif","font-weight:800","font-size:16px","cursor:pointer"].join(";"),ee.addEventListener("click",()=>window.location.reload()),ee}function T($){const ee=document.createElement("div");v(ee),ee.style.background="#16101f",ee.dataset.el="fa-fatal";const ye=document.createElement("div");y(ye);const Se=document.createElement("div");Se.textContent="The kitchen would not open",Se.style.cssText="font-weight:800;font-size:18px";const Ye=document.createElement("div");return Ye.textContent=String($?.message??$??"unknown error"),Ye.style.cssText="margin-top:8px;font-size:13px;opacity:0.75;font-family:'Heebo',sans-serif;word-break:break-word",ye.append(Se,Ye,k("Reload")),ee.appendChild(ye),ee}let S=null,A=null;function C(){if(d||S)return;const $=document.createElement("div");v($),$.dataset.el="fa-gl-notice";const ee=document.createElement("div");y(ee);const ye=document.createElement("div");ye.textContent="Graphics interrupted",ye.style.cssText="font-weight:800;font-size:18px";const Se=document.createElement("div");Se.textContent="The device took the graphics back. Restoring…",Se.style.cssText="margin-top:6px;font-size:14px;opacity:0.8;font-family:'Heebo',sans-serif";const Ye=k("Reload");Ye.style.display="none",ee.append(ye,Se,Ye),$.appendChild(ee),e.appendChild($),S=$,A=setTimeout(()=>{A=null,S&&(Se.textContent="The graphics have not come back. Reloading returns you to this same screen.",Ye.style.display="inline-block")},n4)}function R(){A!==null&&(clearTimeout(A),A=null),S?.remove(),S=null}function F($){return $.detail?.offscreen===!0}function N($){F($)||C()}function L($){F($)||R()}function P($,ee){if(m(`screen "${$.name}" failed to mount`,ee),a.innerHTML="",$.name!=="home"){M({name:"home"},"replace");return}s=null,i={name:"home"},window.__screen="home",b(),a.appendChild(T(ee))}function W(){b();try{if(f("dispose"))throw new Error("__shellFault: dispose");s?.dispose()}catch($){m(`screen "${i.name}" dispose() threw`,$)}s=null,a.innerHTML=""}function H($){return i.name==="opening"||qr($,i)?"replace":"push"}function K($,ee){h=!0,window.__screenReady=!1,o.classList.add("is-on"),c=setTimeout(()=>{c=null;try{W(),M($,ee)}catch(ye){m("navigation threw",ye)}finally{o.classList.remove("is-on"),h=!1,window.__screenReady=!0,z()}},i4)}function O($){d||h||K($,H($))}const _=$=>{if(d)return;const ee=$.state,ye=e4(ee?.route)??t4(window.location.search)??{name:"home"};if(!qr(ye,i)){if(h){p=ye;return}K(ye,"none")}};function z(){const $=p;p=null,!(!$||d||qr($,i))&&K($,"none")}const V=()=>{try{s?.resize?.()}catch($){m(`screen "${i.name}" resize() threw`,$)}},ce='button, [role="button"], a[href], [data-clicksound="on"]',se=$=>{try{if(ke.isMuted())return;const ee=$.target?.closest?.(ce);if(!ee||ee.closest('[data-clicksound="off"]')||ee.hasAttribute("disabled")||ee.getAttribute("aria-disabled")==="true")return;ke.previewClick()}catch(ee){m("ui click sound threw",ee)}};return e.addEventListener("click",se,!0),window.addEventListener("resize",V),window.addEventListener("popstate",_),window.addEventListener("fa:webglcontextlost",N),window.addEventListener("fa:webglcontextrestored",L),window.__shell={navigate:O,route:()=>i},{navigate($){if(!s){M($,$.name==="opening"?"none":"replace"),window.__screenReady=!0;return}O($)},get route(){return i},dispose(){d=!0,c!==null&&clearTimeout(c),e.removeEventListener("click",se,!0),window.removeEventListener("resize",V),window.removeEventListener("popstate",_),window.removeEventListener("fa:webglcontextlost",N),window.removeEventListener("fa:webglcontextrestored",L),R(),W(),ac(),e.remove(),delete window.__shell}}}const St=new URLSearchParams(location.search),l4=["player","enemy","simSpeed","fogRadius","px","py","fighters","seats"];function qp(t,e){const a=St.get(t);return a&&Ee.includes(a)?a:e}function h4(t){if(St.get("screen")==="match"||!St.has("screen")&&l4.some(a=>St.has(a))){const a=qp("player",t.selected),o=a==="donut"?"hamburger":"donut",n=km(St);return{name:"match",player:a,enemy:qp("enemy",o),seats:n}}return St.get("screen")==="lobby"?{name:"lobby"}:St.get("screen")==="characters"?{name:"characters"}:St.get("screen")==="trophies"?{name:"trophies"}:St.get("screen")==="shop"?{name:"shop"}:St.get("screen")==="settings"?{name:"settings"}:St.get("screen")==="home"?{name:"home"}:{name:"opening"}}const uf=new w0,c4=r4({gameHost:document.getElementById("game"),hudRoot:document.getElementById("hud"),screenRoot:document.getElementById("screens"),profile:uf});c4.navigate(h4(uf));ke.music.play();const d4=document.getElementById("boot");requestAnimationFrame(()=>d4.classList.add("hidden"));
