import{C as re,l as el,c as Ia,L as ho,a as Ee,t as za,b as tl,V as de,d as J,S as _l,e as Me,M as Y,f as _e,R as at,B as Kh,g as T,h as Ea,i as Rn,j as et,k as al,m as di,G as ne,P as no,n as V,o as dt,p as Pl,q as In,O as ol,Z as Xh,A as Ps,r as Wf,s as p0,N as Yf,u as nl,v as u0,w as f0,x as $l,y as Xt,z as Wt,D as Lt,E as Ra,F as Ie,H as me,I as Pn,J as Vf,K as Kf,Q as Xe,T as Xf,U as Zf,W as Jf,X as m0,Y as g0,_ as Zh,$ as sl,a0 as Qf,a1 as em,a2 as tm,a3 as Ct,a4 as Bl,a5 as w0,a6 as am,a7 as om,a8 as nt,a9 as nm,aa as b0,ab as sm,ac as im,ad as Is,ae as Jh,af as Qh,ag as Cn,ah as rm,ai as nn,aj as _i,ak as lm,al as hm,am as Pi,an as ec,ao as il,ap as cm,aq as $s,ar as dm,as as pm,at as rl,au as um,av as ll,aw as fm,ax as mm,ay as gm,az as wm,aA as Bs,aB as hl,aC as bm,aD as ym,aE as xm,aF as vm,aG as ql,aH as it,aI as Ko,aJ as pi,aK as Qe,aL as Ja,aM as Ul,aN as Gl,aO as ui,aP as co,aQ as jl,aR as ya,aS as Ot,aT as po,aU as y0,aV as Wl,aW as Ca,aX as km,aY as Mm,aZ as Va,a_ as Em,a$ as Tm,b0 as Sm,b1 as tc,b2 as sn,b3 as qs,b4 as Am,b5 as $i,b6 as Rm,b7 as Im,b8 as Cm,b9 as Om,ba as Fm,bb as Nm,bc as Lm,bd as ac,be as Dm,bf as Hm,bg as zm,bh as _m,bi as Bi,bj as Pm,bk as $m,bl as Bm,bm as qm,bn as Um,bo as Gm}from"./kitchen-D2Xh_qVf.js";const _t=6,st=2;function jm(t){return t===0?"player":"enemy"}function Wm(t){return 1<<t}function Ym(t){const{id:e,controller:a,characterId:o,spawn:n,maxHp:s,size:i,hitRadius:r,facing:l}=t,h=re[o].weapons.length,c=Ia(t.level??ho);return{id:e,controller:a,role:jm(e),characterId:o,level:c,damageMul:el(c),x:n.x,y:n.y,hp:s,maxHp:s,size:i,hitRadius:r,facing:{x:l.x,y:l.y},status:{slowedUntil:-1/0,stunnedUntil:-1/0,slowAppliedAt:-1/0,slowStacks:0,stunAppliedAt:-1/0,stunStacks:0},alive:!0,deaths:0,lastUsed:new Array(h).fill(-1/0),hazardTimers:[],fogTimer:0,regenTimer:0,trailDropTimer:0,detourSign:0,lastDamagedAt:-1/0,terrainSlowFactor:1,concealed:!1,revealedUntil:-1/0,cast:null,push:{x:0,y:0,remaining:0}}}function x0(t){return t.cast!==null}function Yl(t,e){return e<t.status.stunnedUntil||t.cast!==null}function v0(t){return t==="player"?"enemy":"player"}function fi(t,e){return t!==e&&t.alive&&t.hp>0}function k0(t,e){let a=null,o=1/0;for(const n of t.fighters){if(!fi(n,e))continue;const s=Math.hypot(n.x-e.x,n.y-e.y);s<o&&(o=s,a=n)}return a}function Vm(t){let e=null;for(const a of t.fighters)if(!(!a.alive||a.hp<=0)){if(e!==null)return null;e=a}return e}function cl(t,e,a){return t*a+e}function Km(t){const e=t.get("seats");if(e!==null)return mi(Number(e))}function mi(t){if(Number.isInteger(t)&&!(t<=st||t>_t))return t}const oc=Array.from({length:_t-st+1},(t,e)=>st+e);function M0(t,e,a){if(!Number.isInteger(a)||a<st||a>_t)throw new RangeError(`brawlRoster: ${a} seats; the sim seats ${st}..${_t} (see state.ts MIN_FIGHTERS / MAX_FIGHTERS)`);const o=[t];a>1&&o.push(e);const n=Ee.indexOf(t);for(let s=1;o.length<a&&s<=Ee.length;s++){const i=Ee[(n+s)%Ee.length];o.includes(i)||o.push(i)}if(o.length!==a||new Set(o).size!==a)throw new RangeError(`brawlRoster: built ${o.length} seats (${new Set(o).size} distinct) for ${a} from ${Ee.length} characters — [${o.join(", ")}]`);return o}const nc={coins:500,gems:25},Xm=!1,E0=Ee[0],pt={trophiesWin:za("MATCH_PAYOUT.trophiesWin",15,{group:"economy",unit:"trophies",min:0,max:200,int:!0,doc:"Trophies for first place. The whole placement curve is stated relative to this — see the placement block below."}),trophyLossBase:za("MATCH_PAYOUT.trophyLossBase",2,{group:"economy",unit:"trophies",min:0,max:100,int:!0,doc:"Flat part of a loss. Loss = min(cap, base + floor(trophies / per))."}),trophyLossPer:za("MATCH_PAYOUT.trophyLossPer",150,{group:"economy",unit:"trophies",min:1,max:1e4,int:!0,doc:"Trophies per extra point of loss — the escalation rate. A DIVISOR: smaller is harsher."}),trophyLossCap:za("MATCH_PAYOUT.trophyLossCap",10,{group:"economy",unit:"trophies",min:0,max:200,int:!0,doc:"Ceiling on a single loss, however many trophies are held."}),trophyLossGraceBelow:za("MATCH_PAYOUT.trophyLossGraceBelow",100,{group:"economy",unit:"trophies",min:0,max:1e4,int:!0,doc:"Below this standing a loss costs nothing — the first hour must not read as standing still."}),coinsWin:za("MATCH_PAYOUT.coinsWin",60,{group:"economy",unit:"coins",min:0,max:1e4,int:!0,doc:"Coins for a win. The 3:1 ratio against coinsLoss is the design statement, not either number alone."}),coinsLoss:za("MATCH_PAYOUT.coinsLoss",20,{group:"economy",unit:"coins",min:0,max:1e4,int:!0,doc:"Coins for a loss. Always non-zero: a losing streak must not feel like a waste of ten minutes."}),winsPerChest:3,placementSteepness:1},Ho={Normal:120,Rare:260,Epic:520,Legendary:900,Neon:1400,Cyber:2200},rn={baseCoins:300,growth:1.32,rarityCostMultiplier:{Normal:1,Rare:1,Epic:1,Legendary:1,Neon:1,Cyber:1},roundTo:10},la=["chest","hamburgerBox","pineappleBox","redBox","fireBox"],T0="Rarity sets how hard a fighter is to find — not how strong it is, and not what it costs to level up. Two fighters at the same level are a fair fight whatever their rarity.",$e={chest:{name:"Chest",emoji:"📦",blurb:"Earned by winning matches and along the Trophy Road.",price:null,entries:[{weight:50,coins:120},{weight:22,coins:220},{weight:13,coins:90,gems:5},{weight:8,coins:400},{weight:4,coins:150,gems:20},{weight:2.1,characterRarity:"Normal"},{weight:.9,characterRarity:"Rare"}]},hamburgerBox:{name:"Hamburger Box",emoji:"🍔",blurb:"Mostly Normal fighters, with a chance of something rarer.",price:{coins:900,gems:60},entries:[{weight:89,characterRarity:"Normal"},{weight:10,characterRarity:"Rare"},{weight:1,characterRarity:"Epic"}]},pineappleBox:{name:"Purple Pineapple Box",emoji:"🍍",blurb:"Rare fighters guaranteed, Epic and Legendary possible.",price:{coins:3200,gems:120},entries:[{weight:94.5,characterRarity:"Rare"},{weight:5,characterRarity:"Epic"},{weight:.5,characterRarity:"Legendary"}]},redBox:{name:"Big Smile Box",emoji:"🎁",blurb:"Epic fighters, with the only Cyber chance outside the Fire Box.",price:{coins:5600,gems:240},entries:[{weight:89.49,characterRarity:"Epic"},{weight:10,characterRarity:"Legendary"},{weight:.5,characterRarity:"Neon"},{weight:.01,characterRarity:"Cyber"}]},fireBox:{name:"Purple Fire Box",emoji:"🔥",blurb:"Legendary fighters, with the best Neon and Cyber odds in the game.",price:{coins:12e3,gems:480},entries:[{weight:94.5,characterRarity:"Legendary"},{weight:5,characterRarity:"Neon"},{weight:.5,characterRarity:"Cyber"}]}},Zm=1e4,sa=[{trophies:30,reward:{type:"container",kind:"chest",count:1}},{trophies:65,reward:{type:"coins",amount:150}},{trophies:100,reward:{type:"character",id:"donut"}},{trophies:145,reward:{type:"gems",amount:5}},{trophies:195,reward:{type:"container",kind:"hamburgerBox",count:1}},{trophies:250,reward:{type:"character",id:"taco"}},{trophies:315,reward:{type:"coins",amount:250}},{trophies:390,reward:{type:"container",kind:"chest",count:1}},{trophies:480,reward:{type:"character",id:"burrito"}},{trophies:575,reward:{type:"gems",amount:10}},{trophies:685,reward:{type:"container",kind:"hamburgerBox",count:1}},{trophies:800,reward:{type:"character",id:"soup"}},{trophies:940,reward:{type:"coins",amount:400}},{trophies:1090,reward:{type:"container",kind:"pineappleBox",count:1}},{trophies:1250,reward:{type:"character",id:"sushi"}},{trophies:1420,reward:{type:"gems",amount:20}},{trophies:1595,reward:{type:"container",kind:"chest",count:1}},{trophies:1770,reward:{type:"coins",amount:700}},{trophies:1950,reward:{type:"character",id:"waterbottle"}},{trophies:2140,reward:{type:"container",kind:"pineappleBox",count:1}},{trophies:2340,reward:{type:"gems",amount:35}},{trophies:2550,reward:{type:"coins",amount:1200}},{trophies:2770,reward:{type:"container",kind:"chest",count:2}},{trophies:3e3,reward:{type:"character",id:"pizza"}},{trophies:3235,reward:{type:"container",kind:"redBox",count:1}},{trophies:3475,reward:{type:"coins",amount:1800}},{trophies:3725,reward:{type:"gems",amount:50}},{trophies:3980,reward:{type:"container",kind:"pineappleBox",count:1}},{trophies:4240,reward:{type:"coins",amount:2400}},{trophies:4500,reward:{type:"character",id:"egg"}},{trophies:4780,reward:{type:"gems",amount:70}},{trophies:5080,reward:{type:"container",kind:"redBox",count:1}},{trophies:5390,reward:{type:"coins",amount:3e3}},{trophies:5710,reward:{type:"container",kind:"chest",count:3}},{trophies:6040,reward:{type:"gems",amount:90}},{trophies:6380,reward:{type:"container",kind:"pineappleBox",count:2}},{trophies:6750,reward:{type:"character",id:"lollipop"}},{trophies:7125,reward:{type:"coins",amount:4e3}},{trophies:7510,reward:{type:"container",kind:"redBox",count:1}},{trophies:7905,reward:{type:"gems",amount:120}},{trophies:8310,reward:{type:"coins",amount:5e3}},{trophies:8725,reward:{type:"container",kind:"fireBox",count:1}},{trophies:9145,reward:{type:"gems",amount:150}},{trophies:9565,reward:{type:"bundle",parts:[{type:"coins",amount:8e3},{type:"gems",amount:250},{type:"container",kind:"fireBox",count:1}]}},{trophies:Zm,reward:{type:"character",id:"hotdog"}}],S0=[{id:"gemsPouch",name:"Pouch of Gems",emoji:"💎",priceUsdCents:99,gems:80},{id:"gemsSack",name:"Sack of Gems",emoji:"💎",priceUsdCents:499,gems:500},{id:"gemsCrate",name:"Crate of Gems",emoji:"💎",priceUsdCents:999,gems:1200},{id:"gemsBarrel",name:"Barrel of Gems",emoji:"💎",priceUsdCents:1999,gems:2600},{id:"gemsVault",name:"Vault of Gems",emoji:"💎",priceUsdCents:4999,gems:7e3},{id:"starterBundle",name:"Chef Starter Pack",emoji:"🧑‍🍳",priceUsdCents:499,gems:500,coins:2e3,container:{kind:"pineappleBox",count:1},oneTime:!0}],gi=(()=>{const t={};for(const e of Ee){const a=re[e].rarity;(t[a]??=[]).push(e)}return t})();function Jm(t){let e=t>>>0;return e=Math.imul(e^e>>>16,569420461),e=Math.imul(e^e>>>15,1935289751),(e^e>>>15)>>>0}function Qm(t){let e=Jm(Math.trunc(t)||0);const a=()=>{e=e+1831565813>>>0;let o=e;return o=Math.imul(o^o>>>15,o|1),o^=o+Math.imul(o^o>>>7,o|61),((o^o>>>14)>>>0)/4294967296};return{next:a,int(o){return o>0?Math.floor(a()*o):0},pick(o){return o.length>0?o[Math.floor(a()*o.length)]:void 0}}}function eg(t,e,a){if(e.length===0)return-1;const o=t.next()*a;let n=0;for(let s=0;s<e.length;s++)if(n+=e[s],o<n)return s;return e.length-1}function tg(){return Math.floor(Math.random()*4294967295)>>>0||1}function Vl(){return{coins:0,gems:0,containers:{},characters:[]}}function Cs(t,e){return e===1?t:/[sxz]$/i.test(t)?`${t}es`:`${t}s`}function A0(t,e){t.coins+=e.coins,t.gems+=e.gems;for(const[a,o]of Object.entries(e.containers))t.containers[a]=(t.containers[a]??0)+o;for(const a of e.characters)t.characters.includes(a)||t.characters.push(a);return t}function ag(t){const e=[];for(const a of t.characters)e.push({emoji:re[a].emoji,label:re[a].name});for(const[a,o]of Object.entries(t.containers)){if(!o)continue;const n=$e[a];e.push({emoji:n.emoji,label:o>1?`${o} ${Cs(n.name,o)}`:n.name})}return t.coins>0&&e.push({emoji:"🪙",label:`${t.coins.toLocaleString()} ${Cs("Coin",t.coins)}`}),t.gems>0&&e.push({emoji:"💎",label:`${t.gems.toLocaleString()} ${Cs("Gem",t.gems)}`}),e}function wi(t){return t.reduce((e,a)=>e+a.weight,0)}function On(t){const e=$e[t],a=wi(e.entries);if(a<=0)return[];const o=[];for(const s of e.entries){const i=s.weight/a*100;if(s.characterRarity){const r=gi[s.characterRarity]??[];o.push({label:`${s.characterRarity} fighter`,percent:i,rarity:s.characterRarity,pool:r})}else{const r=[];s.coins&&r.push(`${s.coins.toLocaleString()} coins`),s.gems&&r.push(`${s.gems.toLocaleString()} gems`),o.push({label:r.join(" + ")||"Nothing",percent:i})}}const n=new Map;for(const s of o){const i=n.get(s.label);i?i.percent+=s.percent:n.set(s.label,{...s})}return[...n.values()].sort((s,i)=>i.percent-s.percent)}function R0(t){return`${t.toFixed(4).replace(/0+$/,"").replace(/\.$/,"")}%`}function og(t,e,a){const o=$e[t],n=wi(o.entries),s=o.entries[eg(e,o.entries.map(r=>r.weight),n)],i=Vl();if(!s)return{kind:t,reward:i};if(s.coins&&(i.coins+=s.coins),s.gems&&(i.gems+=s.gems),s.characterRarity){const r=gi[s.characterRarity]??[],l=r.filter(h=>!a.has(h));if(l.length>0){const h=e.pick(l);i.characters.push(h)}else{const h=e.pick(r);if(i.coins+=Ho[s.characterRarity],h)return{kind:t,reward:i,duplicateOf:h}}}return{kind:t,reward:i}}function I0(t){return Ho[re[t].rarity]}function ng(t){return t<pt.trophyLossGraceBelow?0:Math.min(pt.trophyLossCap,pt.trophyLossBase+Math.floor(t/pt.trophyLossPer))}function bi(t,e){if(!Number.isInteger(e)||e<st||e>_t)throw new RangeError(`placementRank01: ${e} seats; the sim seats ${st}..${_t} (see game/state.ts MIN_FIGHTERS / MAX_FIGHTERS)`);if(!Number.isInteger(t)||t<0||t>=e)throw new RangeError(`placementRank01: place ${t} is outside 0..${e-1}`);return t/(e-1)}function Kl(t,e=pt.placementSteepness){return t<=0?0:t>=1?1:Math.pow(t,e)}function sg(t,e,a,o){const n=Kl(bi(t,e),o),s=pt.trophiesWin+ng(a);return Math.round(pt.trophiesWin-n*s)}function ig(t,e,a){const o=Kl(bi(t,e),a);return Math.round(pt.coinsWin-o*(pt.coinsWin-pt.coinsLoss))}function rg(t,e){return bi(t,e)<.5}function lg(){return sa}function dl(){return sa.length>0?sa[sa.length-1].trophies:0}function C0(t,e){return sa.filter(a=>t>=a.trophies&&!e.includes(a.trophies))}function hg(t){return sa.find(e=>t<e.trophies)??null}function O0(t){const e=hg(t);if(!e)return{from:dl(),to:dl(),progress01:1,next:null};const a=sa.indexOf(e),o=a>0?sa[a-1].trophies:0,n=e.trophies-o,s=n>0?Math.min(1,Math.max(0,(t-o)/n)):0;return{from:o,to:e.trophies,progress01:s,next:e}}function F0(t,e){const a=Vl();switch(t.type){case"coins":a.coins+=t.amount;break;case"gems":a.gems+=t.amount;break;case"container":a.containers[t.kind]=(a.containers[t.kind]??0)+t.count;break;case"character":a.coins+=I0(t.id);break;case"bundle":for(const o of t.parts)A0(a,F0(o));break}return a}function pl(t,e){switch(t.type){case"coins":return{emoji:"🪙",title:`${t.amount.toLocaleString()} Coins`,isCharacter:!1};case"gems":return{emoji:"💎",title:`${t.amount.toLocaleString()} Gems`,isCharacter:!1};case"container":{const a=$e[t.kind];return{emoji:a.emoji,title:t.count>1?`${t.count} ${Cs(a.name,t.count)}`:a.name,isCharacter:!1}}case"character":{const a=re[t.id],o=Xm;return{emoji:a.emoji,title:a.name,isCharacter:!0,payoutNote:o?void 0:`owned · 🪙 ${I0(t.id).toLocaleString()}`}}case"bundle":return{emoji:"🎉",title:"Grand Prize",isCharacter:!1}}}function cg(t,e){const a=Ia(e);if(a>=tl)return null;const o=a-ho,n=rn.baseCoins*Math.pow(rn.growth,o)*rn.rarityCostMultiplier[re[t].rarity];return{coins:Math.round(n/rn.roundTo)*rn.roundTo,gems:0}}function N0(t){return Ia(t)}function dg(){return S0}function pg(t){return new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}).format(t/100)}function sc(t){return t.priceUsdCents>0?t.gems/(t.priceUsdCents/100):0}function ug(t){const e=S0.filter(n=>!n.oneTime&&n.gems>0),a=e.reduce((n,s)=>s.priceUsdCents<n.priceUsdCents?s:n,e[0]);if(!a||t.id===a.id)return 0;const o=sc(t)/sc(a);return Math.max(0,Math.round((o-1)*100))}function L0(){const t={};for(const e of la)t[e]=0;return t}function D0(t=tg()){return{trophies:0,bestTrophies:0,coins:nc.coins,gems:nc.gems,containers:L0(),claimed:[],unlocked:[E0],winsTowardChest:0,lastMatch:null,levels:{},seed:t,rolls:0}}function Xl(t){return new Set(Ee)}function fg(t,e){return!0}function H0(t,e){t.coins+=e.coins,t.gems+=e.gems;for(const[a,o]of Object.entries(e.containers))t.containers[a]=(t.containers[a]??0)+(o??0);for(const a of e.characters)t.unlocked.includes(a)||t.unlocked.push(a)}function ul(t,e,a){return t.coins<e||t.gems<a?!1:(t.coins-=e,t.gems-=a,!0)}function mg(t,e,a){const o=sg(e,a,t.trophies);t.trophies=Math.max(0,t.trophies+o),t.bestTrophies=Math.max(t.bestTrophies,t.trophies);const n=ig(e,a);t.coins+=n;let s=0;if(rg(e,a)){for(t.winsTowardChest++;t.winsTowardChest>=pt.winsPerChest;)t.winsTowardChest-=pt.winsPerChest,s++;t.containers.chest+=s}const i={won:e===0,trophies:o,coins:n,chests:s,place:e,seats:a,seen:!1};return t.lastMatch=i,i}function gg(t){return Math.max(0,pt.winsPerChest-t.winsTowardChest)}function z0(t){return C0(t.trophies,t.claimed)}function _0(t,e){const a=C0(t.trophies,t.claimed).find(n=>n.trophies===e);if(!a)return null;const o=F0(a.reward,Xl());return t.claimed.push(e),t.claimed.sort((n,s)=>n-s),H0(t,o),o}function wg(t){const e=Vl();for(const a of z0(t)){const o=_0(t,a.trophies);o&&A0(e,o)}return e}function bg(t,e){if((t.containers[e]??0)<=0)return null;t.containers[e]--;const a=Qm(t.seed+t.rolls);t.rolls++;const o=og(e,a,Xl());return H0(t,o.reward),o}function yg(t){return la.reduce((e,a)=>e+(t.containers[a]??0),0)}function xg(t,e,a){const o=$e[e].price;return!o||!(a==="coins"?ul(t,o.coins,0):ul(t,0,o.gems))?!1:(t.containers[e]++,!0)}function Zl(t,e){return Ia(t.levels[e]??ho)}function Jl(t,e){return cg(e,Zl(t,e))}function vg(t,e){const a=Jl(t,e);return a!==null&&t.coins>=a.coins&&t.gems>=a.gems}function kg(t,e){const a=Jl(t,e);if(!a||!ul(t,a.coins,a.gems))return null;const o=Ia(Zl(t,e)+1);return t.levels[e]=o,{level:o,spent:a}}function Mg(t){const e=D0();if(!t||typeof t!="object")return e;const a=t,o=(s,i)=>typeof s=="number"&&Number.isFinite(s)&&s>=0?Math.floor(s):i,n={trophies:o(a.trophies,0),bestTrophies:o(a.bestTrophies,0),coins:o(a.coins,e.coins),gems:o(a.gems,e.gems),containers:L0(),claimed:[],unlocked:[E0],winsTowardChest:o(a.winsTowardChest,0),lastMatch:null,levels:{},seed:o(a.seed,e.seed)||e.seed,rolls:o(a.rolls,0)};if(a.containers&&typeof a.containers=="object"){const s=a.containers;for(const i of la)n.containers[i]=o(s[i],0)}if(Array.isArray(a.claimed)){const s=new Set(sa.map(r=>r.trophies)),i=new Set(a.claimed.filter(r=>typeof r=="number"&&s.has(r)));n.claimed=[...i].sort((r,l)=>r-l)}if(Array.isArray(a.unlocked))for(const s of a.unlocked)typeof s=="string"&&Ee.includes(s)&&!n.unlocked.includes(s)&&n.unlocked.push(s);if(a.levels&&typeof a.levels=="object"){const s=a.levels;for(const i of Ee){const r=s[i];if(typeof r!="number"||!Number.isFinite(r))continue;const l=Ia(r);l>ho&&(n.levels[i]=l)}}if(a.lastMatch&&typeof a.lastMatch=="object"){const s=a.lastMatch,i=s.won===!0,r=Number.isInteger(s.seats)&&s.seats>=st&&s.seats<=_t?s.seats:st,l=Number.isInteger(s.place)&&s.place>=0&&s.place<r?s.place:i?0:r-1;n.lastMatch={won:l===0,trophies:typeof s.trophies=="number"&&Number.isFinite(s.trophies)?Math.trunc(s.trophies):0,coins:o(s.coins,0),chests:o(s.chests,0),place:l,seats:r,seen:s.seen===!0}}return n.bestTrophies=Math.max(n.bestTrophies,n.trophies),n}function Eg(t){return{trophies:t.trophies,bestTrophies:t.bestTrophies,coins:t.coins,gems:t.gems,containers:{...t.containers},claimed:[...t.claimed],unlocked:[...t.unlocked],winsTowardChest:t.winsTowardChest,lastMatch:t.lastMatch?{...t.lastMatch}:null,levels:{...t.levels},seed:t.seed,rolls:t.rolls}}function Tg(t,e){typeof e.coins=="number"&&Number.isFinite(e.coins)&&e.coins>=0&&(t.coins=Math.floor(e.coins)),typeof e.gems=="number"&&Number.isFinite(e.gems)&&e.gems>=0&&(t.gems=Math.floor(e.gems))}const P0="food-arena.profile.v1",En=250,ic=100,Sg=35;function $0(t,e){const a=Kl(bi(t,e));return Math.round(ic-a*(ic-Sg))}const fl="Chef",ml=16;function B0(t){if(typeof t!="string")return fl;const e=t.replace(/\s+/g," ").replace(/[\p{Cc}\p{Cf}]/gu,"").trim().slice(0,ml).trim();return e.length>0?e:fl}function Ag(t){return typeof t=="string"&&Ee.includes(t)}function qi(t,e){return typeof t=="number"&&Number.isFinite(t)&&t>=0?t:e}function rc(){return{name:fl,wins:0,losses:0,xp:0,selected:Ee[0],economy:D0()}}function lc(){try{const t=localStorage.getItem(P0);if(!t)return rc();const e=JSON.parse(t),a=Mg(e.economy);return e.economy===void 0&&Tg(a,e),{name:B0(e.name),wins:Math.floor(qi(e.wins,0)),losses:Math.floor(qi(e.losses,0)),xp:Math.floor(qi(e.xp,0)),selected:Ag(e.selected)?e.selected:Ee[0],economy:a}}catch{return rc()}}class q0{data;listeners=new Set;constructor(e){this.data=e?{...lc(),...e}:lc()}get name(){return this.data.name}get wins(){return this.data.wins}get losses(){return this.data.losses}get xp(){return this.data.xp}get selected(){return this.data.selected}get level(){return Math.floor(this.data.xp/En)+1}get levelProgress01(){return this.data.xp%En/En}get economy(){return this.data.economy}get coins(){return this.data.economy.coins}get gems(){return this.data.economy.gems}get trophies(){return this.data.economy.trophies}get bestTrophies(){return this.data.economy.bestTrophies}get containers(){return this.data.economy.containers}get containerCount(){return yg(this.data.economy)}get winsToNextChest(){return gg(this.data.economy)}get lastMatch(){return this.data.economy.lastMatch}get unlocked(){return Xl(this.data.economy)}isUnlocked(e){return fg(this.data.economy)}get claimable(){return z0(this.data.economy)}select(e){this.data.selected!==e&&(this.data.selected=e,this.commit())}setName(e){const a=B0(e);return a===this.data.name||(this.data.name=a,this.commit()),a}recordPlacement(e,a){const o=mg(this.data.economy,e,a);return o.won?this.data.wins++:this.data.losses++,this.data.xp+=$0(e,a),this.commit(),o}recordResult(e){return this.recordPlacement(e?0:1,st)}markLastMatchSeen(){const e=this.data.economy.lastMatch;!e||e.seen||(e.seen=!0,this.commit())}claimMilestone(e){const a=_0(this.data.economy,e);return a&&this.commit(),a}claimAllMilestones(){const e=wg(this.data.economy);return this.commit(),e}openContainer(e){const a=bg(this.data.economy,e);return a&&this.commit(),a}buyContainer(e,a){const o=xg(this.data.economy,e,a);return o&&this.commit(),o}characterLevel(e){return Zl(this.data.economy,e)}nextLevelPrice(e){return Jl(this.data.economy,e)}canLevelUp(e){return vg(this.data.economy,e)}levelUp(e){const a=kg(this.data.economy,e);return a&&this.commit(),a}onChange(e){return this.listeners.add(e),()=>this.listeners.delete(e)}commit(){try{localStorage.setItem(P0,JSON.stringify({name:this.data.name,wins:this.data.wins,losses:this.data.losses,xp:this.data.xp,selected:this.data.selected,economy:Eg(this.data.economy)}))}catch{}for(const e of this.listeners)e()}}const Rg="fa-screen-styles";function ha(t,e){if(document.getElementById(t))return;const a=document.createElement("style");a.id=t,a.textContent=e,document.head.appendChild(a)}function Ig(){ha(Rg,Cg)}function U0(t,e){const a=t.replace("#",""),o=a.length===3?a.split("").map(r=>r+r).join(""):a,n=parseInt(o.slice(0,2),16)||0,s=parseInt(o.slice(2,4),16)||0,i=parseInt(o.slice(4,6),16)||0;return`rgba(${n},${s},${i},${e})`}const Cg=`
:root {
...
`,Og=3101286,G0="#2f5266",Fg="#2E4E60",Ng="#284053",hc="#3F5462",Lg="#6D8290",Dg="#9FB1BE",ln=5,hn=14,Ui=-.6,Hg=[[-.6,.86],[0,.88],[1.2,.94],[2.6,1.02],[3.8,1.16],[8,1.4],[14,1.55]],cc=1.3,zg=.52,dc=new de(16.35,9.82,4.69).normalize(),_g=[[0,.58],[1.5,.62],[2.6,.88],[3.8,1.16],[4.7,1.36],[6.4,1.42]],cn=.24,dn=.215,pc=.62,Pg=2.48,$g=.86;function uc(t,e){if(e<=t[0][0])return t[0][1];const a=t[t.length-1];if(e>=a[0])return a[1];for(let o=1;o<t.length;o++){const[n,s]=t[o],[i,r]=t[o-1];if(e>n)continue;const l=(e-i)/Math.max(1e-6,n-i);return r+(s-r)*(l*l*(3-2*l))}return a[1]}function Bg(t,e=128){const a=document.createElement("canvas");a.width=e,a.height=e;const o=a.getContext("2d");if(o){const s=o.createRadialGradient(e/2,e/2,0,e/2,e/2,e/2),[i,r,l]=t,h=c=>`rgb(${Math.round(i+(255-i)*c)},${Math.round(r+(255-r)*c)},${Math.round(l+(255-l)*c)})`;s.addColorStop(0,h(0)),s.addColorStop(.54,h(.1)),s.addColorStop(.8,h(.58)),s.addColorStop(1,"rgb(255,255,255)"),o.fillStyle=s,o.fillRect(0,0,e,e)}const n=new et(a);return n.colorSpace=Yf,n.wrapS=nl,n.wrapT=nl,n}function fc(t,e,a){const o=new V({map:Bg(e),blending:p0,blendEquation:Ps,blendSrc:Xh,blendDst:Wf,blendEquationAlpha:Ps,blendSrcAlpha:Xh,blendDstAlpha:ol,transparent:!0,depthWrite:!1,toneMapped:!1}),n=new T(new no(t,t),o);return n.rotation.x=-Math.PI/2,n.renderOrder=a,n.userData.noOutline=!0,n}const Jt={counterBody:"#123A50",counterTop:"#A8641F",counterLip:"#D08A2E",shelf:"#7A431A",steel:"#24485C",jars:["#B02733","#4E8A12","#C99414","#1668A8","#6B3AA8","#B85A18","#2E8C6A","#C4553C"]};class Us{stage;holder=document.createElement("div");model=null;currentId=null;subjectW=J*.8;subjectH=J;elapsed=0;introT=0;observer=null;footShadow=null;disposed=!1;dressing=null;constructor(){this.holder.style.cssText="position:absolute;inset:0;",this.stage=new _l({container:this.holder,background:Og,fog:null,camera:{pitchDeg:20,yawDeg:0,frameMode:"subject",subjectHeight:J,subjectFill:.6,targetHeight:J*.52,followLerp:1},budget:"menu",maxPixelRatio:2}),this.stage.canvas.style.cssText="display:block;width:100%;height:100%;",this.buildSet(),this.stage.rig.snapTo(0,0),this.stage.lighting.focus(0,0,6)}buildSet(){const e=new Me(ln,ln,hn,72,28,!0);this.paintVertexRamp(e,(m,g,w)=>{const b=Y.clamp(-(m*dc.x+w*dc.z)/ln,0,1);return uc(Hg,g+hn/2+Ui)*(cc+(zg-cc)*b)});const a=_e({color:Fg,ramp:at(),roughness:.9,rim:!1});a.side=Kh,a.vertexColors=!0;const o=new T(e,a);o.position.y=hn/2+Ui,o.receiveShadow=!0,o.userData.noOutline=!0,o.name="menu_wall",o.renderOrder=-1,this.stage.scene.add(o);const n=new Ea(0,6.4,96,32);this.paintVertexRamp(n,(m,g)=>uc(_g,Math.hypot(m,g)));const s=_e({color:Ng,ramp:at(),roughness:.86,rim:!1});s.vertexColors=!0;const i=new T(n,s);i.rotation.x=-Math.PI/2,i.receiveShadow=!0,i.userData.noOutline=!0,i.name="menu_ground",this.stage.scene.add(i);const r=fc(5.4,[18,32,160],1);r.position.y=.012,r.name="menu_ground_decal",this.stage.scene.add(r);const l=new T(new Me(1.15,1.24,.18,48),_e({color:hc,ramp:at(),roughness:.72}));l.position.y=.09,l.castShadow=!0,l.receiveShadow=!0,l.userData.noOutline=!0,l.name="menu_plinth_body",this.stage.scene.add(l);const h=_e({color:Lg,ramp:at(),roughness:.55}),c=new T(new Me(1.21,1.19,.06,48,1,!0),h);c.position.y=cn-.03,c.castShadow=!0,c.receiveShadow=!0,c.userData.noOutline=!0,c.name="menu_plinth_rim",this.stage.scene.add(c);const d=new T(new Ea(1.1,1.21,48),h);d.rotation.x=-Math.PI/2,d.position.y=cn,d.receiveShadow=!0,d.userData.noOutline=!0,d.name="menu_plinth_rim_top",this.stage.scene.add(d);const p=new T(new Me(1.1,1.1,cn-dn,48,1,!0),_e({color:hc,ramp:at(),roughness:.8,doubleSide:!0}));p.position.y=(cn+dn)/2,p.receiveShadow=!0,p.userData.noOutline=!0,p.name="menu_plinth_recess",this.stage.scene.add(p);const u=new T(new Me(1.1,1.1,.05,48),_e({color:Dg,ramp:at(),roughness:.45}));u.position.y=dn-.025,u.receiveShadow=!0,u.userData.noOutline=!0,u.name="menu_plinth_top",this.stage.scene.add(u);const f=fc(1.9,[58,64,72],2);f.position.y=dn+.004,f.scale.set(1,1,.72),f.name="menu_foot_decal",this.footShadow=f,this.stage.scene.add(f)}paintVertexRamp(e,a){const o=e.attributes.position,n=new Float32Array(o.count*3);for(let s=0;s<o.count;s++){const i=a(o.getX(s),o.getY(s),o.getZ(s));n[s*3]=i,n[s*3+1]=i,n[s*3+2]=i}e.setAttribute("color",new Rn(n,3))}applyFraming(){const e=this.stage.rig.camera,a=e.aspect>0&&Number.isFinite(e.aspect)?e.aspect:1,o=Math.max(.5,this.subjectH)+cn,n=Math.max(.5,this.subjectW,Pg),s=$g*a*o/n;this.stage.rig.subjectHeight=o,this.stage.rig.subjectFill=Y.clamp(Math.min(pc,s),.2,pc),this.stage.rig.targetHeight=o*.5,this.stage.rig.apply()}static floorGridTexture(e=256){const a=document.createElement("canvas");a.width=e,a.height=e;const o=a.getContext("2d");o&&(o.clearRect(0,0,e,e),o.strokeStyle="rgba(0,0,0,0.55)",o.lineWidth=e*.055,o.strokeRect(0,0,e,e));const n=new et(a);return n.wrapS=al,n.wrapT=al,n.repeat.set(22,22),n.colorSpace=di,n}buildDressing(){const e=new ne;e.name="lobby_dressing";const a=(f,m=!1)=>(f.castShadow=m,f.receiveShadow=!0,f.userData.noOutline=!0,e.add(f),f),o=-3.35,n=7.2,s=.78,i=new T(new no(13,13),new V({map:Us.floorGridTexture(),transparent:!0,depthWrite:!1,toneMapped:!1}));i.rotation.x=-Math.PI/2,i.position.y=.006,i.renderOrder=0,i.userData.noOutline=!0,i.name="lobby_floor_grid",e.add(i);const r=Us.floorGridTexture();r.repeat.set(26,9);const l=new T(new Me(ln-.04,ln-.04,hn,72,1,!0),new V({map:r,side:Kh,transparent:!0,depthWrite:!1,toneMapped:!1}));l.position.y=hn/2+Ui,l.renderOrder=0,l.userData.noOutline=!0,l.name="lobby_wall_grid",e.add(l),a(new T(new dt(n,s,.72),_e({color:Jt.counterBody,ramp:at(),roughness:.8})),!0).position.set(0,s/2,o),a(new T(new dt(n+.12,.11,.84),_e({color:Jt.counterTop,ramp:at(),roughness:.5}))).position.set(0,s+.055,o),a(new T(new dt(n+.12,.045,.06),_e({color:Jt.counterLip,ramp:at(),roughness:.4}))).position.set(0,s+.012,o+.44),a(new T(new dt(n-.4,.13,.52),_e({color:Jt.shelf,ramp:at(),roughness:.75}))).position.set(0,2.15,o-.05);for(const f of[-2.6,2.6])a(new T(new dt(.1,.36,.1),_e({color:Jt.steel,ramp:at(),roughness:.7}))).position.set(f,2.31,o-.2);const h=new Me(.19,.21,.44,20),c=new Me(.21,.21,.07,20),d=_e({color:Jt.steel,ramp:at(),roughness:.45}),p=[-2.95,-2.25,-1.55,1.55,2.25,2.95,-2.6,2.6],u=[2.35,2.35,2.35,2.35,2.35,2.35,.9,.9];for(let f=0;f<p.length;f++){const m=.86+f*37%5*.09,g=u[f]+.22*m;a(new T(h,_e({color:Jt.jars[f],ramp:at(),roughness:.55}))).position.set(p[f],g,o-.02),e.children[e.children.length-1].scale.setScalar(m),a(new T(c,d)).position.set(p[f],g+.25*m,o-.02),e.children[e.children.length-1].scale.setScalar(m)}for(const f of[-1.95,1.95])a(new T(new Me(.4,.36,.46,24),_e({color:Jt.steel,ramp:at(),roughness:.35}))).position.set(f,s+.34,o-.02),a(new T(new Me(.44,.44,.06,24),_e({color:Jt.counterLip,ramp:at(),roughness:.3}))).position.set(f,s+.6,o-.02);return e}setScene(e){this.disposed||(e==="lobby"&&!this.dressing&&(this.dressing=this.buildDressing(),this.stage.scene.add(this.dressing)),this.dressing&&(this.dressing.visible=e==="lobby"))}attachTo(e){this.disposed||(this.holder.parentElement!==e&&e.appendChild(this.holder),this.observer?.disconnect(),this.observer=new ResizeObserver(()=>this.resize()),this.observer.observe(e),this.resize())}detach(){this.observer?.disconnect(),this.observer=null,this.holder.remove()}show(e){if(this.disposed||e===this.currentId)return;this.model&&(this.stage.scene.remove(this.model.root),this.model.dispose()),this.model=Pl(e),this.model.play("idle"),this.stage.scene.add(this.model.root);const a=new In().setFromObject(this.model.root);if(this.subjectH=Math.max(.5,a.max.y-a.min.y),this.subjectW=2*Math.max(.25,Math.abs(a.min.x),Math.abs(a.max.x),Math.abs(a.min.z),Math.abs(a.max.z)),this.model.root.position.y=dn+.005-a.min.y,this.footShadow){const o=Y.clamp(Math.max(a.max.x-a.min.x,a.max.z-a.min.z)*1.15,1,2.3);this.footShadow.scale.set(o/1.9,1,o/1.9*.72)}this.currentId=e,this.introT=.34,this.applyFraming()}poke(){this.model?.play("attack")}update(e){if(!this.disposed){if(this.elapsed+=e,this.stage.rig.yawDeg=Math.sin(this.elapsed*.42)*22,this.model){if(this.introT>0){this.introT=Math.max(0,this.introT-e);const a=1-this.introT/.34,o=Math.sin(a*Math.PI)*(1-a*.4);this.model.root.scale.setScalar(1+o*.16),this.model.root.rotation.y=(1-a)*-.9}else this.model.root.scale.setScalar(1),this.model.root.rotation.y=0;this.model.update({dt:e,elapsed:this.elapsed,moveSpeed01:0,health01:1})}this.stage.render(e)}}resize(){this.disposed||(this.stage.resize(),this.applyFraming())}info(){const e=this.stage.rig.camera,a=this.model?new In().setFromObject(this.model.root):null,o=s=>{const i=s.clone().project(e);return{x:+(i.x*.5+.5).toFixed(3),y:+(1-(i.y*.5+.5)).toFixed(3)}},n=this.stage.rig;return{id:this.currentId,aspect:+e.aspect.toFixed(3),fill:+n.subjectFill.toFixed(3),subject:{w:+this.subjectW.toFixed(2),h:+this.subjectH.toFixed(2)},cameraOk:Number.isFinite(e.position.x)&&Number.isFinite(e.position.y),feet:a?o(new de(0,a.min.y,0)):null,crown:a?o(new de(0,a.max.y,0)):null,left:a?o(new de(a.min.x,(a.min.y+a.max.y)/2,0)):null,right:a?o(new de(a.max.x,(a.min.y+a.max.y)/2,0)):null}}dispose(){if(!this.disposed){if(this.disposed=!0,this.observer?.disconnect(),this.observer=null,this.dressing){const e=new Set,a=new Set;this.dressing.traverse(o=>{const n=o;if(n.geometry&&e.add(n.geometry),n.material)for(const s of Array.isArray(n.material)?n.material:[n.material])a.add(s)}),e.forEach(o=>o.dispose()),a.forEach(o=>o.dispose()),this.stage.scene.remove(this.dressing),this.dressing=null}this.model&&(this.stage.scene.remove(this.model.root),this.model.dispose(),this.model=null),this.stage.dispose(),this.holder.remove()}}}let Io=null;function Ql(){return Io||(Io=new Us,typeof window<"u"&&(window.__charStage=()=>Io?.info()??null)),Io}function mc(){Io?.dispose(),Io=null}const Gi=1e-4,qg=2e4;function eh(t){let e=t|0||2654435769;return()=>(e^=e<<13,e^=e>>>17,e^=e<<5,(e>>>0)/4294967296)}function be(t,e,a){return e+t()*(a-e)}function se(t,e){return Math.pow(2,be(t,-e,e)/1200)}const gc=new WeakMap;function Ug(t){const e=gc.get(t);if(e)return e;const a=Math.floor(t.sampleRate*2),o=t.createBuffer(1,a,t.sampleRate),n=o.getChannelData(0),s=eh(6221086);for(let i=0;i<a;i++)n[i]=s()*2-1;return gc.set(t,o),o}const wc=new WeakMap;function Gg(t,e){let a=wc.get(t);a||(a=new Map,wc.set(t,a));const o=Math.max(.05,Math.round(e*20)/20),n=a.get(o);if(n)return n;const s=1024,i=new Float32Array(s),r=Math.tanh(o);for(let l=0;l<s;l++){const h=l/(s-1)*2-1;i[l]=Math.tanh(o*h)/r}return a.set(o,i),i}function j0(t,e){const a=t.createWaveShaper();return a.curve=Gg(t,e),a.oversample="2x",a}const jg=.26,Wg=.19,bc=new WeakMap;function Yg(t){const e=bc.get(t);if(e)return e;const a=t.sampleRate,o=Math.floor(a*jg),n=t.createBuffer(2,o,a),s=Math.floor(a*.005),i=6.9078/(Wg*a);for(let h=0;h<2;h++){const c=n.getChannelData(h),d=eh(h===0?1990433:7840721);let p=0;for(let f=s;f<o;f++){const m=f-s,g=.3+.42*(m/(o-s)),w=d()*2-1;p=p*g+w*(1-g),c[f]=p*Math.exp(-i*m)}const u=h===0?[.0071,.0132,.0198,.0281,.0367,.0458]:[.0083,.0119,.0214,.0263,.0389,.0441];for(let f=0;f<u.length;f++){const m=s+Math.floor(u[f]*a);if(m>=o)continue;const g=f%2===0?1:-1;c[m]+=g*.62*Math.exp(-i*(m-s)*.55)}}let r=0;for(let h=0;h<2;h++){const c=n.getChannelData(h);for(let d=0;d<o;d++)r=Math.max(r,Math.abs(c[d]))}const l=r>0?.6/r:1;for(let h=0;h<2;h++){const c=n.getChannelData(h);for(let d=0;d<o;d++)c[d]*=l}return bc.set(t,n),n}function Vg(t){const e=t.createConvolver();return e.normalize=!1,e.buffer=Yg(t),e}function W0(t,e,a){if(!t.wet||!(a>0))return;const o=t.ctx.createGain();o.gain.value=a,e.connect(o),o.connect(t.wet)}function Y0(t,e,a){const o=t.createGain(),n=Math.max(5e-4,a.attack??.002),s=(a.duration-n)*Math.max(0,Math.min(.9,a.hold??0)),i=Math.max(Gi*2,a.peak),r=e+a.duration;return o.gain.setValueAtTime(Gi,e),o.gain.linearRampToValueAtTime(i,e+n),s>0&&o.gain.setValueAtTime(i,e+n+s),(a.curve??"exp")==="exp"?o.gain.exponentialRampToValueAtTime(Gi,r):o.gain.linearRampToValueAtTime(0,r),o.gain.setValueAtTime(0,r+.001),o}function Co(t,e,a,o,n="exp"){if(typeof e=="number"){t.setValueAtTime(e,a);return}const[s,i]=e;t.setValueAtTime(s,a),n==="exp"&&s>0&&i>0?t.exponentialRampToValueAtTime(i,a+o):t.linearRampToValueAtTime(i,a+o)}function q(t,e){const{ctx:a,dest:o,when:n}=t,s=a.createBufferSource(),i=Ug(a);s.buffer=i,s.playbackRate.value=e.rate??1,e.loop&&(s.loop=!0,s.loopStart=0,s.loopEnd=i.duration);const r=Math.max(0,i.duration-(e.duration+.02)),l=e.loop?be(t.rng,0,i.duration):be(t.rng,0,Math.min(1.5,r)),h=Y0(a,n,e),c=e.tremolo?Kg(a,n,e.duration,e.tremolo.rate,e.tremolo.depth):h;c!==h&&c.connect(h);const d=e.drive?j0(a,e.drive):c;if(d!==c&&d.connect(c),e.filter){const p=u=>{const f=a.createBiquadFilter();return f.type=e.filter,f.Q.value=u,Co(f.frequency,e.freq??1e3,n,e.duration,e.freqCurve??"exp"),f};if(e.poles===24){const u=Math.sqrt(Math.max(.1,e.q??1));s.connect(p(u)).connect(p(u)).connect(d)}else s.connect(p(e.q??1)).connect(d)}else s.connect(d);return h.connect(o),W0(t,h,e.wet??0),s.start(n,l,e.duration+.02),s.stop(n+e.duration+.02),e.duration}function X(t,e){const{ctx:a,dest:o,when:n}=t,s=Y0(a,n,e);let i=s;if(e.ring!==void 0){const h=a.createGain();h.gain.value=0;const c=a.createOscillator();c.type="sine",Co(c.frequency,e.ring,n,e.duration,"exp"),c.connect(h.gain),c.start(n),c.stop(n+e.duration+.02),h.connect(s),i=h}if(e.drive){const h=j0(a,e.drive);h.connect(i),i=h}if(e.lowpass!==void 0){const h=a.createBiquadFilter();h.type="lowpass",h.Q.value=.7,Co(h.frequency,e.lowpass,n,e.duration),h.connect(i),i=h}const r=Math.max(1,Math.min(3,Math.round(e.voices??1))),l=e.detuneCents??0;for(let h=0;h<r;h++){const c=a.createOscillator();c.type=e.type??"sine";const d=r===1?0:(h/(r-1)-.5)*l,p=Math.pow(2,d/1200);if(typeof e.freq=="number"?Co(c.frequency,e.freq*p,n,e.duration,e.freqCurve??"exp"):Co(c.frequency,[e.freq[0]*p,e.freq[1]*p],n,e.duration,e.freqCurve??"exp"),r>1){const u=a.createGain();u.gain.value=1/r,c.connect(u).connect(i)}else c.connect(i);c.start(n),c.stop(n+e.duration+.02)}return s.connect(o),W0(t,s,e.wet??0),e.duration}function yi(t,e){let a=0;for(const o of e.modes){const n=e.duration*o.decay,s=typeof e.freq=="number"?e.freq*o.ratio:[e.freq[0]*o.ratio,e.freq[1]*o.ratio];(typeof s=="number"?s:Math.max(s[0],s[1]))>qg||(a=Math.max(a,n),X(t,{type:"sine",freq:s,peak:e.peak*o.gain,attack:e.attack??.0015,duration:n,drive:e.drive,wet:e.wet}))}return a}function Kg(t,e,a,o,n){const s=Math.max(0,Math.min(1,n)),i=t.createGain();i.gain.value=1-s*.5;const r=t.createOscillator();r.type="sine",Co(r.frequency,o,e,a,"lin");const l=t.createGain();return l.gain.value=s*.5,r.connect(l),l.connect(i.gain),r.start(e),r.stop(e+a+.02),i}function ve(t,e){const a=e.freq??5e3,o=q(t,{filter:"highpass",freq:a,q:.9,peak:e.peak,attack:4e-4,duration:.007,wet:e.wet??.06});if(!e.snap)return o;const n=(e.snapMs??14)/1e3,s=X(t,{type:"triangle",freq:[e.snap,e.snap*.38],peak:e.peak*.72,attack:6e-4,duration:n,drive:2.2,wet:e.wet??.06});return j(o,s)}function He(t,e){const[a,o]=e.grainMs??[4,11],n=e.decay??.35,s=e.freqShift;for(let i=0;i<e.count;i++){const r=Math.pow(t.rng(),1.5)*e.spread,l=be(t.rng,a,o)/1e3,h=e.peak*(1-r/e.spread*(1-n))*be(t.rng,.55,1),c=s?s[0]+(s[1]-s[0])*(r/e.spread):1;q({...t,when:t.when+r},{filter:"bandpass",freq:be(t.rng,e.freq[0],e.freq[1])*c,q:e.q??6,peak:h,attack:8e-4,duration:l,drive:e.drive,wet:e.wet})}return e.spread+o/1e3}function xn(t,e){const a=e.rise??2.6;let o=0;for(let n=0;n<e.count;n++){const s=be(t.rng,0,e.spread),i=be(t.rng,e.freq[0],e.freq[1]),r=be(t.rng,.045,.095);o=Math.max(o,s+r),X({...t,when:t.when+s},{type:"sine",freq:[i,i*a],peak:e.peak*be(t.rng,.5,1),attack:.002,duration:r,wet:e.wet})}return o}function Gs(t,e){const[a,o]=e.pingMs??[7,18],n=e.bend??.92,s=Math.log2(e.freq[0]),i=Math.log2(e.freq[1]);let r=0;for(let l=0;l<e.count;l++){const h=Math.pow(t.rng(),1.6)*e.spread,c=Math.pow(2,s+(t.rng()+l*.6180339887)%1*(i-s)),d=be(t.rng,a,o)/1e3;r=Math.max(r,h+d),X({...t,when:t.when+h},{type:"sine",freq:[c,c*n],peak:e.peak*be(t.rng,.55,1),attack:6e-4,duration:d,wet:e.wet})}return r}function th(t,e){const[a,o]=e.freq??[9e3,3200],n=e.duration??.11,s=e.wet??.3,i=q(t,{filter:"bandpass",freq:[a*se(t.rng,90),o*se(t.rng,90)],q:.7,peak:e.peak,attack:.0012,duration:n,wet:s}),r=q(t,{filter:"highpass",poles:24,freq:[a*.8,a*.45],q:.7,peak:e.peak*.55,attack:6e-4,duration:n*.55,wet:s}),l=e.drops??6,h=l>0?He(t,{count:l,spread:n*.85,grainMs:[3,9],freq:[o,a],q:5,peak:e.peak*.85,decay:.25,wet:s}):0;return j(i,r,h)}function j(...t){let e=0;for(const a of t)a>e&&(e=a);return e}const yc="fa.audio.volume",xc="fa.audio.muted",Xg=.62,Zg=20,Jg=.008,Ke={Ambient:0,Normal:1,Critical:2},Qg=.11,vc=[1,.62,.42,.3,.22],ew=.5,pn=.7,kc=1.2,V0=3,Mc=new WeakMap;function tw(t){const e=Mc.get(t);if(e)return e;const a=2048,o=new Float32Array(a);for(let n=0;n<a;n++){const s=(n/(a-1)*2-1)*V0,i=Math.abs(s),r=i<=pn?i:pn+(kc-pn)*Math.tanh((i-pn)/(kc-pn));o[n]=Math.sign(s)*r}return Mc.set(t,o),o}function aw(t,e,a=!0){const o=t.createGain();o.gain.value=1;let n=null;if(a)try{n=t.createGain(),n.gain.value=1;const l=t.createGain();l.gain.value=ew,n.connect(Vg(t)).connect(l).connect(o)}catch{n=null}const s=t.createGain();s.gain.value=1/V0;const i=t.createWaveShaper();i.curve=tw(t),i.oversample="2x";const r=t.createGain();return r.gain.value=0,o.connect(s).connect(i).connect(r).connect(e??t.destination),{input:o,wetIn:n,limiter:i,master:r}}function ow(t){const e=Math.max(0,Math.min(1,t));return Math.pow(e,1.8)*Xg}function nw(){const t=typeof navigator<"u"?navigator.userActivation:void 0;return t===void 0||t.isActive===!0}class sw{ctx=null;chain=null;state="idle";failure=null;volume=.8;muted=!1;maxVoices;persist;reverb;injected;injectedDestination;offline;voices=[];retrigger=new Map;listeners=new Set;virtualTime=0;counters={started:0,droppedBudget:0,droppedThrottle:0,droppedNotRunning:0};analyser=null;gestureBound=!1;constructor(e={}){this.maxVoices=e.maxVoices??Zg,this.persist=e.persist??!0,this.reverb=e.reverb??!0,this.injected=e.context??null,this.injectedDestination=e.destination??null,this.offline=!!this.injected&&typeof OfflineAudioContext<"u"&&this.injected instanceof OfflineAudioContext,this.loadSettings(),this.injected?(this.attachContext(this.injected),this.offline&&(this.state="running")):(this.bindGestureUnlock(),this.bindVisibility())}setVolume(e){this.volume=Math.max(0,Math.min(1,Number.isFinite(e)?e:0)),this.applyMasterGain(.02),this.saveSettings(),this.emit()}getVolume(){return this.volume}setMuted(e){this.muted=!!e,this.applyMasterGain(.015),this.saveSettings(),this.emit()}isMuted(){return this.muted}toggleMuted(){return this.setMuted(!this.muted),this.muted}onChange(e){return this.listeners.add(e),()=>this.listeners.delete(e)}getState(){return this.state}getFailure(){return this.failure}activeVoices(){return this.prune(this.now()),this.voices.length}unlock(){if(this.state==="failed"||this.offline||!this.ctx&&!nw())return;const e=this.ensureContext();e&&(typeof e.resume=="function"&&e.state!=="running"&&e.resume().then(()=>this.syncState(),()=>this.syncState()),this.syncState())}bindGestureUnlock(){if(this.gestureBound||typeof window>"u")return;this.gestureBound=!0;const e=["pointerdown","touchend","keydown","click"],a=()=>{if(this.unlock(),this.state==="running"||this.state==="failed")for(const o of e)window.removeEventListener(o,a,!0)};for(const o of e)window.addEventListener(o,a,!0)}bindVisibility(){typeof document>"u"||document.addEventListener("visibilitychange",()=>{const e=this.ctx;if(!(!e||typeof e.suspend!="function")){try{document.hidden?e.suspend().catch(()=>{}):this.state!=="idle"&&e.resume().catch(()=>{})}catch{}this.syncState()}})}ensureContext(){if(this.ctx)return this.ctx;if(this.state==="failed")return null;try{const e=typeof AudioContext<"u"?AudioContext:globalThis.webkitAudioContext;if(!e)return this.fail("Web Audio API unavailable"),null;const a=new e({latencyHint:"interactive"});return this.attachContext(a),a}catch(e){return this.fail(String(e)),null}}attachContext(e){this.ctx=e;try{this.chain=aw(e,this.injectedDestination??void 0,this.reverb),this.applyMasterGain(0),this.syncState()}catch(a){this.fail(String(a))}}syncState(){if(this.state==="failed")return;const e=this.state;this.ctx?this.offline?this.state="running":this.state=this.ctx.state==="running"?"running":"suspended":this.state="idle",e!==this.state&&this.emit()}fail(e){this.state="failed",this.failure=e,console.warn("[audio] disabled:",e),this.emit()}play(e,a={}){try{return this.playInner(e,a)}catch(o){return this.failure||(this.failure=String(o),console.warn("[audio] sound failed:",o)),!1}}playInner(e,a){if(this.state==="failed")return!1;if(this.state!=="running"||!this.ctx||!this.chain)return this.counters.droppedNotRunning++,!1;const o=this.now();this.prune(o);const n=a.priority??Ke.Normal;let s=1,i=1;if(a.key){const y=this.retrigger.get(a.key),v=y&&o-y.at<Qg?y.count+1:0;if(this.retrigger.set(a.key,{at:o,count:v}),v>=vc.length)return this.counters.droppedThrottle++,!1;s=vc[v],i=1+v*.045}if(this.voices.length>=this.maxVoices){if(n<Ke.Critical&&!this.steal(n))return this.counters.droppedBudget++,!1;n>=Ke.Critical&&this.voices.length>=this.maxVoices&&this.steal(Ke.Critical)}const r=this.ctx,l=Math.max(o,r.currentTime)+Jg+(a.delay??0),h=Math.max(0,(a.gain??1)*s),c=r.createGain();c.gain.value=h;const d=a.pan!==void 0&&typeof r.createStereoPanner=="function",p=Math.max(-1,Math.min(1,a.pan??0));let u=c;if(d){const y=r.createStereoPanner();y.pan.value=p,c.connect(y),u=y}u.connect(this.chain.input);let f=null;if(this.chain.wetIn)if(f=r.createGain(),f.gain.value=h,d){const y=r.createStereoPanner();y.pan.value=p,f.connect(y).connect(this.chain.wetIn)}else f.connect(this.chain.wetIn);const m=eh(a.seed??Math.random()*4294967295|0),g={ctx:r,dest:c,wet:f??void 0,when:l,rng:m};let w=0;try{w=e(g)||0}catch(y){throw c.disconnect(),f?.disconnect(),y}const b=l+w/i+.05;if(this.voices.push({node:c,wet:f,end:b,priority:n}),this.counters.started++,!this.offline){const y=Math.max(30,(b-r.currentTime)*1e3+40);setTimeout(()=>this.prune(this.now()),y)}return!0}steal(e){let a=-1;for(let n=0;n<this.voices.length;n++)if(this.voices[n].priority<e){a=n;break}if(a<0)return!1;const[o]=this.voices.splice(a,1);return this.release(o),!0}prune(e){for(let a=this.voices.length-1;a>=0;a--)if(this.voices[a].end<=e){const[o]=this.voices.splice(a,1);this.release(o)}if(this.retrigger.size>64)for(const[a,o]of this.retrigger)e-o.at>1&&this.retrigger.delete(a)}release(e){try{e.node.gain.cancelScheduledValues(0),e.node.gain.value=0,e.node.disconnect()}catch{}if(e.wet)try{e.wet.gain.cancelScheduledValues(0),e.wet.gain.value=0,e.wet.disconnect()}catch{}}now(){return this.ctx?Math.max(this.ctx.currentTime,this.virtualTime):this.virtualTime}setVirtualTime(e){this.virtualTime=e,this.prune(e)}tap(){if(!this.ctx||!this.chain)return null;if(this.analyser)return this.analyser;try{const e=this.ctx.createAnalyser();return e.fftSize=2048,e.smoothingTimeConstant=0,this.chain.master.connect(e),this.analyser=e,e}catch{return null}}connectTap(e){if(!this.ctx||!this.chain)return!1;try{return this.chain.master.connect(e),!0}catch{return!1}}get context(){return this.ctx}get busInput(){return this.chain?.input??null}applyMasterGain(e){if(!this.chain||!this.ctx)return;const a=this.muted?0:ow(this.volume),o=this.chain.master.gain;try{if(e>0&&!this.offline){const n=this.ctx.currentTime;o.cancelScheduledValues(n),o.setValueAtTime(o.value,n),o.linearRampToValueAtTime(a,n+e)}else o.cancelScheduledValues(0),o.value=a}catch{o.value=a}}loadSettings(){if(!(!this.persist||typeof localStorage>"u"))try{const e=localStorage.getItem(yc);if(e!==null){const a=Number(e);Number.isFinite(a)&&(this.volume=Math.max(0,Math.min(1,a)))}this.muted=localStorage.getItem(xc)==="1"}catch{}}saveSettings(){if(!(!this.persist||typeof localStorage>"u"))try{localStorage.setItem(yc,String(this.volume)),localStorage.setItem(xc,this.muted?"1":"0")}catch{}}emit(){for(const e of this.listeners)try{e()}catch{}}}const Oe=0;function Pe(t){const e=t.fighters;return Array.isArray(e)&&e.length>0?e:[t.player,t.enemy].filter(Boolean)}function Ze(t){return Pe(t)[Oe]??t.player}function bt(t,e,a){if(typeof e=="number"){const o=Pe(t)[e];if(o)return o}return t[a]}function vn(t,e,a){return bt(t,e.attackerId,v0(a))}function Ec(t,e){return bt(t,e.ownerId,e.ownerRole)}function oa(t,e){return typeof t=="number"?t:e==="player"?0:1}function iw(t){return t===0?"player":t===1?"enemy":`slot${t}`}function rw(t){const{seats:e,center:a,eliminated:o,winnerId:n}=t,s=g=>e.find(w=>w.id===g),i=g=>g.maxHp>0?g.hp/g.maxHp:0,r=g=>Math.hypot(g.x-a.x,g.y-a.y),l=(g,w)=>{const b=i(g),y=i(w);if(b!==y)return y-b;const v=r(g),k=r(w);return v!==k?v-k:g.deaths!==w.deaths?g.deaths-w.deaths:g.id-w.id},h=e.filter(g=>g.alive&&g.hp>0).slice().sort(l).map(g=>g.id),c=new Set(h),d=new Map;o.forEach((g,w)=>{s(g)!==void 0&&d.set(g,w)});const p=[...d.keys()].filter(g=>!c.has(g)).sort((g,w)=>{const b=d.get(g)??-1,y=d.get(w)??-1;if(b!==y)return y-b;const v=s(g),k=s(w);return v&&k&&v.deaths!==k.deaths?v.deaths-k.deaths:g-w}),u=new Set([...h,...p]),f=e.filter(g=>!u.has(g.id)).slice().sort((g,w)=>g.deaths!==w.deaths?g.deaths-w.deaths:g.id-w.id).map(g=>g.id),m=[...h,...p,...f];return n!==null&&m[0]!==n&&s(n)!==void 0?[n,...m.filter(g=>g!==n)]:m}function lw(t,e,a){if(!(t>e))return 1;if(t>=a)return 0;const o=a-e,n=(t-e)/o;return 1-n*n*(3-2*n)}const hw=200,cw=900;function ah(t){return Math.max(0,Math.min(1,(t-2)/16))}function dw(t){const e=ah(t);return a=>{const o=se(a.rng,70),n=q(a,{filter:"bandpass",freq:[2600*o,620*o],q:1.1,peak:.26+e*.12,attack:.006,duration:.13,drive:1.5,wet:.14}),s=X(a,{type:"sine",freq:[440*o,170*o],peak:.16+e*.12,attack:.004,duration:.11,drive:1.9,voices:2,detuneCents:14,wet:.1});return j(n,s)}}function pw(t,e){const a=ah(t),o=Math.min(1,e/180);return n=>{const s=se(n.rng,55),i=.2+o*.1,r=q(n,{filter:"bandpass",freq:[420*s,(1900-o*600)*s],q:2.2,peak:.44+a*.2,attack:.05+o*.03,hold:.12,duration:i,drive:1.6,wet:.2}),l=X(n,{type:"sawtooth",freq:[200*s,88*s],lowpass:[900,300],peak:.2+a*.12,attack:.02,duration:i*.8,drive:1.8,voices:2,detuneCents:18,wet:.12});return j(r,l)}}function uw(){const t=[523.25,659.25,783.99];return e=>{const a=se(e.rng,25);t.forEach((n,s)=>{X({...e,when:e.when+s*.06},{type:"triangle",freq:n*a,peak:.2,attack:.012,hold:.2,duration:.3,voices:2,detuneCents:9,wet:.42})});const o=q(e,{filter:"highpass",freq:[3e3,7e3],q:.8,peak:.07,attack:.08,duration:.42,wet:.5});return j(.3+t.length*.06,o)}}function fw(){return t=>{const e=se(t.rng,30),a=X(t,{type:"sine",freq:[130*e,30*e],peak:.9,attack:.004,hold:.08,duration:.78,drive:3.4,voices:3,detuneCents:22,wet:.3}),o=q(t,{filter:"lowpass",freq:[2200,140],q:1.4,peak:.55,attack:.01,duration:.62,drive:2.2,wet:.34}),n=ve(t,{peak:.62,freq:3e3,snap:1900,snapMs:26}),s=He(t,{count:10,spread:.42,freq:[900,4200],peak:.16,q:5,wet:.4});return j(a,o,n,s)}}function mw(t){const e=ah(t);return a=>{const o=se(a.rng,60),n=ve(a,{peak:.66-e*.14,freq:3900-e*1100,snap:2700-e*800,snapMs:11+e*7}),s=X(a,{type:"sine",freq:[(230-e*80)*o,(62-e*22)*o],peak:.48+e*.34,attack:.0018,duration:.11+e*.22,drive:2+e*1.5,voices:2,detuneCents:16,wet:.16}),i=e>.12?X(a,{type:"sine",freq:[(118-e*38)*o,(44-e*12)*o],peak:.14+e*.38,attack:.004,duration:.1+e*.2,drive:1.5,wet:.1}):0,r=q(a,{filter:"bandpass",freq:[1700*o,470*o],q:1.5,peak:.24+e*.2,attack:.0012,duration:.07+e*.1,drive:1.9,wet:.22}),l=q(a,{filter:"bandpass",freq:[1900,640],q:.9,peak:.05+e*.05,attack:.018,duration:.16+e*.22,wet:.6}),h=th(a,{peak:.1+(1-e)*.06,freq:[8600-e*2200,3400-e*900],duration:.06+e*.05,drops:5,wet:.28});return j(n,s,i,r,l,h)}}function gw(t){const e=t<.3;return a=>{const o=se(a.rng,45),n=be(a.rng,.9,1.15),s=be(a.rng,285,360),i=X(a,{type:"sawtooth",freq:[s*o,s*o*.4],lowpass:[be(a.rng,1180,1620),260],peak:.3,attack:.004,duration:(e?.34:.22)*n,drive:be(a.rng,2.1,2.8),voices:2,detuneCents:20,wet:.18}),r=be(a.rng,830,1150),l=q(a,{filter:"lowpass",poles:24,freq:[r,190],q:.9,peak:.2,attack:.002,duration:.16*n,drive:1.6,wet:.24}),h=ve(a,{peak:.2,freq:3600,wet:.16}),c=He(a,{count:4,spread:.03,grainMs:[3,8],freq:[be(a.rng,2700,3400),be(a.rng,6e3,9e3)],q:4,peak:.24,decay:.3,wet:.2}),d=th(a,{peak:.13,freq:[be(a.rng,7600,9400),be(a.rng,2800,3600)],duration:be(a.rng,.05,.08),drops:5,wet:.26}),p=e?X(a,{type:"sine",freq:[be(a.rng,88,104),32],peak:.55,attack:.006,duration:.3*n,drive:2.6,wet:.16}):0;return j(i,l,h,c,d,p)}}function ww(){return t=>{const e=se(t.rng,30),a=ve(t,{peak:.2,freq:5400,snap:3800,snapMs:6}),o=X(t,{type:"triangle",freq:[620*e,1560*e],ring:[132,96],peak:.34,attack:.022,duration:.26,wet:.34}),n=X(t,{type:"sine",freq:[1880*e,2520*e],peak:.1,attack:.03,duration:.34,wet:.55});return j(a,o,n)}}function bw(){return t=>{const e=se(t.rng,40),a=X(t,{type:"sawtooth",freq:[440*e,58*e],lowpass:[2600,240],peak:.42,attack:.006,duration:.6,drive:2.2,voices:2,detuneCents:24,wet:.26}),o=q(t,{filter:"lowpass",freq:[3200,200],q:1.1,peak:.34,attack:.004,duration:.44,drive:1.5,wet:.4}),n=X(t,{type:"sine",freq:[150*e,30*e],peak:.7,attack:.003,duration:.42,drive:3,voices:2,detuneCents:14,wet:.2});return j(a,o,n)}}function yw(){const t=[392,523.25,659.25];return e=>{const a=se(e.rng,20);return t.forEach((o,n)=>{X({...e,when:e.when+n*.05},{type:"triangle",freq:o*a,peak:.26,attack:.01,duration:.24,voices:2,detuneCents:8,wet:.34})}),.24+t.length*.05}}function xw(){return t=>{const e=q(t,{filter:"lowpass",poles:24,freq:[420,110],q:1.2,peak:.34,attack:.05,duration:.4,drive:2,wet:.35}),a=q(t,{filter:"bandpass",freq:[1400,2600],q:.7,peak:.1,attack:.08,duration:.42,wet:.55});return j(e,a)}}const vw=2.1,K0=1.5,ji=.55;function kw(){return t=>{const e=vw,a={attack:ji,hold:(K0-ji)/(e-ji),duration:e},o=X(t,{type:"sine",freq:118*se(t.rng,25),peak:.026,voices:3,detuneCents:26,drive:1.6,...a,wet:.25}),n=q(t,{filter:"bandpass",freq:[be(t.rng,900,1500),be(t.rng,1700,2500)],q:.45,peak:.055,loop:!0,tremolo:{rate:[.55,.85],depth:.3},...a,wet:.4}),s=q(t,{filter:"highpass",poles:24,freq:[6400,8200],q:.7,peak:.009,loop:!0,...a,wet:.5}),i=be(t.rng,.3,e-.6),r={...t,when:t.when+i},l=Math.floor(t.rng()*4);let h=0;if(l===0)h=yi(r,{freq:be(t.rng,620,980),duration:.42,peak:.085,attack:.0015,wet:.62,modes:[{ratio:1,gain:1,decay:1},{ratio:2.71,gain:.6,decay:.5},{ratio:4.63,gain:.34,decay:.3}]});else if(l===1){const c=ve(r,{peak:.1,freq:3400,snap:900,snapMs:14,wet:.5}),d=be(t.rng,.11,.19),p=ve({...r,when:r.when+d},{peak:.075,freq:3100,snap:820,snapMs:12,wet:.5});h=j(c,d+p)}else l===2?h=q(r,{filter:"bandpass",freq:[be(t.rng,2800,3600),be(t.rng,5600,7400)],q:.8,peak:.04,attack:.09,duration:.55,wet:.7}):h=Gs(r,{count:3,spread:.16,freq:[4200,11e3],peak:.022,pingMs:[8,20],bend:.94,wet:.6});return j(o,n,s,i+h)}}function Mw(){return t=>{const e=q(t,{filter:"highpass",freq:[2600,5200],q:.8,peak:.18,attack:.01,duration:.26,wet:.3}),a=He(t,{count:4,spread:.2,freq:[2500,6e3],peak:.1,q:7,wet:.35});return j(e,a)}}function Ew(){return t=>{const e=q(t,{filter:"lowpass",freq:[1400,260],q:3.2,peak:.2,attack:.008,duration:.15,drive:1.8,wet:.2}),a=X(t,{type:"sine",freq:[180,84],peak:.14,duration:.11,drive:2.2,wet:.14});return j(e,a)}}function Tw(){return t=>{const e=se(t.rng,90),a=ve(t,{peak:.26,freq:2400,snap:1200,snapMs:8}),o=X(t,{type:"sine",freq:[150*e,66*e],peak:.22,duration:.09,drive:2,wet:.24});return j(o,a)}}function Sw(t){const e=[523.25,587.33,659.25,698.46,783.99],a=e[Math.max(0,Math.min(e.length-1,5-t))];return o=>{const n=X(o,{type:"triangle",freq:a,peak:.34,attack:.004,hold:.25,duration:.16,voices:2,detuneCents:7,wet:.3}),s=q(o,{filter:"highpass",freq:3800,peak:.12,duration:.015,wet:.12});return j(n,s)}}function Aw(){const t=[523.25,659.25,1046.5];return e=>{t.forEach((o,n)=>{X({...e,when:e.when+n*.07},{type:"square",freq:o,lowpass:[3200,1800],peak:.22,attack:.006,hold:.3,duration:.34,voices:2,detuneCents:10,wet:.3})});const a=q(e,{filter:"bandpass",freq:[500,4e3],q:.9,peak:.16,attack:.14,duration:.2,wet:.35});return j(.34+t.length*.07,a)}}function Rw(){return t=>{const e=se(t.rng,18);[587.33,392].forEach((n,s)=>{X({...t,when:t.when+s*.16},{type:"triangle",freq:n*e,peak:.26,attack:.008,hold:.25,duration:.38,voices:2,detuneCents:11,wet:.34})});const a=X(t,{type:"sine",freq:[196*e,98*e],peak:.34,attack:.02,hold:.3,duration:.72,drive:2.2,voices:2,detuneCents:15,wet:.28}),o=q(t,{filter:"bandpass",freq:[2200,620],q:.8,peak:.12,attack:.06,duration:.66,wet:.55});return j(.38+.16,a,o)}}function Iw(t){const e=t?[523.25,659.25,783.99,1046.5]:[659.25,587.33,493.88,392];return a=>(e.forEach((o,n)=>{X({...a,when:a.when+n*.1},{type:t?"square":"sawtooth",freq:o,lowpass:t?[3600,2200]:[1600,500],peak:.24,attack:.008,hold:.3,duration:.4,voices:2,detuneCents:t?9:16,wet:.34})}),.4+e.length*.1)}function Cw(t){const e=t?[523.25,659.25,1046.5]:[587.33,493.88,392],a=.62;return o=>{const n=(r,l)=>(q({...o,when:o.when+r},{filter:"bandpass",freq:2900,q:10,peak:.7,attack:.012,hold:.45,duration:l,tremolo:{rate:24,depth:.7},wet:.06}),r+l);n(0,.26);const s=n(.36,.22),i=X(o,{type:"sawtooth",freq:[150,132],lowpass:[1100,420],peak:.14,attack:.01,hold:.5,duration:.58,drive:1.8,voices:2,detuneCents:22,wet:.2});return e.forEach((r,l)=>{X({...o,when:o.when+a+l*.1},{type:t?"square":"sawtooth",freq:r,lowpass:t?[3600,2200]:[1600,500],peak:.24,attack:.008,hold:.3,duration:.36,voices:2,detuneCents:t?9:16,wet:.34})}),j(s,i,a+(e.length-1)*.1+.36)}}function Ow(){return t=>{const e=X(t,{type:"triangle",freq:[900,620],peak:.22,duration:.055,drive:1.6,wet:.16}),a=q(t,{filter:"highpass",freq:5e3,peak:.1,duration:.012});return j(e,a)}}function ts(t,e,a,o,n){return He(t,{count:12,spread:e,grainMs:[5,14],freq:[2300,4600],freqShift:[a,o],q:3.2,peak:n,decay:.4,drive:1.5,wet:.3})}function un(t,e,a){return He(t,{count:7,spread:e,grainMs:[2,5],freq:[5600,11e3],q:9,peak:a,decay:.25,wet:.34})}const Fw={Disc:{cast(t){const e=se(t.rng,55),a=ts(t,.3,1.35,.62,.3),o=un(t,.22,.13),n=q(t,{filter:"bandpass",freq:[700*e,1800*e],q:1.6,peak:.34,attack:.05,hold:.1,duration:.3,drive:1.4,wet:.3});return j(a,o,n)},impact(t){const e=ve(t,{peak:.46,freq:3400,snap:1600,snapMs:10,wet:.1}),a=q(t,{filter:"bandpass",freq:[2400,950],q:2,peak:.3,attack:.003,duration:.07,drive:1.9,wet:.24}),o=ts(t,.2,1.3,.68,.3),n=un(t,.14,.46),s=X(t,{type:"sine",freq:[190,72],peak:.46,attack:.0022,duration:.1,drive:2.6,voices:2,detuneCents:15,wet:.14});return j(e,a,o,n,s)}},Roll:{cast(t){const e=se(t.rng,60);return q(t,{filter:"bandpass",freq:[900*e,2100*e],q:2.4,peak:.36,attack:.04,duration:.2,drive:1.5,wet:.3})},impact(t){const e=ts(t,.26,.7,1.5,.32),a=un(t,.2,.44),o=q(t,{filter:"bandpass",freq:[1100,3400],q:7,peak:.3,attack:.02,duration:.26,drive:1.6,wet:.32}),n=X(t,{type:"sine",freq:[230,124],peak:.18,attack:.004,duration:.08,drive:2.2,wet:.12});return j(e,a,o,n)}},Swarm:{cast(t){const e=se(t.rng,70),a=q(t,{filter:"bandpass",freq:[1400*e,3e3*e],q:4,peak:.36,attack:.025,duration:.17,drive:1.7,wet:.3}),o=un(t,.16,.16);return j(a,o)},impact(t){const e=ve(t,{peak:.36,freq:4200,snap:2200,snapMs:7,wet:.1}),a=ts(t,.13,1.2,.8,.24),o=un(t,.1,.3),n=X(t,{type:"sine",freq:[250,118],peak:.18,attack:.002,duration:.07,drive:2.4,wet:.12});return j(e,a,o,n)}}};function as(t,e,a,o){return yi(t,{freq:e,duration:a,peak:o,attack:.0012,drive:1.4,wet:.34,modes:[{ratio:1,gain:1,decay:1},{ratio:2.06,gain:.82,decay:.82},{ratio:3.18,gain:.6,decay:.6},{ratio:4.34,gain:.4,decay:.42},{ratio:5.52,gain:.3,decay:.3}]})}function Tc(t,e,a){return He(t,{count:7,spread:e,grainMs:[2,5],freq:[4200,12e3],q:10,peak:a,decay:.3,wet:.12})}function Nw(t,e,a){return Gs(t,{count:4,spread:e,freq:[5e3,12500],peak:a,pingMs:[5,13],bend:1.08,wet:.2})}const Lw={Candy:{cast(t){const e=se(t.rng,70),a=q(t,{filter:"bandpass",freq:[1400*e,3200*e],q:2,peak:.34,attack:.022,duration:.13,wet:.28}),o=as(t,1900*e,.11,.2),n=Tc(t,.07,.1);return j(a,o,n)},impact(t){const e=se(t.rng,60),a=ve(t,{peak:.5,freq:5400,snap:3200,snapMs:8,wet:.12}),o=as(t,2450*e,.4,.56),n=Tc(t,.22,.9),s=Nw(t,.16,.74),i=as({...t,when:t.when+.09},2450*e*1.02,.26,.22),r=as({...t,when:t.when+.175},2450*e*1.045,.17,.11),l=X(t,{type:"sine",freq:[280*e,130*e],peak:.42,attack:.0018,duration:.1,drive:3.2,wet:.12});return j(a,o,n,s,.09+i,.175+r,l)}}};function Wi(t,e,a){const o=se(t.rng,60),n=ve(t,{peak:e,freq:(4200+a*1800)*o,snap:(2600+a*900)*o,snapMs:7,wet:.05}),s=q(t,{filter:"bandpass",freq:[(2600+a*800)*o,(5200+a*1600)*o],q:3.4,peak:e*.8,attack:5e-4,duration:.022,drive:2.2,wet:.1}),i=q(t,{filter:"highpass",poles:24,freq:[(7e3+a*1800)*o,(4600+a*1200)*o],q:.7,peak:e*1.5,attack:4e-4,duration:.024,wet:.12});return j(n,s,i)}function Sc(t,e){const a=se(t.rng,70),o=q(t,{filter:"lowpass",poles:24,freq:[(1800+e*600)*a,(420-e*110)*a],q:3.6,peak:.26+e*.18,attack:.012+e*.01,duration:.15+e*.12,drive:2,wet:.24}),n=X(t,{type:"sine",freq:[(180-e*45)*a,(58-e*16)*a],peak:.36+e*.3,attack:.006,duration:.13+e*.1,drive:3.2,voices:2,detuneCents:16,wet:.14}),s=q(t,{filter:"bandpass",freq:[700*a,1500*a],q:6,peak:.12+e*.08,attack:.03,duration:.2+e*.14,wet:.36}),i=He(t,{count:Math.round(5+e*5),spread:.12+e*.06,grainMs:[3,8],freq:[3800,10600],q:7,peak:.5+e*.3,decay:.3,wet:.28});return j(o,n,s,i)}const Yi=.045,Dw={Tackle:{cast(t){const e=se(t.rng,40),a=q(t,{filter:"bandpass",freq:[420*e,1900*e],q:2,peak:.44,attack:.07,hold:.1,duration:.26,drive:1.6,wet:.3}),o=X(t,{type:"sine",freq:[120*e,240*e],peak:.28,attack:.08,duration:.24,drive:2.4,voices:2,detuneCents:14,wet:.16});return j(a,o)},impact(t){const e=Wi(t,.88,.35),a=Sc({...t,when:t.when+Yi},1);return j(e,Yi+a)}},Hatch:{cast(t){const e=Wi(t,.5,0),a=X({...t,when:t.when+.05},{type:"triangle",freq:[1500,2400],peak:.3,attack:.006,duration:.09,drive:2.2,wet:.32}),o=X({...t,when:t.when+.15},{type:"triangle",freq:[1800,2700],peak:.24,attack:.005,duration:.07,drive:2.2,wet:.32});return j(e,.05+a,.15+o)},impact(t){const e=ve(t,{peak:.4,freq:5400,snap:3200,snapMs:6,wet:.1}),a=q(t,{filter:"highpass",poles:24,freq:[8200,5600],q:.7,peak:.2,attack:4e-4,duration:.005,wet:.12}),o=X(t,{type:"triangle",freq:[2100,1250],peak:.22,attack:.0015,duration:.05,drive:2.4,wet:.2}),n=X({...t,when:t.when+.035},{type:"triangle",freq:[1700,2600],peak:.18,attack:.005,duration:.06,drive:2,wet:.3}),s=X(t,{type:"sine",freq:[240,120],peak:.22,attack:.002,duration:.06,drive:2.2,wet:.1});return j(e,a,o,.035+n,s)}},Shards:{cast(t){const e=se(t.rng,80),a=q(t,{filter:"highpass",freq:[1900*e,3800*e],q:1.1,peak:.32,attack:.016,duration:.11,wet:.26}),o=He(t,{count:4,spread:.08,grainMs:[3,6],freq:[3400,7e3],q:8,peak:.13,wet:.28});return j(a,o)},impact(t){const e=Yi*.62,a=Wi(t,.66,1),o=Sc({...t,when:t.when+e},.18);return j(a,e+o)}}};function Ac(t,e,a,o){const n=se(t.rng,70),s=X(t,{type:"sine",freq:[(170-e*55)*n,(52-e*16)*n],peak:o,attack:.003,duration:a,drive:3+e*1.2,voices:2,detuneCents:18,wet:.12}),i=q(t,{filter:"lowpass",poles:24,freq:[(760-e*220)*n,(150-e*45)*n],q:1.2,peak:o*.45,attack:.002,duration:a*.7,drive:2.2,wet:.2}),r=q(t,{filter:"bandpass",freq:[(2400-e*400)*n,(1450-e*300)*n],q:.8,peak:o*.056,attack:.003,duration:a*.55,drive:1.4,wet:.3});return j(s,i,r)}const Hw={Smash:{cast(t){const e=se(t.rng,55),a=q(t,{filter:"lowpass",poles:24,freq:[1300*e,420*e],q:1.6,peak:.42,attack:.055,hold:.1,duration:.22,drive:1.7,wet:.22}),o=X(t,{type:"sawtooth",freq:[180*e,92*e],lowpass:[620,220],peak:.24,attack:.03,duration:.2,drive:2.2,voices:2,detuneCents:20,wet:.12});return j(a,o)},impact(t){const e=ve(t,{peak:.44,freq:1500,snap:620,snapMs:22,wet:.1}),a=Ac(t,1,.24,.86);return j(e,a)}},Tomato:{cast(t){const e=se(t.rng,80),a=q(t,{filter:"lowpass",poles:24,freq:[1500*e,520*e],q:2.1,peak:.36,attack:.014,duration:.14,drive:1.6,wet:.18}),o=X(t,{type:"sine",freq:[300*e,140*e],peak:.16,attack:.006,duration:.11,drive:2,wet:.1});return j(a,o)},impact(t){const e=ve(t,{peak:.34,freq:1900,snap:780,snapMs:15,wet:.1}),a=Ac(t,.55,.19,.62),o=q(t,{filter:"lowpass",poles:24,freq:[1e3,260],q:2.8,peak:.24,attack:.008,duration:.13,drive:1.8,wet:.26});return j(e,a,o)}},Lettuce:{cast(t){return q(t,{filter:"bandpass",freq:[900,2200],q:1.2,peak:.26,attack:.03,duration:.15,wet:.3})},impact(t){const e=q(t,{filter:"lowpass",poles:24,freq:[1600,380],q:1.4,peak:.3,attack:.006,duration:.16,drive:1.5,wet:.3}),a=X(t,{type:"triangle",freq:[240,96],peak:.3,attack:.012,hold:.2,duration:.3,drive:2.4,voices:2,detuneCents:22,wet:.18}),o=q(t,{filter:"bandpass",freq:[3400,1900],q:.9,peak:.042,attack:.004,duration:.1,wet:.34});return j(e,a,o)}},Onion:{cast(t){const e=se(t.rng,20),a=[174.61,220,261.63];a.forEach((n,s)=>{X({...t,when:t.when+s*.07},{type:"triangle",freq:n*e,peak:.28,attack:.016,hold:.22,duration:.34,drive:2.2,voices:2,detuneCents:11,wet:.4})});const o=q(t,{filter:"lowpass",poles:24,freq:[900,300],q:1,peak:.1,attack:.1,duration:.45,wet:.5});return j(.34+a.length*.07,o)}}};function Rc(t,e,a,o,n){const s=se(t.rng,60),i=.075+o*.045,r=.1+o*.06,l=q(t,{filter:"bandpass",freq:[e*s,a*s],q:5.5,peak:n,attack:.012,duration:i,drive:1.8,wet:.2}),h=q({...t,when:t.when+i*.82},{filter:"bandpass",freq:[a*s,e*.72*s],q:5.5,peak:n*.9,attack:.008,duration:r,drive:1.8,wet:.24}),c=X(t,{type:"triangle",freq:[e*.34*s,a*.3*s],peak:n*.5,attack:.014,duration:i+r*.6,drive:2.4,voices:2,detuneCents:16,wet:.14});return j(l,i*.82+h,c)}function Ic(t,e,a){const o=se(t.rng,70),n=ve(t,{peak:.3+e*.1,freq:1700+a*700,snap:700+a*320,snapMs:16,wet:.1}),s=q(t,{filter:"lowpass",poles:24,freq:[(1400+a*600)*o,(280+a*120)*o],q:3.2,peak:.42+e*.2,attack:.005,duration:.15+e*.07,drive:2,wet:.26}),i=X(t,{type:"sine",freq:[(210-e*50)*o,(66-e*18)*o],peak:.6+e*.34,attack:.0025,duration:.16+e*.14,drive:2.6,voices:2,detuneCents:15,wet:.14}),r=q(t,{filter:"bandpass",freq:[(4200+a*2200)*o,(2100+a*900)*o],q:.75,peak:.23+a*.06,attack:.0015,duration:.05+a*.03,wet:.34});return j(n,s,i,r)}const zw={Mustard:{cast(t){return Rc(t,520,1250,.15,.44)},impact(t){return Ic(t,.42,1)}},Ketchup:{cast(t){return Rc(t,340,780,1,.42)},impact(t){const e=Ic(t,.3,0),a=q(t,{filter:"lowpass",poles:24,freq:[640,200],q:4,peak:.2,attack:.04,duration:.34,drive:1.6,wet:.4});return j(e,a)}},Slash:{cast(t){const e=se(t.rng,50);return q(t,{filter:"bandpass",freq:[700*e,2300*e],q:2,peak:.38,attack:.05,hold:.1,duration:.19,drive:1.5,wet:.26})},impact(t){const e=se(t.rng,45),a=.026,o=(h,c,d)=>ve({...t,when:t.when+h},{peak:c,freq:d,snap:d*.3,snapMs:20,wet:.12}),n=o(0,.5,1400),s=o(a,.4,1200),i=q(t,{filter:"bandpass",freq:[900*e,340*e],q:2.4,peak:.34,attack:.0015,duration:.12,drive:2.1,wet:.24}),r=X(t,{type:"sine",freq:[200*e,58*e],peak:.95,attack:.002,duration:.24,drive:3,voices:2,detuneCents:17,wet:.14}),l=He(t,{count:5,spread:.075,grainMs:[3,9],freq:[3e3,6400],q:4,peak:.38,decay:.3,wet:.3});return j(n,a+s,i,r,l)}}};function Vi(t,e,a,o){const n=yi(t,{freq:e,duration:a,peak:o,attack:8e-4,wet:.36,modes:[{ratio:1,gain:1,decay:1},{ratio:2.76,gain:.8,decay:.7},{ratio:5.4,gain:.5,decay:.44}]}),s=X(t,{type:"sine",freq:[e*1.02,e*.92],ring:e*1.37,peak:o*.7,attack:8e-4,duration:a*.8,wet:.4});return j(n,s)}function Cc(t,e,a,o){return He(t,{count:e,spread:a,grainMs:[2,5],freq:[5600,14e3],q:11,peak:o,decay:.3,wet:.3})}const _w={Smash:{cast(t){const e=se(t.rng,50),a=q(t,{filter:"bandpass",freq:[600*e,2400*e],q:2.4,peak:.44,attack:.055,hold:.1,duration:.22,drive:1.5,wet:.3}),o=Vi(t,2400*e,.12,.16);return j(a,o)},impact(t){const e=se(t.rng,45),a=ve(t,{peak:.66,freq:6400,snap:4200,snapMs:6,wet:.14}),o=Vi(t,5400*e,.34,.56),n=Cc(t,9,.2,.8),s=X(t,{type:"sine",freq:[250*e,100*e],peak:.62,attack:.0015,duration:.12,drive:3,wet:.12}),i=q(t,{filter:"bandpass",freq:[7e3,12e3],q:1.2,peak:.26,attack:.025,duration:.16,wet:.5});return j(a,o,n,i,s)}},Giant:{impact(t){const e=se(t.rng,35),a=ve(t,{peak:.72,freq:5800,snap:3600,snapMs:9,wet:.16}),o=Vi(t,4550*e,.5,.64),n=Cc(t,12,.36,.84),s=q(t,{filter:"bandpass",freq:[6e3,9500],q:1.4,peak:.14,attack:.06,duration:.58,wet:.6}),i=X(t,{type:"sine",freq:[230*e,78*e],peak:.52,attack:.0025,duration:.14,drive:3,voices:2,detuneCents:16,wet:.14});return j(a,o,n,s,i)}}};function Ki(t,e,a){const o=se(t.rng,60),n=.38+a*.12,s=q(t,{filter:"bandpass",freq:[(560-a*200)*o,(2200-a*900)*o],q:1.5,peak:1.2,attack:.035,hold:.1,duration:n,drive:1.5,wet:.1*Math.min(1,16/e),tremolo:{rate:[e*.88,e],depth:.85}}),i=q(t,{filter:"highpass",freq:3600,peak:.16,attack:8e-4,duration:.018,wet:.1});return j(s,i)}const Pw={Dough:{cast(t){return Ki(t,16,.85)},impact(t){const e=se(t.rng,70),a=q(t,{filter:"lowpass",poles:24,freq:[1100*e,190*e],q:1.1,peak:.34,attack:.004,duration:.13,drive:1.8,wet:.24}),o=ve(t,{peak:.34,freq:1600,snap:660,snapMs:18,wet:.1}),n=X(t,{type:"sine",freq:[150*e,58*e],peak:.5,attack:.003,duration:.18,drive:2.8,voices:2,detuneCents:18,wet:.14}),s=q(t,{filter:"bandpass",freq:[2500,1700],q:.8,peak:.028,attack:.012,duration:.11,wet:.4});return j(a,o,n,s)}},Tomato:{cast(t){return Ki(t,26,.25)},impact(t){const e=se(t.rng,65),a=q(t,{filter:"bandpass",freq:[1350*e,400*e],q:1.4,peak:.34,attack:.001,duration:.07,drive:2,wet:.2}),o=q(t,{filter:"lowpass",poles:24,freq:[900,240],q:2.6,peak:.3,attack:.008,duration:.15,drive:1.7,wet:.26}),n=ve(t,{peak:.34,freq:2e3,snap:900,snapMs:13,wet:.1}),s=X(t,{type:"sine",freq:[200*e,72*e],peak:.62,duration:.18,drive:3.2,voices:2,detuneCents:16,wet:.14}),i=th(t,{peak:.15,freq:[8200,3e3],duration:.085,drops:6,wet:.34});return j(a,o,n,s,i)}},Cheese:{cast(t){return Ki(t,12,.6)},impact(t){const e=se(t.rng,55),a=q(t,{filter:"bandpass",freq:[1400*e,480*e],q:2.2,peak:.3,attack:.01,duration:.2,drive:1.6,wet:.26}),o=X(t,{type:"triangle",freq:[300*e,110*e],peak:.32,attack:.012,hold:.25,duration:.34,drive:2.4,voices:2,detuneCents:20,wet:.18}),n=ve(t,{peak:.26,freq:1800,snap:760,snapMs:16,wet:.1}),s=He(t,{count:4,spread:.13,grainMs:[6,16],freq:[3200,5200],q:3.5,peak:.16,decay:.35,freqShift:[1,.62],wet:.34});return j(a,o,n,s)}}};function Xi(t,e,a){return q(t,{filter:"bandpass",freq:[2800,5600],q:.85,peak:e,attack:a*.35,duration:a,wet:.55})}function Zi(t,e,a,o){return xn(t,{count:e,spread:a,freq:[1500,3100],rise:1.9,peak:o,wet:.42})}function Ji(t,e,a,o){const n=se(t.rng,80),s=(2600-e*900)*n,i=(420-e*200)*n,r=q(t,{filter:"lowpass",freq:[s,i],poles:24,q:2.4+e*2,peak:o*.72,attack:.006+e*.012,duration:a,drive:1.8,wet:.3}),l=X(t,{type:"sine",freq:[(190-e*60)*n,(68-e*22)*n],peak:o*(.85+e*.55),attack:.005,duration:a*.75,drive:2.5,voices:2,detuneCents:16,wet:.14}),h=ve(t,{peak:.22+e*.12,freq:1150,snap:460,snapMs:18,wet:.12});return j(r,l,h)}const $w={Splash:{cast(t){const e=se(t.rng,90),a=q(t,{filter:"bandpass",freq:[900*e,260*e],q:3.4,peak:.46,attack:.012,duration:.12,drive:1.8,wet:.24}),o=xn(t,{count:2,spread:.07,freq:[620,980],peak:.2,wet:.3});return j(a,o)},impact(t){const e=Ji(t,.24,.2,.44),a=xn(t,{count:4,spread:.16,freq:[480,900],peak:.14,wet:.3}),o=Zi(t,7,.11,.2),n=Xi(t,.11,.34);return j(e,a,o,n)}},Noodle:{cast(t){const e=se(t.rng,70),a=q(t,{filter:"bandpass",freq:[1500*e,520*e],q:2.2,peak:.42,attack:.01,duration:.16,drive:1.7,wet:.26}),o=X(t,{type:"sine",freq:[520*e,190*e],peak:.16,attack:.02,duration:.18,drive:2,wet:.16});return j(a,o)},impact(t){const e=q(t,{filter:"bandpass",freq:[1400,560],q:1.6,peak:.26,attack:.0015,duration:.05,drive:1.8,wet:.18}),a=Ji(t,.35,.26,.44),o=xn(t,{count:3,spread:.2,freq:[440,820],peak:.12,wet:.3}),n=Zi(t,8,.14,.2),s=Xi(t,.12,.42);return j(e,a,o,n,s)}},Dump:{cast(t){const e=se(t.rng,40);let a=0;const o=9;for(let s=0;s<o;s++){const i=s/o*.34+be(t.rng,-.012,.012),r=be(t.rng,320,1100)*e,l=be(t.rng,.05,.11);a=Math.max(a,i+l),q({...t,when:t.when+Math.max(0,i)},{filter:"lowpass",poles:24,freq:[r*2.2,r*.6],q:4.5,peak:.32,attack:.008,duration:l,drive:1.6,wet:.28})}const n=X(t,{type:"sine",freq:[150*e,70*e],peak:.3,attack:.12,duration:.4,drive:2,voices:2,detuneCents:14,wet:.2});return j(a,n)},impact(t){const e=Ji(t,1,.42,.62),a=xn(t,{count:7,spread:.34,freq:[380,820],peak:.16,wet:.34}),o=He(t,{count:5,spread:.26,freq:[600,1500],peak:.1,q:4,wet:.3}),n=Zi(t,7,.22,.14),s=Xi(t,.15,.75);return j(e,a,o,n,s)}}};function Qi(t,e,a,o,n){const s=se(t.rng,45),i=q(t,{filter:"bandpass",freq:[e*s,a*s],q:12,peak:n,attack:.004,duration:o,curve:"lin",freqCurve:"exp",wet:.18}),r=q({...t,when:t.when+o*.16},{filter:"bandpass",freq:[e*2*s,a*1.7*s],q:14,peak:n*.5,attack:.002,duration:o*.7,curve:"lin",wet:.22}),l=q({...t,when:t.when+o*.06},{filter:"bandpass",freq:[e*3.4*s,a*2.6*s],q:16,peak:n*.8,attack:.0015,duration:o*.45,curve:"lin",wet:.24});return j(i,o*.16+r,o*.06+l)}function os(t,e,a,o){return He(t,{count:e,spread:a,grainMs:[2,5],freq:[4200,12e3],q:6,peak:o,decay:.35,wet:.1})}const Bw={Rice:{cast(t){const e=q(t,{filter:"highpass",freq:[2200,4200],q:1,peak:.3,attack:.012,duration:.09,wet:.2}),a=os(t,7,.09,.2);return j(e,a)},impact(t){const e=os(t,6,.075,.34),a=ve(t,{peak:.3,freq:5600,snap:3600,snapMs:5,wet:.08}),o=X(t,{type:"sine",freq:[300,170],peak:.16,attack:.0015,duration:.05,drive:2,wet:.1});return j(e,a,o)}},Seaweed:{cast(t){const e=se(t.rng,60);return q(t,{filter:"bandpass",freq:[1600*e,3400*e],q:1.8,peak:.34,attack:.03,duration:.18,wet:.3})},impact(t){const e=se(t.rng,55),a=He(t,{count:10,spread:.16,grainMs:[3,9],freq:[2800,6400],q:4.5,peak:.28,decay:.35,wet:.28}),o=q(t,{filter:"bandpass",freq:[3600*e,1600*e],q:7,peak:.26,attack:.012,duration:.24,wet:.32}),n=ve(t,{peak:.32,freq:4200,snap:2400,snapMs:7,wet:.1}),s=X(t,{type:"sine",freq:[280,150],peak:.13,attack:.003,duration:.06,drive:2,wet:.12});return j(a,o,n,s)}},Fish:{cast(t){return Qi(t,900,2600,.14,.3)},impact(t){const e=Qi(t,2600,8200,.17,.72),a=q(t,{filter:"lowpass",poles:24,freq:[1100,340],q:2.4,peak:.16,attack:.006,duration:.09,drive:1.8,wet:.24}),o=os(t,5,.1,.2),n=X(t,{type:"sine",freq:[230,96],peak:.42,attack:.0018,duration:.07,drive:2.4,wet:.12});return j(e,a,o,n)}},Catch:{cast(t){const e=se(t.rng,40),a=X(t,{type:"sine",freq:[140*e,300*e],peak:.3,attack:.1,duration:.3,drive:2.2,voices:2,detuneCents:14,wet:.24}),o=q(t,{filter:"bandpass",freq:[800*e,2400*e],q:2.2,peak:.34,attack:.08,duration:.28,wet:.32});return j(a,o)},impact(t){const e=Qi(t,3e3,9e3,.15,.8),a=q({...t,when:t.when+.05},{filter:"lowpass",poles:24,freq:[1300,420],q:2.2,peak:.2,attack:.005,duration:.11,drive:1.9,wet:.26}),o=os({...t,when:t.when+.04},8,.16,.28),n=ve(t,{peak:.52,freq:5e3,snap:2800,snapMs:7,wet:.1}),s=X(t,{type:"sine",freq:[220,80],peak:.5,attack:.0018,duration:.09,drive:2.6,voices:2,detuneCents:14,wet:.14});return j(e,.05+a,.04+o,n,s)}}};function ns(t,e,a){const o=se(t.rng,70),n=q(t,{filter:"bandpass",freq:[3400*o,1500*o],q:1.2,peak:.55+e*.3,attack:6e-4,duration:.03,drive:2.2,wet:.12}),s=ve(t,{peak:.44+e*.2,freq:5200*o,snap:(2900-e*500)*o,snapMs:8,wet:.1}),i=He(t,{count:Math.round(7+e*6),spread:.14+e*.1,grainMs:[3,9-a*3],freq:[2700+a*900,9200+a*2600],q:7,peak:.34+e*.16,decay:.28,drive:1.6,wet:.26}),r=e*(1-a)>.02?X(t,{type:"sine",freq:[(190-e*60)*o,(72-e*22)*o],peak:.24+e*.26,attack:.002,duration:.08+e*.1,drive:2.6,voices:2,detuneCents:16,wet:.14}):0,l=q(t,{filter:"highpass",poles:24,freq:[8e3+a*2e3,5200+a*1200],q:.7,peak:.165+e*.065,attack:6e-4,duration:.014+e*.012,wet:.22});return j(n,s,i,r,l)}const qw={Filling:{cast(t){const e=se(t.rng,60),a=q(t,{filter:"bandpass",freq:[700*e,1800*e],q:2,peak:.44,attack:.03,duration:.16,drive:1.6,wet:.26}),o=He(t,{count:4,spread:.1,freq:[3e3,7e3],peak:.11,q:8,wet:.28}),n=X(t,{type:"sine",freq:[260*e,130*e],peak:.14,duration:.1,drive:2,wet:.12});return j(a,o,n)},impact(t){return ns(t,.75,.3)}},Onion:{cast(t){const e=se(t.rng,80);return q(t,{filter:"highpass",freq:[1800*e,3400*e],q:1.1,peak:.36,attack:.02,duration:.12,wet:.28})},impact(t){const e=ns(t,.3,1),a=q(t,{filter:"bandpass",freq:[1100,420],q:1.6,peak:.26,attack:.006,duration:.1,drive:1.7,wet:.24});return j(e,a)}},Double:{cast(t){const e=se(t.rng,50),a=q(t,{filter:"bandpass",freq:[640*e,1700*e],q:2,peak:.44,attack:.025,duration:.15,drive:1.6,wet:.26}),o=q({...t,when:t.when+.055},{filter:"bandpass",freq:[820*e,2100*e],q:2,peak:.38,attack:.02,duration:.13,drive:1.6,wet:.26}),n=X(t,{type:"sine",freq:[240*e,118*e],peak:.16,duration:.12,drive:2,wet:.12});return j(a,.055+o,n)},impact(t){const e=ns(t,.85,.1),a=ns({...t,when:t.when+.055},.4,.85);return j(e,.055+a)}}};function ss(t,e,a,o){return yi(t,{freq:e,duration:a,peak:o,attack:.001,drive:1.8,wet:.22,modes:[{ratio:1,gain:1,decay:1},{ratio:2.43,gain:.78,decay:.55},{ratio:3.71,gain:.5,decay:.34},{ratio:5.86,gain:.3,decay:.2}]})}function Oc(t,e,a){const o=q(t,{filter:"bandpass",freq:[1300,2800],q:1.5,peak:e,attack:.004,duration:a,wet:.34}),n=He(t,{count:7,spread:a*.7,grainMs:[3,7],freq:[2600,8600],q:8,peak:e*.42,decay:.3,wet:.3}),s=q(t,{filter:"highpass",poles:24,freq:[6200,3800],q:.7,peak:e*.25,attack:.002,duration:a*.5,wet:.36});return j(o,n,s)}const Uw={Spray:{cast(t){const e=q(t,{filter:"bandpass",freq:[900,2800],q:1.1,peak:.34,attack:.02,duration:.14,wet:.28}),a=ss(t,190,.06,.2);return j(e,a)},impact(t){const e=ve(t,{peak:.28,freq:4200,snap:2500,snapMs:8,wet:.12}),a=Oc(t,.34,.16),o=X(t,{type:"sine",freq:[260,120],peak:.3,attack:.002,duration:.09,drive:2,wet:.12});return j(e,a,o)}},Glass:{cast(t){const e=se(t.rng,70),a=q(t,{filter:"highpass",freq:[1600*e,3600*e],q:1.2,peak:.36,attack:.018,duration:.13,wet:.26}),o=He(t,{count:3,spread:.07,grainMs:[3,7],freq:[4200,8e3],q:9,peak:.14,wet:.3});return j(a,o)},impact(t){const e=ve(t,{peak:.62,freq:4600,snap:3400,snapMs:9,wet:.14}),a=ss(t,460,.13,.42),o=He(t,{count:9,spread:.15,grainMs:[3,8],freq:[3200,9200],q:8,peak:.3,decay:.25,wet:.32}),n=Gs(t,{count:3,spread:.1,freq:[5200,11e3],peak:.19,pingMs:[6,14],bend:.9,wet:.34});return j(e,a,o,n)}},Cap:{cast(t){const e=X(t,{type:"sine",freq:[520,900],peak:.4,attack:.001,duration:.05,drive:2.6,wet:.2}),a=ve(t,{peak:.3,freq:4e3,snap:2400,snapMs:6,wet:.12});return j(e,a)},impact(t){const e=ve(t,{peak:.52,freq:3800,snap:2300,snapMs:9,wet:.12}),a=ss(t,560,.2,.7),o=X(t,{type:"sine",freq:[150,68],peak:.17,attack:.003,duration:.11,drive:2.4,wet:.12}),n=Gs(t,{count:2,spread:.05,freq:[4600,9e3],peak:.3,pingMs:[5,11],bend:.86,wet:.28});return j(e,a,o,n)}},Mega:{cast(t){const e=se(t.rng,35),a=q(t,{filter:"bandpass",freq:[500*e,2600*e],q:1.8,peak:.44,attack:.1,hold:.08,duration:.34,drive:1.5,wet:.34}),o=X(t,{type:"sine",freq:[90*e,200*e],peak:.34,attack:.12,duration:.36,drive:2.4,voices:2,detuneCents:14,wet:.2});return j(a,o)},impact(t){const e=ve(t,{peak:.58,freq:3e3,snap:1500,snapMs:16,wet:.12}),a=Oc(t,.56,.42),o=ss(t,380,.24,.56),n=X(t,{type:"sine",freq:[140,46],peak:.62,attack:.003,duration:.3,drive:3.2,voices:2,detuneCents:18,wet:.16});return j(e,a,o,n)}}};function St(t,e){const a={};for(const[o,n]of Object.entries(e))n&&(a[`${t}.${o}`]=n);return a}const Gw={...St("burrito",Fw),...St("donut",Lw),...St("egg",Dw),...St("hamburger",Hw),...St("hotdog",zw),...St("lollipop",_w),...St("pizza",Pw),...St("soup",$w),...St("sushi",Bw),...St("taco",qw),...St("waterbottle",Uw)};function Fc(t,e){return Gw[`${t}.${e}`]}const jw=210,Ww=.78,Yw=420,Vw=900,Kw=520,Xw=.45,Zw=1.5,Jw=1600,Qw=Yw,e1=.6180339887,t1=.42;class js{constructor(e,a={}){this.engine=e,this.localSlot=a.listenerId??(a.listener==="enemy"?1:Oe),this.listenerSlot=this.localSlot}listenerSlot;localSlot;lastFogSoundAt=-1/0;lastHealSoundAt=-1/0;ringFloored=!1;sawRingAboveFloor=!1;statusBefore=[];statusWriterUnclaimed=[];statusTrackable=!1;nextAmbienceAt=-1/0;ambienceChunk=0;lastCombatAt=-1/0;setListener(e){this.listenerSlot=e}handleEvents(e,a){try{this.watchZone(a),this.watchAmbience(a),this.openStatusWindow(a);for(const o of e)this.handleEvent(o,a)}catch(o){console.warn("[audio] event dispatch failed:",o)}finally{this.closeStatusWindow(a)}}reset(){this.listenerSlot=this.localSlot,this.lastFogSoundAt=-1/0,this.lastHealSoundAt=-1/0,this.ringFloored=!1,this.sawRingAboveFloor=!1,this.statusBefore=[],this.statusWriterUnclaimed=[],this.statusTrackable=!1,this.nextAmbienceAt=-1/0,this.ambienceChunk=0,this.lastCombatAt=-1/0}static statusTimestamps(e){const a=e.status;return!a||typeof a.stunnedUntil!="number"||typeof a.slowedUntil!="number"?null:{stun:a.stunnedUntil,slow:a.slowedUntil}}openStatusWindow(e){const o=Pe(e).map(n=>js.statusTimestamps(n));if(this.statusTrackable=o.length>0&&o.every(n=>n!==null),!!this.statusTrackable)for(let n=0;n<o.length;n++){const s=this.statusBefore[n]??{stun:NaN,slow:NaN},i=o[n];this.statusWriterUnclaimed[n]={stun:i.stun!==s.stun,slow:i.slow!==s.slow}}}closeStatusWindow(e){Pe(e).forEach((a,o)=>{const n=js.statusTimestamps(a);n&&(this.statusBefore[o]=n)})}wasStatusRefused(e,a){if(!this.statusTrackable)return!1;const o=this.statusWriterUnclaimed[e];return o?.[a]?(o[a]=!1,!1):!0}watchZone(e){if(!this.ringFloored&&e.phase==="playing"){if(e.safeRadius>u0(e.fighters.length,e.timeRemaining)+.5){this.sawRingAboveFloor=!0;return}this.sawRingAboveFloor&&(this.ringFloored=!0,this.engine.play(Rw(),{priority:Ke.Critical}))}}watchAmbience(e){if(e.phase!=="playing"||e.elapsed<this.nextAmbienceAt)return;this.nextAmbienceAt=e.elapsed+K0*1e3;const a=this.ambienceChunk*e1%1;this.ambienceChunk++;const o=Pe(e);let n=1/0;for(let i=0;i<o.length;i++)for(let r=i+1;r<o.length;r++){const l=Math.hypot(o[i].x-o[r].x,o[i].y-o[r].y);l<n&&(n=l)}const s=e.elapsed-this.lastCombatAt<Jw||n<Qw;this.engine.play(kw(),{gain:s?Xw:Zw,pan:(a*2-1)*t1,priority:Ke.Ambient,key:"ambience"})}handleEvent(e,a){switch(e.type){case"countdown-tick":this.engine.play(Sw(e.value),{priority:Ke.Critical});break;case"match-started":this.engine.play(Aw(),{priority:Ke.Critical});break;case"match-ended":{const o=Pe(a),n=o.length>0&&o.every(i=>i.alive===!0),s=oa(e.winnerId,e.winner)===this.localSlot;this.engine.play(n?Cw(s):Iw(s),{priority:Ke.Critical});break}case"weapon-fired":this.lastCombatAt=a.elapsed,this.playCast(bt(a,e.fighterId,e.fighterRole),e.weaponKey,a);break;case"hit-landed":this.lastCombatAt=a.elapsed,this.playHit(e,a);break;case"heal":{if(e.amount<=f0&&a.elapsed-this.lastHealSoundAt<Kw)break;this.lastHealSoundAt=a.elapsed;const o=bt(a,e.fighterId,e.fighterRole);this.engine.play(yw(),{...this.place(o.x,o.y,a),key:"heal"});break}case"death":{const o=bt(a,e.fighterId,e.fighterRole),n=this.place(o.x,o.y,a);this.engine.play(bw(),{...n,priority:Ke.Critical,gain:oa(e.fighterId,e.fighterRole)===this.localSlot?1:n.gain});break}case"projectile-destroyed":e.reason==="hit-cover"&&this.engine.play(Tw(),{...this.place(e.x,e.y,a),priority:Ke.Ambient,key:"cover"});break}}playCast(e,a,o){const n=re[e.characterId].weapons.find(r=>r.key===a);if(!n)return;if(n.giantSlam){this.engine.play(fw(),{priority:Ke.Critical});return}const s=Fc(e.characterId,a)?.cast,i=s?this.wrapWeaponHook(s,n,e.characterId,n.damage):a1(n);this.engine.play(i,{...this.place(e.x,e.y,o),key:`cast:${e.characterId}.${a}`})}playHit(e,a){const o=this.place(e.x,e.y,a),n=oa(e.targetId,e.targetRole),s=e.effect==="stun"&&this.wasStatusRefused(n,"stun");if(e.source.kind==="fog"){if(a.elapsed-this.lastFogSoundAt<Vw)return;this.lastFogSoundAt=a.elapsed,this.engine.play(xw(),{priority:Ke.Ambient,key:"fog"});return}if(e.source.kind==="hazard"){this.engine.play(Mw(),{...o,priority:Ke.Ambient,key:"hazard"});return}if(e.source.kind==="trail"){this.engine.play(Ew(),{...o,priority:Ke.Ambient,key:"trail"});return}const i=e.source.weaponKey,r=vn(a,e.source,e.targetRole),l=re[r.characterId].weapons.find(d=>d.key===i),h=l?Fc(r.characterId,l.key)?.impact:void 0,c=h&&l?this.wrapWeaponHook(h,l,r.characterId,e.amount):mw(e.amount);if(this.engine.play(c,{...o,key:`impact:${r.characterId}.${i}`}),n===this.localSlot){const d=bt(a,e.targetId,e.targetRole);this.engine.play(gw(d.hp/d.maxHp),{gain:.9,key:"hurt",priority:Ke.Normal})}s&&this.engine.play(ww(),{...o,key:"shrug",priority:Ke.Normal})}wrapWeaponHook(e,a,o,n){return s=>e({...s,color:a.color,damage:n,weapon:a,characterId:o})}place(e,a,o){const n=Pe(o)[this.listenerSlot]??o.player,s=e-n.x,i=a-n.y,r=Math.max(-1,Math.min(1,s/jw))*Ww,l=Math.hypot(s,i),h=lw(l,hw,cw);return{pan:r,gain:h}}}function a1(t){return t.type==="melee"?pw(t.damage,t.cone??90):t.type==="self"?uw():dw(t.damage)}const er="/food-arena/",Nc=`${er.endsWith("/")?er:`${er}/`}audio/bounce-and-bash.mp3`,Lc=.45,X0="fa.audio.music";function o1(){try{const t=localStorage.getItem(X0);if(t){const e=JSON.parse(t);return{volume:typeof e.volume=="number"?Math.min(1,Math.max(0,e.volume)):Lc,enabled:e.enabled!==!1}}}catch{}return{volume:Lc,enabled:!0}}function Dc(t){try{localStorage.setItem(X0,JSON.stringify(t))}catch{}}class n1{el=null;source=null;gain=null;state=o1();wanted=!1;listeners=new Set;fadeToken=0;loadError=null;suppressed=!1;ensureGraph(){if(typeof document>"u")return!1;const e=ht(),a=e.context,o=e.busInput;if(!a||!o||typeof a.createMediaElementSource!="function")return!1;if(this.source)return!0;if(!this.el){const n=document.createElement("audio");n.src=Nc,n.loop=!0,n.preload="auto",n.volume=1,n.crossOrigin="anonymous",n.addEventListener("error",()=>{const s=n.error?n.error.code:0;this.loadError=`music track failed to load (MediaError ${s}) from ${n.currentSrc||n.src}`,console.warn(`[audio] ${this.loadError}`),this.emit()},{once:!0}),this.el=n}try{return this.source=a.createMediaElementSource(this.el),this.gain=a.createGain(),this.gain.gain.value=this.state.enabled?this.state.volume:0,this.source.connect(this.gain).connect(o),!0}catch{return this.source=null,this.gain=null,!1}}play(){if(this.wanted=!0,this.suppressed||!this.state.enabled||!this.ensureGraph()||!this.el)return;const e=this.el.play();e&&typeof e.catch=="function"&&e.catch(()=>{})}pause(){this.wanted=!1,this.el?.pause()}onUnlock(){this.wanted&&this.play()}isPlaying(){return!!this.el&&!this.el.paused}getLoadError(){return this.loadError}getTrackUrl(){return this.el?this.el.src:Nc}getVolume(){return this.state.volume}setVolume(e){this.state.volume=Math.min(1,Math.max(0,e)),Dc(this.state),this.applyGain(),this.emit()}isEnabled(){return this.state.enabled}setEnabled(e){this.state.enabled=e,Dc(this.state),this.applyGain(),e?this.play():this.el?.pause(),this.emit()}fadeOut(e=.6){if(this.suppressed=!0,!this.el||this.el.paused)return;this.applyGain(0,e);const a=this.el;window.setTimeout(()=>{this.fadeToken===o&&a.pause()},e*1e3+40);const o=++this.fadeToken}fadeIn(e=.8){if(this.fadeToken++,this.suppressed=!1,!this.state.enabled||!this.ensureGraph()||!this.el)return;const a=this.el.paused;if(a){this.gain&&(this.gain.gain.value=0);const o=this.el.play();o&&typeof o.catch=="function"&&o.catch(()=>{})}this.applyGain(void 0,a?e:.25)}duck(e=.35){this.applyGain(this.state.volume*Math.min(1,Math.max(0,e)))}unduck(){this.applyGain()}onChange(e){return this.listeners.add(e),()=>this.listeners.delete(e)}applyGain(e,a=.08){if(!this.gain)return;const n=ht().context,s=this.state.enabled?e??this.state.volume:0;try{if(n){const i=n.currentTime;this.gain.gain.cancelScheduledValues(i),this.gain.gain.setValueAtTime(this.gain.gain.value,i),this.gain.gain.linearRampToValueAtTime(s,i+a)}else this.gain.gain.value=s}catch{this.gain.gain.value=s}}emit(){for(const e of this.listeners)try{e()}catch{}}}let is=null;function ot(){if(!is){is=new n1;const t=is;ht().onChange(()=>{ht().getState()==="running"&&t.onUnlock()})}return is}let rs=null;function ht(){return rs||(rs=new sw,i1(rs)),rs}function s1(t){return new js(ht(),t)}const ke={setVolume(t){ht().setVolume(t)},getVolume(){return ht().getVolume()},setMuted(t){ht().setMuted(t)},isMuted(){return ht().isMuted()},toggleMuted(){return ht().toggleMuted()},onChange(t){return ht().onChange(t)},getState(){return ht().getState()},unlock(){ht().unlock()},previewClick(){ht().play(Ow(),{key:"ui"})},music:{play(){ot().play()},pause(){ot().pause()},isPlaying(){return ot().isPlaying()},getVolume(){return ot().getVolume()},setVolume(t){ot().setVolume(t)},isEnabled(){return ot().isEnabled()},setEnabled(t){ot().setEnabled(t)},fadeOut(t){ot().fadeOut(t)},fadeIn(t){ot().fadeIn(t)},duck(t){ot().duck(t)},unduck(){ot().unduck()},onChange(t){return ot().onChange(t)},getLoadError(){return ot().getLoadError()},getTrackUrl(){return ot().getTrackUrl()}}};function i1(t){typeof window>"u"||(window.__audio={engine:t,tap:()=>t.tap(),connectTap:e=>t.connectTap(e),stats:()=>({state:t.getState(),activeVoices:t.activeVoices(),started:t.counters.started,droppedBudget:t.counters.droppedBudget,droppedThrottle:t.counters.droppedThrottle,droppedNotRunning:t.counters.droppedNotRunning,volume:t.getVolume(),muted:t.isMuted()}),get music(){const e=ot();return{url:e.getTrackUrl(),error:e.getLoadError(),playing:e.isPlaying(),enabled:e.isEnabled()}}})}const O={ink:"#1a1224",cream:"#FFF3DE",white:"#FFFFFF",gold:"#F4A300",goldDark:"#B87400",mustard:"#FFC93C",mustardHi:"#FFDD6B",ketchup:"#D62839",tomato:"#E63946",tomatoHi:"#FF9E9E",lettuce:"#7CB518",leafDark:"#4E8B2B",water:"#1E90D8",waterHi:"#5BC8F5",ice:"#8FE1FF",iceHi:"#BFF0FF",grape:"#7A4BC4",grapeHi:"#9B6BE0",grapeDark:"#5B2E8C",violet:"#B497D6",wood:"#8B4A22",woodHi:"#B4622A",meat:"#8B3A2E",meatHi:"#D98A72",patty:"#A05A2C",pattyDark:"#5A2E17",steel:"#DCD6E8",candy:"#FF6FA5",candyHi:"#FFB3D1",flame:"#FF7A2F"};function Oo(t,e,a,o=12,n=12){const s=[];for(let i=0;i<t*2;i++){const r=i%2===0?e:a,l=Math.PI*i/t-Math.PI/2;s.push(`${(o+r*Math.cos(l)).toFixed(2)} ${(n+r*Math.sin(l)).toFixed(2)}`)}return`M${s.join("L")}Z`}const r1={patty:`
...
<path d="M8.4 15a4 4 0 0 0 4.6 4.4" stroke="${O.gold}" stroke-width="1.9"/>`,burst:`<path d="${Oo(9,10.2,4.6)}" fill="${O.gold}"/>
<path d="${Oo(9,5.6,2.4)}" fill="${O.mustardHi}" stroke-width="1.3"/>`,hammer:`
...
<path d="M18.3 9.2c1.7 2.4 2.5 4.2 2.5 5.5 0 1.5-.9 2.5-2.2 2.5s-2.2-1-2.2-2.5c0-1.3.6-3 1.9-5.5z" fill="${O.mustardHi}"/>`};function ls(t,e,a,o=""){return`
...
${o}`}const l1=`<path d="M12 0.6c2.6 2.2 3.7 3.9 3.2 5.5-.9-.8-1.6-1.1-2.3-.9.7 1.9.3 3.1-.9 4-1.2-.9-1.6-2.1-.9-4-.7-.2-1.4.1-2.3.9-.5-1.6.6-3.3 3.2-5.5z" fill="${O.flame}" stroke-width="1.3"/>`,h1=`<path d="M12 0.4c2.4.8 3.6 2.4 3.6 4.6-2.4-.7-3.6-2.3-3.6-4.6zM12 0.4c-2.4.8-3.6 2.4-3.6 4.6C10.8 4.3 12 2.7 12 .4z" fill="${O.lettuce}" stroke-width="1.3"/>`,c1=`<path d="M12 5.6C9.2 1.6 4.8 2.8 6.2 5.6M12 5.6C14.8 1.6 19.2 2.8 17.8 5.6" fill="${O.mustard}" stroke-width="1.4"/>`,d1=`<path d="M4.9 13.4a2.6 2.6 0 0 1 5.2 0z" fill="#B4622A" stroke-width="1.2"/>
<path d="M4.7 13.4h5.6v1.5H4.7z" fill="${O.lettuce}" stroke-width="1.2"/>
<path d="M4.9 15h5.2a2.2 2.2 0 0 1-5.2 0z" fill="#B4622A" stroke-width="1.2"/>`,p1=Array.from({length:8},(t,e)=>`<rect x="10.3" y="0.9" width="3.4" height="5.4" rx="1.2" fill="${O.gold}" transform="rotate(${e*45} 12 12)"/>`).join(""),u1={coin:`
<circle cx="12" cy="12" r="9.5" fill="${O.goldDark}"/>
<circle cx="12" cy="12" r="7.6" fill="${O.gold}" stroke="none"/>
<path d="${Oo(5,5.8,2.5,12,12)}" fill="${O.cream}" stroke="none"/>`,gem:`
...
<path d="M9.6 5.1a3.4 3.4 0 0 0 .5 4.5" stroke="${O.cream}" stroke-width="1.4"/>`,star:`<path d="${Oo(5,9.4,4.1)}" fill="${O.mustard}"/>
...
<circle cx="12" cy="12.9" r="0.85" fill="${O.wood}" stroke="none"/>`,boxBurger:ls(O.gold,O.mustard,O.ketchup,d1),boxPineapple:ls(O.grape,O.grapeHi,O.mustard,h1),boxRed:ls(O.ketchup,"#E9536A",O.mustard,c1),boxFire:ls(O.grapeDark,O.grape,O.flame,l1),gift:`
...
<path d="M12 6.2c-2.6-3.4-6.2-2.4-5 .2M12 6.2c2.6-3.4 6.2-2.4 5 .2" fill="${O.mustard}" stroke-width="1.4"/>`,gear:`${p1}
...
<path d="M12 9.6v5.6M9.2 12.4h5.6" stroke="${O.cream}" stroke-width="2.1"/>`,stun:`<path d="${Oo(5,8.6,3.7,10.2,10.6)}" fill="${O.mustard}"/>
<path d="${Oo(5,4.2,1.8,19.2,18)}" fill="${O.mustardHi}" stroke-width="1.4"/>`,slow:`
...
<path d="M16.2 8.8 18.6 6.4" stroke-width="1.4"/>`},mt=416,vt=496,Hc=mt/vt,f1=.42,m1=.07,tr=.08,g1=.66,w1=.08,_a={x0:.035,x1:.965,y0:.045,y1:.725},b1=.7,ar=.18,or=.92,y1=1.15,eo=new Map,nr=new Map,gl=[];let sr=!1;function x1(t){const a=document.createElement("canvas");a.width=8,a.height=8;const o=a.getContext("2d",{willReadFrequently:!0});if(!o)return[0,0,0];o.drawImage(t,0,0,8,8);const n=o.getImageData(0,0,8,8).data;let s=0,i=0,r=0;for(let h=0;h<n.length;h+=4)s+=n[h],i+=n[h+1],r+=n[h+2];const l=n.length/4;return[Math.round(s/l),Math.round(i/l),Math.round(r/l)]}function oh(t){return eo.get(t)}function wl(){const t=[...Ee];if(typeof document>"u"||typeof window<"u"&&window.__screen==="characters")return t;const e=new Set;for(const a of document.querySelectorAll("[data-portrait]")){const o=a.dataset.portrait;Ee.includes(o)&&e.add(o)}return!e.size&&(typeof window>"u"||!window.__screen)?t:[...e]}function Z0(t){for(const a of Ee){const o=eo.get(a);o&&t(a,o)}if(Ee.every(a=>eo.has(a))){window.__thumbsReady=!0;return}if(gl.push(t),sr)return;sr=!0,window.__thumbsReady=!1;const e=()=>void v1().finally(()=>{sr=!1,gl.length=0,window.__thumbsReady=wl().every(a=>eo.has(a))});typeof requestIdleCallback=="function"?requestIdleCallback(e,{timeout:600}):setTimeout(e,120)}async function v1(){if(!wl().some(a=>!eo.has(a)))return;const t=document.createElement("div");t.style.cssText=`position:fixed;left:-9999px;top:0;width:${mt}px;height:${vt}px;pointer-events:none;`,document.body.appendChild(t);let e=null;try{e=new _l({container:t,background:0,fog:null,camera:{pitchDeg:12,yawDeg:24,frameMode:"subject",subjectHeight:2.1,subjectFill:1,targetHeight:1.05,followLerp:1},shadows:!1,postFx:"grade",offscreen:!0,maxPixelRatio:1}),e.canvas.style.cssText=`display:block;width:${mt}px;height:${vt}px;`,e.resize();const a=new Set;for(;;){const o=wl().filter(n=>!eo.has(n)&&!a.has(n));if(!o.length)break;for(const n of o)a.add(n),await M1(e,n)}}catch{}finally{e?.dispose(),t.remove()}}function fn(t,e,a,o){const n=new de,s=t.getCenter(n.clone()).applyMatrix4(e.matrixWorldInverse).z;let i=1/0,r=1/0,l=-1/0,h=-1/0;for(let c=0;c<8;c++){n.set(c&1?t.max.x:t.min.x,c&2?t.max.y:t.min.y,c&4?t.max.z:t.min.z).applyMatrix4(e.matrixWorldInverse),n.z=s,n.applyMatrix4(e.projectionMatrix);const d=(n.x*.5+.5)*a,p=(1-(n.y*.5+.5))*o;i=Math.min(i,d),l=Math.max(l,d),r=Math.min(r,p),h=Math.max(h,p)}return{x:+i.toFixed(1),y:+r.toFixed(1),w:+(l-i).toFixed(1),h:+(h-r).toFixed(1)}}function zc(t,e){const a=t.getObjectByName(e);if(!a)return null;const o=new In().setFromObject(a);return o.isEmpty()?null:o}function k1(t,e,a){const o=new de;let n=0;return t.traverse(s=>{const i=s;if(!i.isMesh||!i.visible)return;const r=i.geometry?.getAttribute("position");if(r)for(let l=0;l<r.count;l++){if(o.fromBufferAttribute(r,l).applyMatrix4(i.matrixWorld),o.y<e)continue;const h=Math.abs(o.dot(a));h>n&&(n=h)}}),n}async function M1(t,e){const a=Pl(e);t.scene.add(a.root),a.play("idle"),a.update({dt:.4,elapsed:.4,moveSpeed01:0,health01:1});const o=new In().setFromObject(a.root),n=zc(a.root,"head"),s=zc(a.root,"face"),i=Math.max(.5,o.max.y-o.min.y),r=o.max.y,l=(s??n)?.min.y??o.min.y+.45*i,h=Math.max(o.min.y,Math.min(o.min.y+f1*i,l-m1*i)),c=Math.max(.4,r-h),d=t.rig.camera,p=new de,u=(S,E,A)=>{t.rig.subjectFill=1,t.rig.subjectHeight=S,t.rig.targetHeight=E-S/2,t.rig.snapTo(A*p.x,A*p.z),d.updateMatrixWorld(!0),d.matrixWorldInverse.copy(d.matrixWorld).invert()};u(c/or,r+tr*(c/or),0),p.setFromMatrixColumn(d.matrixWorld,0).normalize();const f=k1(a.root,h,p),m=Math.max(c/or,2*f/(Hc*y1),s?(r-s.min.y)/(g1+w1):0);let g=r+tr*m,w=0,b=m;if(s){const S=()=>r-ar*b;for(let E=0;E<4;E++){g=r+tr*b;for(let D=0;D<3;D++){u(b,g,w);const W=fn(s,d,mt,vt),F=(W.y+W.h)/vt-b1;if(F<=0)break;const z=Math.max(0,(W.y/vt-_a.y0)*b),P=Math.max(S(),g-Math.min(F*b,z));if(Math.abs(P-g)<1e-4)break;g=P}u(b,g,w);const A=fn(s,d,mt,vt),C=A.x+A.w-_a.x1*mt,R=_a.x0*mt-A.x,I=b*Hc/mt;C>0&&R<0?w+=Math.min(C,-R)*I:R>0&&C<0&&(w-=Math.min(R,-C)*I);const N=A.w/((_a.x1-_a.x0)*mt),L=(A.y+A.h)/vt,_=L>_a.y1?(L+ar)/(_a.y1+ar):1,U=Math.max(N,_);if(U<=1.001)break;b*=U}}u(b,g,w);const y=$l[re[e].rarity];t.scene.background=new Xt(y),t.lighting.focus(0,0,4),nr.has(y)||(a.root.visible=!1,t.render(0),nr.set(y,x1(t.canvas)),a.root.visible=!0),t.render(0),t.render(0);const v=t.canvas.toDataURL("image/png"),k=a.root.getObjectByName("hips"),M=a.root.getObjectByName("shoulderL"),x=new de;(window.__thumbMeta??={})[e]={size:{w:mt,h:vt},subject:fn(o,d,mt,vt),head:n?fn(n,d,mt,vt):null,face:s?fn(s,d,mt,vt):null,bg:nr.get(y)??null,world:{minY:+o.min.y.toFixed(4),maxY:+o.max.y.toFixed(4),halfWidth:+Math.max(Math.abs(o.min.x),Math.abs(o.max.x)).toFixed(4),hipsY:k?+k.getWorldPosition(x).y.toFixed(4):null,shoulderY:M?+M.getWorldPosition(x).y.toFixed(4):null,headY:n?[+n.min.y.toFixed(4),+n.max.y.toFixed(4)]:null,faceY:s?[+s.min.y.toFixed(4),+s.max.y.toFixed(4)]:null,yCut:+h.toFixed(4),upperHalfWidth:+f.toFixed(4)},frame:{subjectHeight:+t.rig.subjectHeight.toFixed(4),subjectFill:+t.rig.subjectFill.toFixed(4),targetHeight:+t.rig.targetHeight.toFixed(4),headroom:+((g-r)/b).toFixed(4),pan:+w.toFixed(4)}},t.scene.remove(a.root),a.dispose(),eo.set(e,v);for(const S of gl)S(e,v);await new Promise(S=>setTimeout(S,0))}const E1='<circle cx="12" cy="9" r="5.6" fill="#FFF3DE"/><path d="M5.2 21.6c0-3.5 3-5.6 6.8-5.6s6.8 2.1 6.8 5.6z" fill="#FFF3DE"/>';function Ta(t,e={}){const a=$l[re[t].rarity],o=oh(t),n=["fa-ic-portrait",e.crop==="head"?"fa-ic-portrait--head":"",o?"has-render":"",e.class??""].filter(Boolean).join(" "),s=o?` src="${o}"`:"";return`<span class="${n}" data-portrait="${t}" style="--pc:${a}"><img alt=""${s}/><svg class="fa-ic" viewBox="0 0 24 24" fill="none" style="stroke:var(--fa-ic-ink,#1a1224)" stroke-width="1.7" stroke-linejoin="round" stroke-linecap="round" aria-hidden="true" focusable="false">${E1}</svg></span>`}function Bo(t,e={}){const a=(o,n)=>{for(const s of t.querySelectorAll(`[data-portrait="${o}"]`)){const i=s.querySelector("img");i&&(i.getAttribute("src")!==n&&i.setAttribute("src",n),s.classList.add("has-render"))}};if(e.generate===!1){for(const o of t.querySelectorAll("[data-portrait]")){const n=o.dataset.portrait,s=oh(n);s&&a(n,s)}return}Z0(a)}const T1={...u1,...r1},S1='viewBox="0 0 24 24" fill="none" style="stroke:var(--fa-ic-ink,#1a1224)" stroke-width="1.7" stroke-linejoin="round" stroke-linecap="round"';function H(t,e={}){const a=T1[t];if(!a)return"";const o=["fa-ic",`fa-ic--${t}`,e.class??""].filter(Boolean).join(" "),n=e.size??"1em",s=e.label?`role="img" aria-label="${e.label}"`:'aria-hidden="true" focusable="false"';return`<svg class="${o}" ${S1} width="${n}" height="${n}" ${s}>${a}</svg>`}const A1={"🪙":"coin","💎":"gem","🏆":"trophy","⭐":"star","✨":"sparkle","🏁":"flag","📍":"pin","🎉":"party","🎁":"gift","🧑‍🍳":"chefhat","⚙️":"gear","⚙":"gear","🔒":"lock","▶":"play","⏸":"pause","◀":"back","🙂":"avatar","🚧":"cone","🔇":"mute","🔊":"sound","🏠":"home","🍟":"swap","❤️":"health","❤":"health","💨":"speed","↔":"range","⏱":"timer","💚":"heal","💫":"stun","🐌":"slow","🍖":"patty","🍅":"tomato","🥬":"lettuce","🧅":"onion","🍬":"candy","🥩":"meat","🌯":"wrap","🌀":"swirl","🥚":"egg","🐣":"chick","💥":"burst","🔨":"hammer","🍭":"lollipop","⚪":"dough","🧀":"cheese","🍚":"rice","🌿":"seaweed","🐟":"fish","🐡":"puffer","💦":"droplets","🍜":"noodle","🌊":"wave","🧊":"shards","🔵":"cap","💛":"mustardblast","🔴":"ketchupslip","⚔️":"slash","⚔":"damage","🍯":"honey","💧":"droplets"},R1={chest:"chest",hamburgerBox:"boxBurger",pineappleBox:"boxPineapple",redBox:"boxRed",fireBox:"boxFire"};function xa(t,e={}){const a=A1[t];return a?H(a,e):t}function It(t,e={}){return H(R1[t]??"chest",e)}function J0(t,e={}){return xa(t,e)}const _c="fa-icon-styles";function ca(){if(document.getElementById(_c))return;const t=document.createElement("style");t.id=_c,t.textContent=I1,document.head.appendChild(t)}const I1=`
...
`,Pc=[Wt.tomato,Wt.mustard,Wt.lettuce,Wt.cheese,Wt.glaze,Wt.waterCap];function Ws(t,e=50,a=26){for(let o=0;o<a;o++){const n=document.createElement("span");n.className="fa-confetti",n.style.left=`${e+(Math.random()*12-6)}%`,n.style.background=Pc[Math.floor(Math.random()*Pc.length)],n.style.animationDelay=`${(Math.random()*.22).toFixed(2)}s`,n.style.setProperty("--x",`${Math.round(Math.random()*240-120)}px`),t.appendChild(n),setTimeout(()=>n.remove(),1800)}}function Fe(t,e,a){const o=document.createElement(t);return e&&(o.className=e),o}const C1="Kitchen Rumble";function O1(t){const e=Math.round(t/1e3);return`${Math.floor(e/60)}:${String(e%60).padStart(2,"0")}`}function F1(t){ha("fa-home-styles",N1),ca();const e=Fe("div","fa-screen fa-home"),a=Ql();a.setScene("lobby"),e.innerHTML=`
    ...
    <header class="fa-topbar">
      <div class="fa-chip ds-chip ds-chip--slate"><span class="fa-chip-em">${H("avatar")}</span><span data-el="name"></span></div>
      <div class="fa-chip ds-chip ds-chip--slate"><span class="fa-chip-em">${H("trophy")}</span><span class="fa-chip-val ds-chip-val ds-num" data-el="trophies">0</span></div>
      <div class="fa-chip ds-chip ds-chip--slate home-chip-coin"><span class="fa-chip-em">${H("coin")}</span><span class="fa-chip-val ds-chip-val ds-num" data-el="coins">0</span></div>
      ...
      <nav class="fa-tabs">
        <button class="fa-tab is-active" type="button">${H("home")} Home</button>
        <button class="fa-tab" type="button" data-go="characters">${H("chefhat")} Foods</button>
        <button class="fa-tab" type="button" data-go="trophies">${H("trophy")} Trophies</button>
        ...
        <button class="fa-tab" type="button" data-go="shop">${H("coin")} Shop</button>
      </nav>
      <button class="fa-iconbtn" type="button" data-el="settings" aria-label="Settings">${H("gear")}</button>
    </header>
      ...
      <aside class="fa-panel home-col home-progress">
        ...
        <button class="home-track home-track--road" type="button" data-go="trophies" data-el="road">
          <span class="home-track-top">
            <span class="home-track-icon" data-el="roadicon">${H("chest")}</span>
            <span class="home-track-title" data-el="roadtitle">Next reward</span>
            <span class="home-track-pill" data-el="roadpill">${H("trophy")}</span>
          </span>
        ...
        <button class="home-track" type="button" data-go="trophies" data-el="chest">
          <span class="home-track-top">
            <span class="home-track-icon">${H("gift")}</span>
        ...
        <button class="home-track home-track--held" type="button" data-go="trophies" data-el="held" hidden>
          <span class="home-track-top">
            <span class="home-track-icon">${H("chest")}</span>
        ...
        <div class="home-record">
          <div class="home-rec"><span class="home-rec-ic">${H("medal")}</span><span class="home-rec-val is-win" data-el="wins">0</span><span class="home-rec-key">Wins</span></div>
          <div class="home-rec"><span class="home-rec-ic">${H("close")}</span><span class="home-rec-val is-loss" data-el="losses">0</span><span class="home-rec-key">Losses</span></div>
          <div class="home-rec"><span class="home-rec-ic">${H("trophy")}</span><span class="home-rec-val is-best" data-el="best">0</span><span class="home-rec-key">Best</span></div>
        </div>
      </aside>
    ...
    <footer class="home-bottom">
      ...
      <button class="home-mode" type="button" data-el="mode"
        ...
        <span class="home-mode-lines">
          <span class="home-mode-name">${C1}</span>
          <span class="home-mode-sub" data-el="modesub">${O1(Ra)} · last one standing</span>
        </span>
        <span class="home-mode-go" aria-hidden="true">${H("party")}</span>
      </button>
      <button class="fa-btn fa-btn--primary" type="button" data-el="start">${H("play")} Start Game</button>
    </footer>

    <div class="fa-confetti-layer" data-el="confetti"></div>
  `;const o=E=>{const A=e.querySelector(`[data-el="${E}"]`);if(!A)throw new Error(`home: missing element "${E}"`);return A},n=o("stage3d"),s=o("confetti"),i=o("heroname"),r=o("herorarity"),l=o("hint");let h=0;function c(){const E=t.profile.claimable.length,A=o("road"),C=o("roadfill");if(E>0){A.classList.add("is-ready"),o("roadicon").innerHTML=H("sparkle"),o("roadtitle").textContent=E>1?`${E} rewards ready`:"Reward ready",o("roadsub").textContent="Tap to claim",o("roadpill").textContent="Claim",C.style.width="100%";return}A.classList.remove("is-ready");const{progress01:R,next:I}=O0(t.profile.trophies);if(C.style.width=`${(R*100).toFixed(1)}%`,!I){o("roadicon").innerHTML=H("flag"),o("roadtitle").textContent="Road complete",o("roadsub").textContent="Every reward claimed",o("roadpill").innerHTML=`${H("trophy")} ${t.profile.trophies.toLocaleString()}`;return}const N=pl(I.reward,t.profile.unlocked);o("roadicon").innerHTML=I.reward.type==="character"?Ta(I.reward.id,{crop:"head"}):I.reward.type==="container"?It(I.reward.kind):xa(N.emoji),Bo(e),o("roadtitle").textContent=N.title,o("roadsub").textContent=`${(I.trophies-t.profile.trophies).toLocaleString()} trophies to go`,o("roadpill").innerHTML=`${H("trophy")} ${I.trophies.toLocaleString()}`}function d(){const E=t.profile.winsToNextChest,A=pt.winsPerChest,C=Math.max(0,Math.min(A,A-E));o("chestsub").textContent=E===0?"Ready on your next win":`${E} more ${E===1?"win":"wins"}`,o("pips").innerHTML=Array.from({length:A},(R,I)=>`<span class="home-pip${I<C?" is-on":""}"></span>`).join("")}function p(){const E=t.profile.containerCount,A=o("held");A.hidden=E===0,E>0&&(o("heldtitle").textContent=E===1?"1 chest held":`${E} chests held`)}const u=[["damage","Damage","damage","#FF8A96"],["health","Health","health","#8FE04A"],["speed","Speed","speed","#6FC8F5"]];function f(){const E=re[t.profile.selected];o("stats").innerHTML=u.map(([A,C,R,I])=>`
      <div class="fa-stat ds-row ds-row--slate home-stat" style="--ds-row-accent:${I}">
        <span class="ds-tile ds-tile--stat" style="--ds-tile-fill:${I}">${H(A)}</span>
        <span class="ds-row-body">
          <span class="ds-row-label">${C}</span>
          <span class="ds-row-val ds-num">${E.stats[R]}</span>
        </span>
      </div>`).join(""),m()}function m(){const E=re[t.profile.selected];h>=E.abilities.length&&(h=0),o("kit").innerHTML=E.abilities.map((R,I)=>`
      <button class="home-kit-tile${I===h?" is-on":""}" type="button" data-kit="${I}">
        <span class="home-kit-em">${xa(R.emoji)}</span>
        <span class="home-kit-name">${R.name}</span>
      </button>`).join("");const A=o("kitcap"),C=E.abilities[h];A.innerHTML=C?`<span class="home-kit-capname">${C.name}</span><span>${C.desc}</span>`:"",g()}function g(){const E=o("kit"),A=E.children[h];if(!A)return;const C=E.getBoundingClientRect(),R=A.getBoundingClientRect();if(C.width<=0||R.width<=0)return;const I=R.left+R.width/2,N=getComputedStyle(E).direction==="rtl"?(C.right-I)/C.width:(I-C.left)/C.width;o("kitcap").style.setProperty("--home-cap-x",`${(N*100).toFixed(1)}%`)}function w(){const E=e.getBoundingClientRect();if(E.height<=0)return;const A=e.querySelector(".fa-topbar");if(A){const R=A.getBoundingClientRect();R.height>0&&e.style.setProperty("--home-topbar-b",`${Math.round(R.bottom-E.top)}px`)}const C=e.querySelector(".home-bottom");if(C){const R=C.getBoundingClientRect();R.height>0&&e.style.setProperty("--home-bottom-h",`${Math.round(E.bottom-R.top)}px`)}}function b(){const E=re[t.profile.selected];o("name").textContent=t.profile.name,o("trophies").textContent=t.profile.trophies.toLocaleString(),o("coins").textContent=t.profile.coins.toLocaleString(),c(),d(),p(),f(),o("wins").textContent=t.profile.wins.toLocaleString(),o("losses").textContent=t.profile.losses.toLocaleString(),o("best").textContent=t.profile.bestTrophies.toLocaleString(),o("lv").textContent=`Lv ${t.profile.level}`,o("lvnext").textContent=`Lv ${t.profile.level+1}`,o("lvfill").style.width=`${(t.profile.levelProgress01*100).toFixed(1)}%`,o("lvxp").textContent=`${t.profile.xp%En} / ${En} XP`,i.textContent=E.name,r.textContent=E.rarity,r.style.background=Lt[E.rarity],a.show(E.id)}const y=E=>{const A=E.target,C=A.closest("[data-kit]");if(C){const N=Number(C.dataset.kit);Number.isInteger(N)&&(h=N,m());return}const R=A.closest("[data-go]");if(!R)return;const I=R.dataset.go;I==="characters"?t.navigate({name:"characters"}):I==="trophies"?t.navigate({name:"trophies"}):I==="shop"&&t.navigate({name:"shop"})};e.addEventListener("click",y),o("start").addEventListener("click",()=>{t.navigate({name:"characters"})}),o("mode").addEventListener("click",()=>{t.navigate({name:"lobby"})}),o("settings").addEventListener("click",()=>{t.navigate({name:"settings"})}),o("stage").addEventListener("click",()=>{a.poke(),Ws(s,50,18)}),setTimeout(()=>l.classList.add("is-faded"),4200);const v=t.profile.onChange(b);b(),a.attachTo(n);const k=requestAnimationFrame(()=>{g(),w()}),M=new ResizeObserver(()=>w()),x=e.querySelector(".fa-topbar"),S=e.querySelector(".home-bottom");return x&&M.observe(x),S&&M.observe(S),{root:e,update(E){a.update(E)},resize(){a.resize(),g(),w()},dispose(){v(),M.disconnect(),cancelAnimationFrame(k),e.removeEventListener("click",y),a.setScene("portrait"),a.detach(),e.remove()}}}const N1=`
/* ═══════════════════════════════════════════════════════════════════════════
...
`,L1=4500,D1=["No","One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen","Twenty"];function H1(t){return D1[t]??String(t)}function z1(){const t=new URLSearchParams(location.search).get("hold"),e=t===null?NaN:Number(t);return Number.isFinite(e)&&e>=0?e:L1}function _1(t){ha("fa-opening-styles",P1),ca();const e=Fe("div","fa-screen fa-opening"),a=Ql();e.innerHTML=`
    <header class="open-head">
      <h1 class="open-title">Food Fight Arena</h1>
      <p class="open-tagline">${H1(Ee.length)} fighters. One kitchen. No table manners.</p>
    </header>
...
`,$1=.15,B1=44,q1=78,U1=5,G1=10,$c=.5,Bc="touch-styles";function j1(){return typeof window>"u"?!1:typeof navigator<"u"&&(navigator.maxTouchPoints??0)>0?!0:"ontouchstart"in window}function W1(){return typeof window.matchMedia!="function"?!1:window.matchMedia("(pointer: coarse)").matches}function Y1(){const t=Math.min(window.innerWidth,window.innerHeight);return Math.max(B1,Math.min(q1,t*$1))}function V1(t,e,a){const o=Math.max(Math.abs(t),Math.abs(e)),n=o>1e-6?Math.min(1,Math.hypot(t,e))/o:0;return a.x=Math.max(-1,Math.min(1,t*n)),a.y=Math.max(-1,Math.min(1,e*n)),a}function qc(){return{id:null,baseX:0,baseY:0,curX:0,curY:0}}function K1(t){const e=j1(),a=qc(),o=qc(),n={x:0,y:0},s={x:0,y:-1};let i=!1,r=!1,l=!1,h=0,c="",d="";if(!e)return{available:!1,get engaged(){return!1},move:n,get moving(){return!1},aimDir:()=>null,get firing(){return!1},clearAim(){},reset(){},dispose(){}};X1();const p=document.createElement("div");p.className="tch-root",p.innerHTML='<div class="tch-stick tch-stick--move" data-el="move-stick"><div class="tch-knob"></div></div><div class="tch-stick tch-stick--aim" data-el="aim-stick"><div class="tch-knob"></div></div><div class="tch-hint tch-hint--move" data-el="move-hint"><div class="tch-hint-ring"></div><div class="tch-hint-label">MOVE</div></div><div class="tch-hint tch-hint--aim" data-el="aim-hint"><div class="tch-hint-ring"></div><div class="tch-hint-label">AIM &amp; FIRE</div></div>',document.body.appendChild(p);const u=P=>p.querySelector('[data-el="'+P+'"]'),f=u("move-stick"),m=u("aim-stick"),g=u("move-hint"),w=u("aim-hint");W1()&&(p.classList.add("is-hinted"),document.documentElement.classList.add("fa-touch-capable"));const y=t.canvas.parentElement,v=t.canvas.style.touchAction,k=y?y.style.touchAction:"";t.canvas.style.touchAction="none",y&&(y.style.touchAction="none");function M(P){if(!(P instanceof Node))return!1;const K=t.canvas;return P===K||K.contains(P)||P.contains(K)}function x(){return Y1()}function S(P,K){const ce=x();let ie=P.curX-P.baseX,$=P.curY-P.baseY;const ee=Math.hypot(ie,$);if(ee>ce){const Se=ce/ee;P.baseX=P.curX-ie*Se,P.baseY=P.curY-$*Se,ie*=Se,$*=Se}const ye=Math.hypot(ie,$);return K.x=ie,K.y=$,ye}const E={x:0,y:0},A=[];function C(P){const K=A.indexOf(P);K>=0&&A.splice(K,1)}function R(P,K){for(let ce=0;ce<P.length;ce++)if(P[ce].identifier===K)return P[ce];return null}function I(P,K,ce){for(let ie=A.length-1;ie>=0;ie--){const $=R(ce,A[ie]);if(!$){A.splice(ie,1);continue}if($.clientX<window.innerWidth*$c===K){A.splice(ie,1),P.id=$.identifier,P.baseX=$.clientX,P.baseY=$.clientY,P.curX=$.clientX,P.curY=$.clientY;return}}}function N(){if(a.id===null){n.x=0,n.y=0;return}if(S(a,E)<U1){n.x=0,n.y=0;return}const K=x();V1(E.x/K,E.y/K,n)}function L(){if(o.id===null)return;const P=S(o,E);P<G1||(s.x=E.x/P,s.y=E.y/P,i=!0)}function _(P,K,ce){if(K.id===null)return ce!==""&&(P.style.display="none"),"";const ie=K.curX-K.baseX,$=K.curY-K.baseY,ee=x(),ye=Math.hypot(ie,$),Se=ye>ee?ee/ye:1,Ve=Math.round(K.baseX),bo=Math.round(K.baseY),Zn=Math.round(K.baseX+ie*Se),Jn=Math.round(K.baseY+$*Se),en=Ve+","+bo+","+Zn+","+Jn+","+Math.round(ee);if(en===ce)return en;ce===""&&(P.style.display="block"),P.style.setProperty("--r",ee.toFixed(0)+"px"),P.style.transform="translate("+Ve+"px,"+bo+"px) translate(-50%,-50%)";const Qn=P.firstElementChild;return Qn&&(Qn.style.transform="translate("+(Zn-Ve)+"px,"+(Jn-bo)+"px) translate(-50%,-50%)"),en}function U(){if(c=_(f,a,c),d=_(m,o,d),a.id===null&&o.id===null){h=0;return}h=requestAnimationFrame(U)}function D(){!h&&!l&&(h=requestAnimationFrame(U))}const W=P=>{if(l)return;let K=!1;for(let ce=0;ce<P.changedTouches.length;ce++){const ie=P.changedTouches[ce];if(!M(ie.target))continue;const $=ie.clientX<window.innerWidth*$c,ee=$?a:o;if(ee.id!==null){A.includes(ie.identifier)||A.push(ie.identifier),K=!0;continue}ee.id=ie.identifier,ee.baseX=ie.clientX,ee.baseY=ie.clientY,ee.curX=ie.clientX,ee.curY=ie.clientY,K=!0,$?g.classList.add("is-used"):w.classList.add("is-used")}K&&(r||(r=!0,document.documentElement.classList.add("fa-touch")),N(),L(),D(),P.preventDefault())},F=P=>{if(l)return;let K=!1;for(let ce=0;ce<P.changedTouches.length;ce++){const ie=P.changedTouches[ce];ie.identifier===a.id?(a.curX=ie.clientX,a.curY=ie.clientY,K=!0):ie.identifier===o.id?(o.curX=ie.clientX,o.curY=ie.clientY,K=!0):A.includes(ie.identifier)&&(K=!0)}K&&(N(),L(),D(),P.preventDefault())},z=P=>{if(l)return;let K=!1;for(let ce=0;ce<P.changedTouches.length;ce++){const ie=P.changedTouches[ce];ie.identifier===a.id?(a.id=null,I(a,!0,P.touches),K=!0):ie.identifier===o.id?(o.id=null,I(o,!1,P.touches),K=!0):A.includes(ie.identifier)&&(C(ie.identifier),K=!0)}K&&(N(),L(),D())};return window.addEventListener("touchstart",W,{passive:!1}),window.addEventListener("touchmove",F,{passive:!1}),window.addEventListener("touchend",z),window.addEventListener("touchcancel",z),{available:!0,get engaged(){return r},move:n,get moving(){return a.id!==null},aimDir:()=>i?s:null,get firing(){return o.id!==null},clearAim(){o.id===null&&(i=!1)},reset(){a.id=null,o.id=null,A.length=0,n.x=0,n.y=0,i=!1,D()},dispose(){l||(l=!0,cancelAnimationFrame(h),window.removeEventListener("touchstart",W),window.removeEventListener("touchmove",F),window.removeEventListener("touchend",z),window.removeEventListener("touchcancel",z),A.length=0,t.canvas.style.touchAction=v,y&&(y.style.touchAction=k),document.documentElement.classList.remove("fa-touch","fa-touch-capable"),p.remove())}}}function X1(){if(document.getElementById(Bc))return;const t=document.createElement("style");t.id=Bc,t.textContent=Z1,document.head.appendChild(t)}const Z1=`
.tch-root {
  position: fixed;
  inset: 0;
  z-index: 25;
...
`,Vt={left:["KeyA","ArrowLeft"],right:["KeyD","ArrowRight"],up:["KeyW","ArrowUp"],down:["KeyS","ArrowDown"]},nh="KeyM",sh=9,J1=.155,Q1=84,eb=190;function tb(t){const e=new URLSearchParams(location.search).get(t);if(e===null)return null;const a=Number(e);return Number.isFinite(a)?a:null}class ab{constructor(e){this.canvas=e;const a=tb("aimSens");this.sensitivity=a!==null&&a>0?Math.min(6,a):1,this.freeAim=new URLSearchParams(location.search).get("aimMode")==="free",this.touch=K1({canvas:e}),window.addEventListener("keydown",this.onKeyDown),window.addEventListener("keyup",this.onKeyUp),window.addEventListener("blur",this.onBlur),document.addEventListener("visibilitychange",this.onVisibilityChange),e.addEventListener("mousemove",this.onMouseMove),e.addEventListener("mousedown",this.onMouseDown),window.addEventListener("mouseup",this.onMouseUp),e.addEventListener("contextmenu",this.onContextMenu)}keys=new Set;mouseDown=!1;ndcX=0;ndcY=0;hasMouse=!1;weaponIndex=0;weaponCount=1;locked=!1;offX=0;offY=0;clientX=0;clientY=0;sensitivity;freeAim;touch;touchOffset={x:0,y:0};setWeaponCount(e){this.weaponCount=Math.max(1,e),this.weaponIndex>=this.weaponCount&&(this.weaponIndex=0)}get selectedWeapon(){return this.weaponIndex}selectWeapon(e){!Number.isInteger(e)||e<0||e>=this.weaponCount||(this.weaponIndex=e)}get touchEngaged(){return this.touch.engaged}get attackHeld(){return this.mouseDown||this.touch.firing}get mouseNdc(){return this.hasMouse&&!this.locked?{x:this.ndcX,y:this.ndcY}:null}get pointerLocked(){return this.locked}get aimOffsetPx(){const e=this.touch.aimDir();if(e){const a=this.aimRadiusPx();return this.touchOffset.x=e.x*a,this.touchOffset.y=e.y*a,this.touchOffset}return this.locked?{x:this.offX,y:this.offY}:null}setPointerLocked(e){e!==this.locked&&(this.locked=e,e&&(this.hasMouse?(this.offX=this.clientX-window.innerWidth/2,this.offY=this.clientY-window.innerHeight/2):(this.offX=0,this.offY=-this.aimRadiusPx()),this.clampOffset(),this.hasMouse=!0))}moveAxes(){let e=0,a=0;return this.keyDown(Vt.left)&&(e-=1),this.keyDown(Vt.right)&&(e+=1),this.keyDown(Vt.up)&&(a-=1),this.keyDown(Vt.down)&&(a+=1),this.touch.moving&&(e=Math.max(-1,Math.min(1,e+this.touch.move.x)),a=Math.max(-1,Math.min(1,a+this.touch.move.y))),{x:e,y:a}}reset(){this.keys.clear(),this.mouseDown=!1,this.touch.reset(),this.locked&&(this.offX=0,this.offY=-this.aimRadiusPx())}dispose(){this.touch.dispose(),window.removeEventListener("keydown",this.onKeyDown),window.removeEventListener("keyup",this.onKeyUp),window.removeEventListener("blur",this.onBlur),document.removeEventListener("visibilitychange",this.onVisibilityChange),this.canvas.removeEventListener("mousemove",this.onMouseMove),this.canvas.removeEventListener("mousedown",this.onMouseDown),window.removeEventListener("mouseup",this.onMouseUp),this.canvas.removeEventListener("contextmenu",this.onContextMenu)}aimRadiusPx(){const e=Math.min(window.innerWidth,window.innerHeight);return Math.max(Q1,Math.min(eb,e*J1))}clampOffset(){if(this.freeAim){const n=window.innerWidth/2,s=window.innerHeight/2;this.offX=Math.max(-n,Math.min(n,this.offX)),this.offY=Math.max(-s,Math.min(s,this.offY));return}const e=this.aimRadiusPx(),a=Math.hypot(this.offX,this.offY);if(a<=e){a<.001&&(this.offY=-e);return}const o=e/a;this.offX*=o,this.offY*=o}keyDown(e){return e.some(a=>this.keys.has(a))}onKeyDown=e=>{this.keys.add(e.code);const a=Number(e.key);if(Number.isInteger(a)&&a>=1&&a<=sh){const o=a-1;o<this.weaponCount&&(this.weaponIndex=o)}e.code===nh&&!e.repeat&&!e.ctrlKey&&!e.metaKey&&!e.altKey&&ke.toggleMuted()};onKeyUp=e=>{this.keys.delete(e.code)};onMouseMove=e=>{if(this.touch.clearAim(),this.locked){this.offX+=(e.movementX??0)*this.sensitivity,this.offY+=(e.movementY??0)*this.sensitivity,this.clampOffset(),this.hasMouse=!0;return}const a=this.canvas.getBoundingClientRect();this.clientX=e.clientX,this.clientY=e.clientY,this.ndcX=(e.clientX-a.left)/a.width*2-1,this.ndcY=-((e.clientY-a.top)/a.height*2-1),this.hasMouse=!0};onMouseDown=e=>{e.button===0&&(this.mouseDown=!0)};onMouseUp=e=>{e.button===0&&(this.mouseDown=!1)};onBlur=()=>{this.keys.clear(),this.mouseDown=!1,this.touch.reset()};onVisibilityChange=()=>{document.visibilityState==="hidden"&&this.onBlur()};onContextMenu=e=>{e.preventDefault()}}const Uc=16241663,ob=14711797,nb=12872686,Fo=2755399,sb=.34,hs=3.2,ib=6.5;function rb(t){return Y.clamp(t*.3,J,ib)}const lb=.5,je=128,ih=Xf+Zf,hb=[{offset:-14,color:Uc,alpha:0},{offset:-1,color:Uc,alpha:.9},{offset:7,color:ob,alpha:.85},{offset:34,color:5906060,alpha:.3},{offset:150,color:Fo,alpha:.18},{offset:0,absolute:ih,color:Fo,alpha:.18}],cb=[{offset:12,color:Fo,alpha:0},{offset:44,color:Fo,alpha:.6},{offset:140,color:Fo,alpha:.72},{offset:0,absolute:ih,color:Fo,alpha:.72}];function db(){const a=document.createElement("canvas");a.width=64,a.height=256;const o=a.getContext("2d"),n=o.createImageData(64,256);let s=2654435769;const i=()=>(s=s*1664525+1013904223>>>0,s/4294967295),r=new Float32Array(64);for(let h=0;h<64;h++)r[h]=.18+.82*i();for(let h=0;h<256;h++){const c=1-h/255,d=Math.pow(1-c,2.6);for(let p=0;p<64;p++){const u=.85+.15*Math.sin(p*.9+c*5),f=Math.max(0,Math.min(1,d*r[p]*u)),m=(h*64+p)*4,g=Math.pow(1-c,3);n.data[m]=255,n.data[m+1]=Math.round(190+65*g),n.data[m+2]=255,n.data[m+3]=Math.round(f*255)}}o.putImageData(n,0,0);const l=new et(a);return l.wrapS=al,l.wrapT=nl,l.needsUpdate=!0,l}function Gc(t,e,a,o){const n=t.length*je,s=new Float32Array(n*3),i=new Float32Array(n*4),r=[],l=new Float32Array(je),h=new Float32Array(je);for(let m=0;m<je;m++){const g=m/je*Math.PI*2;l[m]=Math.cos(g),h[m]=Math.sin(g)}const c=new Xt;for(let m=0;m<t.length;m++){c.setHex(t[m].color);for(let g=0;g<je;g++){const w=m*je+g;s[w*3+1]=0,i[w*4]=c.r,i[w*4+1]=c.g,i[w*4+2]=c.b,i[w*4+3]=t[m].alpha}}for(let m=0;m<t.length-1;m++)for(let g=0;g<je;g++){const w=(g+1)%je;r.push(m*je+g,(m+1)*je+g,m*je+w),r.push(m*je+w,(m+1)*je+g,(m+1)*je+w)}const d=new Pn,p=new Rn(s,3);p.setUsage(Vf),d.setAttribute("position",p),d.setAttribute("color",new Rn(i,4)),d.setIndex(r),d.boundingSphere=new Kf(new de,Xe(ih)*1.2);const u=new V({vertexColors:!0,transparent:!0,depthWrite:!1,side:me,toneMapped:!1}),f=new T(d,u);return f.name=`${o}__no_outline`,f.userData.noOutline=!0,f.renderOrder=a,f.frustumCulled=!1,f.castShadow=!1,f.receiveShadow=!1,f.position.y=e,{mesh:f,setRadius(m){for(let g=0;g<t.length;g++){const w=t[g],b=w.absolute!==void 0?Math.max(w.absolute,m+200):Math.max(0,m+w.offset),y=Xe(b),v=g*je;for(let k=0;k<je;k++){const M=(v+k)*3;s[M]=l[k]*y,s[M+2]=h[k]*y}}p.needsUpdate=!0},setOpacity(m){u.opacity=m},dispose(){d.dispose(),u.dispose()}}}function pb(t){const e=new ne;e.name="fog_boundary";const a=Ie(t.x,t.y);e.position.set(a.x,0,a.z),e.frustumCulled=!1;const o=Gc(hb,sb,6,"fog_edge"),n=Gc(cb,hs,8,"fog_canopy");e.add(o.mesh);const s=db(),i=new Me(1,1,1,je,1,!0),r=new V({map:s,color:nb,transparent:!0,opacity:.82,depthWrite:!1,side:me,toneMapped:!1}),l=new T(i,r);l.name="fog_curtain__no_outline",l.userData.noOutline=!0,l.renderOrder=7,l.frustumCulled=!1,l.castShadow=!1,l.receiveShadow=!1,e.add(l),e.add(n.mesh);let h=0,c=0;return{root:e,update(d,p,u,f){const m=Math.min(.25,Math.max(0,p-c));if(c=p,h=u&&d>=0?1:Math.max(0,h-m/lb),e.visible=h>.002,!e.visible)return;const w=Math.max(0,d);o.setRadius(w),n.setRadius(w),o.setOpacity(h),n.setOpacity(h);const b=f.camera.position.y,y=Y.clamp(b>hs?(b-hs)/b:0,.05,1);n.mesh.scale.set(y,1,y),n.mesh.position.set((1-y)*(f.camera.position.x-e.position.x),hs,(1-y)*(f.camera.position.z-e.position.z));const v=Xe(w),k=rb(v);l.scale.set(v,k,v),l.position.y=k/2;const M=2*Math.PI*v;s.repeat.x=Math.max(6,Math.round(M/5)),s.offset.x=p*.035%1,r.opacity=(.82+.1*Math.sin(p*2.1))*h},dispose(){o.dispose(),n.dispose(),i.dispose(),r.dispose(),s.dispose(),e.clear()}}}function $n(t,e,a,o,n,s,i,r){return Math.abs(t-n)<(a+i)/2&&Math.abs(e-s)<(o+r)/2}function Ys(t,e,a,o){for(let n=0;n<o.length;n++){const s=o[n];if(Math.abs(t-s.x)<(a+s.w)/2&&Math.abs(e-s.y)<(a+s.h)/2)return!0}return!1}const Q0=[];function eu(t){return t.concealment??Q0}function ub(t,e){if(!e)return!1;const a=e.brokenConcealment;for(let o=0;o<a.length;o++)if(a[o]===t)return!0;return!1}function fb(t,e,a,o){const n=eu(a);for(let s=0;s<n.length;s++){const i=n[s];if($n(t,e,0,0,i.x,i.y,i.w,i.h)&&!ub(i,o))return!0}return!1}function tu(t,e,a,o,n){return o&&n&&o.elapsed<n.revealedUntil?!1:fb(t,e,a,o)}function rh(t,e,a,o,n,s,i){return tu(a,o,n,s,i)?Math.hypot(a-t,o-e)<=Jf:!0}function mb(t,e,a,o){const n=eu(a);let s=null;for(let i=0;i<n.length;i++){const r=n[i];$n(t,e,0,0,r.x,r.y,r.w,r.h)&&(o.includes(r)||(o.push(r),(s??=[]).push(r)))}return s??Q0}function au(t,e,a,o){let n=1;for(const s of a.hazards)s.kind==="slow"&&Math.hypot(t-s.x,e-s.y)<s.radius&&(n=Math.min(n,s.slowFactor??Zh));for(const s of o)Math.hypot(t-s.x,e-s.y)<sl&&(n=Math.min(n,Zh));return n}const gb=g0,wb=1e-6;function bl(t,e,a,o){if(!(o>0))return;const n=Math.hypot(e,a);if(n<wb)return;const s=t.push;s.x=e/n,s.y=a/n,s.remaining=Math.min(gb,s.remaining+o)}function bb(t,e,a,o){const n=t.push;if(n.remaining<=0)return!1;const s=m0*e,i=n.remaining<s?n.remaining:s;n.remaining-=i;const r=Yl(t,o)?!1:Vs(t,n.x*i,n.y*i,a);return n.remaining<=0&&(n.remaining=0,n.x=0,n.y=0),r}const yb=4,jc=.01;function xb(t,e){const a=t.size,o=a/2,n=e.cover;for(let s=0;s<yb;s++){let i=null,r=0;for(let c=0;c<n.length;c++){const d=n[c],p=(a+d.w)/2-Math.abs(t.x-d.x);if(p<=0)continue;const u=(a+d.h)/2-Math.abs(t.y-d.y);if(u<=0)continue;const f=p<u?p:u;f>r&&(r=f,i=d)}if(i===null)return;const l=(a+i.w)/2-Math.abs(t.x-i.x),h=(a+i.h)/2-Math.abs(t.y-i.y);if(l<=h){const c=t.x>=i.x?1:-1;t.x=Math.min(e.width-o,Math.max(o,t.x+c*(l+jc)))}else{const c=t.y>=i.y?1:-1;t.y=Math.min(e.height-o,Math.max(o,t.y+c*(h+jc)))}}}function Vs(t,e,a,o){const n=t.size/2,s=t.x,i=t.y;if((e!==0||a!==0)&&xb(t,o),e!==0){const r=Math.min(o.width-n,Math.max(n,t.x+e));Ys(r,t.y,t.size,o.cover)||(t.x=r)}if(a!==0){const r=Math.min(o.height-n,Math.max(n,t.y+a));Ys(t.x,r,t.size,o.cover)||(t.y=r)}return t.x!==s||t.y!==i}const vb=10,kb=4e4,ou=16,Mb=8,Eb=4,Wc=new WeakMap;function Tb(t,e){const a=Wc.get(t);if(a&&a.size===e&&a.cover===t.cover)return a;let o=vb;for(;Math.ceil(t.width/o)*Math.ceil(t.height/o)>kb;)o*=2;const n=Math.max(1,Math.ceil(t.width/o)),s=Math.max(1,Math.ceil(t.height/o)),i=n*s,r=new Uint8Array(i),l=e/2;for(let c=0;c<s;c++)for(let d=0;d<n;d++){const p=(d+.5)*o,u=(c+.5)*o;p>=l&&p<=t.width-l&&u>=l&&u<=t.height-l&&!Ys(p,u,e,t.cover)&&(r[c*n+d]=1)}const h={cell:o,cols:n,rows:s,size:e,cover:t.cover,passable:r,dist:new Int32Array(i),queue:new Int32Array(i),chain:new Int32Array(ou+1),goalCell:-1,requestedGoal:-1};return Wc.set(t,h),h}function ir(t,e){const{cols:a,rows:o,passable:n,dist:s,queue:i}=t;s.fill(-1),t.goalCell=e,s[e]=0,i[0]=e;let r=0,l=1;for(;r<l;){const h=i[r++],c=h%a,d=(h-c)/a,p=s[h]+1;for(let u=-1;u<=1;u++){const f=d+u;if(f<0||f>=o)continue;const m=f*a;for(let g=-1;g<=1;g++){if(g===0&&u===0)continue;const w=c+g;if(w<0||w>=a)continue;const b=m+w;n[b]===0||s[b]>=0||g!==0&&u!==0&&(n[d*a+w]===0||n[m+c]===0)||(s[b]=p,i[l++]=b)}}}}function Yc(t,e,a,o,n){const{cols:s,rows:i,passable:r,dist:l}=t;if(e>=0&&e<s&&a>=0&&a<i){const h=a*s+e;if(r[h]===1)return h}for(let h=1;h<=o;h++)for(let c=-h;c<=h;c++){const d=a+c;if(d<0||d>=i)continue;const p=Math.abs(c)===h;for(let u=-h;u<=h;u+=p?1:2*h){const f=e+u;if(f<0||f>=s)continue;const m=d*s+f;if(r[m]===1)return m}}return-1}function Vc(t,e,a,o,n,s){const i=a-t,r=o-e,l=Math.max(1,Math.ceil(Math.hypot(i,r)/(n*.4)));for(let h=1;h<=l;h++){const c=h/l;if(Ys(t+i*c,e+r*c,n,s))return!1}return!0}const va={dirX:0,dirY:0,wpX:0,wpY:0};function Sb(t,e,a,o){const n=Tb(t,e.size),{cell:s,cols:i,rows:r,dist:l,chain:h}=n,c=e.size/2,d=Math.min(t.width-c,Math.max(c,a)),p=Math.min(t.height-c,Math.max(c,o)),u=Yc(n,Math.min(i-1,Math.max(0,Math.floor(d/s))),Math.min(r-1,Math.max(0,Math.floor(p/s))),Mb);if(u<0)return!1;const f=Yc(n,Math.min(i-1,Math.max(0,Math.floor(e.x/s))),Math.min(r-1,Math.max(0,Math.floor(e.y/s))),Eb);if(f<0)return!1;if(n.requestedGoal!==u||l[f]<0){if(ir(n,u),l[f]<0){ir(n,f);let M=f,x=1/0;for(let S=0;S<l.length;S++){if(l[S]<0)continue;const E=S%i,A=(E+.5)*s-d,C=((S-E)/i+.5)*s-p,R=A*A+C*C;R<x&&(x=R,M=S)}ir(n,M)}n.requestedGoal=u}if(l[f]<0)return!1;let m=f,g=0;for(;g<ou&&l[m]>0;){const M=m%i,x=(m-M)/i,S=l[m];let E=-1,A=S,C=1/0;for(let R=-1;R<=1;R++){const I=x+R;if(I<0||I>=r)continue;const N=I*i;for(let L=-1;L<=1;L++){if(L===0&&R===0)continue;const _=M+L;if(_<0||_>=i)continue;const U=N+_,D=l[U];if(D<0||D>=S||L!==0&&R!==0&&(n.passable[x*i+_]===0||n.passable[N+M]===0))continue;const W=(_+.5)*s-d,F=(I+.5)*s-p,z=W*W+F*F;(D<A||D===A&&z<C)&&(A=D,C=z,E=U)}}if(E<0)break;h[g++]=E,m=E}let w,b;if(g===0)w=d,b=p;else{let M=0;for(let A=1;A<g;A++){const C=h[A],R=C%i,I=(C-R)/i;if(!Vc(e.x,e.y,(R+.5)*s,(I+.5)*s,e.size,t.cover))break;M=A}const x=h[M],S=x%i,E=(x-S)/i;w=(S+.5)*s,b=(E+.5)*s,M===g-1&&l[x]===0&&Vc(e.x,e.y,d,p,e.size,t.cover)&&(w=d,b=p)}const y=w-e.x,v=b-e.y,k=Math.hypot(y,v);return k<1e-6?!1:(va.dirX=y/k,va.dirY=v/k,va.wpX=w,va.wpY=b,!0)}function Kc(t,e,a,o,n,s,i){const r=t.x,l=t.y;let h=e,c=a,d=s,p=i;Sb(n,t,s,i)&&(h=va.dirX,c=va.dirY,d=va.wpX,p=va.wpY);const u=(M,x)=>Math.hypot(M-d,x-p),f=u(r,l);Vs(t,h*o,c*o,n);const m=t.x,g=t.y;if(f-u(m,g)>=o*.35)return t.detourSign=0,!0;const w=M=>{t.x=r,t.y=l;const x=-c*M+h*.3,S=h*M+c*.3,E=Math.hypot(x,S)||1;return Vs(t,x/E*o,S/E*o,n),Math.hypot(t.x-r,t.y-l)};if(t.detourSign!==0&&w(t.detourSign)>=o*.35)return!0;const b=w(1),y=t.x,v=t.y,k=w(-1);if(b>=k){if(b>=o*.35)return t.detourSign=1,t.x=y,t.y=v,!0}else if(k>=o*.35)return t.detourSign=-1,!0;return t.detourSign=0,t.x=m,t.y=g,m!==r||g!==l}const Ab=180/Math.PI,Rb=Math.PI/180,Ib=1e-6;function lh(t,e){return re[e.characterId].hasTrail?t.trailMarks.some(a=>a.ownerId===e.id&&Math.hypot(e.x-a.x,e.y-a.y)<Ct.radius):!1}function Ks(t,e){return e==="stun"?t.status.stunnedUntil+Qf:t.status.slowedUntil+em}function yl(t,e,a){const o=t.status,n=e==="stun"?o.stunAppliedAt:o.slowAppliedAt,s=e==="stun"?o.stunStacks:o.slowStacks,i=a-n>=nm;return Math.min(i?0:s+1,w0.length-1)}function Xc(t,e,a,o){return o*w0[yl(t,e,a)]}function Zc(t,e,a){const o=t.cast;o!==null&&(t.cast=null,a.push({type:"cast-cancelled",fighterRole:t.role,fighterId:t.id,weaponKey:re[t.characterId].weapons[o.weaponIndex].key,reason:e}))}function Cb(t,e,a,o){const n=o.knockback??0;n>0&&bl(a,a.x-e.x,a.y-e.y,n);const s=o.lure??0;if(s>0){const i=a.x,r=a.y;for(const l of t.fighters){if(!fi(l,e))continue;const h=i-l.x,c=r-l.y,d=Math.hypot(h,c);bl(l,h,c,s<d?s:d)}}}function to(t,e,a,o,n,s){if(!e.alive)return;const i=n.kind==="weapon"?t.fighters[n.attackerId]:n.kind==="trail"?t.fighters[n.ownerId]:null,r=i?a*i.damageMul:a;if(e.hp=Math.max(0,e.hp-r),e.lastDamagedAt=t.elapsed,o==="slow"){if(t.elapsed>=Ks(e,"slow")){const l=Xc(e,"slow",t.elapsed,am);l>0&&(e.status.slowStacks=yl(e,"slow",t.elapsed),e.status.slowAppliedAt=t.elapsed,e.status.slowedUntil=t.elapsed+l)}}else if(o==="stun"){const l=t.elapsed>=Ks(e,"stun")?Xc(e,"stun",t.elapsed,om):0;l>0&&(e.status.stunStacks=yl(e,"stun",t.elapsed),e.status.stunAppliedAt=t.elapsed,e.status.stunnedUntil=t.elapsed+l,e.cast!==null&&Zc(e,"stun",s))}if(i!=null&&n.kind==="weapon"){const l=re[i.characterId].weapons.find(h=>h.key===n.weaponKey);l!==void 0&&Cb(t,i,e,l)}if(s.push({type:"hit-landed",targetRole:e.role,targetId:e.id,amount:r,effect:o,source:n,x:e.x,y:e.y}),e.hp===0&&(e.alive=!1,s.push({type:"death",fighterRole:e.role,fighterId:e.id}),e.deaths++,e.cast!==null&&Zc(e,"death",s),Ob(t,e,s),t.phase==="playing")){const l=Vm(t);l!==null&&(t.phase="ended",t.winner=l.role,t.winnerId=l.id,s.push({type:"match-ended",winner:l.role,winnerId:l.id}))}}function Ob(t,e,a){const o=Math.atan2(e.facing.y,e.facing.x),n=nt.pickupRadius;for(let s=0;s<nt.count;s++){const i=o+s*2*Math.PI/nt.count;let r=Math.min(t.arena.width-n,Math.max(n,e.x+Math.cos(i)*nt.popDistance)),l=Math.min(t.arena.height-n,Math.max(n,e.y+Math.sin(i)*nt.popDistance));for(const c of t.arena.cover)if($n(r,l,n,n,c.x,c.y,c.w,c.h)){r=e.x,l=e.y;break}const h={id:t.nextId++,sourceId:e.id,x:r,y:l,fromX:e.x,fromY:e.y,armsAt:t.elapsed+nt.popMs,expiresAt:t.elapsed+nt.popMs+nt.durationMs};t.medikits.push(h),a.push({type:"medikit-dropped",id:h.id,sourceRole:e.role,sourceId:e.id,fromX:h.fromX,fromY:h.fromY,x:h.x,y:h.y,popMs:nt.popMs})}}function rr(t,e,a,o,n,s,i,r,l,h,c){const d=Math.atan2(h.y,h.x)+n*Rb,p=Math.cos(d),u=Math.sin(d),f=o.speed??0,m=i??o.color,g=r??o.emoji,w=t.nextId++;t.projectiles.push({id:w,ownerId:e.id,targetId:a.id,ownerRole:e.role,targetRole:a.role,weapon:o,x:l.x,y:l.y,vx:p*f,vy:u*f,traveled:0,tx:a.x,ty:a.y,age:0,damage:s,color:m,emoji:g}),c.push({type:"projectile-spawned",id:w,ownerRole:e.role,ownerId:e.id,weaponKey:o.key,x:l.x,y:l.y,color:m,emoji:g})}function nu(t,e,a,o){if(a.type!=="self"){e.revealedUntil=t.elapsed+tm;for(const n of mb(e.x,e.y,t.arena,t.brokenConcealment))o.push({type:"concealment-broken",ownerRole:e.role,ownerId:e.id,x:n.x,y:n.y,w:n.w,h:n.h,kind:n.kind})}}function su(t,e,a,o){const s=re[e.characterId].weapons[a];if(!s)return!1;o.push({type:"weapon-fired",fighterRole:e.role,fighterId:e.id,weaponKey:s.key}),nu(t,e,s,o);const i=Nb(t,e,s,o),r=s.selfLaunch??0;return r>0&&bl(e,e.facing.x,e.facing.y,r),i}function Fb(t,e,a){if(t.phase!=="playing")return!1;const o=e.cast;return o===null||t.elapsed<o.resolvesAt?!1:(e.cast=null,su(t,e,o.weaponIndex,a))}function xl(t,e,a,o){if(t.phase!=="playing")return!1;const n=re[e.characterId].weapons[a];if(!n)return!1;const s=t.elapsed,i=n.castMs??0;return e.cast!==null&&i>0||s-e.lastUsed[a]<n.cooldown?!1:(e.lastUsed[a]=s,i>0?(e.cast={weaponIndex:a,startedAt:s,resolvesAt:s+i},o.push({type:"cast-started",fighterRole:e.role,fighterId:e.id,weaponKey:n.key,castMs:i}),nu(t,e,n,o),!0):su(t,e,a,o))}function Nb(t,e,a,o){const n=k0(t,e);if(a.type==="self"){const h=(a.healAmount??0)*Bl(e.level),c=Math.min(h,e.maxHp-e.hp);return e.hp=Math.min(e.maxHp,e.hp+h),c>0&&o.push({type:"heal",fighterRole:e.role,fighterId:e.id,amount:c}),!0}if(n===null)return!0;if(a.type==="melee"){const h=a.cone??360,c=a.range??0;for(const d of t.fighters){if(!fi(d,e))continue;const p=d.x-e.x,u=d.y-e.y,f=Math.hypot(p,u);if(!(f>c)){if(h<360){if(f<Ib)continue;const m=(e.facing.x*p+e.facing.y*u)/f;if(Math.acos(Math.max(-1,Math.min(1,m)))*Ab>h/2)continue}to(t,d,a.damage,a.effect,{kind:"weapon",weaponKey:a.key,weaponName:a.name,attackerId:e.id},o)}}return!0}const s={x:e.x,y:e.y},i=e.facing;if(a.comboParts){for(const h of a.comboParts)rr(t,e,n,a,h.angle,h.damage,h.color,h.emoji,s,i,o);return!0}const l=!!a.trailBoosted&&lh(t,e)?Math.round(a.damage*Ct.damageBoost):a.damage;if(a.pellets&&a.pellets>1){const h=a.spreadDeg??0;for(let c=0;c<a.pellets;c++){const d=(c-(a.pellets-1)/2)*h,p=a.pelletColors?a.pelletColors[c%a.pelletColors.length]:void 0,u=a.pelletEmojis?a.pelletEmojis[c%a.pelletEmojis.length]:void 0;rr(t,e,n,a,d,l,p,u,s,i,o)}}else rr(t,e,n,a,0,l,void 0,void 0,s,i,o);return!0}const cs=400,ka=1e-6,Jc=.8,Qc=.6,Ut={x:0,y:0},Ge={dirX:0,dirY:0,navX:0,navY:0},iu=Math.PI/180,Lb=[0];function ru(t){if(t.comboParts)return t.comboParts.map(n=>n.angle);const e=t.pellets??1;if(e<=1)return Lb;const a=t.spreadDeg??0,o=[];for(let n=0;n<e;n++)o.push((n-(e-1)/2)*a);return o}const Db=(()=>{const t=new Map;for(const e of Ee)for(const a of re[e].weapons)t.set(a,ru(a));return t})();function Hb(t,e,a,o,n){const s=e.range??0;if(s<=0)return null;const i=a-t.x,r=o-t.y,l=Math.hypot(i,r),h=l>ka?i/l:1,c=l>ka?r/l:0;switch(e.type){case"self":return null;case"melee":return{margin:l-s,outX:h,outY:c};case"ranged":{const p=s+n,u=l-p;if(e.homing)return{margin:u,outX:h,outY:c};const f=Math.hypot(t.facing.x,t.facing.y);if(f<ka)return{margin:u,outX:h,outY:c};const m=t.facing.x/f,g=t.facing.y/f,w=i*m+r*g,b=-i*g+r*m;let y=-1/0,v=-1/0,k=!1,M=!0;for(const E of Db.get(e)??ru(e)){const A=E*iu,C=Math.cos(A),R=Math.sin(A);if(w*C+b*R<0)continue;if(C<=ka){M=!1;break}k=!0;const N=b*C-w*R,L=(n-N)/C,_=(n+N)/C;L>y&&(y=L),_>v&&(v=_)}if(!M)return{margin:u,outX:h,outY:c};if(!k)return{margin:l-n,outX:h,outY:c};const x=y<=v,S=x?-y:-v;return u>=S?{margin:u,outX:h,outY:c}:{margin:S,outX:x?-g:g,outY:x?m:-m}}}return e.type}function zb(t,e,a,o,n){const s=e.x,i=e.y;Ut.x=0,Ut.y=0;let r=0;for(const u of t.arena.hazards){if(u.kind!=="damage")continue;const f=s-u.x,m=i-u.y,g=Math.hypot(f,m),w=u.radius+nn;if(g>=w)continue;const b=g>ka?f/g:1,y=g>ka?m/g:0,v=-y*a+b*o>=0?1:-1,k=-y*v,M=b*v,x=Math.min(2,(w-g)/nn),S=x*_i;Ut.x+=(b*Jc+k*Qc)*S,Ut.y+=(y*Jc+M*Qc)*S,x>r&&(r=x)}const l=t.arena.center.x,h=t.arena.center.y,c=l-s,d=h-i,p=Math.hypot(c,d);if(p>ka){const u=t.safeRadius-p;if(u<Pi){const f=Math.min(2,(Pi-u)/Pi);Ut.x+=c/p*f*ec,Ut.y+=d/p*f*ec,f>r&&(r=f)}}for(const u of t.fighters){if(u===e||!u.alive)continue;const f=u.cast;if(f===null)continue;const m=re[u.characterId].weapons[f.weaponIndex];if(m===void 0)continue;const g=Hb(u,m,s,i,e.hitRadius);if(g===null)continue;const w=g.margin;if(w>=nn)continue;const b=Math.max(0,f.resolvesAt-t.elapsed);if(w<0&&-w>n*b)continue;const y=Math.min(2,(nn-w)/nn);Ut.x+=g.outX*y*_i,Ut.y+=g.outY*y*_i,y>r&&(r=y)}return r}const ed={melee:!0,ranged:!0,self:!1},_b={melee:!1,ranged:!1,self:!0},Pb=(()=>{const t=new Map,e=a=>{const o=Math.abs(Math.sin(a*iu));return o<1e-9?1/0:b0/o};for(const a of Ee)for(const o of re[a].weapons){let n=0;const s=[];if(o.type!=="self")if(o.comboParts)for(const i of o.comboParts){const r=e(i.angle);r===1/0?n+=i.damage:s.push({maxDist:r,damage:i.damage})}else{const i=o.damage*(o.peckHits??1),r=o.pellets??1;if(o.type==="melee"||r<=1||o.homing)n=i*r;else{const l=o.spreadDeg??0;for(let h=0;h<r;h++){const c=e((h-(r-1)/2)*l);c===1/0?n+=i:s.push({maxDist:c,damage:i})}}}t.set(o,{always:n,offAxis:s})}return t})();function $b(t,e){const a=Pb.get(t);if(!a)return t.damage;let o=a.always;for(const n of a.offAxis)e<n.maxDist&&(o+=n.damage);return o}const td=(t,e,a,o,n)=>$b(a,n),Bb=(t,e,a)=>{const o=a.healAmount??0;return o<=0||e.hp>e.maxHp*hm||e.maxHp-e.hp<o?-1/0:o};function lr(t,e,a,o,n,s){const i=re[e.characterId].weapons,r=t.elapsed;let l=null,h=-1/0;for(let c=0;c<i.length;c++){const d=i[c];if(!o[d.type]||r-e.lastUsed[c]<d.cooldown||a>(d.range??1/0)||(d.castMs??0)>0&&(d.castMs??0)>=s)continue;const p=n(t,e,d,c,a);p>h&&(h=p,l=c)}return l}function qb(t,e,a,o){if(t.phase!=="playing")return!1;const n=k0(t,e);if(e.hp<=0||n===null)return!1;const s=t.elapsed,i=rh(e.x,e.y,n.x,n.y,t.arena,t,n),r=t.sightings[cl(e.id,n.id,t.fighters.length)];i&&(r.x=n.x,r.y=n.y,r.at=s);const l=r.x,h=r.y,c=l-e.x,d=h-e.y,p=Math.hypot(c,d),u=p||1,f=p>1e-6,m=e.hp<e.maxHp*sm,g=(s<e.status.slowedUntil?im:1)*au(e.x,e.y,t.arena,t.splats)*(lh(t,e)?Ct.speedBoost:1),w=Yl(e,s);f&&!x0(e)&&(e.facing={x:c/u,y:d/u});let b=!1;const y=m?-1:1,v=Is(e.characterId,m?Jh:Qh)*g,k=(()=>{if(t.medikits.length===0||e.maxHp-e.hp<nt.heal*Bl(e.level))return null;let L=null,_=1/0;for(const U of t.medikits){const D=Math.hypot(U.x-e.x,U.y-e.y);D>=_||D>(U.expiresAt-s)*v||(L=U,_=D)}return L})(),M=k===null?0:Math.hypot(k.x-e.x,k.y-e.y)||1,x=k===null?y*c/u:(k.x-e.x)/M,S=k===null?y*d/u:(k.y-e.y)/M,E=zb(t,e,x,S,v),A=E>=lm,C=(L,_,U,D)=>{if(Ge.dirX=L,Ge.dirY=_,Ge.navX=U,Ge.navY=D,E<=0)return;const W=L+Ut.x,F=_+Ut.y,z=Math.hypot(W,F);z<ka||(Ge.dirX=W/z,Ge.dirY=F/z,Ge.navX=e.x+Ge.dirX*cs,Ge.navY=e.y+Ge.dirY*cs)},R=A&&!w,I=A?0:Cn(t.timeRemaining)?e.hp*1e3/rm:1/0,N=R?null:lr(t,e,u,_b,Bb,I);if(m){if(!w){const _=Is(e.characterId,Jh)*a*g;k!==null?C(x,S,k.x,k.y):C(-c/u,-d/u,e.x-c/u*cs,e.y-d/u*cs),Kc(e,Ge.dirX,Ge.dirY,_,t.arena,Ge.navX,Ge.navY),b=!0}const L=N??(i?lr(t,e,u,ed,td,I):null);L!==null&&xl(t,e,L,o)}else{const L=R?null:N??(i?lr(t,e,u,ed,td,I):null);if(L!==null)xl(t,e,L,o);else if(!w){const _=Is(e.characterId,Qh)*a*g;k!==null?C(x,S,k.x,k.y):C(c/u,d/u,l,h),Kc(e,Ge.dirX,Ge.dirY,_,t.arena,Ge.navX,Ge.navY),b=!0}}return b}const ad=12;function hr(t,e,a,o){if(Array.isArray(e)){if(a!==void 0||o!==void 0)throw new TypeError("createMatch: the fighter-list form takes no third or fourth argument; put `level` on each FighterConfig instead");return od(t,e)}const n=o??{};return od(t,[{characterId:e,level:n.player},{characterId:a,level:n.enemy}])}function od(t,e){if(e.length<st||e.length>_t)throw new RangeError(`createMatch: ${e.length} fighters; the sim seats ${st}..${_t} (see state.ts MIN_FIGHTERS / MAX_FIGHTERS)`);const a=e.length===st,o=e.map((i,r)=>{const l=Ia(i.level??ho),h=r===0,c=a&&!h,d=i.spawn??Ub(t,r);return Ym({id:r,controller:i.controller??(h?"human":"ai"),characterId:i.characterId,spawn:d,maxHp:i.maxHp??rl(i.characterId,c?um:ll,l),size:i.size??(c?pm:g0),hitRadius:i.hitRadius??(c?dm:b0),facing:i.facing??Gb(t,r,d),level:l})}),n=o.length,s=new Array(n*n);for(let i=0;i<n;i++)for(let r=0;r<n;r++)s[cl(i,r,n)]={x:o[r].x,y:o[r].y,at:0};return{phase:"countdown",elapsed:0,countdownValue:fm,countdownTick:0,startFlashTimer:0,timeRemaining:Ra,safeRadius:t.maxSafeRadius,fighters:o,player:o[0],enemy:o[1],projectiles:[],splats:[],trailMarks:[],medikits:[],winner:null,winnerId:null,arena:t,sightings:s,aiSighting:s[cl(1,0,n)],brokenConcealment:[],nextId:1}}function Ub(t,e){if(e===0)return t.playerSpawn;if(e===1)return t.enemySpawn;const a=t.spawns?.[e];if(a)return{x:a.x,y:a.y};throw new RangeError(`createMatch: slot ${e} has no spawn. ArenaDefinition declares playerSpawn and enemySpawn only, so slots 2 and up must pass \`spawn\` explicitly — arena geometry is src/arena/**'s to own (DECISIONS §48: spawn placement is part of the 180° point-symmetry fairness constraint).`)}function Gb(t,e,a){if(e===0)return{x:1,y:0};if(e===1)return{x:-1,y:0};const o=t.center.x-a.x,n=t.center.y-a.y,s=Math.hypot(o,n);return s>1e-6?{x:o/s,y:n/s}:{x:1,y:0}}const jb=Object.freeze({move:Object.freeze({x:0,y:0}),selectedWeapon:0,attack:!1});function Wb(t,e,a){const o=[];if(t.elapsed+=e,Vb(t,e,o),t.phase==="playing"){t.timeRemaining=Math.max(0,t.timeRemaining-e);const n=Ra-t.timeRemaining;t.safeRadius=Cn(t.timeRemaining)?il:cm(n,t.arena.maxSafeRadius,$s(t.fighters.length))}if(Kb(t),t.phase==="playing"){const n=Array.isArray(a)?a:null;for(const s of t.fighters){let i;if(Fb(t,s,o),!!s.alive){if(s.controller==="human"){const r=n===null?a:n[s.id]??jb;Zb(s,r),r.attack&&xl(t,s,r.selectedWeapon,o),i=Jb(t,s,e,r)}else i=qb(t,s,e,o);bb(s,e,t.arena,t.elapsed),Qb(t,s,e,i,o)}}Cn(t.timeRemaining)&&ey(t,e,o),Xb(t,o)}return ay(t,e,o),t.phase==="playing"&&t.timeRemaining<=0&&Yb(t,o),o}function Yb(t,e){const{arena:a}=t,o=r=>r.maxHp>0?r.hp/r.maxHp:0,n=r=>Math.hypot(r.x-a.center.x,r.y-a.center.y),i=t.fighters.slice().sort((r,l)=>{const h=o(r),c=o(l);if(h!==c)return c-h;const d=n(r),p=n(l);return d!==p?d-p:r.deaths!==l.deaths?r.deaths-l.deaths:r.id-l.id})[0];t.phase="ended",t.winner=i.role,t.winnerId=i.id,e.push({type:"match-ended",winner:i.role,winnerId:i.id})}function Vb(t,e,a){t.phase==="countdown"&&(t.countdownTick+=e,t.countdownTick>=1e3&&(t.countdownTick-=1e3,t.countdownValue-=1,t.countdownValue>0?a.push({type:"countdown-tick",value:t.countdownValue}):(t.startFlashTimer=mm,a.push({type:"countdown-tick",value:0}))),t.countdownValue<=0&&(t.startFlashTimer-=e,t.startFlashTimer<=0&&(t.phase="playing",t.timeRemaining=Ra,t.safeRadius=t.arena.maxSafeRadius,a.push({type:"match-started"}))))}function Kb(t){for(let e=t.splats.length-1;e>=0;e--)t.elapsed>=t.splats[e].expiresAt&&t.splats.splice(e,1);for(let e=t.trailMarks.length-1;e>=0;e--)t.elapsed>=t.trailMarks[e].expiresAt&&t.trailMarks.splice(e,1);for(let e=t.medikits.length-1;e>=0;e--)t.elapsed>=t.medikits[e].expiresAt&&t.medikits.splice(e,1)}function Xb(t,e){for(let a=0;a<t.medikits.length;){const o=t.medikits[a];if(t.elapsed<o.armsAt){a++;continue}let n=null;for(const r of t.fighters)if(!(!r.alive||r.hp>=r.maxHp)&&!(Math.hypot(r.x-o.x,r.y-o.y)>nt.pickupRadius)){if(n===null){n=r;continue}r.hp/r.maxHp<n.hp/n.maxHp&&(n=r)}if(n===null){a++;continue}const s=n.hp;n.hp=Math.min(n.maxHp,n.hp+nt.heal*Bl(n.level));const i=n.hp-s;t.medikits.splice(a,1),e.push({type:"heal",fighterRole:n.role,fighterId:n.id,amount:i}),e.push({type:"medikit-taken",id:o.id,fighterRole:n.role,fighterId:n.id,x:o.x,y:o.y,amount:i})}}function lu(t,e){return au(e.x,e.y,t.arena,t.splats)}function Zb(t,e){if(x0(t)||!e.aim)return;const a=Math.hypot(e.aim.x,e.aim.y);a>1e-6&&(t.facing={x:e.aim.x/a,y:e.aim.y/a})}function Jb(t,e,a,o){const n=t.elapsed;let s=lu(t,e);lh(t,e)&&(s*=Ct.speedBoost),n<e.status.slowedUntil&&(s*=vm);const r=Yl(e,n)?0:Is(e.characterId,m0)*a*s,l=o.move.x*r,h=o.move.y*r;return Vs(e,l,h,t.arena),l!==0||h!==0}function Qb(t,e,a,o,n){if(!e.alive)return;if(e.terrainSlowFactor=lu(t,e),e.concealed=tu(e.x,e.y,t.arena,t,e),re[e.characterId].hasTrail&&o){if(e.trailDropTimer+=a,e.trailDropTimer>=Ct.dropIntervalMs){e.trailDropTimer=0;const r={id:t.nextId++,ownerId:e.id,ownerRole:e.role,x:e.x,y:e.y,expiresAt:t.elapsed+Ct.durationMs,damagedMask:0,damaged:!1};t.trailMarks.push(r),n.push({type:"trail-mark-created",ownerRole:e.role,ownerId:e.id,x:e.x,y:e.y})}}else e.trailDropTimer=0;for(const r of t.fighters){if(r===e||!r.alive)continue;const l=Wm(r.id);let h=0;for(const c of t.trailMarks)if(!(c.ownerId!==e.id||(c.damagedMask&l)!==0)&&!(Math.hypot(r.x-c.x,r.y-c.y)>=Ct.radius)&&(c.damagedMask|=l,c.damaged=!0,!(h>=Ct.maxHitsPerTick)&&(h++,to(t,r,Ct.damage,null,{kind:"trail",ownerId:e.id,ownerRole:e.role},n),!r.alive)))break}if(t.arena.hazards.forEach((r,l)=>{if(r.kind!=="damage")return;if(Math.hypot(e.x-r.x,e.y-r.y)<r.radius){const c=(e.hazardTimers[l]??0)+a;c>=(r.tickMs??1/0)?(e.hazardTimers[l]=0,to(t,e,r.damage??0,null,{kind:"hazard"},n)):e.hazardTimers[l]=c}else e.hazardTimers[l]=0}),t.elapsed-e.lastDamagedAt>gm&&e.hp<e.maxHp&&e.hp>0){if(e.regenTimer+=a,e.regenTimer>=wm){e.regenTimer=0;const r=e.hp;e.hp=Math.min(e.maxHp,e.hp+f0),e.hp>r&&n.push({type:"heal",fighterRole:e.role,fighterId:e.id,amount:e.hp-r})}}else e.regenTimer=0;if(Cn(t.timeRemaining))return;Math.hypot(e.x-t.arena.center.x,e.y-t.arena.center.y)>t.safeRadius&&e.hp>0?(e.fogTimer+=a,e.fogTimer>=Bs&&(e.fogTimer=0,to(t,e,ql,null,{kind:"fog"},n))):e.fogTimer=0}function ey(t,e,a){const o=hl-t.timeRemaining;if(Math.floor(o/Bs)===Math.floor((o-e)/Bs))return;const n=t.fighters.slice().sort((s,i)=>s.hp!==i.hp?s.hp-i.hp:i.id-s.id);for(const s of n){if(t.phase!=="playing")break;!s.alive||s.hp<=0||Math.hypot(s.x-t.arena.center.x,s.y-t.arena.center.y)<=t.safeRadius||to(t,s,ql,null,{kind:"fog"},a)}}function ds(t,e,a,o){const n=t.projectiles[e];o.push({type:"projectile-destroyed",id:n.id,reason:a,x:n.x,y:n.y}),t.projectiles.splice(e,1)}function nd(t,e,a,o){const n={id:t.nextId++,x:e,y:a,expiresAt:t.elapsed+ym};t.splats.push(n),o.push({type:"splat-created",x:e,y:a})}function ty(t,e,a){let o=null,n=1/0;for(const s of t.fighters){if(!fi(s,a))continue;const i=Math.hypot(e.x-s.x,e.y-s.y);i>=s.hitRadius||i<n&&(n=i,o=s)}return o}function ay(t,e,a){for(let o=t.projectiles.length-1;o>=0;o--){const n=t.projectiles[o],s=n.weapon,i=t.fighters[n.targetId],r=t.fighters[n.ownerId];if(s.peckHits&&n.arrived){if(i.hp<=0){ds(t,o,"expired",a);continue}n.peckTimer=(n.peckTimer??0)+e,n.peckTimer>=(s.peckInterval??500)&&(n.peckTimer=0,to(t,i,n.damage,s.effect,{kind:"weapon",weaponKey:s.key,weaponName:s.name,attackerId:n.ownerId},a),n.hitsSoFar=(n.hitsSoFar??1)+1,n.hitsSoFar>=s.peckHits&&ds(t,o,"expired",a));continue}if(s.homing&&i.hp>0&&rh(n.x,n.y,i.x,i.y,t.arena,t,i)){const g=i.x-n.x,w=i.y-n.y,b=Math.hypot(g,w)||1,y=g/b,v=w/b,k=Math.hypot(n.vx,n.vy)||1,M=n.vx/k,x=n.vy/k,S=Math.min(1,xm*e),E=M+(y-M)*S,A=x+(v-x)*S,C=Math.hypot(E,A)||1,R=s.speed??0;n.vx=E/C*R,n.vy=A/C*R}const l=n.vx*e/1e3,h=n.vy*e/1e3,c=n.x+l,d=n.y+h,p=t.arena.cover.some(g=>$n(c,d,ad,ad,g.x,g.y,g.w,g.h)),u=Math.hypot(l,h);let f=u;if(u>0&&n.tx!==void 0&&n.ty!==void 0){const g=((i.x-n.tx)*l+(i.y-n.ty)*h)/u;g>0&&(f=u-g)}if(n.tx=i.x,n.ty=i.y,n.age=(n.age??0)+e,n.traveled+=f>0?f:0,n.x=c,n.y=d,p||n.traveled>=(s.range??1/0)||n.age>=bm(s)){s.splatter&&nd(t,n.x,n.y,a),ds(t,o,p?"hit-cover":"expired",a);continue}const m=ty(t,n,r);if(m!==null){if(m!==i&&(n.targetId=m.id,n.targetRole=m.role),to(t,m,n.damage,s.effect,{kind:"weapon",weaponKey:s.key,weaponName:s.name,attackerId:n.ownerId},a),s.splatter&&nd(t,n.x,n.y,a),s.peckHits){n.arrived=!0,n.peckTimer=0,n.hitsSoFar=1;continue}ds(t,o,"hit-target",a);continue}}}const sd="pointerlock-styles",oy=2600;function hu(){const t=new URLSearchParams(location.search);return t.get("pointerLock")??t.get("pointerlock")}function ny(){const t=hu();if(t==="0")return!1;if(t==="1"||t==="sim")return!0;const e=new URLSearchParams(location.search);return!(e.has("shot")||e.has("simSpeed"))}function sy(){return typeof window.matchMedia!="function"?!0:window.matchMedia("(pointer: fine)").matches}function iy(t){const{target:e}=t,a=hu()==="sim";let o=!1;const s=typeof document<"u"&&"pointerLockElement"in document&&typeof e.requestPointerLock=="function"&&sy()&&ny();let i=!1,r=!1,l=!0,h="hidden",c=0,d=!1,p=!1,u="";const f=document.createElement("div");f.className="plk-root",f.innerHTML=`
  ...
  `;const m=D=>f.querySelector(`[data-el="${D}"]`),g=m("fs"),w=m("fs2");function b(){return a?o:document.pointerLockElement===e}function y(){window.__plockDebug={state:h,wantsLock:i,locked:b(),pending:p,lastError:u,available:s}}function v(){f.classList.toggle("is-prompt",h==="prompt"),f.classList.toggle("is-toast",h==="toast"),f.classList.toggle("is-lost",h==="lost"),y()}function k(D){h!==D&&(h=D,window.clearTimeout(c),D==="toast"&&(c=window.setTimeout(()=>{!d&&h==="toast"&&k("hidden")},oy)),v())}function M(){const W=!!document.fullscreenElement?"⛶ Exit fullscreen":"⛶ Fullscreen";g.textContent=W,w.textContent=W}function x(){try{document.fullscreenElement?document.exitFullscreen?.()?.catch(()=>{}):document.documentElement.requestFullscreen?.()?.catch(()=>{})}catch{}}function S(D){u=D===void 0?"refused":String(D?.message??D),y(),!(d||!i||b())&&(t.pause(),k("lost"))}function E(){if(!(d||!s||!i||b()||p)){if(a){o=!0,I();return}p=!0;try{const D=e.requestPointerLock();D&&typeof D.then=="function"?D.then(()=>{p=!1},W=>{p=!1,S(W)}):window.setTimeout(()=>{p=!1},0)}catch(D){p=!1,S(D)}}}function A(){if(b()){if(r=!0,a){o=!1,I();return}try{document.exitPointerLock()}catch{r=!1}}}function C(){i=!0,t.resume()}function R(){i=!1,A(),k("prompt"),t.resume()}const I=()=>{if(d)return;const D=b();if(t.onLockChange(D),p=!1,D){i=!0,r=!1,k("toast");return}if(r){r=!1,k(l&&s?"prompt":"hidden");return}i?(t.pause(),k("lost")):k(l&&s?"prompt":"hidden")},N=()=>{p=!1,!d&&S("pointerlockerror")},L=()=>{d||!i||!s||b()||h!=="lost"&&(t.pause(),k("lost"))},_=()=>M(),U=D=>{d||!o||D.key!=="Escape"||(D.preventDefault(),D.stopImmediatePropagation(),o=!1,I())};return s&&(ry(),document.body.appendChild(f),document.addEventListener("pointerlockchange",I),document.addEventListener("pointerlockerror",N),document.addEventListener("fullscreenchange",_),window.addEventListener("blur",L),a&&window.addEventListener("keydown",U,!0),m("capture").addEventListener("click",D=>{D.stopPropagation(),C()}),m("resume").addEventListener("click",D=>{D.stopPropagation(),C()}),m("scrim").addEventListener("click",()=>C()),m("free").addEventListener("click",D=>{D.stopPropagation(),R()}),g.addEventListener("click",D=>{D.stopPropagation(),x()}),w.addEventListener("click",D=>{D.stopPropagation(),x()}),M(),k("prompt"),v()),{available:s,get locked(){return s&&b()},engage:E,release:A,setMatchActive(D){!s||l===D||(l=D,D?b()||k("prompt"):(A(),k("hidden")))},dispose(){d||(d=!0,window.clearTimeout(c),s&&(A(),document.removeEventListener("pointerlockchange",I),document.removeEventListener("pointerlockerror",N),document.removeEventListener("fullscreenchange",_),window.removeEventListener("blur",L),window.removeEventListener("keydown",U,!0),f.remove()))}}}function ry(){if(document.getElementById(sd))return;const t=document.createElement("style");t.id=sd,t.textContent=ly,document.head.appendChild(t)}const ly=`
.plk-root {
  position: fixed;
  inset: 0;
  z-index: 30;
...
`,Kt=.11,id=J*.1,cu=new it(Kt,12,10);cu.scale(1,.86,1);const hy=new Ko(Kt*.32,Kt*.5,6),zo=new pi(Kt*.6,0);zo.scale(1,.4,1);const cy=new V({color:"#E63946"}),dy=new V({color:"#3E5C2B"}),py=new V({color:"#FF9E9E",transparent:!0,opacity:.55,depthWrite:!1});function hh(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const uy=hh(18,()=>new V({color:"#E63946",transparent:!0,opacity:.85,depthWrite:!1})),fy=hh(20,()=>new V({color:"#C21F32",transparent:!0,opacity:.9,depthWrite:!1})),rd=hh(6,()=>new V({color:"#FFD9C7",transparent:!0,opacity:.95,blending:Qe,depthWrite:!1}));function my(t){const e=new ne,a=new T(cu,cy);e.add(a);const o=new T(hy,dy);o.position.set(0,Kt*.75,0),e.add(o);const n=new T(zo,py);return n.scale.setScalar(.55),n.position.set(Kt*.32,Kt*.28,Kt*.5),e.add(n),e}function cr(t,e,a,o,n,s=1){const i=new T(zo,fy()),r=(.3+Math.random()*.25)*s;i.scale.setScalar(r),i.position.copy(e);const l=e.x,h=e.y,c=e.z,d=1.1+Math.random()*1.3,p=-5.5,u=.32+Math.random()*.16;t.spawnTransient(i,u,(f,m)=>{i.position.set(l+a*n*m,h+d*m+.5*p*m*m,c+o*n*m),i.scale.setScalar(r*(1-f*.35)),i.material.opacity=.9*(1-f)})}const gy={Tomato:{projectile(t){const e=my(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=(e.userData.__spin??0)+a*8;e.userData.__spin=o,e.rotation.x=o,e.rotation.z=Math.sin(o*.6)*.25;const n=1+Math.sin(o*2.2)*.09;e.scale.set(1/n,n,1/n);const s=(e.userData.__dripTimer??.05)-a;s<=0?(e.userData.__dripTimer=.09+Math.random()*.05,cr(t,t.position,-t.direction.x*.5,-t.direction.z*.5,.3+Math.random()*.25)):e.userData.__dripTimer=s},impact(t){const e=t.position,a=Y.clamp(1+t.damage*.05,1,2.2),o=id/(Kt*.6),n=new T(zo,rd());n.position.copy(e),n.scale.setScalar(.7*o),t.spawnTransient(n,.18,r=>{n.scale.setScalar(Y.lerp(.7,2.4,r)*o*a),n.material.opacity=.9*(1-r)});const s=7,i=Ja*.45;for(let r=0;r<s;r++){const l=r/s*Math.PI*2+Math.random()*.5,h=i+(.5+Math.random()*.75)*a,c=new T(zo,uy()),d=(.55+Math.random()*.4)*o*a,p=e.x+Math.cos(l)*i,u=e.y,f=e.z+Math.sin(l)*i;c.position.set(p,u,f),c.rotation.y=Math.random()*Math.PI*2;const m=e.x+Math.cos(l)*h,g=e.z+Math.sin(l)*h,w=u-.9;t.spawnTransient(c,.55+Math.random()*.2,b=>{const y=1-Math.pow(1-b,3);c.position.set(Y.lerp(p,m,y),Y.lerp(u,w,Math.min(1,y*1.3)),Y.lerp(f,g,y)),c.scale.setScalar(d*(1-b*.3)),c.material.opacity=.85*(1-Math.pow(b,1.5))})}for(let r=0;r<5;r++){const l=Math.random()*Math.PI*2;cr(t,e,Math.cos(l),Math.sin(l),1.3+Math.random()*1.1,o)}},cast(t){const e=id/(Kt*.6),a=new T(zo,rd()),o=a.material;o.color.set(t.color),a.position.copy(t.position),a.scale.setScalar(.16*e),t.spawnTransient(a,.15,n=>{a.scale.setScalar(Y.lerp(.16,.62,n)*e),o.opacity=.9*(1-n)});for(let n=0;n<3;n++){const s=(Math.random()-.5)*.6;cr(t,t.position,t.direction.x+s,t.direction.z+s,.9+Math.random()*.5,e*.35)}}}},ch="#C93F73",wy="#F0C070",xi="#FFF0F6",by="#FFD9EC",vl=["#E63946","#7CB518","#FFC93C","#7C4DFF","#2E86D8","#FFFFFF"],Mt=J,so=Math.PI*2,Xs=.28,zt=Mt*.09,ia=Mt*.043,yy=Mt*.014,xy=Mt*.042,ps=Mt*.375,us=Mt*.4;function _o(t,e,a,o,n){const s=new Gl(t,e,a,o,n);return s.rotateX(-Math.PI/2),s}const vy=_o(zt,ia,8,22),ky=_o(zt,ia*.82,8,22),My=_o(zt,ia*1.3,8,22),ld=[_o(zt*.92,ia*.86,6,8,1.5),_o(zt*1.05,ia*.72,6,8,1),_o(zt*.8,ia*.95,6,7,2.1)];let Ey=0;const Ty=()=>ld[Ey++%ld.length],du=new Ul(yy,xy,3,6);function pu(t,e=40){const a=new Ea(t,1,e,1);return a.rotateX(-Math.PI/2),a}const Sy=pu(.84),Ay=pu(.7);function Xo(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Zo=(t,e,a={})=>new V({color:t,transparent:!0,opacity:e,depthWrite:!1,side:me,...a}),hd=new V({color:"#FF6FA5"}),Ry=new V({color:wy}),Iy=new V({color:ch}),cd=vl.map(t=>new V({color:t})),Cy=Xo(18,()=>Zo(ch,1)),Oy=Xo(18,()=>Zo("#FF6FA5",1)),Fy=Xo(30,()=>Zo("#FFFFFF",1)),Ny=Xo(24,()=>Zo(xi,.7)),Ly=Xo(20,()=>Zo(xi,.7,{blending:Qe})),Dy=Xo(24,()=>Zo(xi,1)),uu=new de(0,1,0),dd=new de,dr=new ui,pd=new ui;function Hy(t,e,a,o,n){dr.setFromAxisAngle(uu,o);const s=Math.hypot(e,a);Math.abs(n)>1e-4&&s>1e-4?(dd.set(a/s,0,-e/s),pd.setFromAxisAngle(dd,n),t.quaternion.copy(pd).multiply(dr)):t.quaternion.copy(dr)}function zy(t){return t.range&&t.speed?t.range/t.speed:co.normal/1e3}function _y(t,e,a){let o=t.userData.__ring;return o||(o={spin:Math.random()*so,rate:a*so/zy(e),shed:0,echo:0},t.userData.__ring=o),o}function Pa(t,e,a,o,n,s,i,r,l,h={}){const c=h.hard?Dy():h.glow?Ly():Ny();c.color.set(i),c.opacity=r;const d=new T(h.band?Ay:Sy,c);d.renderOrder=h.renderOrder??9,d.position.set(e,a,o),d.rotation.y=Math.random()*so,d.scale.set(n,1,n);const p=h.fadePow??1,u=h.hold??0;t.spawnTransient(d,l,f=>{const m=Y.lerp(n,s,1-Math.pow(1-f,2.4));d.scale.set(m,1,m),c.opacity=f<u?r:r*(1-Math.pow((f-u)/(1-u),p))})}function pr(t,e,a,o,n,s,i,r,l=1){const h=Fy();h.color.set(vl[Math.random()*vl.length|0]),h.opacity=1;const c=new T(du,h);c.renderOrder=9,c.position.set(e,a,o),c.scale.setScalar(l);const d=(Math.random()-.5)*26,p=(Math.random()-.5)*26,u=-9;t.spawnTransient(c,r,(f,m)=>{c.position.set(e+n*m,Math.max(Xs,a+s*m+.5*u*m*m),o+i*m),c.rotation.set(d*m,0,p*m),h.opacity=1-Math.pow(f,2.4)})}function Py(t,e,a,o,n,s,i){const r=new ne,l=Cy();l.color.set(ch),l.opacity=1;const h=Ty(),c=new T(h,l);c.scale.setScalar(1.28),r.add(c);const d=Oy();d.color.set(a),d.opacity=1,r.add(new T(h,d)),r.renderOrder=9,r.position.copy(e),r.scale.setScalar(s);const p=e.x,u=e.y,f=e.z,m=Math.cos(o)*n,g=Math.sin(o)*n,w=1.5+Math.random()*1.2,b=-8.5,y=(Math.random()-.5)*20,v=(Math.random()-.5)*20;t.spawnTransient(r,i,(k,M)=>{r.position.set(p+m*M,Math.max(Xs,u+w*M+.5*b*M*M),f+g*M),r.rotation.set(y*M,0,v*M);const x=1-Math.pow(k,2.2);d.opacity=x,l.opacity=x})}function $y(t){return Y.clamp(.85+t*.035,.85,1.25)}function By(t){const e=new ne,a=new T(My,Iy);a.position.y=-Mt*.007,e.add(a),e.add(new T(vy,Ry)),hd.color.set(t);const o=new T(ky,hd);o.position.y=ia*.36,e.add(o);const n=Math.random()*so;for(let s=0;s<5;s++){const i=n+s/5*so+(Math.random()-.5)*.6,r=new T(du,cd[Math.random()*cd.length|0]);r.position.set(Math.cos(i)*zt,ia*1.05,Math.sin(i)*zt),r.quaternion.setFromAxisAngle(uu,-i),r.rotateX(Math.PI/2),r.scale.setScalar(1.05),e.add(r)}return e.userData.__isCandyRing=!0,e}const qy={Candy:{projectile(t){const e=By(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=_y(e,t.weapon,2.4);if(o.spin+=o.rate*a,Hy(e,t.direction.x,t.direction.z,o.spin,.13+Math.sin(o.spin*.41)*.08),e.position.y+=Math.sin(o.spin*.62)*Mt*.011,o.echo-=a,o.echo<=0){o.echo=.075;const n=zt+ia;Pa(t,t.position.x,t.position.y,t.position.z,n,n*1.45,by,.55,.2,{glow:!0,fadePow:1.4})}o.shed-=a,o.shed<=0&&(o.shed=.085+Math.random()*.05,pr(t,t.position.x-t.direction.x*zt,t.position.y,t.position.z-t.direction.z*zt,-t.direction.x*.6+(Math.random()-.5)*.6,.15+Math.random()*.35,-t.direction.z*.6+(Math.random()-.5)*.6,.34,.85))},impact(t){const e=$y(t.damage),{x:a,y:o,z:n}=t.position;Pa(t,a,o,n,ps*.8*e,ps*e,"#FFF6FA",1,.16,{hard:!0,renderOrder:12,fadePow:1.1,hold:.45}),Pa(t,a,o,n,ps*.62*e,ps*.86*e,t.color,1,.19,{hard:!0,renderOrder:11,fadePow:1.4,hold:.3}),Pa(t,a,Xs,n,us*.2*e,us*e,t.color,.95,.3,{hard:!0,renderOrder:7,fadePow:1.6,hold:.35}),Pa(t,a,Xs-.01,n,us*.16*e,us*.86*e,xi,.9,.34,{hard:!0,band:!0,renderOrder:6,fadePow:1.4,hold:.3});for(let s=0;s<3;s++){const i=s/3*so+Math.random()*.9;Py(t,t.position,t.color,i,(2.3+Math.random()*1.5)*e,(1.05+Math.random()*.5)*e,.36+Math.random()*.12)}for(let s=0;s<8;s++){const i=Math.random()*so,r=(2.2+Math.random()*1.8)*e;pr(t,a,o,n,Math.cos(i)*r+t.direction.x*.9,2.5+Math.random()*1.6,Math.sin(i)*r+t.direction.z*.9,.4+Math.random()*.14,1.1+Math.random()*.6)}},cast(t){Pa(t,t.position.x,t.position.y,t.position.z,Mt*.06,Mt*.2,"#FFF6FA",1,.16,{hard:!0,renderOrder:12,hold:.3}),Pa(t,t.position.x,t.position.y,t.position.z,Mt*.03,Mt*.13,t.color,.95,.13,{hard:!0,band:!0,renderOrder:11,hold:.25});for(let e=0;e<4;e++)pr(t,t.position.x,t.position.y,t.position.z,t.direction.x*(1.2+Math.random()*.8)+(Math.random()-.5)*.7,.7+Math.random()*.6,t.direction.z*(1.2+Math.random()*.8)+(Math.random()-.5)*.7,.3,.85)}}},Bn="#F2A73E",dh="#B96F16",fu="#E9C078",ph="#4E2C1B",mu="#E63946",gu="#8FCB1E",vi="#EFE2FA",wu="#C9A9E4",bu="#CDB0EE",pe=J,Be=Math.PI*2,Zs=.29,qo=pe*.085,ki=pe*.105,ur=pe*.032,we=pe*.105,aa=pe*.07,Ua=pe*.036,Re=pe*.125,Uy=pe*.33;function Po(t,e=7){return new Me(1,1,1,e,1,!0,-t/2,t)}const Uo=[Po(1.1),Po(1.7),Po(2.3)];let Gy=0;const jy=()=>Uo[Gy++%Uo.length],kl=Po(2.7,9),yu=Po(2.9,12),Ml=new pi(1,0),xu=new jl(1,0),El=new dt(1,1,1),ud=new it(1,14,10),Wy=new it(1,16,10,0,Math.PI*1.5),Yy=new Gl(1,.062,5,20),fd=new Ko(1,1,6),Vy=Po(2.2,7),Ky=(()=>{const e=document.createElement("canvas");e.width=e.height=64;const a=e.getContext("2d"),o=a.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);o.addColorStop(0,"rgba(255,255,255,0.85)"),o.addColorStop(.42,"rgba(255,255,255,0.44)"),o.addColorStop(.76,"rgba(255,255,255,0.12)"),o.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=o,a.fillRect(0,0,64,64);const n=new et(e);return n.colorSpace=di,n})();function uo(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Jo=(t,e={})=>new V({color:t,transparent:!0,opacity:1,depthWrite:!1,side:me,...e}),uh=uo(26,()=>Jo(Bn)),vu=uo(34,()=>Jo(fu)),fs=uo(30,()=>Jo(ph)),Xy=uo(12,()=>Jo(wu)),ku=uo(20,()=>Jo("#FFF3D6")),Zy=uo(14,()=>new Ot({map:Ky,color:bu,transparent:!0,opacity:.3,depthWrite:!1})),da=(t,e={})=>new V({color:t,side:me,...e}),md=da("#6B3E26"),Jy=da(ph),Qy=da(Bn),e2=da(dh),gd=da(gu),t2=da(mu),wd=da("#B497D6"),a2=da(wu),fr=da(vi);function o2(t){return t.range&&t.speed?t.range/t.speed:co.normal/1e3}function mr(t){const e=t.weapon.comboParts;if(!e)return-1;const a=e.findIndex(o=>o.color===t.color&&o.damage===t.damage);return a>=0?a:e.findIndex(o=>o.color===t.color)}function Mu(t){return Y.clamp(.85+t*.035,.85,1.45)}function Eu(t,e,a){let o=t.userData.__tumble;return o||(o={t:Math.random()*Be,rate:a*Be/o2(e),shed:0},t.userData.__tumble=o),o}function No(t,e,a,o,n,s,i,r,l,h,c,d,p,u,f=-9){a.color.set(o),a.opacity=1;const m=new T(e,a);m.renderOrder=9,m.position.set(n,s,i),m.scale.set(c,d,p),m.rotation.set(Math.random()*Be,Math.random()*Be,Math.random()*Be);const g=(Math.random()-.5)*20,w=(Math.random()-.5)*20,b=(Math.random()-.5)*20,y=m.rotation.x,v=m.rotation.y,k=m.rotation.z;t.spawnTransient(m,u,(M,x)=>{const S=s+l*x+.5*f*x*x,E=S<=Zs;m.position.set(n+r*x,E?Zs:S,i+h*x),E||m.rotation.set(y+g*x,v+w*x,k+b*x),a.opacity=1-Math.pow(M,2.4)})}function Tu(t,e,a,o,n,s,i,r,l){No(t,jy(),uh(),Math.random()<.35?dh:Bn,e,a,o,n,s,i,qo*r,ki*r,qo*r,l)}function Mi(t,e,a,o,n,s,i,r,l){No(t,xu,vu(),fu,e,a,o,n,s,i,ur*r,ur*r,ur*r,l)}function Ei(t,e,a,o,n,s,i,r,l,h){if(e==="lettuce")No(t,kl,fs(),gu,a,o,n,s,i,r,aa*l,aa*.42*l,aa*l,h,-6.5);else if(e==="tomato")No(t,El,fs(),mu,a,o,n,s,i,r,Ua*l,Ua*l,Ua*l,h);else if(e==="onion")No(t,El,fs(),vi,a,o,n,s,i,r,Ua*1.3*l,Ua*.4*l,Ua*1.3*l,h);else{const c=we*(.45+Math.random()*.3)*l;No(t,Ml,fs(),Math.random()<.4?ph:"#6B3E26",a,o,n,s,i,r,c,c*.8,c*1.15,h)}}function fh(t,e,a,o,n){const s=ku();s.color.set("#FFF3D6"),s.opacity=1;const i=new T(xu,s);i.renderOrder=12,i.position.set(e,a,o),i.rotation.set(Math.random()*Be,Math.random()*Be,0),i.scale.setScalar(n*.6),t.spawnTransient(i,.12,r=>{i.scale.setScalar(n*Y.lerp(.6,1.3,r)),s.opacity=r<.4?1:1-(r-.4)/.6})}function Su(t,e){const{x:a,y:o,z:n}=t.position,s=t.direction,i=Math.random()*Be;for(let r=0;r<5;r++){const l=i+r/5*Be,h=ku();h.color.set(r%2===0?"#FFF3D6":"#FFD27A"),h.opacity=1;const c=new T(Uo[r%Uo.length],h);c.renderOrder=12;const d=Math.cos(l),p=Math.sin(l),u=pe*.11*e,f=pe*.44*e,m=Math.atan2(d,p);t.spawnTransient(c,.13,g=>{const w=1-Math.pow(1-g,2.2),b=Y.lerp(u,f,w);c.position.set(a+d*b+s.x*b*.3,o,n+p*b+s.z*b*.3);const y=(1-g*.45)*e;c.rotation.set(0,m,0),c.scale.set(qo*1.15*y,ki*1*y,qo*1.15*y),h.opacity=g<.45?1:1-(g-.45)/.55})}}function bd(t,e,a,o,n,s,i,r=.3){const l=new ya(Zy()),h=l.material;h.color.set(bu),h.opacity=0,l.renderOrder=10;const c=(Math.random()-.5)*n*1.4,d=(Math.random()-.5)*n*1.4;l.position.set(e,a,o),l.scale.set(n,n,1),t.spawnTransient(l,i,p=>{const u=1-Math.pow(1-p,2);l.position.set(e+c*u,a+s*u,o+d*u);const f=n*(1+u*.9);l.scale.set(f,f,1),h.opacity=r*Math.sin(Math.min(1,p*1.25)*Math.PI)})}function n2(t,e,a,o){const{x:n,y:s,z:i}=t.position,r=t.direction;let l=-r.z,h=r.x;Math.hypot(l,h)<1e-4&&(l=1,h=0);for(const c of[-1,1]){const d=uh();d.color.set(c<0?Bn:dh),d.opacity=1;const p=new T(yu,d);p.renderOrder=9;const u=n+l*c*pe*.24*e,f=i+h*c*pe*.24*e;p.position.set(u,s,f);const m=qo*2.1*e;p.scale.set(m,ki*1.9*e,m);const g=l*c*a+r.x*a*.35,w=h*c*a+r.z*a*.35,b=1.5+Math.random()*.9,y=c*(7+Math.random()*5),v=(Math.random()-.5)*6;t.spawnTransient(p,o,(k,M)=>{const x=s+b*M-4.6*M*M;p.position.set(u+g*M,Math.max(Zs,x),f+w*M),p.rotation.set(v*M,y*M,c*.5),d.opacity=1-Math.pow(k,2.2)})}}function gr(t){const e=new ne;md.color.set(t);const a=new T(Ml,md);a.scale.set(we,we*.85,we*1.18),a.rotation.set(.6,.4,.2),e.add(a);const o=new T(Ml,Jy);o.scale.setScalar(we*.62),o.position.set(we*.55,-we*.4,-we*.3),o.rotation.set(1.1,.3,.8),e.add(o);const n=new T(kl,gd);n.scale.set(aa*1.15,aa*.4,aa*1.15),n.position.set(-we*.45,we*.55,we*.2),n.rotation.set(.9,.7,-.5),e.add(n);for(const[l,h,c]of[[.8,.3,.5],[-.55,-.25,-.8]]){const d=new T(El,t2);d.scale.setScalar(Ua*1.45),d.position.set(we*l,we*h,we*c),d.rotation.set(Math.random(),Math.random(),Math.random()),e.add(d)}const s=new T(kl,gd);s.scale.set(aa*.8,aa*.3,aa*.8),s.position.set(we*.3,-we*.15,-we*.7),s.rotation.set(-.6,1.9,.8),e.add(s);const i=new T(Uo[2],Qy);i.scale.set(we*1.02,we*1.25,we*1.02),i.position.set(-we*.25,-we*.72,-we*.1),i.rotation.set(1.5,.4,.15),e.add(i);const r=new T(Uo[0],e2);return r.scale.set(we*.7,we*.85,we*.7),r.position.set(we*.75,-we*.35,we*.45),r.rotation.set(.9,2.2,-.6),e.add(r),e}function wr(t){const e=new ne;wd.color.set(t);const a=new T(ud,wd);a.scale.set(Re,Re*.92,Re),e.add(a);const o=new ne;for(let i=0;i<3;i++){const r=new T(Yy,fr);r.scale.set(Re*1.01,Re*.93,Re*1.01),r.rotation.y=i/3*Math.PI,o.add(r)}e.add(o);const n=new T(fd,fr);n.scale.set(Re*.42,Re*.62,Re*.42),n.position.y=Re*1.06,n.rotation.z=.18,e.add(n);for(let i=0;i<3;i++){const r=i/3*Be+.4,l=new T(fd,a2);l.scale.set(Re*.09,Re*.34,Re*.09),l.position.set(Math.cos(r)*Re*.2,-Re*1,Math.sin(r)*Re*.2),l.rotation.set(Math.PI+(Math.random()-.5)*.6,0,(Math.random()-.5)*.6),e.add(l)}const s=new T(ud,fr);return s.scale.set(Re*.42,Re*.2,Re*.42),s.position.set(Re*.42,Re*.62,-Re*.3),e.add(s),e.userData.__bands=o,e}function yd(t,e){const a=t.object;if(!a)return;const o=t.dt??0,n=Eu(a,t.weapon,e);if(n.t+=n.rate*o,a.rotation.x=n.t,a.rotation.z=Math.sin(n.t*.63)*.9,n.shed-=o,n.shed<=0){n.shed=.06+Math.random()*.04;const s=Math.random(),i=s<.45?"meat":s<.72?"tomato":"lettuce",r=t.position.x-t.direction.x*we,l=t.position.z-t.direction.z*we;Ei(t,i,r,t.position.y-we*.4,l,-t.direction.x*.5+(Math.random()-.5)*.7,-.2-Math.random()*.4,-t.direction.z*.5+(Math.random()-.5)*.7,.85,.34),Math.random()<.55&&Mi(t,r,t.position.y,l,-t.direction.x*.7+(Math.random()-.5)*.6,.1+Math.random()*.3,-t.direction.z*.7+(Math.random()-.5)*.6,.9,.3)}}function xd(t,e){const a=Mu(t.damage)*e,{x:o,y:n,z:s}=t.position,i=t.direction;fh(t,o,n,s,pe*.24*a),Su(t,a),n2(t,a*.95,2.4*a,.4);const r=pe*.26*a,l=.8;for(let h=0;h<6;h++){const c=h/6*Be+Math.random()*.7,d=(2.2+Math.random()*1.5)*a,p=Math.random();Ei(t,p<.5?"meat":p<.78?"tomato":"lettuce",o+Math.cos(c)*r,n,s+Math.sin(c)*r,Math.cos(c)*d+i.x*l,1.9+Math.random()*1.3,Math.sin(c)*d+i.z*l,a,.42+Math.random()*.14)}for(let h=0;h<4;h++){const c=h/4*Be+Math.random()*.9,d=(2.4+Math.random()*1.6)*a;Tu(t,o+Math.cos(c)*r,n,s+Math.sin(c)*r,Math.cos(c)*d+i.x*l,1.7+Math.random()*1.5,Math.sin(c)*d+i.z*l,(.85+Math.random()*.5)*a,.42+Math.random()*.12)}for(let h=0;h<9;h++){const c=Math.random()*Be,d=(2.6+Math.random()*2.1)*a;Mi(t,o+Math.cos(c)*r*.8,n,s+Math.sin(c)*r*.8,Math.cos(c)*d+i.x*l,1.5+Math.random()*1.8,Math.sin(c)*d+i.z*l,(.85+Math.random()*.7)*a,.36+Math.random()*.14)}}function vd(t,e){const a=t.object;if(!a)return;const o=t.dt??0,n=Eu(a,t.weapon,e);n.t+=n.rate*o,a.rotation.x=n.t*.8,a.rotation.z=n.t*.45;const s=a.userData.__bands;if(s&&(s.rotation.y+=o*1.9),n.shed-=o,n.shed<=0){n.shed=.1+Math.random()*.07;const i=vu();i.color.set(vi),i.opacity=1;const r=new T(Vy,i);r.renderOrder=9;const l=t.position.x-t.direction.x*Re,h=t.position.z-t.direction.z*Re;r.position.set(l,t.position.y,h);const c=Re*(.3+Math.random()*.2);r.scale.set(c,c*.5,c);const d=-t.direction.x*.5+(Math.random()-.5)*.5,p=-t.direction.z*.5+(Math.random()-.5)*.5,u=5+Math.random()*5;t.spawnTransient(r,.42,(f,m)=>{r.position.set(l+d*m,t.position.y-.7*m*m-.25*m,h+p*m),r.rotation.set(Math.sin(m*u)*1.4,m*3,Math.cos(m*u*.7)*1.1),i.opacity=1-Math.pow(f,2)})}}function kd(t,e){const a=Mu(t.damage)*e,{x:o,y:n,z:s}=t.position,i=t.direction;fh(t,o,n,s,pe*.21*a),Su(t,a*.88);for(let h=0;h<3;h++){const c=Xy();c.color.set(h===0||h===1?t.color:vi),c.opacity=.66;const d=new T(Wy,c);d.renderOrder=10,d.position.set(o,n,s),d.rotation.set((Math.random()-.5)*.5,Math.random()*Be,(Math.random()-.5)*.5);const p=Re*(.8+h*.12),u=Uy*a*(.78+h*.22),f=(Math.random()-.5)*5;t.spawnTransient(d,.3+h*.05,m=>{const g=1-Math.pow(1-m,2.6),w=Y.lerp(p,u,g);d.scale.set(w,w*(.9-g*.45),w),d.position.y=n+g*pe*.06,d.rotation.y+=f*.02,c.opacity=.66*(1-Math.pow(m,1.4))})}bd(t,o,n*.6,s,pe*.34*a,pe*.3,.65,.4);for(let h=0;h<3;h++){const c=h/3*Be+Math.random();bd(t,o+Math.cos(c)*pe*.24*a,Zs+pe*.12,s+Math.sin(c)*pe*.24*a,pe*.28*a,pe*.26,.6,.34)}const r=pe*.24*a,l=.7;for(let h=0;h<5;h++){const c=h/5*Be+Math.random()*.8,d=(2.3+Math.random()*1.4)*a;Ei(t,"onion",o+Math.cos(c)*r,n,s+Math.sin(c)*r,Math.cos(c)*d+i.x*l,1.9+Math.random()*1.2,Math.sin(c)*d+i.z*l,a,.4+Math.random()*.12)}for(let h=0;h<3;h++){const c=Math.random()*Be,d=(2.3+Math.random()*1.5)*a;Tu(t,o+Math.cos(c)*r,n,s+Math.sin(c)*r,Math.cos(c)*d+i.x*l,1.6+Math.random()*1.4,Math.sin(c)*d+i.z*l,(.75+Math.random()*.45)*a,.4)}for(let h=0;h<7;h++){const c=Math.random()*Be,d=(2.5+Math.random()*1.9)*a;Mi(t,o+Math.cos(c)*r*.8,n,s+Math.sin(c)*r*.8,Math.cos(c)*d+i.x*l,1.4+Math.random()*1.6,Math.sin(c)*d+i.z*l,(.8+Math.random()*.6)*a,.34+Math.random()*.12)}}function br(t,e,a){const o=t.direction,{x:n,y:s,z:i}=t.position,r=uh();r.color.set(Bn),r.opacity=.9;const l=new T(yu,r);l.renderOrder=11;const h=Math.atan2(o.x,o.z),c=qo*.9*a;t.spawnTransient(l,.18,d=>{const p=c*(1+d*1.5);l.position.set(n+o.x*d*pe*.14,s-d*pe*.04,i+o.z*d*pe*.14),l.scale.set(p,ki*1.1*a*(1-d*.35),p),l.rotation.set(0,h+d*1.1,0),r.opacity=.9*(1-d*d)}),fh(t,n+o.x*pe*.06,s,i+o.z*pe*.06,pe*.1*a);for(let d=0;d<7;d++)Mi(t,n,s,i,o.x*(1.4+Math.random()*1.1)+(Math.random()-.5)*.9,.6+Math.random()*.7,o.z*(1.4+Math.random()*1.1)+(Math.random()-.5)*.9,.9,.3);for(const d of e)Ei(t,d,n,s,i,o.x*(1.3+Math.random()*.7)+(Math.random()-.5)*.6,.8+Math.random()*.5,o.z*(1.3+Math.random()*.7)+(Math.random()-.5)*.6,.9*a,.3)}const s2=pe*.83/(we*2.8),i2=new it(pe*.06,7,6),r2=uo(8,()=>Jo("#FFF3D6",{blending:Qe,opacity:0}));function Md(t,e){let a=0;t.traverse(o=>{o.isMesh&&!o.name&&(o.name=`${e}Part${a++}`)})}const l2={Filling:{projectile(t){const e=gr(t.color);return e.position.copy(t.position),e},trail(t){yd(t,1.7)},impact(t){xd(t,1)},cast(t){br(t,["meat","tomato"],1)}},Onion:{projectile(t){const e=wr(t.color);return e.position.copy(t.position),e},trail(t){vd(t,1.2)},impact(t){kd(t,1)},cast(t){br(t,["onion","onion"],1)}},Double:{projectile(t){const e=mr(t)===1?wr(t.color):gr(t.color);return e.scale.setScalar(1.12),e.position.copy(t.position),e},trail(t){mr(t)===1?vd(t,1.3):yd(t,1.9)},impact(t){mr(t)===1?kd(t,1.12):xd(t,1.12)},cast(t){br(t,["meat","onion","tomato"],1.25)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=new e.Group;o.name="teleTacoRoot";const n=t.position.clone();n.y-=pe*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=t.weapon.comboParts??[],i=gr(s[0]?.color??t.color);i.name="teleTacoFilling";const r=wr(s[1]?.color??"#B497D6");r.name="teleTacoOnion",Md(i,"teleTacoFilling"),Md(r,"teleTacoOnion"),o.add(i,r);const l=6,h=[];for(let m=0;m<l;m++){const g=new e.Mesh(i2,r2());g.name=`teleTacoSpark${m}`,h.push(g),o.add(g)}const c=(m,g,w)=>{const b=e.MathUtils.clamp((m-g)/(w-g),0,1);return b*b*(3-2*b)},d=pe*.48,p=pe*.72,u=[e.MathUtils.degToRad(s[0]?.angle??-10),e.MathUtils.degToRad(s[1]?.angle??10)],f=(m,g)=>{const w=e.MathUtils.clamp(g/a,0,1),b=c(w,0,.42),y=c(w,.3,.82),v=c(w,.82,1);for(let k=0;k<2;k++){const M=k===0?i:r,x=k===0?-1:1,S=.76+.24*b,E=-pe*.62*y,A=d*(.55+.65*b+.35*y),C=u[k],R=pe*.85*v,I=x*A+Math.sin(C)*R,N=E+Math.cos(C)*R;M.position.set(I,p+pe*(.2*y+.1*v),N),M.scale.setScalar(s2*S*(1+.18*v)),M.rotation.set(w*5.5*(k===0?1:-1),w*3.1,w*2.2*x)}for(let k=0;k<l;k++){const M=h[k],x=k/l*Be+w*6.5,S=d*(.25+.85*b);M.position.set(Math.cos(x)*S,p+Math.sin(x*1.7)*pe*.16+pe*.18*y,Math.sin(x)*S*.55-pe*.3*y);const E=.85+1.15*w;M.scale.setScalar(E),M.material.opacity=.45+.45*w}};f(0,0),t.spawnTransient(o,a+.06,f)}}},Qo="#F5EAD6",h2="#E4CFA0",Au="#B9843C",Ru="#6B3E12",Iu="#452D18",Ti="#E0562B",Cu="#D5EAF4",mh="#FFFFFF",qn="#FFF6E4",Ou="#5B3324",gh="#FFC93C",wh="#E63946",bh="#7DA33F",c2="#FFFDF7",ae=J,Ce=Math.PI*2,Fn=.29,Le=ae*.115,rt=ae*.3,d2=ae*.085,Fu=ae*.075,yh=ae*.09,Go=ae*.032,yr=ae*.058,p2=ae*.1,jo=ae*.022,u2=ae*.4,f2=ae*.97,m2=ae*.7,Nu=ae*.11,Tl=new dt(1,1,1),g2=new Me(.5,.5,1,8,1,!0,-1.5,3),Lu=new pi(.5,0),Du=new jl(.62,0),Un=new Ul(1,1.4,3,6);Un.scale(.5,1/3.4,.5);const Hu=new it(.5,8,6),Nn=new dt(1,1,1),zu=new Ko(.5,1,4),Ln=new dt(1,1,1),Ed=new Gl(1,.085,5,18),Td=new Me(1,1,1,16,1),w2=new Me(.55,1,1,14,1),b2=new Me(1,1,1,12,1,!0,-1.55,3.1),y2=new po(1,18);function pa(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const ua=(t,e={})=>new V({color:t,transparent:!0,opacity:1,depthWrite:!1,side:me,...e}),x2=pa(30,()=>ua(Qo)),So=pa(34,()=>ua(qn)),v2=pa(6,()=>ua(Ti)),k2=pa(10,()=>ua(Qo)),M2=pa(10,()=>ua(Ru)),_u=pa(24,()=>ua(mh)),Ye=(t,e={})=>new V({color:t,side:me,...e}),Sd=Ye(Qo),Ad=Ye(h2),ms=Ye(Au),E2=Ye(Cu),T2=Ye(Ti),Rd=Ye(qn),S2=Ye(Ou);Ye(gh);Ye(wh);Ye(bh);const A2=[Ye(bh),Ye(wh),Ye(gh),Ye(qn)],R2=[Ye("#5C7F2A"),Ye("#B02733"),Ye("#E0A317"),Ye(c2)],gs=new de,ws=new de,xr=new de,Id=new y0;function I2(t,e,a,o,n,s,i){gs.set(e,a,o).normalize(),ws.set(n,s,i).normalize(),xr.crossVectors(gs,ws).normalize(),ws.crossVectors(xr,gs).normalize(),Id.makeBasis(gs,ws,xr),t.quaternion.setFromRotationMatrix(Id)}function C2(t){return t.range&&t.speed?t.range/t.speed:co.normal/1e3}function Cd(t){const e=t.weapon.pelletColors;if(!e||e.length===0)return 0;const a=e.indexOf(t.color);return a>=0?a%4:0}function Sl(t){return Y.clamp(.85+t*.035,.85,1.35)}function Pu(t,e,a){let o=t.userData.__spin;return o||(o={t:Math.random()*Ce,rate:a*Ce/C2(e),shed:0,age:0},t.userData.__spin=o),o}function Ft(t,e,a,o,n,s,i,r,l,h,c,d,p,u,f=-9){a.color.set(o),a.opacity=1;const m=new T(e,a);m.renderOrder=9,m.position.set(n,s,i),m.scale.set(c,d,p),m.rotation.set(Math.random()*Ce,Math.random()*Ce,Math.random()*Ce);const g=(Math.random()-.5)*18,w=(Math.random()-.5)*18,b=(Math.random()-.5)*18,y=m.rotation.x,v=m.rotation.y,k=m.rotation.z;t.spawnTransient(m,u,(M,x)=>{const S=s+l*x+.5*f*x*x,E=S<=Fn;m.position.set(n+r*x,E?Fn:S,i+h*x),E||m.rotation.set(y+g*x,v+w*x,k+b*x),a.opacity=1-Math.pow(M,2.4)})}function $o(t,e,a,o,n,s,i,r,l){const h=d2*r*(.85+Math.random()*.55),c=Math.random();Ft(t,g2,x2(),c<.24?Iu:c<.48?Au:Qo,e,a,o,n,s,i,h,h*.85,h,l,-7.5)}function Dn(t,e,a,o,n,s,i,r,l){const h=Fu*r*(.7+Math.random()*.6);Ft(t,Math.random()<.5?Lu:Du,_u(),Math.random()<.45?mh:Cu,e,a,o,n,s,i,h*1.3,h*.34,h,l,-8.5)}function Hn(t,e,a,o,n,s,i,r,l,h){if(e==="rice")Ft(t,Un,So(),qn,a,o,n,s,i,r,Go*l,yh*l,Go*l,h);else if(e==="bean"){const c=yr*l;Ft(t,Hu,So(),Ou,a,o,n,s,i,r,c*1.35,c*.85,c*.85,h)}else if(e==="cheese")Ft(t,Nn,So(),gh,a,o,n,s,i,r,p2*l,jo*l,jo*l,h,-6.5);else if(e==="salsa"){const c=yr*.85*l;Ft(t,Ln,So(),wh,a,o,n,s,i,r,c,c,c,h)}else{const c=yr*l;Ft(t,Ln,So(),bh,a,o,n,s,i,r,c*1.2,c*.55,c*1.2,h)}}const O2=ae*.075,bs=pa(28,()=>ua(qn)),Od=7;function F2(t,e,a,o,n,s,i,r,l,h){const c=t.color,d=O2*l;if(e===0)Ft(t,zu,bs(),c,a,o,n,s,i,r,d*.5,d*2.6,d*.22,h,-7.2);else if(e===1){const p=d*(1+Math.random()*.35);Ft(t,Ln,bs(),c,a,o,n,s,i,r,p,p,p,h)}else e===2?Ft(t,Nn,bs(),c,a,o,n,s,i,r,d*2.5,jo*2.2,jo*2.2,h,-6.5):Ft(t,Un,bs(),c,a,o,n,s,i,r,Go*1.15*l,yh*1.15*l,Go*1.15*l,h,-7.5)}function Al(t,e){const{x:a,y:o,z:n}=t.position,s=t.direction,i=Math.random()*Ce;for(let r=0;r<8;r++){const l=i+r/8*Ce,h=_u();h.color.set(r%2===0?mh:Iu),h.opacity=1;const c=new T(r%2===0?Lu:Du,h);c.renderOrder=12;const d=Math.cos(l),p=Math.sin(l),u=ae*.26*e,f=ae*.44*e,m=(Math.random()-.5)*14;t.spawnTransient(c,.14,g=>{const w=1-Math.pow(1-g,2.2),b=Y.lerp(u,f,w);c.position.set(a+d*b+s.x*b*.28,o+w*ae*.05,n+p*b+s.z*b*.28);const y=Fu*e*(1.7-g*.5);c.scale.set(y*1.6,y*.34,y),c.rotation.set(m*g,Math.atan2(d,p),m*g*.6),h.opacity=g<.45?1:1-(g-.45)/.55})}}const Ma=16,$u=2.35,N2=.42;function xh(t){const e=new ne,a=k2(),o=M2();a.color.set(Qo),a.opacity=1,o.color.set(Ru),o.opacity=1;const n=[];for(let s=0;s<t;s++){const i=new T(Tl,o);i.renderOrder=10;const r=new T(Tl,a);r.renderOrder=11,i.scale.setScalar(0),r.scale.setScalar(0),e.add(i,r),n.push({face:r,back:i})}return{group:e,slats:n,faceMat:a,backMat:o}}function L2(t,e,a,o,n,s,i,r){const{group:l,slats:h,faceMat:c,backMat:d}=xh(Ma),p=ae*.06*i,u=ae*.15*i,f=m2*i,m=Nu*i,g=(v,k,M)=>{const x=v*$u*Ce*s,S=v*N2*Ce*s,E=x+(S-x)*k,A=p+v*(u-p),C=p+v*(f-p),R=A+(C-A)*k;M.x=e+Math.cos(n+E)*R,M.z=o+Math.sin(n+E)*R},w={x:0,z:0},b={x:0,z:0},y=v=>{const k=1-Math.pow(1-Math.min(1,v/.62),2.4),M=Y.lerp(a,Fn,1-Math.pow(1-Math.min(1,v/.72),1.8));for(let S=0;S<Ma;S++){const E=S/Ma,A=(S+1)/Ma;g(E,k,w),g(A,k,b);const C=b.x-w.x,R=b.z-w.z,I=Math.hypot(C,R)*1.14,N=Math.atan2(C,R),L=(w.x+b.x)*.5,_=(w.z+b.z)*.5,U=m*(1-E*.35),{face:D,back:W}=h[S];D.rotation.set(0,N,0),W.rotation.set(0,N,0),D.position.set(L,M+.022,_),W.position.set(L,M,_),D.scale.set(U,ae*.008,I),W.scale.set(U*1.8,ae*.006,I*1.12)}const x=v<.68?1:1-(v-.68)/.32;c.opacity=x,d.opacity=x*.95};y(0),t.spawnTransient(l,r,y)}function D2(t,e,a){const{x:o,z:n}=t.position,s=22,i=2.2,r=u2*e,{group:l,slats:h,faceMat:c,backMat:d}=xh(s),p=Math.random()*Ce,u=Fn+ae*.02,f=(f2*e-u)/(s-1),m=i*Ce/(s-1),g=w=>{const b=Math.min(1,w/.52),y=w<.62?1:1-(w-.62)/.38*.16;for(let k=0;k<s;k++){const M=k/s*.9,x=b>M,{face:S,back:E}=h[k];if(S.visible=x,E.visible=x,!x)continue;const A=p+k*m,C=r*y,R=o+Math.cos(A)*C,I=u+k*f,N=n+Math.sin(A)*C;I2(S,-Math.sin(A)*C*m,f,Math.cos(A)*C*m,Math.cos(A),0,Math.sin(A)),E.quaternion.copy(S.quaternion);const L=C*m*1.02,_=ae*.1*e;S.position.set(R,I,N),E.position.set(R-Math.cos(A)*.02,I,N-Math.sin(A)*.02),S.scale.set(L,ae*.009,_),E.scale.set(L*1.02,ae*.007,_*1.75)}const v=w<.62?1:1-(w-.62)/.38;c.opacity=.88*v,d.opacity=.92*v};g(0),t.spawnTransient(l,a,g)}function Bu(t,e,a,o,n,s,i,r,l){const{group:h,slats:c,faceMat:d,backMat:p}=xh(Ma),u=ae*.03*r,f=ae*.13*r,m=Math.random()<.5?1:-1,g=m*(9+Math.random()*5),w={x:0,z:0},b={x:0,z:0},y=(k,M,x)=>{const S=M+k*$u*Ce*m,E=u+k*(f-u);x.x=Math.cos(S)*E,x.z=Math.sin(S)*E},v=(k,M)=>{const x=g*M,S=e+n*M,E=Math.max(Fn,a+s*M-4*M*M),A=o+i*M;for(let R=0;R<Ma;R++){y(R/Ma,x,w),y((R+1)/Ma,x,b);const I=b.x-w.x,N=b.z-w.z,L=Math.hypot(I,N)*1.16,_=Math.atan2(I,N),{face:U,back:D}=c[R];U.rotation.set(0,_,0),D.rotation.set(0,_,0),U.position.set(S+(w.x+b.x)*.5,E+.018,A+(w.z+b.z)*.5),D.position.set(S+(w.x+b.x)*.5,E,A+(w.z+b.z)*.5);const W=Nu*r*.72;U.scale.set(W,ae*.007,L),D.scale.set(W*1.8,ae*.005,L*1.14)}const C=1-Math.pow(k,2);d.opacity=C,p.opacity=C*.95};v(0,0),t.spawnTransient(h,l,v)}function H2(t){const e=new ne,a=new ne;e.add(a),Sd.color.set(t);const o=new T(Td,Sd);o.rotation.x=Math.PI/2,o.scale.set(Le,rt*.8,Le),a.add(o);const n=new T(w2,Ad);n.rotation.x=-Math.PI/2,n.scale.set(Le,rt*.12,Le),n.position.z=-rt*.46,a.add(n);const s=new T(b2,ms);s.rotation.x=Math.PI/2,s.scale.set(Le*1.02,rt*.8,Le*1.02),a.add(s);const i=new T(Nn,ms);i.position.set(Le*.92,0,0),i.rotation.set(.42,0,0),i.scale.set(Le*.14,Le*.16,rt*.82),a.add(i);const r=new T(Td,E2);r.rotation.x=Math.PI/2,r.scale.set(Le*1.07,rt*.26,Le*1.07),r.position.z=-rt*.2,a.add(r);for(const c of[-rt*.1,rt*.04]){const d=new T(Ed,T2);d.scale.set(Le*1.08,Le*1.08,Le*.85),d.position.z=c,a.add(d)}const l=new T(y2,Ad);l.scale.setScalar(Le*.99),l.position.z=rt*.404,a.add(l);const h=[ms,Rd,ms];for(let c=0;c<3;c++){const d=new T(Ed,h[c]),p=Le*(.78-c*.25);d.scale.set(p,p,Le*.2),d.position.z=rt*.412,a.add(d)}for(let c=0;c<4;c++){const d=c/4*Ce+.5,p=new T(c%2===0?Un:Hu,c%2===0?Rd:S2),u=Le*.28;p.scale.set(u,c%2===0?u*2:u,u),p.position.set(Math.cos(d)*Le*.6,Math.sin(d)*Le*.6,rt*.42),p.rotation.set(Math.random(),Math.random(),Math.random()),a.add(p)}return e.userData.__spinner=a,e}function Fd(t){const e=new ne,a=A2[t],o=R2[t],n=ae*.075;if(t===0){for(let i=0;i<3;i++){const r=new T(zu,i===1?o:a);r.scale.set(n*.5,n*2.6,n*.22),r.position.set((i-1)*n*.5,n*.4,0),r.rotation.set(.2,0,(i-1)*.55),e.add(r)}const s=new T(Nn,o);s.scale.set(n*.16,n*1.2,n*.16),s.position.y=-n*.7,e.add(s)}else if(t===1)for(let s=0;s<3;s++){const i=s/3*Ce,r=new T(Ln,s===2?o:a),l=n*(1+Math.random()*.35);r.scale.setScalar(l),r.position.set(Math.cos(i)*n*.75,Math.sin(i)*n*.5,Math.sin(i*1.7)*n*.55),r.rotation.set(Math.random(),Math.random(),Math.random()),e.add(r)}else if(t===2)for(let s=0;s<4;s++){const i=new T(Nn,s===3?o:a);i.scale.set(n*2.5,jo*1.2,jo*1.2),i.position.set(0,(s-1.5)*n*.28,(s-1.5)*n*.2),i.rotation.set(0,(s-1.5)*.28,(s-1.5)*.14),e.add(i)}else for(let s=0;s<5;s++){const i=s/5*Ce+.3,r=new T(Un,s===4?o:a);r.scale.set(Go*1.15,yh*1.15,Go*1.15),r.position.set(Math.cos(i)*n*.55,Math.sin(i*1.3)*n*.4,Math.sin(i)*n*.55),r.rotation.set(Math.random()*2,Math.random()*2,Math.random()*2),e.add(r)}return e}function z2(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Pu(e,t.weapon,9);o.t+=o.rate*a;const n=e.userData.__spinner;if(n&&(n.rotation.z=o.t),e.rotation.x=Math.sin(o.t*.35)*.1,o.shed-=a,o.shed<=0){o.shed=.055+Math.random()*.04;const s=t.position.x-t.direction.x*rt*.5,i=t.position.z-t.direction.z*rt*.5,r=Math.random();r<.42?Hn(t,"rice",s,t.position.y-Le*.3,i,-t.direction.x*.6+(Math.random()-.5)*.7,-.15-Math.random()*.4,-t.direction.z*.6+(Math.random()-.5)*.7,.9,.32):r<.72?$o(t,s,t.position.y,i,-t.direction.x*.8+(Math.random()-.5)*.6,.15+Math.random()*.3,-t.direction.z*.8+(Math.random()-.5)*.6,.75,.3):Dn(t,s,t.position.y,i,-t.direction.x*.9+(Math.random()-.5)*.5,.2+Math.random()*.35,-t.direction.z*.9+(Math.random()-.5)*.5,.65,.26)}}function _2(t){const e=Sl(t.damage),{x:a,y:o,z:n}=t.position,s=t.direction;Al(t,e);const i=ae*.16*e;let r=-s.z,l=s.x;Math.hypot(r,l)<1e-4&&(r=1,l=0);const h=Math.atan2(s.z,s.x);for(const p of[-1,1])L2(t,a+s.x*i+r*p*i*.7,o,n+s.z*i+l*p*i*.7,h+p*1.05,p,e*.92,.78);const c=ae*.26*e,d=.8;for(let p=0;p<9;p++){const u=p/9*Ce+Math.random()*.6,f=(2.3+Math.random()*1.5)*e,m=Math.random();Hn(t,m<.32?"rice":m<.66?"bean":m<.85?"cheese":"salsa",a+Math.cos(u)*c,o,n+Math.sin(u)*c,Math.cos(u)*f+s.x*d,1.9+Math.random()*1.3,Math.sin(u)*f+s.z*d,e,.42+Math.random()*.14)}for(let p=0;p<6;p++){const u=p/6*Ce+Math.random()*.9,f=(2.4+Math.random()*1.6)*e;$o(t,a+Math.cos(u)*c,o,n+Math.sin(u)*c,Math.cos(u)*f+s.x*d,1.8+Math.random()*1.4,Math.sin(u)*f+s.z*d,(.9+Math.random()*.5)*e,.44+Math.random()*.12)}for(let p=0;p<4;p++){const u=Math.random()*Ce,f=(2.7+Math.random()*1.8)*e;Dn(t,a+Math.cos(u)*c*.9,o,n+Math.sin(u)*c*.9,Math.cos(u)*f+s.x*d,1.6+Math.random()*1.6,Math.sin(u)*f+s.z*d,(.8+Math.random()*.6)*e,.36+Math.random()*.12)}}function P2(t,e){const a=t.direction,{x:o,y:n,z:s}=t.position;Bu(t,o,n,s,a.x*2.2+(Math.random()-.5)*.4,.7,a.z*2.2+(Math.random()-.5)*.4,e,.26);for(let i=0;i<5;i++)Hn(t,i%2===0?"rice":"bean",o,n,s,a.x*(1.5+Math.random()*1)+(Math.random()-.5)*.9,.7+Math.random()*.6,a.z*(1.5+Math.random()*1)+(Math.random()-.5)*.9,.9*e,.3);for(let i=0;i<4;i++)Dn(t,o,n,s,a.x*(1.7+Math.random()*1.2)+(Math.random()-.5)*.8,.8+Math.random()*.6,a.z*(1.7+Math.random()*1.2)+(Math.random()-.5)*.8,.8*e,.24);for(let i=0;i<3;i++)$o(t,o,n,s,a.x*(1.3+Math.random()*.9)+(Math.random()-.5)*.7,.6+Math.random()*.5,a.z*(1.3+Math.random()*.9)+(Math.random()-.5)*.7,.8*e,.26)}const $2=3.6,Nd=new it(1,14,10),B2=pa(4,()=>ua(Ti,{opacity:.85})),q2=pa(4,()=>ua(Qo,{opacity:.7}));function U2(t,e){let a=0;t.traverse(o=>{o.isMesh&&!o.name&&(o.name=`${e}Part${a++}`)})}const G2={Disc:{projectile(t){const e=H2(t.color);return e.position.copy(t.position),e},trail(t){z2(t)},impact(t){_2(t)},cast(t){P2(t,1)}},Roll:{impact(t){const e=Sl(t.damage);D2(t,1,.62),Al(t,e*.85);const{x:a,y:o,z:n}=t.position,s=t.direction,i=ae*.24*e;for(let r=0;r<5;r++){const l=r/5*Ce+Math.random()*.8,h=(2+Math.random()*1.3)*e;Hn(t,r%2===0?"rice":"guac",a+Math.cos(l)*i,o,n+Math.sin(l)*i,Math.cos(l)*h+s.x*.6,1.7+Math.random()*1.1,Math.sin(l)*h+s.z*.6,e,.38+Math.random()*.12)}for(let r=0;r<3;r++){const l=Math.random()*Ce,h=(2.2+Math.random()*1.4)*e;$o(t,a+Math.cos(l)*i,o,n+Math.sin(l)*i,Math.cos(l)*h+s.x*.6,1.6+Math.random()*1.2,Math.sin(l)*h+s.z*.6,.85*e,.4)}},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position;for(const s of[-.5,.5])Bu(t,a-e.z*s*ae*.12,o,n+e.x*s*ae*.12,e.x*2.6-e.z*s*1.2,.5,e.z*2.6+e.x*s*1.2,.9,.3);for(let s=0;s<5;s++)$o(t,a,o,n,e.x*(1.6+Math.random()*1.1)+(Math.random()-.5)*1,.6+Math.random()*.6,e.z*(1.6+Math.random()*1.1)+(Math.random()-.5)*1,.85,.28);for(let s=0;s<3;s++)Dn(t,a,o,n,e.x*(1.8+Math.random()*1)+(Math.random()-.5)*.9,.7+Math.random()*.5,e.z*(1.8+Math.random()*1)+(Math.random()-.5)*.9,.75,.24)}},Swarm:{projectile(t){const e=Fd(Cd(t));return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Pu(e,t.weapon,2.4);o.t+=o.rate*a,o.age+=a;const n=Math.sin(o.age*7.5+o.t)*ae*.085;if(e.position.x+=-t.direction.z*n,e.position.z+=t.direction.x*n,e.position.y+=Math.sin(o.age*5.2)*ae*.03,e.rotation.x=o.t*.8,e.rotation.z=Math.sin(o.t*.7)*.7,o.shed-=a,o.shed<=0){o.shed=.14+Math.random()*.08;const s=So();s.color.set(t.color),s.opacity=1;const i=new T(Ln,s);i.renderOrder=9;const r=e.position.x,l=e.position.y,h=e.position.z,c=ae*.03;i.position.set(r,l,h),i.scale.setScalar(c),t.spawnTransient(i,.26,(d,p)=>{i.position.set(r,l-.5*p*p,h),i.scale.setScalar(c*(1-d*.6)),s.opacity=1-d})}},impact(t){const e=Sl(t.damage)*.8,{x:a,y:o,z:n}=t.position,s=t.direction;Al(t,1);const i=ae*.28,r=Cd(t);for(let l=0;l<Od;l++){const h=l/Od*Ce+Math.random()*.8,c=(2.6+Math.random()*1.5)*e;F2(t,r,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*.7,1.8+Math.random()*1.2,Math.sin(h)*c+s.z*.7,1.15,.44+Math.random()*.1)}for(let l=0;l<4;l++){const h=l/4*Ce+Math.random()*.9,c=(2.5+Math.random()*1.5)*e;$o(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*.5,1.6+Math.random()*1.2,Math.sin(h)*c+s.z*.5,1+Math.random()*.4,.38)}},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position,s=(t.weapon.spreadDeg??40)*Math.PI/360,i=["guac","salsa","cheese","rice"];for(let c=0;c<12;c++){const d=(Math.random()*2-1)*s,p=Math.cos(d),u=Math.sin(d),f=e.x*p-e.z*u,m=e.x*u+e.z*p,g=1.8+Math.random()*1.4;Hn(t,i[c%4],a,o,n,f*g,.8+Math.random()*.7,m*g,.95,.34)}const r=v2();r.color.set(Ti),r.opacity=1;const l=new T(Tl,r);l.renderOrder=11;const h=Math.atan2(e.x,e.z);t.spawnTransient(l,.2,c=>{const d=1-Math.pow(1-c,2);l.position.set(a+e.x*d*ae*.3,o+d*ae*.05,n+e.z*d*ae*.3),l.rotation.set(0,h+d*.8,0),l.scale.set(ae*.2*(1+d*.5),ae*.01,ae*.05),r.opacity=1-c*c});for(let c=0;c<4;c++)Dn(t,a,o,n,e.x*(1.6+Math.random()*1.1)+(Math.random()-.5)*1.1,.8+Math.random()*.6,e.z*(1.6+Math.random()*1.1)+(Math.random()-.5)*1.1,.8,.26)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=new e.Group;o.name="teleBurritoRoot";const n=t.position.clone();n.y-=ae*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=B2(),i=new e.Mesh(Nd,s);i.name="teleBurritoBulge",o.add(i);const r=q2(),l=new e.Mesh(Nd,r);l.name="teleBurritoShell",o.add(l);const h=4,c=[];for(let g=0;g<h;g++){const w=Fd(g);w.name=`teleBurritoTopping${g}`,U2(w,`teleBurritoTopping${g}`),c.push(w),o.add(w)}const d=(g,w,b)=>{const y=e.MathUtils.clamp((g-w)/(b-w),0,1);return y*y*(3-2*y)},p=ae*.78,u=ae*.22,f=(t.weapon.spreadDeg??55)*Math.PI/360,m=(g,w)=>{const b=e.MathUtils.clamp(w/a,0,1),y=d(b,0,.4),v=d(b,.85,1),k=ae*(.13+.15*y)*(1-.35*v);i.position.set(0,p,u),i.scale.set(k,k*(.82+.25*Math.sin(b*11)),k),s.opacity=(.55+.4*y)*(1-v*.8);const M=ae*(.17-.05*y);l.position.set(0,p-ae*.04,u-ae*.16),l.scale.set(M,M*(1.25-.3*y),M),r.opacity=.62*(1-v*.9);for(let x=0;x<h;x++){const S=c[x],E=x*.09,A=d(b,.18+E,.85),C=(x/(h-1)-.5)*2*f,R=x/h*Ce+b*(3.2+2.4*A),I=e.MathUtils.lerp(R,C,v),N=ae*(.42+.34*A+.26*v);S.position.set(Math.sin(I)*N,p+Math.sin(R*1.6)*ae*.1*(1-v)+ae*.1*A,u+Math.cos(I)*N*(.55+.45*v));const L=2.2+($2-2.2)*A;S.scale.setScalar(L),S.rotation.set(b*4.2+x,b*3-x,b*2.4)}};m(0,0),t.spawnTransient(o,a+.06,m)}}},fo="#FFF8EA",vh="#E4D6AE",Si="#FFFFFF",kh="#4A3118",qu="#FF9E12",j2="#FFCE55",Uu="#F4FBFF",Os="#FFD84D",W2="#EFB528",Y2="#F5872B",V2="#2A2320",Gu="#FFF0B8",Te=J,De=Math.PI*2,io=.29,K2=Te*.31,X2=Te*.2,ju=Te*.03,Z2=Te*.062,J2=Te*.115,Q2=Te*.052,ex=Te*.16,tx=Te*.026,ax=Te*.045,Ga=Te*.125,lt=Te*.085,ys=Te*.115,ro=new Ko(.5,1,4);ro.rotateZ(-Math.PI/2);const Rl=new it(.5,16,11,0,Math.PI*1.5),ox=new Me(.5,.5,1,8,1,!0,-1.35,2.7),nx=new Me(.5,.5,1,8,1,!0,-1.2,2.4),Lo=new it(.5,12,10),Mh=new Ul(1,2.2,3,7);Mh.scale(.5,1/4.2,.5);Mh.rotateZ(-Math.PI/2);const Wu=new jl(.62,0),sx=new Ko(.5,1,3),ix=new dt(1,1,1),Yu=new Ko(.5,1,4);Yu.rotateX(Math.PI/2);function Gn(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const jn=(t,e={})=>new V({color:t,transparent:!0,opacity:1,depthWrite:!1,side:me,...e}),Vu=Gn(34,()=>jn(fo)),rx=Gn(18,()=>jn(qu)),lx=Gn(18,()=>jn(Uu)),hx=Gn(16,()=>jn(Gu)),Wo=Gn(40,()=>jn(Si)),ra=(t,e={})=>new V({color:t,side:me,...e}),vr=ra(fo),Il=ra(vh),cx=ra(fo),Ld=ra(Y2),dx=ra(V2),Dd=ra(W2),Hd=[ra(Os),ra(Os),ra(Os)];let px=0;const mn=new de,gn=new de,kr=new de,zd=new y0;function Ai(t,e,a,o){mn.set(e,a,o).normalize(),Math.abs(mn.y)>.94?gn.set(1,0,0):gn.set(0,1,0),kr.crossVectors(mn,gn).normalize(),gn.crossVectors(kr,mn).normalize(),zd.makeBasis(mn,gn,kr),t.quaternion.setFromRotationMatrix(zd)}function ux(t){return t.range&&t.speed?t.range/t.speed:co.normal/1e3}function Cl(t){return Y.clamp(.85+t*.035,.85,1.45)}function fx(t,e,a,o,n,s,i,r,l,h,c,d,p,u,f=-9){a.color.set(o),a.opacity=1;const m=new T(e,a);m.renderOrder=9,m.position.set(n,s,i),m.scale.set(c,d,p),m.rotation.set(Math.random()*De,Math.random()*De,Math.random()*De);const g=(Math.random()-.5)*20,w=(Math.random()-.5)*20,b=(Math.random()-.5)*20,y=m.rotation.x,v=m.rotation.y,k=m.rotation.z;t.spawnTransient(m,u,(M,x)=>{const S=s+l*x+.5*f*x*x,E=S<=io;m.position.set(n+r*x,E?io:S,i+h*x),E||m.rotation.set(y+g*x,v+w*x,k+b*x),a.opacity=1-Math.pow(M,2.4)})}function Ka(t,e,a,o,n,s,i,r,l){const h=Z2*r*(.75+Math.random()*.6);fx(t,Wu,Vu(),Math.random()<.3?vh:fo,e,a,o,n,s,i,h,h*.8,h,l)}function Mr(t,e,a,o,n,s,i,r,l){const h=rx();h.color.set(Math.random()<.3?j2:qu),h.opacity=1;const c=new T(Lo,h);c.renderOrder=9;const d=Q2*r*(.8+Math.random()*.6);c.position.set(e,a,o),c.scale.setScalar(d);const p=14+Math.random()*10,u=Math.random()*De;t.spawnTransient(c,l,(f,m)=>{const g=a+s*m-4.4*m*m;c.position.set(e+n*m,Math.max(io,g),o+i*m);const w=Math.sin(u+m*p)*.24;c.scale.set(d*(1+w),d*(1-w),d*(1+w*.4)),h.opacity=1-Math.pow(f,3)})}function Fs(t,e,a,o,n,s,i,r,l){const h=lx();h.color.set(Uu),h.opacity=.78;const c=new T(Mh,h);c.renderOrder=10,c.position.set(e,a,o);const d=ex*r*(.55+Math.random()*.4),p=tx*r*(.75+Math.random()*.5);Ai(c,n,s,i),c.scale.set(d,p,p),t.spawnTransient(c,l,(u,f)=>{const m=a+s*f-2.2*f*f;c.position.set(e+n*f,Math.max(io,m),o+i*f),c.scale.set(d*(1+u*1.5),p*(1-u*.4),p*(1-u*.4)),h.opacity=.78*(1-Math.pow(u,1.8))})}function Eh(t,e,a,o,n,s,i,r){const l=hx();l.color.set(Math.random()<.35?Os:Gu),l.opacity=1;const h=new T(sx,l);h.renderOrder=9;const c=ax*i*(.7+Math.random()*.6);h.position.set(e,a,o),h.scale.set(c,c*1.5,c*.35);const d=4+Math.random()*4,p=Math.random()*De;t.spawnTransient(h,r,(u,f)=>{h.position.set(e+n*f+Math.sin(p+f*d)*.1,a+.35*f-.55*f*f,o+s*f+Math.cos(p+f*d*.8)*.1),h.rotation.set(Math.sin(p+f*d)*1.5,f*2.2,Math.cos(p+f*d*.7)*1.2),l.opacity=1-Math.pow(u,2)})}function Ns(t,e,a,o=.13){const{x:n,y:s,z:i}=t.position,r=t.direction,l=Math.random()*De;for(let h=0;h<e;h++){const c=l+h/e*De+(Math.random()-.5)*.5,d=(h%3-1)*.42+(Math.random()-.5)*.2,p=Math.cos(d),u=Math.cos(c)*p,f=Math.sin(d),m=Math.sin(c)*p,g=Wo();g.color.set(h%2===0?Si:fo),g.opacity=1;const w=Wo();w.color.set(kh),w.opacity=1;const b=new T(ro,g),y=new T(ro,w);b.renderOrder=13,y.renderOrder=12;const v=K2,k=v+X2*a*(.7+Math.random()*.55),M=ju*(.8+Math.random()*.45),x=n+r.x*v*.22,S=i+r.z*v*.22,E=new ne;E.add(y,b),Ai(b,u,f,m),y.quaternion.copy(b.quaternion),t.spawnTransient(E,o,A=>{const C=1-Math.pow(1-A,2.4),R=Y.lerp(v,v+(k-v)*.45,C),I=Y.lerp(v+(k-v)*.35,k,C),N=Math.max(.02,I-R),L=(R+I)*.5;b.position.set(x+u*L,s+f*L,S+m*L),y.position.copy(b.position),b.scale.set(N,M,M),y.scale.set(N*1.06,M*2.6,M*2.6);const _=A<.45?1:1-(A-.45)/.55;g.opacity=_,w.opacity=_})}}function _d(t,e,a,o){const{x:n,z:s}=t.position,i=Math.random()*De,r=new ne,l=Wo();l.color.set(Si),l.opacity=1;const h=Wo();h.color.set(kh),h.opacity=1;const c=[];for(let u=0;u<e;u++){const f=i+u/e*De+(Math.random()-.5)*.55,m=new T(ro,h),g=new T(ro,l);m.renderOrder=10,g.renderOrder=11,m.scale.setScalar(0),g.scale.setScalar(0),Ai(g,Math.cos(f),0,Math.sin(f)),m.quaternion.copy(g.quaternion),r.add(m,g),c.push({face:g,seam:m,a:f,len:Te*(.16+Math.random()*.3)*a,w:Te*(.02+Math.random()*.014)*a})}const d=Te*.2*a,p=u=>{const f=1-Math.pow(1-Math.min(1,u/.22),2.6);for(const g of c){const w=Math.max(.001,g.len*f),b=d+w*.5,y=n+Math.cos(g.a)*b,v=s+Math.sin(g.a)*b;g.face.position.set(y,io+.012,v),g.seam.position.set(y,io,v),g.face.scale.set(w,Te*.006,g.w),g.seam.scale.set(w*1.05,Te*.004,g.w*2.1)}const m=u<.42?1:1-(u-.42)/.58;l.opacity=.92*m,h.opacity=.92*m};p(0),t.spawnTransient(r,o,p)}function Pd(t,e,a,o){const{x:n,y:s,z:i}=t.position,r=t.direction;let l=-r.z,h=r.x;Math.hypot(l,h)<1e-4&&(l=1,h=0);for(const c of[-1,1]){const d=Vu();d.color.set(c<0?fo:vh),d.opacity=1;const p=new T(Rl,d);p.renderOrder=10;const u=n+l*c*Te*.26*e,f=i+h*c*Te*.26*e,m=J2*2*e;p.position.set(u,s,f),p.scale.set(m,m*1.15,m),p.rotation.set(0,c*1.4,0);const g=l*c*a+r.x*a*.35,w=h*c*a+r.z*a*.35,b=1.6+Math.random()*.9,y=c*(6+Math.random()*4),v=(Math.random()-.5)*5;t.spawnTransient(p,o,(k,M)=>{const x=s+b*M-4.6*M*M;p.position.set(u+g*M,Math.max(io,x),f+w*M),p.rotation.set(v*M,c*1.4+y*M,c*.4),d.opacity=1-Math.pow(k,2.2)})}}function mx(t){const e=new ne,a=new ne;e.add(a);const o=Hd[px++%Hd.length];o.color.set(t);const n=Ga,s=new T(Lo,o);s.scale.set(n*2,n*1.85,n*1.9),s.position.y=n*.15,a.add(s);const i=new T(Lo,Dd);i.scale.set(n*1.5,n*.8,n*1.45),i.position.set(0,-n*.42,n*.18),a.add(i);const r=new T(Yu,Ld);r.scale.set(n*.55,n*.46,n*.7),r.position.set(0,n*.26,n*.92),a.add(r);for(const c of[-1,1]){const d=new T(Lo,dx);d.scale.setScalar(n*.34),d.position.set(c*n*.4,n*.62,n*.62),a.add(d);const p=new T(Lo,Dd);p.scale.set(n*.34,n*.85,n*1.05),p.position.set(c*n*.92,n*.08,-n*.1),p.rotation.z=c*.4,a.add(p),p.userData.__side=c;const u=new T(ix,Ld);u.scale.set(n*.18,n*.1,n*.44),u.position.set(c*n*.34,-n*.92,n*.12),a.add(u)}const l=new T(Rl,cx);l.scale.set(n*1.22,n*1,n*1.22),l.position.set(-n*.16,n*.88,-n*.22),l.rotation.set(Math.PI-.42,.7,.3),a.add(l);const h=new T(Rl,Il);return h.scale.set(n*1.08,n*.8,n*1.08),h.position.set(-n*.16,n*.86,-n*.22),h.rotation.set(Math.PI-.42,.7,.3),a.add(h),e.userData.__bob=a,e}function gx(t){const e=new ne;vr.color.set(t);const a=new T(ox,vr);a.scale.set(lt*2,ys,lt*2),e.add(a);const o=new T(nx,Il);o.scale.set(lt*1.78,ys*.92,lt*1.78),e.add(o);for(let s=0;s<2;s++){const i=new T(Wu,vr),r=lt*(.42+s*.18);i.scale.set(r,r*.7,r),i.position.set(lt*(s===0?.8:-.5),ys*(s===0?.45:-.5),lt*.4),i.rotation.set(Math.random()*2,Math.random()*2,Math.random()*2),e.add(i)}const n=new T(Lo,Il);return n.scale.set(lt*.75,lt*.4,lt*.75),n.position.set(-lt*.2,-ys*.34,0),e.add(n),e}function Ku(t,e,a){let o=t.userData.__anim;return o||(o={t:Math.random()*De,rate:a*De/ux(e.weapon),shed:0,age:0,lx:e.position.x,lz:e.position.z,speed:Xe(e.weapon.speed??160)},t.userData.__anim=o),o}function wx(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Ku(e,t,1);o.age+=a;const n=Math.hypot(t.position.x-o.lx,t.position.z-o.lz);a>0&&(o.speed=o.speed*.55+n/a*.45),o.lx=t.position.x,o.lz=t.position.z;const s=Xe(t.weapon.speed??160),i=o.speed<s*.28,r=e.userData.__bob;if(r)if(i){const l=o.age*2.2%1,h=Math.sin(Math.min(1,l*2.2)*Math.PI);r.position.set(0,-Ga*.3*h,Ga*.75*h),r.rotation.set(h*.95,0,0)}else{const l=o.age*7;r.position.set(0,Math.abs(Math.sin(l))*Ga*.22,0),r.rotation.set(0,0,Math.sin(l*.5)*.3);for(const h of r.children){const c=h.userData.__side;c!==void 0&&(h.rotation.z=c*(.4+Math.sin(l)*.5))}}o.shed-=a,o.shed<=0&&(o.shed=i?.1+Math.random()*.08:.2+Math.random()*.14,Eh(t,t.position.x+(Math.random()-.5)*Ga,t.position.y+Ga*.3,t.position.z+(Math.random()-.5)*Ga,-t.direction.x*.25+(Math.random()-.5)*.35,-t.direction.z*.25+(Math.random()-.5)*.35,1,.7))}const bx=Te*.27;function yx(t){const e=Cl(t.damage)*1.25,{x:a,y:o,z:n}=t.position,s=t.direction;Ns(t,4,e*1.15);const i=bx;for(let r=0;r<9;r++){const l=r/9*De+Math.random()*.6,h=(1.9+Math.random()*1.2)*e;Ka(t,a+Math.cos(l)*i,o,n+Math.sin(l)*i,Math.cos(l)*h+s.x*.5,1.5+Math.random()*1,Math.sin(l)*h+s.z*.5,1.2*e,.34)}for(let r=0;r<10;r++){const l=Math.random()*De;Eh(t,a+Math.cos(l)*i,o+Te*.05,n+Math.sin(l)*i,Math.cos(l)*(.9+Math.random()*.8),Math.sin(l)*(.9+Math.random()*.8),e*1.25,.62)}}function xx(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Ku(e,t,1.9);if(o.t+=o.rate*a,e.rotation.x=o.t,e.rotation.z=Math.sin(o.t*.7)*1,o.shed-=a,o.shed<=0){o.shed=.075+Math.random()*.05;const n=t.position.x-t.direction.x*lt,s=t.position.z-t.direction.z*lt;Math.random()<.45?Fs(t,n,t.position.y-lt*.3,s,-t.direction.x*.35+(Math.random()-.5)*.4,-.5-Math.random()*.4,-t.direction.z*.35+(Math.random()-.5)*.4,.6,.3):Ka(t,n,t.position.y,s,-t.direction.x*.7+(Math.random()-.5)*.6,.1+Math.random()*.3,-t.direction.z*.7+(Math.random()-.5)*.6,.7,.28)}}const vx={Tackle:{impact(t){const e=Cl(t.damage),{x:a,y:o,z:n}=t.position,s=t.direction;Ns(t,8,e),Pd(t,e*.95,2.4*e,.42),_d(t,7,e,.66);const i=Te*.26*e,r=.8;for(let l=0;l<5;l++){const h=l/5*De+Math.random()*.7,c=(2+Math.random()*1.2)*e;Mr(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*r,1.9+Math.random()*1.1,Math.sin(h)*c+s.z*r,e*1.15,.5+Math.random()*.12)}for(let l=0;l<6;l++){const h=l/6*De+Math.random()*.8,c=(2.4+Math.random()*1.5)*e;Fs(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*r,1.4+Math.random()*1,Math.sin(h)*c+s.z*r,e,.4+Math.random()*.12)}for(let l=0;l<11;l++){const h=Math.random()*De,c=(2.6+Math.random()*2)*e;Ka(t,a+Math.cos(h)*i*.9,o,n+Math.sin(h)*i*.9,Math.cos(h)*c+s.x*r,1.7+Math.random()*1.7,Math.sin(h)*c+s.z*r,(.9+Math.random()*.6)*e,.4+Math.random()*.14)}},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position,s=Math.atan2(e.x,e.z);for(let i=0;i<4;i++){const r=(i-1.5)*.34,l=Math.sin(s+r),h=Math.cos(s+r),c=(i%2-.5)*.35,d=Wo();d.color.set(i%2===0?Si:fo),d.opacity=1;const p=Wo();p.color.set(kh),p.opacity=1;const u=new T(ro,d),f=new T(ro,p);u.renderOrder=13,f.renderOrder=12;const m=new ne;m.add(f,u),Ai(u,l,c,h),f.quaternion.copy(u.quaternion);const g=ju*.85;t.spawnTransient(m,.17,w=>{const b=1-Math.pow(1-w,2.2),y=Te*.1+b*Te*.1,v=Te*(.12+b*.22),k=y+v*.5;u.position.set(a+l*k,o+c*k*.5,n+h*k),f.position.copy(u.position),u.scale.set(v,g,g),f.scale.set(v*1.06,g*2.6,g*2.6);const M=w<.5?1:1-(w-.5)/.5;d.opacity=M,p.opacity=M})}for(let i=0;i<8;i++)Ka(t,a,o,n,e.x*(1.5+Math.random()*1.1)+(Math.random()-.5)*.9,.7+Math.random()*.7,e.z*(1.5+Math.random()*1.1)+(Math.random()-.5)*.9,.9,.3);for(let i=0;i<3;i++)Mr(t,a,o,n,e.x*(1.2+Math.random()*.8)+(Math.random()-.5)*.6,.8+Math.random()*.5,e.z*(1.2+Math.random()*.8)+(Math.random()-.5)*.6,.9,.32)}},Hatch:{projectile(t){const e=mx(t.color);return e.position.copy(t.position),e},trail(t){wx(t)},impact(t){yx(t)},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position;Ns(t,6,.62,.14),Pd(t,.8,2,.4);for(let s=0;s<9;s++){const i=Math.random()*De;Eh(t,a+Math.cos(i)*Te*.1,o+Te*.06,n+Math.sin(i)*Te*.1,Math.cos(i)*(.8+Math.random()*.9)+e.x*.5,Math.sin(i)*(.8+Math.random()*.9)+e.z*.5,1.1,.8)}for(let s=0;s<5;s++)Ka(t,a,o,n,e.x*(1.2+Math.random()*.9)+(Math.random()-.5)*1,.8+Math.random()*.6,e.z*(1.2+Math.random()*.9)+(Math.random()-.5)*1,.85,.3)}},Shards:{projectile(t){const e=gx(t.color);return e.position.copy(t.position),e},trail(t){xx(t)},impact(t){const e=Cl(t.damage)*.9,{x:a,y:o,z:n}=t.position,s=t.direction;Ns(t,5,e*.82,.12),_d(t,5,e*.7,.6);const i=Te*.24*e,r=.7;for(let l=0;l<6;l++){const h=l/6*De+Math.random()*.8,c=(2.2+Math.random()*1.4)*e;Fs(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*r,1.4+Math.random()*1,Math.sin(h)*c+s.z*r,e*1.1,.42+Math.random()*.12)}for(let l=0;l<7;l++){const h=l/7*De+Math.random()*.9,c=(2.4+Math.random()*1.7)*e;Ka(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*c+s.x*r,1.6+Math.random()*1.4,Math.sin(h)*c+s.z*r,(.85+Math.random()*.5)*e,.38+Math.random()*.12)}for(let l=0;l<2;l++){const h=Math.random()*De;Mr(t,a+Math.cos(h)*i,o,n+Math.sin(h)*i,Math.cos(h)*2*e+s.x*r,1.7+Math.random()*.9,Math.sin(h)*2*e+s.z*r,e*.85,.44)}},cast(t){const e=t.direction,{x:a,y:o,z:n}=t.position,s=(t.weapon.spreadDeg??30)*Math.PI/360;for(let i=0;i<9;i++){const r=(Math.random()*2-1)*s,l=Math.cos(r),h=Math.sin(r),c=e.x*l-e.z*h,d=e.x*h+e.z*l,p=1.6+Math.random()*1.2;Ka(t,a,o,n,c*p,.7+Math.random()*.6,d*p,.95,.32)}for(let i=0;i<3;i++){const r=(Math.random()*2-1)*s,l=Math.cos(r),h=Math.sin(r),c=e.x*l-e.z*h,d=e.x*h+e.z*l;Fs(t,a,o,n,c*1.6,.5+Math.random()*.4,d*1.6,.85,.3)}}}},Oa="#E63946",Fa="#FFFDF9",Xu="#00E5B0",kx="#FFEAF1",Mx=.32,Ex=.34,$d=.36,Tx=.33,Er=.46;function Wn(t){const e=document.createElement("canvas");return e.width=t,e.height=t,e.getContext("2d")}function Yn(t){const e=new et(t.canvas);return e.anisotropy=8,e.needsUpdate=!0,e}function Sx(){const e=Wn(512),a=512/2,o=a,n=5,s=1.15,i=Math.PI/n*.52,r=56;e.fillStyle="#ffffff";for(let h=0;h<n;h++){const c=h/n*Math.PI*2;e.beginPath();for(let d=0;d<=r;d++){const p=d/r*o,u=c+s*Math.PI*2*(p/o)-i,f=a+Math.cos(u)*p,m=a+Math.sin(u)*p;d===0?e.moveTo(f,m):e.lineTo(f,m)}for(let d=r;d>=0;d--){const p=d/r*o,u=c+s*Math.PI*2*(p/o)+i;e.lineTo(a+Math.cos(u)*p,a+Math.sin(u)*p)}e.closePath(),e.fill()}e.globalCompositeOperation="destination-out";const l=e.createRadialGradient(a,a,o*.9,a,a,o);return l.addColorStop(0,"rgba(0,0,0,0)"),l.addColorStop(1,"rgba(0,0,0,1)"),e.fillStyle=l,e.fillRect(0,0,512,512),e.globalCompositeOperation="source-over",Yn(e)}function Ax(){const e=Wn(256),a=256/2,o=e.createRadialGradient(a,a,0,a,a,a);return o.addColorStop(0,"rgba(255,255,255,0.62)"),o.addColorStop(.55,"rgba(255,255,255,0.58)"),o.addColorStop(.88,"rgba(255,255,255,0.8)"),o.addColorStop(.975,"rgba(255,255,255,1)"),o.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=o,e.fillRect(0,0,256,256),Yn(e)}function Rx(){const e=Wn(512),a=512/2,o=a,n=o*.74;e.fillStyle="#ffffff",e.beginPath(),e.moveTo(a+o,a),e.arc(a,a,o,0,Math.PI*2,!1),e.moveTo(a+n,a),e.arc(a,a,n,0,Math.PI*2,!0),e.fill(),e.globalCompositeOperation="destination-out";const s=40;e.fillStyle="rgba(0,0,0,0.5)";for(let l=0;l<s;l++){const h=l/s*Math.PI*2,c=h+Math.PI/s;e.beginPath(),e.moveTo(a,a),e.arc(a,a,o,h,c),e.closePath(),e.fill()}const i=e.createRadialGradient(a,a,o*.96,a,a,o);i.addColorStop(0,"rgba(0,0,0,0)"),i.addColorStop(1,"rgba(0,0,0,1)"),e.fillStyle=i,e.fillRect(0,0,512,512);const r=e.createRadialGradient(a,a,n,a,a,n*1.22);return r.addColorStop(0,"rgba(0,0,0,1)"),r.addColorStop(1,"rgba(0,0,0,0)"),e.fillStyle=r,e.fillRect(0,0,512,512),e.globalCompositeOperation="source-over",Yn(e)}function Ix(){const e=Wn(512),a=512/2,o=e.createRadialGradient(a,a,0,a,a,a);return o.addColorStop(0,"rgba(255,255,255,0)"),o.addColorStop(.966,"rgba(255,255,255,0)"),o.addColorStop(.976,"rgba(255,255,255,1)"),o.addColorStop(.991,"rgba(255,255,255,1)"),o.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=o,e.fillRect(0,0,512,512),Yn(e)}function Cx(){const e=Wn(64),a=64/2,o=e.createRadialGradient(a,a,0,a,a,a);return o.addColorStop(0,"rgba(255,255,255,1)"),o.addColorStop(.35,"rgba(255,255,255,0.8)"),o.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=o,e.fillRect(0,0,64,64),Yn(e)}const Vn=Sx(),Th=Ax(),Ox=Rx(),Sh=Ix(),Ri=Cx(),gt=new po(1,96);gt.rotateX(-Math.PI/2);const Fx=new Me(1,1,.34,12),Zu=new Me(1,1,.22,44),Ju=new Me(.055,.055,1,10);function Ne(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Nx=Ne(3,()=>new V({map:Th,color:Oa,transparent:!0,opacity:.6,depthWrite:!1})),Lx=Ne(2,()=>new V({map:Vn,color:Fa,transparent:!0,opacity:.5,depthWrite:!1})),Dx=Ne(2,()=>new V({map:Vn,color:Oa,transparent:!0,opacity:.9,depthWrite:!1})),Hx=Ne(6,()=>new V({map:Vn,color:Fa,transparent:!0,opacity:.9,depthWrite:!1})),zx=Ne(3,()=>new V({map:Ox,color:Fa,transparent:!0,opacity:1,depthWrite:!1,blending:Qe})),Qu=Ne(4,()=>new V({map:Sh,color:Oa,transparent:!0,opacity:1,depthWrite:!1})),_x=Ne(2,()=>new V({map:Sh,color:Fa,transparent:!0,opacity:1,depthWrite:!1})),Px=Ne(10,()=>new V({map:Vn,color:Oa,transparent:!0,opacity:.9,depthWrite:!1})),$x=Ne(14,()=>new V({color:Oa,transparent:!0,opacity:1})),Bx=Ne(14,()=>new V({color:Fa,transparent:!0,opacity:1})),qx=Ne(24,()=>new Ot({map:Ri,color:kx,transparent:!0,opacity:1,depthWrite:!1,blending:Qe})),Ux=Ne(12,()=>new Ot({map:Ri,color:Xu,transparent:!0,opacity:1,depthWrite:!1,blending:Qe})),Gx=Ne(12,()=>new Ot({map:Ri,color:Oa,transparent:!0,opacity:1,depthWrite:!1})),jx=Ne(5,()=>new Ot({map:Ri,color:Xu,transparent:!0,opacity:1,depthWrite:!1})),Wx=Ne(2,()=>new V({color:Fa,transparent:!0,opacity:1})),Yx=Ne(2,()=>new V({color:"#FBF7EE",transparent:!0,opacity:1}));function Bd(t,e,a,o,n,s){const i=Px(),r=new T(gt,i);r.position.set(e,Tx,a),r.rotation.y=Math.random()*Math.PI*2,r.renderOrder=12;const l=(Math.random()<.5?-1:1)*(2.4+Math.random()*1.2),h=r.rotation.y;r.scale.setScalar(o*.35),t.spawnTransient(r,n,c=>{const d=1-Math.pow(1-Math.min(1,c*3.2),3);r.scale.setScalar(o*(.35+.65*d)),r.rotation.y=h+l*c*.35,i.opacity=s*(1-Math.pow(c,1.6))})}function qd(t,e,a,o,n,s,i){const r=Math.random()<.45?$x():Bx(),l=new T(Fx,r);l.scale.setScalar(s),l.position.set(e.x,e.y,e.z),l.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI);const h=e.x,c=e.y,d=e.z,p=1.5+Math.random()*1.9,u=-9.4,f=(Math.random()-.5)*16,m=(Math.random()-.5)*16;t.spawnTransient(l,i,(g,w)=>{l.position.set(h+a*n*w,Math.max(.08,c+p*w+.5*u*w*w),d+o*n*w),l.rotation.x+=f*.016,l.rotation.z+=m*.016,r.opacity=1-Math.pow(g,2.2)})}function $a(t,e,a,o,n,s,i,r,l=qx,h=0){const c=l(),d=new ya(c);d.position.set(e,a,o),d.scale.set(n,n,1),d.renderOrder=14,d.visible=h<=0;const p=(Math.random()-.5)*.5;t.spawnTransient(d,i+h,(u,f)=>{if(f<h){d.visible=!1;return}d.visible=!0;const m=Math.min(1,(f-h)/i),g=Y.lerp(n,s,m);d.scale.set(g,g,1),d.position.y=a+r*m,d.position.x=e+p*m,c.opacity=1-Math.pow(m,1.5)})}function Vx(t,e,a,o,n){const s=J*.85,i=J*1.7,r=new ne,l=Math.hypot(o,n)||1,h=s+J*.5;r.position.set(e+o/l*h,0,a+n/l*h);const c=Qu(),d=new T(gt,c);d.scale.setScalar(s*1.16),d.position.y=.115,d.renderOrder=12,r.add(d);const p=Wx(),u=new T(Zu,p);u.scale.set(s,1,s),r.add(u);const f=Dx(),m=new T(gt,f);m.scale.setScalar(s*.99),m.position.y=.13,m.renderOrder=13,r.add(m);const g=Yx(),w=new T(Ju,g);w.scale.set(1,i,1);const b=new de(-o,0,-n);b.lengthSq()<1e-6&&b.set(0,0,-1),b.normalize(),w.quaternion.setFromUnitVectors(new de(0,1,0),b),w.position.set(b.x*(s+i*.5)*.92,.05,b.z*(s+i*.5)*.92),r.add(w);const y=5.2,v=.09;t.spawnTransient(r,.75,(M,x)=>{if(x<v){const E=x/v;r.position.y=y*(1-E*E),r.scale.set(1,1,1)}else{const E=Math.min(1,(x-v)/.16);r.position.y=0;const A=1-.55*(1-E)*Math.cos(E*Math.PI*1.2);r.scale.set(1+(1-A)*.22,Math.max(.25,A),1+(1-A)*.22)}const S=M<.45?1:1-(M-.45)/.55;p.opacity=S,g.opacity=S,f.opacity=.9*S,c.opacity=S})}const ja=J*.85,xs=ja+J*.5,Ud=J*1.7,Kx="#3C0F12",Xx="#EC656F",Zx="#F5B0B5",Jx=Ne(2,()=>new V({map:Th,color:Kx,transparent:!0,opacity:0,depthWrite:!1})),Qx=Ne(2,()=>new V({map:Th,color:Xx,transparent:!0,opacity:0,depthWrite:!1})),ev=Ne(2,()=>new V({map:Sh,color:Zx,transparent:!0,opacity:0,depthWrite:!1})),tv=Ne(2,()=>new V({color:Fa,transparent:!0,opacity:1,depthWrite:!1})),av=Ne(2,()=>new V({map:Vn,color:Oa,transparent:!0,opacity:.95,depthWrite:!1})),ov=Ne(2,()=>new V({color:"#FBF7EE",transparent:!0,opacity:1,depthWrite:!1})),nv={Smash:{cast(t){const e=t.direction.x,a=t.direction.z,o=t.position.x-e*.75,n=t.position.z-a*.75,s=Math.atan2(a,e),i=J*1.15,r=Y.degToRad((t.weapon.cone??80)/2),l=J*.34;for(let h=0;h<2;h++){const c=h*.05,d=Hx();d.color.set(h===0?Fa:Oa);const p=new T(gt,d);p.scale.setScalar(l*(1-h*.16)),p.renderOrder=13;const u=h===0?.95:.42;t.spawnTransient(p,.2,f=>{const m=Y.clamp((f*.2-c)/.2,0,1),g=1-Math.pow(1-m,2),w=s-r+g*r*2;p.position.set(o+Math.cos(w)*i,Y.lerp(J*.8,.4,g),n+Math.sin(w)*i),p.rotation.y=w*1.6,d.opacity=u*(m<=0?0:1-Math.pow(f,2.4))})}for(let h=0;h<2;h++){const c=s+(Math.random()-.5)*r*1.4;$a(t,o+Math.cos(c)*i*1.05,J*.5,n+Math.sin(c)*i*1.05,J*.13,J*.03,.2,.25)}},impact(t){const{x:e,z:a}=t.position,o=Y.clamp(.85+t.damage*.03,.85,1.6);$a(t,e,t.position.y,a,J*.3*o,J*.6*o,.15,.1),Bd(t,e,a,J*.32*o,.5,.85);const n=6;for(let s=0;s<n;s++){const i=s/n*Math.PI*2+Math.random()*.7;qd(t,{x:e,y:t.position.y*.8,z:a},Math.cos(i),Math.sin(i),(1.7+Math.random()*1.9)*o,J*(.065+Math.random()*.03),.42+Math.random()*.18)}for(let s=0;s<3;s++){const i=Math.random()*Math.PI*2;$a(t,e+Math.cos(i)*.3,t.position.y+.1,a+Math.sin(i)*.3,J*.14,J*.04,.34,.5)}}},Giant:{cast(t){const{x:e,z:a}=t.position,o=Xe(t.weapon.range??0),n=Nx(),s=new T(gt,n);s.position.set(e,Mx,a),s.renderOrder=10,s.scale.setScalar(o*.12),t.spawnTransient(s,1,u=>{const f=1-Math.pow(1-Math.min(1,u/.26),3);s.scale.setScalar(o*(.12+.88*f)),n.opacity=.3*(u<.2?1:Math.pow(1-(u-.2)/.8,1.5))});for(const[u,f,m,g]of[[Qu(),1,.95,16],[_x(),.974,.9,17]]){const w=new T(gt,u);w.position.set(e,$d+.01,a),w.renderOrder=g,w.scale.setScalar(o*.12*f),t.spawnTransient(w,1,b=>{const y=1-Math.pow(1-Math.min(1,b/.26),3);w.scale.setScalar(o*(.12+.88*y)*f),u.opacity=m*(b<.42?1:Math.pow(1-(b-.42)/.58,1.4))})}const i=Lx(),r=new T(gt,i);r.position.set(e,Ex,a),r.renderOrder=11,r.scale.setScalar(o*.12),t.spawnTransient(r,1,u=>{const f=1-Math.pow(1-Math.min(1,u/.26),3);r.scale.setScalar(o*(.12+.88*f)),r.rotation.y=(1-Math.pow(1-u,2))*1.5,i.opacity=.4*(u<.22?1:Math.pow(1-(u-.22)/.78,1.5))});const l=zx(),h=new T(gt,l);h.position.set(e,$d,a),h.renderOrder=15,h.scale.setScalar(o*.05),t.spawnTransient(h,Er+.22,(u,f)=>{const m=Math.min(1,f/Er),g=1-Math.pow(1-m,2.2);h.scale.setScalar(o*(.05+.98*g)),h.rotation.y=g*.5,l.opacity=.95*(1-Math.pow(u,2.4))});const c=10,d=.55,p=Math.PI*(3-Math.sqrt(5));for(let u=0;u<c;u++){const f=o*d*Math.sqrt((u+.6)/c),m=u*p,g=e+Math.cos(m)*f,w=a+Math.sin(m)*f,b=f/o*Er;$a(t,g,.55,w,J*.2,J*.68,.3,.55,Gx,b),u%3===0&&$a(t,g,.5,w,J*.12,J*.34,.34,.7,jx,b+.03)}Vx(t,e,a,t.direction.x,t.direction.z)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1500)/1e3),o=new e.Group;o.name="teleLolliRoot";const n=t.position.clone();n.y-=J*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=Jx(),i=new e.Mesh(gt,s);i.name="teleLolliBase",i.scale.setScalar(ja),i.position.set(0,.02,xs),i.renderOrder=5,o.add(i);const r=Qx(),l=new e.Mesh(gt,r);l.name="teleLolliFill",l.position.set(0,.032,xs),l.renderOrder=5.01,o.add(l);const h=ev(),c=new e.Mesh(gt,h);c.name="teleLolliRim",c.scale.setScalar(ja*1.06),c.position.set(0,.044,xs),c.renderOrder=5.02,o.add(c);const d=new e.Group;d.name="teleLolliCandy",o.add(d);const p=tv(),u=new e.Mesh(Zu,p);u.name="teleLolliHead",u.scale.set(ja,1,ja),d.add(u);const f=av(),m=new e.Mesh(gt,f);m.name="teleLolliSwirl",m.scale.setScalar(ja*.99),m.position.y=.13,m.renderOrder=13,d.add(m);const g=ov(),w=new e.Mesh(Ju,g);w.name="teleLolliStick",w.scale.set(1,Ud,1),w.rotation.x=-Math.PI/2,w.position.z=-3.57*.92,d.add(w);const b=(v,k,M)=>{const x=e.MathUtils.clamp((v-k)/(M-k),0,1);return x*x*(3-2*x)},y=(v,k)=>{const M=e.MathUtils.clamp(k/a,0,1),x=b(M,0,.78),S=b(M,.78,1),E=.5+.5*Math.sin(Math.PI*2*(2*M+3*M*M));s.opacity=.6+.14*E;const A=ja*(.12+.88*M);l.scale.setScalar(A),r.opacity=.7+.22*M,h.opacity=.62+.36*M*M;const C=.28+.72*x;d.scale.setScalar(C),d.position.set(0,J*(.55+1.05*x+.55*S),xs*(.35+.65*x)-Ud*.1*S),d.rotation.y=M*(2.2+5.5*M),d.rotation.x=-.55*S;const R=.85+.15*E;p.opacity=R,g.opacity=R,f.opacity=.95*R};y(0,0),t.spawnTransient(o,a+.06,y)},impact(t){const{x:e,z:a}=t.position,o=Y.clamp(.9+t.damage*.035,.9,1.7);$a(t,e,t.position.y,a,J*.34*o,J*.62*o,.18,.12),Bd(t,e,a,J*.42*o,.62,.9);const n=8;for(let s=0;s<n;s++){const i=s/n*Math.PI*2+Math.random()*.6;qd(t,{x:e,y:t.position.y*.85,z:a},Math.cos(i),Math.sin(i),(2.1+Math.random()*2.2)*o,J*(.07+Math.random()*.035),.48+Math.random()*.2)}for(let s=0;s<4;s++){const i=s/4*Math.PI*2+Math.random();$a(t,e+Math.cos(i)*.34,t.position.y+.15,a+Math.sin(i)*.34,J*.11,J*.04,.42,.85,Ux)}}}},sv="#EFB868",iv="#CE8A2E",ef="#4A2A12",rv="#B93A28",Tn="#F7ECD3",xe=J,ct=Math.PI*2,Ii=.26;function mo(t,e=10){const a=new Wl(t,e);return a.rotateX(-Math.PI/2),a}function Ah(t,e){const a=Math.tan(e)*t,o=-t*.58,n=t*.42,s=new Ca;return s.moveTo(0,o),s.lineTo(-a,n),s.quadraticCurveTo(0,n+a*.5,a,n),s.closePath(),s}function lv(t){const e=new Ca;return e.moveTo(0,t),e.quadraticCurveTo(t*.82,t*.78,t*.96,-t*.06),e.quadraticCurveTo(t*.7,-t*.72,0,-t),e.quadraticCurveTo(-t*.84,-t*.66,-t,t*.04),e.quadraticCurveTo(-t*.7,t*.8,0,t),e}function tf(t,e,a=22){const o=new Ca;for(let n=0;n<=a;n++){const s=n/a*ct,i=1+Math.sin(s*3+t)*.17+Math.sin(s*5+e)*.11,r=Math.cos(s)*i,l=Math.sin(s)*i;n===0?o.moveTo(r,l):o.lineTo(r,l)}return o}function hv(t){const e=new Ca;return e.moveTo(-t,0),e.lineTo(t,0),e.lineTo(0,1),e.closePath(),e}const Do=xe*.3,Sn=xe*.16,Ls=xe*.18,Gd=mo(Ah(Do,.44),8),Ds=mo(lv(Ls),8),Rh=(()=>{const t=new po(1,12);return t.rotateX(-Math.PI/2),t})(),jd=(()=>{const t=new po(Sn,20);t.rotateX(-Math.PI/2);const e=t.attributes.position;for(let a=1;a<e.count;a++){const o=e.getX(a),n=e.getZ(a),s=Math.atan2(n,o),i=1+Math.sin(s*3)*.13+Math.sin(s*7+1.3)*.075;e.setX(a,o*i),e.setZ(a,n*i)}return e.needsUpdate=!0,t})(),Wd=mo(Ah(xe*.105,.52),4),af=mo(Ah(1,.62),3),of=mo(tf(0,2.1),1),cv=mo(tf(1.7,4.3),1),dv=mo(hv(.16),1),nf=(()=>{const t=new Ea(.62,1,18,1,0,Math.PI*.8);return t.rotateX(-Math.PI/2),t})(),pv=(()=>{const t=new po(xe*.032,6);return t.rotateX(-Math.PI/2),t})(),uv=(()=>{const t=new dt(xe*.022,1,xe*.022);return t.translate(0,-.5,0),t})();function go(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Na=t=>new V({color:t,side:me}),Yd=Na("#F6E3B4"),Vd=Na("#E63946"),Kd=Na("#FFD873"),fv=Na(sv),sf=Na(iv),mv=Na(rv),gv=Na(Tn),wv=Na(ef),bv=go(20,()=>new V({color:"#E63946",transparent:!0,opacity:1,side:me,depthWrite:!1})),rf=go(24,()=>new V({color:ef,transparent:!0,opacity:1,side:me,depthWrite:!1})),lf=go(10,()=>new V({color:"#B62430",transparent:!0,opacity:.9,side:me,depthWrite:!1})),yv=go(28,()=>new V({color:Tn,transparent:!0,opacity:.9,side:me,depthWrite:!1})),hf=go(8,()=>new V({color:"#FFE9A8",transparent:!0,opacity:.9,side:me,blending:Qe,depthWrite:!1})),cf=go(16,()=>new V({color:"#FFD9A0",transparent:!0,opacity:.5,side:me,blending:Qe,depthWrite:!1})),Tr=go(12,()=>new V({color:"#FFD873",transparent:!0,opacity:.95,side:me,depthWrite:!1})),xv=new de(0,1,0),Xd=new de,Zd=new de,Sr=new ui,Jd=new ui;function Ao(t,e,a,o){Sr.setFromAxisAngle(xv,a);const n=Math.hypot(e.x,e.z);Math.abs(o)>1e-4&&n>1e-4?(Xd.set(e.z/n,0,-e.x/n),Jd.setFromAxisAngle(Xd,o),t.quaternion.copy(Jd).multiply(Sr)):t.quaternion.copy(Sr)}function Ih(t,e,a){const o=new ne,n=new T(t,wv);return n.scale.set(a,1,a),n.position.y=-xe*.011,o.add(n),o.add(new T(t,e)),o}function vv(t){return t.range&&t.speed?t.range/t.speed:co.normal/1e3}function Ar(t,e,a){let o=t.userData.__spin;return o||(o={spin:Math.random()*ct,rate:a*ct/vv(e),shed:0},t.userData.__spin=o),o}function Qd(t,e,a,o){const n=cf();n.color.set(o),n.opacity=.45;const s=new T(nf,n);s.renderOrder=9,s.position.copy(t.position),s.rotation.y=a,s.scale.set(e,1,e),t.spawnTransient(s,.13,i=>{const r=e*(1+i*.28);s.scale.set(r,1,r),n.opacity=.45*(1-i)})}function ma(t,e,a,o,n,s,i,r,l){const h=yv();h.color.set(a),h.opacity=.9;const c=new T(pv,h);c.renderOrder=9,c.position.copy(e),c.scale.setScalar(r);const d=e.x,p=e.y,u=e.z;t.spawnTransient(c,l,(f,m)=>{c.position.set(d+o*m,Math.max(Ii,p+n*m+.5*i*m*m),u+s*m),h.opacity=.9*(1-f*f)})}function Rr(t,e,a,o,n,s,i){const r=new ne,l=rf();l.opacity=1;const h=new T(Wd,l);h.scale.set(1.22,1,1.22),h.position.y=-xe*.008,r.add(h);const c=bv();c.color.set(a),c.opacity=1,r.add(new T(Wd,c)),r.renderOrder=9,r.position.copy(e),r.scale.setScalar(s);const d=e.x,p=e.y,u=e.z,f=Math.cos(o),m=Math.sin(o),g=f*n,w=m*n,b=.8+Math.random()*.9,y=-7.5,v=Math.random()*ct,k=(Math.random()-.5)*24;t.spawnTransient(r,i,(M,x)=>{r.position.set(d+g*x,Math.max(Ii,p+b*x+.5*y*x*x),u+w*x),Zd.set(f,0,m),Ao(r,Zd,v+k*x,.22);const S=1-Math.pow(M,2.2);c.opacity=S,l.opacity=S})}function kv(t,e,a,o,n,s){const i=new ne;i.position.set(t.position.x,Ii,t.position.z),i.renderOrder=4;const r=lf();r.color.set(e),r.opacity=s;const l=new T(Math.random()<.5?of:cv,r);l.rotation.y=Math.random()*ct,i.add(l);for(let h=0;h<o;h++){const c=new T(dv,r);c.rotation.y=h/o*ct+Math.random()*.7,c.scale.set(.7+Math.random()*.4,1,1+Math.random()*.4),i.add(c)}t.spawnTransient(i,n,h=>{const c=1-Math.pow(1-Math.min(1,h*5),3);i.scale.set(a*c,1,a*c),r.opacity=s*(h<.55?1:1-(h-.55)/.45)})}function Ir(t,e,a,o){const n=hf();n.color.set(e),n.opacity=.9;const s=new T(af,n);s.renderOrder=11,s.position.copy(t.position),s.rotation.y=Math.random()*ct,s.scale.set(a*.35,1,a*.35),t.spawnTransient(s,o,i=>{const r=Y.lerp(a*.35,a,1-Math.pow(1-i,2));s.scale.set(r,1,r),n.opacity=.9*(1-i)})}function Cr(t){return Y.clamp(.85+t*.035,.85,1.4)}function Mv(t){const e=Ih(Gd,fv,1.15);Vd.color.set(t);const a=new T(Gd,Vd);a.scale.set(.86,1,.86),a.position.set(0,xe*.006,Do*.04),e.add(a);for(const[o,n,s]of[[-.2,-.1,.075],[.15,.11,.06]]){const i=new T(Rh,mv);i.position.set(Do*o,xe*.012,Do*n),i.scale.setScalar(Do*s*2),e.add(i)}return e}function Ev(t){const e=Ih(jd,sf,1.13);Yd.color.set(t);const a=new T(jd,Yd);a.scale.set(.84,1,.84),a.position.y=xe*.006,e.add(a);const o=new T(Rh,gv);return o.scale.setScalar(Sn*.44),o.position.set(Sn*.4,xe*.011,-Sn*.26),e.add(o),e}function Tv(t){Kd.color.set(t);const e=Ih(Ds,Kd,1.12),a=new T(Rh,sf);return a.scale.setScalar(Ls*.22),a.position.set(Ls*.34,xe*.006,Ls*.2),e.add(a),e}const Sv={Dough:{projectile(t){const e=Ev(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Ar(e,t.weapon,2.6);o.spin+=o.rate*a,Ao(e,t.direction,o.spin,.15+Math.sin(o.spin*.37)*.07),e.position.y+=Math.sin(o.spin*.5)*xe*.012,o.shed-=a,o.shed<=0&&(o.shed=.055+Math.random()*.04,ma(t,t.position,Tn,-t.direction.x*.5+(Math.random()-.5)*.5,.25+Math.random()*.4,-t.direction.z*.5+(Math.random()-.5)*.5,-1.1,.5+Math.random()*.35,.3+Math.random()*.15),Math.random()<.45&&Qd(t,Sn*1.2,o.spin,"#FFF0CC"))},impact(t){const e=Cr(t.damage),a=lf();a.color.set("#F0DDAE"),a.opacity=.95;const o=new T(of,a);o.renderOrder=4,o.position.set(t.position.x,Ii,t.position.z),o.rotation.y=Math.random()*ct;const n=xe*.25*e;t.spawnTransient(o,.62,s=>{const i=Y.lerp(n*.3,n,1-Math.pow(1-Math.min(1,s*4),3));o.scale.set(i,1,i),a.opacity=.95*(s<.5?1:1-(s-.5)/.5)}),Ir(t,"#FFF3D2",xe*.3*e,.18);for(let s=0;s<10;s++){const i=s/10*ct+Math.random()*.5,r=(.9+Math.random()*1.2)*e;ma(t,t.position,Tn,Math.cos(i)*r,.7+Math.random()*.9,Math.sin(i)*r,-2.4,.6+Math.random()*.6,.45+Math.random()*.25)}for(let s=0;s<4;s++)Rr(t,t.position,"#EFD9A6",Math.random()*ct,(1.9+Math.random()*1.3)*e,(.55+Math.random()*.35)*e,.4+Math.random()*.14)},cast(t){const e=cf();e.color.set("#FFF0CC"),e.opacity=.6;const a=new T(nf,e);a.renderOrder=11,a.position.copy(t.position),t.spawnTransient(a,.16,o=>{const n=Y.lerp(xe*.05,xe*.16,o);a.scale.set(n,1,n),a.rotation.y=o*9,e.opacity=.6*(1-o)});for(let o=0;o<5;o++)ma(t,t.position,Tn,t.direction.x*(.5+Math.random()*.6)+(Math.random()-.5)*.6,.5+Math.random()*.5,t.direction.z*(.5+Math.random()*.6)+(Math.random()-.5)*.6,-1.6,.55+Math.random()*.4,.3+Math.random()*.15)}},Tomato:{projectile(t){const e=Mv(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Ar(e,t.weapon,1.8);o.spin+=o.rate*a,Ao(e,t.direction,o.spin,.17+Math.sin(o.spin*.5)*.06),o.shed-=a,o.shed<=0&&(o.shed=.058,Qd(t,Do*.62,o.spin,"#FFC08A"),Math.random()<.5&&ma(t,t.position,"#C4262F",-t.direction.x*.7+(Math.random()-.5)*.4,.15+Math.random()*.3,-t.direction.z*.7+(Math.random()-.5)*.4,-2.2,.5+Math.random()*.3,.26))},impact(t){const e=Cr(t.damage);Ir(t,"#FFE7CC",xe*.4*e,.18),kv(t,t.color,xe*.22*e,4,.55,.9);for(let a=0;a<5;a++){const o=a/5*ct+Math.random()*.6;Rr(t,t.position,t.color,o,(2.2+Math.random()*1.4)*e,(.75+Math.random()*.45)*e,.4+Math.random()*.14)}for(let a=0;a<6;a++){const o=Math.random()*ct,n=(1.3+Math.random()*1.5)*e;ma(t,t.position,"#C4262F",Math.cos(o)*n,1+Math.random()*1.1,Math.sin(o)*n,-6.5,.7+Math.random()*.5,.34+Math.random()*.14)}},cast(t){const e=hf();e.color.set("#FF8E6A"),e.opacity=.85;const a=new T(af,e);a.renderOrder=11,a.position.copy(t.position),a.rotation.y=Math.atan2(t.direction.x,t.direction.z),t.spawnTransient(a,.15,o=>{const n=Y.lerp(xe*.08,xe*.24,1-Math.pow(1-o,2));a.scale.set(n*.7,1,n),e.opacity=.85*(1-o)});for(let o=0;o<3;o++)ma(t,t.position,"#C4262F",t.direction.x*(1+Math.random())+(Math.random()-.5)*.5,.4+Math.random()*.4,t.direction.z*(1+Math.random())+(Math.random()-.5)*.5,-2.6,.6,.28)}},Cheese:{projectile(t){const e=Tv(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Ar(e,t.weapon,.9);o.spin+=o.rate*a,Ao(e,t.direction,o.spin,.2*Math.sin(o.spin*1.9));const n=1+Math.sin(o.spin*2.4)*.22;e.scale.set(1/n,1,n),e.position.y+=Math.sin(o.spin*1.2)*xe*.016,o.shed-=a,o.shed<=0&&(o.shed=.13+Math.random()*.07,ma(t,t.position,"#FFE49A",-t.direction.x*.4,-.1,-t.direction.z*.4,-1.6,.5,.24))},impact(t){const e=Cr(t.damage),a=xe*.96,o=Tr();o.color.set(t.color),o.opacity=.95;const n=new T(Ds,o);n.renderOrder=11;const s=rf();s.opacity=.6;const i=new T(Ds,s);i.scale.set(1.12,1,1.12),i.position.y=-xe*.008,n.add(i),n.position.set(t.position.x,a,t.position.z);const r=1.8*e;t.spawnTransient(n,.5,l=>{const h=Y.lerp(r*.4,r,1-Math.pow(1-Math.min(1,l*3.5),3));n.scale.set(h,1,h*(1-l*.25)),n.position.y=a-l*l*xe*.34,Ao(n,t.direction,l*1.2,.35+l*.5);const c=l<.6?1:1-(l-.6)/.4;o.opacity=.95*c,s.opacity=.6*c}),Ir(t,"#FFF6D8",xe*.26*e,.17);for(let l=0;l<4;l++){const h=Tr();h.color.set("#FFE08A"),h.opacity=.9;const c=new T(uv,h);c.renderOrder=10;const d=Math.random()*ct,p=xe*(.06+Math.random()*.08)*e;c.position.set(t.position.x+Math.cos(d)*p,a-xe*.04,t.position.z+Math.sin(d)*p);const u=xe*(.14+Math.random()*.12)*e;t.spawnTransient(c,.42,f=>{c.scale.set(1-f*.55,u*(.3+f*.7),1-f*.55),h.opacity=.9*(1-f*f)})}for(let l=0;l<3;l++)Rr(t,t.position,"#FFD873",Math.random()*ct,(1+Math.random())*e,(.55+Math.random()*.3)*e,.38)},cast(t){const e=Tr();e.color.set(t.color),e.opacity=.85;const a=new T(Ds,e);a.renderOrder=11,a.position.copy(t.position),t.spawnTransient(a,.16,o=>{const n=Y.lerp(.3,.85,1-Math.pow(1-o,2));a.scale.set(n*(.5+o*.6),1,n),Ao(a,t.direction,o*2.4,.3-o*.25),e.opacity=.85*(1-o)});for(let o=0;o<3;o++)ma(t,t.position,"#FFE49A",t.direction.x*(.6+Math.random()*.5),.35+Math.random()*.3,t.direction.z*(.6+Math.random()*.5),-2,.55,.26)}}},Yo="#FFFDF6",df="#E4D7BE",Sa="#22301F",Av="#3E5B33",Ch=Wt.salmon,Oh="#B85B26",pf="#FFEEDD",uf="#F2FBFF",ff="#8FD3E8",Z=J,xt=Math.PI*2,Nt=.29;function mf(t,e=8){const a=new Wl(t,e);return a.rotateX(-Math.PI/2),a}const Dt=(()=>{const t=new no(1,1);return t.rotateX(-Math.PI/2),t})(),ep=(()=>{const t=new Ca;t.moveTo(0,0),t.quadraticCurveTo(1,.5,0,1),t.quadraticCurveTo(-1,.5,0,0);const e=mf(t,10);return e.translate(0,0,1),e})(),tp=(()=>{const e=new Ca;return e.moveTo(-.5+.22,-.5),e.lineTo(.5-.22,-.5),e.quadraticCurveTo(.5,-.5,.5,-.5+.22),e.lineTo(.5,.5-.22),e.quadraticCurveTo(.5,.5,.5-.22,.5),e.lineTo(-.5+.22,.5),e.quadraticCurveTo(-.5,.5,-.5,.5-.22),e.lineTo(-.5,-.5+.22),e.quadraticCurveTo(-.5,-.5,-.5+.22,-.5),mf(e,6)})(),Fh=(()=>{const t=new it(.5,7,5);return t.scale(.44,.44,1),t})(),Rv=new Me(.5,.5,1,20,1,!0),Or=(()=>{const t=new po(.5,20);return t.rotateX(-Math.PI/2),t})(),Iv=new Me(.5,.5,1,12,1,!0,0,Math.PI),ap=(()=>{const t=new po(.5,12,-Math.PI/2,Math.PI);return t.rotateX(-Math.PI/2),t})(),Cv=(()=>{const t=new no(1,1);return t.rotateY(-Math.PI/2),t})(),wt=Z*.155,gf=Z*.46,Hs=Z*.3,Bt=Z*.185,vs=Z*.2;function Pt(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Kn=t=>new V({color:t,side:me}),wf=Kn(Yo),Ov=Kn(df),bf=Kn(Sa),Fv=Kn(Oh),op=new Map;function Nh(t){let e=op.get(t);return e||(e=Kn(t),op.set(t,e)),e}const La=(t,e)=>new V({color:t,transparent:!0,opacity:e,side:me,depthWrite:!1}),yf=(t,e)=>new V({color:t,transparent:!0,opacity:e,side:me,depthWrite:!1,depthTest:!1}),xf=Pt(56,()=>new V({color:Yo,transparent:!0,opacity:1,depthWrite:!1})),Nv=Pt(12,()=>yf(uf,1)),Lv=Pt(12,()=>yf(ff,.5)),Js=Pt(28,()=>La(Sa,1)),Qs=Pt(28,()=>La(Av,1)),Dv=Pt(24,()=>La(Ch,1)),Hv=Pt(24,()=>La(Oh,1)),zv=Pt(24,()=>La(pf,1)),_v=Pt(12,()=>La(Sa,1)),Pv=Pt(12,()=>La(Yo,1)),$v=Pt(12,()=>La(Ch,1));function qt(t,e){return Math.atan2(t,e)}function Bv(t,e=.62){const a=Math.sin(t),o=Math.cos(t);if(Math.abs(a)>=e)return t;const n=a>=0?1:-1,s=o>=0?1:-1;return Math.atan2(n*e,s*Math.sqrt(1-e*e))}function Fr(t){return t.range&&t.speed?t.range/t.speed:co.normal/1e3}function ks(t){return Y.clamp(.85+t*.035,.85,1.4)}function Nr(t){let e=t.userData.__sushi;return e||(e={phase:Math.random()*xt,shed:0,grow:0},t.userData.__sushi=e),e}function Ms(t,e,a,o,n,s,i,r){const l=new ne,h=Bv(n);l.rotation.y=h,l.position.set(e-Math.sin(h)*s*.5,a,o-Math.cos(h)*s*.5),l.renderOrder=13;const c=Lv();c.color.set(ff),c.opacity=.55;const d=new T(ep,c);d.scale.set(2.9,1,1.02),d.position.y=-Z*.006,d.renderOrder=0,l.add(d);const p=Nv();p.color.set(uf),p.opacity=1;const u=new T(ep,p);u.renderOrder=1,l.add(u),t.spawnTransient(l,r,f=>{const m=Math.min(1,f*8);l.scale.set(i*(1-f*.55),1,Math.max(.02,s*m));const g=f<.3?1:1-(f-.3)/.7;p.opacity=g,c.opacity=.55*g*g})}function Ba(t,e,a,o,n,s,i,r,l,h=!1){const c=xf();c.color.set(h?df:Yo),c.opacity=1;const d=new T(Fh,c);d.renderOrder=9,d.scale.setScalar(r),d.position.set(e,a,o);const p=-9.6,u=(Math.random()-.5)*14,f=(Math.random()-.5)*14;t.spawnTransient(d,l,(m,g)=>{let w=a+s*g+.5*p*g*g,b=1;if(w<Nt){const y=Nt-w;w=Nt+y*.28,b=.35,w<Nt&&(w=Nt)}d.position.set(e+n*g,w,o+i*g*1),d.rotation.set(u*g*b,f*g*b,0),c.opacity=1-m*m*m})}function qv(t,e,a){const o=new ne,n=new T(tp,a.deep);n.scale.set(t*1.16,1,e*1.1),n.position.y=-Z*.008,o.add(n);const s=new T(tp,a.face);s.scale.set(t,1,e),o.add(s);for(let i=0;i<2;i++){const r=new T(Dt,a.fat);r.scale.set(t*.86,1,e*.09),r.position.set(0,Z*.005,e*(i===0?-.18:.16)),o.add(r)}return o}function np(t,e,a){const o=new ne,n=new T(Iv,a.wall);n.scale.set(t*2,e,t*2),o.add(n);const s=new T(ap,a.face);s.scale.set(t*1.6,1,t*1.6),s.position.y=e*.5,o.add(s);const i=new T(ap,a.core);i.scale.set(t*.94,1,t*.94),i.position.y=e*.5+Z*.004,o.add(i);const r=new T(Cv,a.face);return r.scale.set(1,e*.98,t*1.96),o.add(r),o}function Uv(t){const e=new ne,a=t==="#FFFFFF"?wf:Nh(t),o=[[0,0,wt*.34,1],[-wt*.4,Z*.012,-wt*.3,.85],[wt*.38,-Z*.014,-wt*.42,.78]];for(let n=0;n<o.length;n++){const[s,i,r,l]=o[n],h=new T(Fh,n===1?Ov:a);h.scale.setScalar(wt*l),h.position.set(s,i,r),h.rotation.set(0,(n-1)*.5,0),e.add(h)}return e}function sp(t){const e=new ne,a=[],o=4,n=gf/o,s=Nh(t);for(let r=0;r<o;r++){const l=new ne,h=new T(Dt,bf);h.scale.set(Hs,1,n*1.02),l.add(h);for(const c of[-1,1]){const d=new T(Dt,s);d.scale.set(Hs*.1,1,n*1.02),d.position.set(c*Hs*.45,Z*.004,0),l.add(d)}l.position.z=(r-(o-1)/2)*n,e.add(l),a.push(l)}const i={segs:a};return e.userData.__parts=i,e}function ip(t){const e=new ne,a=new T(Rv,bf);a.scale.set(Bt*2,vs,Bt*2),e.add(a);const o=new T(Or,wf);o.scale.set(Bt*1.6,1,Bt*1.6),o.position.y=vs*.5,e.add(o);const n=new T(Or,Nh(t));n.scale.set(Bt*.94,1,Bt*.94),n.position.y=vs*.5+Z*.004,e.add(n);const s=new T(Or,Fv);return s.scale.set(Bt*.34,1,Bt*.34),s.position.set(Bt*.46,vs*.5+Z*.005,-Bt*.3),e.add(s),e}const Gv=1.9;function rp(t,e){let a=0;t.traverse(o=>{o.isMesh&&!o.name&&(o.name=`${e}Part${a++}`)})}const jv={Rice:{projectile(t){const e=Uv(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Nr(e);o.phase+=a/Fr(t.weapon)*xt*1.6,e.rotation.y=qt(t.direction.x,t.direction.z)+Math.sin(o.phase)*.3;const n=1+Math.sin(o.phase*1.9)*.14;e.scale.set(n,1,1/n);for(let s=0;s<e.children.length;s++)e.children[s].rotation.x=o.phase*(.6+s*.35);o.shed-=a,o.shed<=0&&(o.shed=.1+Math.random()*.06,Ba(t,t.position.x,t.position.y,t.position.z,-t.direction.x*.5+(Math.random()-.5)*.7,-.15,-t.direction.z*.5+(Math.random()-.5)*.7,wt*.75,.3+Math.random()*.12,Math.random()<.4))},impact(t){const e=ks(t.damage),{x:a,y:o,z:n}=t.position,s=t.direction,i=Z*.26*e;for(let c=0;c<7;c++){const d=c/7*xt+Math.random()*.7,p=(1.9+Math.random()*1.5)*e;Ba(t,a+Math.cos(d)*i,o,n+Math.sin(d)*i,Math.cos(d)*p+s.x*.7,1.5+Math.random()*1.2,Math.sin(d)*p+s.z*.7,wt*(.9+Math.random()*.5)*e,.44+Math.random()*.16,Math.random()<.35)}const r=Math.hypot(s.x,s.z)>1e-4?Z*.34:0,l=xf();l.color.set(Yo),l.opacity=1;const h=new T(Fh,l);h.renderOrder=12,h.position.set(a-s.x*r,o,n-s.z*r),h.rotation.y=qt(s.x,s.z)+Math.PI*.5,t.spawnTransient(h,.14,c=>{h.scale.setScalar(Y.lerp(Z*.12,Z*.3,c)*e),l.opacity=1-c})},cast(t){const e=t.direction;for(let a=0;a<6;a++)Ba(t,t.position.x,t.position.y,t.position.z,e.x*(1.5+Math.random()*1.2)+(Math.random()-.5)*1.1,.5+Math.random()*.5,e.z*(1.5+Math.random()*1.2)+(Math.random()-.5)*1.1,wt*(.7+Math.random()*.4),.3+Math.random()*.12,Math.random()<.4)}},Seaweed:{projectile(t){const e=sp(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Nr(e);o.phase+=a/Fr(t.weapon)*xt*2.8,e.rotation.y=qt(t.direction.x,t.direction.z);const n=e.userData.__parts;if(n)for(let s=0;s<n.segs.length;s++){const i=o.phase-s*1.1;n.segs[s].rotation.x=Math.sin(i)*.42,n.segs[s].position.y=Math.sin(i)*Z*.03}o.shed-=a,o.shed<=0&&(o.shed=.14+Math.random()*.08,Lr(t,t.position.x,t.position.y,t.position.z,-t.direction.x*.5+(Math.random()-.5)*.6,-.05,-t.direction.z*.5+(Math.random()-.5)*.6,Z*.075,.28,t.color))},impact(t){const e=ks(t.damage),a=t.direction,o=qt(a.x,a.z),{x:n,y:s,z:i}=t.position,r=new ne;r.rotation.y=o,r.position.set(n+a.x*Z*.42,Nt,i+a.z*Z*.42),r.renderOrder=5;const l=Qs();l.color.set(t.color),l.opacity=.95;const h=new T(Dt,l);h.scale.set(1.1,1,1.07),h.position.y=-.004,r.add(h);const c=Js();c.color.set(Sa),c.opacity=.95,r.add(new T(Dt,c));const d=Z*.42*e,p=Z*.72*e;t.spawnTransient(r,.85,f=>{const m=1-Math.pow(1-Math.min(1,f*8),3);r.scale.set(d,1,Math.max(.02,p*m));const g=f<.55?1:1-(f-.55)/.45;c.opacity=.95*g,l.opacity=.95*g});const u=Z*.28*e;for(let f=0;f<4;f++){const m=f/4*xt+Math.random()*.8,g=(1.7+Math.random()*1.2)*e;Wv(t,n+Math.cos(m)*u,s,i+Math.sin(m)*u,Math.cos(m)*g,1.3+Math.random()*1.1,Math.sin(m)*g,Z*(.34+Math.random()*.16)*e,.42+Math.random()*.14,t.color)}for(let f=0;f<5;f++){const m=Math.random()*xt;Lr(t,n+Math.cos(m)*u*.8,s,i+Math.sin(m)*u*.8,Math.cos(m)*(1.6+Math.random()*1.4),1.2+Math.random(),Math.sin(m)*(1.6+Math.random()*1.4),Z*.085*e,.36,t.color)}},cast(t){const e=t.direction,a=qt(e.x,e.z),o=new ne;o.rotation.y=a,o.position.copy(t.position),o.renderOrder=11;const n=Qs();n.color.set(t.color),n.opacity=1;const s=new T(Dt,n);s.scale.set(1.12,1,1.08),s.position.y=-Z*.006,o.add(s);const i=Js();i.color.set(Sa),i.opacity=1,o.add(new T(Dt,i)),t.spawnTransient(o,.18,r=>{const l=1-Math.pow(1-r,2);o.scale.set(Hs*(.5+l*.6),1,gf*(.25+l*.8)),o.position.set(t.position.x+e.x*l*Z*.16,t.position.y,t.position.z+e.z*l*Z*.16),i.opacity=1-r,n.opacity=1-r});for(let r=0;r<3;r++)Lr(t,t.position.x,t.position.y,t.position.z,e.x*(1+Math.random())+(Math.random()-.5)*.7,.4+Math.random()*.4,e.z*(1+Math.random())+(Math.random()-.5)*.7,Z*.08,.28,t.color)}},Fish:{impact(t){const e=ks(t.damage),a=t.direction,{x:o,y:n,z:s}=t.position,i=qt(a.x,a.z);Ms(t,o,n,s,i+Math.PI*.5,Z*.95*e,Z*.078,.28);const r=Z*.3*e;for(let l=0;l<5;l++){const h=l/5*xt+Math.random()*.5;Dr(t,o+Math.cos(h)*r,n,s+Math.sin(h)*r,h,(1.5+Math.random()*1)*e,Z*.16*e,Z*.3*e,.5+Math.random()*.16)}for(let l=0;l<8;l++){const h=Math.random()*xt,c=(1.7+Math.random()*1.4)*e;Ba(t,o+Math.cos(h)*r*.85,n,s+Math.sin(h)*r*.85,Math.cos(h)*c,1.4+Math.random()*1.2,Math.sin(h)*c,wt*(.85+Math.random()*.4)*e,.42+Math.random()*.14,Math.random()<.35)}},cast(t){const e=t.direction,a=qt(e.x,e.z);Ms(t,t.position.x,t.position.y,t.position.z,a+Math.PI*.42,Z*.5,Z*.062,.17);const o=(t.weapon.cone??150)*Math.PI/180;for(let n=0;n<3;n++){const s=(n-1)*o*.3,i=a+s;Dr(t,t.position.x,t.position.y,t.position.z,Math.atan2(Math.sin(i),Math.cos(i))-Math.PI*.5,1.5+Math.random()*.7,Z*.12,Z*.22,.34)}}},Catch:{projectile(t){const e=ip(t.color);return e.position.copy(t.position),e.scale.setScalar(.6),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Nr(e),n=Fr(t.weapon);o.phase+=a/n*xt*1.1,o.grow=Math.min(1,o.grow+a/n),e.rotation.y=o.phase;const s=Y.lerp(.6,1.28,1-Math.pow(1-o.grow,2));e.scale.setScalar(s),e.position.y+=Math.sin(o.phase*1.6)*Z*.02,o.shed-=a,o.shed<=0&&(o.shed=.1+Math.random()*.06,Ba(t,t.position.x,t.position.y,t.position.z,-t.direction.x*.6+(Math.random()-.5)*.8,.1,-t.direction.z*.6+(Math.random()-.5)*.8,wt*.8,.32,Math.random()<.4))},impact(t){const e=ks(t.damage),a=t.direction,{x:o,y:n,z:s}=t.position,r=qt(a.x,a.z)+Math.PI*.5;Ms(t,o,n,s,r,Z*1.12*e,Z*.085,.32);const l=Z*.25*e,h=Z*.26*e,c=new ne;c.rotation.y=r,c.position.set(o,n-Z*.05,s),c.renderOrder=10;const d=_v();d.color.set(Sa),d.opacity=1;const p=Pv();p.color.set(Yo),p.opacity=1;const u=$v();u.color.set(t.color),u.opacity=1;const f={wall:d,face:p,core:u},m=np(l,h,f),g=np(l,h,f);g.rotation.y=Math.PI,c.add(m,g);const w=Z*.185*e,b=Z*.4*e,y=n-Z*.05-(Nt+l*.6);t.spawnTransient(c,.55,k=>{const M=1-Math.pow(1-k,2),x=Y.lerp(w,b,M);m.position.x=x,g.position.x=-x,m.rotation.z=-M*.9,g.rotation.z=M*.9,c.position.y=n-Z*.05-y*M*M;const S=k<.6?1:1-(k-.6)/.4;d.opacity=S,p.opacity=S,u.opacity=S});const v=Z*.3*e;for(let k=0;k<9;k++){const M=k/9*xt+Math.random()*.6,x=(1.9+Math.random()*1.5)*e;Ba(t,o+Math.cos(M)*v,n,s+Math.sin(M)*v,Math.cos(M)*x,1.6+Math.random()*1.3,Math.sin(M)*x,wt*(.9+Math.random()*.5)*e,.46+Math.random()*.16,Math.random()<.35)}for(let k=0;k<2;k++){const M=r+(k===0?.6:-.6)+Math.PI*(k===0?0:1);Dr(t,o+Math.cos(M)*v,n,s+Math.sin(M)*v,M,(1.6+Math.random()*.9)*e,Z*.14*e,Z*.26*e,.48)}},cast(t){const e=t.direction,a=qt(e.x,e.z);Ms(t,t.position.x,t.position.y,t.position.z,a+Math.PI*.38,Z*.58,Z*.068,.18);for(let o=0;o<5;o++)Ba(t,t.position.x,t.position.y,t.position.z,e.x*(1.3+Math.random())+(Math.random()-.5)*.9,.5+Math.random()*.4,e.z*(1.3+Math.random())+(Math.random()-.5)*.9,wt*.8,.3,Math.random()<.4)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=new e.Group;o.name="teleSushiRoot";const n=t.position.clone();n.y-=Z*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=sp(t.color);s.name="teleSushiNori",rp(s,"teleSushiNori"),o.add(s);const i=Math.max(1,t.weapon.pellets??3),r=[];for(let p=0;p<i;p++){const u=ip(t.color);u.name=`teleSushiRoll${p}`,rp(u,`teleSushiRoll${p}`),r.push(u),o.add(u)}const l=(p,u,f)=>{const m=e.MathUtils.clamp((p-u)/(f-u),0,1);return m*m*(3-2*m)},h=(t.weapon.spreadDeg??40)*Math.PI/360,c=Z*.7,d=(p,u)=>{const f=e.MathUtils.clamp(u/a,0,1),m=l(f,0,.38),g=l(f,.88,1);s.position.set(Math.sin(f*3.1)*Z*.3,c+Z*(.7+.34*m),Z*(.1+.34*m)),s.rotation.set(-.95-.3*Math.sin(f*4.2),f*2.6,.35*Math.sin(f*3.4));const w=.85+.45*m;s.scale.set(w,1,w*(1+.25*Math.sin(f*5)));for(let b=0;b<i;b++){const y=r[b],v=b*.1,k=l(f,.15+v,.88),M=i===1?0:(b/(i-1)-.5)*2*h,x=b/i*xt+f*(2.4+2*k),S=e.MathUtils.lerp(x,M,g),E=Z*(.62+.3*k+.34*g);y.position.set(Math.sin(S)*E,c+Math.sin(x*1.4)*Z*.14*(1-g)+Z*.16*k,Math.cos(S)*E*(.6+.4*g)),y.scale.setScalar(1.1+(Gv-1.1)*k),y.rotation.y=x*1.5}};d(0,0),t.spawnTransient(o,a+.06,d)}}};function Lr(t,e,a,o,n,s,i,r,l,h){const c=new ne,d=Qs();d.color.set(h),d.opacity=1;const p=new T(Dt,d);p.scale.set(r*1.3,1,r*.75),p.position.y=-Z*.005,c.add(p);const u=Js();u.color.set(Sa),u.opacity=1;const f=new T(Dt,u);f.scale.set(r,1,r*.55),c.add(f),c.renderOrder=9,c.position.set(e,a,o),c.rotation.y=Math.random()*xt;const m=(Math.random()-.5)*9,g=-5.2;t.spawnTransient(c,l,(w,b)=>{c.position.set(e+n*b,Math.max(Nt,a+s*b+.5*g*b*b),o+i*b),c.rotation.y+=m*.016,u.opacity=1-w*w,d.opacity=1-w*w})}function Wv(t,e,a,o,n,s,i,r,l,h){const c=new ne,d=Qs();d.color.set(h),d.opacity=1;const p=new T(Dt,d);p.scale.set(Z*.075,1,r*1.03),p.position.y=-Z*.006,c.add(p);const u=Js();u.color.set(Sa),u.opacity=1;const f=new T(Dt,u);f.scale.set(Z*.05,1,r),c.add(f),c.renderOrder=9,c.position.set(e,a,o);const m=-5.6,g=(Math.random()-.5)*4.5;t.spawnTransient(c,l,(w,b)=>{c.position.set(e+n*b,Math.max(Nt,a+s*b+.5*m*b*b),o+i*b),c.rotation.y=qt(n,i)+g*b,c.scale.set(1+w*.5,1,1-w*.35),u.opacity=1-w*w,d.opacity=1-w*w})}function Dr(t,e,a,o,n,s,i,r,l){const h=Dv();h.color.set(Ch),h.opacity=1;const c=Hv();c.color.set(Oh),c.opacity=1;const d=zv();d.color.set(pf),d.opacity=1;const p=qv(i,r,{face:h,deep:c,fat:d});p.renderOrder=9,p.position.set(e,a,o),p.rotation.y=n+Math.PI*.5;const u=Math.cos(n)*s,f=Math.sin(n)*s,m=.9+Math.random()*.7,g=-7.8,w=(Math.random()-.5)*2.2;t.spawnTransient(p,l,(b,y)=>{const v=a+m*y+.5*g*y*y,k=v<=Nt;p.position.set(e+u*y,k?Nt:v,o+f*y),p.rotation.y=n+Math.PI*.5+w*y;const M=1-Math.pow(b,2.4);h.opacity=M,c.opacity=M,d.opacity=M})}function Yv(t){const e=t.replace("#","");return[0,2,4].map(a=>parseInt(e.slice(a,a+2),16)/255)}function Vv(t){return`#${t.map(e=>Math.round(Math.max(0,Math.min(1,e))*255).toString(16).padStart(2,"0").toUpperCase()).join("")}`}function lp(t){return .2126*t[0]+.7152*t[1]+.0722*t[2]}function Kv([t,e,a]){const o=Math.max(t,e,a),n=Math.min(t,e,a),s=(o+n)/2,i=o-n;if(i===0)return[0,0,s];const r=s>.5?i/(2-o-n):i/(o+n);return[(o===t?(e-a)/i+(e<a?6:0):o===e?(a-t)/i+2:(t-e)/i+4)*60,r,s]}function hp([t,e,a]){const o=(t%360+360)%360/360,n=a<.5?a*(1+e):a+e-a*e,s=2*a-n,i=r=>{const l=(r+1)%1;return l<1/6?s+(n-s)*6*l:l<.5?n:l<2/3?s+(n-s)*(2/3-l)*6:s};return[i(o+1/3),i(o),i(o-1/3)]}function vf(t,e,a,o){const n=Yv(t),[s,i]=Kv(n),r=lp(n)+o,l=s+e,h=Math.max(0,Math.min(1,i+a));let c=0,d=1;for(let p=0;p<32;p++){const u=(c+d)/2;lp(hp([l,h,u]))<r?c=u:d=u}return Vv(hp([l,h,(c+d)/2]))}function kf(t){const e=re.soup.weapons.find(a=>a.key===t);if(!e)throw new Error(`soup vfx: no weapon '${t}' in CHARACTERS.soup.weapons`);return e.color}const Ci=kf("Splash"),Oi=vf(Ci,7.1,.195,.196),Fi=vf(Ci,-6.4,.07,-.212),Xv="#FFF2E2",Lh=kf("Noodle"),oe=J,We=.27,wn=oe*.3,Zv=oe*.34,Hr=oe*.55,ao=oe*.042,Je=oe*.085,Ht=oe*.4,Jv=oe*.024;function Mf(t){let e=t%2147483647;return e<=0&&(e+=2147483646),()=>(e=e*48271%2147483647,e/2147483647)}function zr(t,e){const o=Mf(t),n=o()*Math.PI*2,s=o()*Math.PI*2,i=o()*Math.PI*2,r=[];for(let u=0;u<e;u++)r.push([o()*Math.PI*2,.14+o()*.2,.16+o()*.14]);const l=[];let h=0;for(let u=0;u<=84;u++){const f=u/84*Math.PI*2;let m=1+.15*Math.sin(3*f+n)+.09*Math.sin(5*f+s)+.05*Math.sin(8*f+i);for(const[g,w,b]of r){let y=f-g;for(;y>Math.PI;)y-=Math.PI*2;for(;y<-Math.PI;)y+=Math.PI*2;m+=w*Math.exp(-(y*y)/(2*b*b))}l.push(m),m>h&&(h=m)}const c=new Float32Array(258);for(let u=0;u<=84;u++){const f=u/84*Math.PI*2,m=l[u]/h,g=(u+1)*3;c[g]=Math.cos(f)*m,c[g+1]=0,c[g+2]=Math.sin(f)*m}const d=[];for(let u=1;u<=84;u++)d.push(0,u+1,u);const p=new Pn;return p.setAttribute("position",new Rn(c,3)),p.setIndex(d),p.computeVertexNormals(),p}const cp=[zr(9173,4),zr(48271,5),zr(11071,3)];let Qv=0;const Ef=()=>cp[Qv++%cp.length],zn=new it(1,9,7);zn.scale(.78,.78,1.4);const Qa=new it(1,10,8),e5=new Me(1,.34,1,24,1,!0),t5=(()=>{const e=document.createElement("canvas");e.width=e.height=64;const a=e.getContext("2d"),o=a.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);o.addColorStop(0,"rgba(255,255,255,0.95)"),o.addColorStop(.45,"rgba(255,255,255,0.52)"),o.addColorStop(.78,"rgba(255,255,255,0.14)"),o.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=o,a.fillRect(0,0,64,64);const n=new et(e);return n.colorSpace=di,n})();function _r(t){const e=Mf(t),a=1.1+e()*1.4,o=.9+e()*1.3,n=.13+e()*.11,s=.08+e()*.09,i=[],r=8;for(let l=0;l<r;l++){const h=l/(r-1);i.push(new de(Math.sin(h*Math.PI*a+t)*n,Math.cos(h*Math.PI*o+t)*s,h-.5))}return new km(new Mm(i),20,Jv/Ht,5,!1)}const dp=[_r(7919),_r(30011),_r(65449)];let a5=0;const Dh=()=>dp[a5++%dp.length];function ut(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Tt=(t,e)=>new V({color:t,transparent:!0,opacity:e,depthWrite:!1,side:me}),Tf=ut(10,()=>Tt(Fi,.9)),o5=ut(10,()=>Tt(Oi,.9)),Sf=ut(28,()=>Tt(Ci,.95)),ei=ut(14,()=>Tt(Oi,.95)),n5=ut(16,()=>Tt(Lh,1)),s5=ut(6,()=>Tt(Fi,.85)),Ol=ut(6,()=>Tt(Ci,1)),i5=ut(6,()=>Tt(Oi,1)),r5=ut(12,()=>Tt(Lh,1)),l5=ut(3,()=>Tt(Fi,.92)),h5=ut(3,()=>Tt(Oi,.9)),c5=ut(6,()=>Tt(Lh,1)),d5=ut(16,()=>new Ot({map:t5,color:Xv,transparent:!0,opacity:.5,depthWrite:!1})),p5=ut(8,()=>new V({color:"#FFF4DF",transparent:!0,opacity:.9,depthWrite:!1,blending:Qe})),Es=new de,u5=new de(0,0,1);function ti(t,e,a,o){Es.set(e,a,o),!(Es.lengthSq()<1e-9)&&(Es.normalize(),t.quaternion.setFromUnitVectors(u5,Es))}function Aa(t,e,a,o,n,s,i,r,l,h=!1){const c=new T(zn,h?ei():Sf()),d=c.material,p=.95;d.opacity=p,c.position.set(e,a,o);const u=-9.4;t.spawnTransient(c,l,(f,m)=>{const g=a+s*m+.5*u*m*m,w=g<=We;c.position.set(e+n*m,w?We:g,o+i*m);const b=s+u*m;if(w)ti(c,n,0,i),c.scale.set(r*1.5,r*.3,r*1.7);else{ti(c,n,b,i);const y=Math.hypot(n,b,i),v=1+Math.min(.9,y*.075);c.scale.set(r/Math.sqrt(v),r/Math.sqrt(v),r*v)}d.opacity=p*(1-f*f)})}function oo(t,e,a,o,n,s,i){const r=new ya(d5()),l=r.material;l.opacity=0;const h=(Math.random()-.5)*n*1.6,c=(Math.random()-.5)*n*1.6;r.renderOrder=9,r.position.set(e,a,o),r.scale.set(n*1.1,n*1.1,1),t.spawnTransient(r,i,d=>{const p=1-Math.pow(1-d,2);r.position.set(e+h*p,a+s*p,o+c*p);const u=n*(1.1+p*1.5);r.scale.set(u,u,1),l.opacity=.5*Math.sin(Math.min(1,d*1.3)*Math.PI)})}function Hh(t,e,a,o,n){const s=Ef(),i=Math.random()*Math.PI*2,r=new T(s,Tf()),l=r.material;r.rotation.y=i,r.position.set(e,We,a),r.renderOrder=6,r.scale.setScalar(o*.35);const h=new T(s,o5()),c=h.material;h.rotation.y=i+.7,h.position.set(e,We+.01,a),h.renderOrder=7,h.scale.setScalar(o*.18);const d=p=>p<.34?1-Math.pow(1-p/.34,2.2):1;t.spawnTransient(r,n,p=>{r.scale.setScalar(o*Y.lerp(.35,1,d(p))),l.opacity=.82*(1-Math.pow(p,1.5))}),t.spawnTransient(h,n*.86,p=>{h.scale.setScalar(o*Y.lerp(.18,.62,d(p))),c.opacity=.9*(1-Math.pow(p,1.8))})}function f5(t,e,a,o,n){const s=new T(e5,s5()),i=s.material;i.color.set(Fi),i.opacity=.85,s.rotation.y=Math.random()*Math.PI*2,s.renderOrder=8;const r=o*.78,l=h=>{const c=h<.5?1-Math.pow(1-h/.5,2.4):1,d=o*Y.lerp(.24,1,c),p=r*Y.lerp(1,.18,c);s.position.set(e,We+p*.5,a),s.scale.set(d,p,d),i.opacity=.85*(1-Math.pow(h,1.6))};l(0),t.spawnTransient(s,n,l)}function zh(t,e,a,o,n){const s=new T(Qa,p5()),i=s.material;s.position.set(e,a,o),s.scale.set(n,n*.55,n),t.spawnTransient(s,.19,r=>{const l=n*Y.lerp(.9,1.7,r);s.scale.set(l,l*.5,l),i.opacity=.9*(1-r)*(1-r)})}function ai(t,e,a,o,n,s,i,r,l){const h=new T(Dh(),n5()),c=h.material;c.opacity=1,h.position.set(e,a,o),h.scale.setScalar(r);const d=-9.4,p=6+Math.random()*6,u=Math.atan2(n,i)+(Math.random()-.5)*.8;t.spawnTransient(h,l,(f,m)=>{const g=a+s*m+.5*d*m*m;g<=We+.02?(h.position.set(e+n*m,We+.02,o+i*m),h.quaternion.identity(),h.rotation.set(0,u,0),h.scale.set(r,r*.55,r)):(h.position.set(e+n*m,g,o+i*m),ti(h,n,s+d*m,i),h.rotateZ(m*p)),c.opacity=1-Math.pow(f,3)})}function m5(t){const e=new ne,a=new T(zn,Ol());a.material.color.set(t),a.scale.setScalar(Je),a.position.z=Je*.4,e.add(a);const o=new T(Qa,i5());o.scale.setScalar(Je*.5),o.position.set(Je*.25,Je*.4,Je*.85),e.add(o);for(let n=0;n<2;n++){const s=new T(zn,Ol());s.material.color.set(t);const i=Je*(.44-n*.13);s.scale.setScalar(i),s.position.set((Math.random()-.5)*Je*.5,(Math.random()-.5)*Je*.4,-Je*(1.05+n*.95)),e.add(s)}return e.userData.__head=a,e}const g5={projectile(t){const e=m5(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=(e.userData.__phase??Math.random()*6)+a*17;e.userData.__phase=o;const n=1+Math.sin(o)*.22;e.scale.set(1/Math.sqrt(n),1/Math.sqrt(n),n);const s=e.userData.__head;s&&(s.position.x=Math.sin(o*.55)*Je*.3);const i=(e.userData.__drip??.04)-a;i<=0?(e.userData.__drip=.055+Math.random()*.045,Aa(t,t.position.x-t.direction.x*Je*1.6,t.position.y-Je*.4,t.position.z-t.direction.z*Je*1.6,-t.direction.x*.5+(Math.random()-.5)*.5,-.3-Math.random()*.4,-t.direction.z*.5+(Math.random()-.5)*.5,ao*(.5+Math.random()*.4),.3)):e.userData.__drip=i;const r=(e.userData.__steam??.09)-a;r<=0?(e.userData.__steam=.13+Math.random()*.09,oo(t,t.position.x,t.position.y+Je,t.position.z,oe*.075,oe*.14,.34)):e.userData.__steam=r},impact(t){const{x:e,z:a}=t.position,o=t.direction;let n=o.x,s=o.z;const i=Math.hypot(n,s);i<1e-4?(n=1,s=0):(n/=i,s/=i),zh(t,e,t.position.y*.55,a,oe*.19);const r=wn*.85;Hh(t,e+n*r,a+s*r,wn,.42),f5(t,e+n*r*.45,a+s*r*.45,wn*1.15,.24);for(let l=0;l<7;l++){const h=l/7*Math.PI*2+Math.random()*.6,c=1.7+Math.random()*1.5;Aa(t,e+Math.cos(h)*wn*.55,t.position.y*.5,a+Math.sin(h)*wn*.55,Math.cos(h)*c+n*.9,2.1+Math.random()*1.2,Math.sin(h)*c+s*.9,ao*(1+Math.random()*.7),.36+Math.random()*.12,l%3===0)}oo(t,e+n*r*.6,We+oe*.05,a+s*r*.6,oe*.14,oe*.3,.5)},cast(t){const e=t.direction,a=new T(zn,ei()),o=a.material;a.position.copy(t.position),ti(a,e.x,-.25,e.z),t.spawnTransient(a,.16,n=>{a.position.set(t.position.x+e.x*n*oe*.2,t.position.y-n*oe*.07,t.position.z+e.z*n*oe*.2);const s=oe*(.05+n*.05);a.scale.set(s*1.5,s*.8,s*(1.6+n)),o.opacity=.95*(1-n*n)});for(let n=0;n<4;n++){const s=(Math.random()-.5)*.8,i=(Math.random()-.5)*.8;Aa(t,t.position.x,t.position.y,t.position.z,e.x*(1.6+Math.random())+s,.7+Math.random()*.9,e.z*(1.6+Math.random())+i,ao*(.5+Math.random()*.4),.3)}oo(t,t.position.x,t.position.y,t.position.z,oe*.09,oe*.2,.34)}};function w5(t){const e=new ne,a=[];for(let n=0;n<3;n++){const s=new T(Dh(),r5());s.material.color.set(t),s.scale.setScalar(Ht*.62),s.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),s.position.set((Math.random()-.5)*Ht*.22,(Math.random()-.5)*Ht*.22,(Math.random()-.5)*Ht*.22),e.add(s),a.push(s)}const o=new T(Qa,Ol());return o.scale.setScalar(Je*.62),e.add(o),e.userData.__strands=a,e}const b5={projectile(t){const e=w5(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=e.userData.__strands;if(o)for(let s=0;s<o.length;s++){const i=o[s];i.rotation.x+=a*(3.4+s*1.7),i.rotation.z+=a*(2.1+s*1.1)}const n=(e.userData.__drip??.06)-a;n<=0?(e.userData.__drip=.085+Math.random()*.06,Aa(t,t.position.x,t.position.y-Ht*.2,t.position.z,(Math.random()-.5)*.7,-.2-Math.random()*.5,(Math.random()-.5)*.7,ao*(.45+Math.random()*.35),.32)):e.userData.__drip=n},impact(t){const{x:e,z:a}=t.position;zh(t,e,t.position.y*.55,a,oe*.18),Hh(t,e,a,Zv,.48);for(let o=0;o<5;o++){const n=o/5*Math.PI*2+Math.random()*.7,s=1.3+Math.random()*1.2;ai(t,e,t.position.y*.7,a,Math.cos(n)*s,1.5+Math.random()*1.1,Math.sin(n)*s,Ht*(.7+Math.random()*.45),.7+Math.random()*.15)}for(let o=0;o<4;o++){const n=Math.random()*Math.PI*2,s=1.2+Math.random()*1.3;Aa(t,e,t.position.y*.6,a,Math.cos(n)*s,1.8+Math.random()*1.1,Math.sin(n)*s,ao*(.6+Math.random()*.5),.36,o===0)}oo(t,e,We+oe*.05,a,oe*.15,oe*.32,.55)},cast(t){const e=t.direction;ai(t,t.position.x,t.position.y,t.position.z,e.x*1.4,1.5,e.z*1.4,Ht*.7,.26);for(let a=0;a<3;a++)Aa(t,t.position.x,t.position.y,t.position.z,e.x*1.2+(Math.random()-.5)*.8,.9+Math.random()*.7,e.z*1.2+(Math.random()-.5)*.8,ao*.55,.28)}},y5={cast(t){const e=t.direction,a=Xe(t.weapon.range??Va.meleeHeavy),o=t.position.x,n=t.position.y,s=t.position.z,i=-e.z,r=e.x;for(let d=0;d<13;d++){const p=(d/12-.5)*2,u=p*a*.16+(Math.random()-.5)*a*.06,f=1.1+Math.random()*1.5-Math.abs(p)*.35,m=oe*(.055+Math.random()*.055)*(1-Math.abs(p)*.25);Aa(t,o+i*u,n+oe*(.05+Math.random()*.12),s+r*u,e.x*f+i*p*.35,.5+Math.random()*.7,e.z*f+r*p*.35,m,.42+Math.random()*.16,d%4===0)}for(let d=0;d<3;d++){const p=new T(Qa,d===1?ei():Sf()),u=p.material,f=.35+d*.5,m=o+e.x*a*.1,g=s+e.z*a*.1,w=n+oe*.1;p.position.set(m,w,g),t.spawnTransient(p,.4,y=>{const v=y*y;p.position.set(m+e.x*f*a*.28*y,Math.max(We,w-v*oe*.8),g+e.z*f*a*.28*y),p.scale.set(oe*(.13+y*.1),oe*(.13-y*.09),oe*(.13+y*.1)),u.opacity=.85*(1-Math.pow(y,1.7))})}for(let d=0;d<3;d++){const p=(d-1)*.5;ai(t,o+i*p*a*.1,n,s+r*p*a*.1,e.x*(1.6+Math.random())+i*p,.9+Math.random()*.6,e.z*(1.6+Math.random())+r*p,Ht*(.8+Math.random()*.4),.6)}const l=Ef(),h=new T(l,Tf()),c=h.material;h.position.set(o+e.x*a*.26,We,s+e.z*a*.26),h.rotation.y=Math.atan2(e.x,e.z),h.renderOrder=6,t.spawnTransient(h,.6,d=>{const p=d<.45?1-Math.pow(1-d/.45,2):1;h.scale.set(a*.13*p+.05,1,a*.3*p+.05),c.opacity=.8*(1-Math.pow(d,2.2))});for(let d=0;d<3;d++)oo(t,o+e.x*a*(.12+d*.13),We+oe*.06,s+e.z*a*(.12+d*.13),oe*.16,oe*.42,.6)},telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=new e.Group;o.name="teleSoupRoot";const n=t.position.clone();n.y-=oe*.55,o.position.copy(n),o.rotation.y=Math.atan2(t.direction.x,t.direction.z);const s=new e.Group;s.name="teleSoupTilt",o.add(s);const i=l5(),r=new e.Mesh(Qa,i);r.name="teleSoupBroth",s.add(r);const l=h5(),h=new e.Mesh(Qa,l);h.name="teleSoupLip",s.add(h);const c=3,d=[];for(let m=0;m<c;m++){const g=new e.Mesh(Dh(),c5());g.name=`teleSoupNoodle${m}`,d.push(g),s.add(g)}const p=(m,g,w)=>{const b=e.MathUtils.clamp((m-g)/(w-g),0,1);return b*b*(3-2*b)},u=oe*.98,f=(m,g)=>{const w=e.MathUtils.clamp(g/a,0,1),b=p(w,0,.45),y=p(w,.25,.85),v=p(w,.85,1),k=oe*(.45+.22*b),M=Math.sin(w*(7+9*y));r.position.set(Math.sin(w*(5+7*y))*oe*.06*y,u+oe*.1*b,oe*.3*y),r.scale.set(k*(1+.1*M),k*(.72-.1*M),k),i.opacity=.8+.15*b;const x=k*(.48+.3*v);h.position.set(r.position.x,r.position.y+k*(.3-.34*v),r.position.z+k*(.42+.55*v)),h.scale.set(x,x*.55,x),l.opacity=.35+.6*v+.15*y;for(let S=0;S<c;S++){const E=d[S],A=S/c*Math.PI*2+w*3.4,C=p(w,.25+S*.08,.9),R=k*(.35+.75*C);E.position.set(r.position.x+Math.cos(A)*R,r.position.y+k*(.35+.45*C),r.position.z+Math.sin(A)*R*.7),E.scale.setScalar(Ht*(.5+.85*C)),E.rotation.set(A*1.3,w*4.1+S,A*.8),E.material.opacity=.55+.45*C}s.rotation.x=v*.75+y*.12};f(0,0),t.spawnTransient(o,a+.06,f)},impact(t){const{x:e,z:a}=t.position,o=new T(Qa,ei()),n=o.material;o.position.set(e,We,a),t.spawnTransient(o,.16,s=>{const i=1-Math.pow(1-s,2.6),r=oe*Y.lerp(.42,.05,i),l=oe*Y.lerp(.13,.4,i);o.position.set(e,We+r*.5,a),o.scale.set(l,r,l),n.opacity=.95*(1-Math.pow(s,2.5))}),zh(t,e,t.position.y*.5,a,oe*.3),Hh(t,e,a,Hr,.62);for(let s=0;s<11;s++){const i=s/11*Math.PI*2+Math.random()*.5,r=2.2+Math.random()*2.2;Aa(t,e+Math.cos(i)*oe*.12,We+oe*.1,a+Math.sin(i)*oe*.12,Math.cos(i)*r,2.6+Math.random()*1.8,Math.sin(i)*r,ao*(.9+Math.random()*.8),.45+Math.random()*.15,s%3===0)}for(let s=0;s<4;s++){const i=s/4*Math.PI*2+Math.random(),r=1.5+Math.random()*1.3;ai(t,e,We+oe*.15,a,Math.cos(i)*r,2+Math.random()*1.2,Math.sin(i)*r,Ht*(.85+Math.random()*.45),.85)}oo(t,e,We+oe*.05,a,oe*.22,oe*.6,.8);for(let s=0;s<3;s++){const i=s/3*Math.PI*2+Math.random();oo(t,e+Math.cos(i)*Hr*.55,We+oe*.03,a+Math.sin(i)*Hr*.55,oe*.14,oe*.4,.7)}}},x5={Splash:g5,Noodle:b5,Dump:y5},Yt=.09,v5=J*.075,k5=J*.1,pp=Ja*.5,_h=new Em(Yt,0);_h.scale(.55,1.7,.55);const Fl=new it(Yt*.24,6,6);function Da(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const Af=Da(24,()=>new V({color:"#BFEFFF",transparent:!0,opacity:.8,depthWrite:!1})),M5=Da(8,()=>new V({color:"#FFFFFF",transparent:!0,opacity:1,blending:Qe,depthWrite:!1})),up=Da(6,()=>new V({color:"#EAFBFF",transparent:!0,opacity:.95,blending:Qe,depthWrite:!1}));function fp(t){const e=new ne,a=4;for(let n=0;n<a;n++){const s=Af();s.color.set(t);const i=new T(_h,s),r=n/a*Math.PI*2;i.position.set(Math.cos(r)*Yt*.5,(Math.random()-.5)*Yt*.6,Math.sin(r)*Yt*.5),i.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),i.scale.setScalar(.6+Math.random()*.5),e.add(i)}const o=new T(Fl,M5());return e.add(o),e.userData.__glint=o,e}const Ts=J*1,E5=new Me(.3,.36,.66,14,1,!1),T5=new it(.3,14,8),S5=new Me(.15,.24,.16,12,1,!1),A5=new Me(.185,.185,.14,12,1,!1),R5=new Me(.26,.31,.6,12,1,!1),I5=new it(J*.09,7,6),C5=new Me(1,1,1,16,1,!0),mp=new Ea(.72,1,28),O5=Da(8,()=>new V({color:"#7FD4F5",transparent:!0,opacity:.42,depthWrite:!1,side:me})),F5=Da(4,()=>new V({color:"#BFEFFF",transparent:!0,opacity:.9,depthWrite:!1})),N5=Da(20,()=>new V({color:"#BFEFFF",transparent:!0,opacity:.9,depthWrite:!1})),L5=Da(6,()=>new V({color:"#1E90D8",transparent:!0,opacity:.95,depthWrite:!1})),Pr=Da(8,()=>new V({color:"#8FD9F7",transparent:!0,opacity:.9,blending:Qe,depthWrite:!1,side:me}));function gp(t){const e=new ne;e.name=t;const a=O5(),o=new T(E5,a);o.name=`${t}Body`,o.position.y=.33;const n=new T(T5,a);n.name=`${t}Shoulder`,n.position.y=.66,n.scale.set(1,.62,1);const s=new T(S5,a);s.name=`${t}Neck`,s.position.y=.8;const i=new T(R5,F5());i.name=`${t}Fill`,i.position.y=.3;const r=new T(A5,L5());return r.name=`${t}Cap`,r.position.y=.93,e.add(o,n,s,i,r),e.userData.__cap=r,e.userData.__fill=i,e}const D5={Mega:{telegraph(t){const e=t.THREE,a=Math.max(.2,(t.castMs??1100)/1e3),o=t.position.clone();o.y-=J*.55;const n=new e.Group;n.name="megaTelegraph",n.position.copy(o);const s=gp("megaSelfBottle"),i=gp("megaCapBottle");n.add(s,i);const r=[],l=16;for(let g=0;g<l;g++){const w=new e.Mesh(I5,N5());w.name=`megaLaunchStreak${g}`,w.scale.set(.8,2.6,.8),r.push(w),n.add(w)}const h=new e.Mesh(mp,Pr());h.name="megaMergeGlow",h.rotation.x=-Math.PI/2,h.visible=!1,n.add(h);const c=g=>g.userData.__cap,d=g=>g.userData.__fill,p=(g,w,b)=>{const y=e.MathUtils.clamp((g-w)/(b-w),0,1);return y*y*(3-2*y)},u=J*.85,f=2.05,m=(g,w)=>{const b=e.MathUtils.clamp(w/a,0,1),y=p(b,0,.38),v=p(b,.22,.62),k=p(b,.55,.88),M=p(b,.88,1),x=u*y;s.position.set(0,x,0),s.rotation.z=.24+.09*Math.sin(b*7);const S=Ts*(.55+.45*y);s.scale.setScalar(S);for(let N=0;N<l;N++){const L=N/l*Math.PI*2,_=N%4*.06,U=e.MathUtils.clamp((b-_)/.5,0,1),D=r[N],W=Ja*(.6+1.5*U);D.position.set(Math.cos(L)*W,J*(.05+1.25*U),Math.sin(L)*W),D.scale.set(.8*(1-U*.4),2.6*(1-U*.5),.8*(1-U*.4)),D.material.opacity=.9*(1-U)*(1-k)}const E=c(s);E.position.y=.93+v*.55,E.visible=v<.98;const A=v>.02;if(i.visible=A,A){const N=Ts*(.06+.62*v);i.scale.setScalar(N);const L=Ja*1.5*v*(1-k);i.position.set(L,x+S*.95+v*J*.42,0),i.rotation.z=-.3-.1*Math.sin(b*6),c(i).visible=v>.5}if(k>0){const N=Ts*e.MathUtils.lerp(1,f,k);s.scale.setScalar(N),s.position.set(0,u+J*.25*k,0),i.position.x*=1-k,i.position.y=s.position.y+N*.55,s.rotation.z=(.24+.09*Math.sin(b*7))*(1-k*.5);const L=Ts*e.MathUtils.lerp(.62,.02,k);i.scale.setScalar(Math.max(.001,L)),h.visible=k<.99,h.position.set(0,s.position.y+N*.45,0);const _=N*(.22+.3*k);h.scale.set(_,_,_),h.material.opacity=.75*Math.sin(Math.PI*k)}else h.visible=!1;const C=M*.85;n.rotation.z=-C*t.direction.x,n.rotation.x=C*t.direction.z;const R=d(s),I=.35+.65*b;R.scale.set(1,I,1),R.position.y=.3*I,R.material.opacity=.75+.25*M};m(0,0),t.spawnTransient(n,a+.06,m)},cast(t){const e=t.THREE,a=t.position.clone();a.y-=J*.55;const o=new e.Mesh(C5,Pr());o.name="megaPourColumn";const n=Ja*1.35,s=J*2.6;o.position.set(a.x,a.y+s*.5,a.z),o.scale.set(n,s,n),t.spawnTransient(o,.34,i=>{const r=Math.min(1,i*2.4),l=Math.max(0,(i-.42)/.58);o.position.y=a.y+s*.5*(1-.55*r),o.scale.set(n*(1+1.5*l),s*(1-.5*r),n*(1+1.5*l)),o.material.opacity=.85*(1-i*i)});for(let i=0;i<2;i++){const r=new e.Mesh(mp,Pr());r.name=`megaPourRing${i}`,r.rotation.x=-Math.PI/2,r.position.set(a.x,a.y+.05+i*.03,a.z);const l=i*.09;t.spawnTransient(r,.42+l,h=>{const c=Math.max(0,(h*(.42+l)-l)/.42),d=Ja*(.8+3.6*c);r.scale.set(d,d,d),r.material.opacity=.9*(1-c)})}}},Glass:{projectile(t){const e=fp(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=e.userData.__glint;let n=0;for(const s of e.children){if(s===o)continue;const i=2+n*.9;s.rotation.x+=a*i,s.rotation.y+=a*i*.75,n++}if(o){const s=o.material;s.opacity=Math.max(0,s.opacity-a*3.2);const i=(e.userData.__glintTimer??0)-a;i<=0?(e.userData.__glintTimer=.14+Math.random()*.3,s.opacity=1,o.position.set((Math.random()-.5)*Yt,(Math.random()-.5)*Yt,(Math.random()-.5)*Yt)):e.userData.__glintTimer=i}},impact(t){const e=t.position,a=k5/Yt,o=new T(Fl,up());o.position.copy(e),o.scale.setScalar(1.25*a),t.spawnTransient(o,.14,i=>{o.scale.setScalar(Y.lerp(1.25,3,i)*a),o.material.opacity=.95*(1-i)});const n=Y.clamp(1+t.damage*.06,1,2.4),s=11;for(let i=0;i<s;i++){const r=i/s*Math.PI*2+Math.random()*.5,l=(1.6+Math.random()*2.4)*n,h=Af();h.color.set(t.color);const c=new T(_h,h),d=(.42+Math.random()*.43)*a*n;c.scale.setScalar(d);const p=e.x+Math.cos(r)*pp,u=e.y,f=e.z+Math.sin(r)*pp;c.position.set(p,u,f);const m=1.1+Math.random()*1.6,g=-9,w=(Math.random()-.5)*22,b=(Math.random()-.5)*22;t.spawnTransient(c,.38+Math.random()*.2,(y,v)=>{c.position.set(p+Math.cos(r)*l*v,u+m*v+.5*g*v*v,f+Math.sin(r)*l*v),c.rotation.x=v*w,c.rotation.y=v*b,c.scale.setScalar(d*(1-y*.25)),c.material.opacity=.85*(1-y)})}},cast(t){const e=v5/Yt,a=fp(t.color);a.position.copy(t.position),a.scale.setScalar(.35*e),t.spawnTransient(a,.16,n=>{const s=Math.min(1,n*2.2),i=n>.55?1-(n-.55)*2.2:1;a.scale.setScalar(Y.clamp(.35+s*.75,.1,1.15)*e*Math.max(0,i)),a.rotation.y=n*5});const o=new T(Fl,up());o.position.copy(t.position),o.scale.setScalar(.8*e),t.spawnTransient(o,.12,n=>{o.scale.setScalar(Y.lerp(.8,1.9,n)*e),o.material.opacity=.9*(1-n)})}}},Vo=Wt.mustard,Gt="#9A6410",Ph="#FFF2C0",$h=Wt.ketchup,ea="#6E121D",Nl="#FFC0AE",zs=Wt.bun,An="#7A4A1E",Ll="#F9E9C2",Q=J,Ro=Math.PI*2,oi=.28;function Ni(t,e=8){const a=new Wl(t,e);return a.rotateX(-Math.PI/2),a}function Bh(t,e,a,o){const n=Math.max(2,a*2),s=new Ca,i=l=>l%2===0?-o:o,r=l=>-t/2+l/n*t;s.moveTo(i(0)-e,r(0));for(let l=1;l<=n;l++)s.lineTo(i(l)-e,r(l));for(let l=n;l>=0;l--)s.lineTo(i(l)+e,r(l));return s.closePath(),s}function H5(t,e){const a=new Ca;return a.moveTo(0,t),a.quadraticCurveTo(e,t*.45,e,0),a.quadraticCurveTo(e,-t*.45,0,-t),a.quadraticCurveTo(-e,-t*.45,-e,0),a.quadraticCurveTo(-e,t*.45,0,t),a}const _n=Q*.44,Dl=Q*.065,z5=Q*.072,ta=Q*.26,ko=Q*.185,ni=Ni(Bh(_n,Dl,3,z5),1),si=Q*.78,Rf=Q*.075,If=(Rf+Q*.098)*2,$r=(()=>{const t=Ni(Bh(si,Rf,3,Q*.098),1);return t.translate(0,0,si/2),t})(),Et=Ni(H5(.5,.5),6),_5=new pi(Q*.024,0),wp=(()=>{const t=new Me(1,1,1,16,1,!0,0,Math.PI);return t.rotateZ(-Math.PI/2),t.rotateY(Math.PI/2),t})(),P5=(()=>{const t=new no(2,1);return t.rotateX(-Math.PI/2),t})(),$5=Ni(Bh(1,.14,4,.36),1);function Ha(t,e){const a=Array.from({length:t},e);let o=0;return()=>a[o++%t]}const wo=t=>new V({color:t,side:me}),B5=wo(Vo),bp=wo(Gt),q5=wo(Ph),U5=wo($h),yp=wo(ea),G5=wo(Nl),Xn=(t,e)=>new V({color:t,transparent:!0,opacity:e,side:me,depthWrite:!1}),ii=Ha(48,()=>Xn(Vo,1)),ri=Ha(48,()=>Xn(Gt,1)),Cf=Ha(20,()=>Xn(Ph,1)),xp=Ha(8,()=>new V({color:zs,transparent:!0,opacity:1,side:me,depthWrite:!1})),vp=Ha(8,()=>new V({color:An,transparent:!0,opacity:1,side:me,depthWrite:!1})),kp=Ha(8,()=>Xn(Ll,1)),Mp=Ha(8,()=>Xn(Vo,1)),j5=Ha(14,()=>new V({color:An,transparent:!0,opacity:1,depthWrite:!1}));function kt(t,e){return Math.atan2(t,e)}function Ep(t){return t.range&&t.speed?t.range/t.speed:co.normal/1e3}function Br(t){return Y.clamp(.85+t*.035,.85,1.4)}function Tp(t){let e=t.userData.__hotdog;return e||(e={phase:Math.random()*Ro,shed:0},t.userData.__hotdog=e),e}function ga(t,e,a,o,n,s,i,r,l,h,c){const d=new ne,p=ri();p.color.set(a),p.opacity=1;const u=new T(Et,p);u.scale.set(1.34,1,1.14),u.position.y=-Q*.008,d.add(u);const f=ii();f.color.set(e),f.opacity=1,d.add(new T(Et,f)),d.renderOrder=9,d.position.set(o,n,s);const m=h*.45,g=-8.2;t.spawnTransient(d,c,(w,b)=>{const y=n+r*b+.5*g*b*b,v=y<=oi;if(d.position.set(o+i*b,v?oi:y,s+l*b),v)d.rotation.y=kt(i,l),d.scale.set(m*1.5,1,h*.75);else{const M=r+g*b,x=Math.hypot(i,M,l),S=1+Math.min(.85,x*.07);d.rotation.y=kt(i,l),d.scale.set(m/S,1,h*S)}const k=1-w*w;f.opacity=k,p.opacity=k})}function Sp(t,e,a,o,n,s){const i=t.direction,r=Math.hypot(i.x,i.z)>1e-4,l=r?Q*.36:0;_s(t,e,a,t.position.x-i.x*l,t.position.y,t.position.z-i.z*l,r?kt(i.x,i.z)+Math.PI*.5:0,o,n,s,.45)}function _s(t,e,a,o,n,s,i,r,l,h,c,d=1,p="#FFF6DC"){const u=r/si,f=l/If,m=new ne;m.rotation.y=i,m.position.set(o-Math.sin(i)*r*.5,n,s-Math.cos(i)*r*.5);const g=ri();g.color.set(a),g.opacity=d;const w=new T($r,g);w.scale.set(1.42,1,1.02),w.position.y=-Q*.009,m.add(w);const b=ii();b.color.set(e),b.opacity=d,m.add(new T($r,b));const y=Cf();y.color.set(p),y.opacity=d;const v=new T($r,y);v.scale.set(.42,1,.985),v.position.y=Q*.006,m.add(v),t.spawnTransient(m,h,k=>{const M=1-Math.pow(1-Math.min(1,k*5.5),3);m.scale.set(f,1,Math.max(.02,u*M));const x=k<c?1:1-(k-c)/(1-c);b.opacity=d*x,g.opacity=d*x,y.opacity=d*x})}function W5(t){const e=new ne,a=new T(ni,bp);a.scale.set(1.5,1,1.07),a.position.y=-Q*.012,e.add(a),e.add(new T(ni,t===Vo?B5:Of(t)));const o=new T(Et,bp);o.scale.set(Dl*3.2,1,Q*.15),o.position.set(0,-Q*.012,_n*.46),e.add(o);const n=new T(Et,q5);return n.scale.set(Dl*2.1,1,Q*.105),n.position.set(0,0,_n*.47),e.add(n),e}function Y5(t){const e=new ne,a=t===$h?U5:Of(t),o=new T(Et,yp);o.scale.set(ko*1.32,1,ta*1.12),o.position.y=-Q*.012,e.add(o);const n=new T(Et,a);n.scale.set(ko,1,ta),e.add(n);const s=new T(Et,G5);s.scale.set(ko*.32,1,ta*.42),s.position.set(-ko*.2,Q*.004,ta*.16),e.add(s);const i=[];for(let l=0;l<3;l++){const h=new ne,c=1-l*.24,d=new T(Et,yp);d.scale.set(ko*.72*c*1.34,1,ta*.42*c*1.14),d.position.y=-Q*.012,h.add(d);const p=new T(Et,a);p.scale.set(ko*.72*c,1,ta*.42*c),h.add(p),h.position.z=-ta*(.7+l*.46),e.add(h),i.push(h)}const r={tail:i};return e.userData.__parts=r,e}const Ap=new Map;function Of(t){let e=Ap.get(t);return e||(e=wo(t),Ap.set(t,e)),e}function Ss(t,e,a){const o=new ne,n=new T(wp,a.crust);n.scale.set(t*1.13,t*1.13,e*1.04),n.position.y=-t*.04,o.add(n);const s=new T(wp,a.bun);s.scale.set(t,t,e),o.add(s);const i=new T(P5,a.crumb);i.scale.set(t*.86,1,e*.92),i.position.y=-t*.34,o.add(i);const r=new T($5,a.seam);return r.scale.set(t*1.3,1,e*.84),r.position.y=-t*.3,o.add(r),o}const V5={Mustard:{projectile(t){const e=W5(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Tp(e);o.phase+=a/Ep(t.weapon)*Ro*3.2,e.rotation.y=kt(t.direction.x,t.direction.z)+Math.sin(o.phase)*.16;const n=1+Math.sin(o.phase*1.7)*.13;e.scale.set(1/n,1,n),o.shed-=a,o.shed<=0&&(o.shed=.05+Math.random()*.03,ga(t,t.color,Gt,t.position.x-t.direction.x*_n*.5,t.position.y,t.position.z-t.direction.z*_n*.5,-t.direction.x*(.6+Math.random()*.7)+(Math.random()-.5)*.9,.25+Math.random()*.45,-t.direction.z*(.6+Math.random()*.7)+(Math.random()-.5)*.9,Q*(.12+Math.random()*.06),.26+Math.random()*.12))},impact(t){const e=Br(t.damage),a=t.direction,o=kt(a.x,a.z)+Math.PI*.5;_s(t,t.color,Gt,t.position.x,t.position.y,t.position.z,o,Q*1.045*e,Q*.3*e,.34,.5),Sp(t,Ph,Gt,Q*.46*e,Q*.2*e,.19);const{x:n,y:s,z:i}=t.position,r=Q*.3*e;for(let l=0;l<8;l++){const h=l/8*Ro+Math.random()*.6,c=(2.1+Math.random()*1.5)*e;ga(t,t.color,Gt,n+Math.cos(h)*r,s,i+Math.sin(h)*r,Math.cos(h)*c+t.direction.x*.7,1.7+Math.random()*1.2,Math.sin(h)*c+t.direction.z*.7,Q*(.14+Math.random()*.07)*e,.42+Math.random()*.14)}},cast(t){const e=t.direction,a=kt(e.x,e.z),o=new ne,n=ri();n.color.set(Gt),n.opacity=1;const s=new T(ni,n);s.scale.set(1.5,1,1.08),s.position.y=-Q*.012,o.add(s);const i=ii();i.color.set(t.color),i.opacity=1,o.add(new T(ni,i)),o.renderOrder=11,o.rotation.y=a;const r=t.position.x,l=t.position.z;t.spawnTransient(o,.16,h=>{const c=1-Math.pow(1-h,2);o.scale.set(.6+h*.3,1,.35+c*.85),o.position.set(r+e.x*c*Q*.16,t.position.y,l+e.z*c*Q*.16);const d=1-h;i.opacity=d,n.opacity=d});for(let h=0;h<4;h++)ga(t,t.color,Gt,t.position.x,t.position.y,t.position.z,e.x*(1.4+Math.random()*1.1)+(Math.random()-.5)*.7,.4+Math.random()*.5,e.z*(1.4+Math.random()*1.1)+(Math.random()-.5)*.7,Q*(.12+Math.random()*.05),.3)}},Ketchup:{projectile(t){const e=Y5(t.color);return e.position.copy(t.position),e},trail(t){const e=t.object;if(!e)return;const a=t.dt??0,o=Tp(e);o.phase+=a/Ep(t.weapon)*Ro*2.4,e.rotation.y=kt(t.direction.x,t.direction.z);const n=e.userData.__parts;if(n)for(let i=0;i<n.tail.length;i++){const r=n.tail[i],l=Math.sin(o.phase-(i+1)*.9);r.position.x=l*Q*.055*(i+1)*.55,r.rotation.y=l*.4}const s=1+Math.sin(o.phase*1.3)*.09;e.scale.set(s,1,1/s),o.shed-=a,o.shed<=0&&(o.shed=.09+Math.random()*.05,ga(t,t.color,ea,t.position.x-t.direction.x*ta*1.5,t.position.y,t.position.z-t.direction.z*ta*1.5,(Math.random()-.5)*.9,.1+Math.random()*.3,(Math.random()-.5)*.9,Q*(.11+Math.random()*.05),.24+Math.random()*.1))},impact(t){const e=Br(t.damage),a=t.direction;_s(t,t.color,ea,t.position.x,t.position.y,t.position.z,kt(a.x,a.z)+Math.PI*.5,Q*.78*e,Q*.36*e,.3,.45),Sp(t,Nl,ea,Q*.4*e,Q*.2*e,.18),_s(t,t.color,ea,t.position.x+a.x*Q*.5,oi,t.position.z+a.z*Q*.5,kt(a.x,a.z),si*e,If*e,.8,.55,.95,Nl);const{x:o,y:n,z:s}=t.position,i=Q*.29*e;for(let r=0;r<6;r++){const l=r/6*Ro+Math.random()*.7,h=(1.8+Math.random()*1.3)*e;ga(t,t.color,ea,o+Math.cos(l)*i,n,s+Math.sin(l)*i,Math.cos(l)*h+a.x*.6,1.5+Math.random()*1.1,Math.sin(l)*h+a.z*.6,Q*(.14+Math.random()*.07)*e,.44+Math.random()*.14)}},cast(t){const e=t.direction;for(let i=0;i<5;i++)ga(t,t.color,ea,t.position.x,t.position.y,t.position.z,e.x*(1+Math.random()*.9)+(Math.random()-.5)*.8,.3+Math.random()*.4,e.z*(1+Math.random()*.9)+(Math.random()-.5)*.8,Q*(.13+Math.random()*.05),.3);const a=new ne,o=ri();o.color.set(ea),o.opacity=1;const n=new T(Et,o);n.scale.set(1.3,1,1.16),n.position.y=-Q*.01,a.add(n);const s=ii();s.color.set(t.color),s.opacity=1,a.add(new T(Et,s)),a.renderOrder=11,a.rotation.y=kt(e.x,e.z),a.position.copy(t.position),t.spawnTransient(a,.15,i=>{const r=Y.lerp(Q*.06,Q*.24,1-Math.pow(1-i,2));a.scale.set(r*.55,1,r),a.position.set(t.position.x+e.x*i*Q*.14,t.position.y,t.position.z+e.z*i*Q*.14),s.opacity=1-i,o.opacity=1-i})}},Slash:{impact(t){const e=Br(t.damage),a=t.direction,o=kt(a.x,a.z),{x:n,y:s,z:i}=t.position,r=Q*.175*e,l=Q*.62*e,h=Q*.375*e,c=Q*.125*e,d=new ne;d.rotation.y=o,d.position.set(n,s-Q*.06,i),d.renderOrder=10;const p=xp();p.color.set(zs),p.opacity=1;const u=kp();u.color.set(Ll),u.opacity=1;const f=Mp();f.color.set(t.color),f.opacity=1;const m=vp();m.color.set(An),m.opacity=1;const g={bun:p,crust:m,crumb:u,seam:f},w=Ss(r,l,g),b=Ss(r,l,g);d.add(w,b);const y=Cf();y.color.set("#FFF6DA"),y.opacity=0;const v=new T(Et,y);v.scale.set(Q*.075,1,l*.92),v.position.y=r*.15,v.renderOrder=12,d.add(v);let k=!1;t.spawnTransient(d,.46,x=>{const S=Math.min(1,x/.35),E=1-Math.pow(1-S,3),A=x<=.35?E:E-(x-.35)/.65*.55,C=Y.lerp(h,c,Y.clamp(A,0,1));w.position.x=C,b.position.x=-C;const R=Y.lerp(.55,.12,Y.clamp(A,0,1));w.rotation.z=R,b.rotation.z=-R,y.opacity=x<.35?0:Math.max(0,1-(x-.35)/.2);const I=x<.6?1:1-(x-.6)/.4;if(p.opacity=I,m.opacity=I,u.opacity=I,f.opacity=I,!k&&x>=.35){k=!0;const N=-Math.sin(o),L=-Math.cos(o);for(let _=0;_<6;_++){const U=_%2===0?1:-1,D=_<4,W=(Math.random()-.5)*.8;ga(t,D?Vo:$h,D?Gt:ea,n+N*U*c*1.2,s,i+L*U*c*1.2,N*U*(2.4+Math.random()*1.6)+a.x*W,1.6+Math.random()*1.3,L*U*(2.4+Math.random()*1.6)+a.z*W,Q*(.15+Math.random()*.07)*e,.4+Math.random()*.14)}}});const M=Q*.24*e;for(let x=0;x<6;x++){const S=Math.random()*Ro,E=(1.9+Math.random()*1.6)*e,A=j5();A.color.set(x%3===0?zs:An),A.opacity=1;const C=new T(_5,A);C.renderOrder=9;const R=n+Math.cos(S)*M,I=i+Math.sin(S)*M,N=Math.cos(S)*E,L=Math.sin(S)*E,_=1.7+Math.random()*1.3,U=(.8+Math.random()*.7)*e;C.scale.setScalar(U);const D=Math.random()*9-4.5,W=Math.random()*9-4.5;t.spawnTransient(C,.42+Math.random()*.14,(F,z)=>{C.position.set(R+N*z,Math.max(oi,s+_*z-4.6*z*z),I+L*z),C.rotation.set(D*z,W*z,0),A.opacity=1-F*F})}},cast(t){const e=t.direction,a=kt(e.x,e.z),o=.62,n=Q*.175*o,s=Q*.62*o,i=new ne;i.rotation.y=a,i.position.copy(t.position),i.renderOrder=11;const r=xp();r.color.set(zs),r.opacity=1;const l=kp();l.color.set(Ll),l.opacity=1;const h=Mp();h.color.set(t.color),h.opacity=1;const c=vp();c.color.set(An),c.opacity=1;const d={bun:r,crust:c,crumb:l,seam:h},p=Ss(n,s,d),u=Ss(n,s,d);i.add(p,u),t.spawnTransient(i,.2,f=>{const m=1-Math.pow(1-f,2),g=Y.lerp(Q*.06,Q*.2,m);p.position.x=g,u.position.x=-g,p.rotation.z=m*.6,u.rotation.z=-m*.6;const w=1-f;r.opacity=w,c.opacity=w,l.opacity=w,h.opacity=w});for(let f=0;f<3;f++)ga(t,Vo,Gt,t.position.x,t.position.y,t.position.z,e.x*(1.2+Math.random())+(Math.random()-.5)*.9,.5+Math.random()*.4,e.z*(1.2+Math.random())+(Math.random()-.5)*.9,Q*(.12+Math.random()*.05),.28)}}};function At(t,e){const a={};for(const[o,n]of Object.entries(e))n&&(a[`${t}.${o}`]=n);return a}const K5={...At("hamburger",gy),...At("donut",qy),...At("taco",l2),...At("burrito",G2),...At("egg",vx),...At("lollipop",nv),...At("pizza",Sv),...At("sushi",jv),...At("soup",x5),...At("waterbottle",D5),...At("hotdog",V5)};function bn(t,e){return K5[`${t}.${e}`]}function Qt(t){window.__vfxQaCounts??={cast:0,meleeArc:0,impact:0,death:0,heal:0,giantSlam:0,puddleSplash:0,coverScuff:0,castTelegraph:0},window.__vfxQaCounts[t]++}const Mo=.5,X5=.3,Li=.3,Z5=Li,J5=Li+.01,Q5=0,Wa=Xe(nt.pickupRadius),Xa=Wa*.62,ek=Xa*2.2,Rp=Xa*.16,tk=.0042,ak=.0013,ok=nt.popMs*3,wa=1.15,qr=1.25,nk=.25,sk=0,qa=Li+.02,As=Li+.04,ik=J,Ip=.85,Cp=.68,rk=4,lk=.7,hk=.92,ck=7,dk=.55,Op=.6,Fp=.32,Ur=new Xt("#F2F6FF"),pk=new Xt("#63A8E0"),uk=J*.62,fk=J*.66,mk=J*.62,gk=.58,wk="#EAF4FF",bk="#1D2740",Np=18,kn=.8,Gr=3,Lp=["#F5475E","#F5C147","#47C4F5","#6BE05A","#B36BF5","#F58A47"],Dp="#EF5B2E",yk=.62,xk=.28,Hp=.85,vk=.9,kk=1.15,Mk=1.45,Ek=2,zp=.3,ft=new Xt("#ffffff"),Tk=new Xt("#241a33"),_p=new Xt("#FFE79A"),jr=Tm.clone().normalize(),Sk=.38,Ak=.45,Rk=.995;function Ff(t){if(t.userData.__fxShaded)return!1;const e=t.getAttribute("position");if(!e)return t.userData.__fxShaded=!0,!1;const a=t.getAttribute("normal"),o=e.count,n=new Float32Array(o*3);let s=!0;if(a&&a.count===o){let u=0,f=0,m=0;for(let g=0;g<o;g++)u+=a.getX(g),f+=a.getY(g),m+=a.getZ(g);s=Math.hypot(u/o,f/o,m/o)>=Rk}t.computeBoundingSphere();const i=t.boundingSphere,r=i?i.center.x:0,l=i?i.center.y:0,h=i?i.center.z:0,c=Math.max(i?i.radius:1,1e-6);let d=0;for(let u=0;u<o;u++){const f=Math.min(1,Math.hypot(e.getX(u)-r,e.getY(u)-l,e.getZ(u)-h)/c),m=1-Ak*f*f,g=s?1:1+Sk*(a.getX(u)*jr.x+a.getY(u)*jr.y+a.getZ(u)*jr.z),w=Math.max(0,g*m);n[u*3]=w,d+=w}const p=d>1e-9?o/d:1;for(let u=0;u<o;u++){const f=n[u*3]*p;n[u*3]=f,n[u*3+1]=f,n[u*3+2]=f}return t.setAttribute("color",new Rn(n,3)),t.userData.__fxShaded=!0,!0}function Ik(t){const e=t;return e.vertexColors||e.map?!1:(e.vertexColors=!0,e.needsUpdate=!0,!0)}const Ck=.62,Ok=.3,Pp=new WeakMap;function $p(t){const e=t;if(!t.isMeshBasicMaterial||e.transparent||e.blending!==Am||e.map)return null;const a=Pp.get(t);if(a)return a;const o=_e({color:e.color.clone(),roughness:Ok,metalness:0,doubleSide:e.side===me,emissive:e.color.clone().multiplyScalar(Ck)});return o.depthWrite=e.depthWrite,o.depthTest=e.depthTest,o.vertexColors=e.vertexColors,Pp.set(t,o),o}function Bp(t){t.traverse(e=>{const a=e;if(!a.isMesh||a.isSprite)return;if(Array.isArray(a.material)){const n=a.material.map(s=>$p(s)??s);a.material=n;return}const o=$p(a.material);o&&(a.material=o)})}function Nf(t){t.traverse(e=>{const a=e;if(!a.isMesh)return;const o=Array.isArray(a.material)?a.material:[a.material];o.some(n=>n&&!n.map)&&Ff(a.geometry);for(const n of o)n&&Ik(n)})}const qp=.55,Fk=.34,Nk=.72,Lk=1,Dk=.34,Hk=1.1,zk=J*.85,_k=.8,Pk=12,$k=2,Wr=.05,ba={scopes:0,inert:0,members:0,mats:0,opaqueSkipped:0,cores:0,coresStarved:0,aliasTouches:0};function Bk(t){const e=[],a=new Set;return t.traverse(o=>{const s=o.material;if(!s)return;const i=Array.isArray(s)?s:[s];for(const r of i)if(r){if(!r.transparent){ba.opaqueSkipped++;continue}a.has(r.uuid)||(a.add(r.uuid),e.push(r))}}),ba.mats+=e.length,{mats:e}}function qk(t,e){let a=0;e.set(0,0,0);const o=(n,s,i,r)=>{const l=s+n.position.x,h=i+n.position.y,c=r+n.position.z;if(!n.visible)return;const d=n;(d.isMesh||d.isSprite)&&(e.x+=l,e.y+=h,e.z+=c,a++);for(const p of n.children)o(p,l,h,c)};return o(t,0,0,0),a===0?!1:(e.multiplyScalar(1/a),!0)}function yn(t,e,a,o,n){const s=new Set;for(const i of a){s.add(i.id);let r=t.get(i.id);r||(r=o(i),Nf(r),e.add(r),t.set(i.id,r)),n(r,i)}for(const[i,r]of t)s.has(i)||(e.remove(r),t.delete(i))}function Uk(t){return t.depthWrite=!1,t}const Up=t=>1-Math.pow(1-t,3);function Gp(t){const e=Math.sin(t*12.9898)*43758.5453;return(e-Math.floor(e))*Math.PI*2}function Yr(t,e){const a=Math.hypot(t,e);return a>1e-6?{x:t/a,y:e/a}:{x:0,y:0}}function Gk(){const e=document.createElement("canvas");e.width=64,e.height=64;const a=e.getContext("2d"),o=a.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);o.addColorStop(0,"rgba(255,255,255,1)"),o.addColorStop(.4,"rgba(255,255,255,0.85)"),o.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=o,a.fillRect(0,0,64,64);const n=new et(e);return n.needsUpdate=!0,n}function jk(){const e=document.createElement("canvas");e.width=64,e.height=64;const a=e.getContext("2d"),o=a.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);o.addColorStop(0,"rgba(255,255,255,1)"),o.addColorStop(.14,"rgba(255,255,255,0.85)"),o.addColorStop(.32,"rgba(255,255,255,0.45)"),o.addColorStop(.55,"rgba(255,255,255,0.18)"),o.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=o,a.fillRect(0,0,64,64);const n=new et(e);return n.needsUpdate=!0,n}function Wk(){const e=document.createElement("canvas");e.width=64,e.height=64;const a=e.getContext("2d"),o=a.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);o.addColorStop(0,"rgba(255,255,255,1)"),o.addColorStop(.62,"rgba(255,255,255,1)"),o.addColorStop(.82,"rgba(255,255,255,0.6)"),o.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=o,a.fillRect(0,0,64,64);const n=new et(e);return n.needsUpdate=!0,n}function Yk(){const a=document.createElement("canvas");a.width=128,a.height=128;const o=a.getContext("2d"),n=o.createRadialGradient(64,64,0,64,64,128*.16);n.addColorStop(0,"rgba(255,255,255,1)"),n.addColorStop(.6,"rgba(255,255,255,0.85)"),n.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=n,o.fillRect(0,0,128,128);const s=8;for(let r=0;r<s;r++){const l=r%2===0,h=128*(l?.48:.26),c=128*(l?.045:.028),d=r/s*Math.PI*2;o.save(),o.translate(64,64),o.rotate(d);const p=o.createLinearGradient(0,0,h,0);p.addColorStop(0,"rgba(255,255,255,1)"),p.addColorStop(.7,"rgba(255,255,255,0.8)"),p.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=p,o.beginPath(),o.moveTo(0,-c),o.lineTo(h,0),o.lineTo(0,c),o.closePath(),o.fill(),o.restore()}const i=new et(a);return i.needsUpdate=!0,i}function Vk(){const a=document.createElement("canvas");a.width=128,a.height=32;const o=a.getContext("2d"),n=o.createLinearGradient(0,0,128,0);n.addColorStop(0,"rgba(255,255,255,0)"),n.addColorStop(.5,"rgba(255,255,255,1)"),n.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=n,o.fillRect(0,0,128,32),o.globalCompositeOperation="destination-in";const s=o.createLinearGradient(0,0,0,32);s.addColorStop(0,"rgba(255,255,255,0)"),s.addColorStop(.5,"rgba(255,255,255,1)"),s.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=s,o.fillRect(0,0,128,32),o.globalCompositeOperation="source-over";const i=new et(a);return i.needsUpdate=!0,i}function Kk(){const a=document.createElement("canvas");a.width=8,a.height=64;const o=a.getContext("2d"),n=o.createLinearGradient(0,0,0,64);n.addColorStop(0,"rgba(255,255,255,0.1)"),n.addColorStop(.55,"rgba(255,255,255,0.55)"),n.addColorStop(.86,"rgba(255,255,255,0.85)"),n.addColorStop(.94,"rgba(255,255,255,1)"),n.addColorStop(1,"rgba(255,255,255,0.65)"),o.fillStyle=n,o.fillRect(0,0,8,64);const s=new et(a);return s.flipY=!1,s.needsUpdate=!0,s}function Xk(){const a=document.createElement("canvas");a.width=8,a.height=128;const o=a.getContext("2d"),n=o.createLinearGradient(0,0,0,128);n.addColorStop(0,"rgba(255,255,255,0)"),n.addColorStop(.78,"rgba(255,255,255,0)"),n.addColorStop(.88,"rgba(255,255,255,0.85)"),n.addColorStop(.94,"rgba(255,255,255,1)"),n.addColorStop(1,"rgba(255,255,255,0.75)"),o.fillStyle=n,o.fillRect(0,0,8,128);const s=new et(a);return s.flipY=!1,s.needsUpdate=!0,s}function li(t){const e=t.replace("#","");return[parseInt(e.slice(0,2),16),parseInt(e.slice(2,4),16),parseInt(e.slice(4,6),16)]}const hi=t=>t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4),Zk=t=>t<=.0031308?t*12.92:1.055*Math.pow(t,1/2.4)-.055,Jk=42,Qk=.7,jp=.66;function qh(t){const[e,a,o]=li(t).map(y=>y/255),n=Math.max(e,a,o),s=Math.min(e,a,o),i=(n+s)/2,r=n-s,l=r===0?0:r/(1-Math.abs(2*i-1));let h=0;r!==0&&(n===e?h=60*((a-o)/r%6):n===a?h=60*((o-e)/r+2):h=60*((e-a)/r+4)),h<0&&(h+=360);let c=Jk-h;c>180&&(c-=360),c<-180&&(c+=360);const d=(h+c*Qk+360)%360,p=(1-Math.abs(2*jp-1))*l,u=p*(1-Math.abs(d/60%2-1)),f=jp-p/2,m=Math.floor(d/60)%6,w=[[p,u,0],[u,p,0],[0,p,u],[0,u,p],[u,0,p],[p,0,u]][m].map((y,v)=>Math.max(y+f,[e,a,o][v])),b=y=>Math.round(Math.min(1,y)*255).toString(16).padStart(2,"0");return`#${b(w[0])}${b(w[1])}${b(w[2])}`}function Wp(t,e){const a=/rgb\((\d+),(\d+),(\d+)\)/.exec(Ya(t,e)),o=li(qh(t)).map(s=>hi(s/255)),n=[1,2,3].map(s=>hi(Number(a[s])/255));return .2126*o[0]*n[0]+.7152*o[1]*n[1]+.0722*o[2]*n[2]}const Yp="#F5475E";function Eo(t,e){if(t===Yp)return e;const a=Wp(Yp,e);let o=0,n=2;for(let s=0;s<28;s++){const i=(o+n)/2;Wp(t,i)<a?o=i:n=i}return(o+n)/2}function Ya(t,e){const a=li(t).map(r=>hi(r/255)),o=li(qh(t)).map(r=>hi(r/255)),n=a.map((r,l)=>r/Math.max(1e-6,o[l])),s=Math.max(0,Math.min(1,e-1)),i=n.map(r=>Math.round(255*Zk(e<=1?r*Math.max(0,e):r+(1-r)*s)));return`rgb(${i[0]},${i[1]},${i[2]})`}function e4(t,e){const n=document.createElement("canvas");n.width=128,n.height=128;const s=n.getContext("2d"),i=document.createElement("canvas");i.width=128,i.height=128;const r=i.getContext("2d"),l=x=>{const S=Math.round(255*x);return`rgb(${S},${S},${S})`},h=1.9*t,c=3.3*t+.7,d=x=>64*(kn+.13*Math.sin(x*3+h)+.06*Math.sin(x*5+c)),p=x=>{x.beginPath();const S=96;for(let E=0;E<=S;E++){const A=E/S*Math.PI*2,C=d(A),R=64+Math.cos(A)*C,I=64+Math.sin(A)*C;E===0?x.moveTo(R,I):x.lineTo(R,I)}x.closePath()},u=()=>p(s);u();const f=s.createLinearGradient(128*.18,128*.12,128*.86,128*.92);f.addColorStop(0,Ya(e,Eo(e,Mk))),f.addColorStop(.5,Ya(e,Eo(e,kk))),f.addColorStop(1,Ya(e,Eo(e,vk))),s.fillStyle=f,s.fill(),p(r),r.fillStyle=l(yk),r.fill(),s.save(),u(),s.clip(),r.save(),p(r),r.clip();const m=.45,g=1/Math.sqrt(.5+.5*m*m),w=(x,S,E,A,C)=>{const R=64+x*128,I=64+S*128,N=E*128*g,L=(D,W)=>{const F=D.createRadialGradient(R,I,0,R,I,N),z=P=>`rgba(${W[0]},${W[1]},${W[2]},${P})`;F.addColorStop(0,z(1)),F.addColorStop(m,z(1)),F.addColorStop(1,z(0)),D.fillStyle=F,D.beginPath(),D.arc(R,I,N,0,Math.PI*2),D.fill()},_=/rgb\((\d+),(\d+),(\d+)\)/.exec(A);L(s,[Number(_[1]),Number(_[2]),Number(_[3])]);const U=Math.round(255*C);L(r,[U,U,U])},b=t*1.7;for(let x=0;x<7;x++){const S=b+x*2.399963,E=.075+.215*Math.sqrt((x+.55)/7),A=.08-.005*x,C=Ek-.055*x;w(Math.cos(S)*E,Math.sin(S)*E,A,Ya(e,Eo(e,C)),xk)}w(-.06+.05*t,.2,.075,Ya(e,Eo(e,zp)),Hp),w(.2-.04*t,-.17,.055,Ya(e,Eo(e,zp*.85)),Hp),s.restore(),r.restore();const y=s.getImageData(0,0,128,128),v=y.data,k=r.getImageData(0,0,128,128).data;for(let x=0;x<v.length;x+=4){const S=v[x+3];if(S===0){v[x]=0,v[x+1]=0,v[x+2]=0;continue}const E=S/255;v[x]=Math.round(v[x]*E),v[x+1]=Math.round(v[x+1]*E),v[x+2]=Math.round(v[x+2]*E),v[x+3]=Math.round(k[x]*E)}s.putImageData(y,0,0);const M=new et(n);return M.colorSpace=di,M.needsUpdate=!0,M}const t4=.26,a4=2.4,o4=1.65,Vp=.36,n4=.64,s4=.66,i4=.4,r4=.78,l4=1.25,h4=6;function c4(){const e=document.createElement("canvas");e.width=128,e.height=128;const a=e.getContext("2d"),o=a.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);o.addColorStop(0,"rgba(255,255,255,0.22)"),o.addColorStop(.44,"rgba(255,255,255,0.34)"),o.addColorStop(.62,"rgba(255,255,255,0.78)"),o.addColorStop(.82,"rgba(255,255,255,0.90)"),o.addColorStop(.88,"rgba(70,70,70,0.86)"),o.addColorStop(.96,"rgba(48,48,48,0.55)"),o.addColorStop(1,"rgba(40,40,40,0)"),a.fillStyle=o,a.fillRect(0,0,128,128);const n=new et(e);return n.needsUpdate=!0,n}function d4(t){const e=/^#?([0-9a-f]{6})$/i.exec(t.trim());if(!e)return t;const a=parseInt(e[1],16),o=(a>>16&255)/255,n=(a>>8&255)/255,s=(a&255)/255,i=Math.max(o,n,s),r=Math.min(o,n,s),l=i-r;let h=0;l>1e-6&&(i===o?h=(n-s)/l%6:i===n?h=(s-o)/l+2:h=(o-n)/l+4,h*=60,h<0&&(h+=360));const c=(i+r)/2,d=l<1e-6?0:l/(1-Math.abs(2*c-1)),p=c>=r4?i4:Math.max(c,s4),u=Math.min(1,d*l4),f=(1-Math.abs(2*p-1))*u,m=f*(1-Math.abs(h/60%2-1)),g=p-f/2;let w=0,b=0,y=0;h<60?(w=f,b=m):h<120?(w=m,b=f):h<180?(b=f,y=m):h<240?(b=m,y=f):h<300?(w=m,y=f):(w=f,y=m);const v=k=>Math.round((k+g)*255).toString(16).padStart(2,"0");return`#${v(w)}${v(b)}${v(y)}`}function p4(){const e=document.createElement("canvas");e.width=64,e.height=64;const a=e.getContext("2d"),o=[[.5,.02],[.78,.32],[.68,.98],[.32,.98],[.22,.32],[.5,.02]];a.beginPath(),o.forEach(([i,r],l)=>{const h=i*64,c=r*64;l===0?a.moveTo(h,c):a.lineTo(h,c)}),a.closePath();const n=a.createLinearGradient(64*.3,0,64*.6,64);n.addColorStop(0,"rgba(255,255,255,1)"),n.addColorStop(.45,"rgba(255,255,255,0.85)"),n.addColorStop(1,"rgba(255,255,255,0.55)"),a.fillStyle=n,a.fill(),a.beginPath(),a.moveTo(64*.5,64*.05),a.lineTo(64*.62,64*.34),a.lineTo(64*.5,64*.5),a.lineTo(64*.4,64*.3),a.closePath(),a.fillStyle="rgba(255,255,255,0.9)",a.fill();const s=new et(e);return s.needsUpdate=!0,s}function u4(t,e,a,o){const n=[],s=[],i=Math.PI*2/a,r=i*o,l=6;let h=0;for(let d=0;d<a;d++){const p=d*i;for(let u=0;u<=l;u++){const f=p+u/l*r;n.push(Math.sin(f)*t,0,Math.cos(f)*t),n.push(Math.sin(f)*e,0,Math.cos(f)*e)}for(let u=0;u<l;u++){const f=h+u*2;s.push(f,f+1,f+2,f+1,f+3,f+2)}h+=(l+1)*2}const c=new Pn;return c.setAttribute("position",new qs(n,3)),c.setIndex(s),c.computeVertexNormals(),c}function Vr(t,e){const a=Y.degToRad(Y.clamp(e,1,360))/2,o=Math.max(8,Math.round(e/8)),n=[0,0,0],s=[.5,0];for(let l=0;l<=o;l++){const h=-a+l/o*a*2;n.push(Math.sin(h)*t,0,Math.cos(h)*t),s.push(l/o,1)}const i=[];for(let l=1;l<o+1;l++)i.push(0,l,l+1);const r=new Pn;return r.setAttribute("position",new qs(n,3)),r.setAttribute("uv",new qs(s,2)),r.setIndex(i),r.computeVertexNormals(),r}function f4(t,e=8,a=.45){const o=e*2,n=[0,0,0];for(let r=0;r<=o;r++){const l=r/o*Math.PI*2,h=r%2===0?t:t*a;n.push(Math.sin(l)*h,0,Math.cos(l)*h)}const s=[];for(let r=1;r<o+1;r++)s.push(0,r,r+1);const i=new Pn;return i.setAttribute("position",new qs(n,3)),i.setIndex(s),i.computeVertexNormals(),i}const m4=96,g4=10,w4=16,Kp=.09,Xp=.2;function Zp(t,e,a){const o=t.clone().convertLinearToSRGB(),n=e.clone().convertLinearToSRGB();return o.lerp(n,a).convertSRGBToLinear()}function b4(t,e){return t.clone().convertLinearToSRGB().multiplyScalar(e).convertSRGBToLinear()}function Kr(t){t.traverse(e=>{const a=e.material;if(a)for(const o of Array.isArray(a)?a:[a])o.userData?.__ownMat&&o.dispose()})}class y4{group=new ne;projectilePool=new Map;shellPool=new Map;splatPool=new Map;trailPool=new Map;medikitPool=new Map;materialCache=new Map;transientEffects=[];unionScopes=[];pendingUnion=null;unionCores=[];unionMemberState=new WeakMap;unionMatState=new WeakMap;unionFrame=0;unionPointScratch=new de;unionCentreScratch=new de;unionDistScratch=[];unionSortScratch=[];castTelegraphs=new Map;lastSyncElapsedMs=0;projectileGeo=new it(Xe(10),10,8);splatGeo=new no(2*Xe(sl)/kn,2*Xe(sl)/kn);trailGeo=new no(2*Xe(Ct.radius)/kn,2*Xe(Ct.radius)/kn);medikitBodyGeo=new dt(Wa,Xa,Wa);medikitArmXGeo=new dt(Wa*.66,Xa*.16,Wa*.24);medikitArmZGeo=new dt(Wa*.24,Xa*.16,Wa*.66);medikitBodyMat=_e({color:"#FBFDFF",roughness:.42});medikitCrossMat=_e({color:"#FF2F45",roughness:.38,emissive:"#7A0A16",emissiveIntensity:.55});glazeTexByColor=new Map;glazeTexFor(e){let a=this.glazeTexByColor.get(e);return a||(a=Array.from({length:Gr},(o,n)=>e4(n,e)),this.glazeTexByColor.set(e,a)),a}haloTex=c4();haloMats=new Map;shellBox=new In;shellSize=new de;splatMats=this.glazeTexFor(Dp).map(e=>this.groundMarkMat(Dp,e));trailMats=[];trailMatsFor(e){let a=this.trailMats[e];if(!a){const o=Lp[e]??Lp[0];a=this.glazeTexFor(o).map(n=>this.groundMarkMat(o,n)),this.trailMats[e]=a}return a}groundMarkMat(e,a){const o=Uk(Sm(qh(e),{transparent:!0,opacity:1}));return o.userData.markColor=e,o.map=a,o.blending=p0,o.blendEquation=Ps,o.blendSrc=ol,o.blendDst=tc,o.blendEquationAlpha=Ps,o.blendSrcAlpha=ol,o.blendDstAlpha=tc,o.needsUpdate=!0,o}glowTex=Gk();coreTex=jk();softDiscTex=Wk();starTex=Yk();streakTex=Vk();shardTex=p4();wedgeGradientTex=Kk();telegraphRimTex=Xk();particles=[];wedges=[];rings=[];wedgeGeoCache=new Map;ringUnitGeo=new Ea(.62,1,40);wardGeo=u4(lk,hk,ck,dk);statusBySlot=[];buildStatusVisual;ensureSlots(e){for(;this.statusBySlot.length<e;)this.statusBySlot.push(this.buildStatusVisual()),this.slowSplashState.push({lastX:NaN,lastY:NaN,distAccum:0}),this.statusSnapshot.push({x:NaN,y:NaN,stunReady:!0,slowReady:!0})}slowSplashState=[];statusSnapshot=[];constructor(e){this.group.name="vfx_layer",e.add(this.group);for(let o=0;o<m4;o++){const n=new Ot({map:this.glowTex,color:16777215,transparent:!0,opacity:0,depthWrite:!1,blending:Qe}),s=new ya(n);s.visible=!1,s.renderOrder=10,this.group.add(s),this.particles.push({sprite:s,mat:n,active:!1,life:0,maxLife:1,vx:0,vy:0,vz:0,gravity:0,startScale:1,endScale:1,startOpacity:1,endOpacity:0,fadeEase:1,aspect:1})}for(let o=0;o<Pk;o++){const n=new Ot({map:this.coreTex,color:16777215,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1,blending:Qe}),s=new ya(n);s.name="vfx_union_core",s.visible=!1,s.renderOrder=9,this.group.add(s),this.unionCores.push({sprite:s,mat:n,busy:!1})}for(let o=0;o<g4;o++){const n=new V({color:16777215,map:this.wedgeGradientTex,transparent:!0,opacity:0,side:me,depthWrite:!1}),s=new T(Vr(.01,10),n);s.visible=!1,s.renderOrder=5,this.group.add(s),this.wedges.push({mesh:s,mat:n,active:!1,life:0,maxLife:1,startOpacity:.6})}for(let o=0;o<w4;o++){const n=new V({color:16777215,transparent:!0,opacity:0,side:me,depthWrite:!1,blending:Qe}),s=new T(this.ringUnitGeo,n);s.rotation.x=-Math.PI/2,s.visible=!1,s.renderOrder=6,this.group.add(s),this.rings.push({mesh:s,mat:n,active:!1,life:0,maxLife:1,startScale:.1,targetScale:1,startOpacity:.9})}const a=()=>{const o=new V({color:bk,transparent:!0,opacity:0,side:me,depthWrite:!1}),n=new T(new Ea(.55,.95,28),o);n.rotation.x=-Math.PI/2,n.visible=!1,n.renderOrder=3,this.group.add(n);const s=new V({color:wk,transparent:!0,opacity:0,side:me,depthWrite:!1}),i=new T(new Ea(.64,.86,28),s);i.rotation.x=-Math.PI/2,i.visible=!1,i.renderOrder=4,this.group.add(i);const r=new Ot({map:this.softDiscTex,color:pk,transparent:!0,opacity:0,depthTest:!1,depthWrite:!1}),l=new ya(r);l.scale.set(uk,fk,1),l.visible=!1,l.renderOrder=8,this.group.add(l);const h=[];for(let p=0;p<rk;p++){const u=new Ot({map:this.starTex,color:"#FFE75E",transparent:!0,opacity:0,depthWrite:!1,blending:Qe}),f=new ya(u);f.scale.set(Cp,Cp,1),f.visible=!1,f.renderOrder=11,this.group.add(f),h.push(f)}const c=new V({color:Ur,transparent:!0,opacity:0,side:me,depthWrite:!1}),d=new T(this.wardGeo,c);return d.visible=!1,d.renderOrder=2,this.group.add(d),{slowRing:i,slowRingDark:n,slowTint:l,stunStars:h,wardRing:d,wardMat:c,wardPop:0,wardPopColor:new Xt(Ur)}};this.buildStatusVisual=a,this.ensureSlots(2),window.__vfxSpawnTest=(o,n,s,i=14,r="#FFC93C",l,h,c)=>{const d=l??"hamburger",p=h?re[d]?.weapons?.find(u=>u.key===h):void 0;if(o==="impact")this.spawnImpactBurst(n,s,r,i,p?{weapon:p,characterId:d,fromXWU:n-60,fromYWU:s}:void 0);else if(o==="death")this.spawnDeathBurst(n,s,r);else if(o==="heal")this.spawnHealPulse(n,s);else if(o==="puddleSplash"){const u=Ie(n,s);this.spawnPuddleSplash(u.x,u.z)}else if(o==="meleeArc")this.spawnMeleeArc(n,s,{x:1,y:0},p?.range??70,p?.cone??80,p?.color??r);else if(o==="giantSlam")this.spawnGiantSlamShockwave(n,s,p?.color??r,p?.range??Va.ultimateSlam);else if(o==="coverScuff")this.spawnCoverScuff(n,s,p?.color??r,1,0);else if(o==="castTelegraph"){const u=p??{key:"qa",name:"qa",type:"melee",range:84,cone:100,damage:i,cooldown:1,color:r,effect:null},f=c??u.castMs??1100;this.spawnCastTelegraph(0,n,s,{x:1,y:0},u,d,f)}else if(o==="weaponFired"){const u=p??{key:"qa",name:"qa",type:"ranged",range:100,damage:i,cooldown:1,color:r,effect:null};this.spawnWeaponCast(n,s,{x:1,y:0},u,d)}else{const u=p??{key:"qa",name:"qa",type:"ranged",range:100,damage:i,cooldown:1,color:r,effect:null};this.spawnCastFlash(n,s,{x:1,y:0},u,d)}},window.__vfxLayer=this}sync(e){const a=Pe(e);this.ensureSlots(a.length);const o=s=>({x:s.x,y:s.y,hp:s.hp,alive:s.alive,terrainSlowFactor:s.terrainSlowFactor});window.__vfxDebugFighters={player:o(a[0]),enemy:o(a[1]??a[0]),slots:a.map(o)};const n=Math.max(0,(e.elapsed-this.lastSyncElapsedMs)/1e3);this.lastSyncElapsedMs=e.elapsed,yn(this.projectilePool,this.group,e.projectiles,s=>{const i=bt(e,s.ownerId,s.ownerRole),r=bn(i.characterId,s.weapon.key);if(r?.projectile){const h=Ie(s.x,s.y),c=Yr(s.vx,s.vy),d={THREE:sn,position:new de(h.x,Mo,h.z),direction:new de(c.x,0,c.y),color:s.color,damage:s.damage,weapon:s.weapon,characterId:i.characterId,spawnTransient:(u,f,m)=>this.spawnTransientObject(u,f,m)},p=r.projectile(d);return Bp(p),p.userData.weaponVfx=r,p.name=`projectile:${i.characterId}.${s.weapon.key}`,this.measureShell(p),p}const l=new T(this.projectileGeo,this.materialFor(s.color));return l.name=`projectile:${i.characterId}.${s.weapon.key}`,this.measureShell(l),l},(s,i)=>{const r=bt(e,i.ownerId,i.ownerRole),l=s.userData.weaponVfx,h=Ie(i.x,i.y),c=s.userData.shellSpec?.scale??1;if(!l){const u=s;if(u.material=this.materialFor(i.color),i.arrived){const f=(i.peckTimer??0)/500,m=1+Math.sin(f*Math.PI)*.5;u.scale.setScalar(m*c)}else u.scale.setScalar(c);u.position.set(h.x,Mo,h.z);return}s.position.set(h.x,Mo,h.z);const d=Yr(i.vx,i.vy);(d.x!==0||d.y!==0)&&(s.rotation.y=Math.atan2(d.x,d.y));const p=s.userData.__authoredScale??=s.scale.clone();if(s.scale.copy(p),l.trail){const u={THREE:sn,position:s.position.clone(),direction:new de(d.x,0,d.y),color:i.color,damage:i.damage,weapon:i.weapon,characterId:r.characterId,spawnTransient:(f,m,g)=>this.spawnTransientObject(f,m,g),object:s,dt:n};l.trail(u)}p.copy(s.scale),s.scale.multiplyScalar(c)}),yn(this.shellPool,this.group,e.projectiles,s=>{const r=`${bt(e,s.ownerId,s.ownerRole).characterId}.${s.weapon.key}`,h=this.projectilePool.get(s.id)?.userData.shellSpec?.haloR??Vp,c=new ne;c.name=`projectile_shell:${r}`;let d=this.haloMats.get(s.color);d||(d=new Ot({map:this.haloTex,color:new Xt(d4(s.color)),transparent:!0,opacity:1,depthWrite:!1}),this.haloMats.set(s.color,d));const p=new ya(d);return p.name=`projectile_halo:${r}`,p.scale.set(h*2,h*2,1),p.renderOrder=h4,c.add(p),c},(s,i)=>{const r=Ie(i.x,i.y);s.position.set(r.x,Mo,r.z)}),yn(this.splatPool,this.group,e.splats,s=>{const i=new T(this.splatGeo,this.splatMats[s.id%Gr]);return i.name="vfx_ground_mark",i.rotation.set(-Math.PI/2,0,Gp(s.id)),i},(s,i)=>{const r=Ie(i.x,i.y);s.position.set(r.x,Z5,r.z)}),yn(this.medikitPool,this.group,e.medikits,()=>{const s=new ne;s.name="vfx_medikit";const i=new T(this.medikitBodyGeo,this.medikitBodyMat);i.name="vfx_medikit_body",s.add(i);for(const r of[this.medikitArmXGeo,this.medikitArmZGeo]){const l=new T(r,this.medikitCrossMat);l.name="vfx_medikit_cross",l.position.y=Xa*.5,s.add(l)}return s},(s,i)=>{const r=Ie(i.x,i.y),l=Q5+Xa*.5+Rp,h=i.armsAt-e.elapsed;if(h>0){const d=Ie(i.fromX,i.fromY),p=1-h/nt.popMs;s.position.set(d.x+(r.x-d.x)*p,l+4*ek*p*(1-p),d.z+(r.z-d.z)*p),s.rotation.set(Math.PI*2*p,Math.PI*3*p,0)}else{const d=e.elapsed-i.armsAt;s.position.set(r.x,l+Math.sin(d*tk)*Rp,r.z),s.rotation.set(0,d*ak,0)}const c=i.expiresAt-e.elapsed;s.scale.setScalar(c<ok&&c>0?1+Math.sin(c*.03)*.14:1)}),yn(this.trailPool,this.group,e.trailMarks,s=>{const i=new T(this.trailGeo,this.trailMatsFor(oa(s.ownerId,s.ownerRole))[s.id%Gr]);return i.name="vfx_ground_mark",i.rotation.set(-Math.PI/2,0,Gp(s.id)),i},(s,i)=>{const r=Ie(i.x,i.y),l=(e.elapsed+i.id*137)*.004,h=1+Math.sin(l)*.08;s.position.set(r.x,J5,r.z),s.scale.setScalar(h)}),a.forEach((s,i)=>{const r=this.statusBySlot[i];if(!r)return;const l=Ie(s.x,s.y),h=s.alive&&s.terrainSlowFactor<1,c=s.alive&&e.elapsed<s.status.slowedUntil,d=h||c;if(r.slowRing.visible=d,r.slowRingDark.visible=d,r.slowTint.visible=d,d){const v=.9+Math.sin(e.elapsed*.0035)*.12,k=e.elapsed*.0012;r.slowRingDark.position.set(l.x,As-.01,l.z),r.slowRingDark.scale.setScalar(v),r.slowRingDark.rotation.z=k,r.slowRingDark.material.opacity=.5,r.slowRing.position.set(l.x,As,l.z),r.slowRing.scale.setScalar(v),r.slowRing.rotation.z=k,r.slowRing.material.opacity=.9,r.slowTint.position.set(l.x,mk,l.z);const M=gk+Math.sin(e.elapsed*.006)*.08;r.slowTint.material.opacity=M}const p=this.slowSplashState[i];if(h){if(Number.isFinite(p.lastX))for(p.distAccum+=Math.hypot(s.x-p.lastX,s.y-p.lastY);p.distAccum>=Np;)p.distAccum-=Np,this.spawnPuddleSplash(l.x,l.z)}else p.distAccum=0;p.lastX=s.x,p.lastY=s.y;const u=e.elapsed>=Ks(s,"stun"),f=e.elapsed>=Ks(s,"slow");this.statusSnapshot[i]={x:s.x,y:s.y,stunReady:u,slowReady:f};const m=s.alive&&!u&&e.elapsed>=s.status.stunnedUntil,g=s.alive&&!f&&e.elapsed>=s.status.slowedUntil,w=m||g,b=r.wardPop>0?r.wardPop/Fp:0;r.wardRing.visible=w||b>0,r.wardRing.visible&&(r.wardRing.position.set(l.x,As-.02,l.z),r.wardRing.rotation.y=-e.elapsed*.0019,r.wardRing.scale.setScalar(1+.5*b),r.wardMat.opacity=w?Op+(1-Op)*b:b,r.wardMat.color.copy(Ur).lerp(r.wardPopColor,b));const y=s.alive&&e.elapsed<s.status.stunnedUntil;r.stunStars.forEach((v,k)=>{if(v.visible=y,!y)return;const M=e.elapsed*.006+k*Math.PI*2/r.stunStars.length;v.position.set(l.x+Math.cos(M)*Ip,ik+Math.sin(e.elapsed*.01+k)*.05,l.z+Math.sin(M)*Ip),v.material.opacity=.95})})}updateEffects(e){for(const a of this.particles){if(!a.active)continue;if(a.life+=e,a.life>=a.maxLife){a.active=!1,a.sprite.visible=!1;continue}const o=a.life/a.maxLife;a.vy+=a.gravity*e,a.sprite.position.x+=a.vx*e,a.sprite.position.y+=a.vy*e,a.sprite.position.z+=a.vz*e;const n=Y.lerp(a.startScale,a.endScale,Up(o));a.sprite.scale.set(n,n*a.aspect,1),a.mat.opacity=Math.max(0,Y.lerp(a.startOpacity,a.endOpacity,Math.pow(o,a.fadeEase)))}for(const a of this.wedges){if(!a.active)continue;if(a.life+=e,a.life>=a.maxLife){a.active=!1,a.mesh.visible=!1;continue}const o=a.life/a.maxLife;a.mat.opacity=a.startOpacity*(1-Math.pow(o,1.8))}for(const a of this.rings){if(!a.active)continue;if(a.life+=e,a.life>=a.maxLife){a.active=!1,a.mesh.visible=!1;continue}const o=a.life/a.maxLife,n=Y.lerp(a.startScale,a.targetScale,Up(o));a.mesh.scale.set(n,n,n),a.mat.opacity=a.startOpacity*(1-o)}for(const a of this.statusBySlot)a.wardPop>0&&(a.wardPop=Math.max(0,a.wardPop-e));for(let a=this.transientEffects.length-1;a>=0;a--){const o=this.transientEffects[a];if(o.life+=e,o.life>=o.maxLife){this.group.remove(o.object),Kr(o.object),o.telegraphOwner!==void 0&&this.castTelegraphs.get(o.telegraphOwner)===o.object&&this.castTelegraphs.delete(o.telegraphOwner),this.detachUnionMember(o),this.transientEffects.splice(a,1);continue}o.onUpdate?.(o.life/o.maxLife,o.life)}this.updateUnionScopes(e)}spawnTransientObject(e,a,o,n){Nf(e),Bp(e),this.group.add(e);const s=this.pendingUnion;s&&(s.members.push(e),this.unionMemberState.set(e,Bk(e)),s.maxLife=Math.max(s.maxLife,Math.max(.001,a)),ba.members++),this.transientEffects.push({object:e,life:0,maxLife:Math.max(.001,a),onUpdate:o,telegraphOwner:n,union:s??void 0})}openUnionScope(e,a){this.pendingUnion={cx:e.x,cy:wa,cz:e.z,members:[],life:0,maxLife:0,core:null,color:a}}closeUnionScope(){const e=this.pendingUnion;if(this.pendingUnion=null,!e)return;if(ba.scopes++,e.members.length<$k){ba.inert++;return}const a=this.unionCores.find(o=>!o.busy)??null;a?(a.busy=!0,a.sprite.visible=!0,a.sprite.position.set(e.cx,e.cy,e.cz),a.sprite.scale.set(Wr,Wr,1),a.mat.color.set(e.color).lerp(ft,Nk),a.mat.opacity=0,e.core=a,ba.cores++):ba.coresStarved++,this.unionScopes.push(e)}detachUnionMember(e){if(!e.union)return;const a=e.union.members.indexOf(e.object);a>=0&&e.union.members.splice(a,1)}releaseUnionCore(e){e.core&&(e.core.busy=!1,e.core.sprite.visible=!1,e.core.mat.opacity=0,e.core=null)}updateUnionScopes(e){this.unionFrame++;for(let a=this.unionScopes.length-1;a>=0;a--){const o=this.unionScopes[a];if(o.life+=e,o.members.length===0||o.life>=o.maxLife){this.releaseUnionCore(o),this.unionScopes.splice(a,1);continue}const n=this.unionDistScratch;n.length=0;for(const p of o.members){if(!qk(p,this.unionPointScratch)){n.push(-1);continue}n.push(this.unionPointScratch.distanceTo(this.unionCentreScratch.set(o.cx,o.cy,o.cz)))}const s=this.unionSortScratch;s.length=0;for(const p of n)p>=0&&s.push(p);if(s.length===0)continue;s.sort((p,u)=>p-u);const i=s[Math.min(s.length-1,Math.floor(s.length*_k))],r=Y.clamp(i,Wr,zk);let l=0,h=0;for(let p=0;p<o.members.length;p++){const u=n[p];if(u<0)continue;const f=this.unionMemberState.get(o.members[p]);if(!f||f.mats.length===0)continue;const m=Math.min(1,u/r);l+=1-qp*m*m,h++}if(h===0)continue;const c=l>1e-9?h/l:1;for(let p=0;p<o.members.length;p++){const u=n[p];if(u<0)continue;const f=this.unionMemberState.get(o.members[p]);if(!f||f.mats.length===0)continue;const m=Math.min(1,u/r),g=(1-qp*m*m)*c;for(const w of f.mats){const b=w.opacity;let y=this.unionMatState.get(w);y||(y={frame:-1,base:b,written:NaN},this.unionMatState.set(w,y)),y.frame!==this.unionFrame?(y.base=y.written===b?y.base:b,y.frame=this.unionFrame):ba.aliasTouches++;const v=Math.min(1,y.base*g);y.written=v,w.opacity=v}}const d=o.core;if(d){const p=Math.min(1,o.life/Dk),u=2*r*Fk;d.sprite.position.set(o.cx,o.cy,o.cz),d.sprite.scale.set(u,u,1),d.mat.opacity=Lk*Math.pow(1-p,Hk),p>=1&&this.releaseUnionCore(o)}}}spawnCastTelegraph(e,a,o,n,s,i,r){if(!(r>0))return;const l=s.range??0;if(!(l>0))return;Qt("castTelegraph"),this.cancelCastTelegraph(e,"resolved");const h=Ie(a,o),c=s.type==="melee"?s.cone??360:Math.max(12,s.spreadDeg??18),d=Xe(l),p=bn(i,s.key)?.telegraph,u=s.giantSlam!==!0;if(!u&&!p)return;const f=`${Math.round(c)}_${d.toFixed(3)}`;let m=this.wedgeGeoCache.get(f);m||(m=Vr(d,c),this.wedgeGeoCache.set(f,m));const g=new Xt(s.color),w=Math.atan2(n.x,n.y),b=(I,N,L,_,U)=>{const D=new V({color:N,map:U?this.telegraphRimTex:null,transparent:!0,opacity:0,depthWrite:!1,side:me});D.userData.__ownMat=!0;const W=new T(m,D);return W.name=I,W.rotation.y=w,W.position.set(0,L,0),W.renderOrder=_,W},y=new ne;y.name="castTelegraph",y.position.set(h.x,qa,h.z);const v=u?b("castTelegraphBase",b4(g,.26),0,5,!1):null,k=u?b("castTelegraphFill",Zp(g,ft,.22),.012,5.01,!1):null,M=u?b("castTelegraphRim",Zp(g,ft,.6),.024,5.02,!0):null;v&&k&&M&&y.add(v,k,M);const x=r/1e3,S=v?.material,E=k?.material,A=M?.material;this.castTelegraphs.set(e,y);const C=(I,N)=>{if(!v||!k||!M||!S||!E||!A)return;const L=Y.clamp(N/x,0,1),_=N<=x?1:Math.max(0,1-(N-x)/Kp),U=.5+.5*Math.sin(Math.PI*2*(2*L+3*L*L));S.opacity=(.6+.14*U)*_;const D=.1+.9*L;k.scale.set(D,1,D),E.opacity=(.7+.22*L)*_,A.opacity=(.62+.36*L*L)*_};if(C(0,0),this.spawnTransientObject(y,x+Kp,C,e),!p)return;const R={THREE:sn,position:new de(h.x,qr,h.z),direction:new de(n.x,0,n.y).normalize(),color:s.color,damage:s.damage,weapon:s,characterId:i,castMs:r,spawnTransient:(I,N,L)=>this.spawnTransientObject(I,N,L,e)};p(R)}cancelCastTelegraph(e,a){const o=this.castTelegraphs.get(e);if(o){this.castTelegraphs.delete(e);for(let n=this.transientEffects.length-1;n>=0;n--){const s=this.transientEffects[n];if(s.telegraphOwner===e){if(s.object===o&&a!=="resolved"){const i=s.life,r=o.children.map(l=>l.material.opacity);s.maxLife=i+Xp,s.onUpdate=(l,h)=>{const c=Y.clamp((h-i)/Xp,0,1),d=Math.max(.001,1-c);o.scale.set(d,1,d);for(let p=0;p<o.children.length;p++){const u=o.children[p].material;u.opacity=r[p]*(1-c)}};continue}this.group.remove(s.object),Kr(s.object),this.detachUnionMember(s),this.transientEffects.splice(n,1)}}}}spawnWeaponCast(e,a,o,n,s){const i=!!bn(s,n.key)?.cast;this.spawnCastFlash(e,a,o,n,s),n.type==="melee"&&(n.giantSlam&&i||this.spawnMeleeArc(e,a,o,n.range??0,n.cone??360,n.color)),n.giantSlam&&this.spawnGiantSlamShockwave(e,a,n.color,n.range??0,{bespokeOwnsGround:i})}spawnCastFlash(e,a,o,n,s){Qt("cast");const i=Ie(e,a),r=Math.hypot(o.x,o.y)||1,l=o.x/r,h=o.y/r,c=.7,d=n.color,p=bn(s,n.key)?.cast;if(this.castMuzzle(i.x+l*c,i.z+h*c,d,p?"subordinate":"primary"),!p)return;const u={THREE:sn,position:new de(i.x+l*c,qr,i.z+h*c),direction:new de(l,0,h),color:d,damage:n.damage,weapon:n,characterId:s,spawnTransient:(f,m,g)=>this.spawnTransientObject(f,m,g)};p(u)}castMuzzle(e,a,o,n){const s=n==="primary"?1:.75,i=this.allocParticle();i.active=!0,i.life=0,i.maxLife=n==="primary"?.16:.13,i.sprite.visible=!0,i.sprite.position.set(e,qr,a),i.vx=0,i.vy=0,i.vz=0,i.gravity=0,i.startScale=.75*s,i.endScale=1.3*s,i.startOpacity=1,i.endOpacity=0,i.fadeEase=1.6,i.mat.color.set(o).lerp(ft,.4)}spawnMeleeArc(e,a,o,n,s,i){Qt("meleeArc");const r=Ie(e,a),l=Xe(n),h=`${Math.round(s)}_${l.toFixed(3)}`;let c=this.wedgeGeoCache.get(h);c||(c=Vr(l,s),this.wedgeGeoCache.set(h,c));const d=this.allocWedge();d.active=!0,d.life=0,d.maxLife=.3,d.startOpacity=.88,d.mesh.visible=!0,d.mesh.geometry=c,d.mesh.rotation.y=Math.atan2(o.x,o.y),d.mesh.position.set(r.x,qa,r.z),d.mat.color.set(i).lerp(Tk,.14),d.mat.opacity=d.startOpacity}spawnImpactStarDecal(e,a,o,n){const s=`star_${o.toFixed(3)}`;let i=this.wedgeGeoCache.get(s);i||(i=f4(o,8,.42),this.wedgeGeoCache.set(s,i));const r=this.allocWedge();r.active=!0,r.life=0,r.maxLife=n,r.startOpacity=.9,r.mesh.visible=!0,r.mesh.geometry=i,r.mesh.rotation.y=Math.random()*Math.PI*2,r.mesh.position.set(e.x,qa+.03,e.z),r.mat.map=null,Ff(i),r.mat.vertexColors,r.mat.vertexColors=!0,r.mat.needsUpdate=!0,r.mat.color.set(a).lerp(ft,.05),r.mat.opacity=r.startOpacity}spawnImpactBurst(e,a,o,n,s){Qt("impact");const i=Ie(e,a);(s?.weapon.effect==="stun"||s?.weapon.effect==="slow")&&this.flagStatusRefused(e,a,s.weapon.effect,s.weapon.color);const r=s&&bn(s.characterId,s.weapon.key)?.impact;if(this.impactAnchor(i,o,n,r?"subordinate":"primary"),r&&s){let l=0,h=0;if(s.fromXWU!==void 0&&s.fromYWU!==void 0){const d=Yr(e-s.fromXWU,a-s.fromYWU);l=d.x,h=d.y}const c={THREE:sn,position:new de(i.x,wa,i.z),direction:new de(l,0,h),color:o,damage:n,weapon:s.weapon,characterId:s.characterId,spawnTransient:(d,p,u)=>this.spawnTransientObject(d,p,u)};this.openUnionScope(i,o);try{r(c)}finally{this.closeUnionScope()}}}impactAnchor(e,a,o,n){const s=n==="primary"?1:nk,i=Y.clamp(.42+o*.075,.42,2)*s,r=Math.max(2,Math.round(Y.clamp(1+o*.4,2,8)*s));if(n==="primary"){this.burst(e,a,i,r);return}this.burst(e,a,i,0,{skipFlash:!0,skipStreaks:!0,decalMinRadius:sk})}flagStatusRefused(e,a,o,n){for(let s=0;s<this.statusSnapshot.length;s++){const i=this.statusSnapshot[s];if(!Number.isFinite(i.x)||Math.hypot(i.x-e,i.y-a)>1)continue;if(o==="stun"?i.stunReady:i.slowReady)return;const l=this.statusBySlot[s];if(l){l.wardPop=Fp,l.wardPopColor.set(n).lerp(ft,.35);return}}}spawnDeathBurst(e,a,o){Qt("death");const n=Ie(e,a);this.burst(n,o,2.6,9,{life:1.35})}spawnHealPulse(e,a){Qt("heal");const o=Ie(e,a),n=7;for(let s=0;s<n;s++){const i=this.allocParticle(),r=s/n*Math.PI*2+Math.random()*.5,l=.66+Math.random()*.3;i.active=!0,i.life=0,i.maxLife=.72+Math.random()*.22,i.sprite.visible=!0,i.sprite.position.set(o.x+Math.cos(r)*l,J*.22,o.z+Math.sin(r)*l),i.vx=Math.cos(r)*.22,i.vz=Math.sin(r)*.22,i.vy=2+Math.random()*.45,i.gravity=-.45,i.startScale=.46+Math.random()*.14,i.endScale=.14,i.startOpacity=.95,i.endOpacity=0,i.fadeEase=1,i.mat.color.set("#6FE0A8")}}spawnPuddleSplash(e,a){Qt("puddleSplash");const o=5;for(let n=0;n<o;n++){const s=this.allocParticle(),i=n/o*Math.PI*2+Math.random()*1,r=Ja*(.58+Math.random()*.16);s.active=!0,s.life=0,s.maxLife=.3+Math.random()*.12,s.sprite.visible=!0,s.sprite.position.set(e+Math.cos(i)*r,As,a+Math.sin(i)*r);const l=2.2+Math.random()*.6;s.vx=Math.cos(i)*l,s.vz=Math.sin(i)*l,s.vy=1.1+Math.random()*.5,s.gravity=-5.5,s.startScale=.58+Math.random()*.2,s.endScale=.12,s.startOpacity=1,s.endOpacity=0,s.fadeEase=1,s.mat.color.set("#E8F8FF")}}spawnCoverScuff(e,a,o,n,s){Qt("coverScuff");const i=Ie(e,a),r=Math.hypot(n,s),l=r>1e-4?-n/r:0,h=r>1e-4?-s/r:-1,c=this.allocParticle();c.active=!0,c.life=0,c.maxLife=.12,c.sprite.visible=!0,c.sprite.position.set(i.x,Mo,i.z),c.vx=0,c.vy=0,c.vz=0,c.gravity=0,c.startScale=.42,c.endScale=.85,c.startOpacity=1,c.endOpacity=0,c.fadeEase=1.4,c.mat.color.set(o).lerp(ft,.6);for(let d=0;d<5;d++){const p=(Math.random()-.5)*(Math.PI*2/3),u=Math.cos(p),f=Math.sin(p),m=l*u-h*f,g=l*f+h*u,w=this.allocParticle();w.mat.map=this.streakTex,w.mat.rotation=Math.atan2(g,m),w.aspect=.22,w.active=!0,w.life=0,w.maxLife=.22+Math.random()*.1,w.sprite.visible=!0,w.sprite.position.set(i.x+l*.22,Mo,i.z+h*.22),w.vx=m*(2.4+Math.random()*1.6),w.vz=g*(2.4+Math.random()*1.6),w.vy=.9+Math.random()*.7,w.gravity=-7.5,w.startScale=.62+Math.random()*.28,w.endScale=.12,w.startOpacity=1,w.endOpacity=0,w.fadeEase=1.2,w.mat.color.set(_p)}}spawnGiantSlamShockwave(e,a,o,n,s){Qt("giantSlam");const i=Ie(e,a),r=Xe(n);if(!(s?.bespokeOwnsGround??!1)){const h=this.allocRing();h.active=!0,h.life=0,h.maxLife=.65,h.startScale=.3,h.targetScale=r*1.05,h.startOpacity=1,h.mesh.visible=!0,h.mesh.position.set(i.x,qa+.02,i.z),h.mesh.scale.setScalar(h.startScale),h.mat.color.set(o).lerp(ft,.3),h.mat.opacity=h.startOpacity;const c=this.allocRing();c.active=!0,c.life=0,c.maxLife=.8,c.startScale=.15,c.targetScale=r*.85,c.startOpacity=.6,c.mesh.visible=!0,c.mesh.position.set(i.x,qa+.01,i.z),c.mesh.scale.setScalar(c.startScale),c.mat.color.set(o),c.mat.opacity=c.startOpacity,this.spawnStarPop(i,wa*1.5,o,5.2,.38);const d=this.allocParticle();d.active=!0,d.life=0,d.maxLife=.3,d.sprite.visible=!0,d.sprite.position.set(i.x,wa*1.5,i.z),d.vx=0,d.vy=0,d.vz=0,d.gravity=0,d.startScale=1.8,d.endScale=3.5,d.startOpacity=.9,d.endOpacity=0,d.fadeEase=1.2,d.mat.color.set(o).lerp(ft,.4),this.spawnStreaks(i,wa*.6,"#FFE79A",10,4.5,.55)}this.burst(i,o,3.2,14,{life:.9,speedMult:1.7,skipFlash:!0,skipRing:!0,skipStreaks:!0,skipDecal:!0})}burst(e,a,o,n,s){const i=s?.life??1,r=s?.speedMult??1;if(s?.skipDecal||this.spawnImpactStarDecal(e,a,Y.clamp(.65*o,s?.decalMinRadius??.55,1.5),(.55+o*.08)*i),!s?.skipFlash){const h=this.allocParticle();h.active=!0,h.life=0,h.maxLife=(.16+o*.04)*i,h.sprite.visible=!0,h.sprite.position.set(e.x,wa,e.z),h.vx=0,h.vy=0,h.vz=0,h.gravity=0,h.startScale=.5*o,h.endScale=1.15*o,h.startOpacity=1,h.endOpacity=0,h.fadeEase=1.4,h.mat.color.set(a).lerp(ft,.3)}if(!s?.skipRing){const h=this.allocRing();h.active=!0,h.life=0,h.maxLife=(.24+o*.06)*i,h.startScale=.15,h.targetScale=.6*o+.35,h.startOpacity=.95,h.mesh.visible=!0,h.mesh.position.set(e.x,qa,e.z),h.mesh.scale.setScalar(h.startScale),h.mat.color.set(a).lerp(ft,.25),h.mat.opacity=h.startOpacity;const c=this.allocRing();c.active=!0,c.life=0,c.maxLife=(.32+o*.08)*i,c.startScale=.1,c.targetScale=(.6*o+.35)*1.35,c.startOpacity=.55,c.mesh.visible=!0,c.mesh.position.set(e.x,qa-.01,e.z),c.mesh.scale.setScalar(c.startScale),c.mat.color.set(a),c.mat.opacity=c.startOpacity}if(!s?.skipStreaks){const h=Math.max(4,Math.round(n*.7));this.spawnStreaks(e,wa,"#FFE79A",h,(.5+o*.5)*r,.26*i)}const l=.4*o;for(let h=0;h<n;h++){const c=this.allocParticle();c.mat.map=this.shardTex;const d=Math.random()*Math.PI*2;c.mat.rotation=d,c.aspect=.4+Math.random()*.15;const p=(2.6+Math.random()*2.8)*(.6+o*.4)*r,u=.18+Math.random()*.24;c.active=!0,c.life=0,c.maxLife=(.36+Math.random()*.22+o*.06)*i,c.sprite.visible=!0,c.sprite.position.set(e.x+Math.cos(d)*u,wa,e.z+Math.sin(d)*u),c.vx=Math.cos(d)*p,c.vz=Math.sin(d)*p,c.vy=1.3+Math.random()*1.8,c.gravity=-6.2,c.startScale=l*(.8+Math.random()*.5),c.endScale=l*.2,c.startOpacity=1,c.endOpacity=0,c.fadeEase=.85,c.mat.color.set(_p)}}allocParticle(){let e=null;for(const o of this.particles)if(!o.active){e=o;break}if(!e){let o=-1/0;for(const n of this.particles){const s=n.life/n.maxLife;s>o&&(o=s,e=n)}}const a=e;return a.mat.map=this.glowTex,a.mat.rotation=0,a.aspect=1,a}spawnStarPop(e,a,o,n,s){const i=this.allocParticle();i.mat.map=this.starTex,i.active=!0,i.life=0,i.maxLife=s,i.sprite.visible=!0,i.sprite.position.set(e.x,a,e.z),i.vx=0,i.vy=0,i.vz=0,i.gravity=0,i.startScale=n*.5,i.endScale=n,i.startOpacity=1,i.endOpacity=0,i.fadeEase=1.7,i.mat.color.set(o).lerp(ft,.45)}spawnStreaks(e,a,o,n,s,i){for(let r=0;r<n;r++){const l=this.allocParticle();l.mat.map=this.streakTex,l.mat.rotation=Math.random()*Math.PI*2,l.aspect=.22,l.active=!0,l.life=0,l.maxLife=i*(.8+Math.random()*.4),l.sprite.visible=!0,l.sprite.position.set(e.x,a,e.z),l.vx=0,l.vy=0,l.vz=0,l.gravity=0,l.startScale=s*(.7+Math.random()*.3),l.endScale=s*1.35,l.startOpacity=.95,l.endOpacity=0,l.fadeEase=1.3,l.mat.color.set(o).lerp(ft,.3)}}allocWedge(){let e;for(const a of this.wedges)if(!a.active){e=a;break}return e||(e=this.wedges.reduce((a,o)=>a.life/a.maxLife>=o.life/o.maxLife?a:o)),e.mat.map!==this.wedgeGradientTex&&(e.mat.map=this.wedgeGradientTex,e.mat.needsUpdate=!0),e.mat.vertexColors&&(e.mat.vertexColors=!1,e.mat.needsUpdate=!0),e}allocRing(){for(const e of this.rings)if(!e.active)return e;return this.rings.reduce((e,a)=>e.life/e.maxLife>=a.life/a.maxLife?e:a)}clear(){for(const e of[this.projectilePool,this.shellPool,this.splatPool,this.trailPool,this.medikitPool]){for(const a of e.values())this.group.remove(a);e.clear()}for(const e of this.particles)e.active=!1,e.sprite.visible=!1;for(const e of this.wedges)e.active=!1,e.mesh.visible=!1;for(const e of this.rings)e.active=!1,e.mesh.visible=!1;for(const e of this.transientEffects)this.group.remove(e.object),Kr(e.object);this.transientEffects.length=0;for(const e of this.unionScopes)this.releaseUnionCore(e);this.unionScopes.length=0,this.pendingUnion=null,this.castTelegraphs.clear(),this.lastSyncElapsedMs=0;for(let e=0;e<this.statusBySlot.length;e++){const a=this.statusBySlot[e];a.slowRing.visible=!1,a.slowRingDark.visible=!1,a.slowTint.visible=!1,a.stunStars.forEach(n=>{n.visible=!1}),a.wardRing.visible=!1,a.wardPop=0,this.statusSnapshot[e]={x:NaN,y:NaN,stunReady:!0,slowReady:!0};const o=this.slowSplashState[e];o.lastX=NaN,o.lastY=NaN,o.distAccum=0}}dispose(){this.clear(),delete window.__vfxSpawnTest,window.__vfxLayer===this&&delete window.__vfxLayer,this.projectileGeo.dispose(),this.splatGeo.dispose(),this.trailGeo.dispose(),this.medikitBodyGeo.dispose(),this.medikitArmXGeo.dispose(),this.medikitArmZGeo.dispose(),this.medikitBodyMat.dispose(),this.medikitCrossMat.dispose(),this.splatMats.forEach(e=>e.dispose()),Object.values(this.trailMats).forEach(e=>e.forEach(a=>a.dispose())),this.glazeTexByColor.forEach(e=>e.forEach(a=>a.dispose())),this.glazeTexByColor.clear(),this.materialCache.forEach(e=>e.dispose()),this.materialCache.clear(),this.haloTex.dispose(),this.haloMats.forEach(e=>e.dispose()),this.haloMats.clear(),this.glowTex.dispose(),this.coreTex.dispose(),this.softDiscTex.dispose(),this.starTex.dispose(),this.streakTex.dispose(),this.shardTex.dispose(),this.wedgeGradientTex.dispose(),this.telegraphRimTex.dispose();for(const e of this.particles)e.mat.dispose();for(const e of this.unionCores)e.mat.dispose();for(const e of this.wedges)e.mat.dispose();for(const e of this.rings)e.mat.dispose();this.wedgeGeoCache.forEach(e=>e.dispose()),this.wedgeGeoCache.clear(),this.ringUnitGeo.dispose(),this.wardGeo.dispose();for(const e of this.statusBySlot)e.slowRing.material.dispose(),e.slowRing.geometry.dispose(),e.slowRingDark.material.dispose(),e.slowRingDark.geometry.dispose(),e.slowTint.material.dispose(),e.stunStars.forEach(a=>a.material.dispose()),e.wardMat.dispose()}measureShell(e){let a=Xe(10);if(this.shellBox.setFromObject(e),!this.shellBox.isEmpty()){this.shellBox.getSize(this.shellSize);const s=.5*Math.max(this.shellSize.x,this.shellSize.y,this.shellSize.z);s>1e-4&&(a=s)}const o=Math.min(a4,Math.max(1,t4/a)),n=Math.min(n4,Math.max(Vp,a*o*o4));e.userData.shellSpec={scale:o,haloR:n}}materialFor(e){let a=this.materialCache.get(e);return a||(a=_e({color:e,roughness:X5,metalness:0}),this.materialCache.set(e,a)),a}}function Hl(t,e,a){return rh(e.x,e.y,a.x,a.y,t.arena,t,a)}function Jp(t,e){return Pe(t)[e.observerSlot??Oe]??Ze(t)}function Xr(t){return t.phase==="playing"&&!Ze(t).alive}const Qp="hud-styles";function x4(){if(document.getElementById(Qp))return;const t=document.createElement("style");t.id=Qp,t.textContent=E4,document.head.appendChild(t)}function e0(t){const e=Math.max(0,Math.ceil(t/1e3)),a=Math.floor(e/60),o=e%60;return`${a}:${String(o).padStart(2,"0")}`}function v4(t){const e=Math.max(0,Math.round(t/1e3)),a=Math.floor(e/60),o=e%60;return`${a}:${String(o).padStart(2,"0")}`}const t0=.25,a0=.14;function k4(t,e,a,o){const n=o>0?Math.max(0,Math.min(1,a/o)):0;t.style.width=`${(n*100).toFixed(1)}%`,e.textContent=`${Math.max(0,Math.ceil(a))} / ${o}`}function M4(t,e){x4(),ca(),t.innerHTML=`
    <div class="hud-root">
  ...
  `;const a=G=>{const te=t.querySelector(`[data-el="${G}"]`);if(!te)throw new Error(`hud: missing element "${G}"`);return te},o=a("timer"),n=a("weapons"),s=a("spectate"),i=a("countdown"),r=a("gameover"),l=a("gameover-title"),h=a("gameover-place"),c=a("gameover-subtitle"),d=a("gameover-stats"),p=a("gameover-payout"),u=a("gameover-btn"),f=a("topbar"),m=t.querySelector(".hud-clock"),g=t.querySelector(".hud-root"),w=a("dmg-layer"),b=a("screenflash"),y=a("zone"),v=a("zone-label"),k=a("zone-value"),M=a("zone-bar"),x=a("radar"),S=a("radar-safe"),E=a("radar-arena"),A=a("radar-map"),C=a("radar-cap"),R=a("fogedge"),I=a("fogtick"),N=a("safearrow"),L=a("safearrow-label"),_=a("aim-stick"),U=a("aim-reticle"),D=a("mute");let W=[],F=null;function z(G){if(W.length===G)return;for(const he of W)he.bar.parentElement?.remove(),he.float.remove(),he.blip.remove();W=[],F?.remove(),F=null;const te=G>2;f.classList.toggle("hud-topbar--chips",te),te&&(F=document.createElement("div"),F.className="hud-chips",F.dataset.el="chips",f.appendChild(F));for(let he=0;he<G;he++){const B=iw(he),ue=he===0?"player":"enemy",le=te&&he>0,fe=document.createElement("div");fe.className=`hud-fighter hud-fighter--${ue}${le?" hud-fighter--chip":""}`;const Ae=`<div class="hud-fighter-level" data-el="${B}-level"><span class="hud-fighter-level-tag">LV</span><span class="hud-fighter-level-n" data-el="${B}-level-n"></span></div>`,qe=he===0?`<div class="hud-fighter-emoji" data-el="${B}-emoji"></div><div class="hud-fighter-name" data-el="${B}-name"></div>`+Ae:Ae+`<div class="hud-fighter-name" data-el="${B}-name"></div><div class="hud-fighter-emoji" data-el="${B}-emoji"></div>`;fe.innerHTML=`<div class="hud-fighter-pill">${qe}</div><div class="hud-healthbar hud-healthbar--${ue}" data-el="${B}-bar"><div class="hud-healthbar-fill" data-el="${B}-fill"></div><div class="hud-healthbar-text" data-el="${B}-hp"></div></div>`,he===0?f.insertBefore(fe,m):F?F.appendChild(fe):f.appendChild(fe);const ze=document.createElement("div");ze.className=`hud-float hud-float--${ue}`,ze.dataset.el=`float-${B}`,ze.innerHTML=`<div class="hud-float-pill"><div class="hud-float-emoji" data-el="float-${B}-emoji"></div><div class="hud-float-bar"><div class="hud-float-fill" data-el="float-${B}-fill"></div></div></div>`,x.parentElement.insertBefore(ze,x);const Ue=document.createElement("div");Ue.className=`hud-radar-dot hud-radar-dot--${ue}`,Ue.dataset.el=`radar-${B}`,he===0?A.appendChild(Ue):A.insertBefore(Ue,A.querySelector(".hud-radar-dot--player")),W.push({name:fe.querySelector(`[data-el="${B}-name"]`),emoji:fe.querySelector(`[data-el="${B}-emoji"]`),level:fe.querySelector(`[data-el="${B}-level-n"]`),levelValue:-1,bar:fe.querySelector(`[data-el="${B}-bar"]`),fill:fe.querySelector(`[data-el="${B}-fill"]`),hpText:fe.querySelector(`[data-el="${B}-hp"]`),float:ze,floatEmoji:ze.querySelector(`[data-el="float-${B}-emoji"]`),floatFill:ze.querySelector(`[data-el="float-${B}-fill"]`),blip:Ue})}}z(2);let P=0,K=null;function ce(){const G=ke.isMuted();if(G===K)return;const te=K===null;if(K=G,window.clearTimeout(P),G){D.innerHTML=H("mute")+"<span>MUTED · M</span>",D.classList.add("is-on"),D.classList.remove("is-ok");return}if(te){D.classList.remove("is-on","is-ok");return}D.innerHTML=H("sound")+"<span>SOUND ON · M</span>",D.classList.add("is-on","is-ok"),P=window.setTimeout(()=>D.classList.remove("is-on","is-ok"),1500)}const ie=ke.onChange(ce);ce();const $=24,ee=[];let ye=0;for(let G=0;G<$;G++){const te=document.createElement("div");te.className="hud-dmg",w.appendChild(te),ee.push(te)}function Se(G,te){const he=G.replace("#",""),B=he.length===3?he.split("").map(Ae=>Ae+Ae).join(""):he,ue=parseInt(B.slice(0,2),16)||0,le=parseInt(B.slice(2,4),16)||0,fe=parseInt(B.slice(4,6),16)||0;return`rgba(${ue},${le},${fe},${te})`}u.addEventListener("click",()=>e.onRestart());let Ve=null,bo=[];function Zn(G){n.innerHTML="",bo=G.map((te,he)=>{const B=document.createElement("div");return B.className="hud-weapon-slot",B.innerHTML=`
        <div class="hud-weapon-cooldown"></div>
        <div class="hud-weapon-emoji">${J0(te.emoji)}</div>
        <div class="hud-weapon-timer" data-role="timer"></div>
        <div class="hud-weapon-key">${he+1}</div>
      `,B.addEventListener("pointerdown",ue=>{ue.preventDefault(),ue.stopPropagation(),e.onSelectWeapon?.(he)}),n.appendChild(B),{root:B,cooldown:B.querySelector(".hud-weapon-cooldown"),timer:B.querySelector('[data-role="timer"]'),wasReady:!0}})}const Jn=Math.round(ql/Bs*1e3);function en(G,te){const he=$i(G-Rm.radiusUnits,G,te)-$i(G,G,te);return he>0?Math.min(12e3,he):0}function Qn(G){const te=G.arena.maxSafeRadius,he=Ze(G),B=Math.hypot(he.x-G.arena.center.x,he.y-G.arena.center.y),ue=B>G.safeRadius,le=Ra-G.timeRemaining,fe=$s(G.fighters.length),Ae=B<=u0(G.fighters.length,G.timeRemaining);return{outside:ue,holds:Ae,ringAtFloor:G.safeRadius<=fe,sudden:Cn(G.timeRemaining),radius01:te>0?Math.max(0,Math.min(1,G.safeRadius/te)):0,msUntilEdge:ue||Ae?null:$i(B,te,fe)-le}}const Gh=56;let jh=0,Di=-1,Wh=-1,Yh=-1;function Hi(){if(window.innerWidth!==Di||window.innerHeight!==Wh||W.length!==Yh){Di=window.innerWidth,Wh=window.innerHeight,Yh=W.length;const G=f.getBoundingClientRect().bottom;jh=G+36,w.style.setProperty("--fa-dmg-top",`${Math.max(0,Math.round(G+2))}px`),g.style.setProperty("--fa-topbar-b",`${Math.max(0,Math.round(G))}px`)}return jh}let es=0;function Bf(G,te){const he=Xr(G);if(s.classList.toggle("is-on",he),!he){s.textContent!==""&&(s.textContent="");return}const B=Jp(G,te),le=B!==Ze(G)?`Spectating ${re[B.characterId].name}`:"Eliminated";s.textContent!==le&&(s.textContent=le)}function qf(G,te){const he=G.phase==="playing",B=Qn(G),ue=Xr(G),le=he&&B.outside&&Ze(G).alive,fe=he&&B.sudden,Ae=G.arena.maxSafeRadius;y.classList.toggle("is-danger",le),y.classList.toggle("is-imminent",!le&&!ue&&B.msUntilEdge!==null&&B.msUntilEdge<en(Ae,$s(G.fighters.length))),M.style.width=`${(B.radius01*100).toFixed(1)}%`,fe?(v.textContent="SUDDEN DEATH",k.textContent="MOST HP WINS"):le?(v.textContent="▲ OUTSIDE THE ZONE",k.textContent=`−${Jn} HP/s`):(v.textContent="ZONE CLOSES",k.textContent=ue?B.ringAtFloor?"FINAL RING":"CLOSING":B.msUntilEdge!==null?`REACHES YOU ${e0(B.msUntilEdge)}`:B.holds?"FINAL RING":"CLOSING");const qe=G.arena.width,ze=G.arena.height,Ue=G.arena.center.x,Zt=G.arena.center.y,tn=qe/ze,yo=Math.max(Ae,Ue,qe-Ue)*(1+a0),zi=Math.max(Zt,ze-Zt)*(1+a0),$t=Math.max(2*yo,2*zi*tn),ge=$t/tn,yt=tt=>`${(50+(tt-Ue)/$t*100).toFixed(2)}%`,xo=tt=>`${(50+(tt-Zt)/ge*100).toFixed(2)}%`,an=tt=>`${(tt/$t*100).toFixed(2)}%`,Vh=tt=>`${(tt/ge*100).toFixed(2)}%`;S.style.left=yt(Ue),S.style.top=xo(Zt),S.style.width=an(G.safeRadius*2),S.style.height=Vh(G.safeRadius*2),E.style.left=yt(qe/2),E.style.top=xo(ze/2),E.style.width=an(qe),E.style.height=Vh(ze);const Gf=Jp(G,te);Pe(G).forEach((tt,on)=>{const vo=W[on]?.blip;vo&&(vo.style.left=yt(tt.x),vo.style.top=xo(tt.y),vo.style.display=on===Oe?tt.alive?"block":"none":tt.alive&&Hl(G,Gf,tt)?"block":"none")}),x.classList.toggle("is-danger",le),C.textContent=fe?"SUDDEN DEATH":le?"GET INSIDE":"SAFE ZONE",R.classList.toggle("is-on",le);const fa=le&&!fe?te.safeArrow??null:null;if(fa){N.style.display="block",L.style.display="block";const tt=fa.angleRad*180/Math.PI;N.style.transform=`translate(${fa.at.x.toFixed(1)}px, ${fa.at.y.toFixed(1)}px) rotate(${tt.toFixed(1)}deg)`,(es===0||window.innerWidth!==Di)&&(es=L.offsetWidth/2);const on=8,vo=Math.min(Math.max(fa.at.x+Math.cos(fa.angleRad)*178,es+on),window.innerWidth-es-on),jf=Math.min(Math.max(fa.at.y+Math.sin(fa.angleRad)*178,Hi()+4),window.innerHeight-22);L.style.transform=`translate(${vo.toFixed(1)}px, ${jf.toFixed(1)}px) translate(-50%, -50%)`}else N.style.display="none",L.style.display="none"}function Uf(G){const te=G.aim??null;if(!te){_.style.display="none",U.style.display="none";return}const he=te.at.x-te.from.x,B=te.at.y-te.from.y,ue=Math.hypot(he,B),le=Math.atan2(B,he)*180/Math.PI;_.style.display="block",_.style.width=`${ue.toFixed(1)}px`,_.style.transform=`translate(${te.from.x.toFixed(1)}px, ${te.from.y.toFixed(1)}px) rotate(${le.toFixed(1)}deg)`,U.style.display="flex",U.style.transform=`translate(${te.at.x.toFixed(1)}px, ${te.at.y.toFixed(1)}px) translate(-50%, -50%)`}return{setCharacters(G){z(G.length),Ve=G[Oe]??null,G.forEach((te,he)=>{const B=W[he];B&&(B.name.textContent=re[te].name,B.emoji.innerHTML=Ta(te,{crop:"head"}),B.floatEmoji.innerHTML=Ta(te,{crop:"head"}))}),Ve&&Zn(re[Ve].weapons),Bo(t,{generate:!1})},update(G,te){o.textContent=e0(G.timeRemaining),Pe(G).forEach((B,ue)=>{const le=W[ue];if(!le)return;k4(le.fill,le.hpText,B.hp,B.maxHp),le.levelValue!==B.level&&(le.levelValue=B.level,le.level.textContent=String(B.level));const fe=B.maxHp>0?B.hp/B.maxHp:0;le.bar.classList.toggle("is-low",B.alive&&fe<=t0)});const he=Xr(G);if(n.classList.toggle("is-inert",he),Ve){const B=re[Ve].weapons,ue=Ze(G).lastUsed;bo.forEach((le,fe)=>{const Ae=B[fe];if(!Ae)return;const qe=Math.max(0,Ae.cooldown-(G.elapsed-ue[fe])),ze=Ae.cooldown>0?Math.min(1,qe/Ae.cooldown):0;le.cooldown.style.setProperty("--p",ze.toFixed(3));const Ue=ze<=0,Zt=Ue&&!he;le.root.classList.toggle("is-ready",Zt),le.root.classList.toggle("is-selected",!he&&fe===te.selectedWeapon),le.timer.textContent=Ue?"":(qe/1e3).toFixed(1),Ue&&!le.wasReady&&!he&&(le.root.classList.remove("is-flash"),le.root.offsetWidth,le.root.classList.add("is-flash")),le.wasReady=Ue})}if(Bf(G,te),qf(G,te),Uf(te),G.phase==="countdown"){i.style.display="flex";const B=G.countdownValue<=0;i.textContent=B?"START!":String(G.countdownValue),i.classList.toggle("is-start",B)}else i.style.display="none";if(G.phase==="ended"){r.style.display="flex";const B=Pe(G),ue=oa(G.winnerId??void 0,G.winner??"player"),le=ue===Oe;l.textContent=le?"VICTORY!":"DEFEAT!",l.classList.toggle("is-win",le),l.classList.toggle("is-lose",!le);const fe=B[ue]??B[0];re[fe.characterId];const Ae=B.every(ge=>ge.alive),qe=te.order??null,ze=qe!==null&&qe.length===B.length&&qe.every(ge=>Number.isInteger(ge)&&ge>=0&&ge<B.length)&&new Set(qe).size===B.length,Ue=qe&&ze?qe.filter(ge=>ge!==ue).map(ge=>B[ge]):B.filter((ge,yt)=>yt!==ue),Zt=ge=>`<span class="hud-go-fighter"><span class="hud-go-emoji">${Ta(ge.characterId,{crop:"head"})}</span>${re[ge.characterId].name}</span>`,tn=(ge,yt)=>yt.length?`<span class="hud-go-vs">${ge}</span>${yt.map(Zt).join("")}`:"";c.innerHTML=Zt(fe)+tn("defeated",Ue.filter(ge=>!ge.alive))+tn("outlasted",Ue.filter(ge=>ge.alive)),Bo(c,{generate:!1});const yo=te.place??null;if(yo&&yo.of>1){const ge=yo.place,yt=ge%100>=11&&ge%100<=13?"th":{1:"st",2:"nd",3:"rd"}[ge%10]??"th";h.textContent=`${ge}${yt} of ${yo.of}`,h.classList.toggle("is-podium",ge<=3),h.style.display="block"}else h.textContent="",h.style.display="none";const zi=Math.max(0,Ra-G.timeRemaining);d.innerHTML=Ae?`${H("timer")} Time up — no knockout`:`${H("timer")} Match time ${v4(zi)}`;const $t=te.payout??null;if($t){const ge=(yt,xo,an="")=>`<span class="hud-go-pay">${H(yt)}<b>${xo>0?"+":""}${xo}</b>${an?`<i>${an}</i>`:""}</span>`;p.innerHTML=ge("trophy",$t.trophies)+ge("coin",$t.coins)+ge("star",$t.xp,"xp")+($t.chests?ge("chest",$t.chests):""),p.style.display="flex"}else p.innerHTML="",p.style.display="none"}else r.style.display="none"},updateFloatingBars(G,te){const he=Hi(),B=(ue,le)=>{const fe=Math.max(le.y,he),Ae=Math.min(Math.max(le.x,Gh),window.innerWidth-Gh);ue.style.transform=`translate(${Ae.toFixed(1)}px, ${fe.toFixed(1)}px) translate(-50%, -100%)`};W.forEach((ue,le)=>{const fe=G[le]??null;if(!fe){ue.float.style.display="none";return}ue.float.style.display="flex",B(ue.float,fe);const Ae=Math.max(0,Math.min(1,te[le]??0));ue.floatFill.style.width=`${(Ae*100).toFixed(1)}%`,ue.floatFill.classList.toggle("is-low",Ae>0&&Ae<=t0)})},spawnDamageNumber(G,te,he){const B=ee[ye];ye=(ye+1)%ee.length;const ue=!!he?.heal,le=te>=15,fe=!le&&te>=6,Ae=Math.max(G.y,Hi()),qe=Math.min(Math.max(G.x,24),window.innerWidth-24);B.style.setProperty("--x",`${qe.toFixed(1)}px`),B.style.setProperty("--y",`${Ae.toFixed(1)}px`),B.textContent=ue?`+${Math.round(te)}`:`-${Math.round(te)}`;const ze=ue?" hud-dmg--heal":he?.fog?" hud-dmg--fog":"";B.className=`hud-dmg ${le?"hud-dmg--big":fe?"hud-dmg--medium":"hud-dmg--small"}${ze}`,B.offsetWidth,B.classList.add("is-playing")},flashScreen(G){b.style.setProperty("--flash-color",Se(G,.42)),b.classList.remove("is-playing"),b.offsetWidth,b.classList.add("is-playing")},flashFogTick(){I.classList.remove("is-playing"),I.offsetWidth,I.classList.add("is-playing")},dispose(){u.removeEventListener("click",()=>e.onRestart()),window.clearTimeout(P),ie(),t.innerHTML=""}}}const E4=`
.hud-root {
  position: fixed;
  inset: 0;
  pointer-events: none;
...
`,T4=["countdown-tick","match-started","match-ended","weapon-fired","weapon-fired:giantSlam","projectile-spawned","projectile-destroyed:hit-target","projectile-destroyed:hit-cover","projectile-destroyed:expired","hit-landed:weapon","hit-landed:trail","hit-landed:hazard","hit-landed:fog","heal","death","splat-created","trail-mark-created"],S4="hamburger",A4="donut";function o0(t){const e=new URLSearchParams(location.search).get(t);return e&&Ee.includes(e)?e:null}function R4(){const t=new URLSearchParams(location.search).get("fighters");if(!t)return null;const e=[];for(const a of t.split(";")){const[o,n]=a.split("@"),s=o?.trim();if(!s||!Ee.includes(s))return null;const i={characterId:s};if(n){const[r,l]=n.split(",").map(Number);if(!Number.isFinite(r)||!Number.isFinite(l))return null;i.spawn={x:r,y:l}}e.push(i)}return e.length>=3?e:null}function Rs(t){const e=new URLSearchParams(location.search).get(t);if(e===null)return null;const a=Number(e);return Number.isFinite(a)?a:null}function I4(t){if(t.type!=="hit-landed")return t;const e=t.targetRole??"enemy",a=t.source.kind==="trail"&&t.source.ownerRole===void 0?{...t.source,ownerRole:v0(e)}:t.source;return{...t,targetRole:e,source:a}}const C4=J+.35;class Za{constructor(e){this.opts=e,this.playerId=e.playerCharacterId??o0("player")??S4,this.enemyId=e.enemyCharacterId??o0("enemy")??A4;const a=Ia(e.playerLevel??Rs("level")??ho);this.levels={player:a,enemy:N0(a)},this.roster=e.roster&&e.roster.length>st&&e.roster.length<=_t?e.roster.slice():null,this.characterIds=this.qaFighters?this.qaFighters.map(n=>n.characterId):this.roster?this.roster.slice():[this.playerId,this.enemyId];const o=Number(new URLSearchParams(location.search).get("simSpeed"));this.simSpeed=Number.isFinite(o)&&o>0?Math.min(50,o):1,this.stage=new _l({container:e.container,background:16764810,fog:{color:16764810,near:40,far:130},camera:{pitchDeg:58,yawDeg:0,frameMode:"fair"}}),this.stage.scene.add(this.arena.build()),this.fogRing=pb(this.arena.center),this.stage.scene.add(this.fogRing.root),this.vfx=new y4(this.stage.scene),this.hud=M4(e.hudRoot,{onRestart:()=>this.restart(),onSelectWeapon:n=>this.input.selectWeapon(n)}),this.hud.setCharacters(this.characterIds),this.input=new ab(this.stage.canvas),this.input.setWeaponCount(re[this.characterIds[Oe]].weapons.length),this.pointerLock=iy({target:this.stage.canvas,pause:()=>this.pause(),resume:()=>this.resume(),onLockChange:n=>this.input.setPointerLocked(n)}),this.state=this.newMatch(),this.spawnMatch(),window.__matchDebug=this.debug,window.__feelDebug=this.feel,window.__feelEvent=n=>this.handleEvents([I4(n)]),window.__matchArena=this.arena,window.addEventListener("resize",this.handleResize),this.raf=requestAnimationFrame(this.loop)}stage;arena=Im();vfx;audio=s1();hud;input;pointerLock;fogRing;playerId;enemyId;levels;characterIds;qaFighters=R4();roster;models=[];state;eliminated=[];killedBy=[];viewSubject=Oe;spectateDwellMs=0;static SPECTATE_DWELL_MS=1350;endedOutcome=null;endedPayout=null;clock=new Cm;raf=0;disposed=!1;readyFired=!1;isPaused=!1;lastPhase=null;raycaster=new Om;groundPlane=new Fm(new de(0,1,0),0);rayHit=new de;projectVec=new de;projectileOrigins=new Map;simSpeed;qaFogRadius=Rs("fogRadius");qaPlayerX=Rs("px");qaPlayerY=Rs("py");debug={phase:"countdown",winner:null,paused:!1,moveX:0,moveY:0,attack:!1,facingX:0,facingY:0,selectedWeapon:0,pointerLocked:!1,qaSpawnInsideCover:null,frames:0,viewSubject:Oe,viewReason:"local"};feel={events:Object.fromEntries(T4.map(e=>[e,0])),responses:{vfx:0,shake:0,hitStop:0,knockback:0,damageNumber:0,screenFlash:0},hitStopBudgetMs:0,hitStopBankedMs:0,lastHitStopMs:0,rawDtMs:0,stepDtMs:0,frames:0,frozenFrames:0,repayingFrames:0,peakHitAmount:0,peakShakeM:0,shakeSumM:0,shakeRawSumM:0,peakShakeRawM:0};hitStopBudgetMs=0;hitStopBankedMs=0;static HITSTOP_TRICKLE=.05;static HITSTOP_CATCHUP_RATE=3;static SHAKE_MAX_M=.4;shakeFadeUnits=-1;knockback=[];restart(){this.spawnMatch(),this.resume()}get paused(){return this.isPaused}pause(){this.isPaused=!0,this.pointerLock.release(),this.hud.update(this.state,{selectedWeapon:this.input.selectedWeapon,safeArrow:this.hudSafeArrow(),observerSlot:this.viewSubject,aim:null,...this.hudResult()})}resume(){this.isPaused=!1,this.pointerLock.engage()}resize(){this.stage.resize()}dispose(){this.disposed=!0,cancelAnimationFrame(this.raf),window.__matchDebug===this.debug&&delete window.__matchDebug,window.__feelDebug===this.feel&&delete window.__feelDebug,window.__matchArena===this.arena&&delete window.__matchArena,delete window.__feelEvent,window.removeEventListener("resize",this.handleResize),this.pointerLock.dispose(),this.input.dispose(),this.hud.dispose(),this.vfx.dispose(),this.fogRing.dispose();for(const e of this.models)e.dispose();this.stage.dispose()}newMatch(){return this.qaFighters?hr(this.arena,this.qaFighters):this.roster?hr(this.arena,this.roster.map((e,a)=>({characterId:e,level:a===Oe?this.levels.player:this.levels.enemy}))):hr(this.arena,this.playerId,this.enemyId,this.levels)}spawnMatch(){this.state=this.newMatch(),this.applyQaSetup();for(const n of this.models)this.stage.scene.remove(n.root),n.dispose();const e=Pe(this.state);this.models=e.map((n,s)=>Pl(this.characterIds[s]??n.characterId));for(const n of this.models)this.stage.scene.add(n.root);this.models.forEach((n,s)=>{this.syncModelTransform(n,e[s]),n.play("idle")}),this.vfx.clear(),this.audio.reset(),this.input.reset(),this.projectileOrigins.clear(),this.eliminated.length=0,this.killedBy.length=0,this.viewSubject=Oe,this.spectateDwellMs=0,this.hitStopBudgetMs=0,this.hitStopBankedMs=0;for(const n of Object.keys(this.feel.events))this.feel.events[n]=0;this.feel.responses.vfx=0,this.feel.responses.shake=0,this.feel.responses.hitStop=0,this.feel.responses.knockback=0,this.feel.responses.damageNumber=0,this.feel.responses.screenFlash=0,this.feel.frames=0,this.feel.frozenFrames=0,this.feel.repayingFrames=0,this.feel.peakHitAmount=0,this.feel.peakShakeM=0,this.feel.lastHitStopMs=0,this.feel.shakeSumM=0,this.feel.shakeRawSumM=0,this.feel.peakShakeRawM=0,this.knockback=e.map(()=>({x:0,z:0}));const a=Ze(this.state),o=Ie(a.x,a.y);this.stage.rig.snapTo(o.x,o.z),this.stage.lighting.focus(o.x,o.z),this.fogRing.update(this.state.safeRadius,this.state.elapsed/1e3,this.state.phase==="playing",this.stage.rig),this.lastPhase=null,this.notifyPhase()}applyQaSetup(){const e=Ze(this.state);if(this.qaPlayerX!==null&&(e.x=this.qaPlayerX),this.qaPlayerY!==null&&(e.y=this.qaPlayerY),(this.qaPlayerX!==null||this.qaPlayerY!==null)&&this.checkQaSpawn(),this.qaFogRadius===null)return;const a=this.arena.maxSafeRadius;this.state.phase="playing",this.state.countdownValue=0,this.state.countdownTick=0,this.state.startFlashTimer=0;const o=Math.max($s(this.state.fighters.length),a*(hl/Ra));if(this.qaFogRadius<=o){this.qaFogRadius>il&&console.warn(`[QA] ?fogRadius=${this.qaFogRadius} is below the lowest radius the schedule ever reaches (${o.toFixed(2)} wu — DECISIONS §2 collapses the ring at ${Nm/1e3} s). Snapped to SUDDEN DEATH (radius 0). Ask for a larger radius if you wanted a ring.`),this.state.timeRemaining=hl,this.state.safeRadius=il;return}const n=Y.clamp(this.qaFogRadius,o,a),s=Y.clamp(n/a,0,1);this.state.timeRemaining=Ra*s,this.state.safeRadius=n}checkQaSpawn(){const e=Ze(this.state),a=this.arena.cover.find(o=>$n(e.x,e.y,e.size,e.size,o.x,o.y,o.w,o.h));this.debug.qaSpawnInsideCover=a?`${a.kind??"cover"} @(${a.x},${a.y}) ${a.w}x${a.h}`:null,a&&console.warn(`[QA] ?px=${e.x}&py=${e.y} places the player INSIDE cover "${a.kind??"cover"}" @(${a.x},${a.y}) ${a.w}x${a.h}. There is no depenetration in movement.ts, so the fighter cannot move at all — input is fine, the sim is refusing every step. Pick a point at least ${((e.size+Math.max(a.w,a.h))/2).toFixed(0)} wu from that centre.`)}aimCursor(){const e=this.input.aimOffsetPx;if(!e)return null;const a=Ze(this.state),o=this.projectPointToScreen(a.x,a.y,0);return o?{from:o,at:{x:o.x+e.x,y:o.y+e.y}}:null}buildInput(){const e=this.state.phase==="playing",a=e?this.input.moveAxes():{x:0,y:0};let o;if(e){const s=this.aimCursor();let i=this.input.mouseNdc;if(s){const r=this.stage.canvas.getBoundingClientRect();i={x:(s.at.x-r.left)/r.width*2-1,y:-((s.at.y-r.top)/r.height*2-1)}}if(i){this.raycaster.setFromCamera(new Lm(i.x,i.y),this.stage.rig.camera);const r=this.raycaster.ray.intersectPlane(this.groundPlane,this.rayHit);if(r){const l=Ze(this.state);o={x:ac(r.x)-l.x,y:ac(r.z)-l.y}}}}const n=e&&this.input.attackHeld;return{move:a,aim:o,selectedWeapon:this.input.selectedWeapon,attack:n}}syncModelTransform(e,a){const o=Ie(a.x,a.y);e.root.position.set(o.x,0,o.z),e.root.rotation.y=Math.atan2(a.facing.x,a.facing.y)}attackerSlotOf(e,a){let o=null;if(e.kind==="weapon"?o=vn(this.state,e,a):e.kind==="trail"&&(o=Ec(this.state,e)),!o)return;const n=Pe(this.state).indexOf(o);return n>=0?n:void 0}colorForDamageSource(e,a){switch(a.kind){case"weapon":{const o=vn(this.state,a,e);return re[o.characterId].weapons.find(s=>s.key===a.weaponKey)?.color??"#FFFFFF"}case"trail":return oa(a.ownerId,a.ownerRole)===Oe?"#FF9EC4":"#FFD27A";case"hazard":return"#FF7A3D";case"fog":return"#B98CE6";default:return"#FFFFFF"}}triggerHitStop(e){this.hitStopBudgetMs=Math.max(this.hitStopBudgetMs,e),this.feel.responses.hitStop++,this.feel.lastHitStopMs=e}kick(e,a,o){const n=Math.min(e,Za.SHAKE_MAX_M),s=n*a;this.stage.rig.shake(s,o),this.feel.responses.shake++,this.feel.shakeSumM+=s,this.feel.shakeRawSumM+=n,s>this.feel.peakShakeM&&(this.feel.peakShakeM=s),n>this.feel.peakShakeRawM&&(this.feel.peakShakeRawM=n)}shakeProximity(e,a){this.shakeFadeUnits<0&&(this.shakeFadeUnits=this.stage.rig.shakeFadeRadiusUnits());const o=this.viewObserver();return Dm(Math.hypot(e-o.x,a-o.y),this.shakeFadeUnits)}viewObserver(){return Pe(this.state)[this.viewSubject]??Ze(this.state)}updateViewSubject(e){const a=Pe(this.state);if(a[Oe]?.alive){this.viewSubject=Oe,this.spectateDwellMs=0,this.audio.setListener(Oe),this.debug.viewSubject=Oe,this.debug.viewReason="local";return}if(this.spectateDwellMs>0){this.spectateDwellMs=Math.max(0,this.spectateDwellMs-e),this.debug.viewReason="dwell";return}this.shakeFadeUnits<0&&(this.shakeFadeUnits=this.stage.rig.shakeFadeRadiusUnits());const o=this.stage.rig.targetUnits(),n=Hm({seats:a,localSlot:Oe,current:this.viewSubject,killedBy:this.killedBy,cameraX:o.x,cameraY:o.y,cutBeyondUnits:this.shakeFadeUnits});if(n.slot!==this.viewSubject&&(this.viewSubject=n.slot,n.cut)){const s=a[n.slot];if(s){const i=Ie(s.x,s.y);this.stage.rig.snapTo(i.x,i.z),this.stage.lighting.focus(i.x,i.z)}}this.audio.setListener(this.viewSubject),this.debug.viewSubject=this.viewSubject,this.debug.viewReason=n.reason}applyKnockback(e,a,o,n){const s=Pe(this.state)[e],i=this.knockback[e];if(!s||!i)return;const r=s.x-a,l=s.y-o,h=Math.hypot(r,l);if(h<1e-4)return;const c=Y.clamp(n,0,.22);i.x+=r/h*c,i.z+=l/h*c,this.feel.responses.knockback++}handleEvents(e){const a=[],o=[];for(const n of e){const s=n.type==="hit-landed"?`hit-landed:${n.source.kind}`:n.type==="projectile-destroyed"?`projectile-destroyed:${n.reason}`:n.type;switch(s in this.feel.events&&this.feel.events[s]++,n.type){case"weapon-fired":{const i=this.models[oa(n.fighterId,n.fighterRole)],r=bt(this.state,n.fighterId,n.fighterRole);if(!i)break;const l=re[r.characterId].weapons,h=l.findIndex(d=>d.key===n.weaponKey),c=l[h<0?0:h];i.play("attack",{weaponIndex:h<0?0:h}),c&&(this.vfx.spawnWeaponCast(r.x,r.y,r.facing,c,r.characterId),this.feel.responses.vfx++,c.giantSlam&&(this.feel.events["weapon-fired:giantSlam"]++,this.hud.flashScreen(c.color),this.feel.responses.screenFlash++,this.kick(.55,this.shakeProximity(r.x,r.y),2.6),this.triggerHitStop(120),window.__vfxDebugGiantSlamCount=(window.__vfxDebugGiantSlamCount??0)+1));break}case"hit-landed":{const i=oa(n.targetId,n.targetRole);this.models[i]?.play("hit",{intensity:Y.clamp(n.amount/12,.25,1)});const l=this.colorForDamageSource(n.targetRole,n.source);if(a[i]=l,o[i]=this.attackerSlotOf(n.source,n.targetRole),n.source.kind==="fog"){const m=this.projectPointToScreen(n.x,n.y,1.3);m&&(this.hud.spawnDamageNumber(m,n.amount,{fog:!0}),this.feel.responses.damageNumber++),i===Oe&&(this.hud.flashFogTick(),this.feel.responses.screenFlash++);break}let h;if(n.source.kind==="weapon"){const m=vn(this.state,n.source,n.targetRole),g=n.source.weaponKey,w=re[m.characterId].weapons.find(b=>b.key===g);w&&(h={weapon:w,characterId:m.characterId,fromXWU:m.x,fromYWU:m.y})}this.vfx.spawnImpactBurst(n.x,n.y,l,n.amount,h),this.feel.responses.vfx++,n.amount>this.feel.peakHitAmount&&(this.feel.peakHitAmount=n.amount);const c=this.projectPointToScreen(n.x,n.y,1.3);c&&(this.hud.spawnDamageNumber(c,n.amount),this.feel.responses.damageNumber++);const d=n.source.kind==="weapon",p=Y.clamp(.012+n.amount*.0175,.012,Za.SHAKE_MAX_M),u=i===Oe?1.25:1,f=bt(this.state,n.targetId,n.targetRole);if(this.kick(p*u*(d?1:.45),this.shakeProximity(f.x,f.y)),d&&this.triggerHitStop(Y.clamp(10+n.amount*4.6,16,105)),n.source.kind==="weapon"){const m=n.source,g=vn(this.state,m,n.targetRole);(re[g.characterId].weapons.find(y=>y.key===m.weaponKey)?.knockback??0)>0||this.applyKnockback(i,g.x,g.y,.05+n.amount*.006)}else if(n.source.kind==="trail"){const m=Ec(this.state,n.source);this.applyKnockback(i,m.x,m.y,.03)}break}case"projectile-spawned":{this.projectileOrigins.set(n.id,{color:n.color,x:n.x,y:n.y});break}case"projectile-destroyed":{const i=this.projectileOrigins.get(n.id);if(this.projectileOrigins.delete(n.id),n.reason!=="hit-cover")break;this.vfx.spawnCoverScuff(n.x,n.y,i?.color??"#FFFFFF",i?n.x-i.x:0,i?n.y-i.y:0);break}case"heal":{const i=bt(this.state,n.fighterId,n.fighterRole);this.vfx.spawnHealPulse(i.x,i.y),this.feel.responses.vfx++;const r=this.projectPointToScreen(i.x,i.y,1.6);r&&(this.hud.spawnDamageNumber(r,n.amount,{heal:!0}),this.feel.responses.damageNumber++);break}case"death":{const i=oa(n.fighterId,n.fighterRole);this.eliminated.push(i),this.killedBy[i]=o[i]??null,i===this.viewSubject&&(this.spectateDwellMs=Za.SPECTATE_DWELL_MS),this.models[i]?.play("death");const r=bt(this.state,n.fighterId,n.fighterRole),l=a[i]??"#FFFFFF";this.vfx.spawnDeathBurst(r.x,r.y,l),this.feel.responses.vfx++,this.kick(.42,this.shakeProximity(r.x,r.y),3),this.triggerHitStop(90);break}}}}groundOnScreen(e,a){return this.projectVec.set(e,0,a),this.projectVec.project(this.stage.rig.camera),this.projectVec.z<=1&&Math.abs(this.projectVec.x)<=1&&Math.abs(this.projectVec.y)<=1}projectToScreen(e,a){if(!a||!this.groundOnScreen(e.root.position.x,e.root.position.z)||(this.projectVec.set(e.root.position.x,C4,e.root.position.z),this.projectVec.project(this.stage.rig.camera),this.projectVec.z>1))return null;const o=this.stage.canvas.getBoundingClientRect();return{x:(this.projectVec.x*.5+.5)*o.width+o.left,y:(1-(this.projectVec.y*.5+.5))*o.height+o.top}}projectPointToScreen(e,a,o){const n=Ie(e,a);if(!this.groundOnScreen(n.x,n.z)||(this.projectVec.set(n.x,o,n.z),this.projectVec.project(this.stage.rig.camera),this.projectVec.z>1))return null;const s=this.stage.canvas.getBoundingClientRect();return{x:(this.projectVec.x*.5+.5)*s.width+s.left,y:(1-(this.projectVec.y*.5+.5))*s.height+s.top}}safeArrow(){const e=Ze(this.state),a=this.arena.center.x-e.x,o=this.arena.center.y-e.y,n=Math.hypot(a,o);if(n<.001)return null;const s=this.projectPointToScreen(e.x,e.y,.35),i=this.projectPointToScreen(e.x+a/n*80,e.y+o/n*80,.35);if(!s||!i)return null;const r=i.x-s.x,l=i.y-s.y;return Math.hypot(r,l)<1?null:{at:s,angleRad:Math.atan2(l,r)}}notifyPhase(){this.state.phase!==this.lastPhase&&(this.lastPhase=this.state.phase,this.pointerLock.setMatchActive(this.state.phase!=="ended"),this.endedOutcome=this.state.phase==="ended"?this.outcome():null,this.state.phase!=="ended"&&(this.endedPayout=null),this.opts.onPhase?.(this.state.phase,this.state.winner,this.endedOutcome))}showPayout(e){this.endedPayout=e}hudSafeArrow(){return Ze(this.state).alive?this.safeArrow():null}hudResult(){return{place:this.hudPlace(),order:this.endedOutcome?.places??null,payout:this.endedOutcome?this.endedPayout:null}}hudPlace(){const e=this.endedOutcome;return!e||e.seats<=1||e.localPlace<0?null:{place:e.localPlace+1,of:e.seats}}outcome(){const a={seats:Pe(this.state).map((n,s)=>({id:s,alive:n.alive,hp:n.hp,maxHp:n.maxHp,x:n.x,y:n.y,deaths:n.deaths})),center:{x:this.arena.center.x,y:this.arena.center.y},eliminated:this.eliminated,winnerId:this.state.winnerId??null},o=rw(a);return{seats:a.seats.length,places:o,localPlace:o.indexOf(Oe),winnerId:a.winnerId}}handleResize=()=>this.resize();publishDebug(e,a,o){const n=this.debug;n.phase=this.state.phase,n.winner=this.state.winner,n.paused=this.isPaused,n.moveX=e,n.moveY=a,n.attack=o;const s=Ze(this.state);n.facingX=s.facing.x,n.facingY=s.facing.y,n.selectedWeapon=this.input.selectedWeapon,n.pointerLocked=this.input.pointerLocked,n.frames++}decayKnockback(e){const a=Math.exp(-e*14);for(const o of this.knockback)o.x*=a,o.z*=a,Math.abs(o.x)<1e-4&&(o.x=0),Math.abs(o.z)<1e-4&&(o.z=0)}loop=()=>{if(this.disposed)return;const e=Math.min(this.clock.getDelta(),1/20)*this.simSpeed,a=e*1e3;if(this.isPaused){this.publishDebug(0,0,!1),this.stage.render(0),this.raf=requestAnimationFrame(this.loop);return}let o;if(this.hitStopBudgetMs>0)this.hitStopBudgetMs=Math.max(0,this.hitStopBudgetMs-a),o=a*Za.HITSTOP_TRICKLE,this.hitStopBankedMs+=a-o;else if(this.hitStopBankedMs>0){const u=Math.min(this.hitStopBankedMs,a*Za.HITSTOP_CATCHUP_RATE);this.hitStopBankedMs-=u,o=a+u}else o=a;const n=o/1e3;this.feel.rawDtMs=a,this.feel.stepDtMs=o,this.feel.hitStopBudgetMs=this.hitStopBudgetMs,this.feel.hitStopBankedMs=this.hitStopBankedMs,this.feel.frames++,o<a*.5?this.feel.frozenFrames++:o>a*1.05&&this.feel.repayingFrames++;const s=Pe(this.state),i=s.map(u=>({x:u.x,y:u.y})),r=this.buildInput(),l=Wb(this.state,o,r);this.handleEvents(l),this.audio.handleEvents(l,this.state),this.notifyPhase(),this.publishDebug(r.move.x,r.move.y,r.attack===!0);const h=s.map((u,f)=>u.x!==i[f].x||u.y!==i[f].y);this.models.forEach((u,f)=>{const m=s[f];if(!m)return;this.syncModelTransform(u,m);const g=this.knockback[f];g&&(u.root.position.x+=g.x,u.root.position.z+=g.z)}),this.decayKnockback(e),this.updateViewSubject(a);const c=this.viewObserver();this.models.forEach((u,f)=>{if(f===Oe)return;const m=s[f];m&&(u.root.visible=Hl(this.state,c,m))}),this.models.forEach((u,f)=>{s[f]?.alive&&u.play(h[f]?"run":"idle")});const d=this.state.elapsed/1e3;this.models.forEach((u,f)=>{const m=s[f];m&&u.update({dt:n,elapsed:d,moveSpeed01:m.alive&&h[f]?1:0,health01:m.hp/m.maxHp})}),this.arena.update?.(n,d),this.vfx.sync(this.state),this.vfx.updateEffects(e),this.fogRing.update(this.state.safeRadius,this.clock.elapsedTime,this.state.phase==="playing",this.stage.rig);const p=Ie(c.x,c.y);this.stage.rig.follow(p.x,p.z),this.stage.lighting.focus(p.x,p.z),window.__vfxDebugScreen={player:this.projectPointToScreen(s[0].x,s[0].y,0),enemy:s[1]?this.projectPointToScreen(s[1].x,s[1].y,0):null,slots:s.map(u=>this.projectPointToScreen(u.x,u.y,0))},this.hud.update(this.state,{selectedWeapon:this.input.selectedWeapon,safeArrow:this.hudSafeArrow(),aim:Ze(this.state).alive?this.aimCursor():null,observerSlot:this.viewSubject,...this.hudResult()}),this.hud.updateFloatingBars(this.models.map((u,f)=>{const m=s[f];if(!m)return null;const g=f===Oe?m.alive:m.alive&&Hl(this.state,c,m);return this.projectToScreen(u,g)}),s.map(u=>u.hp/u.maxHp)),this.stage.render(e),this.readyFired||(this.readyFired=!0,window.__gameReady=!0,window.__previewReady=!0),this.raf=requestAnimationFrame(this.loop)}}function O4(t){return new Za(t)}const Uh="Escape";function F4(t,e){if(e.name!=="match")throw new Error("createMatchScreen: wrong route");ha("fa-match-styles",N4),ca();const a=Fe("div","fa-screen-bare fa-match");a.innerHTML=`
    ...
    <button class="match-chip" type="button" data-el="pause" aria-label="Pause">${H("pause",{size:"22px"})}</button>

    <div class="match-corner">
      <button class="fa-btn fa-btn--quiet match-exit" type="button" data-el="exit">${H("back")} Menu</button>
    </div>
    ...
    <div class="match-sheet" data-el="sheet">
      <div class="match-sheet-card">
        <div class="match-sheet-pane" data-el="pane-pause">
          ...
          <button class="fa-btn fa-btn--primary" type="button" data-el="resume">${H("play")} Resume</button>
          <button class="fa-btn fa-btn--quiet" type="button" data-el="change">${H("swap")} Change Fighter</button>
          <button class="fa-btn fa-btn--quiet" type="button" data-el="quit">${H("home")} Quit to Home</button>
        </div>
        <div class="match-sheet-pane match-sheet-pane--confirm" data-el="pane-confirm" hidden>
          ...
          <button class="fa-btn fa-btn--primary" type="button" data-el="keep">${H("play")} Keep Playing</button>
          <button class="fa-btn fa-btn--quiet match-leave" type="button" data-el="leave">${H("close")} Leave</button>
        </div>
      </div>
    </div>
  `;const o=M=>{const x=a.querySelector(`[data-el="${M}"]`);if(!x)throw new Error(`matchScreen: missing element "${M}"`);return x},n=o("sheet"),s=o("pause"),i=o("exit");let r=!1;const l=e.seats===void 0?void 0:M0(e.player,e.enemy,e.seats),h=O4({container:t.gameHost,hudRoot:t.hudRoot,playerCharacterId:e.player,enemyCharacterId:e.enemy,roster:l,playerLevel:t.profile.characterLevel(e.player),onPhase(M,x,S){if(M==="ended"){if(!r){r=!0;const A=S!==null&&S.localPlace>=0&&S.seats>=st&&S.seats<=_t&&S?t.profile.recordPlacement(S.localPlace,S.seats):t.profile.recordResult(x==="player");h.showPayout({trophies:A.trophies,coins:A.coins,xp:$0(A.place,A.seats),chests:A.chests})}a.classList.add("is-ended")}else r=!1,a.classList.remove("is-ended")}}),c=o("pane-pause"),d=o("pane-confirm"),p=o("leave"),u="22px";function f(M){s.innerHTML=H(M?"play":"pause",{size:u}),s.setAttribute("aria-label",M?"Resume":"Pause")}const m=350;let g=0,w=null;function b(M,x,S){w=M,p.innerHTML=`${H(S)} ${x}`,o("confirmbody").textContent="This match ends now — no trophies, coins or XP from it.",c.hidden=!0,d.hidden=!1,p.disabled=!0,window.clearTimeout(g),g=window.setTimeout(()=>{p.disabled=!1},m)}function y(){w=null,window.clearTimeout(g),p.disabled=!0,d.hidden=!0,c.hidden=!1}function v(M){M||y(),M?h.pause():h.resume(),n.classList.toggle("is-open",M),f(M)}s.addEventListener("click",()=>v(!h.paused)),o("resume").addEventListener("click",()=>v(!1)),o("change").addEventListener("click",()=>b({name:"characters"},"Change Fighter","swap")),o("quit").addEventListener("click",()=>b({name:"home"},"Quit to Home","home")),o("keep").addEventListener("click",()=>v(!1)),p.addEventListener("click",()=>{w&&t.navigate(w)}),i.addEventListener("click",()=>t.navigate({name:"home"}));const k=M=>{if(M.key===Uh){if(M.preventDefault(),w!==null){y();return}v(!h.paused)}};return window.addEventListener("keydown",k),i.title=l?l.map(M=>re[M].name).join(" · "):`${re[e.player].name} vs ${re[e.enemy].name}`,{root:a,resize(){h.resize()},dispose(){window.removeEventListener("keydown",k),window.clearTimeout(g),h.dispose(),a.remove()}}}const N4=`
...
`,Lf="food-arena.settings.v1",L4="fa-reduce-motion";function Df(){try{const t=localStorage.getItem(Lf),e=t?JSON.parse(t):{};return{reduceMotion:e.reduceMotion===!0,moveKeys:H4(e.moveKeys)}}catch{return{reduceMotion:!1,moveKeys:{}}}}function Zr(t){try{localStorage.setItem(Lf,JSON.stringify(t))}catch{}}function Hf(){const t=Df();document.documentElement.classList.toggle(L4,t.reduceMotion),zl(t.moveKeys)}const na=["up","left","down","right"],Mn={up:"Move up",left:"Move left",down:"Move down",right:"Move right"},lo={...Vt},D4=[{code:nh,does:"mutes the game"},{code:Uh,does:"pauses a match"},{code:"Tab",does:"moves between controls"},{code:"Enter",does:"presses the control you are on"},{code:"NumpadEnter",does:"presses the control you are on"},...Array.from({length:sh},(t,e)=>[{code:`Digit${e+1}`,does:"picks a weapon"},{code:`Numpad${e+1}`,does:"picks a weapon"}]).flat()];function zf(t){return D4.find(e=>e.code===t)?.does??null}function jt(t){if(t.startsWith("Key"))return t.slice(3);if(t.startsWith("Digit"))return t.slice(5);switch(t){case"ArrowUp":return"↑";case"ArrowDown":return"↓";case"ArrowLeft":return"←";case"ArrowRight":return"→";case"Escape":return"Esc";case"Space":return"Space";default:return t}}function zl(t){const e=Vt;for(const a of na){const o=lo[a],n=t[a];e[a]=n?[n,...o.slice(1).filter(s=>s!==n)]:o}}function H4(t){const e={};if(t===null||typeof t!="object")return e;const a=t,o=new Set;for(const n of na){const s=a[n];typeof s!="string"||s.length===0||s.length>32||zf(s)||o.has(s)||na.some(i=>i!==n&&lo[i].includes(s))||(o.add(s),e[n]=s)}return e}function z4(t,e,a){const o=zf(e);if(o)return`${jt(e)} already ${o}.`;for(const n of na){if(n===t)continue;if((a[n]??lo[n][0])===e||lo[n].includes(e))return`${jt(e)} is already ${Mn[n].toLowerCase()}.`}return null}function _4(){return na.some(t=>Vt[t][0]!==lo[t][0])}function n0(){return'<svg class="fa-ic fa-ic--note" viewBox="0 0 24 24" fill="none" style="stroke:var(--fa-ic-ink,#1a1224)" stroke-width="1.7" stroke-linejoin="round" stroke-linecap="round" aria-hidden="true" focusable="false"><path d="M10.4 17.2V5.4l8.2-1.9v11.7" fill="none" stroke-width="2"/><ellipse cx="7.6" cy="17.4" rx="3" ry="2.5" fill="#FFC93C"/><ellipse cx="15.8" cy="15.2" rx="3" ry="2.5" fill="#FFC93C"/></svg>'}function P4(t){ha("fa-settings-styles",$4),ca();const e=Fe("div","fa-screen fa-settings");let a=Df(),o=null;const n=()=>{const F=[],z=na.flatMap(K=>Vt[K].slice(1)).map(jt);z.length>0&&F.push({action:"Move (fixed)",keys:z}),F.push({action:"Aim",keys:["Mouse"]}),F.push({action:"Fire",keys:["Click"]});const P=Math.min(re[t.profile.selected].weapons.length,sh);return P>1&&F.push({action:"Switch weapon",keys:Array.from({length:P},(K,ce)=>String(ce+1))}),F.push({action:"Mute / unmute",keys:[jt(nh)]}),F.push({action:"Pause",keys:[jt(Uh)]}),F},s=()=>`Aim, fire, mute and pause are fixed.${re[t.profile.selected].weapons.length>1?"":` ${re[t.profile.selected].name} carries one weapon, so there is no weapon-switch key while it is equipped.`} On a phone, twin sticks appear under your thumbs — the left half of the screen moves, the right half aims and fires — in landscape and in portrait alike.`,i=(F,z,P,K)=>`
    <div class="set-row">
      <span class="set-row-label">
        <span class="set-row-icon">${F}</span>
        <span class="set-row-text">
          <span class="set-row-title">${z}</span>
          ${P?`<span class="set-row-sub">${P}</span>`:""}
        </span>
      </span>
      <span class="set-row-control">${K}</span>
    </div>`,r=(F,z,P=!1)=>`<button class="set-toggle" type="button" role="switch" aria-checked="false"
       aria-label="${z}" data-toggle="${F}"${P?' data-clicksound="off"':""}><span class="set-knob"></span></button>`,l=(F,z)=>`<span class="set-slider">
       <input class="set-range" type="range" min="0" max="1" step="0.01"
              aria-label="${z}" data-range="${F}" />
       <span class="set-range-val" data-el="${F}val">100%</span>
     </span>`,h=F=>{const z=Bi(F),P=F==="auto"?Bi(Pm()):"";return`<button class="set-seg-btn" type="button" role="radio" aria-checked="false"
        aria-label="${P?`${z} (${P})`:z}"
        data-el="quality-${F}" data-quality="${F}">
        <span class="set-seg-name">${z}</span>
        ${P?`<span class="set-seg-auto">(${P})</span>`:""}
      </button>`};e.innerHTML=`
    <header class="fa-topbar">
      <button class="fa-iconbtn" type="button" data-el="back">${H("back")} Back</button>
    ...
    <div class="fa-scroll set-body">
      <section class="fa-panel set-section">
        ...
        <div class="set-row">
          <span class="set-row-label">
            <span class="set-row-icon">${H("avatar")}</span>
            <span class="set-row-text">
          ...
          <span class="set-row-control set-name-wrap">
            <input class="set-name" type="text" data-el="name" aria-label="Player name"
                   maxlength="${ml}" autocomplete="off" autocapitalize="words"
      ...
      <section class="fa-panel set-section">
        ...
        ${i(H("sound"),"Sound effects","Hits, pickups, menu taps",l("sfx","Sound effects volume"))}
        ${i(H("mute"),"Mute everything","Same as pressing M in a match",r("mute","Mute everything",!0))}
      ...
      <section class="fa-panel set-section">
        ...
        ${i(H("speed"),"Reduce motion","Stops the menus pulsing and drifting",r("motion","Reduce motion"))}
      </section>
    ...
    <footer class="set-foot">
      ...
      <button class="fa-btn fa-btn--primary set-done" type="button" data-el="done">${H("check")} Done</button>
    </footer>
    ...
    <div class="set-confirm" data-el="confirm" hidden>
      <div class="set-confirm-card" role="alertdialog" aria-modal="true" aria-label="Reset progress">
        <span class="set-confirm-icon">${H("cone")}</span>
  ...
  `;const c=F=>{const z=e.querySelector(`[data-el="${F}"]`);if(!z)throw new Error(`settings: missing element "${F}"`);return z},d=F=>e.querySelector(`[data-toggle="${F}"]`),p=F=>e.querySelector(`[data-range="${F}"]`),u=c("qualityrow"),f=F=>`${Math.round(F*100)}%`;function m(F,z){const P=d(F);P.setAttribute("aria-checked",z?"true":"false"),P.classList.toggle("is-on",z)}function g(){const F=Bm(),z=qm();for(const ce of u.querySelectorAll("[data-quality]")){const ie=ce.dataset.quality===z;ce.setAttribute("aria-checked",ie?"true":"false"),ce.classList.toggle("is-on",ie),ce.disabled=F!==null}const P=c("qualitypin");F?(P.textContent=`This session is pinned to ${Bi(F)} by a ?tier= link in the address bar, so this control is switched off. Reload without it to choose.`,P.hidden=!1):P.hidden=!0;const K=Um();c("qualityblurb").textContent=z==="auto"&&!F?`Auto picked ${K.label} on this device. ${K.blurb}`:K.blurb}function w(){for(const F of na){const z=c(`bind-${F}`),P=jt(Vt[F][0]),K=o===F;z.textContent=K?"…":P,z.classList.toggle("is-listening",K),z.setAttribute("aria-label",K?`${Mn[F]}: press the key you want, or Escape to keep ${P}`:`${Mn[F]}, currently ${P}. Press to change it.`)}c("bindreset").hidden=!_4(),c("keys").innerHTML=n().map(F=>`
      <div class="set-key-row">
        <span class="set-key-action">${F.action}</span>
        <span class="set-key-caps">${F.keys.map(z=>`<kbd class="set-cap">${z}</kbd>`).join("")}</span>
      </div>`).join(""),c("ctrlnote").textContent=s()}function b(F){c("bindnote").textContent=F??(o!==null?"Press any key. Escape keeps the one you have.":`Tap a key to change it. ${na.map(z=>jt(lo[z].slice(1)[0]??"")).filter(Boolean).join(" ")} always work as well, so movement can never be lost.`)}function y(F){c("namecount").textContent=`${F.length}/${ml}`}function v(){const F=ke.isMuted(),z=ke.getState(),P=c("name");document.activeElement!==P&&(P.value=t.profile.name),y(P.value);const K=p("sfx");document.activeElement!==K&&(K.value=String(ke.getVolume())),K.style.setProperty("--p",f(ke.getVolume())),c("sfxval").textContent=f(ke.getVolume());const ce=p("music");document.activeElement!==ce&&(ce.value=String(ke.music.getVolume())),ce.style.setProperty("--p",f(ke.music.getVolume())),c("musicval").textContent=f(ke.music.getVolume()),m("mute",F),m("music",ke.music.isEnabled()),m("motion",a.reduceMotion),e.classList.toggle("is-muted",F);const ie=c("audiostate");z==="failed"?(ie.textContent="This browser blocked audio, so nothing here will make a sound.",ie.hidden=!1):z!=="running"?(ie.textContent="Sound switches on when you touch the screen — drag a slider to try it.",ie.hidden=!1):ie.hidden=!0}function k(F,z){const P=z4(F,z,a.moveKeys);if(P){b(`${P} Pick another, or press Escape.`);return}const K={...a.moveKeys};K[F]=z,a={...a,moveKeys:K},Zr(a),zl(a.moveKeys),E(),b(`${Mn[F]} is now ${jt(z)}.`),w()}function M(){a={...a,moveKeys:{}},Zr(a),zl(a.moveKeys),E(),b(`Movement is back to ${na.map(F=>jt(lo[F][0])).join(" ")}.`),w()}const x=F=>{if(o!==null){if(F.preventDefault(),F.stopPropagation(),F.key==="Escape"){const z=o;E(),b(`Left ${Mn[z].toLowerCase()} on ${jt(Vt[z][0])}.`),w();return}["Shift","Control","Alt","Meta","CapsLock"].includes(F.key)||F.code&&k(o,F.code)}};function S(F){if(o===F){E(),w(),b();return}o===null&&window.addEventListener("keydown",x,!0),o=F,w(),b()}function E(){o!==null&&(o=null,window.removeEventListener("keydown",x,!0))}const A=F=>{const z=F.target.closest("[data-quality]");if(z){$m(z.dataset.quality),g();return}const P=F.target.closest("[data-bind]");if(P){S(P.dataset.bind);return}if(F.target.closest('[data-el="bindreset"]')){M();return}o!==null&&(E(),w(),b());const K=F.target.closest("[data-toggle]");if(K){switch(K.dataset.toggle){case"mute":ke.setMuted(!ke.isMuted()),ke.isMuted()||ke.previewClick();break;case"music":ke.music.setEnabled(!ke.music.isEnabled());break;case"motion":a={...a,reduceMotion:!a.reduceMotion},Zr(a),Hf();break}v()}};e.addEventListener("click",A);const C=F=>{const z=F.target;if(z.dataset.el==="name"){t.profile.setName(z.value),y(z.value);return}const P=Number(z.value);Number.isFinite(P)&&(z.dataset.range==="sfx"?(ke.setVolume(P),ke.previewClick()):z.dataset.range==="music"&&ke.music.setVolume(P),v())};e.addEventListener("input",C);const R=F=>{const z=F.target;z.dataset.el==="name"&&(z.value=t.profile.setName(z.value),y(z.value))};e.addEventListener("change",R);const I=F=>{const z=F.target;!z||z.dataset.el!=="name"||F.key!=="Enter"||(F.preventDefault(),z.blur())};e.addEventListener("keydown",I),c("back").addEventListener("click",()=>t.navigate({name:"home"})),c("done").addEventListener("click",()=>t.navigate({name:"home"}));const N=c("confirm");c("reset").addEventListener("click",()=>{const F=Ee.filter(z=>t.profile.characterLevel(z)>ho).length;c("confirmsub").textContent=`${t.profile.trophies.toLocaleString()} trophies, ${t.profile.coins.toLocaleString()} coins and ${t.profile.wins} wins will be deleted`+(F>0?`, along with ${F} upgraded fighter${F===1?"":"s"}.`:"."),N.hidden=!1}),c("cancel").addEventListener("click",()=>{N.hidden=!0}),c("confirmyes").addEventListener("click",()=>{try{const F=[];for(let z=0;z<localStorage.length;z++){const P=localStorage.key(z);P&&P.startsWith("food-arena.profile")&&F.push(P)}for(const z of F)localStorage.removeItem(z)}catch{}location.reload()});const L=e.querySelector(".set-body"),_=()=>{const F=L.scrollHeight-L.scrollTop-L.clientHeight>2;L.classList.toggle("is-more",F)};L.addEventListener("scroll",_,{passive:!0}),requestAnimationFrame(_);const U=ke.onChange(v),D=ke.music.onChange(v),W=_m(g);return v(),g(),w(),b(),{root:e,resize(){_()},dispose(){U(),D(),W(),E(),L.removeEventListener("scroll",_),e.removeEventListener("click",A),e.removeEventListener("input",C),e.removeEventListener("change",R),e.removeEventListener("keydown",I),e.remove()}}}const $4=`
...
`,s0=[{key:"damage",icon:"damage",label:"Damage",color:"#FF8A96"},{key:"health",icon:"health",label:"Health",color:"#8FE04A"},{key:"speed",icon:"speed",label:"Speed",color:"#6FC8F5"}],B4=new Set(["Neon","Cyber"]);function q4(t){return t===void 0?null:t>=Va.ultimateSlam?"Widest":t>Va.rangedLong?"Max range":t>Va.rangedMid?"Long":t>Va.rangedClose?"Mid":t>Va.meleeHeavy?"Short":"Melee"}function U4(t){const e=[];t.type==="self"&&t.healAmount?e.push(`${H("heal")} +${t.healAmount} HP`):t.comboParts?.length?e.push(`${H("damage")} ${t.comboParts.map(o=>o.damage).join(" + ")}`):t.pellets&&t.pellets>1?e.push(`${H("damage")} ${t.damage} × ${t.pellets}`):t.damage>0&&e.push(`${H("damage")} ${t.damage}`);const a=q4(t.range);return a&&e.push(`${H("range")} ${a}`),e.push(`${H("timer")} ${(t.cooldown/1e3).toFixed(1)}s`),t.effect&&e.push(t.effect==="stun"?`${H("stun")} Stun`:`${H("slow")} Slow`),e}function G4(t){const e=Ee.filter(a=>a!==t);return e[Math.floor(Math.random()*e.length)]}function j4(t){ha("fa-chars-styles",W4),ca();const e=Fe("div","fa-screen fa-chars"),a=Ql();let o=t.profile.selected;e.innerHTML=`
    <header class="fa-topbar">
      <button class="fa-iconbtn" type="button" data-el="back" aria-label="Back to home">${H("back")} Back</button>
      ...
      <div class="fa-chip ds-chip"><span class="fa-chip-em">${H("medal")}</span>Wins <span class="fa-chip-val ds-chip-val ds-num" data-el="wins">0</span></div>
      <div class="fa-chip ds-chip"><span class="fa-chip-em">${H("coin")}</span><span class="fa-chip-val ds-chip-val ds-num" data-el="coins">0</span></div>
    </header>
    ...
    <div class="chars-body">
      <section class="chars-hero">
        ...
        <button class="chars-equip" type="button" data-el="select">${H("star")} Equip</button>
      </section>
    ...
    <footer class="chars-bottom">
      <button class="fa-btn fa-btn--primary fa-btn--hero" type="button" data-el="fight">${H("play")} Fight!</button>
    </footer>

    <div class="fa-confetti-layer" data-el="confetti"></div>
  `;const n=S=>{const E=e.querySelector(`[data-el="${S}"]`);if(!E)throw new Error(`characterSelect: missing element "${S}"`);return E},s=n("roster"),i=n("stats"),r=n("abilities"),l=n("hero3d"),h=n("heroname"),c=n("herorarity"),d=n("select"),p=n("level"),u=n("confetti"),f=new Map;for(const S of Ee){const E=re[S],A=Fe("button","chars-card");A.type="button",A.dataset.char=S,A.style.setProperty("--card-bg",$l[E.rarity]),A.style.setProperty("--rarity",Lt[E.rarity]),A.style.setProperty("--rarity-glow",U0(Lt[E.rarity],.75)),B4.has(E.rarity)&&A.classList.add("is-animated"),A.innerHTML=`
      <img class="chars-card-render" alt="" data-el="render" />
      <span class="chars-card-sheen"></span>
      <span class="chars-card-gloss"></span>
      <span class="chars-card-art">${H("avatar")}</span>
      <span class="chars-card-name">${E.name}</span>
      <span class="fa-rarity chars-card-rarity"
            style="background:${Lt[E.rarity]}">${E.rarity}</span>
      <span class="chars-card-playing">${H("star")}</span>
      <span class="chars-card-lv" data-el="lv"></span>
    `,A.addEventListener("click",()=>v(S,!0)),s.appendChild(A),f.set(S,A)}const m=(S,E)=>{const A=f.get(S),C=A?.querySelector('[data-el="render"]');C&&(C.src=E,A.classList.add("has-render"))};for(const S of Ee){const E=oh(S);E&&m(S,E)}Z0(m);const g=Fe("div","chars-card chars-card--locked");g.innerHTML=`
    <span class="chars-card-art">${H("lock")}</span>
    <span class="chars-card-name">More soon</span>
  `,s.appendChild(g);const w=new Map;for(const S of s0){const E=Fe("div","fa-stat ds-row ds-row--slate chars-stat");E.style.setProperty("--ds-row-accent",S.color),E.innerHTML=`
      <span class="ds-tile ds-tile--stat" style="--ds-tile-fill:${S.color}">${H(S.icon)}</span>
      <span class="ds-row-body">
        <span class="ds-row-label">${S.label}</span>
        <span class="ds-row-val ds-num"></span>
      </span>
    `,w.set(S.key,E.querySelector(".ds-row-val")),i.appendChild(E)}function b(){const S=o,E=t.profile.characterLevel(S),A=t.profile.nextLevelPrice(S),C=t.profile.canLevelUp(S),R=A===null,I=rl(S,ll,E),N=el(E),L=R?I:rl(S,ll,E+1),_=R?N:el(E+1),U=R?"":`
      <span class="chars-lv-gain"><span class="chars-lv-item">${H("health")} +${L-I}</span
        ><span class="chars-lv-item">${H("damage")} +${Math.round((_/N-1)*100)}%</span></span>`;p.innerHTML=`
      <div class="chars-lv-head">
        <span class="chars-lv-badge${R?" is-max":""}">Lv ${E}${R?"":` / ${tl}`}</span>
        <span class="chars-lv-now"><span class="chars-lv-item">${H("health")} ${I} HP</span
          ><span class="chars-lv-item">${H("damage")} x${N.toFixed(2)}</span></span>
      </div>
      ${U}
      <button class="ds-btn ds-btn--block chars-lv-btn" type="button" data-el="upgrade"${R||!C?" disabled":""}>${R?`${H("star")} Max level`:`${H("sparkle")} Upgrade <span class="chars-lv-price">${H("coin")} ${A.coins.toLocaleString()}</span>`}</button>
      ${R||C?"":`<span class="chars-lv-short">${(A.coins-t.profile.coins).toLocaleString()} more coins needed</span>`}
    `}function y(){const S=t.profile.selected;for(const[A,C]of f)C.classList.toggle("is-playing",A===S);const E=o===S;d.innerHTML=E?`${H("star")} Equipped`:`${H("star")} Equip`,d.classList.toggle("is-equipped",E),d.disabled=E}function v(S,E=!1){o=S;const A=re[S];for(const[C,R]of f)R.classList.toggle("is-viewed",C===S);E&&f.get(S)?.scrollIntoView({block:"nearest"}),h.textContent=A.name,c.textContent=A.rarity,c.style.background=Lt[A.rarity];for(const C of s0)w.get(C.key).textContent=String(A.stats[C.key]);r.innerHTML="";for(const C of Gm(A)){const R=C.weapon,I=Fe("div","chars-ability");I.innerHTML=`
        <span class="chars-ability-em">${J0(C.emoji)}</span>
        <span class="chars-ability-body">
          <span class="chars-ability-name">${C.name}</span>
          <span class="chars-ability-desc">${C.desc}</span>
          ${R?`<span class="chars-ability-facts">${U4(R).map(N=>`<span class="chars-fact">${N}</span>`).join("")}</span>`:""}
        </span>
      `,r.appendChild(I)}if(A.hasTrail){const C=Fe("div","chars-ability chars-ability--passive");C.innerHTML=`
        <span class="chars-ability-em">${H("honey")}</span>
        <span class="chars-ability-body">
      ...
      `,r.appendChild(C)}r.scrollTop=0,a.show(S),y(),b()}n("back").addEventListener("click",()=>t.navigate({name:"home"})),d.addEventListener("click",()=>{t.profile.select(o),y(),Ws(u,50,24),a.poke()}),n("fight").addEventListener("click",()=>{t.profile.select(o),t.navigate({name:"match",player:o,enemy:G4(o)})});function k(){for(const[S,E]of f){const A=t.profile.characterLevel(S),C=E.querySelector('[data-el="lv"]');C&&(C.textContent=A>1?`Lv ${A}`:"",E.classList.toggle("has-lv",A>1),E.classList.toggle("is-maxed",A>=tl))}}function M(){n("wins").textContent=String(t.profile.wins),n("coins").textContent=t.profile.coins.toLocaleString()}p.addEventListener("click",S=>{!S.target.closest('[data-el="upgrade"]')||!t.profile.levelUp(o)||(Ws(u,34,18),a.poke())});const x=t.profile.onChange(()=>{M(),k(),b()});return M(),k(),v(o),a.attachTo(l),{root:e,update(S){a.update(S)},resize(){a.resize()},dispose(){x(),a.detach(),e.remove()}}}const W4=`
...
`,i0=["Normal","Rare","Epic","Legendary","Neon","Cyber"],Y4=(()=>{const t=la.map(a=>{const o=On(a).filter(r=>r.rarity);let n=null,s=-1,i=0;for(const r of o)i+=r.percent,r.percent>s&&(s=r.percent,n=r.rarity??null);return{kind:a,floor:n,charShare:i}});t.sort((a,o)=>{const n=a.floor?i0.indexOf(a.floor):-1,s=o.floor?i0.indexOf(o.floor):-1;return n-s||a.charShare-o.charShare});const e={};return t.forEach((a,o)=>{e[a.kind]={rank:o+1,of:t.length,floor:a.floor}}),e})();function Jr(t,e={}){const a=Y4[t];if(!a)return"";const o=a.floor?Lt[a.floor]:"var(--ink)",n=Array.from({length:a.of},(i,r)=>`<i class="tr-pip${r<a.rank?" is-on":""}"></i>`).join(""),s=`Tier ${a.rank} of ${a.of}${a.floor?`, ${a.floor} or rarer`:""}`;return`<span class="tr-tier" style="--pip:${o}" role="img" aria-label="${s}">${n}${e.label&&a.floor?`<span class="tr-tier-txt">${a.floor}+</span>`:""}</span>`}function V4(t){ha("fa-trophy-styles",K4),ca();const e=Fe("div","fa-screen fa-tr"),a=t.profile;e.innerHTML=`
    <header class="fa-topbar">
      <button class="fa-iconbtn" type="button" data-el="back" aria-label="Back to home">${H("back")} Back</button>
      <h1 class="fa-title tr-heading">Trophy Road</h1>
      <div class="fa-topbar-spacer"></div>
      <div class="fa-chip"><span class="fa-chip-em">${H("coin")}</span><span data-el="coins">0</span></div>
      <div class="fa-chip fa-chip--gem"><span class="fa-chip-em">${H("gem")}</span><span data-el="gems">0</span></div>
    </header>

    <div class="tr-body">
      <section class="tr-hero">
        <div class="tr-hero-count">
          <span class="tr-hero-em">${H("trophy")}</span>
        ...
        <button class="fa-btn fa-btn--green tr-claimall" type="button" data-el="claimall">${H("sparkle")} Claim</button>
      </section>
    ...
    <footer class="tr-bottom">
      ...
      <div class="tr-bottom-actions">
        ...
        <button class="fa-iconbtn tr-odds" type="button" data-el="oddsbtn">${H("chest")} Drop rates</button>
        <button class="fa-btn fa-btn--quiet tr-storebtn" type="button" data-el="storebtn">${H("gem")} Get Gems</button>
      </div>
    </footer>
    ...
    <div class="fa-confetti-layer" data-el="confetti"></div>
  `;const o=R=>{const I=e.querySelector(`[data-el="${R}"]`);if(!I)throw new Error(`trophyRoad: missing element "${R}"`);return I},n=o("road"),s=o("inventory"),i=o("sheet"),r=o("sheetcard"),l=o("confetti"),h=o("claimall"),c=o("delta");function d(R=!1){const I=a.trophies;a.unlocked;const N=new Set(a.economy.claimed);n.innerHTML="";const L=Fe("div","tr-roadtrack"),_=Fe("div","tr-spine"),U=Fe("div","tr-spine-fill");_.appendChild(U),L.appendChild(_);let D=!1;const W=()=>{const z=Fe("div","tr-pin");z.dataset.el="pin",z.innerHTML=`
        <span class="tr-pin-dot">${H("pin")}</span>
        <span class="tr-pin-label">${I.toLocaleString()}</span>
      `,L.appendChild(z),D=!0};let F=0;for(const z of lg()){!D&&I<z.trophies&&W();const P=f(z,I,N.has(z.trophies));P.classList.add(F%2===0?"is-high":"is-low"),L.appendChild(P),F++}D||W(),n.appendChild(L),Bo(L),p(),R&&u()}function p(){const R=n.querySelector(".tr-roadtrack"),I=n.querySelector(".tr-spine"),N=n.querySelector(".tr-spine-fill"),L=n.querySelector('[data-el="pin"]');if(!R||!I||!N||!L)return;N.style.width=`${Math.max(0,L.offsetLeft+L.offsetWidth/2)}px`;const _=I.getBoundingClientRect();if(_.height===0)return;const U=_.top+_.height/2;for(const D of R.querySelectorAll(".tr-node")){const W=D.getBoundingClientRect(),F=D.classList.contains("is-high")?U-W.bottom:W.top-U;D.style.setProperty("--stem",`${Math.max(0,Math.round(F))}px`)}}function u(){const R=n.querySelector('[data-el="pin"]');!R||n.clientWidth===0||(n.scrollLeft=Math.max(0,R.offsetLeft-n.clientWidth/2+R.offsetWidth/2))}function f(R,I,N,L){const _=pl(R.reward),D=I>=R.trophies&&!N,W=D?Fe("button","tr-node is-claimable"):Fe("div","tr-node");if(D&&(W.type="button"),N&&W.classList.add("is-claimed"),_.isCharacter&&W.classList.add("is-character"),W.dataset.trophies=String(R.trophies),R.reward.type==="character"){const z=Lt[re[R.reward.id].rarity];W.style.setProperty("--node-accent",z),W.style.setProperty("--node-glow",U0(z,.55))}const F=N?`<span class="tr-status is-done">${H("check")} Claimed</span>`:D?'<span class="tr-status is-ready">Claim</span>':`<span class="tr-status">${(R.trophies-I).toLocaleString()} to go</span>`;return W.innerHTML=`
      <span class="tr-node-req">${H("trophy")} ${R.trophies.toLocaleString()}</span>
      <span class="tr-node-medal"><span class="tr-node-em">${R.reward.type==="character"?Ta(R.reward.id,{crop:"head"}):R.reward.type==="container"?It(R.reward.kind):xa(_.emoji)}</span>${N?`<span class="tr-node-tick">${H("check")}</span>`:""}</span>
      <span class="tr-node-title">${_.title}</span>
      ${R.reward.type==="container"?Jr(R.reward.kind):""}
      ${_.payoutNote?`<span class="tr-node-note">${_.payoutNote.replace("🪙",H("coin"))}</span>`:""}
      ${F}
    `,W}function m(){o("coins").textContent=a.coins.toLocaleString(),o("gems").textContent=a.gems.toLocaleString(),o("trophies").textContent=a.trophies.toLocaleString();const R=O0(a.trophies),I=o("fill");I.style.width=`${(R.progress01*100).toFixed(1)}%`;const N=a.claimable.length;if(N>0)o("nextlabel").textContent="Ready now",o("nextval").innerHTML=N>1?`${H("sparkle")} ${N} road rewards to claim`:`${H("sparkle")} 1 road reward — tap it on the track`;else if(R.next){const L=R.next.reward,_=pl(L,a.unlocked),U=R.next.trophies-a.trophies;o("nextlabel").textContent="Next reward",o("nextval").innerHTML=`${L.type==="character"?Ta(L.id,{crop:"head"}):L.type==="container"?It(L.kind):xa(_.emoji)} ${_.title} <span class="tr-togo">${H("trophy")} ${U.toLocaleString()} to go</span>`}else o("nextlabel").textContent="Road complete",o("nextval").innerHTML=`${H("flag")} Master of the Kitchen`;o("fillxp").textContent=R.next?`${(a.trophies-R.from).toLocaleString()} / ${(R.to-R.from).toLocaleString()}`:`Road complete — ${dl().toLocaleString()}`,h.style.display=N>1?"":"none",h.innerHTML=`${H("sparkle")} Claim ${N}`,g()}function g(){s.innerHTML="";const R=la.filter(I=>(a.containers[I]??0)>0);if(R.length===0){const I=a.winsToNextChest,N=Fe("p","tr-inv-empty");N.innerHTML=`${H("chest")} <strong>${I}</strong> more ${I===1?"win":"wins"} for a free Chest`,s.appendChild(N);return}for(const I of R){const N=$e[I],L=a.containers[I]??0,_=Fe("button","tr-open");_.type="button",_.dataset.open=I,_.innerHTML=`
        <span class="tr-open-em">${It(I)}</span>
        <span class="tr-open-body">
          <span class="tr-open-name">${N.name}</span>
          <span class="tr-open-cta">Open ${Jr(I)}</span>
        </span>
        <span class="tr-open-count">${L}</span>
      `,s.appendChild(_)}}function w(R,I="wide"){r.innerHTML=R,r.classList.toggle("is-reveal",I==="reveal"),i.classList.add("is-open")}function b(){i.classList.remove("is-open"),r.innerHTML=""}function y(R){const I=[];for(const N of R.characters)I.push(Ta(N,{crop:"head"}));for(const[N,L]of Object.entries(R.containers))L&&I.push(It(N));return R.coins>0&&I.push(H("coin")),R.gems>0&&I.push(H("gem")),I}function v(R,I){const N=ag(R);if(N.length===0)return;const L=y(R),[_,...U]=N;w(`
      <div class="tr-reveal">
        <div class="tr-reveal-em">${L[0]??xa(_.emoji)}</div>
        <p class="tr-reveal-kicker">${I}</p>
        <p class="tr-reveal-name">${_.label}</p>
        ${U.length>0?`<div class="tr-reveal-more">${U.map((D,W)=>`<span class="tr-reveal-chip">${L[W+1]??xa(D.emoji)} ${D.label}</span>`).join("")}</div>`:""}
        <button class="fa-btn fa-btn--primary tr-sheet-close" type="button" data-el="close">Nice!</button>
      </div>
    `,"reveal"),Bo(r),Ws(l,50,28)}function k(){const R=la.map(I=>{const N=$e[I],L=On(I).map(U=>`
        <li class="tr-odds-row">
          <span class="tr-odds-what">${U.rarity?`<i class="tr-odds-dot" style="background:${Lt[U.rarity]}"></i>`:""}${U.label}</span>
          <span class="tr-odds-pct">${R0(U.percent)}</span>
        </li>
      `).join(""),_=On(I).filter(U=>U.pool&&U.pool.length>0).map(U=>`${U.rarity}: ${U.pool.map(D=>re[D].name).join(", ")}`).join(" · ");return`
        <section class="tr-odds-block">
          <h3 class="tr-odds-title">${It(I)} ${N.name} ${Jr(I,{label:!0})}</h3>
          <p class="tr-odds-blurb">${N.blurb}</p>
          <ul class="tr-odds-list">${L}</ul>
          ${_?`<p class="tr-odds-pool">${_}</p>`:""}
        </section>
      `}).join("");w(`
      <div class="tr-sheet-head">
        <p class="tr-sheet-title">Drop rates</p>
        <button class="fa-iconbtn tr-sheet-x" type="button" data-el="close" aria-label="Close">${H("close")}</button>
      </div>
      <div class="fa-scroll tr-sheet-scroll">
        ...
        <p class="tr-sheet-note tr-sheet-note--rarity">${T0}</p>
        ${R}
      </div>
    `)}function M(){const R=dg().map(I=>{const N=ug(I),L=[];return I.coins&&L.push(`${H("coin")} ${I.coins.toLocaleString()}`),I.container&&L.push(`${It(I.container.kind)} ${$e[I.container.kind].name}`),`
        <div class="tr-sku${I.oneTime?" is-featured":""}">
          ${N>0||I.oneTime?`<span class="tr-sku-flags">
            ${N>0?`<span class="tr-sku-bonus">+${N}%</span>`:""}
            ${I.oneTime?'<span class="tr-sku-bonus tr-sku-once">ONE TIME</span>':""}
          </span>`:""}
          <span class="tr-sku-em">${I.container?It(I.container.kind):xa(I.emoji)}</span>
          <span class="tr-sku-name">${I.name}</span>
          <span class="tr-sku-gems">${H("gem")} ${I.gems.toLocaleString()}</span>
          ${L.length>0?`<span class="tr-sku-extra">+ ${L.join(" + ")}</span>`:""}
          <button class="tr-sku-buy" type="button" disabled>${`${pg(I.priceUsdCents)} · Soon`}</button>
        </div>
      `}).join("");w(`
      <div class="tr-sheet-head">
        <p class="tr-sheet-title">${H("gem")} Gem Store</p>
        <button class="fa-iconbtn tr-sheet-x" type="button" data-el="close" aria-label="Close">${H("close")}</button>
      </div>
      <div class="fa-scroll tr-sheet-scroll">
        <p class="tr-soon">${H("cone")} Purchases are not available yet — nothing here can be bought.
        Every gem in the game is earned on the Trophy Road and out of chests.</p>
        <div class="tr-skus">${R}</div>
      </div>
    `)}o("back").addEventListener("click",()=>t.navigate({name:"home"})),o("oddsbtn").addEventListener("click",k),o("storebtn").addEventListener("click",M),o("scrim").addEventListener("click",b),h.addEventListener("click",()=>{const R=a.claimAllMilestones();v(R,"You earned")});const x=R=>{const I=R.target;if(I.closest('[data-el="close"]')){b();return}const N=I.closest(".tr-node.is-claimable");if(N){const _=Number(N.dataset.trophies),U=a.claimMilestone(_);U&&v(U,"You earned");return}const L=I.closest("[data-open]");if(L){const _=L.dataset.open,U=a.openContainer(_);U&&v(U.reward,U.duplicateOf?`${re[U.duplicateOf].name} again — traded in`:`From a ${$e[_].name}`)}};e.addEventListener("click",x);const S=R=>{R.key==="Escape"&&i.classList.contains("is-open")&&b()};window.addEventListener("keydown",S);const E=a.onChange(()=>{m(),d()});m(),d();let A=!1;requestAnimationFrame(()=>{A||(p(),u())});const C=a.lastMatch;if(C&&!C.seen){const R=C.trophies>0?"+":"";c.innerHTML=`${R}${C.trophies} ${H("trophy")}`,c.className=`tr-delta is-on ${C.trophies>0?"is-up":C.trophies<0?"is-down":"is-flat"}`,a.markLastMatchSeen()}return{root:e,resize(){d(),u()},dispose(){A=!0,E(),e.removeEventListener("click",x),window.removeEventListener("keydown",S),e.remove()}}}const K4=`
...
`,r0=Object.keys(Ho).sort((t,e)=>Ho[t]-Ho[e]);function X4(t,e){const a=$e[t].entries,o=wi(a);return a.map(n=>{let s=n.coins??0;const i=n.gems??0;let r=null;return n.characterRarity&&((gi[n.characterRarity]??[]).some(h=>!e.has(h))?r=n.characterRarity:s+=Ho[n.characterRarity]),{chance01:o>0?n.weight/o:0,coins:s,gems:i,fighter:r}})}function _f(t,e){const a=X4(t,e),o={canGrantFighter:!1,bestCoins:0,bestGems:0,expectedCoins:0,expectedGems:0,characterPercent:0,floorRarity:null};for(const s of a)s.fighter&&(o.canGrantFighter=!0),o.bestCoins=Math.max(o.bestCoins,s.coins),o.bestGems=Math.max(o.bestGems,s.gems),o.expectedCoins+=s.chance01*s.coins,o.expectedGems+=s.chance01*s.gems;const n=wi($e[t].entries);for(const s of $e[t].entries){if(!s.characterRarity)continue;o.characterPercent+=n>0?s.weight/n*100:0;const i=r0.indexOf(s.characterRarity),r=o.floorRarity===null?1/0:r0.indexOf(o.floorRarity);i<r&&(o.floorRarity=s.characterRarity)}return o}function To(t,e,a){const o=$e[t].price;if(!o)return!1;const n=_f(t,a);return n.canGrantFighter?!0:e==="coins"?n.bestCoins>o.coins:n.bestGems>o.gems}const Z4=la.filter(t=>$e[t].price!==null);function J4(t){ha("fa-shop-styles",Q4),ca();const e=Fe("div","fa-screen fa-shop"),a=t.profile;e.innerHTML=`
    <header class="fa-topbar">
      <button class="fa-iconbtn" type="button" data-el="back" aria-label="Back to home">${H("back")} Back</button>
    ...
    <footer class="shop-bottom">
      ...
      <div class="shop-foot-actions">
        <button class="fa-btn fa-btn--quiet" type="button" data-go="trophies">${H("trophy")} Trophy Road</button>
        <button class="fa-btn fa-btn--green" type="button" data-go="characters">${H("play")} Play a match</button>
      </div>
    </footer>
  `;const o=u=>{const f=e.querySelector(`[data-el="${u}"]`);if(!f)throw new Error(`shop: missing element "${u}"`);return f},n=o("scroll");function s(u){return`<ul class="shop-odds">${On(u).map(m=>`
      <li class="shop-odds-row">
        <span class="shop-odds-what">${m.rarity?`<i class="shop-odds-dot" style="background:${Lt[m.rarity]}"></i>`:""}${m.label}</span>
        <span class="shop-odds-pct">${R0(m.percent)}</span>
      </li>`).join("")}</ul>`}function i(u){const f=On(u).filter(m=>m.rarity&&m.pool&&m.pool.length>0).map(m=>`<span class="shop-pool-line"><i class="shop-odds-dot" style="background:${Lt[m.rarity]}"></i>${m.pool.map(g=>re[g].name).join(", ")}</span>`).join("");return f?`<div class="shop-pool">${f}</div>`:""}function r(u,f){const m=$e[u],g=m.price,w=_f(u,f),b=w.canGrantFighter&&w.characterPercent>=99.999&&w.floorRarity?`<span class="shop-guarantee"><i class="shop-odds-dot" style="background:${Lt[w.floorRarity]}"></i>Always a fighter, ${w.floorRarity} or rarer</span>`:"",y=k=>{const M=k==="coins"?g.coins:g.gems,x=k==="coins"?a.coins:a.gems,S=H(k==="coins"?"coin":"gem"),E=To(u,k,f),A=x>=M,C=E&&A,R=E?`You need ${(M-x).toLocaleString()} more ${k}`:"Not for sale right now";return`
        <button class="shop-buy shop-buy--${k}${C?"":" is-off"}" type="button"
          data-buy="${u}" data-currency="${k}"${C?"":` disabled title="${R}" aria-label="${M.toLocaleString()} ${k}. ${R}."`}>
          ${S} ${M.toLocaleString()}
        </button>`};let v="";if(!To(u,"coins",f)&&!To(u,"gems",f)){const k=w.bestGems===0,M=w.bestCoins<g.coins?`It pays back at most ${w.bestCoins.toLocaleString()} coins for a ${g.coins.toLocaleString()} coin price, and ${Math.round(w.expectedCoins).toLocaleString()} on average.`:`Its average return is ${Math.round(w.expectedCoins).toLocaleString()} coins against a ${g.coins.toLocaleString()} coin price.`;v=`
        <p class="shop-why">
          <span class="shop-why-head">Not for sale</span>
          Every fighter this box can give is already unlocked, so it can only pay
          ${k?"coins":"currency"} back. ${M}
        ...
        </p>`;else{const k=[...new Set($e[u].entries.flatMap(x=>x.characterRarity?gi[x.characterRarity]??[]:[]))],M=k.filter(x=>!f.has(x)).length;v=w.expectedCoins===0?`<p class="shop-why"><span class="shop-why-head">What you get</span>
            Every roll here is a new fighter. ${M} of the ${k.length} are still
            missing from your roster.</p>`:`<p class="shop-why"><span class="shop-why-head">Duplicates</span>
            ${M} of the ${k.length} fighters here are still missing. A repeat
            trades in for coins, ${Math.round(w.expectedCoins).toLocaleString()} on
            average across the table.</p>`}return`
      <article class="shop-card">
        <div class="shop-card-head">
          <span class="shop-card-em">${It(u)}</span>
        ...
        ${v}
      </article>`}function l(u){const f=$e[u],m=a.winsToNextChest;return`
      ...
      </article>`}function h(){const u=la.filter(m=>(a.containers[m]??0)>0);return u.length===0?"":`
      ...
      <span class="shop-held">
        <span class="shop-held-em">${It(m)}</span>
        <span class="shop-held-name">${$e[m].name}</span>
      ...
      </section>`}function c(){const u=a.unlocked;o("coins").textContent=a.coins.toLocaleString(),o("gems").textContent=a.gems.toLocaleString();const f=Z4.some(g=>To(g,"coins",u)||To(g,"gems",u)),m=f?"":`
      <p class="shop-notice">${H("cone")}
      ...
      <section class="shop-section">
        ...
        <p class="shop-rarity">${T0}</p>
        <div class="shop-grid">${la.map(g=>$e[g].price?r(g,u):l(g)).join("")}</div>
      </section>
    `,o("footnote").textContent=f?"Coins and gems are earned by playing. Both work on every box.":"Boxes are earned, not bought:"}o("back").addEventListener("click",()=>t.navigate({name:"home"}));const d=u=>{const f=u.target,m=f.closest("[data-go]")?.dataset.go;if(m==="trophies"){t.navigate({name:"trophies"});return}if(m==="characters"){t.navigate({name:"characters"});return}const g=f.closest("[data-buy]");if(!g||g.disabled)return;const w=g.dataset.buy,b=g.dataset.currency;To(w,b,a.unlocked)&&a.buyContainer(w,b)};e.addEventListener("click",d);const p=a.onChange(c);return c(),{root:e,dispose(){p(),e.removeEventListener("click",d),e.remove()}}}const Q4=`
...
`,eM=null,l0="Open to a player",h0="Online play is not connected yet. This seat is played by a bot.";function tM(t){return`Online play is not connected yet, so ${t===1?"the other seat is":`all ${t} other seats are`} played by a bot. Opening a seat to another player is switched off rather than offered as a button that does nothing.`}function aM(t){ha("fa-lobby-styles",nM),ca();const e=window.__faOpenSeat!==void 0?window.__faOpenSeat:eM,a=e!==null,o=t.profile.selected,n=oM(o);let s=oc[0];const i=Fe("div","fa-screen fa-lobby");i.innerHTML=`
    <header class="fa-topbar">
      <button class="fa-iconbtn" type="button" data-el="back" aria-label="Back to home">${H("back")} Back</button>
      <h1 class="fa-title lobby-heading">Match Lobby</h1>
      <div class="fa-topbar-spacer"></div>
      <div class="fa-chip ds-chip"><span class="fa-chip-em">${H("party")}</span>Players <span class="fa-chip-val ds-chip-val ds-num" data-el="count">2</span></div>
    </header>
    ...
    <footer class="lobby-bottom">
      ...
      <button class="fa-btn ds-btn ds-btn--primary lobby-start" type="button" data-el="start">${H("play")} Start</button>
    </footer>
  `;const r=g=>{const w=i.querySelector(`[data-el="${g}"]`);if(!w)throw new Error(`lobby: missing element "${g}"`);return w},l=r("seats"),h=r("opts"),c=r("note");for(const g of oc){const w=Fe("button","ds-btn lobby-opt");w.type="button",w.dataset.seats=String(g),w.textContent=String(g),w.setAttribute("aria-label",`${g} players`),h.appendChild(w)}function d(){r("count").textContent=String(s);for(const g of h.querySelectorAll(".lobby-opt")){const w=Number(g.dataset.seats)===s;g.classList.toggle("is-on",w),g.setAttribute("aria-pressed",w?"true":"false")}}function p(){const g=M0(o,n,s),w=t.profile.characterLevel(o),b=N0(w);l.innerHTML=g.map((y,v)=>{const k=v===0,M=re[y].name,x=k?w:b,S=k?"You":"Bot",E=k?`<button class="ds-btn ds-btn--icon lobby-seat-act" type="button" data-el="swap"
             title="Change your fighter" aria-label="Change your fighter">${H("swap")}</button>`:`<button class="ds-btn ds-btn--icon lobby-seat-act lobby-seat-open" type="button"
             data-el="open" data-slot="${v}"${a?"":" disabled"}
             title="${l0}. ${h0}"
             aria-label="${l0} — seat ${v+1}. ${a?"":h0}">${H("avatar")}</button>`;return`
        <div class="lobby-seat${k?" is-you":""}" data-seat="${v}" data-char="${y}">
          <span class="lobby-seat-pic">${Ta(y,{crop:"head"})}</span>
          <span class="lobby-seat-body">
            <span class="lobby-seat-name" data-el="seat-name">${M}</span>
            <span class="lobby-seat-tag"><b>${S}</b> · Lv ${x}</span>
          </span>
          ${E}
        </div>`}).join(""),Bo(l)}function u(){c.textContent=a?"":tM(s-1),c.hidden=a}function f(){d(),p(),u()}const m=g=>{const w=g.target,b=w?.closest(".lobby-opt");if(b){const v=Number(b.dataset.seats);Number.isInteger(v)&&v!==s&&(s=v,f());return}const y=w?.closest('[data-el="open"]');if(y){e?.(Number(y.dataset.slot));return}if(w?.closest('[data-el="swap"]')){t.navigate({name:"characters"});return}w?.closest('[data-el="back"]')&&t.navigate({name:"home"})};return i.addEventListener("click",m),r("start").addEventListener("click",()=>{const g={name:"match",player:o,enemy:n,seats:mi(s)};t.navigate(g)}),f(),{root:i,dispose(){i.removeEventListener("click",m),i.remove()}}}function oM(t){const e=Ee.filter(a=>a!==t);return e[Math.floor(Math.random()*e.length)]}const nM=`
...
`,sM="admin panel is not enabled in this build — rebuild with VITE_FA_ADMIN=1, or run the dev server",Pf=["opening","home","characters","trophies","shop","settings","lobby","match"];function ci(t){return typeof t=="string"&&Ee.includes(t)}function iM(t){return typeof t=="number"?mi(t):void 0}function rM(t){if(!t||typeof t!="object")return null;const e=t.name;if(typeof e!="string"||!Pf.includes(e))return null;if(e==="match"){const{player:a,enemy:o,seats:n}=t;return ci(a)&&ci(o)?{name:e,player:a,enemy:o,seats:iM(n)}:null}return{name:e}}function lM(t){const e=new URLSearchParams(t),a=e.get("screen");if(a===null||!Pf.includes(a))return null;if(a==="match"){const o=e.get("player"),n=e.get("enemy");return ci(o)&&ci(n)?{name:a,player:o,enemy:n,seats:hM(e)}:null}return{name:a}}function hM(t){const e=t.get("seats");return e===null?void 0:mi(Number(e))}function Qr(t,e){return t.name!==e.name?!1:t.name==="match"&&e.name==="match"?t.player===e.player&&t.enemy===e.enemy&&t.seats===e.seats:!0}function c0(t){const e=new URLSearchParams(window.location.search);e.set("screen",t.name),t.name==="match"?(e.set("player",t.player),e.set("enemy",t.enemy),t.seats===void 0?e.delete("seats"):e.set("seats",String(t.seats))):(e.delete("player"),e.delete("enemy"),e.delete("seats"));const a=e.toString();return`${window.location.pathname}${a?`?${a}`:""}${window.location.hash}`}function cM(t,e){if(e!=="none")try{const a={fa:1,route:t};e==="push"?window.history.pushState(a,"",c0(t)):window.history.replaceState(a,"",c0(t))}catch{}}const dM=3e3,pM=10,uM=140;function fM(t){Ig(),Hf();const e=document.createElement("div");e.className="fa-root",e.innerHTML=`
    <div class="fa-bg"></div>
    <div class="fa-rays"></div>
    <div class="fa-dots"></div>
    <div class="fa-stack" data-el="stack"></div>
    <div class="fa-curtain" data-el="curtain"></div>
  `,t.screenRoot.appendChild(e);const a=e.querySelector('[data-el="stack"]'),o=e.querySelector('[data-el="curtain"]'),n=t.profile??new q0;let s=null,i={name:"home"},r=0,l=0,h=!1,c=null,d=!1,p=null,u=0;function f($,ee){console.error(`[shell] ${$}:`,ee)}function m($){const ee=window.__shellFault;if(!ee)return!1;const ye=ee[$];return typeof ye!="number"||ye<=0?!1:(ee[$]=ye-1,!0)}const g={navigate:F,profile:n,gameHost:t.gameHost,hudRoot:t.hudRoot};function w($){if(m("build"))throw new Error(`__shellFault: build ${$.name}`);switch($.name){case"opening":return _1(g);case"home":return F1(g);case"characters":return j4(g);case"trophies":return V4(g);case"shop":return J4(g);case"settings":return P4(g);case"lobby":return aM(g);case"admin":throw new Error(sM);case"match":return F4(g,$)}throw new Error(`unknown route "${String($.name)}"`)}function b(){r&&cancelAnimationFrame(r),r=0}function y(){b(),l=performance.now();const $=ee=>{if(d)return;const ye=Math.min(Math.max(0,(ee-l)/1e3),1/20);l=ee;try{if(m("update"))throw new Error("__shellFault: update");s?.update?.(ye),u=0}catch(Se){if(u++,u===1&&f(`screen "${i.name}" update() threw`,Se),u>=pM){f(`screen "${i.name}" update() threw ${u} frames running — stopping the menu loop`,Se),b();return}}r=requestAnimationFrame($)};r=requestAnimationFrame($)}function v($,ee){if($.name==="match")try{mc()}catch(Se){f("disposeCharacterStage() threw",Se)}try{$.name==="match"?ke.music.fadeOut():ke.music.fadeIn()}catch(Se){f("music transition threw",Se)}e.classList.toggle("is-ingame",$.name==="match");let ye;try{ye=w($)}catch(Se){_($,Se);return}i=$,s=ye,a.appendChild(ye.root),cM($,ee),R(),window.__screen=$.name,u=0,s.update?y():b(),$.name!=="match"&&(window.__previewReady=!1,requestAnimationFrame(()=>requestAnimationFrame(()=>{d||(window.__previewReady=!0)})))}function k($){$.style.cssText=["pointer-events:auto","background:#FFF3DE","color:#1a1224","border-radius:16px","padding:18px 22px","max-width:min(92vw,420px)","text-align:center","box-shadow:0 10px 30px rgba(0,0,0,0.45)","font-family:'Rubik',sans-serif"].join(";")}function M($){$.style.cssText=["position:absolute","inset:0","z-index:120","display:grid","place-items:center","padding:16px","background:rgba(20,13,30,0.72)","pointer-events:none"].join(";")}function x($){const ee=document.createElement("button");return ee.type="button",ee.textContent=$,ee.style.cssText=["min-height:44px","min-width:140px","margin-top:14px","padding:0 20px","border:0","border-radius:999px","background:#F4A300","color:#1a1224","font-family:'Rubik',sans-serif","font-weight:800","font-size:16px","cursor:pointer"].join(";"),ee.addEventListener("click",()=>window.location.reload()),ee}function S($){const ee=document.createElement("div");M(ee),ee.style.background="#16101f",ee.dataset.el="fa-fatal";const ye=document.createElement("div");k(ye);const Se=document.createElement("div");Se.textContent="The kitchen would not open",Se.style.cssText="font-weight:800;font-size:18px";const Ve=document.createElement("div");return Ve.textContent=String($?.message??$??"unknown error"),Ve.style.cssText="margin-top:8px;font-size:13px;opacity:0.75;font-family:'Heebo',sans-serif;word-break:break-word",ye.append(Se,Ve,x("Reload")),ee.appendChild(ye),ee}let E=null,A=null;function C(){if(d||E)return;const $=document.createElement("div");M($),$.dataset.el="fa-gl-notice";const ee=document.createElement("div");k(ee);const ye=document.createElement("div");ye.textContent="Graphics interrupted",ye.style.cssText="font-weight:800;font-size:18px";const Se=document.createElement("div");Se.textContent="The device took the graphics back. Restoring…",Se.style.cssText="margin-top:6px;font-size:14px;opacity:0.8;font-family:'Heebo',sans-serif";const Ve=x("Reload");Ve.style.display="none",ee.append(ye,Se,Ve),$.appendChild(ee),e.appendChild($),E=$,A=setTimeout(()=>{A=null,E&&(Se.textContent="The graphics have not come back. Reloading returns you to this same screen.",Ve.style.display="inline-block")},dM)}function R(){A!==null&&(clearTimeout(A),A=null),E?.remove(),E=null}function I($){return $.detail?.offscreen===!0}function N($){I($)||C()}function L($){I($)||R()}function _($,ee){if(f(`screen "${$.name}" failed to mount`,ee),a.innerHTML="",$.name!=="home"){v({name:"home"},"replace");return}s=null,i={name:"home"},window.__screen="home",b(),a.appendChild(S(ee))}function U(){b();try{if(m("dispose"))throw new Error("__shellFault: dispose");s?.dispose()}catch($){f(`screen "${i.name}" dispose() threw`,$)}s=null,a.innerHTML=""}function D($){return i.name==="opening"||Qr($,i)?"replace":"push"}function W($,ee){h=!0,window.__screenReady=!1,o.classList.add("is-on"),c=setTimeout(()=>{c=null;try{U(),v($,ee)}catch(ye){f("navigation threw",ye)}finally{o.classList.remove("is-on"),h=!1,window.__screenReady=!0,P()}},uM)}function F($){d||h||W($,D($))}const z=$=>{if(d)return;const ee=$.state,ye=rM(ee?.route)??lM(window.location.search)??{name:"home"};if(!Qr(ye,i)){if(h){p=ye;return}W(ye,"none")}};function P(){const $=p;p=null,!(!$||d||Qr($,i))&&W($,"none")}const K=()=>{try{s?.resize?.()}catch($){f(`screen "${i.name}" resize() threw`,$)}},ce='button, [role="button"], a[href], [data-clicksound="on"]',ie=$=>{try{if(ke.isMuted())return;const ee=$.target?.closest?.(ce);if(!ee||ee.closest('[data-clicksound="off"]')||ee.hasAttribute("disabled")||ee.getAttribute("aria-disabled")==="true")return;ke.previewClick()}catch(ee){f("ui click sound threw",ee)}};return e.addEventListener("click",ie,!0),window.addEventListener("resize",K),window.addEventListener("popstate",z),window.addEventListener("fa:webglcontextlost",N),window.addEventListener("fa:webglcontextrestored",L),window.__shell={navigate:F,route:()=>i},{navigate($){if(!s){v($,$.name==="opening"?"none":"replace"),window.__screenReady=!0;return}F($)},get route(){return i},dispose(){d=!0,c!==null&&clearTimeout(c),e.removeEventListener("click",ie,!0),window.removeEventListener("resize",K),window.removeEventListener("popstate",z),window.removeEventListener("fa:webglcontextlost",N),window.removeEventListener("fa:webglcontextrestored",L),R(),U(),mc(),e.remove(),delete window.__shell}}}const Rt=new URLSearchParams(location.search),mM=["player","enemy","simSpeed","fogRadius","px","py","fighters","seats"];function d0(t,e){const a=Rt.get(t);return a&&Ee.includes(a)?a:e}function gM(t){if(Rt.get("screen")==="match"||!Rt.has("screen")&&mM.some(a=>Rt.has(a))){const a=d0("player",t.selected),o=a==="donut"?"hamburger":"donut",n=Km(Rt);return{name:"match",player:a,enemy:d0("enemy",o),seats:n}}return Rt.get("screen")==="lobby"?{name:"lobby"}:Rt.get("screen")==="characters"?{name:"characters"}:Rt.get("screen")==="trophies"?{name:"trophies"}:Rt.get("screen")==="shop"?{name:"shop"}:Rt.get("screen")==="settings"?{name:"settings"}:Rt.get("screen")==="home"?{name:"home"}:{name:"opening"}}const $f=new q0,wM=fM({gameHost:document.getElementById("game"),hudRoot:document.getElementById("hud"),screenRoot:document.getElementById("screens"),profile:$f});wM.navigate(gM($f));ke.music.play();const bM=document.getElementById("boot");requestAnimationFrame(()=>bM.classList.add("hidden"));
